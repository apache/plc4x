...
type MQTT_ControlPacket_AUTH struct {
	*MQTT_ControlPacket
...
type IMQTT_ControlPacket_AUTH interface {
...
///////////////////////////////////////////////////////////
func (m *MQTT_ControlPacket_AUTH) PacketType() MQTT_ControlPacketType {
	return MQTT_ControlPacketType_AUTH
}


func (m *MQTT_ControlPacket_AUTH) InitializeParent(parent *MQTT_ControlPacket) {
}

func NewMQTT_ControlPacket_AUTH(remainingLength uint8, reason MQTT_ReasonCode, propertyLength *uint32, properties []*MQTT_Property) *MQTT_ControlPacket {
	child := &MQTT_ControlPacket_AUTH{
...
func CastMQTT_ControlPacket_AUTH(structType interface{}) *MQTT_ControlPacket_AUTH {
	castFunc := func(typ interface{}) *MQTT_ControlPacket_AUTH {
		if casted, ok := typ.(MQTT_ControlPacket_AUTH); ok {
			return &casted
		}
		if casted, ok := typ.(*MQTT_ControlPacket_AUTH); ok {
			return casted
		...
		if casted, ok := typ.(MQTT_ControlPacket); ok {
			return CastMQTT_ControlPacket_AUTH(casted.Child)
		}
		if casted, ok := typ.(*MQTT_ControlPacket); ok {
			return CastMQTT_ControlPacket_AUTH(casted.Child)
		}
...
func (m *MQTT_ControlPacket_AUTH) GetTypeName() string {
	return "MQTT_ControlPacket_AUTH"
}

func (m *MQTT_ControlPacket_AUTH) LengthInBits() uint16 {
	return m.LengthInBitsConditional(false)
}

func (m *MQTT_ControlPacket_AUTH) LengthInBitsConditional(lastItem bool) uint16 {
...
func (m *MQTT_ControlPacket_AUTH) LengthInBytes() uint16 {
	return m.LengthInBits() / 8
}

func MQTT_ControlPacket_AUTHParse(readBuffer utils.ReadBuffer) (*MQTT_ControlPacket, error) {
	if pullErr := readBuffer.PullContext("MQTT_ControlPacket_AUTH"); pullErr != nil {
		return nil, pullErr
	}
...
_reason, _reasonErr := MQTT_ReasonCodeParse(readBuffer)
	...
	if closeErr := readBuffer.CloseContext("MQTT_ControlPacket_AUTH"); closeErr != nil {
		return nil, closeErr
	}

	// Create a partially initialized instance
	_child := &MQTT_ControlPacket_AUTH{
		RemainingLength: remainingLength,
		Reason: reason,
		PropertyLength: propertyLength,
		Properties: properties,
...
func (m *MQTT_ControlPacket_AUTH) Serialize(writeBuffer utils.WriteBuffer) error {
	ser := func() error {
		if pushErr := writeBuffer.PushContext("MQTT_ControlPacket_AUTH"); pushErr != nil {
			return pushErr
		}
	...
	if m.Properties != nil {
		...
		if popErr := writeBuffer.PopContext("MQTT_ControlPacket_AUTH"); popErr != nil {
			return popErr
		}
		return nil
	}
...
func (m *MQTT_ControlPacket_AUTH) String() string {
	if m == nil {
		return "<nil>"
	}
