...
type MQTT_ControlPacket_PUBREC struct {
	*MQTT_ControlPacket
...
type IMQTT_ControlPacket_PUBREC interface {
...
///////////////////////////////////////////////////////////
func (m *MQTT_ControlPacket_PUBREC) PacketType() MQTT_ControlPacketType {
	return MQTT_ControlPacketType_PUBREC
}


func (m *MQTT_ControlPacket_PUBREC) InitializeParent(parent *MQTT_ControlPacket) {
}

func NewMQTT_ControlPacket_PUBREC(remainingLength uint8, packetIdentifier uint16, reasonCode *MQTT_ReasonCode, propertyLength *uint32, properties []*MQTT_Property) *MQTT_ControlPacket {
	child := &MQTT_ControlPacket_PUBREC{
...
func CastMQTT_ControlPacket_PUBREC(structType interface{}) *MQTT_ControlPacket_PUBREC {
	castFunc := func(typ interface{}) *MQTT_ControlPacket_PUBREC {
		if casted, ok := typ.(MQTT_ControlPacket_PUBREC); ok {
			return &casted
		}
		if casted, ok := typ.(*MQTT_ControlPacket_PUBREC); ok {
			return casted
		...
		if casted, ok := typ.(MQTT_ControlPacket); ok {
			return CastMQTT_ControlPacket_PUBREC(casted.Child)
		}
		if casted, ok := typ.(*MQTT_ControlPacket); ok {
			return CastMQTT_ControlPacket_PUBREC(casted.Child)
		}
...
func (m *MQTT_ControlPacket_PUBREC) GetTypeName() string {
	return "MQTT_ControlPacket_PUBREC"
}

func (m *MQTT_ControlPacket_PUBREC) LengthInBits() uint16 {
	return m.LengthInBitsConditional(false)
}

func (m *MQTT_ControlPacket_PUBREC) LengthInBitsConditional(lastItem bool) uint16 {
...
func (m *MQTT_ControlPacket_PUBREC) LengthInBytes() uint16 {
	return m.LengthInBits() / 8
}

func MQTT_ControlPacket_PUBRECParse(readBuffer utils.ReadBuffer) (*MQTT_ControlPacket, error) {
	if pullErr := readBuffer.PullContext("MQTT_ControlPacket_PUBREC"); pullErr != nil {
		return nil, pullErr
	}
...
_packetIdentifier, _packetIdentifierErr := readBuffer.ReadUint16("packetIdentifier", 16)
	...
	if closeErr := readBuffer.CloseContext("MQTT_ControlPacket_PUBREC"); closeErr != nil {
		return nil, closeErr
	}

	// Create a partially initialized instance
	_child := &MQTT_ControlPacket_PUBREC{
		RemainingLength: remainingLength,
		PacketIdentifier: packetIdentifier,
		ReasonCode: reasonCode,
		PropertyLength: propertyLength,
...
func (m *MQTT_ControlPacket_PUBREC) Serialize(writeBuffer utils.WriteBuffer) error {
	ser := func() error {
		if pushErr := writeBuffer.PushContext("MQTT_ControlPacket_PUBREC"); pushErr != nil {
			return pushErr
		}
	...
	if m.Properties != nil {
		...
		if popErr := writeBuffer.PopContext("MQTT_ControlPacket_PUBREC"); popErr != nil {
			return popErr
		}
		return nil
	}
...
func (m *MQTT_ControlPacket_PUBREC) String() string {
	if m == nil {
		return "<nil>"
	}
