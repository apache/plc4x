...
type MQTT_ControlPacket_PUBCOMP struct {
	*MQTT_ControlPacket
...
type IMQTT_ControlPacket_PUBCOMP interface {
...
///////////////////////////////////////////////////////////
func (m *MQTT_ControlPacket_PUBCOMP) PacketType() MQTT_ControlPacketType {
	return MQTT_ControlPacketType_PUBCOMP
}


func (m *MQTT_ControlPacket_PUBCOMP) InitializeParent(parent *MQTT_ControlPacket) {
}

func NewMQTT_ControlPacket_PUBCOMP(remainingLength uint8, packetIdentifier uint16, reasonCode *MQTT_ReasonCode, propertyLength *uint32, properties []*MQTT_Property) *MQTT_ControlPacket {
	child := &MQTT_ControlPacket_PUBCOMP{
...
func CastMQTT_ControlPacket_PUBCOMP(structType interface{}) *MQTT_ControlPacket_PUBCOMP {
	castFunc := func(typ interface{}) *MQTT_ControlPacket_PUBCOMP {
		if casted, ok := typ.(MQTT_ControlPacket_PUBCOMP); ok {
			return &casted
		}
		if casted, ok := typ.(*MQTT_ControlPacket_PUBCOMP); ok {
			return casted
		...
		if casted, ok := typ.(MQTT_ControlPacket); ok {
			return CastMQTT_ControlPacket_PUBCOMP(casted.Child)
		}
		if casted, ok := typ.(*MQTT_ControlPacket); ok {
			return CastMQTT_ControlPacket_PUBCOMP(casted.Child)
		}
...
func (m *MQTT_ControlPacket_PUBCOMP) GetTypeName() string {
	return "MQTT_ControlPacket_PUBCOMP"
}

func (m *MQTT_ControlPacket_PUBCOMP) LengthInBits() uint16 {
	return m.LengthInBitsConditional(false)
}

func (m *MQTT_ControlPacket_PUBCOMP) LengthInBitsConditional(lastItem bool) uint16 {
...
func (m *MQTT_ControlPacket_PUBCOMP) LengthInBytes() uint16 {
	return m.LengthInBits() / 8
}

func MQTT_ControlPacket_PUBCOMPParse(readBuffer utils.ReadBuffer) (*MQTT_ControlPacket, error) {
	if pullErr := readBuffer.PullContext("MQTT_ControlPacket_PUBCOMP"); pullErr != nil {
		return nil, pullErr
	}
...
_packetIdentifier, _packetIdentifierErr := readBuffer.ReadUint16("packetIdentifier", 16)
	...
	if closeErr := readBuffer.CloseContext("MQTT_ControlPacket_PUBCOMP"); closeErr != nil {
		return nil, closeErr
	}

	// Create a partially initialized instance
	_child := &MQTT_ControlPacket_PUBCOMP{
		RemainingLength: remainingLength,
		PacketIdentifier: packetIdentifier,
		ReasonCode: reasonCode,
		PropertyLength: propertyLength,
...
func (m *MQTT_ControlPacket_PUBCOMP) Serialize(writeBuffer utils.WriteBuffer) error {
	ser := func() error {
		if pushErr := writeBuffer.PushContext("MQTT_ControlPacket_PUBCOMP"); pushErr != nil {
			return pushErr
		}
	...
	if m.Properties != nil {
		...
		if popErr := writeBuffer.PopContext("MQTT_ControlPacket_PUBCOMP"); popErr != nil {
			return popErr
		}
		return nil
	}
...
func (m *MQTT_ControlPacket_PUBCOMP) String() string {
	if m == nil {
		return "<nil>"
	}
