...
func S7ParameterWriteVarRequestParse(io *utils.ReadBuffer) (S7ParameterInitializer, error) {
...
func (m S7ParameterWriteVarRequest) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
    if err := e.EncodeToken(xml.StartElement{Name: start.Name, Attr: []xml.Attr{
            {Name: xml.Name{Local: "className"}, Value: "org.apache.plc4x.java.s7.readwrite.S7ParameterWriteVarRequest"},
        }}); err != nil {
        return err
    }
