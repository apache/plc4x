...
@dataclass
class UmasPDUReadFifoQueueResponse(UmasPDU):
    fifo_value: List[int]
    ...
    def serialize_umas_pdu_child(self, write_buffer: WriteBuffer):
        write_buffer.push_context("UmasPDUReadFifoQueueResponse")
        ...
        write_buffer.pop_context("UmasPDUReadFifoQueueResponse")
    ...
    def length_in_bits(self) -> int:
        ...
        _value: UmasPDUReadFifoQueueResponse = self
    ...
    def static_parse_builder(read_buffer: ReadBuffer, response: bool):
        read_buffer.push_context("UmasPDUReadFifoQueueResponse")
        ...
        read_buffer.pop_context("UmasPDUReadFifoQueueResponse")
        # Create the instance
        return UmasPDUReadFifoQueueResponseBuilder(fifo_value)

    def equals(self, o: object) -> bool:
        if self == o:
            return True

        if not isinstance(o, UmasPDUReadFifoQueueResponse):
            return False

        that: UmasPDUReadFifoQueueResponse = UmasPDUReadFifoQueueResponse(o)
...
@dataclass
class UmasPDUReadFifoQueueResponseBuilder(UmasPDUBuilder):
    fifo_value: List[int]

    def build(
        self,
    ) -> UmasPDUReadFifoQueueResponse:
        umas_pdu_read_fifo_queue_response: UmasPDUReadFifoQueueResponse = (
            UmasPDUReadFifoQueueResponse(self.fifo_value)
        )
        return umas_pdu_read_fifo_queue_response
