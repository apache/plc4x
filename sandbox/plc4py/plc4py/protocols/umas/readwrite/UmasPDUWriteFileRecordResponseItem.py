...
@dataclass
class UmasPDUWriteFileRecordResponseItem:
    reference_type: int
    file_number: int
    record_number: int
    ...
    def serialize(self, write_buffer: WriteBuffer):
        write_buffer.push_context("UmasPDUWriteFileRecordResponseItem")
        ...
        write_buffer.pop_context("UmasPDUWriteFileRecordResponseItem")
    ...
    def length_in_bits(self) -> int:
        ...
        _value: UmasPDUWriteFileRecordResponseItem = self
    ...
    def static_parse(read_buffer: ReadBuffer, **kwargs):
        return UmasPDUWriteFileRecordResponseItem.static_parse_context(read_buffer)

    @staticmethod
    def static_parse_context(read_buffer: ReadBuffer):
        read_buffer.push_context("UmasPDUWriteFileRecordResponseItem")
        ...
        read_buffer.pop_context("UmasPDUWriteFileRecordResponseItem")
        # Create the instance
        _umas_pdu_write_file_record_response_item: UmasPDUWriteFileRecordResponseItem = UmasPDUWriteFileRecordResponseItem(
            reference_type, file_number, record_number, record_data
        )
        return _umas_pdu_write_file_record_response_item

    def equals(self, o: object) -> bool:
        if self == o:
            return True

        if not isinstance(o, UmasPDUWriteFileRecordResponseItem):
            return False

        that: UmasPDUWriteFileRecordResponseItem = UmasPDUWriteFileRecordResponseItem(o)
        return (
