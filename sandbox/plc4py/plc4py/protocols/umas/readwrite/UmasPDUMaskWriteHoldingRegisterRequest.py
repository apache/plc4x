...
@dataclass
class UmasPDUMaskWriteHoldingRegisterRequest(UmasPDU):
    ...
    def serialize_umas_pdu_child(self, write_buffer: WriteBuffer):
        write_buffer.push_context("UmasPDUMaskWriteHoldingRegisterRequest")
        ...
        write_buffer.pop_context("UmasPDUMaskWriteHoldingRegisterRequest")
    ...
    def length_in_bits(self) -> int:
        ...
        _value: UmasPDUMaskWriteHoldingRegisterRequest = self
    ...
    def static_parse_builder(read_buffer: ReadBuffer, response: bool):
        read_buffer.push_context("UmasPDUMaskWriteHoldingRegisterRequest")
        ...
        read_buffer.pop_context("UmasPDUMaskWriteHoldingRegisterRequest")
        # Create the instance
        return UmasPDUMaskWriteHoldingRegisterRequestBuilder(
    ...
    def equals(self, o: object) -> bool:
        ...
        if not isinstance(o, UmasPDUMaskWriteHoldingRegisterRequest):
            return False

        that: UmasPDUMaskWriteHoldingRegisterRequest = (
            UmasPDUMaskWriteHoldingRegisterRequest(o)
        )
        return (
...
@dataclass
class UmasPDUMaskWriteHoldingRegisterRequestBuilder(UmasPDUBuilder):
    reference_address: int
    and_mask: int
    or_mask: int
    ...
    def build(
        self,
    ) -> UmasPDUMaskWriteHoldingRegisterRequest:
        umas_pdu_mask_write_holding_register_request: UmasPDUMaskWriteHoldingRegisterRequest = UmasPDUMaskWriteHoldingRegisterRequest(
            self.reference_address, self.and_mask, self.or_mask
        )
        return umas_pdu_mask_write_holding_register_request
