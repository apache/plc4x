...
@dataclass
class UmasPDUReadCoilsResponse(UmasPDU):
    value: List[int]
    ...
    def serialize_umas_pdu_child(self, write_buffer: WriteBuffer):
        write_buffer.push_context("UmasPDUReadCoilsResponse")
        ...
        write_buffer.pop_context("UmasPDUReadCoilsResponse")
    ...
    def length_in_bits(self) -> int:
        ...
        _value: UmasPDUReadCoilsResponse = self
    ...
    def static_parse_builder(read_buffer: ReadBuffer, response: bool):
        read_buffer.push_context("UmasPDUReadCoilsResponse")
        ...
        read_buffer.pop_context("UmasPDUReadCoilsResponse")
        # Create the instance
        return UmasPDUReadCoilsResponseBuilder(value)

    def equals(self, o: object) -> bool:
        if self == o:
            return True

        if not isinstance(o, UmasPDUReadCoilsResponse):
            return False

        that: UmasPDUReadCoilsResponse = UmasPDUReadCoilsResponse(o)
...
@dataclass
class UmasPDUReadCoilsResponseBuilder(UmasPDUBuilder):
    value: List[int]

    def build(
        self,
    ) -> UmasPDUReadCoilsResponse:
        umas_pdu_read_coils_response: UmasPDUReadCoilsResponse = (
            UmasPDUReadCoilsResponse(self.value)
        )
        return umas_pdu_read_coils_response
