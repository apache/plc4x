...
@dataclass
class UmasPDUWriteMultipleCoilsRequest(UmasPDU):
    ...
    def serialize_umas_pdu_child(self, write_buffer: WriteBuffer):
        write_buffer.push_context("UmasPDUWriteMultipleCoilsRequest")
        ...
        write_buffer.pop_context("UmasPDUWriteMultipleCoilsRequest")
    ...
    def length_in_bits(self) -> int:
        ...
        _value: UmasPDUWriteMultipleCoilsRequest = self
    ...
    def static_parse_builder(read_buffer: ReadBuffer, response: bool):
        read_buffer.push_context("UmasPDUWriteMultipleCoilsRequest")
        ...
        read_buffer.pop_context("UmasPDUWriteMultipleCoilsRequest")
        # Create the instance
        return UmasPDUWriteMultipleCoilsRequestBuilder(
    ...
    def equals(self, o: object) -> bool:
        ...
        if not isinstance(o, UmasPDUWriteMultipleCoilsRequest):
            return False

        that: UmasPDUWriteMultipleCoilsRequest = UmasPDUWriteMultipleCoilsRequest(o)
        return (
...
@dataclass
class UmasPDUWriteMultipleCoilsRequestBuilder(UmasPDUBuilder):
    starting_address: int
    quantity: int
    value: List[int]
    ...
    def build(
        self,
    ) -> UmasPDUWriteMultipleCoilsRequest:
        umas_pdu_write_multiple_coils_request: UmasPDUWriteMultipleCoilsRequest = (
            UmasPDUWriteMultipleCoilsRequest(
                self.starting_address, self.quantity, self.value
            )
        )
        return umas_pdu_write_multiple_coils_request
