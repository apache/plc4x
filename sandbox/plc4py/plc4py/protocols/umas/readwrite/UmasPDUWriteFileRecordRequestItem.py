...
@dataclass
class UmasPDUWriteFileRecordRequestItem:
    reference_type: int
    file_number: int
    record_number: int
    ...
    def serialize(self, write_buffer: WriteBuffer):
        write_buffer.push_context("UmasPDUWriteFileRecordRequestItem")
        ...
        write_buffer.pop_context("UmasPDUWriteFileRecordRequestItem")
    ...
    def length_in_bits(self) -> int:
        ...
        _value: UmasPDUWriteFileRecordRequestItem = self
    ...
    def static_parse(read_buffer: ReadBuffer, **kwargs):
        return UmasPDUWriteFileRecordRequestItem.static_parse_context(read_buffer)

    @staticmethod
    def static_parse_context(read_buffer: ReadBuffer):
        read_buffer.push_context("UmasPDUWriteFileRecordRequestItem")
        ...
        read_buffer.pop_context("UmasPDUWriteFileRecordRequestItem")
        # Create the instance
        _umas_pdu_write_file_record_request_item: UmasPDUWriteFileRecordRequestItem = (
            UmasPDUWriteFileRecordRequestItem(
                reference_type, file_number, record_number, record_data
            )
        )
        return _umas_pdu_write_file_record_request_item

    def equals(self, o: object) -> bool:
        if self == o:
            return True

        if not isinstance(o, UmasPDUWriteFileRecordRequestItem):
            return False

        that: UmasPDUWriteFileRecordRequestItem = UmasPDUWriteFileRecordRequestItem(o)
        return (
