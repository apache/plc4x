...
@dataclass
class UmasPDUWriteMultipleHoldingRegistersRequest(UmasPDU):
    ...
    def serialize_umas_pdu_child(self, write_buffer: WriteBuffer):
        write_buffer.push_context("UmasPDUWriteMultipleHoldingRegistersRequest")
        ...
        write_buffer.pop_context("UmasPDUWriteMultipleHoldingRegistersRequest")
    ...
    def length_in_bits(self) -> int:
        ...
        _value: UmasPDUWriteMultipleHoldingRegistersRequest = self
    ...
    def static_parse_builder(read_buffer: ReadBuffer, response: bool):
        read_buffer.push_context("UmasPDUWriteMultipleHoldingRegistersRequest")
        ...
        read_buffer.pop_context("UmasPDUWriteMultipleHoldingRegistersRequest")
        # Create the instance
        return UmasPDUWriteMultipleHoldingRegistersRequestBuilder(
    ...
    def equals(self, o: object) -> bool:
        ...
        if not isinstance(o, UmasPDUWriteMultipleHoldingRegistersRequest):
            return False

        that: UmasPDUWriteMultipleHoldingRegistersRequest = (
            UmasPDUWriteMultipleHoldingRegistersRequest(o)
        )
        return (
...
@dataclass
class UmasPDUWriteMultipleHoldingRegistersRequestBuilder(UmasPDUBuilder):
    starting_address: int
    quantity: int
    value: List[int]
    ...
    def build(
        self,
    ) -> UmasPDUWriteMultipleHoldingRegistersRequest:
        umas_pdu_write_multiple_holding_registers_request: UmasPDUWriteMultipleHoldingRegistersRequest = UmasPDUWriteMultipleHoldingRegistersRequest(
            self.starting_address, self.quantity, self.value
        )
        return umas_pdu_write_multiple_holding_registers_request
