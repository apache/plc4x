...
@dataclass
class UmasPDUReadWriteMultipleHoldingRegistersRequest(UmasPDU):
    ...
    def serialize_umas_pdu_child(self, write_buffer: WriteBuffer):
        write_buffer.push_context("UmasPDUReadWriteMultipleHoldingRegistersRequest")
        ...
        write_buffer.pop_context("UmasPDUReadWriteMultipleHoldingRegistersRequest")
    ...
    def length_in_bits(self) -> int:
        ...
        _value: UmasPDUReadWriteMultipleHoldingRegistersRequest = self
    ...
    def static_parse_builder(read_buffer: ReadBuffer, response: bool):
        read_buffer.push_context("UmasPDUReadWriteMultipleHoldingRegistersRequest")
        ...
        read_buffer.pop_context("UmasPDUReadWriteMultipleHoldingRegistersRequest")
        # Create the instance
        return UmasPDUReadWriteMultipleHoldingRegistersRequestBuilder(
    ...
    def equals(self, o: object) -> bool:
        ...
        if not isinstance(o, UmasPDUReadWriteMultipleHoldingRegistersRequest):
            return False

        that: UmasPDUReadWriteMultipleHoldingRegistersRequest = (
            UmasPDUReadWriteMultipleHoldingRegistersRequest(o)
        )
        return (
...
@dataclass
class UmasPDUReadWriteMultipleHoldingRegistersRequestBuilder(UmasPDUBuilder):
    read_starting_address: int
    read_quantity: int
    write_starting_address: int
    write_quantity: int
    ...
    def build(
        self,
    ) -> UmasPDUReadWriteMultipleHoldingRegistersRequest:
        umas_pdu_read_write_multiple_holding_registers_request: UmasPDUReadWriteMultipleHoldingRegistersRequest = UmasPDUReadWriteMultipleHoldingRegistersRequest(
        ...
        return umas_pdu_read_write_multiple_holding_registers_request
