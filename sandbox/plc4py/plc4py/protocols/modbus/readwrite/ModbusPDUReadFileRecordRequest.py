...
class ModbusPDUReadFileRecordRequest(PlcMessage,ModbusPDU):
    ...
    def static_parse_builder(read_buffer: ReadBuffer, response: c_bool):
        ...
        items: List[ModbusPDUReadFileRecordRequestItem] = read_length_array_field("items", DataReaderComplexDefault(ModbusPDUReadFileRecordRequestItem.static_parse(read_buffer), read_buffer), byte_count)
