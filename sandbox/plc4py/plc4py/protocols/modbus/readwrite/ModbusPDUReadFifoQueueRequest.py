...
class ModbusPDUReadFifoQueueRequest(PlcMessage,ModbusPDU):
    ...
    def serialize_modbus_pdu_child(self, write_buffer: WriteBuffer):
        ...
        write_simple_field("fifoPointerAddress", self.fifo_pointer_address, write_unsigned_int(write_buffer, 16))
    ...
    def static_parse_builder(read_buffer: ReadBuffer, response: c_bool):
        ...
        fifo_pointer_address: c_uint16 = read_simple_field("fifoPointerAddress", read_unsigned_int(read_buffer, 16))
