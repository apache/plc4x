...
class ModbusPDUWriteFileRecordResponse(PlcMessage,ModbusPDU):
    ...
    def static_parse_builder(read_buffer: ReadBuffer, response: c_bool):
        ...
        items: List[ModbusPDUWriteFileRecordResponseItem] = read_length_array_field("items", DataReaderComplexDefault(ModbusPDUWriteFileRecordResponseItem.static_parse(read_buffer), read_buffer), byte_count)
