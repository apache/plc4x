...
class ModbusPDUReadWriteMultipleHoldingRegistersRequest(PlcMessage,ModbusPDU):
    ...
    def serialize_modbus_pdu_child(self, write_buffer: WriteBuffer):
        ...
        write_simple_field("readStartingAddress", self.read_starting_address, write_unsigned_int(write_buffer, 16))

        # Simple Field (readQuantity)
        write_simple_field("readQuantity", self.read_quantity, write_unsigned_int(write_buffer, 16))

        # Simple Field (writeStartingAddress)
        write_simple_field("writeStartingAddress", self.write_starting_address, write_unsigned_int(write_buffer, 16))

        # Simple Field (writeQuantity)
        write_simple_field("writeQuantity", self.write_quantity, write_unsigned_int(write_buffer, 16))
    ...
    def static_parse_builder(read_buffer: ReadBuffer, response: c_bool):
        ...
        read_starting_address: c_uint16 = read_simple_field("readStartingAddress", read_unsigned_int(read_buffer, 16))

        read_quantity: c_uint16 = read_simple_field("readQuantity", read_unsigned_int(read_buffer, 16))

        write_starting_address: c_uint16 = read_simple_field("writeStartingAddress", read_unsigned_int(read_buffer, 16))

        write_quantity: c_uint16 = read_simple_field("writeQuantity", read_unsigned_int(read_buffer, 16))
