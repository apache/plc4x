...
class DataItem:
    ...
    def static_parse(read_buffer: ReadBuffer, data_type: ModbusDataType, number_of_values: int):
        if EvaluationHelper.equals( data_type, ModbusDataType.get_bool() ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # BOOL
        ...
        if EvaluationHelper.equals( data_type, ModbusDataType.get_byte() ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # BYTE
        ...
        if EvaluationHelper.equals( data_type, ModbusDataType.get_byte() ) :  # List
            ...
            if numberOfValues* int(8) > Integer.MAX_VALUE:
                raise ParseException("Array count of " + (numberOfValues* int(8)) + " exceeds the maximum allowed count of " + Integer.MAX_VALUE)
        ...
        if EvaluationHelper.equals( data_type, ModbusDataType.get_sint() ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # SINT
        ...
        if EvaluationHelper.equals( data_type, ModbusDataType.get_sint() ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, ModbusDataType.get_int() ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # INT
        ...
        if EvaluationHelper.equals( data_type, ModbusDataType.get_int() ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, ModbusDataType.get_dint() ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # DINT
        ...
        if EvaluationHelper.equals( data_type, ModbusDataType.get_dint() ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, ModbusDataType.get_lint() ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # LINT
        ...
        if EvaluationHelper.equals( data_type, ModbusDataType.get_lint() ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, ModbusDataType.get_usint() ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # USINT
        ...
        if EvaluationHelper.equals( data_type, ModbusDataType.get_usint() ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, ModbusDataType.get_uint() ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # UINT
        ...
        if EvaluationHelper.equals( data_type, ModbusDataType.get_uint() ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, ModbusDataType.get_udint() ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # UDINT
        ...
        if EvaluationHelper.equals( data_type, ModbusDataType.get_udint() ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, ModbusDataType.get_ulint() ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # ULINT
        ...
        if EvaluationHelper.equals( data_type, ModbusDataType.get_ulint() ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, ModbusDataType.get_real() ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # REAL
        ...
        if EvaluationHelper.equals( data_type, ModbusDataType.get_real() ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, ModbusDataType.get_lreal() ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # LREAL
        ...
        if EvaluationHelper.equals( data_type, ModbusDataType.get_lreal() ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, ModbusDataType.get_char() ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # CHAR
        ...
        if EvaluationHelper.equals( data_type, ModbusDataType.get_char() ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, ModbusDataType.get_wchar() ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # WCHAR
    ...
    def static_serialize(writeBuffer: WriteBuffer, _value: PlcValue, dataType: ModbusDataType, numberOfValues: int, byteOrder: ByteOrder) -> None:
        if EvaluationHelper.equals( dataType, ModbusDataType.get_bool() ) and EvaluationHelper.equals( numberOfValues, int(1) ) : # BOOL
        ...
        if EvaluationHelper.equals( dataType, ModbusDataType.get_byte() ) and EvaluationHelper.equals( numberOfValues, int(1) ) : # BYTE
        ...
        if EvaluationHelper.equals( dataType, ModbusDataType.get_sint() ) and EvaluationHelper.equals( numberOfValues, int(1) ) : # SINT
        ...
        if EvaluationHelper.equals( dataType, ModbusDataType.get_int() ) and EvaluationHelper.equals( numberOfValues, int(1) ) : # INT
        ...
        if EvaluationHelper.equals( dataType, ModbusDataType.get_dint() ) and EvaluationHelper.equals( numberOfValues, int(1) ) : # DINT
        ...
        if EvaluationHelper.equals( dataType, ModbusDataType.get_lint() ) and EvaluationHelper.equals( numberOfValues, int(1) ) : # LINT
        ...
        if EvaluationHelper.equals( dataType, ModbusDataType.get_usint() ) and EvaluationHelper.equals( numberOfValues, int(1) ) : # USINT
        ...
        if EvaluationHelper.equals( dataType, ModbusDataType.get_uint() ) and EvaluationHelper.equals( numberOfValues, int(1) ) : # UINT
        ...
        if EvaluationHelper.equals( dataType, ModbusDataType.get_udint() ) and EvaluationHelper.equals( numberOfValues, int(1) ) : # UDINT
        ...
        if EvaluationHelper.equals( dataType, ModbusDataType.get_ulint() ) and EvaluationHelper.equals( numberOfValues, int(1) ) : # ULINT
        ...
        if EvaluationHelper.equals( dataType, ModbusDataType.get_real() ) and EvaluationHelper.equals( numberOfValues, int(1) ) : # REAL
        ...
        if EvaluationHelper.equals( dataType, ModbusDataType.get_lreal() ) and EvaluationHelper.equals( numberOfValues, int(1) ) : # LREAL
        ...
        if EvaluationHelper.equals( dataType, ModbusDataType.get_char() ) and EvaluationHelper.equals( numberOfValues, int(1) ) : # CHAR
        ...
        if EvaluationHelper.equals( dataType, ModbusDataType.get_wchar() ) and EvaluationHelper.equals( numberOfValues, int(1) ) : # WCHAR
