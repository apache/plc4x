...
class ModbusPDUMaskWriteHoldingRegisterResponse(PlcMessage,ModbusPDU):
    ...
    def serialize_modbus_pdu_child(self, write_buffer: WriteBuffer):
        ...
        write_simple_field("referenceAddress", self.reference_address, write_unsigned_int(write_buffer, 16))

        # Simple Field (andMask)
        write_simple_field("andMask", self.and_mask, write_unsigned_int(write_buffer, 16))
    ...
    def static_parse_builder(read_buffer: ReadBuffer, response: c_bool):
        ...
        reference_address: c_uint16 = read_simple_field("referenceAddress", read_unsigned_int(read_buffer, 16))

        and_mask: c_uint16 = read_simple_field("andMask", read_unsigned_int(read_buffer, 16))

        or_mask: c_uint16 = read_simple_field("orMask", read_unsigned_int(read_buffer, 16))
