...
class ModbusPDUReadFileRecordRequestItem(PlcMessage):
    ...
    def serialize(self, write_buffer: WriteBuffer):
        ...
        write_simple_field("recordLength", self.record_length, write_unsigned_int(write_buffer, 16))
    ...
    def static_parse_context(read_buffer: ReadBuffer):
        ...
        record_length: c_uint16 = read_simple_field("recordLength", read_unsigned_int(read_buffer, 16))
