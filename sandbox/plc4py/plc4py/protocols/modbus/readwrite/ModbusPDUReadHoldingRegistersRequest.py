...
@dataclass
class ModbusPDUReadHoldingRegistersRequestBuilder:
    starting_address: int
    quantity: int
    ...
    def build(
        ...
        modbus_pdu_read_holding_registers_request: ModbusPDUReadHoldingRegistersRequest = ModbusPDUReadHoldingRegistersRequest(
