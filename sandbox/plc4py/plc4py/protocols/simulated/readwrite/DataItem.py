...
class DataItem:
    ...
    def static_parse(read_buffer: ReadBuffer, data_type: str, number_of_values: int):
        if EvaluationHelper.equals( data_type, "_bool" ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # BOOL
        ...
        if EvaluationHelper.equals( data_type, "_byte" ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # BYTE
        ...
        if EvaluationHelper.equals( data_type, "_byte" ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, "_word" ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # WORD
        ...
        if EvaluationHelper.equals( data_type, "_word" ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, "_dword" ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # DWORD
        ...
        if EvaluationHelper.equals( data_type, "_dword" ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, "_lword" ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # LWORD
        ...
        if EvaluationHelper.equals( data_type, "_lword" ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, "_sint" ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # SINT
        ...
        if EvaluationHelper.equals( data_type, "_sint" ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, "_int" ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # INT
        ...
        if EvaluationHelper.equals( data_type, "_int" ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, "_dint" ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # DINT
        ...
        if EvaluationHelper.equals( data_type, "_dint" ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, "_lint" ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # LINT
        ...
        if EvaluationHelper.equals( data_type, "_lint" ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, "_usint" ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # USINT
        ...
        if EvaluationHelper.equals( data_type, "_usint" ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, "_uint" ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # UINT
        ...
        if EvaluationHelper.equals( data_type, "_uint" ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, "_udint" ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # UDINT
        ...
        if EvaluationHelper.equals( data_type, "_udint" ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, "_ulint" ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # ULINT
        ...
        if EvaluationHelper.equals( data_type, "_ulint" ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, "_real" ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # REAL
        ...
        if EvaluationHelper.equals( data_type, "_real" ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, "_lreal" ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # LREAL
        ...
        if EvaluationHelper.equals( data_type, "_lreal" ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, "_char" ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # CHAR
        ...
        if EvaluationHelper.equals( data_type, "_char" ) :  # List
            ...
            return PlcList(value)
        if EvaluationHelper.equals( data_type, "_wchar" ) and EvaluationHelper.equals( number_of_values, int(1) ) :  # WCHAR
    ...
    @staticmethod
    def static_serialize(writeBuffer: WriteBuffer, _value: PlcValue, dataType: str, numberOfValues: int) -> None:
    ...
    @staticmethod
    def get_length_in_bytes(_value: PlcValue, dataType: str, numberOfValues: int) -> int:
