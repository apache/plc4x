...
plc4c_return_code plc4c_modbus_read_write_data_item_parse(plc4c_spi_read_buffer* io, plc4c_modbus_read_write_modbus_data_type dataType, uint16_t numberOfValues, plc4c_data** data_item) {
    ...
    plc4c_return_code _res = OK;
        ...
        *data_item = plc4c_data_create_list_data(*value);
                ...
                // Simple Field (value)
                char* value = "";
                _res = plc4c_spi_read_string(io, (numberOfValues) * (8), "'UTF-8'", (char**) &value);
                if(_res != OK) {
                    return _res;
                }
    ...
    } else         if(dataType == plc4c_modbus_read_write_modbus_data_type_WSTRING) { /* STRING */

                // Simple Field (value)
                char* value = "";
                _res = plc4c_spi_read_string(io, (numberOfValues) * (16), "'UTF-16'", (char**) &value);
                if(_res != OK) {
                    return _res;
                }
