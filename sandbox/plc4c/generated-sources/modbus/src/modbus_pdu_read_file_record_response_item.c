...
uint8_t plc4c_modbus_read_write_modbus_pdu_read_file_record_response_item_length_in_bytes(plc4c_modbus_read_write_modbus_pdu_read_file_record_response_item* _message) {
  return plc4c_modbus_read_write_modbus_pdu_read_file_record_response_item_length_in_bits(_message) / 8;
}

uint8_t plc4c_modbus_read_write_modbus_pdu_read_file_record_response_item_length_in_bits(plc4c_modbus_read_write_modbus_pdu_read_file_record_response_item* _message) {
