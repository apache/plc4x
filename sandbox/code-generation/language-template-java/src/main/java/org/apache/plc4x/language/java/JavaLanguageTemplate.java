...
public class JavaLanguageTemplate implements LanguageTemplate {
    ...
    @Override
    public List<Template> getTemplates(Configuration freemarkerConfiguration) throws IOException {
        ClassTemplateLoader classTemplateLoader = new ClassTemplateLoader(JavaLanguageTemplate.class, "/");
    ...
    @Override
    public LanguageTemplateHelper getHelper() {
