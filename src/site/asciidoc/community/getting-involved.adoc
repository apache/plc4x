...
You can always read the mailinglist content via our link:++https://lists.apache.org/list.html?dev@plc4x.apache.org++[Apache list archive.] We're a friendly bunch, so don't be afraid :-)
