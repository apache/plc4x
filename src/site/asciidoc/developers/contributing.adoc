...
All our content is written in Asciidoctor and is located in `src/site/asciidoctor` directories. For a reference of the Asciidoctor snytax please have a look at the https://asciidoctor.org/docs/user-manual/#introduction-to-asciidoctor[Asciidoctor documentation].
