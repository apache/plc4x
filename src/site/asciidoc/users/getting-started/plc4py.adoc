...
Currently, you need to install PLC4Py from the GitHub repository instead of pypi. Navigate to the sandbox/plc4py directory
and run. This will install plc4py in your global repository.
...
You now should be able to use PLC4PY in your application. A short example is shown below.
