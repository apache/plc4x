...
a|image::users/companies/logo-c-ware.png[c-ware, 200, 200] |https://www.c-ware.de[C-Ware^,opts=nofollow] |commercial support, training, workshops, consulting, individual software-development |Christofer Dutz |christofer.dutz@codecentric.de |  |PMC Member
