...
This support is however done voluntatily by the community, so there are no service-level-agreements.

If you or your business has higher demands on guaranteed availability and execution of supprot requests,
the following individuals and companies are providing commercial support offerings.

The information provided here was provided by the entities named, and is not verified, updated or endorsed by the `Apache Software Foundation` or the `Apache PLC4X` project.

|===
||Name |Description |Contact Person(s) |Contact Email(s) |Contact Phone(s) |Involvement Level

a|image::users/companies/logo-codecentric.png[cc, 200, 200] |https://www.codecentric.de/innovation/industrial-iot-mit-apache-plc4x/[codecentric AG^,opts=nofollow] |We develop software that solves real problems - and PLC4X solves the problem of IoT connectivity in a highly performant and open source way |Christofer Dutz |christofer.dutz@codecentric.de |  |PMC Member
