           ...
           <div class="container text-center">
               <div class="row">
                   <div class="col-lg-12 mx-auto">
                       ...
                       <p class="lead">Just because you can download and use PLC4X for free doesn't mean that you're left on your own. Some of our community member's companies can also provide you with the <b>commercial support</b> you need.</p>
                   </div>
               </div>
           </div>
       </section>
