...
#include "alarm8_message_query_type.h"

// Code generated by code-generation. DO NOT EDIT.


// Parse function.
plc4c_return_code plc4c_s7_read_write_alarm8_message_query_type_parse(plc4x_spi_context ctx, plc4c_spi_read_buffer* readBuffer, plc4c_s7_read_write_alarm8_message_query_type** _message) {
  uint16_t startPos = plc4c_spi_read_get_pos(readBuffer);
  plc4c_return_code _res = OK;

  // Allocate enough memory to contain this data structure.
  (*_message) = malloc(sizeof(plc4c_s7_read_write_alarm8_message_query_type));
  if(*_message == NULL) {
    return NO_MEMORY;
  }
  ...
  {
    // Count array
    uint16_t itemCount = (uint16_t) (byteCount) / (12);
...
plc4c_return_code plc4c_s7_read_write_alarm8_message_query_type_serialize(plc4x_spi_context ctx, plc4c_spi_write_buffer* writeBuffer, plc4c_s7_read_write_alarm8_message_query_type* _message) {
  plc4c_return_code _res = OK;
  ...
  // Simple Field (byteCount)
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, _message->byte_count);
  if(_res != OK) {
    return _res;
  }
...
uint16_t plc4c_s7_read_write_alarm8_message_query_type_length_in_bytes(plc4x_spi_context ctx, plc4c_s7_read_write_alarm8_message_query_type* _message) {
  return plc4c_s7_read_write_alarm8_message_query_type_length_in_bits(ctx, _message) / 8;
}

uint16_t plc4c_s7_read_write_alarm8_message_query_type_length_in_bits(plc4x_spi_context ctx, plc4c_s7_read_write_alarm8_message_query_type* _message) {
