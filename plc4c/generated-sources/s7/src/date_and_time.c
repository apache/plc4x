...
plc4c_return_code plc4c_s7_read_write_date_and_time_serialize(plc4c_spi_write_buffer* writeBuffer, plc4c_s7_read_write_date_and_time* _message) {
  ...
  // Manual Field (year)  {
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, (uint8_t*) plc4c_utils_list_get_value(_message->year, 1));
  if(_res != OK) {
    return _res;
  }

  // Manual Field (month)  {
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, (uint8_t*) plc4c_utils_list_get_value(_message->month, 1));
  if(_res != OK) {
    return _res;
  }

  // Manual Field (day)  {
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, (uint8_t*) plc4c_utils_list_get_value(_message->day, 1));
  if(_res != OK) {
    return _res;
  }

  // Manual Field (hour)  {
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, (uint8_t*) plc4c_utils_list_get_value(_message->hour, 1));
  if(_res != OK) {
    return _res;
  }

  // Manual Field (minutes)  {
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, (uint8_t*) plc4c_utils_list_get_value(_message->minutes, 1));
  if(_res != OK) {
    return _res;
  }

  // Manual Field (seconds)  {
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, (uint8_t*) plc4c_utils_list_get_value(_message->seconds, 1));
  if(_res != OK) {
    return _res;
  }

  // Manual Field (msec)  {
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 12, (uint16_t*) plc4c_utils_list_get_value(_message->msec, 1));
  if(_res != OK) {
    return _res;
  }
