...
// Parse function.
plc4c_return_code plc4c_s7_read_write_data_item_parse(plc4x_spi_context ctx, plc4c_spi_read_buffer* readBuffer, char* dataProtocolId, plc4c_s7_read_write_controller_type controllerType, int32_t stringLength, plc4c_data** data_item) {
    ...
    plc4c_return_code _res = OK;
        ...
        if(strcmp(dataProtocolId, "IEC61131_BOOL") == 0) { /* BOOL */
                ...
                *data_item = plc4c_data_create_char_data(*value);
                ...
                // Simple Field (value)
                char* value = "";
                _res = plc4c_spi_read_string(readBuffer, 16, "UTF16BE", (char**) &value);
                if(_res != OK) {
                    return _res;
                }
                ...
                *data_item = plc4c_data_create_char_data(*value);
                ...
                // Manual Field (value)
                char* value = (char*) (plc4c_s7_read_write_parse_s7_string(readBuffer, stringLength, "UTF8"));
                ...
                *data_item = plc4c_data_create_string_data(stringLength, value);
                ...
                // Manual Field (value)
                char* value = (char*) (plc4c_s7_read_write_parse_s7_string(readBuffer, stringLength, "UTF16BE"));
...
plc4c_return_code plc4c_s7_read_write_data_item_serialize(plc4x_spi_context ctx, plc4c_spi_write_buffer* writeBuffer, char* dataProtocolId, plc4c_s7_read_write_controller_type controllerType, int32_t stringLength, plc4c_data** data_item) {
  plc4c_return_code _res = OK;
        if(strcmp(dataProtocolId, "IEC61131_BOOL") == 0) { /* BOOL */
                    ...
                    // Simple field (value)
                    _res = plc4c_spi_write_string(writeBuffer, 16, "UTF16BE", (const uint8_t*) &(*data_item)->data.char_value);
                    if(_res != OK) {
                        return _res;
                    }
        } else         if(strcmp(dataProtocolId, "IEC61131_STRING") == 0) { /* STRING */
...
uint16_t plc4c_s7_read_write_data_item_length_in_bytes(plc4x_spi_context ctx, plc4c_data* data_item, char* data_protocol_id, plc4c_s7_read_write_controller_type controller_type, int32_t string_length) {
  return plc4c_s7_read_write_data_item_length_in_bits(ctx, data_item, data_protocol_id, controller_type, string_length) / 8;
}

uint16_t plc4c_s7_read_write_data_item_length_in_bits(plc4x_spi_context ctx, plc4c_data* data_item, char* dataProtocolId, plc4c_s7_read_write_controller_type controllerType, int32_t stringLength) {
