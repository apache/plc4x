...
plc4c_return_code plc4c_s7_read_write_data_item_parse(plc4c_spi_read_buffer* readBuffer, char* dataProtocolId, int32_t stringLength, plc4c_data** data_item) {
    ...
    plc4c_return_code _res = OK;
        ...
        if(dataProtocolId == "IEC61131_BOOL") { /* BOOL */
    ...
    } else         if(dataProtocolId == "IEC61131_BYTE") { /* List */
    ...
    } else         if(dataProtocolId == "IEC61131_WORD") { /* List */
    ...
    } else         if(dataProtocolId == "IEC61131_DWORD") { /* List */
    ...
    } else         if(dataProtocolId == "IEC61131_LWORD") { /* List */
    ...
    } else         if(dataProtocolId == "IEC61131_SINT") { /* SINT */
    ...
    } else         if(dataProtocolId == "IEC61131_USINT") { /* USINT */
    ...
    } else         if(dataProtocolId == "IEC61131_INT") { /* INT */
    ...
    } else         if(dataProtocolId == "IEC61131_UINT") { /* UINT */
    ...
    } else         if(dataProtocolId == "IEC61131_DINT") { /* DINT */
    ...
    } else         if(dataProtocolId == "IEC61131_UDINT") { /* UDINT */
    ...
    } else         if(dataProtocolId == "IEC61131_LINT") { /* LINT */
    ...
    } else         if(dataProtocolId == "IEC61131_ULINT") { /* ULINT */
    ...
    } else         if(dataProtocolId == "IEC61131_REAL") { /* REAL */
    ...
    } else         if(dataProtocolId == "IEC61131_LREAL") { /* LREAL */
    ...
    } else         if(dataProtocolId == "IEC61131_CHAR") { /* CHAR */
    ...
    } else         if(dataProtocolId == "IEC61131_WCHAR") { /* CHAR */
    ...
    } else         if(dataProtocolId == "IEC61131_STRING") { /* STRING */
    ...
    } else         if(dataProtocolId == "IEC61131_WSTRING") { /* STRING */
    ...
    } else         if(dataProtocolId == "IEC61131_TIME") { /* TIME */
    ...
    } else         if(dataProtocolId == "IEC61131_LTIME") { /* LTIME */
    ...
    } else         if(dataProtocolId == "IEC61131_DATE") { /* DATE */
    ...
    } else         if(dataProtocolId == "IEC61131_TIME_OF_DAY") { /* TIME_OF_DAY */
    ...
    } else         if(dataProtocolId == "IEC61131_DATE_AND_TIME") { /* DATE_AND_TIME */
