...
#ifndef PLC4C_S7_READ_WRITE_ALARM_MESSAGE_ACK_RESPONSE_TYPE_H_
#define PLC4C_S7_READ_WRITE_ALARM_MESSAGE_ACK_RESPONSE_TYPE_H_
...
struct plc4c_s7_read_write_alarm_message_ack_response_type {
  /* Properties */
  uint8_t function_id;
  uint8_t number_of_objects;
  plc4c_list* message_objects;
};
typedef struct plc4c_s7_read_write_alarm_message_ack_response_type plc4c_s7_read_write_alarm_message_ack_response_type;
