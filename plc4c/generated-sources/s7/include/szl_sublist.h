...
enum plc4c_s7_read_write_szl_sublist {
  ...
  plc4c_s7_read_write_szl_sublist_PRIORITY_CLASSES = 0x16,
  plc4c_s7_read_write_szl_sublist_EXTENDED_PRIORITY_CLASSES = 0x17,
  plc4c_s7_read_write_szl_sublist_OPERATING_SYSTEM = 0x18,
  plc4c_s7_read_write_szl_sublist_STATUS_MODULE_LEDS = 0x19,
  plc4c_s7_read_write_szl_sublist_COMPONENT_IDENTIFICATION = 0x1C,
  plc4c_s7_read_write_szl_sublist_INTERRUPT_INFO = 0x21,
  plc4c_s7_read_write_szl_sublist_INTERRUPT_STATUS = 0x22,
  plc4c_s7_read_write_szl_sublist_OPERATION_HISTORY = 0x23,
  plc4c_s7_read_write_szl_sublist_OPERATING_MODES = 0x24,
  plc4c_s7_read_write_szl_sublist_ASSIGNMENT_BETWEEN_PROCESS_IMAGE_PARTITIONS_AND_OBS = 0x25,
  plc4c_s7_read_write_szl_sublist_COMMUNICATION_MODE_DATA = 0x31,
  plc4c_s7_read_write_szl_sublist_COMMUNICATION_STATUS_DATA = 0x32,
  plc4c_s7_read_write_szl_sublist_DIAGNOSTIC_DATA_ON_COMM_OBJECTS = 0x33,
  plc4c_s7_read_write_szl_sublist_STATUS_H_SYSTEM = 0x70,
