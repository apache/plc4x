...
// Parse function.
plc4c_return_code plc4c_modbus_read_write_data_item_parse(plc4x_spi_context ctx, plc4c_spi_read_buffer* readBuffer, plc4c_modbus_read_write_modbus_data_type dataType, uint16_t numberOfValues, bool bigEndian, uint16_t stringLength, plc4c_data** data_item) {
    uint16_t startPos = plc4c_spi_read_get_pos(readBuffer);
    uint16_t curPos;
    plc4c_return_code _res = OK;

        if((dataType == plc4c_modbus_read_write_modbus_data_type_BOOL) && (numberOfValues == 1) && (bigEndian == true)) { /* BOOL */
    ...
    } else         if((dataType == plc4c_modbus_read_write_modbus_data_type_BOOL) && (numberOfValues == 1) && (bigEndian == false)) { /* BOOL */
    ...
    } else         if((dataType == plc4c_modbus_read_write_modbus_data_type_BYTE) && (numberOfValues == 1) && (bigEndian == true)) { /* BYTE */
    ...
    } else         if((dataType == plc4c_modbus_read_write_modbus_data_type_BYTE) && (numberOfValues == 1) && (bigEndian == false)) { /* BYTE */
    ...
    } else         if((dataType == plc4c_modbus_read_write_modbus_data_type_SINT) && (numberOfValues == 1) && (bigEndian == true)) { /* SINT */
    ...
    } else         if((dataType == plc4c_modbus_read_write_modbus_data_type_SINT) && (numberOfValues == 1) && (bigEndian == false)) { /* SINT */
    ...
    } else         if((dataType == plc4c_modbus_read_write_modbus_data_type_USINT) && (numberOfValues == 1) && (bigEndian == true)) { /* USINT */
    ...
    } else         if((dataType == plc4c_modbus_read_write_modbus_data_type_USINT) && (numberOfValues == 1) && (bigEndian == false)) { /* USINT */
        ...
        *data_item = plc4c_data_create_list_data(value);
        ...
        for(int curItem = 0; curItem < itemCount; curItem++) {
            ...
            _res = plc4c_spi_read_string(readBuffer, 8, "UTF8", (char**) _val);
            if(_res != OK) {
                return _res;
            }
        ...
        *data_item = plc4c_data_create_list_data(value);
        ...
        for(int curItem = 0; curItem < itemCount; curItem++) {
                /*
            char** _val = malloc(sizeof(char*) * 1);
            _res = plc4c_spi_read_string(readBuffer, 16, "UTF8", (char**) _val);
            if(_res != OK) {
                return _res;
            }
            plc4c_data* _item = plc4c_data_create_char_data(*_val);
        ...
        *data_item = plc4c_data_create_list_data(value);
    ...
    } else         if((dataType == plc4c_modbus_read_write_modbus_data_type_STRING) && (numberOfValues == 1)) { /* STRING */
    ...
    } else         if(dataType == plc4c_modbus_read_write_modbus_data_type_STRING) { /* List */
        ...
        for(int curItem = 0; curItem < itemCount; curItem++) {
                /*
            char** _val = malloc(sizeof(char*) * 1);
            _res = plc4c_spi_read_string(readBuffer, (stringLength) * (8), "UTF8", (char**) _val);
            if(_res != OK) {
                return _res;
            }
            plc4c_data* _item = plc4c_data_create_char_data(*_val);
        ...
        *data_item = plc4c_data_create_list_data(value);
    ...
    } else         if((dataType == plc4c_modbus_read_write_modbus_data_type_WSTRING) && (numberOfValues == 1)) { /* WSTRING */
    ...
    } else         if(dataType == plc4c_modbus_read_write_modbus_data_type_WSTRING) { /* List */
        ...
        for(int curItem = 0; curItem < itemCount; curItem++) {
                /*
            char** _val = malloc(sizeof(char*) * 1);
            _res = plc4c_spi_read_string(readBuffer, (stringLength) * (16), "UTF8", (char**) _val);
            if(_res != OK) {
                return _res;
            }
            plc4c_data* _item = plc4c_data_create_char_data(*_val);
...
plc4c_return_code plc4c_modbus_read_write_data_item_serialize(plc4x_spi_context ctx, plc4c_spi_write_buffer* writeBuffer, plc4c_modbus_read_write_modbus_data_type dataType, uint16_t numberOfValues, bool bigEndian, uint16_t stringLength, plc4c_data** data_item) {
  plc4c_return_code _res = OK;
        if((dataType == plc4c_modbus_read_write_modbus_data_type_BOOL) && (numberOfValues == 1) && (bigEndian == true)) { /* BOOL */
...
uint16_t plc4c_modbus_read_write_data_item_length_in_bytes(plc4x_spi_context ctx, plc4c_data* data_item, plc4c_modbus_read_write_modbus_data_type data_type, uint16_t number_of_values, bool big_endian, uint16_t string_length) {
  return plc4c_modbus_read_write_data_item_length_in_bits(ctx, data_item, data_type, number_of_values, big_endian, string_length) / 8;
}

uint16_t plc4c_modbus_read_write_data_item_length_in_bits(plc4x_spi_context ctx, plc4c_data* data_item, plc4c_modbus_read_write_modbus_data_type dataType, uint16_t numberOfValues, bool bigEndian, uint16_t stringLength) {
