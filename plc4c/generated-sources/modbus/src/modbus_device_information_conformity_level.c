...
static const plc4c_modbus_read_write_modbus_device_information_conformity_level plc4c_modbus_read_write_modbus_device_information_conformity_level_null_const;
...
plc4c_modbus_read_write_modbus_device_information_conformity_level plc4c_modbus_read_write_modbus_device_information_conformity_level_null() {
  return plc4c_modbus_read_write_modbus_device_information_conformity_level_null_const;
}
...
plc4c_return_code plc4c_modbus_read_write_modbus_device_information_conformity_level_parse(plc4c_spi_read_buffer* readBuffer, plc4c_modbus_read_write_modbus_device_information_conformity_level** _message) {
    ...
    (*_message) = malloc(sizeof(plc4c_modbus_read_write_modbus_device_information_conformity_level));
    if(*_message == NULL) {
        return NO_MEMORY;
    }
...
plc4c_modbus_read_write_modbus_device_information_conformity_level plc4c_modbus_read_write_modbus_device_information_conformity_level_value_of(char* value_string) {
    ...
    if(strcmp(value_string, "REGULAR_STREAM_ONLY") == 0) {
        return plc4c_modbus_read_write_modbus_device_information_conformity_level_REGULAR_STREAM_ONLY;
    }
    if(strcmp(value_string, "EXTENDED_STREAM_ONLY") == 0) {
        return plc4c_modbus_read_write_modbus_device_information_conformity_level_EXTENDED_STREAM_ONLY;
    }
    return -1;
}
