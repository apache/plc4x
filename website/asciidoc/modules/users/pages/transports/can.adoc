...
<dependency>
  ...
  <artifactId>plc4j-transports-can</artifactId>
...
Please have a look on xref:protocols/can.adoc[CAN] describe usage of CAN driver adapter with CAN transport facade.

== Compatible CAN transports

- xref:transports/socketcan.adoc[SocketCAN] - a real CAN bus through the Linux kernel
- xref:transports/can-virtualcan.adoc[Virtual CAN] - an in-memory bus for tests and development
