...
a|image::users/companies/logo-toddysoft.png[toddysoft, 200, 159] |https://toddysoft.com/[ToddySoft GmbH,opts=nofollow]|consulting, workshops, individual software development, protocol/driver development |Christofer Dutz |christofer.dutz@toddysoft.com |  |PMC Member
...
Please create a Pull-Request on GitHub as described xref:developers:contributing.adoc[here]. The resource requiring editing can be found https://github.com/apache/plc4x/blob/develop/website/asciidoc/modules/users/pages/commercial-support.adoc[here]
