...
[#release-0_13_1]
=== 0.13.1 Official https://www.apache.org/dyn/closer.lua/plc4x/0.13.1/apache-plc4x-0.13.1-source-release.zip[source release] [ https://downloads.apache.org/plc4x/0.13.1/apache-plc4x-0.13.1-source-release.zip.sha512[SHA512] ] [ https://downloads.apache.org/plc4x/0.13.1/apache-plc4x-0.13.1-source-release.zip.asc[ASC] ]

==== New Features

- Extended the PlcRawByteArray to provide access to a List of USINT objects.
...
- The block optimizer used in s7-light causes errors, if a tag references the same byte multiple times.
- When using the new block-optimizer in the s7-light driver, when reading multiple BOOL values located in the same byte produces errors
