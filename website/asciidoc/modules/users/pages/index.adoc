...
- link:tools/event-pump.html[Event-Pump] (Util for automating fetching PLC data using a variety of triggers)
- link:tools/opm.html[Object PLC Mapping (OPM)] (Object PLC Mapping - Like JPA for PLC data)
- link:tools/plc4x-server.adoc[PLC4X-Server] (A small relay server that speaks the **PLC4X proxy protocol**.)
