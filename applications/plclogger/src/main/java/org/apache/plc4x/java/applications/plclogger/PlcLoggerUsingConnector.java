...
public class PlcLoggerUsingConnector {
    ...
    private PlcLoggerUsingConnector(PlcConnectionAdapter plcAdapter, String addressString, int interval) throws Exception {
    ...
    public static void main(String[] args) {
        ...
        try (PlcConnectionAdapter plcAdapter = new PlcConnectionAdapter(connectionString)) {
            ...
            PlcLoggerUsingConnector logger = new PlcLoggerUsingConnector(plcAdapter, addressString, interval);
