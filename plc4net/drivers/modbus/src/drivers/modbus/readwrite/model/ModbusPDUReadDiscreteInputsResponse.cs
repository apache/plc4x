...
{
    public partial class ModbusPDUReadDiscreteInputsResponse : ModbusPDU
    {
        public override bool ErrorFlag => false;
        public override byte FunctionFlag => (byte) (0x02);
        public override bool Response => true;

        public byte[] Value { get; }

        public ModbusPDUReadDiscreteInputsResponse(byte[] value)
        {
            Value = value;
        }

        public static new ModbusPDUReadDiscreteInputsResponse StaticParse(ReadBuffer readBuffer, bool response)
        {
            var byteCount = readBuffer.ReadByte("byteCount", 8);
            var value = readBuffer.ReadByteArray("value", (int) (byteCount) * 8);
            return new ModbusPDUReadDiscreteInputsResponse(value);
        }
