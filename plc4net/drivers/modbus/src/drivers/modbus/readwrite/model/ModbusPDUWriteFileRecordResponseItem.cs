...
{
    public partial class ModbusPDUWriteFileRecordResponseItem : IMessage
    {
        ...
        public ModbusPDUWriteFileRecordResponseItem(byte referenceType, ushort fileNumber, ushort recordNumber, byte[] recordData)
        {
        ...
        public static ModbusPDUWriteFileRecordResponseItem StaticParse(ReadBuffer readBuffer)
        {
            ...
            var recordData = readBuffer.ReadByteArray("recordData", (int) (recordLength) * 8);
