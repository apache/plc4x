...
{
    public partial class ModbusPDUWriteSingleCoilRequest : ModbusPDU
    {
        ...
        public ModbusPDUWriteSingleCoilRequest(ushort address, ushort value)
        {
            Address = address;
            Value = value;
        }

        public static new ModbusPDUWriteSingleCoilRequest StaticParse(ReadBuffer readBuffer, bool response)
        {
