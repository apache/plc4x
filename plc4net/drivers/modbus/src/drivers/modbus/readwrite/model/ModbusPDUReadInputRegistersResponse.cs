...
{
    public partial class ModbusPDUReadInputRegistersResponse : ModbusPDU
    {
        ...
        public static new ModbusPDUReadInputRegistersResponse StaticParse(ReadBuffer readBuffer, bool response)
        {
