...
{
    public partial class ModbusPDUReadCoilsRequest : ModbusPDU
    {
        ...
        public ModbusPDUReadCoilsRequest(ushort startingAddress, ushort quantity)
        {
            StartingAddress = startingAddress;
            Quantity = quantity;
        }

        public static new ModbusPDUReadCoilsRequest StaticParse(ReadBuffer readBuffer, bool response)
        {
