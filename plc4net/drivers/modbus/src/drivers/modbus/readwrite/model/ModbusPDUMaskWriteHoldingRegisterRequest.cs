...
{
    public partial class ModbusPDUMaskWriteHoldingRegisterRequest : ModbusPDU
    {
        ...
        public ModbusPDUMaskWriteHoldingRegisterRequest(ushort referenceAddress, ushort andMask, ushort orMask)
        {
        ...
        public static new ModbusPDUMaskWriteHoldingRegisterRequest StaticParse(ReadBuffer readBuffer, bool response)
        {
            ...
            return new ModbusPDUMaskWriteHoldingRegisterRequest(referenceAddress, andMask, orMask);
        }
