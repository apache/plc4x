...
{
    public partial class ModbusPDUReadWriteMultipleHoldingRegistersResponse : ModbusPDU
    {
        ...
        public ModbusPDUReadWriteMultipleHoldingRegistersResponse(byte[] value)
        {
            Value = value;
        }

        public static new ModbusPDUReadWriteMultipleHoldingRegistersResponse StaticParse(ReadBuffer readBuffer, bool response)
        {
            var byteCount = readBuffer.ReadByte("byteCount", 8);
            var value = readBuffer.ReadByteArray("value", (int) (byteCount) * 8);
            return new ModbusPDUReadWriteMultipleHoldingRegistersResponse(value);
        }
