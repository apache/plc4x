...
{
    public partial class ModbusPDUReadHoldingRegistersRequest : ModbusPDU
    {
        ...
        public ModbusPDUReadHoldingRegistersRequest(ushort startingAddress, ushort quantity)
        {
            StartingAddress = startingAddress;
            Quantity = quantity;
        }

        public static new ModbusPDUReadHoldingRegistersRequest StaticParse(ReadBuffer readBuffer, bool response)
        {
