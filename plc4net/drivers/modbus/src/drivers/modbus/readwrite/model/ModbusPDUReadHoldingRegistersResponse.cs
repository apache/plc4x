...
{
    public partial class ModbusPDUReadHoldingRegistersResponse : ModbusPDU
    {
        public override bool ErrorFlag => false;
        public override byte FunctionFlag => (byte) (0x03);
        public override bool Response => true;

        public byte[] Value { get; }

        public ModbusPDUReadHoldingRegistersResponse(byte[] value)
        {
            Value = value;
        }

        public static new ModbusPDUReadHoldingRegistersResponse StaticParse(ReadBuffer readBuffer, bool response)
        {
            var byteCount = readBuffer.ReadByte("byteCount", 8);
            var value = readBuffer.ReadByteArray("value", (int) (byteCount) * 8);
            return new ModbusPDUReadHoldingRegistersResponse(value);
        }
