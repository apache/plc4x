...
namespace org.apache.plc4net.drivers.modbus.readwrite.model
{
    ...
    /// modbus.mspec. The generated bodies throw; supply the real
    ...
    public static partial class ModbusStaticHelper
    {
        ...
        public static byte AsciiLrcCheck(params object[] args)
            => throw new NotImplementedException("modbus.mspec STATIC_CALL 'AsciiLrcCheck' has no implementation yet");

        public static ushort RtuCrcCheck(params object[] args)
            => throw new NotImplementedException("modbus.mspec STATIC_CALL 'RtuCrcCheck' has no implementation yet");
    }
}
