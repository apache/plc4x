...
{
    public partial class ModbusPDUWriteMultipleCoilsRequest : ModbusPDU
    {
        public override bool ErrorFlag => false;
        public override byte FunctionFlag => (byte) (0x0F);
        ...
        public ModbusPDUWriteMultipleCoilsRequest(ushort startingAddress, ushort quantity, byte[] value)
        {
        ...
        public static new ModbusPDUWriteMultipleCoilsRequest StaticParse(ReadBuffer readBuffer, bool response)
        {
