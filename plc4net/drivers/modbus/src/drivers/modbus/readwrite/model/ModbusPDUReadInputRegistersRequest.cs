...
{
    public partial class ModbusPDUReadInputRegistersRequest : ModbusPDU
    {
        public override bool ErrorFlag => false;
        public override byte FunctionFlag => (byte) (0x04);
        public override bool Response => false;

        public ushort StartingAddress { get; }
        public ushort Quantity { get; }

        public ModbusPDUReadInputRegistersRequest(ushort startingAddress, ushort quantity)
        {
            StartingAddress = startingAddress;
            Quantity = quantity;
        }

        public static new ModbusPDUReadInputRegistersRequest StaticParse(ReadBuffer readBuffer, bool response)
        {
