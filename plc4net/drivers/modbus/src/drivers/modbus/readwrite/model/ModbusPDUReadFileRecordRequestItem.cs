...
{
    public partial class ModbusPDUReadFileRecordRequestItem : IMessage
    {
        ...
        public ModbusPDUReadFileRecordRequestItem(byte referenceType, ushort fileNumber, ushort recordNumber, ushort recordLength)
        {
        ...
        public void Serialize(WriteBuffer writeBuffer)
        {
            ...
            writeBuffer.WriteUshort("recordLength", 16, RecordLength);
        }
