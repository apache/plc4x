...
{
    public partial class ModbusPDUReadDiscreteInputsRequest : ModbusPDU
    {
        ...
        public ModbusPDUReadDiscreteInputsRequest(ushort startingAddress, ushort quantity)
        {
            StartingAddress = startingAddress;
            Quantity = quantity;
        }

        public static new ModbusPDUReadDiscreteInputsRequest StaticParse(ReadBuffer readBuffer, bool response)
        {
