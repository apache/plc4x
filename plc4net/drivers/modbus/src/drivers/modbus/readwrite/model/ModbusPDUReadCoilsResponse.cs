...
{
    public partial class ModbusPDUReadCoilsResponse : ModbusPDU
    {
        public override bool ErrorFlag => false;
        public override byte FunctionFlag => (byte) (0x01);
        ...
        public static new ModbusPDUReadCoilsResponse StaticParse(ReadBuffer readBuffer, bool response)
        {
            var byteCount = readBuffer.ReadByte("byteCount", 8);
            var value = readBuffer.ReadByteArray("value", (int) (byteCount) * 8);
            return new ModbusPDUReadCoilsResponse(value);
        }
