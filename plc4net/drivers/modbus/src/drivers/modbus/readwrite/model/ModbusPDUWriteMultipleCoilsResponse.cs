...
{
    public partial class ModbusPDUWriteMultipleCoilsResponse : ModbusPDU
    {
        ...
        public ModbusPDUWriteMultipleCoilsResponse(ushort startingAddress, ushort quantity)
        {
            StartingAddress = startingAddress;
            Quantity = quantity;
        }

        public static new ModbusPDUWriteMultipleCoilsResponse StaticParse(ReadBuffer readBuffer, bool response)
        {
