...
{
    public partial class ApduDataExtPropertyValueRead : ApduDataExt
    {
        public override byte ExtApciType => (byte) (0x15);
        ...
        public static new ApduDataExtPropertyValueRead StaticParse(ReadBuffer readBuffer, byte length)
        {
