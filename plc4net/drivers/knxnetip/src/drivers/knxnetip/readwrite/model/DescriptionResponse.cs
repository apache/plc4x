...
{
    public partial class DescriptionResponse : KnxNetIpMessage
    {
        public override ushort MsgType => (ushort) (0x0204);
        ...
        public static new DescriptionResponse StaticParse(ReadBuffer readBuffer)
        {
