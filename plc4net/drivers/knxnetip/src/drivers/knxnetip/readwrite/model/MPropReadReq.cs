...
{
    public partial class MPropReadReq : CEMI
    {
        public override byte MessageCode => (byte) (0xFC);
        ...
        public MPropReadReq(ushort interfaceObjectType, byte objectInstance, byte propertyId, byte numberOfElements, ushort startIndex)
        {
        ...
        public static new MPropReadReq StaticParse(ReadBuffer readBuffer, ushort size)
        {
