...
{
    public partial class LDataCon : CEMI
    {
        public override byte MessageCode => (byte) (0x2E);
        ...
        public LDataCon(byte additionalInformationLength, System.Collections.Generic.List<CEMIAdditionalInformation> additionalInformation, LDataFrame dataFrame)
        {
        ...
        public static new LDataCon StaticParse(ReadBuffer readBuffer, ushort size)
        {
