...
{
    public partial class ApduDataGroupValueResponse : ApduData
    {
        public override byte ApciType => (byte) (0x1);
        ...
        public static new ApduDataGroupValueResponse StaticParse(ReadBuffer readBuffer, byte dataLength)
        {
