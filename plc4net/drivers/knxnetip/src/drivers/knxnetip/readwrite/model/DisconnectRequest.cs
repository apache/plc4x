...
{
    public partial class DisconnectRequest : KnxNetIpMessage
    {
        public override ushort MsgType => (ushort) (0x0209);
        ...
        public static new DisconnectRequest StaticParse(ReadBuffer readBuffer)
        {
