...
{
    public partial class LBusmonInd : CEMI
    {
        public override byte MessageCode => (byte) (0x2B);
        ...
        public LBusmonInd(byte additionalInformationLength, System.Collections.Generic.List<CEMIAdditionalInformation> additionalInformation, LDataFrame dataFrame, byte? crc)
        {
        ...
        public static new LBusmonInd StaticParse(ReadBuffer readBuffer, ushort size)
        {
            ...
            {
                crc = readBuffer.ReadByte("crc", 8);
            }
            return new LBusmonInd(additionalInformationLength, additionalInformation, dataFrame, crc);
        }
        ...
        protected override void SerializeChild(WriteBuffer writeBuffer)
        {
            ...
            if (Crc != null)
            {
                writeBuffer.WriteByte("crc", 8, Crc.Value);
            }
        }
