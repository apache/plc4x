...
{
    public partial class LDataInd : CEMI
    {
        public override byte MessageCode => (byte) (0x29);
        ...
        public LDataInd(byte additionalInformationLength, System.Collections.Generic.List<CEMIAdditionalInformation> additionalInformation, LDataFrame dataFrame)
        {
        ...
        public static new LDataInd StaticParse(ReadBuffer readBuffer, ushort size)
        {
