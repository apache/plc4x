...
{
    public partial class ApduDataExtPropertyDescriptionRead : ApduDataExt
    {
        public override byte ExtApciType => (byte) (0x18);
        ...
        public static new ApduDataExtPropertyDescriptionRead StaticParse(ReadBuffer readBuffer, byte length)
        {
