...
{
    public partial class ConnectionStateRequest : KnxNetIpMessage
    {
        public override ushort MsgType => (ushort) (0x0207);
        ...
        public static new ConnectionStateRequest StaticParse(ReadBuffer readBuffer)
        {
