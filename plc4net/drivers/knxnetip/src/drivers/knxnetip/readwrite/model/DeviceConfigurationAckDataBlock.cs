...
{
    public partial class DeviceConfigurationAckDataBlock : IMessage
    {
        ...
        public static DeviceConfigurationAckDataBlock StaticParse(ReadBuffer readBuffer)
        {
            ...
            var sequenceCounter = readBuffer.ReadByte("sequenceCounter", 8);
        ...
        public void Serialize(WriteBuffer writeBuffer)
        {
            ...
            writeBuffer.WriteByte("sequenceCounter", 8, SequenceCounter);
