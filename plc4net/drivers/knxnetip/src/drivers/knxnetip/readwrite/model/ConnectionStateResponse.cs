...
{
    public partial class ConnectionStateResponse : KnxNetIpMessage
    {
        public override ushort MsgType => (ushort) (0x0208);
        ...
        public static new ConnectionStateResponse StaticParse(ReadBuffer readBuffer)
        {
