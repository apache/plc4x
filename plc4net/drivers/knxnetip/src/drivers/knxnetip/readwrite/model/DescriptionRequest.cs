...
{
    public partial class DescriptionRequest : KnxNetIpMessage
    {
        public override ushort MsgType => (ushort) (0x0203);
        ...
        public static new DescriptionRequest StaticParse(ReadBuffer readBuffer)
        {
            var hpaiControlEndpoint = HPAIControlEndpoint.StaticParse(readBuffer);
            return new DescriptionRequest(hpaiControlEndpoint);
        }
