...
{
    public partial class ApduDataExtPropertyValueResponse : ApduDataExt
    {
        public override byte ExtApciType => (byte) (0x16);
        ...
        public static new ApduDataExtPropertyValueResponse StaticParse(ReadBuffer readBuffer, byte length)
        {
            ...
            return new ApduDataExtPropertyValueResponse(objectIndex, propertyId, count, index, data);
        }
