...
{
    public partial class GroupObjectDescriptorRealisationType7 : IMessage
    {
        ...
        public GroupObjectDescriptorRealisationType7(ushort dataAddress, bool updateEnable, bool transmitEnable, bool segmentSelectorEnable, bool writeEnable, bool readEnable, bool communicationEnable, CEMIPriority priority, ComObjectValueType valueType)
        {
        ...
        {
            var dataAddress = readBuffer.ReadUshort("dataAddress", 16);
            ...
            return new GroupObjectDescriptorRealisationType7(dataAddress, updateEnable, transmitEnable, segmentSelectorEnable, writeEnable, readEnable, communicationEnable, priority, valueType);
        }

        public void Serialize(WriteBuffer writeBuffer)
        {
            writeBuffer.WriteUshort("dataAddress", 16, DataAddress);
