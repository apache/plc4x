...
{
    public partial class GroupObjectDescriptorRealisationType1 : IMessage
    {
        ...
        public GroupObjectDescriptorRealisationType1(byte dataPointer, bool transmitEnable, bool segmentSelectorEnable, bool writeEnable, bool readEnable, bool communicationEnable, CEMIPriority priority, ComObjectValueType valueType)
        {
        ...
        {
            var dataPointer = readBuffer.ReadByte("dataPointer", 8);
            {
                var reserved = readBuffer.ReadByte("reserved", 1);
                if (!Equals(reserved, (byte) (0x1))) { /* mspec reserved: value differs from the spec default */ }
            }
            ...
            return new GroupObjectDescriptorRealisationType1(dataPointer, transmitEnable, segmentSelectorEnable, writeEnable, readEnable, communicationEnable, priority, valueType);
        }

        public void Serialize(WriteBuffer writeBuffer)
        {
            writeBuffer.WriteByte("dataPointer", 8, DataPointer);
            writeBuffer.WriteByte("reserved", 1, (byte) (0x1));
