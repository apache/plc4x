...
{
    public partial class COTPPacketConnectionRequest : COTPPacket
    {
        public override byte TpduCode => (byte) (0xE0);

        public ushort DestinationReference { get; }
        public ushort SourceReference { get; }
        public COTPProtocolClass ProtocolClass { get; }

        public COTPPacketConnectionRequest(ushort destinationReference, ushort sourceReference, COTPProtocolClass protocolClass, System.Collections.Generic.List<COTPParameter> parameters, S7Message? payload) : base(parameters, payload)
        {
        ...
        public static COTPPacketConnectionRequest StaticParse(ReadBuffer readBuffer, ushort cotpLen, byte headerLength, int _startPos)
        {
            ...
            return new COTPPacketConnectionRequest(destinationReference, sourceReference, protocolClass, parameters, payload);
        }
