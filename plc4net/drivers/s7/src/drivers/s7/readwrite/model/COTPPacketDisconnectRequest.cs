...
{
    public partial class COTPPacketDisconnectRequest : COTPPacket
    {
        public override byte TpduCode => (byte) (0x80);

        public ushort DestinationReference { get; }
        public ushort SourceReference { get; }
        public COTPProtocolClass ProtocolClass { get; }

        public COTPPacketDisconnectRequest(ushort destinationReference, ushort sourceReference, COTPProtocolClass protocolClass, System.Collections.Generic.List<COTPParameter> parameters, S7Message? payload) : base(parameters, payload)
        {
        ...
        public static COTPPacketDisconnectRequest StaticParse(ReadBuffer readBuffer, ushort cotpLen, byte headerLength, int _startPos)
        {
            ...
            return new COTPPacketDisconnectRequest(destinationReference, sourceReference, protocolClass, parameters, payload);
        }
