...
{
    public partial class AlarmMessageAckResponseType : IMessage
    {
        public byte FunctionId { get; }
        public byte NumberOfObjects { get; }
        public System.Collections.Generic.List<byte> MessageObjects { get; }

        public AlarmMessageAckResponseType(byte functionId, byte numberOfObjects, System.Collections.Generic.List<byte> messageObjects)
        {
