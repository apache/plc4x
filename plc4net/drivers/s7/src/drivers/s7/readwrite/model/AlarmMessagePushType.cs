...
{
    public partial class AlarmMessagePushType : IMessage
    {
        public DateAndTime TimeStamp { get; }
        public byte FunctionId { get; }
        public byte NumberOfObjects { get; }
        public System.Collections.Generic.List<AlarmMessageObjectPushType> MessageObjects { get; }

        public AlarmMessagePushType(DateAndTime timeStamp, byte functionId, byte numberOfObjects, System.Collections.Generic.List<AlarmMessageObjectPushType> messageObjects)
        {
            TimeStamp = timeStamp;
        ...
        public static AlarmMessagePushType StaticParse(ReadBuffer readBuffer)
        {
            ...
            var messageObjects = new System.Collections.Generic.List<AlarmMessageObjectPushType>();
            ...
            {
                messageObjects.Add(AlarmMessageObjectPushType.StaticParse(readBuffer));
            }
