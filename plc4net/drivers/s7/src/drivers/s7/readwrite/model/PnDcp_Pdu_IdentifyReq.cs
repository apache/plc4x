...
{
    public partial class PnDcp_Pdu_IdentifyReq : PnDcp_Pdu
    {
        public const byte ServiceId = 0x05;
        public const bool NotSupported = false;
        public const bool Response = false;

        public uint Xid { get; }
        public ushort ResponseDelay { get; }
        public System.Collections.Generic.List<PnDcp_Block> Blocks { get; }

        public PnDcp_Pdu_IdentifyReq(ushort frameIdValue, uint xid, ushort responseDelay, System.Collections.Generic.List<PnDcp_Block> blocks) : base(frameIdValue)
        {
            Xid = xid;
        ...
        public static PnDcp_Pdu_IdentifyReq StaticParse(ReadBuffer readBuffer, ushort frameIdValue)
        {
            ...
            if (!Equals(notSupported, false))
                throw new ParseException($"Expected constant {NotSupported} for 'notSupported' but got {notSupported}");
            {
            ...
            var responseDelay = readBuffer.ReadUshort("responseDelay", 16);
        ...
        protected override void SerializeChild(WriteBuffer writeBuffer)
        {
            ...
            writeBuffer.WriteUshort("responseDelay", 16, ResponseDelay);
