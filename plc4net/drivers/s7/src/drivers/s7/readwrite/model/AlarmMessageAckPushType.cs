...
{
    public partial class AlarmMessageAckPushType : IMessage
    {
        public DateAndTime TimeStamp { get; }
        public byte FunctionId { get; }
        public byte NumberOfObjects { get; }
        public System.Collections.Generic.List<AlarmMessageAckObjectPushType> MessageObjects { get; }

        public AlarmMessageAckPushType(DateAndTime timeStamp, byte functionId, byte numberOfObjects, System.Collections.Generic.List<AlarmMessageAckObjectPushType> messageObjects)
        {
            TimeStamp = timeStamp;
        ...
        public static AlarmMessageAckPushType StaticParse(ReadBuffer readBuffer)
        {
            ...
            var messageObjects = new System.Collections.Generic.List<AlarmMessageAckObjectPushType>();
            ...
            {
                messageObjects.Add(AlarmMessageAckObjectPushType.StaticParse(readBuffer));
            }
