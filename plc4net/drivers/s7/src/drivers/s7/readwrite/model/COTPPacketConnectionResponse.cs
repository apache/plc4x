...
{
    public partial class COTPPacketConnectionResponse : COTPPacket
    {
        public override byte TpduCode => (byte) (0xD0);

        public ushort DestinationReference { get; }
        public ushort SourceReference { get; }
        public COTPProtocolClass ProtocolClass { get; }

        public COTPPacketConnectionResponse(ushort destinationReference, ushort sourceReference, COTPProtocolClass protocolClass, System.Collections.Generic.List<COTPParameter> parameters, S7Message? payload) : base(parameters, payload)
        {
        ...
        public static COTPPacketConnectionResponse StaticParse(ReadBuffer readBuffer, ushort cotpLen, byte headerLength, int _startPos)
        {
            ...
            var protocolClass = (COTPProtocolClass) readBuffer.ReadByte("protocolClass", 8);
            ...
            return new COTPPacketConnectionResponse(destinationReference, sourceReference, protocolClass, parameters, payload);
        }
        ...
        protected override void SerializeChild(WriteBuffer writeBuffer)
        {
            ...
            writeBuffer.WriteByte("protocolClass", 8, (byte) ProtocolClass);
