...
{
    public partial class S7MessageResponse : S7Message
    {
        public override byte MessageType => (byte) (0x02);

        public byte ErrorClass { get; }
        public byte ErrorCode { get; }

        public S7MessageResponse(ushort tpduReference, byte errorClass, byte errorCode, S7Parameter? parameter, S7Payload? payload) : base(tpduReference, parameter, payload)
        {
            ErrorClass = errorClass;
            ErrorCode = errorCode;
        }

        public static S7MessageResponse StaticParse(ReadBuffer readBuffer, byte messageType, ushort tpduReference, ushort parameterLength, ushort payloadLength)
        {
            ...
            return new S7MessageResponse(tpduReference, errorClass, errorCode, parameter, payload);
        }
