...
pub struct ModbusPDUReportServerIdResponseOptions {
    pub response: bool
}
...
impl Message for ModbusPDUReportServerIdResponse {
    type M = ModbusPDUReportServerIdResponse;
    type P = ModbusPDUReportServerIdResponseOptions;
