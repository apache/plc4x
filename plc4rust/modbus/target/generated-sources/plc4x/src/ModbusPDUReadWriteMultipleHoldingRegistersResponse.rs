...
pub struct ModbusPDUReadWriteMultipleHoldingRegistersResponseOptions {
    pub response: bool
}
#[derive(PartialEq, Debug, Clone)]
...
impl Message for ModbusPDUReadWriteMultipleHoldingRegistersResponse {
    type M = ModbusPDUReadWriteMultipleHoldingRegistersResponse;
    type P = ModbusPDUReadWriteMultipleHoldingRegistersResponseOptions;
