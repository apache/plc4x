...
pub struct ModbusPDUWriteFileRecordResponseItemOptions {
}
...
impl Message for ModbusPDUWriteFileRecordResponseItem {
    ...
    type P = ModbusPDUWriteFileRecordResponseItemOptions;
    ...
    fn parse<T: Read>(reader: &mut ReadBuffer<T>, parameter: Option<Self::P>) -> Result<Self::M, Error> {
        ...
        let recordData: Vec<_, 1024>  = Vec::new();
        let recordData_read = 0 as usize;
        // while recordData_read < DefaultVariableLiteral{name='recordLength', typeReference='null', args=null, index=null, child=null} {
            // do something
        // }
        Ok(Self::M {
            referenceType,
