...
pub struct ModbusPDUReadHoldingRegistersResponseOptions {
    pub response: bool
}
#[derive(PartialEq, Debug, Clone)]
...
impl Message for ModbusPDUReadHoldingRegistersResponse {
    type M = ModbusPDUReadHoldingRegistersResponse;
    type P = ModbusPDUReadHoldingRegistersResponseOptions;
