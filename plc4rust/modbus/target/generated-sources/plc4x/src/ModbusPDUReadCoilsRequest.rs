...
pub struct ModbusPDUReadCoilsRequestOptions {
    pub response: bool
}

#[derive(PartialEq, Debug, Clone)]
pub struct ModbusPDUReadCoilsRequest {
    pub startingAddress: u16,
    pub quantity: u16
}

impl ModbusPDUReadCoilsRequest {
}

impl Message for ModbusPDUReadCoilsRequest {
    type M = ModbusPDUReadCoilsRequest;
    type P = ModbusPDUReadCoilsRequestOptions;
