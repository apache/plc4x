...
pub struct ModbusPDUWriteMultipleHoldingRegistersRequestOptions {
    pub response: bool
}
...
impl Message for ModbusPDUWriteMultipleHoldingRegistersRequest {
    type M = ModbusPDUWriteMultipleHoldingRegistersRequest;
    type P = ModbusPDUWriteMultipleHoldingRegistersRequestOptions;
