...
use crate::ModbusPDUWriteFileRecordRequestItem::ModbusPDUWriteFileRecordRequestItem;
use crate::ModbusPDUWriteFileRecordRequestItem::ModbusPDUWriteFileRecordRequestItemOptions;

#[derive(PartialEq, Debug, Clone)]
pub struct ModbusPDUWriteFileRecordRequestOptions {
    pub response: bool
}

#[derive(PartialEq, Debug, Clone)]
pub struct ModbusPDUWriteFileRecordRequest {
    pub items: Vec<ModbusPDUWriteFileRecordRequestItem, 1024>
}
...
impl Message for ModbusPDUWriteFileRecordRequest {
    type M = ModbusPDUWriteFileRecordRequest;
    type P = ModbusPDUWriteFileRecordRequestOptions;
