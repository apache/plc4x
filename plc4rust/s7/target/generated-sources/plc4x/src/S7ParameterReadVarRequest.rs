...
pub struct S7ParameterReadVarRequestOptions {
    pub messageType: u8
}
#[derive(PartialEq, Debug, Clone)]
pub struct S7ParameterReadVarRequest {
...
impl S7ParameterReadVarRequest {
    pub fn numItems(&self) -> u8 {
        0
    }
}

impl Message for S7ParameterReadVarRequest {
    type M = S7ParameterReadVarRequest;
    type P = S7ParameterReadVarRequestOptions;
