...
use crate::AlarmMessageObjectQueryType::AlarmMessageObjectQueryType;
use crate::AlarmMessageObjectQueryType::AlarmMessageObjectQueryTypeOptions;

#[derive(PartialEq, Debug, Clone)]
pub struct AlarmMessageQueryTypeOptions {
}
#[derive(PartialEq, Debug, Clone)]
pub struct AlarmMessageQueryType {
    pub functionId: u8,
    pub numberOfObjects: u8,
    pub returnCode: DataTransportErrorCode,
    pub transportSize: DataTransportSize,
    // Intentionally do nothing
    pub messageObjects: Vec<AlarmMessageObjectQueryType>
}

impl AlarmMessageQueryType {
}

impl Message for AlarmMessageQueryType {
    type M = AlarmMessageQueryType;
    type P = AlarmMessageQueryTypeOptions;
