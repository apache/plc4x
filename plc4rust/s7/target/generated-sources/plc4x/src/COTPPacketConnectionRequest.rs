...
pub struct COTPPacketConnectionRequestOptions {
    pub cotpLen: u16
}
#[derive(PartialEq, Debug, Clone)]
pub struct COTPPacketConnectionRequest {
    pub destinationReference: u16,
    pub sourceReference: u16,
    pub protocolClass: COTPProtocolClass
}

impl COTPPacketConnectionRequest {
}

impl Message for COTPPacketConnectionRequest {
    type M = COTPPacketConnectionRequest;
    type P = COTPPacketConnectionRequestOptions;
