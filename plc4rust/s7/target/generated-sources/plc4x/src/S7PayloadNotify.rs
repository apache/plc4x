...
pub struct S7PayloadNotifyOptions {
    pub cpuFunctionType: u8, 
    pub cpuSubfunction: u8
}
#[derive(PartialEq, Debug, Clone)]
pub struct S7PayloadNotify {
    pub alarmMessage: AlarmMessagePushType
}

impl S7PayloadNotify {
}

impl Message for S7PayloadNotify {
    type M = S7PayloadNotify;
    type P = S7PayloadNotifyOptions;
