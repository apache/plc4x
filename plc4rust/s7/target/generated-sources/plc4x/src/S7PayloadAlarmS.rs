...
pub struct S7PayloadAlarmSOptions {
    pub cpuFunctionType: u8, 
    pub cpuSubfunction: u8
}
#[derive(PartialEq, Debug, Clone)]
pub struct S7PayloadAlarmS {
    pub alarmMessage: AlarmMessagePushType
}

impl S7PayloadAlarmS {
}

impl Message for S7PayloadAlarmS {
    type M = S7PayloadAlarmS;
    type P = S7PayloadAlarmSOptions;
