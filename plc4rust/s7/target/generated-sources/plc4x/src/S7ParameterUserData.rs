...
use crate::S7ParameterUserDataItem::S7ParameterUserDataItem;
use crate::S7ParameterUserDataItem::S7ParameterUserDataItemOptions;

#[derive(PartialEq, Debug, Clone)]
pub struct S7ParameterUserDataOptions {
    pub messageType: u8
}
#[derive(PartialEq, Debug, Clone)]
pub struct S7ParameterUserData {
    ...
    pub items: Vec<S7ParameterUserDataItem>
}

impl S7ParameterUserData {
    pub fn numItems(&self) -> u8 {
        0
    }
}

impl Message for S7ParameterUserData {
    type M = S7ParameterUserData;
    type P = S7ParameterUserDataOptions;
