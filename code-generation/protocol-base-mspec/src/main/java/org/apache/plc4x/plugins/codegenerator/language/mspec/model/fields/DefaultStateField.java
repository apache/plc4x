...
public class DefaultStateField extends DefaultTypedNamedField implements StateField {

    private final Term valueExpression;

    public DefaultStateField(Map<String, Term> attributes, Set<String> currentAttributeNames, String name, Term valueExpression, String comment) {
