...
public class DefaultArrayTypeReference implements ArrayTypeReference {

    final TypeReference elementTypeReference;

    public DefaultArrayTypeReference(TypeReference elementTypeReference) {
        this.elementTypeReference = elementTypeReference;
    }

    @Override
    public TypeReference getElementTypeReference() {
