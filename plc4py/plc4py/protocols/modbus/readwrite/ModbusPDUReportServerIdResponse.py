...
class ModbusPDUReportServerIdResponse(ModbusPDU):
    ...
    function_flag: ClassVar[int] = 0x11
...
@dataclass
class ModbusPDUReportServerIdResponseBuilder:
    value: List[int]

    def build(self,) -> ModbusPDUReportServerIdResponse:
        modbus_pdureport_server_id_response: ModbusPDUReportServerIdResponse = ModbusPDUReportServerIdResponse(self.value )
