...
class ModbusPDUReadFileRecordRequest(ModbusPDU):
    ...
    def static_parse_builder(read_buffer: ReadBuffer, response: bool):
        ...
        items: List[Any] = read_buffer.read_array_field(logical_name="items", read_function=ModbusPDUReadFileRecordRequestItem.static_parse, length=byte_count, response=response)
...
@dataclass
class ModbusPDUReadFileRecordRequestBuilder:
    items: List[ModbusPDUReadFileRecordRequestItem]

    def build(self,) -> ModbusPDUReadFileRecordRequest:
        modbus_pduread_file_record_request: ModbusPDUReadFileRecordRequest = ModbusPDUReadFileRecordRequest(self.items )
