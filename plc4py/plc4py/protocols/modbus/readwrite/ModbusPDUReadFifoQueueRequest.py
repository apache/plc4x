...
class ModbusPDUReadFifoQueueRequest(ModbusPDU):
    ...
    def serialize_modbus_pdu_child(self, write_buffer: WriteBuffer):
        ...
        write_buffer.write_unsigned_short(self.fifo_pointer_address,bit_length=16,logical_name="fifoPointerAddress")
    ...
    def static_parse_builder(read_buffer: ReadBuffer, response: bool):
        ...
        fifo_pointer_address: int = read_buffer.read_unsigned_short(logical_name="fifo_pointer_address", bit_length=16, response=response)  
...
class ModbusPDUReadFifoQueueRequestBuilder:
    ...
    def build(self,) -> ModbusPDUReadFifoQueueRequest:
        modbus_pduread_fifo_queue_request: ModbusPDUReadFifoQueueRequest = ModbusPDUReadFifoQueueRequest(self.fifo_pointer_address )
