...
class ModbusPDUWriteMultipleCoilsRequestBuilder:
    ...
    def build(self,) -> ModbusPDUWriteMultipleCoilsRequest:
        modbus_pduwrite_multiple_coils_request: ModbusPDUWriteMultipleCoilsRequest = ModbusPDUWriteMultipleCoilsRequest(self.starting_address, self.quantity, self.value )
