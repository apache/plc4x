...
class ModbusPDUReadHoldingRegistersResponseBuilder:
    ...
    def build(self,) -> ModbusPDUReadHoldingRegistersResponse:
        modbus_pduread_holding_registers_response: ModbusPDUReadHoldingRegistersResponse = ModbusPDUReadHoldingRegistersResponse(self.value )
        return modbus_pduread_holding_registers_response
