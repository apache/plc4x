...
class ModbusPDUReadFileRecordResponse(ModbusPDU):
    ...
    def static_parse_builder(read_buffer: ReadBuffer, response: bool):
        ...
        items: List[Any] = read_buffer.read_array_field(logical_name="items", read_function=ModbusPDUReadFileRecordResponseItem.static_parse, length=byte_count, response=response)
...
class ModbusPDUReadFileRecordResponseBuilder:
    ...
    def build(self,) -> ModbusPDUReadFileRecordResponse:
        modbus_pduread_file_record_response: ModbusPDUReadFileRecordResponse = ModbusPDUReadFileRecordResponse(self.items )
