...
class ModbusPDUWriteFileRecordRequestItem():
    ...
    def static_parse_context(read_buffer: ReadBuffer):
        ...
        record_length: int = read_buffer.read_unsigned_short(logical_name="record_length")
        ...
        # Create the instance
        _modbus_pduwrite_file_record_request_item: ModbusPDUWriteFileRecordRequestItem = ModbusPDUWriteFileRecordRequestItem(reference_type, file_number, record_number, record_data )
