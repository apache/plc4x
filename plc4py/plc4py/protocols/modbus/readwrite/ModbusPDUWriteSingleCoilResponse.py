...
class ModbusPDUWriteSingleCoilResponse(ModbusPDU):
    ...
    def equals(self, o: object) -> bool:
        ...
        that: ModbusPDUWriteSingleCoilResponse = (
            ModbusPDUWriteSingleCoilResponse(o)
        )
        return (
...
class ModbusPDUWriteSingleCoilResponseBuilder:
    ...
    def build(
        ...
        modbus_pduwrite_single_coil_response: ModbusPDUWriteSingleCoilResponse = ModbusPDUWriteSingleCoilResponse(
