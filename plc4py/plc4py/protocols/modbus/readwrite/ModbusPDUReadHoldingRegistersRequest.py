...
class ModbusPDUReadHoldingRegistersRequestBuilder:
    ...
    def build(self,) -> ModbusPDUReadHoldingRegistersRequest:
        modbus_pduread_holding_registers_request: ModbusPDUReadHoldingRegistersRequest = ModbusPDUReadHoldingRegistersRequest(self.starting_address, self.quantity )
