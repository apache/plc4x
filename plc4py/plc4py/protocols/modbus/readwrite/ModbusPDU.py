...
class ModbusPDU(ABC, PlcMessage):
    ...
    def static_parse_context(read_buffer: ReadBuffer, response: bool):
        ...
        error_flag: bool = read_buffer.read_bit(logical_name="error_flag", bit_length=1, response=response)


        function_flag: int = read_buffer.read_unsigned_byte(logical_name="function_flag", bit_length=7, response=response)
