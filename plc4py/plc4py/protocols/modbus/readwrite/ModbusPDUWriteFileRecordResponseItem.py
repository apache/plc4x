...
class ModbusPDUWriteFileRecordResponseItem():
    ...
    def static_parse_context(read_buffer: ReadBuffer):
        ...
        # Create the instance
        _modbus_pduwrite_file_record_response_item: ModbusPDUWriteFileRecordResponseItem = ModbusPDUWriteFileRecordResponseItem(reference_type, file_number, record_number, record_data )
