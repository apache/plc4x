...
from plc4py.spi.values.PlcValues import PlcRawByteArray
...
class DataItem:
    @staticmethod
    def static_parse(read_buffer: ReadBuffer, data_type: ModbusDataType, number_of_values: int, big_endian: bool):
        if data_type == ModbusDataType.BOOL and number_of_values == int(1) and big_endian == true :  # BOOL

            # Reserved Field (Compartmentalized so the "reserved" variable can't leak)
            reserved: int = read_buffer.read_unsigned_int(15, logical_name="")
            if reserved != int(0x0000):
                logging.warning("Expected constant value " + str(0x0000) + " but got " + str(reserved) + " for reserved field.")

            # Simple Field (value)
            value: bool = read_buffer.read_bit("")

            return PlcBOOL(value)
        if data_type == ModbusDataType.BOOL and number_of_values == int(1) and big_endian == false :  # BOOL

            # Reserved Field (Compartmentalized so the "reserved" variable can't leak)
            reserved: int = read_buffer.read_unsigned_short(7, logical_name="")
            if reserved != int(0x00):
                logging.warning("Expected constant value " + str(0x00) + " but got " + str(reserved) + " for reserved field.")
        ...
        if data_type == ModbusDataType.BYTE and number_of_values == int(1) and big_endian == true :  # BYTE
        ...
        if data_type == ModbusDataType.BYTE and number_of_values == int(1) and big_endian == false :  # BYTE
        ...
        if data_type == ModbusDataType.SINT and number_of_values == int(1) and big_endian == true :  # SINT
        ...
        if data_type == ModbusDataType.SINT and number_of_values == int(1) and big_endian == false :  # SINT
        ...
        if data_type == ModbusDataType.LINT :  # List
            ...
            return PlcList(value)
        if data_type == ModbusDataType.USINT and number_of_values == int(1) and big_endian == true :  # USINT
        ...
        if data_type == ModbusDataType.USINT and number_of_values == int(1) and big_endian == false :  # USINT
        ...
        if data_type == ModbusDataType.ULINT :  # List
            ...
            value: List[PlcValue] = []
            for _ in range(item_count):
                value.append(PlcLINT(int(read_buffer.read_unsigned_long(64, logical_name=""))))
        ...
        if data_type == ModbusDataType.CHAR :  # List
            ...
            value: List[PlcValue] = []
            for _ in range(item_count):
                value.append(PlcSTRING(str(read_buffer.read_str(8, logical_name="", encoding=""))))
        ...
        if data_type == ModbusDataType.WCHAR :  # List
            ...
            value: List[PlcValue] = []
            for _ in range(item_count):
                value.append(PlcSTRING(str(read_buffer.read_str(16, logical_name="", encoding=""))))
    ...
    @staticmethod
    def static_serialize(write_buffer: WriteBuffer, _value: PlcValue, data_type: ModbusDataType, number_of_values: int, big_endian: bool, byte_order: ByteOrder) -> None:
        if  data_type == ModbusDataType.BOOL and number_of_values == int(1) and big_endian == True : # BOOL
            # Reserved Field
        ...
        elif data_type == ModbusDataType.BOOL and number_of_values == int(1) and big_endian == False : # BOOL
            # Reserved Field
        ...
        elif data_type == ModbusDataType.BYTE and number_of_values == int(1) and big_endian == True : # BYTE
            # Reserved Field
            write_buffer.write_byte(int(0x00), 8, "int0x00")
            # Simple Field (value)
        ...
        elif data_type == ModbusDataType.BYTE and number_of_values == int(1) and big_endian == False : # BYTE
            # Simple Field (value)
            value: int = _value.get_int()
            write_buffer.write_byte((value), 8, "value")
        ...
        elif data_type == ModbusDataType.SINT and number_of_values == int(1) and big_endian == True : # SINT
            # Reserved Field
            write_buffer.write_byte(int(0x00), 8, "int0x00")
            # Simple Field (value)
            value: int = _value.get_int()
        ...
        elif data_type == ModbusDataType.SINT and number_of_values == int(1) and big_endian == False : # SINT
            # Simple Field (value)
            value: int = _value.get_int()
            write_buffer.write_signed_byte((value), 8, "value")
        ...
        elif data_type == ModbusDataType.USINT and number_of_values == int(1) and big_endian == True : # USINT
            # Reserved Field
            write_buffer.write_byte(int(0x00), 8, "int0x00")
            # Simple Field (value)
            value: int = _value.get_int()
        ...
        elif data_type == ModbusDataType.USINT and number_of_values == int(1) and big_endian == False : # USINT
            # Simple Field (value)
            value: int = _value.get_int()
            write_buffer.write_byte((value), 8, "value")
    ...
    @staticmethod
    def get_length_in_bytes(_value: PlcValue, data_type: ModbusDataType, number_of_values: int, big_endian: bool) -> int:
        return int(math.ceil(float(DataItem.get_length_in_bits(_value, data_type, number_of_values, big_endian)) / 8.0))


    @staticmethod
    def get_length_in_bits(_value: PlcValue, data_type: ModbusDataType, number_of_values: int, big_endian: bool) -> int:
        size_in_bits: int = 0
        if  data_type == ModbusDataType.BOOL and number_of_values == int(1) and big_endian == True: # BOOL
                # Reserved Field
                size_in_bits += 15
