...
class ModbusPDUWriteMultipleHoldingRegistersRequestBuilder:
    ...
    def build(self,) -> ModbusPDUWriteMultipleHoldingRegistersRequest:
        modbus_pduwrite_multiple_holding_registers_request: ModbusPDUWriteMultipleHoldingRegistersRequest = ModbusPDUWriteMultipleHoldingRegistersRequest(self.starting_address, self.quantity, self.value )
