...
from plc4py.protocols.umas.readwrite.VariableReadRequestReference import VariableReadRequestReference
...
class UmasPDUReadVariableRequest(UmasPDUItem):
    ...
    def static_parse_builder(read_buffer: ReadBuffer, umas_request_function_key: int, byte_length: int):
        ...
        variables: List[Any] = read_buffer.read_array_field(logical_name="variables", read_function=VariableReadRequestReference.static_parse, count=variable_count, byte_order=ByteOrder.LITTLE_ENDIAN, umas_request_function_key=umas_request_function_key, byte_length=byte_length)
...
class UmasPDUReadVariableRequestBuilder:
    ...
    def build(self,byte_length: int , pairing_key ) -> UmasPDUReadVariableRequest:
        umas_pduread_variable_request: UmasPDUReadVariableRequest = UmasPDUReadVariableRequest(byte_length , pairing_key , self.crc, self.variable_count, self.variables )
