...
class UmasPDUReadUmasUDTDefinitionResponse():
    ...
    def serialize(self, write_buffer: WriteBuffer):
        ...
        write_buffer.write_unsigned_int(self.unknown1,bit_length=32,logical_name="unknown1")
    ...
    def static_parse_context(read_buffer: ReadBuffer):
        ...
        unknown1: int = read_buffer.read_unsigned_int(logical_name="unknown1", bit_length=32)  
        ...
        records: List[Any] = read_buffer.read_array_field(logical_name="records", read_function=UmasUDTDefinition.static_parse, count=no_of_records)

        read_buffer.pop_context("UmasPDUReadUmasUDTDefinitionResponse")
        # Create the instance
        _umas_pduread_umas_udtdefinition_response: UmasPDUReadUmasUDTDefinitionResponse = UmasPDUReadUmasUDTDefinitionResponse(range, unknown1, no_of_records, records )
    ...
    def equals(self, o: object) -> bool:
        ...
        that: UmasPDUReadUmasUDTDefinitionResponse = UmasPDUReadUmasUDTDefinitionResponse(o)
        return (self.range == that.range) and (self.unknown1 == that.unknown1) and (self.no_of_records == that.no_of_records) and (self.records == that.records) and True
