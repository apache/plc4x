...
class DataItem:
    @staticmethod
    def static_parse(read_buffer: ReadBuffer, data_type: UmasDataType, number_of_values: int):
        ...
        if data_type == UmasDataType.STRING and number_of_values == int(1) :  # STRING
            # Manual Field (value)
            value: str = (str) (StaticHelper.parse_terminated_string_bytes(read_buffer, number_of_values))
    ...
    @staticmethod
    def static_serialize(write_buffer: WriteBuffer, _value: PlcValue, data_type: UmasDataType, number_of_values: int, byte_order: ByteOrder) -> None:
        if  data_type == UmasDataType.BOOL and number_of_values == int(1) : # BOOL
            # Reserved Field
    ...
    @staticmethod
    def get_length_in_bytes(_value: PlcValue, data_type: UmasDataType, number_of_values: int) -> int:
        return int(math.ceil(float(DataItem.get_length_in_bits(_value, data_type, number_of_values)) / 8.0))


    @staticmethod
    def get_length_in_bits(_value: PlcValue, data_type: UmasDataType, number_of_values: int) -> int:
        size_in_bits: int = 0
        if  data_type == UmasDataType.BOOL and number_of_values == int(1): # BOOL
                # Reserved Field
                size_in_bits += 7
