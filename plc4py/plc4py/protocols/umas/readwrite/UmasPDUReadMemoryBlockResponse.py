...
class UmasPDUReadMemoryBlockResponse(UmasPDUItem):
    ...
    def static_parse_builder(read_buffer: ReadBuffer, umas_request_function_key: int, byte_length: int):
        ...
        block: List[Any] = read_buffer.read_array_field(logical_name="block", read_function=read_buffer.read_unsigned_byte, count=number_of_bytes, byte_order=ByteOrder.LITTLE_ENDIAN, umas_request_function_key=umas_request_function_key, byte_length=byte_length)
    ...
    def equals(self, o: object) -> bool:
        ...
        return (self.range == that.range) and (self.number_of_bytes == that.number_of_bytes) and (self.block == that.block) and super().equals(that) and True
...
class UmasPDUReadMemoryBlockResponseBuilder:
    ...
    def build(self,byte_length: int , pairing_key ) -> UmasPDUReadMemoryBlockResponse:
        umas_pduread_memory_block_response: UmasPDUReadMemoryBlockResponse = UmasPDUReadMemoryBlockResponse(byte_length , pairing_key , self.range, self.number_of_bytes, self.block )
