...
class UmasUnlocatedVariableReference():
    ...
    def serialize(self, write_buffer: WriteBuffer):
        ...
        # Simple Field (block)
        write_buffer.write_unsigned_short(self.block,bit_length=16,logical_name="block")

        # Simple Field (offset)
        write_buffer.write_unsigned_byte(self.offset,bit_length=8,logical_name="offset")

        # Simple Field (unknown5)
        write_buffer.write_unsigned_byte(self.unknown5,bit_length=8,logical_name="unknown5")

        # Simple Field (unknown4)
        write_buffer.write_unsigned_short(self.unknown4,bit_length=16,logical_name="unknown4")

        # Simple Field (stringLength)
        write_buffer.write_unsigned_short(self.string_length,bit_length=16,logical_name="stringLength")
        # Manual Field (value)
    ...
    def static_parse_context(read_buffer: ReadBuffer):
        ...
        block: int = read_buffer.read_unsigned_short(logical_name="block", bit_length=16)  



        offset: int = read_buffer.read_unsigned_byte(logical_name="offset", bit_length=8)  



        unknown5: int = read_buffer.read_unsigned_byte(logical_name="unknown5", bit_length=8)  
        ...
        string_length: int = read_buffer.read_unsigned_short(logical_name="string_length", bit_length=16)  
        ...
        # Create the instance
        _umas_unlocated_variable_reference: UmasUnlocatedVariableReference = UmasUnlocatedVariableReference(data_type, unknown1, block, offset, unknown5, unknown4, string_length, value )
    ...
    def equals(self, o: object) -> bool:
        ...
        return (self.data_type == that.data_type) and (self.unknown1 == that.unknown1) and (self.block == that.block) and (self.offset == that.offset) and (self.unknown5 == that.unknown5) and (self.unknown4 == that.unknown4) and (self.string_length == that.string_length) and (self.value == that.value) and True
