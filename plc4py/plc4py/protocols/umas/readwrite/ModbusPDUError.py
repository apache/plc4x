...
class ModbusPDUError(ModbusPDU):
    ...
    def static_parse_builder(read_buffer: ReadBuffer, umas_request_function_key: int, byte_length: int):
        ...
        exception_code: ModbusErrorCode = read_buffer.read_enum(read_function=ModbusErrorCode,bit_length=8, logical_name="exception_code", umas_request_function_key=umas_request_function_key, byte_length=byte_length)
...
class ModbusPDUErrorBuilder:
    ...
    def build(self,umas_request_function_key: int, byte_length: int , ) -> ModbusPDUError:
        modbus_pduerror: ModbusPDUError = ModbusPDUError(umas_request_function_key, byte_length , self.exception_code )
