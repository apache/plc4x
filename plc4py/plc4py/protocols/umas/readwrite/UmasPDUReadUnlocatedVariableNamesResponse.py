...
class UmasPDUReadUnlocatedVariableNamesResponse():
    ...
    def static_parse_context(read_buffer: ReadBuffer):
        ...
        records: List[Any] = read_buffer.read_array_field(logical_name="records", read_function=UmasUnlocatedVariableReference.static_parse, count=no_of_records)

        read_buffer.pop_context("UmasPDUReadUnlocatedVariableNamesResponse")
        # Create the instance
        _umas_pduread_unlocated_variable_names_response: UmasPDUReadUnlocatedVariableNamesResponse = UmasPDUReadUnlocatedVariableNamesResponse(range, next_address, unknown1, no_of_records, records )
    ...
    def equals(self, o: object) -> bool:
        ...
        that: UmasPDUReadUnlocatedVariableNamesResponse = UmasPDUReadUnlocatedVariableNamesResponse(o)
