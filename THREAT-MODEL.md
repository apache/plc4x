...
| **.NET bindings (`plc4net/`)**                                                                                                                                                     | n/a                                                                      | n/a                                             | **out** — not marked supported in the protocols index; README declares "not ready for usage" *(documented: `README.md`)*              |
...
6. **Code that ships in the repository but is not part of the supported
   product.** `plc4c/`, `plc4py/` and `plc4net/` are flagged "not ready for
   usage" in `README.md` (and none is marked supported in the protocols index); the
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|-----------------------------------------------------------|
| `README.md` ("`plc4c/`, `plc4py/`, `plc4net/` not ready for usage")                                                                                                                                                                                                                                                                                                 | scope carve-out                     | §3 item 6, §5a                                            |
