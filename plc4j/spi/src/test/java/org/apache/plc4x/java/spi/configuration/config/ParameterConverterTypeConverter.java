...
public class ParameterConverterTypeConverter implements ConfigurationParameterConverter<ParameterConverterType> {

    @Override
    public Class<ParameterConverterType> getType() {
