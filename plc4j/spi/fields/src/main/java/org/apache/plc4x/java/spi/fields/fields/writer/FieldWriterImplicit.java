...
public class FieldWriterImplicit<T> implements FieldCommons {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(FieldWriterImplicit.class);

    public void writeImplicitField(T value, DataWriter<T> dataWriter, WithOption... options) throws BufferException {
