...
public class DataWriterFactory {
    ...
    public static DataWriter<byte[]> writeByteArray(WriteBuffer writeBuffer, int numBytes) {
        return new DataWriterSimpleByteArray(writeBuffer, numBytes);
    }
    ...
    public static DataWriter<LocalDate> writeDate(WriteBuffer writeBuffer) {
        return new DataWriterSimpleDateFromEpochDays(writeBuffer);
    }

    public static DataWriter<LocalDateTime> writeDateTime(WriteBuffer writeBuffer) {
        return new DataWriterSimpleDateTimeFromEpochSeconds(writeBuffer);
    }

    public static DataWriter<LocalTime> writeTime(WriteBuffer writeBuffer) {
        return new DataWriterSimpleTimeFromDaySeconds(writeBuffer);
    }
