...
public class DataReaderFactory {
    ...
    public static DataReader<byte[]> readByteArray(ReadBuffer readBuffer, int numBytes) {
        return new DataReaderSimpleByteArray(readBuffer, numBytes);
    }
    ...
    public static DataReader<LocalDate> readDate(ReadBuffer readBuffer) {
        return new DataReaderSimpleDateFromEpochDays(readBuffer);
    }

    public static DataReader<LocalDateTime> readDateTime(ReadBuffer readBuffer) {
        return new DataReaderSimpleDateTimeFromEpochSeconds(readBuffer);
    }

    public static DataReader<LocalTime> readTime(ReadBuffer readBuffer) {
        return new DataReaderSimpleTimeFromDaySeconds(readBuffer);
    }
