...
public class DataWriterSimpleBoolean extends DataWriterSimpleBase<Boolean> {
    ...
    @Override
    public void write(Boolean value, WithOption... options) throws BufferException {
        if (bitLength != 1) {
            throw new BufferException("Bit fields only support bitLength of 1");
        }
        writeBuffer.writeBit(value, options);
    }
