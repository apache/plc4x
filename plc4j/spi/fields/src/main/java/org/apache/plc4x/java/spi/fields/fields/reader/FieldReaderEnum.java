...
public class FieldReaderEnum<T> implements FieldCommons {
    ...
    public T readEnumField(DataReader<T> dataReader, WithOption... options) throws BufferException {
        ...
        // The serializer names the inner element after the enum type (see FieldWriterSimpleEnum),
