...
public class FieldWriterSimple<T> implements FieldCommons {

    private static final Logger LOGGER = LoggerFactory.getLogger(FieldWriterSimple.class);

    public void writeSimpleField(T value, DataWriter<T> dataWriter, WithOption... options) throws BufferException {
