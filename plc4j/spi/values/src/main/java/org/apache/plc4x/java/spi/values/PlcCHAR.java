...
public class PlcCHAR extends PlcIECValue<Short> {
    ...
    public static PlcCHAR of(Object value) {
        if (value instanceof PlcCHAR plcCHAR) {
            return plcCHAR;
        }
        if (value instanceof Boolean b) {
            return new PlcCHAR(b);
        }
        if (value instanceof Byte b) {
            return new PlcCHAR(b);
        }
        if (value instanceof Short i) {
            return new PlcCHAR(i);
        }
        if (value instanceof Integer i) {
            return new PlcCHAR(i);
        }
        if (value instanceof Long l) {
            return new PlcCHAR(l);
        }
        if (value instanceof Float v) {
            return new PlcCHAR(v);
        }
        if (value instanceof Double v) {
            return new PlcCHAR(v);
        }
        if (value instanceof BigInteger bigInteger) {
            return new PlcCHAR(bigInteger);
        }
        if (value instanceof BigDecimal bigDecimal) {
            return new PlcCHAR(bigDecimal);
        }
        if (value instanceof Character c) {
            return new PlcCHAR(c);
        }
