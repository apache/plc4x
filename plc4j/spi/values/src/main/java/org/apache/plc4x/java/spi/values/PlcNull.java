...
public class PlcNull implements PlcValue, Serializable {
    ...
    public boolean equals(Object o) {
        ...
        // All PlcNull instances are equal
        return o != null && getClass() == o.getClass();
    }

    @Override
    public int hashCode() {
        // All PlcNull instances have the same hash code
        return 0;
    }

    @Override
    public void serialize(WriteBuffer writeBuffer) throws BufferException {
        writeBuffer.pushContext(WithOption.WithName("PlcNull"));
        writeBuffer.popContext(WithOption.WithName("PlcNull"));
    }
}
