...
public class PlcLWORD extends PlcIECValue<BigInteger> {
    ...
    public static PlcLWORD of(Object value) {
        if (value instanceof PlcLWORD plcLWORD) {
            return plcLWORD;
        }
        if (value instanceof Boolean b) {
            return new PlcLWORD(b);
        }
        if (value instanceof Byte b) {
            return new PlcLWORD(b);
        }
        if (value instanceof Short i) {
            return new PlcLWORD(i);
        }
        if (value instanceof Integer i) {
            return new PlcLWORD(i);
        }
        if (value instanceof Long l) {
            return new PlcLWORD(l);
        }
        if (value instanceof Float v) {
            return new PlcLWORD(v);
        }
        if (value instanceof Double v) {
            return new PlcLWORD(v);
        }
        if (value instanceof BigInteger bigInteger) {
            return new PlcLWORD(bigInteger);
        }
        if (value instanceof BigDecimal bigDecimal) {
            return new PlcLWORD(bigDecimal);
        }
