...
public class PlcUINT extends PlcIECValue<Integer> {
    ...
    public static final Integer MAX_VALUE = 65535; // Unsigned 16-bit: 0 to 2^16-1

    public static PlcUINT of(Object value) {
        if (value instanceof PlcUINT plcUINT) {
            return plcUINT;
        }
        if (value instanceof Boolean b) {
            return new PlcUINT(b);
        }
        if (value instanceof Byte b) {
            return new PlcUINT(b);
        }
        if (value instanceof Short i) {
            return new PlcUINT(i);
        }
        if (value instanceof Integer i) {
            return new PlcUINT(i);
        }
        if (value instanceof Long l) {
            return new PlcUINT(l);
        }
        if (value instanceof Float v) {
            return new PlcUINT(v);
        }
        if (value instanceof Double v) {
            return new PlcUINT(v);
        }
        if (value instanceof BigInteger bigInteger) {
            return new PlcUINT(bigInteger);
        }
        if (value instanceof BigDecimal bigDecimal) {
            return new PlcUINT(bigDecimal);
        }
