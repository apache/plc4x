...
public class DefaultPlcValueHandler implements PlcValueHandler {
    ...
    private static PlcValue ofElement(PlcValueType type, Object value) {
        ...
        return switch (type) {
            case BOOL -> PlcBOOL.of(value);
            case BYTE -> PlcBYTE.of(value);
            case SINT -> PlcSINT.of(value);
            case USINT -> PlcUSINT.of(value);
            case INT -> PlcINT.of(value);
            case UINT -> PlcUINT.of(value);
            case WORD -> PlcWORD.of(value);
            case DINT -> PlcDINT.of(value);
            case UDINT -> PlcUDINT.of(value);
            case DWORD -> PlcDWORD.of(value);
            case LINT -> PlcLINT.of(value);
            case ULINT -> PlcULINT.of(value);
            case LWORD -> PlcLWORD.of(value);
            case REAL -> PlcREAL.of(value);
            case LREAL -> PlcLREAL.of(value);
            case CHAR -> PlcCHAR.of(value);
            case WCHAR -> PlcWCHAR.of(value);
            case STRING -> PlcSTRING.of(value);
            case WSTRING -> PlcWSTRING.of(value);
            case TIME -> PlcTIME.of(value);
            case LTIME -> PlcLTIME.of(value);
            case DATE -> PlcDATE.of(value);
            case LDATE -> PlcLDATE.of(value);
            case TIME_OF_DAY -> PlcTIME_OF_DAY.of(value);
            case LTIME_OF_DAY -> PlcLTIME_OF_DAY.of(value);
            case DATE_AND_TIME -> PlcDATE_AND_TIME.of(value);
            case DATE_AND_LTIME -> PlcDATE_AND_LTIME.of(value);
            case LDATE_AND_TIME -> PlcLDATE_AND_TIME.of(value);
            case RAW_BYTE_ARRAY -> PlcRawByteArray.of(value);
            ...
            case List -> throw new UnsupportedOperationException("Not implemented yet");
            ...
            case Struct -> throw new UnsupportedOperationException("Not implemented yet");
            case NULL -> new PlcNull();
            default -> throw new PlcUnsupportedDataTypeException("Data Type " + value.getClass()
                + " Is not supported");
        };
    }
    ...
    private static PlcValue of(Object value) {
        ...
        if (value instanceof BigInteger bigInteger) {
            if ((bigInteger.compareTo(BigInteger.ZERO) >= 0) && (BigInteger.ONE.shiftLeft(64).subtract(BigInteger.ONE).compareTo(bigInteger) > 0)) {
