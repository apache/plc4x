...
public class PlcBYTE extends PlcIECValue<Short> {
    ...
    public static PlcBYTE of(Object value) {
        if (value instanceof PlcBYTE plcBYTE) {
            return plcBYTE;
        }
        if (value instanceof Boolean b) {
            return new PlcBYTE(b);
        }
        ...
        if (value instanceof Long l) {
            return new PlcBYTE(l);
        }
        if (value instanceof Float v) {
            return new PlcBYTE(v);
        }
        if (value instanceof Double v) {
            return new PlcBYTE(v);
        }
        if (value instanceof BigInteger bigInteger) {
            return new PlcBYTE(bigInteger);
        }
        if (value instanceof BigDecimal bigDecimal) {
            return new PlcBYTE(bigDecimal);
        }
