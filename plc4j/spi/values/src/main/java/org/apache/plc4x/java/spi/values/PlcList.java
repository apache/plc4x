...
public class PlcList extends PlcValueAdapter {
    ...
    public PlcList(List<? extends PlcValue> listItems) {
    ...
    public boolean equals(Object o) {
        ...
        PlcList plcList = (PlcList) o;
        return listItems.equals(plcList.listItems);
    }
    ...
    public void serialize(WriteBuffer writeBuffer) throws BufferException {
        writeBuffer.pushContext(WithOption.WithName("PlcList"));
        ...
        writeBuffer.popContext(WithOption.WithName("PlcList"));
    }
