...
public class PlcDWORD extends PlcIECValue<Long> {
    ...
    public static final Long MIN_VALUE = (long) 0;
    public static final Long MAX_VALUE = (long) Integer.MAX_VALUE * 2 + 1;

    public static PlcDWORD of(Object value) {
        if (value instanceof PlcDWORD plcDWORD) {
            return plcDWORD;
        }
        if (value instanceof Boolean b) {
            return new PlcDWORD(b);
        }
        if (value instanceof Byte b) {
            return new PlcDWORD(b);
        }
        if (value instanceof Short i) {
            return new PlcDWORD(i);
        }
        if (value instanceof Integer i) {
            return new PlcDWORD(i);
        }
        if (value instanceof Long l) {
            return new PlcDWORD(l);
        }
        if (value instanceof Float v) {
            return new PlcDWORD(v);
        }
        if (value instanceof Double v) {
            return new PlcDWORD(v);
        }
        if (value instanceof BigInteger bigInteger) {
            return new PlcDWORD(bigInteger);
        }
        if (value instanceof BigDecimal bigDecimal) {
            return new PlcDWORD(bigDecimal);
        }
