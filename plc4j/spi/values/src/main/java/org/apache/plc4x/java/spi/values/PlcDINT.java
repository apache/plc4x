...
public class PlcDINT extends PlcIECValue<Integer> {
    ...
    public static PlcDINT of(Object value) {
        if (value instanceof PlcDINT plcDINT) {
            return plcDINT;
        }
        if (value instanceof Boolean b) {
            return new PlcDINT(b);
        }
        ...
        if (value instanceof Long l) {
            return new PlcDINT(l);
        }
        if (value instanceof Float v) {
            return new PlcDINT(v);
        }
        if (value instanceof Double v) {
            return new PlcDINT(v);
        }
        if (value instanceof BigInteger bigInteger) {
            return new PlcDINT(bigInteger);
        }
        if (value instanceof BigDecimal bigDecimal) {
            return new PlcDINT(bigDecimal);
        }
    ...
    public void serialize(WriteBuffer writeBuffer) throws BufferException {
        writeBuffer.writeSignedInt(32, value, WithOption.WithName(getClass().getSimpleName()));
    }
