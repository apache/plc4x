...
public class PlcSINT extends PlcIECValue<Byte> {
    ...
    public static PlcSINT of(Object value) {
        if (value instanceof PlcSINT plcSINT) {
            return plcSINT;
        }
        if (value instanceof Boolean b) {
            return new PlcSINT(b);
        }
        ...
        if (value instanceof Long l) {
            return new PlcSINT(l);
        }
        if (value instanceof Float v) {
            return new PlcSINT(v);
        }
        if (value instanceof Double v) {
            return new PlcSINT(v);
        }
        if (value instanceof BigInteger bigInteger) {
            return new PlcSINT(bigInteger);
        }
        if (value instanceof BigDecimal bigDecimal) {
            return new PlcSINT(bigDecimal);
        }
    ...
    public void serialize(WriteBuffer writeBuffer) throws BufferException {
        writeBuffer.writeSignedInt(8, value, WithOption.WithName(getClass().getSimpleName()));
    }
