...
public class PlcRawByteArray extends PlcIECValue<byte[]> {
    ...
    public String toString() {
        return StaticHelper.ENCODE_HEX(value);
    }
    ...
    public boolean equals(Object o) {
        ...
        PlcRawByteArray that = (PlcRawByteArray) o;
    ...
    @Override
    public int hashCode() {
        // Use Arrays.hashCode for the byte array
        return java.util.Arrays.hashCode(value);
    }

    @Override
    public void serialize(WriteBuffer writeBuffer) throws BufferException {
        writeBuffer.writeBits(value.length * 8, value, WithOption.WithName(getClass().getSimpleName()));
    }
