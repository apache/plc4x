...
public enum Plc4xResponseCode {
  ...
  private static final Map<Short, Plc4xResponseCode> map;

  static {
    map = new HashMap<>();
    for (Plc4xResponseCode value : Plc4xResponseCode.values()) {
  ...
  public static Plc4xResponseCode enumForValue(short value) {
