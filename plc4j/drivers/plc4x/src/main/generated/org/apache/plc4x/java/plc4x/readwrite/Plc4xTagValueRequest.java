...
public class Plc4xTagValueRequest implements Message {
  ...
  public static Plc4xTagValueRequest staticParse(ReadBuffer readBuffer) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("Plc4xTagValueRequest"));
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("Plc4xTagValueRequest"));
