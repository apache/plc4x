...
public class KnxNetIpRouting extends ServiceId implements Message {
  ...
  protected void serializeServiceIdChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("KnxNetIpRouting");
  }
  ...
  public static class KnxNetIpRoutingBuilderImpl implements ServiceId.ServiceIdBuilder {
    ...
    public KnxNetIpRouting build() {
      KnxNetIpRouting knxNetIpRouting = new KnxNetIpRouting(version);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof KnxNetIpRouting)) {
      return false;
    }
    KnxNetIpRouting that = (KnxNetIpRouting) o;
