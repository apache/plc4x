...
public class KnxNetIpCore extends ServiceId implements Message {
  ...
  protected void serializeServiceIdChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("KnxNetIpCore");

    // Simple Field (version)
    writeSimpleField("version", version, writeUnsignedShort(writeBuffer, 8));

    writeBuffer.popContext("KnxNetIpCore");
  }
  ...
  public static class KnxNetIpCoreBuilder implements ServiceId.ServiceIdBuilder {
    ...
    public KnxNetIpCore build() {
      KnxNetIpCore knxNetIpCore = new KnxNetIpCore(version);
      return knxNetIpCore;
    }
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof KnxNetIpCore)) {
      return false;
    }
    KnxNetIpCore that = (KnxNetIpCore) o;
