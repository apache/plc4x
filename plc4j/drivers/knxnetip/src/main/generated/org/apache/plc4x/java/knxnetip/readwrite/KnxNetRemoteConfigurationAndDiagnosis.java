...
public class KnxNetRemoteConfigurationAndDiagnosis extends ServiceId implements Message {
  ...
  protected void serializeServiceIdChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("KnxNetRemoteConfigurationAndDiagnosis");
  }
  ...
  public static class KnxNetRemoteConfigurationAndDiagnosisBuilderImpl
    ...
    public KnxNetRemoteConfigurationAndDiagnosis build() {
      KnxNetRemoteConfigurationAndDiagnosis knxNetRemoteConfigurationAndDiagnosis =
          new KnxNetRemoteConfigurationAndDiagnosis(version);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof KnxNetRemoteConfigurationAndDiagnosis)) {
      return false;
    }
    KnxNetRemoteConfigurationAndDiagnosis that = (KnxNetRemoteConfigurationAndDiagnosis) o;
