...
public class DescriptionResponse extends KnxNetIpMessage implements Message {
  ...
  public static class DescriptionResponseBuilder implements KnxNetIpMessage.KnxNetIpMessageBuilder {
    ...
    public DescriptionResponse build() {
      DescriptionResponse descriptionResponse =
          new DescriptionResponse(dibDeviceInfo, dibSuppSvcFamilies);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof DescriptionResponse)) {
      return false;
    }
    DescriptionResponse that = (DescriptionResponse) o;
    return (getDibDeviceInfo() == that.getDibDeviceInfo())
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getDibDeviceInfo(), getDibSuppSvcFamilies());
  }
