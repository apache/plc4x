...
public abstract class CEMI implements Message {
  ...
  protected abstract void serializeCEMIChild(WriteBuffer writeBuffer) throws BufferException;

  public static CEMI staticParse(ReadBuffer readBuffer, int size) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("CEMI"));
    int startPos = readBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Discriminator Field: messageCode
    short messageCode = FieldReaderFactory.readDiscriminatorField(DataReaderFactory.readUnsignedShort(readBuffer, 8), WithOption.WithName("messageCode"));
    ...
    if (builder == null) {
      throw new BufferException("Unsupported case for discriminated type parameters parameters [messageCode]");
    }
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("CEMI"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    short messageCode = (short) getMessageCode();
    // Discriminator Field: messageCode
    FieldWriterFactory.writeDiscriminatorField((short) messageCode, DataWriterFactory.writeUnsignedShort(writeBuffer, 8), WithOption.WithName("messageCode"));
