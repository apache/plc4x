...
public class KnxNetObjectServer extends ServiceId implements Message {
  ...
  protected void serializeServiceIdChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("KnxNetObjectServer");
  }
  ...
  public static class KnxNetObjectServerBuilder implements ServiceId.ServiceIdBuilder {
    ...
    public KnxNetObjectServer build() {
      KnxNetObjectServer knxNetObjectServer = new KnxNetObjectServer(version);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof KnxNetObjectServer)) {
      return false;
    }
    KnxNetObjectServer that = (KnxNetObjectServer) o;
