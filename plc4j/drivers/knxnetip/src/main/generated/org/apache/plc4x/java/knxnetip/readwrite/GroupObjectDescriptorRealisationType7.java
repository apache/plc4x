...
/**
 * AKA: System 7 It seems that these devices generally define their own format. From having a look
 * at the memory, it looks as if in this case at the address of the ComObjectTable, there's one byte
 * indicating the total number of entries. This seems to be followed by a 2-byte Address and then by
 * the entries themselves. Each entry seems to be 4 bytes long.
 */
public class GroupObjectDescriptorRealisationType7 implements Message {
  ...
  /**
   * Additional information to the 'dataPointer', if set to 'true' 0x100 needs to be added to the
   * address
   */
  ...
  /**
   * Communication is generally enabled (If this is set to false, 'transmitEnable', 'writeEnable'
   * and 'readEnable' are generally considered 'false'
   */
