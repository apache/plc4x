...
public class ApduDataExtOpenRoutingTableRequest extends ApduDataExt implements Message {
  ...
  protected void serializeApduDataExtChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("ApduDataExtOpenRoutingTableRequest");
  }
  ...
  public static ApduDataExtBuilder staticParseApduDataExtBuilder(
    ...
    // Create the instance
    return new ApduDataExtOpenRoutingTableRequestBuilderImpl(length);
  }
  ...
  public static class ApduDataExtOpenRoutingTableRequestBuilderImpl
    ...
    public ApduDataExtOpenRoutingTableRequestBuilderImpl(Short length) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ApduDataExtOpenRoutingTableRequest)) {
      return false;
    }
    ApduDataExtOpenRoutingTableRequest that = (ApduDataExtOpenRoutingTableRequest) o;
