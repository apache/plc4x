 ...
 */
public class LDataCon extends CEMI implements Message {
  ...
  public LDataCon(Short additionalInformationLength,
  ...
  public static CEMIBuilder staticParseCEMIBuilder(ReadBuffer readBuffer, int size) throws
      BufferException {
    readBuffer.pushContext(WithOption.WithName("LDataCon"));
  ...
  protected void serializeCEMIChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("LDataCon"));
  ...
  public static class CEMIBuilderImpl implements CEMI.CEMIBuilder {
    ...
    public CEMI build() {
      return new LDataCon(additionalInformationLength, additionalInformation, dataFrame);
    }
  }
}
