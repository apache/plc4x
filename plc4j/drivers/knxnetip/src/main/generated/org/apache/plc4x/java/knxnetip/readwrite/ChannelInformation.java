...
public class ChannelInformation implements Message {
  ...
  public static ChannelInformation staticParse(ReadBuffer readBuffer) throws ParseException {
    ...
    // Create the instance
    ChannelInformation _channelInformation;
    _channelInformation = new ChannelInformation(numChannels, channelCode);
  ...
  public boolean equals(Object o) {
    ...
    return (getNumChannels() == that.getNumChannels())
        && (getChannelCode() == that.getChannelCode())
        && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(getNumChannels(), getChannelCode());
  }
