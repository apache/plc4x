...
public class ApduDataExtIndividualAddressSerialNumberWrite extends ApduDataExt implements Message {
  ...
  protected void serializeApduDataExtChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("ApduDataExtIndividualAddressSerialNumberWrite");
  }
  ...
  public static ApduDataExtBuilder staticParseApduDataExtBuilder(
    ...
    // Create the instance
    return new ApduDataExtIndividualAddressSerialNumberWriteBuilderImpl(length);
  }
  ...
  public static class ApduDataExtIndividualAddressSerialNumberWriteBuilderImpl
    ...
    public ApduDataExtIndividualAddressSerialNumberWriteBuilderImpl(Short length) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ApduDataExtIndividualAddressSerialNumberWrite)) {
      return false;
    }
    ApduDataExtIndividualAddressSerialNumberWrite that =
        (ApduDataExtIndividualAddressSerialNumberWrite) o;
