...
public class ApduDataExtDomainAddressRead extends ApduDataExt implements Message {
  ...
  protected void serializeApduDataExtChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("ApduDataExtDomainAddressRead");
  }
  ...
  public static ApduDataExtBuilder staticParseApduDataExtBuilder(
    ...
    // Create the instance
    return new ApduDataExtDomainAddressReadBuilderImpl(length);
  }
  ...
  public static class ApduDataExtDomainAddressReadBuilderImpl
    ...
    public ApduDataExtDomainAddressReadBuilderImpl(Short length) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ApduDataExtDomainAddressRead)) {
      return false;
    }
    ApduDataExtDomainAddressRead that = (ApduDataExtDomainAddressRead) o;
