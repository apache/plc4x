...
public class DeviceStatus implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("DeviceStatus");
  }
  ...
  public static DeviceStatus staticParse(ReadBuffer readBuffer) throws ParseException {
    ...
    readBuffer.closeContext("DeviceStatus");
    // Create the instance
  ...
  public boolean equals(Object o) {
    ...
    return (getProgramMode() == that.getProgramMode()) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(getProgramMode());
  }
