...
public enum OpcuaDataType {
  ...
  public static OpcuaDataType firstEnumForFieldVariantType(short variantType) {
    for (OpcuaDataType _val : OpcuaDataType.values()) {
      if (_val.getVariantType() == variantType) {
        return _val;
      }
    }
    return null;
  ...
  public static List<OpcuaDataType> enumsForFieldVariantType(short variantType) {
