...
public class VariantQualifiedName extends Variant implements Message {
  ...
  protected void serializeVariantChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("VariantQualifiedName");
    ...
    writeBuffer.popContext("VariantQualifiedName");
  }
  ...
  public int getLengthInBits() {
    ...
    if (value != null) {
      int i = 0;
      for (QualifiedName element : value) {
  ...
  public static class VariantQualifiedNameBuilderImpl implements Variant.VariantBuilder {
    ...
    public VariantQualifiedName build(
        boolean arrayLengthSpecified,
        boolean arrayDimensionsSpecified,
        Integer noOfArrayDimensions,
        List<Boolean> arrayDimensions) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof VariantQualifiedName)) {
      return false;
    }
    VariantQualifiedName that = (VariantQualifiedName) o;
