...
public class RegisterServer2Response extends ExtensionObjectDefinition implements Message {
  ...
  public RegisterServer2Response(ResponseHeader responseHeader,
      List<StatusCode> configurationResults, List<DiagnosticInfo> diagnosticInfos) {
  ...
  /**
   * Property field configurationResults
   */
  ...
  public static ExtensionObjectDefinitionBuilder staticParseExtensionObjectDefinitionBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("RegisterServer2Response"), WithOption.WithFloatEncoding("IEEE754"), WithOption.WithSignedIntegerEncoding("twos-complement"), WithOption.WithUnsignedIntegerEncoding("unsigned-binary"), WithOption.WithStringEncoding("UTF8"));
  ...
  protected void serializeExtensionObjectDefinitionChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("RegisterServer2Response"), WithOption.WithFloatEncoding("IEEE754"), WithOption.WithSignedIntegerEncoding("twos-complement"), WithOption.WithUnsignedIntegerEncoding("unsigned-binary"), WithOption.WithStringEncoding("UTF8"));
    ...
    // Implicit Field: noOfConfigurationResults
    int noOfConfigurationResults = (int) ((((configurationResults) == (null)) ? -(1) : StaticHelper.COUNT(configurationResults)));
    FieldWriterFactory.writeImplicitField((int) noOfConfigurationResults, DataWriterFactory.writeSignedInt(writeBuffer, 32), WithOption.WithName("noOfConfigurationResults"), WithOption.WithFloatEncoding("IEEE754"), WithOption.WithSignedIntegerEncoding("twos-complement"), WithOption.WithUnsignedIntegerEncoding("unsigned-binary"), WithOption.WithStringEncoding("UTF8"));

    // Array Field: configurationResults
    FieldWriterFactory.writeComplexTypeArrayField(configurationResults, writeBuffer, WithOption.WithName("configurationResults"), WithOption.WithFloatEncoding("IEEE754"), WithOption.WithSignedIntegerEncoding("twos-complement"), WithOption.WithUnsignedIntegerEncoding("unsigned-binary"), WithOption.WithStringEncoding("UTF8"));
  ...
  public int getLengthInBits() {
    ...
    if (configurationResults != null) {
      int i = 0;
      for (StatusCode _element : configurationResults) {
