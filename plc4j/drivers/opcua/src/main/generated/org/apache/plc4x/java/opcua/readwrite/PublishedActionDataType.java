...
public class PublishedActionDataType extends ExtensionObjectDefinition implements Message {
  ...
  public PublishedActionDataType(
      DataSetMetaDataType requestDataSetMetaData, List<ActionTargetDataType> actionTargets) {
    super();
  ...
  protected void serializeExtensionObjectDefinitionChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.pushContext("PublishedActionDataType");
    ...
    writeBuffer.popContext("PublishedActionDataType");
  }
  ...
  public static ExtensionObjectDefinitionBuilder staticParseExtensionObjectDefinitionBuilder(
    ...
    readBuffer.pullContext("PublishedActionDataType");
    ...
    readBuffer.closeContext("PublishedActionDataType");
    // Create the instance
    return new PublishedActionDataTypeBuilderImpl(requestDataSetMetaData, actionTargets);
  }

  public static class PublishedActionDataTypeBuilderImpl
    ...
    public PublishedActionDataTypeBuilderImpl(
        DataSetMetaDataType requestDataSetMetaData, List<ActionTargetDataType> actionTargets) {
      this.requestDataSetMetaData = requestDataSetMetaData;
      this.actionTargets = actionTargets;
    }

    public PublishedActionDataType build() {
      PublishedActionDataType publishedActionDataType =
          new PublishedActionDataType(requestDataSetMetaData, actionTargets);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof PublishedActionDataType)) {
      return false;
    }
    PublishedActionDataType that = (PublishedActionDataType) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getRequestDataSetMetaData(), getActionTargets());
  }
