...
public class VariantNodeId extends Variant implements Message {
  ...
  public VariantNodeId(Boolean arrayLengthSpecified, Boolean arrayDimensionsSpecified,
  ...
  public static VariantBuilder staticParseVariantBuilder(ReadBuffer readBuffer,
    ...
    readBuffer.pushContext(WithOption.WithName("VariantNodeId"));
    ...
    // Array Field: value
    List<NodeId> value = FieldReaderFactory.readCountArrayField(DataReaderFactory.readComplex(() -> DataReaderFactory.castToDeclaredType(NodeId.class, NodeId.staticParse(readBuffer)), readBuffer), (((arrayLength) == (null)) ? 1 : arrayLength), WithOption.WithName("value"));
  ...
  protected void serializeVariantChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("VariantNodeId"));
  ...
  public static class VariantBuilderImpl implements Variant.VariantBuilder {
    ...
    public VariantBuilderImpl(Integer arrayLength, List<NodeId> value) {
      this.arrayLength = arrayLength;
      this.value = value;
    }
