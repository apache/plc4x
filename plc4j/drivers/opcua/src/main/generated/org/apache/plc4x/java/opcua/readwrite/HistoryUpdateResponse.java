...
public class HistoryUpdateResponse extends ExtensionObjectDefinition implements Message {
  ...
  protected void serializeExtensionObjectDefinitionChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("HistoryUpdateResponse");
  }
  ...
  public int getLengthInBits() {
    ...
    if (results != null) {
      int i = 0;
      for (HistoryUpdateResult element : results) {
  ...
  public static ExtensionObjectDefinitionBuilder staticParseExtensionObjectDefinitionBuilder(
    ...
    List<HistoryUpdateResult> results =
        readCountArrayField(
            ...
            readComplex(
                () ->
                    (HistoryUpdateResult)
                        ExtensionObjectDefinition.staticParse(readBuffer, (int) (697)),
                readBuffer),
            noOfResults);
    ...
    // Create the instance
    return new HistoryUpdateResponseBuilderImpl(responseHeader, results, diagnosticInfos);
  }
  ...
  public static class HistoryUpdateResponseBuilderImpl
    ...
    public HistoryUpdateResponse build() {
      HistoryUpdateResponse historyUpdateResponse =
          new HistoryUpdateResponse(responseHeader, results, diagnosticInfos);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof HistoryUpdateResponse)) {
      return false;
    }
    HistoryUpdateResponse that = (HistoryUpdateResponse) o;
