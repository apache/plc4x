...
public class JsonWriterGroupMessageDataType extends ExtensionObjectDefinition implements Message {
  ...
  protected void serializeExtensionObjectDefinitionChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.pushContext("JsonWriterGroupMessageDataType");
    ...
    writeBuffer.popContext("JsonWriterGroupMessageDataType");
  }
  ...
  public static ExtensionObjectDefinitionBuilder staticParseExtensionObjectDefinitionBuilder(
    ...
    readBuffer.pullContext("JsonWriterGroupMessageDataType");
    ...
    readBuffer.closeContext("JsonWriterGroupMessageDataType");
    // Create the instance
    return new JsonWriterGroupMessageDataTypeBuilderImpl(networkMessageContentMask);
  }

  public static class JsonWriterGroupMessageDataTypeBuilderImpl
      implements ExtensionObjectDefinition.ExtensionObjectDefinitionBuilder {
    private final JsonNetworkMessageContentMask networkMessageContentMask;

    public JsonWriterGroupMessageDataTypeBuilderImpl(
        JsonNetworkMessageContentMask networkMessageContentMask) {
      this.networkMessageContentMask = networkMessageContentMask;
    }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof JsonWriterGroupMessageDataType)) {
      return false;
    }
    JsonWriterGroupMessageDataType that = (JsonWriterGroupMessageDataType) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getNetworkMessageContentMask());
  }
