 ...
 */
public enum OpcuaNodeIdServicesVariableAlias {
  AliasNameCategoryType_SubAliasNameCategories_Placeholder_FindAlias_InputArguments((int) 23460),

  AliasNameCategoryType_SubAliasNameCategories_Placeholder_FindAlias_OutputArguments((int) 23461),

  AliasNameCategoryType_FindAlias_InputArguments((int) 23463),
  ...
  static {
    map = new HashMap<>();
    for (OpcuaNodeIdServicesVariableAlias value : OpcuaNodeIdServicesVariableAlias.values()) {
  ...
  OpcuaNodeIdServicesVariableAlias(int value) {
    this.value = value;
  }
  ...
  public static OpcuaNodeIdServicesVariableAlias enumForValue(int value) {
