...
public enum OpcuaNodeIdServicesVariableReader {
  ReaderGroupType_GroupProperties((int) 17491L),
  ...
  ReaderGroupType_SecurityMode((int) 18000L),
  ReaderGroupType_SecurityGroupId((int) 18002L),
  ReaderGroupType_SecurityKeyServices((int) 18003L),
  ReaderGroupType_MaxNetworkMessageSize((int) 18065L),
  ReaderGroupType_Status_State((int) 18068L),
