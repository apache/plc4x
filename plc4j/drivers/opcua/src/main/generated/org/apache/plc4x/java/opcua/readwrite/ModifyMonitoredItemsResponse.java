...
public class ModifyMonitoredItemsResponse extends ExtensionObjectDefinition implements Message {
  ...
  public ModifyMonitoredItemsResponse(
      ...
      List<MonitoredItemModifyResult> results,
  ...
  public int getLengthInBits() {
    ...
    if (results != null) {
      int i = 0;
      for (MonitoredItemModifyResult element : results) {
  ...
  public static ExtensionObjectDefinitionBuilder staticParseExtensionObjectDefinitionBuilder(
            ...
            readComplex(
                () ->
                    (MonitoredItemModifyResult)
                        ExtensionObjectDefinition.staticParse(readBuffer, (int) (760)),
                readBuffer),
            noOfResults);
    ...
    // Create the instance
    return new ModifyMonitoredItemsResponseBuilderImpl(responseHeader, results, diagnosticInfos);
  }
  ...
  public static class ModifyMonitoredItemsResponseBuilderImpl
    ...
    public ModifyMonitoredItemsResponse build() {
      ModifyMonitoredItemsResponse modifyMonitoredItemsResponse =
          new ModifyMonitoredItemsResponse(responseHeader, results, diagnosticInfos);
