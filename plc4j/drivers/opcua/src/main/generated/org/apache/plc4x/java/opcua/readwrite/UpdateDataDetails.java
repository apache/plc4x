...
public class UpdateDataDetails extends ExtensionObjectDefinition implements Message {
  ...
  protected void serializeExtensionObjectDefinitionChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.pushContext("UpdateDataDetails");
    ...
    writeBuffer.popContext("UpdateDataDetails");
  }
  ...
  public static ExtensionObjectDefinitionBuilder staticParseExtensionObjectDefinitionBuilder(
    ...
    readBuffer.pullContext("UpdateDataDetails");
    ...
    readBuffer.closeContext("UpdateDataDetails");
    // Create the instance
    return new UpdateDataDetailsBuilderImpl(nodeId, performInsertReplace, updateValues);
  }

  public static class UpdateDataDetailsBuilderImpl
      implements ExtensionObjectDefinition.ExtensionObjectDefinitionBuilder {
    private final NodeId nodeId;
    private final PerformUpdateType performInsertReplace;
    private final List<DataValue> updateValues;

    public UpdateDataDetailsBuilderImpl(
        NodeId nodeId, PerformUpdateType performInsertReplace, List<DataValue> updateValues) {
      this.nodeId = nodeId;
      this.performInsertReplace = performInsertReplace;
      this.updateValues = updateValues;
    ...
    public UpdateDataDetails build() {
      UpdateDataDetails updateDataDetails =
          new UpdateDataDetails(nodeId, performInsertReplace, updateValues);
  ...
  public boolean equals(Object o) {
    ...
    UpdateDataDetails that = (UpdateDataDetails) o;
