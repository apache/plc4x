...
public class ByteStringNodeId implements Message {
  ...
  public ByteStringNodeId(Integer namespaceIndex, PascalByteString identifier) {
  ...
  public static ByteStringNodeId staticParse(ReadBuffer readBuffer) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("ByteStringNodeId"));
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("ByteStringNodeId"));
    ...
    // Simple Field: identifier
    FieldWriterFactory.writeSimpleField((PascalByteString) identifier, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("identifier"));
