...
public class ExtensiblePayload extends Payload implements Message {
  ...
  public static PayloadBuilder staticParsePayloadBuilder(ReadBuffer readBuffer, boolean binary,
    ...
    readBuffer.pushContext(WithOption.WithName("ExtensiblePayload"));
  ...
  protected void serializePayloadChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("ExtensiblePayload"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: payload
    FieldWriterFactory.writeSimpleField((RootExtensionObject) payload, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("payload"));
  ...
  public static class PayloadBuilderImpl implements Payload.PayloadBuilder {
    ...
    public PayloadBuilderImpl(RootExtensionObject payload) {
      this.payload = payload;
    }

    public Payload build(SequenceHeader sequenceHeader) {
      return new ExtensiblePayload(sequenceHeader, payload);
    }
  }
}
