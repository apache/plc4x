...
public class NumericNodeId implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeSimpleField("identifier", identifier, writeUnsignedLong(writeBuffer, 32));
  ...
  public static NumericNodeId staticParse(ReadBuffer readBuffer) throws ParseException {
    ...
    long identifier = readSimpleField("identifier", readUnsignedLong(readBuffer, 32));

    readBuffer.closeContext("NumericNodeId");
    // Create the instance
    NumericNodeId _numericNodeId;
    _numericNodeId = new NumericNodeId(namespaceIndex, identifier);
