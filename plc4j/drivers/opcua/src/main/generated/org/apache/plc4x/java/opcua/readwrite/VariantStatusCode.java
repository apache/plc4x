...
public class VariantStatusCode extends Variant implements Message {
  ...
  public static VariantBuilder staticParseVariantBuilder(ReadBuffer readBuffer,
    ...
    readBuffer.pushContext(WithOption.WithName("VariantStatusCode"));
  ...
  protected void serializeVariantChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("VariantStatusCode"));
  ...
  public static class VariantBuilderImpl implements Variant.VariantBuilder {
    ...
    public VariantBuilderImpl(Integer arrayLength, List<StatusCode> value) {
      this.arrayLength = arrayLength;
      this.value = value;
    }
