...
public enum OpcuaNodeIdServicesVariableQuantities {
  ...
  private static final Map<Integer, OpcuaNodeIdServicesVariableQuantities> map;

  static {
    map = new HashMap<>();
    for (OpcuaNodeIdServicesVariableQuantities value :
        OpcuaNodeIdServicesVariableQuantities.values()) {
  ...
  OpcuaNodeIdServicesVariableQuantities(int value) {
    this.value = value;
  }
  ...
  public static OpcuaNodeIdServicesVariableQuantities enumForValue(int value) {
