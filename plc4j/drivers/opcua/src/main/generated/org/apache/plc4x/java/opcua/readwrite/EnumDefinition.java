...
public class EnumDefinition extends ExtensionObjectDefinition implements Message {
  ...
  protected void serializeExtensionObjectDefinitionChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.pushContext("EnumDefinition");
    ...
    writeBuffer.popContext("EnumDefinition");
  }
  ...
  public static ExtensionObjectDefinitionBuilder staticParseExtensionObjectDefinitionBuilder(
    ...
    readBuffer.pullContext("EnumDefinition");
    ...
    List<EnumField> fields =
        readCountArrayField(
            "fields",
            readComplex(
                () -> (EnumField) ExtensionObjectDefinition.staticParse(readBuffer, (int) (104)),
                readBuffer),
            noOfFields);

    readBuffer.closeContext("EnumDefinition");
    // Create the instance
    return new EnumDefinitionBuilderImpl(fields);
  }

  public static class EnumDefinitionBuilderImpl
      implements ExtensionObjectDefinition.ExtensionObjectDefinitionBuilder {
    private final List<EnumField> fields;

    public EnumDefinitionBuilderImpl(List<EnumField> fields) {
      this.fields = fields;
    }
  ...
  public boolean equals(Object o) {
    ...
    return (getFields() == that.getFields()) && super.equals(that) && true;
  }
