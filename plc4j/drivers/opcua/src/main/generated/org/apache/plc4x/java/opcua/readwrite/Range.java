...
public class Range extends ExtensionObjectDefinition implements Message {
  ...
  protected void serializeExtensionObjectDefinitionChild(WriteBuffer writeBuffer)
    ...
    // Simple Field (low)
    writeSimpleField("low", low, writeDouble(writeBuffer, 64));

    // Simple Field (high)
    writeSimpleField("high", high, writeDouble(writeBuffer, 64));
  ...
  public static ExtensionObjectDefinitionBuilder staticParseExtensionObjectDefinitionBuilder(
    ...
    double high = readSimpleField("high", readDouble(readBuffer, 64));
