...
public enum OpcuaNodeIdServicesObject {
  ...
  AlarmSuppressionGroupType_AlarmCondition_Placeholder((int) 19847L),
  ...
  AlarmSuppressionGroupType_AlarmCondition_Placeholder_ShelvingState((int) 23623L),
  ...
  AlarmSuppressionGroupType_AlarmCondition_Placeholder_FirstInGroup((int) 23694L),
  ServiceCertificateDataType_Encoding_DefaultBinary((int) 23725L),
  ServiceCertificateDataType_Encoding_DefaultXml((int) 23735L),
  ServiceCertificateDataType_Encoding_DefaultJson((int) 23739L),
  ApplicationConfigurationDataType_Encoding_DefaultBinary((int) 23754L),
  AuthorizationServiceConfigurationDataType_Encoding_DefaultBinary((int) 23755L),
  ApplicationConfigurationDataType_Encoding_DefaultXml((int) 23762L),
  AuthorizationServiceConfigurationDataType_Encoding_DefaultXml((int) 23763L),
  ApplicationConfigurationDataType_Encoding_DefaultJson((int) 23776L),
  AuthorizationServiceConfigurationDataType_Encoding_DefaultJson((int) 23777L),
