...
public enum OpcuaNodeIdServicesObject {
  ...
  LimitAlarmType_ShelvingState((int) 9279L),
  ...
  ExclusiveLimitAlarmType_ShelvingState((int) 9416L),
  ExclusiveLimitAlarmType_LimitState((int) 9455L),
  ExclusiveLevelAlarmType_ShelvingState((int) 9557L),
  ExclusiveLevelAlarmType_LimitState((int) 9596L),
  ExclusiveRateOfChangeAlarmType_ShelvingState((int) 9698L),
  ExclusiveRateOfChangeAlarmType_LimitState((int) 9737L),
  ExclusiveDeviationAlarmType_ShelvingState((int) 9839L),
  ExclusiveDeviationAlarmType_LimitState((int) 9878L),
  NonExclusiveLimitAlarmType_ShelvingState((int) 9981L),
  NonExclusiveLevelAlarmType_ShelvingState((int) 10135L),
  NonExclusiveRateOfChangeAlarmType_ShelvingState((int) 10289L),
  NonExclusiveDeviationAlarmType_ShelvingState((int) 10443L),
  DiscreteAlarmType_ShelvingState((int) 10598L),
  OffNormalAlarmType_ShelvingState((int) 10712L),
  TripAlarmType_ShelvingState((int) 10826L),
  ...
  SystemOffNormalAlarmType_ShelvingState((int) 11831L),
  ...
  CertificateExpirationAlarmType_ShelvingState((int) 13305L),
  ...
  PublishedDataItemsType_DataSetWriterName_Placeholder((int) 15230L),
  PublishedDataItemsType_DataSetWriterName_Placeholder_Status((int) 15231L),
  PublishedDataItemsType_DataSetWriterName_Placeholder_TransportSettings((int) 15235L),
  ParsingResult_Encoding_DefaultJson((int) 15236L),
  PublishedEventsType_DataSetWriterName_Placeholder((int) 15238L),
  PublishedEventsType_DataSetWriterName_Placeholder_Status((int) 15239L),
  PublishedEventsType_DataSetWriterName_Placeholder_TransportSettings((int) 15243L),
  ...
  PublishSubscribeType_SecurityGroups((int) 15434L),
  ...
  PublishedDataItemsType_ExtensionFields((int) 15503L),
  PublishedEventsType_ExtensionFields((int) 15511L),
  ...
  PublishSubscribe_ConnectionName_Placeholder((int) 15790L),
  ...
  PublishSubscribe_ConnectionName_Placeholder_Address((int) 15851L),
  PublishSubscribe_ConnectionName_Placeholder_TransportSettings((int) 15864L),
  PublishSubscribe_ConnectionName_Placeholder_Status((int) 15865L),
  ...
  PublishSubscribe_ConnectionName_Placeholder_Diagnostics((int) 15937L),
  ...
  PublishSubscribe_ConnectionName_Placeholder_Diagnostics_Counters((int) 16102L),
  ...
  FileSystem_FileDirectoryName_Placeholder((int) 16315L),
  UadpWriterGroupMessageDataType_Encoding_DefaultJson((int) 16323L),
  FileSystem_FileName_Placeholder((int) 16327L),
  ...
  LimitAlarmType_FirstInGroup((int) 16565L),
  LimitAlarmType_AlarmGroup_Placeholder((int) 16566L),
  ExclusiveLimitAlarmType_FirstInGroup((int) 16605L),
  ExclusiveLimitAlarmType_AlarmGroup_Placeholder((int) 16606L),
  NonExclusiveLimitAlarmType_FirstInGroup((int) 16645L),
  NonExclusiveLimitAlarmType_AlarmGroup_Placeholder((int) 16646L),
  NonExclusiveLevelAlarmType_FirstInGroup((int) 16685L),
  NonExclusiveLevelAlarmType_AlarmGroup_Placeholder((int) 16686L),
  ExclusiveLevelAlarmType_FirstInGroup((int) 16725L),
  ExclusiveLevelAlarmType_AlarmGroup_Placeholder((int) 16726L),
  PublishedDataSetType_DataSetWriterName_Placeholder_MessageSettings((int) 16758L),
  NonExclusiveDeviationAlarmType_FirstInGroup((int) 16765L),
  NonExclusiveDeviationAlarmType_AlarmGroup_Placeholder((int) 16766L),
  PublishedDataItemsType_DataSetWriterName_Placeholder_MessageSettings((int) 16799L),
  ExclusiveDeviationAlarmType_FirstInGroup((int) 16806L),
  ExclusiveDeviationAlarmType_AlarmGroup_Placeholder((int) 16807L),
  PublishedEventsType_DataSetWriterName_Placeholder_MessageSettings((int) 16840L),
  NonExclusiveRateOfChangeAlarmType_FirstInGroup((int) 16847L),
  NonExclusiveRateOfChangeAlarmType_AlarmGroup_Placeholder((int) 16848L),
  ExclusiveRateOfChangeAlarmType_FirstInGroup((int) 16888L),
  ExclusiveRateOfChangeAlarmType_AlarmGroup_Placeholder((int) 16889L),
  DiscreteAlarmType_FirstInGroup((int) 16929L),
  DiscreteAlarmType_AlarmGroup_Placeholder((int) 16930L),
  OffNormalAlarmType_FirstInGroup((int) 16965L),
  OffNormalAlarmType_AlarmGroup_Placeholder((int) 16966L),
  SystemOffNormalAlarmType_FirstInGroup((int) 17001L),
  SystemOffNormalAlarmType_AlarmGroup_Placeholder((int) 17002L),
  TripAlarmType_FirstInGroup((int) 17037L),
  TripAlarmType_AlarmGroup_Placeholder((int) 17038L),
  CertificateExpirationAlarmType_FirstInGroup((int) 17073L),
  CertificateExpirationAlarmType_AlarmGroup_Placeholder((int) 17074L),
  DiscrepancyAlarmType_ShelvingState((int) 17180L),
  PubSubConnectionType_TransportSettings((int) 17203L),
  DiscrepancyAlarmType_FirstInGroup((int) 17208L),
  DiscrepancyAlarmType_AlarmGroup_Placeholder((int) 17209L),
  ...
  PublishSubscribe_ConnectionName_Placeholder_Diagnostics_LiveValues((int) 17352L),
  ...
  Dictionaries_DictionaryFolderName_Placeholder((int) 17595L),
  Dictionaries_DictionaryEntryName_Placeholder((int) 17596L),
  IrdiDictionaryEntryType_DictionaryEntryName_Placeholder((int) 17599L),
  UriDictionaryEntryType_DictionaryEntryName_Placeholder((int) 17601L),
  ...
  WriterGroupType_Status((int) 17730L),
  ...
  ReaderGroupType_Status((int) 18067L),
  ...
  KeyCredentialConfiguration_ServiceName_Placeholder((int) 18156L),
  InstrumentDiagnosticAlarmType_ShelvingState((int) 18438L),
  InstrumentDiagnosticAlarmType_FirstInGroup((int) 18476L),
  InstrumentDiagnosticAlarmType_AlarmGroup_Placeholder((int) 18486L),
  SystemDiagnosticAlarmType_ShelvingState((int) 18587L),
  SystemDiagnosticAlarmType_FirstInGroup((int) 18625L),
  SystemDiagnosticAlarmType_AlarmGroup_Placeholder((int) 18635L),
  ...
  PublishedDataItemsType_DataSetWriterName_Placeholder_Diagnostics((int) 18930L),
  PublishedDataItemsType_DataSetWriterName_Placeholder_Diagnostics_Counters((int) 18944L),
  PublishedDataItemsType_DataSetWriterName_Placeholder_Diagnostics_LiveValues((int) 18975L),
  PublishedEventsType_DataSetWriterName_Placeholder_Diagnostics((int) 18989L),
  PublishedEventsType_DataSetWriterName_Placeholder_Diagnostics_Counters((int) 19003L),
  PublishedEventsType_DataSetWriterName_Placeholder_Diagnostics_LiveValues((int) 19034L),
  ...
  TrustListOutOfDateAlarmType_ShelvingState((int) 19388L),
  TrustListOutOfDateAlarmType_FirstInGroup((int) 19426L),
  TrustListOutOfDateAlarmType_AlarmGroup_Placeholder((int) 19436L),
  ...
  PubSubDiagnosticsRootType_Counters((int) 19746L),
  PubSubDiagnosticsRootType_LiveValues((int) 19777L),
  PubSubDiagnosticsConnectionType_Counters((int) 19800L),
  ...
  Aliases((int) 23470L),
  Aliases_Alias_Placeholder((int) 23471L),
  Aliases_SubAliasNameCategories_Placeholder((int) 23472L),
  TagVariables((int) 23479L),
  TagVariables_Alias_Placeholder((int) 23480L),
  TagVariables_SubAliasNameCategories_Placeholder((int) 23481L),
  Topics((int) 23488L),
  Topics_Alias_Placeholder((int) 23489L),
  Topics_SubAliasNameCategories_Placeholder((int) 23490L),
  ...
  PublishSubscribeType_KeyPushTargets((int) 25392L),
  ...
  ApplicationConfigurationType_CertificateGroups((int) 25732L),
  ApplicationConfigurationType_CertificateGroups_DefaultApplicationGroup((int) 25733L),
  ApplicationConfigurationType_CertificateGroups_DefaultApplicationGroup_TrustList((int) 25734L),
  ApplicationConfigurationType_CertificateGroups_DefaultApplicationGroup_CertificateExpired(
      (int) 25774L),
  ApplicationConfigurationType_CertificateGroups_DefaultApplicationGroup_CertificateExpired_ShelvingState(
      (int) 25861L),
  ApplicationConfigurationType_CertificateGroups_DefaultApplicationGroup_CertificateExpired_FirstInGroup(
      (int) 25905L),
  ApplicationConfigurationType_CertificateGroups_DefaultApplicationGroup_TrustListOutOfDate(
      (int) 25940L),
  ApplicationConfigurationType_CertificateGroups_DefaultApplicationGroup_TrustListOutOfDate_ShelvingState(
      (int) 26027L),
  ApplicationConfigurationType_CertificateGroups_DefaultApplicationGroup_TrustListOutOfDate_FirstInGroup(
      (int) 26071L),
  ApplicationConfigurationType_CertificateGroups_DefaultHttpsGroup((int) 26105L),
  ApplicationConfigurationType_CertificateGroups_DefaultHttpsGroup_TrustList((int) 26106L),
  ApplicationConfigurationType_CertificateGroups_DefaultHttpsGroup_CertificateExpired((int) 26146L),
  ApplicationConfigurationType_CertificateGroups_DefaultHttpsGroup_CertificateExpired_ShelvingState(
      (int) 26233L),
  ApplicationConfigurationType_CertificateGroups_DefaultHttpsGroup_CertificateExpired_FirstInGroup(
      (int) 26277L),
  ApplicationConfigurationType_CertificateGroups_DefaultHttpsGroup_TrustListOutOfDate((int) 26312L),
  ApplicationConfigurationType_CertificateGroups_DefaultHttpsGroup_TrustListOutOfDate_ShelvingState(
      (int) 26399L),
  ApplicationConfigurationType_CertificateGroups_DefaultHttpsGroup_TrustListOutOfDate_FirstInGroup(
      (int) 26443L),
  ApplicationConfigurationType_CertificateGroups_DefaultUserTokenGroup((int) 26477L),
  ApplicationConfigurationType_CertificateGroups_DefaultUserTokenGroup_TrustList((int) 26478L),
  ApplicationConfigurationType_CertificateGroups_DefaultUserTokenGroup_CertificateExpired(
      (int) 26518L),
  ApplicationConfigurationType_CertificateGroups_DefaultUserTokenGroup_CertificateExpired_ShelvingState(
      (int) 26605L),
  ...
  ApplicationConfigurationType_CertificateGroups_DefaultUserTokenGroup_TrustListOutOfDate_ShelvingState(
      (int) 26771L),
  ApplicationConfigurationType_CertificateGroups_DefaultUserTokenGroup_TrustListOutOfDate_FirstInGroup(
      (int) 26815L),
  ...
  ProvisionableDevice_ApplicationName_Placeholder((int) 29885L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups((int) 29886L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups_DefaultApplicationGroup(
      (int) 29887L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups_DefaultApplicationGroup_TrustList(
      (int) 29888L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups_DefaultApplicationGroup_CertificateExpired(
      (int) 29928L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups_DefaultApplicationGroup_CertificateExpired_ShelvingState(
      (int) 30015L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups_DefaultApplicationGroup_CertificateExpired_FirstInGroup(
      (int) 30059L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups_DefaultApplicationGroup_TrustListOutOfDate(
      (int) 30094L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups_DefaultApplicationGroup_TrustListOutOfDate_ShelvingState(
      (int) 30181L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups_DefaultApplicationGroup_TrustListOutOfDate_FirstInGroup(
      (int) 30225L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups_DefaultHttpsGroup((int) 30259L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups_DefaultHttpsGroup_TrustList(
      (int) 30260L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups_DefaultHttpsGroup_CertificateExpired(
      (int) 30300L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups_DefaultHttpsGroup_CertificateExpired_ShelvingState(
      (int) 30387L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups_DefaultHttpsGroup_CertificateExpired_FirstInGroup(
      (int) 30431L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups_DefaultHttpsGroup_TrustListOutOfDate(
      (int) 30466L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups_DefaultHttpsGroup_TrustListOutOfDate_ShelvingState(
      (int) 30553L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups_DefaultHttpsGroup_TrustListOutOfDate_FirstInGroup(
      (int) 30597L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups_DefaultUserTokenGroup(
      (int) 30631L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups_DefaultUserTokenGroup_TrustList(
      (int) 30632L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups_DefaultUserTokenGroup_CertificateExpired(
      (int) 30672L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups_DefaultUserTokenGroup_CertificateExpired_ShelvingState(
      (int) 30759L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups_DefaultUserTokenGroup_CertificateExpired_FirstInGroup(
      (int) 30803L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups_DefaultUserTokenGroup_TrustListOutOfDate(
      (int) 30838L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups_DefaultUserTokenGroup_TrustListOutOfDate_ShelvingState(
      (int) 30925L),
  ProvisionableDevice_ApplicationName_Placeholder_CertificateGroups_DefaultUserTokenGroup_TrustListOutOfDate_FirstInGroup(
      (int) 30969L),
  Locations((int) 31915L),
  AlarmSuppressionGroupType_AlarmConditionInstance_Placeholder((int) 32065L),
  AlarmSuppressionGroupType_AlarmConditionInstance_Placeholder_ShelvingState((int) 32152L),
  AlarmSuppressionGroupType_AlarmConditionInstance_Placeholder_FirstInGroup((int) 32196L),
  ServerConfigurationType_TransactionDiagnostics((int) 32299L),
  ServerConfiguration_TransactionDiagnostics((int) 32336L),
  ApplicationConfigurationType_TransactionDiagnostics((int) 32349L),
  ProvisionableDeviceType_ApplicationName_Placeholder_TransactionDiagnostics((int) 32362L),
  ProvisionableDevice_ApplicationName_Placeholder_TransactionDiagnostics((int) 32375L),
  ...
  DataSetClasses((int) 32405L),
  DataSetClasses_SecurityGroups((int) 32412L),
  DataSetClasses_KeyPushTargets((int) 32424L),
  DataSetClasses_ConnectionName_Placeholder((int) 32435L),
  DataSetClasses_ConnectionName_Placeholder_Address((int) 32442L),
  DataSetClasses_ConnectionName_Placeholder_TransportSettings((int) 32447L),
  DataSetClasses_ConnectionName_Placeholder_Status((int) 32448L),
  DataSetClasses_ConnectionName_Placeholder_Diagnostics((int) 32452L),
  DataSetClasses_ConnectionName_Placeholder_Diagnostics_Counters((int) 32466L),
  DataSetClasses_ConnectionName_Placeholder_Diagnostics_LiveValues((int) 32497L),
  DataSetClasses_PublishedDataSets((int) 32515L),
  DataSetClasses_SubscribedDataSets((int) 32535L),
  DataSetClasses_PubSubConfiguration((int) 32546L),
  DataSetClasses_Status((int) 32575L),
  DataSetClasses_Diagnostics((int) 32579L),
  DataSetClasses_Diagnostics_Counters((int) 32593L),
  DataSetClasses_Diagnostics_LiveValues((int) 32624L),
  DataSetClasses_PubSubCapablities((int) 32633L),
  DataSetClasses_DataSetClasses((int) 32644L),
