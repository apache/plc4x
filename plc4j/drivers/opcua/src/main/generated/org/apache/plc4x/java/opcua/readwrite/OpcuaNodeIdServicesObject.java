...
public enum OpcuaNodeIdServicesObject {
  ...
  NumberRange_Encoding_DefaultBinary((int) 24250L),
  AliasNameVerboseDataType_Encoding_DefaultBinary((int) 24262L),
  ...
  AliasCategoryUpdateDataType_Encoding_DefaultBinary((int) 24338L),
  AliasUpdateDataType_Encoding_DefaultBinary((int) 24339L),
  NumberRange_Encoding_DefaultXml((int) 24352L),
  AliasNameVerboseDataType_Encoding_DefaultXml((int) 24353L),
  AliasCategoryUpdateDataType_Encoding_DefaultXml((int) 24354L),
  AliasUpdateDataType_Encoding_DefaultXml((int) 24355L),
  NumberRange_Encoding_DefaultJson((int) 24368L),
  AliasNameVerboseDataType_Encoding_DefaultJson((int) 24369L),
  AliasCategoryUpdateDataType_Encoding_DefaultJson((int) 24370L),
  AliasUpdateDataType_Encoding_DefaultJson((int) 24371L),
  DefaultJson((int) 24502L),
