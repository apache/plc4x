...
public class OptionSet extends ExtensionObjectDefinition implements Message {
  ...
  public static class OptionSetBuilderImpl
    ...
    public OptionSet build() {
      OptionSet optionSet = new OptionSet(value, validBits);
      return optionSet;
    }
  }
  ...
  public boolean equals(Object o) {
    ...
    OptionSet that = (OptionSet) o;
    return (getValue() == that.getValue())
        && (getValidBits() == that.getValidBits())
        && super.equals(that)
        && true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getValue(), getValidBits());
  }
