...
public enum OpcuaNodeIdServicesVariableCondition {
  ConditionType_EventId((int) 3865L),
  ConditionType_EventType((int) 3866L),
  ConditionType_SourceNode((int) 3867L),
  ConditionType_SourceName((int) 3868L),
  ConditionType_Time((int) 3869L),
  ConditionType_ReceiveTime((int) 3870L),
  ConditionType_LocalTime((int) 3871L),
  ConditionType_Message((int) 3872L),
  ConditionType_Severity((int) 3873L),
