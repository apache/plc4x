...
public class OpcuaAcknowledgeResponse extends MessagePDU implements Message {
  ...
  public static MessagePDUBuilder staticParseMessagePDUBuilder(ReadBuffer readBuffer,
    ...
    readBuffer.pushContext(WithOption.WithName("OpcuaAcknowledgeResponse"));
  ...
  protected void serializeMessagePDUChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("OpcuaAcknowledgeResponse"));
  ...
  public static class MessagePDUBuilderImpl implements MessagePDU.MessagePDUBuilder {
    ...
    public MessagePDUBuilderImpl(long version, OpcuaProtocolLimits limits) {
      this.version = version;
      this.limits = limits;
    }

    public MessagePDU build(ChunkType chunk) {
      return new OpcuaAcknowledgeResponse(chunk, version, limits);
    }
  }
}
