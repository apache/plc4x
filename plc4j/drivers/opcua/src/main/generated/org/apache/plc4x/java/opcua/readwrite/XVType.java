...
public class XVType extends ExtensionObjectDefinition implements Message {
  ...
  protected void serializeExtensionObjectDefinitionChild(WriteBuffer writeBuffer)
    ...
    // Simple Field (x)
    writeSimpleField("x", x, writeDouble(writeBuffer, 64));

    // Simple Field (value)
    writeSimpleField("value", value, writeFloat(writeBuffer, 32));

    writeBuffer.popContext("XVType");
  }
  ...
  public static class XVTypeBuilder
    ...
    public XVType build() {
      XVType xVType = new XVType(x, value);
      return xVType;
    }
  }
  ...
  public boolean equals(Object o) {
    ...
    XVType that = (XVType) o;
    return (getX() == that.getX()) && (getValue() == that.getValue()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getX(), getValue());
  }
