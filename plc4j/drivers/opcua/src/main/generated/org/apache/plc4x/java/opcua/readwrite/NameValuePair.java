...
public class NameValuePair extends ExtensionObjectDefinition implements Message {
  ...
  protected void serializeExtensionObjectDefinitionChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.pushContext("NameValuePair");
    ...
    writeBuffer.popContext("NameValuePair");
  }
  ...
  public static ExtensionObjectDefinitionBuilder staticParseExtensionObjectDefinitionBuilder(
    ...
    readBuffer.pullContext("NameValuePair");
    ...
    readBuffer.closeContext("NameValuePair");
    // Create the instance
    return new NameValuePairBuilderImpl(name, value);
  }

  public static class NameValuePairBuilderImpl
      implements ExtensionObjectDefinition.ExtensionObjectDefinitionBuilder {
    private final PascalString name;
    private final Variant value;

    public NameValuePairBuilderImpl(PascalString name, Variant value) {
      this.name = name;
      this.value = value;
    }
