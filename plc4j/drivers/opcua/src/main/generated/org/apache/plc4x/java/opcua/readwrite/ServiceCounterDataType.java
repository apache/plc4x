...
public class ServiceCounterDataType extends ExtensionObjectDefinition implements Message {
  ...
  protected void serializeExtensionObjectDefinitionChild(WriteBuffer writeBuffer)
    ...
    writeSimpleField("totalCount", totalCount, writeUnsignedLong(writeBuffer, 32));

    // Simple Field (errorCount)
    writeSimpleField("errorCount", errorCount, writeUnsignedLong(writeBuffer, 32));

    writeBuffer.popContext("ServiceCounterDataType");
  }
  ...
  public static ExtensionObjectDefinitionBuilder staticParseExtensionObjectDefinitionBuilder(
    ...
    long errorCount = readSimpleField("errorCount", readUnsignedLong(readBuffer, 32));
  ...
  public static class ServiceCounterDataTypeBuilderImpl
    ...
    public ServiceCounterDataType build() {
      ServiceCounterDataType serviceCounterDataType =
          new ServiceCounterDataType(totalCount, errorCount);
  ...
  public boolean equals(Object o) {
    ...
    ServiceCounterDataType that = (ServiceCounterDataType) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getTotalCount(), getErrorCount());
  }
