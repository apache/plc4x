...
public enum OpcuaNodeIdServicesVariableLog {
  LogObjectType_GetRecords_InputArguments((int) 19354),

  LogObjectType_GetRecords_OutputArguments((int) 19355),

  LogObjectType_MaxRecords((int) 19356),

  LogObjectType_MaxStorageDuration((int) 19357),
