...
public class VariantSByte extends Variant implements Message {
  ...
  public static VariantBuilder staticParseVariantBuilder(ReadBuffer readBuffer,
    ...
    readBuffer.pushContext(WithOption.WithName("VariantSByte"));
    ...
    // Array Field: value
    byte[] value = readBuffer.readBits(Math.toIntExact(((((arrayLength) == (null)) ? 1 : arrayLength)) * 8), WithOption.WithName("value"));
  ...
  protected void serializeVariantChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("VariantSByte"));
  ...
  public static class VariantBuilderImpl implements Variant.VariantBuilder {
    ...
    public VariantBuilderImpl(Integer arrayLength, byte[] value) {
      this.arrayLength = arrayLength;
      this.value = value;
    }
