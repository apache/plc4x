...
public class StatusCode implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeSimpleField("statusCode", statusCode, writeUnsignedLong(writeBuffer, 32));
  ...
  public static StatusCode staticParse(ReadBuffer readBuffer) throws ParseException {
    ...
    long statusCode = readSimpleField("statusCode", readUnsignedLong(readBuffer, 32));

    readBuffer.closeContext("StatusCode");
    // Create the instance
    StatusCode _statusCode;
    _statusCode = new StatusCode(statusCode);
    return _statusCode;
  }
  ...
  public boolean equals(Object o) {
    ...
    return (getStatusCode() == that.getStatusCode()) && true;
  }
