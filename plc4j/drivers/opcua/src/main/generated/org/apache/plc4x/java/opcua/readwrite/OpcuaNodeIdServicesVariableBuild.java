...
public enum OpcuaNodeIdServicesVariableBuild {
  BuildInfoType_ProductUri((int) 3052),

  BuildInfoType_ManufacturerName((int) 3053),

  BuildInfoType_ProductName((int) 3054),

  BuildInfoType_SoftwareVersion((int) 3055),

  BuildInfoType_BuildNumber((int) 3056),

  BuildInfoType_BuildDate((int) 3057);
