...
public class CreateMonitoredItemsResponse extends ExtensionObjectDefinition implements Message {
  ...
  public int getLengthInBits() {
    ...
    if (results != null) {
      int i = 0;
      for (MonitoredItemCreateResult element : results) {
  ...
  public static ExtensionObjectDefinitionBuilder staticParseExtensionObjectDefinitionBuilder(
            ...
            readComplex(
                () ->
                    (MonitoredItemCreateResult)
                        ExtensionObjectDefinition.staticParse(readBuffer, (int) (748)),
                readBuffer),
            noOfResults);
    ...
    // Create the instance
    return new CreateMonitoredItemsResponseBuilderImpl(responseHeader, results, diagnosticInfos);
  }
  ...
  public static class CreateMonitoredItemsResponseBuilderImpl
    ...
    public CreateMonitoredItemsResponseBuilderImpl(
        ResponseHeader responseHeader,
        List<MonitoredItemCreateResult> results,
        List<DiagnosticInfo> diagnosticInfos) {
      this.responseHeader = responseHeader;
    ...
    public CreateMonitoredItemsResponse build() {
      CreateMonitoredItemsResponse createMonitoredItemsResponse =
          new CreateMonitoredItemsResponse(responseHeader, results, diagnosticInfos);
