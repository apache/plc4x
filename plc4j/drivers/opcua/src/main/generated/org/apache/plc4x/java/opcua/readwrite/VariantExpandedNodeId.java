...
public class VariantExpandedNodeId extends Variant implements Message {
  ...
  protected void serializeVariantChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("VariantExpandedNodeId");
  }
  ...
  public int getLengthInBits() {
    ...
    if (value != null) {
      int i = 0;
      for (ExpandedNodeId element : value) {
  ...
  public static class VariantExpandedNodeIdBuilderImpl implements Variant.VariantBuilder {
    ...
    public VariantExpandedNodeId build(
        boolean arrayLengthSpecified,
        boolean arrayDimensionsSpecified,
        Integer noOfArrayDimensions,
        List<Boolean> arrayDimensions) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof VariantExpandedNodeId)) {
      return false;
    }
    VariantExpandedNodeId that = (VariantExpandedNodeId) o;
