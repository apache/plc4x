...
public class VariantExpandedNodeId extends Variant implements Message {
  ...
  public VariantExpandedNodeId(Boolean arrayLengthSpecified, Boolean arrayDimensionsSpecified,
  ...
  public static VariantBuilder staticParseVariantBuilder(ReadBuffer readBuffer,
    ...
    readBuffer.pushContext(WithOption.WithName("VariantExpandedNodeId"));
  ...
  protected void serializeVariantChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("VariantExpandedNodeId"));
  ...
  public int getLengthInBits() {
    ...
    VariantExpandedNodeId _value = this;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Optional Field: arrayLength
    if(arrayLength != null) {
      lengthInBits += 32;
    ...
    if (value != null) {
      int i = 0;
      for (ExpandedNodeId _element : value) {
  ...
  public static class VariantBuilderImpl implements Variant.VariantBuilder {
    ...
    public VariantBuilderImpl(Integer arrayLength, List<ExpandedNodeId> value) {
      this.arrayLength = arrayLength;
      this.value = value;
    }
    ...
    public Variant build(boolean arrayLengthSpecified, boolean arrayDimensionsSpecified,
      ...
      return new VariantExpandedNodeId(arrayLengthSpecified, arrayDimensionsSpecified, noOfArrayDimensions, arrayDimensions, arrayLength, value);
    }
  }
}
