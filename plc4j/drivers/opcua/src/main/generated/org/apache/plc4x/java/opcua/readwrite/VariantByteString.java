...
public class VariantByteString extends Variant implements Message {
  ...
  public int getLengthInBits() {
    ...
    if (value != null) {
      int i = 0;
      for (ByteStringArray element : value) {
  ...
  public static VariantBuilder staticParseVariantBuilder(
    ...
    // Create the instance
    return new VariantByteStringBuilderImpl(arrayLength, value);
  }

  public static class VariantByteStringBuilderImpl implements Variant.VariantBuilder {
    private final Integer arrayLength;
    private final List<ByteStringArray> value;

    public VariantByteStringBuilderImpl(Integer arrayLength, List<ByteStringArray> value) {
      this.arrayLength = arrayLength;
      this.value = value;
    }

    public VariantByteString build(
        boolean arrayLengthSpecified,
        boolean arrayDimensionsSpecified,
        Integer noOfArrayDimensions,
        List<Boolean> arrayDimensions) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof VariantByteString)) {
      return false;
    }
    VariantByteString that = (VariantByteString) o;
