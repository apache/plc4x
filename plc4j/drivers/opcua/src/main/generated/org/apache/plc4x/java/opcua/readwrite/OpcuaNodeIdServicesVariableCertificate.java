...
public enum OpcuaNodeIdServicesVariableCertificate {
  CertificateUpdatedAuditEventType_EventId((int) 12621L),
  CertificateUpdatedAuditEventType_EventType((int) 12622L),
  CertificateUpdatedAuditEventType_SourceNode((int) 12623L),
  CertificateUpdatedAuditEventType_SourceName((int) 12624L),
  CertificateUpdatedAuditEventType_Time((int) 12625L),
  CertificateUpdatedAuditEventType_ReceiveTime((int) 12626L),
  CertificateUpdatedAuditEventType_LocalTime((int) 12627L),
  CertificateUpdatedAuditEventType_Message((int) 12628L),
  CertificateUpdatedAuditEventType_Severity((int) 12629L),
  CertificateUpdatedAuditEventType_ActionTimeStamp((int) 12630L),
  CertificateUpdatedAuditEventType_Status((int) 12631L),
  CertificateUpdatedAuditEventType_ServerId((int) 12632L),
  CertificateUpdatedAuditEventType_ClientAuditEntryId((int) 12633L),
  CertificateUpdatedAuditEventType_ClientUserId((int) 12634L),
  CertificateExpirationAlarmType_EventId((int) 13226L),
  CertificateExpirationAlarmType_EventType((int) 13227L),
  CertificateExpirationAlarmType_SourceNode((int) 13228L),
  CertificateExpirationAlarmType_SourceName((int) 13229L),
  CertificateExpirationAlarmType_Time((int) 13230L),
  CertificateExpirationAlarmType_ReceiveTime((int) 13231L),
  CertificateExpirationAlarmType_LocalTime((int) 13232L),
  CertificateExpirationAlarmType_Message((int) 13233L),
  CertificateExpirationAlarmType_Severity((int) 13234L),
  CertificateExpirationAlarmType_ConditionClassId((int) 13235L),
  CertificateExpirationAlarmType_ConditionClassName((int) 13236L),
  CertificateExpirationAlarmType_ConditionName((int) 13237L),
  CertificateExpirationAlarmType_BranchId((int) 13238L),
  CertificateExpirationAlarmType_Retain((int) 13239L),
  CertificateExpirationAlarmType_EnabledState((int) 13240L),
  CertificateExpirationAlarmType_EnabledState_Id((int) 13241L),
  CertificateExpirationAlarmType_EnabledState_Name((int) 13242L),
  CertificateExpirationAlarmType_EnabledState_Number((int) 13243L),
  CertificateExpirationAlarmType_EnabledState_EffectiveDisplayName((int) 13244L),
  CertificateExpirationAlarmType_EnabledState_TransitionTime((int) 13245L),
  CertificateExpirationAlarmType_EnabledState_EffectiveTransitionTime((int) 13246L),
  CertificateExpirationAlarmType_EnabledState_TrueState((int) 13247L),
  CertificateExpirationAlarmType_EnabledState_FalseState((int) 13248L),
  CertificateExpirationAlarmType_Quality((int) 13249L),
  CertificateExpirationAlarmType_Quality_SourceTimestamp((int) 13250L),
  CertificateExpirationAlarmType_LastSeverity((int) 13251L),
  CertificateExpirationAlarmType_LastSeverity_SourceTimestamp((int) 13252L),
  CertificateExpirationAlarmType_Comment((int) 13253L),
  CertificateExpirationAlarmType_Comment_SourceTimestamp((int) 13254L),
  CertificateExpirationAlarmType_ClientUserId((int) 13255L),
  CertificateExpirationAlarmType_AddComment_InputArguments((int) 13259L),
  CertificateExpirationAlarmType_ConditionRefresh_InputArguments((int) 13261L),
  CertificateExpirationAlarmType_ConditionRefresh2_InputArguments((int) 13263L),
  CertificateExpirationAlarmType_AckedState((int) 13264L),
  CertificateExpirationAlarmType_AckedState_Id((int) 13265L),
  CertificateExpirationAlarmType_AckedState_Name((int) 13266L),
  CertificateExpirationAlarmType_AckedState_Number((int) 13267L),
  CertificateExpirationAlarmType_AckedState_EffectiveDisplayName((int) 13268L),
  CertificateExpirationAlarmType_AckedState_TransitionTime((int) 13269L),
  CertificateExpirationAlarmType_AckedState_EffectiveTransitionTime((int) 13270L),
  CertificateExpirationAlarmType_AckedState_TrueState((int) 13271L),
  CertificateExpirationAlarmType_AckedState_FalseState((int) 13272L),
  CertificateExpirationAlarmType_ConfirmedState((int) 13273L),
  CertificateExpirationAlarmType_ConfirmedState_Id((int) 13274L),
  CertificateExpirationAlarmType_ConfirmedState_Name((int) 13275L),
  CertificateExpirationAlarmType_ConfirmedState_Number((int) 13276L),
  CertificateExpirationAlarmType_ConfirmedState_EffectiveDisplayName((int) 13277L),
  CertificateExpirationAlarmType_ConfirmedState_TransitionTime((int) 13278L),
  CertificateExpirationAlarmType_ConfirmedState_EffectiveTransitionTime((int) 13279L),
  CertificateExpirationAlarmType_ConfirmedState_TrueState((int) 13280L),
  CertificateExpirationAlarmType_ConfirmedState_FalseState((int) 13281L),
  CertificateExpirationAlarmType_Acknowledge_InputArguments((int) 13283L),
  CertificateExpirationAlarmType_Confirm_InputArguments((int) 13285L),
  CertificateExpirationAlarmType_ActiveState((int) 13286L),
  CertificateExpirationAlarmType_ActiveState_Id((int) 13287L),
  CertificateExpirationAlarmType_ActiveState_Name((int) 13288L),
  CertificateExpirationAlarmType_ActiveState_Number((int) 13289L),
  CertificateExpirationAlarmType_ActiveState_EffectiveDisplayName((int) 13290L),
  CertificateExpirationAlarmType_ActiveState_TransitionTime((int) 13291L),
  CertificateExpirationAlarmType_ActiveState_EffectiveTransitionTime((int) 13292L),
  CertificateExpirationAlarmType_ActiveState_TrueState((int) 13293L),
  CertificateExpirationAlarmType_ActiveState_FalseState((int) 13294L),
  CertificateExpirationAlarmType_InputNode((int) 13295L),
  CertificateExpirationAlarmType_SuppressedState((int) 13296L),
  CertificateExpirationAlarmType_SuppressedState_Id((int) 13297L),
  CertificateExpirationAlarmType_SuppressedState_Name((int) 13298L),
  CertificateExpirationAlarmType_SuppressedState_Number((int) 13299L),
  CertificateExpirationAlarmType_SuppressedState_EffectiveDisplayName((int) 13300L),
  CertificateExpirationAlarmType_SuppressedState_TransitionTime((int) 13301L),
  CertificateExpirationAlarmType_SuppressedState_EffectiveTransitionTime((int) 13302L),
  CertificateExpirationAlarmType_SuppressedState_TrueState((int) 13303L),
  CertificateExpirationAlarmType_SuppressedState_FalseState((int) 13304L),
  CertificateExpirationAlarmType_ShelvingState_CurrentState((int) 13306L),
  CertificateExpirationAlarmType_ShelvingState_CurrentState_Id((int) 13307L),
  CertificateExpirationAlarmType_ShelvingState_CurrentState_Name((int) 13308L),
  CertificateExpirationAlarmType_ShelvingState_CurrentState_Number((int) 13309L),
  CertificateExpirationAlarmType_ShelvingState_CurrentState_EffectiveDisplayName((int) 13310L),
  CertificateExpirationAlarmType_ShelvingState_LastTransition((int) 13311L),
  CertificateExpirationAlarmType_ShelvingState_LastTransition_Id((int) 13312L),
  CertificateExpirationAlarmType_ShelvingState_LastTransition_Name((int) 13313L),
  CertificateExpirationAlarmType_ShelvingState_LastTransition_Number((int) 13314L),
  CertificateExpirationAlarmType_ShelvingState_LastTransition_TransitionTime((int) 13315L),
  CertificateExpirationAlarmType_ShelvingState_LastTransition_EffectiveTransitionTime((int) 13316L),
  CertificateExpirationAlarmType_ShelvingState_UnshelveTime((int) 13317L),
  CertificateExpirationAlarmType_ShelvingState_TimedShelve_InputArguments((int) 13321L),
  CertificateExpirationAlarmType_SuppressedOrShelved((int) 13322L),
  CertificateExpirationAlarmType_MaxTimeShelved((int) 13323L),
  CertificateExpirationAlarmType_NormalState((int) 13324L),
  ...
  CertificateExpirationAlarmType_ConditionSubClassId((int) 17044L),
  CertificateExpirationAlarmType_ConditionSubClassName((int) 17045L),
  CertificateExpirationAlarmType_OutOfServiceState((int) 17046L),
  CertificateExpirationAlarmType_OutOfServiceState_Id((int) 17047L),
  CertificateExpirationAlarmType_OutOfServiceState_Name((int) 17048L),
  CertificateExpirationAlarmType_OutOfServiceState_Number((int) 17049L),
  CertificateExpirationAlarmType_OutOfServiceState_EffectiveDisplayName((int) 17050L),
  CertificateExpirationAlarmType_OutOfServiceState_TransitionTime((int) 17051L),
  CertificateExpirationAlarmType_OutOfServiceState_EffectiveTransitionTime((int) 17052L),
  CertificateExpirationAlarmType_OutOfServiceState_TrueState((int) 17053L),
  CertificateExpirationAlarmType_OutOfServiceState_FalseState((int) 17054L),
  CertificateExpirationAlarmType_SilenceState((int) 17055L),
  CertificateExpirationAlarmType_SilenceState_Id((int) 17056L),
  CertificateExpirationAlarmType_SilenceState_Name((int) 17057L),
  CertificateExpirationAlarmType_SilenceState_Number((int) 17058L),
  CertificateExpirationAlarmType_SilenceState_EffectiveDisplayName((int) 17059L),
  CertificateExpirationAlarmType_SilenceState_TransitionTime((int) 17060L),
  CertificateExpirationAlarmType_SilenceState_EffectiveTransitionTime((int) 17061L),
  CertificateExpirationAlarmType_SilenceState_TrueState((int) 17062L),
  CertificateExpirationAlarmType_SilenceState_FalseState((int) 17063L),
  CertificateExpirationAlarmType_AudibleEnabled((int) 17064L),
  CertificateExpirationAlarmType_AudibleSound((int) 17065L),
  CertificateExpirationAlarmType_OnDelay((int) 17070L),
  CertificateExpirationAlarmType_OffDelay((int) 17071L),
  CertificateExpirationAlarmType_FirstInGroupFlag((int) 17072L),
  CertificateExpirationAlarmType_ReAlarmTime((int) 17075L),
  CertificateExpirationAlarmType_ReAlarmRepeatCount((int) 17076L),
  CertificateExpirationAlarmType_ShelvingState_AvailableStates((int) 17700L),
  CertificateExpirationAlarmType_ShelvingState_AvailableTransitions((int) 17701L),
  CertificateExpirationAlarmType_AudibleSound_ListId((int) 17970L),
  CertificateExpirationAlarmType_AudibleSound_AgencyId((int) 17971L),
  CertificateExpirationAlarmType_AudibleSound_VersionId((int) 17972L),
  CertificateExpirationAlarmType_LatchedState((int) 18645L),
  CertificateExpirationAlarmType_LatchedState_Id((int) 18646L),
  CertificateExpirationAlarmType_LatchedState_Name((int) 18647L),
  CertificateExpirationAlarmType_LatchedState_Number((int) 18648L),
  CertificateExpirationAlarmType_LatchedState_EffectiveDisplayName((int) 18649L),
  CertificateExpirationAlarmType_LatchedState_TransitionTime((int) 18650L),
  CertificateExpirationAlarmType_LatchedState_EffectiveTransitionTime((int) 18651L),
  CertificateExpirationAlarmType_LatchedState_TrueState((int) 18652L),
  CertificateExpirationAlarmType_LatchedState_FalseState((int) 18653L),
  ...
  CertificateGroupFolderType_AdditionalGroup_Placeholder_TrustList_MaxByteStringLength(
      (int) 24255L),
  CertificateExpirationAlarmType_Suppress2_InputArguments((int) 24489L),
  CertificateExpirationAlarmType_Unsuppress2_InputArguments((int) 24491L),
  CertificateExpirationAlarmType_RemoveFromService2_InputArguments((int) 24493L),
  CertificateExpirationAlarmType_PlaceInService2_InputArguments((int) 24495L),
  CertificateExpirationAlarmType_Reset2_InputArguments((int) 24497L),
  ...
  CertificateGroupFolderType_AdditionalGroup_Placeholder_TrustListOutOfDate_Reset2_InputArguments(
      (int) 24617L),
  CertificateExpirationAlarmType_ShelvingState_TimedShelve2_InputArguments((int) 24955L),
  CertificateExpirationAlarmType_ShelvingState_Unshelve2_InputArguments((int) 24957L),
  CertificateExpirationAlarmType_ShelvingState_OneShotShelve2_InputArguments((int) 24959L),
  ...
  CertificateGroupFolderType_AdditionalGroup_Placeholder_TrustListOutOfDate_ShelvingState_OneShotShelve2_InputArguments(
      (int) 25055L),
  CertificateExpirationAlarmType_GetGroupMemberships_OutputArguments((int) 25174L),
  ...
  CertificateUpdatedAuditEventType_ConditionClassId((int) 32031L),
  CertificateUpdatedAuditEventType_ConditionClassName((int) 32032L),
  CertificateUpdatedAuditEventType_ConditionSubClassId((int) 32033L),
  CertificateUpdatedAuditEventType_ConditionSubClassName((int) 32034L),
  CertificateExpirationAlarmType_SupportsFilteredRetain((int) 32242L),
  ...
  CertificateUpdateRequestedAuditEventType_EventId((int) 32307L),
  CertificateUpdateRequestedAuditEventType_EventType((int) 32308L),
  CertificateUpdateRequestedAuditEventType_SourceNode((int) 32309L),
  CertificateUpdateRequestedAuditEventType_SourceName((int) 32310L),
  CertificateUpdateRequestedAuditEventType_Time((int) 32311L),
  CertificateUpdateRequestedAuditEventType_ReceiveTime((int) 32312L),
  CertificateUpdateRequestedAuditEventType_LocalTime((int) 32313L),
  CertificateUpdateRequestedAuditEventType_Message((int) 32314L),
  CertificateUpdateRequestedAuditEventType_Severity((int) 32315L),
  CertificateUpdateRequestedAuditEventType_ConditionClassId((int) 32316L),
  CertificateUpdateRequestedAuditEventType_ConditionClassName((int) 32317L),
  CertificateUpdateRequestedAuditEventType_ConditionSubClassId((int) 32318L),
  CertificateUpdateRequestedAuditEventType_ConditionSubClassName((int) 32319L),
  CertificateUpdateRequestedAuditEventType_ActionTimeStamp((int) 32320L),
  CertificateUpdateRequestedAuditEventType_Status((int) 32321L),
  CertificateUpdateRequestedAuditEventType_ServerId((int) 32322L),
  CertificateUpdateRequestedAuditEventType_ClientAuditEntryId((int) 32323L),
  CertificateUpdateRequestedAuditEventType_ClientUserId((int) 32324L),
  CertificateUpdateRequestedAuditEventType_MethodId((int) 32325L),
  CertificateUpdateRequestedAuditEventType_InputArguments((int) 32326L);
