...
public class VariantDouble extends Variant implements Message {
  ...
  public static VariantBuilder staticParseVariantBuilder(ReadBuffer readBuffer,
    ...
    readBuffer.pushContext(WithOption.WithName("VariantDouble"));
    ...
    // Array Field: value
    List<Double> value = FieldReaderFactory.readCountArrayField(DataReaderFactory.readDouble(readBuffer, 64), (((arrayLength) == (null)) ? 1 : arrayLength), WithOption.WithName("value"));
  ...
  protected void serializeVariantChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("VariantDouble"));
    ...
    // Array Field: value
    FieldWriterFactory.writeSimpleTypeArrayField(value, DataWriterFactory.writeDouble(writeBuffer, 64), WithOption.WithName("value"));
  ...
  public static class VariantBuilderImpl implements Variant.VariantBuilder {
    ...
    public VariantBuilderImpl(Integer arrayLength, List<Double> value) {
      this.arrayLength = arrayLength;
      this.value = value;
    }
