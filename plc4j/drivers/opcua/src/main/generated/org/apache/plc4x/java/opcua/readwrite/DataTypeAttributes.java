...
public class DataTypeAttributes extends ExtensionObjectDefinition implements Message {
  ...
  protected void serializeExtensionObjectDefinitionChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.pushContext("DataTypeAttributes");
    ...
    writeBuffer.popContext("DataTypeAttributes");
  }
  ...
  public static ExtensionObjectDefinitionBuilder staticParseExtensionObjectDefinitionBuilder(
    ...
    readBuffer.pullContext("DataTypeAttributes");
    ...
    readBuffer.closeContext("DataTypeAttributes");
    // Create the instance
    return new DataTypeAttributesBuilderImpl(
        specifiedAttributes, displayName, description, writeMask, userWriteMask, isAbstract);
  }

  public static class DataTypeAttributesBuilderImpl
    ...
    public DataTypeAttributesBuilderImpl(
        long specifiedAttributes,
        LocalizedText displayName,
        LocalizedText description,
        long writeMask,
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof DataTypeAttributes)) {
      return false;
    }
    DataTypeAttributes that = (DataTypeAttributes) o;
