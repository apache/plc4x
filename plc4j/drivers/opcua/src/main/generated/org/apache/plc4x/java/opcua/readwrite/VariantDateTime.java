 ...
 */
public class VariantDateTime extends Variant implements Message {
  ...
  public static VariantBuilder staticParseVariantBuilder(ReadBuffer readBuffer,
    ...
    readBuffer.pushContext(WithOption.WithName("VariantDateTime"));
    ...
    // Array Field: value
    List<Long> value = FieldReaderFactory.readCountArrayField(DataReaderFactory.readSignedLong(readBuffer, 64), (((arrayLength) == (null)) ? 1 : arrayLength), WithOption.WithName("value"));
  ...
  protected void serializeVariantChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("VariantDateTime"));
    ...
    // Array Field: value
    FieldWriterFactory.writeSimpleTypeArrayField(value, DataWriterFactory.writeSignedLong(writeBuffer, 64), WithOption.WithName("value"));
