...
public class VariantDateTime extends Variant implements Message {
  ...
  protected void serializeVariantChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("VariantDateTime");
  }
  ...
  public static VariantDateTimeBuilder staticParseBuilder(
      ReadBuffer readBuffer, Boolean arrayLengthSpecified) throws ParseException {
    readBuffer.pullContext("VariantDateTime");
    ...
    readBuffer.closeContext("VariantDateTime");
    // Create the instance
    return new VariantDateTimeBuilder(arrayLength, value);
  }

  public static class VariantDateTimeBuilder implements Variant.VariantBuilder {
    private final Integer arrayLength;
    private final List<Long> value;

    public VariantDateTimeBuilder(Integer arrayLength, List<Long> value) {

      this.arrayLength = arrayLength;
      this.value = value;
    }

    public VariantDateTime build(
        boolean arrayLengthSpecified,
        boolean arrayDimensionsSpecified,
        Integer noOfArrayDimensions,
        List<Boolean> arrayDimensions) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof VariantDateTime)) {
      return false;
    }
    VariantDateTime that = (VariantDateTime) o;
