...
public class CallResponse extends ExtensionObjectDefinition implements Message {
  ...
  protected void serializeExtensionObjectDefinitionChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.pushContext("CallResponse");
    ...
    writeBuffer.popContext("CallResponse");
  }
  ...
  public int getLengthInBits() {
    ...
    if (results != null) {
      int i = 0;
      for (CallMethodResult element : results) {
  ...
  public static ExtensionObjectDefinitionBuilder staticParseExtensionObjectDefinitionBuilder(
    ...
    readBuffer.pullContext("CallResponse");
    ...
    List<CallMethodResult> results =
        readCountArrayField(
            ...
            readComplex(
                () ->
                    (CallMethodResult)
                        ExtensionObjectDefinition.staticParse(readBuffer, (int) (709)),
                readBuffer),
            noOfResults);
    ...
    readBuffer.closeContext("CallResponse");
    // Create the instance
    return new CallResponseBuilderImpl(responseHeader, results, diagnosticInfos);
  }

  public static class CallResponseBuilderImpl
      implements ExtensionObjectDefinition.ExtensionObjectDefinitionBuilder {
    private final ResponseHeader responseHeader;
    private final List<CallMethodResult> results;
    private final List<DiagnosticInfo> diagnosticInfos;

    public CallResponseBuilderImpl(
        ResponseHeader responseHeader,
        List<CallMethodResult> results,
        List<DiagnosticInfo> diagnosticInfos) {
      this.responseHeader = responseHeader;
    ...
    public CallResponse build() {
      CallResponse callResponse = new CallResponse(responseHeader, results, diagnosticInfos);
      return callResponse;
    }
  }
