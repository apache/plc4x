...
public class CallResponse extends ExtensionObjectDefinition implements Message {
  ...
  public static CallResponseBuilder staticParseBuilder(ReadBuffer readBuffer, String identifier)
    ...
    List<ExtensionObjectDefinition> results =
        readCountArrayField(
            "results",
            new DataReaderComplexDefault<>(
                () -> ExtensionObjectDefinition.staticParse(readBuffer, (String) ("709")),
                readBuffer),
            noOfResults);
