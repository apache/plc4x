...
public class VariantNull extends Variant implements Message {
  ...
  public static VariantBuilder staticParseVariantBuilder(ReadBuffer readBuffer) throws
      BufferException {
    readBuffer.pushContext(WithOption.WithName("VariantNull"));
  ...
  protected void serializeVariantChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("VariantNull"));
