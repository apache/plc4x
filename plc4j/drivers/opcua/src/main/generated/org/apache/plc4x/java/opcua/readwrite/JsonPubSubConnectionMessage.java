...
public class JsonPubSubConnectionMessage extends ExtensionObjectDefinition implements Message {
  ...
  protected void serializeExtensionObjectDefinitionChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.pushContext("JsonPubSubConnectionMessage");
    ...
    writeBuffer.popContext("JsonPubSubConnectionMessage");
  }
  ...
  public static ExtensionObjectDefinitionBuilder staticParseExtensionObjectDefinitionBuilder(
    ...
    readBuffer.pullContext("JsonPubSubConnectionMessage");
    ...
    readBuffer.closeContext("JsonPubSubConnectionMessage");
    // Create the instance
    return new JsonPubSubConnectionMessageBuilderImpl(
        messageId, messageType, publisherId, timestamp, connection);
  }

  public static class JsonPubSubConnectionMessageBuilderImpl
    ...
    public JsonPubSubConnectionMessageBuilderImpl(
        PascalString messageId,
        PascalString messageType,
        PascalString publisherId,
        long timestamp,
    ...
    public JsonPubSubConnectionMessage build() {
      JsonPubSubConnectionMessage jsonPubSubConnectionMessage =
          new JsonPubSubConnectionMessage(
              messageId, messageType, publisherId, timestamp, connection);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof JsonPubSubConnectionMessage)) {
      return false;
    }
    JsonPubSubConnectionMessage that = (JsonPubSubConnectionMessage) o;
