...
public enum JsonNetworkMessageContentMask {
  jsonNetworkMessageContentMaskNone((long) 0L),
  jsonNetworkMessageContentMaskNetworkMessageHeader((long) 1L),
  jsonNetworkMessageContentMaskDataSetMessageHeader((long) 2L),
  ...
  static {
    map = new HashMap<>();
    for (JsonNetworkMessageContentMask value : JsonNetworkMessageContentMask.values()) {
  ...
  public static JsonNetworkMessageContentMask enumForValue(long value) {
