 ...
 */
public class InformationObjectWithoutTime_MEASURED_VALUE_NORMALISED_VALUE extends InformationObjectWithoutTime implements Message {
  protected final NormalizedValue nva;

  protected final QualityDescriptor qds;

  public InformationObjectWithoutTime_MEASURED_VALUE_NORMALISED_VALUE(Integer address,
  ...
  public static InformationObjectWithoutTimeBuilder staticParseInformationObjectWithoutTimeBuilder(
      ...
      BufferException {
    readBuffer.pushContext(WithOption.WithName("InformationObjectWithoutTime_MEASURED_VALUE_NORMALISED_VALUE"), WithByteBasedOption.WithByteOrder("LITTLE_ENDIAN"));
  ...
  protected void serializeInformationObjectWithoutTimeChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("InformationObjectWithoutTime_MEASURED_VALUE_NORMALISED_VALUE"), WithByteBasedOption.WithByteOrder("LITTLE_ENDIAN"));
  ...
  public static class InformationObjectWithoutTimeBuilderImpl implements InformationObjectWithoutTime.InformationObjectWithoutTimeBuilder {
    ...
    public InformationObjectWithoutTimeBuilderImpl(NormalizedValue nva, QualityDescriptor qds) {
      this.nva = nva;
      this.qds = qds;
    }

    public InformationObjectWithoutTime build(int address) {
      return new InformationObjectWithoutTime_MEASURED_VALUE_NORMALISED_VALUE(address, nva, qds);
    }
  }
}
