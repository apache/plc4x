...
public class InformationObjectWithoutTime_DOUBLE_POINT_INFORMATION
  ...
  public InformationObjectWithoutTime_DOUBLE_POINT_INFORMATION(
      int address, DoublePointInformation diq) {
    super(address);
    this.diq = diq;
  }
  ...
  protected void serializeInformationObjectWithoutTimeChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.pushContext("InformationObjectWithoutTime_DOUBLE_POINT_INFORMATION");
  ...
  public static InformationObjectWithoutTimeBuilder staticParseInformationObjectWithoutTimeBuilder(
    ...
    readBuffer.pullContext("InformationObjectWithoutTime_DOUBLE_POINT_INFORMATION");
    ...
    // Create the instance
    return new InformationObjectWithoutTime_DOUBLE_POINT_INFORMATIONBuilderImpl(diq);
  }

  public static class InformationObjectWithoutTime_DOUBLE_POINT_INFORMATIONBuilderImpl
      implements InformationObjectWithoutTime.InformationObjectWithoutTimeBuilder {
    private final DoublePointInformation diq;

    public InformationObjectWithoutTime_DOUBLE_POINT_INFORMATIONBuilderImpl(
        DoublePointInformation diq) {
      this.diq = diq;
    }

    public InformationObjectWithoutTime_DOUBLE_POINT_INFORMATION build(int address) {
      InformationObjectWithoutTime_DOUBLE_POINT_INFORMATION
          informationObjectWithoutTime_DOUBLE_POINT_INFORMATION =
              new InformationObjectWithoutTime_DOUBLE_POINT_INFORMATION(address, diq);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof InformationObjectWithoutTime_DOUBLE_POINT_INFORMATION)) {
      return false;
    }
    InformationObjectWithoutTime_DOUBLE_POINT_INFORMATION that =
        (InformationObjectWithoutTime_DOUBLE_POINT_INFORMATION) o;
