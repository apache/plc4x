 ...
 */
public class InformationObjectWithTreeByteTime_STEP_POSITION_INFORMATION extends InformationObjectWithTreeByteTime implements Message {
  ...
  public InformationObjectWithTreeByteTime_STEP_POSITION_INFORMATION(Integer address,
  ...
  public static InformationObjectWithTreeByteTimeBuilder staticParseInformationObjectWithTreeByteTimeBuilder(
      ...
      BufferException {
    readBuffer.pushContext(WithOption.WithName("InformationObjectWithTreeByteTime_STEP_POSITION_INFORMATION"), WithOption.WithFloatEncoding("IEEE754"), WithOption.WithSignedIntegerEncoding("twos-complement"), WithOption.WithUnsignedIntegerEncoding("unsigned-binary"), WithByteBasedOption.WithByteOrder("LITTLE_ENDIAN"), WithOption.WithStringEncoding("UTF8"));
    int startPos = readBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: vti
    ValueWithTransientStateIndication vti = FieldReaderFactory.readSimpleField(DataReaderFactory.readComplex(() -> DataReaderFactory.castToDeclaredType(ValueWithTransientStateIndication.class, ValueWithTransientStateIndication.staticParse(readBuffer)), readBuffer), WithOption.WithName("vti"), WithOption.WithFloatEncoding("IEEE754"), WithOption.WithSignedIntegerEncoding("twos-complement"), WithOption.WithUnsignedIntegerEncoding("unsigned-binary"), WithByteBasedOption.WithByteOrder("LITTLE_ENDIAN"), WithOption.WithStringEncoding("UTF8"));
    ...
    return new InformationObjectWithTreeByteTimeBuilderImpl(vti, qds, cp24Time2a);
  }

  protected void serializeInformationObjectWithTreeByteTimeChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("InformationObjectWithTreeByteTime_STEP_POSITION_INFORMATION"), WithOption.WithFloatEncoding("IEEE754"), WithOption.WithSignedIntegerEncoding("twos-complement"), WithOption.WithUnsignedIntegerEncoding("unsigned-binary"), WithByteBasedOption.WithByteOrder("LITTLE_ENDIAN"), WithOption.WithStringEncoding("UTF8"));
  ...
  public static class InformationObjectWithTreeByteTimeBuilderImpl implements InformationObjectWithTreeByteTime.InformationObjectWithTreeByteTimeBuilder {
    ...
    public InformationObjectWithTreeByteTimeBuilderImpl(ValueWithTransientStateIndication vti,
    ...
    public InformationObjectWithTreeByteTime build(int address) {
      return new InformationObjectWithTreeByteTime_STEP_POSITION_INFORMATION(address, vti, qds, cp24Time2a);
    }
  }
}
