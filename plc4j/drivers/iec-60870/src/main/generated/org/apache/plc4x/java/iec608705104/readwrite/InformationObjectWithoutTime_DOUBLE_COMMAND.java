 ...
 */
public class InformationObjectWithoutTime_DOUBLE_COMMAND extends InformationObjectWithoutTime implements Message {
  protected final DoubleCommand dco;

  public InformationObjectWithoutTime_DOUBLE_COMMAND(Integer address, DoubleCommand dco) {
    super(address);
    this.dco = dco;
  }
  ...
  public static class InformationObjectWithoutTimeBuilderImpl implements InformationObjectWithoutTime.InformationObjectWithoutTimeBuilder {
    ...
    public InformationObjectWithoutTimeBuilderImpl(DoubleCommand dco) {
      this.dco = dco;
    }

    public InformationObjectWithoutTime build(int address) {
      return new InformationObjectWithoutTime_DOUBLE_COMMAND(address, dco);
    }
  }
}
