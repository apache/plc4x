...
public class InformationObjectWithSevenByteTime_MEASURED_VALUE_SCALED_VALUE
  ...
  protected void serializeInformationObjectWithSevenByteTimeChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.pushContext("InformationObjectWithSevenByteTime_MEASURED_VALUE_SCALED_VALUE");
  ...
  public int getLengthInBits() {
    ...
    InformationObjectWithSevenByteTime_MEASURED_VALUE_SCALED_VALUE _value = this;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
  ...
  public static InformationObjectWithSevenByteTimeBuilder
    ...
    readBuffer.pullContext("InformationObjectWithSevenByteTime_MEASURED_VALUE_SCALED_VALUE");
    ...
    readBuffer.closeContext("InformationObjectWithSevenByteTime_MEASURED_VALUE_SCALED_VALUE");
    // Create the instance
    return new InformationObjectWithSevenByteTime_MEASURED_VALUE_SCALED_VALUEBuilderImpl(
        sva, qds, cp56Time2a);
  }

  public static class InformationObjectWithSevenByteTime_MEASURED_VALUE_SCALED_VALUEBuilderImpl
    ...
    public InformationObjectWithSevenByteTime_MEASURED_VALUE_SCALED_VALUE build(int address) {
      InformationObjectWithSevenByteTime_MEASURED_VALUE_SCALED_VALUE
          informationObjectWithSevenByteTime_MEASURED_VALUE_SCALED_VALUE =
              new InformationObjectWithSevenByteTime_MEASURED_VALUE_SCALED_VALUE(
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof InformationObjectWithSevenByteTime_MEASURED_VALUE_SCALED_VALUE)) {
      return false;
    }
    InformationObjectWithSevenByteTime_MEASURED_VALUE_SCALED_VALUE that =
        (InformationObjectWithSevenByteTime_MEASURED_VALUE_SCALED_VALUE) o;
