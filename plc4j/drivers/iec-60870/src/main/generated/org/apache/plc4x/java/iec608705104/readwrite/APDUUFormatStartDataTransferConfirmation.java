...
public class APDUUFormatStartDataTransferConfirmation extends APDU implements Message {
  ...
  protected void serializeAPDUChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("APDUUFormatStartDataTransferConfirmation");
    ...
    writeBuffer.popContext("APDUUFormatStartDataTransferConfirmation");
  }
  ...
  public static APDUBuilder staticParseAPDUBuilder(ReadBuffer readBuffer) throws ParseException {
    readBuffer.pullContext("APDUUFormatStartDataTransferConfirmation");
    ...
    readBuffer.closeContext("APDUUFormatStartDataTransferConfirmation");
    // Create the instance
    return new APDUUFormatStartDataTransferConfirmationBuilderImpl();
  }

  public static class APDUUFormatStartDataTransferConfirmationBuilderImpl
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof APDUUFormatStartDataTransferConfirmation)) {
      return false;
    }
    APDUUFormatStartDataTransferConfirmation that = (APDUUFormatStartDataTransferConfirmation) o;
