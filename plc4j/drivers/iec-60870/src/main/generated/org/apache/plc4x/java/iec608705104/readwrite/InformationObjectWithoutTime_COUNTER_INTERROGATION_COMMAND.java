...
public class InformationObjectWithoutTime_COUNTER_INTERROGATION_COMMAND
  ...
  protected void serializeInformationObjectWithoutTimeChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.pushContext("InformationObjectWithoutTime_COUNTER_INTERROGATION_COMMAND");
  ...
  public static InformationObjectWithoutTimeBuilder staticParseInformationObjectWithoutTimeBuilder(
    ...
    readBuffer.pullContext("InformationObjectWithoutTime_COUNTER_INTERROGATION_COMMAND");
    ...
    readBuffer.closeContext("InformationObjectWithoutTime_COUNTER_INTERROGATION_COMMAND");
    // Create the instance
    return new InformationObjectWithoutTime_COUNTER_INTERROGATION_COMMANDBuilderImpl(qcc);
  }

  public static class InformationObjectWithoutTime_COUNTER_INTERROGATION_COMMANDBuilderImpl
    ...
    public InformationObjectWithoutTime_COUNTER_INTERROGATION_COMMANDBuilderImpl(
        QualifierOfCounterInterrogationCommand qcc) {
      this.qcc = qcc;
    }

    public InformationObjectWithoutTime_COUNTER_INTERROGATION_COMMAND build(int address) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof InformationObjectWithoutTime_COUNTER_INTERROGATION_COMMAND)) {
      return false;
    }
    InformationObjectWithoutTime_COUNTER_INTERROGATION_COMMAND that =
        (InformationObjectWithoutTime_COUNTER_INTERROGATION_COMMAND) o;
