...
public class QualityDescriptor implements Message {
  ...
  public QualityDescriptor(
      boolean invalid, boolean notTopical, boolean substituted, boolean blocked, boolean overflow) {
    super();
  ...
  public static QualityDescriptor staticParse(ReadBuffer readBuffer) throws ParseException {
    ...
    // Create the instance
    QualityDescriptor _qualityDescriptor;
    _qualityDescriptor = new QualityDescriptor(invalid, notTopical, substituted, blocked, overflow);
    return _qualityDescriptor;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof QualityDescriptor)) {
      return false;
    }
    QualityDescriptor that = (QualityDescriptor) o;
  ...
  public int hashCode() {
    return Objects.hash(
        getInvalid(), getNotTopical(), getSubstituted(), getBlocked(), getOverflow());
  }
