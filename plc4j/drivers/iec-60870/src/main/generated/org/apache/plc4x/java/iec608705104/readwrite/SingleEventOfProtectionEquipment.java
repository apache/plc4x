...
public class SingleEventOfProtectionEquipment implements Message {
  ...
  protected final byte eventState;

  public SingleEventOfProtectionEquipment(
      boolean invalid,
      boolean notTopical,
      boolean substituted,
      boolean blocked,
  ...
  public int getLengthInBits() {
    int lengthInBits = 0;
    SingleEventOfProtectionEquipment _value = this;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
  ...
  public static SingleEventOfProtectionEquipment staticParse(ReadBuffer readBuffer)
    ...
    // Create the instance
    SingleEventOfProtectionEquipment _singleEventOfProtectionEquipment;
    _singleEventOfProtectionEquipment =
        new SingleEventOfProtectionEquipment(
            invalid, notTopical, substituted, blocked, elapsedTimeInvalid, eventState);
    return _singleEventOfProtectionEquipment;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SingleEventOfProtectionEquipment)) {
      return false;
    }
    SingleEventOfProtectionEquipment that = (SingleEventOfProtectionEquipment) o;
