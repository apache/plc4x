 ...
 */
public class InformationObjectWithoutTime_INTEGRATED_TOTALS extends InformationObjectWithoutTime implements Message {
  protected final BinaryCounterReading bcr;

  public InformationObjectWithoutTime_INTEGRATED_TOTALS(Integer address, BinaryCounterReading bcr) {
    super(address);
    this.bcr = bcr;
  }
  ...
  public static class InformationObjectWithoutTimeBuilderImpl implements InformationObjectWithoutTime.InformationObjectWithoutTimeBuilder {
    ...
    public InformationObjectWithoutTimeBuilderImpl(BinaryCounterReading bcr) {
      this.bcr = bcr;
    }

    public InformationObjectWithoutTime build(int address) {
      return new InformationObjectWithoutTime_INTEGRATED_TOTALS(address, bcr);
    }
  }
}
