...
public class APDUUFormatTestFrameActivation extends APDU implements Message {
  ...
  protected void serializeAPDUChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("APDUUFormatTestFrameActivation");
    ...
    writeBuffer.popContext("APDUUFormatTestFrameActivation");
  }
  ...
  public int getLengthInBits() {
    ...
    APDUUFormatTestFrameActivation _value = this;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
  ...
  public static APDUBuilder staticParseAPDUBuilder(ReadBuffer readBuffer) throws ParseException {
    readBuffer.pullContext("APDUUFormatTestFrameActivation");
    ...
    readBuffer.closeContext("APDUUFormatTestFrameActivation");
    // Create the instance
    return new APDUUFormatTestFrameActivationBuilderImpl();
  }

  public static class APDUUFormatTestFrameActivationBuilderImpl implements APDU.APDUBuilder {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof APDUUFormatTestFrameActivation)) {
      return false;
    }
    APDUUFormatTestFrameActivation that = (APDUUFormatTestFrameActivation) o;
