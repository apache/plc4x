...
public class QualifierOfResetProcessCommand implements Message {
  ...
  public static QualifierOfResetProcessCommand staticParse(ReadBuffer readBuffer) throws
      BufferException {
    readBuffer.pushContext(WithOption.WithName("QualifierOfResetProcessCommand"), WithByteBasedOption.WithByteOrder("LITTLE_ENDIAN"));
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("QualifierOfResetProcessCommand"), WithByteBasedOption.WithByteOrder("LITTLE_ENDIAN"));
