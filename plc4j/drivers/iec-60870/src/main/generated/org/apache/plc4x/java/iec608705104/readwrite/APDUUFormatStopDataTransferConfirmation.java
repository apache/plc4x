...
public class APDUUFormatStopDataTransferConfirmation extends APDU implements Message {
  ...
  protected void serializeAPDUChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("APDUUFormatStopDataTransferConfirmation");
    ...
    writeBuffer.popContext("APDUUFormatStopDataTransferConfirmation");
  }
  ...
  public static APDUBuilder staticParseAPDUBuilder(ReadBuffer readBuffer) throws ParseException {
    readBuffer.pullContext("APDUUFormatStopDataTransferConfirmation");
    ...
    readBuffer.closeContext("APDUUFormatStopDataTransferConfirmation");
    // Create the instance
    return new APDUUFormatStopDataTransferConfirmationBuilderImpl();
  }

  public static class APDUUFormatStopDataTransferConfirmationBuilderImpl
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof APDUUFormatStopDataTransferConfirmation)) {
      return false;
    }
    APDUUFormatStopDataTransferConfirmation that = (APDUUFormatStopDataTransferConfirmation) o;
