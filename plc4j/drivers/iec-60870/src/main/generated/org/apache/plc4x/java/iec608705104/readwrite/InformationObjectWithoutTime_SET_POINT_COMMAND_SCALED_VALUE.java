...
public class InformationObjectWithoutTime_SET_POINT_COMMAND_SCALED_VALUE
  ...
  protected void serializeInformationObjectWithoutTimeChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.pushContext("InformationObjectWithoutTime_SET_POINT_COMMAND_SCALED_VALUE");
  ...
  public static InformationObjectWithoutTimeBuilder staticParseInformationObjectWithoutTimeBuilder(
    ...
    readBuffer.pullContext("InformationObjectWithoutTime_SET_POINT_COMMAND_SCALED_VALUE");
    ...
    // Create the instance
    return new InformationObjectWithoutTime_SET_POINT_COMMAND_SCALED_VALUEBuilderImpl(sva, qos);
  }

  public static class InformationObjectWithoutTime_SET_POINT_COMMAND_SCALED_VALUEBuilderImpl
    ...
    public InformationObjectWithoutTime_SET_POINT_COMMAND_SCALED_VALUEBuilderImpl(
        ScaledValue sva, QualifierOfSetPointCommand qos) {
      this.sva = sva;
      this.qos = qos;
    }

    public InformationObjectWithoutTime_SET_POINT_COMMAND_SCALED_VALUE build(int address) {
      InformationObjectWithoutTime_SET_POINT_COMMAND_SCALED_VALUE
          informationObjectWithoutTime_SET_POINT_COMMAND_SCALED_VALUE =
              new InformationObjectWithoutTime_SET_POINT_COMMAND_SCALED_VALUE(address, sva, qos);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof InformationObjectWithoutTime_SET_POINT_COMMAND_SCALED_VALUE)) {
      return false;
    }
    InformationObjectWithoutTime_SET_POINT_COMMAND_SCALED_VALUE that =
        (InformationObjectWithoutTime_SET_POINT_COMMAND_SCALED_VALUE) o;
