...
public class QualityDescriptorForPointsOfProtectionEquipment implements Message {
  ...
  public QualityDescriptorForPointsOfProtectionEquipment(Boolean invalid, Boolean notTopical,
      Boolean substituted, Boolean blocked, Boolean elapsedTimeInvalid) {
  ...
  /**
   * Property field elapsedTimeInvalid
   */
  ...
  public static QualityDescriptorForPointsOfProtectionEquipment staticParse(ReadBuffer readBuffer)
    ...
    readBuffer.pushContext(WithOption.WithName("QualityDescriptorForPointsOfProtectionEquipment"), WithByteBasedOption.WithByteOrder("LITTLE_ENDIAN"));
    ...
    // Reserved Field
    FieldReaderFactory.readReservedField(DataReaderFactory.readUnsignedByte(readBuffer, 3), (byte) 0, WithOption.WithName("QualityDescriptorForPointsOfProtectionEquipment.reserved5"));

    readBuffer.popContext();
    return new QualityDescriptorForPointsOfProtectionEquipment(invalid, notTopical, substituted, blocked, elapsedTimeInvalid);
  }

  @Override
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("QualityDescriptorForPointsOfProtectionEquipment"), WithByteBasedOption.WithByteOrder("LITTLE_ENDIAN"));
