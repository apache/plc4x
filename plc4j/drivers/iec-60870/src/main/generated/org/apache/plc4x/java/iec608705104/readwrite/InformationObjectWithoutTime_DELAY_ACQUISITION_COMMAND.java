 ...
 */
public class InformationObjectWithoutTime_DELAY_ACQUISITION_COMMAND extends InformationObjectWithoutTime implements Message {
  protected final TwoOctetBinaryTime cp16Time2a;

  public InformationObjectWithoutTime_DELAY_ACQUISITION_COMMAND(Integer address,
  ...
  public static class InformationObjectWithoutTimeBuilderImpl implements InformationObjectWithoutTime.InformationObjectWithoutTimeBuilder {
    ...
    public InformationObjectWithoutTimeBuilderImpl(TwoOctetBinaryTime cp16Time2a) {
      this.cp16Time2a = cp16Time2a;
    }

    public InformationObjectWithoutTime build(int address) {
      return new InformationObjectWithoutTime_DELAY_ACQUISITION_COMMAND(address, cp16Time2a);
    }
  }
}
