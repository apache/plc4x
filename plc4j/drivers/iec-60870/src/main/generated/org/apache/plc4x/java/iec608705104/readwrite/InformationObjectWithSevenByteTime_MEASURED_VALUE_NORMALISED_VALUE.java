...
public class InformationObjectWithSevenByteTime_MEASURED_VALUE_NORMALISED_VALUE extends InformationObjectWithSevenByteTime implements Message {
  ...
  public static InformationObjectWithSevenByteTimeBuilder staticParseInformationObjectWithSevenByteTimeBuilder(
      ...
      BufferException {
    readBuffer.pushContext(WithOption.WithName("InformationObjectWithSevenByteTime_MEASURED_VALUE_NORMALISED_VALUE"), WithByteBasedOption.WithByteOrder("LITTLE_ENDIAN"));
  ...
  protected void serializeInformationObjectWithSevenByteTimeChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("InformationObjectWithSevenByteTime_MEASURED_VALUE_NORMALISED_VALUE"), WithByteBasedOption.WithByteOrder("LITTLE_ENDIAN"));
