...
public class QualifierOfCommand implements Message {
  ...
  public static QualifierOfCommand staticParse(ReadBuffer readBuffer) throws ParseException {
    ...
    // Create the instance
    QualifierOfCommand _qualifierOfCommand;
    _qualifierOfCommand = new QualifierOfCommand(select, qualifier);
    return _qualifierOfCommand;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof QualifierOfCommand)) {
      return false;
    }
    QualifierOfCommand that = (QualifierOfCommand) o;
