...
public class APDUUFormatTestFrameConfirmation extends APDU implements Message {
  ...
  protected void serializeAPDUChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("APDUUFormatTestFrameConfirmation");
    ...
    writeBuffer.popContext("APDUUFormatTestFrameConfirmation");
  }
  ...
  public static APDUBuilder staticParseAPDUBuilder(ReadBuffer readBuffer) throws ParseException {
    readBuffer.pullContext("APDUUFormatTestFrameConfirmation");
    ...
    readBuffer.closeContext("APDUUFormatTestFrameConfirmation");
    // Create the instance
    return new APDUUFormatTestFrameConfirmationBuilderImpl();
  }

  public static class APDUUFormatTestFrameConfirmationBuilderImpl implements APDU.APDUBuilder {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof APDUUFormatTestFrameConfirmation)) {
      return false;
    }
    APDUUFormatTestFrameConfirmation that = (APDUUFormatTestFrameConfirmation) o;
