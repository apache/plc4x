...
public class ManualFactoryS71200DriverTest extends BasicPlcTest {
    ...
    public ManualFactoryS71200DriverTest(String connectionString) {
        super(connectionString, new PlcNullAuthentication(), true, true, true, true, 100);
    }

    public static void main(String[] args) throws Exception {
        ManualFactoryS71200DriverTest test = new ManualFactoryS71200DriverTest("s7://192.168.23.30");//?log.audit-log-file=ManualFactoryS71200DriverTest-audit.log
