 ...
 */
class S7LegacyAddressTest {

    @Test
    void legacyForm0IsRejected() {
        assertThrows(PlcInvalidTagException.class, () -> S7Tag.of("%DB42:28.0:BYTE[4]"));
    }

    @Test
    void legacyForm1IsRejected() {
        assertThrows(PlcInvalidTagException.class, () -> S7Tag.of("%DB1.DBW20:INT[5]"));
    }

    @Test
    void legacyForm2IsRejected() {
        assertThrows(PlcInvalidTagException.class, () -> S7StringFixedLengthTag.of("%DB1.DB0:STRING(40)[3]"));
    }

    @Test
    void theReplacementFormParses() {
        assertNotNull(S7Tag.of("%DB42:28.0[0..3]:BYTE"));
    }
    ...
    void theErrorNamesTheReplacementAddress() {
        PlcInvalidTagException thrown =
            assertThrows(PlcInvalidTagException.class, () -> S7Tag.of("%DB42:28.0:BYTE[4]"));
        assertTrue(thrown.getMessage().contains("%DB42:28.0[0..3]:BYTE"), thrown::getMessage);
    }
}
