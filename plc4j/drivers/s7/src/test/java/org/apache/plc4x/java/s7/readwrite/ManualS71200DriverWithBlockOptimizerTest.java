...
public class ManualS71200DriverWithBlockOptimizerTest extends ManualTest {
    ...
    public ManualS71200DriverWithBlockOptimizerTest(String connectionString) {
        super(connectionString, true, true, true, true, 100);
    }

    public static void main(String[] args) throws Exception {
        ManualS71200DriverWithBlockOptimizerTest test = new ManualS71200DriverWithBlockOptimizerTest("s7-light://192.168.23.30?enable-block-read-optimizer=true");
