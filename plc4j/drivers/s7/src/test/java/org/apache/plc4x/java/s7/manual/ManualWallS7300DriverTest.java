...
public class ManualWallS7300DriverTest extends BasicPlcTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ManualWallS7300DriverTest test = new ManualWallS7300DriverTest("s7://192.168.24.60?cotp.remote-rack=0&cotp.remote-slot=1");//?log.audit-log-file=ManualWallS7300DriverTest-audit.log
