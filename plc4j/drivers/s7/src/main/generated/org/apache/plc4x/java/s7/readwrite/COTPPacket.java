...
public abstract class COTPPacket implements Message {
  ...
  public static COTPPacket staticParse(ReadBuffer readBuffer, long cotpLen) throws BufferException {
    ...
    S7Message payload = FieldReaderFactory.readOptionalField(DataReaderFactory.readComplex(() -> DataReaderFactory.castToDeclaredType(S7Message.class, S7Message.staticParse(readBuffer)), readBuffer), (((readBuffer.getPositionInBits() - startPos) / 8)) < (cotpLen), WithOption.WithName("payload"));
