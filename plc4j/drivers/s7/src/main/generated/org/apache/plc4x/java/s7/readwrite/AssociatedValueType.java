...
/**
 * TODO: The calculation must be modified to include the type . if it is type 0x07(REAL) or 0x09
 * (OCTET_STRING), the length is indicated . another type uses scrolling . verify calculation with
 * the other types
 */
public class AssociatedValueType implements Message {
  ...
  /**
   * [manual uint 16 valueLength 'STATIC_CALL("rightShift3", readBuffer)' 'STATIC_CALL("leftShift3",
   * writeBuffer, valueLength)' '16']
   */
