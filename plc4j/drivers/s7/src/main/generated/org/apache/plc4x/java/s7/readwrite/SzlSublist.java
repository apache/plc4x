...
public enum SzlSublist {
  ...
  PRIORITY_CLASSES((short) 0x16),

  EXTENDED_PRIORITY_CLASSES((short) 0x17),

  OPERATING_SYSTEM((short) 0x18),

  STATUS_MODULE_LEDS((short) 0x19),

  COMPONENT_IDENTIFICATION((short) 0x1C),

  INTERRUPT_INFO((short) 0x21),

  INTERRUPT_STATUS((short) 0x22),

  OPERATION_HISTORY((short) 0x23),

  OPERATING_MODES((short) 0x24),

  ASSIGNMENT_BETWEEN_PROCESS_IMAGE_PARTITIONS_AND_OBS((short) 0x25),

  COMMUNICATION_MODE_DATA((short) 0x31),

  COMMUNICATION_STATUS_DATA((short) 0x32),

  DIAGNOSTIC_DATA_ON_COMM_OBJECTS((short) 0x33),

  STATUS_H_SYSTEM((short) 0x70),
