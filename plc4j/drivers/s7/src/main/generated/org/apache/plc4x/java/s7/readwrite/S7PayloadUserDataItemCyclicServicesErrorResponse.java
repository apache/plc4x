...
public class S7PayloadUserDataItemCyclicServicesErrorResponse extends S7PayloadUserDataItem
    implements Message {
  ...
  public static S7PayloadUserDataItemBuilder staticParseS7PayloadUserDataItemBuilder(
    ...
    // Create the instance
    return new S7PayloadUserDataItemCyclicServicesErrorResponseBuilderImpl();
  }

  public static class S7PayloadUserDataItemCyclicServicesErrorResponseBuilderImpl
      implements S7PayloadUserDataItem.S7PayloadUserDataItemBuilder {

    public S7PayloadUserDataItemCyclicServicesErrorResponseBuilderImpl() {}

    public S7PayloadUserDataItemCyclicServicesErrorResponse build(
        DataTransportErrorCode returnCode, DataTransportSize transportSize, int dataLength) {
      S7PayloadUserDataItemCyclicServicesErrorResponse
          s7PayloadUserDataItemCyclicServicesErrorResponse =
              new S7PayloadUserDataItemCyclicServicesErrorResponse(
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof S7PayloadUserDataItemCyclicServicesErrorResponse)) {
      return false;
    }
