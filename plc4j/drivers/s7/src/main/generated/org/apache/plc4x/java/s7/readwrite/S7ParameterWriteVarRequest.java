...
public class S7ParameterWriteVarRequest extends S7Parameter implements Message {
  ...
  public static S7ParameterBuilder staticParseS7ParameterBuilder(ReadBuffer readBuffer,
    ...
    readBuffer.pushContext(WithOption.WithName("S7ParameterWriteVarRequest"));
  ...
  protected void serializeS7ParameterChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("S7ParameterWriteVarRequest"));
  ...
  public int getLengthInBits() {
    ...
    if (items != null) {
      int i = 0;
      for (S7VarRequestParameterItem _element : items) {
  ...
  public static class S7ParameterBuilderImpl implements S7Parameter.S7ParameterBuilder {
    ...
    public S7ParameterBuilderImpl(List<S7VarRequestParameterItem> items) {
      this.items = items;
    }
