...
public class S7PayloadUserDataItemCpuFunctionMsgSubscriptionSysResponse extends S7PayloadUserDataItem implements Message {
  ...
  public static S7PayloadUserDataItemBuilder staticParseS7PayloadUserDataItemBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("S7PayloadUserDataItemCpuFunctionMsgSubscriptionSysResponse"));
    ...
    return new S7PayloadUserDataItemBuilderImpl(result, reserved01);
  }

  protected void serializeS7PayloadUserDataItemChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("S7PayloadUserDataItemCpuFunctionMsgSubscriptionSysResponse"));
