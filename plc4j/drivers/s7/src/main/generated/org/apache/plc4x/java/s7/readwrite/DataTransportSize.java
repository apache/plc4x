...
public enum DataTransportSize {
  ...
  public static DataTransportSize firstEnumForFieldSizeInBits(boolean sizeInBits) {
  ...
  public static List<DataTransportSize> enumsForFieldSizeInBits(boolean sizeInBits) {
