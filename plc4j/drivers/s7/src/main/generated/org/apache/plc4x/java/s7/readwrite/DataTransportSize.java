...
public enum DataTransportSize {
  NULL((short) 0x00, false),
  BIT((short) 0x03, true),
  BYTE_WORD_DWORD((short) 0x04, true),
  INTEGER((short) 0x05, true),
  DINTEGER((short) 0x06, false),
  REAL((short) 0x07, false),
  OCTET_STRING((short) 0x09, false);
