...
public class S7PayloadUserDataItemCyclicServicesChangeDrivenPush extends S7PayloadUserDataItem
    implements Message {
  ...
  public S7PayloadUserDataItemCyclicServicesChangeDrivenPush(
  ...
  protected void serializeS7PayloadUserDataItemChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("S7PayloadUserDataItemCyclicServicesChangeDrivenPush");
  }
  ...
  public static S7PayloadUserDataItemBuilder staticParseS7PayloadUserDataItemBuilder(
    ...
    // Create the instance
    return new S7PayloadUserDataItemCyclicServicesChangeDrivenPushBuilderImpl(itemsCount, items);
  }

  public static class S7PayloadUserDataItemCyclicServicesChangeDrivenPushBuilderImpl
      implements S7PayloadUserDataItem.S7PayloadUserDataItemBuilder {
    private final int itemsCount;
    private final List<AssociatedQueryValueType> items;

    public S7PayloadUserDataItemCyclicServicesChangeDrivenPushBuilderImpl(
        int itemsCount, List<AssociatedQueryValueType> items) {
      this.itemsCount = itemsCount;
      this.items = items;
    }

    public S7PayloadUserDataItemCyclicServicesChangeDrivenPush build(
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof S7PayloadUserDataItemCyclicServicesChangeDrivenPush)) {
      return false;
    }
    S7PayloadUserDataItemCyclicServicesChangeDrivenPush that =
