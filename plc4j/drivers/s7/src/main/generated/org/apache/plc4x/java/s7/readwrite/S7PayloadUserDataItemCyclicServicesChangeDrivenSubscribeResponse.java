 ...
 */
public class S7PayloadUserDataItemCyclicServicesChangeDrivenSubscribeResponse extends S7PayloadUserDataItem implements Message {
  ...
  public S7PayloadUserDataItemCyclicServicesChangeDrivenSubscribeResponse(
      ...
      Integer itemsCount, List<AssociatedQueryValueType> items) {
  ...
  public static S7PayloadUserDataItemBuilder staticParseS7PayloadUserDataItemBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("S7PayloadUserDataItemCyclicServicesChangeDrivenSubscribeResponse"));
  ...
  protected void serializeS7PayloadUserDataItemChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("S7PayloadUserDataItemCyclicServicesChangeDrivenSubscribeResponse"));
