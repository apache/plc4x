...
/**
 * This is actually not quite correct as depending pon the transportSize the length is either
 * defined in bits or bytes.
 *
 * @param hasNext In the serialization process, if you have multiple write requests the last element
