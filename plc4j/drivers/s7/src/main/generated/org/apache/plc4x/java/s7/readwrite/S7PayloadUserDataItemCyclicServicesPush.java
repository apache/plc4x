 ...
 */
public class S7PayloadUserDataItemCyclicServicesPush extends S7PayloadUserDataItem implements Message {
  protected final int itemsCount;

  protected final List<AssociatedValueType> items;

  public S7PayloadUserDataItemCyclicServicesPush(DataTransportErrorCode returnCode,
  ...
  public static S7PayloadUserDataItemBuilder staticParseS7PayloadUserDataItemBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("S7PayloadUserDataItemCyclicServicesPush"));
  ...
  protected void serializeS7PayloadUserDataItemChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("S7PayloadUserDataItemCyclicServicesPush"));
