...
public class StaticHelper {
    ...
    public static int count(boolean expedited, boolean indicated, SDOInitiateUploadResponsePayload payload) {
        return expedited && indicated && payload instanceof SDOInitiateExpeditedUploadResponse ? 4 - org.apache.plc4x.java.spi.utils.StaticHelper.COUNT(((SDOInitiateExpeditedUploadResponse) payload).getData()) : 0;
    }
    ...
    public static Object parseString(ReadBuffer io, int length, String charset) throws BufferException {
        return io.readString(8 * length, WithOption.WithEncoding(charset));
    }

    public static void serializeString(WriteBuffer io, PlcValue value, String charset) throws BufferException {
