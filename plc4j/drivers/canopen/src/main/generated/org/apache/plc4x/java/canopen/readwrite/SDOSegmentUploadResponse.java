...
public class SDOSegmentUploadResponse extends SDOResponse implements Message {
  ...
  public static SDOResponseBuilder staticParseSDOResponseBuilder(ReadBuffer readBuffer,
    ...
    return new SDOResponseBuilderImpl(toggle, last, data);
  }
  ...
  public static class SDOResponseBuilderImpl implements SDOResponse.SDOResponseBuilder {
    ...
    public SDOResponseBuilderImpl(boolean toggle, boolean last, byte[] data) {
      this.toggle = toggle;
      this.last = last;
      this.data = data;
    }
    ...
    public SDOResponse build() {
      return new SDOSegmentUploadResponse(toggle, last, data);
    }
  }
}
