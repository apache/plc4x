...
public abstract class SDORequest implements Message {
  ...
  protected abstract void serializeSDORequestChild(WriteBuffer writeBuffer)
  ...
  public static SDORequest staticParse(ReadBuffer readBuffer, Object... args)
    ...
    if (args[0] instanceof SDORequestCommand) {
      ...
      throw new PlcRuntimeException(
          "Argument 0 expected to be of type SDORequestCommand or a string which is parseable but"
              + " was "
  ...
  public static SDORequest staticParse(ReadBuffer readBuffer, SDORequestCommand command)
      throws ParseException {
