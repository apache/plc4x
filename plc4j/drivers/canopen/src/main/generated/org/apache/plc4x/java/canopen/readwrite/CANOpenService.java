...
public enum CANOpenService {
  ...
  public static CANOpenService firstEnumForFieldMin(short min) {
  ...
  public static List<CANOpenService> enumsForFieldMin(short min) {
  ...
  public static CANOpenService firstEnumForFieldMax(short max) {
    for (CANOpenService _val : CANOpenService.values()) {
      if (_val.getMax() == max) {
        return _val;
      }
  ...
  public static List<CANOpenService> enumsForFieldMax(short max) {
    List<CANOpenService> _values = new ArrayList<>();
    for (CANOpenService _val : CANOpenService.values()) {
      if (_val.getMax() == max) {
        _values.add(_val);
  ...
  public static CANOpenService firstEnumForFieldPdo(boolean pdo) {
    for (CANOpenService _val : CANOpenService.values()) {
      if (_val.getPdo() == pdo) {
        return _val;
      }
  ...
  public static List<CANOpenService> enumsForFieldPdo(boolean pdo) {
    List<CANOpenService> _values = new ArrayList<>();
    for (CANOpenService _val : CANOpenService.values()) {
      if (_val.getPdo() == pdo) {
        _values.add(_val);
