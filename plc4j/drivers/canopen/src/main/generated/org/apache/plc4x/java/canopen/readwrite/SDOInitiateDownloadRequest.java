...
public class SDOInitiateDownloadRequest extends SDORequest implements Message {
  ...
  public static SDORequestBuilder staticParseSDORequestBuilder(ReadBuffer readBuffer,
    ...
    SDOInitiateUploadResponsePayload payload = FieldReaderFactory.readSimpleField(DataReaderFactory.readComplex(() -> DataReaderFactory.castToDeclaredType(SDOInitiateUploadResponsePayload.class, SDOInitiateUploadResponsePayload.staticParse(readBuffer, (boolean) (expedited), (boolean) (indicated), (byte) (size))), readBuffer), WithOption.WithName("payload"), WithOption.WithFloatEncoding("IEEE754"), WithOption.WithSignedIntegerEncoding("twos-complement"), WithOption.WithUnsignedIntegerEncoding("unsigned-binary"), WithByteBasedOption.WithByteOrder("LITTLE_ENDIAN"), WithOption.WithStringEncoding("UTF8"));
