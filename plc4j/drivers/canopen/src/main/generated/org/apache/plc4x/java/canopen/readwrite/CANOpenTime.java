...
public class CANOpenTime implements Message {
  ...
  public CANOpenTime(Long millis, Integer days) {
    this.millis = millis;
    this.days = days;
  }

  /**
   * Property field millis
   */
  ...
  /**
   * Virtual field cleanMillis
   */
  public int getCleanMillis() {
    return (int) ((millis) & (0x0FFFFFFF));
  }
  ...
  public int getLengthInBits() {
    ...
    // Virtual Field: cleanMillis (doesn't produce any output, just makes the value available)
