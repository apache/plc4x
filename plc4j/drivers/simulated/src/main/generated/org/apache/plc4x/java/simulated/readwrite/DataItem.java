...
public class DataItem {
  ...
  public static PlcValue staticParse(ReadBuffer readBuffer, String dataType, int numberOfValues)
      throws BufferException {
    readBuffer.pushContext(WithOption.WithName("DataItem"), WithOption.WithFloatEncoding("IEEE754"), WithOption.WithSignedIntegerEncoding("twos-complement"), WithOption.WithUnsignedIntegerEncoding("unsigned-binary"), WithByteBasedOption.WithByteOrder("BIG_ENDIAN"), WithOption.WithStringEncoding("UTF8"));
    try {
      ...
      } else if (EvaluationHelper.equals(dataType, "BOOL")) {
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // List
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  public static void staticSerialize(WriteBuffer writeBuffer, PlcValue _value, String dataType,
      int numberOfValues) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("DataItem"), WithOption.WithFloatEncoding("IEEE754"), WithOption.WithSignedIntegerEncoding("twos-complement"), WithOption.WithUnsignedIntegerEncoding("unsigned-binary"), WithByteBasedOption.WithByteOrder("BIG_ENDIAN"), WithOption.WithStringEncoding("UTF8"));
    if (EvaluationHelper.equals(dataType, "BOOL") &&
            EvaluationHelper.equals(numberOfValues, 1)) {
      //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      // BOOL
  ...
  public static Integer getLengthInBytes(PlcValue _value, String dataType, int numberOfValues)
      throws BufferException {
    return (int) Math.ceil((float) getLengthInBits(_value, dataType, numberOfValues) / 8.0);
  }

  public static Integer getLengthInBits(PlcValue _value, String dataType, int numberOfValues) throws
      BufferException {
    int lengthInBits = 0;
    if (EvaluationHelper.equals(dataType, "BOOL") &&
            EvaluationHelper.equals(numberOfValues, 1)) {
