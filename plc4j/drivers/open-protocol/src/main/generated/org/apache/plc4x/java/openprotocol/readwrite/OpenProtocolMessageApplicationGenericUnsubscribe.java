...
public abstract class OpenProtocolMessageApplicationGenericUnsubscribe extends OpenProtocolMessage
    implements Message {
  ...
  public static OpenProtocolMessageBuilder staticParseOpenProtocolMessageBuilder(
    ...
    // Create the instance
    return new OpenProtocolMessageApplicationGenericUnsubscribeBuilderImpl(builder);
  }

  public interface OpenProtocolMessageApplicationGenericUnsubscribeBuilder {
    OpenProtocolMessageApplicationGenericUnsubscribe build(
        Long midRevision,
        Short noAckFlag,
        Integer targetStationId,
        Integer targetSpindleId,
  ...
  public static class OpenProtocolMessageApplicationGenericUnsubscribeBuilderImpl
    ...
    public OpenProtocolMessageApplicationGenericUnsubscribeBuilderImpl(
