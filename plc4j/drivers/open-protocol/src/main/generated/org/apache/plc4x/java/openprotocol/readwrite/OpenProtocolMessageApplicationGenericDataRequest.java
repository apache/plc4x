...
public abstract class OpenProtocolMessageApplicationGenericDataRequest extends OpenProtocolMessage
    implements Message {
  ...
  public static OpenProtocolMessageBuilder staticParseOpenProtocolMessageBuilder(
    ...
    // Create the instance
    return new OpenProtocolMessageApplicationGenericDataRequestBuilderImpl(builder);
  }

  public interface OpenProtocolMessageApplicationGenericDataRequestBuilder {
    OpenProtocolMessageApplicationGenericDataRequest build(
        Integer midRevision,
        Short noAckFlag,
        Integer targetStationId,
        Integer targetSpindleId,
