...
public abstract class OpenProtocolMessageApplicationCommandAccepted extends OpenProtocolMessage
    implements Message {
  ...
  public static OpenProtocolMessageBuilder staticParseOpenProtocolMessageBuilder(
    ...
    // Create the instance
    return new OpenProtocolMessageApplicationCommandAcceptedBuilderImpl(builder);
  }

  public interface OpenProtocolMessageApplicationCommandAcceptedBuilder {
    OpenProtocolMessageApplicationCommandAccepted build(
        Long midRevision,
        Short noAckFlag,
        Integer targetStationId,
        Integer targetSpindleId,
