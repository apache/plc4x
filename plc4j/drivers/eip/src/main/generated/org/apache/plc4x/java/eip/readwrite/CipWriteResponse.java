...
public class CipWriteResponse extends CipService implements Message {
  ...
  public static CipServiceBuilder staticParseCipServiceBuilder(ReadBuffer readBuffer,
    ...
    // Reserved Field
    FieldReaderFactory.readReservedField(DataReaderFactory.readUnsignedShort(readBuffer, 8), (short) 0x00, WithOption.WithName("CipWriteResponse.reserved0"));
    ...
    return new CipServiceBuilderImpl(status, extStatus);
  }
  ...
  public static class CipServiceBuilderImpl implements CipService.CipServiceBuilder {
    ...
    public CipServiceBuilderImpl(short status, short extStatus) {
      this.status = status;
      this.extStatus = extStatus;
    }
