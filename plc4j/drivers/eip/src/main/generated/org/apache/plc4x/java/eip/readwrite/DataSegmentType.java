...
public abstract class DataSegmentType implements Message {
  ...
  protected abstract void serializeDataSegmentTypeChild(WriteBuffer writeBuffer) throws
      BufferException;

  public static DataSegmentType staticParse(ReadBuffer readBuffer) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("DataSegmentType"));
    int startPos = readBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Discriminator Field: dataSegmentType
    byte dataSegmentType = FieldReaderFactory.readDiscriminatorField(DataReaderFactory.readUnsignedByte(readBuffer, 5), WithOption.WithName("dataSegmentType"));
    ...
    if (builder == null) {
      throw new BufferException("Unsupported case for discriminated type parameters parameters [dataSegmentType]");
    }
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("DataSegmentType"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    byte dataSegmentType = (byte) getDataSegmentType();
    // Discriminator Field: dataSegmentType
    FieldWriterFactory.writeDiscriminatorField((byte) dataSegmentType, DataWriterFactory.writeUnsignedByte(writeBuffer, 5), WithOption.WithName("dataSegmentType"));
