...
public class GetAttributeSingleRequest extends CipServiceRequest implements Message {
  ...
  public static CipServiceRequestBuilder staticParseCipServiceRequestBuilder(ReadBuffer readBuffer,
    ...
    PathSegment attributeSegment = FieldReaderFactory.readSimpleField(DataReaderFactory.readComplex(() -> DataReaderFactory.castToDeclaredType(PathSegment.class, PathSegment.staticParse(readBuffer)), readBuffer), WithOption.WithName("attributeSegment"));
