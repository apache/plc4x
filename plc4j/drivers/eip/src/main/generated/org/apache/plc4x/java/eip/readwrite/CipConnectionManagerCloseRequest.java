...
public class CipConnectionManagerCloseRequest extends CipService implements Message {
  ...
  public static CipServiceBuilder staticParseCipServiceBuilder(ReadBuffer readBuffer,
    ...
    return new CipServiceBuilderImpl(requestPathSize, classSegment, instanceSegment, priority, tickTime, timeoutTicks, connectionSerialNumber, originatorVendorId, originatorSerialNumber, connectionPathSize, connectionPaths);
  }
  ...
  public static class CipServiceBuilderImpl implements CipService.CipServiceBuilder {
    ...
    public CipServiceBuilderImpl(short requestPathSize, PathSegment classSegment,
        PathSegment instanceSegment, byte priority, byte tickTime, short timeoutTicks,
