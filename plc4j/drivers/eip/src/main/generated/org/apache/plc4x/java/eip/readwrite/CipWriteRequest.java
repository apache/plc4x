 ...
 */
public class CipWriteRequest extends CipServiceRequest implements Message {
  ...
  public static CipServiceRequestBuilder staticParseCipServiceRequestBuilder(ReadBuffer readBuffer,
    ...
    return new CipServiceRequestBuilderImpl(tag, dataType, elementNb, data);
  }
  ...
  public static class CipServiceRequestBuilderImpl implements CipServiceRequest.CipServiceRequestBuilder {
    ...
    public CipServiceRequestBuilderImpl(byte[] tag, CIPDataTypeCode dataType, int elementNb,
        byte[] data) {
      this.tag = tag;
      this.dataType = dataType;
      this.elementNb = elementNb;
