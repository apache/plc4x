...
public abstract class PathSegment implements Message {
  ...
  protected abstract void serializePathSegmentChild(WriteBuffer writeBuffer) throws BufferException;

  public static PathSegment staticParse(ReadBuffer readBuffer) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("PathSegment"));
    int startPos = readBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Discriminator Field: pathSegment
    byte pathSegment = FieldReaderFactory.readDiscriminatorField(DataReaderFactory.readUnsignedByte(readBuffer, 3), WithOption.WithName("pathSegment"));
    ...
    if (builder == null) {
      throw new BufferException("Unsupported case for discriminated type parameters parameters [pathSegment]");
    }
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("PathSegment"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    byte pathSegment = (byte) getPathSegment();
    // Discriminator Field: pathSegment
    FieldWriterFactory.writeDiscriminatorField((byte) pathSegment, DataWriterFactory.writeUnsignedByte(writeBuffer, 3), WithOption.WithName("pathSegment"));
