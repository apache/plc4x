...
public class LogicalSegment extends PathSegment implements Message {
  ...
  public static PathSegmentBuilder staticParsePathSegmentBuilder(ReadBuffer readBuffer) throws
      BufferException {
    readBuffer.pushContext(WithOption.WithName("LogicalSegment"));
  ...
  protected void serializePathSegmentChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("LogicalSegment"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: segmentType
    FieldWriterFactory.writeSimpleField((LogicalSegmentType) segmentType, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("segmentType"));
  ...
  public static class PathSegmentBuilderImpl implements PathSegment.PathSegmentBuilder {
    ...
    public PathSegmentBuilderImpl(LogicalSegmentType segmentType) {
      this.segmentType = segmentType;
    }

    public PathSegment build() {
      return new LogicalSegment(segmentType);
    }
  }
}
