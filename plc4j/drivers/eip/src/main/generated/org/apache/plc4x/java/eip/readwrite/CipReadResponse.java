 ...
 */
public class CipReadResponse extends CipServiceResponse implements Message {
  protected final CIPData data;

  public CipReadResponse(Short status, List<Integer> extStatus, CIPData data) {
  ...
  public static class CipServiceResponseBuilderImpl implements CipServiceResponse.CipServiceResponseBuilder {
    ...
    public CipServiceResponseBuilderImpl(CIPData data) {
      this.data = data;
    }
