...
class ModbusRtuConfigurationTest {
    ...
    void testToString() {
        ...
        config.setDefaultUnitIdentifier(2);

        String result = config.toString();
        assertTrue(result.contains("ModbusRtuConfiguration"));
        assertTrue(result.contains("requestTimeout=3000"));
        assertTrue(result.contains("unitIdentifier=2"));
    }
}
