...
/**
 * Manual smoke-test for the Modbus/ASCII driver's <em>emulated</em> subscription path.
 * <p>
 * Modbus has no native subscription mechanism; since {@code ModbusAsciiConnection} now extends
 ...
 * <p>
 * Requires a serial adapter and an attached ASCII device; adjust the connection URL / serial
