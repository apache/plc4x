...
class ModbusAsciiConnectionTest {

    private ModbusAsciiConnection connection;
    ...
    void setUp() {
        ...
        connection = new ModbusAsciiConnection(config, transportInstance, auditLog);
    }
    ...
    void testByteSwap() throws Exception {
        Method method = ModbusAsciiConnection.class.getDeclaredMethod("byteSwap", byte[].class);
    ...
    void testReverseBitsOfByte() throws Exception {
        Method method = ModbusAsciiConnection.class.getDeclaredMethod("reverseBitsOfByte", byte.class);
        method.setAccessible(true);
    ...
    void testGetUnitId() throws Exception {
        Method method = ModbusAsciiConnection.class.getDeclaredMethod("getUnitId", PlcTag.class);
        method.setAccessible(true);

        ModbusTag tag = ModbusTag.of("4x00001:INT");
        assertEquals((short) 1, method.invoke(connection, tag));

        ModbusTag tagWithUnit = ModbusTag.of("4x00001:INT{unit-id: 3}");
        assertEquals((short) 3, method.invoke(connection, tagWithUnit));
    }

    @Test
    void testGetReadRequestPdu_allTypes() throws Exception {
        Method method = ModbusAsciiConnection.class.getDeclaredMethod("getReadRequestPdu", PlcTag.class);
        method.setAccessible(true);
    ...
    void testGetErrorCode() throws Exception {
        Method method = ModbusAsciiConnection.class.getDeclaredMethod("getErrorCode", ModbusPDUError.class);
        method.setAccessible(true);
    ...
    void testGetWriteRequestPdu() throws Exception {
        Method method = ModbusAsciiConnection.class.getDeclaredMethod("getWriteRequestPdu", PlcTag.class, PlcValue.class);
        method.setAccessible(true);
    ...
    void testFromPlcValueCoil() throws Exception {
        Method method = ModbusAsciiConnection.class.getDeclaredMethod("fromPlcValueCoil", PlcValue.class, ModbusByteOrder.class);
        method.setAccessible(true);
    ...
    void testCreateWriteBuffer() throws Exception {
        Method method = ModbusAsciiConnection.class.getDeclaredMethod("createWriteBuffer", int.class, ModbusByteOrder.class);
        method.setAccessible(true);
    ...
    void testGetEffectiveByteOrder() throws Exception {
        Method method = ModbusAsciiConnection.class.getDeclaredMethod("getEffectiveByteOrder", ModbusTag.class);
        method.setAccessible(true);
     ...
     */
    private static Object newPendingRequest(byte functionFlag, CompletableFuture<ModbusAsciiADU> future) throws Exception {
        Class<?> pendingRequestClass = Arrays.stream(ModbusAsciiConnection.class.getDeclaredClasses())
    ...
    void testHandleIncomingMessage() throws Exception {
        Method method = ModbusAsciiConnection.class.getDeclaredMethod("handleIncomingMessage", ModbusAsciiADU.class);
        method.setAccessible(true);

        Field pendingField = ModbusAsciiConnection.class.getDeclaredField("pendingRequests");
    ...
    void testHandleIncomingMessage_unknownAddress() throws Exception {
        ...
        ModbusAsciiADU responseAdu = new ModbusAsciiADU((short) 99,
            new ModbusPDUReadHoldingRegistersResponse(new byte[]{0x00, 0x2A}));
        method.invoke(connection, responseAdu);
    }
    ...
    void testOnTransportDisconnected() throws Exception {
        ...
        Method method = ModbusAsciiConnection.class.getDeclaredMethod("onTransportDisconnected", Throwable.class);
        method.setAccessible(true);
    ...
    void testFromPlcValue_holdingRegister() throws Exception {
        Method method = ModbusAsciiConnection.class.getDeclaredMethod("fromPlcValue", PlcTag.class, PlcValue.class, ModbusByteOrder.class);
        method.setAccessible(true);
