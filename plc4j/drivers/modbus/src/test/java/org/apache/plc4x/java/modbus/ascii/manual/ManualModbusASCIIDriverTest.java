...
public class ManualModbusASCIIDriverTest extends BasicPlcTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ManualModbusASCIIDriverTest test = new ManualModbusASCIIDriverTest("modbus-ascii:///dev/tty.usbserial-AR0K3WCE?serial.baud-rate=9600&serial.num-data-bits=8&num-stop-bits=1&serial.parity=EVEN_PARITY");
