...
public class ModbusFieldInputRegister extends ModbusField {
    ...
    protected ModbusFieldInputRegister(int address, Integer quantity, Integer stringLength, ModbusDataType dataType) {
    ...
    public static ModbusFieldInputRegister of(String addressString) {
        ...
        return new ModbusFieldInputRegister(address, quantity, stringLength, dataType);
    }
}
