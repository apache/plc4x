...
public class ModbusFieldHoldingRegister extends ModbusField {
    ...
    public static final Pattern ADDRESS_SHORTER_PATTERN = Pattern.compile("4" + ModbusField.ADDRESS_PATTERN);
    public static final Pattern ADDRESS_SHORT_PATTERN = Pattern.compile("4x" + ModbusField.ADDRESS_PATTERN);
