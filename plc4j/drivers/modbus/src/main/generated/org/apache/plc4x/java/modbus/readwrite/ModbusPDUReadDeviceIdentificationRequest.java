...
/**
 * Remark: Even if the Modbus spec states that supporting this type of request is mandatory I have
 * not come across a single device that really supported it. Some devices just reacted with an
 * error.
 */
