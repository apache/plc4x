...
public class ModbusPDUReadExceptionStatusResponse extends ModbusPDU implements Message {
  ...
  public static ModbusPDUBuilder staticParseModbusPDUBuilder(ReadBuffer readBuffer,
    ...
    readBuffer.pushContext(WithOption.WithName("ModbusPDUReadExceptionStatusResponse"));
  ...
  protected void serializeModbusPDUChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("ModbusPDUReadExceptionStatusResponse"));
  ...
  public static class ModbusPDUBuilderImpl implements ModbusPDU.ModbusPDUBuilder {
    ...
    public ModbusPDUBuilderImpl(short value) {
      this.value = value;
    }
