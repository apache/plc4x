...
public class ModbusPDUWriteFileRecordRequest extends ModbusPDU implements Message {
  ...
  public static ModbusPDUBuilder staticParseModbusPDUBuilder(ReadBuffer readBuffer,
    ...
    readBuffer.pushContext(WithOption.WithName("ModbusPDUWriteFileRecordRequest"));
  ...
  protected void serializeModbusPDUChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("ModbusPDUWriteFileRecordRequest"));
  ...
  public static class ModbusPDUBuilderImpl implements ModbusPDU.ModbusPDUBuilder {
    ...
    public ModbusPDUBuilderImpl(List<ModbusPDUWriteFileRecordRequestItem> items) {
      this.items = items;
    }
