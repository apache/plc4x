...
public class ModbusPDUReadHoldingRegistersResponse extends ModbusPDU implements Message {
  ...
  public static ModbusPDUReadHoldingRegistersResponseBuilder staticParseBuilder(
    ...
    // Create the instance
    return new ModbusPDUReadHoldingRegistersResponseBuilder(value);
  }

  public static class ModbusPDUReadHoldingRegistersResponseBuilder
      implements ModbusPDU.ModbusPDUBuilder {
    private final byte[] value;

    public ModbusPDUReadHoldingRegistersResponseBuilder(byte[] value) {

      this.value = value;
    }

    public ModbusPDUReadHoldingRegistersResponse build() {
      ModbusPDUReadHoldingRegistersResponse modbusPDUReadHoldingRegistersResponse =
          new ModbusPDUReadHoldingRegistersResponse(value);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ModbusPDUReadHoldingRegistersResponse)) {
      return false;
    }
    ModbusPDUReadHoldingRegistersResponse that = (ModbusPDUReadHoldingRegistersResponse) o;
