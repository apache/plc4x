...
public class ModbusPDUReadInputRegistersRequest extends ModbusPDU implements Message {
  ...
  public static ModbusPDUBuilder staticParseModbusPDUBuilder(
    ...
    // Create the instance
    return new ModbusPDUReadInputRegistersRequestBuilderImpl(startingAddress, quantity);
  }

  public static class ModbusPDUReadInputRegistersRequestBuilderImpl
      implements ModbusPDU.ModbusPDUBuilder {
    private final int startingAddress;
    private final int quantity;

    public ModbusPDUReadInputRegistersRequestBuilderImpl(int startingAddress, int quantity) {
      this.startingAddress = startingAddress;
      this.quantity = quantity;
    }
    ...
    public ModbusPDUReadInputRegistersRequest build() {
      ModbusPDUReadInputRegistersRequest modbusPDUReadInputRegistersRequest =
          new ModbusPDUReadInputRegistersRequest(startingAddress, quantity);
