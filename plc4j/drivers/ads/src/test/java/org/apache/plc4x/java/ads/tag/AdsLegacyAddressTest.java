 ...
 */
class AdsLegacyAddressTest {

    @Test
    void legacyForm0IsRejected() {
        assertThrows(PlcInvalidTagException.class, () -> DirectAdsTag.of("0x4020/0:DINT[4]"));
    }

    @Test
    void legacyForm1IsRejected() {
        assertThrows(PlcInvalidTagException.class, () -> DirectAdsTag.of("1/2:INT[8]"));
    }

    @Test
    void theReplacementFormParses() {
        assertNotNull(DirectAdsTag.of("0x4020/0[0..3]:DINT"));
    }
    ...
    void theErrorNamesTheReplacementAddress() {
        PlcInvalidTagException thrown =
            assertThrows(PlcInvalidTagException.class, () -> DirectAdsTag.of("0x4020/0:DINT[4]"));
        assertTrue(thrown.getMessage().contains("0x4020/0[0..3]:DINT"), thrown::getMessage);
    }
}
