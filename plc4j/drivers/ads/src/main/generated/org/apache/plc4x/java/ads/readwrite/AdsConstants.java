...
public class AdsConstants implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeConstField("adsTcpDefaultPort", ADSTCPDEFAULTPORT, writeUnsignedInt(writeBuffer, 16));
  ...
  public static AdsConstants staticParse(ReadBuffer readBuffer) throws ParseException {
    ...
    int adsTcpDefaultPort =
        readConstField(
            "adsTcpDefaultPort", readUnsignedInt(readBuffer, 16), AdsConstants.ADSTCPDEFAULTPORT);
