...
public class AdsDiscoveryBlockRouteName extends AdsDiscoveryBlock implements Message {
  ...
  public static AdsDiscoveryBlockBuilder staticParseAdsDiscoveryBlockBuilder(ReadBuffer readBuffer)
    ...
    readBuffer.pushContext(WithOption.WithName("AdsDiscoveryBlockRouteName"));
  ...
  protected void serializeAdsDiscoveryBlockChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("AdsDiscoveryBlockRouteName"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: routeName
    FieldWriterFactory.writeSimpleField((AmsString) routeName, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("routeName"));
  ...
  public static class AdsDiscoveryBlockBuilderImpl implements AdsDiscoveryBlock.AdsDiscoveryBlockBuilder {
    ...
    public AdsDiscoveryBlockBuilderImpl(AmsString routeName) {
      this.routeName = routeName;
    }

    public AdsDiscoveryBlock build() {
      return new AdsDiscoveryBlockRouteName(routeName);
    }
  }
}
