...
public class AdsDiscoveryBlockUserName extends AdsDiscoveryBlock implements Message {
  ...
  public static AdsDiscoveryBlockBuilder staticParseAdsDiscoveryBlockBuilder(ReadBuffer readBuffer)
    ...
    readBuffer.pushContext(WithOption.WithName("AdsDiscoveryBlockUserName"));
  ...
  protected void serializeAdsDiscoveryBlockChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("AdsDiscoveryBlockUserName"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: userName
    FieldWriterFactory.writeSimpleField((AmsString) userName, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("userName"));
  ...
  public static class AdsDiscoveryBlockBuilderImpl implements AdsDiscoveryBlock.AdsDiscoveryBlockBuilder {
    ...
    public AdsDiscoveryBlockBuilderImpl(AmsString userName) {
      this.userName = userName;
    }

    public AdsDiscoveryBlock build() {
      return new AdsDiscoveryBlockUserName(userName);
    }
  }
}
