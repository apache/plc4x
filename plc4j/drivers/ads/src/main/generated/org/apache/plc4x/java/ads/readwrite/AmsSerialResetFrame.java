...
/**
 * In case the transmitter does not receive a valid acknowledgement after multiple transmission,
 * then a reset frame is sent. In this way the receiver is informed that a new communication is
 * running and the receiver then accepts the fragment number during the next AMS-Frame, without
...
public class AmsSerialResetFrame implements Message {
  ...
  public static AmsSerialResetFrame staticParse(ReadBuffer readBuffer) throws ParseException {
    ...
    // Create the instance
    AmsSerialResetFrame _amsSerialResetFrame;
    _amsSerialResetFrame =
        new AmsSerialResetFrame(
