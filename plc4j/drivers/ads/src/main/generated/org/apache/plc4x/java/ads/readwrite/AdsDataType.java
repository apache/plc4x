...
public enum AdsDataType {
  ...
  public static AdsDataType firstEnumForFieldNumBytes(int numBytes) {
  ...
  public static List<AdsDataType> enumsForFieldNumBytes(int numBytes) {
  ...
  public static AdsDataType firstEnumForFieldPlcValueType(PlcValueType plcValueType) {
    for (AdsDataType _val : AdsDataType.values()) {
      if (_val.getPlcValueType() == plcValueType) {
        return _val;
      }
    }
    return null;
