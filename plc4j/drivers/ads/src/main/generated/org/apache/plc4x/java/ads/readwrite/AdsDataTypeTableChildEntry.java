...
/**
 * In data-type child entries, the name seems to be used by the property name and the data-type name
 * seems to contain what in the parent case the "name" attribute seems to use. TODO: In general only
 * the propertyName, dataTypeName and offset are interesting here. The rest is mostly not fully
 * initialized
 */
