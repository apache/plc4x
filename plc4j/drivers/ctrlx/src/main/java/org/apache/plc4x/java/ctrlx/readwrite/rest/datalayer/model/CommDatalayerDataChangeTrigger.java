...
/**
 * Gets or Sets comm_datalayer_DataChangeTrigger
 */
public enum CommDatalayerDataChangeTrigger {
  
  STATUS("Status"),
  
  STATUSVALUE("StatusValue"),
  
  STATUSVALUETIMESTAMP("StatusValueTimestamp");

  private String value;

  CommDatalayerDataChangeTrigger(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static CommDatalayerDataChangeTrigger fromValue(String value) {
    for (CommDatalayerDataChangeTrigger b : CommDatalayerDataChangeTrigger.values()) {
