...
public enum CommDatalayerQueueBehaviour {
  ...
  CommDatalayerQueueBehaviour(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static CommDatalayerQueueBehaviour fromValue(String value) {
    for (CommDatalayerQueueBehaviour b : CommDatalayerQueueBehaviour.values()) {
