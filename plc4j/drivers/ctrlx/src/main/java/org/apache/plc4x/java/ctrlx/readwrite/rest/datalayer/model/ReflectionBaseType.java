...
/**
 * Gets or Sets reflection_BaseType
 */
public enum ReflectionBaseType {
  ...
  ReflectionBaseType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static ReflectionBaseType fromValue(String value) {
    for (ReflectionBaseType b : ReflectionBaseType.values()) {
