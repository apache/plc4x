...
public class DataLayerInformationAndSettingsApi {
  ...
  public ServerSettings getDatalayerServerSettings() throws ApiException {
    ...
    String localVarPath = "/nodes/datalayer/server/settings";
    ...
    TypeReference<ServerSettings> localVarReturnType = new TypeReference<ServerSettings>() {};
  ...
  /**
   * List of registered non-realtime data (Data Layer NRT) node names
   * List of registered non-realtime data (Data Layer NRT) node names.
   * @return BrowseData
   * @throws ApiException if fails to make API call
   */
  public BrowseData getNodeNames() throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/nodes/datalayer/nodes";
    ...
    TypeReference<BrowseData> localVarReturnType = new TypeReference<BrowseData>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "GET",
        localVarQueryParams,
  ...
  /**
   * Public key for Data Layer communication
   * The public key used for secure Data Layer communication.
   * @return DLString
   * @throws ApiException if fails to make API call
   */
  public DLString getPublicKey() throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/nodes/datalayer/curvemq/publickey";
    ...
    TypeReference<DLString> localVarReturnType = new TypeReference<DLString>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "GET",
        localVarQueryParams,
  ...
  /**
   * List of registered realtime data (Data Layer RT) node names
   * List of registered realtime data (Data Layer RT) node names.
   * @return BrowseData
   * @throws ApiException if fails to make API call
   */
  public BrowseData getRealtimeNodeNames() throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/nodes/datalayer/nodesrt";
  ...
  /**
   * Change Data Layer Server Settings
   * Change Data Layer Server Settings. For debug purposes of provider it&#39;s necessary to increase timeout values to prevent a provider to be disconnected from broker.
   * @param serverSettings The data of the new node (optional)
   * @return ServerSettings
   * @throws ApiException if fails to make API call
   */
  public ServerSettings putDatalayerServerSettings(ServerSettings serverSettings) throws ApiException {
    Object localVarPostBody = serverSettings;
