...
import org.apache.plc4x.java.ctrlx.readwrite.rest.datalayer.auth.Authentication;
import org.apache.plc4x.java.ctrlx.readwrite.rest.datalayer.auth.HttpBearerAuth;
import org.apache.plc4x.java.ctrlx.readwrite.rest.datalayer.auth.OAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  private String basePath = "/automation/api/v2";
  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    ...
    new ServerConfiguration(
      "https://[fe80::dcad:beff:fe00:1]/automation/api/v2",
      "No description provided",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://{host}/automation/api/v2",
      "No description provided",
      new HashMap<String, ServerVariable>() {{
        put("host", new ServerVariable(
          "Hostname or ip address of the ctrlX device",
          "192.168.1.1",
          new HashSet<String>(
          )
        ));
  ...
  public ApiClient(CloseableHttpClient httpClient) {
    ...
    authentications.put("UsernamePassword", new OAuth());
