...
/**
 * References to the other nodes in the datalayer tree
 */
@JsonPropertyOrder({
  Reference.JSON_PROPERTY_TYPE,
  Reference.JSON_PROPERTY_TARGET_ADDRESS
})
...
public class Reference {
  ...
  **/
  ...
  public Reference targetAddress(String targetAddress) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, reference.type) &&
        Objects.equals(this.targetAddress, reference.targetAddress);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `targetAddress` to the URL query string
    if (getTargetAddress() != null) {
      try {
        joiner.add(String.format("%stargetAddress%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTargetAddress()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
