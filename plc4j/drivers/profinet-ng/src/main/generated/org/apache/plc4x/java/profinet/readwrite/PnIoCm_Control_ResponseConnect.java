...
public class PnIoCm_Control_ResponseConnect extends PnIoCm_Block implements Message {

  // Accessors for discriminator values.
  public PnIoCm_BlockType getBlockType() {
    return PnIoCm_BlockType.IOD_CONTROL_RES_CONNECT;
  }
  ...
  public PnIoCm_Control_ResponseConnect(
  ...
  protected void serializePnIoCm_BlockChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("PnIoCm_Control_ResponseConnect");
    ...
    writeBuffer.popContext("PnIoCm_Control_ResponseConnect");
  }
  ...
  public int getLengthInBits() {
    ...
    PnIoCm_Control_ResponseConnect _value = this;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
  ...
  public static PnIoCm_BlockBuilder staticParsePnIoCm_BlockBuilder(ReadBuffer readBuffer)
    ...
    readBuffer.pullContext("PnIoCm_Control_ResponseConnect");
    ...
    readBuffer.closeContext("PnIoCm_Control_ResponseConnect");
    // Create the instance
    return new PnIoCm_Control_ResponseConnectBuilderImpl(
        blockVersionHigh,
        blockVersionLow,
        arUuid,
        sessionKey,
  ...
  public static class PnIoCm_Control_ResponseConnectBuilderImpl
    ...
    public PnIoCm_Control_ResponseConnectBuilderImpl(
        short blockVersionHigh,
        short blockVersionLow,
        Uuid arUuid,
        int sessionKey,
    ...
    public PnIoCm_Control_ResponseConnect build() {
      PnIoCm_Control_ResponseConnect pnIoCm_Control_ResponseConnect =
          new PnIoCm_Control_ResponseConnect(
              blockVersionHigh, blockVersionLow, arUuid, sessionKey, controlCommand);
      pnIoCm_Control_ResponseConnect.reservedField0 = reservedField0;
      pnIoCm_Control_ResponseConnect.reservedField1 = reservedField1;
      pnIoCm_Control_ResponseConnect.reservedField2 = reservedField2;
      return pnIoCm_Control_ResponseConnect;
    }
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof PnIoCm_Control_ResponseConnect)) {
      return false;
    }
    PnIoCm_Control_ResponseConnect that = (PnIoCm_Control_ResponseConnect) o;
