...
public class PnIo_CyclicServiceDataUnit implements Message {
  ...
  public static PnIo_CyclicServiceDataUnit staticParse(ReadBuffer readBuffer, short dataUnitLength)
    ...
    readBuffer.pushContext(WithOption.WithName("PnIo_CyclicServiceDataUnit"));
    int startPos = readBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Array Field: data
    byte[] data = readBuffer.readBits(Math.toIntExact((dataUnitLength) * 8), WithOption.WithName("data"));

    readBuffer.popContext();
    return new PnIo_CyclicServiceDataUnit(data);
  }

  @Override
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("PnIo_CyclicServiceDataUnit"));
