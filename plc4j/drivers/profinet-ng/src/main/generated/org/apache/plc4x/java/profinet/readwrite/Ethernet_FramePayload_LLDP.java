...
public class Ethernet_FramePayload_LLDP extends Ethernet_FramePayload implements Message {
  ...
  public static Ethernet_FramePayloadBuilder staticParseEthernet_FramePayloadBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("Ethernet_FramePayload_LLDP"));
  ...
  protected void serializeEthernet_FramePayloadChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("Ethernet_FramePayload_LLDP"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: pdu
    FieldWriterFactory.writeSimpleField((Lldp_Pdu) pdu, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("pdu"));
  ...
  public static class Ethernet_FramePayloadBuilderImpl implements Ethernet_FramePayload.Ethernet_FramePayloadBuilder {
    ...
    public Ethernet_FramePayloadBuilderImpl(Lldp_Pdu pdu) {
      this.pdu = pdu;
    }

    public Ethernet_FramePayload build() {
      return new Ethernet_FramePayload_LLDP(pdu);
    }
  }
}
