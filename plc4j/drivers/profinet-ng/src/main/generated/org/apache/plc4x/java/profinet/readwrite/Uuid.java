...
public class Uuid implements Message {
  ...
  public static Uuid staticParse(ReadBuffer readBuffer) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("Uuid"));
    int startPos = readBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Array Field: data
    byte[] data = readBuffer.readBits(Math.toIntExact((16) * 8), WithOption.WithName("data"));
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("Uuid"));
