...
public class PnIoCM_Block_ResponseConnect extends PnIoCm_Block implements Message {

  // Accessors for discriminator values.
  public PnIoCm_BlockType getBlockType() {
    return PnIoCm_BlockType.IOX_BLOCK_RES_CONNECT;
  }
  ...
  public PnIoCM_Block_ResponseConnect(
  ...
  protected void serializePnIoCm_BlockChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("PnIoCM_Block_ResponseConnect");
    ...
    writeBuffer.popContext("PnIoCM_Block_ResponseConnect");
  }
  ...
  public int getLengthInBits() {
    ...
    PnIoCM_Block_ResponseConnect _value = this;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
  ...
  public static PnIoCm_BlockBuilder staticParsePnIoCm_BlockBuilder(ReadBuffer readBuffer)
    ...
    readBuffer.pullContext("PnIoCM_Block_ResponseConnect");
    ...
    readBuffer.closeContext("PnIoCM_Block_ResponseConnect");
    // Create the instance
    return new PnIoCM_Block_ResponseConnectBuilderImpl(
        blockVersionHigh,
        blockVersionLow,
        arUuid,
        sessionKey,
  ...
  public static class PnIoCM_Block_ResponseConnectBuilderImpl
    ...
    public PnIoCM_Block_ResponseConnectBuilderImpl(
        short blockVersionHigh,
        short blockVersionLow,
        Uuid arUuid,
        int sessionKey,
    ...
    public PnIoCM_Block_ResponseConnect build() {
      PnIoCM_Block_ResponseConnect pnIoCM_Block_ResponseConnect =
          new PnIoCM_Block_ResponseConnect(
              ...
              controlCommand,
              controlBlockProperties);
      pnIoCM_Block_ResponseConnect.reservedField0 = reservedField0;
      pnIoCM_Block_ResponseConnect.reservedField1 = reservedField1;
      return pnIoCM_Block_ResponseConnect;
    }
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof PnIoCM_Block_ResponseConnect)) {
      return false;
    }
    PnIoCM_Block_ResponseConnect that = (PnIoCM_Block_ResponseConnect) o;
