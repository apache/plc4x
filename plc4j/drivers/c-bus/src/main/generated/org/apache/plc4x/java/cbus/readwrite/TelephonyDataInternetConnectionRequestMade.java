...
public class TelephonyDataInternetConnectionRequestMade extends TelephonyData implements Message {
  ...
  public static class TelephonyDataInternetConnectionRequestMadeBuilderImpl
    ...
    public TelephonyDataInternetConnectionRequestMade build(
        TelephonyCommandTypeContainer commandTypeContainer, byte argument) {
      TelephonyDataInternetConnectionRequestMade telephonyDataInternetConnectionRequestMade =
          new TelephonyDataInternetConnectionRequestMade(commandTypeContainer, argument);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof TelephonyDataInternetConnectionRequestMade)) {
      return false;
    }
    TelephonyDataInternetConnectionRequestMade that =
        (TelephonyDataInternetConnectionRequestMade) o;
