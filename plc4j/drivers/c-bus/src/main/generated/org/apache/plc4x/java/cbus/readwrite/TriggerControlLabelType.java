...
public enum TriggerControlLabelType {
  ...
  private static final Map<Byte, TriggerControlLabelType> map;

  static {
    map = new HashMap<>();
    for (TriggerControlLabelType value : TriggerControlLabelType.values()) {
  ...
  public static TriggerControlLabelType enumForValue(byte value) {
