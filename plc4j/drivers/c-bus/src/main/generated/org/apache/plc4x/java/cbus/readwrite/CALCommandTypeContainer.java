...
public enum CALCommandTypeContainer {
  ...
  public static CALCommandTypeContainer firstEnumForFieldNumBytes(byte numBytes) {
  ...
  public static List<CALCommandTypeContainer> enumsForFieldNumBytes(byte numBytes) {
  ...
  public static CALCommandTypeContainer firstEnumForFieldCommandType(CALCommandType commandType) {
    for (CALCommandTypeContainer _val : CALCommandTypeContainer.values()) {
  ...
  public static List<CALCommandTypeContainer> enumsForFieldCommandType(CALCommandType commandType) {
    List<CALCommandTypeContainer> _values = new ArrayList<>();
    for (CALCommandTypeContainer _val : CALCommandTypeContainer.values()) {
      if (_val.getCommandType() == commandType) {
        _values.add(_val);
