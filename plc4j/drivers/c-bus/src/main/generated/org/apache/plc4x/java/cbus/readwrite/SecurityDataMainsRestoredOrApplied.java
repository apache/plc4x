...
public class SecurityDataMainsRestoredOrApplied extends SecurityData implements Message {
  ...
  public SecurityDataMainsRestoredOrApplied(
  ...
  public static class SecurityDataMainsRestoredOrAppliedBuilder
    ...
    public SecurityDataMainsRestoredOrApplied build(
        SecurityCommandTypeContainer commandTypeContainer, byte argument) {
      SecurityDataMainsRestoredOrApplied securityDataMainsRestoredOrApplied =
          new SecurityDataMainsRestoredOrApplied(commandTypeContainer, argument);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityDataMainsRestoredOrApplied)) {
      return false;
    }
    SecurityDataMainsRestoredOrApplied that = (SecurityDataMainsRestoredOrApplied) o;
