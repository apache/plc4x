...
public class SecurityDataPanicActivated extends SecurityData implements Message {
  ...
  public SecurityDataPanicActivated(
  ...
  protected void serializeSecurityDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("SecurityDataPanicActivated");
  }
  ...
  public static class SecurityDataPanicActivatedBuilderImpl
    ...
    public SecurityDataPanicActivated build(
        SecurityCommandTypeContainer commandTypeContainer, byte argument) {
      SecurityDataPanicActivated securityDataPanicActivated =
          new SecurityDataPanicActivated(commandTypeContainer, argument);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityDataPanicActivated)) {
      return false;
    }
    SecurityDataPanicActivated that = (SecurityDataPanicActivated) o;
