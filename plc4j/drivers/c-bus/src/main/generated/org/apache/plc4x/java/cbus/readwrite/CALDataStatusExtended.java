...
public class CALDataStatusExtended extends CALData implements Message {
  ...
  public static CALDataBuilder staticParseCALDataBuilder(ReadBuffer readBuffer,
    ...
    List<StatusByte> statusBytes = FieldReaderFactory.readCountArrayField(DataReaderFactory.readComplex(() -> DataReaderFactory.castToDeclaredType(StatusByte.class, StatusByte.staticParse(readBuffer)), readBuffer), numberOfStatusBytes, WithOption.WithName("statusBytes"), WithOption.WithFloatEncoding("IEEE754"), WithOption.WithSignedIntegerEncoding("twos-complement"), WithOption.WithUnsignedIntegerEncoding("unsigned-binary"), WithByteBasedOption.WithByteOrder("BIG_ENDIAN"), WithOption.WithStringEncoding("UTF8"));

    // Array Field: levelInformation
    List<LevelInformation> levelInformation = FieldReaderFactory.readCountArrayField(DataReaderFactory.readComplex(() -> DataReaderFactory.castToDeclaredType(LevelInformation.class, LevelInformation.staticParse(readBuffer)), readBuffer), numberOfLevelInformation, WithOption.WithName("levelInformation"), WithOption.WithFloatEncoding("IEEE754"), WithOption.WithSignedIntegerEncoding("twos-complement"), WithOption.WithUnsignedIntegerEncoding("unsigned-binary"), WithByteBasedOption.WithByteOrder("BIG_ENDIAN"), WithOption.WithStringEncoding("UTF8"));
