...
public class SecurityDataLineCutAlarmCleared extends SecurityData implements Message {
  ...
  public SecurityDataLineCutAlarmCleared(
  ...
  protected void serializeSecurityDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("SecurityDataLineCutAlarmCleared");

    writeBuffer.popContext("SecurityDataLineCutAlarmCleared");
  }
  ...
  public static class SecurityDataLineCutAlarmClearedBuilderImpl
    ...
    public SecurityDataLineCutAlarmCleared build(
        SecurityCommandTypeContainer commandTypeContainer, byte argument) {
      SecurityDataLineCutAlarmCleared securityDataLineCutAlarmCleared =
          new SecurityDataLineCutAlarmCleared(commandTypeContainer, argument);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityDataLineCutAlarmCleared)) {
      return false;
    }
    SecurityDataLineCutAlarmCleared that = (SecurityDataLineCutAlarmCleared) o;
