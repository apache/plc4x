...
public class SecurityDataEntryDelayStarted extends SecurityData implements Message {
  ...
  public SecurityDataEntryDelayStarted(
  ...
  protected void serializeSecurityDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("SecurityDataEntryDelayStarted");
  }
  ...
  public static class SecurityDataEntryDelayStartedBuilder
    ...
    public SecurityDataEntryDelayStarted build(
        SecurityCommandTypeContainer commandTypeContainer, byte argument) {
      SecurityDataEntryDelayStarted securityDataEntryDelayStarted =
          new SecurityDataEntryDelayStarted(commandTypeContainer, argument);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityDataEntryDelayStarted)) {
      return false;
    }
    SecurityDataEntryDelayStarted that = (SecurityDataEntryDelayStarted) o;
