...
public enum ApplicationIdContainer {
  ...
  TEMPERATURE_BROADCAST_19((short) 0x19, LightingCompatible.NO, ApplicationId.TEMPERATURE_BROADCAST),
  ...
  POOLS_SPAS_PONDS_FOUNTAINS_CONTROL_72((short) 0x72, LightingCompatible.YES, ApplicationId.POOLS_SPAS_PONDS_FOUNTAINS_CONTROL),
  ...
  MEDIA_TRANSPORT_CONTROL_C0((short) 0xC0, LightingCompatible.NA, ApplicationId.MEDIA_TRANSPORT_CONTROL),
  ...
  TRIGGER_CONTROL_CA((short) 0xCA, LightingCompatible.YES_BUT_RESTRICTIONS, ApplicationId.TRIGGER_CONTROL),

  ENABLE_CONTROL_CB((short) 0xCB, LightingCompatible.YES_BUT_RESTRICTIONS, ApplicationId.ENABLE_CONTROL),

  I_HAVE_NO_IDEA_CC((short) 0xCC, LightingCompatible.NA, ApplicationId.RESERVED),

  AUDIO_AND_VIDEO_CD((short) 0xCD, LightingCompatible.YES_BUT_RESTRICTIONS, ApplicationId.AUDIO_AND_VIDEO),
  ...
  CLOCK_AND_TIMEKEEPING_DF((short) 0xDF, LightingCompatible.NO, ApplicationId.CLOCK_AND_TIMEKEEPING),

  TELEPHONY_STATUS_AND_CONTROL_E0((short) 0xE0, LightingCompatible.NO, ApplicationId.TELEPHONY_STATUS_AND_CONTROL),
  ...
  ApplicationIdContainer(short value, LightingCompatible lightingCompatible,
  ...
  public static ApplicationIdContainer firstEnumForFieldLightingCompatible(
    ...
    for (ApplicationIdContainer _val : ApplicationIdContainer.values()) {
      if (_val.getLightingCompatible() == lightingCompatible) {
        return _val;
      }
    }
    return null;
  ...
  public static ApplicationIdContainer firstEnumForFieldApplicationId(ApplicationId applicationId) {
    for (ApplicationIdContainer _val : ApplicationIdContainer.values()) {
      if (_val.getApplicationId() == applicationId) {
        return _val;
      }
    }
    return null;
  ...
  public static List<ApplicationIdContainer> enumsForFieldApplicationId(
      ApplicationId applicationId) {
    List<ApplicationIdContainer> _values = new ArrayList<>();
    for (ApplicationIdContainer _val : ApplicationIdContainer.values()) {
      if (_val.getApplicationId() == applicationId) {
