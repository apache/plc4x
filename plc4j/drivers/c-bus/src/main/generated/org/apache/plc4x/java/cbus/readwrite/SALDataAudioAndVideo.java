...
public class SALDataAudioAndVideo extends SALData implements Message {
  ...
  public static class SALDataAudioAndVideoBuilderImpl implements SALData.SALDataBuilder {
    ...
    public SALDataAudioAndVideo build(SALData salData) {
      SALDataAudioAndVideo sALDataAudioAndVideo = new SALDataAudioAndVideo(salData, audioVideoData);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SALDataAudioAndVideo)) {
      return false;
    }
    SALDataAudioAndVideo that = (SALDataAudioAndVideo) o;
    return (getAudioVideoData() == that.getAudioVideoData()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getAudioVideoData());
  }
