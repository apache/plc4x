...
public class SALDataMeasurement extends SALData implements Message {
  ...
  public static class SALDataMeasurementBuilderImpl implements SALData.SALDataBuilder {
    ...
    public SALDataMeasurement build(SALData salData) {
      SALDataMeasurement sALDataMeasurement = new SALDataMeasurement(salData, measurementData);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SALDataMeasurement)) {
      return false;
    }
    SALDataMeasurement that = (SALDataMeasurement) o;
    return (getMeasurementData() == that.getMeasurementData()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getMeasurementData());
  }
