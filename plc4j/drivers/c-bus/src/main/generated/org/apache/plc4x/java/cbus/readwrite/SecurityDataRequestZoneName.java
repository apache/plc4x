...
public class SecurityDataRequestZoneName extends SecurityData implements Message {
  ...
  public SecurityDataRequestZoneName(
  ...
  protected void serializeSecurityDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("SecurityDataRequestZoneName");

    // Simple Field (zoneNumber)
    writeSimpleField("zoneNumber", zoneNumber, writeUnsignedShort(writeBuffer, 8));

    writeBuffer.popContext("SecurityDataRequestZoneName");
  }
  ...
  public static class SecurityDataRequestZoneNameBuilderImpl
    ...
    public SecurityDataRequestZoneName build(
        SecurityCommandTypeContainer commandTypeContainer, byte argument) {
      SecurityDataRequestZoneName securityDataRequestZoneName =
          new SecurityDataRequestZoneName(commandTypeContainer, argument, zoneNumber);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityDataRequestZoneName)) {
      return false;
    }
    SecurityDataRequestZoneName that = (SecurityDataRequestZoneName) o;
