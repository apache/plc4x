...
public class SALDataIrrigationControl extends SALData implements Message {
  ...
  public static class SALDataIrrigationControlBuilder implements SALData.SALDataBuilder {
    ...
    public SALDataIrrigationControl build(SALData salData) {
      SALDataIrrigationControl sALDataIrrigationControl =
          new SALDataIrrigationControl(salData, irrigationControlData);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SALDataIrrigationControl)) {
      return false;
    }
    SALDataIrrigationControl that = (SALDataIrrigationControl) o;
    return (getIrrigationControlData() == that.getIrrigationControlData())
        && super.equals(that)
        && true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getIrrigationControlData());
  }
