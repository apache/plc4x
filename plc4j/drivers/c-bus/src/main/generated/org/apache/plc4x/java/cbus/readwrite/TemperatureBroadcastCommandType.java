 ...
 */
public enum TemperatureBroadcastCommandType {
  BROADCAST_EVENT((byte) 0x00, (short) 2);

  private static final Map<Byte, TemperatureBroadcastCommandType> map;

  static {
    map = new HashMap<>();
    for (TemperatureBroadcastCommandType value : TemperatureBroadcastCommandType.values()) {
  ...
  public static TemperatureBroadcastCommandType firstEnumForFieldNumberOfArguments(
  ...
  public static TemperatureBroadcastCommandType enumForValue(byte value) {
