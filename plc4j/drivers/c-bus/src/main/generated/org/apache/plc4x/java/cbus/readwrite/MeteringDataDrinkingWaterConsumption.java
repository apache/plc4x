...
public class MeteringDataDrinkingWaterConsumption extends MeteringData implements Message {
  ...
  public MeteringDataDrinkingWaterConsumption(
      MeteringCommandTypeContainer commandTypeContainer, byte argument, long kL) {
  ...
  protected void serializeMeteringDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    // Simple Field (kL)
    writeSimpleField("kL", kL, writeUnsignedLong(writeBuffer, 32));

    writeBuffer.popContext("MeteringDataDrinkingWaterConsumption");
  }
  ...
  public static class MeteringDataDrinkingWaterConsumptionBuilderImpl
    ...
    public MeteringDataDrinkingWaterConsumption build(
        MeteringCommandTypeContainer commandTypeContainer, byte argument) {
      MeteringDataDrinkingWaterConsumption meteringDataDrinkingWaterConsumption =
          new MeteringDataDrinkingWaterConsumption(commandTypeContainer, argument, kL);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof MeteringDataDrinkingWaterConsumption)) {
      return false;
    }
    MeteringDataDrinkingWaterConsumption that = (MeteringDataDrinkingWaterConsumption) o;
    return (getKL() == that.getKL()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getKL());
  }
