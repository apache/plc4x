...
public class SALDataHvacActuator extends SALData implements Message {
  ...
  public static SALDataBuilder staticParseSALDataBuilder(ReadBuffer readBuffer,
    ...
    readBuffer.pushContext(WithOption.WithName("SALDataHvacActuator"));
    int startPos = readBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: hvacActuatorData
    LightingData hvacActuatorData = FieldReaderFactory.readSimpleField(DataReaderFactory.readComplex(() -> (LightingData) LightingData.staticParse(readBuffer), readBuffer), WithOption.WithName("hvacActuatorData"));
  ...
  protected void serializeSALDataChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("SALDataHvacActuator"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: hvacActuatorData
    FieldWriterFactory.writeSimpleField((LightingData) hvacActuatorData, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("hvacActuatorData"));
