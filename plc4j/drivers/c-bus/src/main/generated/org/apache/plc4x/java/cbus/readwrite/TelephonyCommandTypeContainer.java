...
public enum TelephonyCommandTypeContainer {
  ...
  public static TelephonyCommandTypeContainer firstEnumForFieldNumBytes(byte numBytes) {
  ...
  public static List<TelephonyCommandTypeContainer> enumsForFieldNumBytes(byte numBytes) {
