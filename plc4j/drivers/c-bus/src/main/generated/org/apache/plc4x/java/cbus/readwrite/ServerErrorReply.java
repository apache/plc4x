...
public class ServerErrorReply extends ReplyOrConfirmation implements Message {
  ...
  public static ReplyOrConfirmationBuilder staticParseReplyOrConfirmationBuilder(
      ...
      BufferException {
    readBuffer.pushContext(WithOption.WithName("ServerErrorReply"));
    int startPos = readBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Const Field: errorMarker
    byte errorMarker = FieldReaderFactory.readConstField(DataReaderFactory.readByte(readBuffer, 8), ERRORMARKER, WithOption.WithName("errorMarker"));
  ...
  protected void serializeReplyOrConfirmationChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("ServerErrorReply"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Const Field: errorMarker
    FieldWriterFactory.writeConstField((byte) ERRORMARKER, DataWriterFactory.writeByte(writeBuffer, 8), WithOption.WithName("errorMarker"));
