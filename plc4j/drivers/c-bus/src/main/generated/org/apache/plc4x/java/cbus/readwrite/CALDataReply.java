...
public class CALDataReply extends CALData implements Message {
  ...
  public static CALDataBuilder staticParseCALDataBuilder(ReadBuffer readBuffer,
      ...
      BufferException {
    readBuffer.pushContext(WithOption.WithName("CALDataReply"));
  ...
  protected void serializeCALDataChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("CALDataReply"));
