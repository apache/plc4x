...
public enum SecurityCommandTypeContainer {
  ...
  public static SecurityCommandTypeContainer firstEnumForFieldNumBytes(byte numBytes) {
  ...
  public static List<SecurityCommandTypeContainer> enumsForFieldNumBytes(byte numBytes) {
