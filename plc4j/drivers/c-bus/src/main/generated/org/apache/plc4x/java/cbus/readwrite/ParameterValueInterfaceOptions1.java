...
public class ParameterValueInterfaceOptions1 extends ParameterValue implements Message {
  ...
  public static ParameterValueBuilder staticParseParameterValueBuilder(ReadBuffer readBuffer,
    ...
    readBuffer.pushContext(WithOption.WithName("ParameterValueInterfaceOptions1"));
    ...
    // Simple Field: value
    InterfaceOptions1 value = FieldReaderFactory.readSimpleField(DataReaderFactory.readComplex(() -> (InterfaceOptions1) InterfaceOptions1.staticParse(readBuffer), readBuffer), WithOption.WithName("value"));
  ...
  protected void serializeParameterValueChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("ParameterValueInterfaceOptions1"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Validation Field (Nothing needed here)

    // Simple Field: value
    FieldWriterFactory.writeSimpleField((InterfaceOptions1) value, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("value"));
