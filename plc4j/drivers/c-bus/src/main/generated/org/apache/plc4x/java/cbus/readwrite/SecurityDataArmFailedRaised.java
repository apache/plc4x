...
public class SecurityDataArmFailedRaised extends SecurityData implements Message {
  ...
  public SecurityDataArmFailedRaised(
  ...
  protected void serializeSecurityDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("SecurityDataArmFailedRaised");

    writeBuffer.popContext("SecurityDataArmFailedRaised");
  }
  ...
  public static class SecurityDataArmFailedRaisedBuilderImpl
    ...
    public SecurityDataArmFailedRaised build(
        SecurityCommandTypeContainer commandTypeContainer, byte argument) {
      SecurityDataArmFailedRaised securityDataArmFailedRaised =
          new SecurityDataArmFailedRaised(commandTypeContainer, argument);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityDataArmFailedRaised)) {
      return false;
    }
    SecurityDataArmFailedRaised that = (SecurityDataArmFailedRaised) o;
