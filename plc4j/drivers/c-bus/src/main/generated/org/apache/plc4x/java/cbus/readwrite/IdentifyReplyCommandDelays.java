...
public class IdentifyReplyCommandDelays extends IdentifyReplyCommand implements Message {
  ...
  public int getLengthInBits() {
    ...
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Array Field: terminalLevels
    lengthInBits += 8 * ((terminalLevels != null) ? terminalLevels.length : 0);
  ...
  public static class IdentifyReplyCommandBuilderImpl implements IdentifyReplyCommand.IdentifyReplyCommandBuilder {
    ...
    public IdentifyReplyCommandBuilderImpl(byte[] terminalLevels, byte reStrikeDelay) {
      this.terminalLevels = terminalLevels;
      this.reStrikeDelay = reStrikeDelay;
    }

    public IdentifyReplyCommand build() {
      return new IdentifyReplyCommandDelays(terminalLevels, reStrikeDelay);
    }
  }
}
