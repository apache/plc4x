...
public enum AccessControlCategory {
  SYSTEM_ACTIVITY((byte) 0x00),
  SYSTEM_REQUEST((byte) 0x01);
  private static final Map<Byte, AccessControlCategory> map;
  ...
  public static AccessControlCategory enumForValue(byte value) {
