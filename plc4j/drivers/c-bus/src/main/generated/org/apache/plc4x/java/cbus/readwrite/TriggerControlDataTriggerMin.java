...
public class TriggerControlDataTriggerMin extends TriggerControlData implements Message {
  ...
  public TriggerControlDataTriggerMin(
  ...
  protected void serializeTriggerControlDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("TriggerControlDataTriggerMin");
  }
  ...
  public static class TriggerControlDataTriggerMinBuilderImpl
    ...
    public TriggerControlDataTriggerMin build(
        TriggerControlCommandTypeContainer commandTypeContainer, byte triggerGroup) {
      TriggerControlDataTriggerMin triggerControlDataTriggerMin =
          new TriggerControlDataTriggerMin(commandTypeContainer, triggerGroup);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof TriggerControlDataTriggerMin)) {
      return false;
    }
    TriggerControlDataTriggerMin that = (TriggerControlDataTriggerMin) o;
