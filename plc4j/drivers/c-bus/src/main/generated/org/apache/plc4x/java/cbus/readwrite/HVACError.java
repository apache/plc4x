...
public enum HVACError {
  NO_ERROR((short) 0x00),
  HEATER_TOTAL_FAILURE((short) 0x01),
  COOLER_TOTAL_FAILURE((short) 0x02),
  FAN_TOTAL_FAILURE((short) 0x03),
  TEMPERATURE_SENSOR_FAILURE((short) 0x04),
  HEATER_TEMPORARY_PROBLEM((short) 0x05),
  COOLER_TEMPORARY_PROBLEM((short) 0x06),
  FAN_TEMPORARY_PROBLEM((short) 0x07),
  HEATER_SERVICE_REQUIRED((short) 0x08),
  COOLER_SERVICE_REQUIRED((short) 0x09),
  ...
  private static final Map<Short, HVACError> map;

  static {
    map = new HashMap<>();
    for (HVACError value : HVACError.values()) {
  ...
  public static HVACError enumForValue(short value) {
