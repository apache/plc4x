...
public class SecurityDataLowBatteryDetected extends SecurityData implements Message {
  ...
  public SecurityDataLowBatteryDetected(
  ...
  protected void serializeSecurityDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("SecurityDataLowBatteryDetected");
  }
  ...
  public static class SecurityDataLowBatteryDetectedBuilderImpl
    ...
    public SecurityDataLowBatteryDetected build(
        SecurityCommandTypeContainer commandTypeContainer, byte argument) {
      SecurityDataLowBatteryDetected securityDataLowBatteryDetected =
          new SecurityDataLowBatteryDetected(commandTypeContainer, argument);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityDataLowBatteryDetected)) {
      return false;
    }
    SecurityDataLowBatteryDetected that = (SecurityDataLowBatteryDetected) o;
