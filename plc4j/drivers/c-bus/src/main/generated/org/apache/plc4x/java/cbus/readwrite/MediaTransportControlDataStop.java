...
public class MediaTransportControlDataStop extends MediaTransportControlData implements Message {
  ...
  public static class MediaTransportControlDataStopBuilderImpl
    ...
    public MediaTransportControlDataStop build(
        MediaTransportControlCommandTypeContainer commandTypeContainer, byte mediaLinkGroup) {
      MediaTransportControlDataStop mediaTransportControlDataStop =
          new MediaTransportControlDataStop(commandTypeContainer, mediaLinkGroup);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof MediaTransportControlDataStop)) {
      return false;
    }
    MediaTransportControlDataStop that = (MediaTransportControlDataStop) o;
