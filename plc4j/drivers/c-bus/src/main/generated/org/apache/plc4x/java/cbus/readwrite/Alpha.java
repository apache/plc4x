...
public class Alpha implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeSimpleField("character", character, writeByte(writeBuffer, 8));

    writeBuffer.popContext("Alpha");
  }
  ...
  public static Alpha staticParse(ReadBuffer readBuffer) throws ParseException {
    ...
    readBuffer.closeContext("Alpha");
    // Create the instance
    Alpha _alpha;
    _alpha = new Alpha(character);
    return _alpha;
  }
  ...
  public boolean equals(Object o) {
    ...
    Alpha that = (Alpha) o;
    return (getCharacter() == that.getCharacter()) && true;
  }
