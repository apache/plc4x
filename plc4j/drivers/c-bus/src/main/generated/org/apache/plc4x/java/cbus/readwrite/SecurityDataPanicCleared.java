...
public class SecurityDataPanicCleared extends SecurityData implements Message {
  ...
  public SecurityDataPanicCleared(
  ...
  protected void serializeSecurityDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("SecurityDataPanicCleared");

    writeBuffer.popContext("SecurityDataPanicCleared");
  }
  ...
  public static class SecurityDataPanicClearedBuilderImpl
    ...
    public SecurityDataPanicCleared build(
        SecurityCommandTypeContainer commandTypeContainer, byte argument) {
      SecurityDataPanicCleared securityDataPanicCleared =
          new SecurityDataPanicCleared(commandTypeContainer, argument);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityDataPanicCleared)) {
      return false;
    }
    SecurityDataPanicCleared that = (SecurityDataPanicCleared) o;
