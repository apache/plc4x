...
public class AccessControlDataRequestToExit extends AccessControlData implements Message {
  ...
  public AccessControlDataRequestToExit(
  ...
  protected void serializeAccessControlDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("AccessControlDataRequestToExit");
  }
  ...
  public static class AccessControlDataRequestToExitBuilderImpl
    ...
    public AccessControlDataRequestToExit build(
        ...
        byte networkId,
        byte accessPointId) {
      AccessControlDataRequestToExit accessControlDataRequestToExit =
          new AccessControlDataRequestToExit(commandTypeContainer, networkId, accessPointId);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof AccessControlDataRequestToExit)) {
      return false;
    }
    AccessControlDataRequestToExit that = (AccessControlDataRequestToExit) o;
