...
public class SecurityDataZoneName extends SecurityData implements Message {
  ...
  protected void serializeSecurityDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeSimpleField("zoneName", zoneName, writeString(writeBuffer, 88));

    writeBuffer.popContext("SecurityDataZoneName");
  }
  ...
  public static SecurityDataBuilder staticParseSecurityDataBuilder(ReadBuffer readBuffer)
    ...
    String zoneName = readSimpleField("zoneName", readString(readBuffer, 88));
  ...
  public static class SecurityDataZoneNameBuilderImpl implements SecurityData.SecurityDataBuilder {
    ...
    public SecurityDataZoneName build(
        SecurityCommandTypeContainer commandTypeContainer, byte argument) {
      SecurityDataZoneName securityDataZoneName =
          new SecurityDataZoneName(commandTypeContainer, argument, zoneNumber, zoneName);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityDataZoneName)) {
      return false;
    }
    SecurityDataZoneName that = (SecurityDataZoneName) o;
    return (getZoneNumber() == that.getZoneNumber())
        && (getZoneName() == that.getZoneName())
        && super.equals(that)
        && true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getZoneNumber(), getZoneName());
  }
