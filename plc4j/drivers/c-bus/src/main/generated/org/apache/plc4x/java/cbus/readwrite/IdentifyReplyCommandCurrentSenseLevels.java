 ...
 */
public class IdentifyReplyCommandCurrentSenseLevels extends IdentifyReplyCommand implements Message {
  ...
  /**
   * Property field currentSenseLevels
   */
  ...
  public int getLengthInBits() {
    ...
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Array Field: currentSenseLevels
    lengthInBits += 8 * ((currentSenseLevels != null) ? currentSenseLevels.length : 0);
  ...
  public static class IdentifyReplyCommandBuilderImpl implements IdentifyReplyCommand.IdentifyReplyCommandBuilder {
    ...
    public IdentifyReplyCommandBuilderImpl(byte[] currentSenseLevels) {
      this.currentSenseLevels = currentSenseLevels;
    }

    public IdentifyReplyCommand build() {
      return new IdentifyReplyCommandCurrentSenseLevels(currentSenseLevels);
    }
  }
}
