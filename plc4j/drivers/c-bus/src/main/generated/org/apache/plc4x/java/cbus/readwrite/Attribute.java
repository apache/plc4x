...
public enum Attribute {
  ...
  public static Attribute firstEnumForFieldBytesReturned(short bytesReturned) {
    for (Attribute _val : Attribute.values()) {
      if (_val.getBytesReturned() == bytesReturned) {
        return _val;
      }
    }
    return null;
  ...
  public static List<Attribute> enumsForFieldBytesReturned(short bytesReturned) {
