...
public class SecurityDataGasAlarmRaised extends SecurityData implements Message {
  ...
  public SecurityDataGasAlarmRaised(
  ...
  protected void serializeSecurityDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("SecurityDataGasAlarmRaised");
  }
  ...
  public static class SecurityDataGasAlarmRaisedBuilderImpl
    ...
    public SecurityDataGasAlarmRaised build(
        SecurityCommandTypeContainer commandTypeContainer, byte argument) {
      SecurityDataGasAlarmRaised securityDataGasAlarmRaised =
          new SecurityDataGasAlarmRaised(commandTypeContainer, argument);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityDataGasAlarmRaised)) {
      return false;
    }
    SecurityDataGasAlarmRaised that = (SecurityDataGasAlarmRaised) o;
