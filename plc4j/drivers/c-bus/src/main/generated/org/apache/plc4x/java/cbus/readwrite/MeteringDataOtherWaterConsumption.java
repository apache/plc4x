...
public class MeteringDataOtherWaterConsumption extends MeteringData implements Message {
  ...
  public MeteringDataOtherWaterConsumption(
  ...
  protected void serializeMeteringDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("MeteringDataOtherWaterConsumption");
  }
  ...
  public static class MeteringDataOtherWaterConsumptionBuilderImpl
    ...
    public MeteringDataOtherWaterConsumption build(
        MeteringCommandTypeContainer commandTypeContainer, byte argument) {
      MeteringDataOtherWaterConsumption meteringDataOtherWaterConsumption =
          new MeteringDataOtherWaterConsumption(commandTypeContainer, argument, kL);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof MeteringDataOtherWaterConsumption)) {
      return false;
    }
    MeteringDataOtherWaterConsumption that = (MeteringDataOtherWaterConsumption) o;
