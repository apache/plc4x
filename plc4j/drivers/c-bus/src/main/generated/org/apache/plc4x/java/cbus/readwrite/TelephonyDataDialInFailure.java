...
public class TelephonyDataDialInFailure extends TelephonyData implements Message {
  ...
  public TelephonyDataDialInFailure(
  ...
  protected void serializeTelephonyDataChild(WriteBuffer writeBuffer)
    ...
    writeSimpleEnumField(
        ...
        reason,
        writeEnum(
            DialInFailureReason::getValue,
            DialInFailureReason::name,
            writeUnsignedShort(writeBuffer, 8)));

    writeBuffer.popContext("TelephonyDataDialInFailure");
  }
  ...
  public static TelephonyDataBuilder staticParseTelephonyDataBuilder(ReadBuffer readBuffer)
    ...
    DialInFailureReason reason =
        readEnumField(
            "reason",
            "DialInFailureReason",
            readEnum(DialInFailureReason::enumForValue, readUnsignedShort(readBuffer, 8)));
  ...
  public static class TelephonyDataDialInFailureBuilderImpl
    ...
    public TelephonyDataDialInFailure build(
        TelephonyCommandTypeContainer commandTypeContainer, byte argument) {
      TelephonyDataDialInFailure telephonyDataDialInFailure =
          new TelephonyDataDialInFailure(commandTypeContainer, argument, reason);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof TelephonyDataDialInFailure)) {
      return false;
    }
    TelephonyDataDialInFailure that = (TelephonyDataDialInFailure) o;
