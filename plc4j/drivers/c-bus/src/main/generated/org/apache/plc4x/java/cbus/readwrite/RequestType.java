...
public enum RequestType {
  ...
  public static RequestType firstEnumForFieldControlChar(short controlChar) {
    for (RequestType _val : RequestType.values()) {
      if (_val.getControlChar() == controlChar) {
        return _val;
      }
    }
    return null;
  ...
  public static List<RequestType> enumsForFieldControlChar(short controlChar) {
