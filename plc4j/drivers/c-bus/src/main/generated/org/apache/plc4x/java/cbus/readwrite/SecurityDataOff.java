...
public class SecurityDataOff extends SecurityData implements Message {
  ...
  protected void serializeSecurityDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("SecurityDataOff");
  }
  ...
  public static class SecurityDataOffBuilderImpl implements SecurityData.SecurityDataBuilder {
    ...
    public SecurityDataOff build(SecurityCommandTypeContainer commandTypeContainer, byte argument) {
      SecurityDataOff securityDataOff = new SecurityDataOff(commandTypeContainer, argument, data);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityDataOff)) {
      return false;
    }
    SecurityDataOff that = (SecurityDataOff) o;
