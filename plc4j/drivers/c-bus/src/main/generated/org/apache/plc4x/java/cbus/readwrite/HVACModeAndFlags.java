...
public class HVACModeAndFlags implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("HVACModeAndFlags");
    ...
    writeBuffer.popContext("HVACModeAndFlags");
  }
  ...
  public static HVACModeAndFlags staticParse(ReadBuffer readBuffer) throws ParseException {
    ...
    boolean isLevelTemperature = readVirtualField("isLevelTemperature", boolean.class, !(level));
    ...
    // Create the instance
    HVACModeAndFlags _hVACModeAndFlags;
    _hVACModeAndFlags = new HVACModeAndFlags(auxiliaryLevel, guard, setback, level, mode);
    _hVACModeAndFlags.reservedField0 = reservedField0;
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof HVACModeAndFlags)) {
      return false;
    }
    HVACModeAndFlags that = (HVACModeAndFlags) o;
