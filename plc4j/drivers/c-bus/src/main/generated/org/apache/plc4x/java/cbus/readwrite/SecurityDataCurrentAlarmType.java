...
public class SecurityDataCurrentAlarmType extends SecurityData implements Message {
  ...
  public SecurityDataCurrentAlarmType(
  ...
  protected void serializeSecurityDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("SecurityDataCurrentAlarmType");
  }
  ...
  public static class SecurityDataCurrentAlarmTypeBuilderImpl
    ...
    public SecurityDataCurrentAlarmType build(
        SecurityCommandTypeContainer commandTypeContainer, byte argument) {
      SecurityDataCurrentAlarmType securityDataCurrentAlarmType =
          new SecurityDataCurrentAlarmType(commandTypeContainer, argument);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityDataCurrentAlarmType)) {
      return false;
    }
    SecurityDataCurrentAlarmType that = (SecurityDataCurrentAlarmType) o;
