...
public class ParameterValueSerialNumber extends ParameterValue implements Message {
  ...
  public static ParameterValueBuilder staticParseParameterValueBuilder(ReadBuffer readBuffer,
    ...
    // Validation Field
    if(!((numBytes) >= (4))) {
      throw new ParseAssertException("SerialNumber has exactly four bytes");
    }

    // Simple Field: value
    SerialNumber value = FieldReaderFactory.readSimpleField(DataReaderFactory.readComplex(() -> DataReaderFactory.castToDeclaredType(SerialNumber.class, SerialNumber.staticParse(readBuffer)), readBuffer), WithOption.WithName("value"), WithOption.WithFloatEncoding("IEEE754"), WithOption.WithSignedIntegerEncoding("twos-complement"), WithOption.WithUnsignedIntegerEncoding("unsigned-binary"), WithByteBasedOption.WithByteOrder("BIG_ENDIAN"), WithOption.WithStringEncoding("UTF8"));
  ...
  public static class ParameterValueBuilderImpl implements ParameterValue.ParameterValueBuilder {
    ...
    public ParameterValueBuilderImpl(SerialNumber value, byte[] data) {
      this.value = value;
      this.data = data;
    }

    public ParameterValue build() {
      return new ParameterValueSerialNumber(value, data);
    }
  }
}
