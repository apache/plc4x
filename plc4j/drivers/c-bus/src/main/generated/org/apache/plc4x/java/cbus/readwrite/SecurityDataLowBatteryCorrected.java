...
public class SecurityDataLowBatteryCorrected extends SecurityData implements Message {
  ...
  public SecurityDataLowBatteryCorrected(
  ...
  protected void serializeSecurityDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("SecurityDataLowBatteryCorrected");

    writeBuffer.popContext("SecurityDataLowBatteryCorrected");
  }
  ...
  public static class SecurityDataLowBatteryCorrectedBuilderImpl
    ...
    public SecurityDataLowBatteryCorrected build(
        SecurityCommandTypeContainer commandTypeContainer, byte argument) {
      SecurityDataLowBatteryCorrected securityDataLowBatteryCorrected =
          new SecurityDataLowBatteryCorrected(commandTypeContainer, argument);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityDataLowBatteryCorrected)) {
      return false;
    }
    SecurityDataLowBatteryCorrected that = (SecurityDataLowBatteryCorrected) o;
