...
public class SecurityDataAlarmOn extends SecurityData implements Message {
  ...
  protected void serializeSecurityDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("SecurityDataAlarmOn");
  }
  ...
  public static class SecurityDataAlarmOnBuilderImpl implements SecurityData.SecurityDataBuilder {
    ...
    public SecurityDataAlarmOn build(
      ...
      SecurityDataAlarmOn securityDataAlarmOn =
          new SecurityDataAlarmOn(commandTypeContainer, argument);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityDataAlarmOn)) {
      return false;
    }
    SecurityDataAlarmOn that = (SecurityDataAlarmOn) o;
