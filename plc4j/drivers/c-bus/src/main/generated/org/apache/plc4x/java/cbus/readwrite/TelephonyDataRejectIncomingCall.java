...
public class TelephonyDataRejectIncomingCall extends TelephonyData implements Message {
  ...
  public TelephonyDataRejectIncomingCall(
  ...
  protected void serializeTelephonyDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("TelephonyDataRejectIncomingCall");
  }
  ...
  public static class TelephonyDataRejectIncomingCallBuilderImpl
    ...
    public TelephonyDataRejectIncomingCall build(
        TelephonyCommandTypeContainer commandTypeContainer, byte argument) {
      TelephonyDataRejectIncomingCall telephonyDataRejectIncomingCall =
          new TelephonyDataRejectIncomingCall(commandTypeContainer, argument);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof TelephonyDataRejectIncomingCall)) {
      return false;
    }
    TelephonyDataRejectIncomingCall that = (TelephonyDataRejectIncomingCall) o;
