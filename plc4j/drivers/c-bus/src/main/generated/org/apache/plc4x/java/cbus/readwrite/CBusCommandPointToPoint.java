...
public class CBusCommandPointToPoint extends CBusCommand implements Message {
  ...
  public static CBusCommandBuilder staticParseCBusCommandBuilder(ReadBuffer readBuffer,
    ...
    readBuffer.pushContext(WithOption.WithName("CBusCommandPointToPoint"));
    int startPos = readBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: command
    CBusPointToPointCommand command = FieldReaderFactory.readSimpleField(DataReaderFactory.readComplex(() -> (CBusPointToPointCommand) CBusPointToPointCommand.staticParse(readBuffer, (org.apache.plc4x.java.cbus.readwrite.CBusOptions) (cBusOptions)), readBuffer), WithOption.WithName("command"));
  ...
  protected void serializeCBusCommandChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("CBusCommandPointToPoint"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: command
    FieldWriterFactory.writeSimpleField((CBusPointToPointCommand) command, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("command"));
