...
public class SALDataAccessControl extends SALData implements Message {
  ...
  public static SALDataBuilder staticParseSALDataBuilder(ReadBuffer readBuffer,
    ...
    readBuffer.pushContext(WithOption.WithName("SALDataAccessControl"));
  ...
  protected void serializeSALDataChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("SALDataAccessControl"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: accessControlData
    FieldWriterFactory.writeSimpleField((AccessControlData) accessControlData, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("accessControlData"));
