...
public class SecurityDataLineCutAlarmRaised extends SecurityData implements Message {
  ...
  public SecurityDataLineCutAlarmRaised(
  ...
  protected void serializeSecurityDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("SecurityDataLineCutAlarmRaised");
  }
  ...
  public static class SecurityDataLineCutAlarmRaisedBuilderImpl
    ...
    public SecurityDataLineCutAlarmRaised build(
        SecurityCommandTypeContainer commandTypeContainer, byte argument) {
      SecurityDataLineCutAlarmRaised securityDataLineCutAlarmRaised =
          new SecurityDataLineCutAlarmRaised(commandTypeContainer, argument);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityDataLineCutAlarmRaised)) {
      return false;
    }
    SecurityDataLineCutAlarmRaised that = (SecurityDataLineCutAlarmRaised) o;
