 ...
 */
public class AirConditioningDataSetHumidityUpperGuardLimit extends AirConditioningData implements Message {
  ...
  public AirConditioningDataSetHumidityUpperGuardLimit(
      ...
      HVACZoneList zoneList, HVACHumidity limit, HVACHumidityModeAndFlags hvacModeAndFlags) {
  ...
  public static AirConditioningDataBuilder staticParseAirConditioningDataBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("AirConditioningDataSetHumidityUpperGuardLimit"));
  ...
  protected void serializeAirConditioningDataChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("AirConditioningDataSetHumidityUpperGuardLimit"));
    ...
    // Simple Field: limit
    FieldWriterFactory.writeSimpleField((HVACHumidity) limit, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("limit"));

    // Simple Field: hvacModeAndFlags
    FieldWriterFactory.writeSimpleField((HVACHumidityModeAndFlags) hvacModeAndFlags, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("hvacModeAndFlags"));
  ...
  public static class AirConditioningDataBuilderImpl implements AirConditioningData.AirConditioningDataBuilder {
    ...
    public AirConditioningDataBuilderImpl(byte zoneGroup, HVACZoneList zoneList, HVACHumidity limit,
    ...
    public AirConditioningData build(AirConditioningCommandTypeContainer commandTypeContainer) {
      return new AirConditioningDataSetHumidityUpperGuardLimit(commandTypeContainer, zoneGroup, zoneList, limit, hvacModeAndFlags);
    }
  }
}
