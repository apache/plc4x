...
public class SecurityDataStatus1Request extends SecurityData implements Message {
  ...
  public SecurityDataStatus1Request(
  ...
  protected void serializeSecurityDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("SecurityDataStatus1Request");

    writeBuffer.popContext("SecurityDataStatus1Request");
  }
  ...
  public static class SecurityDataStatus1RequestBuilder
    ...
    public SecurityDataStatus1Request build(
        SecurityCommandTypeContainer commandTypeContainer, byte argument) {
      SecurityDataStatus1Request securityDataStatus1Request =
          new SecurityDataStatus1Request(commandTypeContainer, argument);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityDataStatus1Request)) {
      return false;
    }
    SecurityDataStatus1Request that = (SecurityDataStatus1Request) o;
