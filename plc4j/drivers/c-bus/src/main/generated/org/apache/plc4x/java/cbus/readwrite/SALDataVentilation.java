...
public class SALDataVentilation extends SALData implements Message {
  ...
  public static SALDataBuilder staticParseSALDataBuilder(ReadBuffer readBuffer,
    ...
    readBuffer.pushContext(WithOption.WithName("SALDataVentilation"));
    int startPos = readBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: ventilationData
    LightingData ventilationData = FieldReaderFactory.readSimpleField(DataReaderFactory.readComplex(() -> (LightingData) LightingData.staticParse(readBuffer), readBuffer), WithOption.WithName("ventilationData"));
  ...
  protected void serializeSALDataChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("SALDataVentilation"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: ventilationData
    FieldWriterFactory.writeSimpleField((LightingData) ventilationData, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("ventilationData"));
