...
public class SALDataVentilation extends SALData implements Message {
  ...
  /**
   * Property field ventilationData
   */
  ...
  public static SALDataBuilder staticParseSALDataBuilder(ReadBuffer readBuffer,
    ...
    readBuffer.pushContext(WithOption.WithName("SALDataVentilation"), WithOption.WithFloatEncoding("IEEE754"), WithOption.WithSignedIntegerEncoding("twos-complement"), WithOption.WithUnsignedIntegerEncoding("unsigned-binary"), WithByteBasedOption.WithByteOrder("BIG_ENDIAN"), WithOption.WithStringEncoding("UTF8"));
  ...
  protected void serializeSALDataChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("SALDataVentilation"), WithOption.WithFloatEncoding("IEEE754"), WithOption.WithSignedIntegerEncoding("twos-complement"), WithOption.WithUnsignedIntegerEncoding("unsigned-binary"), WithByteBasedOption.WithByteOrder("BIG_ENDIAN"), WithOption.WithStringEncoding("UTF8"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: ventilationData
    FieldWriterFactory.writeSimpleField((LightingData) ventilationData, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("ventilationData"), WithOption.WithFloatEncoding("IEEE754"), WithOption.WithSignedIntegerEncoding("twos-complement"), WithOption.WithUnsignedIntegerEncoding("unsigned-binary"), WithByteBasedOption.WithByteOrder("BIG_ENDIAN"), WithOption.WithStringEncoding("UTF8"));
  ...
  public static class SALDataBuilderImpl implements SALData.SALDataBuilder {
    ...
    public SALDataBuilderImpl(LightingData ventilationData) {
      this.ventilationData = ventilationData;
    }

    public SALData build(SALData salData) {
      return new SALDataVentilation(salData, ventilationData);
    }
  }
}
