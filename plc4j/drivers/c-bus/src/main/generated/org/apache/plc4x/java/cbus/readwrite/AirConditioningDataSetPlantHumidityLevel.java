 ...
 */
public class AirConditioningDataSetPlantHumidityLevel extends AirConditioningData implements Message {
  ...
  public static AirConditioningDataBuilder staticParseAirConditioningDataBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("AirConditioningDataSetPlantHumidityLevel"));
    ...
    HVACAuxiliaryLevel auxLevel = FieldReaderFactory.readOptionalField(DataReaderFactory.readComplex(() -> DataReaderFactory.castToDeclaredType(HVACAuxiliaryLevel.class, HVACAuxiliaryLevel.staticParse(readBuffer)), readBuffer), humidityModeAndFlags.getIsAuxLevelUsed(), WithOption.WithName("auxLevel"));
  ...
  protected void serializeAirConditioningDataChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("AirConditioningDataSetPlantHumidityLevel"));
  ...
  public static class AirConditioningDataBuilderImpl implements AirConditioningData.AirConditioningDataBuilder {
    ...
    public AirConditioningData build(AirConditioningCommandTypeContainer commandTypeContainer) {
      return new AirConditioningDataSetPlantHumidityLevel(commandTypeContainer, zoneGroup, zoneList, humidityModeAndFlags, humidityType, level, rawLevel, auxLevel);
    }
  }
}
