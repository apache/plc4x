...
public class SecurityDataArmFailedCleared extends SecurityData implements Message {
  ...
  public SecurityDataArmFailedCleared(
  ...
  protected void serializeSecurityDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("SecurityDataArmFailedCleared");
  }
  ...
  public static class SecurityDataArmFailedClearedBuilder
    ...
    public SecurityDataArmFailedCleared build(
        SecurityCommandTypeContainer commandTypeContainer, byte argument) {
      SecurityDataArmFailedCleared securityDataArmFailedCleared =
          new SecurityDataArmFailedCleared(commandTypeContainer, argument);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityDataArmFailedCleared)) {
      return false;
    }
    SecurityDataArmFailedCleared that = (SecurityDataArmFailedCleared) o;
