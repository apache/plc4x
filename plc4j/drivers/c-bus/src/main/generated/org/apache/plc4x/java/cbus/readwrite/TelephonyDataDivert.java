...
public class TelephonyDataDivert extends TelephonyData implements Message {
  ...
  protected void serializeTelephonyDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("TelephonyDataDivert");
  }
  ...
  public static TelephonyDataDivertBuilder staticParseBuilder(
    ...
    String number =
        readSimpleField(
            "number", readString(readBuffer, (((commandTypeContainer.getNumBytes()) - (1))) * (8)));
  ...
  public static class TelephonyDataDivertBuilder implements TelephonyData.TelephonyDataBuilder {
    ...
    public TelephonyDataDivert build(
        TelephonyCommandTypeContainer commandTypeContainer, byte argument) {
      TelephonyDataDivert telephonyDataDivert =
          new TelephonyDataDivert(commandTypeContainer, argument, number);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof TelephonyDataDivert)) {
      return false;
    }
    TelephonyDataDivert that = (TelephonyDataDivert) o;
