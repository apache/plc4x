...
public class RequestNull extends Request implements Message {
  ...
  public RequestNull(RequestType peekedByte, RequestType startingCR, RequestType resetMode,
  ...
  public static class RequestBuilderImpl implements Request.RequestBuilder {
    ...
    public Request build(RequestType peekedByte, RequestType startingCR, RequestType resetMode,
        RequestType secondPeek, RequestTermination termination) {
      return new RequestNull(peekedByte, startingCR, resetMode, secondPeek, termination);
    }
  }
}
