...
public class AccessControlDataLockAccessPoint extends AccessControlData implements Message {
  ...
  public AccessControlDataLockAccessPoint(
  ...
  protected void serializeAccessControlDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("AccessControlDataLockAccessPoint");
  }
  ...
  public static class AccessControlDataLockAccessPointBuilderImpl
    ...
    public AccessControlDataLockAccessPoint build(
        ...
        byte networkId,
        byte accessPointId) {
      AccessControlDataLockAccessPoint accessControlDataLockAccessPoint =
          new AccessControlDataLockAccessPoint(commandTypeContainer, networkId, accessPointId);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof AccessControlDataLockAccessPoint)) {
      return false;
    }
    AccessControlDataLockAccessPoint that = (AccessControlDataLockAccessPoint) o;
