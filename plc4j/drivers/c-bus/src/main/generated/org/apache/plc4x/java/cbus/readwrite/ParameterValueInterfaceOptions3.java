...
public class ParameterValueInterfaceOptions3 extends ParameterValue implements Message {
  ...
  protected void serializeParameterValueChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("ParameterValueInterfaceOptions3");
  }
  ...
  public static ParameterValueBuilder staticParseParameterValueBuilder(
    ...
    // Create the instance
    return new ParameterValueInterfaceOptions3BuilderImpl(value, data);
  }
  ...
  public static class ParameterValueInterfaceOptions3BuilderImpl
    ...
    public ParameterValueInterfaceOptions3BuilderImpl(InterfaceOptions3 value, byte[] data) {
      this.value = value;
      this.data = data;
    }

    public ParameterValueInterfaceOptions3 build() {
      ParameterValueInterfaceOptions3 parameterValueInterfaceOptions3 =
          new ParameterValueInterfaceOptions3(value, data);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ParameterValueInterfaceOptions3)) {
      return false;
    }
    ParameterValueInterfaceOptions3 that = (ParameterValueInterfaceOptions3) o;
