...
public class ParameterValueApplicationAddress1 extends ParameterValue implements Message {
  ...
  public static ParameterValueBuilder staticParseParameterValueBuilder(ReadBuffer readBuffer,
    ...
    readBuffer.pushContext(WithOption.WithName("ParameterValueApplicationAddress1"));
    ...
    // Simple Field: value
    ApplicationAddress1 value = FieldReaderFactory.readSimpleField(DataReaderFactory.readComplex(() -> (ApplicationAddress1) ApplicationAddress1.staticParse(readBuffer), readBuffer), WithOption.WithName("value"));
  ...
  protected void serializeParameterValueChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("ParameterValueApplicationAddress1"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Validation Field (Nothing needed here)

    // Simple Field: value
    FieldWriterFactory.writeSimpleField((ApplicationAddress1) value, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("value"));
