...
public class SALDataEnableControl extends SALData implements Message {
  ...
  public static class SALDataEnableControlBuilderImpl implements SALData.SALDataBuilder {
    ...
    public SALDataEnableControl build(SALData salData) {
      SALDataEnableControl sALDataEnableControl =
          new SALDataEnableControl(salData, enableControlData);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SALDataEnableControl)) {
      return false;
    }
    SALDataEnableControl that = (SALDataEnableControl) o;
    return (getEnableControlData() == that.getEnableControlData()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getEnableControlData());
  }
