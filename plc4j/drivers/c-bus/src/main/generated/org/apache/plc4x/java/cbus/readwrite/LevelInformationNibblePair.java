...
public enum LevelInformationNibblePair {
  ...
  public static LevelInformationNibblePair firstEnumForFieldNibbleValue(byte nibbleValue) {
    for (LevelInformationNibblePair _val : LevelInformationNibblePair.values()) {
      if (_val.getNibbleValue() == nibbleValue) {
        return _val;
      }
    }
    return null;
  ...
  public static List<LevelInformationNibblePair> enumsForFieldNibbleValue(byte nibbleValue) {
