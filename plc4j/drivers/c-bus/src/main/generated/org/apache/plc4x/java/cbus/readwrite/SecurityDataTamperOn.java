...
public class SecurityDataTamperOn extends SecurityData implements Message {
  ...
  protected void serializeSecurityDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("SecurityDataTamperOn");
  }
  ...
  public static class SecurityDataTamperOnBuilderImpl implements SecurityData.SecurityDataBuilder {
    ...
    public SecurityDataTamperOn build(
      ...
      SecurityDataTamperOn securityDataTamperOn =
          new SecurityDataTamperOn(commandTypeContainer, argument);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityDataTamperOn)) {
      return false;
    }
    SecurityDataTamperOn that = (SecurityDataTamperOn) o;
