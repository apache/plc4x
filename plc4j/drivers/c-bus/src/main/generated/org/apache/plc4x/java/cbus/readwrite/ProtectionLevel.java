...
public enum ProtectionLevel {
  ...
  public static ProtectionLevel firstEnumForFieldDescription(String description) {
  ...
  public static List<ProtectionLevel> enumsForFieldDescription(String description) {
