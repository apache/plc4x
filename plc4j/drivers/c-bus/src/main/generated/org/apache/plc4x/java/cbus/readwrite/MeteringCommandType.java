...
public enum MeteringCommandType {
  ...
  public static MeteringCommandType firstEnumForFieldNumberOfArguments(short numberOfArguments) {
  ...
  public static List<MeteringCommandType> enumsForFieldNumberOfArguments(short numberOfArguments) {
