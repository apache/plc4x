...
public class SecurityDataZoneUnsealed extends SecurityData implements Message {
  ...
  public SecurityDataZoneUnsealed(
  ...
  protected void serializeSecurityDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("SecurityDataZoneUnsealed");
  }
  ...
  public static class SecurityDataZoneUnsealedBuilderImpl
    ...
    public SecurityDataZoneUnsealed build(
        SecurityCommandTypeContainer commandTypeContainer, byte argument) {
      SecurityDataZoneUnsealed securityDataZoneUnsealed =
          new SecurityDataZoneUnsealed(commandTypeContainer, argument, zoneNumber);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityDataZoneUnsealed)) {
      return false;
    }
    SecurityDataZoneUnsealed that = (SecurityDataZoneUnsealed) o;
