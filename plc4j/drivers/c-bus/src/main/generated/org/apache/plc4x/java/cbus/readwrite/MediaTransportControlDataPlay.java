...
public class MediaTransportControlDataPlay extends MediaTransportControlData implements Message {
  ...
  protected void serializeMediaTransportControlDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("MediaTransportControlDataPlay");
  }
  ...
  public static class MediaTransportControlDataPlayBuilder
    ...
    public MediaTransportControlDataPlay build(
        MediaTransportControlCommandTypeContainer commandTypeContainer, byte mediaLinkGroup) {
      MediaTransportControlDataPlay mediaTransportControlDataPlay =
          new MediaTransportControlDataPlay(commandTypeContainer, mediaLinkGroup);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof MediaTransportControlDataPlay)) {
      return false;
    }
    MediaTransportControlDataPlay that = (MediaTransportControlDataPlay) o;
