...
public class UnitAddress implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("UnitAddress");
  }
  ...
  public static UnitAddress staticParse(ReadBuffer readBuffer) throws ParseException {
    ...
    readBuffer.closeContext("UnitAddress");
    // Create the instance
    UnitAddress _unitAddress;
    _unitAddress = new UnitAddress(address);
    return _unitAddress;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof UnitAddress)) {
      return false;
    }
    UnitAddress that = (UnitAddress) o;
