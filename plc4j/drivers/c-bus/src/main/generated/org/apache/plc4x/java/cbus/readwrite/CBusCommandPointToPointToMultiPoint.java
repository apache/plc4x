...
public class CBusCommandPointToPointToMultiPoint extends CBusCommand implements Message {
  ...
  public CBusCommandPointToPointToMultiPoint(CBusHeader header,
  ...
  public static class CBusCommandBuilderImpl implements CBusCommand.CBusCommandBuilder {
    ...
    public CBusCommandBuilderImpl(CBusPointToPointToMultiPointCommand command) {
      this.command = command;
    }

    public CBusCommand build(CBusHeader header) {
      return new CBusCommandPointToPointToMultiPoint(header, command);
    }
  }
}
