...
public class SecurityDataGasAlarmCleared extends SecurityData implements Message {
  ...
  public SecurityDataGasAlarmCleared(
  ...
  protected void serializeSecurityDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("SecurityDataGasAlarmCleared");
  }
  ...
  public static class SecurityDataGasAlarmClearedBuilderImpl
    ...
    public SecurityDataGasAlarmCleared build(
        SecurityCommandTypeContainer commandTypeContainer, byte argument) {
      SecurityDataGasAlarmCleared securityDataGasAlarmCleared =
          new SecurityDataGasAlarmCleared(commandTypeContainer, argument);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityDataGasAlarmCleared)) {
      return false;
    }
    SecurityDataGasAlarmCleared that = (SecurityDataGasAlarmCleared) o;
