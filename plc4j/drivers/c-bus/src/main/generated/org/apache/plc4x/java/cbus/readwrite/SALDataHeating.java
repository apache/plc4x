...
public class SALDataHeating extends SALData implements Message {
  ...
  public static SALDataBuilder staticParseSALDataBuilder(ReadBuffer readBuffer,
    ...
    readBuffer.pushContext(WithOption.WithName("SALDataHeating"));
    int startPos = readBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: heatingData
    LightingData heatingData = FieldReaderFactory.readSimpleField(DataReaderFactory.readComplex(() -> (LightingData) LightingData.staticParse(readBuffer), readBuffer), WithOption.WithName("heatingData"));
  ...
  protected void serializeSALDataChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("SALDataHeating"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: heatingData
    FieldWriterFactory.writeSimpleField((LightingData) heatingData, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("heatingData"));
