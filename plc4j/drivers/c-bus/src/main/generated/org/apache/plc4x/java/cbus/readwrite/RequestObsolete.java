...
public class RequestObsolete extends Request implements Message {
  ...
  public RequestObsolete(RequestType peekedByte, RequestType startingCR, RequestType resetMode,
      RequestType secondPeek, RequestTermination termination, CALData calData, Alpha alpha) {
  ...
  public static class RequestBuilderImpl implements Request.RequestBuilder {
    ...
    public Request build(RequestType peekedByte, RequestType startingCR, RequestType resetMode,
      ...
      return new RequestObsolete(peekedByte, startingCR, resetMode, secondPeek, termination, calData, alpha);
    }
  }
}
