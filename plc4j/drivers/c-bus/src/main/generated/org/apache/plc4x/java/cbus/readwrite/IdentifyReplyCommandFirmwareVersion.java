...
public class IdentifyReplyCommandFirmwareVersion extends IdentifyReplyCommand implements Message {
  ...
  protected void serializeIdentifyReplyCommandChild(WriteBuffer writeBuffer)
    ...
    writeSimpleField("firmwareVersion", firmwareVersion, writeString(writeBuffer, 64));

    writeBuffer.popContext("IdentifyReplyCommandFirmwareVersion");
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof IdentifyReplyCommandFirmwareVersion)) {
      return false;
    }
    IdentifyReplyCommandFirmwareVersion that = (IdentifyReplyCommandFirmwareVersion) o;
    return (getFirmwareVersion() == that.getFirmwareVersion()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getFirmwareVersion());
  }
