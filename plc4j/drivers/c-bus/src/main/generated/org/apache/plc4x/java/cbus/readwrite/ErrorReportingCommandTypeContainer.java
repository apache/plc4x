...
public enum ErrorReportingCommandTypeContainer {
  ErrorReportingCommandDeprecated((short) 0x05, (byte) 5, ErrorReportingCommandType.DEPRECATED),

  ErrorReportingCommandErrorReport((short) 0x15, (byte) 5, ErrorReportingCommandType.ERROR_REPORT),

  ErrorReportingCommandAcknowledge((short) 0x25, (byte) 5, ErrorReportingCommandType.ACKNOWLEDGE),

  ErrorReportingCommandClearMostSevere((short) 0x35, (byte) 5, ErrorReportingCommandType.CLEAR_MOST_SEVERE);
  ...
  ErrorReportingCommandTypeContainer(short value, byte numBytes,
  ...
  public static ErrorReportingCommandTypeContainer firstEnumForFieldNumBytes(byte numBytes) {
  ...
  public static List<ErrorReportingCommandTypeContainer> enumsForFieldNumBytes(byte numBytes) {
