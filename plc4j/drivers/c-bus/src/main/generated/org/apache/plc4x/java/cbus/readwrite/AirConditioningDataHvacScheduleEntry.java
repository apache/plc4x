...
public class AirConditioningDataHvacScheduleEntry extends AirConditioningData implements Message {
  ...
  public AirConditioningDataHvacScheduleEntry(
      ...
      HVACZoneList zoneList, Short entry, Byte format, HVACModeAndFlags hvacModeAndFlags,
      HVACStartTime startTime, HVACTemperature level, HVACRawLevels rawLevel) {
  ...
  public static AirConditioningDataBuilder staticParseAirConditioningDataBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("AirConditioningDataHvacScheduleEntry"));
    ...
    return new AirConditioningDataBuilderImpl(zoneGroup, zoneList, entry, format, hvacModeAndFlags, startTime, level, rawLevel);
  }

  protected void serializeAirConditioningDataChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("AirConditioningDataHvacScheduleEntry"));
  ...
  public static class AirConditioningDataBuilderImpl implements AirConditioningData.AirConditioningDataBuilder {
    ...
    public AirConditioningDataBuilderImpl(byte zoneGroup, HVACZoneList zoneList, short entry,
        byte format, HVACModeAndFlags hvacModeAndFlags, HVACStartTime startTime,
        HVACTemperature level, HVACRawLevels rawLevel) {
      this.zoneGroup = zoneGroup;
      this.zoneList = zoneList;
      this.entry = entry;
      this.format = format;
    ...
    public AirConditioningData build(AirConditioningCommandTypeContainer commandTypeContainer) {
      return new AirConditioningDataHvacScheduleEntry(commandTypeContainer, zoneGroup, zoneList, entry, format, hvacModeAndFlags, startTime, level, rawLevel);
    }
  }
}
