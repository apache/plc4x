...
public class SecurityDataStatus2Request extends SecurityData implements Message {
  ...
  public SecurityDataStatus2Request(
  ...
  protected void serializeSecurityDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("SecurityDataStatus2Request");
  }
  ...
  public static class SecurityDataStatus2RequestBuilderImpl
    ...
    public SecurityDataStatus2Request build(
        SecurityCommandTypeContainer commandTypeContainer, byte argument) {
      SecurityDataStatus2Request securityDataStatus2Request =
          new SecurityDataStatus2Request(commandTypeContainer, argument);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityDataStatus2Request)) {
      return false;
    }
    SecurityDataStatus2Request that = (SecurityDataStatus2Request) o;
