...
public class SecurityDataEvent extends SecurityData implements Message {
  ...
  protected void serializeSecurityDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("SecurityDataEvent");
  }
  ...
  public static class SecurityDataEventBuilderImpl implements SecurityData.SecurityDataBuilder {
    ...
    public SecurityDataEvent build(
        SecurityCommandTypeContainer commandTypeContainer, byte argument) {
      SecurityDataEvent securityDataEvent =
          new SecurityDataEvent(commandTypeContainer, argument, data);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityDataEvent)) {
      return false;
    }
    SecurityDataEvent that = (SecurityDataEvent) o;
