...
public class SALDataPoolsSpasPondsFountainsControl extends SALData implements Message {
  ...
  public SALDataPoolsSpasPondsFountainsControl(
      SALData salData, LightingData poolsSpaPondsFountainsData) {
    super(salData);
  ...
  public static class SALDataPoolsSpasPondsFountainsControlBuilderImpl
    ...
    public SALDataPoolsSpasPondsFountainsControl build(SALData salData) {
      SALDataPoolsSpasPondsFountainsControl sALDataPoolsSpasPondsFountainsControl =
          new SALDataPoolsSpasPondsFountainsControl(salData, poolsSpaPondsFountainsData);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SALDataPoolsSpasPondsFountainsControl)) {
      return false;
    }
    SALDataPoolsSpasPondsFountainsControl that = (SALDataPoolsSpasPondsFountainsControl) o;
    return (getPoolsSpaPondsFountainsData() == that.getPoolsSpaPondsFountainsData())
        && super.equals(that)
        && true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getPoolsSpaPondsFountainsData());
  }
