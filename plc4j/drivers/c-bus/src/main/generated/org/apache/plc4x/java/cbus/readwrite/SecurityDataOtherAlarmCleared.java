...
public class SecurityDataOtherAlarmCleared extends SecurityData implements Message {
  ...
  public SecurityDataOtherAlarmCleared(
  ...
  protected void serializeSecurityDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("SecurityDataOtherAlarmCleared");
  }
  ...
  public static class SecurityDataOtherAlarmClearedBuilderImpl
    ...
    public SecurityDataOtherAlarmCleared build(
        SecurityCommandTypeContainer commandTypeContainer, byte argument) {
      SecurityDataOtherAlarmCleared securityDataOtherAlarmCleared =
          new SecurityDataOtherAlarmCleared(commandTypeContainer, argument);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityDataOtherAlarmCleared)) {
      return false;
    }
    SecurityDataOtherAlarmCleared that = (SecurityDataOtherAlarmCleared) o;
