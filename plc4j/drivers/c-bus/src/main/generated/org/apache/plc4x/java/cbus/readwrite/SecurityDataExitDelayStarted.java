...
public class SecurityDataExitDelayStarted extends SecurityData implements Message {
  ...
  public SecurityDataExitDelayStarted(
  ...
  protected void serializeSecurityDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("SecurityDataExitDelayStarted");
  }
  ...
  public static class SecurityDataExitDelayStartedBuilder
    ...
    public SecurityDataExitDelayStarted build(
        SecurityCommandTypeContainer commandTypeContainer, byte argument) {
      SecurityDataExitDelayStarted securityDataExitDelayStarted =
          new SecurityDataExitDelayStarted(commandTypeContainer, argument);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityDataExitDelayStarted)) {
      return false;
    }
    SecurityDataExitDelayStarted that = (SecurityDataExitDelayStarted) o;
