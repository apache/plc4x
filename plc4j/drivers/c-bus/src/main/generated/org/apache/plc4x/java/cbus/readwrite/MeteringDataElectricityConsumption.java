...
public class MeteringDataElectricityConsumption extends MeteringData implements Message {
  ...
  public MeteringDataElectricityConsumption(
      MeteringCommandTypeContainer commandTypeContainer, byte argument, long kWhr) {
  ...
  protected void serializeMeteringDataChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    // Simple Field (kWhr)
    writeSimpleField("kWhr", kWhr, writeUnsignedLong(writeBuffer, 32));

    writeBuffer.popContext("MeteringDataElectricityConsumption");
  }
  ...
  public static class MeteringDataElectricityConsumptionBuilderImpl
    ...
    public MeteringDataElectricityConsumption build(
        MeteringCommandTypeContainer commandTypeContainer, byte argument) {
      MeteringDataElectricityConsumption meteringDataElectricityConsumption =
          new MeteringDataElectricityConsumption(commandTypeContainer, argument, kWhr);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof MeteringDataElectricityConsumption)) {
      return false;
    }
    MeteringDataElectricityConsumption that = (MeteringDataElectricityConsumption) o;
    return (getKWhr() == that.getKWhr()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getKWhr());
  }
