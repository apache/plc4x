...
public class PnIoCM_Block_Request extends PnIoCm_Block implements Message {
  ...
  public static PnIoCM_Block_RequestBuilder staticParseBuilder(ReadBuffer readBuffer)
    ...
    // Create the instance
    return new PnIoCM_Block_RequestBuilder(
        blockVersionHigh,
        blockVersionLow,
        arUuid,
        sessionKey,
  ...
  public static class PnIoCM_Block_RequestBuilder implements PnIoCm_Block.PnIoCm_BlockBuilder {
    ...
    public PnIoCM_Block_RequestBuilder(
        short blockVersionHigh,
        short blockVersionLow,
        Uuid arUuid,
        int sessionKey,
