...
public abstract class TlvOrganizationSpecificUnit implements Message {
   ...
   */
  public abstract int getUniqueCode();

  protected abstract void serializeTlvOrganizationSpecificUnitChild(WriteBuffer writeBuffer) throws
      BufferException;

  public static TlvOrganizationSpecificUnit staticParse(ReadBuffer readBuffer) throws
      BufferException {
    readBuffer.pushContext(WithOption.WithName("TlvOrganizationSpecificUnit"));
    int startPos = readBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Discriminator Field: uniqueCode
    int uniqueCode = FieldReaderFactory.readDiscriminatorField(DataReaderFactory.readUnsignedInt(readBuffer, 24), WithOption.WithName("uniqueCode"));
    ...
    if (builder == null) {
      throw new BufferException("Unsupported case for discriminated type parameters parameters [uniqueCode]");
    }
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("TlvOrganizationSpecificUnit"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    int uniqueCode = (int) getUniqueCode();
    // Discriminator Field: uniqueCode
    FieldWriterFactory.writeDiscriminatorField((int) uniqueCode, DataWriterFactory.writeUnsignedInt(writeBuffer, 24), WithOption.WithName("uniqueCode"));
