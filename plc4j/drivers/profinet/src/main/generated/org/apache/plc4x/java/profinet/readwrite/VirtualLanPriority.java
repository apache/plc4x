...
public enum VirtualLanPriority {
  BEST_EFFORT((byte) 0x0, "BE"),

  BACKGROUND((byte) 0x1, "BK"),

  EXCELLENT_EFFORT((byte) 0x2, "EE"),

  CRITICAL_APPLICATIONS((byte) 0x3, "CA"),

  VIDEO((byte) 0x4, "VI"),

  VOICE((byte) 0x5, "VO"),

  INTERNETWORK_CONTROL((byte) 0x6, "IC"),

  NETWORK_CONTROL((byte) 0x7, "NC");
  ...
  public static VirtualLanPriority firstEnumForFieldAcronym(String acronym) {
    for (VirtualLanPriority _val : VirtualLanPriority.values()) {
      if (_val.getAcronym().equals(acronym)) {
        return _val;
      }
    }
    return null;
  ...
  public static List<VirtualLanPriority> enumsForFieldAcronym(String acronym) {
