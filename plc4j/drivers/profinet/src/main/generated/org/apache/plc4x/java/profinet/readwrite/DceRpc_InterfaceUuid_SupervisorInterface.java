...
public class DceRpc_InterfaceUuid_SupervisorInterface extends DceRpc_InterfaceUuid implements Message {
  ...
  public static DceRpc_InterfaceUuidBuilder staticParseDceRpc_InterfaceUuidBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("DceRpc_InterfaceUuid_SupervisorInterface"));
  ...
  protected void serializeDceRpc_InterfaceUuidChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("DceRpc_InterfaceUuid_SupervisorInterface"));
