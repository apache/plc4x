...
public class BACnetLifeSafetyStateTagged implements Message {
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetLifeSafetyState.VENDOR_PROPRIETARY_VALUE));
  }

  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    PositionAware positionAware = writeBuffer;
    int startPos = positionAware.getPos();
    writeBuffer.pushContext("BACnetLifeSafetyStateTagged");
    ...
    writeBuffer.popContext("BACnetLifeSafetyStateTagged");
  }
  ...
  public static BACnetLifeSafetyStateTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetLifeSafetyStateTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetLifeSafetyStateTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
            ...
            () ->
                (BACnetLifeSafetyState)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        BACnetLifeSafetyState.VENDOR_PROPRIETARY_VALUE)));
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetLifeSafetyStateTagged)) {
      return false;
    }
    BACnetLifeSafetyStateTagged that = (BACnetLifeSafetyStateTagged) o;
