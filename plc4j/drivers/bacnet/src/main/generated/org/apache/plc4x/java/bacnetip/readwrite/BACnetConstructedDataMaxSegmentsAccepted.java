...
public class BACnetConstructedDataMaxSegmentsAccepted extends BACnetConstructedData
    implements Message {
  ...
  public BACnetApplicationTagUnsignedInteger getActualValue() {
    return (BACnetApplicationTagUnsignedInteger) (getMaxSegmentsAccepted());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeSimpleField(
        "maxSegmentsAccepted", maxSegmentsAccepted, new DataWriterComplexDefault<>(writeBuffer));

    // Virtual field (doesn't actually serialize anything, just makes the value available)
    BACnetApplicationTagUnsignedInteger actualValue = getActualValue();
    writeBuffer.writeVirtual("actualValue", actualValue);

    writeBuffer.popContext("BACnetConstructedDataMaxSegmentsAccepted");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    BACnetApplicationTagUnsignedInteger actualValue =
        readVirtualField(
            "actualValue", BACnetApplicationTagUnsignedInteger.class, maxSegmentsAccepted);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataMaxSegmentsAccepted)) {
      return false;
    }
    BACnetConstructedDataMaxSegmentsAccepted that = (BACnetConstructedDataMaxSegmentsAccepted) o;
    return (getMaxSegmentsAccepted() == that.getMaxSegmentsAccepted())
        && super.equals(that)
        && true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getMaxSegmentsAccepted());
  }
