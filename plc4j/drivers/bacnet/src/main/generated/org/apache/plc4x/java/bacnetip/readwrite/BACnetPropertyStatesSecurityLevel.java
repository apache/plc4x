...
public class BACnetPropertyStatesSecurityLevel extends BACnetPropertyStates implements Message {
  ...
  public BACnetPropertyStatesSecurityLevel(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetPropertyStatesBuilder staticParseBACnetPropertyStatesBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetPropertyStatesSecurityLevel"));
  ...
  protected void serializeBACnetPropertyStatesChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetPropertyStatesSecurityLevel"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: securityLevel
    FieldWriterFactory.writeSimpleField((BACnetSecurityLevelTagged) securityLevel, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("securityLevel"));
  ...
  public static class BACnetPropertyStatesBuilderImpl implements BACnetPropertyStates.BACnetPropertyStatesBuilder {
    ...
    public BACnetPropertyStatesBuilderImpl(BACnetSecurityLevelTagged securityLevel) {
      this.securityLevel = securityLevel;
    }

    public BACnetPropertyStates build(BACnetTagHeader peekedTagHeader) {
      return new BACnetPropertyStatesSecurityLevel(peekedTagHeader, securityLevel);
    }
  }
}
