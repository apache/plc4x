...
public class BACnetConstructedDataNetworkAccessSecurityPolicies extends BACnetConstructedData
    implements Message {
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeComplexTypeArrayField(
        "networkAccessSecurityPolicies", networkAccessSecurityPolicies, writeBuffer);

    writeBuffer.popContext("BACnetConstructedDataNetworkAccessSecurityPolicies");
  }
  ...
  public int getLengthInBits() {
    ...
    // Array field
    if (networkAccessSecurityPolicies != null) {
      for (Message element : networkAccessSecurityPolicies) {
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    List<BACnetNetworkSecurityPolicy> networkAccessSecurityPolicies =
        readTerminatedArrayField(
            ...
            readComplex(() -> BACnetNetworkSecurityPolicy.staticParse(readBuffer), readBuffer),
            () ->
                ((boolean)
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataNetworkAccessSecurityPolicies)) {
      return false;
    }
    BACnetConstructedDataNetworkAccessSecurityPolicies that =
        (BACnetConstructedDataNetworkAccessSecurityPolicies) o;
  ...
  public int hashCode() {
    return Objects.hash(
        super.hashCode(), getNumberOfDataElements(), getNetworkAccessSecurityPolicies());
  }
