...
public class BACnetAccessZoneOccupancyStateTagged implements Message {
  ...
  public BACnetAccessZoneOccupancyStateTagged(
      BACnetTagHeader header, BACnetAccessZoneOccupancyState value, long proprietaryValue) {
    super();
    this.header = header;
    this.value = value;
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetAccessZoneOccupancyState.VENDOR_PROPRIETARY_VALUE));
  }
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("BACnetAccessZoneOccupancyStateTagged");
  }
  ...
  public static BACnetAccessZoneOccupancyStateTagged staticParse(
    ...
    BACnetAccessZoneOccupancyState value =
        readManualField(
            "value",
            readBuffer,
            () ->
                (BACnetAccessZoneOccupancyState)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        BACnetAccessZoneOccupancyState.VENDOR_PROPRIETARY_VALUE)));
    ...
    readBuffer.closeContext("BACnetAccessZoneOccupancyStateTagged");
    // Create the instance
    BACnetAccessZoneOccupancyStateTagged _bACnetAccessZoneOccupancyStateTagged;
    _bACnetAccessZoneOccupancyStateTagged =
        new BACnetAccessZoneOccupancyStateTagged(header, value, proprietaryValue);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetAccessZoneOccupancyStateTagged)) {
      return false;
    }
    BACnetAccessZoneOccupancyStateTagged that = (BACnetAccessZoneOccupancyStateTagged) o;
