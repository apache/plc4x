...
public class BACnetShedStateTagged implements Message {
  ...
  public BACnetShedStateTagged(
      BACnetTagHeader header, BACnetShedState value, Short tagNumber, TagClass tagClass) {
    super();
    this.header = header;
    this.value = value;
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("BACnetShedStateTagged");
    ...
    writeBuffer.popContext("BACnetShedStateTagged");
  }
  ...
  public static BACnetShedStateTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetShedStateTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetShedStateTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
                ...
                (BACnetShedState)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper
                        .readEnumGenericFailing(
                            readBuffer, header.getActualLength(), BACnetShedState.SHED_INACTIVE)));

    readBuffer.closeContext("BACnetShedStateTagged");
    // Create the instance
    BACnetShedStateTagged _bACnetShedStateTagged;
    _bACnetShedStateTagged = new BACnetShedStateTagged(header, value, tagNumber, tagClass);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetShedStateTagged)) {
      return false;
    }
    BACnetShedStateTagged that = (BACnetShedStateTagged) o;
