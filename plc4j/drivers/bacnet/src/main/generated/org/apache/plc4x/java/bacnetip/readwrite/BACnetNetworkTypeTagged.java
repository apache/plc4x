...
public class BACnetNetworkTypeTagged implements Message {
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetNetworkType.VENDOR_PROPRIETARY_VALUE));
  }

  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    PositionAware positionAware = writeBuffer;
    int startPos = positionAware.getPos();
    writeBuffer.pushContext("BACnetNetworkTypeTagged");
    ...
    writeBuffer.popContext("BACnetNetworkTypeTagged");
  }
  ...
  public static BACnetNetworkTypeTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetNetworkTypeTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetNetworkTypeTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
            ...
            () ->
                (BACnetNetworkType)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        BACnetNetworkType.VENDOR_PROPRIETARY_VALUE)));
