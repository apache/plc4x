...
public class BACnetConstructedDataWeeklySchedule extends BACnetConstructedData implements Message {
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataWeeklySchedule");
  }
  ...
  public int getLengthInBits() {
    ...
    if (weeklySchedule != null) {
      for (Message element : weeklySchedule) {
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataWeeklySchedule");
    ...
    // Validation
    if (!(((arrayIndexArgument) != (null)) || ((COUNT(weeklySchedule)) == (7)))) {
      throw new ParseValidationException("weeklySchedule should have exactly 7 values");
    }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataWeeklySchedule)) {
      return false;
    }
    BACnetConstructedDataWeeklySchedule that = (BACnetConstructedDataWeeklySchedule) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getNumberOfDataElements(), getWeeklySchedule());
  }
