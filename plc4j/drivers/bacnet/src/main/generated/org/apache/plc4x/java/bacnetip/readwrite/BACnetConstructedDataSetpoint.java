...
public class BACnetConstructedDataSetpoint extends BACnetConstructedData implements Message {
  ...
  public BACnetApplicationTagReal getActualValue() {
    return (BACnetApplicationTagReal) (getSetpoint());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataSetpoint");
  }
  ...
  public static BACnetConstructedDataSetpointBuilder staticParseBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataSetpoint");
    ...
    BACnetApplicationTagReal actualValue =
        readVirtualField("actualValue", BACnetApplicationTagReal.class, setpoint);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataSetpoint)) {
      return false;
    }
    BACnetConstructedDataSetpoint that = (BACnetConstructedDataSetpoint) o;
    return (getSetpoint() == that.getSetpoint()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getSetpoint());
  }
