...
public class BACnetEventParameterAccessEventListOfAccessEvents implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeComplexTypeArrayField("listOfAccessEvents", listOfAccessEvents, writeBuffer);

    // Simple Field (closingTag)
    writeSimpleField("closingTag", closingTag, new DataWriterComplexDefault<>(writeBuffer));

    writeBuffer.popContext("BACnetEventParameterAccessEventListOfAccessEvents");
  }
  ...
  public int getLengthInBits() {
    ...
    if (listOfAccessEvents != null) {
      for (Message element : listOfAccessEvents) {
  ...
  public static BACnetEventParameterAccessEventListOfAccessEvents staticParse(
  ...
  public static BACnetEventParameterAccessEventListOfAccessEvents staticParse(
    ...
    readBuffer.closeContext("BACnetEventParameterAccessEventListOfAccessEvents");
    // Create the instance
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetEventParameterAccessEventListOfAccessEvents)) {
      return false;
    }
    BACnetEventParameterAccessEventListOfAccessEvents that =
        (BACnetEventParameterAccessEventListOfAccessEvents) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(getOpeningTag(), getListOfAccessEvents(), getClosingTag());
  }
