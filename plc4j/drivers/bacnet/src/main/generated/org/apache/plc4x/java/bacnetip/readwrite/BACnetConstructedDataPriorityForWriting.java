...
public class BACnetConstructedDataPriorityForWriting extends BACnetConstructedData
    implements Message {
  ...
  public BACnetApplicationTagUnsignedInteger getActualValue() {
    return (BACnetApplicationTagUnsignedInteger) (getPriorityForWriting());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataPriorityForWriting");
  }
  ...
  public static BACnetConstructedDataPriorityForWritingBuilder staticParseBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataPriorityForWriting");
    ...
    BACnetApplicationTagUnsignedInteger actualValue =
        readVirtualField(
            "actualValue", BACnetApplicationTagUnsignedInteger.class, priorityForWriting);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataPriorityForWriting)) {
      return false;
    }
    BACnetConstructedDataPriorityForWriting that = (BACnetConstructedDataPriorityForWriting) o;
    return (getPriorityForWriting() == that.getPriorityForWriting()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getPriorityForWriting());
  }
