...
public class BACnetConstructedDataAlignIntervals extends BACnetConstructedData implements Message {
  ...
  public BACnetApplicationTagBoolean getActualValue() {
    return (BACnetApplicationTagBoolean) (getAlignIntervals());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataAlignIntervals");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    BACnetApplicationTagBoolean actualValue =
        readVirtualField("actualValue", BACnetApplicationTagBoolean.class, alignIntervals);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataAlignIntervals)) {
      return false;
    }
    BACnetConstructedDataAlignIntervals that = (BACnetConstructedDataAlignIntervals) o;
    return (getAlignIntervals() == that.getAlignIntervals()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getAlignIntervals());
  }
