...
public class BACnetConstructedDataMinimumOffTime extends BACnetConstructedData implements Message {
  ...
  public BACnetApplicationTagUnsignedInteger getActualValue() {
    return (BACnetApplicationTagUnsignedInteger) (getMinimumOffTime());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataMinimumOffTime");
  }
  ...
  public static BACnetConstructedDataMinimumOffTimeBuilder staticParseBuilder(
    ...
    BACnetApplicationTagUnsignedInteger actualValue =
        readVirtualField("actualValue", BACnetApplicationTagUnsignedInteger.class, minimumOffTime);

    readBuffer.closeContext("BACnetConstructedDataMinimumOffTime");
    // Create the instance
    return new BACnetConstructedDataMinimumOffTimeBuilder(
        minimumOffTime, tagNumber, arrayIndexArgument);
  }

  public static class BACnetConstructedDataMinimumOffTimeBuilder
      implements BACnetConstructedData.BACnetConstructedDataBuilder {
    private final BACnetApplicationTagUnsignedInteger minimumOffTime;
    private final Short tagNumber;
    private final BACnetTagPayloadUnsignedInteger arrayIndexArgument;

    public BACnetConstructedDataMinimumOffTimeBuilder(
        BACnetApplicationTagUnsignedInteger minimumOffTime,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataMinimumOffTime)) {
      return false;
    }
    BACnetConstructedDataMinimumOffTime that = (BACnetConstructedDataMinimumOffTime) o;
    return (getMinimumOffTime() == that.getMinimumOffTime()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getMinimumOffTime());
  }
