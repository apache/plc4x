...
public class BACnetDoorStatusTagged implements Message {
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetDoorStatus.VENDOR_PROPRIETARY_VALUE));
  }
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("BACnetDoorStatusTagged");
  }
  ...
  public static BACnetDoorStatusTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetDoorStatusTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetDoorStatusTagged");
    PositionAware positionAware = readBuffer;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
            ...
            () ->
                (BACnetDoorStatus)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        BACnetDoorStatus.VENDOR_PROPRIETARY_VALUE)));
    boolean isProprietary =
        readVirtualField(
            "isProprietary", boolean.class, (value) == (BACnetDoorStatus.VENDOR_PROPRIETARY_VALUE));
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetDoorStatusTagged)) {
      return false;
    }
    BACnetDoorStatusTagged that = (BACnetDoorStatusTagged) o;
