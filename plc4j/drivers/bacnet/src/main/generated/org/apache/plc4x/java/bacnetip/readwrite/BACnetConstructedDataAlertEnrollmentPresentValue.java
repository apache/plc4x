...
public class BACnetConstructedDataAlertEnrollmentPresentValue extends BACnetConstructedData
    implements Message {
  ...
  public BACnetApplicationTagObjectIdentifier getActualValue() {
    return (BACnetApplicationTagObjectIdentifier) (getPresentValue());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataAlertEnrollmentPresentValue");
  }
  ...
  public static BACnetConstructedDataAlertEnrollmentPresentValueBuilder staticParseBuilder(
    ...
    BACnetApplicationTagObjectIdentifier actualValue =
        readVirtualField("actualValue", BACnetApplicationTagObjectIdentifier.class, presentValue);

    readBuffer.closeContext("BACnetConstructedDataAlertEnrollmentPresentValue");
    // Create the instance
    return new BACnetConstructedDataAlertEnrollmentPresentValueBuilder(
        presentValue, tagNumber, arrayIndexArgument);
  }

  public static class BACnetConstructedDataAlertEnrollmentPresentValueBuilder
      implements BACnetConstructedData.BACnetConstructedDataBuilder {
    private final BACnetApplicationTagObjectIdentifier presentValue;
    private final Short tagNumber;
    private final BACnetTagPayloadUnsignedInteger arrayIndexArgument;

    public BACnetConstructedDataAlertEnrollmentPresentValueBuilder(
        BACnetApplicationTagObjectIdentifier presentValue,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataAlertEnrollmentPresentValue)) {
      return false;
    }
    BACnetConstructedDataAlertEnrollmentPresentValue that =
        (BACnetConstructedDataAlertEnrollmentPresentValue) o;
