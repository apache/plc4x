...
public class BACnetContextTagCharacterString extends BACnetContextTag implements Message {
  ...
  public BACnetContextTagCharacterString(
  ...
  protected void serializeBACnetContextTagChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetContextTagCharacterString");
  }
  ...
  public static BACnetContextTagBuilder staticParseBACnetContextTagBuilder(
    ...
    // Create the instance
    return new BACnetContextTagCharacterStringBuilderImpl(payload);
  }
  ...
  public static class BACnetContextTagCharacterStringBuilderImpl
    ...
    public BACnetContextTagCharacterStringBuilderImpl(BACnetTagPayloadCharacterString payload) {
      this.payload = payload;
    }

    public BACnetContextTagCharacterString build(BACnetTagHeader header) {
      BACnetContextTagCharacterString bACnetContextTagCharacterString =
          new BACnetContextTagCharacterString(header, payload);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetContextTagCharacterString)) {
      return false;
    }
    BACnetContextTagCharacterString that = (BACnetContextTagCharacterString) o;
