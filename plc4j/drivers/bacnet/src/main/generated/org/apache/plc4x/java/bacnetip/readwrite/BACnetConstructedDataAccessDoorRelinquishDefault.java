...
public class BACnetConstructedDataAccessDoorRelinquishDefault extends BACnetConstructedData
    implements Message {
  ...
  public BACnetConstructedDataAccessDoorRelinquishDefault(
  ...
  public BACnetDoorValueTagged getActualValue() {
    return (BACnetDoorValueTagged) (getRelinquishDefault());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataAccessDoorRelinquishDefault");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    BACnetDoorValueTagged actualValue =
        readVirtualField("actualValue", BACnetDoorValueTagged.class, relinquishDefault);

    readBuffer.closeContext("BACnetConstructedDataAccessDoorRelinquishDefault");
    // Create the instance
    return new BACnetConstructedDataAccessDoorRelinquishDefaultBuilderImpl(relinquishDefault);
  }
  ...
  public static class BACnetConstructedDataAccessDoorRelinquishDefaultBuilderImpl
    ...
    public BACnetConstructedDataAccessDoorRelinquishDefault build(
        BACnetOpeningTag openingTag, BACnetTagHeader peekedTagHeader, BACnetClosingTag closingTag) {
      BACnetConstructedDataAccessDoorRelinquishDefault
          bACnetConstructedDataAccessDoorRelinquishDefault =
              new BACnetConstructedDataAccessDoorRelinquishDefault(
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataAccessDoorRelinquishDefault)) {
      return false;
    }
    BACnetConstructedDataAccessDoorRelinquishDefault that =
        (BACnetConstructedDataAccessDoorRelinquishDefault) o;
