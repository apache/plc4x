...
public class BACnetConstructedDataMusterPoint extends BACnetConstructedData implements Message {
  ...
  public BACnetApplicationTagBoolean getActualValue() {
    return (BACnetApplicationTagBoolean) (getMusterPoint());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataMusterPoint");
  }
  ...
  public static BACnetConstructedDataMusterPointBuilder staticParseBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataMusterPoint");
    ...
    BACnetApplicationTagBoolean actualValue =
        readVirtualField("actualValue", BACnetApplicationTagBoolean.class, musterPoint);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataMusterPoint)) {
      return false;
    }
    BACnetConstructedDataMusterPoint that = (BACnetConstructedDataMusterPoint) o;
    return (getMusterPoint() == that.getMusterPoint()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getMusterPoint());
  }
