...
public abstract class BACnetShedLevel implements Message {
  ...
  protected abstract void serializeBACnetShedLevelChild(WriteBuffer writeBuffer)
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("BACnetShedLevel");
  }
  ...
  public static BACnetShedLevel staticParse(ReadBuffer readBuffer, Object... args)
      throws ParseException {
    PositionAware positionAware = readBuffer;
    return staticParse(readBuffer);
  }

  public static BACnetShedLevel staticParse(ReadBuffer readBuffer) throws ParseException {
    readBuffer.pullContext("BACnetShedLevel");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
    ...
    readBuffer.closeContext("BACnetShedLevel");
    // Create the instance
    BACnetShedLevel _bACnetShedLevel = builder.build(peekedTagHeader);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetShedLevel)) {
      return false;
    }
    BACnetShedLevel that = (BACnetShedLevel) o;
