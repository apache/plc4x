...
public class BACnetConstructedDataCarAssignedDirection extends BACnetConstructedData
    implements Message {
  ...
  public BACnetLiftCarDirectionTagged getActualValue() {
    return (BACnetLiftCarDirectionTagged) (getAssignedDirection());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataCarAssignedDirection");
  }
  ...
  public static BACnetConstructedDataCarAssignedDirectionBuilder staticParseBuilder(
    ...
    BACnetLiftCarDirectionTagged actualValue =
        readVirtualField("actualValue", BACnetLiftCarDirectionTagged.class, assignedDirection);

    readBuffer.closeContext("BACnetConstructedDataCarAssignedDirection");
    // Create the instance
    return new BACnetConstructedDataCarAssignedDirectionBuilder(
        assignedDirection, tagNumber, arrayIndexArgument);
  }

  public static class BACnetConstructedDataCarAssignedDirectionBuilder
      implements BACnetConstructedData.BACnetConstructedDataBuilder {
    private final BACnetLiftCarDirectionTagged assignedDirection;
    private final Short tagNumber;
    private final BACnetTagPayloadUnsignedInteger arrayIndexArgument;

    public BACnetConstructedDataCarAssignedDirectionBuilder(
        BACnetLiftCarDirectionTagged assignedDirection,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataCarAssignedDirection)) {
      return false;
    }
    BACnetConstructedDataCarAssignedDirection that = (BACnetConstructedDataCarAssignedDirection) o;
    return (getAssignedDirection() == that.getAssignedDirection()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getAssignedDirection());
  }
