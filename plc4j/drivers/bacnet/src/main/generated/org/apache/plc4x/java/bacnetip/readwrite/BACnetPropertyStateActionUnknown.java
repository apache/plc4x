...
public class BACnetPropertyStateActionUnknown extends BACnetPropertyStates implements Message {
  ...
  public BACnetPropertyStateActionUnknown(
      BACnetTagHeader peekedTagHeader, BACnetContextTagUnknown unknownValue) {
  ...
  public static class BACnetPropertyStateActionUnknownBuilderImpl
    ...
    public BACnetPropertyStateActionUnknown build(BACnetTagHeader peekedTagHeader) {
      BACnetPropertyStateActionUnknown bACnetPropertyStateActionUnknown =
          new BACnetPropertyStateActionUnknown(peekedTagHeader, unknownValue);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetPropertyStateActionUnknown)) {
      return false;
    }
    BACnetPropertyStateActionUnknown that = (BACnetPropertyStateActionUnknown) o;
    return (getUnknownValue() == that.getUnknownValue()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getUnknownValue());
  }
