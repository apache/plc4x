...
public class BACnetConstructedDataModelName extends BACnetConstructedData implements Message {
  ...
  public BACnetApplicationTagCharacterString getActualValue() {
    return (BACnetApplicationTagCharacterString) (getModelName());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeSimpleField("modelName", modelName, new DataWriterComplexDefault<>(writeBuffer));

    // Virtual field (doesn't actually serialize anything, just makes the value available)
    BACnetApplicationTagCharacterString actualValue = getActualValue();
    writeBuffer.writeVirtual("actualValue", actualValue);

    writeBuffer.popContext("BACnetConstructedDataModelName");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataModelName");
    ...
    BACnetApplicationTagCharacterString actualValue =
        readVirtualField("actualValue", BACnetApplicationTagCharacterString.class, modelName);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataModelName)) {
      return false;
    }
    BACnetConstructedDataModelName that = (BACnetConstructedDataModelName) o;
    return (getModelName() == that.getModelName()) && super.equals(that) && true;
  }
