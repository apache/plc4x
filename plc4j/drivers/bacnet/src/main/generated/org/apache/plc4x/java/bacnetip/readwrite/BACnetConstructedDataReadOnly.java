...
public class BACnetConstructedDataReadOnly extends BACnetConstructedData implements Message {
  ...
  public BACnetApplicationTagBoolean getActualValue() {
    return (BACnetApplicationTagBoolean) (getReadOnly());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataReadOnly");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataReadOnly");
    ...
    BACnetApplicationTagBoolean actualValue =
        readVirtualField("actualValue", BACnetApplicationTagBoolean.class, readOnly);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataReadOnly)) {
      return false;
    }
    BACnetConstructedDataReadOnly that = (BACnetConstructedDataReadOnly) o;
    return (getReadOnly() == that.getReadOnly()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getReadOnly());
  }
