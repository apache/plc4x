...
public class BACnetTimeStampEnclosed implements Message {
  ...
  public BACnetTimeStampEnclosed(
      BACnetOpeningTag openingTag, BACnetTimeStamp timestamp, BACnetClosingTag closingTag) {
    super();
  ...
  public static BACnetTimeStampEnclosed staticParse(ReadBuffer readBuffer, Short tagNumber)
    ...
    BACnetTimeStamp timestamp =
        readSimpleField(
            "timestamp", readComplex(() -> BACnetTimeStamp.staticParse(readBuffer), readBuffer));
    ...
    _bACnetTimeStampEnclosed = new BACnetTimeStampEnclosed(openingTag, timestamp, closingTag);
