...
public class BACnetProgramRequestTagged implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("BACnetProgramRequestTagged");
    ...
    writeBuffer.popContext("BACnetProgramRequestTagged");
  }
  ...
  public static BACnetProgramRequestTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetProgramRequestTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetProgramRequestTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
                ...
                (BACnetProgramRequest)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper
                        .readEnumGenericFailing(
                            readBuffer, header.getActualLength(), BACnetProgramRequest.READY)));
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetProgramRequestTagged)) {
      return false;
    }
    BACnetProgramRequestTagged that = (BACnetProgramRequestTagged) o;
