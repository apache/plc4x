...
public class BACnetEscalatorOperationDirectionTagged implements Message {
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetEscalatorOperationDirection.VENDOR_PROPRIETARY_VALUE));
  }

  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    PositionAware positionAware = writeBuffer;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    writeBuffer.pushContext("BACnetEscalatorOperationDirectionTagged");
    ...
    writeBuffer.popContext("BACnetEscalatorOperationDirectionTagged");
  }
  ...
  public static BACnetEscalatorOperationDirectionTagged staticParse(
  ...
  public static BACnetEscalatorOperationDirectionTagged staticParse(
    ...
    readBuffer.pullContext("BACnetEscalatorOperationDirectionTagged");
    PositionAware positionAware = readBuffer;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
            ...
            () ->
                (BACnetEscalatorOperationDirection)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        BACnetEscalatorOperationDirection.VENDOR_PROPRIETARY_VALUE)));
    ...
    readBuffer.closeContext("BACnetEscalatorOperationDirectionTagged");
    // Create the instance
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetEscalatorOperationDirectionTagged)) {
      return false;
    }
    BACnetEscalatorOperationDirectionTagged that = (BACnetEscalatorOperationDirectionTagged) o;
