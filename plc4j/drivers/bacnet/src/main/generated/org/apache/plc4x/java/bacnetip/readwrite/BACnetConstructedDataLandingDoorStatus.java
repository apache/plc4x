...
public class BACnetConstructedDataLandingDoorStatus extends BACnetConstructedData
    implements Message {
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.pushContext("BACnetConstructedDataLandingDoorStatus");
    ...
    writeBuffer.popContext("BACnetConstructedDataLandingDoorStatus");
  }
  ...
  public int getLengthInBits() {
    ...
    // Array field
    if (landingDoorStatus != null) {
      for (Message element : landingDoorStatus) {
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataLandingDoorStatus");
    ...
    List<BACnetLandingDoorStatus> landingDoorStatus =
        readTerminatedArrayField(
            "landingDoorStatus",
            readComplex(() -> BACnetLandingDoorStatus.staticParse(readBuffer), readBuffer),
            () ->
                ((boolean)
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataLandingDoorStatus)) {
      return false;
    }
    BACnetConstructedDataLandingDoorStatus that = (BACnetConstructedDataLandingDoorStatus) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getNumberOfDataElements(), getLandingDoorStatus());
  }
