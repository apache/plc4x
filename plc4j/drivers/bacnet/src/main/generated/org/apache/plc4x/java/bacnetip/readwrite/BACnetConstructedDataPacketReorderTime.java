...
public class BACnetConstructedDataPacketReorderTime extends BACnetConstructedData
    implements Message {
  ...
  public BACnetApplicationTagUnsignedInteger getActualValue() {
    return (BACnetApplicationTagUnsignedInteger) (getPacketReorderTime());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataPacketReorderTime");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataPacketReorderTime");
    ...
    BACnetApplicationTagUnsignedInteger actualValue =
        readVirtualField(
            "actualValue", BACnetApplicationTagUnsignedInteger.class, packetReorderTime);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataPacketReorderTime)) {
      return false;
    }
    BACnetConstructedDataPacketReorderTime that = (BACnetConstructedDataPacketReorderTime) o;
    return (getPacketReorderTime() == that.getPacketReorderTime()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getPacketReorderTime());
  }
