...
public class BACnetLifeSafetyModeTagged implements Message {
  ...
  public BACnetLifeSafetyModeTagged(
      BACnetTagHeader header,
      BACnetLifeSafetyMode value,
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetLifeSafetyMode.VENDOR_PROPRIETARY_VALUE));
  }
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("BACnetLifeSafetyModeTagged");
  }
  ...
  public static BACnetLifeSafetyModeTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetLifeSafetyModeTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetLifeSafetyModeTagged");
    PositionAware positionAware = readBuffer;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
            ...
            () ->
                (BACnetLifeSafetyMode)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        BACnetLifeSafetyMode.VENDOR_PROPRIETARY_VALUE)));
    ...
    readBuffer.closeContext("BACnetLifeSafetyModeTagged");
    // Create the instance
    BACnetLifeSafetyModeTagged _bACnetLifeSafetyModeTagged;
    _bACnetLifeSafetyModeTagged =
        new BACnetLifeSafetyModeTagged(header, value, proprietaryValue, tagNumber, tagClass);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetLifeSafetyModeTagged)) {
      return false;
    }
    BACnetLifeSafetyModeTagged that = (BACnetLifeSafetyModeTagged) o;
