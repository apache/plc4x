 ...
 */
public class BACnetUnconfirmedServiceRequestTimeSynchronization extends BACnetUnconfirmedServiceRequest implements Message {
  ...
  public static BACnetUnconfirmedServiceRequestBuilder staticParseBACnetUnconfirmedServiceRequestBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetUnconfirmedServiceRequestTimeSynchronization"));
  ...
  protected void serializeBACnetUnconfirmedServiceRequestChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetUnconfirmedServiceRequestTimeSynchronization"));
  ...
  public static class BACnetUnconfirmedServiceRequestBuilderImpl implements BACnetUnconfirmedServiceRequest.BACnetUnconfirmedServiceRequestBuilder {
    ...
    public BACnetUnconfirmedServiceRequest build() {
      return new BACnetUnconfirmedServiceRequestTimeSynchronization(synchronizedDate, synchronizedTime);
    }
  }
}
