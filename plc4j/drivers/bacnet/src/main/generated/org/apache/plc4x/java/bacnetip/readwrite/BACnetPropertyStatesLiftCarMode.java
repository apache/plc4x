...
public class BACnetPropertyStatesLiftCarMode extends BACnetPropertyStates implements Message {
  ...
  public BACnetPropertyStatesLiftCarMode(
      BACnetTagHeader peekedTagHeader, BACnetLiftCarModeTagged liftCarMode) {
  ...
  public static class BACnetPropertyStatesLiftCarModeBuilder
    ...
    public BACnetPropertyStatesLiftCarMode build(BACnetTagHeader peekedTagHeader) {
      BACnetPropertyStatesLiftCarMode bACnetPropertyStatesLiftCarMode =
          new BACnetPropertyStatesLiftCarMode(peekedTagHeader, liftCarMode);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetPropertyStatesLiftCarMode)) {
      return false;
    }
    BACnetPropertyStatesLiftCarMode that = (BACnetPropertyStatesLiftCarMode) o;
    return (getLiftCarMode() == that.getLiftCarMode()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getLiftCarMode());
  }
