...
public class BACnetConstructedDataElevatorGroup extends BACnetConstructedData implements Message {
  ...
  public BACnetApplicationTagObjectIdentifier getActualValue() {
    return (BACnetApplicationTagObjectIdentifier) (getElevatorGroup());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataElevatorGroup");
  }
  ...
  public static BACnetConstructedDataElevatorGroupBuilder staticParseBuilder(
    ...
    BACnetApplicationTagObjectIdentifier actualValue =
        readVirtualField("actualValue", BACnetApplicationTagObjectIdentifier.class, elevatorGroup);

    readBuffer.closeContext("BACnetConstructedDataElevatorGroup");
    // Create the instance
    return new BACnetConstructedDataElevatorGroupBuilder(
        elevatorGroup, tagNumber, arrayIndexArgument);
  }

  public static class BACnetConstructedDataElevatorGroupBuilder
      implements BACnetConstructedData.BACnetConstructedDataBuilder {
    private final BACnetApplicationTagObjectIdentifier elevatorGroup;
    private final Short tagNumber;
    private final BACnetTagPayloadUnsignedInteger arrayIndexArgument;

    public BACnetConstructedDataElevatorGroupBuilder(
        BACnetApplicationTagObjectIdentifier elevatorGroup,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataElevatorGroup)) {
      return false;
    }
    BACnetConstructedDataElevatorGroup that = (BACnetConstructedDataElevatorGroup) o;
    return (getElevatorGroup() == that.getElevatorGroup()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getElevatorGroup());
  }
