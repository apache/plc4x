...
public class BACnetConstructedDataAccessAlarmEvents extends BACnetConstructedData
    implements Message {
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeComplexTypeArrayField("accessAlarmEvents", accessAlarmEvents, writeBuffer);

    writeBuffer.popContext("BACnetConstructedDataAccessAlarmEvents");
  }
  ...
  public int getLengthInBits() {
    ...
    if (accessAlarmEvents != null) {
      for (Message element : accessAlarmEvents) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataAccessAlarmEvents)) {
      return false;
    }
    BACnetConstructedDataAccessAlarmEvents that = (BACnetConstructedDataAccessAlarmEvents) o;
    return (getAccessAlarmEvents() == that.getAccessAlarmEvents()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getAccessAlarmEvents());
  }
