...
public class BACnetAuthenticationPolicyListEntry implements Message {
  ...
  /**
   * Property field credentialDataInput
   */
  ...
  public static BACnetAuthenticationPolicyListEntry staticParse(ReadBuffer readBuffer) throws
      BufferException {
    readBuffer.pushContext(WithOption.WithName("BACnetAuthenticationPolicyListEntry"));
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetAuthenticationPolicyListEntry"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: credentialDataInput
    FieldWriterFactory.writeSimpleField((BACnetDeviceObjectReferenceEnclosed) credentialDataInput, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("credentialDataInput"));

    // Simple Field: index
    FieldWriterFactory.writeSimpleField((BACnetContextTagUnsignedInteger) index, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("index"));
