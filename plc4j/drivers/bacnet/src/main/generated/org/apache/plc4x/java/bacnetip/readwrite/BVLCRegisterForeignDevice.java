...
public class BVLCRegisterForeignDevice extends BVLC implements Message {
  ...
  public BVLCRegisterForeignDevice(int ttl) {
    super();
    this.ttl = ttl;
  }
  ...
  protected void serializeBVLCChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("BVLCRegisterForeignDevice");
  }
  ...
  public static BVLCBuilder staticParseBVLCBuilder(ReadBuffer readBuffer) throws ParseException {
    ...
    int ttl =
        readSimpleField(
            "ttl", readUnsignedInt(readBuffer, 16), WithOption.WithByteOrder(ByteOrder.BIG_ENDIAN));
  ...
  public static class BVLCRegisterForeignDeviceBuilderImpl implements BVLC.BVLCBuilder {
    ...
    public BVLCRegisterForeignDevice build() {
      BVLCRegisterForeignDevice bVLCRegisterForeignDevice = new BVLCRegisterForeignDevice(ttl);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BVLCRegisterForeignDevice)) {
      return false;
    }
    BVLCRegisterForeignDevice that = (BVLCRegisterForeignDevice) o;
    return (getTtl() == that.getTtl()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getTtl());
  }
