...
public class CharacterStringValue implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("CharacterStringValue");
    ...
    writeBuffer.popContext("CharacterStringValue");
  }
  ...
  public int getLengthInBits() {
    int lengthInBits = 0;
    CharacterStringValue _value = this;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
  ...
  public static CharacterStringValue staticParse(ReadBuffer readBuffer) throws ParseException {
    readBuffer.pullContext("CharacterStringValue");
            ...
            readComplex(
                () ->
                    OptionalProperty.staticParse(
                        readBuffer, (String) ("BACnetARRAY[N] of BACnetOptionalCharacterString")),
                readBuffer));
    ...
    readBuffer.closeContext("CharacterStringValue");
    // Create the instance
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof CharacterStringValue)) {
      return false;
    }
    CharacterStringValue that = (CharacterStringValue) o;
