...
public class BACnetCalendarEntryDateRange extends BACnetCalendarEntry implements Message {
  ...
  public BACnetCalendarEntryDateRange(
      BACnetTagHeader peekedTagHeader, BACnetDateRangeEnclosed dateRange) {
  ...
  public static class BACnetCalendarEntryDateRangeBuilderImpl
    ...
    public BACnetCalendarEntryDateRange build(BACnetTagHeader peekedTagHeader) {
      BACnetCalendarEntryDateRange bACnetCalendarEntryDateRange =
          new BACnetCalendarEntryDateRange(peekedTagHeader, dateRange);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetCalendarEntryDateRange)) {
      return false;
    }
    BACnetCalendarEntryDateRange that = (BACnetCalendarEntryDateRange) o;
