...
public class BACnetDateTimeEnclosed implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("BACnetDateTimeEnclosed");
    ...
    writeBuffer.popContext("BACnetDateTimeEnclosed");
  }
  ...
  public static BACnetDateTimeEnclosed staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetDateTimeEnclosed staticParse(ReadBuffer readBuffer, Short tagNumber)
      throws ParseException {
    readBuffer.pullContext("BACnetDateTimeEnclosed");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetDateTimeEnclosed)) {
      return false;
    }
    BACnetDateTimeEnclosed that = (BACnetDateTimeEnclosed) o;
    return (getOpeningTag() == that.getOpeningTag())
        && (getDateTimeValue() == that.getDateTimeValue())
  ...
  @Override
  public int hashCode() {
    return Objects.hash(getOpeningTag(), getDateTimeValue(), getClosingTag());
  }
