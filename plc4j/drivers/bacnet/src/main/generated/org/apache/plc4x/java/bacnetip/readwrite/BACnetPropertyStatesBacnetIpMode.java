...
public class BACnetPropertyStatesBacnetIpMode extends BACnetPropertyStates implements Message {
  ...
  public BACnetPropertyStatesBacnetIpMode(
      BACnetTagHeader peekedTagHeader, BACnetIPModeTagged bacnetIpMode) {
  ...
  public static class BACnetPropertyStatesBacnetIpModeBuilderImpl
    ...
    public BACnetPropertyStatesBacnetIpMode build(BACnetTagHeader peekedTagHeader) {
      BACnetPropertyStatesBacnetIpMode bACnetPropertyStatesBacnetIpMode =
          new BACnetPropertyStatesBacnetIpMode(peekedTagHeader, bacnetIpMode);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetPropertyStatesBacnetIpMode)) {
      return false;
    }
    BACnetPropertyStatesBacnetIpMode that = (BACnetPropertyStatesBacnetIpMode) o;
