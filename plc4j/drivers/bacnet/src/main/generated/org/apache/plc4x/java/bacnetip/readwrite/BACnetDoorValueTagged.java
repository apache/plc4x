...
public class BACnetDoorValueTagged implements Message {
  ...
  public BACnetDoorValueTagged(
      BACnetTagHeader header, BACnetDoorValue value, Short tagNumber, TagClass tagClass) {
    super();
    this.header = header;
    this.value = value;
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("BACnetDoorValueTagged");
    ...
    writeBuffer.popContext("BACnetDoorValueTagged");
  }
  ...
  public static BACnetDoorValueTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetDoorValueTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetDoorValueTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
                ...
                (BACnetDoorValue)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper
                        .readEnumGenericFailing(
                            readBuffer, header.getActualLength(), BACnetDoorValue.LOCK)));

    readBuffer.closeContext("BACnetDoorValueTagged");
    // Create the instance
    BACnetDoorValueTagged _bACnetDoorValueTagged;
    _bACnetDoorValueTagged = new BACnetDoorValueTagged(header, value, tagNumber, tagClass);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetDoorValueTagged)) {
      return false;
    }
    BACnetDoorValueTagged that = (BACnetDoorValueTagged) o;
