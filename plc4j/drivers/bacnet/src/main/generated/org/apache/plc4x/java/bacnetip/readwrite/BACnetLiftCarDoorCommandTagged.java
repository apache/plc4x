...
public class BACnetLiftCarDoorCommandTagged implements Message {
  ...
  public BACnetLiftCarDoorCommandTagged(
      BACnetTagHeader header, BACnetLiftCarDoorCommand value, Short tagNumber, TagClass tagClass) {
    super();
    this.header = header;
    this.value = value;
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("BACnetLiftCarDoorCommandTagged");
    ...
    writeBuffer.popContext("BACnetLiftCarDoorCommandTagged");
  }
  ...
  public static BACnetLiftCarDoorCommandTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetLiftCarDoorCommandTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetLiftCarDoorCommandTagged");
    PositionAware positionAware = readBuffer;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    ...
    BACnetLiftCarDoorCommand value =
        readManualField(
            "value",
            readBuffer,
            () ->
                (BACnetLiftCarDoorCommand)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper
                        .readEnumGenericFailing(
                            readBuffer, header.getActualLength(), BACnetLiftCarDoorCommand.NONE)));

    readBuffer.closeContext("BACnetLiftCarDoorCommandTagged");
    // Create the instance
    BACnetLiftCarDoorCommandTagged _bACnetLiftCarDoorCommandTagged;
    _bACnetLiftCarDoorCommandTagged =
        new BACnetLiftCarDoorCommandTagged(header, value, tagNumber, tagClass);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetLiftCarDoorCommandTagged)) {
      return false;
    }
    BACnetLiftCarDoorCommandTagged that = (BACnetLiftCarDoorCommandTagged) o;
