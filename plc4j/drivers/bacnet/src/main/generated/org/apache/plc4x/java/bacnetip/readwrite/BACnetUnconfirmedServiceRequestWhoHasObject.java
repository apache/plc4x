...
public abstract class BACnetUnconfirmedServiceRequestWhoHasObject implements Message {
  ...
  public static BACnetUnconfirmedServiceRequestWhoHasObject staticParse(ReadBuffer readBuffer)
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetUnconfirmedServiceRequestWhoHasObject"));
    ...
    if (EvaluationHelper.equals(peekedTagNumber, (short) (2))) {
      builder = BACnetUnconfirmedServiceRequestWhoHasObjectIdentifier.staticParseBACnetUnconfirmedServiceRequestWhoHasObjectBuilder(readBuffer);
    } else if (EvaluationHelper.equals(peekedTagNumber, (short) (3))) {
      builder = BACnetUnconfirmedServiceRequestWhoHasObjectName.staticParseBACnetUnconfirmedServiceRequestWhoHasObjectBuilder(readBuffer);
    }
    if (builder == null) {
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetUnconfirmedServiceRequestWhoHasObject"));
