...
public abstract class BACnetSpecialEventPeriod implements Message {
  ...
  protected abstract void serializeBACnetSpecialEventPeriodChild(WriteBuffer writeBuffer)
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("BACnetSpecialEventPeriod");
  }
  ...
  public static BACnetSpecialEventPeriod staticParse(ReadBuffer readBuffer, Object... args)
      throws ParseException {
    PositionAware positionAware = readBuffer;
    return staticParse(readBuffer);
  }

  public static BACnetSpecialEventPeriod staticParse(ReadBuffer readBuffer) throws ParseException {
    readBuffer.pullContext("BACnetSpecialEventPeriod");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
    ...
    readBuffer.closeContext("BACnetSpecialEventPeriod");
    // Create the instance
    BACnetSpecialEventPeriod _bACnetSpecialEventPeriod = builder.build(peekedTagHeader);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetSpecialEventPeriod)) {
      return false;
    }
    BACnetSpecialEventPeriod that = (BACnetSpecialEventPeriod) o;
