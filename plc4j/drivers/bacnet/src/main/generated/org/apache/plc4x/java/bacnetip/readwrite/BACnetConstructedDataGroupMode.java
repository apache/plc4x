...
public class BACnetConstructedDataGroupMode extends BACnetConstructedData implements Message {
  ...
  public BACnetLiftGroupModeTagged getActualValue() {
    return (BACnetLiftGroupModeTagged) (getGroupMode());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataGroupMode");
  }
  ...
  public static BACnetConstructedDataGroupModeBuilder staticParseBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataGroupMode");
    ...
    BACnetLiftGroupModeTagged groupMode =
        readSimpleField(
            ...
            new DataReaderComplexDefault<>(
                ...
                readBuffer));
    BACnetLiftGroupModeTagged actualValue =
        readVirtualField("actualValue", BACnetLiftGroupModeTagged.class, groupMode);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataGroupMode)) {
      return false;
    }
    BACnetConstructedDataGroupMode that = (BACnetConstructedDataGroupMode) o;
    return (getGroupMode() == that.getGroupMode()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getGroupMode());
  }
