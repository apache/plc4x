...
public class BACnetVendorIdTagged implements Message {
  ...
  public boolean getIsUnknownId() {
    return (boolean) ((getValue()) == (BACnetVendorId.UNKNOWN_VENDOR));
  }

  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    PositionAware positionAware = writeBuffer;
    int startPos = positionAware.getPos();
    writeBuffer.pushContext("BACnetVendorIdTagged");
    ...
    writeManualField(
        ...
        () ->
            org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.writeProprietaryEnumGeneric(
                writeBuffer, unknownId, isUnknownId),
        writeBuffer);

    writeBuffer.popContext("BACnetVendorIdTagged");
  }
  ...
  public static BACnetVendorIdTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetVendorIdTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetVendorIdTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
            ...
            () ->
                (BACnetVendorId)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        readBuffer, header.getActualLength(), BACnetVendorId.UNKNOWN_VENDOR)));
    boolean isUnknownId =
        readVirtualField("isUnknownId", boolean.class, (value) == (BACnetVendorId.UNKNOWN_VENDOR));
                ...
                (long)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper
                        .readProprietaryEnumGeneric(
                            readBuffer, header.getActualLength(), isUnknownId)));
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetVendorIdTagged)) {
      return false;
    }
    BACnetVendorIdTagged that = (BACnetVendorIdTagged) o;
    return (getHeader() == that.getHeader())
        && (getValue() == that.getValue())
        && (getUnknownId() == that.getUnknownId())
        && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(getHeader(), getValue(), getUnknownId());
  }
