...
public class BACnetPropertyStatesBinaryLightningValue extends BACnetPropertyStates
    implements Message {
  ...
  public BACnetPropertyStatesBinaryLightningValue(
      BACnetTagHeader peekedTagHeader, BACnetBinaryLightingPVTagged binaryLightningValue) {
  ...
  public static class BACnetPropertyStatesBinaryLightningValueBuilderImpl
    ...
    public BACnetPropertyStatesBinaryLightningValue build(BACnetTagHeader peekedTagHeader) {
      BACnetPropertyStatesBinaryLightningValue bACnetPropertyStatesBinaryLightningValue =
          new BACnetPropertyStatesBinaryLightningValue(peekedTagHeader, binaryLightningValue);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetPropertyStatesBinaryLightningValue)) {
      return false;
    }
    BACnetPropertyStatesBinaryLightningValue that = (BACnetPropertyStatesBinaryLightningValue) o;
    return (getBinaryLightningValue() == that.getBinaryLightningValue())
        && super.equals(that)
        && true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getBinaryLightningValue());
  }
