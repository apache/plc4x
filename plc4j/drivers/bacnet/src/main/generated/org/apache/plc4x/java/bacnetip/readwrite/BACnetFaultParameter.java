...
public abstract class BACnetFaultParameter implements Message {
  ...
  protected abstract void serializeBACnetFaultParameterChild(WriteBuffer writeBuffer)
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("BACnetFaultParameter");
  }
  ...
  public static BACnetFaultParameter staticParse(ReadBuffer readBuffer, Object... args)
      throws ParseException {
    PositionAware positionAware = readBuffer;
    return staticParse(readBuffer);
  }

  public static BACnetFaultParameter staticParse(ReadBuffer readBuffer) throws ParseException {
    readBuffer.pullContext("BACnetFaultParameter");
    PositionAware positionAware = readBuffer;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    ...
    readBuffer.closeContext("BACnetFaultParameter");
    // Create the instance
    BACnetFaultParameter _bACnetFaultParameter = builder.build(peekedTagHeader);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetFaultParameter)) {
      return false;
    }
    BACnetFaultParameter that = (BACnetFaultParameter) o;
