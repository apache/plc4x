...
public class BACnetLogRecordLogDatumAnyValue extends BACnetLogRecordLogDatum implements Message {
  ...
  public BACnetLogRecordLogDatumAnyValue(BACnetOpeningTag openingTag,
  ...
  public static BACnetLogRecordLogDatumBuilder staticParseBACnetLogRecordLogDatumBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetLogRecordLogDatumAnyValue"));
  ...
  protected void serializeBACnetLogRecordLogDatumChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetLogRecordLogDatumAnyValue"));
  ...
  public static class BACnetLogRecordLogDatumBuilderImpl implements BACnetLogRecordLogDatum.BACnetLogRecordLogDatumBuilder {
    ...
    public BACnetLogRecordLogDatumBuilderImpl(BACnetConstructedData anyValue) {
      this.anyValue = anyValue;
    }

    public BACnetLogRecordLogDatum build(BACnetOpeningTag openingTag,
        BACnetTagHeader peekedTagHeader, BACnetClosingTag closingTag) {
      return new BACnetLogRecordLogDatumAnyValue(openingTag, peekedTagHeader, closingTag, anyValue);
    }
  }
}
