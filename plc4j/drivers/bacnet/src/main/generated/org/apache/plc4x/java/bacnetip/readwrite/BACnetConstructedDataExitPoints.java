...
public class BACnetConstructedDataExitPoints extends BACnetConstructedData implements Message {
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeComplexTypeArrayField("exitPoints", exitPoints, writeBuffer);

    writeBuffer.popContext("BACnetConstructedDataExitPoints");
  }
  ...
  public int getLengthInBits() {
    ...
    // Array field
    if (exitPoints != null) {
      for (Message element : exitPoints) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataExitPoints)) {
      return false;
    }
    BACnetConstructedDataExitPoints that = (BACnetConstructedDataExitPoints) o;
    return (getExitPoints() == that.getExitPoints()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getExitPoints());
  }
