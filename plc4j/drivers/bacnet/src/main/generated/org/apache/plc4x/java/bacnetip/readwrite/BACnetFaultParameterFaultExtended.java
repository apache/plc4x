...
public class BACnetFaultParameterFaultExtended extends BACnetFaultParameter implements Message {
  ...
  public BACnetFaultParameterFaultExtended(
  ...
  public static class BACnetFaultParameterFaultExtendedBuilderImpl
    ...
    public BACnetFaultParameterFaultExtended build(BACnetTagHeader peekedTagHeader) {
      BACnetFaultParameterFaultExtended bACnetFaultParameterFaultExtended =
          new BACnetFaultParameterFaultExtended(
              peekedTagHeader, openingTag, vendorId, extendedFaultType, parameters, closingTag);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetFaultParameterFaultExtended)) {
      return false;
    }
    BACnetFaultParameterFaultExtended that = (BACnetFaultParameterFaultExtended) o;
    return (getOpeningTag() == that.getOpeningTag())
        && (getVendorId() == that.getVendorId())
        && (getExtendedFaultType() == that.getExtendedFaultType())
