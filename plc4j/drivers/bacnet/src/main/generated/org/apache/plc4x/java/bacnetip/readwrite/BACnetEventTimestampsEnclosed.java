...
public class BACnetEventTimestampsEnclosed implements Message {
  ...
  public static BACnetEventTimestampsEnclosed staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetEventTimestampsEnclosed staticParse(ReadBuffer readBuffer, Short tagNumber)
      throws ParseException {
    readBuffer.pullContext("BACnetEventTimestampsEnclosed");
    PositionAware positionAware = readBuffer;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetEventTimestampsEnclosed)) {
      return false;
    }
    BACnetEventTimestampsEnclosed that = (BACnetEventTimestampsEnclosed) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(getOpeningTag(), getEventTimestamps(), getClosingTag());
  }
