...
public class BACnetConstructedDataInactiveText extends BACnetConstructedData implements Message {
  ...
  public BACnetApplicationTagCharacterString getActualValue() {
    return (BACnetApplicationTagCharacterString) (getInactiveText());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataInactiveText");
  }
  ...
  public static BACnetConstructedDataInactiveTextBuilder staticParseBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataInactiveText");
    ...
    BACnetApplicationTagCharacterString actualValue =
        readVirtualField("actualValue", BACnetApplicationTagCharacterString.class, inactiveText);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataInactiveText)) {
      return false;
    }
    BACnetConstructedDataInactiveText that = (BACnetConstructedDataInactiveText) o;
    return (getInactiveText() == that.getInactiveText()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getInactiveText());
  }
