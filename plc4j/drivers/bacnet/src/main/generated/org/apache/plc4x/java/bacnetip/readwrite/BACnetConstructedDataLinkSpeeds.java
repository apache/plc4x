...
public class BACnetConstructedDataLinkSpeeds extends BACnetConstructedData implements Message {
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataLinkSpeeds");
  }
  ...
  public int getLengthInBits() {
    ...
    // Array field
    if (linkSpeeds != null) {
      for (Message element : linkSpeeds) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataLinkSpeeds)) {
      return false;
    }
    BACnetConstructedDataLinkSpeeds that = (BACnetConstructedDataLinkSpeeds) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getNumberOfDataElements(), getLinkSpeeds());
  }
