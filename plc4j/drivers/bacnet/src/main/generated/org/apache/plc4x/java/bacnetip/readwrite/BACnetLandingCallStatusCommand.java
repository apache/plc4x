...
public abstract class BACnetLandingCallStatusCommand implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("BACnetLandingCallStatusCommand");
  }
  ...
  public static BACnetLandingCallStatusCommand staticParse(ReadBuffer readBuffer, Object... args)
      throws ParseException {
    PositionAware positionAware = readBuffer;
    return staticParse(readBuffer);
  }

  public static BACnetLandingCallStatusCommand staticParse(ReadBuffer readBuffer)
      throws ParseException {
    readBuffer.pullContext("BACnetLandingCallStatusCommand");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
    ...
    readBuffer.closeContext("BACnetLandingCallStatusCommand");
    // Create the instance
    BACnetLandingCallStatusCommand _bACnetLandingCallStatusCommand = builder.build(peekedTagHeader);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetLandingCallStatusCommand)) {
      return false;
    }
    BACnetLandingCallStatusCommand that = (BACnetLandingCallStatusCommand) o;
