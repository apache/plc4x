...
public class BACnetConstructedDataInstanceOf extends BACnetConstructedData implements Message {
  ...
  public BACnetApplicationTagCharacterString getActualValue() {
    return (BACnetApplicationTagCharacterString) (getInstanceOf());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataInstanceOf");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataInstanceOf");
    ...
    BACnetApplicationTagCharacterString actualValue =
        readVirtualField("actualValue", BACnetApplicationTagCharacterString.class, instanceOf);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataInstanceOf)) {
      return false;
    }
    BACnetConstructedDataInstanceOf that = (BACnetConstructedDataInstanceOf) o;
    return (getInstanceOf() == that.getInstanceOf()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getInstanceOf());
  }
