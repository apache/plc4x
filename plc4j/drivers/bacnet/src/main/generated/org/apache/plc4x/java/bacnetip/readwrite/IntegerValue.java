...
public class IntegerValue implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("IntegerValue");
    ...
    writeBuffer.popContext("IntegerValue");
  }
  ...
  public static IntegerValue staticParse(ReadBuffer readBuffer) throws ParseException {
    readBuffer.pullContext("IntegerValue");
    ...
    ReadableProperty presentValue =
        readSimpleField(
            "presentValue",
            readComplex(
                () -> ReadableProperty.staticParse(readBuffer, (String) ("INTEGER")), readBuffer));
    ...
    readBuffer.closeContext("IntegerValue");
    // Create the instance
