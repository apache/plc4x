...
public class BACnetConstructedDataElapsedActiveTime extends BACnetConstructedData
    implements Message {
  ...
  public BACnetApplicationTagUnsignedInteger getActualValue() {
    return (BACnetApplicationTagUnsignedInteger) (getElapsedActiveTime());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeSimpleField(
        "elapsedActiveTime", elapsedActiveTime, new DataWriterComplexDefault<>(writeBuffer));

    // Virtual field (doesn't actually serialize anything, just makes the value available)
    BACnetApplicationTagUnsignedInteger actualValue = getActualValue();
    writeBuffer.writeVirtual("actualValue", actualValue);

    writeBuffer.popContext("BACnetConstructedDataElapsedActiveTime");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    BACnetApplicationTagUnsignedInteger actualValue =
        readVirtualField(
            "actualValue", BACnetApplicationTagUnsignedInteger.class, elapsedActiveTime);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataElapsedActiveTime)) {
      return false;
    }
    BACnetConstructedDataElapsedActiveTime that = (BACnetConstructedDataElapsedActiveTime) o;
    return (getElapsedActiveTime() == that.getElapsedActiveTime()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getElapsedActiveTime());
  }
