...
public class ErrorClassTagged implements Message {
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (ErrorClass.VENDOR_PROPRIETARY_VALUE));
  }

  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    PositionAware positionAware = writeBuffer;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    writeBuffer.pushContext("ErrorClassTagged");
    ...
    writeBuffer.popContext("ErrorClassTagged");
  }
  ...
  public static ErrorClassTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static ErrorClassTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("ErrorClassTagged");
    PositionAware positionAware = readBuffer;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
            ...
            () ->
                (ErrorClass)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        ErrorClass.VENDOR_PROPRIETARY_VALUE)));
    boolean isProprietary =
        readVirtualField(
            "isProprietary", boolean.class, (value) == (ErrorClass.VENDOR_PROPRIETARY_VALUE));
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ErrorClassTagged)) {
      return false;
    }
    ErrorClassTagged that = (ErrorClassTagged) o;
