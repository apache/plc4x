...
public class BACnetFaultTypeTagged implements Message {
  ...
  public BACnetFaultTypeTagged(
      BACnetTagHeader header, BACnetFaultType value, Short tagNumber, TagClass tagClass) {
    super();
    this.header = header;
    this.value = value;
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("BACnetFaultTypeTagged");
    ...
    writeBuffer.popContext("BACnetFaultTypeTagged");
  }
  ...
  public static BACnetFaultTypeTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetFaultTypeTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetFaultTypeTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
                ...
                (BACnetFaultType)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper
                        .readEnumGenericFailing(
                            readBuffer, header.getActualLength(), BACnetFaultType.NONE)));

    readBuffer.closeContext("BACnetFaultTypeTagged");
    // Create the instance
    BACnetFaultTypeTagged _bACnetFaultTypeTagged;
    _bACnetFaultTypeTagged = new BACnetFaultTypeTagged(header, value, tagNumber, tagClass);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetFaultTypeTagged)) {
      return false;
    }
    BACnetFaultTypeTagged that = (BACnetFaultTypeTagged) o;
