...
public class BACnetConstructedDataFaultType extends BACnetConstructedData implements Message {
  ...
  public BACnetFaultTypeTagged getActualValue() {
    return (BACnetFaultTypeTagged) (getFaultType());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeSimpleField("faultType", faultType, new DataWriterComplexDefault<>(writeBuffer));

    // Virtual field (doesn't actually serialize anything, just makes the value available)
    BACnetFaultTypeTagged actualValue = getActualValue();
    writeBuffer.writeVirtual("actualValue", actualValue);

    writeBuffer.popContext("BACnetConstructedDataFaultType");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataFaultType");
    ...
    BACnetFaultTypeTagged faultType =
        readSimpleField(
            ...
            new DataReaderComplexDefault<>(
                ...
                readBuffer));
    BACnetFaultTypeTagged actualValue =
        readVirtualField("actualValue", BACnetFaultTypeTagged.class, faultType);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataFaultType)) {
      return false;
    }
    BACnetConstructedDataFaultType that = (BACnetConstructedDataFaultType) o;
    return (getFaultType() == that.getFaultType()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getFaultType());
  }
