...
public class BACnetPolarityTagged implements Message {
  ...
  public static BACnetPolarityTagged staticParse(ReadBuffer readBuffer, short tagNumber,
      TagClass tagClass) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("BACnetPolarityTagged"));
    ...
    // Manual Field: value
    BACnetPolarity value = FieldReaderFactory.readManualField(readBuffer, () -> (BACnetPolarity) (StaticHelper.readEnumGenericFailing(readBuffer, header.getActualLength(), BACnetPolarity.NORMAL)), WithOption.WithName("value"));

    readBuffer.popContext();
    return new BACnetPolarityTagged(header, value);
  }

  @Override
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetPolarityTagged"));
