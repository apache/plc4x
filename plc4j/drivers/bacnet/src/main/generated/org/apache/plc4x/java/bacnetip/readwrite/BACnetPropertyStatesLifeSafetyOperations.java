 ...
 */
public class BACnetPropertyStatesLifeSafetyOperations extends BACnetPropertyStates implements Message {
  protected final BACnetLifeSafetyOperationTagged lifeSafetyOperations;

  public BACnetPropertyStatesLifeSafetyOperations(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetPropertyStatesBuilder staticParseBACnetPropertyStatesBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetPropertyStatesLifeSafetyOperations"));
  ...
  protected void serializeBACnetPropertyStatesChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetPropertyStatesLifeSafetyOperations"));
  ...
  public static class BACnetPropertyStatesBuilderImpl implements BACnetPropertyStates.BACnetPropertyStatesBuilder {
    ...
    public BACnetPropertyStatesBuilderImpl(BACnetLifeSafetyOperationTagged lifeSafetyOperations) {
      this.lifeSafetyOperations = lifeSafetyOperations;
    }

    public BACnetPropertyStates build(BACnetTagHeader peekedTagHeader) {
      return new BACnetPropertyStatesLifeSafetyOperations(peekedTagHeader, lifeSafetyOperations);
    }
  }
}
