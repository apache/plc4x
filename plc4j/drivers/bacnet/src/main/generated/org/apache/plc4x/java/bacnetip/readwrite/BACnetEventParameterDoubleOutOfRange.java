...
public class BACnetEventParameterDoubleOutOfRange extends BACnetEventParameter implements Message {
  ...
  public BACnetEventParameterDoubleOutOfRange(
  ...
  protected void serializeBACnetEventParameterChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetEventParameterDoubleOutOfRange");
  }
            ...
            new DataReaderComplexDefault<>(
                () ->
                    (BACnetContextTagDouble)
                        BACnetContextTag.staticParse(
                            readBuffer, (short) (1), (BACnetDataType) (BACnetDataType.DOUBLE)),
                readBuffer));
  ...
  public static class BACnetEventParameterDoubleOutOfRangeBuilderImpl
    ...
    public BACnetEventParameterDoubleOutOfRange build(BACnetTagHeader peekedTagHeader) {
      BACnetEventParameterDoubleOutOfRange bACnetEventParameterDoubleOutOfRange =
          new BACnetEventParameterDoubleOutOfRange(
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetEventParameterDoubleOutOfRange)) {
      return false;
    }
    BACnetEventParameterDoubleOutOfRange that = (BACnetEventParameterDoubleOutOfRange) o;
