...
public class BACnetLogRecordLogDatumRealValue extends BACnetLogRecordLogDatum implements Message {
  ...
  public BACnetLogRecordLogDatumRealValue(BACnetOpeningTag openingTag,
  ...
  public static BACnetLogRecordLogDatumBuilder staticParseBACnetLogRecordLogDatumBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetLogRecordLogDatumRealValue"));
  ...
  protected void serializeBACnetLogRecordLogDatumChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetLogRecordLogDatumRealValue"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: realValue
    FieldWriterFactory.writeSimpleField((BACnetContextTagReal) realValue, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("realValue"));
  ...
  public static class BACnetLogRecordLogDatumBuilderImpl implements BACnetLogRecordLogDatum.BACnetLogRecordLogDatumBuilder {
    ...
    public BACnetLogRecordLogDatumBuilderImpl(BACnetContextTagReal realValue) {
      this.realValue = realValue;
    }

    public BACnetLogRecordLogDatum build(BACnetOpeningTag openingTag,
        BACnetTagHeader peekedTagHeader, BACnetClosingTag closingTag) {
      return new BACnetLogRecordLogDatumRealValue(openingTag, peekedTagHeader, closingTag, realValue);
    }
  }
}
