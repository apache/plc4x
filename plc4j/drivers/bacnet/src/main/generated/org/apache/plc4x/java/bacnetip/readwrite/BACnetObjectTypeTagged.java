...
public class BACnetObjectTypeTagged implements Message {
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetObjectType.VENDOR_PROPRIETARY_VALUE));
  }

  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    PositionAware positionAware = writeBuffer;
    int startPos = positionAware.getPos();
    writeBuffer.pushContext("BACnetObjectTypeTagged");
    ...
    writeBuffer.popContext("BACnetObjectTypeTagged");
  }
  ...
  public static BACnetObjectTypeTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetObjectTypeTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetObjectTypeTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
    ...
    boolean isProprietary =
        readVirtualField(
            "isProprietary", boolean.class, (value) == (BACnetObjectType.VENDOR_PROPRIETARY_VALUE));
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetObjectTypeTagged)) {
      return false;
    }
    BACnetObjectTypeTagged that = (BACnetObjectTypeTagged) o;
