...
public class BACnetConstructedDataPassengerAlarm extends BACnetConstructedData implements Message {
  ...
  public BACnetApplicationTagBoolean getActualValue() {
    return (BACnetApplicationTagBoolean) (getPassengerAlarm());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataPassengerAlarm");
  }
  ...
  public static BACnetConstructedDataPassengerAlarmBuilder staticParseBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataPassengerAlarm");
    ...
    BACnetApplicationTagBoolean actualValue =
        readVirtualField("actualValue", BACnetApplicationTagBoolean.class, passengerAlarm);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataPassengerAlarm)) {
      return false;
    }
    BACnetConstructedDataPassengerAlarm that = (BACnetConstructedDataPassengerAlarm) o;
    return (getPassengerAlarm() == that.getPassengerAlarm()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getPassengerAlarm());
  }
