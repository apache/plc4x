...
public class BACnetReliabilityTagged implements Message {
  ...
  public BACnetReliabilityTagged(
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetReliability.VENDOR_PROPRIETARY_VALUE));
  }
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("BACnetReliabilityTagged");
  }
  ...
  public static BACnetReliabilityTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetReliabilityTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetReliabilityTagged");
    PositionAware positionAware = readBuffer;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
            ...
            () ->
                (BACnetReliability)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        BACnetReliability.VENDOR_PROPRIETARY_VALUE)));
    ...
    readBuffer.closeContext("BACnetReliabilityTagged");
    // Create the instance
    BACnetReliabilityTagged _bACnetReliabilityTagged;
    _bACnetReliabilityTagged =
        new BACnetReliabilityTagged(header, value, proprietaryValue, tagNumber, tagClass);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetReliabilityTagged)) {
      return false;
    }
    BACnetReliabilityTagged that = (BACnetReliabilityTagged) o;
