...
public class BACnetConstructedDataIPv6PrefixLength extends BACnetConstructedData
    implements Message {
  ...
  public BACnetApplicationTagUnsignedInteger getActualValue() {
    return (BACnetApplicationTagUnsignedInteger) (getIpv6PrefixLength());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataIPv6PrefixLength");
  }
  ...
  public static BACnetConstructedDataIPv6PrefixLengthBuilder staticParseBuilder(
    ...
    BACnetApplicationTagUnsignedInteger actualValue =
        readVirtualField(
            "actualValue", BACnetApplicationTagUnsignedInteger.class, ipv6PrefixLength);

    readBuffer.closeContext("BACnetConstructedDataIPv6PrefixLength");
    // Create the instance
    return new BACnetConstructedDataIPv6PrefixLengthBuilder(
        ipv6PrefixLength, tagNumber, arrayIndexArgument);
  }

  public static class BACnetConstructedDataIPv6PrefixLengthBuilder
      implements BACnetConstructedData.BACnetConstructedDataBuilder {
    private final BACnetApplicationTagUnsignedInteger ipv6PrefixLength;
    private final Short tagNumber;
    private final BACnetTagPayloadUnsignedInteger arrayIndexArgument;

    public BACnetConstructedDataIPv6PrefixLengthBuilder(
        BACnetApplicationTagUnsignedInteger ipv6PrefixLength,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataIPv6PrefixLength)) {
      return false;
    }
    BACnetConstructedDataIPv6PrefixLength that = (BACnetConstructedDataIPv6PrefixLength) o;
    return (getIpv6PrefixLength() == that.getIpv6PrefixLength()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getIpv6PrefixLength());
  }
