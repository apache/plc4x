...
public class BACnetEventLogRecordLogDatumTimeChange extends BACnetEventLogRecordLogDatum
    implements Message {
  ...
  public BACnetEventLogRecordLogDatumTimeChange(
  ...
  protected void serializeBACnetEventLogRecordLogDatumChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.pushContext("BACnetEventLogRecordLogDatumTimeChange");

    // Simple Field (timeChange)
    writeSimpleField("timeChange", timeChange, writeComplex(writeBuffer));

    writeBuffer.popContext("BACnetEventLogRecordLogDatumTimeChange");
  }
  ...
  public static BACnetEventLogRecordLogDatumBuilder staticParseBACnetEventLogRecordLogDatumBuilder(
    ...
    // Create the instance
    return new BACnetEventLogRecordLogDatumTimeChangeBuilderImpl(timeChange);
  }
  ...
  public static class BACnetEventLogRecordLogDatumTimeChangeBuilderImpl
    ...
    public BACnetEventLogRecordLogDatumTimeChangeBuilderImpl(BACnetContextTagReal timeChange) {
      this.timeChange = timeChange;
    }

    public BACnetEventLogRecordLogDatumTimeChange build(
        BACnetOpeningTag openingTag, BACnetTagHeader peekedTagHeader, BACnetClosingTag closingTag) {
      BACnetEventLogRecordLogDatumTimeChange bACnetEventLogRecordLogDatumTimeChange =
          new BACnetEventLogRecordLogDatumTimeChange(
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetEventLogRecordLogDatumTimeChange)) {
      return false;
    }
    BACnetEventLogRecordLogDatumTimeChange that = (BACnetEventLogRecordLogDatumTimeChange) o;
