...
public class BACnetConstructedDataGlobalIdentifier extends BACnetConstructedData
    implements Message {
  ...
  public BACnetApplicationTagUnsignedInteger getActualValue() {
    return (BACnetApplicationTagUnsignedInteger) (getGlobalIdentifier());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataGlobalIdentifier");
  }
  ...
  public static BACnetConstructedDataGlobalIdentifierBuilder staticParseBuilder(
    ...
    BACnetApplicationTagUnsignedInteger actualValue =
        readVirtualField(
            "actualValue", BACnetApplicationTagUnsignedInteger.class, globalIdentifier);

    readBuffer.closeContext("BACnetConstructedDataGlobalIdentifier");
    // Create the instance
    return new BACnetConstructedDataGlobalIdentifierBuilder(
        globalIdentifier, tagNumber, arrayIndexArgument);
  }

  public static class BACnetConstructedDataGlobalIdentifierBuilder
      implements BACnetConstructedData.BACnetConstructedDataBuilder {
    private final BACnetApplicationTagUnsignedInteger globalIdentifier;
    private final Short tagNumber;
    private final BACnetTagPayloadUnsignedInteger arrayIndexArgument;

    public BACnetConstructedDataGlobalIdentifierBuilder(
        BACnetApplicationTagUnsignedInteger globalIdentifier,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataGlobalIdentifier)) {
      return false;
    }
    BACnetConstructedDataGlobalIdentifier that = (BACnetConstructedDataGlobalIdentifier) o;
    return (getGlobalIdentifier() == that.getGlobalIdentifier()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getGlobalIdentifier());
  }
