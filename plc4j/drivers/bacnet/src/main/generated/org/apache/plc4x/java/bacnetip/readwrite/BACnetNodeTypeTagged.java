...
public class BACnetNodeTypeTagged implements Message {
  ...
  public BACnetNodeTypeTagged(
      BACnetTagHeader header, BACnetNodeType value, Short tagNumber, TagClass tagClass) {
    super();
    this.header = header;
    this.value = value;
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("BACnetNodeTypeTagged");
  }
  ...
  public static BACnetNodeTypeTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetNodeTypeTagged staticParse(
                ...
                (BACnetNodeType)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper
                        .readEnumGenericFailing(
                            readBuffer, header.getActualLength(), BACnetNodeType.UNKNOWN)));

    readBuffer.closeContext("BACnetNodeTypeTagged");
    // Create the instance
    BACnetNodeTypeTagged _bACnetNodeTypeTagged;
    _bACnetNodeTypeTagged = new BACnetNodeTypeTagged(header, value, tagNumber, tagClass);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetNodeTypeTagged)) {
      return false;
    }
    BACnetNodeTypeTagged that = (BACnetNodeTypeTagged) o;
