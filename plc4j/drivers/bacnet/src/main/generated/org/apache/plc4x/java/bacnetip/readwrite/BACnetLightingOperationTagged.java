...
public class BACnetLightingOperationTagged implements Message {
  ...
  public BACnetLightingOperationTagged(
      BACnetTagHeader header,
      BACnetLightingOperation value,
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetLightingOperation.VENDOR_PROPRIETARY_VALUE));
  }
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("BACnetLightingOperationTagged");
  }
  ...
  public static BACnetLightingOperationTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetLightingOperationTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetLightingOperationTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
            ...
            () ->
                (BACnetLightingOperation)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        BACnetLightingOperation.VENDOR_PROPRIETARY_VALUE)));
    ...
    readBuffer.closeContext("BACnetLightingOperationTagged");
    // Create the instance
    BACnetLightingOperationTagged _bACnetLightingOperationTagged;
    _bACnetLightingOperationTagged =
        new BACnetLightingOperationTagged(header, value, proprietaryValue, tagNumber, tagClass);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetLightingOperationTagged)) {
      return false;
    }
    BACnetLightingOperationTagged that = (BACnetLightingOperationTagged) o;
