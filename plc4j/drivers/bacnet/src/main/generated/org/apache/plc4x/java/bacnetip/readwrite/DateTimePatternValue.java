...
public class DateTimePatternValue implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("DateTimePatternValue");
    ...
    writeBuffer.popContext("DateTimePatternValue");
  }
  ...
  public int getLengthInBits() {
    int lengthInBits = 0;
    DateTimePatternValue _value = this;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
  ...
  public static DateTimePatternValue staticParse(ReadBuffer readBuffer) throws ParseException {
    readBuffer.pullContext("DateTimePatternValue");
    ...
    readBuffer.closeContext("DateTimePatternValue");
    // Create the instance
    DateTimePatternValue _dateTimePatternValue;
    _dateTimePatternValue =
        new DateTimePatternValue(
            objectIdentifier,
            objectName,
            objectType,
            description,
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof DateTimePatternValue)) {
      return false;
    }
    DateTimePatternValue that = (DateTimePatternValue) o;
