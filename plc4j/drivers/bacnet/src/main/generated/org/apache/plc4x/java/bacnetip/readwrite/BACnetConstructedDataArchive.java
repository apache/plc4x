...
public class BACnetConstructedDataArchive extends BACnetConstructedData implements Message {
  ...
  public BACnetApplicationTagBoolean getActualValue() {
    return (BACnetApplicationTagBoolean) (getArchive());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataArchive");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    BACnetApplicationTagBoolean actualValue =
        readVirtualField("actualValue", BACnetApplicationTagBoolean.class, archive);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataArchive)) {
      return false;
    }
    BACnetConstructedDataArchive that = (BACnetConstructedDataArchive) o;
    return (getArchive() == that.getArchive()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getArchive());
  }
