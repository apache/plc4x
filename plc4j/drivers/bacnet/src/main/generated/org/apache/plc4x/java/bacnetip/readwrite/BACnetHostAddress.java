 ...
 */
public abstract class BACnetHostAddress implements Message {
  protected final BACnetTagHeader peekedTagHeader;

  public BACnetHostAddress(BACnetTagHeader peekedTagHeader) {
    this.peekedTagHeader = peekedTagHeader;
  }

  protected abstract void serializeBACnetHostAddressChild(WriteBuffer writeBuffer) throws
      BufferException;
  ...
  public static BACnetHostAddress staticParse(ReadBuffer readBuffer) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("BACnetHostAddress"));
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetHostAddress"));
    ...
    // Switch Field
    serializeBACnetHostAddressChild(writeBuffer);
