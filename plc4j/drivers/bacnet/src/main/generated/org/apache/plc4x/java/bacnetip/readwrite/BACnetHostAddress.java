...
public abstract class BACnetHostAddress implements Message {
  ...
  protected abstract void serializeBACnetHostAddressChild(WriteBuffer writeBuffer)
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("BACnetHostAddress");
  }
  ...
  public static BACnetHostAddress staticParse(ReadBuffer readBuffer) throws ParseException {
    ...
    readBuffer.closeContext("BACnetHostAddress");
    // Create the instance
    BACnetHostAddress _bACnetHostAddress = builder.build(peekedTagHeader);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetHostAddress)) {
      return false;
    }
    BACnetHostAddress that = (BACnetHostAddress) o;
