...
public class BACnetConstructedDataBBMDForeignDeviceTable extends BACnetConstructedData
    implements Message {
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeComplexTypeArrayField("bbmdForeignDeviceTable", bbmdForeignDeviceTable, writeBuffer);

    writeBuffer.popContext("BACnetConstructedDataBBMDForeignDeviceTable");
  }
  ...
  public int getLengthInBits() {
    ...
    if (bbmdForeignDeviceTable != null) {
      for (Message element : bbmdForeignDeviceTable) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataBBMDForeignDeviceTable)) {
      return false;
    }
    BACnetConstructedDataBBMDForeignDeviceTable that =
        (BACnetConstructedDataBBMDForeignDeviceTable) o;
    return (getBbmdForeignDeviceTable() == that.getBbmdForeignDeviceTable())
        && super.equals(that)
        && true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getBbmdForeignDeviceTable());
  }
