...
public abstract class BACnetEventParameter implements Message {
  ...
  protected abstract void serializeBACnetEventParameterChild(WriteBuffer writeBuffer) throws
      BufferException;
  ...
  public static BACnetEventParameter staticParse(ReadBuffer readBuffer) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("BACnetEventParameter"));
    ...
    if (EvaluationHelper.equals(peekedTagNumber, (short) (0))) {
      builder = BACnetEventParameterChangeOfBitstring.staticParseBACnetEventParameterBuilder(readBuffer);
    } else if (EvaluationHelper.equals(peekedTagNumber, (short) (1))) {
      builder = BACnetEventParameterChangeOfState.staticParseBACnetEventParameterBuilder(readBuffer);
    } else if (EvaluationHelper.equals(peekedTagNumber, (short) (2))) {
      builder = BACnetEventParameterChangeOfValue.staticParseBACnetEventParameterBuilder(readBuffer);
    } else if (EvaluationHelper.equals(peekedTagNumber, (short) (3))) {
      builder = BACnetEventParameterCommandFailure.staticParseBACnetEventParameterBuilder(readBuffer);
    } else if (EvaluationHelper.equals(peekedTagNumber, (short) (4))) {
      builder = BACnetEventParameterFloatingLimit.staticParseBACnetEventParameterBuilder(readBuffer);
      ...
      builder = BACnetEventParameterChangeOfLifeSavety.staticParseBACnetEventParameterBuilder(readBuffer);
      ...
      builder = BACnetEventParameterUnsignedRange.staticParseBACnetEventParameterBuilder(readBuffer);
      ...
      builder = BACnetEventParameterDoubleOutOfRange.staticParseBACnetEventParameterBuilder(readBuffer);
    } else if (EvaluationHelper.equals(peekedTagNumber, (short) (15))) {
      builder = BACnetEventParameterSignedOutOfRange.staticParseBACnetEventParameterBuilder(readBuffer);
    } else if (EvaluationHelper.equals(peekedTagNumber, (short) (16))) {
      builder = BACnetEventParameterUnsignedOutOfRange.staticParseBACnetEventParameterBuilder(readBuffer);
    } else if (EvaluationHelper.equals(peekedTagNumber, (short) (17))) {
      builder = BACnetEventParameterChangeOfCharacterString.staticParseBACnetEventParameterBuilder(readBuffer);
    } else if (EvaluationHelper.equals(peekedTagNumber, (short) (18))) {
      builder = BACnetEventParameterChangeOfStatusFlags.staticParseBACnetEventParameterBuilder(readBuffer);
      ...
      builder = BACnetEventParameterChangeOfDiscreteValue.staticParseBACnetEventParameterBuilder(readBuffer);
    } else if (EvaluationHelper.equals(peekedTagNumber, (short) (22))) {
      builder = BACnetEventParameterChangeOfTimer.staticParseBACnetEventParameterBuilder(readBuffer);
    }
    if (builder == null) {
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetEventParameter"));
