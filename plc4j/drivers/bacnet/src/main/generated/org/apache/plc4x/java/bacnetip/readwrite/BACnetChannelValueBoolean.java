...
public class BACnetChannelValueBoolean extends BACnetChannelValue implements Message {
  ...
  public BACnetChannelValueBoolean(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetChannelValueBuilder staticParseBACnetChannelValueBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetChannelValueBoolean"));
    ...
    return new BACnetChannelValueBuilderImpl(booleanValue);
  }

  protected void serializeBACnetChannelValueChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetChannelValueBoolean"));
  ...
  public static class BACnetChannelValueBuilderImpl implements BACnetChannelValue.BACnetChannelValueBuilder {
    ...
    public BACnetChannelValueBuilderImpl(BACnetApplicationTagBoolean booleanValue) {
      this.booleanValue = booleanValue;
    }

    public BACnetChannelValue build(BACnetTagHeader peekedTagHeader) {
      return new BACnetChannelValueBoolean(peekedTagHeader, booleanValue);
    }
  }
}
