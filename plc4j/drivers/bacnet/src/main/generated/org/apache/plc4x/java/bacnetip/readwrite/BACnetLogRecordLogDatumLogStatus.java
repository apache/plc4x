...
public class BACnetLogRecordLogDatumLogStatus extends BACnetLogRecordLogDatum implements Message {
  ...
  public BACnetLogRecordLogDatumLogStatus(
  ...
  protected void serializeBACnetLogRecordLogDatumChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetLogRecordLogDatumLogStatus");
  }
  ...
  public static BACnetLogRecordLogDatumBuilder staticParseBACnetLogRecordLogDatumBuilder(
    ...
    // Create the instance
    return new BACnetLogRecordLogDatumLogStatusBuilderImpl(logStatus);
  }
  ...
  public static class BACnetLogRecordLogDatumLogStatusBuilderImpl
    ...
    public BACnetLogRecordLogDatumLogStatusBuilderImpl(BACnetLogStatusTagged logStatus) {
      this.logStatus = logStatus;
    }

    public BACnetLogRecordLogDatumLogStatus build(
        BACnetOpeningTag openingTag, BACnetTagHeader peekedTagHeader, BACnetClosingTag closingTag) {
      BACnetLogRecordLogDatumLogStatus bACnetLogRecordLogDatumLogStatus =
          new BACnetLogRecordLogDatumLogStatus(openingTag, peekedTagHeader, closingTag, logStatus);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetLogRecordLogDatumLogStatus)) {
      return false;
    }
    BACnetLogRecordLogDatumLogStatus that = (BACnetLogRecordLogDatumLogStatus) o;
