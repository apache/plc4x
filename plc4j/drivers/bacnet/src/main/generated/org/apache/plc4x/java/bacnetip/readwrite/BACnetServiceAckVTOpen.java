...
public class BACnetServiceAckVTOpen extends BACnetServiceAck implements Message {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetServiceAckVTOpen)) {
      return false;
    }
    BACnetServiceAckVTOpen that = (BACnetServiceAckVTOpen) o;
    return (getRemoteVtSessionIdentifier() == that.getRemoteVtSessionIdentifier())
        && super.equals(that)
        && true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getRemoteVtSessionIdentifier());
  }
