...
public class BACnetEngineeringUnitsTagged implements Message {
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetEngineeringUnits.VENDOR_PROPRIETARY_VALUE));
  }
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("BACnetEngineeringUnitsTagged");
    ...
    writeBuffer.popContext("BACnetEngineeringUnitsTagged");
  }
  ...
  public static BACnetEngineeringUnitsTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetEngineeringUnitsTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetEngineeringUnitsTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
            ...
            () ->
                (BACnetEngineeringUnits)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        BACnetEngineeringUnits.VENDOR_PROPRIETARY_VALUE)));
    ...
    readBuffer.closeContext("BACnetEngineeringUnitsTagged");
    // Create the instance
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetEngineeringUnitsTagged)) {
      return false;
    }
    BACnetEngineeringUnitsTagged that = (BACnetEngineeringUnitsTagged) o;
