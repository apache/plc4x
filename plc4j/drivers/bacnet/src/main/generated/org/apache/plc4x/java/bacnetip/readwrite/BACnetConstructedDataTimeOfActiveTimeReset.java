...
public class BACnetConstructedDataTimeOfActiveTimeReset extends BACnetConstructedData
    implements Message {
  ...
  public BACnetDateTime getActualValue() {
    return (BACnetDateTime) (getTimeOfActiveTimeReset());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataTimeOfActiveTimeReset");
  }
  ...
  public static BACnetConstructedDataTimeOfActiveTimeResetBuilder staticParseBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataTimeOfActiveTimeReset");
    ...
    BACnetDateTime actualValue =
        readVirtualField("actualValue", BACnetDateTime.class, timeOfActiveTimeReset);

    readBuffer.closeContext("BACnetConstructedDataTimeOfActiveTimeReset");
    // Create the instance
    return new BACnetConstructedDataTimeOfActiveTimeResetBuilder(
        timeOfActiveTimeReset, tagNumber, arrayIndexArgument);
  }

  public static class BACnetConstructedDataTimeOfActiveTimeResetBuilder
      implements BACnetConstructedData.BACnetConstructedDataBuilder {
    private final BACnetDateTime timeOfActiveTimeReset;
    private final Short tagNumber;
    private final BACnetTagPayloadUnsignedInteger arrayIndexArgument;

    public BACnetConstructedDataTimeOfActiveTimeResetBuilder(
        BACnetDateTime timeOfActiveTimeReset,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataTimeOfActiveTimeReset)) {
      return false;
    }
    BACnetConstructedDataTimeOfActiveTimeReset that =
        (BACnetConstructedDataTimeOfActiveTimeReset) o;
    return (getTimeOfActiveTimeReset() == that.getTimeOfActiveTimeReset())
        && super.equals(that)
        && true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getTimeOfActiveTimeReset());
  }
