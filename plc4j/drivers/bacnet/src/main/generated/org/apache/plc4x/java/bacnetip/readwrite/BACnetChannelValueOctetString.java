...
public class BACnetChannelValueOctetString extends BACnetChannelValue implements Message {
  ...
  public BACnetChannelValueOctetString(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetChannelValueBuilder staticParseBACnetChannelValueBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetChannelValueOctetString"));
    ...
    return new BACnetChannelValueBuilderImpl(octetStringValue);
  }

  protected void serializeBACnetChannelValueChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetChannelValueOctetString"));
  ...
  public static class BACnetChannelValueBuilderImpl implements BACnetChannelValue.BACnetChannelValueBuilder {
    ...
    public BACnetChannelValueBuilderImpl(BACnetApplicationTagOctetString octetStringValue) {
      this.octetStringValue = octetStringValue;
    }

    public BACnetChannelValue build(BACnetTagHeader peekedTagHeader) {
      return new BACnetChannelValueOctetString(peekedTagHeader, octetStringValue);
    }
  }
}
