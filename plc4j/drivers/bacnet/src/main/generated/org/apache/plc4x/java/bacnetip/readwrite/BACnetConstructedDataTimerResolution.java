...
public class BACnetConstructedDataTimerResolution extends BACnetConstructedData implements Message {
  ...
  public BACnetConstructedDataTimerResolution(
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataTimerResolution");
  }
  ...
  public static BACnetConstructedDataTimerResolutionBuilder staticParseBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataTimerResolution");
    ...
    readBuffer.closeContext("BACnetConstructedDataTimerResolution");
    // Create the instance
    return new BACnetConstructedDataTimerResolutionBuilder(
        resolution, tagNumber, arrayIndexArgument);
  }

  public static class BACnetConstructedDataTimerResolutionBuilder
      implements BACnetConstructedData.BACnetConstructedDataBuilder {
    private final BACnetApplicationTagUnsignedInteger resolution;
    private final Short tagNumber;
    private final BACnetTagPayloadUnsignedInteger arrayIndexArgument;

    public BACnetConstructedDataTimerResolutionBuilder(
        BACnetApplicationTagUnsignedInteger resolution,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
    ...
    public BACnetConstructedDataTimerResolution build(
        BACnetOpeningTag openingTag,
        BACnetTagHeader peekedTagHeader,
        BACnetClosingTag closingTag,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
      BACnetConstructedDataTimerResolution bACnetConstructedDataTimerResolution =
          new BACnetConstructedDataTimerResolution(
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataTimerResolution)) {
      return false;
    }
    BACnetConstructedDataTimerResolution that = (BACnetConstructedDataTimerResolution) o;
