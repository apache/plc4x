...
public class BACnetPriorityValueUnsigned extends BACnetPriorityValue implements Message {
  ...
  public BACnetPriorityValueUnsigned(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetPriorityValueBuilder staticParseBACnetPriorityValueBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetPriorityValueUnsigned"));
  ...
  protected void serializeBACnetPriorityValueChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetPriorityValueUnsigned"));
  ...
  public static class BACnetPriorityValueBuilderImpl implements BACnetPriorityValue.BACnetPriorityValueBuilder {
    ...
    public BACnetPriorityValueBuilderImpl(BACnetApplicationTagUnsignedInteger unsignedValue) {
      this.unsignedValue = unsignedValue;
    }

    public BACnetPriorityValue build(BACnetTagHeader peekedTagHeader) {
      return new BACnetPriorityValueUnsigned(peekedTagHeader, unsignedValue);
    }
  }
}
