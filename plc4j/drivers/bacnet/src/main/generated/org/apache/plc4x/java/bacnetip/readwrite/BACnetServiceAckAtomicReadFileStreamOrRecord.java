...
public abstract class BACnetServiceAckAtomicReadFileStreamOrRecord implements Message {
  ...
  public BACnetServiceAckAtomicReadFileStreamOrRecord(
  ...
  public static BACnetServiceAckAtomicReadFileStreamOrRecord staticParse(ReadBuffer readBuffer)
    ...
    if (EvaluationHelper.equals(peekedTagNumber, (short) 0x0)) {
      builder = BACnetServiceAckAtomicReadFileStream.staticParseBuilder(readBuffer);
    } else if (EvaluationHelper.equals(peekedTagNumber, (short) 0x1)) {
      builder = BACnetServiceAckAtomicReadFileRecord.staticParseBuilder(readBuffer);
    }
    if (builder == null) {
    ...
    readBuffer.closeContext("BACnetServiceAckAtomicReadFileStreamOrRecord");
    // Create the instance
    BACnetServiceAckAtomicReadFileStreamOrRecord _bACnetServiceAckAtomicReadFileStreamOrRecord =
        builder.build(peekedTagHeader, openingTag, closingTag);
    return _bACnetServiceAckAtomicReadFileStreamOrRecord;
  }

  public static interface BACnetServiceAckAtomicReadFileStreamOrRecordBuilder {
    BACnetServiceAckAtomicReadFileStreamOrRecord build(
        BACnetTagHeader peekedTagHeader, BACnetOpeningTag openingTag, BACnetClosingTag closingTag);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetServiceAckAtomicReadFileStreamOrRecord)) {
      return false;
    }
    BACnetServiceAckAtomicReadFileStreamOrRecord that =
        (BACnetServiceAckAtomicReadFileStreamOrRecord) o;
