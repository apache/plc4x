...
public class BACnetConstructedDataChannelNumber extends BACnetConstructedData implements Message {
  ...
  public BACnetApplicationTagUnsignedInteger getActualValue() {
    return (BACnetApplicationTagUnsignedInteger) (getChannelNumber());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataChannelNumber");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    BACnetApplicationTagUnsignedInteger actualValue =
        readVirtualField("actualValue", BACnetApplicationTagUnsignedInteger.class, channelNumber);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataChannelNumber)) {
      return false;
    }
    BACnetConstructedDataChannelNumber that = (BACnetConstructedDataChannelNumber) o;
    return (getChannelNumber() == that.getChannelNumber()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getChannelNumber());
  }
