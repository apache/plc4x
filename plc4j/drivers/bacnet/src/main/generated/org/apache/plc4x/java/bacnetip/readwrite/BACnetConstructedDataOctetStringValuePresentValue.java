...
public class BACnetConstructedDataOctetStringValuePresentValue extends BACnetConstructedData
    implements Message {
  ...
  public BACnetConstructedDataOctetStringValuePresentValue(
  ...
  public BACnetApplicationTagOctetString getActualValue() {
    return (BACnetApplicationTagOctetString) (getPresentValue());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataOctetStringValuePresentValue");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataOctetStringValuePresentValue");
    ...
    BACnetApplicationTagOctetString actualValue =
        readVirtualField("actualValue", BACnetApplicationTagOctetString.class, presentValue);

    readBuffer.closeContext("BACnetConstructedDataOctetStringValuePresentValue");
    // Create the instance
    return new BACnetConstructedDataOctetStringValuePresentValueBuilderImpl(presentValue);
  }
  ...
  public static class BACnetConstructedDataOctetStringValuePresentValueBuilderImpl
    ...
    public BACnetConstructedDataOctetStringValuePresentValue build(
        BACnetOpeningTag openingTag, BACnetTagHeader peekedTagHeader, BACnetClosingTag closingTag) {
      BACnetConstructedDataOctetStringValuePresentValue
          bACnetConstructedDataOctetStringValuePresentValue =
              new BACnetConstructedDataOctetStringValuePresentValue(
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataOctetStringValuePresentValue)) {
      return false;
    }
    BACnetConstructedDataOctetStringValuePresentValue that =
        (BACnetConstructedDataOctetStringValuePresentValue) o;
