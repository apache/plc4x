...
public class BACnetSecurityLevelTagged implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("BACnetSecurityLevelTagged");
  }
  ...
  public static BACnetSecurityLevelTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetSecurityLevelTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetSecurityLevelTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
                ...
                (BACnetSecurityLevel)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper
                        .readEnumGenericFailing(
                            readBuffer, header.getActualLength(), BACnetSecurityLevel.INCAPABLE)));
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetSecurityLevelTagged)) {
      return false;
    }
    BACnetSecurityLevelTagged that = (BACnetSecurityLevelTagged) o;
