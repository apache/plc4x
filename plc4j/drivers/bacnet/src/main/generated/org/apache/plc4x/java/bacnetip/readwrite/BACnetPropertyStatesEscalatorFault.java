...
public class BACnetPropertyStatesEscalatorFault extends BACnetPropertyStates implements Message {
  ...
  public BACnetPropertyStatesEscalatorFault(
      BACnetTagHeader peekedTagHeader, BACnetEscalatorFaultTagged escalatorFault) {
  ...
  public static class BACnetPropertyStatesEscalatorFaultBuilderImpl
    ...
    public BACnetPropertyStatesEscalatorFault build(BACnetTagHeader peekedTagHeader) {
      BACnetPropertyStatesEscalatorFault bACnetPropertyStatesEscalatorFault =
          new BACnetPropertyStatesEscalatorFault(peekedTagHeader, escalatorFault);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetPropertyStatesEscalatorFault)) {
      return false;
    }
    BACnetPropertyStatesEscalatorFault that = (BACnetPropertyStatesEscalatorFault) o;
    return (getEscalatorFault() == that.getEscalatorFault()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getEscalatorFault());
  }
