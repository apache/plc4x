...
public class BACnetPropertyStatesLiftFault extends BACnetPropertyStates implements Message {
  ...
  public BACnetPropertyStatesLiftFault(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetPropertyStatesBuilder staticParseBACnetPropertyStatesBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetPropertyStatesLiftFault"));
  ...
  protected void serializeBACnetPropertyStatesChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetPropertyStatesLiftFault"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: liftFault
    FieldWriterFactory.writeSimpleField((BACnetLiftFaultTagged) liftFault, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("liftFault"));
  ...
  public static class BACnetPropertyStatesBuilderImpl implements BACnetPropertyStates.BACnetPropertyStatesBuilder {
    ...
    public BACnetPropertyStatesBuilderImpl(BACnetLiftFaultTagged liftFault) {
      this.liftFault = liftFault;
    }

    public BACnetPropertyStates build(BACnetTagHeader peekedTagHeader) {
      return new BACnetPropertyStatesLiftFault(peekedTagHeader, liftFault);
    }
  }
}
