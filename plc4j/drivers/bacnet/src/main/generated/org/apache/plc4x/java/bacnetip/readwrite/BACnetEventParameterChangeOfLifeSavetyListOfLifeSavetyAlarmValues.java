...
public class BACnetEventParameterChangeOfLifeSavetyListOfLifeSavetyAlarmValues implements Message {
  ...
  public int getLengthInBits() {
    ...
    // Array field
    if (listOfLifeSavetyAlarmValues != null) {
      for (Message element : listOfLifeSavetyAlarmValues) {
  ...
  public static BACnetEventParameterChangeOfLifeSavetyListOfLifeSavetyAlarmValues staticParse(
    ...
    readBuffer.pullContext("BACnetEventParameterChangeOfLifeSavetyListOfLifeSavetyAlarmValues");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetEventParameterChangeOfLifeSavetyListOfLifeSavetyAlarmValues)) {
      return false;
    }
    BACnetEventParameterChangeOfLifeSavetyListOfLifeSavetyAlarmValues that =
        (BACnetEventParameterChangeOfLifeSavetyListOfLifeSavetyAlarmValues) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(getOpeningTag(), getListOfLifeSavetyAlarmValues(), getClosingTag());
  }
