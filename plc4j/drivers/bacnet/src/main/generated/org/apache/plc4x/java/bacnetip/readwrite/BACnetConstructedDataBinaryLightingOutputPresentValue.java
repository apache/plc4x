...
public class BACnetConstructedDataBinaryLightingOutputPresentValue extends BACnetConstructedData
    implements Message {
  ...
  public BACnetBinaryLightingPVTagged getActualValue() {
    return (BACnetBinaryLightingPVTagged) (getPresentValue());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataBinaryLightingOutputPresentValue");
  }
  ...
  public static BACnetConstructedDataBinaryLightingOutputPresentValueBuilder staticParseBuilder(
    ...
    BACnetBinaryLightingPVTagged actualValue =
        readVirtualField("actualValue", BACnetBinaryLightingPVTagged.class, presentValue);

    readBuffer.closeContext("BACnetConstructedDataBinaryLightingOutputPresentValue");
    // Create the instance
    return new BACnetConstructedDataBinaryLightingOutputPresentValueBuilder(
        presentValue, tagNumber, arrayIndexArgument);
  }

  public static class BACnetConstructedDataBinaryLightingOutputPresentValueBuilder
      implements BACnetConstructedData.BACnetConstructedDataBuilder {
    private final BACnetBinaryLightingPVTagged presentValue;
    private final Short tagNumber;
    private final BACnetTagPayloadUnsignedInteger arrayIndexArgument;

    public BACnetConstructedDataBinaryLightingOutputPresentValueBuilder(
        BACnetBinaryLightingPVTagged presentValue,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataBinaryLightingOutputPresentValue)) {
      return false;
    }
    BACnetConstructedDataBinaryLightingOutputPresentValue that =
        (BACnetConstructedDataBinaryLightingOutputPresentValue) o;
