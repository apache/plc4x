...
public class BACnetPropertyStatesMaintenance extends BACnetPropertyStates implements Message {
  ...
  public BACnetPropertyStatesMaintenance(
      BACnetTagHeader peekedTagHeader, BACnetMaintenanceTagged maintenance) {
  ...
  public static class BACnetPropertyStatesMaintenanceBuilderImpl
    ...
    public BACnetPropertyStatesMaintenance build(BACnetTagHeader peekedTagHeader) {
      BACnetPropertyStatesMaintenance bACnetPropertyStatesMaintenance =
          new BACnetPropertyStatesMaintenance(peekedTagHeader, maintenance);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetPropertyStatesMaintenance)) {
      return false;
    }
    BACnetPropertyStatesMaintenance that = (BACnetPropertyStatesMaintenance) o;
    return (getMaintenance() == that.getMaintenance()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getMaintenance());
  }
