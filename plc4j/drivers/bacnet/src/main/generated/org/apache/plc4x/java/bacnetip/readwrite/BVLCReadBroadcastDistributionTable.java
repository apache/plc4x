...
public class BVLCReadBroadcastDistributionTable extends BVLC implements Message {
  ...
  protected void serializeBVLCChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("BVLCReadBroadcastDistributionTable");

    writeBuffer.popContext("BVLCReadBroadcastDistributionTable");
  }
  ...
  public static class BVLCReadBroadcastDistributionTableBuilderImpl implements BVLC.BVLCBuilder {
    ...
    public BVLCReadBroadcastDistributionTable build() {
      BVLCReadBroadcastDistributionTable bVLCReadBroadcastDistributionTable =
          new BVLCReadBroadcastDistributionTable();
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BVLCReadBroadcastDistributionTable)) {
      return false;
    }
    BVLCReadBroadcastDistributionTable that = (BVLCReadBroadcastDistributionTable) o;
