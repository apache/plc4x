...
public class BACnetNetworkPortCommandTagged implements Message {
  ...
  public BACnetNetworkPortCommandTagged(
      BACnetTagHeader header,
      BACnetNetworkPortCommand value,
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetNetworkPortCommand.VENDOR_PROPRIETARY_VALUE));
  }
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("BACnetNetworkPortCommandTagged");
  }
  ...
  public static BACnetNetworkPortCommandTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetNetworkPortCommandTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetNetworkPortCommandTagged");
    PositionAware positionAware = readBuffer;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
            ...
            () ->
                (BACnetNetworkPortCommand)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        BACnetNetworkPortCommand.VENDOR_PROPRIETARY_VALUE)));
    ...
    readBuffer.closeContext("BACnetNetworkPortCommandTagged");
    // Create the instance
    BACnetNetworkPortCommandTagged _bACnetNetworkPortCommandTagged;
    _bACnetNetworkPortCommandTagged =
        new BACnetNetworkPortCommandTagged(header, value, proprietaryValue, tagNumber, tagClass);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetNetworkPortCommandTagged)) {
      return false;
    }
    BACnetNetworkPortCommandTagged that = (BACnetNetworkPortCommandTagged) o;
