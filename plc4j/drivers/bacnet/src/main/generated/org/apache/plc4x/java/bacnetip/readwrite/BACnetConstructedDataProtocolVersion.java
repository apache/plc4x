...
public class BACnetConstructedDataProtocolVersion extends BACnetConstructedData implements Message {
  ...
  public BACnetApplicationTagUnsignedInteger getActualValue() {
    return (BACnetApplicationTagUnsignedInteger) (getProtocolVersion());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeSimpleField(
        "protocolVersion", protocolVersion, new DataWriterComplexDefault<>(writeBuffer));

    // Virtual field (doesn't actually serialize anything, just makes the value available)
    BACnetApplicationTagUnsignedInteger actualValue = getActualValue();
    writeBuffer.writeVirtual("actualValue", actualValue);

    writeBuffer.popContext("BACnetConstructedDataProtocolVersion");
  }
  ...
  public static BACnetConstructedDataProtocolVersionBuilder staticParseBuilder(
    ...
    BACnetApplicationTagUnsignedInteger actualValue =
        readVirtualField("actualValue", BACnetApplicationTagUnsignedInteger.class, protocolVersion);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataProtocolVersion)) {
      return false;
    }
    BACnetConstructedDataProtocolVersion that = (BACnetConstructedDataProtocolVersion) o;
    return (getProtocolVersion() == that.getProtocolVersion()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getProtocolVersion());
  }
