...
public class BACnetConstructedDataWindowSamples extends BACnetConstructedData implements Message {
  ...
  public BACnetApplicationTagUnsignedInteger getActualValue() {
    return (BACnetApplicationTagUnsignedInteger) (getWindowSamples());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataWindowSamples");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataWindowSamples");
    ...
    BACnetApplicationTagUnsignedInteger actualValue =
        readVirtualField("actualValue", BACnetApplicationTagUnsignedInteger.class, windowSamples);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataWindowSamples)) {
      return false;
    }
    BACnetConstructedDataWindowSamples that = (BACnetConstructedDataWindowSamples) o;
    return (getWindowSamples() == that.getWindowSamples()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getWindowSamples());
  }
