...
public class BACnetEventTypeTagged implements Message {
  ...
  public BACnetEventTypeTagged(
      BACnetTagHeader header,
      BACnetEventType value,
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetEventType.VENDOR_PROPRIETARY_VALUE));
  }

  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    PositionAware positionAware = writeBuffer;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    writeBuffer.pushContext("BACnetEventTypeTagged");
    ...
    writeBuffer.popContext("BACnetEventTypeTagged");
  }
  ...
  public static BACnetEventTypeTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetEventTypeTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetEventTypeTagged");
    PositionAware positionAware = readBuffer;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
            ...
            () ->
                (BACnetEventType)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        BACnetEventType.VENDOR_PROPRIETARY_VALUE)));
    boolean isProprietary =
        readVirtualField(
            "isProprietary", boolean.class, (value) == (BACnetEventType.VENDOR_PROPRIETARY_VALUE));
    ...
    readBuffer.closeContext("BACnetEventTypeTagged");
    // Create the instance
    BACnetEventTypeTagged _bACnetEventTypeTagged;
    _bACnetEventTypeTagged =
        new BACnetEventTypeTagged(header, value, proprietaryValue, tagNumber, tagClass);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetEventTypeTagged)) {
      return false;
    }
    BACnetEventTypeTagged that = (BACnetEventTypeTagged) o;
