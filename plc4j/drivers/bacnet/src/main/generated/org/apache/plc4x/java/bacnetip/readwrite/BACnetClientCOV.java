 ...
 */
public abstract class BACnetClientCOV implements Message {
  protected final BACnetTagHeader peekedTagHeader;

  public BACnetClientCOV(BACnetTagHeader peekedTagHeader) {
    this.peekedTagHeader = peekedTagHeader;
  }

  protected abstract void serializeBACnetClientCOVChild(WriteBuffer writeBuffer) throws
      BufferException;
  ...
  public static BACnetClientCOV staticParse(ReadBuffer readBuffer) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("BACnetClientCOV"));
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetClientCOV"));
    ...
    // Switch Field
    serializeBACnetClientCOVChild(writeBuffer);
