...
public class BACnetApplicationTagDouble extends BACnetApplicationTag implements Message {
  ...
  protected void serializeBACnetApplicationTagChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetApplicationTagDouble");
  }
  ...
  public static class BACnetApplicationTagDoubleBuilderImpl
    ...
    public BACnetApplicationTagDouble build(BACnetTagHeader header) {
      BACnetApplicationTagDouble bACnetApplicationTagDouble =
          new BACnetApplicationTagDouble(header, payload);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetApplicationTagDouble)) {
      return false;
    }
    BACnetApplicationTagDouble that = (BACnetApplicationTagDouble) o;
