...
public class EventLog implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("EventLog");
    ...
    writeBuffer.popContext("EventLog");
  }
  ...
  public static EventLog staticParse(ReadBuffer readBuffer) throws ParseException {
    readBuffer.pullContext("EventLog");
    ...
    ReadableProperty logBuffer =
        readSimpleField(
            ...
            readComplex(
                () ->
                    ReadableProperty.staticParse(
                        readBuffer, (String) ("BACnetLIST of BACnetEventLogRecord")),
                readBuffer));
    ...
    readBuffer.closeContext("EventLog");
    // Create the instance
    EventLog _eventLog;
    _eventLog =
        new EventLog(
