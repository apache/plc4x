...
public class BACnetConstructedDataLoggingType extends BACnetConstructedData implements Message {
  ...
  public BACnetLoggingTypeTagged getActualValue() {
    return (BACnetLoggingTypeTagged) (getLoggingType());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataLoggingType");
  }
  ...
  public static BACnetConstructedDataLoggingTypeBuilder staticParseBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataLoggingType");
    ...
    BACnetLoggingTypeTagged loggingType =
        readSimpleField(
            ...
            new DataReaderComplexDefault<>(
                ...
                readBuffer));
    BACnetLoggingTypeTagged actualValue =
        readVirtualField("actualValue", BACnetLoggingTypeTagged.class, loggingType);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataLoggingType)) {
      return false;
    }
    BACnetConstructedDataLoggingType that = (BACnetConstructedDataLoggingType) o;
    return (getLoggingType() == that.getLoggingType()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getLoggingType());
  }
