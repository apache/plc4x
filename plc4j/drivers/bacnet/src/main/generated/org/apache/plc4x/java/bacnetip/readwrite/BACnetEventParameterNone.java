...
public class BACnetEventParameterNone extends BACnetEventParameter implements Message {
                ...
                () ->
                    (BACnetContextTagNull)
                        BACnetContextTag.staticParse(
                            readBuffer, (short) (20), (BACnetDataType) (BACnetDataType.NULL)),
                readBuffer));
  ...
  public static class BACnetEventParameterNoneBuilderImpl
    ...
    public BACnetEventParameterNone build(BACnetTagHeader peekedTagHeader) {
      BACnetEventParameterNone bACnetEventParameterNone =
          new BACnetEventParameterNone(peekedTagHeader, none);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetEventParameterNone)) {
      return false;
    }
    BACnetEventParameterNone that = (BACnetEventParameterNone) o;
