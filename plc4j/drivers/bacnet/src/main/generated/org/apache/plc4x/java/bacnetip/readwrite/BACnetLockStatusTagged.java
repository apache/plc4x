...
public class BACnetLockStatusTagged implements Message {
  ...
  public BACnetLockStatusTagged(
      BACnetTagHeader header, BACnetLockStatus value, Short tagNumber, TagClass tagClass) {
    super();
    this.header = header;
    this.value = value;
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("BACnetLockStatusTagged");
    ...
    writeBuffer.popContext("BACnetLockStatusTagged");
  }
  ...
  public static BACnetLockStatusTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetLockStatusTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetLockStatusTagged");
    PositionAware positionAware = readBuffer;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
                ...
                (BACnetLockStatus)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper
                        .readEnumGenericFailing(
                            readBuffer, header.getActualLength(), BACnetLockStatus.LOCKED)));

    readBuffer.closeContext("BACnetLockStatusTagged");
    // Create the instance
    BACnetLockStatusTagged _bACnetLockStatusTagged;
    _bACnetLockStatusTagged = new BACnetLockStatusTagged(header, value, tagNumber, tagClass);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetLockStatusTagged)) {
      return false;
    }
    BACnetLockStatusTagged that = (BACnetLockStatusTagged) o;
