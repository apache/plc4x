...
public class BACnetConstructedDataIsUTC extends BACnetConstructedData implements Message {
  ...
  public BACnetApplicationTagBoolean getActualValue() {
    return (BACnetApplicationTagBoolean) (getIsUtc());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataIsUTC");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataIsUTC");
    ...
    BACnetApplicationTagBoolean actualValue =
        readVirtualField("actualValue", BACnetApplicationTagBoolean.class, isUtc);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataIsUTC)) {
      return false;
    }
    BACnetConstructedDataIsUTC that = (BACnetConstructedDataIsUTC) o;
    return (getIsUtc() == that.getIsUtc()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getIsUtc());
  }
