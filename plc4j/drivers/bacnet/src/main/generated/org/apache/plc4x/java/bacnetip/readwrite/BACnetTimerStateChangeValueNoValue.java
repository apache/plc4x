...
public class BACnetTimerStateChangeValueNoValue extends BACnetTimerStateChangeValue
    implements Message {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetTimerStateChangeValueNoValue)) {
      return false;
    }
    BACnetTimerStateChangeValueNoValue that = (BACnetTimerStateChangeValueNoValue) o;
    return (getNoValue() == that.getNoValue()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getNoValue());
  }
