...
public class BACnetConstructedDataTrigger extends BACnetConstructedData implements Message {
  ...
  public BACnetApplicationTagBoolean getActualValue() {
    return (BACnetApplicationTagBoolean) (getTrigger());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataTrigger");
  }
  ...
  public static BACnetConstructedDataTriggerBuilder staticParseBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataTrigger");
    ...
    BACnetApplicationTagBoolean actualValue =
        readVirtualField("actualValue", BACnetApplicationTagBoolean.class, trigger);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataTrigger)) {
      return false;
    }
    BACnetConstructedDataTrigger that = (BACnetConstructedDataTrigger) o;
    return (getTrigger() == that.getTrigger()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getTrigger());
  }
