...
public class BACnetPropertyReferenceEnclosed implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("BACnetPropertyReferenceEnclosed");
    ...
    writeBuffer.popContext("BACnetPropertyReferenceEnclosed");
  }
  ...
  public static BACnetPropertyReferenceEnclosed staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetPropertyReferenceEnclosed staticParse(ReadBuffer readBuffer, Short tagNumber)
      throws ParseException {
    readBuffer.pullContext("BACnetPropertyReferenceEnclosed");
    PositionAware positionAware = readBuffer;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetPropertyReferenceEnclosed)) {
      return false;
    }
    BACnetPropertyReferenceEnclosed that = (BACnetPropertyReferenceEnclosed) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(getOpeningTag(), getReference(), getClosingTag());
  }
