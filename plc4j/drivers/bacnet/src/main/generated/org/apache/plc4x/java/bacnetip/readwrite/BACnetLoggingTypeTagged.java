...
public class BACnetLoggingTypeTagged implements Message {
  ...
  public BACnetLoggingTypeTagged(
      BACnetTagHeader header,
      BACnetLoggingType value,
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetLoggingType.VENDOR_PROPRIETARY_VALUE));
  }

  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    PositionAware positionAware = writeBuffer;
    int startPos = positionAware.getPos();
    writeBuffer.pushContext("BACnetLoggingTypeTagged");
    ...
    writeBuffer.popContext("BACnetLoggingTypeTagged");
  }
  ...
  public static BACnetLoggingTypeTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetLoggingTypeTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetLoggingTypeTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
            ...
            () ->
                (BACnetLoggingType)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        BACnetLoggingType.VENDOR_PROPRIETARY_VALUE)));
    ...
    readBuffer.closeContext("BACnetLoggingTypeTagged");
    // Create the instance
    BACnetLoggingTypeTagged _bACnetLoggingTypeTagged;
    _bACnetLoggingTypeTagged =
        new BACnetLoggingTypeTagged(header, value, proprietaryValue, tagNumber, tagClass);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetLoggingTypeTagged)) {
      return false;
    }
    BACnetLoggingTypeTagged that = (BACnetLoggingTypeTagged) o;
