...
public class BACnetConstructedDataWindowInterval extends BACnetConstructedData implements Message {
  ...
  public BACnetApplicationTagUnsignedInteger getActualValue() {
    return (BACnetApplicationTagUnsignedInteger) (getWindowInterval());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataWindowInterval");
  }
  ...
  public static BACnetConstructedDataWindowIntervalBuilder staticParseBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataWindowInterval");
    ...
    BACnetApplicationTagUnsignedInteger actualValue =
        readVirtualField("actualValue", BACnetApplicationTagUnsignedInteger.class, windowInterval);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataWindowInterval)) {
      return false;
    }
    BACnetConstructedDataWindowInterval that = (BACnetConstructedDataWindowInterval) o;
    return (getWindowInterval() == that.getWindowInterval()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getWindowInterval());
  }
