...
public class BACnetEscalatorModeTagged implements Message {
  ...
  public BACnetEscalatorModeTagged(
      BACnetTagHeader header,
      BACnetEscalatorMode value,
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetEscalatorMode.VENDOR_PROPRIETARY_VALUE));
  }
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("BACnetEscalatorModeTagged");
  }
  ...
  public static BACnetEscalatorModeTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetEscalatorModeTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetEscalatorModeTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
            ...
            () ->
                (BACnetEscalatorMode)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        BACnetEscalatorMode.VENDOR_PROPRIETARY_VALUE)));
    ...
    readBuffer.closeContext("BACnetEscalatorModeTagged");
    // Create the instance
    BACnetEscalatorModeTagged _bACnetEscalatorModeTagged;
    _bACnetEscalatorModeTagged =
        new BACnetEscalatorModeTagged(header, value, proprietaryValue, tagNumber, tagClass);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetEscalatorModeTagged)) {
      return false;
    }
    BACnetEscalatorModeTagged that = (BACnetEscalatorModeTagged) o;
