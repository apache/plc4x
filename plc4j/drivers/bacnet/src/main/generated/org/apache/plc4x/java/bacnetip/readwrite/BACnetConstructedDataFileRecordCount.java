...
public class BACnetConstructedDataFileRecordCount extends BACnetConstructedData implements Message {
  ...
  public BACnetConstructedDataFileRecordCount(
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataFileRecordCount");
  }
  ...
  public static BACnetConstructedDataFileRecordCountBuilder staticParseBuilder(
    ...
    readBuffer.closeContext("BACnetConstructedDataFileRecordCount");
    // Create the instance
    return new BACnetConstructedDataFileRecordCountBuilder(
        recordCount, tagNumber, arrayIndexArgument);
  }

  public static class BACnetConstructedDataFileRecordCountBuilder
      implements BACnetConstructedData.BACnetConstructedDataBuilder {
    private final BACnetApplicationTagUnsignedInteger recordCount;
    private final Short tagNumber;
    private final BACnetTagPayloadUnsignedInteger arrayIndexArgument;

    public BACnetConstructedDataFileRecordCountBuilder(
        BACnetApplicationTagUnsignedInteger recordCount,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
    ...
    public BACnetConstructedDataFileRecordCount build(
        BACnetOpeningTag openingTag,
        BACnetTagHeader peekedTagHeader,
        BACnetClosingTag closingTag,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
      BACnetConstructedDataFileRecordCount bACnetConstructedDataFileRecordCount =
          new BACnetConstructedDataFileRecordCount(
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataFileRecordCount)) {
      return false;
    }
    BACnetConstructedDataFileRecordCount that = (BACnetConstructedDataFileRecordCount) o;
