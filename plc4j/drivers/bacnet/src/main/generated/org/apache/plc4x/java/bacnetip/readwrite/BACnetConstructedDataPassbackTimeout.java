...
public class BACnetConstructedDataPassbackTimeout extends BACnetConstructedData implements Message {
  ...
  public BACnetApplicationTagUnsignedInteger getActualValue() {
    return (BACnetApplicationTagUnsignedInteger) (getPassbackTimeout());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataPassbackTimeout");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    BACnetApplicationTagUnsignedInteger actualValue =
        readVirtualField("actualValue", BACnetApplicationTagUnsignedInteger.class, passbackTimeout);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataPassbackTimeout)) {
      return false;
    }
    BACnetConstructedDataPassbackTimeout that = (BACnetConstructedDataPassbackTimeout) o;
    return (getPassbackTimeout() == that.getPassbackTimeout()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getPassbackTimeout());
  }
