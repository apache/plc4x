...
public class BACnetConstructedDataEgressTime extends BACnetConstructedData implements Message {
  ...
  public BACnetApplicationTagUnsignedInteger getActualValue() {
    return (BACnetApplicationTagUnsignedInteger) (getEgressTime());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataEgressTime");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataEgressTime");
    ...
    BACnetApplicationTagUnsignedInteger actualValue =
        readVirtualField("actualValue", BACnetApplicationTagUnsignedInteger.class, egressTime);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataEgressTime)) {
      return false;
    }
    BACnetConstructedDataEgressTime that = (BACnetConstructedDataEgressTime) o;
    return (getEgressTime() == that.getEgressTime()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getEgressTime());
  }
