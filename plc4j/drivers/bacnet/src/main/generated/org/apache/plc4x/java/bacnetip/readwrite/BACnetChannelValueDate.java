...
public class BACnetChannelValueDate extends BACnetChannelValue implements Message {
  ...
  public static class BACnetChannelValueDateBuilderImpl
    ...
    public BACnetChannelValueDate build(BACnetTagHeader peekedTagHeader) {
      BACnetChannelValueDate bACnetChannelValueDate =
          new BACnetChannelValueDate(peekedTagHeader, dateValue);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetChannelValueDate)) {
      return false;
    }
    BACnetChannelValueDate that = (BACnetChannelValueDate) o;
