...
public class BACnetTimerStateTagged implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("BACnetTimerStateTagged");
    ...
    writeBuffer.popContext("BACnetTimerStateTagged");
  }
  ...
  public static BACnetTimerStateTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetTimerStateTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetTimerStateTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
                ...
                (BACnetTimerState)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper
                        .readEnumGenericFailing(
                            readBuffer, header.getActualLength(), BACnetTimerState.IDLE)));
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetTimerStateTagged)) {
      return false;
    }
    BACnetTimerStateTagged that = (BACnetTimerStateTagged) o;
