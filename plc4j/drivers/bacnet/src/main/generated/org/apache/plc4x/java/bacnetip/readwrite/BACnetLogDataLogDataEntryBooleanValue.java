...
public class BACnetLogDataLogDataEntryBooleanValue extends BACnetLogDataLogDataEntry
    implements Message {
  ...
  public BACnetLogDataLogDataEntryBooleanValue(
      BACnetTagHeader peekedTagHeader, BACnetContextTagBoolean booleanValue) {
  ...
  protected void serializeBACnetLogDataLogDataEntryChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetLogDataLogDataEntryBooleanValue");
  }
                ...
                () ->
                    (BACnetContextTagBoolean)
                        BACnetContextTag.staticParse(
                            readBuffer, (short) (0), (BACnetDataType) (BACnetDataType.BOOLEAN)),
                readBuffer));
  ...
  public static class BACnetLogDataLogDataEntryBooleanValueBuilderImpl
    ...
    public BACnetLogDataLogDataEntryBooleanValue build(BACnetTagHeader peekedTagHeader) {
      BACnetLogDataLogDataEntryBooleanValue bACnetLogDataLogDataEntryBooleanValue =
          new BACnetLogDataLogDataEntryBooleanValue(peekedTagHeader, booleanValue);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetLogDataLogDataEntryBooleanValue)) {
      return false;
    }
    BACnetLogDataLogDataEntryBooleanValue that = (BACnetLogDataLogDataEntryBooleanValue) o;
