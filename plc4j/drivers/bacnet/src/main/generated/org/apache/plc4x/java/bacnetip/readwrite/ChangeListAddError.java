...
public class ChangeListAddError extends BACnetError implements Message {
  ...
  protected void serializeBACnetErrorChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("ChangeListAddError");
  }
  ...
  public static class ChangeListAddErrorBuilderImpl implements BACnetError.BACnetErrorBuilder {
    ...
    public ChangeListAddError build() {
      ChangeListAddError changeListAddError =
          new ChangeListAddError(errorType, firstFailedElementNumber);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ChangeListAddError)) {
      return false;
    }
    ChangeListAddError that = (ChangeListAddError) o;
