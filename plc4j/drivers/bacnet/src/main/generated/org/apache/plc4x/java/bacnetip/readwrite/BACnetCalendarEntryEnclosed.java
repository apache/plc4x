 ...
 */
public class BACnetCalendarEntryEnclosed implements Message {
  ...
  public BACnetCalendarEntryEnclosed(BACnetOpeningTag openingTag, BACnetCalendarEntry calendarEntry,
   ...
   */
  public BACnetCalendarEntry getCalendarEntry() {
  ...
  public static BACnetCalendarEntryEnclosed staticParse(ReadBuffer readBuffer, short tagNumber)
      throws BufferException {
    readBuffer.pushContext(WithOption.WithName("BACnetCalendarEntryEnclosed"));
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetCalendarEntryEnclosed"));
    ...
    // Simple Field: calendarEntry
    FieldWriterFactory.writeSimpleField((BACnetCalendarEntry) calendarEntry, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("calendarEntry"));
