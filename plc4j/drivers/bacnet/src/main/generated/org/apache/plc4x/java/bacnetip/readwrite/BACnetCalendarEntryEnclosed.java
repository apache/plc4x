...
public class BACnetCalendarEntryEnclosed implements Message {
  ...
  public static BACnetCalendarEntryEnclosed staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetCalendarEntryEnclosed)) {
      return false;
    }
    BACnetCalendarEntryEnclosed that = (BACnetCalendarEntryEnclosed) o;
    return (getOpeningTag() == that.getOpeningTag())
        && (getCalendarEntry() == that.getCalendarEntry())
  ...
  @Override
  public int hashCode() {
    return Objects.hash(getOpeningTag(), getCalendarEntry(), getClosingTag());
  }
