...
public class BACnetConstructedDataSchedulePresentValue extends BACnetConstructedData
    implements Message {
  ...
  public BACnetConstructedDataSchedulePresentValue(
  ...
  public BACnetConstructedDataElement getActualValue() {
    return (BACnetConstructedDataElement) (getPresentValue());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataSchedulePresentValue");
  }
    ...
    BACnetConstructedDataElement presentValue =
        readSimpleField(
            ...
            readComplex(
                ...
                readBuffer));
    BACnetConstructedDataElement actualValue =
        readVirtualField("actualValue", BACnetConstructedDataElement.class, presentValue);

    readBuffer.closeContext("BACnetConstructedDataSchedulePresentValue");
    // Create the instance
    return new BACnetConstructedDataSchedulePresentValueBuilderImpl(presentValue);
  }
  ...
  public static class BACnetConstructedDataSchedulePresentValueBuilderImpl
    ...
    public BACnetConstructedDataSchedulePresentValue build(
        BACnetOpeningTag openingTag, BACnetTagHeader peekedTagHeader, BACnetClosingTag closingTag) {
      BACnetConstructedDataSchedulePresentValue bACnetConstructedDataSchedulePresentValue =
          new BACnetConstructedDataSchedulePresentValue(
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataSchedulePresentValue)) {
      return false;
    }
    BACnetConstructedDataSchedulePresentValue that = (BACnetConstructedDataSchedulePresentValue) o;
