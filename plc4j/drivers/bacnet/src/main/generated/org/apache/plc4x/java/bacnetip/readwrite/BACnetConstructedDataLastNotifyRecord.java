...
public class BACnetConstructedDataLastNotifyRecord extends BACnetConstructedData
    implements Message {
  ...
  public BACnetApplicationTagUnsignedInteger getActualValue() {
    return (BACnetApplicationTagUnsignedInteger) (getLastNotifyRecord());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeSimpleField(
        "lastNotifyRecord", lastNotifyRecord, new DataWriterComplexDefault<>(writeBuffer));

    // Virtual field (doesn't actually serialize anything, just makes the value available)
    BACnetApplicationTagUnsignedInteger actualValue = getActualValue();
    writeBuffer.writeVirtual("actualValue", actualValue);

    writeBuffer.popContext("BACnetConstructedDataLastNotifyRecord");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataLastNotifyRecord");
    ...
    BACnetApplicationTagUnsignedInteger actualValue =
        readVirtualField(
            "actualValue", BACnetApplicationTagUnsignedInteger.class, lastNotifyRecord);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataLastNotifyRecord)) {
      return false;
    }
    BACnetConstructedDataLastNotifyRecord that = (BACnetConstructedDataLastNotifyRecord) o;
    return (getLastNotifyRecord() == that.getLastNotifyRecord()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getLastNotifyRecord());
  }
