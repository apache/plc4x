...
public class BACnetIPModeTagged implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("BACnetIPModeTagged");
    ...
    writeBuffer.popContext("BACnetIPModeTagged");
  }
  ...
  public static BACnetIPModeTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetIPModeTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetIPModeTagged");
    PositionAware positionAware = readBuffer;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
                ...
                (BACnetIPMode)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper
                        .readEnumGenericFailing(
                            readBuffer, header.getActualLength(), BACnetIPMode.NORMAL)));
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetIPModeTagged)) {
      return false;
    }
    BACnetIPModeTagged that = (BACnetIPModeTagged) o;
