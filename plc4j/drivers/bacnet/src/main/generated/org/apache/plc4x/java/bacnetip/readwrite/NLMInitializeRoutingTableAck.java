...
public class NLMInitializeRoutingTableAck extends NLM implements Message {
  ...
  protected void serializeNLMChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("NLMInitializeRoutingTableAck");
    ...
    writeBuffer.popContext("NLMInitializeRoutingTableAck");
  }
  ...
  public int getLengthInBits() {
    ...
    if (portMappings != null) {
      int i = 0;
      for (NLMInitializeRoutingTablePortMapping element : portMappings) {
  ...
  public static NLMBuilder staticParseNLMBuilder(ReadBuffer readBuffer, Integer apduLength)
    ...
    readBuffer.pullContext("NLMInitializeRoutingTableAck");
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof NLMInitializeRoutingTableAck)) {
      return false;
    }
    NLMInitializeRoutingTableAck that = (NLMInitializeRoutingTableAck) o;
