...
public abstract class BACnetOptionalREAL implements Message {
  ...
  protected abstract void serializeBACnetOptionalREALChild(WriteBuffer writeBuffer)
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("BACnetOptionalREAL");
  }
  ...
  public static BACnetOptionalREAL staticParse(ReadBuffer readBuffer, Object... args)
      throws ParseException {
    PositionAware positionAware = readBuffer;
    return staticParse(readBuffer);
  }

  public static BACnetOptionalREAL staticParse(ReadBuffer readBuffer) throws ParseException {
    readBuffer.pullContext("BACnetOptionalREAL");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
    ...
    readBuffer.closeContext("BACnetOptionalREAL");
    // Create the instance
    BACnetOptionalREAL _bACnetOptionalREAL = builder.build(peekedTagHeader);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetOptionalREAL)) {
      return false;
    }
    BACnetOptionalREAL that = (BACnetOptionalREAL) o;
