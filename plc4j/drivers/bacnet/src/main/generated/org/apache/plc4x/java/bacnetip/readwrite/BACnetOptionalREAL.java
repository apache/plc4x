 ...
 */
public abstract class BACnetOptionalREAL implements Message {
  protected final BACnetTagHeader peekedTagHeader;

  public BACnetOptionalREAL(BACnetTagHeader peekedTagHeader) {
    this.peekedTagHeader = peekedTagHeader;
  }

  protected abstract void serializeBACnetOptionalREALChild(WriteBuffer writeBuffer) throws
      BufferException;
  ...
  public static BACnetOptionalREAL staticParse(ReadBuffer readBuffer) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("BACnetOptionalREAL"));
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetOptionalREAL"));
    ...
    // Switch Field
    serializeBACnetOptionalREALChild(writeBuffer);
