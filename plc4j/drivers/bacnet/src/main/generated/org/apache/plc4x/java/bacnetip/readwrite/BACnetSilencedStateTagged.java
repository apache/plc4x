...
public class BACnetSilencedStateTagged implements Message {
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetSilencedState.VENDOR_PROPRIETARY_VALUE));
  }

  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    PositionAware positionAware = writeBuffer;
    int startPos = positionAware.getPos();
    writeBuffer.pushContext("BACnetSilencedStateTagged");
    ...
    writeBuffer.popContext("BACnetSilencedStateTagged");
  }
  ...
  public static BACnetSilencedStateTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetSilencedStateTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetSilencedStateTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
            ...
            () ->
                (BACnetSilencedState)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        BACnetSilencedState.VENDOR_PROPRIETARY_VALUE)));
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetSilencedStateTagged)) {
      return false;
    }
    BACnetSilencedStateTagged that = (BACnetSilencedStateTagged) o;
