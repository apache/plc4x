...
public class BACnetDoorAlarmStateTagged implements Message {
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetDoorAlarmState.VENDOR_PROPRIETARY_VALUE));
  }

  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    PositionAware positionAware = writeBuffer;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    writeBuffer.pushContext("BACnetDoorAlarmStateTagged");
    ...
    writeBuffer.popContext("BACnetDoorAlarmStateTagged");
  }
  ...
  public static BACnetDoorAlarmStateTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetDoorAlarmStateTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetDoorAlarmStateTagged");
    PositionAware positionAware = readBuffer;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
            ...
            () ->
                (BACnetDoorAlarmState)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        BACnetDoorAlarmState.VENDOR_PROPRIETARY_VALUE)));
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetDoorAlarmStateTagged)) {
      return false;
    }
    BACnetDoorAlarmStateTagged that = (BACnetDoorAlarmStateTagged) o;
