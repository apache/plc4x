...
public class BACnetPropertyStatesLifeSafetyMode extends BACnetPropertyStates implements Message {
  ...
  public BACnetPropertyStatesLifeSafetyMode(
      BACnetTagHeader peekedTagHeader, BACnetLifeSafetyModeTagged lifeSafetyMode) {
  ...
  public static class BACnetPropertyStatesLifeSafetyModeBuilderImpl
    ...
    public BACnetPropertyStatesLifeSafetyMode build(BACnetTagHeader peekedTagHeader) {
      BACnetPropertyStatesLifeSafetyMode bACnetPropertyStatesLifeSafetyMode =
          new BACnetPropertyStatesLifeSafetyMode(peekedTagHeader, lifeSafetyMode);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetPropertyStatesLifeSafetyMode)) {
      return false;
    }
    BACnetPropertyStatesLifeSafetyMode that = (BACnetPropertyStatesLifeSafetyMode) o;
    return (getLifeSafetyMode() == that.getLifeSafetyMode()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getLifeSafetyMode());
  }
