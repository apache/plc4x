...
public class BACnetConstructedDataGroupMemberNames extends BACnetConstructedData
    implements Message {
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataGroupMemberNames");
  }
  ...
  public int getLengthInBits() {
    ...
    if (groupMemberNames != null) {
      for (Message element : groupMemberNames) {
  ...
  public static BACnetConstructedDataGroupMemberNamesBuilder staticParseBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataGroupMemberNames");
    ...
    // Create the instance
    return new BACnetConstructedDataGroupMemberNamesBuilder(
        numberOfDataElements, groupMemberNames, tagNumber, arrayIndexArgument);
  }

  public static class BACnetConstructedDataGroupMemberNamesBuilder
    ...
    public BACnetConstructedDataGroupMemberNamesBuilder(
        BACnetApplicationTagUnsignedInteger numberOfDataElements,
        List<BACnetApplicationTagCharacterString> groupMemberNames,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataGroupMemberNames)) {
      return false;
    }
    BACnetConstructedDataGroupMemberNames that = (BACnetConstructedDataGroupMemberNames) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getNumberOfDataElements(), getGroupMemberNames());
  }
