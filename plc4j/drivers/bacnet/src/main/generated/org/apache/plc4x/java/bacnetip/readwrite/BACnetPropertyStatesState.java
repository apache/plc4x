...
public class BACnetPropertyStatesState extends BACnetPropertyStates implements Message {
  ...
  protected void serializeBACnetPropertyStatesChild(WriteBuffer writeBuffer)
    ...
    // Simple Field (state)
    writeSimpleField("state", state, new DataWriterComplexDefault<>(writeBuffer));

    writeBuffer.popContext("BACnetPropertyStatesState");
  }
  ...
  public static class BACnetPropertyStatesStateBuilder
    ...
    public BACnetPropertyStatesState build(BACnetTagHeader peekedTagHeader) {
      BACnetPropertyStatesState bACnetPropertyStatesState =
          new BACnetPropertyStatesState(peekedTagHeader, state);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetPropertyStatesState)) {
      return false;
    }
    BACnetPropertyStatesState that = (BACnetPropertyStatesState) o;
