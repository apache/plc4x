...
public class BACnetLightingInProgressTagged implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("BACnetLightingInProgressTagged");
    ...
    writeBuffer.popContext("BACnetLightingInProgressTagged");
  }
  ...
  public static BACnetLightingInProgressTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetLightingInProgressTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetLightingInProgressTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    ...
    BACnetLightingInProgress value =
        readManualField(
            "value",
            readBuffer,
            () ->
                (BACnetLightingInProgress)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper
                        .readEnumGenericFailing(
                            readBuffer, header.getActualLength(), BACnetLightingInProgress.IDLE)));
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetLightingInProgressTagged)) {
      return false;
    }
    BACnetLightingInProgressTagged that = (BACnetLightingInProgressTagged) o;
