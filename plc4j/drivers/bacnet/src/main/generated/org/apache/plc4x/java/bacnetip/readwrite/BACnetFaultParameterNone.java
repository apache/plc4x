...
public class BACnetFaultParameterNone extends BACnetFaultParameter implements Message {
  ...
  public BACnetFaultParameterNone(BACnetTagHeader peekedTagHeader, BACnetContextTagNull none) {
  ...
  protected void serializeBACnetFaultParameterChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetFaultParameterNone");
  }
  ...
  public static class BACnetFaultParameterNoneBuilderImpl
    ...
    public BACnetFaultParameterNone build(BACnetTagHeader peekedTagHeader) {
      BACnetFaultParameterNone bACnetFaultParameterNone =
          new BACnetFaultParameterNone(peekedTagHeader, none);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetFaultParameterNone)) {
      return false;
    }
    BACnetFaultParameterNone that = (BACnetFaultParameterNone) o;
