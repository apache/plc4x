...
public class BACnetConstructedDataAccessDoors extends BACnetConstructedData implements Message {
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataAccessDoors");
  }
  ...
  public int getLengthInBits() {
    ...
    // Array field
    if (accessDoors != null) {
      for (Message element : accessDoors) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataAccessDoors)) {
      return false;
    }
    BACnetConstructedDataAccessDoors that = (BACnetConstructedDataAccessDoors) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getNumberOfDataElements(), getAccessDoors());
  }
