...
public abstract class BACnetOptionalCharacterString implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("BACnetOptionalCharacterString");
  }
  ...
  public static BACnetOptionalCharacterString staticParse(ReadBuffer readBuffer)
    ...
    readBuffer.closeContext("BACnetOptionalCharacterString");
    // Create the instance
    BACnetOptionalCharacterString _bACnetOptionalCharacterString = builder.build(peekedTagHeader);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetOptionalCharacterString)) {
      return false;
    }
    BACnetOptionalCharacterString that = (BACnetOptionalCharacterString) o;
