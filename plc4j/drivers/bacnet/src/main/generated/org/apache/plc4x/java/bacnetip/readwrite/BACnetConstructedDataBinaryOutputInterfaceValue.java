...
public class BACnetConstructedDataBinaryOutputInterfaceValue extends BACnetConstructedData
    implements Message {
  ...
  public BACnetConstructedDataBinaryOutputInterfaceValue(
  ...
  public BACnetOptionalBinaryPV getActualValue() {
    return (BACnetOptionalBinaryPV) (getInterfaceValue());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataBinaryOutputInterfaceValue");
  }
  ...
  public static BACnetConstructedDataBinaryOutputInterfaceValueBuilder staticParseBuilder(
    ...
    readBuffer.closeContext("BACnetConstructedDataBinaryOutputInterfaceValue");
    // Create the instance
    return new BACnetConstructedDataBinaryOutputInterfaceValueBuilder(
        interfaceValue, tagNumber, arrayIndexArgument);
  }

  public static class BACnetConstructedDataBinaryOutputInterfaceValueBuilder
      implements BACnetConstructedData.BACnetConstructedDataBuilder {
    private final BACnetOptionalBinaryPV interfaceValue;
    private final Short tagNumber;
    private final BACnetTagPayloadUnsignedInteger arrayIndexArgument;

    public BACnetConstructedDataBinaryOutputInterfaceValueBuilder(
        BACnetOptionalBinaryPV interfaceValue,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
    ...
    public BACnetConstructedDataBinaryOutputInterfaceValue build(
        BACnetOpeningTag openingTag,
        BACnetTagHeader peekedTagHeader,
        BACnetClosingTag closingTag,
        Short tagNumber,
      ...
      BACnetConstructedDataBinaryOutputInterfaceValue
          bACnetConstructedDataBinaryOutputInterfaceValue =
              new BACnetConstructedDataBinaryOutputInterfaceValue(
                  openingTag,
                  peekedTagHeader,
                  closingTag,
                  interfaceValue,
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataBinaryOutputInterfaceValue)) {
      return false;
    }
    BACnetConstructedDataBinaryOutputInterfaceValue that =
        (BACnetConstructedDataBinaryOutputInterfaceValue) o;
