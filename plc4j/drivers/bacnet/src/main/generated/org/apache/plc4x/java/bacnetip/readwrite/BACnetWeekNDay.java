...
public class BACnetWeekNDay implements Message {
  ...
  public static BACnetWeekNDay staticParse(ReadBuffer readBuffer) throws ParseException {
    ...
    if (!((1) == (2))) {
      throw new ParseValidationException(
          "Unusable type. Exits only for consistency. Use BACnetWeekNDayTagged");
    }

    readBuffer.closeContext("BACnetWeekNDay");
    // Create the instance
    BACnetWeekNDay _bACnetWeekNDay;
    _bACnetWeekNDay = new BACnetWeekNDay();
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetWeekNDay)) {
      return false;
    }
    BACnetWeekNDay that = (BACnetWeekNDay) o;
    return true;
  }
