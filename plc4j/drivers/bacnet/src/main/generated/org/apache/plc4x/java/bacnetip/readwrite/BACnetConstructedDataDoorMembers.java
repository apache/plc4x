...
public class BACnetConstructedDataDoorMembers extends BACnetConstructedData implements Message {
  ...
  public BACnetConstructedDataDoorMembers(
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeComplexTypeArrayField("doorMembers", doorMembers, writeBuffer);

    writeBuffer.popContext("BACnetConstructedDataDoorMembers");
  }
  ...
  public int getLengthInBits() {
    ...
    // Array field
    if (doorMembers != null) {
      for (Message element : doorMembers) {
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataDoorMembers");
    ...
    // Create the instance
    return new BACnetConstructedDataDoorMembersBuilderImpl(numberOfDataElements, doorMembers);
  }
  ...
  public static class BACnetConstructedDataDoorMembersBuilderImpl
    ...
    public BACnetConstructedDataDoorMembers build(
        BACnetOpeningTag openingTag, BACnetTagHeader peekedTagHeader, BACnetClosingTag closingTag) {
      BACnetConstructedDataDoorMembers bACnetConstructedDataDoorMembers =
          new BACnetConstructedDataDoorMembers(
              openingTag, peekedTagHeader, closingTag, numberOfDataElements, doorMembers);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataDoorMembers)) {
      return false;
    }
    BACnetConstructedDataDoorMembers that = (BACnetConstructedDataDoorMembers) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getNumberOfDataElements(), getDoorMembers());
  }
