...
public class BACnetConstructedDataAccumulatorFaultLowLimit extends BACnetConstructedData
    implements Message {
  ...
  public BACnetConstructedDataAccumulatorFaultLowLimit(
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataAccumulatorFaultLowLimit");
  }
  ...
  public static BACnetConstructedDataAccumulatorFaultLowLimitBuilder staticParseBuilder(
    ...
    readBuffer.closeContext("BACnetConstructedDataAccumulatorFaultLowLimit");
    // Create the instance
    return new BACnetConstructedDataAccumulatorFaultLowLimitBuilder(
        faultLowLimit, tagNumber, arrayIndexArgument);
  }

  public static class BACnetConstructedDataAccumulatorFaultLowLimitBuilder
      implements BACnetConstructedData.BACnetConstructedDataBuilder {
    private final BACnetApplicationTagUnsignedInteger faultLowLimit;
    private final Short tagNumber;
    private final BACnetTagPayloadUnsignedInteger arrayIndexArgument;

    public BACnetConstructedDataAccumulatorFaultLowLimitBuilder(
        BACnetApplicationTagUnsignedInteger faultLowLimit,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
    ...
    public BACnetConstructedDataAccumulatorFaultLowLimit build(
        BACnetOpeningTag openingTag,
        BACnetTagHeader peekedTagHeader,
        BACnetClosingTag closingTag,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
      BACnetConstructedDataAccumulatorFaultLowLimit bACnetConstructedDataAccumulatorFaultLowLimit =
          new BACnetConstructedDataAccumulatorFaultLowLimit(
              openingTag,
              peekedTagHeader,
              closingTag,
              faultLowLimit,
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataAccumulatorFaultLowLimit)) {
      return false;
    }
    BACnetConstructedDataAccumulatorFaultLowLimit that =
        (BACnetConstructedDataAccumulatorFaultLowLimit) o;
