...
public class BACnetEventStateTagged implements Message {
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetEventState.VENDOR_PROPRIETARY_VALUE));
  }

  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    PositionAware positionAware = writeBuffer;
    int startPos = positionAware.getPos();
    writeBuffer.pushContext("BACnetEventStateTagged");
    ...
    writeBuffer.popContext("BACnetEventStateTagged");
  }
  ...
  public static BACnetEventStateTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetEventStateTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetEventStateTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
            ...
            () ->
                (BACnetEventState)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        BACnetEventState.VENDOR_PROPRIETARY_VALUE)));
    boolean isProprietary =
        readVirtualField(
            "isProprietary", boolean.class, (value) == (BACnetEventState.VENDOR_PROPRIETARY_VALUE));
    ...
    readBuffer.closeContext("BACnetEventStateTagged");
    // Create the instance
    BACnetEventStateTagged _bACnetEventStateTagged;
    _bACnetEventStateTagged =
        new BACnetEventStateTagged(header, value, proprietaryValue, tagNumber, tagClass);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetEventStateTagged)) {
      return false;
    }
    BACnetEventStateTagged that = (BACnetEventStateTagged) o;
