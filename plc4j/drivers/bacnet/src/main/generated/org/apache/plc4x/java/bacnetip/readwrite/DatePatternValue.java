...
public class DatePatternValue implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("DatePatternValue");
    ...
    writeBuffer.popContext("DatePatternValue");
  }
  ...
  public static DatePatternValue staticParse(ReadBuffer readBuffer) throws ParseException {
    readBuffer.pullContext("DatePatternValue");
    ...
    readBuffer.closeContext("DatePatternValue");
    // Create the instance
    DatePatternValue _datePatternValue;
    _datePatternValue =
        new DatePatternValue(
            objectIdentifier,
            objectName,
            objectType,
            description,
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof DatePatternValue)) {
      return false;
    }
    DatePatternValue that = (DatePatternValue) o;
