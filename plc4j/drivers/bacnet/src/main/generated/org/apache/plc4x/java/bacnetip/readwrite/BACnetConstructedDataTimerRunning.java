...
public class BACnetConstructedDataTimerRunning extends BACnetConstructedData implements Message {
  ...
  public BACnetApplicationTagBoolean getActualValue() {
    return (BACnetApplicationTagBoolean) (getTimerRunning());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataTimerRunning");
  }
  ...
  public static BACnetConstructedDataTimerRunningBuilder staticParseBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataTimerRunning");
    ...
    BACnetApplicationTagBoolean actualValue =
        readVirtualField("actualValue", BACnetApplicationTagBoolean.class, timerRunning);

    readBuffer.closeContext("BACnetConstructedDataTimerRunning");
    // Create the instance
    return new BACnetConstructedDataTimerRunningBuilder(
        timerRunning, tagNumber, arrayIndexArgument);
  }

  public static class BACnetConstructedDataTimerRunningBuilder
      implements BACnetConstructedData.BACnetConstructedDataBuilder {
    private final BACnetApplicationTagBoolean timerRunning;
    private final Short tagNumber;
    private final BACnetTagPayloadUnsignedInteger arrayIndexArgument;

    public BACnetConstructedDataTimerRunningBuilder(
        BACnetApplicationTagBoolean timerRunning,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataTimerRunning)) {
      return false;
    }
    BACnetConstructedDataTimerRunning that = (BACnetConstructedDataTimerRunning) o;
    return (getTimerRunning() == that.getTimerRunning()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getTimerRunning());
  }
