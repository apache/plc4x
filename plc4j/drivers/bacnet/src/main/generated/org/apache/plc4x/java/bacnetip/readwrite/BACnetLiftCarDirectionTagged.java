...
public class BACnetLiftCarDirectionTagged implements Message {
  ...
  public BACnetLiftCarDirectionTagged(
      BACnetTagHeader header,
      BACnetLiftCarDirection value,
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetLiftCarDirection.VENDOR_PROPRIETARY_VALUE));
  }

  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    PositionAware positionAware = writeBuffer;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    writeBuffer.pushContext("BACnetLiftCarDirectionTagged");
    ...
    writeBuffer.popContext("BACnetLiftCarDirectionTagged");
  }
  ...
  public static BACnetLiftCarDirectionTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetLiftCarDirectionTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetLiftCarDirectionTagged");
    PositionAware positionAware = readBuffer;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
            ...
            () ->
                (BACnetLiftCarDirection)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        BACnetLiftCarDirection.VENDOR_PROPRIETARY_VALUE)));
    ...
    readBuffer.closeContext("BACnetLiftCarDirectionTagged");
    // Create the instance
    BACnetLiftCarDirectionTagged _bACnetLiftCarDirectionTagged;
    _bACnetLiftCarDirectionTagged =
        new BACnetLiftCarDirectionTagged(header, value, proprietaryValue, tagNumber, tagClass);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetLiftCarDirectionTagged)) {
      return false;
    }
    BACnetLiftCarDirectionTagged that = (BACnetLiftCarDirectionTagged) o;
