...
public class BACnetPriorityValueCharacterString extends BACnetPriorityValue implements Message {
  ...
  public BACnetPriorityValueCharacterString(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetPriorityValueBuilder staticParseBACnetPriorityValueBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetPriorityValueCharacterString"));
    ...
    return new BACnetPriorityValueBuilderImpl(characterStringValue);
  }

  protected void serializeBACnetPriorityValueChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetPriorityValueCharacterString"));
  ...
  public static class BACnetPriorityValueBuilderImpl implements BACnetPriorityValue.BACnetPriorityValueBuilder {
    ...
    public BACnetPriorityValueBuilderImpl(
        BACnetApplicationTagCharacterString characterStringValue) {
      this.characterStringValue = characterStringValue;
    }

    public BACnetPriorityValue build(BACnetTagHeader peekedTagHeader) {
      return new BACnetPriorityValueCharacterString(peekedTagHeader, characterStringValue);
    }
  }
}
