...
public abstract class BACnetTimeStamp implements Message {
  ...
  protected abstract void serializeBACnetTimeStampChild(WriteBuffer writeBuffer)
      throws SerializationException;

  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    PositionAware positionAware = writeBuffer;
    int startPos = positionAware.getPos();
    writeBuffer.pushContext("BACnetTimeStamp");
    ...
    writeBuffer.popContext("BACnetTimeStamp");
  }
  ...
  public static BACnetTimeStamp staticParse(ReadBuffer readBuffer, Object... args)
      throws ParseException {
    PositionAware positionAware = readBuffer;
    return staticParse(readBuffer);
  }

  public static BACnetTimeStamp staticParse(ReadBuffer readBuffer) throws ParseException {
    readBuffer.pullContext("BACnetTimeStamp");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
    ...
    readBuffer.closeContext("BACnetTimeStamp");
    // Create the instance
    BACnetTimeStamp _bACnetTimeStamp = builder.build(peekedTagHeader);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetTimeStamp)) {
      return false;
    }
    BACnetTimeStamp that = (BACnetTimeStamp) o;
