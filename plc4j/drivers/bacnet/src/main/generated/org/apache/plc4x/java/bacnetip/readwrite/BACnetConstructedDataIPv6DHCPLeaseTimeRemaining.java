...
public class BACnetConstructedDataIPv6DHCPLeaseTimeRemaining extends BACnetConstructedData
    implements Message {
  ...
  public BACnetApplicationTagUnsignedInteger getActualValue() {
    return (BACnetApplicationTagUnsignedInteger) (getIpv6DhcpLeaseTimeRemaining());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataIPv6DHCPLeaseTimeRemaining");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    BACnetApplicationTagUnsignedInteger actualValue =
        readVirtualField(
            "actualValue", BACnetApplicationTagUnsignedInteger.class, ipv6DhcpLeaseTimeRemaining);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataIPv6DHCPLeaseTimeRemaining)) {
      return false;
    }
    BACnetConstructedDataIPv6DHCPLeaseTimeRemaining that =
        (BACnetConstructedDataIPv6DHCPLeaseTimeRemaining) o;
    return (getIpv6DhcpLeaseTimeRemaining() == that.getIpv6DhcpLeaseTimeRemaining())
        && super.equals(that)
        && true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getIpv6DhcpLeaseTimeRemaining());
  }
