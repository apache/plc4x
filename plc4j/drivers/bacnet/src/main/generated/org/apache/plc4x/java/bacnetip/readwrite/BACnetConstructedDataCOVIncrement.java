...
public class BACnetConstructedDataCOVIncrement extends BACnetConstructedData implements Message {
  ...
  public BACnetConstructedDataCOVIncrement(
  ...
  public BACnetApplicationTagReal getActualValue() {
    return (BACnetApplicationTagReal) (getCovIncrement());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataCOVIncrement");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    BACnetApplicationTagReal actualValue =
        readVirtualField("actualValue", BACnetApplicationTagReal.class, covIncrement);

    readBuffer.closeContext("BACnetConstructedDataCOVIncrement");
    // Create the instance
    return new BACnetConstructedDataCOVIncrementBuilderImpl(covIncrement);
  }
  ...
  public static class BACnetConstructedDataCOVIncrementBuilderImpl
    ...
    public BACnetConstructedDataCOVIncrementBuilderImpl(BACnetApplicationTagReal covIncrement) {
      this.covIncrement = covIncrement;
    }

    public BACnetConstructedDataCOVIncrement build(
        BACnetOpeningTag openingTag, BACnetTagHeader peekedTagHeader, BACnetClosingTag closingTag) {
      BACnetConstructedDataCOVIncrement bACnetConstructedDataCOVIncrement =
          new BACnetConstructedDataCOVIncrement(
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataCOVIncrement)) {
      return false;
    }
    BACnetConstructedDataCOVIncrement that = (BACnetConstructedDataCOVIncrement) o;
