...
public enum MaxApduLengthAccepted {
  ...
  public static MaxApduLengthAccepted firstEnumForFieldNumberOfOctets(int numberOfOctets) {
    for (MaxApduLengthAccepted _val : MaxApduLengthAccepted.values()) {
      if (_val.getNumberOfOctets() == numberOfOctets) {
        return _val;
      }
    }
    return null;
  ...
  public static List<MaxApduLengthAccepted> enumsForFieldNumberOfOctets(int numberOfOctets) {
