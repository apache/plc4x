...
public class BACnetNotificationParametersExtended extends BACnetNotificationParameters implements Message {
  ...
  public static BACnetNotificationParametersBuilder staticParseBACnetNotificationParametersBuilder(
    ...
    BACnetNotificationParametersExtendedParameters parameters = FieldReaderFactory.readSimpleField(DataReaderFactory.readComplex(() -> DataReaderFactory.castToDeclaredType(BACnetNotificationParametersExtendedParameters.class, BACnetNotificationParametersExtendedParameters.staticParse(readBuffer, (short) (2))), readBuffer), WithOption.WithName("parameters"));
