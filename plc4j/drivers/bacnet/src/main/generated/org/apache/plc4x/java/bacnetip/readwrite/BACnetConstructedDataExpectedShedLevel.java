...
public class BACnetConstructedDataExpectedShedLevel extends BACnetConstructedData
    implements Message {
  ...
  public BACnetShedLevel getActualValue() {
    return (BACnetShedLevel) (getExpectedShedLevel());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeSimpleField(
        "expectedShedLevel", expectedShedLevel, new DataWriterComplexDefault<>(writeBuffer));

    // Virtual field (doesn't actually serialize anything, just makes the value available)
    BACnetShedLevel actualValue = getActualValue();
    writeBuffer.writeVirtual("actualValue", actualValue);

    writeBuffer.popContext("BACnetConstructedDataExpectedShedLevel");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    BACnetShedLevel actualValue =
        readVirtualField("actualValue", BACnetShedLevel.class, expectedShedLevel);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataExpectedShedLevel)) {
      return false;
    }
    BACnetConstructedDataExpectedShedLevel that = (BACnetConstructedDataExpectedShedLevel) o;
    return (getExpectedShedLevel() == that.getExpectedShedLevel()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getExpectedShedLevel());
  }
