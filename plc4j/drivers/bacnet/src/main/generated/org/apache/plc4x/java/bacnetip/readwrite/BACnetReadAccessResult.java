...
public class BACnetReadAccessResult implements Message {
  ...
  public static BACnetReadAccessResult staticParse(ReadBuffer readBuffer) throws ParseException {
    ...
    readBuffer.closeContext("BACnetReadAccessResult");
    // Create the instance
    BACnetReadAccessResult _bACnetReadAccessResult;
    _bACnetReadAccessResult = new BACnetReadAccessResult(objectIdentifier, listOfResults);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetReadAccessResult)) {
      return false;
    }
    BACnetReadAccessResult that = (BACnetReadAccessResult) o;
    return (getObjectIdentifier() == that.getObjectIdentifier())
        && (getListOfResults() == that.getListOfResults())
        && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(getObjectIdentifier(), getListOfResults());
  }
