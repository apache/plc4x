 ...
 */
public class BACnetTimerStateChangeValueObjectidentifier extends BACnetTimerStateChangeValue implements Message {
  protected final BACnetApplicationTagObjectIdentifier objectidentifierValue;

  public BACnetTimerStateChangeValueObjectidentifier(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetTimerStateChangeValueBuilder staticParseBACnetTimerStateChangeValueBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetTimerStateChangeValueObjectidentifier"));
  ...
  protected void serializeBACnetTimerStateChangeValueChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetTimerStateChangeValueObjectidentifier"));
  ...
  public static class BACnetTimerStateChangeValueBuilderImpl implements BACnetTimerStateChangeValue.BACnetTimerStateChangeValueBuilder {
    ...
    public BACnetTimerStateChangeValue build(BACnetTagHeader peekedTagHeader) {
      return new BACnetTimerStateChangeValueObjectidentifier(peekedTagHeader, objectidentifierValue);
    }
  }
}
