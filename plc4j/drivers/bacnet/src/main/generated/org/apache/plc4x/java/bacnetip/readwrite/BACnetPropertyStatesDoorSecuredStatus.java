...
public class BACnetPropertyStatesDoorSecuredStatus extends BACnetPropertyStates implements Message {
  ...
  public BACnetPropertyStatesDoorSecuredStatus(
      BACnetTagHeader peekedTagHeader, BACnetDoorSecuredStatusTagged doorSecuredStatus) {
  ...
  public static class BACnetPropertyStatesDoorSecuredStatusBuilderImpl
    ...
    public BACnetPropertyStatesDoorSecuredStatus build(BACnetTagHeader peekedTagHeader) {
      BACnetPropertyStatesDoorSecuredStatus bACnetPropertyStatesDoorSecuredStatus =
          new BACnetPropertyStatesDoorSecuredStatus(peekedTagHeader, doorSecuredStatus);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetPropertyStatesDoorSecuredStatus)) {
      return false;
    }
    BACnetPropertyStatesDoorSecuredStatus that = (BACnetPropertyStatesDoorSecuredStatus) o;
    return (getDoorSecuredStatus() == that.getDoorSecuredStatus()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getDoorSecuredStatus());
  }
