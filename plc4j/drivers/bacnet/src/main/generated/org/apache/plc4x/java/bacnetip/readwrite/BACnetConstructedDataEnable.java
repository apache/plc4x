...
public class BACnetConstructedDataEnable extends BACnetConstructedData implements Message {
  ...
  public BACnetApplicationTagBoolean getActualValue() {
    return (BACnetApplicationTagBoolean) (getEnable());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataEnable");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    BACnetApplicationTagBoolean actualValue =
        readVirtualField("actualValue", BACnetApplicationTagBoolean.class, enable);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataEnable)) {
      return false;
    }
    BACnetConstructedDataEnable that = (BACnetConstructedDataEnable) o;
    return (getEnable() == that.getEnable()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getEnable());
  }
