...
public class BACnetConstructedDataInProcess extends BACnetConstructedData implements Message {
  ...
  public BACnetApplicationTagBoolean getActualValue() {
    return (BACnetApplicationTagBoolean) (getInProcess());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataInProcess");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataInProcess");
    ...
    BACnetApplicationTagBoolean actualValue =
        readVirtualField("actualValue", BACnetApplicationTagBoolean.class, inProcess);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataInProcess)) {
      return false;
    }
    BACnetConstructedDataInProcess that = (BACnetConstructedDataInProcess) o;
    return (getInProcess() == that.getInProcess()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getInProcess());
  }
