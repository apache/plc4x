...
public class LifeSafetyZone implements Message {
  ...
  protected final ReadableProperty zoneMembers;
  ...
  public ReadableProperty getZoneMembers() {
    return zoneMembers;
  }
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("LifeSafetyZone");
    ...
    writeSimpleField("zoneMembers", zoneMembers, writeComplex(writeBuffer));
    ...
    writeBuffer.popContext("LifeSafetyZone");
  }
  ...
  public int getLengthInBits() {
    ...
    // Simple field (zoneMembers)
    lengthInBits += zoneMembers.getLengthInBits();
  ...
  public static LifeSafetyZone staticParse(ReadBuffer readBuffer) throws ParseException {
    readBuffer.pullContext("LifeSafetyZone");
    ...
    readBuffer.closeContext("LifeSafetyZone");
    // Create the instance
    LifeSafetyZone _lifeSafetyZone;
    _lifeSafetyZone =
        new LifeSafetyZone(
            objectIdentifier,
            objectName,
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof LifeSafetyZone)) {
      return false;
    }
    LifeSafetyZone that = (LifeSafetyZone) o;
    return (getObjectIdentifier() == that.getObjectIdentifier())
        ...
        && (getZoneMembers() == that.getZoneMembers())
