...
public class BACnetConstructedDataSubordinateTags extends BACnetConstructedData implements Message {
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.pushContext("BACnetConstructedDataSubordinateTags");
    ...
    writeBuffer.popContext("BACnetConstructedDataSubordinateTags");
  }
  ...
  public int getLengthInBits() {
    ...
    if (subordinateList != null) {
      for (Message element : subordinateList) {
  ...
  public static BACnetConstructedDataSubordinateTagsBuilder staticParseBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataSubordinateTags");
    ...
    List<BACnetNameValueCollection> subordinateList =
        readTerminatedArrayField(
            "subordinateList",
            new DataReaderComplexDefault<>(
                () -> BACnetNameValueCollection.staticParse(readBuffer, (short) (0)), readBuffer),
            () ->
                ((boolean)
    ...
    // Create the instance
    return new BACnetConstructedDataSubordinateTagsBuilder(
        numberOfDataElements, subordinateList, tagNumber, arrayIndexArgument);
  }

  public static class BACnetConstructedDataSubordinateTagsBuilder
    ...
    public BACnetConstructedDataSubordinateTagsBuilder(
        BACnetApplicationTagUnsignedInteger numberOfDataElements,
        List<BACnetNameValueCollection> subordinateList,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataSubordinateTags)) {
      return false;
    }
    BACnetConstructedDataSubordinateTags that = (BACnetConstructedDataSubordinateTags) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getNumberOfDataElements(), getSubordinateList());
  }
