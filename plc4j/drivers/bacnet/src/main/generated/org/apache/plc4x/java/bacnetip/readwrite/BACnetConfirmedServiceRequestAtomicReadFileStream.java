...
public class BACnetConfirmedServiceRequestAtomicReadFileStream
  ...
  public BACnetConfirmedServiceRequestAtomicReadFileStream(
  ...
  public static class BACnetConfirmedServiceRequestAtomicReadFileStreamBuilderImpl
    ...
    public BACnetConfirmedServiceRequestAtomicReadFileStream build(
      ...
      BACnetConfirmedServiceRequestAtomicReadFileStream
          bACnetConfirmedServiceRequestAtomicReadFileStream =
              new BACnetConfirmedServiceRequestAtomicReadFileStream(
                  peekedTagHeader, openingTag, closingTag, fileStartPosition, requestOctetCount);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConfirmedServiceRequestAtomicReadFileStream)) {
      return false;
    }
    BACnetConfirmedServiceRequestAtomicReadFileStream that =
        (BACnetConfirmedServiceRequestAtomicReadFileStream) o;
    return (getFileStartPosition() == that.getFileStartPosition())
        && (getRequestOctetCount() == that.getRequestOctetCount())
        && super.equals(that)
        && true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getFileStartPosition(), getRequestOctetCount());
  }
