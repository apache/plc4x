...
public class BACnetPropertyStatesLightningTransition extends BACnetPropertyStates implements Message {
  ...
  public BACnetPropertyStatesLightningTransition(BACnetTagHeader peekedTagHeader,
  ...
  /**
   * Property field lightningTransition
   */
  public BACnetLightingTransitionTagged getLightningTransition() {
    return lightningTransition;
  }

  public static BACnetPropertyStatesBuilder staticParseBACnetPropertyStatesBuilder(
      ReadBuffer readBuffer, short peekedTagNumber) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("BACnetPropertyStatesLightningTransition"));
  ...
  protected void serializeBACnetPropertyStatesChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetPropertyStatesLightningTransition"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: lightningTransition
    FieldWriterFactory.writeSimpleField((BACnetLightingTransitionTagged) lightningTransition, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("lightningTransition"));
  ...
  public static class BACnetPropertyStatesBuilderImpl implements BACnetPropertyStates.BACnetPropertyStatesBuilder {
    ...
    public BACnetPropertyStatesBuilderImpl(BACnetLightingTransitionTagged lightningTransition) {
      this.lightningTransition = lightningTransition;
    }

    public BACnetPropertyStates build(BACnetTagHeader peekedTagHeader) {
      return new BACnetPropertyStatesLightningTransition(peekedTagHeader, lightningTransition);
    }
  }
}
