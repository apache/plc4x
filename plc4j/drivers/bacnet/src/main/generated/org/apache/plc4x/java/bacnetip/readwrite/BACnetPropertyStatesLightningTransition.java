...
public class BACnetPropertyStatesLightningTransition extends BACnetPropertyStates
    implements Message {
  ...
  public BACnetPropertyStatesLightningTransition(
      BACnetTagHeader peekedTagHeader, BACnetLightingTransitionTagged lightningTransition) {
  ...
  protected void serializeBACnetPropertyStatesChild(WriteBuffer writeBuffer)
    ...
    writeSimpleField("lightningTransition", lightningTransition, writeComplex(writeBuffer));

    writeBuffer.popContext("BACnetPropertyStatesLightningTransition");
  }
  ...
  public static class BACnetPropertyStatesLightningTransitionBuilderImpl
    ...
    public BACnetPropertyStatesLightningTransition build(BACnetTagHeader peekedTagHeader) {
      BACnetPropertyStatesLightningTransition bACnetPropertyStatesLightningTransition =
          new BACnetPropertyStatesLightningTransition(peekedTagHeader, lightningTransition);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetPropertyStatesLightningTransition)) {
      return false;
    }
    BACnetPropertyStatesLightningTransition that = (BACnetPropertyStatesLightningTransition) o;
    return (getLightningTransition() == that.getLightningTransition())
        && super.equals(that)
        && true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getLightningTransition());
  }
