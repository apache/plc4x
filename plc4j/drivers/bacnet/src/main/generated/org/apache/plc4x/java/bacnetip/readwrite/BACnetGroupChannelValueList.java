...
public class BACnetGroupChannelValueList implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("BACnetGroupChannelValueList");
    ...
    writeBuffer.popContext("BACnetGroupChannelValueList");
  }
  ...
  public static BACnetGroupChannelValueList staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetGroupChannelValueList staticParse(ReadBuffer readBuffer, Short tagNumber)
      throws ParseException {
    readBuffer.pullContext("BACnetGroupChannelValueList");
    PositionAware positionAware = readBuffer;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    ...
    List<BACnetEventSummary> listOfEventSummaries =
        readTerminatedArrayField(
            ...
            new DataReaderComplexDefault<>(
                () -> BACnetEventSummary.staticParse(readBuffer), readBuffer),
            () ->
                ((boolean)
    ...
    readBuffer.closeContext("BACnetGroupChannelValueList");
    // Create the instance
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetGroupChannelValueList)) {
      return false;
    }
    BACnetGroupChannelValueList that = (BACnetGroupChannelValueList) o;
