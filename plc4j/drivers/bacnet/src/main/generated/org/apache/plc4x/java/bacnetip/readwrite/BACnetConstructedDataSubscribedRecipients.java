...
public class BACnetConstructedDataSubscribedRecipients extends BACnetConstructedData
    implements Message {
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.pushContext("BACnetConstructedDataSubscribedRecipients");

    // Array Field (subscribedRecipients)
    writeComplexTypeArrayField("subscribedRecipients", subscribedRecipients, writeBuffer);

    writeBuffer.popContext("BACnetConstructedDataSubscribedRecipients");
  }
  ...
  public int getLengthInBits() {
    ...
    if (subscribedRecipients != null) {
      for (Message element : subscribedRecipients) {
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataSubscribedRecipients");
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataSubscribedRecipients)) {
      return false;
    }
    BACnetConstructedDataSubscribedRecipients that = (BACnetConstructedDataSubscribedRecipients) o;
    return (getSubscribedRecipients() == that.getSubscribedRecipients())
        && super.equals(that)
        && true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getSubscribedRecipients());
  }
