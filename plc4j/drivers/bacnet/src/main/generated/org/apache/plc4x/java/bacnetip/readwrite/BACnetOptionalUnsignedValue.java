...
public class BACnetOptionalUnsignedValue extends BACnetOptionalUnsigned implements Message {
  ...
  public BACnetOptionalUnsignedValue(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetOptionalUnsignedBuilder staticParseBACnetOptionalUnsignedBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetOptionalUnsignedValue"));
  ...
  protected void serializeBACnetOptionalUnsignedChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetOptionalUnsignedValue"));
  ...
  public static class BACnetOptionalUnsignedBuilderImpl implements BACnetOptionalUnsigned.BACnetOptionalUnsignedBuilder {
    ...
    public BACnetOptionalUnsignedBuilderImpl(BACnetApplicationTagUnsignedInteger unsignedValue) {
      this.unsignedValue = unsignedValue;
    }

    public BACnetOptionalUnsigned build(BACnetTagHeader peekedTagHeader) {
      return new BACnetOptionalUnsignedValue(peekedTagHeader, unsignedValue);
    }
  }
}
