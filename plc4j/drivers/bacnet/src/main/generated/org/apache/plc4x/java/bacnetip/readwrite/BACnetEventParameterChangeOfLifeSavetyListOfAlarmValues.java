...
public class BACnetEventParameterChangeOfLifeSavetyListOfAlarmValues implements Message {
  ...
  public BACnetEventParameterChangeOfLifeSavetyListOfAlarmValues(BACnetOpeningTag openingTag,
      List<BACnetLifeSafetyStateTagged> listOfAlarmValues, BACnetClosingTag closingTag) {
  ...
  public static BACnetEventParameterChangeOfLifeSavetyListOfAlarmValues staticParse(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetEventParameterChangeOfLifeSavetyListOfAlarmValues"));
    ...
    return new BACnetEventParameterChangeOfLifeSavetyListOfAlarmValues(openingTag, listOfAlarmValues, closingTag);
  }

  @Override
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetEventParameterChangeOfLifeSavetyListOfAlarmValues"));
    ...
    // Array Field: listOfAlarmValues
    FieldWriterFactory.writeComplexTypeArrayField(listOfAlarmValues, writeBuffer, WithOption.WithName("listOfAlarmValues"));
  ...
  public int getLengthInBits() {
    ...
    // Array Field: listOfAlarmValues
    for (Message _element : listOfAlarmValues) {
