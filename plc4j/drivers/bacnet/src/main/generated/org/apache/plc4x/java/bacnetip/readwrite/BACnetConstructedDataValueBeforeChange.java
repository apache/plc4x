...
public class BACnetConstructedDataValueBeforeChange extends BACnetConstructedData
    implements Message {
  ...
  public BACnetApplicationTagUnsignedInteger getActualValue() {
    return (BACnetApplicationTagUnsignedInteger) (getValuesBeforeChange());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataValueBeforeChange");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataValueBeforeChange");
    ...
    BACnetApplicationTagUnsignedInteger actualValue =
        readVirtualField(
            "actualValue", BACnetApplicationTagUnsignedInteger.class, valuesBeforeChange);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataValueBeforeChange)) {
      return false;
    }
    BACnetConstructedDataValueBeforeChange that = (BACnetConstructedDataValueBeforeChange) o;
    return (getValuesBeforeChange() == that.getValuesBeforeChange()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getValuesBeforeChange());
  }
