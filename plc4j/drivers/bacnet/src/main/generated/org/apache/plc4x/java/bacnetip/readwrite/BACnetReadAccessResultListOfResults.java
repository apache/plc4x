...
public class BACnetReadAccessResultListOfResults implements Message {
  ...
  public BACnetReadAccessResultListOfResults(BACnetOpeningTag openingTag,
      List<BACnetReadAccessProperty> listOfReadAccessProperty, BACnetClosingTag closingTag) {
  ...
  /**
   * Property field listOfReadAccessProperty
   */
  ...
  public static BACnetReadAccessResultListOfResults staticParse(ReadBuffer readBuffer,
      short tagNumber, BACnetObjectType objectTypeArgument) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("BACnetReadAccessResultListOfResults"));
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetReadAccessResultListOfResults"));
    ...
    // Array Field: listOfReadAccessProperty
    FieldWriterFactory.writeComplexTypeArrayField(listOfReadAccessProperty, writeBuffer, WithOption.WithName("listOfReadAccessProperty"));
  ...
  public int getLengthInBits() {
    ...
    // Array Field: listOfReadAccessProperty
    for (Message _element : listOfReadAccessProperty) {
