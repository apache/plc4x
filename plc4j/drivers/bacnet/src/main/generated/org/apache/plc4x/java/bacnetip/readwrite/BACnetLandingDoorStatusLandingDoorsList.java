...
public class BACnetLandingDoorStatusLandingDoorsList implements Message {
  ...
  public int getLengthInBits() {
    ...
    if (landingDoors != null) {
      for (Message element : landingDoors) {
  ...
  public static BACnetLandingDoorStatusLandingDoorsList staticParse(
  ...
  public static BACnetLandingDoorStatusLandingDoorsList staticParse(
    ...
    readBuffer.pullContext("BACnetLandingDoorStatusLandingDoorsList");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetLandingDoorStatusLandingDoorsList)) {
      return false;
    }
    BACnetLandingDoorStatusLandingDoorsList that = (BACnetLandingDoorStatusLandingDoorsList) o;
    return (getOpeningTag() == that.getOpeningTag())
        && (getLandingDoors() == that.getLandingDoors())
  ...
  @Override
  public int hashCode() {
    return Objects.hash(getOpeningTag(), getLandingDoors(), getClosingTag());
  }
