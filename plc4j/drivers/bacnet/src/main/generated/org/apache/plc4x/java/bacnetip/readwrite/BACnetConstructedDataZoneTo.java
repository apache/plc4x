...
public class BACnetConstructedDataZoneTo extends BACnetConstructedData implements Message {
  ...
  public BACnetDeviceObjectReference getActualValue() {
    return (BACnetDeviceObjectReference) (getZoneTo());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataZoneTo");
  }
  ...
  public static BACnetConstructedDataZoneToBuilder staticParseBuilder(
    ...
    // Create the instance
    return new BACnetConstructedDataZoneToBuilder(zoneTo, tagNumber, arrayIndexArgument);
  }

  public static class BACnetConstructedDataZoneToBuilder
      implements BACnetConstructedData.BACnetConstructedDataBuilder {
    private final BACnetDeviceObjectReference zoneTo;
    private final Short tagNumber;
    private final BACnetTagPayloadUnsignedInteger arrayIndexArgument;

    public BACnetConstructedDataZoneToBuilder(
        BACnetDeviceObjectReference zoneTo,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataZoneTo)) {
      return false;
    }
    BACnetConstructedDataZoneTo that = (BACnetConstructedDataZoneTo) o;
    return (getZoneTo() == that.getZoneTo()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getZoneTo());
  }
