...
public class BACnetConstructedDataSubordinateAnnotations extends BACnetConstructedData
    implements Message {
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.pushContext("BACnetConstructedDataSubordinateAnnotations");
    ...
    writeBuffer.popContext("BACnetConstructedDataSubordinateAnnotations");
  }
  ...
  public int getLengthInBits() {
    ...
    // Array field
    if (subordinateAnnotations != null) {
      for (Message element : subordinateAnnotations) {
  ...
  public static BACnetConstructedDataSubordinateAnnotationsBuilder staticParseBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataSubordinateAnnotations");
    ...
    // Create the instance
    return new BACnetConstructedDataSubordinateAnnotationsBuilder(
        numberOfDataElements, subordinateAnnotations, tagNumber, arrayIndexArgument);
  }

  public static class BACnetConstructedDataSubordinateAnnotationsBuilder
    ...
    public BACnetConstructedDataSubordinateAnnotationsBuilder(
        BACnetApplicationTagUnsignedInteger numberOfDataElements,
        List<BACnetApplicationTagCharacterString> subordinateAnnotations,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataSubordinateAnnotations)) {
      return false;
    }
    BACnetConstructedDataSubordinateAnnotations that =
        (BACnetConstructedDataSubordinateAnnotations) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getNumberOfDataElements(), getSubordinateAnnotations());
  }
