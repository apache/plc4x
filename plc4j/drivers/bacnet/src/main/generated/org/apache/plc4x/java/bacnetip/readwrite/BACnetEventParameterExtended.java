...
public class BACnetEventParameterExtended extends BACnetEventParameter implements Message {
  ...
  public BACnetEventParameterExtended(BACnetTagHeader peekedTagHeader, BACnetOpeningTag openingTag,
      BACnetVendorIdTagged vendorId, BACnetContextTagUnsignedInteger extendedEventType,
      BACnetEventParameterExtendedParameters parameters, BACnetClosingTag closingTag) {
  ...
  public static BACnetEventParameterBuilder staticParseBACnetEventParameterBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetEventParameterExtended"));
  ...
  protected void serializeBACnetEventParameterChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetEventParameterExtended"));
    ...
    // Simple Field: parameters
    FieldWriterFactory.writeSimpleField((BACnetEventParameterExtendedParameters) parameters, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("parameters"));
  ...
  public static class BACnetEventParameterBuilderImpl implements BACnetEventParameter.BACnetEventParameterBuilder {
    ...
    public BACnetEventParameter build(BACnetTagHeader peekedTagHeader) {
      return new BACnetEventParameterExtended(peekedTagHeader, openingTag, vendorId, extendedEventType, parameters, closingTag);
    }
  }
}
