...
public class BVLCReadBroadcastDistributionTableAck extends BVLC implements Message {
  ...
  public static BVLCBuilder staticParseBVLCBuilder(ReadBuffer readBuffer, int bvlcPayloadLength)
    ...
    readBuffer.pushContext(WithOption.WithName("BVLCReadBroadcastDistributionTableAck"), WithOption.WithFloatEncoding("IEEE754"), WithOption.WithSignedIntegerEncoding("twos-complement"), WithOption.WithUnsignedIntegerEncoding("unsigned-binary"), WithByteBasedOption.WithByteOrder("BIG_ENDIAN"), WithOption.WithStringEncoding("UTF8"));
  ...
  protected void serializeBVLCChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BVLCReadBroadcastDistributionTableAck"), WithOption.WithFloatEncoding("IEEE754"), WithOption.WithSignedIntegerEncoding("twos-complement"), WithOption.WithUnsignedIntegerEncoding("unsigned-binary"), WithByteBasedOption.WithByteOrder("BIG_ENDIAN"), WithOption.WithStringEncoding("UTF8"));
  ...
  public static class BVLCBuilderImpl implements BVLC.BVLCBuilder {
    ...
    public BVLC build() {
      return new BVLCReadBroadcastDistributionTableAck(table);
    }
  }
}
