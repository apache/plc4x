...
public class BACnetConstructedDataSecuredStatus extends BACnetConstructedData implements Message {
  ...
  public BACnetDoorSecuredStatusTagged getActualValue() {
    return (BACnetDoorSecuredStatusTagged) (getSecuredStatus());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataSecuredStatus");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataSecuredStatus");
    ...
    BACnetDoorSecuredStatusTagged securedStatus =
        readSimpleField(
            ...
            new DataReaderComplexDefault<>(
                ...
                readBuffer));
    BACnetDoorSecuredStatusTagged actualValue =
        readVirtualField("actualValue", BACnetDoorSecuredStatusTagged.class, securedStatus);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataSecuredStatus)) {
      return false;
    }
    BACnetConstructedDataSecuredStatus that = (BACnetConstructedDataSecuredStatus) o;
    return (getSecuredStatus() == that.getSecuredStatus()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getSecuredStatus());
  }
