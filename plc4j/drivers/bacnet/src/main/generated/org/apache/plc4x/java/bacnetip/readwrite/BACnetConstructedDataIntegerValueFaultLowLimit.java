...
public class BACnetConstructedDataIntegerValueFaultLowLimit extends BACnetConstructedData
    implements Message {
  ...
  public BACnetConstructedDataIntegerValueFaultLowLimit(
  ...
  public BACnetApplicationTagSignedInteger getActualValue() {
    return (BACnetApplicationTagSignedInteger) (getFaultLowLimit());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataIntegerValueFaultLowLimit");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataIntegerValueFaultLowLimit");
    ...
    BACnetApplicationTagSignedInteger actualValue =
        readVirtualField("actualValue", BACnetApplicationTagSignedInteger.class, faultLowLimit);

    readBuffer.closeContext("BACnetConstructedDataIntegerValueFaultLowLimit");
    // Create the instance
    return new BACnetConstructedDataIntegerValueFaultLowLimitBuilderImpl(faultLowLimit);
  }
  ...
  public static class BACnetConstructedDataIntegerValueFaultLowLimitBuilderImpl
    ...
    public BACnetConstructedDataIntegerValueFaultLowLimit build(
        BACnetOpeningTag openingTag, BACnetTagHeader peekedTagHeader, BACnetClosingTag closingTag) {
      BACnetConstructedDataIntegerValueFaultLowLimit
          bACnetConstructedDataIntegerValueFaultLowLimit =
              new BACnetConstructedDataIntegerValueFaultLowLimit(
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataIntegerValueFaultLowLimit)) {
      return false;
    }
    BACnetConstructedDataIntegerValueFaultLowLimit that =
        (BACnetConstructedDataIntegerValueFaultLowLimit) o;
