...
public class BACnetProgramStateTagged implements Message {
  ...
  public BACnetProgramStateTagged(
      BACnetTagHeader header, BACnetProgramState value, Short tagNumber, TagClass tagClass) {
    super();
    this.header = header;
    this.value = value;
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("BACnetProgramStateTagged");
    ...
    writeBuffer.popContext("BACnetProgramStateTagged");
  }
  ...
  public static BACnetProgramStateTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetProgramStateTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetProgramStateTagged");
    PositionAware positionAware = readBuffer;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
                ...
                (BACnetProgramState)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper
                        .readEnumGenericFailing(
                            readBuffer, header.getActualLength(), BACnetProgramState.IDLE)));

    readBuffer.closeContext("BACnetProgramStateTagged");
    // Create the instance
    BACnetProgramStateTagged _bACnetProgramStateTagged;
    _bACnetProgramStateTagged = new BACnetProgramStateTagged(header, value, tagNumber, tagClass);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetProgramStateTagged)) {
      return false;
    }
    BACnetProgramStateTagged that = (BACnetProgramStateTagged) o;
