...
public class Group implements Message {
  ...
  protected final ReadableProperty listOfGroupMembers;
  ...
  public Group(
      ...
      ReadableProperty listOfGroupMembers,
  ...
  public ReadableProperty getListOfGroupMembers() {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeSimpleField("listOfGroupMembers", listOfGroupMembers, writeComplex(writeBuffer));
  ...
  public int getLengthInBits() {
    ...
    // Simple field (listOfGroupMembers)
    lengthInBits += listOfGroupMembers.getLengthInBits();
  ...
  public static Group staticParse(ReadBuffer readBuffer) throws ParseException {
    readBuffer.pullContext("Group");
            ...
            readComplex(
                () ->
                    ReadableProperty.staticParse(
                        readBuffer, (String) ("BACnetLIST of ReadAccessSpecification")),
                readBuffer));
    ...
    ReadableProperty presentValue =
        readSimpleField(
            ...
            readComplex(
                () ->
                    ReadableProperty.staticParse(
                        readBuffer, (String) ("BACnetLIST of ReadAccessResult")),
                readBuffer));
  ...
  public boolean equals(Object o) {
    ...
    return (getObjectIdentifier() == that.getObjectIdentifier())
        ...
        && (getListOfGroupMembers() == that.getListOfGroupMembers())
