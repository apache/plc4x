...
public class BACnetConstructedDataAckRequired extends BACnetConstructedData implements Message {
  ...
  public BACnetEventTransitionBitsTagged getActualValue() {
    return (BACnetEventTransitionBitsTagged) (getAckRequired());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataAckRequired");
  }
  ...
  public static BACnetConstructedDataAckRequiredBuilder staticParseBuilder(
    ...
    BACnetEventTransitionBitsTagged actualValue =
        readVirtualField("actualValue", BACnetEventTransitionBitsTagged.class, ackRequired);

    readBuffer.closeContext("BACnetConstructedDataAckRequired");
    // Create the instance
    return new BACnetConstructedDataAckRequiredBuilder(ackRequired, tagNumber, arrayIndexArgument);
  }

  public static class BACnetConstructedDataAckRequiredBuilder
      implements BACnetConstructedData.BACnetConstructedDataBuilder {
    private final BACnetEventTransitionBitsTagged ackRequired;
    private final Short tagNumber;
    private final BACnetTagPayloadUnsignedInteger arrayIndexArgument;

    public BACnetConstructedDataAckRequiredBuilder(
        BACnetEventTransitionBitsTagged ackRequired,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataAckRequired)) {
      return false;
    }
    BACnetConstructedDataAckRequired that = (BACnetConstructedDataAckRequired) o;
    return (getAckRequired() == that.getAckRequired()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getAckRequired());
  }
