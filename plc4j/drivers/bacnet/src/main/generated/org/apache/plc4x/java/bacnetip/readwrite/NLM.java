...
public abstract class NLM implements Message {
  /**
   * Discriminator field messageType, as it was read from the wire.
   */
  ...
  public static NLM staticParse(ReadBuffer readBuffer, int apduLength) throws BufferException {
    ...
    // Switch Field
    Short _retainedMessageType = null;
    ...
    if (EvaluationHelper.equals(messageType, (short) (0x00))) {
      ...
      _retainedMessageType = messageType;
    } else if (true) {
    ...
    NLM _instance = builder.build();
    if (_retainedMessageType != null) {
      _instance.messageType = _retainedMessageType;
    }
    return _instance;
  }
