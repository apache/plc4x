...
public class BACnetFaultParameterFaultOutOfRangeMaxNormalValueReal
  ...
  public BACnetFaultParameterFaultOutOfRangeMaxNormalValueReal(
  ...
  public static BACnetFaultParameterFaultOutOfRangeMaxNormalValueRealBuilder staticParseBuilder(
      ReadBuffer readBuffer, Short tagNumber) throws ParseException {
    readBuffer.pullContext("BACnetFaultParameterFaultOutOfRangeMaxNormalValueReal");
    ...
    readBuffer.closeContext("BACnetFaultParameterFaultOutOfRangeMaxNormalValueReal");
    // Create the instance
    return new BACnetFaultParameterFaultOutOfRangeMaxNormalValueRealBuilder(realValue, tagNumber);
  }

  public static class BACnetFaultParameterFaultOutOfRangeMaxNormalValueRealBuilder
    ...
    public BACnetFaultParameterFaultOutOfRangeMaxNormalValueRealBuilder(
    ...
    public BACnetFaultParameterFaultOutOfRangeMaxNormalValueReal build(
        BACnetOpeningTag openingTag,
        BACnetTagHeader peekedTagHeader,
        BACnetClosingTag closingTag,
        Short tagNumber) {
      BACnetFaultParameterFaultOutOfRangeMaxNormalValueReal
          bACnetFaultParameterFaultOutOfRangeMaxNormalValueReal =
              new BACnetFaultParameterFaultOutOfRangeMaxNormalValueReal(
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetFaultParameterFaultOutOfRangeMaxNormalValueReal)) {
      return false;
    }
    BACnetFaultParameterFaultOutOfRangeMaxNormalValueReal that =
        (BACnetFaultParameterFaultOutOfRangeMaxNormalValueReal) o;
