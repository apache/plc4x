...
public class BACnetLightingTransitionTagged implements Message {
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetLightingTransition.VENDOR_PROPRIETARY_VALUE));
  }
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("BACnetLightingTransitionTagged");
    ...
    writeBuffer.popContext("BACnetLightingTransitionTagged");
  }
  ...
  public static BACnetLightingTransitionTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetLightingTransitionTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetLightingTransitionTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
            ...
            () ->
                (BACnetLightingTransition)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        BACnetLightingTransition.VENDOR_PROPRIETARY_VALUE)));
    ...
    readBuffer.closeContext("BACnetLightingTransitionTagged");
    // Create the instance
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetLightingTransitionTagged)) {
      return false;
    }
    BACnetLightingTransitionTagged that = (BACnetLightingTransitionTagged) o;
