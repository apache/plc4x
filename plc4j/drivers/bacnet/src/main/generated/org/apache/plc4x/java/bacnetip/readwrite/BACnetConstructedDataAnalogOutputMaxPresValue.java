...
public class BACnetConstructedDataAnalogOutputMaxPresValue extends BACnetConstructedData
    implements Message {
  ...
  public BACnetConstructedDataAnalogOutputMaxPresValue(
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataAnalogOutputMaxPresValue");
  }
  ...
  public static BACnetConstructedDataAnalogOutputMaxPresValueBuilder staticParseBuilder(
    ...
    readBuffer.closeContext("BACnetConstructedDataAnalogOutputMaxPresValue");
    // Create the instance
    return new BACnetConstructedDataAnalogOutputMaxPresValueBuilder(
        maxPresValue, tagNumber, arrayIndexArgument);
  }

  public static class BACnetConstructedDataAnalogOutputMaxPresValueBuilder
      implements BACnetConstructedData.BACnetConstructedDataBuilder {
    private final BACnetApplicationTagReal maxPresValue;
    private final Short tagNumber;
    private final BACnetTagPayloadUnsignedInteger arrayIndexArgument;

    public BACnetConstructedDataAnalogOutputMaxPresValueBuilder(
        BACnetApplicationTagReal maxPresValue,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
    ...
    public BACnetConstructedDataAnalogOutputMaxPresValue build(
        BACnetOpeningTag openingTag,
        BACnetTagHeader peekedTagHeader,
        BACnetClosingTag closingTag,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
      BACnetConstructedDataAnalogOutputMaxPresValue bACnetConstructedDataAnalogOutputMaxPresValue =
          new BACnetConstructedDataAnalogOutputMaxPresValue(
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataAnalogOutputMaxPresValue)) {
      return false;
    }
    BACnetConstructedDataAnalogOutputMaxPresValue that =
        (BACnetConstructedDataAnalogOutputMaxPresValue) o;
