...
public class BACnetApplicationTagBoolean extends BACnetApplicationTag implements Message {
  ...
  protected void serializeBACnetApplicationTagChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetApplicationTagBoolean");
  }
  ...
  public static class BACnetApplicationTagBooleanBuilderImpl
    ...
    public BACnetApplicationTagBoolean build(BACnetTagHeader header) {
      BACnetApplicationTagBoolean bACnetApplicationTagBoolean =
          new BACnetApplicationTagBoolean(header, payload);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetApplicationTagBoolean)) {
      return false;
    }
    BACnetApplicationTagBoolean that = (BACnetApplicationTagBoolean) o;
