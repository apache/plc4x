...
public class BACnetConstructedDataLastAccessPoint extends BACnetConstructedData implements Message {
  ...
  public BACnetDeviceObjectReference getActualValue() {
    return (BACnetDeviceObjectReference) (getLastAccessPoint());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeSimpleField(
        "lastAccessPoint", lastAccessPoint, new DataWriterComplexDefault<>(writeBuffer));

    // Virtual field (doesn't actually serialize anything, just makes the value available)
    BACnetDeviceObjectReference actualValue = getActualValue();
    writeBuffer.writeVirtual("actualValue", actualValue);

    writeBuffer.popContext("BACnetConstructedDataLastAccessPoint");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataLastAccessPoint");
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataLastAccessPoint)) {
      return false;
    }
    BACnetConstructedDataLastAccessPoint that = (BACnetConstructedDataLastAccessPoint) o;
    return (getLastAccessPoint() == that.getLastAccessPoint()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getLastAccessPoint());
  }
