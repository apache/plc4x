...
public class BACnetApplicationTagTime extends BACnetApplicationTag implements Message {
  ...
  public static BACnetApplicationTagTimeBuilder staticParseBuilder(ReadBuffer readBuffer)
    ...
    // Create the instance
    return new BACnetApplicationTagTimeBuilder(payload);
  }

  public static class BACnetApplicationTagTimeBuilder
      implements BACnetApplicationTag.BACnetApplicationTagBuilder {
    private final BACnetTagPayloadTime payload;

    public BACnetApplicationTagTimeBuilder(BACnetTagPayloadTime payload) {

      this.payload = payload;
    }

    public BACnetApplicationTagTime build(BACnetTagHeader header) {
      BACnetApplicationTagTime bACnetApplicationTagTime =
          new BACnetApplicationTagTime(header, payload);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetApplicationTagTime)) {
      return false;
    }
    BACnetApplicationTagTime that = (BACnetApplicationTagTime) o;
