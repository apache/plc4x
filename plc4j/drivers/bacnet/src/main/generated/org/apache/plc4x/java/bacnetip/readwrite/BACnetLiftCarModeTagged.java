...
public class BACnetLiftCarModeTagged implements Message {
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetLiftCarMode.VENDOR_PROPRIETARY_VALUE));
  }
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("BACnetLiftCarModeTagged");
  }
  ...
  public static BACnetLiftCarModeTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetLiftCarModeTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetLiftCarModeTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
            ...
            () ->
                (BACnetLiftCarMode)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        BACnetLiftCarMode.VENDOR_PROPRIETARY_VALUE)));
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetLiftCarModeTagged)) {
      return false;
    }
    BACnetLiftCarModeTagged that = (BACnetLiftCarModeTagged) o;
