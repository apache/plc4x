...
public abstract class BACnetRecipient implements Message {
  ...
  protected abstract void serializeBACnetRecipientChild(WriteBuffer writeBuffer)
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("BACnetRecipient");
  }
  ...
  public static BACnetRecipient staticParse(ReadBuffer readBuffer) throws ParseException {
    ...
    readBuffer.closeContext("BACnetRecipient");
    // Create the instance
    BACnetRecipient _bACnetRecipient = builder.build(peekedTagHeader);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetRecipient)) {
      return false;
    }
    BACnetRecipient that = (BACnetRecipient) o;
