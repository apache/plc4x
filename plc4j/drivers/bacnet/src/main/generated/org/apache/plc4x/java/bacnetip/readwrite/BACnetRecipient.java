 ...
 */
public abstract class BACnetRecipient implements Message {
  protected final BACnetTagHeader peekedTagHeader;

  public BACnetRecipient(BACnetTagHeader peekedTagHeader) {
    this.peekedTagHeader = peekedTagHeader;
  }

  protected abstract void serializeBACnetRecipientChild(WriteBuffer writeBuffer) throws
      BufferException;
  ...
  public static BACnetRecipient staticParse(ReadBuffer readBuffer) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("BACnetRecipient"));
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetRecipient"));
    ...
    // Switch Field
    serializeBACnetRecipientChild(writeBuffer);
