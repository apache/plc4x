...
public class BinaryOutput implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("BinaryOutput");
    ...
    writeBuffer.popContext("BinaryOutput");
  }
  ...
  public static BinaryOutput staticParse(ReadBuffer readBuffer) throws ParseException {
    readBuffer.pullContext("BinaryOutput");
    ...
    WritableProperty presentValue =
        readSimpleField(
            "presentValue",
            readComplex(
                () -> WritableProperty.staticParse(readBuffer, (String) ("BACnetBinaryPV")),
                readBuffer));
    ...
    readBuffer.closeContext("BinaryOutput");
    // Create the instance
    BinaryOutput _binaryOutput;
    _binaryOutput =
        new BinaryOutput(
            objectIdentifier,
            objectName,
  ...
  public boolean equals(Object o) {
    ...
    BinaryOutput that = (BinaryOutput) o;
