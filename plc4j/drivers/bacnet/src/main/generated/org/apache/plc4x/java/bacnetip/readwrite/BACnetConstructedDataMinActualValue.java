...
public class BACnetConstructedDataMinActualValue extends BACnetConstructedData implements Message {
  ...
  public BACnetApplicationTagReal getActualValue() {
    return (BACnetApplicationTagReal) (getMinActualValue());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataMinActualValue");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataMinActualValue");
    ...
    BACnetApplicationTagReal actualValue =
        readVirtualField("actualValue", BACnetApplicationTagReal.class, minActualValue);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataMinActualValue)) {
      return false;
    }
    BACnetConstructedDataMinActualValue that = (BACnetConstructedDataMinActualValue) o;
    return (getMinActualValue() == that.getMinActualValue()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getMinActualValue());
  }
