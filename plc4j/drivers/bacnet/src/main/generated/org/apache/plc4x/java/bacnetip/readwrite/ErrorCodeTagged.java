...
public class ErrorCodeTagged implements Message {
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (ErrorCode.VENDOR_PROPRIETARY_VALUE));
  }

  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    PositionAware positionAware = writeBuffer;
    int startPos = positionAware.getPos();
    writeBuffer.pushContext("ErrorCodeTagged");
    ...
    writeBuffer.popContext("ErrorCodeTagged");
  }
  ...
  public static ErrorCodeTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static ErrorCodeTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("ErrorCodeTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
            ...
            () ->
                (ErrorCode)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        readBuffer, header.getActualLength(), ErrorCode.VENDOR_PROPRIETARY_VALUE)));
    boolean isProprietary =
        readVirtualField(
            "isProprietary", boolean.class, (value) == (ErrorCode.VENDOR_PROPRIETARY_VALUE));
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ErrorCodeTagged)) {
      return false;
    }
    ErrorCodeTagged that = (ErrorCodeTagged) o;
