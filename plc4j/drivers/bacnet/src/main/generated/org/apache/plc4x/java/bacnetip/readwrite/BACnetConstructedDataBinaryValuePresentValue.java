...
public class BACnetConstructedDataBinaryValuePresentValue extends BACnetConstructedData
    implements Message {
  ...
  public BACnetConstructedDataBinaryValuePresentValue(
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataBinaryValuePresentValue");
  }
  ...
  public static BACnetConstructedDataBinaryValuePresentValueBuilder staticParseBuilder(
    ...
    readBuffer.closeContext("BACnetConstructedDataBinaryValuePresentValue");
    // Create the instance
    return new BACnetConstructedDataBinaryValuePresentValueBuilder(
        presentValue, tagNumber, arrayIndexArgument);
  }

  public static class BACnetConstructedDataBinaryValuePresentValueBuilder
      implements BACnetConstructedData.BACnetConstructedDataBuilder {
    private final BACnetBinaryPVTagged presentValue;
    private final Short tagNumber;
    private final BACnetTagPayloadUnsignedInteger arrayIndexArgument;

    public BACnetConstructedDataBinaryValuePresentValueBuilder(
        BACnetBinaryPVTagged presentValue,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
    ...
    public BACnetConstructedDataBinaryValuePresentValue build(
        BACnetOpeningTag openingTag,
        BACnetTagHeader peekedTagHeader,
        BACnetClosingTag closingTag,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
      BACnetConstructedDataBinaryValuePresentValue bACnetConstructedDataBinaryValuePresentValue =
          new BACnetConstructedDataBinaryValuePresentValue(
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataBinaryValuePresentValue)) {
      return false;
    }
    BACnetConstructedDataBinaryValuePresentValue that =
        (BACnetConstructedDataBinaryValuePresentValue) o;
