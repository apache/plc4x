...
public class BACnetAuthenticationFactorTypeTagged implements Message {
  ...
  public BACnetAuthenticationFactorTypeTagged(
      BACnetTagHeader header, BACnetAuthenticationFactorType value) {
    super();
    this.header = header;
    this.value = value;
  }
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("BACnetAuthenticationFactorTypeTagged");
  }
  ...
  public static BACnetAuthenticationFactorTypeTagged staticParse(
                ...
                (BACnetAuthenticationFactorType)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper
                        .readEnumGenericFailing(
                            ...
                            BACnetAuthenticationFactorType.UNDEFINED)));

    readBuffer.closeContext("BACnetAuthenticationFactorTypeTagged");
    // Create the instance
    BACnetAuthenticationFactorTypeTagged _bACnetAuthenticationFactorTypeTagged;
    _bACnetAuthenticationFactorTypeTagged = new BACnetAuthenticationFactorTypeTagged(header, value);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetAuthenticationFactorTypeTagged)) {
      return false;
    }
    BACnetAuthenticationFactorTypeTagged that = (BACnetAuthenticationFactorTypeTagged) o;
