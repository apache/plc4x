...
public class BACnetConstructedDataRecipientList extends BACnetConstructedData implements Message {
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeComplexTypeArrayField("recipientList", recipientList, writeBuffer);

    writeBuffer.popContext("BACnetConstructedDataRecipientList");
  }
  ...
  public int getLengthInBits() {
    ...
    if (recipientList != null) {
      for (Message element : recipientList) {
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataRecipientList");
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataRecipientList)) {
      return false;
    }
    BACnetConstructedDataRecipientList that = (BACnetConstructedDataRecipientList) o;
    return (getRecipientList() == that.getRecipientList()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getRecipientList());
  }
