...
public abstract class BACnetProcessIdSelection implements Message {
  ...
  protected abstract void serializeBACnetProcessIdSelectionChild(WriteBuffer writeBuffer)
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("BACnetProcessIdSelection");
  }
  ...
  public static BACnetProcessIdSelection staticParse(ReadBuffer readBuffer) throws ParseException {
    ...
    readBuffer.closeContext("BACnetProcessIdSelection");
    // Create the instance
    BACnetProcessIdSelection _bACnetProcessIdSelection = builder.build(peekedTagHeader);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetProcessIdSelection)) {
      return false;
    }
    BACnetProcessIdSelection that = (BACnetProcessIdSelection) o;
