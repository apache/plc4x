...
public class BACnetConstructedDataCarDoorCommand extends BACnetConstructedData implements Message {
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataCarDoorCommand");
  }
  ...
  public int getLengthInBits() {
    ...
    // Array field
    if (carDoorCommand != null) {
      for (Message element : carDoorCommand) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataCarDoorCommand)) {
      return false;
    }
    BACnetConstructedDataCarDoorCommand that = (BACnetConstructedDataCarDoorCommand) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getNumberOfDataElements(), getCarDoorCommand());
  }
