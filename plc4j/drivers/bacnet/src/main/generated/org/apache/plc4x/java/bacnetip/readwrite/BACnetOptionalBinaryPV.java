...
public abstract class BACnetOptionalBinaryPV implements Message {
  ...
  protected abstract void serializeBACnetOptionalBinaryPVChild(WriteBuffer writeBuffer)
      throws SerializationException;

  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    PositionAware positionAware = writeBuffer;
    int startPos = positionAware.getPos();
    writeBuffer.pushContext("BACnetOptionalBinaryPV");
    ...
    writeBuffer.popContext("BACnetOptionalBinaryPV");
  }
  ...
  public static BACnetOptionalBinaryPV staticParse(ReadBuffer readBuffer, Object... args)
      throws ParseException {
    PositionAware positionAware = readBuffer;
    return staticParse(readBuffer);
  }

  public static BACnetOptionalBinaryPV staticParse(ReadBuffer readBuffer) throws ParseException {
    readBuffer.pullContext("BACnetOptionalBinaryPV");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
    ...
    readBuffer.closeContext("BACnetOptionalBinaryPV");
    // Create the instance
    BACnetOptionalBinaryPV _bACnetOptionalBinaryPV = builder.build(peekedTagHeader);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetOptionalBinaryPV)) {
      return false;
    }
    BACnetOptionalBinaryPV that = (BACnetOptionalBinaryPV) o;
