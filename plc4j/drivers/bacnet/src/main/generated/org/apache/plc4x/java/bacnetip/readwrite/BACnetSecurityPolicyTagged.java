...
public class BACnetSecurityPolicyTagged implements Message {
  ...
  public BACnetSecurityPolicyTagged(
      BACnetTagHeader header, BACnetSecurityPolicy value, Short tagNumber, TagClass tagClass) {
    super();
    this.header = header;
    this.value = value;
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("BACnetSecurityPolicyTagged");
  }
  ...
  public static BACnetSecurityPolicyTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetSecurityPolicyTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetSecurityPolicyTagged");
    PositionAware positionAware = readBuffer;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
                ...
                (BACnetSecurityPolicy)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper
                        .readEnumGenericFailing(
                            ...
                            BACnetSecurityPolicy.PLAIN_NON_TRUSTED)));

    readBuffer.closeContext("BACnetSecurityPolicyTagged");
    // Create the instance
    BACnetSecurityPolicyTagged _bACnetSecurityPolicyTagged;
    _bACnetSecurityPolicyTagged =
        new BACnetSecurityPolicyTagged(header, value, tagNumber, tagClass);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetSecurityPolicyTagged)) {
      return false;
    }
    BACnetSecurityPolicyTagged that = (BACnetSecurityPolicyTagged) o;
