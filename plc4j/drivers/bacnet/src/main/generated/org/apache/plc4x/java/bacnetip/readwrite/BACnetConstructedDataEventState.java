...
public class BACnetConstructedDataEventState extends BACnetConstructedData implements Message {
  ...
  public BACnetEventStateTagged getActualValue() {
    return (BACnetEventStateTagged) (getEventState());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataEventState");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataEventState");
    ...
    BACnetEventStateTagged eventState =
        readSimpleField(
            ...
            new DataReaderComplexDefault<>(
                ...
                readBuffer));
    BACnetEventStateTagged actualValue =
        readVirtualField("actualValue", BACnetEventStateTagged.class, eventState);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataEventState)) {
      return false;
    }
    BACnetConstructedDataEventState that = (BACnetConstructedDataEventState) o;
    return (getEventState() == that.getEventState()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getEventState());
  }
