...
public class BACnetDoorSecuredStatusTagged implements Message {
  ...
  public BACnetDoorSecuredStatusTagged(
      BACnetTagHeader header, BACnetDoorSecuredStatus value, Short tagNumber, TagClass tagClass) {
    super();
    this.header = header;
    this.value = value;
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("BACnetDoorSecuredStatusTagged");
    ...
    writeBuffer.popContext("BACnetDoorSecuredStatusTagged");
  }
  ...
  public static BACnetDoorSecuredStatusTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetDoorSecuredStatusTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetDoorSecuredStatusTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
                ...
                (BACnetDoorSecuredStatus)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper
                        .readEnumGenericFailing(
                            ...
                            BACnetDoorSecuredStatus.SECURED)));

    readBuffer.closeContext("BACnetDoorSecuredStatusTagged");
    // Create the instance
    BACnetDoorSecuredStatusTagged _bACnetDoorSecuredStatusTagged;
    _bACnetDoorSecuredStatusTagged =
        new BACnetDoorSecuredStatusTagged(header, value, tagNumber, tagClass);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetDoorSecuredStatusTagged)) {
      return false;
    }
    BACnetDoorSecuredStatusTagged that = (BACnetDoorSecuredStatusTagged) o;
