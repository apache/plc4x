...
public class BACnetConstructedDataMode extends BACnetConstructedData implements Message {
  ...
  public BACnetLifeSafetyModeTagged getActualValue() {
    return (BACnetLifeSafetyModeTagged) (getMode());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataMode");
  }
  ...
  public static BACnetConstructedDataModeBuilder staticParseBuilder(
    ...
    BACnetLifeSafetyModeTagged mode =
        readSimpleField(
            ...
            new DataReaderComplexDefault<>(
                ...
                readBuffer));
    BACnetLifeSafetyModeTagged actualValue =
        readVirtualField("actualValue", BACnetLifeSafetyModeTagged.class, mode);

    readBuffer.closeContext("BACnetConstructedDataMode");
    // Create the instance
    return new BACnetConstructedDataModeBuilder(mode, tagNumber, arrayIndexArgument);
  }

  public static class BACnetConstructedDataModeBuilder
      implements BACnetConstructedData.BACnetConstructedDataBuilder {
    private final BACnetLifeSafetyModeTagged mode;
    private final Short tagNumber;
    private final BACnetTagPayloadUnsignedInteger arrayIndexArgument;

    public BACnetConstructedDataModeBuilder(
        BACnetLifeSafetyModeTagged mode,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataMode)) {
      return false;
    }
    BACnetConstructedDataMode that = (BACnetConstructedDataMode) o;
    return (getMode() == that.getMode()) && super.equals(that) && true;
  }
