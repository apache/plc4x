...
public class NLMICouldBeRouterToNetwork extends NLM implements Message {
  ...
  protected void serializeNLMChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeSimpleField("performanceIndex", performanceIndex, writeUnsignedShort(writeBuffer, 8));

    writeBuffer.popContext("NLMICouldBeRouterToNetwork");
  }
  ...
  public static NLMBuilder staticParseNLMBuilder(ReadBuffer readBuffer, Integer apduLength)
    ...
    short performanceIndex = readSimpleField("performanceIndex", readUnsignedShort(readBuffer, 8));
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof NLMICouldBeRouterToNetwork)) {
      return false;
    }
    NLMICouldBeRouterToNetwork that = (NLMICouldBeRouterToNetwork) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getDestinationNetworkAddress(), getPerformanceIndex());
  }
