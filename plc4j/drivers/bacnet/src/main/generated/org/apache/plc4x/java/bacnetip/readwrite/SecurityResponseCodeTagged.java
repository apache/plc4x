...
public class SecurityResponseCodeTagged implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("SecurityResponseCodeTagged");
    ...
    writeBuffer.popContext("SecurityResponseCodeTagged");
  }
  ...
  public static SecurityResponseCodeTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static SecurityResponseCodeTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("SecurityResponseCodeTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
                ...
                (SecurityResponseCode)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper
                        .readEnumGenericFailing(
                            readBuffer, header.getActualLength(), SecurityResponseCode.SUCCESS)));
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SecurityResponseCodeTagged)) {
      return false;
    }
    SecurityResponseCodeTagged that = (SecurityResponseCodeTagged) o;
