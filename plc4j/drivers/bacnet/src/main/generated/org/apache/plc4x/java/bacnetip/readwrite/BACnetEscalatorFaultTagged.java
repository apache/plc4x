...
public class BACnetEscalatorFaultTagged implements Message {
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetEscalatorFault.VENDOR_PROPRIETARY_VALUE));
  }

  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    PositionAware positionAware = writeBuffer;
    int startPos = positionAware.getPos();
    writeBuffer.pushContext("BACnetEscalatorFaultTagged");
    ...
    writeBuffer.popContext("BACnetEscalatorFaultTagged");
  }
  ...
  public static BACnetEscalatorFaultTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetEscalatorFaultTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetEscalatorFaultTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
            ...
            () ->
                (BACnetEscalatorFault)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        BACnetEscalatorFault.VENDOR_PROPRIETARY_VALUE)));
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetEscalatorFaultTagged)) {
      return false;
    }
    BACnetEscalatorFaultTagged that = (BACnetEscalatorFaultTagged) o;
