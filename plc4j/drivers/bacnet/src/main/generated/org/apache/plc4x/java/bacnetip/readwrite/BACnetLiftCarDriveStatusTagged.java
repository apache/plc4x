...
public class BACnetLiftCarDriveStatusTagged implements Message {
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetLiftCarDriveStatus.VENDOR_PROPRIETARY_VALUE));
  }

  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    PositionAware positionAware = writeBuffer;
    int startPos = positionAware.getPos();
    writeBuffer.pushContext("BACnetLiftCarDriveStatusTagged");
    ...
    writeBuffer.popContext("BACnetLiftCarDriveStatusTagged");
  }
  ...
  public static BACnetLiftCarDriveStatusTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetLiftCarDriveStatusTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetLiftCarDriveStatusTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
            ...
            () ->
                (BACnetLiftCarDriveStatus)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        BACnetLiftCarDriveStatus.VENDOR_PROPRIETARY_VALUE)));
    ...
    readBuffer.closeContext("BACnetLiftCarDriveStatusTagged");
    // Create the instance
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetLiftCarDriveStatusTagged)) {
      return false;
    }
    BACnetLiftCarDriveStatusTagged that = (BACnetLiftCarDriveStatusTagged) o;
