...
public class BACnetProtocolLevelTagged implements Message {
  ...
  public BACnetProtocolLevelTagged(
      BACnetTagHeader header, BACnetProtocolLevel value, Short tagNumber, TagClass tagClass) {
    super();
    this.header = header;
    this.value = value;
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("BACnetProtocolLevelTagged");
    ...
    writeBuffer.popContext("BACnetProtocolLevelTagged");
  }
  ...
  public static BACnetProtocolLevelTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetProtocolLevelTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetProtocolLevelTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
                ...
                (BACnetProtocolLevel)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper
                        .readEnumGenericFailing(
                            readBuffer, header.getActualLength(), BACnetProtocolLevel.PHYSICAL)));

    readBuffer.closeContext("BACnetProtocolLevelTagged");
    // Create the instance
    BACnetProtocolLevelTagged _bACnetProtocolLevelTagged;
    _bACnetProtocolLevelTagged = new BACnetProtocolLevelTagged(header, value, tagNumber, tagClass);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetProtocolLevelTagged)) {
      return false;
    }
    BACnetProtocolLevelTagged that = (BACnetProtocolLevelTagged) o;
