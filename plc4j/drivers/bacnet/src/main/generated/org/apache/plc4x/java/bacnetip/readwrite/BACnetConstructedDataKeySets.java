...
public class BACnetConstructedDataKeySets extends BACnetConstructedData implements Message {
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataKeySets");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataKeySets");
    ...
    // Validation
    if (!(((arrayIndexArgument) != (null)) || ((COUNT(keySets)) == (2)))) {
      throw new ParseValidationException("keySets should have exactly 2 values");
    }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataKeySets)) {
      return false;
    }
    BACnetConstructedDataKeySets that = (BACnetConstructedDataKeySets) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getNumberOfDataElements(), getKeySets());
  }
