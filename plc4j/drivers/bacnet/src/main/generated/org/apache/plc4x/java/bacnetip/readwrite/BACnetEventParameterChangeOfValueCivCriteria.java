...
public abstract class BACnetEventParameterChangeOfValueCivCriteria implements Message {
  ...
  public BACnetEventParameterChangeOfValueCivCriteria(BACnetOpeningTag openingTag,
  ...
  protected abstract void serializeBACnetEventParameterChangeOfValueCivCriteriaChild(
  ...
  public static BACnetEventParameterChangeOfValueCivCriteria staticParse(ReadBuffer readBuffer,
      short tagNumber) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("BACnetEventParameterChangeOfValueCivCriteria"));
    ...
    if (EvaluationHelper.equals(peekedTagNumber, (short) (0))) {
      builder = BACnetEventParameterChangeOfValueCivCriteriaBitmask.staticParseBACnetEventParameterChangeOfValueCivCriteriaBuilder(readBuffer, tagNumber);
    } else if (EvaluationHelper.equals(peekedTagNumber, (short) (1))) {
      builder = BACnetEventParameterChangeOfValueCivCriteriaReferencedPropertyIncrement.staticParseBACnetEventParameterChangeOfValueCivCriteriaBuilder(readBuffer, tagNumber);
    }
    if (builder == null) {
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetEventParameterChangeOfValueCivCriteria"));
  ...
  public interface BACnetEventParameterChangeOfValueCivCriteriaBuilder {
    BACnetEventParameterChangeOfValueCivCriteria build(BACnetOpeningTag openingTag,
        BACnetTagHeader peekedTagHeader, BACnetClosingTag closingTag);
  }
}
