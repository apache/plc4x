...
public class BACnetConstructedDataCalendarPresentValue extends BACnetConstructedData
    implements Message {
  ...
  public BACnetApplicationTagBoolean getActualValue() {
    return (BACnetApplicationTagBoolean) (getPresentValue());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataCalendarPresentValue");
  }
  ...
  public static BACnetConstructedDataCalendarPresentValueBuilder staticParseBuilder(
    ...
    BACnetApplicationTagBoolean actualValue =
        readVirtualField("actualValue", BACnetApplicationTagBoolean.class, presentValue);

    readBuffer.closeContext("BACnetConstructedDataCalendarPresentValue");
    // Create the instance
    return new BACnetConstructedDataCalendarPresentValueBuilder(
        presentValue, tagNumber, arrayIndexArgument);
  }

  public static class BACnetConstructedDataCalendarPresentValueBuilder
      implements BACnetConstructedData.BACnetConstructedDataBuilder {
    private final BACnetApplicationTagBoolean presentValue;
    private final Short tagNumber;
    private final BACnetTagPayloadUnsignedInteger arrayIndexArgument;

    public BACnetConstructedDataCalendarPresentValueBuilder(
        BACnetApplicationTagBoolean presentValue,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataCalendarPresentValue)) {
      return false;
    }
    BACnetConstructedDataCalendarPresentValue that = (BACnetConstructedDataCalendarPresentValue) o;
