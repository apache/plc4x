...
public class BACnetDeviceStatusTagged implements Message {
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetDeviceStatus.VENDOR_PROPRIETARY_VALUE));
  }

  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    PositionAware positionAware = writeBuffer;
    int startPos = positionAware.getPos();
    writeBuffer.pushContext("BACnetDeviceStatusTagged");
    ...
    writeBuffer.popContext("BACnetDeviceStatusTagged");
  }
  ...
  public static BACnetDeviceStatusTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetDeviceStatusTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetDeviceStatusTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
            ...
            () ->
                (BACnetDeviceStatus)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        BACnetDeviceStatus.VENDOR_PROPRIETARY_VALUE)));
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetDeviceStatusTagged)) {
      return false;
    }
    BACnetDeviceStatusTagged that = (BACnetDeviceStatusTagged) o;
