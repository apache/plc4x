...
public class TimePatternValue implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("TimePatternValue");
    ...
    writeBuffer.popContext("TimePatternValue");
  }
  ...
  public static TimePatternValue staticParse(ReadBuffer readBuffer) throws ParseException {
    readBuffer.pullContext("TimePatternValue");
    ...
    readBuffer.closeContext("TimePatternValue");
    // Create the instance
    TimePatternValue _timePatternValue;
    _timePatternValue =
        new TimePatternValue(
            objectIdentifier,
            objectName,
            objectType,
            description,
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof TimePatternValue)) {
      return false;
    }
    TimePatternValue that = (TimePatternValue) o;
