...
public class BACnetConstructedDataDatePatternValuePresentValue extends BACnetConstructedData
    implements Message {
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataDatePatternValuePresentValue");
  }
  ...
  public static BACnetConstructedDataDatePatternValuePresentValueBuilder staticParseBuilder(
    ...
    readBuffer.pullContext("BACnetConstructedDataDatePatternValuePresentValue");
    ...
    // Create the instance
    return new BACnetConstructedDataDatePatternValuePresentValueBuilder(
        presentValue, tagNumber, arrayIndexArgument);
  }

  public static class BACnetConstructedDataDatePatternValuePresentValueBuilder
      implements BACnetConstructedData.BACnetConstructedDataBuilder {
    private final BACnetApplicationTagDate presentValue;
    private final Short tagNumber;
    private final BACnetTagPayloadUnsignedInteger arrayIndexArgument;

    public BACnetConstructedDataDatePatternValuePresentValueBuilder(
        BACnetApplicationTagDate presentValue,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataDatePatternValuePresentValue)) {
      return false;
    }
    BACnetConstructedDataDatePatternValuePresentValue that =
        (BACnetConstructedDataDatePatternValuePresentValue) o;
