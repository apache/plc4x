...
public class BACnetConstructedDataBaseDeviceSecurityPolicy extends BACnetConstructedData
    implements Message {
  ...
  public BACnetSecurityLevelTagged getActualValue() {
    return (BACnetSecurityLevelTagged) (getBaseDeviceSecurityPolicy());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataBaseDeviceSecurityPolicy");
  }
    ...
    BACnetSecurityLevelTagged baseDeviceSecurityPolicy =
        readSimpleField(
            ...
            new DataReaderComplexDefault<>(
                ...
                readBuffer));
    BACnetSecurityLevelTagged actualValue =
        readVirtualField("actualValue", BACnetSecurityLevelTagged.class, baseDeviceSecurityPolicy);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataBaseDeviceSecurityPolicy)) {
      return false;
    }
    BACnetConstructedDataBaseDeviceSecurityPolicy that =
        (BACnetConstructedDataBaseDeviceSecurityPolicy) o;
    return (getBaseDeviceSecurityPolicy() == that.getBaseDeviceSecurityPolicy())
        && super.equals(that)
        && true;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getBaseDeviceSecurityPolicy());
  }
