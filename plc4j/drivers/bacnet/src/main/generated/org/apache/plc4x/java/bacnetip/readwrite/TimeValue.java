...
public class TimeValue implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("TimeValue");
    ...
    writeBuffer.popContext("TimeValue");
  }
  ...
  public static TimeValue staticParse(ReadBuffer readBuffer) throws ParseException {
    readBuffer.pullContext("TimeValue");
    ...
    ReadableProperty presentValue =
        readSimpleField(
            "presentValue",
            readComplex(
                () -> ReadableProperty.staticParse(readBuffer, (String) ("Time")), readBuffer));
    ...
    readBuffer.closeContext("TimeValue");
    // Create the instance
