...
public class BACnetAuthenticationPolicyList implements Message {
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    // Array Field (entries)
    writeComplexTypeArrayField("entries", entries, writeBuffer);

    // Simple Field (closingTag)
    writeSimpleField("closingTag", closingTag, new DataWriterComplexDefault<>(writeBuffer));

    writeBuffer.popContext("BACnetAuthenticationPolicyList");
  }
  ...
  public static BACnetAuthenticationPolicyList staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetAuthenticationPolicyList)) {
      return false;
    }
    BACnetAuthenticationPolicyList that = (BACnetAuthenticationPolicyList) o;
    return (getOpeningTag() == that.getOpeningTag())
        && (getEntries() == that.getEntries())
  ...
  @Override
  public int hashCode() {
    return Objects.hash(getOpeningTag(), getEntries(), getClosingTag());
  }
