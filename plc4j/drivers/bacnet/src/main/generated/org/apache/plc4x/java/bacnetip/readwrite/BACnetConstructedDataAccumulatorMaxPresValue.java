...
public class BACnetConstructedDataAccumulatorMaxPresValue extends BACnetConstructedData
    implements Message {
  ...
  public BACnetConstructedDataAccumulatorMaxPresValue(
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataAccumulatorMaxPresValue");
  }
  ...
  public static BACnetConstructedDataAccumulatorMaxPresValueBuilder staticParseBuilder(
    ...
    readBuffer.closeContext("BACnetConstructedDataAccumulatorMaxPresValue");
    // Create the instance
    return new BACnetConstructedDataAccumulatorMaxPresValueBuilder(
        maxPresValue, tagNumber, arrayIndexArgument);
  }

  public static class BACnetConstructedDataAccumulatorMaxPresValueBuilder
      implements BACnetConstructedData.BACnetConstructedDataBuilder {
    private final BACnetApplicationTagUnsignedInteger maxPresValue;
    private final Short tagNumber;
    private final BACnetTagPayloadUnsignedInteger arrayIndexArgument;

    public BACnetConstructedDataAccumulatorMaxPresValueBuilder(
        BACnetApplicationTagUnsignedInteger maxPresValue,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
    ...
    public BACnetConstructedDataAccumulatorMaxPresValue build(
        BACnetOpeningTag openingTag,
        BACnetTagHeader peekedTagHeader,
        BACnetClosingTag closingTag,
        Short tagNumber,
        BACnetTagPayloadUnsignedInteger arrayIndexArgument) {
      BACnetConstructedDataAccumulatorMaxPresValue bACnetConstructedDataAccumulatorMaxPresValue =
          new BACnetConstructedDataAccumulatorMaxPresValue(
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataAccumulatorMaxPresValue)) {
      return false;
    }
    BACnetConstructedDataAccumulatorMaxPresValue that =
        (BACnetConstructedDataAccumulatorMaxPresValue) o;
