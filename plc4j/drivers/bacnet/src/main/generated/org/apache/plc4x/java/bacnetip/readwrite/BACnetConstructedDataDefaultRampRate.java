...
public class BACnetConstructedDataDefaultRampRate extends BACnetConstructedData implements Message {
  ...
  public BACnetApplicationTagReal getActualValue() {
    return (BACnetApplicationTagReal) (getDefaultRampRate());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataDefaultRampRate");
  }
  ...
  public static BACnetConstructedDataDefaultRampRateBuilder staticParseBuilder(
    ...
    BACnetApplicationTagReal actualValue =
        readVirtualField("actualValue", BACnetApplicationTagReal.class, defaultRampRate);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataDefaultRampRate)) {
      return false;
    }
    BACnetConstructedDataDefaultRampRate that = (BACnetConstructedDataDefaultRampRate) o;
    return (getDefaultRampRate() == that.getDefaultRampRate()) && super.equals(that) && true;
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), getDefaultRampRate());
  }
