...
public class BACnetLifeSafetyOperationTagged implements Message {
  ...
  public BACnetLifeSafetyOperationTagged(
      BACnetTagHeader header,
      BACnetLifeSafetyOperation value,
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetLifeSafetyOperation.VENDOR_PROPRIETARY_VALUE));
  }
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.pushContext("BACnetLifeSafetyOperationTagged");
    ...
    writeBuffer.popContext("BACnetLifeSafetyOperationTagged");
  }
  ...
  public static BACnetLifeSafetyOperationTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetLifeSafetyOperationTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetLifeSafetyOperationTagged");
    PositionAware positionAware = readBuffer;
    int startPos = positionAware.getPos();
    int curPos;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
            ...
            () ->
                (BACnetLifeSafetyOperation)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        BACnetLifeSafetyOperation.VENDOR_PROPRIETARY_VALUE)));
    ...
    readBuffer.closeContext("BACnetLifeSafetyOperationTagged");
    // Create the instance
    BACnetLifeSafetyOperationTagged _bACnetLifeSafetyOperationTagged;
    _bACnetLifeSafetyOperationTagged =
        new BACnetLifeSafetyOperationTagged(header, value, proprietaryValue, tagNumber, tagClass);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetLifeSafetyOperationTagged)) {
      return false;
    }
    BACnetLifeSafetyOperationTagged that = (BACnetLifeSafetyOperationTagged) o;
