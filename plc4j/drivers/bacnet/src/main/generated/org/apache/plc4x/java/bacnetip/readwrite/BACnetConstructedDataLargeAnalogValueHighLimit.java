...
public class BACnetConstructedDataLargeAnalogValueHighLimit extends BACnetConstructedData
    implements Message {
  ...
  public BACnetConstructedDataLargeAnalogValueHighLimit(
  ...
  public BACnetApplicationTagDouble getActualValue() {
    return (BACnetApplicationTagDouble) (getHighLimit());
  }
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer)
    ...
    writeBuffer.popContext("BACnetConstructedDataLargeAnalogValueHighLimit");
  }
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    BACnetApplicationTagDouble actualValue =
        readVirtualField("actualValue", BACnetApplicationTagDouble.class, highLimit);

    readBuffer.closeContext("BACnetConstructedDataLargeAnalogValueHighLimit");
    // Create the instance
    return new BACnetConstructedDataLargeAnalogValueHighLimitBuilderImpl(highLimit);
  }
  ...
  public static class BACnetConstructedDataLargeAnalogValueHighLimitBuilderImpl
    ...
    public BACnetConstructedDataLargeAnalogValueHighLimit build(
        BACnetOpeningTag openingTag, BACnetTagHeader peekedTagHeader, BACnetClosingTag closingTag) {
      BACnetConstructedDataLargeAnalogValueHighLimit
          bACnetConstructedDataLargeAnalogValueHighLimit =
              new BACnetConstructedDataLargeAnalogValueHighLimit(
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetConstructedDataLargeAnalogValueHighLimit)) {
      return false;
    }
    BACnetConstructedDataLargeAnalogValueHighLimit that =
        (BACnetConstructedDataLargeAnalogValueHighLimit) o;
