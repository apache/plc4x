 ...
 */
public class BACnetPropertyStatesNetworkNumberQuality extends BACnetPropertyStates implements Message {
  protected final BACnetNetworkNumberQualityTagged networkNumberQuality;

  public BACnetPropertyStatesNetworkNumberQuality(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetPropertyStatesBuilder staticParseBACnetPropertyStatesBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetPropertyStatesNetworkNumberQuality"));
  ...
  protected void serializeBACnetPropertyStatesChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetPropertyStatesNetworkNumberQuality"));
  ...
  public static class BACnetPropertyStatesBuilderImpl implements BACnetPropertyStates.BACnetPropertyStatesBuilder {
    ...
    public BACnetPropertyStatesBuilderImpl(BACnetNetworkNumberQualityTagged networkNumberQuality) {
      this.networkNumberQuality = networkNumberQuality;
    }

    public BACnetPropertyStates build(BACnetTagHeader peekedTagHeader) {
      return new BACnetPropertyStatesNetworkNumberQuality(peekedTagHeader, networkNumberQuality);
    }
  }
}
