...
public class BACnetRelationshipTagged implements Message {
  ...
  public BACnetRelationshipTagged(
      BACnetTagHeader header,
      BACnetRelationship value,
  ...
  public boolean getIsProprietary() {
    return (boolean) ((getValue()) == (BACnetRelationship.VENDOR_PROPRIETARY_VALUE));
  }
  ...
  public void serialize(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("BACnetRelationshipTagged");
  }
  ...
  public static BACnetRelationshipTagged staticParse(ReadBuffer readBuffer, Object... args)
  ...
  public static BACnetRelationshipTagged staticParse(
      ReadBuffer readBuffer, Short tagNumber, TagClass tagClass) throws ParseException {
    readBuffer.pullContext("BACnetRelationshipTagged");
    PositionAware positionAware = readBuffer;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
            ...
            () ->
                (BACnetRelationship)
                    (org.apache.plc4x.java.bacnetip.readwrite.utils.StaticHelper.readEnumGeneric(
                        ...
                        BACnetRelationship.VENDOR_PROPRIETARY_VALUE)));
    ...
    readBuffer.closeContext("BACnetRelationshipTagged");
    // Create the instance
    BACnetRelationshipTagged _bACnetRelationshipTagged;
    _bACnetRelationshipTagged =
        new BACnetRelationshipTagged(header, value, proprietaryValue, tagNumber, tagClass);
    return _bACnetRelationshipTagged;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof BACnetRelationshipTagged)) {
      return false;
    }
    BACnetRelationshipTagged that = (BACnetRelationshipTagged) o;
