...
public class BACnetChannelValueObjectidentifier extends BACnetChannelValue implements Message {
  ...
  public BACnetChannelValueObjectidentifier(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetChannelValueBuilder staticParseBACnetChannelValueBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetChannelValueObjectidentifier"));
    ...
    return new BACnetChannelValueBuilderImpl(objectidentifierValue);
  }

  protected void serializeBACnetChannelValueChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetChannelValueObjectidentifier"));
  ...
  public static class BACnetChannelValueBuilderImpl implements BACnetChannelValue.BACnetChannelValueBuilder {
    ...
    public BACnetChannelValueBuilderImpl(
        BACnetApplicationTagObjectIdentifier objectidentifierValue) {
      this.objectidentifierValue = objectidentifierValue;
    }

    public BACnetChannelValue build(BACnetTagHeader peekedTagHeader) {
      return new BACnetChannelValueObjectidentifier(peekedTagHeader, objectidentifierValue);
    }
  }
}
