...
public class BACnetPropertyStatesReasonForHalt extends BACnetPropertyStates implements Message {
  ...
  public BACnetPropertyStatesReasonForHalt(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetPropertyStatesBuilder staticParseBACnetPropertyStatesBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetPropertyStatesReasonForHalt"));
  ...
  protected void serializeBACnetPropertyStatesChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetPropertyStatesReasonForHalt"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: reasonForHalt
    FieldWriterFactory.writeSimpleField((BACnetProgramErrorTagged) reasonForHalt, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("reasonForHalt"));
  ...
  public static class BACnetPropertyStatesBuilderImpl implements BACnetPropertyStates.BACnetPropertyStatesBuilder {
    ...
    public BACnetPropertyStatesBuilderImpl(BACnetProgramErrorTagged reasonForHalt) {
      this.reasonForHalt = reasonForHalt;
    }

    public BACnetPropertyStates build(BACnetTagHeader peekedTagHeader) {
      return new BACnetPropertyStatesReasonForHalt(peekedTagHeader, reasonForHalt);
    }
  }
}
