 ...
 * <p>
 * UMAS has no native subscription mechanism; since {@code UmasConnection} now extends
 * {@code PollingSubscriptionConnectionBase}, subscriptions are emulated by polling the tag via the
 * regular read path. This test registers two subscriptions against {@code g_b16}:
 * <ul>
 ...
 * <p>
 * To produce visible value changes, change {@code g_b16} on the PLC while this is running.
 */
