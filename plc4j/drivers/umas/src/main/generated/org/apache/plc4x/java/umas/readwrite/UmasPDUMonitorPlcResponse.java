...
/**
 * Response payload is a flat byte array because the per-variable value sizes depend on the data
 * types of the registered variables, which are only known at the driver layer (via the symbol
 * table). The driver parses the raw bytes using DataItem and the registered variable types.
 */
