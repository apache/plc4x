...
public class CIPEncapsulationConnectionRequest extends CIPEncapsulationPacket implements Message {
  public CIPEncapsulationConnectionRequest(Long sessionHandle, Long status,
  ...
  public static class CIPEncapsulationPacketBuilderImpl implements CIPEncapsulationPacket.CIPEncapsulationPacketBuilder {
    ...
    public CIPEncapsulationPacket build(long sessionHandle, long status, List<Short> senderContext,
        long options) {
      return new CIPEncapsulationConnectionRequest(sessionHandle, status, senderContext, options);
    }
  }
}
