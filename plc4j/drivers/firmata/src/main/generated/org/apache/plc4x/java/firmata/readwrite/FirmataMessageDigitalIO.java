...
/**
 * Bitmask containing the first 7 bits in the least significant bits of the first byte and bit 8 in
 * the second byte The 'pinBlock' refers to the block of bytes (0 refers to the first 8 pins, 1 to
