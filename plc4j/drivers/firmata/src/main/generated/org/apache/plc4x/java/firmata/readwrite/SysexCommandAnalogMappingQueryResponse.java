...
public class SysexCommandAnalogMappingQueryResponse extends SysexCommand implements Message {
  ...
  protected void serializeSysexCommandChild(WriteBuffer writeBuffer) throws SerializationException {
    ...
    writeBuffer.popContext("SysexCommandAnalogMappingQueryResponse");
  }
  ...
  public static class SysexCommandAnalogMappingQueryResponseBuilderImpl
    ...
    public SysexCommandAnalogMappingQueryResponse build() {
      SysexCommandAnalogMappingQueryResponse sysexCommandAnalogMappingQueryResponse =
          new SysexCommandAnalogMappingQueryResponse(pin);
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SysexCommandAnalogMappingQueryResponse)) {
      return false;
    }
    SysexCommandAnalogMappingQueryResponse that = (SysexCommandAnalogMappingQueryResponse) o;
