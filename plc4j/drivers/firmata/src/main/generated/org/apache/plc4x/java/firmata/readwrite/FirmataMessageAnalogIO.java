...
/**
 * Reading operations Data-Format is: in both bytes only the least significant 7 bits count
 * (unsigned 14 bit integer number) The first byte contains the least significant part The second
 * byte contains the most significant part
 */
