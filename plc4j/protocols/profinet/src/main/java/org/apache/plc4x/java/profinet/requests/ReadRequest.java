...
public class ReadRequest {
    ...
    public static final byte[] TEMPLATE = {
        ...
        ///////////////////////////////////
        // Parameter field
        FunctionCode.READ_VARIABLE.getCode(),
        ...
        VariableAddressingMode.ANY_POINTER.getCode(),
        VariableType.BYTE.getCode(),
        (byte) 0x00, (byte) 0x40,   // Number of consecutive elements of above type to read (0x40 = 64 Bytes)
        (byte) 0x00, (byte) 0x01,   // Data Block Number (Ignored if MemoryArea != DATA_BLOCKS)
        MemoryArea.DATA_BLOCKS.getCode(),
        (byte) 0x00, (byte) 0x00,   // Address (Byte offset)
        (byte) 0x00                 // Address (Bit offset - ignored if variable type is not 'bit')
    };
