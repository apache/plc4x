...
public class S7ResponseMessage extends AbstractS7Message {

    private final byte errorClass;
    private final byte errorCode;

    public S7ResponseMessage(MessageType messageType, List<S7Parameter> s7Parameters, List<S7Payload> s7Payloads,
                                     byte errorClass, byte errorCode) {
        super(TpduCode.DATA_ACKNOWLEDGEMENT, messageType, s7Parameters, s7Payloads);
