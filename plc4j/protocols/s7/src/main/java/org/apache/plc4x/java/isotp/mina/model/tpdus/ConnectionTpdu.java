...
public abstract class ConnectionTpdu extends Tpdu {
    ...
    public ConnectionTpdu(TpduCode tpduCode, short destinationReference, short sourceReference, ProtocolClass protocolClass, List<Parameter> parameters, IoBuffer userData) {
