...
import org.apache.plc4x.java.isotp.mina.model.types.RejectCause;
...
public class ErrorTpdu extends Tpdu {
    ...
    public ErrorTpdu(short destinationReference, RejectCause rejectCause, List<Parameter> parameters, IoBuffer userData) {
