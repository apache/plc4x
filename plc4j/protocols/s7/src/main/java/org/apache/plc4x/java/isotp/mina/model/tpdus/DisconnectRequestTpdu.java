...
public class DisconnectRequestTpdu extends DisconnectTpdu {
    ...
    public DisconnectRequestTpdu(short destinationReference, short sourceReference, DisconnectReason disconnectReason, List<Parameter> parameters, IoBuffer userData) {
