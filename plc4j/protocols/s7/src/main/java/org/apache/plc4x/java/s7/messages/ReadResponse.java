 ...
 * </ul>
 */
public class ReadResponse extends S7ResponseMessage {

    private final byte[] data;

    public ReadResponse(MemoryArea memoryArea, TransportSize transportSize, short numElements,
                        short dataBlockNumber, short byteOffset, byte bitOffset, byte errorClass, byte errorCode, byte[] data) {
