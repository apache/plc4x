...
/**
 * Creates connections to PLCs, without taking any responsibility for what becomes of them.
 * <p>
 * Every connection handed out belongs to the caller, who closes it - typically in a
 * try-with-resources block. A factory keeps nothing and therefore has nothing to release, which is
 * why it is not {@link AutoCloseable}. Implementations that do hold on to the connections they hand
 * out, such as a connection cache, implement {@link PlcConnectionManager} instead.
 */
