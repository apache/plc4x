...
class TestReadRequestTest {
    ...
    void testGetLengthInBytes() {
        ...
        assertEquals(0, readRequest.getLengthInBytes());
    }
    ...
    void testGetLengthInBits() {
        ...
        assertEquals(0, readRequest.getLengthInBits());
    }
    ...
    void testSerialize() throws Exception {
        ...
        assertDoesNotThrow(() -> readRequest.serialize(writeBuffer));
        String xml = writeBuffer.getXmlString();
        assertNotNull(xml);
        assertTrue(xml.contains("TestReadRequest"));
    }
}
