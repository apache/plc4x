...
public class TestReadRequest implements Message {
    ...
    public static TestReadRequest staticParse(ReadBuffer readBuffer, Object... args) throws BufferException {
        readBuffer.pushContext(WithOption.WithName("TestReadRequest"));
