...
public class Response implements org.apache.thrift.TBase<Response, Response._Fields>, java.io.Serializable, Cloneable, Comparable<Response> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,FieldResponse> fields; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.FIELDS, new org.apache.thrift.meta_data.FieldMetaData("fields", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP, 
            ...
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, FieldResponse.class))));
  ...
  public Response(
    java.util.Map<java.lang.String,FieldResponse> fields)
  {
    this();
    this.fields = fields;
  }
  ...
  public Response(Response other) {
    if (other.isSetFields()) {
      java.util.Map<java.lang.String,FieldResponse> __this__fields = new java.util.HashMap<java.lang.String,FieldResponse>(other.fields.size());
      for (java.util.Map.Entry<java.lang.String, FieldResponse> other_element : other.fields.entrySet()) {

        java.lang.String other_element_key = other_element.getKey();
        FieldResponse other_element_value = other_element.getValue();

        java.lang.String __this__fields_copy_key = other_element_key;

        FieldResponse __this__fields_copy_value = new FieldResponse(other_element_value);
  ...
  public void putToFields(java.lang.String key, FieldResponse val) {
    if (this.fields == null) {
      this.fields = new java.util.HashMap<java.lang.String,FieldResponse>();
    }
    this.fields.put(key, val);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Map<java.lang.String,FieldResponse> getFields() {
    return this.fields;
  }

  public Response setFields(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,FieldResponse> fields) {
    this.fields = fields;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case FIELDS:
      if (value == null) {
        ...
        setFields((java.util.Map<java.lang.String,FieldResponse>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.fields = new java.util.HashMap<java.lang.String,FieldResponse>(2*_map10.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key11;
                @org.apache.thrift.annotation.Nullable FieldResponse _val12;
                for (int _i13 = 0; _i13 < _map10.size; ++_i13)
                {
                  _key11 = iprot.readString();
                  _val12 = new FieldResponse();
                  _val12.read(iprot);
                  struct.fields.put(_key11, _val12);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Response struct) throws org.apache.thrift.TException {
      ...
      if (struct.fields != null) {
        oprot.writeFieldBegin(FIELDS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, FieldResponse> _iter14 : struct.fields.entrySet())
          {
      ...
      if (struct.isSetFields()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, FieldResponse> _iter15 : struct.fields.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.fields = new java.util.HashMap<java.lang.String,FieldResponse>(2*_map16.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _key17;
          @org.apache.thrift.annotation.Nullable FieldResponse _val18;
          for (int _i19 = 0; _i19 < _map16.size; ++_i19)
          {
            _key17 = iprot.readString();
            _val18 = new FieldResponse();
            _val18.read(iprot);
