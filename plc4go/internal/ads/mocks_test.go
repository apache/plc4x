...
// GetQueryString provides a mock function for the type MockSymbolicPlcQuery
func (_mock *MockSymbolicPlcQuery) GetQueryString() string {
	ret := _mock.Called()
...
func (_c *MockSymbolicPlcQuery_GetQueryString_Call) Return(s string) *MockSymbolicPlcQuery_GetQueryString_Call {
	_c.Call.Return(s)
	return _c
}
...
// GetSymbolicAddressPattern provides a mock function for the type MockSymbolicPlcQuery
func (_mock *MockSymbolicPlcQuery) GetSymbolicAddressPattern() string {
	ret := _mock.Called()
...
func (_c *MockSymbolicPlcQuery_GetSymbolicAddressPattern_Call) Return(s string) *MockSymbolicPlcQuery_GetSymbolicAddressPattern_Call {
	_c.Call.Return(s)
	return _c
}
