...
type mockConstructorTestingTNewMockSymbolicPlcQuery interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockSymbolicPlcQuery(t mockConstructorTestingTNewMockSymbolicPlcQuery) *MockSymbolicPlcQuery {
