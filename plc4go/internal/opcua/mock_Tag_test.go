...
func (_m *MockTag) GetIdentifier() string {
	ret := _m.Called()
...
func (_c *MockTag_GetIdentifier_Call) Return(_a0 string) *MockTag_GetIdentifier_Call {
	_c.Call.Return(_a0)
	return _c
}
...
// GetIdentifierType provides a mock function with given fields:
func (_m *MockTag) GetIdentifierType() readwritemodel.OpcuaIdentifierType {
	ret := _m.Called()
	...
	if rf, ok := ret.Get(0).(func() readwritemodel.OpcuaIdentifierType); ok {
		r0 = rf()
	} else {
		r0 = ret.Get(0).(readwritemodel.OpcuaIdentifierType)
	}
...
func (_c *MockTag_GetIdentifierType_Call) Return(_a0 readwritemodel.OpcuaIdentifierType) *MockTag_GetIdentifierType_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockTag_GetIdentifierType_Call) RunAndReturn(run func() readwritemodel.OpcuaIdentifierType) *MockTag_GetIdentifierType_Call {
	_c.Call.Return(run)
	return _c
}

// GetNamespace provides a mock function with given fields:
func (_m *MockTag) GetNamespace() int {
	ret := _m.Called()
...
func (_c *MockTag_GetNamespace_Call) Return(_a0 int) *MockTag_GetNamespace_Call {
	_c.Call.Return(_a0)
	return _c
}
