...
func (m HPAIDataEndpoint) Box(name string, width int) utils.AsciiBox {
	...
	// TODO  waaaa org.apache.plc4x.plugins.codegenerator.types.references.DefaultComplexTypeReference@682266d8
	boxes = append(boxes, m.HostProtocolCode.Box("hostProtocolCode", width-2))
	// Simple field (case simple)
	// TODO  waaaa org.apache.plc4x.plugins.codegenerator.types.references.DefaultComplexTypeReference@44a93f8a
