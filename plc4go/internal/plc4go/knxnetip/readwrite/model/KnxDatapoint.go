...
func KnxDatapointParse(io utils.ReadBuffer, datapointType KnxDatapointType) (api.PlcValue, error) {
	io.PullContext("KnxDatapoint")
	switch {
	case datapointType == KnxDatapointType_BOOL: // BOOL

		// Reserved Field (Just skip the bytes)
		if _, _err := io.ReadUint8("reserved", 7); _err != nil {
	...
	case datapointType == KnxDatapointType_DPT_Switch_Control: // Struct
		...
		// Reserved Field (Just skip the bytes)
		if _, _err := io.ReadUint8("reserved", 6); _err != nil {
			return nil, errors.Wrap(_err, "Error parsing reserved field")
		}

		// Simple Field (control)
		control, _controlErr := io.ReadBit("control")
		if _controlErr != nil {
	...
	case datapointType == KnxDatapointType_DPT_Bool_Control: // Struct
		...
		valueTrue, _valueTrueErr := io.ReadBit("valueTrue")
	...
	case datapointType == KnxDatapointType_DPT_Alarm_Control: // Struct
		...
		// Simple Field (alarm)
		alarm, _alarmErr := io.ReadBit("alarm")
		if _alarmErr != nil {
	...
	case datapointType == KnxDatapointType_DPT_Step_Control: // Struct
		...
		increase, _increaseErr := io.ReadBit("increase")
		if _increaseErr != nil {
	...
	case datapointType == KnxDatapointType_DPT_Direction2_Control: // Struct
		...
		// Simple Field (close)
		close, _closeErr := io.ReadBit("close")
		if _closeErr != nil {
	...
	case datapointType == KnxDatapointType_DPT_Start_Control: // Struct
		...
		// Simple Field (start)
		start, _startErr := io.ReadBit("start")
		if _startErr != nil {
	...
	case datapointType == KnxDatapointType_DPT_State_Control: // Struct
		...
		// Simple Field (active)
		active, _activeErr := io.ReadBit("active")
		if _activeErr != nil {
	...
	case datapointType == KnxDatapointType_DPT_Invert_Control: // Struct
		...
		inverted, _invertedErr := io.ReadBit("inverted")
		if _invertedErr != nil {
	...
	case datapointType == KnxDatapointType_DPT_Control_Dimming: // Struct
		...
		// Reserved Field (Just skip the bytes)
		if _, _err := io.ReadUint8("reserved", 4); _err != nil {
			return nil, errors.Wrap(_err, "Error parsing reserved field")
		}
		...
		stepcode, _stepcodeErr := io.ReadUint8("stepcode", 3)
		if _stepcodeErr != nil {
	...
	case datapointType == KnxDatapointType_DPT_Char_ASCII: // STRING
		...
		// Simple Field (value)
		value, _valueErr := io.ReadString("value", uint32((8)))
		if _valueErr != nil {
			return nil, errors.Wrap(_valueErr, "Error parsing 'value' field")
		}
		io.CloseContext("KnxDatapoint")
	...
	case datapointType == KnxDatapointType_DPT_Status_Mode3: // Struct
		...
		statusA, _statusAErr := io.ReadBit("statusA")
		if _statusAErr != nil {
		...
		statusB, _statusBErr := io.ReadBit("statusB")
		if _statusBErr != nil {
		...
		statusC, _statusCErr := io.ReadBit("statusC")
		if _statusCErr != nil {
		...
		statusD, _statusDErr := io.ReadBit("statusD")
		if _statusDErr != nil {
		...
		statusE, _statusEErr := io.ReadBit("statusE")
		if _statusEErr != nil {
		...
		// Simple Field (mode)
		mode, _modeErr := io.ReadUint8("mode", 3)
		if _modeErr != nil {
	...
	case datapointType == KnxDatapointType_DPT_Value_Temp: // REAL
		...
		// Simple Field (value)
		value, _valueErr := io.ReadFloat32("value", true, 4, 11)
		if _valueErr != nil {
			return nil, errors.Wrap(_valueErr, "Error parsing 'value' field")
		}
		io.CloseContext("KnxDatapoint")
	...
	case datapointType == KnxDatapointType_DPT_TimeOfDay: // Struct
		...
		// Simple Field (day)
		day, _dayErr := io.ReadUint8("day", 3)
		if _dayErr != nil {
			return nil, errors.Wrap(_dayErr, "Error parsing 'day' field")
		}
		...
		// Simple Field (hour)
		hour, _hourErr := io.ReadUint8("hour", 5)
		if _hourErr != nil {
			return nil, errors.Wrap(_hourErr, "Error parsing 'hour' field")
		}
		...
		// Reserved Field (Just skip the bytes)
		if _, _err := io.ReadUint8("reserved", 2); _err != nil {
			return nil, errors.Wrap(_err, "Error parsing reserved field")
		}

		// Simple Field (minutes)
		minutes, _minutesErr := io.ReadUint8("minutes", 6)
		if _minutesErr != nil {
			return nil, errors.Wrap(_minutesErr, "Error parsing 'minutes' field")
		}
		...
		// Simple Field (seconds)
		seconds, _secondsErr := io.ReadUint8("seconds", 6)
		if _secondsErr != nil {
			return nil, errors.Wrap(_secondsErr, "Error parsing 'seconds' field")
		}
	...
	case datapointType == KnxDatapointType_DPT_Date: // Struct
		...
		// Reserved Field (Just skip the bytes)
		if _, _err := io.ReadUint8("reserved", 3); _err != nil {
			return nil, errors.Wrap(_err, "Error parsing reserved field")
		}

		// Simple Field (dayOfMonth)
		dayOfMonth, _dayOfMonthErr := io.ReadUint8("dayOfMonth", 5)
		...
		// Simple Field (month)
		month, _monthErr := io.ReadUint8("month", 4)
		if _monthErr != nil {
			return nil, errors.Wrap(_monthErr, "Error parsing 'month' field")
		}
		...
		// Reserved Field (Just skip the bytes)
		if _, _err := io.ReadUint8("reserved", 1); _err != nil {
			return nil, errors.Wrap(_err, "Error parsing reserved field")
		}

		// Simple Field (year)
		year, _yearErr := io.ReadUint8("year", 7)
		if _yearErr != nil {
			return nil, errors.Wrap(_yearErr, "Error parsing 'year' field")
		}
	...
	case datapointType == KnxDatapointType_DPT_Access_Data: // Struct
		...
		// Simple Field (hurz)
		hurz, _hurzErr := io.ReadUint8("hurz", 4)
		if _hurzErr != nil {
		...
		// Simple Field (value1)
		value1, _value1Err := io.ReadUint8("value1", 4)
		if _value1Err != nil {
		...
		// Simple Field (value2)
		value2, _value2Err := io.ReadUint8("value2", 4)
		if _value2Err != nil {
		...
		// Simple Field (value3)
		value3, _value3Err := io.ReadUint8("value3", 4)
		if _value3Err != nil {
		...
		// Simple Field (value4)
		value4, _value4Err := io.ReadUint8("value4", 4)
		if _value4Err != nil {
		...
		// Simple Field (value5)
		value5, _value5Err := io.ReadUint8("value5", 4)
		if _value5Err != nil {
		...
		detectionError, _detectionErrorErr := io.ReadBit("detectionError")
		...
		permission, _permissionErr := io.ReadBit("permission")
		...
		readDirection, _readDirectionErr := io.ReadBit("readDirection")
		...
		encryptionOfAccessInformation, _encryptionOfAccessInformationErr := io.ReadBit("encryptionOfAccessInformation")
		...
		indexOfAccessIdentificationCode, _indexOfAccessIdentificationCodeErr := io.ReadUint8("indexOfAccessIdentificationCode", 4)
	...
	case datapointType == KnxDatapointType_DPT_String_ASCII: // STRING
		...
		// Simple Field (value)
		value, _valueErr := io.ReadString("value", uint32((112)))
		if _valueErr != nil {
			return nil, errors.Wrap(_valueErr, "Error parsing 'value' field")
		}
		io.CloseContext("KnxDatapoint")
	...
	case datapointType == KnxDatapointType_DPT_SceneNumber: // USINT
		...
		// Simple Field (value)
		value, _valueErr := io.ReadUint8("value", 6)
		if _valueErr != nil {
			return nil, errors.Wrap(_valueErr, "Error parsing 'value' field")
		}
		io.CloseContext("KnxDatapoint")
	...
	case datapointType == KnxDatapointType_DPT_SceneControl: // Struct
		...
		learnTheSceneCorrespondingToTheFieldSceneNumber, _learnTheSceneCorrespondingToTheFieldSceneNumberErr := io.ReadBit("learnTheSceneCorrespondingToTheFieldSceneNumber")
		...
		sceneNumber, _sceneNumberErr := io.ReadUint8("sceneNumber", 6)
	...
	case datapointType == KnxDatapointType_DPT_DateTime: // Struct
		...
		// Simple Field (year)
		year, _yearErr := io.ReadUint8("year", 8)
		if _yearErr != nil {
			return nil, errors.Wrap(_yearErr, "Error parsing 'year' field")
		}
		_map["Struct"] = values.NewPlcUSINT(year)
		...
		// Simple Field (dayofweek)
		dayofweek, _dayofweekErr := io.ReadUint8("dayofweek", 3)
		if _dayofweekErr != nil {
			return nil, errors.Wrap(_dayofweekErr, "Error parsing 'dayofweek' field")
		}
		...
		hourofday, _hourofdayErr := io.ReadUint8("hourofday", 5)
		...
		// Simple Field (fault)
		fault, _faultErr := io.ReadBit("fault")
		if _faultErr != nil {
		...
		workingDay, _workingDayErr := io.ReadBit("workingDay")
		...
		// Simple Field (noYear)
		noYear, _noYearErr := io.ReadBit("noYear")
		if _noYearErr != nil {
		...
		// Simple Field (noDate)
		noDate, _noDateErr := io.ReadBit("noDate")
		if _noDateErr != nil {
		...
		noDayOfWeek, _noDayOfWeekErr := io.ReadBit("noDayOfWeek")
		...
		// Simple Field (noTime)
		noTime, _noTimeErr := io.ReadBit("noTime")
		if _noTimeErr != nil {
		...
		standardSummerTime, _standardSummerTimeErr := io.ReadBit("standardSummerTime")
		...
		qualityOfClock, _qualityOfClockErr := io.ReadBit("qualityOfClock")
	...
	case datapointType == KnxDatapointType_DPT_StatusGen: // Struct
		...
		alarmStatusOfCorrespondingDatapointIsNotAcknowledged, _alarmStatusOfCorrespondingDatapointIsNotAcknowledgedErr := io.ReadBit("alarmStatusOfCorrespondingDatapointIsNotAcknowledged")
		...
		correspondingDatapointIsInAlarm, _correspondingDatapointIsInAlarmErr := io.ReadBit("correspondingDatapointIsInAlarm")
		...
		correspondingDatapointMainValueIsOverridden, _correspondingDatapointMainValueIsOverriddenErr := io.ReadBit("correspondingDatapointMainValueIsOverridden")
		...
		correspondingDatapointMainValueIsCorruptedDueToFailure, _correspondingDatapointMainValueIsCorruptedDueToFailureErr := io.ReadBit("correspondingDatapointMainValueIsCorruptedDueToFailure")
		...
		correspondingDatapointValueIsOutOfService, _correspondingDatapointValueIsOutOfServiceErr := io.ReadBit("correspondingDatapointValueIsOutOfService")
	...
	case datapointType == KnxDatapointType_DPT_Device_Control: // Struct
		...
		// Reserved Field (Just skip the bytes)
		if _, _err := io.ReadUint8("reserved", 5); _err != nil {
			return nil, errors.Wrap(_err, "Error parsing reserved field")
		}

		// Simple Field (verifyModeIsOn)
		verifyModeIsOn, _verifyModeIsOnErr := io.ReadBit("verifyModeIsOn")
		...
		aDatagramWithTheOwnIndividualAddressAsSourceAddressHasBeenReceived, _aDatagramWithTheOwnIndividualAddressAsSourceAddressHasBeenReceivedErr := io.ReadBit("aDatagramWithTheOwnIndividualAddressAsSourceAddressHasBeenReceived")
		...
		theUserApplicationIsStopped, _theUserApplicationIsStoppedErr := io.ReadBit("theUserApplicationIsStopped")
	...
	case datapointType == KnxDatapointType_DPT_ForceSign: // Struct
		...
		roomhmax, _roomhmaxErr := io.ReadBit("roomhmax")
		if _roomhmaxErr != nil {
		...
		roomhconf, _roomhconfErr := io.ReadBit("roomhconf")
		...
		dhwlegio, _dhwlegioErr := io.ReadBit("dhwlegio")
		if _dhwlegioErr != nil {
		...
		dhwnorm, _dhwnormErr := io.ReadBit("dhwnorm")
		if _dhwnormErr != nil {
		...
		overrun, _overrunErr := io.ReadBit("overrun")
		if _overrunErr != nil {
		...
		oversupply, _oversupplyErr := io.ReadBit("oversupply")
		...
		protection, _protectionErr := io.ReadBit("protection")
		...
		forcerequest, _forcerequestErr := io.ReadBit("forcerequest")
	...
	case datapointType == KnxDatapointType_DPT_StatusRHC: // Struct
		...
		summermode, _summermodeErr := io.ReadBit("summermode")
		...
		statusstopoptim, _statusstopoptimErr := io.ReadBit("statusstopoptim")
		...
		statusstartoptim, _statusstartoptimErr := io.ReadBit("statusstartoptim")
		...
		statusmorningboost, _statusmorningboostErr := io.ReadBit("statusmorningboost")
		...
		tempreturnlimit, _tempreturnlimitErr := io.ReadBit("tempreturnlimit")
		...
		tempflowlimit, _tempflowlimitErr := io.ReadBit("tempflowlimit")
		...
		satuseco, _satusecoErr := io.ReadBit("satuseco")
		if _satusecoErr != nil {
	...
	case datapointType == KnxDatapointType_DPT_StatusSDHWC: // Struct
		...
		solarloadsufficient, _solarloadsufficientErr := io.ReadBit("solarloadsufficient")
		...
		sdhwloadactive, _sdhwloadactiveErr := io.ReadBit("sdhwloadactive")
	...
	case datapointType == KnxDatapointType_DPT_FuelTypeSet: // Struct
		...
		solidstate, _solidstateErr := io.ReadBit("solidstate")
	...
	case datapointType == KnxDatapointType_DPT_StatusAHU: // Struct
		...
		fanactive, _fanactiveErr := io.ReadBit("fanactive")
	...
	case datapointType == KnxDatapointType_DPT_CombinedStatus_RTSM: // Struct
		...
		statusOfHvacModeUser, _statusOfHvacModeUserErr := io.ReadBit("statusOfHvacModeUser")
		...
		statusOfComfortProlongationUser, _statusOfComfortProlongationUserErr := io.ReadBit("statusOfComfortProlongationUser")
		...
		effectiveValueOfTheComfortPushButton, _effectiveValueOfTheComfortPushButtonErr := io.ReadBit("effectiveValueOfTheComfortPushButton")
		...
		effectiveValueOfThePresenceStatus, _effectiveValueOfThePresenceStatusErr := io.ReadBit("effectiveValueOfThePresenceStatus")
		...
		effectiveValueOfTheWindowStatus, _effectiveValueOfTheWindowStatusErr := io.ReadBit("effectiveValueOfTheWindowStatus")
	...
	case datapointType == KnxDatapointType_DPT_LightActuatorErrorInfo: // Struct
		...
		overheat, _overheatErr := io.ReadBit("overheat")
		if _overheatErr != nil {
		...
		lampfailure, _lampfailureErr := io.ReadBit("lampfailure")
		...
		defectiveload, _defectiveloadErr := io.ReadBit("defectiveload")
		...
		underload, _underloadErr := io.ReadBit("underload")
		...
		overcurrent, _overcurrentErr := io.ReadBit("overcurrent")
		...
		undervoltage, _undervoltageErr := io.ReadBit("undervoltage")
		...
		loaddetectionerror, _loaddetectionerrorErr := io.ReadBit("loaddetectionerror")
	...
	case datapointType == KnxDatapointType_DPT_RF_ModeInfo: // Struct
		...
		bibatSlave, _bibatSlaveErr := io.ReadBit("bibatSlave")
		...
		bibatMaster, _bibatMasterErr := io.ReadBit("bibatMaster")
		...
		asynchronous, _asynchronousErr := io.ReadBit("asynchronous")
	...
	case datapointType == KnxDatapointType_DPT_RF_FilterInfo: // Struct
		...
		// Simple Field (knxSn)
		knxSn, _knxSnErr := io.ReadBit("knxSn")
		if _knxSnErr != nil {
		...
		doaAndKnxSn, _doaAndKnxSnErr := io.ReadBit("doaAndKnxSn")
	...
	case datapointType == KnxDatapointType_DPT_Channel_Activation_8: // Struct
		...
		activationStateOfChannel1, _activationStateOfChannel1Err := io.ReadBit("activationStateOfChannel1")
		...
		activationStateOfChannel2, _activationStateOfChannel2Err := io.ReadBit("activationStateOfChannel2")
		...
		activationStateOfChannel3, _activationStateOfChannel3Err := io.ReadBit("activationStateOfChannel3")
		...
		activationStateOfChannel4, _activationStateOfChannel4Err := io.ReadBit("activationStateOfChannel4")
		...
		activationStateOfChannel5, _activationStateOfChannel5Err := io.ReadBit("activationStateOfChannel5")
		...
		activationStateOfChannel6, _activationStateOfChannel6Err := io.ReadBit("activationStateOfChannel6")
		...
		activationStateOfChannel7, _activationStateOfChannel7Err := io.ReadBit("activationStateOfChannel7")
		...
		activationStateOfChannel8, _activationStateOfChannel8Err := io.ReadBit("activationStateOfChannel8")
	...
	case datapointType == KnxDatapointType_DPT_StatusDHWC: // Struct
		...
		// Reserved Field (Just skip the bytes)
		if _, _err := io.ReadUint8("reserved", 8); _err != nil {
			return nil, errors.Wrap(_err, "Error parsing reserved field")
		}

		// Simple Field (tempoptimshiftactive)
		tempoptimshiftactive, _tempoptimshiftactiveErr := io.ReadBit("tempoptimshiftactive")
		...
		solarenergysupport, _solarenergysupportErr := io.ReadBit("solarenergysupport")
		...
		solarenergyonly, _solarenergyonlyErr := io.ReadBit("solarenergyonly")
		...
		otherenergysourceactive, _otherenergysourceactiveErr := io.ReadBit("otherenergysourceactive")
		...
		dhwpushactive, _dhwpushactiveErr := io.ReadBit("dhwpushactive")
		...
		legioprotactive, _legioprotactiveErr := io.ReadBit("legioprotactive")
		...
		dhwloadactive, _dhwloadactiveErr := io.ReadBit("dhwloadactive")
	...
	case datapointType == KnxDatapointType_DPT_StatusRHCC: // Struct
		...
		overheatalarm, _overheatalarmErr := io.ReadBit("overheatalarm")
		...
		frostalarm, _frostalarmErr := io.ReadBit("frostalarm")
		...
		dewpointstatus, _dewpointstatusErr := io.ReadBit("dewpointstatus")
		...
		coolingdisabled, _coolingdisabledErr := io.ReadBit("coolingdisabled")
		...
		statusprecool, _statusprecoolErr := io.ReadBit("statusprecool")
		...
		statusecoc, _statusecocErr := io.ReadBit("statusecoc")
		...
		heatcoolmode, _heatcoolmodeErr := io.ReadBit("heatcoolmode")
		...
		heatingdiabled, _heatingdiabledErr := io.ReadBit("heatingdiabled")
		...
		statusmorningboosth, _statusmorningboosthErr := io.ReadBit("statusmorningboosth")
		...
		tempflowreturnlimit, _tempflowreturnlimitErr := io.ReadBit("tempflowreturnlimit")
		...
		statusecoh, _statusecohErr := io.ReadBit("statusecoh")
	...
	case datapointType == KnxDatapointType_DPT_CombinedStatus_HVA: // Struct
		...
		calibrationMode, _calibrationModeErr := io.ReadBit("calibrationMode")
		...
		lockedPosition, _lockedPositionErr := io.ReadBit("lockedPosition")
		...
		forcedPosition, _forcedPositionErr := io.ReadBit("forcedPosition")
		...
		manuaOperationOverridden, _manuaOperationOverriddenErr := io.ReadBit("manuaOperationOverridden")
		...
		serviceMode, _serviceModeErr := io.ReadBit("serviceMode")
		...
		valveKick, _valveKickErr := io.ReadBit("valveKick")
		...
		overload, _overloadErr := io.ReadBit("overload")
		if _overloadErr != nil {
		...
		shortCircuit, _shortCircuitErr := io.ReadBit("shortCircuit")
		...
		currentValvePosition, _currentValvePositionErr := io.ReadBit("currentValvePosition")
	...
	case datapointType == KnxDatapointType_DPT_CombinedStatus_RTC: // Struct
		...
		coolingModeEnabled, _coolingModeEnabledErr := io.ReadBit("coolingModeEnabled")
		...
		heatingModeEnabled, _heatingModeEnabledErr := io.ReadBit("heatingModeEnabled")
		...
		additionalHeatingCoolingStage2Stage, _additionalHeatingCoolingStage2StageErr := io.ReadBit("additionalHeatingCoolingStage2Stage")
		...
		controllerInactive, _controllerInactiveErr := io.ReadBit("controllerInactive")
		...
		activeMode, _activeModeErr := io.ReadBit("activeMode")
		...
		generalFailureInformation, _generalFailureInformationErr := io.ReadBit("generalFailureInformation")
	...
	case datapointType == KnxDatapointType_DPT_Media: // Struct
		...
		// Reserved Field (Just skip the bytes)
		if _, _err := io.ReadUint16("reserved", 10); _err != nil {
			return nil, errors.Wrap(_err, "Error parsing reserved field")
		}

		// Simple Field (knxIp)
		knxIp, _knxIpErr := io.ReadBit("knxIp")
		if _knxIpErr != nil {
		...
		// Simple Field (pl110)
		pl110, _pl110Err := io.ReadBit("pl110")
		if _pl110Err != nil {
	...
	case datapointType == KnxDatapointType_DPT_Channel_Activation_16: // Struct
		...
		activationStateOfChannel9, _activationStateOfChannel9Err := io.ReadBit("activationStateOfChannel9")
		...
		activationStateOfChannel10, _activationStateOfChannel10Err := io.ReadBit("activationStateOfChannel10")
		...
		activationStateOfChannel11, _activationStateOfChannel11Err := io.ReadBit("activationStateOfChannel11")
		...
		activationStateOfChannel12, _activationStateOfChannel12Err := io.ReadBit("activationStateOfChannel12")
		...
		activationStateOfChannel13, _activationStateOfChannel13Err := io.ReadBit("activationStateOfChannel13")
		...
		activationStateOfChannel14, _activationStateOfChannel14Err := io.ReadBit("activationStateOfChannel14")
		...
		activationStateOfChannel15, _activationStateOfChannel15Err := io.ReadBit("activationStateOfChannel15")
		...
		activationStateOfChannel16, _activationStateOfChannel16Err := io.ReadBit("activationStateOfChannel16")
	...
	case datapointType == KnxDatapointType_DPT_OnOffAction: // USINT
		...
		// Simple Field (value)
		value, _valueErr := io.ReadUint8("value", 2)
		if _valueErr != nil {
			return nil, errors.Wrap(_valueErr, "Error parsing 'value' field")
		}
		io.CloseContext("KnxDatapoint")
	...
	case datapointType == KnxDatapointType_DPT_DoubleNibble: // Struct
		...
		// Simple Field (busy)
		busy, _busyErr := io.ReadUint8("busy", 4)
		if _busyErr != nil {
		...
		// Simple Field (nak)
		nak, _nakErr := io.ReadUint8("nak", 4)
		if _nakErr != nil {
	...
	case datapointType == KnxDatapointType_DPT_SceneInfo: // Struct
		...
		sceneIsInactive, _sceneIsInactiveErr := io.ReadBit("sceneIsInactive")
	...
	case datapointType == KnxDatapointType_DPT_CombinedInfoOnOff: // Struct
		...
		maskBitInfoOnOffOutput16, _maskBitInfoOnOffOutput16Err := io.ReadBit("maskBitInfoOnOffOutput16")
		...
		maskBitInfoOnOffOutput15, _maskBitInfoOnOffOutput15Err := io.ReadBit("maskBitInfoOnOffOutput15")
		...
		maskBitInfoOnOffOutput14, _maskBitInfoOnOffOutput14Err := io.ReadBit("maskBitInfoOnOffOutput14")
		...
		maskBitInfoOnOffOutput13, _maskBitInfoOnOffOutput13Err := io.ReadBit("maskBitInfoOnOffOutput13")
		...
		maskBitInfoOnOffOutput12, _maskBitInfoOnOffOutput12Err := io.ReadBit("maskBitInfoOnOffOutput12")
		...
		maskBitInfoOnOffOutput11, _maskBitInfoOnOffOutput11Err := io.ReadBit("maskBitInfoOnOffOutput11")
		...
		maskBitInfoOnOffOutput10, _maskBitInfoOnOffOutput10Err := io.ReadBit("maskBitInfoOnOffOutput10")
		...
		maskBitInfoOnOffOutput9, _maskBitInfoOnOffOutput9Err := io.ReadBit("maskBitInfoOnOffOutput9")
		...
		maskBitInfoOnOffOutput8, _maskBitInfoOnOffOutput8Err := io.ReadBit("maskBitInfoOnOffOutput8")
		...
		maskBitInfoOnOffOutput7, _maskBitInfoOnOffOutput7Err := io.ReadBit("maskBitInfoOnOffOutput7")
		...
		maskBitInfoOnOffOutput6, _maskBitInfoOnOffOutput6Err := io.ReadBit("maskBitInfoOnOffOutput6")
		...
		maskBitInfoOnOffOutput5, _maskBitInfoOnOffOutput5Err := io.ReadBit("maskBitInfoOnOffOutput5")
		...
		maskBitInfoOnOffOutput4, _maskBitInfoOnOffOutput4Err := io.ReadBit("maskBitInfoOnOffOutput4")
		...
		maskBitInfoOnOffOutput3, _maskBitInfoOnOffOutput3Err := io.ReadBit("maskBitInfoOnOffOutput3")
		...
		maskBitInfoOnOffOutput2, _maskBitInfoOnOffOutput2Err := io.ReadBit("maskBitInfoOnOffOutput2")
		...
		maskBitInfoOnOffOutput1, _maskBitInfoOnOffOutput1Err := io.ReadBit("maskBitInfoOnOffOutput1")
		...
		infoOnOffOutput16, _infoOnOffOutput16Err := io.ReadBit("infoOnOffOutput16")
		...
		infoOnOffOutput15, _infoOnOffOutput15Err := io.ReadBit("infoOnOffOutput15")
		...
		infoOnOffOutput14, _infoOnOffOutput14Err := io.ReadBit("infoOnOffOutput14")
		...
		infoOnOffOutput13, _infoOnOffOutput13Err := io.ReadBit("infoOnOffOutput13")
		...
		infoOnOffOutput12, _infoOnOffOutput12Err := io.ReadBit("infoOnOffOutput12")
		...
		infoOnOffOutput11, _infoOnOffOutput11Err := io.ReadBit("infoOnOffOutput11")
		...
		infoOnOffOutput10, _infoOnOffOutput10Err := io.ReadBit("infoOnOffOutput10")
		...
		infoOnOffOutput9, _infoOnOffOutput9Err := io.ReadBit("infoOnOffOutput9")
		...
		infoOnOffOutput8, _infoOnOffOutput8Err := io.ReadBit("infoOnOffOutput8")
		...
		infoOnOffOutput7, _infoOnOffOutput7Err := io.ReadBit("infoOnOffOutput7")
		...
		infoOnOffOutput6, _infoOnOffOutput6Err := io.ReadBit("infoOnOffOutput6")
		...
		infoOnOffOutput5, _infoOnOffOutput5Err := io.ReadBit("infoOnOffOutput5")
		...
		infoOnOffOutput4, _infoOnOffOutput4Err := io.ReadBit("infoOnOffOutput4")
		...
		infoOnOffOutput3, _infoOnOffOutput3Err := io.ReadBit("infoOnOffOutput3")
		...
		infoOnOffOutput2, _infoOnOffOutput2Err := io.ReadBit("infoOnOffOutput2")
		...
		infoOnOffOutput1, _infoOnOffOutput1Err := io.ReadBit("infoOnOffOutput1")
	...
	case datapointType == KnxDatapointType_DPT_Channel_Activation_24: // Struct
		...
		activationStateOfChannel17, _activationStateOfChannel17Err := io.ReadBit("activationStateOfChannel17")
		...
		activationStateOfChannel18, _activationStateOfChannel18Err := io.ReadBit("activationStateOfChannel18")
		...
		activationStateOfChannel19, _activationStateOfChannel19Err := io.ReadBit("activationStateOfChannel19")
		...
		activationStateOfChannel20, _activationStateOfChannel20Err := io.ReadBit("activationStateOfChannel20")
		...
		activationStateOfChannel21, _activationStateOfChannel21Err := io.ReadBit("activationStateOfChannel21")
		...
		activationStateOfChannel22, _activationStateOfChannel22Err := io.ReadBit("activationStateOfChannel22")
		...
		activationStateOfChannel23, _activationStateOfChannel23Err := io.ReadBit("activationStateOfChannel23")
		...
		activationStateOfChannel24, _activationStateOfChannel24Err := io.ReadBit("activationStateOfChannel24")
	...
	case datapointType == KnxDatapointType_DPT_HVACModeNext: // Struct
		...
		delayTimeMin, _delayTimeMinErr := io.ReadUint16("delayTimeMin", 16)
		...
		hvacMode, _hvacModeErr := io.ReadUint8("hvacMode", 8)
		if _hvacModeErr != nil {
	...
	case datapointType == KnxDatapointType_DPT_DHWModeNext: // Struct
		...
		dhwMode, _dhwModeErr := io.ReadUint8("dhwMode", 8)
		if _dhwModeErr != nil {
	...
	case datapointType == KnxDatapointType_DPT_OccModeNext: // Struct
		...
		occupancyMode, _occupancyModeErr := io.ReadUint8("occupancyMode", 8)
	...
	case datapointType == KnxDatapointType_DPT_BuildingModeNext: // Struct
		...
		buildingMode, _buildingModeErr := io.ReadUint8("buildingMode", 8)
	...
	case datapointType == KnxDatapointType_DPT_Version: // Struct
		...
		magicNumber, _magicNumberErr := io.ReadUint8("magicNumber", 5)
		...
		versionNumber, _versionNumberErr := io.ReadUint8("versionNumber", 5)
		...
		revisionNumber, _revisionNumberErr := io.ReadUint8("revisionNumber", 6)
	...
	case datapointType == KnxDatapointType_DPT_AlarmInfo: // Struct
		...
		logNumber, _logNumberErr := io.ReadUint8("logNumber", 8)
		...
		alarmPriority, _alarmPriorityErr := io.ReadUint8("alarmPriority", 8)
		...
		applicationArea, _applicationAreaErr := io.ReadUint8("applicationArea", 8)
		...
		errorcodeSup, _errorcodeSupErr := io.ReadBit("errorcodeSup")
		...
		alarmtextSup, _alarmtextSupErr := io.ReadBit("alarmtextSup")
		...
		timestampSup, _timestampSupErr := io.ReadBit("timestampSup")
		...
		// Simple Field (ackSup)
		ackSup, _ackSupErr := io.ReadBit("ackSup")
		if _ackSupErr != nil {
		...
		// Simple Field (locked)
		locked, _lockedErr := io.ReadBit("locked")
		if _lockedErr != nil {
		...
		alarmunack, _alarmunackErr := io.ReadBit("alarmunack")
		...
		inalarm, _inalarmErr := io.ReadBit("inalarm")
		if _inalarmErr != nil {
	...
	case datapointType == KnxDatapointType_DPT_TempRoomSetpSetF16_3: // Struct
		...
		tempsetpcomf, _tempsetpcomfErr := io.ReadFloat32("tempsetpcomf", true, 4, 11)
		...
		tempsetpstdby, _tempsetpstdbyErr := io.ReadFloat32("tempsetpstdby", true, 4, 11)
		...
		tempsetpeco, _tempsetpecoErr := io.ReadFloat32("tempsetpeco", true, 4, 11)
	...
	case datapointType == KnxDatapointType_DPT_TempRoomSetpSetShiftF16_3: // Struct
		...
		tempsetpshiftcomf, _tempsetpshiftcomfErr := io.ReadFloat32("tempsetpshiftcomf", true, 4, 11)
		...
		tempsetpshiftstdby, _tempsetpshiftstdbyErr := io.ReadFloat32("tempsetpshiftstdby", true, 4, 11)
		...
		tempsetpshifteco, _tempsetpshiftecoErr := io.ReadFloat32("tempsetpshifteco", true, 4, 11)
	...
	case datapointType == KnxDatapointType_DPT_Scaling_Speed: // Struct
		...
		timePeriod, _timePeriodErr := io.ReadUint16("timePeriod", 16)
		...
		percent, _percentErr := io.ReadUint8("percent", 8)
		if _percentErr != nil {
	...
	case datapointType == KnxDatapointType_DPT_MeteringValue: // Struct
		...
		countval, _countvalErr := io.ReadInt32("countval", 32)
		if _countvalErr != nil {
		...
		valinffield, _valinffieldErr := io.ReadUint8("valinffield", 8)
		...
		overridden, _overriddenErr := io.ReadBit("overridden")
		...
		outofservice, _outofserviceErr := io.ReadBit("outofservice")
	...
	case datapointType == KnxDatapointType_DPT_MBus_Address: // Struct
		...
		manufactid, _manufactidErr := io.ReadUint16("manufactid", 16)
		...
		identnumber, _identnumberErr := io.ReadUint32("identnumber", 32)
		...
		// Simple Field (medium)
		medium, _mediumErr := io.ReadUint8("medium", 8)
		if _mediumErr != nil {
	...
	case datapointType == KnxDatapointType_DPT_LanguageCodeAlpha2_ASCII: // STRING
		...
		// Simple Field (value)
		value, _valueErr := io.ReadString("value", uint32((16)))
		if _valueErr != nil {
			return nil, errors.Wrap(_valueErr, "Error parsing 'value' field")
		}
		io.CloseContext("KnxDatapoint")
	...
	case datapointType == KnxDatapointType_DPT_Tariff_ActiveEnergy: // Struct
		...
		activeelectricalenergy, _activeelectricalenergyErr := io.ReadInt32("activeelectricalenergy", 32)
		...
		// Simple Field (tariff)
		tariff, _tariffErr := io.ReadUint8("tariff", 8)
		if _tariffErr != nil {
		...
		electricalengergyvalidity, _electricalengergyvalidityErr := io.ReadBit("electricalengergyvalidity")
		...
		tariffvalidity, _tariffvalidityErr := io.ReadBit("tariffvalidity")
	...
	case datapointType == KnxDatapointType_DPT_Prioritised_Mode_Control: // Struct
		...
		deactivationOfPriority, _deactivationOfPriorityErr := io.ReadBit("deactivationOfPriority")
		...
		priorityLevel, _priorityLevelErr := io.ReadUint8("priorityLevel", 3)
		...
		modeLevel, _modeLevelErr := io.ReadUint8("modeLevel", 4)
	...
	case datapointType == KnxDatapointType_DPT_DALI_Control_Gear_Diagnostic: // Struct
		...
		convertorError, _convertorErrorErr := io.ReadBit("convertorError")
		...
		ballastFailure, _ballastFailureErr := io.ReadBit("ballastFailure")
		...
		readOrResponse, _readOrResponseErr := io.ReadBit("readOrResponse")
		...
		addressIndicator, _addressIndicatorErr := io.ReadBit("addressIndicator")
		...
		daliDeviceAddressOrDaliGroupAddress, _daliDeviceAddressOrDaliGroupAddressErr := io.ReadUint8("daliDeviceAddressOrDaliGroupAddress", 6)
	...
	case datapointType == KnxDatapointType_DPT_DALI_Diagnostics: // Struct
		...
		deviceAddress, _deviceAddressErr := io.ReadUint8("deviceAddress", 6)
	...
	case datapointType == KnxDatapointType_DPT_CombinedPosition: // Struct
		...
		heightPosition, _heightPositionErr := io.ReadUint8("heightPosition", 8)
		...
		slatsPosition, _slatsPositionErr := io.ReadUint8("slatsPosition", 8)
		...
		validityHeightPosition, _validityHeightPositionErr := io.ReadBit("validityHeightPosition")
		...
		validitySlatsPosition, _validitySlatsPositionErr := io.ReadBit("validitySlatsPosition")
	...
	case datapointType == KnxDatapointType_DPT_StatusSAB: // Struct
		...
		upperEndPosReached, _upperEndPosReachedErr := io.ReadBit("upperEndPosReached")
		...
		lowerEndPosReached, _lowerEndPosReachedErr := io.ReadBit("lowerEndPosReached")
		...
		lowerPredefPosReachedTypHeight100PercentSlatsAngle100Percent, _lowerPredefPosReachedTypHeight100PercentSlatsAngle100PercentErr := io.ReadBit("lowerPredefPosReachedTypHeight100PercentSlatsAngle100Percent")
		...
		targetPosDrive, _targetPosDriveErr := io.ReadBit("targetPosDrive")
		...
		restrictionOfTargetHeightPosPosCanNotBeReached, _restrictionOfTargetHeightPosPosCanNotBeReachedErr := io.ReadBit("restrictionOfTargetHeightPosPosCanNotBeReached")
		...
		restrictionOfSlatsHeightPosPosCanNotBeReached, _restrictionOfSlatsHeightPosPosCanNotBeReachedErr := io.ReadBit("restrictionOfSlatsHeightPosPosCanNotBeReached")
		...
		atLeastOneOfTheInputsWindRainFrostAlarmIsInAlarm, _atLeastOneOfTheInputsWindRainFrostAlarmIsInAlarmErr := io.ReadBit("atLeastOneOfTheInputsWindRainFrostAlarmIsInAlarm")
		...
		upDownPositionIsForcedByMoveupdownforcedInput, _upDownPositionIsForcedByMoveupdownforcedInputErr := io.ReadBit("upDownPositionIsForcedByMoveupdownforcedInput")
		...
		movementIsLockedEGByDevicelockedInput, _movementIsLockedEGByDevicelockedInputErr := io.ReadBit("movementIsLockedEGByDevicelockedInput")
		...
		actuatorSetvalueIsLocallyOverriddenEGViaALocalUserInterface, _actuatorSetvalueIsLocallyOverriddenEGViaALocalUserInterfaceErr := io.ReadBit("actuatorSetvalueIsLocallyOverriddenEGViaALocalUserInterface")
		...
		generalFailureOfTheActuatorOrTheDrive, _generalFailureOfTheActuatorOrTheDriveErr := io.ReadBit("generalFailureOfTheActuatorOrTheDrive")
		...
		validityHeightPos, _validityHeightPosErr := io.ReadBit("validityHeightPos")
		...
		validitySlatsPos, _validitySlatsPosErr := io.ReadBit("validitySlatsPos")
	...
	case datapointType == KnxDatapointType_DPT_Colour_xyY: // Struct
		...
		// Simple Field (xAxis)
		xAxis, _xAxisErr := io.ReadUint16("xAxis", 16)
		if _xAxisErr != nil {
		...
		// Simple Field (yAxis)
		yAxis, _yAxisErr := io.ReadUint16("yAxis", 16)
		if _yAxisErr != nil {
		...
		brightness, _brightnessErr := io.ReadUint8("brightness", 8)
		...
		validityXy, _validityXyErr := io.ReadBit("validityXy")
		...
		validityBrightness, _validityBrightnessErr := io.ReadBit("validityBrightness")
	...
	case datapointType == KnxDatapointType_DPT_Converter_Status: // Struct
		...
		converterModeAccordingToTheDaliConverterStateMachine, _converterModeAccordingToTheDaliConverterStateMachineErr := io.ReadUint8("converterModeAccordingToTheDaliConverterStateMachine", 4)
		...
		hardwiredSwitchIsActive, _hardwiredSwitchIsActiveErr := io.ReadBit("hardwiredSwitchIsActive")
		...
		hardwiredInhibitIsActive, _hardwiredInhibitIsActiveErr := io.ReadBit("hardwiredInhibitIsActive")
		...
		functionTestPending, _functionTestPendingErr := io.ReadUint8("functionTestPending", 2)
		...
		durationTestPending, _durationTestPendingErr := io.ReadUint8("durationTestPending", 2)
		...
		partialDurationTestPending, _partialDurationTestPendingErr := io.ReadUint8("partialDurationTestPending", 2)
		...
		converterFailure, _converterFailureErr := io.ReadUint8("converterFailure", 2)
	...
	case datapointType == KnxDatapointType_DPT_Converter_Test_Result: // Struct
		...
		// Simple Field (ltrf)
		ltrf, _ltrfErr := io.ReadUint8("ltrf", 4)
		if _ltrfErr != nil {
		...
		// Simple Field (ltrd)
		ltrd, _ltrdErr := io.ReadUint8("ltrd", 4)
		if _ltrdErr != nil {
		...
		// Simple Field (ltrp)
		ltrp, _ltrpErr := io.ReadUint8("ltrp", 4)
		if _ltrpErr != nil {
		...
		// Simple Field (ldtr)
		ldtr, _ldtrErr := io.ReadUint16("ldtr", 16)
		if _ldtrErr != nil {
		...
		// Simple Field (lpdtr)
		lpdtr, _lpdtrErr := io.ReadUint8("lpdtr", 8)
		if _lpdtrErr != nil {
	...
	case datapointType == KnxDatapointType_DPT_Battery_Info: // Struct
		...
		batteryFailure, _batteryFailureErr := io.ReadBit("batteryFailure")
		...
		batteryDurationFailure, _batteryDurationFailureErr := io.ReadBit("batteryDurationFailure")
		...
		batteryFullyCharged, _batteryFullyChargedErr := io.ReadBit("batteryFullyCharged")
		...
		batteryChargeLevel, _batteryChargeLevelErr := io.ReadUint8("batteryChargeLevel", 8)
	...
	case datapointType == KnxDatapointType_DPT_Brightness_Colour_Temperature_Transition: // Struct
		...
		temperatureK, _temperatureKErr := io.ReadUint16("temperatureK", 16)
		...
		validityOfTheTimePeriod, _validityOfTheTimePeriodErr := io.ReadBit("validityOfTheTimePeriod")
		...
		validityOfTheAbsoluteColourTemperature, _validityOfTheAbsoluteColourTemperatureErr := io.ReadBit("validityOfTheAbsoluteColourTemperature")
		...
		validityOfTheAbsoluteBrightness, _validityOfTheAbsoluteBrightnessErr := io.ReadBit("validityOfTheAbsoluteBrightness")
	...
	case datapointType == KnxDatapointType_DPT_Brightness_Colour_Temperature_Control: // Struct
		...
		stepCodeColourTemperature, _stepCodeColourTemperatureErr := io.ReadUint8("stepCodeColourTemperature", 3)
		...
		stepCodeBrightness, _stepCodeBrightnessErr := io.ReadUint8("stepCodeBrightness", 3)
		...
		cctAndStepCodeColourValidity, _cctAndStepCodeColourValidityErr := io.ReadBit("cctAndStepCodeColourValidity")
		...
		cbAndStepCodeBrightnessValidity, _cbAndStepCodeBrightnessValidityErr := io.ReadBit("cbAndStepCodeBrightnessValidity")
	...
	case datapointType == KnxDatapointType_DPT_Colour_RGBW: // Struct
		...
		colourLevelRed, _colourLevelRedErr := io.ReadUint8("colourLevelRed", 8)
		...
		colourLevelGreen, _colourLevelGreenErr := io.ReadUint8("colourLevelGreen", 8)
		...
		colourLevelBlue, _colourLevelBlueErr := io.ReadUint8("colourLevelBlue", 8)
		...
		colourLevelWhite, _colourLevelWhiteErr := io.ReadUint8("colourLevelWhite", 8)
	...
	case datapointType == KnxDatapointType_DPT_Relative_Control_RGBW: // Struct
		...
		// Simple Field (maskcw)
		maskcw, _maskcwErr := io.ReadBit("maskcw")
		if _maskcwErr != nil {
		...
		// Simple Field (maskcb)
		maskcb, _maskcbErr := io.ReadBit("maskcb")
		if _maskcbErr != nil {
		...
		// Simple Field (maskcg)
		maskcg, _maskcgErr := io.ReadBit("maskcg")
		if _maskcgErr != nil {
		...
		// Simple Field (maskcr)
		maskcr, _maskcrErr := io.ReadBit("maskcr")
		if _maskcrErr != nil {
		...
		stepCodeColourWhite, _stepCodeColourWhiteErr := io.ReadUint8("stepCodeColourWhite", 3)
		...
		stepCodeColourBlue, _stepCodeColourBlueErr := io.ReadUint8("stepCodeColourBlue", 3)
		...
		stepCodeColourGreen, _stepCodeColourGreenErr := io.ReadUint8("stepCodeColourGreen", 3)
		...
		stepCodeColourRed, _stepCodeColourRedErr := io.ReadUint8("stepCodeColourRed", 3)
	...
	case datapointType == KnxDatapointType_DPT_GeographicalLocation: // Struct
		...
		longitude, _longitudeErr := io.ReadFloat32("longitude", true, 8, 23)
		...
		latitude, _latitudeErr := io.ReadFloat32("latitude", true, 8, 23)
		if _latitudeErr != nil {
	...
	case datapointType == KnxDatapointType_DPT_TempRoomSetpSetF16_4: // Struct
		...
		roomTemperatureSetpointComfort, _roomTemperatureSetpointComfortErr := io.ReadFloat32("roomTemperatureSetpointComfort", true, 4, 11)
		...
		roomTemperatureSetpointStandby, _roomTemperatureSetpointStandbyErr := io.ReadFloat32("roomTemperatureSetpointStandby", true, 4, 11)
		...
		roomTemperatureSetpointEconomy, _roomTemperatureSetpointEconomyErr := io.ReadFloat32("roomTemperatureSetpointEconomy", true, 4, 11)
		...
		roomTemperatureSetpointBuildingProtection, _roomTemperatureSetpointBuildingProtectionErr := io.ReadFloat32("roomTemperatureSetpointBuildingProtection", true, 4, 11)
	...
	case datapointType == KnxDatapointType_DPT_TempRoomSetpSetShiftF16_4: // Struct
		...
		roomTemperatureSetpointShiftComfort, _roomTemperatureSetpointShiftComfortErr := io.ReadFloat32("roomTemperatureSetpointShiftComfort", true, 4, 11)
		...
		roomTemperatureSetpointShiftStandby, _roomTemperatureSetpointShiftStandbyErr := io.ReadFloat32("roomTemperatureSetpointShiftStandby", true, 4, 11)
		...
		roomTemperatureSetpointShiftEconomy, _roomTemperatureSetpointShiftEconomyErr := io.ReadFloat32("roomTemperatureSetpointShiftEconomy", true, 4, 11)
		...
		roomTemperatureSetpointShiftBuildingProtection, _roomTemperatureSetpointShiftBuildingProtectionErr := io.ReadFloat32("roomTemperatureSetpointShiftBuildingProtection", true, 4, 11)
