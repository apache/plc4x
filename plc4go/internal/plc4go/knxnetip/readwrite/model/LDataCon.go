...
func LDataConParse(io utils.ReadBuffer) (*CEMI, error) {
	if pullErr := io.PullContext("LDataCon"); pullErr != nil {
		return nil, pullErr
	}
	...
	if closeErr := io.CloseContext("LDataCon"); closeErr != nil {
		return nil, closeErr
	}
...
func (m *LDataCon) Serialize(io utils.WriteBuffer) error {
	ser := func() error {
		if pushErr := io.PushContext("LDataCon"); pushErr != nil {
			return pushErr
		}
		...
		if popErr := io.PopContext("LDataCon"); popErr != nil {
			return popErr
		}
		return nil
	}
