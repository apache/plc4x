...
func (m HPAIDiscoveryEndpoint) Box(name string, width int) utils.AsciiBox {
	...
	// TODO  waaaa org.apache.plc4x.plugins.codegenerator.types.references.DefaultComplexTypeReference@7ba06506
	boxes = append(boxes, m.HostProtocolCode.Box("hostProtocolCode", width-2))
	// Simple field (case simple)
	// TODO  waaaa org.apache.plc4x.plugins.codegenerator.types.references.DefaultComplexTypeReference@63dc3420
