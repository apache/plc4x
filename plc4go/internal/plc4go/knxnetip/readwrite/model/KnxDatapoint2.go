...
func KnxDatapoint2Parse(io *utils.ReadBuffer, formatName string) (api.PlcValue, error) {
    switch {
...
func KnxDatapoint2Serialize(io *utils.WriteBuffer, value api.PlcValue, formatName string) error {
    switch {
        case formatName == "B1": // BOOL
