...
// BACnetRestartReasonTagged is the data-structure of this message
type BACnetRestartReasonTagged struct {
...
// IBACnetRestartReasonTagged is the corresponding interface of BACnetRestartReasonTagged
type IBACnetRestartReasonTagged interface {
...
func (m *BACnetRestartReasonTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetRestartReasonTagged) GetValue() BACnetRestartReason {
	return m.Value
}

func (m *BACnetRestartReasonTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetRestartReasonTagged) GetIsProprietary() bool {
...
// NewBACnetRestartReasonTagged factory function for BACnetRestartReasonTagged
func NewBACnetRestartReasonTagged(header *BACnetTagHeader, value BACnetRestartReason, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetRestartReasonTagged {
	return &BACnetRestartReasonTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetRestartReasonTagged) GetTypeName() string {
	return "BACnetRestartReasonTagged"
}

func (m *BACnetRestartReasonTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetRestartReasonTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetRestartReasonTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetRestartReasonTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetRestartReasonTagged) String() string {
	if m == nil {
		return "<nil>"
	}
