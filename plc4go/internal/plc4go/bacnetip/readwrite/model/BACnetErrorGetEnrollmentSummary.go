...
// BACnetErrorGetEnrollmentSummary is the data-structure of this message
type BACnetErrorGetEnrollmentSummary struct {
	*BACnetError
}

// IBACnetErrorGetEnrollmentSummary is the corresponding interface of BACnetErrorGetEnrollmentSummary
