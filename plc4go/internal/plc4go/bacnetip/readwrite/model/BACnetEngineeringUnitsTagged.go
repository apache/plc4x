...
// BACnetEngineeringUnitsTagged is the data-structure of this message
type BACnetEngineeringUnitsTagged struct {
...
// IBACnetEngineeringUnitsTagged is the corresponding interface of BACnetEngineeringUnitsTagged
type IBACnetEngineeringUnitsTagged interface {
...
func (m *BACnetEngineeringUnitsTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetEngineeringUnitsTagged) GetValue() BACnetEngineeringUnits {
	return m.Value
}

func (m *BACnetEngineeringUnitsTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetEngineeringUnitsTagged) GetIsProprietary() bool {
...
// NewBACnetEngineeringUnitsTagged factory function for BACnetEngineeringUnitsTagged
func NewBACnetEngineeringUnitsTagged(header *BACnetTagHeader, value BACnetEngineeringUnits, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetEngineeringUnitsTagged {
	return &BACnetEngineeringUnitsTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetEngineeringUnitsTagged) GetTypeName() string {
	return "BACnetEngineeringUnitsTagged"
}

func (m *BACnetEngineeringUnitsTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetEngineeringUnitsTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetEngineeringUnitsTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetEngineeringUnitsTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetEngineeringUnitsTagged) String() string {
	if m == nil {
		return "<nil>"
	}
