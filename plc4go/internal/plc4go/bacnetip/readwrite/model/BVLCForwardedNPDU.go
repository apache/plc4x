...
func (m *BVLCForwardedNPDU) InitializeParent(parent *BVLCbvlcPayloadLength uint16) {
}

func NewBVLCForwardedNPDU( ip []uint8 , port uint16 , npdu *NPDU , bvlcPayloadLength uint16 ) *BVLC {	child := &BVLCForwardedNPDU{
		Ip: ip,
		Port: port,
		Npdu: npdu,
