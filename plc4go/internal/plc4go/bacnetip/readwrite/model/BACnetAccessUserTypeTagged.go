...
// BACnetAccessUserTypeTagged is the data-structure of this message
type BACnetAccessUserTypeTagged struct {
...
// IBACnetAccessUserTypeTagged is the corresponding interface of BACnetAccessUserTypeTagged
type IBACnetAccessUserTypeTagged interface {
...
func (m *BACnetAccessUserTypeTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetAccessUserTypeTagged) GetValue() BACnetAccessUserType {
	return m.Value
}

func (m *BACnetAccessUserTypeTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetAccessUserTypeTagged) GetIsProprietary() bool {
...
// NewBACnetAccessUserTypeTagged factory function for BACnetAccessUserTypeTagged
func NewBACnetAccessUserTypeTagged(header *BACnetTagHeader, value BACnetAccessUserType, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetAccessUserTypeTagged {
	return &BACnetAccessUserTypeTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetAccessUserTypeTagged) GetTypeName() string {
	return "BACnetAccessUserTypeTagged"
}

func (m *BACnetAccessUserTypeTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetAccessUserTypeTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetAccessUserTypeTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetAccessUserTypeTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetAccessUserTypeTagged) String() string {
	if m == nil {
		return "<nil>"
	}
