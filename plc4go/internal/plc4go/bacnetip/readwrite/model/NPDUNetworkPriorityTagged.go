...
// NPDUNetworkPriorityTagged is the data-structure of this message
type NPDUNetworkPriorityTagged struct {
...
// INPDUNetworkPriorityTagged is the corresponding interface of NPDUNetworkPriorityTagged
type INPDUNetworkPriorityTagged interface {
...
func (m *NPDUNetworkPriorityTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *NPDUNetworkPriorityTagged) GetValue() NPDUNetworkPriority {
	return m.Value
}
...
// NewNPDUNetworkPriorityTagged factory function for NPDUNetworkPriorityTagged
func NewNPDUNetworkPriorityTagged(header *BACnetTagHeader, value NPDUNetworkPriority, tagNumber uint8, tagClass TagClass) *NPDUNetworkPriorityTagged {
	return &NPDUNetworkPriorityTagged{Header: header, Value: value, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *NPDUNetworkPriorityTagged) GetTypeName() string {
	return "NPDUNetworkPriorityTagged"
}

func (m *NPDUNetworkPriorityTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *NPDUNetworkPriorityTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *NPDUNetworkPriorityTagged) GetLengthInBytes() uint16 {
...
func (m *NPDUNetworkPriorityTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *NPDUNetworkPriorityTagged) String() string {
	if m == nil {
		return "<nil>"
	}
