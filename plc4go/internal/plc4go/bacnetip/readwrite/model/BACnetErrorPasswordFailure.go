...
// BACnetErrorPasswordFailure is the data-structure of this message
type BACnetErrorPasswordFailure struct {
	*BACnetError
}

// IBACnetErrorPasswordFailure is the corresponding interface of BACnetErrorPasswordFailure
