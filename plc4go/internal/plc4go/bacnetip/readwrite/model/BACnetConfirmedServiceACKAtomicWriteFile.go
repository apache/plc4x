...
// BACnetConfirmedServiceACKAtomicWriteFile is the data-structure of this message
type BACnetConfirmedServiceACKAtomicWriteFile struct {
	*BACnetConfirmedServiceACK
}

// IBACnetConfirmedServiceACKAtomicWriteFile is the corresponding interface of BACnetConfirmedServiceACKAtomicWriteFile
