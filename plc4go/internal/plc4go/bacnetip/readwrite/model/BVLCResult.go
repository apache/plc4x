...
func (m *BVLCResult) InitializeParent(parent *BVLCbvlcPayloadLength uint16) {
}

func NewBVLCResult( code BVLCResultCode , bvlcPayloadLength uint16 ) *BVLC {	child := &BVLCResult{
		Code: code,
