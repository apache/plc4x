...
func (m BACnetConfirmedServiceRequestCreateObject) String() string {
	return string(m.Box("BACnetConfirmedServiceRequestCreateObject", utils.DefaultWidth*2))
}

func (m BACnetConfirmedServiceRequestCreateObject) Box(name string, width int) utils.AsciiBox {
	if name == "" {
		name = "BACnetConfirmedServiceRequestCreateObject"
	}
