...
// IBACnetSegmentationTagged is the corresponding interface of BACnetSegmentationTagged
type IBACnetSegmentationTagged interface {
...
func (m *BACnetSegmentationTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetSegmentationTagged) GetValue() BACnetSegmentation {
	return m.Value
}
...
func (m *BACnetSegmentationTagged) GetTypeName() string {
	return "BACnetSegmentationTagged"
}

func (m *BACnetSegmentationTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetSegmentationTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetSegmentationTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetSegmentationTagged) String() string {
	if m == nil {
		return "<nil>"
	}
