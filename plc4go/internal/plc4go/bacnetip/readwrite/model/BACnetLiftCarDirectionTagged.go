...
// BACnetLiftCarDirectionTagged is the data-structure of this message
type BACnetLiftCarDirectionTagged struct {
...
// IBACnetLiftCarDirectionTagged is the corresponding interface of BACnetLiftCarDirectionTagged
type IBACnetLiftCarDirectionTagged interface {
...
func (m *BACnetLiftCarDirectionTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetLiftCarDirectionTagged) GetValue() BACnetLiftCarDirection {
	return m.Value
}

func (m *BACnetLiftCarDirectionTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetLiftCarDirectionTagged) GetIsProprietary() bool {
...
// NewBACnetLiftCarDirectionTagged factory function for BACnetLiftCarDirectionTagged
func NewBACnetLiftCarDirectionTagged(header *BACnetTagHeader, value BACnetLiftCarDirection, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetLiftCarDirectionTagged {
	return &BACnetLiftCarDirectionTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetLiftCarDirectionTagged) GetTypeName() string {
	return "BACnetLiftCarDirectionTagged"
}

func (m *BACnetLiftCarDirectionTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetLiftCarDirectionTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetLiftCarDirectionTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetLiftCarDirectionTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetLiftCarDirectionTagged) String() string {
	if m == nil {
		return "<nil>"
	}
