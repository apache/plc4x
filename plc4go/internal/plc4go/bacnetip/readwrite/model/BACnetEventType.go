...
func (m BACnetEventType) LengthInBits() uint16 {
	return 9
}

func (m BACnetEventType) LengthInBytes() uint16 {
	return m.LengthInBits() / 8
}

func BACnetEventTypeParse(readBuffer utils.ReadBuffer) (BACnetEventType, error) {
	val, err := readBuffer.ReadUint16("BACnetEventType", 9)
	if err != nil {
		return 0, nil
	}
...
func (e BACnetEventType) Serialize(writeBuffer utils.WriteBuffer) error {
	return writeBuffer.WriteUint16("BACnetEventType", 9, uint16(e), utils.WithAdditionalStringRepresentation(e.name()))
}
