...
// BACnetLifeSafetyStateTagged is the data-structure of this message
type BACnetLifeSafetyStateTagged struct {
...
// IBACnetLifeSafetyStateTagged is the corresponding interface of BACnetLifeSafetyStateTagged
type IBACnetLifeSafetyStateTagged interface {
...
func (m *BACnetLifeSafetyStateTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetLifeSafetyStateTagged) GetValue() BACnetLifeSafetyState {
	return m.Value
}

func (m *BACnetLifeSafetyStateTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetLifeSafetyStateTagged) GetIsProprietary() bool {
...
// NewBACnetLifeSafetyStateTagged factory function for BACnetLifeSafetyStateTagged
func NewBACnetLifeSafetyStateTagged(header *BACnetTagHeader, value BACnetLifeSafetyState, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetLifeSafetyStateTagged {
	return &BACnetLifeSafetyStateTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetLifeSafetyStateTagged) GetTypeName() string {
	return "BACnetLifeSafetyStateTagged"
}

func (m *BACnetLifeSafetyStateTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetLifeSafetyStateTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetLifeSafetyStateTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetLifeSafetyStateTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetLifeSafetyStateTagged) String() string {
	if m == nil {
		return "<nil>"
	}
