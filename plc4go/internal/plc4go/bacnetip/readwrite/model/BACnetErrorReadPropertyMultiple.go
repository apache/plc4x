...
// BACnetErrorReadPropertyMultiple is the data-structure of this message
type BACnetErrorReadPropertyMultiple struct {
	*BACnetError
}

// IBACnetErrorReadPropertyMultiple is the corresponding interface of BACnetErrorReadPropertyMultiple
