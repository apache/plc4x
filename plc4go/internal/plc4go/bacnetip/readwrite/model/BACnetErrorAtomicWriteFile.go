...
// BACnetErrorAtomicWriteFile is the data-structure of this message
type BACnetErrorAtomicWriteFile struct {
	*BACnetError
}

// IBACnetErrorAtomicWriteFile is the corresponding interface of BACnetErrorAtomicWriteFile
...
func (m *BACnetErrorAtomicWriteFile) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetErrorAtomicWriteFile) GetLengthInBitsConditional(lastItem bool) uint16 {
	lengthInBits := uint16(m.GetParentLengthInBits())

	return lengthInBits
}

func (m *BACnetErrorAtomicWriteFile) GetLengthInBytes() uint16 {
...
func (m *BACnetErrorAtomicWriteFile) Serialize(writeBuffer utils.WriteBuffer) error {
	ser := func() error {
		if pushErr := writeBuffer.PushContext("BACnetErrorAtomicWriteFile"); pushErr != nil {
			return pushErr
		}

		if popErr := writeBuffer.PopContext("BACnetErrorAtomicWriteFile"); popErr != nil {
			return popErr
		}
		return nil
	}
