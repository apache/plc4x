...
// BACnetConfirmedServiceACKRemovedReadPropertyConditional is the data-structure of this message
type BACnetConfirmedServiceACKRemovedReadPropertyConditional struct {
	*BACnetConfirmedServiceACK
}

// IBACnetConfirmedServiceACKRemovedReadPropertyConditional is the corresponding interface of BACnetConfirmedServiceACKRemovedReadPropertyConditional
