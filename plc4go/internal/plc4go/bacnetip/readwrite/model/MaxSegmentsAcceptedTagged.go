...
// MaxSegmentsAcceptedTagged is the data-structure of this message
type MaxSegmentsAcceptedTagged struct {
...
// IMaxSegmentsAcceptedTagged is the corresponding interface of MaxSegmentsAcceptedTagged
type IMaxSegmentsAcceptedTagged interface {
...
func (m *MaxSegmentsAcceptedTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *MaxSegmentsAcceptedTagged) GetValue() MaxSegmentsAccepted {
	return m.Value
}
...
// NewMaxSegmentsAcceptedTagged factory function for MaxSegmentsAcceptedTagged
func NewMaxSegmentsAcceptedTagged(header *BACnetTagHeader, value MaxSegmentsAccepted, tagNumber uint8, tagClass TagClass) *MaxSegmentsAcceptedTagged {
	return &MaxSegmentsAcceptedTagged{Header: header, Value: value, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *MaxSegmentsAcceptedTagged) GetTypeName() string {
	return "MaxSegmentsAcceptedTagged"
}

func (m *MaxSegmentsAcceptedTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *MaxSegmentsAcceptedTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *MaxSegmentsAcceptedTagged) GetLengthInBytes() uint16 {
...
func (m *MaxSegmentsAcceptedTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *MaxSegmentsAcceptedTagged) String() string {
	if m == nil {
		return "<nil>"
	}
