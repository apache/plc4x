...
// BACnetErrorAcknowledgeAlarm is the data-structure of this message
type BACnetErrorAcknowledgeAlarm struct {
	*BACnetError
}

// IBACnetErrorAcknowledgeAlarm is the corresponding interface of BACnetErrorAcknowledgeAlarm
