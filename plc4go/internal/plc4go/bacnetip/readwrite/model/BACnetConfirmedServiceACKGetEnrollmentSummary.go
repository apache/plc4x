...
// BACnetConfirmedServiceACKGetEnrollmentSummary is the data-structure of this message
type BACnetConfirmedServiceACKGetEnrollmentSummary struct {
	*BACnetConfirmedServiceACK
}

// IBACnetConfirmedServiceACKGetEnrollmentSummary is the corresponding interface of BACnetConfirmedServiceACKGetEnrollmentSummary
