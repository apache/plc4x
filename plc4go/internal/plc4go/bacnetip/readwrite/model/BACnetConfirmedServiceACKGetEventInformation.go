...
// BACnetConfirmedServiceACKGetEventInformation is the data-structure of this message
type BACnetConfirmedServiceACKGetEventInformation struct {
	*BACnetConfirmedServiceACK
}

// IBACnetConfirmedServiceACKGetEventInformation is the corresponding interface of BACnetConfirmedServiceACKGetEventInformation
