...
func (m *BVLCReadBroadcastDistributionTableAck) InitializeParent(parent *BVLCbvlcPayloadLength uint16) {
}

func NewBVLCReadBroadcastDistributionTableAck( bvlcPayloadLength uint16 ) *BVLC {	child := &BVLCReadBroadcastDistributionTableAck{
