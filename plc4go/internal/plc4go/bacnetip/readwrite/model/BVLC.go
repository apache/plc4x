...
type IBVLCChild interface {
	Serialize(writeBuffer utils.WriteBuffer) error
	InitializeParent(parent *BVLCbvlcPayloadLength uint16)
	GetTypeName() string
	IBVLC
}

func NewBVLC( bvlcPayloadLength uint16 ) *BVLC {	return &BVLC{BvlcPayloadLength: bvlcPayloadLength}
}
...
case bvlcFunction == 0x0C : // BVLCSecureBVLL
	...
	// Finish initializing
	_parent.Child.InitializeParent(_parentbvlcPayloadLength)
	return _parent, nil
}
