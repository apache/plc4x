...
// BACnetErrorConfirmedPrivateTransfer is the data-structure of this message
type BACnetErrorConfirmedPrivateTransfer struct {
	*BACnetError
}

// IBACnetErrorConfirmedPrivateTransfer is the corresponding interface of BACnetErrorConfirmedPrivateTransfer
