...
// BACnetErrorDeviceCommunicationProtocol is the data-structure of this message
type BACnetErrorDeviceCommunicationProtocol struct {
	*BACnetError
}

// IBACnetErrorDeviceCommunicationProtocol is the corresponding interface of BACnetErrorDeviceCommunicationProtocol
...
func BACnetErrorDeviceCommunicationProtocolParse(readBuffer utils.ReadBuffer) (*BACnetErrorDeviceCommunicationProtocol, error) {
	...
	_child := &BACnetErrorDeviceCommunicationProtocol{
...
func (m *BACnetErrorDeviceCommunicationProtocol) Serialize(writeBuffer utils.WriteBuffer) error {
	ser := func() error {
		if pushErr := writeBuffer.PushContext("BACnetErrorDeviceCommunicationProtocol"); pushErr != nil {
			return pushErr
		}

		if popErr := writeBuffer.PopContext("BACnetErrorDeviceCommunicationProtocol"); popErr != nil {
			return popErr
		}
		return nil
	}
...
func (m *BACnetErrorDeviceCommunicationProtocol) String() string {
	if m == nil {
		return "<nil>"
	}
