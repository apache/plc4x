...
// BACnetConfirmedServiceACKRemovedAuthenticate is the data-structure of this message
type BACnetConfirmedServiceACKRemovedAuthenticate struct {
	*BACnetConfirmedServiceACK
}

// IBACnetConfirmedServiceACKRemovedAuthenticate is the corresponding interface of BACnetConfirmedServiceACKRemovedAuthenticate
