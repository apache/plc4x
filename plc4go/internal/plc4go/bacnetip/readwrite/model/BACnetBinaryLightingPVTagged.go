...
// BACnetBinaryLightingPVTagged is the data-structure of this message
type BACnetBinaryLightingPVTagged struct {
...
// IBACnetBinaryLightingPVTagged is the corresponding interface of BACnetBinaryLightingPVTagged
type IBACnetBinaryLightingPVTagged interface {
...
func (m *BACnetBinaryLightingPVTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetBinaryLightingPVTagged) GetValue() BACnetBinaryLightingPV {
	return m.Value
}

func (m *BACnetBinaryLightingPVTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetBinaryLightingPVTagged) GetIsProprietary() bool {
...
// NewBACnetBinaryLightingPVTagged factory function for BACnetBinaryLightingPVTagged
func NewBACnetBinaryLightingPVTagged(header *BACnetTagHeader, value BACnetBinaryLightingPV, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetBinaryLightingPVTagged {
	return &BACnetBinaryLightingPVTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetBinaryLightingPVTagged) GetTypeName() string {
	return "BACnetBinaryLightingPVTagged"
}

func (m *BACnetBinaryLightingPVTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetBinaryLightingPVTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetBinaryLightingPVTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetBinaryLightingPVTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetBinaryLightingPVTagged) String() string {
	if m == nil {
		return "<nil>"
	}
