...
func (m *BACnetNotificationParametersChangeOfBitString) InitializeParent(parent *BACnetNotificationParameters, openingTag *BACnetOpeningTag, peekedTagNumber uint8, closingTag *BACnetClosingTag) {
	m.OpeningTag = openingTag
	m.PeekedTagNumber = peekedTagNumber
	m.ClosingTag = closingTag
}

func NewBACnetNotificationParametersChangeOfBitString(innerOpeningTag *BACnetOpeningTag, changeOfBitString *BACnetContextTagBitString, statusFlags *BACnetStatusFlags, innerClosingTag *BACnetClosingTag, openingTag *BACnetOpeningTag, peekedTagNumber uint8, closingTag *BACnetClosingTag) *BACnetNotificationParameters {
...
func (m *BACnetNotificationParametersChangeOfBitString) LengthInBits() uint16 {
	return m.LengthInBitsConditional(false)
}

func (m *BACnetNotificationParametersChangeOfBitString) LengthInBitsConditional(lastItem bool) uint16 {
	...
	lengthInBits += m.ChangeOfBitString.LengthInBits()
...
func (m *BACnetNotificationParametersChangeOfBitString) LengthInBytes() uint16 {
	return m.LengthInBits() / 8
}

func BACnetNotificationParametersChangeOfBitStringParse(readBuffer utils.ReadBuffer, tagNumber uint8, peekedTagNumber uint8) (*BACnetNotificationParameters, error) {
	...
	_changeOfBitString, _changeOfBitStringErr := BACnetContextTagParse(readBuffer, uint8(0), BACnetDataType_BIT_STRING)
