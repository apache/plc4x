...
func (m *BVLCReadForeignDeviceTableAck) InitializeParent(parent *BVLCbvlcPayloadLength uint16) {
}

func NewBVLCReadForeignDeviceTableAck( bvlcPayloadLength uint16 ) *BVLC {	child := &BVLCReadForeignDeviceTableAck{
