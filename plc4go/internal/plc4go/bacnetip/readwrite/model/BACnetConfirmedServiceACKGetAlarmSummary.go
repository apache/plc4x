...
// BACnetConfirmedServiceACKGetAlarmSummary is the data-structure of this message
type BACnetConfirmedServiceACKGetAlarmSummary struct {
	*BACnetConfirmedServiceACK
}

// IBACnetConfirmedServiceACKGetAlarmSummary is the corresponding interface of BACnetConfirmedServiceACKGetAlarmSummary
