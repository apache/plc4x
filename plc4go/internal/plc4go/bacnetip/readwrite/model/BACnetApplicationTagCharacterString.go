...
// BACnetApplicationTagCharacterString is the data-structure of this message
type BACnetApplicationTagCharacterString struct {
	*BACnetApplicationTag
	Payload *BACnetTagPayloadCharacterString
}

// IBACnetApplicationTagCharacterString is the corresponding interface of BACnetApplicationTagCharacterString
