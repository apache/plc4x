...
// BACnetLiftCarDriveStatusTagged is the data-structure of this message
type BACnetLiftCarDriveStatusTagged struct {
...
// IBACnetLiftCarDriveStatusTagged is the corresponding interface of BACnetLiftCarDriveStatusTagged
type IBACnetLiftCarDriveStatusTagged interface {
...
func (m *BACnetLiftCarDriveStatusTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetLiftCarDriveStatusTagged) GetValue() BACnetLiftCarDriveStatus {
	return m.Value
}

func (m *BACnetLiftCarDriveStatusTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetLiftCarDriveStatusTagged) GetIsProprietary() bool {
...
// NewBACnetLiftCarDriveStatusTagged factory function for BACnetLiftCarDriveStatusTagged
func NewBACnetLiftCarDriveStatusTagged(header *BACnetTagHeader, value BACnetLiftCarDriveStatus, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetLiftCarDriveStatusTagged {
	return &BACnetLiftCarDriveStatusTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetLiftCarDriveStatusTagged) GetTypeName() string {
	return "BACnetLiftCarDriveStatusTagged"
}

func (m *BACnetLiftCarDriveStatusTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetLiftCarDriveStatusTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetLiftCarDriveStatusTagged) GetLengthInBytes() uint16 {
...
func BACnetLiftCarDriveStatusTaggedParse(readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (*BACnetLiftCarDriveStatusTagged, error) {
	...
	// Create the instance
	return NewBACnetLiftCarDriveStatusTagged(header, value, proprietaryValue, tagNumber, tagClass), nil
}

func (m *BACnetLiftCarDriveStatusTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetLiftCarDriveStatusTagged) String() string {
	if m == nil {
		return "<nil>"
	}
