...
func (m *BACnetConfirmedServiceRequestSubscribeCOVProperty) GetLengthInBits() uint16 {
...
func (m *BACnetConfirmedServiceRequestSubscribeCOVProperty) GetLengthInBytes() uint16 {
