...
// BACnetErrorGetEventInformation is the data-structure of this message
type BACnetErrorGetEventInformation struct {
	*BACnetError
}

// IBACnetErrorGetEventInformation is the corresponding interface of BACnetErrorGetEventInformation
