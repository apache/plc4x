...
func (m *BVLCReadForeignDeviceTable) InitializeParent(parent *BVLCbvlcPayloadLength uint16) {
}

func NewBVLCReadForeignDeviceTable( bvlcPayloadLength uint16 ) *BVLC {	child := &BVLCReadForeignDeviceTable{
