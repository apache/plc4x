...
func (m *BVLCReadBroadcastDistributionTable) InitializeParent(parent *BVLCbvlcPayloadLength uint16) {
}

func NewBVLCReadBroadcastDistributionTable( bvlcPayloadLength uint16 ) *BVLC {	child := &BVLCReadBroadcastDistributionTable{
