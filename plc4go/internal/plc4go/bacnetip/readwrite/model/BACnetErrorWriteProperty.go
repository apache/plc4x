...
// BACnetErrorWriteProperty is the data-structure of this message
type BACnetErrorWriteProperty struct {
	*BACnetError
}

// IBACnetErrorWriteProperty is the corresponding interface of BACnetErrorWriteProperty
...
func (m *BACnetErrorWriteProperty) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetErrorWriteProperty) GetLengthInBitsConditional(lastItem bool) uint16 {
	lengthInBits := uint16(m.GetParentLengthInBits())

	return lengthInBits
}

func (m *BACnetErrorWriteProperty) GetLengthInBytes() uint16 {
