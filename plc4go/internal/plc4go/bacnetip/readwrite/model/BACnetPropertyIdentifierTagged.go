...
// BACnetPropertyIdentifierTagged is the data-structure of this message
type BACnetPropertyIdentifierTagged struct {
...
// IBACnetPropertyIdentifierTagged is the corresponding interface of BACnetPropertyIdentifierTagged
type IBACnetPropertyIdentifierTagged interface {
...
func (m *BACnetPropertyIdentifierTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetPropertyIdentifierTagged) GetValue() BACnetPropertyIdentifier {
	return m.Value
}

func (m *BACnetPropertyIdentifierTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetPropertyIdentifierTagged) GetIsProprietary() bool {
...
// NewBACnetPropertyIdentifierTagged factory function for BACnetPropertyIdentifierTagged
func NewBACnetPropertyIdentifierTagged(header *BACnetTagHeader, value BACnetPropertyIdentifier, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetPropertyIdentifierTagged {
	return &BACnetPropertyIdentifierTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetPropertyIdentifierTagged) GetTypeName() string {
	return "BACnetPropertyIdentifierTagged"
}

func (m *BACnetPropertyIdentifierTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetPropertyIdentifierTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetPropertyIdentifierTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetPropertyIdentifierTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetPropertyIdentifierTagged) String() string {
	if m == nil {
		return "<nil>"
	}
