...
// CIPEncapsulationConnectionResponse is the data-structure of this message
type CIPEncapsulationConnectionResponse struct {
	*CIPEncapsulationPacket
}

// ICIPEncapsulationConnectionResponse is the corresponding interface of CIPEncapsulationConnectionResponse
