...
func FirmataMessageSubscribeAnalogPinValueParse(io utils.ReadBuffer) (*FirmataMessage, error) {
	if pullErr := io.PullContext("FirmataMessageSubscribeAnalogPinValue"); pullErr != nil {
		return nil, pullErr
	}
	...
	if closeErr := io.CloseContext("FirmataMessageSubscribeAnalogPinValue"); closeErr != nil {
		return nil, closeErr
	}
...
func (m *FirmataMessageSubscribeAnalogPinValue) Serialize(io utils.WriteBuffer) error {
	ser := func() error {
		if pushErr := io.PushContext("FirmataMessageSubscribeAnalogPinValue"); pushErr != nil {
			return pushErr
		}
		...
		if popErr := io.PopContext("FirmataMessageSubscribeAnalogPinValue"); popErr != nil {
			return popErr
		}
		return nil
	}
...
func (m *FirmataMessageSubscribeAnalogPinValue) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
	var token xml.Token
	var err error
	foundContent := false
	token = start
...
func (m *FirmataMessageSubscribeAnalogPinValue) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
...
func (m FirmataMessageSubscribeAnalogPinValue) Box(name string, width int) utils.AsciiBox {
	boxName := "FirmataMessageSubscribeAnalogPinValue"
	if name != "" {
		boxName += "/" + name
	}
