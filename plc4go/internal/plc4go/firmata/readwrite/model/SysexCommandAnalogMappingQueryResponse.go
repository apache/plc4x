...
// SysexCommandAnalogMappingQueryResponse is the data-structure of this message
type SysexCommandAnalogMappingQueryResponse struct {
	*SysexCommand
	Pin uint8
}

// ISysexCommandAnalogMappingQueryResponse is the corresponding interface of SysexCommandAnalogMappingQueryResponse
