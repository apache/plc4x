...
// ModbusPDUDiagnosticResponse is the data-structure of this message
...
// IModbusPDUDiagnosticResponse is the corresponding interface of ModbusPDUDiagnosticResponse
...
func NewModbusPDUDiagnosticResponse(subFunction uint16, data uint16) *ModbusPDUDiagnosticResponse {
	_result := &ModbusPDUDiagnosticResponse{
