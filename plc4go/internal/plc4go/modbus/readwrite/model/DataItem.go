...
func DataItemParse(io *utils.ReadBuffer, dataType ModbusDataType, numberOfValues uint16, stringLength uint16) (api.PlcValue, error) {
	switch {
	...
	case dataType == ModbusDataType_WCHAR: // List
		...
		return values.NewPlcList(value), nil
	case dataType == ModbusDataType_STRING && numberOfValues == 1: // STRING

		// Simple Field (value)
		value, _valueErr := io.ReadString(uint32((stringLength) * (8)))
		if _valueErr != nil {
			return nil, errors.Wrap(_valueErr, "Error parsing 'value' field")
		}
	...
	case dataType == ModbusDataType_STRING: // List
		...
		var value []api.PlcValue
		for i := 0; i < int(numberOfValues); i++ {
			_item, _itemErr := io.ReadString(uint32((stringLength) * (8)))
			if _itemErr != nil {
				return nil, errors.Wrap(_itemErr, "Error parsing 'value' field")
			}
		...
		return values.NewPlcList(value), nil
	case dataType == ModbusDataType_WSTRING && numberOfValues == 1: // STRING

		// Simple Field (value)
		value, _valueErr := io.ReadString(uint32((stringLength) * (16)))
		if _valueErr != nil {
			return nil, errors.Wrap(_valueErr, "Error parsing 'value' field")
		}
		return values.NewPlcSTRING(value), nil
	case dataType == ModbusDataType_WSTRING: // List
		...
		var value []api.PlcValue
		for i := 0; i < int(numberOfValues); i++ {
			_item, _itemErr := io.ReadString(uint32((stringLength) * (16)))
			if _itemErr != nil {
				return nil, errors.Wrap(_itemErr, "Error parsing 'value' field")
			}
			value = append(value, values.NewPlcSTRING(_item))
...
func DataItemSerialize(io *utils.WriteBuffer, value api.PlcValue, dataType ModbusDataType, numberOfValues uint16, stringLength uint16) error {
	switch {
	case dataType == ModbusDataType_BOOL && numberOfValues == 1: // BOOL
	...
	case dataType == ModbusDataType_STRING && numberOfValues == 1: // STRING
		...
		// Simple Field (value)
		if _err := io.WriteString(uint8(stringLength*(8)), "UTF-8", value.GetString()); _err != nil {
			return errors.Wrap(_err, "Error serializing 'value' field")
		}
	case dataType == ModbusDataType_STRING: // List
		...
		// Array Field (value)
		for i := uint32(0); i < uint32(numberOfValues); i++ {
			_itemErr := io.WriteString(uint8(stringLength*(8)), "UTF-8", value.GetIndex(i).GetString())
			if _itemErr != nil {
				return errors.Wrap(_itemErr, "Error serializing 'value' field")
			}
		}
	case dataType == ModbusDataType_WSTRING && numberOfValues == 1: // STRING
		...
		// Simple Field (value)
		if _err := io.WriteString(uint8(stringLength*(16)), "UTF-16", value.GetString()); _err != nil {
			return errors.Wrap(_err, "Error serializing 'value' field")
		}
	case dataType == ModbusDataType_WSTRING: // List
		...
		// Array Field (value)
		for i := uint32(0); i < uint32(numberOfValues); i++ {
			_itemErr := io.WriteString(uint8(stringLength*(16)), "UTF-16", value.GetIndex(i).GetString())
			if _itemErr != nil {
				return errors.Wrap(_itemErr, "Error serializing 'value' field")
			}
		}
