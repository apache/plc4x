...
// ModbusPDUReadFifoQueueResponse is the data-structure of this message
type ModbusPDUReadFifoQueueResponse struct {
	*ModbusPDU
	FifoValue []uint16
}

// IModbusPDUReadFifoQueueResponse is the corresponding interface of ModbusPDUReadFifoQueueResponse
