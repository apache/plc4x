...
// ModbusPDUReadInputRegistersRequest is the data-structure of this message
...
// IModbusPDUReadInputRegistersRequest is the corresponding interface of ModbusPDUReadInputRegistersRequest
...
func NewModbusPDUReadInputRegistersRequest(startingAddress uint16, quantity uint16) *ModbusPDUReadInputRegistersRequest {
	_result := &ModbusPDUReadInputRegistersRequest{
