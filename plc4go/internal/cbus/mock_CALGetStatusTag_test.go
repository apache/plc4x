...
type mockConstructorTestingTNewMockCALGetStatusTag interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockCALGetStatusTag(t mockConstructorTestingTNewMockCALGetStatusTag) *MockCALGetStatusTag {
