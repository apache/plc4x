...
type mockConstructorTestingTnewMock_ServiceAccessPoint interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMock_ServiceAccessPoint(t mockConstructorTestingTnewMock_ServiceAccessPoint) *mock_ServiceAccessPoint {
