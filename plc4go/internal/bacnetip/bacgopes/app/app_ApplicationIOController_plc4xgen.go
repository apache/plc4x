...
// Code generated by "plc4xGenerator -type=ApplicationIOController -prefix=app_"; DO NOT EDIT.
...
func (d *ApplicationIOController) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	...
	if err := writeBuffer.PushContext("ApplicationIOController"); err != nil {
		return err
	}
	...
	if err := writeBuffer.PushContext("queueByAddress", utils.WithRenderAsList(true)); err != nil {
		return err
	}
	for _name, elem := range d.queueByAddress {
		name := _name
	...
	if err := writeBuffer.PopContext("queueByAddress", utils.WithRenderAsList(true)); err != nil {
		return err
	}
	if err := writeBuffer.PopContext("ApplicationIOController"); err != nil {
		return err
	}
	return nil
}
