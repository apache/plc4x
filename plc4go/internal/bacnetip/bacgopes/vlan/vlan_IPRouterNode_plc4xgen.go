...
// Code generated by "plc4xGenerator -type=IPRouterNode -prefix=vlan_"; DO NOT EDIT.
...
func (d *IPRouterNode) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	...
	if d.router != nil {
		{
			_value := fmt.Sprintf("%v", d.router)

			if err := writeBuffer.WriteString("router", uint32(len(_value)*8), _value); err != nil {
				return err
			}
		}
	}
