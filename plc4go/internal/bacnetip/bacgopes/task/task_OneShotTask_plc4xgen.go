...
// Code generated by "plc4xGenerator -type=OneShotTask -prefix=task_"; DO NOT EDIT.
...
func (d *OneShotTask) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	...
	if err := writeBuffer.PushContext("OneShotTask"); err != nil {
		return err
	}
	if err := d.Task.SerializeWithWriteBuffer(ctx, writeBuffer); err != nil {
		return err
	}
	if err := writeBuffer.PopContext("OneShotTask"); err != nil {
		return err
	}
	return nil
}
