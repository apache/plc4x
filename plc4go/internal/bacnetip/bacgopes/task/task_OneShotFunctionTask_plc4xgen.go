...
// Code generated by "plc4xGenerator -type=OneShotFunctionTask -prefix=task_"; DO NOT EDIT.
...
func (d *OneShotFunctionTask) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	...
	if err := writeBuffer.PushContext("OneShotFunctionTask"); err != nil {
		return err
	}
	if err := d.OneShotDeleteTask.SerializeWithWriteBuffer(ctx, writeBuffer); err != nil {
		return err
	}
	{
	...
	if err := writeBuffer.PopContext("OneShotFunctionTask"); err != nil {
		return err
	}
	return nil
}
