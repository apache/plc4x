...
func NewIntegerValueObject(options ...Option) (*IntegerValueObject, error) {
	...
	var err error
	i.Object, err = NewObject(Combine(options, WithObjectType(objectType), WithObjectExtraProperties(properties), WithObjectSupportsCov(_object_supports_cov))...)
	if err != nil {
		return nil, errors.Wrap(err, "error creating object")
	}
	if _, err := RegisterObjectType(NKW(KWCls, i)); err != nil {
