...
// Code generated by "plc4xGenerator -type=FauxMultiplexer -prefix=helpers_"; DO NOT EDIT.
...
func (d *FauxMultiplexer) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	...
	if err := writeBuffer.PushContext("FauxMultiplexer"); err != nil {
		return err
	}
	...
	if err := writeBuffer.PopContext("FauxMultiplexer"); err != nil {
		return err
	}
	return nil
}
