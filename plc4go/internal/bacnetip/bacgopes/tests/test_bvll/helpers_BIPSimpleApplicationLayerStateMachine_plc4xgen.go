...
// Code generated by "plc4xGenerator -type=BIPSimpleApplicationLayerStateMachine -prefix=helpers_"; DO NOT EDIT.
...
func (d *BIPSimpleApplicationLayerStateMachine) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	...
	if err := writeBuffer.PushContext("BIPSimpleApplicationLayerStateMachine"); err != nil {
		return err
	}
	if err := d.ApplicationServiceElementContract.SerializeWithWriteBuffer(ctx, writeBuffer); err != nil {
		return err
	}
	if err := d.ClientStateMachine.SerializeWithWriteBuffer(ctx, writeBuffer); err != nil {
		return err
	}
	...
	if err := writeBuffer.PopContext("BIPSimpleApplicationLayerStateMachine"); err != nil {
		return err
	}
	return nil
}
