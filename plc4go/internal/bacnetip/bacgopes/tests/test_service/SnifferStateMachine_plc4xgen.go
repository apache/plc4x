...
// Code generated by "plc4xGenerator -type=SnifferStateMachine"; DO NOT EDIT.
...
func (d *SnifferStateMachine) Serialize() ([]byte, error) {
	if d == nil {
...
func (d *SnifferStateMachine) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	if d == nil {
	...
	if err := writeBuffer.PopContext("SnifferStateMachine"); err != nil {
		return err
	}
	return nil
}

func (d *SnifferStateMachine) String() string {
