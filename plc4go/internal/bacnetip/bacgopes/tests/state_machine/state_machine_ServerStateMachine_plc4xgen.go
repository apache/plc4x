...
// Code generated by "plc4xGenerator -type=ServerStateMachine -prefix=state_machine_"; DO NOT EDIT.
...
func (d *ServerStateMachine) Serialize() ([]byte, error) {
	if d == nil {
...
func (d *ServerStateMachine) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	if d == nil {
	...
	if err := writeBuffer.PopContext("ServerStateMachine"); err != nil {
		return err
	}
	return nil
}

func (d *ServerStateMachine) String() string {
