...
// Code generated by "plc4xGenerator -type=ClientStateMachine -prefix=state_machine_"; DO NOT EDIT.
...
func (d *ClientStateMachine) Serialize() ([]byte, error) {
	if d == nil {
...
func (d *ClientStateMachine) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	if d == nil {
		return fmt.Errorf("(*DeviceInfoCache)(nil)")
	}
	if err := writeBuffer.PushContext("ClientStateMachine"); err != nil {
		return err
	}
	...
	{
		_value := fmt.Sprintf("%v", d.contract)

		if err := writeBuffer.WriteString("contract", uint32(len(_value)*8), _value); err != nil {
			return err
		}
	}
	...
	if err := writeBuffer.PopContext("ClientStateMachine"); err != nil {
		return err
	}
	return nil
}

func (d *ClientStateMachine) String() string {
