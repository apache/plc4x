...
// Code generated by "plc4xGenerator -type=SnifferNode -suffix=_test"; DO NOT EDIT.
...
func (d *SnifferNode) Serialize() ([]byte, error) {
	if d == nil {
...
func (d *SnifferNode) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	if d == nil {
	...
	if err := writeBuffer.PopContext("SnifferNode"); err != nil {
		return err
	}
	return nil
}

func (d *SnifferNode) String() string {
