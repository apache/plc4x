...
// Code generated by "plc4xGenerator -type=ApplicationServiceAccessPoint -prefix=appservice_"; DO NOT EDIT.
...
func (d *ApplicationServiceAccessPoint) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	...
	if err := writeBuffer.PushContext("ApplicationServiceAccessPoint"); err != nil {
		return err
	}
	...
	if err := writeBuffer.PopContext("ApplicationServiceAccessPoint"); err != nil {
		return err
	}
	return nil
}
