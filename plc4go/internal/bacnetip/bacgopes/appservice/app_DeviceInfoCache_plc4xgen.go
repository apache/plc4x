...
// Code generated by "plc4xGenerator -type=DeviceInfoCache -prefix=app_"; DO NOT EDIT.
...
func (d *DeviceInfoCache) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	...
	if err := writeBuffer.PushContext("cache", utils.WithRenderAsList(true)); err != nil {
		return err
	}
	for _name, elem := range d.cache {
	...
	if err := writeBuffer.PopContext("cache", utils.WithRenderAsList(true)); err != nil {
		return err
	}
