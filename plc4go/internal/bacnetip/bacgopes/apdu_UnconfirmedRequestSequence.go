...
func NewUnconfirmedRequestSequence(serviceRequest model.BACnetUnconfirmedServiceRequest, opts ...func(*UnconfirmedRequestSequence)) (*UnconfirmedRequestSequence, error) {
	...
	var err error
	u.APCISequence, err = NewAPCISequence(model.NewAPDUUnconfirmedRequest(serviceRequest, 0), WithAPCISequenceExtension(u._contract))
	if err != nil {
