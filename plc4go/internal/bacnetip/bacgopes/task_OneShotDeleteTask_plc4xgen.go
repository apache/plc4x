...
// Code generated by "plc4xGenerator -type=OneShotDeleteTask -prefix=task_"; DO NOT EDIT.
...
func (d *OneShotDeleteTask) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	...
	if err := writeBuffer.PushContext("OneShotDeleteTask"); err != nil {
		return err
	}
	if err := d.Task.SerializeWithWriteBuffer(ctx, writeBuffer); err != nil {
		return err
	}
	if err := writeBuffer.PopContext("OneShotDeleteTask"); err != nil {
		return err
	}
	return nil
}
