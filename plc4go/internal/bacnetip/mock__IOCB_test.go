...
func (_m *mock_IOCB) String() string {
	ret := _m.Called()
...
// mock_IOCB_String_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'String'
type mock_IOCB_String_Call struct {
	*mock.Call
}

// String is a helper method to define mock.On call
func (_e *mock_IOCB_Expecter) String() *mock_IOCB_String_Call {
	return &mock_IOCB_String_Call{Call: _e.mock.On("String")}
}

func (_c *mock_IOCB_String_Call) Run(run func()) *mock_IOCB_String_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *mock_IOCB_String_Call) Return(_a0 string) *mock_IOCB_String_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *mock_IOCB_String_Call) RunAndReturn(run func() string) *mock_IOCB_String_Call {
	_c.Call.Return(run)
	return _c
}
