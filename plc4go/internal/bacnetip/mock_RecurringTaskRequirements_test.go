...
// MockRecurringTaskRequirements is an autogenerated mock type for the RecurringTaskRequirements type
type MockRecurringTaskRequirements struct {
	mock.Mock
}

type MockRecurringTaskRequirements_Expecter struct {
	mock *mock.Mock
}

func (_m *MockRecurringTaskRequirements) EXPECT() *MockRecurringTaskRequirements_Expecter {
...
type mockConstructorTestingTNewMockRecurringTaskRequirements interface {
	mock.TestingT
	Cleanup(func())
}

// NewMockRecurringTaskRequirements creates a new instance of MockRecurringTaskRequirements. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockRecurringTaskRequirements(t mockConstructorTestingTNewMockRecurringTaskRequirements) *MockRecurringTaskRequirements {
