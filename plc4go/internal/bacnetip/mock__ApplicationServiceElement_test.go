...
type mockConstructorTestingTnewMock_ApplicationServiceElement interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMock_ApplicationServiceElement(t mockConstructorTestingTnewMock_ApplicationServiceElement) *mock_ApplicationServiceElement {
