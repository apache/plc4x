...
// Code generated by "plc4xGenerator -type=MessageCodecRtu"; DO NOT EDIT.
...
func (d *MessageCodecRtu) Serialize() ([]byte, error) {
	if d == nil {
...
func (d *MessageCodecRtu) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	if d == nil {
		return fmt.Errorf("(*DeviceInfoCache)(nil)")
	}
	if err := writeBuffer.PushContext("MessageCodecRtu"); err != nil {
		return err
	}
	...
	{
		_value := fmt.Sprintf("%v", d.resyncSkippedBytes)

		if err := writeBuffer.WriteString("resyncSkippedBytes", uint32(len(_value)*8), _value, utils.WithEncoding("UTF-8")); err != nil {
			return err
		}
	}
	if err := writeBuffer.PopContext("MessageCodecRtu"); err != nil {
		return err
	}
	return nil
}

func (d *MessageCodecRtu) String() string {
