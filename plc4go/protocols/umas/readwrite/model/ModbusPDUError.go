...
func (m *_ModbusPDUError) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ModbusPDUError) GetLengthInBytes(ctx context.Context) uint64 {
	return m.GetLengthInBits(ctx) / 8
}

func (m *_ModbusPDUError) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ModbusPDU, umasRequestFunctionKey uint8, byteLength uint16) (__modbusPDUError ModbusPDUError, err error) {
