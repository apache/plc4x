...
func (m *_AdsDiscoveryBlockHostName) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_AdsDiscoveryBlockHostName) GetLengthInBytes(ctx context.Context) uint64 {
