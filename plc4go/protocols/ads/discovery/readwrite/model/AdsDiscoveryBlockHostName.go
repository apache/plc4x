...
func (m *_AdsDiscoveryBlockHostName) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AdsDiscoveryBlock) (_adsDiscoveryBlockHostName AdsDiscoveryBlockHostName, err error) {
