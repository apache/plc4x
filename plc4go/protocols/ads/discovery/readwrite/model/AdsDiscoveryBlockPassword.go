...
func (m *_AdsDiscoveryBlockPassword) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AdsDiscoveryBlock) (_adsDiscoveryBlockPassword AdsDiscoveryBlockPassword, err error) {
