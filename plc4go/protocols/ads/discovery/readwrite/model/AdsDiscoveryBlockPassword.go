...
func (m *_AdsDiscoveryBlockPassword) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_AdsDiscoveryBlockPassword) GetLengthInBytes(ctx context.Context) uint64 {
