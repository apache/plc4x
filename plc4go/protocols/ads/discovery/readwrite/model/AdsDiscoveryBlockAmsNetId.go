...
func (m *_AdsDiscoveryBlockAmsNetId) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AdsDiscoveryBlock) (_adsDiscoveryBlockAmsNetId AdsDiscoveryBlockAmsNetId, err error) {
