...
func AdsDiscoveryConstantsParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (AdsDiscoveryConstants, error) {
	...
	adsDiscoveryUdpDefaultPort, err := readConstField[uint16](ctx, "adsDiscoveryUdpDefaultPort", ReadUnsignedShort(readBuffer, 16), AdsDiscoveryConstants.ADSDISCOVERYUDPDEFAULTPORT)
	if err != nil {
