...
func (m *_AdsDiscoveryBlockFingerprint) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AdsDiscoveryBlock) (_adsDiscoveryBlockFingerprint AdsDiscoveryBlockFingerprint, err error) {
