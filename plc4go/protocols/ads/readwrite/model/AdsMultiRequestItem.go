...
func (m *_AdsMultiRequestItem) parse(ctx context.Context, readBuffer utils.ReadBuffer, indexGroup uint32) (_adsMultiRequestItem AdsMultiRequestItem, err error) {
