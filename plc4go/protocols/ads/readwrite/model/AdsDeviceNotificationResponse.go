...
func (m *_AdsDeviceNotificationResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AmsPacket) (_adsDeviceNotificationResponse AdsDeviceNotificationResponse, err error) {
