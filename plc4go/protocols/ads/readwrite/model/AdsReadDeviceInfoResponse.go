...
func (m *_AdsReadDeviceInfoResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AmsPacket) (_adsReadDeviceInfoResponse AdsReadDeviceInfoResponse, err error) {
