...
func (m *_AdsMultiRequestItemRead) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AdsMultiRequestItem, indexGroup uint32) (_adsMultiRequestItemRead AdsMultiRequestItemRead, err error) {
