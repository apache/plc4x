...
func (m *_AdsDeviceNotificationRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AmsPacket) (_adsDeviceNotificationRequest AdsDeviceNotificationRequest, err error) {
