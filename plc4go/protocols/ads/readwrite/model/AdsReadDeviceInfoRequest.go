...
func (m *_AdsReadDeviceInfoRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AmsPacket) (_adsReadDeviceInfoRequest AdsReadDeviceInfoRequest, err error) {
