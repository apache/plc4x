...
func (m *_AdsWriteControlRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AmsPacket) (_adsWriteControlRequest AdsWriteControlRequest, err error) {
