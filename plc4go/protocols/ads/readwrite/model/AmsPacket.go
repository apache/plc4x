...
func AmsPacketParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (AmsPacket, error) {
	...
	initCommand, err := readConstField[bool](ctx, "initCommand", ReadBoolean(readBuffer), AmsPacket.INITCOMMAND)
	if err != nil {
		return nil, errors.Wrap(err, fmt.Sprintf("Error parsing 'initCommand' field"))
	}
	_ = initCommand

	updCommand, err := readConstField[bool](ctx, "updCommand", ReadBoolean(readBuffer), AmsPacket.UPDCOMMAND)
	if err != nil {
		return nil, errors.Wrap(err, fmt.Sprintf("Error parsing 'updCommand' field"))
	}
	_ = updCommand

	timestampAdded, err := readConstField[bool](ctx, "timestampAdded", ReadBoolean(readBuffer), AmsPacket.TIMESTAMPADDED)
	if err != nil {
		return nil, errors.Wrap(err, fmt.Sprintf("Error parsing 'timestampAdded' field"))
	}
	_ = timestampAdded

	highPriorityCommand, err := readConstField[bool](ctx, "highPriorityCommand", ReadBoolean(readBuffer), AmsPacket.HIGHPRIORITYCOMMAND)
	if err != nil {
		return nil, errors.Wrap(err, fmt.Sprintf("Error parsing 'highPriorityCommand' field"))
	}
	_ = highPriorityCommand

	systemCommand, err := readConstField[bool](ctx, "systemCommand", ReadBoolean(readBuffer), AmsPacket.SYSTEMCOMMAND)
	if err != nil {
		return nil, errors.Wrap(err, fmt.Sprintf("Error parsing 'systemCommand' field"))
	}
	_ = systemCommand

	adsCommand, err := readConstField[bool](ctx, "adsCommand", ReadBoolean(readBuffer), AmsPacket.ADSCOMMAND)
	if err != nil {
		return nil, errors.Wrap(err, fmt.Sprintf("Error parsing 'adsCommand' field"))
	}
	_ = adsCommand

	noReturn, err := readConstField[bool](ctx, "noReturn", ReadBoolean(readBuffer), AmsPacket.NORETURN)
	if err != nil {
	...
	broadcast, err := readConstField[bool](ctx, "broadcast", ReadBoolean(readBuffer), AmsPacket.BROADCAST)
	if err != nil {
