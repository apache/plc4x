...
func (m *_AdsWriteControlResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AmsPacket) (_adsWriteControlResponse AdsWriteControlResponse, err error) {
