...
func (m *_AdsDataTypeTableChildEntry) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_adsDataTypeTableChildEntry AdsDataTypeTableChildEntry, err error) {
