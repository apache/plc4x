...
func (m *_AdsReadWriteRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AmsPacket) (_adsReadWriteRequest AdsReadWriteRequest, err error) {
