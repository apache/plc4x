...
func (m *_AdsReadWriteResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AmsPacket) (_adsReadWriteResponse AdsReadWriteResponse, err error) {
