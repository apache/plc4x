...
func (m *_AmsSerialAcknowledgeFrame) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_amsSerialAcknowledgeFrame AmsSerialAcknowledgeFrame, err error) {
