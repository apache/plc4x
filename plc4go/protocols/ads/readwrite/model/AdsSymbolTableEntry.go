...
func AdsSymbolTableEntryParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (AdsSymbolTableEntry, error) {
	...
	nameTerminator, err := readConstField[uint8](ctx, "nameTerminator", ReadUnsignedByte(readBuffer, 8), AdsSymbolTableEntry.NAMETERMINATOR, codegen.WithByteOrder(binary.LittleEndian))
	if err != nil {
	...
	dataTypeNameTerminator, err := readConstField[uint8](ctx, "dataTypeNameTerminator", ReadUnsignedByte(readBuffer, 8), AdsSymbolTableEntry.DATATYPENAMETERMINATOR, codegen.WithByteOrder(binary.LittleEndian))
	if err != nil {
	...
	commentTerminator, err := readConstField[uint8](ctx, "commentTerminator", ReadUnsignedByte(readBuffer, 8), AdsSymbolTableEntry.COMMENTTERMINATOR, codegen.WithByteOrder(binary.LittleEndian))
	if err != nil {
