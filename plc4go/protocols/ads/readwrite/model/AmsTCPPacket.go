...
func (m *_AmsTCPPacketBuilder) WithUserdataBuilder(builderSupplier func(AmsPacketBuilder) AmsPacketBuilder) AmsTCPPacketBuilder {
	builder := builderSupplier(m.Userdata.CreateAmsPacketBuilder())
	var err error
	m.Userdata, err = builder.Build()
	if err != nil {
		if m.err == nil {
			m.err = &utils.MultiError{MainError: errors.New("sub builder failed")}
		}
		m.err.Append(errors.Wrap(err, "AmsPacketBuilder failed"))
	}
	return m
}
