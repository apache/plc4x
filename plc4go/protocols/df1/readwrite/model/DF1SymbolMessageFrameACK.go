...
func (m *_DF1SymbolMessageFrameACK) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_DF1Symbol) (_dF1SymbolMessageFrameACK DF1SymbolMessageFrameACK, err error) {
