...
func DF1SymbolMessageFrameNAKParse(theBytes []byte) (DF1SymbolMessageFrameNAK, error) {
	return DF1SymbolMessageFrameNAKParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian)))
}
...
func (m *_DF1SymbolMessageFrameNAK) SerializeWithWriteBuffer(writeBuffer utils.WriteBuffer) error {
