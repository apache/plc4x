...
func (m *_DF1SymbolMessageFrameNAK) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_DF1Symbol) (_dF1SymbolMessageFrameNAK DF1SymbolMessageFrameNAK, err error) {
