...
func (m *_DF1UnprotectedReadResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_DF1Command) (_dF1UnprotectedReadResponse DF1UnprotectedReadResponse, err error) {
