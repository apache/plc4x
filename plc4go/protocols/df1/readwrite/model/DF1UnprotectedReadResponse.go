...
func (b *_DF1UnprotectedReadResponseBuilder) setParent(contract DF1CommandContract) {
	...
	contract.(*_DF1Command)._SubType = b._DF1UnprotectedReadResponse
}
...
if err := WriteManualArrayField[byte]( ctx, "data", m.GetData(), func(ctx context.Context, writeBuffer utils.WriteBuffer,m byte) error { return WriteData(ctx, writeBuffer, m) }, writeBuffer); err != nil{
