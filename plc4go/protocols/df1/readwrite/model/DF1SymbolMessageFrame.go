...
func (m *_DF1SymbolMessageFrameBuilder) WithCommandBuilder(builderSupplier func(DF1CommandBuilder) DF1CommandBuilder) DF1SymbolMessageFrameBuilder {
	builder := builderSupplier(m.Command.CreateDF1CommandBuilder())
	var err error
	...
	if err != nil {
		...
		m.err.Append(errors.Wrap(err, "DF1CommandBuilder failed"))
	}
	return m
}
