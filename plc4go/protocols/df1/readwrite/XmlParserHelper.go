...
func (m Df1XmlParserHelper) Parse(typeName string, xmlString string, parserArguments ...string) (any, error) {
	switch typeName {
	case "DF1Symbol":
		return DF1SymbolParseWithBuffer[DF1Symbol](context.Background(), utils.NewXmlReadBuffer(strings.NewReader(xmlString)))
	case "DF1Command":
		return DF1CommandParseWithBuffer[DF1Command](context.Background(), utils.NewXmlReadBuffer(strings.NewReader(xmlString)))
	}
