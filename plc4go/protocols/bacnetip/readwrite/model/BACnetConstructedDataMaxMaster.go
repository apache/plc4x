...
func (m *_BACnetConstructedDataMaxMaster) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataMaxMaster) GetLengthInBytes(ctx context.Context) uint64 {
