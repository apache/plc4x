...
func (m *_BACnetPropertyStatesProgramChange) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesProgramChange) GetLengthInBytes(ctx context.Context) uint64 {
