...
type BACnetPropertyStatesProgramChangeBuilder interface {
	...
	WithMandatoryFields(programState BACnetProgramStateTagged) BACnetPropertyStatesProgramChangeBuilder
	// WithProgramState adds ProgramState (property field)
	WithProgramState(BACnetProgramStateTagged) BACnetPropertyStatesProgramChangeBuilder
	// WithProgramStateBuilder adds ProgramState (property field) which is build by the builder
	WithProgramStateBuilder(func(BACnetProgramStateTaggedBuilder) BACnetProgramStateTaggedBuilder) BACnetPropertyStatesProgramChangeBuilder
...
func (m *_BACnetPropertyStatesProgramChangeBuilder) WithMandatoryFields(programState BACnetProgramStateTagged) BACnetPropertyStatesProgramChangeBuilder {
	return m.WithProgramState(programState)
}

func (m *_BACnetPropertyStatesProgramChangeBuilder) WithProgramState(programState BACnetProgramStateTagged) BACnetPropertyStatesProgramChangeBuilder {
	m.ProgramState = programState
	return m
}

func (m *_BACnetPropertyStatesProgramChangeBuilder) WithProgramStateBuilder(builderSupplier func(BACnetProgramStateTaggedBuilder) BACnetProgramStateTaggedBuilder) BACnetPropertyStatesProgramChangeBuilder {
	builder := builderSupplier(m.ProgramState.CreateBACnetProgramStateTaggedBuilder())
	var err error
	m.ProgramState, err = builder.Build()
	if err != nil {
		if m.err == nil {
			m.err = &utils.MultiError{MainError: errors.New("sub builder failed")}
		}
		m.err.Append(errors.Wrap(err, "BACnetProgramStateTaggedBuilder failed"))
	}
	return m
}

func (m *_BACnetPropertyStatesProgramChangeBuilder) Build() (BACnetPropertyStatesProgramChange, error) {
	if m.ProgramState == nil {
		if m.err == nil {
			m.err = new(utils.MultiError)
		}
		m.err.Append(errors.New("mandatory field 'programState' not set"))
	}
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._BACnetPropertyStatesProgramChange.deepCopy(), nil
}

func (m *_BACnetPropertyStatesProgramChangeBuilder) MustBuild() BACnetPropertyStatesProgramChange {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetPropertyStatesProgramChangeBuilder) DeepCopy() any {
	return m.CreateBACnetPropertyStatesProgramChangeBuilder()
}

// CreateBACnetPropertyStatesProgramChangeBuilder creates a BACnetPropertyStatesProgramChangeBuilder
func (m *_BACnetPropertyStatesProgramChange) CreateBACnetPropertyStatesProgramChangeBuilder() BACnetPropertyStatesProgramChangeBuilder {
	if m == nil {
		return NewBACnetPropertyStatesProgramChangeBuilder()
	}
	return &_BACnetPropertyStatesProgramChangeBuilder{_BACnetPropertyStatesProgramChange: m.deepCopy()}
}
