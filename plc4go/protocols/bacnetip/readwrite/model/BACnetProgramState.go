...
func (m BACnetProgramState) GetLengthInBits(ctx context.Context) uint64 {
	return 8
}

func (m BACnetProgramState) GetLengthInBytes(ctx context.Context) uint64 {
...
func BACnetProgramStateParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetProgramState, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint8("BACnetProgramState", 8)
	if err != nil {
...
func (e BACnetProgramState) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint8("BACnetProgramState", 8, uint8(uint8(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}

func (e BACnetProgramState) GetValue() uint8 {
	return uint8(e)
}
