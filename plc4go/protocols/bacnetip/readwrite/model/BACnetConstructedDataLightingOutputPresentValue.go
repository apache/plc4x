...
func (m *_BACnetConstructedDataLightingOutputPresentValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataLightingOutputPresentValue) GetLengthInBytes(ctx context.Context) uint64 {
