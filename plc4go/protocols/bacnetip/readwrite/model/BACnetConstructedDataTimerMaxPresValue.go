...
func (m *_BACnetConstructedDataTimerMaxPresValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataTimerMaxPresValue) GetLengthInBytes(ctx context.Context) uint64 {
