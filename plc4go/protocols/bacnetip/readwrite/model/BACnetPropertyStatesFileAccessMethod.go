...
func (m *_BACnetPropertyStatesFileAccessMethod) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetPropertyStates, peekedTagNumber uint8) (_bACnetPropertyStatesFileAccessMethod BACnetPropertyStatesFileAccessMethod, err error) {
