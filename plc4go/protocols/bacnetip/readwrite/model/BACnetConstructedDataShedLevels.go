...
func (m *_BACnetConstructedDataShedLevels) GetPlx4xTypeName() string {
	return "BACnetConstructedDataShedLevels"
}

func (m *_BACnetConstructedDataShedLevels) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataShedLevels) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataShedLevels) deepCopy() *_BACnetConstructedDataShedLevels {
	...
	_BACnetConstructedDataShedLevelsCopy.BACnetConstructedDataContract.(*_BACnetConstructedData)._SubType = m
