...
// BACnetAccessAuthenticationFactorDisableTagged is the data-structure of this message
type BACnetAccessAuthenticationFactorDisableTagged struct {
...
// IBACnetAccessAuthenticationFactorDisableTagged is the corresponding interface of BACnetAccessAuthenticationFactorDisableTagged
type IBACnetAccessAuthenticationFactorDisableTagged interface {
...
func (m *BACnetAccessAuthenticationFactorDisableTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetAccessAuthenticationFactorDisableTagged) GetValue() BACnetAccessAuthenticationFactorDisable {
	return m.Value
}

func (m *BACnetAccessAuthenticationFactorDisableTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetAccessAuthenticationFactorDisableTagged) GetIsProprietary() bool {
...
// NewBACnetAccessAuthenticationFactorDisableTagged factory function for BACnetAccessAuthenticationFactorDisableTagged
func NewBACnetAccessAuthenticationFactorDisableTagged(header *BACnetTagHeader, value BACnetAccessAuthenticationFactorDisable, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetAccessAuthenticationFactorDisableTagged {
	return &BACnetAccessAuthenticationFactorDisableTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetAccessAuthenticationFactorDisableTagged) GetTypeName() string {
	return "BACnetAccessAuthenticationFactorDisableTagged"
}

func (m *BACnetAccessAuthenticationFactorDisableTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetAccessAuthenticationFactorDisableTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetAccessAuthenticationFactorDisableTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetAccessAuthenticationFactorDisableTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetAccessAuthenticationFactorDisableTagged) String() string {
	if m == nil {
		return "<nil>"
	}
