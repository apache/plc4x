...
func BACnetAccessAuthenticationFactorDisableTaggedParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (BACnetAccessAuthenticationFactorDisableTagged, error) {
	...
	value, err := ReadManualField[BACnetAccessAuthenticationFactorDisable](ctx, "value", readBuffer, func(ctx context.Context) (BACnetAccessAuthenticationFactorDisable, error) {
		v, err := ReadEnumGeneric(ctx, readBuffer, header.GetActualLength(), BACnetAccessAuthenticationFactorDisable_VENDOR_PROPRIETARY_VALUE)
		var zero BACnetAccessAuthenticationFactorDisable
		if err != nil {
			return zero, err
		}
		return v.(BACnetAccessAuthenticationFactorDisable), err
	})
	if err != nil {
