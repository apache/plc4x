...
func (m *_BACnetAccessAuthenticationFactorDisableTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetAccessAuthenticationFactorDisableTagged) GetLengthInBytes(ctx context.Context) uint64 {
