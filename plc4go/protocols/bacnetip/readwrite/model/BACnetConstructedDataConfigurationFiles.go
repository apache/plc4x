...
func (m *_BACnetConstructedDataConfigurationFiles) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataConfigurationFiles) GetLengthInBytes(ctx context.Context) uint64 {
