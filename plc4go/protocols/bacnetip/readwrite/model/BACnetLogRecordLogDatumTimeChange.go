...
func (m *_BACnetLogRecordLogDatumTimeChange) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetLogRecordLogDatum, tagNumber uint8) (_bACnetLogRecordLogDatumTimeChange BACnetLogRecordLogDatumTimeChange, err error) {
