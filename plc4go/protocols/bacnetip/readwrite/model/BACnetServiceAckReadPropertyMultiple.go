...
func (m *_BACnetServiceAckReadPropertyMultiple) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetServiceAck, serviceAckPayloadLength uint32, serviceAckLength uint32) (_bACnetServiceAckReadPropertyMultiple BACnetServiceAckReadPropertyMultiple, err error) {
