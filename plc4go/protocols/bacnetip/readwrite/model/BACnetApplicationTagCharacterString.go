...
func (m *_BACnetApplicationTagCharacterString) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetApplicationTag, header BACnetTagHeader) (_bACnetApplicationTagCharacterString BACnetApplicationTagCharacterString, err error) {
