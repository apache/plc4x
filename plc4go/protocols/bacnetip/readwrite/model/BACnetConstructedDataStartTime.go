...
func (m *BACnetConstructedDataStartTime) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag) {
...
func NewBACnetConstructedDataStartTime(startTime *BACnetDateTime, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag, tagNumber uint8) *BACnetConstructedDataStartTime {
...
func BACnetConstructedDataStartTimeParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier) (*BACnetConstructedDataStartTime, error) {
...
func (m *BACnetConstructedDataStartTime) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		_startTimeErr := m.StartTime.Serialize(writeBuffer)
