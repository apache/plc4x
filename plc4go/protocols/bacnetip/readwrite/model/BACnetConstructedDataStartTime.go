...
func NewBACnetConstructedDataStartTime(openingTag BACnetOpeningTag, peekedTagHeader BACnetTagHeader, closingTag BACnetClosingTag, startTime BACnetDateTime) *_BACnetConstructedDataStartTime {
	if startTime == nil {
...
func (b *_BACnetConstructedDataStartTimeBuilder) setParent(contract BACnetConstructedDataContract) {
	...
	contract.(*_BACnetConstructedData)._SubType = b._BACnetConstructedDataStartTime
}
...
func (m *_BACnetConstructedDataStartTime) GetPlx4xTypeName() string {
	return "BACnetConstructedDataStartTime"
}

func (m *_BACnetConstructedDataStartTime) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataStartTime) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataStartTime) deepCopy() *_BACnetConstructedDataStartTime {
	...
	_BACnetConstructedDataStartTimeCopy.BACnetConstructedDataContract.(*_BACnetConstructedData)._SubType = m
