...
// BACnetCalendarEntryEnclosed is the data-structure of this message
type BACnetCalendarEntryEnclosed struct {
...
// IBACnetCalendarEntryEnclosed is the corresponding interface of BACnetCalendarEntryEnclosed
type IBACnetCalendarEntryEnclosed interface {
...
func (m *BACnetCalendarEntryEnclosed) GetOpeningTag() *BACnetOpeningTag {
	return m.OpeningTag
}

func (m *BACnetCalendarEntryEnclosed) GetCalendarEntry() *BACnetCalendarEntry {
	return m.CalendarEntry
}

func (m *BACnetCalendarEntryEnclosed) GetClosingTag() *BACnetClosingTag {
	return m.ClosingTag
}
...
// NewBACnetCalendarEntryEnclosed factory function for BACnetCalendarEntryEnclosed
func NewBACnetCalendarEntryEnclosed(openingTag *BACnetOpeningTag, calendarEntry *BACnetCalendarEntry, closingTag *BACnetClosingTag, tagNumber uint8) *BACnetCalendarEntryEnclosed {
	return &BACnetCalendarEntryEnclosed{OpeningTag: openingTag, CalendarEntry: calendarEntry, ClosingTag: closingTag, TagNumber: tagNumber}
}
...
func (m *BACnetCalendarEntryEnclosed) GetTypeName() string {
	return "BACnetCalendarEntryEnclosed"
}

func (m *BACnetCalendarEntryEnclosed) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetCalendarEntryEnclosed) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetCalendarEntryEnclosed) GetLengthInBytes() uint16 {
...
func (m *BACnetCalendarEntryEnclosed) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetCalendarEntryEnclosed) String() string {
	if m == nil {
		return "<nil>"
	}
