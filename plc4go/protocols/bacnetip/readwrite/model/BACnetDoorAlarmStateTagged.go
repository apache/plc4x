...
// BACnetDoorAlarmStateTagged is the data-structure of this message
type BACnetDoorAlarmStateTagged struct {
...
// IBACnetDoorAlarmStateTagged is the corresponding interface of BACnetDoorAlarmStateTagged
type IBACnetDoorAlarmStateTagged interface {
...
func (m *BACnetDoorAlarmStateTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetDoorAlarmStateTagged) GetValue() BACnetDoorAlarmState {
	return m.Value
}

func (m *BACnetDoorAlarmStateTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetDoorAlarmStateTagged) GetIsProprietary() bool {
...
// NewBACnetDoorAlarmStateTagged factory function for BACnetDoorAlarmStateTagged
func NewBACnetDoorAlarmStateTagged(header *BACnetTagHeader, value BACnetDoorAlarmState, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetDoorAlarmStateTagged {
	return &BACnetDoorAlarmStateTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetDoorAlarmStateTagged) GetTypeName() string {
	return "BACnetDoorAlarmStateTagged"
}

func (m *BACnetDoorAlarmStateTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetDoorAlarmStateTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetDoorAlarmStateTagged) GetLengthInBytes() uint16 {
	return m.GetLengthInBits() / 8
}

func BACnetDoorAlarmStateTaggedParse(readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (*BACnetDoorAlarmStateTagged, error) {
...
func (m *BACnetDoorAlarmStateTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetDoorAlarmStateTagged) String() string {
	if m == nil {
		return "<nil>"
	}
