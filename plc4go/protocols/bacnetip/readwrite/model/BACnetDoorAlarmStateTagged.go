...
func (m *_BACnetDoorAlarmStateTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *_BACnetDoorAlarmStateTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *_BACnetDoorAlarmStateTagged) GetLengthInBytes() uint16 {
...
func BACnetDoorAlarmStateTaggedParse(theBytes []byte, tagNumber uint8, tagClass TagClass) (BACnetDoorAlarmStateTagged, error) {
	return BACnetDoorAlarmStateTaggedParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian)), tagNumber, tagClass) // TODO: get endianness from mspec
}

func BACnetDoorAlarmStateTaggedParseWithBuffer(readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (BACnetDoorAlarmStateTagged, error) {
...
func (m *_BACnetDoorAlarmStateTagged) SerializeWithWriteBuffer(writeBuffer utils.WriteBuffer) error {
