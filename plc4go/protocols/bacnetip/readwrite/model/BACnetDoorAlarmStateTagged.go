...
func (m *_BACnetDoorAlarmStateTagged) GetPlx4xTypeName() string {
	return "BACnetDoorAlarmStateTagged"
}

func (m *_BACnetDoorAlarmStateTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetDoorAlarmStateTagged) GetLengthInBytes(ctx context.Context) uint64 {
