...
// BACnetConstructedDataIntegerValueMinPresValue is the data-structure of this message
type BACnetConstructedDataIntegerValueMinPresValue struct {
...
type IBACnetConstructedDataIntegerValueMinPresValue interface {
...
func (m *BACnetConstructedDataIntegerValueMinPresValue) GetObjectTypeArgument() BACnetObjectType {
	return BACnetObjectType_INTEGER_VALUE
}

func (m *BACnetConstructedDataIntegerValueMinPresValue) GetPropertyIdentifierArgument() BACnetPropertyIdentifier {
...
func (m *BACnetConstructedDataIntegerValueMinPresValue) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag) {
	m.BACnetConstructedData.OpeningTag = openingTag
	m.BACnetConstructedData.PeekedTagHeader = peekedTagHeader
	m.BACnetConstructedData.ClosingTag = closingTag
}

func (m *BACnetConstructedDataIntegerValueMinPresValue) GetParent() *BACnetConstructedData {
...
func (m *BACnetConstructedDataIntegerValueMinPresValue) GetMinPresValue() *BACnetApplicationTagSignedInteger {
...
func (m *BACnetConstructedDataIntegerValueMinPresValue) GetActualValue() *BACnetApplicationTagSignedInteger {
...
func CastBACnetConstructedDataIntegerValueMinPresValue(structType interface{}) *BACnetConstructedDataIntegerValueMinPresValue {
	...
	if casted, ok := structType.(BACnetConstructedData); ok {
		return CastBACnetConstructedDataIntegerValueMinPresValue(casted.Child)
	}
	if casted, ok := structType.(*BACnetConstructedData); ok {
		return CastBACnetConstructedDataIntegerValueMinPresValue(casted.Child)
	}
...
func (m *BACnetConstructedDataIntegerValueMinPresValue) GetTypeName() string {
	return "BACnetConstructedDataIntegerValueMinPresValue"
}

func (m *BACnetConstructedDataIntegerValueMinPresValue) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetConstructedDataIntegerValueMinPresValue) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetConstructedDataIntegerValueMinPresValue) GetLengthInBytes() uint16 {
...
func BACnetConstructedDataIntegerValueMinPresValueParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) (*BACnetConstructedDataIntegerValueMinPresValue, error) {
	...
	_child := &BACnetConstructedDataIntegerValueMinPresValue{
		MinPresValue:          CastBACnetApplicationTagSignedInteger(minPresValue),
...
func (m *BACnetConstructedDataIntegerValueMinPresValue) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetConstructedDataIntegerValueMinPresValue) String() string {
	if m == nil {
		return "<nil>"
	}
