...
func (m *_BACnetLandingDoorStatusLandingDoorsListEntry) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_bACnetLandingDoorStatusLandingDoorsListEntry BACnetLandingDoorStatusLandingDoorsListEntry, err error) {
