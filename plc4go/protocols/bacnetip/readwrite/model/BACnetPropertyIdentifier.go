...
func BACnetPropertyIdentifierParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetPropertyIdentifier, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint32("BACnetPropertyIdentifier", 32)
	if err != nil {
...
func (e BACnetPropertyIdentifier) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint32("BACnetPropertyIdentifier", 32, uint32(uint32(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}

func (e BACnetPropertyIdentifier) GetValue() uint32 {
	return uint32(e)
}
