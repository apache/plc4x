...
func (m *_BACnetConstructedDataMusterPoint) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataMusterPoint) GetLengthInBytes(ctx context.Context) uint64 {
