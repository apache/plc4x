...
func BACnetConstructedDataSegmentationSupportedParse(theBytes []byte, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier, arrayIndexArgument BACnetTagPayloadUnsignedInteger) (BACnetConstructedDataSegmentationSupported, error) {
	return BACnetConstructedDataSegmentationSupportedParseWithBuffer(utils.NewReadBufferByteBased(theBytes), tagNumber, objectTypeArgument, propertyIdentifierArgument, arrayIndexArgument)
}
...
func (m *_BACnetConstructedDataSegmentationSupported) SerializeWithWriteBuffer(writeBuffer utils.WriteBuffer) error {
