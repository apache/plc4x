...
// BACnetConstructedDataEventDetectionEnable is the data-structure of this message
type BACnetConstructedDataEventDetectionEnable struct {
...
type IBACnetConstructedDataEventDetectionEnable interface {
...
func (m *BACnetConstructedDataEventDetectionEnable) GetObjectTypeArgument() BACnetObjectType {
	return 0
}

func (m *BACnetConstructedDataEventDetectionEnable) GetPropertyIdentifierArgument() BACnetPropertyIdentifier {
...
func (m *BACnetConstructedDataEventDetectionEnable) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag) {
	m.BACnetConstructedData.OpeningTag = openingTag
	m.BACnetConstructedData.ClosingTag = closingTag
}

func (m *BACnetConstructedDataEventDetectionEnable) GetParent() *BACnetConstructedData {
...
func (m *BACnetConstructedDataEventDetectionEnable) GetEventDetectionEnable() *BACnetApplicationTagBoolean {
...
func NewBACnetConstructedDataEventDetectionEnable(eventDetectionEnable *BACnetApplicationTagBoolean, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag, tagNumber uint8) *BACnetConstructedDataEventDetectionEnable {
...
func CastBACnetConstructedDataEventDetectionEnable(structType interface{}) *BACnetConstructedDataEventDetectionEnable {
	...
	if casted, ok := structType.(BACnetConstructedData); ok {
		return CastBACnetConstructedDataEventDetectionEnable(casted.Child)
	}
	if casted, ok := structType.(*BACnetConstructedData); ok {
		return CastBACnetConstructedDataEventDetectionEnable(casted.Child)
	}
...
func (m *BACnetConstructedDataEventDetectionEnable) GetTypeName() string {
	return "BACnetConstructedDataEventDetectionEnable"
}

func (m *BACnetConstructedDataEventDetectionEnable) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetConstructedDataEventDetectionEnable) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetConstructedDataEventDetectionEnable) GetLengthInBytes() uint16 {
...
func BACnetConstructedDataEventDetectionEnableParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier) (*BACnetConstructedDataEventDetectionEnable, error) {
	...
	_child := &BACnetConstructedDataEventDetectionEnable{
...
func (m *BACnetConstructedDataEventDetectionEnable) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetConstructedDataEventDetectionEnable) String() string {
	if m == nil {
		return "<nil>"
	}
