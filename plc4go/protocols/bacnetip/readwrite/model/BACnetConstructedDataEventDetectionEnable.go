...
func (m *BACnetConstructedDataEventDetectionEnable) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag) {
...
func (m *BACnetConstructedDataEventDetectionEnable) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		_eventDetectionEnableErr := writeBuffer.WriteSerializable(m.EventDetectionEnable)
