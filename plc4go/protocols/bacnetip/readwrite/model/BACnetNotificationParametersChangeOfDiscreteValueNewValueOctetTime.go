...
func (m *_BACnetNotificationParametersChangeOfDiscreteValueNewValueOctetTime) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetNotificationParametersChangeOfDiscreteValueNewValue, tagNumber uint8) (_bACnetNotificationParametersChangeOfDiscreteValueNewValueOctetTime BACnetNotificationParametersChangeOfDiscreteValueNewValueOctetTime, err error) {
