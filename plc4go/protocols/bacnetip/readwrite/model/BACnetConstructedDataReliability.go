...
func (m *BACnetConstructedDataReliability) GetObjectTypeArgument() BACnetObjectType {
	return 0
}
...
func (m *BACnetConstructedDataReliability) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag) {
...
func (m *BACnetConstructedDataReliability) GetActualValue() *BACnetReliabilityTagged {
...
func BACnetConstructedDataReliabilityParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) (*BACnetConstructedDataReliability, error) {
	...
	actualValue := CastBACnetReliabilityTagged(_actualValue)
	_ = actualValue
