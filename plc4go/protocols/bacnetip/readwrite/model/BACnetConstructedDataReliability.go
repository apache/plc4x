...
func (m *_BACnetConstructedDataReliability) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataReliability) GetLengthInBytes(ctx context.Context) uint64 {
