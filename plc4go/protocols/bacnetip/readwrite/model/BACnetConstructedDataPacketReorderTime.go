...
func (m *_BACnetConstructedDataPacketReorderTime) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataPacketReorderTime) GetLengthInBytes(ctx context.Context) uint64 {
