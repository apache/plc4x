...
func (m *_BACnetNotificationParametersChangeOfStatusFlagsBuilder) WithPresentValueBuilder(builderSupplier func(BACnetConstructedDataBuilder) BACnetConstructedDataBuilder) BACnetNotificationParametersChangeOfStatusFlagsBuilder {
	builder := builderSupplier(m.PresentValue.CreateBACnetConstructedDataBuilder())
	var err error
