...
func (m *BACnetConstructedDataIPv6DHCPLeaseTimeRemaining) GetActualValue() *BACnetApplicationTagUnsignedInteger {
...
func (m *BACnetConstructedDataIPv6DHCPLeaseTimeRemaining) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		_ipv6DhcpLeaseTimeRemainingErr := writeBuffer.WriteSerializable(m.Ipv6DhcpLeaseTimeRemaining)
