...
func (m *_BACnetChannelValueBoolean) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetChannelValue) (_bACnetChannelValueBoolean BACnetChannelValueBoolean, err error) {
