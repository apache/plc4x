...
func (m *_BACnetTagPayloadSignedInteger) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetTagPayloadSignedInteger) GetLengthInBytes(ctx context.Context) uint64 {
