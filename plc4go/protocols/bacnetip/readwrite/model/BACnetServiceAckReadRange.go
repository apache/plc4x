...
func (m *_BACnetServiceAckReadRange) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetServiceAckReadRange) GetLengthInBytes(ctx context.Context) uint64 {
