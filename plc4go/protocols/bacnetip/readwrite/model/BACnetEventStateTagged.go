...
// BACnetEventStateTagged is the data-structure of this message
type BACnetEventStateTagged struct {
...
// IBACnetEventStateTagged is the corresponding interface of BACnetEventStateTagged
type IBACnetEventStateTagged interface {
...
func (m *BACnetEventStateTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetEventStateTagged) GetValue() BACnetEventState {
	return m.Value
}

func (m *BACnetEventStateTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetEventStateTagged) GetIsProprietary() bool {
...
// NewBACnetEventStateTagged factory function for BACnetEventStateTagged
func NewBACnetEventStateTagged(header *BACnetTagHeader, value BACnetEventState, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetEventStateTagged {
	return &BACnetEventStateTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetEventStateTagged) GetTypeName() string {
	return "BACnetEventStateTagged"
}

func (m *BACnetEventStateTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetEventStateTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetEventStateTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetEventStateTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetEventStateTagged) String() string {
	if m == nil {
		return "<nil>"
	}
