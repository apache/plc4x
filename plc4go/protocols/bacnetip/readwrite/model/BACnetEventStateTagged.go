...
func (m *_BACnetEventStateTagged) GetPlx4xTypeName() string {
	return "BACnetEventStateTagged"
}

func (m *_BACnetEventStateTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetEventStateTagged) GetLengthInBytes(ctx context.Context) uint64 {
