...
// LifeSafetyZone is the corresponding interface of LifeSafetyZone
type LifeSafetyZone interface {
	fmt.Stringer
	utils.LengthAware
	utils.Serializable
	utils.Copyable
	...
	// GetZoneMembers returns ZoneMembers (property field)
	...
	// IsLifeSafetyZone is a marker method to prevent unintentional type checks (interfaces of same signature)
	IsLifeSafetyZone()
	// CreateBuilder creates a LifeSafetyZoneBuilder
	CreateLifeSafetyZoneBuilder() LifeSafetyZoneBuilder
}

// _LifeSafetyZone is the data-structure of this message
type _LifeSafetyZone struct {
...
var _ LifeSafetyZone = (*_LifeSafetyZone)(nil)

// NewLifeSafetyZone factory function for _LifeSafetyZone
func NewLifeSafetyZone(objectIdentifier ReadableProperty, objectName ReadableProperty, objectType ReadableProperty, presentValue ReadableProperty, trackingValue ReadableProperty, description OptionalProperty, deviceType OptionalProperty, statusFlags ReadableProperty, eventState ReadableProperty, reliability ReadableProperty, outOfService ReadableProperty, mode WritableProperty, acceptedModes ReadableProperty, timeDelay OptionalProperty, notificationClass OptionalProperty, lifeSafetyAlarmValues OptionalProperty, alarmValues OptionalProperty, faultValues OptionalProperty, eventEnable OptionalProperty, ackedTransitions OptionalProperty, notifyType OptionalProperty, eventTimeStamps OptionalProperty, eventMessageTexts OptionalProperty, eventMessageTextsConfig OptionalProperty, eventDetectionEnable OptionalProperty, eventAlgorithmInhibitRef OptionalProperty, eventAlgorithmInhibit OptionalProperty, timeDelayNormal OptionalProperty, reliabilityEvaluationInhibit OptionalProperty, silenced ReadableProperty, operationExpected ReadableProperty, maintenanceRequired OptionalProperty, zoneMembers ReadableProperty, memberOf OptionalProperty, propertyList ReadableProperty, valueSource OptionalProperty, tags OptionalProperty, profileLocation OptionalProperty, profileName OptionalProperty) *_LifeSafetyZone {
	if objectIdentifier == nil {
		panic("objectIdentifier of type ReadableProperty for LifeSafetyZone must not be nil")
	}
	if objectName == nil {
		panic("objectName of type ReadableProperty for LifeSafetyZone must not be nil")
	}
	if objectType == nil {
		panic("objectType of type ReadableProperty for LifeSafetyZone must not be nil")
	}
	if presentValue == nil {
		panic("presentValue of type ReadableProperty for LifeSafetyZone must not be nil")
	}
	if trackingValue == nil {
		panic("trackingValue of type ReadableProperty for LifeSafetyZone must not be nil")
	}
	if description == nil {
		panic("description of type OptionalProperty for LifeSafetyZone must not be nil")
	}
	if deviceType == nil {
		panic("deviceType of type OptionalProperty for LifeSafetyZone must not be nil")
	}
	if statusFlags == nil {
		panic("statusFlags of type ReadableProperty for LifeSafetyZone must not be nil")
	}
	if eventState == nil {
		panic("eventState of type ReadableProperty for LifeSafetyZone must not be nil")
	}
	if reliability == nil {
		panic("reliability of type ReadableProperty for LifeSafetyZone must not be nil")
	}
	if outOfService == nil {
		panic("outOfService of type ReadableProperty for LifeSafetyZone must not be nil")
	}
	if mode == nil {
		panic("mode of type WritableProperty for LifeSafetyZone must not be nil")
	}
	if acceptedModes == nil {
		panic("acceptedModes of type ReadableProperty for LifeSafetyZone must not be nil")
	}
	if timeDelay == nil {
		panic("timeDelay of type OptionalProperty for LifeSafetyZone must not be nil")
	}
	if notificationClass == nil {
		panic("notificationClass of type OptionalProperty for LifeSafetyZone must not be nil")
	}
	if lifeSafetyAlarmValues == nil {
		panic("lifeSafetyAlarmValues of type OptionalProperty for LifeSafetyZone must not be nil")
	}
	if alarmValues == nil {
		panic("alarmValues of type OptionalProperty for LifeSafetyZone must not be nil")
	}
	if faultValues == nil {
		panic("faultValues of type OptionalProperty for LifeSafetyZone must not be nil")
	}
	if eventEnable == nil {
		panic("eventEnable of type OptionalProperty for LifeSafetyZone must not be nil")
	}
	if ackedTransitions == nil {
		panic("ackedTransitions of type OptionalProperty for LifeSafetyZone must not be nil")
	}
	if notifyType == nil {
		panic("notifyType of type OptionalProperty for LifeSafetyZone must not be nil")
	}
	if eventTimeStamps == nil {
		panic("eventTimeStamps of type OptionalProperty for LifeSafetyZone must not be nil")
	}
	if eventMessageTexts == nil {
		panic("eventMessageTexts of type OptionalProperty for LifeSafetyZone must not be nil")
	}
	if eventMessageTextsConfig == nil {
		panic("eventMessageTextsConfig of type OptionalProperty for LifeSafetyZone must not be nil")
	}
	if eventDetectionEnable == nil {
		panic("eventDetectionEnable of type OptionalProperty for LifeSafetyZone must not be nil")
	}
	if eventAlgorithmInhibitRef == nil {
		panic("eventAlgorithmInhibitRef of type OptionalProperty for LifeSafetyZone must not be nil")
	}
	if eventAlgorithmInhibit == nil {
		panic("eventAlgorithmInhibit of type OptionalProperty for LifeSafetyZone must not be nil")
	}
	if timeDelayNormal == nil {
		panic("timeDelayNormal of type OptionalProperty for LifeSafetyZone must not be nil")
	}
	if reliabilityEvaluationInhibit == nil {
		panic("reliabilityEvaluationInhibit of type OptionalProperty for LifeSafetyZone must not be nil")
	}
	if silenced == nil {
		panic("silenced of type ReadableProperty for LifeSafetyZone must not be nil")
	}
	if operationExpected == nil {
		panic("operationExpected of type ReadableProperty for LifeSafetyZone must not be nil")
	}
	if maintenanceRequired == nil {
		panic("maintenanceRequired of type OptionalProperty for LifeSafetyZone must not be nil")
	}
	if zoneMembers == nil {
		panic("zoneMembers of type ReadableProperty for LifeSafetyZone must not be nil")
	}
	if memberOf == nil {
		panic("memberOf of type OptionalProperty for LifeSafetyZone must not be nil")
	}
	if propertyList == nil {
		panic("propertyList of type ReadableProperty for LifeSafetyZone must not be nil")
	}
	if valueSource == nil {
		panic("valueSource of type OptionalProperty for LifeSafetyZone must not be nil")
	}
	if tags == nil {
		panic("tags of type OptionalProperty for LifeSafetyZone must not be nil")
	}
	if profileLocation == nil {
		panic("profileLocation of type OptionalProperty for LifeSafetyZone must not be nil")
	}
	if profileName == nil {
		panic("profileName of type OptionalProperty for LifeSafetyZone must not be nil")
	}
	return &_LifeSafetyZone{ObjectIdentifier: objectIdentifier, ObjectName: objectName, ObjectType: objectType, PresentValue: presentValue, TrackingValue: trackingValue, Description: description, DeviceType: deviceType, StatusFlags: statusFlags, EventState: eventState, Reliability: reliability, OutOfService: outOfService, Mode: mode, AcceptedModes: acceptedModes, TimeDelay: timeDelay, NotificationClass: notificationClass, LifeSafetyAlarmValues: lifeSafetyAlarmValues, AlarmValues: alarmValues, FaultValues: faultValues, EventEnable: eventEnable, AckedTransitions: ackedTransitions, NotifyType: notifyType, EventTimeStamps: eventTimeStamps, EventMessageTexts: eventMessageTexts, EventMessageTextsConfig: eventMessageTextsConfig, EventDetectionEnable: eventDetectionEnable, EventAlgorithmInhibitRef: eventAlgorithmInhibitRef, EventAlgorithmInhibit: eventAlgorithmInhibit, TimeDelayNormal: timeDelayNormal, ReliabilityEvaluationInhibit: reliabilityEvaluationInhibit, Silenced: silenced, OperationExpected: operationExpected, MaintenanceRequired: maintenanceRequired, ZoneMembers: zoneMembers, MemberOf: memberOf, PropertyList: propertyList, ValueSource: valueSource, Tags: tags, ProfileLocation: profileLocation, ProfileName: profileName}
}
...
// LifeSafetyZoneBuilder is a builder for LifeSafetyZone
type LifeSafetyZoneBuilder interface {
	utils.Copyable
	...
	WithObjectIdentifierBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder
	...
	WithObjectNameBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder
	...
	WithObjectTypeBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder
	// WithPresentValue adds PresentValue (property field)
	WithPresentValue(ReadableProperty) LifeSafetyZoneBuilder
	// WithPresentValueBuilder adds PresentValue (property field) which is build by the builder
	WithPresentValueBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder
	...
	WithTrackingValueBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder
	// WithDescription adds Description (property field)
	WithDescription(OptionalProperty) LifeSafetyZoneBuilder
	// WithDescriptionBuilder adds Description (property field) which is build by the builder
	WithDescriptionBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder
	...
	WithDeviceTypeBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder
	...
	WithStatusFlagsBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder
	...
	WithEventStateBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder
	...
	WithReliabilityBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder
	...
	WithOutOfServiceBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder
	// WithMode adds Mode (property field)
	WithMode(WritableProperty) LifeSafetyZoneBuilder
	// WithModeBuilder adds Mode (property field) which is build by the builder
	WithModeBuilder(func(WritablePropertyBuilder) WritablePropertyBuilder) LifeSafetyZoneBuilder
	...
	WithAcceptedModesBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder
	...
	WithTimeDelayBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder
	...
	WithNotificationClassBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder
	...
	WithLifeSafetyAlarmValuesBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder
	...
	WithAlarmValuesBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder
	...
	WithFaultValuesBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder
	// WithEventEnable adds EventEnable (property field)
	WithEventEnable(OptionalProperty) LifeSafetyZoneBuilder
	// WithEventEnableBuilder adds EventEnable (property field) which is build by the builder
	WithEventEnableBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder
	...
	WithAckedTransitionsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder
	...
	WithNotifyTypeBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder
	...
	WithEventTimeStampsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder
	...
	WithEventMessageTextsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder
	...
	WithEventMessageTextsConfigBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder
	...
	WithEventDetectionEnableBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder
	// WithEventAlgorithmInhibitRef adds EventAlgorithmInhibitRef (property field)
	WithEventAlgorithmInhibitRef(OptionalProperty) LifeSafetyZoneBuilder
	// WithEventAlgorithmInhibitRefBuilder adds EventAlgorithmInhibitRef (property field) which is build by the builder
	WithEventAlgorithmInhibitRefBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder
	...
	WithEventAlgorithmInhibitBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder
	...
	WithTimeDelayNormalBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder
	...
	WithReliabilityEvaluationInhibitBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder
	// WithSilenced adds Silenced (property field)
	WithSilenced(ReadableProperty) LifeSafetyZoneBuilder
	// WithSilencedBuilder adds Silenced (property field) which is build by the builder
	WithSilencedBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder
	...
	WithOperationExpectedBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder
	// WithMaintenanceRequired adds MaintenanceRequired (property field)
	WithMaintenanceRequired(OptionalProperty) LifeSafetyZoneBuilder
	// WithMaintenanceRequiredBuilder adds MaintenanceRequired (property field) which is build by the builder
	WithMaintenanceRequiredBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder
	// WithZoneMembers adds ZoneMembers (property field)
	WithZoneMembers(ReadableProperty) LifeSafetyZoneBuilder
	// WithZoneMembersBuilder adds ZoneMembers (property field) which is build by the builder
	WithZoneMembersBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder
	// WithMemberOf adds MemberOf (property field)
	WithMemberOf(OptionalProperty) LifeSafetyZoneBuilder
	// WithMemberOfBuilder adds MemberOf (property field) which is build by the builder
	WithMemberOfBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder
	// WithPropertyList adds PropertyList (property field)
	WithPropertyList(ReadableProperty) LifeSafetyZoneBuilder
	// WithPropertyListBuilder adds PropertyList (property field) which is build by the builder
	WithPropertyListBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder
	...
	WithValueSourceBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder
	// WithTags adds Tags (property field)
	WithTags(OptionalProperty) LifeSafetyZoneBuilder
	// WithTagsBuilder adds Tags (property field) which is build by the builder
	WithTagsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder
	...
	WithProfileLocationBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder
	...
	WithProfileNameBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder
	// Build builds the LifeSafetyZone or returns an error if something is wrong
	Build() (LifeSafetyZone, error)
	// MustBuild does the same as Build but panics on error
	MustBuild() LifeSafetyZone
}

// NewLifeSafetyZoneBuilder() creates a LifeSafetyZoneBuilder
func NewLifeSafetyZoneBuilder() LifeSafetyZoneBuilder {
	return &_LifeSafetyZoneBuilder{_LifeSafetyZone: new(_LifeSafetyZone)}
}

type _LifeSafetyZoneBuilder struct {
	*_LifeSafetyZone

	err *utils.MultiError
}

var _ (LifeSafetyZoneBuilder) = (*_LifeSafetyZoneBuilder)(nil)

func (b *_LifeSafetyZoneBuilder) WithMandatoryFields(objectIdentifier ReadableProperty, objectName ReadableProperty, objectType ReadableProperty, presentValue ReadableProperty, trackingValue ReadableProperty, description OptionalProperty, deviceType OptionalProperty, statusFlags ReadableProperty, eventState ReadableProperty, reliability ReadableProperty, outOfService ReadableProperty, mode WritableProperty, acceptedModes ReadableProperty, timeDelay OptionalProperty, notificationClass OptionalProperty, lifeSafetyAlarmValues OptionalProperty, alarmValues OptionalProperty, faultValues OptionalProperty, eventEnable OptionalProperty, ackedTransitions OptionalProperty, notifyType OptionalProperty, eventTimeStamps OptionalProperty, eventMessageTexts OptionalProperty, eventMessageTextsConfig OptionalProperty, eventDetectionEnable OptionalProperty, eventAlgorithmInhibitRef OptionalProperty, eventAlgorithmInhibit OptionalProperty, timeDelayNormal OptionalProperty, reliabilityEvaluationInhibit OptionalProperty, silenced ReadableProperty, operationExpected ReadableProperty, maintenanceRequired OptionalProperty, zoneMembers ReadableProperty, memberOf OptionalProperty, propertyList ReadableProperty, valueSource OptionalProperty, tags OptionalProperty, profileLocation OptionalProperty, profileName OptionalProperty) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithObjectIdentifier(objectIdentifier ReadableProperty) LifeSafetyZoneBuilder {
	b.ObjectIdentifier = objectIdentifier
	return b
}

func (b *_LifeSafetyZoneBuilder) WithObjectIdentifierBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithObjectName(objectName ReadableProperty) LifeSafetyZoneBuilder {
	b.ObjectName = objectName
	return b
}

func (b *_LifeSafetyZoneBuilder) WithObjectNameBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithObjectType(objectType ReadableProperty) LifeSafetyZoneBuilder {
	b.ObjectType = objectType
	return b
}

func (b *_LifeSafetyZoneBuilder) WithObjectTypeBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithPresentValue(presentValue ReadableProperty) LifeSafetyZoneBuilder {
	b.PresentValue = presentValue
	return b
}

func (b *_LifeSafetyZoneBuilder) WithPresentValueBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithTrackingValue(trackingValue ReadableProperty) LifeSafetyZoneBuilder {
	b.TrackingValue = trackingValue
	return b
}

func (b *_LifeSafetyZoneBuilder) WithTrackingValueBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithDescription(description OptionalProperty) LifeSafetyZoneBuilder {
	b.Description = description
	return b
}

func (b *_LifeSafetyZoneBuilder) WithDescriptionBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithDeviceType(deviceType OptionalProperty) LifeSafetyZoneBuilder {
	b.DeviceType = deviceType
	return b
}

func (b *_LifeSafetyZoneBuilder) WithDeviceTypeBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithStatusFlags(statusFlags ReadableProperty) LifeSafetyZoneBuilder {
	b.StatusFlags = statusFlags
	return b
}

func (b *_LifeSafetyZoneBuilder) WithStatusFlagsBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithEventState(eventState ReadableProperty) LifeSafetyZoneBuilder {
	b.EventState = eventState
	return b
}

func (b *_LifeSafetyZoneBuilder) WithEventStateBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithReliability(reliability ReadableProperty) LifeSafetyZoneBuilder {
	b.Reliability = reliability
	return b
}

func (b *_LifeSafetyZoneBuilder) WithReliabilityBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithOutOfService(outOfService ReadableProperty) LifeSafetyZoneBuilder {
	b.OutOfService = outOfService
	return b
}

func (b *_LifeSafetyZoneBuilder) WithOutOfServiceBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithMode(mode WritableProperty) LifeSafetyZoneBuilder {
	b.Mode = mode
	return b
}

func (b *_LifeSafetyZoneBuilder) WithModeBuilder(builderSupplier func(WritablePropertyBuilder) WritablePropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithAcceptedModes(acceptedModes ReadableProperty) LifeSafetyZoneBuilder {
	b.AcceptedModes = acceptedModes
	return b
}

func (b *_LifeSafetyZoneBuilder) WithAcceptedModesBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithTimeDelay(timeDelay OptionalProperty) LifeSafetyZoneBuilder {
	b.TimeDelay = timeDelay
	return b
}

func (b *_LifeSafetyZoneBuilder) WithTimeDelayBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithNotificationClass(notificationClass OptionalProperty) LifeSafetyZoneBuilder {
	b.NotificationClass = notificationClass
	return b
}

func (b *_LifeSafetyZoneBuilder) WithNotificationClassBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithLifeSafetyAlarmValues(lifeSafetyAlarmValues OptionalProperty) LifeSafetyZoneBuilder {
	b.LifeSafetyAlarmValues = lifeSafetyAlarmValues
	return b
}

func (b *_LifeSafetyZoneBuilder) WithLifeSafetyAlarmValuesBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithAlarmValues(alarmValues OptionalProperty) LifeSafetyZoneBuilder {
	b.AlarmValues = alarmValues
	return b
}

func (b *_LifeSafetyZoneBuilder) WithAlarmValuesBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithFaultValues(faultValues OptionalProperty) LifeSafetyZoneBuilder {
	b.FaultValues = faultValues
	return b
}

func (b *_LifeSafetyZoneBuilder) WithFaultValuesBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithEventEnable(eventEnable OptionalProperty) LifeSafetyZoneBuilder {
	b.EventEnable = eventEnable
	return b
}

func (b *_LifeSafetyZoneBuilder) WithEventEnableBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithAckedTransitions(ackedTransitions OptionalProperty) LifeSafetyZoneBuilder {
	b.AckedTransitions = ackedTransitions
	return b
}

func (b *_LifeSafetyZoneBuilder) WithAckedTransitionsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithNotifyType(notifyType OptionalProperty) LifeSafetyZoneBuilder {
	b.NotifyType = notifyType
	return b
}

func (b *_LifeSafetyZoneBuilder) WithNotifyTypeBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithEventTimeStamps(eventTimeStamps OptionalProperty) LifeSafetyZoneBuilder {
	b.EventTimeStamps = eventTimeStamps
	return b
}

func (b *_LifeSafetyZoneBuilder) WithEventTimeStampsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithEventMessageTexts(eventMessageTexts OptionalProperty) LifeSafetyZoneBuilder {
	b.EventMessageTexts = eventMessageTexts
	return b
}

func (b *_LifeSafetyZoneBuilder) WithEventMessageTextsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithEventMessageTextsConfig(eventMessageTextsConfig OptionalProperty) LifeSafetyZoneBuilder {
	b.EventMessageTextsConfig = eventMessageTextsConfig
	return b
}

func (b *_LifeSafetyZoneBuilder) WithEventMessageTextsConfigBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithEventDetectionEnable(eventDetectionEnable OptionalProperty) LifeSafetyZoneBuilder {
	b.EventDetectionEnable = eventDetectionEnable
	return b
}

func (b *_LifeSafetyZoneBuilder) WithEventDetectionEnableBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithEventAlgorithmInhibitRef(eventAlgorithmInhibitRef OptionalProperty) LifeSafetyZoneBuilder {
	b.EventAlgorithmInhibitRef = eventAlgorithmInhibitRef
	return b
}

func (b *_LifeSafetyZoneBuilder) WithEventAlgorithmInhibitRefBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithEventAlgorithmInhibit(eventAlgorithmInhibit OptionalProperty) LifeSafetyZoneBuilder {
	b.EventAlgorithmInhibit = eventAlgorithmInhibit
	return b
}

func (b *_LifeSafetyZoneBuilder) WithEventAlgorithmInhibitBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithTimeDelayNormal(timeDelayNormal OptionalProperty) LifeSafetyZoneBuilder {
	b.TimeDelayNormal = timeDelayNormal
	return b
}

func (b *_LifeSafetyZoneBuilder) WithTimeDelayNormalBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithReliabilityEvaluationInhibit(reliabilityEvaluationInhibit OptionalProperty) LifeSafetyZoneBuilder {
	b.ReliabilityEvaluationInhibit = reliabilityEvaluationInhibit
	return b
}

func (b *_LifeSafetyZoneBuilder) WithReliabilityEvaluationInhibitBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithSilenced(silenced ReadableProperty) LifeSafetyZoneBuilder {
	b.Silenced = silenced
	return b
}

func (b *_LifeSafetyZoneBuilder) WithSilencedBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithOperationExpected(operationExpected ReadableProperty) LifeSafetyZoneBuilder {
	b.OperationExpected = operationExpected
	return b
}

func (b *_LifeSafetyZoneBuilder) WithOperationExpectedBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithMaintenanceRequired(maintenanceRequired OptionalProperty) LifeSafetyZoneBuilder {
	b.MaintenanceRequired = maintenanceRequired
	return b
}

func (b *_LifeSafetyZoneBuilder) WithMaintenanceRequiredBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithZoneMembers(zoneMembers ReadableProperty) LifeSafetyZoneBuilder {
	b.ZoneMembers = zoneMembers
	return b
}

func (b *_LifeSafetyZoneBuilder) WithZoneMembersBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder {
	builder := builderSupplier(b.ZoneMembers.CreateReadablePropertyBuilder())
	var err error
	b.ZoneMembers, err = builder.Build()
	if err != nil {
		if b.err == nil {
			b.err = &utils.MultiError{MainError: errors.New("sub builder failed")}
		}
...
func (b *_LifeSafetyZoneBuilder) WithMemberOf(memberOf OptionalProperty) LifeSafetyZoneBuilder {
	b.MemberOf = memberOf
	return b
}

func (b *_LifeSafetyZoneBuilder) WithMemberOfBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithPropertyList(propertyList ReadableProperty) LifeSafetyZoneBuilder {
	b.PropertyList = propertyList
	return b
}

func (b *_LifeSafetyZoneBuilder) WithPropertyListBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithValueSource(valueSource OptionalProperty) LifeSafetyZoneBuilder {
	b.ValueSource = valueSource
	return b
}

func (b *_LifeSafetyZoneBuilder) WithValueSourceBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithTags(tags OptionalProperty) LifeSafetyZoneBuilder {
	b.Tags = tags
	return b
}

func (b *_LifeSafetyZoneBuilder) WithTagsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithProfileLocation(profileLocation OptionalProperty) LifeSafetyZoneBuilder {
	b.ProfileLocation = profileLocation
	return b
}

func (b *_LifeSafetyZoneBuilder) WithProfileLocationBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) WithProfileName(profileName OptionalProperty) LifeSafetyZoneBuilder {
	b.ProfileName = profileName
	return b
}

func (b *_LifeSafetyZoneBuilder) WithProfileNameBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) LifeSafetyZoneBuilder {
...
func (b *_LifeSafetyZoneBuilder) Build() (LifeSafetyZone, error) {
	...
	if b.ZoneMembers == nil {
		if b.err == nil {
			b.err = new(utils.MultiError)
		}
		b.err.Append(errors.New("mandatory field 'zoneMembers' not set"))
	}
	if b.MemberOf == nil {
		if b.err == nil {
			b.err = new(utils.MultiError)
	...
	return b._LifeSafetyZone.deepCopy(), nil
}

func (b *_LifeSafetyZoneBuilder) MustBuild() LifeSafetyZone {
	build, err := b.Build()
	if err != nil {
		panic(err)
	}
...
func (b *_LifeSafetyZoneBuilder) DeepCopy() any {
	_copy := b.CreateLifeSafetyZoneBuilder().(*_LifeSafetyZoneBuilder)
	if b.err != nil {
...
// CreateLifeSafetyZoneBuilder creates a LifeSafetyZoneBuilder
func (b *_LifeSafetyZone) CreateLifeSafetyZoneBuilder() LifeSafetyZoneBuilder {
	if b == nil {
		return NewLifeSafetyZoneBuilder()
	}
	return &_LifeSafetyZoneBuilder{_LifeSafetyZone: b.deepCopy()}
}
...
func (m *_LifeSafetyZone) GetObjectIdentifier() ReadableProperty {
	return m.ObjectIdentifier
}

func (m *_LifeSafetyZone) GetObjectName() ReadableProperty {
	return m.ObjectName
}

func (m *_LifeSafetyZone) GetObjectType() ReadableProperty {
	return m.ObjectType
}

func (m *_LifeSafetyZone) GetPresentValue() ReadableProperty {
	return m.PresentValue
}

func (m *_LifeSafetyZone) GetTrackingValue() ReadableProperty {
	return m.TrackingValue
}

func (m *_LifeSafetyZone) GetDescription() OptionalProperty {
	return m.Description
}

func (m *_LifeSafetyZone) GetDeviceType() OptionalProperty {
	return m.DeviceType
}

func (m *_LifeSafetyZone) GetStatusFlags() ReadableProperty {
	return m.StatusFlags
}

func (m *_LifeSafetyZone) GetEventState() ReadableProperty {
	return m.EventState
}

func (m *_LifeSafetyZone) GetReliability() ReadableProperty {
	return m.Reliability
}

func (m *_LifeSafetyZone) GetOutOfService() ReadableProperty {
	return m.OutOfService
}

func (m *_LifeSafetyZone) GetMode() WritableProperty {
	return m.Mode
}

func (m *_LifeSafetyZone) GetAcceptedModes() ReadableProperty {
	return m.AcceptedModes
}

func (m *_LifeSafetyZone) GetTimeDelay() OptionalProperty {
	return m.TimeDelay
}

func (m *_LifeSafetyZone) GetNotificationClass() OptionalProperty {
	return m.NotificationClass
}

func (m *_LifeSafetyZone) GetLifeSafetyAlarmValues() OptionalProperty {
	return m.LifeSafetyAlarmValues
}

func (m *_LifeSafetyZone) GetAlarmValues() OptionalProperty {
	return m.AlarmValues
}

func (m *_LifeSafetyZone) GetFaultValues() OptionalProperty {
	return m.FaultValues
}

func (m *_LifeSafetyZone) GetEventEnable() OptionalProperty {
	return m.EventEnable
}

func (m *_LifeSafetyZone) GetAckedTransitions() OptionalProperty {
	return m.AckedTransitions
}

func (m *_LifeSafetyZone) GetNotifyType() OptionalProperty {
	return m.NotifyType
}

func (m *_LifeSafetyZone) GetEventTimeStamps() OptionalProperty {
	return m.EventTimeStamps
}

func (m *_LifeSafetyZone) GetEventMessageTexts() OptionalProperty {
	return m.EventMessageTexts
}

func (m *_LifeSafetyZone) GetEventMessageTextsConfig() OptionalProperty {
	return m.EventMessageTextsConfig
}

func (m *_LifeSafetyZone) GetEventDetectionEnable() OptionalProperty {
	return m.EventDetectionEnable
}

func (m *_LifeSafetyZone) GetEventAlgorithmInhibitRef() OptionalProperty {
	return m.EventAlgorithmInhibitRef
}

func (m *_LifeSafetyZone) GetEventAlgorithmInhibit() OptionalProperty {
	return m.EventAlgorithmInhibit
}

func (m *_LifeSafetyZone) GetTimeDelayNormal() OptionalProperty {
	return m.TimeDelayNormal
}

func (m *_LifeSafetyZone) GetReliabilityEvaluationInhibit() OptionalProperty {
	return m.ReliabilityEvaluationInhibit
}

func (m *_LifeSafetyZone) GetSilenced() ReadableProperty {
	return m.Silenced
}

func (m *_LifeSafetyZone) GetOperationExpected() ReadableProperty {
	return m.OperationExpected
}

func (m *_LifeSafetyZone) GetMaintenanceRequired() OptionalProperty {
	return m.MaintenanceRequired
}

func (m *_LifeSafetyZone) GetZoneMembers() ReadableProperty {
	return m.ZoneMembers
}

func (m *_LifeSafetyZone) GetMemberOf() OptionalProperty {
	return m.MemberOf
}

func (m *_LifeSafetyZone) GetPropertyList() ReadableProperty {
	return m.PropertyList
}

func (m *_LifeSafetyZone) GetValueSource() OptionalProperty {
	return m.ValueSource
}

func (m *_LifeSafetyZone) GetTags() OptionalProperty {
	return m.Tags
}

func (m *_LifeSafetyZone) GetProfileLocation() OptionalProperty {
	return m.ProfileLocation
}

func (m *_LifeSafetyZone) GetProfileName() OptionalProperty {
...
func CastLifeSafetyZone(structType any) LifeSafetyZone {
	if casted, ok := structType.(LifeSafetyZone); ok {
		return casted
	}
	if casted, ok := structType.(*LifeSafetyZone); ok {
		return *casted
...
func (m *_LifeSafetyZone) GetTypeName() string {
	return "LifeSafetyZone"
}

func (m *_LifeSafetyZone) GetLengthInBits(ctx context.Context) uint16 {
	...
	// Simple field (zoneMembers)
	lengthInBits += m.ZoneMembers.GetLengthInBits(ctx)
...
func (m *_LifeSafetyZone) GetLengthInBytes(ctx context.Context) uint16 {
	return m.GetLengthInBits(ctx) / 8
}

func LifeSafetyZoneParse(ctx context.Context, theBytes []byte) (LifeSafetyZone, error) {
	return LifeSafetyZoneParseWithBuffer(ctx, utils.NewReadBufferByteBased(theBytes))
}

func LifeSafetyZoneParseWithBufferProducer() func(ctx context.Context, readBuffer utils.ReadBuffer) (LifeSafetyZone, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (LifeSafetyZone, error) {
		return LifeSafetyZoneParseWithBuffer(ctx, readBuffer)
	}
}

func LifeSafetyZoneParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (LifeSafetyZone, error) {
	v, err := (&_LifeSafetyZone{}).parse(ctx, readBuffer)
	if err != nil {
		return nil, err
	}
	return v, nil
...
func (m *_LifeSafetyZone) parse(ctx context.Context, readBuffer utils.ReadBuffer) (__lifeSafetyZone LifeSafetyZone, err error) {
	positionAware := readBuffer
	_ = positionAware
	if pullErr := readBuffer.PullContext("LifeSafetyZone"); pullErr != nil {
		return nil, errors.Wrap(pullErr, "Error pulling for LifeSafetyZone")
	}
	...
	maintenanceRequired, err := ReadSimpleField[OptionalProperty](ctx, "maintenanceRequired", ReadComplex[OptionalProperty](OptionalPropertyParseWithBufferProducer((string)("BOOLEAN")), readBuffer))
	if err != nil {
		return nil, errors.Wrap(err, fmt.Sprintf("Error parsing 'maintenanceRequired' field"))
	}
	m.MaintenanceRequired = maintenanceRequired

	zoneMembers, err := ReadSimpleField[ReadableProperty](ctx, "zoneMembers", ReadComplex[ReadableProperty](ReadablePropertyParseWithBufferProducer((string)("BACnetLIST of BACnetDeviceObjectReference")), readBuffer))
	if err != nil {
		return nil, errors.Wrap(err, fmt.Sprintf("Error parsing 'zoneMembers' field"))
	}
	m.ZoneMembers = zoneMembers
	...
	if closeErr := readBuffer.CloseContext("LifeSafetyZone"); closeErr != nil {
		return nil, errors.Wrap(closeErr, "Error closing for LifeSafetyZone")
	}

	return m, nil
}

func (m *_LifeSafetyZone) Serialize() ([]byte, error) {
...
func (m *_LifeSafetyZone) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	positionAware := writeBuffer
	_ = positionAware
	log := zerolog.Ctx(ctx)
	_ = log
	if pushErr := writeBuffer.PushContext("LifeSafetyZone"); pushErr != nil {
		return errors.Wrap(pushErr, "Error pushing for LifeSafetyZone")
	}
	...
	if err := WriteSimpleField[ReadableProperty](ctx, "zoneMembers", m.GetZoneMembers(), WriteComplex[ReadableProperty](writeBuffer)); err != nil {
		return errors.Wrap(err, "Error serializing 'zoneMembers' field")
	}
	...
	if popErr := writeBuffer.PopContext("LifeSafetyZone"); popErr != nil {
		return errors.Wrap(popErr, "Error popping for LifeSafetyZone")
	}
	return nil
}

func (m *_LifeSafetyZone) IsLifeSafetyZone() {}

func (m *_LifeSafetyZone) DeepCopy() any {
	return m.deepCopy()
}

func (m *_LifeSafetyZone) deepCopy() *_LifeSafetyZone {
	if m == nil {
		return nil
	}
	_LifeSafetyZoneCopy := &_LifeSafetyZone{
		...
		m.ZoneMembers.DeepCopy().(ReadableProperty),
	...
	return _LifeSafetyZoneCopy
}

func (m *_LifeSafetyZone) String() string {
	if m == nil {
		return "<nil>"
	}
