...
func (m *_BACnetConstructedDataStatusFlags) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataStatusFlags) GetLengthInBytes(ctx context.Context) uint64 {
