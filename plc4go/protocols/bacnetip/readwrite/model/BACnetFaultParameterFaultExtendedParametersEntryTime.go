...
func (m *_BACnetFaultParameterFaultExtendedParametersEntryTime) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetFaultParameterFaultExtendedParametersEntry) (_bACnetFaultParameterFaultExtendedParametersEntryTime BACnetFaultParameterFaultExtendedParametersEntryTime, err error) {
