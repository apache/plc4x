...
func BACnetTimerTransitionTaggedParse(theBytes []byte, tagNumber uint8, tagClass TagClass) (BACnetTimerTransitionTagged, error) {
	return BACnetTimerTransitionTaggedParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian)), tagNumber, tagClass) // TODO: get endianness from mspec
}

func BACnetTimerTransitionTaggedParseWithBuffer(readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (BACnetTimerTransitionTagged, error) {
...
func (m *_BACnetTimerTransitionTagged) SerializeWithWriteBuffer(writeBuffer utils.WriteBuffer) error {
