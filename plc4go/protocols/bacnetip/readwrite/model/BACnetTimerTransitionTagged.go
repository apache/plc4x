...
func (m *_BACnetTimerTransitionTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetTimerTransitionTagged) GetLengthInBytes(ctx context.Context) uint64 {
