...
// BACnetSpecialEventListOfTimeValues is the data-structure of this message
type BACnetSpecialEventListOfTimeValues struct {
...
// IBACnetSpecialEventListOfTimeValues is the corresponding interface of BACnetSpecialEventListOfTimeValues
type IBACnetSpecialEventListOfTimeValues interface {
...
func (m *BACnetSpecialEventListOfTimeValues) GetOpeningTag() *BACnetOpeningTag {
	return m.OpeningTag
}

func (m *BACnetSpecialEventListOfTimeValues) GetListOfTimeValues() []*BACnetTimeValue {
	return m.ListOfTimeValues
}

func (m *BACnetSpecialEventListOfTimeValues) GetClosingTag() *BACnetClosingTag {
	return m.ClosingTag
}
...
// NewBACnetSpecialEventListOfTimeValues factory function for BACnetSpecialEventListOfTimeValues
func NewBACnetSpecialEventListOfTimeValues(openingTag *BACnetOpeningTag, listOfTimeValues []*BACnetTimeValue, closingTag *BACnetClosingTag, tagNumber uint8) *BACnetSpecialEventListOfTimeValues {
	return &BACnetSpecialEventListOfTimeValues{OpeningTag: openingTag, ListOfTimeValues: listOfTimeValues, ClosingTag: closingTag, TagNumber: tagNumber}
}
...
func (m *BACnetSpecialEventListOfTimeValues) GetTypeName() string {
	return "BACnetSpecialEventListOfTimeValues"
}

func (m *BACnetSpecialEventListOfTimeValues) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetSpecialEventListOfTimeValues) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetSpecialEventListOfTimeValues) GetLengthInBytes() uint16 {
	return m.GetLengthInBits() / 8
}

func BACnetSpecialEventListOfTimeValuesParse(readBuffer utils.ReadBuffer, tagNumber uint8) (*BACnetSpecialEventListOfTimeValues, error) {
	...
	listOfTimeValues := make([]*BACnetTimeValue, 0)
	{
		for !bool(IsBACnetConstructedDataClosingTag(readBuffer, false, tagNumber)) {
			...
			if _err != nil {
				return nil, errors.Wrap(_err, "Error parsing 'listOfTimeValues' field")
			}
			listOfTimeValues = append(listOfTimeValues, CastBACnetTimeValue(_item))
...
func (m *BACnetSpecialEventListOfTimeValues) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	if m.ListOfTimeValues != nil {
		...
		for _, _element := range m.ListOfTimeValues {
...
func (m *BACnetSpecialEventListOfTimeValues) String() string {
	if m == nil {
		return "<nil>"
	}
