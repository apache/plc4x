...
func (m *_BACnetSpecialEventListOfTimeValues) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetSpecialEventListOfTimeValues) GetLengthInBytes(ctx context.Context) uint64 {
