...
func (m *_BACnetSpecialEventListOfTimeValuesBuilder) WithMandatoryFields(openingTag BACnetOpeningTag, listOfTimeValues []BACnetTimeValue, closingTag BACnetClosingTag) BACnetSpecialEventListOfTimeValuesBuilder {
	return m.WithOpeningTag(openingTag).WithListOfTimeValues(listOfTimeValues...).WithClosingTag(closingTag)
}

func (m *_BACnetSpecialEventListOfTimeValuesBuilder) WithOpeningTag(openingTag BACnetOpeningTag) BACnetSpecialEventListOfTimeValuesBuilder {
	m.OpeningTag = openingTag
	return m
}

func (m *_BACnetSpecialEventListOfTimeValuesBuilder) WithOpeningTagBuilder(builderSupplier func(BACnetOpeningTagBuilder) BACnetOpeningTagBuilder) BACnetSpecialEventListOfTimeValuesBuilder {
...
func (m *_BACnetSpecialEventListOfTimeValuesBuilder) WithListOfTimeValues(listOfTimeValues ...BACnetTimeValue) BACnetSpecialEventListOfTimeValuesBuilder {
	m.ListOfTimeValues = listOfTimeValues
	return m
}

func (m *_BACnetSpecialEventListOfTimeValuesBuilder) WithClosingTag(closingTag BACnetClosingTag) BACnetSpecialEventListOfTimeValuesBuilder {
	m.ClosingTag = closingTag
	return m
}

func (m *_BACnetSpecialEventListOfTimeValuesBuilder) WithClosingTagBuilder(builderSupplier func(BACnetClosingTagBuilder) BACnetClosingTagBuilder) BACnetSpecialEventListOfTimeValuesBuilder {
...
func (m *_BACnetSpecialEventListOfTimeValuesBuilder) Build() (BACnetSpecialEventListOfTimeValues, error) {
	if m.OpeningTag == nil {
		if m.err == nil {
	...
	return m._BACnetSpecialEventListOfTimeValues.deepCopy(), nil
}

func (m *_BACnetSpecialEventListOfTimeValuesBuilder) MustBuild() BACnetSpecialEventListOfTimeValues {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetSpecialEventListOfTimeValuesBuilder) DeepCopy() any {
	return m.CreateBACnetSpecialEventListOfTimeValuesBuilder()
}

// CreateBACnetSpecialEventListOfTimeValuesBuilder creates a BACnetSpecialEventListOfTimeValuesBuilder
func (m *_BACnetSpecialEventListOfTimeValues) CreateBACnetSpecialEventListOfTimeValuesBuilder() BACnetSpecialEventListOfTimeValuesBuilder {
	if m == nil {
		return NewBACnetSpecialEventListOfTimeValuesBuilder()
	}
	return &_BACnetSpecialEventListOfTimeValuesBuilder{_BACnetSpecialEventListOfTimeValues: m.deepCopy()}
}
