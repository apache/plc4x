...
func (m *_BACnetConstructedDataRestorePreparationTime) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataRestorePreparationTime) GetLengthInBytes(ctx context.Context) uint64 {
