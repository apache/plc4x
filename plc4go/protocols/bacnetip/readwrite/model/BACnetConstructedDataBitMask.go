...
func (m *_BACnetConstructedDataBitMask) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataBitMask) GetLengthInBytes(ctx context.Context) uint64 {
