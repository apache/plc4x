...
func (m *_BACnetRecipientDevice) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetRecipient) (_bACnetRecipientDevice BACnetRecipientDevice, err error) {
