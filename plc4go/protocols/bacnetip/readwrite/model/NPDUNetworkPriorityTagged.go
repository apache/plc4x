...
func (m *_NPDUNetworkPriorityTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_NPDUNetworkPriorityTagged) GetLengthInBytes(ctx context.Context) uint64 {
