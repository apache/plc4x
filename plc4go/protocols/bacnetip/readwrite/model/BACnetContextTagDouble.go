...
func (m *_BACnetContextTagDouble) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetContextTag, tagNumberArgument uint8, dataType BACnetDataType) (_bACnetContextTagDouble BACnetContextTagDouble, err error) {
