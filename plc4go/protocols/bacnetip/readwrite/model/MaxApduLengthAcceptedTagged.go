...
// MaxApduLengthAcceptedTagged is the data-structure of this message
type MaxApduLengthAcceptedTagged struct {
...
// IMaxApduLengthAcceptedTagged is the corresponding interface of MaxApduLengthAcceptedTagged
type IMaxApduLengthAcceptedTagged interface {
...
func (m *MaxApduLengthAcceptedTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *MaxApduLengthAcceptedTagged) GetValue() MaxApduLengthAccepted {
	return m.Value
}
...
// NewMaxApduLengthAcceptedTagged factory function for MaxApduLengthAcceptedTagged
func NewMaxApduLengthAcceptedTagged(header *BACnetTagHeader, value MaxApduLengthAccepted, tagNumber uint8, tagClass TagClass) *MaxApduLengthAcceptedTagged {
	return &MaxApduLengthAcceptedTagged{Header: header, Value: value, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *MaxApduLengthAcceptedTagged) GetTypeName() string {
	return "MaxApduLengthAcceptedTagged"
}

func (m *MaxApduLengthAcceptedTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *MaxApduLengthAcceptedTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *MaxApduLengthAcceptedTagged) GetLengthInBytes() uint16 {
...
func (m *MaxApduLengthAcceptedTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *MaxApduLengthAcceptedTagged) String() string {
	if m == nil {
		return "<nil>"
	}
