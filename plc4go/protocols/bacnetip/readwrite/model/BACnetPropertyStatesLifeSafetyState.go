...
func (m *_BACnetPropertyStatesLifeSafetyState) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesLifeSafetyState) GetLengthInBytes(ctx context.Context) uint64 {
