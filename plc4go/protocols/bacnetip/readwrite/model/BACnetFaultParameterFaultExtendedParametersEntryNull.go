...
func (m *_BACnetFaultParameterFaultExtendedParametersEntryNull) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetFaultParameterFaultExtendedParametersEntry) (_bACnetFaultParameterFaultExtendedParametersEntryNull BACnetFaultParameterFaultExtendedParametersEntryNull, err error) {
