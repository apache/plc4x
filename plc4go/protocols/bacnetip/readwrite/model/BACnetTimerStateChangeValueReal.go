...
// BACnetTimerStateChangeValueReal is the data-structure of this message
type BACnetTimerStateChangeValueReal struct {
...
// IBACnetTimerStateChangeValueReal is the corresponding interface of BACnetTimerStateChangeValueReal
type IBACnetTimerStateChangeValueReal interface {
...
func (m *BACnetTimerStateChangeValueReal) InitializeParent(parent *BACnetTimerStateChangeValue, peekedTagHeader *BACnetTagHeader) {
	m.BACnetTimerStateChangeValue.PeekedTagHeader = peekedTagHeader
}

func (m *BACnetTimerStateChangeValueReal) GetParent() *BACnetTimerStateChangeValue {
...
func (m *BACnetTimerStateChangeValueReal) GetRealValue() *BACnetApplicationTagReal {
	return m.RealValue
}
...
// NewBACnetTimerStateChangeValueReal factory function for BACnetTimerStateChangeValueReal
func NewBACnetTimerStateChangeValueReal(realValue *BACnetApplicationTagReal, peekedTagHeader *BACnetTagHeader, objectTypeArgument BACnetObjectType) *BACnetTimerStateChangeValueReal {
	_result := &BACnetTimerStateChangeValueReal{
		RealValue:                   realValue,
...
func CastBACnetTimerStateChangeValueReal(structType interface{}) *BACnetTimerStateChangeValueReal {
	...
	if casted, ok := structType.(BACnetTimerStateChangeValue); ok {
		return CastBACnetTimerStateChangeValueReal(casted.Child)
	}
	if casted, ok := structType.(*BACnetTimerStateChangeValue); ok {
		return CastBACnetTimerStateChangeValueReal(casted.Child)
	}
...
func (m *BACnetTimerStateChangeValueReal) GetTypeName() string {
	return "BACnetTimerStateChangeValueReal"
}

func (m *BACnetTimerStateChangeValueReal) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetTimerStateChangeValueReal) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetTimerStateChangeValueReal) GetLengthInBytes() uint16 {
	return m.GetLengthInBits() / 8
}

func BACnetTimerStateChangeValueRealParse(readBuffer utils.ReadBuffer, objectTypeArgument BACnetObjectType) (*BACnetTimerStateChangeValueReal, error) {
	...
	_child := &BACnetTimerStateChangeValueReal{
...
func (m *BACnetTimerStateChangeValueReal) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetTimerStateChangeValueReal) String() string {
	if m == nil {
		return "<nil>"
	}
