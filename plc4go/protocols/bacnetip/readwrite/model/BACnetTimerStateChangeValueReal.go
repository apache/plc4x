...
func (m *_BACnetTimerStateChangeValueReal) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetTimerStateChangeValueReal) GetLengthInBytes(ctx context.Context) uint64 {
