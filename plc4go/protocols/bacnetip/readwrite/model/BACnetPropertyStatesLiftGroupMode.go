...
func (m *_BACnetPropertyStatesLiftGroupMode) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesLiftGroupMode) GetLengthInBytes(ctx context.Context) uint64 {
