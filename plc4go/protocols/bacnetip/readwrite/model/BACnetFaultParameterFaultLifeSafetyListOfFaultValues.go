...
func (m *_BACnetFaultParameterFaultLifeSafetyListOfFaultValues) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (_bACnetFaultParameterFaultLifeSafetyListOfFaultValues BACnetFaultParameterFaultLifeSafetyListOfFaultValues, err error) {
