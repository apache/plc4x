...
func (m *_BACnetConstructedDataFaultParameters) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataFaultParameters) GetLengthInBytes(ctx context.Context) uint64 {
