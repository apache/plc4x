...
func (m *_BACnetConstructedDataObjectType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataObjectType) GetLengthInBytes(ctx context.Context) uint64 {
