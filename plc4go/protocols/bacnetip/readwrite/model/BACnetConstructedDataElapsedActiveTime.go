...
// BACnetConstructedDataElapsedActiveTime is the data-structure of this message
type BACnetConstructedDataElapsedActiveTime struct {
...
// IBACnetConstructedDataElapsedActiveTime is the corresponding interface of BACnetConstructedDataElapsedActiveTime
type IBACnetConstructedDataElapsedActiveTime interface {
...
func (m *BACnetConstructedDataElapsedActiveTime) GetObjectTypeArgument() BACnetObjectType {
	return 0
}

func (m *BACnetConstructedDataElapsedActiveTime) GetPropertyIdentifierArgument() BACnetPropertyIdentifier {
...
func (m *BACnetConstructedDataElapsedActiveTime) GetParent() *BACnetConstructedData {
...
func (m *BACnetConstructedDataElapsedActiveTime) GetElapsedActiveTime() *BACnetApplicationTagUnsignedInteger {
...
func CastBACnetConstructedDataElapsedActiveTime(structType interface{}) *BACnetConstructedDataElapsedActiveTime {
	...
	if casted, ok := structType.(BACnetConstructedData); ok {
		return CastBACnetConstructedDataElapsedActiveTime(casted.Child)
	}
	if casted, ok := structType.(*BACnetConstructedData); ok {
		return CastBACnetConstructedDataElapsedActiveTime(casted.Child)
	}
...
func (m *BACnetConstructedDataElapsedActiveTime) GetTypeName() string {
	return "BACnetConstructedDataElapsedActiveTime"
}

func (m *BACnetConstructedDataElapsedActiveTime) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetConstructedDataElapsedActiveTime) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetConstructedDataElapsedActiveTime) GetLengthInBytes() uint16 {
	return m.GetLengthInBits() / 8
}

func BACnetConstructedDataElapsedActiveTimeParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier) (*BACnetConstructedDataElapsedActiveTime, error) {
	...
	_child := &BACnetConstructedDataElapsedActiveTime{
		ElapsedActiveTime:     CastBACnetApplicationTagUnsignedInteger(elapsedActiveTime),
...
func (m *BACnetConstructedDataElapsedActiveTime) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetConstructedDataElapsedActiveTime) String() string {
	if m == nil {
		return "<nil>"
	}
