...
func (m *_BACnetConstructedDataPositiveAccessRules) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataPositiveAccessRules) GetLengthInBytes(ctx context.Context) uint64 {
