...
func (m *_BACnetProgramStateTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetProgramStateTagged) GetLengthInBytes(ctx context.Context) uint64 {
