...
func (m *_BACnetConstructedDataProportionalConstantUnits) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataProportionalConstantUnits) GetLengthInBytes(ctx context.Context) uint64 {
