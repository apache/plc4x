...
func BACnetConstructedDataProportionalConstantUnitsParse(theBytes []byte, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier, arrayIndexArgument BACnetTagPayloadUnsignedInteger) (BACnetConstructedDataProportionalConstantUnits, error) {
	return BACnetConstructedDataProportionalConstantUnitsParseWithBuffer(utils.NewReadBufferByteBased(theBytes), tagNumber, objectTypeArgument, propertyIdentifierArgument, arrayIndexArgument)
}
...
func (m *_BACnetConstructedDataProportionalConstantUnits) SerializeWithWriteBuffer(writeBuffer utils.WriteBuffer) error {
