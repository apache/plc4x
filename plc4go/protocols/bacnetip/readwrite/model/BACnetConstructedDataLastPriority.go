...
func (m *_BACnetConstructedDataLastPriority) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataLastPriority) GetLengthInBytes(ctx context.Context) uint64 {
