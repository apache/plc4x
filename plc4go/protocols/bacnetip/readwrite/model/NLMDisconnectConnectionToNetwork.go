...
func (m *_NLMDisconnectConnectionToNetwork) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_NLM, apduLength uint16) (_nLMDisconnectConnectionToNetwork NLMDisconnectConnectionToNetwork, err error) {
