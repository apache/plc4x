...
func (m *_BACnetSpecialEventBuilder) WithPeriodBuilder(builderSupplier func(BACnetSpecialEventPeriodBuilder) BACnetSpecialEventPeriodBuilder) BACnetSpecialEventBuilder {
	builder := builderSupplier(m.Period.CreateBACnetSpecialEventPeriodBuilder())
	var err error
	m.Period, err = builder.Build()
	if err != nil {
		if m.err == nil {
			m.err = &utils.MultiError{MainError: errors.New("sub builder failed")}
		}
		m.err.Append(errors.Wrap(err, "BACnetSpecialEventPeriodBuilder failed"))
	}
	return m
}
