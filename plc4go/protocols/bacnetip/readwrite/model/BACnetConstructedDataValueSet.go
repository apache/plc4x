...
func (m *_BACnetConstructedDataValueSet) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataValueSet) GetLengthInBytes(ctx context.Context) uint64 {
