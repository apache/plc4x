...
func (m *_BACnetConstructedDataIPSubnetMask) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataIPSubnetMask) GetLengthInBytes(ctx context.Context) uint64 {
