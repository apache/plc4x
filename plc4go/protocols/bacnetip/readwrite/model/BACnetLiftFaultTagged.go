...
// BACnetLiftFaultTagged is the data-structure of this message
type BACnetLiftFaultTagged struct {
...
// IBACnetLiftFaultTagged is the corresponding interface of BACnetLiftFaultTagged
type IBACnetLiftFaultTagged interface {
...
func (m *BACnetLiftFaultTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetLiftFaultTagged) GetValue() BACnetLiftFault {
	return m.Value
}

func (m *BACnetLiftFaultTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetLiftFaultTagged) GetIsProprietary() bool {
...
// NewBACnetLiftFaultTagged factory function for BACnetLiftFaultTagged
func NewBACnetLiftFaultTagged(header *BACnetTagHeader, value BACnetLiftFault, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetLiftFaultTagged {
	return &BACnetLiftFaultTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetLiftFaultTagged) GetTypeName() string {
	return "BACnetLiftFaultTagged"
}

func (m *BACnetLiftFaultTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetLiftFaultTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetLiftFaultTagged) GetLengthInBytes() uint16 {
	return m.GetLengthInBits() / 8
}

func BACnetLiftFaultTaggedParse(readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (*BACnetLiftFaultTagged, error) {
	...
	// Create the instance
	return NewBACnetLiftFaultTagged(header, value, proprietaryValue, tagNumber, tagClass), nil
}

func (m *BACnetLiftFaultTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetLiftFaultTagged) String() string {
	if m == nil {
		return "<nil>"
	}
