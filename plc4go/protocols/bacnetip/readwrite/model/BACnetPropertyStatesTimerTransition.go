...
func (m *_BACnetPropertyStatesTimerTransition) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetPropertyStates, peekedTagNumber uint8) (_bACnetPropertyStatesTimerTransition BACnetPropertyStatesTimerTransition, err error) {
