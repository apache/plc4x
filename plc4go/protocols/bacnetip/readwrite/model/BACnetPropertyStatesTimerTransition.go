...
func (m *_BACnetPropertyStatesTimerTransition) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesTimerTransition) GetLengthInBytes(ctx context.Context) uint64 {
