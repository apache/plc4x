...
func (m *_BACnetLogRecordLogDatumRealValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetLogRecordLogDatumRealValue) GetLengthInBytes(ctx context.Context) uint64 {
