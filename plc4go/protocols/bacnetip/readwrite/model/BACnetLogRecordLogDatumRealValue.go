...
func BACnetLogRecordLogDatumRealValueParseWithBufferProducer(tagNumber uint8) func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetLogRecordLogDatumRealValue, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetLogRecordLogDatumRealValue, error) {
		return BACnetLogRecordLogDatumRealValueParseWithBuffer(ctx, readBuffer, tagNumber)
	}
}
...
func BACnetLogRecordLogDatumRealValueParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (BACnetLogRecordLogDatumRealValue, error) {
	...
	realValue, err := ReadSimpleField[BACnetContextTagReal](ctx, "realValue", ReadComplex[BACnetContextTagReal](BACnetContextTagParseWithBufferProducer((uint8)(uint8(2)), (BACnetDataType)(BACnetDataType_REAL)), readBuffer))
	if err != nil {
