...
func (m *_BACnetTimerStateChangeValueConstructedValue) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetTimerStateChangeValue, objectTypeArgument BACnetObjectType) (_bACnetTimerStateChangeValueConstructedValue BACnetTimerStateChangeValueConstructedValue, err error) {
