...
func (m *_BACnetConstructedDataFDBBMDAddress) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataFDBBMDAddress) GetLengthInBytes(ctx context.Context) uint64 {
