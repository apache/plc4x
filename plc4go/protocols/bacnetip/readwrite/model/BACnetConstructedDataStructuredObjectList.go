...
func (m *BACnetConstructedDataStructuredObjectList) GetNumberOfDataElements() *BACnetApplicationTagUnsignedInteger {
...
func (m *BACnetConstructedDataStructuredObjectList) GetZero() uint64 {
...
func NewBACnetConstructedDataStructuredObjectList(numberOfDataElements *BACnetApplicationTagUnsignedInteger, structuredObjectList []*BACnetApplicationTagObjectIdentifier, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag, tagNumber uint8, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) *BACnetConstructedDataStructuredObjectList {
...
func BACnetConstructedDataStructuredObjectListParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) (*BACnetConstructedDataStructuredObjectList, error) {
	...
	if closeErr := readBuffer.CloseContext("structuredObjectList", utils.WithRenderAsList(true)); closeErr != nil {
		return nil, errors.Wrap(closeErr, "Error closing for structuredObjectList")
	}
