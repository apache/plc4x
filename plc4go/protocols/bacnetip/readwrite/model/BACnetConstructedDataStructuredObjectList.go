...
func (m *_BACnetConstructedDataStructuredObjectList) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *_BACnetConstructedDataStructuredObjectList) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *_BACnetConstructedDataStructuredObjectList) GetLengthInBytes() uint16 {
...
func (m *_BACnetConstructedDataStructuredObjectList) Serialize(writeBuffer utils.WriteBuffer) error {
