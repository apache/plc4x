...
func (m *_BACnetTimerStateChangeValueLightingCommand) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetTimerStateChangeValue, objectTypeArgument BACnetObjectType) (_bACnetTimerStateChangeValueLightingCommand BACnetTimerStateChangeValueLightingCommand, err error) {
