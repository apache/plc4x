...
// DateTimePatternValue is the corresponding interface of DateTimePatternValue
type DateTimePatternValue interface {
	fmt.Stringer
	utils.LengthAware
	utils.Serializable
	utils.Copyable
	...
	// IsDateTimePatternValue is a marker method to prevent unintentional type checks (interfaces of same signature)
	IsDateTimePatternValue()
	// CreateBuilder creates a DateTimePatternValueBuilder
	CreateDateTimePatternValueBuilder() DateTimePatternValueBuilder
}

// _DateTimePatternValue is the data-structure of this message
type _DateTimePatternValue struct {
...
var _ DateTimePatternValue = (*_DateTimePatternValue)(nil)

// NewDateTimePatternValue factory function for _DateTimePatternValue
func NewDateTimePatternValue(objectIdentifier ReadableProperty, objectName ReadableProperty, objectType ReadableProperty, description OptionalProperty, presentValue ReadableProperty, statusFlags ReadableProperty, eventState OptionalProperty, reliability OptionalProperty, outOfService OptionalProperty, isUTC OptionalProperty, priorityArray OptionalProperty, relinquishDefault OptionalProperty, reliabilityEvaluationInhibit OptionalProperty, propertyList ReadableProperty, eventDetectionEnable OptionalProperty, notificationClass OptionalProperty, eventEnable OptionalProperty, ackedTransitions OptionalProperty, notifyType OptionalProperty, eventTimeStamps OptionalProperty, eventMessageTexts OptionalProperty, eventMessageTextsConfig OptionalProperty, currentCommandPriority OptionalProperty, valueSource OptionalProperty, valueSourceArray OptionalProperty, lastCommandTime OptionalProperty, commandTimeArray OptionalProperty, tags OptionalProperty, profileLocation OptionalProperty, profileName OptionalProperty) *_DateTimePatternValue {
	if objectIdentifier == nil {
		panic("objectIdentifier of type ReadableProperty for DateTimePatternValue must not be nil")
	}
	if objectName == nil {
		panic("objectName of type ReadableProperty for DateTimePatternValue must not be nil")
	}
	if objectType == nil {
		panic("objectType of type ReadableProperty for DateTimePatternValue must not be nil")
	}
	if description == nil {
		panic("description of type OptionalProperty for DateTimePatternValue must not be nil")
	}
	if presentValue == nil {
		panic("presentValue of type ReadableProperty for DateTimePatternValue must not be nil")
	}
	if statusFlags == nil {
		panic("statusFlags of type ReadableProperty for DateTimePatternValue must not be nil")
	}
	if eventState == nil {
		panic("eventState of type OptionalProperty for DateTimePatternValue must not be nil")
	}
	if reliability == nil {
		panic("reliability of type OptionalProperty for DateTimePatternValue must not be nil")
	}
	if outOfService == nil {
		panic("outOfService of type OptionalProperty for DateTimePatternValue must not be nil")
	}
	if isUTC == nil {
		panic("isUTC of type OptionalProperty for DateTimePatternValue must not be nil")
	}
	if priorityArray == nil {
		panic("priorityArray of type OptionalProperty for DateTimePatternValue must not be nil")
	}
	if relinquishDefault == nil {
		panic("relinquishDefault of type OptionalProperty for DateTimePatternValue must not be nil")
	}
	if reliabilityEvaluationInhibit == nil {
		panic("reliabilityEvaluationInhibit of type OptionalProperty for DateTimePatternValue must not be nil")
	}
	if propertyList == nil {
		panic("propertyList of type ReadableProperty for DateTimePatternValue must not be nil")
	}
	if eventDetectionEnable == nil {
		panic("eventDetectionEnable of type OptionalProperty for DateTimePatternValue must not be nil")
	}
	if notificationClass == nil {
		panic("notificationClass of type OptionalProperty for DateTimePatternValue must not be nil")
	}
	if eventEnable == nil {
		panic("eventEnable of type OptionalProperty for DateTimePatternValue must not be nil")
	}
	if ackedTransitions == nil {
		panic("ackedTransitions of type OptionalProperty for DateTimePatternValue must not be nil")
	}
	if notifyType == nil {
		panic("notifyType of type OptionalProperty for DateTimePatternValue must not be nil")
	}
	if eventTimeStamps == nil {
		panic("eventTimeStamps of type OptionalProperty for DateTimePatternValue must not be nil")
	}
	if eventMessageTexts == nil {
		panic("eventMessageTexts of type OptionalProperty for DateTimePatternValue must not be nil")
	}
	if eventMessageTextsConfig == nil {
		panic("eventMessageTextsConfig of type OptionalProperty for DateTimePatternValue must not be nil")
	}
	if currentCommandPriority == nil {
		panic("currentCommandPriority of type OptionalProperty for DateTimePatternValue must not be nil")
	}
	if valueSource == nil {
		panic("valueSource of type OptionalProperty for DateTimePatternValue must not be nil")
	}
	if valueSourceArray == nil {
		panic("valueSourceArray of type OptionalProperty for DateTimePatternValue must not be nil")
	}
	if lastCommandTime == nil {
		panic("lastCommandTime of type OptionalProperty for DateTimePatternValue must not be nil")
	}
	if commandTimeArray == nil {
		panic("commandTimeArray of type OptionalProperty for DateTimePatternValue must not be nil")
	}
	if tags == nil {
		panic("tags of type OptionalProperty for DateTimePatternValue must not be nil")
	}
	if profileLocation == nil {
		panic("profileLocation of type OptionalProperty for DateTimePatternValue must not be nil")
	}
	if profileName == nil {
		panic("profileName of type OptionalProperty for DateTimePatternValue must not be nil")
	}
	return &_DateTimePatternValue{ObjectIdentifier: objectIdentifier, ObjectName: objectName, ObjectType: objectType, Description: description, PresentValue: presentValue, StatusFlags: statusFlags, EventState: eventState, Reliability: reliability, OutOfService: outOfService, IsUTC: isUTC, PriorityArray: priorityArray, RelinquishDefault: relinquishDefault, ReliabilityEvaluationInhibit: reliabilityEvaluationInhibit, PropertyList: propertyList, EventDetectionEnable: eventDetectionEnable, NotificationClass: notificationClass, EventEnable: eventEnable, AckedTransitions: ackedTransitions, NotifyType: notifyType, EventTimeStamps: eventTimeStamps, EventMessageTexts: eventMessageTexts, EventMessageTextsConfig: eventMessageTextsConfig, CurrentCommandPriority: currentCommandPriority, ValueSource: valueSource, ValueSourceArray: valueSourceArray, LastCommandTime: lastCommandTime, CommandTimeArray: commandTimeArray, Tags: tags, ProfileLocation: profileLocation, ProfileName: profileName}
}
...
// DateTimePatternValueBuilder is a builder for DateTimePatternValue
type DateTimePatternValueBuilder interface {
	utils.Copyable
	// WithMandatoryFields adds all mandatory fields (convenience for using multiple builder calls)
	WithMandatoryFields(objectIdentifier ReadableProperty, objectName ReadableProperty, objectType ReadableProperty, description OptionalProperty, presentValue ReadableProperty, statusFlags ReadableProperty, eventState OptionalProperty, reliability OptionalProperty, outOfService OptionalProperty, isUTC OptionalProperty, priorityArray OptionalProperty, relinquishDefault OptionalProperty, reliabilityEvaluationInhibit OptionalProperty, propertyList ReadableProperty, eventDetectionEnable OptionalProperty, notificationClass OptionalProperty, eventEnable OptionalProperty, ackedTransitions OptionalProperty, notifyType OptionalProperty, eventTimeStamps OptionalProperty, eventMessageTexts OptionalProperty, eventMessageTextsConfig OptionalProperty, currentCommandPriority OptionalProperty, valueSource OptionalProperty, valueSourceArray OptionalProperty, lastCommandTime OptionalProperty, commandTimeArray OptionalProperty, tags OptionalProperty, profileLocation OptionalProperty, profileName OptionalProperty) DateTimePatternValueBuilder
	// WithObjectIdentifier adds ObjectIdentifier (property field)
	WithObjectIdentifier(ReadableProperty) DateTimePatternValueBuilder
	// WithObjectIdentifierBuilder adds ObjectIdentifier (property field) which is build by the builder
	WithObjectIdentifierBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) DateTimePatternValueBuilder
	// WithObjectName adds ObjectName (property field)
	WithObjectName(ReadableProperty) DateTimePatternValueBuilder
	// WithObjectNameBuilder adds ObjectName (property field) which is build by the builder
	WithObjectNameBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) DateTimePatternValueBuilder
	// WithObjectType adds ObjectType (property field)
	WithObjectType(ReadableProperty) DateTimePatternValueBuilder
	// WithObjectTypeBuilder adds ObjectType (property field) which is build by the builder
	WithObjectTypeBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) DateTimePatternValueBuilder
	// WithDescription adds Description (property field)
	WithDescription(OptionalProperty) DateTimePatternValueBuilder
	// WithDescriptionBuilder adds Description (property field) which is build by the builder
	WithDescriptionBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder
	// WithPresentValue adds PresentValue (property field)
	WithPresentValue(ReadableProperty) DateTimePatternValueBuilder
	// WithPresentValueBuilder adds PresentValue (property field) which is build by the builder
	WithPresentValueBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) DateTimePatternValueBuilder
	// WithStatusFlags adds StatusFlags (property field)
	WithStatusFlags(ReadableProperty) DateTimePatternValueBuilder
	// WithStatusFlagsBuilder adds StatusFlags (property field) which is build by the builder
	WithStatusFlagsBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) DateTimePatternValueBuilder
	// WithEventState adds EventState (property field)
	WithEventState(OptionalProperty) DateTimePatternValueBuilder
	// WithEventStateBuilder adds EventState (property field) which is build by the builder
	WithEventStateBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder
	// WithReliability adds Reliability (property field)
	WithReliability(OptionalProperty) DateTimePatternValueBuilder
	// WithReliabilityBuilder adds Reliability (property field) which is build by the builder
	WithReliabilityBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder
	// WithOutOfService adds OutOfService (property field)
	WithOutOfService(OptionalProperty) DateTimePatternValueBuilder
	// WithOutOfServiceBuilder adds OutOfService (property field) which is build by the builder
	WithOutOfServiceBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder
	// WithIsUTC adds IsUTC (property field)
	WithIsUTC(OptionalProperty) DateTimePatternValueBuilder
	// WithIsUTCBuilder adds IsUTC (property field) which is build by the builder
	WithIsUTCBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder
	// WithPriorityArray adds PriorityArray (property field)
	WithPriorityArray(OptionalProperty) DateTimePatternValueBuilder
	// WithPriorityArrayBuilder adds PriorityArray (property field) which is build by the builder
	WithPriorityArrayBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder
	// WithRelinquishDefault adds RelinquishDefault (property field)
	WithRelinquishDefault(OptionalProperty) DateTimePatternValueBuilder
	// WithRelinquishDefaultBuilder adds RelinquishDefault (property field) which is build by the builder
	WithRelinquishDefaultBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder
	// WithReliabilityEvaluationInhibit adds ReliabilityEvaluationInhibit (property field)
	WithReliabilityEvaluationInhibit(OptionalProperty) DateTimePatternValueBuilder
	// WithReliabilityEvaluationInhibitBuilder adds ReliabilityEvaluationInhibit (property field) which is build by the builder
	WithReliabilityEvaluationInhibitBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder
	// WithPropertyList adds PropertyList (property field)
	WithPropertyList(ReadableProperty) DateTimePatternValueBuilder
	// WithPropertyListBuilder adds PropertyList (property field) which is build by the builder
	WithPropertyListBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) DateTimePatternValueBuilder
	// WithEventDetectionEnable adds EventDetectionEnable (property field)
	WithEventDetectionEnable(OptionalProperty) DateTimePatternValueBuilder
	// WithEventDetectionEnableBuilder adds EventDetectionEnable (property field) which is build by the builder
	WithEventDetectionEnableBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder
	// WithNotificationClass adds NotificationClass (property field)
	WithNotificationClass(OptionalProperty) DateTimePatternValueBuilder
	// WithNotificationClassBuilder adds NotificationClass (property field) which is build by the builder
	WithNotificationClassBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder
	// WithEventEnable adds EventEnable (property field)
	WithEventEnable(OptionalProperty) DateTimePatternValueBuilder
	// WithEventEnableBuilder adds EventEnable (property field) which is build by the builder
	WithEventEnableBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder
	// WithAckedTransitions adds AckedTransitions (property field)
	WithAckedTransitions(OptionalProperty) DateTimePatternValueBuilder
	// WithAckedTransitionsBuilder adds AckedTransitions (property field) which is build by the builder
	WithAckedTransitionsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder
	// WithNotifyType adds NotifyType (property field)
	WithNotifyType(OptionalProperty) DateTimePatternValueBuilder
	// WithNotifyTypeBuilder adds NotifyType (property field) which is build by the builder
	WithNotifyTypeBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder
	// WithEventTimeStamps adds EventTimeStamps (property field)
	WithEventTimeStamps(OptionalProperty) DateTimePatternValueBuilder
	// WithEventTimeStampsBuilder adds EventTimeStamps (property field) which is build by the builder
	WithEventTimeStampsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder
	// WithEventMessageTexts adds EventMessageTexts (property field)
	WithEventMessageTexts(OptionalProperty) DateTimePatternValueBuilder
	// WithEventMessageTextsBuilder adds EventMessageTexts (property field) which is build by the builder
	WithEventMessageTextsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder
	// WithEventMessageTextsConfig adds EventMessageTextsConfig (property field)
	WithEventMessageTextsConfig(OptionalProperty) DateTimePatternValueBuilder
	// WithEventMessageTextsConfigBuilder adds EventMessageTextsConfig (property field) which is build by the builder
	WithEventMessageTextsConfigBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder
	// WithCurrentCommandPriority adds CurrentCommandPriority (property field)
	WithCurrentCommandPriority(OptionalProperty) DateTimePatternValueBuilder
	// WithCurrentCommandPriorityBuilder adds CurrentCommandPriority (property field) which is build by the builder
	WithCurrentCommandPriorityBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder
	// WithValueSource adds ValueSource (property field)
	WithValueSource(OptionalProperty) DateTimePatternValueBuilder
	// WithValueSourceBuilder adds ValueSource (property field) which is build by the builder
	WithValueSourceBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder
	// WithValueSourceArray adds ValueSourceArray (property field)
	WithValueSourceArray(OptionalProperty) DateTimePatternValueBuilder
	// WithValueSourceArrayBuilder adds ValueSourceArray (property field) which is build by the builder
	WithValueSourceArrayBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder
	// WithLastCommandTime adds LastCommandTime (property field)
	WithLastCommandTime(OptionalProperty) DateTimePatternValueBuilder
	// WithLastCommandTimeBuilder adds LastCommandTime (property field) which is build by the builder
	WithLastCommandTimeBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder
	// WithCommandTimeArray adds CommandTimeArray (property field)
	WithCommandTimeArray(OptionalProperty) DateTimePatternValueBuilder
	// WithCommandTimeArrayBuilder adds CommandTimeArray (property field) which is build by the builder
	WithCommandTimeArrayBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder
	// WithTags adds Tags (property field)
	WithTags(OptionalProperty) DateTimePatternValueBuilder
	// WithTagsBuilder adds Tags (property field) which is build by the builder
	WithTagsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder
	// WithProfileLocation adds ProfileLocation (property field)
	WithProfileLocation(OptionalProperty) DateTimePatternValueBuilder
	// WithProfileLocationBuilder adds ProfileLocation (property field) which is build by the builder
	WithProfileLocationBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder
	// WithProfileName adds ProfileName (property field)
	WithProfileName(OptionalProperty) DateTimePatternValueBuilder
	// WithProfileNameBuilder adds ProfileName (property field) which is build by the builder
	WithProfileNameBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder
	// Build builds the DateTimePatternValue or returns an error if something is wrong
	Build() (DateTimePatternValue, error)
	// MustBuild does the same as Build but panics on error
	MustBuild() DateTimePatternValue
}

// NewDateTimePatternValueBuilder() creates a DateTimePatternValueBuilder
func NewDateTimePatternValueBuilder() DateTimePatternValueBuilder {
	return &_DateTimePatternValueBuilder{_DateTimePatternValue: new(_DateTimePatternValue)}
}

type _DateTimePatternValueBuilder struct {
	*_DateTimePatternValue

	err *utils.MultiError
}

var _ (DateTimePatternValueBuilder) = (*_DateTimePatternValueBuilder)(nil)

func (b *_DateTimePatternValueBuilder) WithMandatoryFields(objectIdentifier ReadableProperty, objectName ReadableProperty, objectType ReadableProperty, description OptionalProperty, presentValue ReadableProperty, statusFlags ReadableProperty, eventState OptionalProperty, reliability OptionalProperty, outOfService OptionalProperty, isUTC OptionalProperty, priorityArray OptionalProperty, relinquishDefault OptionalProperty, reliabilityEvaluationInhibit OptionalProperty, propertyList ReadableProperty, eventDetectionEnable OptionalProperty, notificationClass OptionalProperty, eventEnable OptionalProperty, ackedTransitions OptionalProperty, notifyType OptionalProperty, eventTimeStamps OptionalProperty, eventMessageTexts OptionalProperty, eventMessageTextsConfig OptionalProperty, currentCommandPriority OptionalProperty, valueSource OptionalProperty, valueSourceArray OptionalProperty, lastCommandTime OptionalProperty, commandTimeArray OptionalProperty, tags OptionalProperty, profileLocation OptionalProperty, profileName OptionalProperty) DateTimePatternValueBuilder {
	return b.WithObjectIdentifier(objectIdentifier).WithObjectName(objectName).WithObjectType(objectType).WithDescription(description).WithPresentValue(presentValue).WithStatusFlags(statusFlags).WithEventState(eventState).WithReliability(reliability).WithOutOfService(outOfService).WithIsUTC(isUTC).WithPriorityArray(priorityArray).WithRelinquishDefault(relinquishDefault).WithReliabilityEvaluationInhibit(reliabilityEvaluationInhibit).WithPropertyList(propertyList).WithEventDetectionEnable(eventDetectionEnable).WithNotificationClass(notificationClass).WithEventEnable(eventEnable).WithAckedTransitions(ackedTransitions).WithNotifyType(notifyType).WithEventTimeStamps(eventTimeStamps).WithEventMessageTexts(eventMessageTexts).WithEventMessageTextsConfig(eventMessageTextsConfig).WithCurrentCommandPriority(currentCommandPriority).WithValueSource(valueSource).WithValueSourceArray(valueSourceArray).WithLastCommandTime(lastCommandTime).WithCommandTimeArray(commandTimeArray).WithTags(tags).WithProfileLocation(profileLocation).WithProfileName(profileName)
}

func (b *_DateTimePatternValueBuilder) WithObjectIdentifier(objectIdentifier ReadableProperty) DateTimePatternValueBuilder {
	b.ObjectIdentifier = objectIdentifier
	return b
}

func (b *_DateTimePatternValueBuilder) WithObjectIdentifierBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithObjectName(objectName ReadableProperty) DateTimePatternValueBuilder {
	b.ObjectName = objectName
	return b
}

func (b *_DateTimePatternValueBuilder) WithObjectNameBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithObjectType(objectType ReadableProperty) DateTimePatternValueBuilder {
	b.ObjectType = objectType
	return b
}

func (b *_DateTimePatternValueBuilder) WithObjectTypeBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithDescription(description OptionalProperty) DateTimePatternValueBuilder {
	b.Description = description
	return b
}

func (b *_DateTimePatternValueBuilder) WithDescriptionBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithPresentValue(presentValue ReadableProperty) DateTimePatternValueBuilder {
	b.PresentValue = presentValue
	return b
}

func (b *_DateTimePatternValueBuilder) WithPresentValueBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithStatusFlags(statusFlags ReadableProperty) DateTimePatternValueBuilder {
	b.StatusFlags = statusFlags
	return b
}

func (b *_DateTimePatternValueBuilder) WithStatusFlagsBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithEventState(eventState OptionalProperty) DateTimePatternValueBuilder {
	b.EventState = eventState
	return b
}

func (b *_DateTimePatternValueBuilder) WithEventStateBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithReliability(reliability OptionalProperty) DateTimePatternValueBuilder {
	b.Reliability = reliability
	return b
}

func (b *_DateTimePatternValueBuilder) WithReliabilityBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithOutOfService(outOfService OptionalProperty) DateTimePatternValueBuilder {
	b.OutOfService = outOfService
	return b
}

func (b *_DateTimePatternValueBuilder) WithOutOfServiceBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithIsUTC(isUTC OptionalProperty) DateTimePatternValueBuilder {
	b.IsUTC = isUTC
	return b
}

func (b *_DateTimePatternValueBuilder) WithIsUTCBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder {
	builder := builderSupplier(b.IsUTC.CreateOptionalPropertyBuilder())
	var err error
...
func (b *_DateTimePatternValueBuilder) WithPriorityArray(priorityArray OptionalProperty) DateTimePatternValueBuilder {
	b.PriorityArray = priorityArray
	return b
}

func (b *_DateTimePatternValueBuilder) WithPriorityArrayBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithRelinquishDefault(relinquishDefault OptionalProperty) DateTimePatternValueBuilder {
	b.RelinquishDefault = relinquishDefault
	return b
}

func (b *_DateTimePatternValueBuilder) WithRelinquishDefaultBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithReliabilityEvaluationInhibit(reliabilityEvaluationInhibit OptionalProperty) DateTimePatternValueBuilder {
	b.ReliabilityEvaluationInhibit = reliabilityEvaluationInhibit
	return b
}

func (b *_DateTimePatternValueBuilder) WithReliabilityEvaluationInhibitBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithPropertyList(propertyList ReadableProperty) DateTimePatternValueBuilder {
	b.PropertyList = propertyList
	return b
}

func (b *_DateTimePatternValueBuilder) WithPropertyListBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithEventDetectionEnable(eventDetectionEnable OptionalProperty) DateTimePatternValueBuilder {
	b.EventDetectionEnable = eventDetectionEnable
	return b
}

func (b *_DateTimePatternValueBuilder) WithEventDetectionEnableBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithNotificationClass(notificationClass OptionalProperty) DateTimePatternValueBuilder {
	b.NotificationClass = notificationClass
	return b
}

func (b *_DateTimePatternValueBuilder) WithNotificationClassBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithEventEnable(eventEnable OptionalProperty) DateTimePatternValueBuilder {
	b.EventEnable = eventEnable
	return b
}

func (b *_DateTimePatternValueBuilder) WithEventEnableBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithAckedTransitions(ackedTransitions OptionalProperty) DateTimePatternValueBuilder {
	b.AckedTransitions = ackedTransitions
	return b
}

func (b *_DateTimePatternValueBuilder) WithAckedTransitionsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithNotifyType(notifyType OptionalProperty) DateTimePatternValueBuilder {
	b.NotifyType = notifyType
	return b
}

func (b *_DateTimePatternValueBuilder) WithNotifyTypeBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithEventTimeStamps(eventTimeStamps OptionalProperty) DateTimePatternValueBuilder {
	b.EventTimeStamps = eventTimeStamps
	return b
}

func (b *_DateTimePatternValueBuilder) WithEventTimeStampsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithEventMessageTexts(eventMessageTexts OptionalProperty) DateTimePatternValueBuilder {
	b.EventMessageTexts = eventMessageTexts
	return b
}

func (b *_DateTimePatternValueBuilder) WithEventMessageTextsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithEventMessageTextsConfig(eventMessageTextsConfig OptionalProperty) DateTimePatternValueBuilder {
	b.EventMessageTextsConfig = eventMessageTextsConfig
	return b
}

func (b *_DateTimePatternValueBuilder) WithEventMessageTextsConfigBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithCurrentCommandPriority(currentCommandPriority OptionalProperty) DateTimePatternValueBuilder {
	b.CurrentCommandPriority = currentCommandPriority
	return b
}

func (b *_DateTimePatternValueBuilder) WithCurrentCommandPriorityBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithValueSource(valueSource OptionalProperty) DateTimePatternValueBuilder {
	b.ValueSource = valueSource
	return b
}

func (b *_DateTimePatternValueBuilder) WithValueSourceBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithValueSourceArray(valueSourceArray OptionalProperty) DateTimePatternValueBuilder {
	b.ValueSourceArray = valueSourceArray
	return b
}

func (b *_DateTimePatternValueBuilder) WithValueSourceArrayBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithLastCommandTime(lastCommandTime OptionalProperty) DateTimePatternValueBuilder {
	b.LastCommandTime = lastCommandTime
	return b
}

func (b *_DateTimePatternValueBuilder) WithLastCommandTimeBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithCommandTimeArray(commandTimeArray OptionalProperty) DateTimePatternValueBuilder {
	b.CommandTimeArray = commandTimeArray
	return b
}

func (b *_DateTimePatternValueBuilder) WithCommandTimeArrayBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithTags(tags OptionalProperty) DateTimePatternValueBuilder {
	b.Tags = tags
	return b
}

func (b *_DateTimePatternValueBuilder) WithTagsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithProfileLocation(profileLocation OptionalProperty) DateTimePatternValueBuilder {
	b.ProfileLocation = profileLocation
	return b
}

func (b *_DateTimePatternValueBuilder) WithProfileLocationBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) WithProfileName(profileName OptionalProperty) DateTimePatternValueBuilder {
	b.ProfileName = profileName
	return b
}

func (b *_DateTimePatternValueBuilder) WithProfileNameBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimePatternValueBuilder {
...
func (b *_DateTimePatternValueBuilder) Build() (DateTimePatternValue, error) {
	...
	return b._DateTimePatternValue.deepCopy(), nil
}

func (b *_DateTimePatternValueBuilder) MustBuild() DateTimePatternValue {
	build, err := b.Build()
	if err != nil {
		panic(err)
	}
...
func (b *_DateTimePatternValueBuilder) DeepCopy() any {
	_copy := b.CreateDateTimePatternValueBuilder().(*_DateTimePatternValueBuilder)
	if b.err != nil {
...
// CreateDateTimePatternValueBuilder creates a DateTimePatternValueBuilder
func (b *_DateTimePatternValue) CreateDateTimePatternValueBuilder() DateTimePatternValueBuilder {
	if b == nil {
		return NewDateTimePatternValueBuilder()
	}
	return &_DateTimePatternValueBuilder{_DateTimePatternValue: b.deepCopy()}
}
...
func (m *_DateTimePatternValue) GetObjectIdentifier() ReadableProperty {
	return m.ObjectIdentifier
}

func (m *_DateTimePatternValue) GetObjectName() ReadableProperty {
	return m.ObjectName
}

func (m *_DateTimePatternValue) GetObjectType() ReadableProperty {
	return m.ObjectType
}

func (m *_DateTimePatternValue) GetDescription() OptionalProperty {
	return m.Description
}

func (m *_DateTimePatternValue) GetPresentValue() ReadableProperty {
	return m.PresentValue
}

func (m *_DateTimePatternValue) GetStatusFlags() ReadableProperty {
	return m.StatusFlags
}

func (m *_DateTimePatternValue) GetEventState() OptionalProperty {
	return m.EventState
}

func (m *_DateTimePatternValue) GetReliability() OptionalProperty {
	return m.Reliability
}

func (m *_DateTimePatternValue) GetOutOfService() OptionalProperty {
	return m.OutOfService
}

func (m *_DateTimePatternValue) GetIsUTC() OptionalProperty {
	return m.IsUTC
}

func (m *_DateTimePatternValue) GetPriorityArray() OptionalProperty {
	return m.PriorityArray
}

func (m *_DateTimePatternValue) GetRelinquishDefault() OptionalProperty {
	return m.RelinquishDefault
}

func (m *_DateTimePatternValue) GetReliabilityEvaluationInhibit() OptionalProperty {
	return m.ReliabilityEvaluationInhibit
}

func (m *_DateTimePatternValue) GetPropertyList() ReadableProperty {
	return m.PropertyList
}

func (m *_DateTimePatternValue) GetEventDetectionEnable() OptionalProperty {
	return m.EventDetectionEnable
}

func (m *_DateTimePatternValue) GetNotificationClass() OptionalProperty {
	return m.NotificationClass
}

func (m *_DateTimePatternValue) GetEventEnable() OptionalProperty {
	return m.EventEnable
}

func (m *_DateTimePatternValue) GetAckedTransitions() OptionalProperty {
	return m.AckedTransitions
}

func (m *_DateTimePatternValue) GetNotifyType() OptionalProperty {
	return m.NotifyType
}

func (m *_DateTimePatternValue) GetEventTimeStamps() OptionalProperty {
	return m.EventTimeStamps
}

func (m *_DateTimePatternValue) GetEventMessageTexts() OptionalProperty {
	return m.EventMessageTexts
}

func (m *_DateTimePatternValue) GetEventMessageTextsConfig() OptionalProperty {
	return m.EventMessageTextsConfig
}

func (m *_DateTimePatternValue) GetCurrentCommandPriority() OptionalProperty {
	return m.CurrentCommandPriority
}

func (m *_DateTimePatternValue) GetValueSource() OptionalProperty {
	return m.ValueSource
}

func (m *_DateTimePatternValue) GetValueSourceArray() OptionalProperty {
	return m.ValueSourceArray
}

func (m *_DateTimePatternValue) GetLastCommandTime() OptionalProperty {
	return m.LastCommandTime
}

func (m *_DateTimePatternValue) GetCommandTimeArray() OptionalProperty {
	return m.CommandTimeArray
}

func (m *_DateTimePatternValue) GetTags() OptionalProperty {
	return m.Tags
}

func (m *_DateTimePatternValue) GetProfileLocation() OptionalProperty {
	return m.ProfileLocation
}

func (m *_DateTimePatternValue) GetProfileName() OptionalProperty {
...
func CastDateTimePatternValue(structType any) DateTimePatternValue {
	if casted, ok := structType.(DateTimePatternValue); ok {
		return casted
	}
	if casted, ok := structType.(*DateTimePatternValue); ok {
		return *casted
...
func (m *_DateTimePatternValue) GetTypeName() string {
	return "DateTimePatternValue"
}

func (m *_DateTimePatternValue) GetLengthInBits(ctx context.Context) uint16 {
...
func (m *_DateTimePatternValue) GetLengthInBytes(ctx context.Context) uint16 {
	return m.GetLengthInBits(ctx) / 8
}

func DateTimePatternValueParse(ctx context.Context, theBytes []byte) (DateTimePatternValue, error) {
	return DateTimePatternValueParseWithBuffer(ctx, utils.NewReadBufferByteBased(theBytes))
}

func DateTimePatternValueParseWithBufferProducer() func(ctx context.Context, readBuffer utils.ReadBuffer) (DateTimePatternValue, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (DateTimePatternValue, error) {
		return DateTimePatternValueParseWithBuffer(ctx, readBuffer)
	}
}

func DateTimePatternValueParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (DateTimePatternValue, error) {
	v, err := (&_DateTimePatternValue{}).parse(ctx, readBuffer)
	if err != nil {
		return nil, err
	}
	return v, nil
...
func (m *_DateTimePatternValue) parse(ctx context.Context, readBuffer utils.ReadBuffer) (__dateTimePatternValue DateTimePatternValue, err error) {
	positionAware := readBuffer
	_ = positionAware
	if pullErr := readBuffer.PullContext("DateTimePatternValue"); pullErr != nil {
		return nil, errors.Wrap(pullErr, "Error pulling for DateTimePatternValue")
	}
	...
	presentValue, err := ReadSimpleField[ReadableProperty](ctx, "presentValue", ReadComplex[ReadableProperty](ReadablePropertyParseWithBufferProducer((string)("BACnetDateTime")), readBuffer))
	if err != nil {
	...
	isUTC, err := ReadSimpleField[OptionalProperty](ctx, "isUTC", ReadComplex[OptionalProperty](OptionalPropertyParseWithBufferProducer((string)("BOOLEAN")), readBuffer))
	if err != nil {
	...
	relinquishDefault, err := ReadSimpleField[OptionalProperty](ctx, "relinquishDefault", ReadComplex[OptionalProperty](OptionalPropertyParseWithBufferProducer((string)("BACnetDateTime")), readBuffer))
	if err != nil {
	...
	if closeErr := readBuffer.CloseContext("DateTimePatternValue"); closeErr != nil {
		return nil, errors.Wrap(closeErr, "Error closing for DateTimePatternValue")
	}

	return m, nil
}

func (m *_DateTimePatternValue) Serialize() ([]byte, error) {
...
func (m *_DateTimePatternValue) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	positionAware := writeBuffer
	_ = positionAware
	log := zerolog.Ctx(ctx)
	_ = log
	if pushErr := writeBuffer.PushContext("DateTimePatternValue"); pushErr != nil {
		return errors.Wrap(pushErr, "Error pushing for DateTimePatternValue")
	}
	...
	if err := WriteSimpleField[OptionalProperty](ctx, "isUTC", m.GetIsUTC(), WriteComplex[OptionalProperty](writeBuffer)); err != nil {
	...
	if popErr := writeBuffer.PopContext("DateTimePatternValue"); popErr != nil {
		return errors.Wrap(popErr, "Error popping for DateTimePatternValue")
	}
	return nil
}

func (m *_DateTimePatternValue) IsDateTimePatternValue() {}

func (m *_DateTimePatternValue) DeepCopy() any {
	return m.deepCopy()
}

func (m *_DateTimePatternValue) deepCopy() *_DateTimePatternValue {
	if m == nil {
		return nil
	}
	_DateTimePatternValueCopy := &_DateTimePatternValue{
		...
		m.IsUTC.DeepCopy().(OptionalProperty),
	...
	return _DateTimePatternValueCopy
}

func (m *_DateTimePatternValue) String() string {
	if m == nil {
		return "<nil>"
	}
