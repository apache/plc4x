...
func (m *_BACnetConstructedDataInstallationID) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataInstallationID) GetLengthInBytes(ctx context.Context) uint64 {
