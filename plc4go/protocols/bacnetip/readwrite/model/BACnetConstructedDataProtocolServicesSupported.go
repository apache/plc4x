...
func (m *_BACnetConstructedDataProtocolServicesSupported) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataProtocolServicesSupported) GetLengthInBytes(ctx context.Context) uint64 {
