...
func (m *_BACnetConstructedDataCommandTimeArray) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataCommandTimeArray) GetLengthInBytes(ctx context.Context) uint64 {
