...
func (m *_BACnetEventParameterCommandFailure) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetEventParameterCommandFailure) GetLengthInBytes(ctx context.Context) uint64 {
