...
func (m *_BACnetConstructedDataNetworkType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataNetworkType) GetLengthInBytes(ctx context.Context) uint64 {
