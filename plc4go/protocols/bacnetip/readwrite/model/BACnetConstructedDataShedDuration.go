...
func (m *BACnetConstructedDataShedDuration) GetActualValue() *BACnetApplicationTagUnsignedInteger {
...
func (m *BACnetConstructedDataShedDuration) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		_shedDurationErr := writeBuffer.WriteSerializable(m.ShedDuration)
