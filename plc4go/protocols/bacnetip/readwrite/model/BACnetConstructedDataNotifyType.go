...
func (m *_BACnetConstructedDataNotifyType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataNotifyType) GetLengthInBytes(ctx context.Context) uint64 {
