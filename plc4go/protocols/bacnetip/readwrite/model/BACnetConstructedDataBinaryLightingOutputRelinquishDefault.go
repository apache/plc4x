...
func (m *_BACnetConstructedDataBinaryLightingOutputRelinquishDefault) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataBinaryLightingOutputRelinquishDefault) GetLengthInBytes(ctx context.Context) uint64 {
