...
func (m *_BACnetConstructedDataBinaryLightingOutputRelinquishDefaultBuilder) WithMandatoryFields(relinquishDefault BACnetBinaryLightingPVTagged) BACnetConstructedDataBinaryLightingOutputRelinquishDefaultBuilder {
	return m.WithRelinquishDefault(relinquishDefault)
}

func (m *_BACnetConstructedDataBinaryLightingOutputRelinquishDefaultBuilder) WithRelinquishDefault(relinquishDefault BACnetBinaryLightingPVTagged) BACnetConstructedDataBinaryLightingOutputRelinquishDefaultBuilder {
	m.RelinquishDefault = relinquishDefault
	return m
}

func (m *_BACnetConstructedDataBinaryLightingOutputRelinquishDefaultBuilder) WithRelinquishDefaultBuilder(builderSupplier func(BACnetBinaryLightingPVTaggedBuilder) BACnetBinaryLightingPVTaggedBuilder) BACnetConstructedDataBinaryLightingOutputRelinquishDefaultBuilder {
	builder := builderSupplier(m.RelinquishDefault.CreateBACnetBinaryLightingPVTaggedBuilder())
	var err error
...
func (m *_BACnetConstructedDataBinaryLightingOutputRelinquishDefaultBuilder) Build() (BACnetConstructedDataBinaryLightingOutputRelinquishDefault, error) {
	...
	return m._BACnetConstructedDataBinaryLightingOutputRelinquishDefault.deepCopy(), nil
}

func (m *_BACnetConstructedDataBinaryLightingOutputRelinquishDefaultBuilder) MustBuild() BACnetConstructedDataBinaryLightingOutputRelinquishDefault {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetConstructedDataBinaryLightingOutputRelinquishDefaultBuilder) DeepCopy() any {
	return m.CreateBACnetConstructedDataBinaryLightingOutputRelinquishDefaultBuilder()
}
...
func (m *_BACnetConstructedDataBinaryLightingOutputRelinquishDefault) CreateBACnetConstructedDataBinaryLightingOutputRelinquishDefaultBuilder() BACnetConstructedDataBinaryLightingOutputRelinquishDefaultBuilder {
	if m == nil {
		return NewBACnetConstructedDataBinaryLightingOutputRelinquishDefaultBuilder()
	}
	return &_BACnetConstructedDataBinaryLightingOutputRelinquishDefaultBuilder{_BACnetConstructedDataBinaryLightingOutputRelinquishDefault: m.deepCopy()}
}
