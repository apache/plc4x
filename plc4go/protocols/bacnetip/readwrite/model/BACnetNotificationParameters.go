...
func (m *_BACnetNotificationParameters) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType) (_bACnetNotificationParameters BACnetNotificationParameters, err error) {
