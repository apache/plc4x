...
func (m BACnetAccessEvent) GetLengthInBits(ctx context.Context) uint64 {
	return 16
}

func (m BACnetAccessEvent) GetLengthInBytes(ctx context.Context) uint64 {
...
func (e BACnetAccessEvent) GetValue() uint16 {
	return uint16(e)
}
