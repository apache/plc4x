...
func (m *_BACnetPropertyStatesDoorValue) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetPropertyStates, peekedTagNumber uint8) (_bACnetPropertyStatesDoorValue BACnetPropertyStatesDoorValue, err error) {
