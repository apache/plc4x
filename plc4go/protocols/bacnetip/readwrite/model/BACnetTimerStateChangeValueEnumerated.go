...
// BACnetTimerStateChangeValueEnumerated is the data-structure of this message
type BACnetTimerStateChangeValueEnumerated struct {
...
// IBACnetTimerStateChangeValueEnumerated is the corresponding interface of BACnetTimerStateChangeValueEnumerated
type IBACnetTimerStateChangeValueEnumerated interface {
...
func (m *BACnetTimerStateChangeValueEnumerated) InitializeParent(parent *BACnetTimerStateChangeValue, peekedTagHeader *BACnetTagHeader) {
	m.BACnetTimerStateChangeValue.PeekedTagHeader = peekedTagHeader
}

func (m *BACnetTimerStateChangeValueEnumerated) GetParent() *BACnetTimerStateChangeValue {
...
func (m *BACnetTimerStateChangeValueEnumerated) GetEnumeratedValue() *BACnetApplicationTagEnumerated {
...
// NewBACnetTimerStateChangeValueEnumerated factory function for BACnetTimerStateChangeValueEnumerated
func NewBACnetTimerStateChangeValueEnumerated(enumeratedValue *BACnetApplicationTagEnumerated, peekedTagHeader *BACnetTagHeader, objectTypeArgument BACnetObjectType) *BACnetTimerStateChangeValueEnumerated {
	_result := &BACnetTimerStateChangeValueEnumerated{
...
func CastBACnetTimerStateChangeValueEnumerated(structType interface{}) *BACnetTimerStateChangeValueEnumerated {
	...
	if casted, ok := structType.(BACnetTimerStateChangeValue); ok {
		return CastBACnetTimerStateChangeValueEnumerated(casted.Child)
	}
	if casted, ok := structType.(*BACnetTimerStateChangeValue); ok {
		return CastBACnetTimerStateChangeValueEnumerated(casted.Child)
	}
...
func (m *BACnetTimerStateChangeValueEnumerated) GetTypeName() string {
	return "BACnetTimerStateChangeValueEnumerated"
}

func (m *BACnetTimerStateChangeValueEnumerated) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetTimerStateChangeValueEnumerated) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetTimerStateChangeValueEnumerated) GetLengthInBytes() uint16 {
...
func BACnetTimerStateChangeValueEnumeratedParse(readBuffer utils.ReadBuffer, objectTypeArgument BACnetObjectType) (*BACnetTimerStateChangeValueEnumerated, error) {
	...
	_child := &BACnetTimerStateChangeValueEnumerated{
...
func (m *BACnetTimerStateChangeValueEnumerated) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetTimerStateChangeValueEnumerated) String() string {
	if m == nil {
		return "<nil>"
	}
