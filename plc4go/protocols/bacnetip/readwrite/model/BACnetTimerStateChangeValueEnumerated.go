...
func (m *_BACnetTimerStateChangeValueEnumerated) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetTimerStateChangeValue, objectTypeArgument BACnetObjectType) (_bACnetTimerStateChangeValueEnumerated BACnetTimerStateChangeValueEnumerated, err error) {
