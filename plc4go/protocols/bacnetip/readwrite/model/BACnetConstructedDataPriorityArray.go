...
func (m *_BACnetConstructedDataPriorityArray) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataPriorityArray) GetLengthInBytes(ctx context.Context) uint64 {
