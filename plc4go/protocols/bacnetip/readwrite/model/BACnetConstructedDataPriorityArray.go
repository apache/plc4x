...
func (m *_BACnetConstructedDataPriorityArrayBuilder) WithMandatoryFields(priorityArray BACnetPriorityArray) BACnetConstructedDataPriorityArrayBuilder {
	return m.WithPriorityArray(priorityArray)
}

func (m *_BACnetConstructedDataPriorityArrayBuilder) WithPriorityArray(priorityArray BACnetPriorityArray) BACnetConstructedDataPriorityArrayBuilder {
	m.PriorityArray = priorityArray
	return m
}

func (m *_BACnetConstructedDataPriorityArrayBuilder) WithPriorityArrayBuilder(builderSupplier func(BACnetPriorityArrayBuilder) BACnetPriorityArrayBuilder) BACnetConstructedDataPriorityArrayBuilder {
	builder := builderSupplier(m.PriorityArray.CreateBACnetPriorityArrayBuilder())
	var err error
	m.PriorityArray, err = builder.Build()
	if err != nil {
		if m.err == nil {
			m.err = &utils.MultiError{MainError: errors.New("sub builder failed")}
		}
		m.err.Append(errors.Wrap(err, "BACnetPriorityArrayBuilder failed"))
	}
	return m
}

func (m *_BACnetConstructedDataPriorityArrayBuilder) Build() (BACnetConstructedDataPriorityArray, error) {
	if m.PriorityArray == nil {
		if m.err == nil {
			m.err = new(utils.MultiError)
		}
		m.err.Append(errors.New("mandatory field 'priorityArray' not set"))
	}
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._BACnetConstructedDataPriorityArray.deepCopy(), nil
}

func (m *_BACnetConstructedDataPriorityArrayBuilder) MustBuild() BACnetConstructedDataPriorityArray {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetConstructedDataPriorityArrayBuilder) DeepCopy() any {
	return m.CreateBACnetConstructedDataPriorityArrayBuilder()
}

// CreateBACnetConstructedDataPriorityArrayBuilder creates a BACnetConstructedDataPriorityArrayBuilder
func (m *_BACnetConstructedDataPriorityArray) CreateBACnetConstructedDataPriorityArrayBuilder() BACnetConstructedDataPriorityArrayBuilder {
	if m == nil {
		return NewBACnetConstructedDataPriorityArrayBuilder()
	}
	return &_BACnetConstructedDataPriorityArrayBuilder{_BACnetConstructedDataPriorityArray: m.deepCopy()}
}
