...
func (m *_BACnetConstructedDataDoNotHide) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataDoNotHide) GetLengthInBytes(ctx context.Context) uint64 {
