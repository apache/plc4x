...
func (m *_BACnetConstructedDataProgramState) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataProgramState) GetLengthInBytes(ctx context.Context) uint64 {
