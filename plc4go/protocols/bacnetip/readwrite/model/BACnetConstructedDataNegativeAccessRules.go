...
func (m *_BACnetConstructedDataNegativeAccessRules) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataNegativeAccessRules) GetLengthInBytes(ctx context.Context) uint64 {
