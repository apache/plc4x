...
func (m *_BACnetLogDataLogDataEntryRealValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetLogDataLogDataEntryRealValue) GetLengthInBytes(ctx context.Context) uint64 {
