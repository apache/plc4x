...
func (m *_BACnetConstructedDataBitStringValueAlarmValues) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataBitStringValueAlarmValues) GetLengthInBytes(ctx context.Context) uint64 {
