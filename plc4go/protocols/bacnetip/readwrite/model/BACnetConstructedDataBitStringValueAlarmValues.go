...
func (m *BACnetConstructedDataBitStringValueAlarmValues) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag) {
...
func (m *BACnetConstructedDataBitStringValueAlarmValues) GetNumberOfDataElements() *BACnetApplicationTagUnsignedInteger {
...
func (m *BACnetConstructedDataBitStringValueAlarmValues) GetZero() uint64 {
...
func NewBACnetConstructedDataBitStringValueAlarmValues(numberOfDataElements *BACnetApplicationTagUnsignedInteger, alarmValues []*BACnetApplicationTagBitString, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag, tagNumber uint8, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) *BACnetConstructedDataBitStringValueAlarmValues {
