...
func (m *_BACnetConstructedDataBinaryValuePresentValue) GetPlx4xTypeName() string {
	return "BACnetConstructedDataBinaryValuePresentValue"
}

func (m *_BACnetConstructedDataBinaryValuePresentValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataBinaryValuePresentValue) GetLengthInBytes(ctx context.Context) uint64 {
