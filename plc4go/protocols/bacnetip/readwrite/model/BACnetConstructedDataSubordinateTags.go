...
func (m *_BACnetConstructedDataSubordinateTags) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataSubordinateTags) GetLengthInBytes(ctx context.Context) uint64 {
