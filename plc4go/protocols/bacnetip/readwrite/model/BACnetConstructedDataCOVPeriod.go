...
func (m *_BACnetConstructedDataCOVPeriod) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataCOVPeriod) GetLengthInBytes(ctx context.Context) uint64 {
