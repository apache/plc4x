...
func CastBACnetLiftFault(structType any) BACnetLiftFault {
	castFunc := func(typ any) BACnetLiftFault {
...
func (m BACnetLiftFault) GetLengthInBits(ctx context.Context) uint64 {
	return 16
}

func (m BACnetLiftFault) GetLengthInBytes(ctx context.Context) uint64 {
...
func BACnetLiftFaultParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetLiftFault, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint16("BACnetLiftFault", 16)
	if err != nil {
...
func (e BACnetLiftFault) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint16("BACnetLiftFault", 16, uint16(uint16(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}

func (e BACnetLiftFault) GetValue() uint16 {
	return uint16(e)
}
