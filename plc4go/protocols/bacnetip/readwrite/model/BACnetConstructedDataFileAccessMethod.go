...
func (m *_BACnetConstructedDataFileAccessMethod) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataFileAccessMethod) GetLengthInBytes(ctx context.Context) uint64 {
