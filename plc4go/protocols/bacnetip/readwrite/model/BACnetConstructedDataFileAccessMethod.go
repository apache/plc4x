...
func (m *BACnetConstructedDataFileAccessMethod) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag) {
...
func NewBACnetConstructedDataFileAccessMethod(fileAccessMethod *BACnetFileAccessMethodTagged, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag, tagNumber uint8) *BACnetConstructedDataFileAccessMethod {
