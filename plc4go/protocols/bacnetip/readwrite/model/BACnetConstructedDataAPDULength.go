...
func (m *_BACnetConstructedDataAPDULength) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataAPDULength) GetLengthInBytes(ctx context.Context) uint64 {
