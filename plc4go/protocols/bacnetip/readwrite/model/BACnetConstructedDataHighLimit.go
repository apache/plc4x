...
func (m *_BACnetConstructedDataHighLimit) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataHighLimit) GetLengthInBytes(ctx context.Context) uint64 {
