...
func (m *_BACnetShedLevelLevel) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetShedLevel) (_bACnetShedLevelLevel BACnetShedLevelLevel, err error) {
