...
func (m *_BACnetConstructedDataLargeAnalogValueAllBuilder) WithMandatoryFields() BACnetConstructedDataLargeAnalogValueAllBuilder {
	return m
}

func (m *_BACnetConstructedDataLargeAnalogValueAllBuilder) Build() (BACnetConstructedDataLargeAnalogValueAll, error) {
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._BACnetConstructedDataLargeAnalogValueAll.deepCopy(), nil
}

func (m *_BACnetConstructedDataLargeAnalogValueAllBuilder) MustBuild() BACnetConstructedDataLargeAnalogValueAll {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetConstructedDataLargeAnalogValueAllBuilder) DeepCopy() any {
	return m.CreateBACnetConstructedDataLargeAnalogValueAllBuilder()
}

// CreateBACnetConstructedDataLargeAnalogValueAllBuilder creates a BACnetConstructedDataLargeAnalogValueAllBuilder
func (m *_BACnetConstructedDataLargeAnalogValueAll) CreateBACnetConstructedDataLargeAnalogValueAllBuilder() BACnetConstructedDataLargeAnalogValueAllBuilder {
	if m == nil {
		return NewBACnetConstructedDataLargeAnalogValueAllBuilder()
	}
	return &_BACnetConstructedDataLargeAnalogValueAllBuilder{_BACnetConstructedDataLargeAnalogValueAll: m.deepCopy()}
}
