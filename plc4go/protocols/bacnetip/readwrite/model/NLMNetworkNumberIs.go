...
func (m *_NLMNetworkNumberIs) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_NLM, apduLength uint16) (_nLMNetworkNumberIs NLMNetworkNumberIs, err error) {
