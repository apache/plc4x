...
func (m *_BACnetConstructedDataCurrentCommandPriorityBuilder) WithCurrentCommandPriorityBuilder(builderSupplier func(BACnetOptionalUnsignedBuilder) BACnetOptionalUnsignedBuilder) BACnetConstructedDataCurrentCommandPriorityBuilder {
	builder := builderSupplier(m.CurrentCommandPriority.CreateBACnetOptionalUnsignedBuilder())
	var err error
	m.CurrentCommandPriority, err = builder.Build()
	if err != nil {
		if m.err == nil {
			m.err = &utils.MultiError{MainError: errors.New("sub builder failed")}
		}
		m.err.Append(errors.Wrap(err, "BACnetOptionalUnsignedBuilder failed"))
	}
	return m
}
