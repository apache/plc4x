...
func (m *_BACnetConstructedDataAssignedLandingCalls) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataAssignedLandingCalls) GetLengthInBytes(ctx context.Context) uint64 {
