...
// BACnetSecurityLevelTagged is the data-structure of this message
type BACnetSecurityLevelTagged struct {
...
// IBACnetSecurityLevelTagged is the corresponding interface of BACnetSecurityLevelTagged
type IBACnetSecurityLevelTagged interface {
...
func (m *BACnetSecurityLevelTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetSecurityLevelTagged) GetValue() BACnetSecurityLevel {
	return m.Value
}
...
// NewBACnetSecurityLevelTagged factory function for BACnetSecurityLevelTagged
func NewBACnetSecurityLevelTagged(header *BACnetTagHeader, value BACnetSecurityLevel, tagNumber uint8, tagClass TagClass) *BACnetSecurityLevelTagged {
	return &BACnetSecurityLevelTagged{Header: header, Value: value, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetSecurityLevelTagged) GetTypeName() string {
	return "BACnetSecurityLevelTagged"
}

func (m *BACnetSecurityLevelTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetSecurityLevelTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetSecurityLevelTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetSecurityLevelTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetSecurityLevelTagged) String() string {
	if m == nil {
		return "<nil>"
	}
