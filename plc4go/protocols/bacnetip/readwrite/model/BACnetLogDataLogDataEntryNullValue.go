...
func (m *_BACnetLogDataLogDataEntryNullValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetLogDataLogDataEntryNullValue) GetLengthInBytes(ctx context.Context) uint64 {
