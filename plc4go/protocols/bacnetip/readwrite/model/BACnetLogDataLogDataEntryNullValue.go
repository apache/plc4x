...
// BACnetLogDataLogDataEntryNullValue is the data-structure of this message
type BACnetLogDataLogDataEntryNullValue struct {
	*BACnetLogDataLogDataEntry
	NullValue *BACnetContextTagNull
}

// IBACnetLogDataLogDataEntryNullValue is the corresponding interface of BACnetLogDataLogDataEntryNullValue
type IBACnetLogDataLogDataEntryNullValue interface {
...
func (m *BACnetLogDataLogDataEntryNullValue) InitializeParent(parent *BACnetLogDataLogDataEntry, peekedTagHeader *BACnetTagHeader) {
	m.BACnetLogDataLogDataEntry.PeekedTagHeader = peekedTagHeader
}

func (m *BACnetLogDataLogDataEntryNullValue) GetParent() *BACnetLogDataLogDataEntry {
...
func (m *BACnetLogDataLogDataEntryNullValue) GetNullValue() *BACnetContextTagNull {
	return m.NullValue
}
...
// NewBACnetLogDataLogDataEntryNullValue factory function for BACnetLogDataLogDataEntryNullValue
func NewBACnetLogDataLogDataEntryNullValue(nullValue *BACnetContextTagNull, peekedTagHeader *BACnetTagHeader) *BACnetLogDataLogDataEntryNullValue {
	_result := &BACnetLogDataLogDataEntryNullValue{
		NullValue:                 nullValue,
...
func CastBACnetLogDataLogDataEntryNullValue(structType interface{}) *BACnetLogDataLogDataEntryNullValue {
	...
	if casted, ok := structType.(BACnetLogDataLogDataEntry); ok {
		return CastBACnetLogDataLogDataEntryNullValue(casted.Child)
	}
	if casted, ok := structType.(*BACnetLogDataLogDataEntry); ok {
		return CastBACnetLogDataLogDataEntryNullValue(casted.Child)
	}
...
func (m *BACnetLogDataLogDataEntryNullValue) GetTypeName() string {
	return "BACnetLogDataLogDataEntryNullValue"
}

func (m *BACnetLogDataLogDataEntryNullValue) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetLogDataLogDataEntryNullValue) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetLogDataLogDataEntryNullValue) GetLengthInBytes() uint16 {
...
func BACnetLogDataLogDataEntryNullValueParse(readBuffer utils.ReadBuffer) (*BACnetLogDataLogDataEntryNullValue, error) {
	...
	_child := &BACnetLogDataLogDataEntryNullValue{
...
func (m *BACnetLogDataLogDataEntryNullValue) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetLogDataLogDataEntryNullValue) String() string {
	if m == nil {
		return "<nil>"
	}
