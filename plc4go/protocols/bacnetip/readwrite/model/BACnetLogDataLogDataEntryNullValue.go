...
func (m *_BACnetLogDataLogDataEntryNullValue) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetLogDataLogDataEntry) (_bACnetLogDataLogDataEntryNullValue BACnetLogDataLogDataEntryNullValue, err error) {
