...
func (m *_BACnetConstructedDataLoopAction) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataLoopAction) GetLengthInBytes(ctx context.Context) uint64 {
