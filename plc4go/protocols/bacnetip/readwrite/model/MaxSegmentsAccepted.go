...
func MaxSegmentsAcceptedFirstEnumForFieldMaxSegments(value uint8) (enum MaxSegmentsAccepted, ok bool) {
...
func (m MaxSegmentsAccepted) GetLengthInBits(ctx context.Context) uint64 {
	return 3
}

func (m MaxSegmentsAccepted) GetLengthInBytes(ctx context.Context) uint64 {
