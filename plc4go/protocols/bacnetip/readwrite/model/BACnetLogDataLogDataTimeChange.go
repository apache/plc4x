...
func (m *_BACnetLogDataLogDataTimeChange) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetLogData, tagNumber uint8) (_bACnetLogDataLogDataTimeChange BACnetLogDataLogDataTimeChange, err error) {
