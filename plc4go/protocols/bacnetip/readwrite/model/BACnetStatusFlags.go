...
func (m BACnetStatusFlags) GetLengthInBits(ctx context.Context) uint64 {
	return 8
}

func (m BACnetStatusFlags) GetLengthInBytes(ctx context.Context) uint64 {
...
func BACnetStatusFlagsParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetStatusFlags, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint8("BACnetStatusFlags", 8)
	if err != nil {
...
func (e BACnetStatusFlags) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint8("BACnetStatusFlags", 8, uint8(uint8(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}

func (e BACnetStatusFlags) GetValue() uint8 {
	return uint8(e)
}
