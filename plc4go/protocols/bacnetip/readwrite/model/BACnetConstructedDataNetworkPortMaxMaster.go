...
func (m *_BACnetConstructedDataNetworkPortMaxMaster) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataNetworkPortMaxMaster) GetLengthInBytes(ctx context.Context) uint64 {
