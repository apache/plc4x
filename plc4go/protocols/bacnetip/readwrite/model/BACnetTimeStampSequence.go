...
func (m *_BACnetTimeStampSequence) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetTimeStamp) (_bACnetTimeStampSequence BACnetTimeStampSequence, err error) {
