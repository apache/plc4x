...
func (m *_BACnetConstructedDataAckRequired) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataAckRequired) GetLengthInBytes(ctx context.Context) uint64 {
