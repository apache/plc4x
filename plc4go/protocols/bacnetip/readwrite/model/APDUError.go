...
func (m *_APDUErrorBuilder) WithErrorBuilder(builderSupplier func(BACnetErrorBuilder) BACnetErrorBuilder) APDUErrorBuilder {
	builder := builderSupplier(m.Error.CreateBACnetErrorBuilder())
	var err error
	...
	if err != nil {
		...
		m.err.Append(errors.Wrap(err, "BACnetErrorBuilder failed"))
	}
	return m
}
