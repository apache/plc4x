...
func CastBACnetDoorStatus(structType any) BACnetDoorStatus {
	castFunc := func(typ any) BACnetDoorStatus {
...
func (m BACnetDoorStatus) GetLengthInBits(ctx context.Context) uint64 {
	return 16
}

func (m BACnetDoorStatus) GetLengthInBytes(ctx context.Context) uint64 {
...
func (e BACnetDoorStatus) GetValue() uint16 {
	return uint16(e)
}
