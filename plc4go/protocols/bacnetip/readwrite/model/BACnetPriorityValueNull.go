...
func (m *_BACnetPriorityValueNull) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetPriorityValue, objectTypeArgument BACnetObjectType) (_bACnetPriorityValueNull BACnetPriorityValueNull, err error) {
