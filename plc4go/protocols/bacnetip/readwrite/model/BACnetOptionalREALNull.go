...
func (m *_BACnetOptionalREALNull) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetOptionalREAL) (_bACnetOptionalREALNull BACnetOptionalREALNull, err error) {
