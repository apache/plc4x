...
func BACnetOptionalREALNullParse(ctx context.Context, theBytes []byte) (BACnetOptionalREALNull, error) {
	return BACnetOptionalREALNullParseWithBuffer(ctx, utils.NewReadBufferByteBased(theBytes))
}

func BACnetOptionalREALNullParseWithBufferProducer() func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetOptionalREALNull, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetOptionalREALNull, error) {
		return BACnetOptionalREALNullParseWithBuffer(ctx, readBuffer)
	}
}

func BACnetOptionalREALNullParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetOptionalREALNull, error) {
	...
	nullValue, err := ReadSimpleField[BACnetApplicationTagNull](ctx, "nullValue", ReadComplex[BACnetApplicationTagNull](BACnetApplicationTagParseWithBufferProducer(), readBuffer))
	if err != nil {
