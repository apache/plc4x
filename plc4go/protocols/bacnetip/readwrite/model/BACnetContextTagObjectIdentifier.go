...
func (m *_BACnetContextTagObjectIdentifier) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetContextTag, tagNumberArgument uint8, dataType BACnetDataType) (_bACnetContextTagObjectIdentifier BACnetContextTagObjectIdentifier, err error) {
