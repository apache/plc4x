...
func (m *_BACnetConstructedDataPolarity) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataPolarity) GetLengthInBytes(ctx context.Context) uint64 {
