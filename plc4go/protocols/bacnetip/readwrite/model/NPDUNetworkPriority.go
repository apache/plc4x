...
func NPDUNetworkPriorityParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (NPDUNetworkPriority, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint8("NPDUNetworkPriority", 2)
	if err != nil {
...
func (e NPDUNetworkPriority) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint8("NPDUNetworkPriority", 2, uint8(uint8(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}

func (e NPDUNetworkPriority) GetValue() uint8 {
	return uint8(e)
}
