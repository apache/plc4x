...
func (m *BACnetUnconfirmedServiceRequestWriteGroup) GetGroupNumber() *BACnetContextTagUnsignedInteger {
	return m.GroupNumber
}

func (m *BACnetUnconfirmedServiceRequestWriteGroup) GetWritePriority() *BACnetContextTagUnsignedInteger {
	return m.WritePriority
}

func (m *BACnetUnconfirmedServiceRequestWriteGroup) GetChangeList() *BACnetGroupChannelValueList {
	return m.ChangeList
}

func (m *BACnetUnconfirmedServiceRequestWriteGroup) GetInhibitDelay() *BACnetContextTagUnsignedInteger {
...
func NewBACnetUnconfirmedServiceRequestWriteGroup(groupNumber *BACnetContextTagUnsignedInteger, writePriority *BACnetContextTagUnsignedInteger, changeList *BACnetGroupChannelValueList, inhibitDelay *BACnetContextTagUnsignedInteger, serviceRequestLength uint16) *BACnetUnconfirmedServiceRequestWriteGroup {
...
func BACnetUnconfirmedServiceRequestWriteGroupParse(readBuffer utils.ReadBuffer, serviceRequestLength uint16) (*BACnetUnconfirmedServiceRequestWriteGroup, error) {
	...
	_child := &BACnetUnconfirmedServiceRequestWriteGroup{
		GroupNumber:                     CastBACnetContextTagUnsignedInteger(groupNumber),
		WritePriority:                   CastBACnetContextTagUnsignedInteger(writePriority),
		ChangeList:                      CastBACnetGroupChannelValueList(changeList),
		InhibitDelay:                    CastBACnetContextTagUnsignedInteger(inhibitDelay),
