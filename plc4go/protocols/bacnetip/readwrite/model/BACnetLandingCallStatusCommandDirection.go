...
func (m *_BACnetLandingCallStatusCommandDirection) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetLandingCallStatusCommand) (_bACnetLandingCallStatusCommandDirection BACnetLandingCallStatusCommandDirection, err error) {
