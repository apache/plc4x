...
// BACnetConstructedDataSecurityTimeWindow is the data-structure of this message
type BACnetConstructedDataSecurityTimeWindow struct {
...
type IBACnetConstructedDataSecurityTimeWindow interface {
...
func (m *BACnetConstructedDataSecurityTimeWindow) GetObjectTypeArgument() BACnetObjectType {
	return 0
}

func (m *BACnetConstructedDataSecurityTimeWindow) GetPropertyIdentifierArgument() BACnetPropertyIdentifier {
...
func (m *BACnetConstructedDataSecurityTimeWindow) GetParent() *BACnetConstructedData {
...
func (m *BACnetConstructedDataSecurityTimeWindow) GetSecurityTimeWindow() *BACnetApplicationTagUnsignedInteger {
...
func CastBACnetConstructedDataSecurityTimeWindow(structType interface{}) *BACnetConstructedDataSecurityTimeWindow {
	...
	if casted, ok := structType.(BACnetConstructedData); ok {
		return CastBACnetConstructedDataSecurityTimeWindow(casted.Child)
	}
	if casted, ok := structType.(*BACnetConstructedData); ok {
		return CastBACnetConstructedDataSecurityTimeWindow(casted.Child)
	}
...
func (m *BACnetConstructedDataSecurityTimeWindow) GetTypeName() string {
	return "BACnetConstructedDataSecurityTimeWindow"
}

func (m *BACnetConstructedDataSecurityTimeWindow) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetConstructedDataSecurityTimeWindow) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetConstructedDataSecurityTimeWindow) GetLengthInBytes() uint16 {
...
func BACnetConstructedDataSecurityTimeWindowParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) (*BACnetConstructedDataSecurityTimeWindow, error) {
	...
	_child := &BACnetConstructedDataSecurityTimeWindow{
		SecurityTimeWindow:    CastBACnetApplicationTagUnsignedInteger(securityTimeWindow),
...
func (m *BACnetConstructedDataSecurityTimeWindow) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetConstructedDataSecurityTimeWindow) String() string {
	if m == nil {
		return "<nil>"
	}
