...
func (m *_BACnetChannelValueReal) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetChannelValue) (_bACnetChannelValueReal BACnetChannelValueReal, err error) {
