...
func (m *_NLMEstablishConnectionToNetwork) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_NLM, apduLength uint16) (_nLMEstablishConnectionToNetwork NLMEstablishConnectionToNetwork, err error) {
