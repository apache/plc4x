...
func NewBACnetConstructedDataBitstringValueAll(openingTag BACnetOpeningTag, peekedTagHeader BACnetTagHeader, closingTag BACnetClosingTag) *_BACnetConstructedDataBitstringValueAll {
...
func (m *_BACnetConstructedDataBitstringValueAll) GetPlx4xTypeName() string {
	return "BACnetConstructedDataBitstringValueAll"
}

func (m *_BACnetConstructedDataBitstringValueAll) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.BACnetConstructedDataContract.(*_BACnetConstructedData).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_BACnetConstructedDataBitstringValueAll) GetLengthInBytes(ctx context.Context) uint64 {
