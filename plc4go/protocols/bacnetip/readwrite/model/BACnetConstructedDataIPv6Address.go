...
func (m *_BACnetConstructedDataIPv6Address) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataIPv6Address) GetLengthInBytes(ctx context.Context) uint64 {
