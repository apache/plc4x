...
func (m *_BACnetCalendarEntryWeekNDay) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetCalendarEntry) (_bACnetCalendarEntryWeekNDay BACnetCalendarEntryWeekNDay, err error) {
