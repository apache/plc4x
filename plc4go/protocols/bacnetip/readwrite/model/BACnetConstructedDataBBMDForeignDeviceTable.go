...
func (m *_BACnetConstructedDataBBMDForeignDeviceTable) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataBBMDForeignDeviceTable) GetLengthInBytes(ctx context.Context) uint64 {
