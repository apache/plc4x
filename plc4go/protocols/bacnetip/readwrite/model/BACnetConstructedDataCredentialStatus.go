...
func (m *_BACnetConstructedDataCredentialStatus) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataCredentialStatus) GetLengthInBytes(ctx context.Context) uint64 {
