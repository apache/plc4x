...
func (m *_BACnetObjectPropertyReference) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_bACnetObjectPropertyReference BACnetObjectPropertyReference, err error) {
