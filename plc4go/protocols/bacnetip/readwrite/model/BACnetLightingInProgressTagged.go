...
func (m *_BACnetLightingInProgressTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetLightingInProgressTagged) GetLengthInBytes(ctx context.Context) uint64 {
