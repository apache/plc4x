...
func (m *_BACnetRouterEntryStatusTagged) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (_bACnetRouterEntryStatusTagged BACnetRouterEntryStatusTagged, err error) {
