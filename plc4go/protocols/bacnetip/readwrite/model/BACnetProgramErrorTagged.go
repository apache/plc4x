...
func (m *_BACnetProgramErrorTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetProgramErrorTagged) GetLengthInBytes(ctx context.Context) uint64 {
