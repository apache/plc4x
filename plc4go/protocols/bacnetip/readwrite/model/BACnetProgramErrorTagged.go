...
// BACnetProgramErrorTagged is the data-structure of this message
type BACnetProgramErrorTagged struct {
...
// IBACnetProgramErrorTagged is the corresponding interface of BACnetProgramErrorTagged
type IBACnetProgramErrorTagged interface {
...
func (m *BACnetProgramErrorTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetProgramErrorTagged) GetValue() BACnetProgramError {
	return m.Value
}

func (m *BACnetProgramErrorTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetProgramErrorTagged) GetIsProprietary() bool {
...
// NewBACnetProgramErrorTagged factory function for BACnetProgramErrorTagged
func NewBACnetProgramErrorTagged(header *BACnetTagHeader, value BACnetProgramError, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetProgramErrorTagged {
	return &BACnetProgramErrorTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetProgramErrorTagged) GetTypeName() string {
	return "BACnetProgramErrorTagged"
}

func (m *BACnetProgramErrorTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetProgramErrorTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetProgramErrorTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetProgramErrorTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetProgramErrorTagged) String() string {
	if m == nil {
		return "<nil>"
	}
