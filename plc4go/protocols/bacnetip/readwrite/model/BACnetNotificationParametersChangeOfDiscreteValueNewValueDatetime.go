...
func (m *_BACnetNotificationParametersChangeOfDiscreteValueNewValueDatetime) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetNotificationParametersChangeOfDiscreteValueNewValue, tagNumber uint8) (_bACnetNotificationParametersChangeOfDiscreteValueNewValueDatetime BACnetNotificationParametersChangeOfDiscreteValueNewValueDatetime, err error) {
