...
func BACnetNotificationParametersChangeOfDiscreteValueNewValueDatetimeParse(ctx context.Context, theBytes []byte, tagNumber uint8) (BACnetNotificationParametersChangeOfDiscreteValueNewValueDatetime, error) {
