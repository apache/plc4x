...
func (m *_BACnetConstructedDataLowerDeck) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataLowerDeck) GetLengthInBytes(ctx context.Context) uint64 {
