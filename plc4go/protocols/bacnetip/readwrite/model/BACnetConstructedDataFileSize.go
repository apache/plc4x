...
func (m *_BACnetConstructedDataFileSize) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *_BACnetConstructedDataFileSize) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *_BACnetConstructedDataFileSize) GetLengthInBytes() uint16 {
...
func (m *_BACnetConstructedDataFileSize) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		_fileSizeErr := writeBuffer.WriteSerializable(m.GetFileSize())
