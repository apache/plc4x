...
func (m *_BACnetConstructedDataIPv6DNSServer) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataIPv6DNSServer) GetLengthInBytes(ctx context.Context) uint64 {
