...
func BACnetConfirmedServiceRequestReadRangeRangeByTimeParse(theBytes []byte) (BACnetConfirmedServiceRequestReadRangeRangeByTime, error) {
	return BACnetConfirmedServiceRequestReadRangeRangeByTimeParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian))) // TODO: get endianness from mspec
}
