...
func (m *_BACnetNotificationParametersChangeOfBitString) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetNotificationParameters, peekedTagNumber uint8, tagNumber uint8, objectTypeArgument BACnetObjectType) (_bACnetNotificationParametersChangeOfBitString BACnetNotificationParametersChangeOfBitString, err error) {
