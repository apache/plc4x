...
// BACnetSilencedStateTagged is the data-structure of this message
type BACnetSilencedStateTagged struct {
...
// IBACnetSilencedStateTagged is the corresponding interface of BACnetSilencedStateTagged
type IBACnetSilencedStateTagged interface {
...
func (m *BACnetSilencedStateTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetSilencedStateTagged) GetValue() BACnetSilencedState {
	return m.Value
}

func (m *BACnetSilencedStateTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetSilencedStateTagged) GetIsProprietary() bool {
...
// NewBACnetSilencedStateTagged factory function for BACnetSilencedStateTagged
func NewBACnetSilencedStateTagged(header *BACnetTagHeader, value BACnetSilencedState, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetSilencedStateTagged {
	return &BACnetSilencedStateTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetSilencedStateTagged) GetTypeName() string {
	return "BACnetSilencedStateTagged"
}

func (m *BACnetSilencedStateTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetSilencedStateTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetSilencedStateTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetSilencedStateTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetSilencedStateTagged) String() string {
	if m == nil {
		return "<nil>"
	}
