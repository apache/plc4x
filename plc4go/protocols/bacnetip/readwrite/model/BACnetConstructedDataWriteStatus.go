...
func (m *_BACnetConstructedDataWriteStatus) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataWriteStatus) GetLengthInBytes(ctx context.Context) uint64 {
