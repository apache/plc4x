...
func (m *_BACnetConstructedDataPulseConverterPresentValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataPulseConverterPresentValue) GetLengthInBytes(ctx context.Context) uint64 {
