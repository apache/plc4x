...
func (m *_BACnetConstructedDataInactiveText) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataInactiveText) GetLengthInBytes(ctx context.Context) uint64 {
