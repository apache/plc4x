...
func (m *_BACnetConstructedDataVirtualMACAddressTable) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataVirtualMACAddressTable) GetLengthInBytes(ctx context.Context) uint64 {
