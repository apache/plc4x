...
func (m *_BACnetConstructedDataMaxInfoFrames) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataMaxInfoFrames) GetLengthInBytes(ctx context.Context) uint64 {
