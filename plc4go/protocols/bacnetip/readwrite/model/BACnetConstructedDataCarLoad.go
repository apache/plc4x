...
func NewBACnetConstructedDataCarLoad(openingTag BACnetOpeningTag, peekedTagHeader BACnetTagHeader, closingTag BACnetClosingTag, carLoad BACnetApplicationTagReal) *_BACnetConstructedDataCarLoad {
	if carLoad == nil {
...
func (b *_BACnetConstructedDataCarLoadBuilder) Build() (BACnetConstructedDataCarLoad, error) {
	if b.CarLoad == nil {
		b.collectedErr = append(b.collectedErr, errors.New("mandatory field 'carLoad' not set"))
	}
...
func (m *_BACnetConstructedDataCarLoad) GetPlx4xTypeName() string {
	return "BACnetConstructedDataCarLoad"
}

func (m *_BACnetConstructedDataCarLoad) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataCarLoad) GetLengthInBytes(ctx context.Context) uint64 {
