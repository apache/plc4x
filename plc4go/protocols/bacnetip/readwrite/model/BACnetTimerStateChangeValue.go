...
func (m *_BACnetTimerStateChangeValue) parse(ctx context.Context, readBuffer utils.ReadBuffer, objectTypeArgument BACnetObjectType) (_bACnetTimerStateChangeValue BACnetTimerStateChangeValue, err error) {
