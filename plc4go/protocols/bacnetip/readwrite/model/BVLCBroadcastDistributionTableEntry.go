...
func (m *_BVLCBroadcastDistributionTableEntry) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_bVLCBroadcastDistributionTableEntry BVLCBroadcastDistributionTableEntry, err error) {
