...
func (m *_BACnetValueSourceObject) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetValueSource) (_bACnetValueSourceObject BACnetValueSourceObject, err error) {
