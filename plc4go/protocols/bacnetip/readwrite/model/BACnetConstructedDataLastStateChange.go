...
func (m *_BACnetConstructedDataLastStateChange) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataLastStateChange) GetLengthInBytes(ctx context.Context) uint64 {
