...
func (m *_BACnetPropertyStatesSilencedState) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetPropertyStates, peekedTagNumber uint8) (_bACnetPropertyStatesSilencedState BACnetPropertyStatesSilencedState, err error) {
