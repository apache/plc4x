...
func (m *_BACnetConstructedDataValueBeforeChange) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataValueBeforeChange) GetLengthInBytes(ctx context.Context) uint64 {
