...
func (m *_BACnetCredentialAuthenticationFactor) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_bACnetCredentialAuthenticationFactor BACnetCredentialAuthenticationFactor, err error) {
