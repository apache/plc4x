...
// BACnetCredentialAuthenticationFactor is the data-structure of this message
...
// IBACnetCredentialAuthenticationFactor is the corresponding interface of BACnetCredentialAuthenticationFactor
type IBACnetCredentialAuthenticationFactor interface {
...
func (m *BACnetCredentialAuthenticationFactor) GetDisable() *BACnetAccessAuthenticationFactorDisableTagged {
	return m.Disable
}

func (m *BACnetCredentialAuthenticationFactor) GetAuthenticationFactor() *BACnetAuthenticationFactorEnclosed {
...
// NewBACnetCredentialAuthenticationFactor factory function for BACnetCredentialAuthenticationFactor
func NewBACnetCredentialAuthenticationFactor(disable *BACnetAccessAuthenticationFactorDisableTagged, authenticationFactor *BACnetAuthenticationFactorEnclosed) *BACnetCredentialAuthenticationFactor {
	return &BACnetCredentialAuthenticationFactor{Disable: disable, AuthenticationFactor: authenticationFactor}
}
...
func (m *BACnetCredentialAuthenticationFactor) GetTypeName() string {
	return "BACnetCredentialAuthenticationFactor"
}

func (m *BACnetCredentialAuthenticationFactor) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetCredentialAuthenticationFactor) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetCredentialAuthenticationFactor) GetLengthInBytes() uint16 {
...
func (m *BACnetCredentialAuthenticationFactor) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	_disableErr := writeBuffer.WriteSerializable(m.Disable)
	...
	_authenticationFactorErr := writeBuffer.WriteSerializable(m.AuthenticationFactor)
...
func (m *BACnetCredentialAuthenticationFactor) String() string {
	if m == nil {
		return "<nil>"
	}
