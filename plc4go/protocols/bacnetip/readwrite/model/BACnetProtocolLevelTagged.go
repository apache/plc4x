...
func (m *_BACnetProtocolLevelTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetProtocolLevelTagged) GetLengthInBytes(ctx context.Context) uint64 {
