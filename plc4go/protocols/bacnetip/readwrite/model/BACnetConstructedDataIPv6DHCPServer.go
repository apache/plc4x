...
func (m *_BACnetConstructedDataIPv6DHCPServerBuilder) WithMandatoryFields(dhcpServer BACnetApplicationTagOctetString) BACnetConstructedDataIPv6DHCPServerBuilder {
	return m.WithDhcpServer(dhcpServer)
}

func (m *_BACnetConstructedDataIPv6DHCPServerBuilder) WithDhcpServer(dhcpServer BACnetApplicationTagOctetString) BACnetConstructedDataIPv6DHCPServerBuilder {
	m.DhcpServer = dhcpServer
	return m
}

func (m *_BACnetConstructedDataIPv6DHCPServerBuilder) WithDhcpServerBuilder(builderSupplier func(BACnetApplicationTagOctetStringBuilder) BACnetApplicationTagOctetStringBuilder) BACnetConstructedDataIPv6DHCPServerBuilder {
...
func (m *_BACnetConstructedDataIPv6DHCPServerBuilder) Build() (BACnetConstructedDataIPv6DHCPServer, error) {
	if m.DhcpServer == nil {
		if m.err == nil {
	...
	return m._BACnetConstructedDataIPv6DHCPServer.deepCopy(), nil
}

func (m *_BACnetConstructedDataIPv6DHCPServerBuilder) MustBuild() BACnetConstructedDataIPv6DHCPServer {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetConstructedDataIPv6DHCPServerBuilder) DeepCopy() any {
	return m.CreateBACnetConstructedDataIPv6DHCPServerBuilder()
}

// CreateBACnetConstructedDataIPv6DHCPServerBuilder creates a BACnetConstructedDataIPv6DHCPServerBuilder
func (m *_BACnetConstructedDataIPv6DHCPServer) CreateBACnetConstructedDataIPv6DHCPServerBuilder() BACnetConstructedDataIPv6DHCPServerBuilder {
	if m == nil {
		return NewBACnetConstructedDataIPv6DHCPServerBuilder()
	}
	return &_BACnetConstructedDataIPv6DHCPServerBuilder{_BACnetConstructedDataIPv6DHCPServer: m.deepCopy()}
}
