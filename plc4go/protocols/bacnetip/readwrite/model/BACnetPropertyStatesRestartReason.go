...
func (m *_BACnetPropertyStatesRestartReason) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesRestartReason) GetLengthInBytes(ctx context.Context) uint64 {
