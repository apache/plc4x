...
// BACnetAccessThreatLevel is the data-structure of this message
type BACnetAccessThreatLevel struct {
	ThreatLevel *BACnetApplicationTagUnsignedInteger
}

// IBACnetAccessThreatLevel is the corresponding interface of BACnetAccessThreatLevel
type IBACnetAccessThreatLevel interface {
...
func (m *BACnetAccessThreatLevel) GetThreatLevel() *BACnetApplicationTagUnsignedInteger {
...
// NewBACnetAccessThreatLevel factory function for BACnetAccessThreatLevel
func NewBACnetAccessThreatLevel(threatLevel *BACnetApplicationTagUnsignedInteger) *BACnetAccessThreatLevel {
	return &BACnetAccessThreatLevel{ThreatLevel: threatLevel}
}
...
func (m *BACnetAccessThreatLevel) GetTypeName() string {
	return "BACnetAccessThreatLevel"
}

func (m *BACnetAccessThreatLevel) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetAccessThreatLevel) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetAccessThreatLevel) GetLengthInBytes() uint16 {
...
func BACnetAccessThreatLevelParse(readBuffer utils.ReadBuffer) (*BACnetAccessThreatLevel, error) {
	...
	threatLevel := CastBACnetApplicationTagUnsignedInteger(_threatLevel)
...
func (m *BACnetAccessThreatLevel) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetAccessThreatLevel) String() string {
	if m == nil {
		return "<nil>"
	}
