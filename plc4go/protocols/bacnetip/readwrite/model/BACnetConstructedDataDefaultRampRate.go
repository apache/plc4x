...
// BACnetConstructedDataDefaultRampRate is the data-structure of this message
type BACnetConstructedDataDefaultRampRate struct {
...
type IBACnetConstructedDataDefaultRampRate interface {
...
func (m *BACnetConstructedDataDefaultRampRate) GetObjectTypeArgument() BACnetObjectType {
	return 0
}

func (m *BACnetConstructedDataDefaultRampRate) GetPropertyIdentifierArgument() BACnetPropertyIdentifier {
...
func (m *BACnetConstructedDataDefaultRampRate) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag) {
	m.BACnetConstructedData.OpeningTag = openingTag
	m.BACnetConstructedData.ClosingTag = closingTag
}

func (m *BACnetConstructedDataDefaultRampRate) GetParent() *BACnetConstructedData {
...
func (m *BACnetConstructedDataDefaultRampRate) GetDefaultRampRate() *BACnetApplicationTagReal {
...
func NewBACnetConstructedDataDefaultRampRate(defaultRampRate *BACnetApplicationTagReal, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag, tagNumber uint8) *BACnetConstructedDataDefaultRampRate {
...
func CastBACnetConstructedDataDefaultRampRate(structType interface{}) *BACnetConstructedDataDefaultRampRate {
	...
	if casted, ok := structType.(BACnetConstructedData); ok {
		return CastBACnetConstructedDataDefaultRampRate(casted.Child)
	}
	if casted, ok := structType.(*BACnetConstructedData); ok {
		return CastBACnetConstructedDataDefaultRampRate(casted.Child)
	}
...
func (m *BACnetConstructedDataDefaultRampRate) GetTypeName() string {
	return "BACnetConstructedDataDefaultRampRate"
}

func (m *BACnetConstructedDataDefaultRampRate) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetConstructedDataDefaultRampRate) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetConstructedDataDefaultRampRate) GetLengthInBytes() uint16 {
...
func BACnetConstructedDataDefaultRampRateParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier) (*BACnetConstructedDataDefaultRampRate, error) {
	...
	_child := &BACnetConstructedDataDefaultRampRate{
		DefaultRampRate:       CastBACnetApplicationTagReal(defaultRampRate),
...
func (m *BACnetConstructedDataDefaultRampRate) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetConstructedDataDefaultRampRate) String() string {
	if m == nil {
		return "<nil>"
	}
