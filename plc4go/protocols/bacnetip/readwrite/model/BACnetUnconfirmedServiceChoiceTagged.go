...
func BACnetUnconfirmedServiceChoiceTaggedParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (BACnetUnconfirmedServiceChoiceTagged, error) {
	v, err := (&_BACnetUnconfirmedServiceChoiceTagged{}).parse(ctx, readBuffer, tagNumber, tagClass)
	if err != nil {
		return nil, err
	}
	return v, err
...
func (m *_BACnetUnconfirmedServiceChoiceTagged) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (_bACnetUnconfirmedServiceChoiceTagged BACnetUnconfirmedServiceChoiceTagged, err error) {
