...
func (m *_BACnetUnconfirmedServiceChoiceTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetUnconfirmedServiceChoiceTagged) GetLengthInBytes(ctx context.Context) uint64 {
