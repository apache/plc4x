...
// BACnetUnconfirmedServiceChoiceTagged is the data-structure of this message
type BACnetUnconfirmedServiceChoiceTagged struct {
...
// IBACnetUnconfirmedServiceChoiceTagged is the corresponding interface of BACnetUnconfirmedServiceChoiceTagged
type IBACnetUnconfirmedServiceChoiceTagged interface {
...
func (m *BACnetUnconfirmedServiceChoiceTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetUnconfirmedServiceChoiceTagged) GetValue() BACnetUnconfirmedServiceChoice {
	return m.Value
}
...
// NewBACnetUnconfirmedServiceChoiceTagged factory function for BACnetUnconfirmedServiceChoiceTagged
func NewBACnetUnconfirmedServiceChoiceTagged(header *BACnetTagHeader, value BACnetUnconfirmedServiceChoice, tagNumber uint8, tagClass TagClass) *BACnetUnconfirmedServiceChoiceTagged {
	return &BACnetUnconfirmedServiceChoiceTagged{Header: header, Value: value, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetUnconfirmedServiceChoiceTagged) GetTypeName() string {
	return "BACnetUnconfirmedServiceChoiceTagged"
}

func (m *BACnetUnconfirmedServiceChoiceTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetUnconfirmedServiceChoiceTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetUnconfirmedServiceChoiceTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetUnconfirmedServiceChoiceTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetUnconfirmedServiceChoiceTagged) String() string {
	if m == nil {
		return "<nil>"
	}
