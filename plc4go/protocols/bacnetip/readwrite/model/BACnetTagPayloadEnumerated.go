...
func (m *_BACnetTagPayloadEnumerated) parse(ctx context.Context, readBuffer utils.ReadBuffer, actualLength uint32) (_bACnetTagPayloadEnumerated BACnetTagPayloadEnumerated, err error) {
