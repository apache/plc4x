...
func (m *_BACnetPropertyStatesNotifyType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetPropertyStates, peekedTagNumber uint8) (_bACnetPropertyStatesNotifyType BACnetPropertyStatesNotifyType, err error) {
