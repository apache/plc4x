...
func (m *_BACnetFaultTypeTagged) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (_bACnetFaultTypeTagged BACnetFaultTypeTagged, err error) {
