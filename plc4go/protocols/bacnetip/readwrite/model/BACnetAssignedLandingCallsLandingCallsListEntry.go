...
func (m *_BACnetAssignedLandingCallsLandingCallsListEntry) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_bACnetAssignedLandingCallsLandingCallsListEntry BACnetAssignedLandingCallsLandingCallsListEntry, err error) {
