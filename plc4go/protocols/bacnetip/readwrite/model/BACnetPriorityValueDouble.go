...
func (m *_BACnetPriorityValueDouble) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPriorityValueDouble) GetLengthInBytes(ctx context.Context) uint64 {
