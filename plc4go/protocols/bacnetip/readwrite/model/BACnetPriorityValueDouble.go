...
func (m *_BACnetPriorityValueDouble) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetPriorityValue, objectTypeArgument BACnetObjectType) (_bACnetPriorityValueDouble BACnetPriorityValueDouble, err error) {
