...
func (m *_BACnetConstructedDataAcceptedModes) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataAcceptedModes) GetLengthInBytes(ctx context.Context) uint64 {
