...
func (m *_BACnetConstructedDataProfileLocation) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataProfileLocation) GetLengthInBytes(ctx context.Context) uint64 {
