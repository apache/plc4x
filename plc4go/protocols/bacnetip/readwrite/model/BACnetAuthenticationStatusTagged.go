...
// BACnetAuthenticationStatusTagged is the data-structure of this message
type BACnetAuthenticationStatusTagged struct {
...
// IBACnetAuthenticationStatusTagged is the corresponding interface of BACnetAuthenticationStatusTagged
type IBACnetAuthenticationStatusTagged interface {
...
func (m *BACnetAuthenticationStatusTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetAuthenticationStatusTagged) GetValue() BACnetAuthenticationStatus {
	return m.Value
}
...
// NewBACnetAuthenticationStatusTagged factory function for BACnetAuthenticationStatusTagged
func NewBACnetAuthenticationStatusTagged(header *BACnetTagHeader, value BACnetAuthenticationStatus, tagNumber uint8, tagClass TagClass) *BACnetAuthenticationStatusTagged {
	return &BACnetAuthenticationStatusTagged{Header: header, Value: value, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetAuthenticationStatusTagged) GetTypeName() string {
	return "BACnetAuthenticationStatusTagged"
}

func (m *BACnetAuthenticationStatusTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetAuthenticationStatusTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetAuthenticationStatusTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetAuthenticationStatusTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetAuthenticationStatusTagged) String() string {
	if m == nil {
		return "<nil>"
	}
