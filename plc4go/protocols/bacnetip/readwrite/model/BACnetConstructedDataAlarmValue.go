...
func (m *_BACnetConstructedDataAlarmValueBuilder) WithMandatoryFields(binaryPv BACnetBinaryPVTagged) BACnetConstructedDataAlarmValueBuilder {
	return m.WithBinaryPv(binaryPv)
}

func (m *_BACnetConstructedDataAlarmValueBuilder) WithBinaryPv(binaryPv BACnetBinaryPVTagged) BACnetConstructedDataAlarmValueBuilder {
	m.BinaryPv = binaryPv
	return m
}

func (m *_BACnetConstructedDataAlarmValueBuilder) WithBinaryPvBuilder(builderSupplier func(BACnetBinaryPVTaggedBuilder) BACnetBinaryPVTaggedBuilder) BACnetConstructedDataAlarmValueBuilder {
	builder := builderSupplier(m.BinaryPv.CreateBACnetBinaryPVTaggedBuilder())
	var err error
	m.BinaryPv, err = builder.Build()
	if err != nil {
		if m.err == nil {
...
func (m *_BACnetConstructedDataAlarmValueBuilder) Build() (BACnetConstructedDataAlarmValue, error) {
	if m.BinaryPv == nil {
		if m.err == nil {
			m.err = new(utils.MultiError)
		}
		m.err.Append(errors.New("mandatory field 'binaryPv' not set"))
	}
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._BACnetConstructedDataAlarmValue.deepCopy(), nil
}

func (m *_BACnetConstructedDataAlarmValueBuilder) MustBuild() BACnetConstructedDataAlarmValue {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetConstructedDataAlarmValueBuilder) DeepCopy() any {
	return m.CreateBACnetConstructedDataAlarmValueBuilder()
}

// CreateBACnetConstructedDataAlarmValueBuilder creates a BACnetConstructedDataAlarmValueBuilder
func (m *_BACnetConstructedDataAlarmValue) CreateBACnetConstructedDataAlarmValueBuilder() BACnetConstructedDataAlarmValueBuilder {
	if m == nil {
		return NewBACnetConstructedDataAlarmValueBuilder()
	}
	return &_BACnetConstructedDataAlarmValueBuilder{_BACnetConstructedDataAlarmValue: m.deepCopy()}
}
