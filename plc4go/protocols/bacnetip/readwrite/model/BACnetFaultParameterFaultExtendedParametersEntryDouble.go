...
func BACnetFaultParameterFaultExtendedParametersEntryDoubleParseWithBufferProducer() func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetFaultParameterFaultExtendedParametersEntryDouble, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetFaultParameterFaultExtendedParametersEntryDouble, error) {
		return BACnetFaultParameterFaultExtendedParametersEntryDoubleParseWithBuffer(ctx, readBuffer)
	}
}
