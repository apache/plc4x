...
func BACnetEventParameterChangeOfBitstringListOfBitstringValuesParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (BACnetEventParameterChangeOfBitstringListOfBitstringValues, error) {
	...
	listOfBitstringValues, err := ReadTerminatedArrayField[BACnetApplicationTagBitString](ctx, "listOfBitstringValues", ReadComplex[BACnetApplicationTagBitString](func(ctx context.Context, buffer utils.ReadBuffer) (BACnetApplicationTagBitString, error) {
