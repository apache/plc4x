...
func (m *_BACnetEventParameterChangeOfBitstringListOfBitstringValues) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *_BACnetEventParameterChangeOfBitstringListOfBitstringValues) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *_BACnetEventParameterChangeOfBitstringListOfBitstringValues) GetLengthInBytes() uint16 {
...
func BACnetEventParameterChangeOfBitstringListOfBitstringValuesParse(theBytes []byte, tagNumber uint8) (BACnetEventParameterChangeOfBitstringListOfBitstringValues, error) {
	return BACnetEventParameterChangeOfBitstringListOfBitstringValuesParseWithBuffer(utils.NewReadBufferByteBased(theBytes), tagNumber)
}
