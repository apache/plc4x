...
func (m *_BACnetEventParameterChangeOfBitstringListOfBitstringValues) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (_bACnetEventParameterChangeOfBitstringListOfBitstringValues BACnetEventParameterChangeOfBitstringListOfBitstringValues, err error) {
