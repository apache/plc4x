...
func (m *_BACnetTimeStampTime) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetTimeStamp) (_bACnetTimeStampTime BACnetTimeStampTime, err error) {
