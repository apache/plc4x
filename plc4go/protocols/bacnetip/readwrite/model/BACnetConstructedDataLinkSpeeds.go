...
func (m *_BACnetConstructedDataLinkSpeeds) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataLinkSpeeds) GetLengthInBytes(ctx context.Context) uint64 {
