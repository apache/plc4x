...
func (m *_BACnetConstructedDataEventParametersBuilder) WithEventParameterBuilder(builderSupplier func(BACnetEventParameterBuilder) BACnetEventParameterBuilder) BACnetConstructedDataEventParametersBuilder {
	builder := builderSupplier(m.EventParameter.CreateBACnetEventParameterBuilder())
	var err error
	m.EventParameter, err = builder.Build()
	if err != nil {
		if m.err == nil {
			m.err = &utils.MultiError{MainError: errors.New("sub builder failed")}
		}
		m.err.Append(errors.Wrap(err, "BACnetEventParameterBuilder failed"))
	}
	return m
}
