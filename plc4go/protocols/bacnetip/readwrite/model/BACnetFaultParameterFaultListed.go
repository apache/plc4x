...
func (m *_BACnetFaultParameterFaultListed) GetPlx4xTypeName() string {
	return "BACnetFaultParameterFaultListed"
}

func (m *_BACnetFaultParameterFaultListed) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetFaultParameterFaultListed) GetLengthInBytes(ctx context.Context) uint64 {
