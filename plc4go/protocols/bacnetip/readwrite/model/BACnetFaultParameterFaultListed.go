...
func (m *_BACnetFaultParameterFaultListed) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetFaultParameter) (_bACnetFaultParameterFaultListed BACnetFaultParameterFaultListed, err error) {
