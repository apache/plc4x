...
func (m *_BACnetApplicationTagDate) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetApplicationTagDate) GetLengthInBytes(ctx context.Context) uint64 {
