...
func (m *_BACnetConstructedDataRecipientList) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataRecipientList) GetLengthInBytes(ctx context.Context) uint64 {
