...
func (m *_BACnetConstructedDataBitTextBuilder) WithMandatoryFields(bitText []BACnetApplicationTagCharacterString) BACnetConstructedDataBitTextBuilder {
	return m.WithBitText(bitText...)
}

func (m *_BACnetConstructedDataBitTextBuilder) WithOptionalNumberOfDataElements(numberOfDataElements BACnetApplicationTagUnsignedInteger) BACnetConstructedDataBitTextBuilder {
	m.NumberOfDataElements = numberOfDataElements
	return m
}

func (m *_BACnetConstructedDataBitTextBuilder) WithOptionalNumberOfDataElementsBuilder(builderSupplier func(BACnetApplicationTagUnsignedIntegerBuilder) BACnetApplicationTagUnsignedIntegerBuilder) BACnetConstructedDataBitTextBuilder {
...
func (m *_BACnetConstructedDataBitTextBuilder) WithBitText(bitText ...BACnetApplicationTagCharacterString) BACnetConstructedDataBitTextBuilder {
	m.BitText = bitText
	return m
}

func (m *_BACnetConstructedDataBitTextBuilder) Build() (BACnetConstructedDataBitText, error) {
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._BACnetConstructedDataBitText.deepCopy(), nil
}

func (m *_BACnetConstructedDataBitTextBuilder) MustBuild() BACnetConstructedDataBitText {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetConstructedDataBitTextBuilder) DeepCopy() any {
	return m.CreateBACnetConstructedDataBitTextBuilder()
}

// CreateBACnetConstructedDataBitTextBuilder creates a BACnetConstructedDataBitTextBuilder
func (m *_BACnetConstructedDataBitText) CreateBACnetConstructedDataBitTextBuilder() BACnetConstructedDataBitTextBuilder {
	if m == nil {
		return NewBACnetConstructedDataBitTextBuilder()
	}
	return &_BACnetConstructedDataBitTextBuilder{_BACnetConstructedDataBitText: m.deepCopy()}
}
