...
func NewBACnetConstructedDataBinaryOutputRelinquishDefault(openingTag BACnetOpeningTag, peekedTagHeader BACnetTagHeader, closingTag BACnetClosingTag, relinquishDefault BACnetBinaryPVTagged) *_BACnetConstructedDataBinaryOutputRelinquishDefault {
...
func (m *_BACnetConstructedDataBinaryOutputRelinquishDefault) GetPlx4xTypeName() string {
	return "BACnetConstructedDataBinaryOutputRelinquishDefault"
}

func (m *_BACnetConstructedDataBinaryOutputRelinquishDefault) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataBinaryOutputRelinquishDefault) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataBinaryOutputRelinquishDefault) deepCopy() *_BACnetConstructedDataBinaryOutputRelinquishDefault {
	...
	_BACnetConstructedDataBinaryOutputRelinquishDefaultCopy.BACnetConstructedDataContract.(*_BACnetConstructedData)._SubType = m
