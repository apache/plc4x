...
// ChangeListAddError is the data-structure of this message
type ChangeListAddError struct {
	*BACnetError
	ErrorType                *ErrorEnclosed
	FirstFailedElementNumber *BACnetContextTagUnsignedInteger
}

// IChangeListAddError is the corresponding interface of ChangeListAddError
type IChangeListAddError interface {
	IBACnetError
...
func (m *ChangeListAddError) GetErrorChoice() BACnetConfirmedServiceChoice {
...
func (m *ChangeListAddError) InitializeParent(parent *BACnetError) {}

func (m *ChangeListAddError) GetParent() *BACnetError {
...
func (m *ChangeListAddError) GetErrorType() *ErrorEnclosed {
	return m.ErrorType
}

func (m *ChangeListAddError) GetFirstFailedElementNumber() *BACnetContextTagUnsignedInteger {
...
// NewChangeListAddError factory function for ChangeListAddError
func NewChangeListAddError(errorType *ErrorEnclosed, firstFailedElementNumber *BACnetContextTagUnsignedInteger) *ChangeListAddError {
	_result := &ChangeListAddError{
		ErrorType:                errorType,
...
func CastChangeListAddError(structType interface{}) *ChangeListAddError {
	...
	if casted, ok := structType.(BACnetError); ok {
		return CastChangeListAddError(casted.Child)
	}
	if casted, ok := structType.(*BACnetError); ok {
		return CastChangeListAddError(casted.Child)
	}
...
func (m *ChangeListAddError) GetTypeName() string {
	return "ChangeListAddError"
}

func (m *ChangeListAddError) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *ChangeListAddError) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *ChangeListAddError) GetLengthInBytes() uint16 {
...
func (m *ChangeListAddError) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *ChangeListAddError) String() string {
	if m == nil {
		return "<nil>"
	}
