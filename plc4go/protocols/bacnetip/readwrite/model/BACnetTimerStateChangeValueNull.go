...
func (m *_BACnetTimerStateChangeValueNull) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetTimerStateChangeValueNull) GetLengthInBytes(ctx context.Context) uint64 {
