...
func (m *_BACnetConstructedDataSetting) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataSetting) GetLengthInBytes(ctx context.Context) uint64 {
