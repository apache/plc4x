...
func (m *_APDUComplexAckBuilder) WithOptionalServiceAckBuilder(builderSupplier func(BACnetServiceAckBuilder) BACnetServiceAckBuilder) APDUComplexAckBuilder {
	builder := builderSupplier(m.ServiceAck.CreateBACnetServiceAckBuilder())
	var err error
	m.ServiceAck, err = builder.Build()
	if err != nil {
		if m.err == nil {
			m.err = &utils.MultiError{MainError: errors.New("sub builder failed")}
		}
		m.err.Append(errors.Wrap(err, "BACnetServiceAckBuilder failed"))
	}
	return m
}
