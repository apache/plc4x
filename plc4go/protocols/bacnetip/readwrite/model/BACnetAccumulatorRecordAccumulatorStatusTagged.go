...
func (m *_BACnetAccumulatorRecordAccumulatorStatusTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetAccumulatorRecordAccumulatorStatusTagged) GetLengthInBytes(ctx context.Context) uint64 {
