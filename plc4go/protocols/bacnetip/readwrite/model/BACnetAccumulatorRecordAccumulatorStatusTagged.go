...
func (m *_BACnetAccumulatorRecordAccumulatorStatusTagged) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (_bACnetAccumulatorRecordAccumulatorStatusTagged BACnetAccumulatorRecordAccumulatorStatusTagged, err error) {
