...
func (m *_BVLCRegisterForeignDevice) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BVLC) (_bVLCRegisterForeignDevice BVLCRegisterForeignDevice, err error) {
