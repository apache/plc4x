...
func NewBACnetConstructedDataDateTimeValuePresentValue(openingTag BACnetOpeningTag, peekedTagHeader BACnetTagHeader, closingTag BACnetClosingTag, presentValue BACnetDateTime) *_BACnetConstructedDataDateTimeValuePresentValue {
	if presentValue == nil {
...
func (m *_BACnetConstructedDataDateTimeValuePresentValue) GetPlx4xTypeName() string {
	return "BACnetConstructedDataDateTimeValuePresentValue"
}

func (m *_BACnetConstructedDataDateTimeValuePresentValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataDateTimeValuePresentValue) GetLengthInBytes(ctx context.Context) uint64 {
