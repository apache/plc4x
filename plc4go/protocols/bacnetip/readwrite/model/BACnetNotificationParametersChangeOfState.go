...
func (m *BACnetNotificationParametersChangeOfState) GetStatusFlags() *BACnetStatusFlagsTagged {
...
func (m *BACnetNotificationParametersChangeOfState) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		_changeOfStateErr := writeBuffer.WriteSerializable(m.ChangeOfState)
