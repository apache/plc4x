...
func (m *_BACnetNotificationParametersChangeOfState) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetNotificationParametersChangeOfState) GetLengthInBytes(ctx context.Context) uint64 {
