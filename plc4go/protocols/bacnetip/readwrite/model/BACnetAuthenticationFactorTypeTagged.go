...
func (m *_BACnetAuthenticationFactorTypeTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *_BACnetAuthenticationFactorTypeTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *_BACnetAuthenticationFactorTypeTagged) GetLengthInBytes() uint16 {
