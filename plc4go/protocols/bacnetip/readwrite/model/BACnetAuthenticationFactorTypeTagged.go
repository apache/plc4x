...
func (m *_BACnetAuthenticationFactorTypeTagged) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (_bACnetAuthenticationFactorTypeTagged BACnetAuthenticationFactorTypeTagged, err error) {
