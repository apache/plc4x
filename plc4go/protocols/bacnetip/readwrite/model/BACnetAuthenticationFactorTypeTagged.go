...
func (m *_BACnetAuthenticationFactorTypeTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetAuthenticationFactorTypeTagged) GetLengthInBytes(ctx context.Context) uint64 {
