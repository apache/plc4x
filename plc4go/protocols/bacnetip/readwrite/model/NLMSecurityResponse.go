...
func (m *_NLMSecurityResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_NLM, apduLength uint16) (_nLMSecurityResponse NLMSecurityResponse, err error) {
