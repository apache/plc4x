...
func (m *BACnetConstructedDataProgramLocation) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag) {
...
func NewBACnetConstructedDataProgramLocation(programLocation *BACnetApplicationTagCharacterString, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag, tagNumber uint8) *BACnetConstructedDataProgramLocation {
...
func BACnetConstructedDataProgramLocationParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier) (*BACnetConstructedDataProgramLocation, error) {
...
func (m *BACnetConstructedDataProgramLocation) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		_programLocationErr := m.ProgramLocation.Serialize(writeBuffer)
