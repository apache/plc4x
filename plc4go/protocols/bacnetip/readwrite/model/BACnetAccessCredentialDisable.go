...
func (m BACnetAccessCredentialDisable) GetLengthInBits(ctx context.Context) uint64 {
	return 16
}

func (m BACnetAccessCredentialDisable) GetLengthInBytes(ctx context.Context) uint64 {
