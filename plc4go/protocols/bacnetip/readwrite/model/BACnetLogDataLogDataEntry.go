...
func (m *_BACnetLogDataLogDataEntry) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_bACnetLogDataLogDataEntry BACnetLogDataLogDataEntry, err error) {
