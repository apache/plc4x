...
func (m *_BACnetNetworkNumberQualityTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetNetworkNumberQualityTagged) GetLengthInBytes(ctx context.Context) uint64 {
