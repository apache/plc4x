...
func BACnetNetworkNumberQualityTaggedParse(theBytes []byte, tagNumber uint8, tagClass TagClass) (BACnetNetworkNumberQualityTagged, error) {
	return BACnetNetworkNumberQualityTaggedParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian)), tagNumber, tagClass) // TODO: get endianness from mspec
}
