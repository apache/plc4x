...
func (m *_BACnetAccessCredentialDisableTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *_BACnetAccessCredentialDisableTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *_BACnetAccessCredentialDisableTagged) GetLengthInBytes() uint16 {
