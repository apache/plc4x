...
func (m *_BACnetAccessCredentialDisableTagged) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (_bACnetAccessCredentialDisableTagged BACnetAccessCredentialDisableTagged, err error) {
