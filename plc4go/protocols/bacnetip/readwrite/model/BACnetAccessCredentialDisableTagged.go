...
// BACnetAccessCredentialDisableTagged is the data-structure of this message
type BACnetAccessCredentialDisableTagged struct {
...
// IBACnetAccessCredentialDisableTagged is the corresponding interface of BACnetAccessCredentialDisableTagged
type IBACnetAccessCredentialDisableTagged interface {
...
func (m *BACnetAccessCredentialDisableTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetAccessCredentialDisableTagged) GetValue() BACnetAccessCredentialDisable {
	return m.Value
}

func (m *BACnetAccessCredentialDisableTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetAccessCredentialDisableTagged) GetIsProprietary() bool {
...
// NewBACnetAccessCredentialDisableTagged factory function for BACnetAccessCredentialDisableTagged
func NewBACnetAccessCredentialDisableTagged(header *BACnetTagHeader, value BACnetAccessCredentialDisable, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetAccessCredentialDisableTagged {
	return &BACnetAccessCredentialDisableTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetAccessCredentialDisableTagged) GetTypeName() string {
	return "BACnetAccessCredentialDisableTagged"
}

func (m *BACnetAccessCredentialDisableTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetAccessCredentialDisableTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetAccessCredentialDisableTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetAccessCredentialDisableTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetAccessCredentialDisableTagged) String() string {
	if m == nil {
		return "<nil>"
	}
