...
// BACnetVMACEntry is the data-structure of this message
type BACnetVMACEntry struct {
	VirtualMacAddress *BACnetContextTagOctetString
	NativeMacAddress  *BACnetContextTagOctetString
}

// IBACnetVMACEntry is the corresponding interface of BACnetVMACEntry
type IBACnetVMACEntry interface {
...
func (m *BACnetVMACEntry) GetVirtualMacAddress() *BACnetContextTagOctetString {
	return m.VirtualMacAddress
}

func (m *BACnetVMACEntry) GetNativeMacAddress() *BACnetContextTagOctetString {
...
// NewBACnetVMACEntry factory function for BACnetVMACEntry
func NewBACnetVMACEntry(virtualMacAddress *BACnetContextTagOctetString, nativeMacAddress *BACnetContextTagOctetString) *BACnetVMACEntry {
	return &BACnetVMACEntry{VirtualMacAddress: virtualMacAddress, NativeMacAddress: nativeMacAddress}
}
...
func (m *BACnetVMACEntry) GetTypeName() string {
	return "BACnetVMACEntry"
}

func (m *BACnetVMACEntry) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetVMACEntry) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetVMACEntry) GetLengthInBytes() uint16 {
...
func BACnetVMACEntryParse(readBuffer utils.ReadBuffer) (*BACnetVMACEntry, error) {
	...
	var virtualMacAddress *BACnetContextTagOctetString = nil
	{
		...
		default:
			virtualMacAddress = CastBACnetContextTagOctetString(_val)
	...
	var nativeMacAddress *BACnetContextTagOctetString = nil
	{
		...
		default:
			nativeMacAddress = CastBACnetContextTagOctetString(_val)
...
func (m *BACnetVMACEntry) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetVMACEntry) String() string {
	if m == nil {
		return "<nil>"
	}
