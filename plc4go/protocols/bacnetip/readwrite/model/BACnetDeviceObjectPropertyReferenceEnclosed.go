...
func BACnetDeviceObjectPropertyReferenceEnclosedParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (BACnetDeviceObjectPropertyReferenceEnclosed, error) {
	v, err := (&_BACnetDeviceObjectPropertyReferenceEnclosed{}).parse(ctx, readBuffer, tagNumber)
	if err != nil {
		return nil, err
	}
	return v, err
...
func (m *_BACnetDeviceObjectPropertyReferenceEnclosed) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (_bACnetDeviceObjectPropertyReferenceEnclosed BACnetDeviceObjectPropertyReferenceEnclosed, err error) {
