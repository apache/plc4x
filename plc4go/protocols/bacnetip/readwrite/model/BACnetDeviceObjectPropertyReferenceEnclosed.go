...
func (m *_BACnetDeviceObjectPropertyReferenceEnclosed) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetDeviceObjectPropertyReferenceEnclosed) GetLengthInBytes(ctx context.Context) uint64 {
