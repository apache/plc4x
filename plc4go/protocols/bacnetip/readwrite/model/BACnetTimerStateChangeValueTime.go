...
func (m *_BACnetTimerStateChangeValueTime) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetTimerStateChangeValueTime) GetLengthInBytes(ctx context.Context) uint64 {
