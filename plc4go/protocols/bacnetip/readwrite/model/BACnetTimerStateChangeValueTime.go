...
func (m *_BACnetTimerStateChangeValueTime) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetTimerStateChangeValue, objectTypeArgument BACnetObjectType) (_bACnetTimerStateChangeValueTime BACnetTimerStateChangeValueTime, err error) {
