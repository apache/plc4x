...
func (m *_BACnetConstructedDataEscalatorMode) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataEscalatorMode) GetLengthInBytes(ctx context.Context) uint64 {
