...
func (m *_BACnetConstructedDataTrackingValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataTrackingValue) GetLengthInBytes(ctx context.Context) uint64 {
