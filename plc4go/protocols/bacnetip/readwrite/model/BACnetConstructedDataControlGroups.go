...
func (m *_BACnetConstructedDataControlGroups) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataControlGroups) GetLengthInBytes(ctx context.Context) uint64 {
