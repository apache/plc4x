...
func (m *_BACnetAssignedLandingCalls) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_bACnetAssignedLandingCalls BACnetAssignedLandingCalls, err error) {
