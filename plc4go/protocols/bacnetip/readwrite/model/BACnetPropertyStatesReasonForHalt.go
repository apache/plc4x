...
func (m *_BACnetPropertyStatesReasonForHalt) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetPropertyStates, peekedTagNumber uint8) (_bACnetPropertyStatesReasonForHalt BACnetPropertyStatesReasonForHalt, err error) {
