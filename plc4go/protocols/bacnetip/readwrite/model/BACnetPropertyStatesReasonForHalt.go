...
func (m *_BACnetPropertyStatesReasonForHalt) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesReasonForHalt) GetLengthInBytes(ctx context.Context) uint64 {
