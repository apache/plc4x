...
func (m *_BACnetPropertyStatesReasonForHaltBuilder) WithMandatoryFields(reasonForHalt BACnetProgramErrorTagged) BACnetPropertyStatesReasonForHaltBuilder {
	return m.WithReasonForHalt(reasonForHalt)
}

func (m *_BACnetPropertyStatesReasonForHaltBuilder) WithReasonForHalt(reasonForHalt BACnetProgramErrorTagged) BACnetPropertyStatesReasonForHaltBuilder {
	m.ReasonForHalt = reasonForHalt
	return m
}

func (m *_BACnetPropertyStatesReasonForHaltBuilder) WithReasonForHaltBuilder(builderSupplier func(BACnetProgramErrorTaggedBuilder) BACnetProgramErrorTaggedBuilder) BACnetPropertyStatesReasonForHaltBuilder {
	builder := builderSupplier(m.ReasonForHalt.CreateBACnetProgramErrorTaggedBuilder())
	var err error
	m.ReasonForHalt, err = builder.Build()
	if err != nil {
		if m.err == nil {
...
func (m *_BACnetPropertyStatesReasonForHaltBuilder) Build() (BACnetPropertyStatesReasonForHalt, error) {
	if m.ReasonForHalt == nil {
		if m.err == nil {
			m.err = new(utils.MultiError)
		}
		m.err.Append(errors.New("mandatory field 'reasonForHalt' not set"))
	}
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._BACnetPropertyStatesReasonForHalt.deepCopy(), nil
}

func (m *_BACnetPropertyStatesReasonForHaltBuilder) MustBuild() BACnetPropertyStatesReasonForHalt {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetPropertyStatesReasonForHaltBuilder) DeepCopy() any {
	return m.CreateBACnetPropertyStatesReasonForHaltBuilder()
}

// CreateBACnetPropertyStatesReasonForHaltBuilder creates a BACnetPropertyStatesReasonForHaltBuilder
func (m *_BACnetPropertyStatesReasonForHalt) CreateBACnetPropertyStatesReasonForHaltBuilder() BACnetPropertyStatesReasonForHaltBuilder {
	if m == nil {
		return NewBACnetPropertyStatesReasonForHaltBuilder()
	}
	return &_BACnetPropertyStatesReasonForHaltBuilder{_BACnetPropertyStatesReasonForHalt: m.deepCopy()}
}
