...
func (m *_BACnetConstructedDataNetworkNumberQuality) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataNetworkNumberQuality) GetLengthInBytes(ctx context.Context) uint64 {
