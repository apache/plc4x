...
// BACnetLimitEnableTagged is the data-structure of this message
type BACnetLimitEnableTagged struct {
...
// IBACnetLimitEnableTagged is the corresponding interface of BACnetLimitEnableTagged
type IBACnetLimitEnableTagged interface {
...
func (m *BACnetLimitEnableTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetLimitEnableTagged) GetPayload() *BACnetTagPayloadBitString {
	return m.Payload
}
...
// NewBACnetLimitEnableTagged factory function for BACnetLimitEnableTagged
func NewBACnetLimitEnableTagged(header *BACnetTagHeader, payload *BACnetTagPayloadBitString, tagNumber uint8, tagClass TagClass) *BACnetLimitEnableTagged {
	return &BACnetLimitEnableTagged{Header: header, Payload: payload, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetLimitEnableTagged) GetTypeName() string {
	return "BACnetLimitEnableTagged"
}

func (m *BACnetLimitEnableTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetLimitEnableTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetLimitEnableTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetLimitEnableTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetLimitEnableTagged) String() string {
	if m == nil {
		return "<nil>"
	}
