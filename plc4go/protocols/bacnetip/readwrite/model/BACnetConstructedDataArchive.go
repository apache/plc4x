...
func (m *_BACnetConstructedDataArchive) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataArchive) GetLengthInBytes(ctx context.Context) uint64 {
