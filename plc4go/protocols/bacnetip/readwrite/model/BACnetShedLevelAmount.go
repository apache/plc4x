...
func (m *_BACnetShedLevelAmount) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetShedLevel) (_bACnetShedLevelAmount BACnetShedLevelAmount, err error) {
