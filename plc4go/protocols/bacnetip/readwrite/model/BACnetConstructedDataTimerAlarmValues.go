...
func (m *_BACnetConstructedDataTimerAlarmValues) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataTimerAlarmValues) GetLengthInBytes(ctx context.Context) uint64 {
