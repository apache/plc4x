...
func (m *_BACnetContextTagBitString) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetContextTagBitString) GetLengthInBytes(ctx context.Context) uint64 {
