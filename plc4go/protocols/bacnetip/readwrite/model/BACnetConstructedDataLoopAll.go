...
func (m *BACnetConstructedDataLoopAll) GetObjectType() BACnetObjectType {
...
func (m *BACnetConstructedDataLoopAll) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag) {
...
func NewBACnetConstructedDataLoopAll(openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag, tagNumber uint8) *BACnetConstructedDataLoopAll {
...
func BACnetConstructedDataLoopAllParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectType BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier) (*BACnetConstructedDataLoopAll, error) {
	...
	// Validation
	if !(bool((1) == (2))) {
		return nil, utils.ParseValidationError{"TODO: implement me BACnetConstructedData ...LOOP..."}
	}
