...
func (m *BACnetConstructedDataProportionalConstant) GetActualValue() *BACnetApplicationTagReal {
...
func (m *BACnetConstructedDataProportionalConstant) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		_proportionalConstantErr := writeBuffer.WriteSerializable(m.ProportionalConstant)
