...
func (m *_BACnetConstructedDataProportionalConstant) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataProportionalConstant) GetLengthInBytes(ctx context.Context) uint64 {
