...
func (m *_BACnetChannelValueBitString) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetChannelValueBitString) GetLengthInBytes(ctx context.Context) uint64 {
