...
func BACnetEventParameterChangeOfCharacterStringParse(ctx context.Context, theBytes []byte) (BACnetEventParameterChangeOfCharacterString, error) {
	return BACnetEventParameterChangeOfCharacterStringParseWithBuffer(ctx, utils.NewReadBufferByteBased(theBytes))
}

func BACnetEventParameterChangeOfCharacterStringParseWithBufferProducer() func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetEventParameterChangeOfCharacterString, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetEventParameterChangeOfCharacterString, error) {
		return BACnetEventParameterChangeOfCharacterStringParseWithBuffer(ctx, readBuffer)
	}
}
