...
func (m *_BACnetApplicationTagDouble) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetApplicationTag) (_bACnetApplicationTagDouble BACnetApplicationTagDouble, err error) {
