...
// BACnetConstructedDataCommandAction is the data-structure of this message
type BACnetConstructedDataCommandAction struct {
...
type IBACnetConstructedDataCommandAction interface {
...
func (m *BACnetConstructedDataCommandAction) GetObjectTypeArgument() BACnetObjectType {
	return BACnetObjectType_COMMAND
}

func (m *BACnetConstructedDataCommandAction) GetPropertyIdentifierArgument() BACnetPropertyIdentifier {
...
func (m *BACnetConstructedDataCommandAction) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag) {
	m.BACnetConstructedData.OpeningTag = openingTag
	m.BACnetConstructedData.PeekedTagHeader = peekedTagHeader
	m.BACnetConstructedData.ClosingTag = closingTag
}

func (m *BACnetConstructedDataCommandAction) GetParent() *BACnetConstructedData {
...
func (m *BACnetConstructedDataCommandAction) GetNumberOfDataElements() *BACnetApplicationTagUnsignedInteger {
	return m.NumberOfDataElements
}

func (m *BACnetConstructedDataCommandAction) GetActionLists() []*BACnetActionList {
...
func (m *BACnetConstructedDataCommandAction) GetZero() uint64 {
...
func NewBACnetConstructedDataCommandAction(numberOfDataElements *BACnetApplicationTagUnsignedInteger, actionLists []*BACnetActionList, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag, tagNumber uint8, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) *BACnetConstructedDataCommandAction {
...
func CastBACnetConstructedDataCommandAction(structType interface{}) *BACnetConstructedDataCommandAction {
	...
	if casted, ok := structType.(BACnetConstructedData); ok {
		return CastBACnetConstructedDataCommandAction(casted.Child)
	}
	if casted, ok := structType.(*BACnetConstructedData); ok {
		return CastBACnetConstructedDataCommandAction(casted.Child)
	}
...
func (m *BACnetConstructedDataCommandAction) GetTypeName() string {
	return "BACnetConstructedDataCommandAction"
}

func (m *BACnetConstructedDataCommandAction) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetConstructedDataCommandAction) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetConstructedDataCommandAction) GetLengthInBytes() uint16 {
...
func BACnetConstructedDataCommandActionParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) (*BACnetConstructedDataCommandAction, error) {
	...
	_child := &BACnetConstructedDataCommandAction{
...
func (m *BACnetConstructedDataCommandAction) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetConstructedDataCommandAction) String() string {
	if m == nil {
		return "<nil>"
	}
