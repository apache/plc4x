...
func (m *_BACnetOptionalCharacterStringValue) InitializeParent(parent BACnetOptionalCharacterString , peekedTagHeader BACnetTagHeader ) {	m.PeekedTagHeader = peekedTagHeader
}
...
_characterstring, _characterstringErr := BACnetApplicationTagParseWithBuffer(ctx, readBuffer)
