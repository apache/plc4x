...
func (m *_BACnetOptionalCharacterStringValue) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetOptionalCharacterString) (_bACnetOptionalCharacterStringValue BACnetOptionalCharacterStringValue, err error) {
