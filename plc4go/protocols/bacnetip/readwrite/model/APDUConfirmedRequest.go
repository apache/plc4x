...
func (m *_APDUConfirmedRequestBuilder) WithOptionalServiceRequestBuilder(builderSupplier func(BACnetConfirmedServiceRequestBuilder) BACnetConfirmedServiceRequestBuilder) APDUConfirmedRequestBuilder {
	builder := builderSupplier(m.ServiceRequest.CreateBACnetConfirmedServiceRequestBuilder())
	var err error
	...
	if err != nil {
		...
		m.err.Append(errors.Wrap(err, "BACnetConfirmedServiceRequestBuilder failed"))
	}
	return m
}
