...
// BVLCResultCodeTagged is the data-structure of this message
type BVLCResultCodeTagged struct {
...
// IBVLCResultCodeTagged is the corresponding interface of BVLCResultCodeTagged
type IBVLCResultCodeTagged interface {
...
func (m *BVLCResultCodeTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BVLCResultCodeTagged) GetValue() BVLCResultCode {
	return m.Value
}
...
// NewBVLCResultCodeTagged factory function for BVLCResultCodeTagged
func NewBVLCResultCodeTagged(header *BACnetTagHeader, value BVLCResultCode, tagNumber uint8, tagClass TagClass) *BVLCResultCodeTagged {
	return &BVLCResultCodeTagged{Header: header, Value: value, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BVLCResultCodeTagged) GetTypeName() string {
	return "BVLCResultCodeTagged"
}

func (m *BVLCResultCodeTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BVLCResultCodeTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BVLCResultCodeTagged) GetLengthInBytes() uint16 {
...
func (m *BVLCResultCodeTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BVLCResultCodeTagged) String() string {
	if m == nil {
		return "<nil>"
	}
