...
func (m *_BACnetChannelValueCharacterString) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetChannelValue) (_bACnetChannelValueCharacterString BACnetChannelValueCharacterString, err error) {
