...
func (m *BACnetConstructedDataAuthenticationPolicyList) GetNumberOfDataElements() *BACnetApplicationTagUnsignedInteger {
...
func (m *BACnetConstructedDataAuthenticationPolicyList) GetZero() uint64 {
...
func NewBACnetConstructedDataAuthenticationPolicyList(numberOfDataElements *BACnetApplicationTagUnsignedInteger, authenticationPolicyList []*BACnetAuthenticationPolicy, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag, tagNumber uint8, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) *BACnetConstructedDataAuthenticationPolicyList {
