...
func (m *BACnetConstructedDataUsesRemaining) GetActualValue() *BACnetApplicationTagSignedInteger {
...
func (m *BACnetConstructedDataUsesRemaining) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		_usesRemainingErr := writeBuffer.WriteSerializable(m.UsesRemaining)
