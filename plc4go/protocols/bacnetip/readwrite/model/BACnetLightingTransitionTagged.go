...
// BACnetLightingTransitionTagged is the data-structure of this message
type BACnetLightingTransitionTagged struct {
...
// IBACnetLightingTransitionTagged is the corresponding interface of BACnetLightingTransitionTagged
type IBACnetLightingTransitionTagged interface {
...
func (m *BACnetLightingTransitionTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetLightingTransitionTagged) GetValue() BACnetLightingTransition {
	return m.Value
}

func (m *BACnetLightingTransitionTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetLightingTransitionTagged) GetIsProprietary() bool {
...
// NewBACnetLightingTransitionTagged factory function for BACnetLightingTransitionTagged
func NewBACnetLightingTransitionTagged(header *BACnetTagHeader, value BACnetLightingTransition, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetLightingTransitionTagged {
	return &BACnetLightingTransitionTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetLightingTransitionTagged) GetTypeName() string {
	return "BACnetLightingTransitionTagged"
}

func (m *BACnetLightingTransitionTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetLightingTransitionTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetLightingTransitionTagged) GetLengthInBytes() uint16 {
	return m.GetLengthInBits() / 8
}

func BACnetLightingTransitionTaggedParse(readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (*BACnetLightingTransitionTagged, error) {
...
func (m *BACnetLightingTransitionTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetLightingTransitionTagged) String() string {
	if m == nil {
		return "<nil>"
	}
