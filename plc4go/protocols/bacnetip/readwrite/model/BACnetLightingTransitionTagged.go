...
func (m *_BACnetLightingTransitionTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetLightingTransitionTagged) GetLengthInBytes(ctx context.Context) uint64 {
