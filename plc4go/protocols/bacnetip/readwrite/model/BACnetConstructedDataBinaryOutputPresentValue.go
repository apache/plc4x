...
func (m *_BACnetConstructedDataBinaryOutputPresentValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataBinaryOutputPresentValue) GetLengthInBytes(ctx context.Context) uint64 {
