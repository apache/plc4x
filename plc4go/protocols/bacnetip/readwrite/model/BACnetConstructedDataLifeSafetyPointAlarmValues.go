...
func (m *_BACnetConstructedDataLifeSafetyPointAlarmValues) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *_BACnetConstructedDataLifeSafetyPointAlarmValues) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *_BACnetConstructedDataLifeSafetyPointAlarmValues) GetLengthInBytes() uint16 {
...
func BACnetConstructedDataLifeSafetyPointAlarmValuesParse(theBytes []byte, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier, arrayIndexArgument BACnetTagPayloadUnsignedInteger) (BACnetConstructedDataLifeSafetyPointAlarmValues, error) {
	return BACnetConstructedDataLifeSafetyPointAlarmValuesParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian)), tagNumber, objectTypeArgument, propertyIdentifierArgument, arrayIndexArgument) // TODO: get endianness from mspec
}
