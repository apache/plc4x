...
func (m *_BACnetAddressEnclosed) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (_bACnetAddressEnclosed BACnetAddressEnclosed, err error) {
