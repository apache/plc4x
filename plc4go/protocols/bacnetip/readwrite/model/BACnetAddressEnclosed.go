...
func (m *_BACnetAddressEnclosed) GetPlx4xTypeName() string {
	return "BACnetAddressEnclosed"
}

func (m *_BACnetAddressEnclosed) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetAddressEnclosed) GetLengthInBytes(ctx context.Context) uint64 {
