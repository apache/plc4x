...
func (m *_BACnetBinaryLightingPVTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetBinaryLightingPVTagged) GetLengthInBytes(ctx context.Context) uint64 {
