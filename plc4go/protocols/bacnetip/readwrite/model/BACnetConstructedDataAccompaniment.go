...
func (m *_BACnetConstructedDataAccompaniment) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataAccompaniment) GetLengthInBytes(ctx context.Context) uint64 {
