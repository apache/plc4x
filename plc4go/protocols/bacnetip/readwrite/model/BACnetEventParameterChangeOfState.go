...
// BACnetEventParameterChangeOfState is the data-structure of this message
type BACnetEventParameterChangeOfState struct {
...
// IBACnetEventParameterChangeOfState is the corresponding interface of BACnetEventParameterChangeOfState
type IBACnetEventParameterChangeOfState interface {
...
func (m *BACnetEventParameterChangeOfState) InitializeParent(parent *BACnetEventParameter, peekedTagHeader *BACnetTagHeader) {
	m.BACnetEventParameter.PeekedTagHeader = peekedTagHeader
}

func (m *BACnetEventParameterChangeOfState) GetParent() *BACnetEventParameter {
...
func (m *BACnetEventParameterChangeOfState) GetOpeningTag() *BACnetOpeningTag {
	return m.OpeningTag
}

func (m *BACnetEventParameterChangeOfState) GetTimeDelay() *BACnetContextTagUnsignedInteger {
	return m.TimeDelay
}

func (m *BACnetEventParameterChangeOfState) GetListOfValues() *BACnetEventParameterChangeOfStateListOfValues {
	return m.ListOfValues
}

func (m *BACnetEventParameterChangeOfState) GetClosingTag() *BACnetClosingTag {
	return m.ClosingTag
}
...
// NewBACnetEventParameterChangeOfState factory function for BACnetEventParameterChangeOfState
func NewBACnetEventParameterChangeOfState(openingTag *BACnetOpeningTag, timeDelay *BACnetContextTagUnsignedInteger, listOfValues *BACnetEventParameterChangeOfStateListOfValues, closingTag *BACnetClosingTag, peekedTagHeader *BACnetTagHeader) *BACnetEventParameterChangeOfState {
	_result := &BACnetEventParameterChangeOfState{
...
func CastBACnetEventParameterChangeOfState(structType interface{}) *BACnetEventParameterChangeOfState {
	...
	if casted, ok := structType.(BACnetEventParameter); ok {
		return CastBACnetEventParameterChangeOfState(casted.Child)
	}
	if casted, ok := structType.(*BACnetEventParameter); ok {
		return CastBACnetEventParameterChangeOfState(casted.Child)
	}
...
func (m *BACnetEventParameterChangeOfState) GetTypeName() string {
	return "BACnetEventParameterChangeOfState"
}

func (m *BACnetEventParameterChangeOfState) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetEventParameterChangeOfState) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetEventParameterChangeOfState) GetLengthInBytes() uint16 {
...
func BACnetEventParameterChangeOfStateParse(readBuffer utils.ReadBuffer) (*BACnetEventParameterChangeOfState, error) {
	...
	listOfValues := CastBACnetEventParameterChangeOfStateListOfValues(_listOfValues)
	...
	_child := &BACnetEventParameterChangeOfState{
		OpeningTag:           CastBACnetOpeningTag(openingTag),
		TimeDelay:            CastBACnetContextTagUnsignedInteger(timeDelay),
		ListOfValues:         CastBACnetEventParameterChangeOfStateListOfValues(listOfValues),
...
func (m *BACnetEventParameterChangeOfState) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetEventParameterChangeOfState) String() string {
	if m == nil {
		return "<nil>"
	}
