...
func (m *_BACnetEventParameterChangeOfState) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetEventParameter) (_bACnetEventParameterChangeOfState BACnetEventParameterChangeOfState, err error) {
