...
func (m *_BACnetEventParameterChangeOfState) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetEventParameterChangeOfState) GetLengthInBytes(ctx context.Context) uint64 {
