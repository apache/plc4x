...
// BACnetConstructedDataAccessZoneAdjustValue is the data-structure of this message
type BACnetConstructedDataAccessZoneAdjustValue struct {
...
type IBACnetConstructedDataAccessZoneAdjustValue interface {
...
func (m *BACnetConstructedDataAccessZoneAdjustValue) GetObjectTypeArgument() BACnetObjectType {
	return BACnetObjectType_ACCESS_ZONE
}

func (m *BACnetConstructedDataAccessZoneAdjustValue) GetPropertyIdentifierArgument() BACnetPropertyIdentifier {
...
func (m *BACnetConstructedDataAccessZoneAdjustValue) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag) {
	m.BACnetConstructedData.OpeningTag = openingTag
	m.BACnetConstructedData.ClosingTag = closingTag
}

func (m *BACnetConstructedDataAccessZoneAdjustValue) GetParent() *BACnetConstructedData {
...
func (m *BACnetConstructedDataAccessZoneAdjustValue) GetAdjustValue() *BACnetApplicationTagSignedInteger {
...
func NewBACnetConstructedDataAccessZoneAdjustValue(adjustValue *BACnetApplicationTagSignedInteger, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag, tagNumber uint8) *BACnetConstructedDataAccessZoneAdjustValue {
...
func CastBACnetConstructedDataAccessZoneAdjustValue(structType interface{}) *BACnetConstructedDataAccessZoneAdjustValue {
	...
	if casted, ok := structType.(BACnetConstructedData); ok {
		return CastBACnetConstructedDataAccessZoneAdjustValue(casted.Child)
	}
	if casted, ok := structType.(*BACnetConstructedData); ok {
		return CastBACnetConstructedDataAccessZoneAdjustValue(casted.Child)
	}
...
func (m *BACnetConstructedDataAccessZoneAdjustValue) GetTypeName() string {
	return "BACnetConstructedDataAccessZoneAdjustValue"
}

func (m *BACnetConstructedDataAccessZoneAdjustValue) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetConstructedDataAccessZoneAdjustValue) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetConstructedDataAccessZoneAdjustValue) GetLengthInBytes() uint16 {
...
func BACnetConstructedDataAccessZoneAdjustValueParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier) (*BACnetConstructedDataAccessZoneAdjustValue, error) {
	...
	_child := &BACnetConstructedDataAccessZoneAdjustValue{
...
func (m *BACnetConstructedDataAccessZoneAdjustValue) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetConstructedDataAccessZoneAdjustValue) String() string {
	if m == nil {
		return "<nil>"
	}
