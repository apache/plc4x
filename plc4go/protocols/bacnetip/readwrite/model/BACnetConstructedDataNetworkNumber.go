...
func NewBACnetConstructedDataNetworkNumber(openingTag BACnetOpeningTag, peekedTagHeader BACnetTagHeader, closingTag BACnetClosingTag, networkNumber BACnetApplicationTagUnsignedInteger) *_BACnetConstructedDataNetworkNumber {
...
func (b *_BACnetConstructedDataNetworkNumberBuilder) setParent(contract BACnetConstructedDataContract) {
	...
	contract.(*_BACnetConstructedData)._SubType = b._BACnetConstructedDataNetworkNumber
}
...
func (m *_BACnetConstructedDataNetworkNumber) GetPlx4xTypeName() string {
	return "BACnetConstructedDataNetworkNumber"
}

func (m *_BACnetConstructedDataNetworkNumber) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataNetworkNumber) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataNetworkNumber) deepCopy() *_BACnetConstructedDataNetworkNumber {
	...
	_BACnetConstructedDataNetworkNumberCopy.BACnetConstructedDataContract.(*_BACnetConstructedData)._SubType = m
