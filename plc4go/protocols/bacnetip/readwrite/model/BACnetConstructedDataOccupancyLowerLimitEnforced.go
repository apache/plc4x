...
func (m *_BACnetConstructedDataOccupancyLowerLimitEnforced) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataOccupancyLowerLimitEnforced) GetLengthInBytes(ctx context.Context) uint64 {
