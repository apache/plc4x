...
func (m *BACnetConstructedDataOccupancyUpperLimit) GetActualValue() *BACnetApplicationTagUnsignedInteger {
...
func (m *BACnetConstructedDataOccupancyUpperLimit) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		_occupancyUpperLimitErr := writeBuffer.WriteSerializable(m.OccupancyUpperLimit)
