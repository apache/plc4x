...
func (m BACnetServicesSupported) GetLengthInBits(ctx context.Context) uint64 {
	return 8
}

func (m BACnetServicesSupported) GetLengthInBytes(ctx context.Context) uint64 {
...
func BACnetServicesSupportedParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetServicesSupported, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint8("BACnetServicesSupported", 8)
	if err != nil {
...
func (e BACnetServicesSupported) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint8("BACnetServicesSupported", 8, uint8(uint8(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}

func (e BACnetServicesSupported) GetValue() uint8 {
	return uint8(e)
}
