...
func (m *_BACnetConstructedDataLowLimit) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataLowLimit) GetLengthInBytes(ctx context.Context) uint64 {
