...
// BACnetConstructedDataAssignedAccessRights is the data-structure of this message
type BACnetConstructedDataAssignedAccessRights struct {
...
type IBACnetConstructedDataAssignedAccessRights interface {
...
func (m *BACnetConstructedDataAssignedAccessRights) GetObjectTypeArgument() BACnetObjectType {
	return 0
}
...
func (m *BACnetConstructedDataAssignedAccessRights) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag) {
	m.BACnetConstructedData.OpeningTag = openingTag
	m.BACnetConstructedData.PeekedTagHeader = peekedTagHeader
	m.BACnetConstructedData.ClosingTag = closingTag
}

func (m *BACnetConstructedDataAssignedAccessRights) GetParent() *BACnetConstructedData {
...
func (m *BACnetConstructedDataAssignedAccessRights) GetNumberOfDataElements() *BACnetApplicationTagUnsignedInteger {
	return m.NumberOfDataElements
}

func (m *BACnetConstructedDataAssignedAccessRights) GetAssignedAccessRights() []*BACnetAssignedAccessRights {
...
func (m *BACnetConstructedDataAssignedAccessRights) GetZero() uint64 {
...
func NewBACnetConstructedDataAssignedAccessRights(numberOfDataElements *BACnetApplicationTagUnsignedInteger, assignedAccessRights []*BACnetAssignedAccessRights, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag, tagNumber uint8, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) *BACnetConstructedDataAssignedAccessRights {
...
func CastBACnetConstructedDataAssignedAccessRights(structType interface{}) *BACnetConstructedDataAssignedAccessRights {
	...
	if casted, ok := structType.(BACnetConstructedData); ok {
		return CastBACnetConstructedDataAssignedAccessRights(casted.Child)
	}
	if casted, ok := structType.(*BACnetConstructedData); ok {
		return CastBACnetConstructedDataAssignedAccessRights(casted.Child)
	}
...
func (m *BACnetConstructedDataAssignedAccessRights) GetTypeName() string {
	return "BACnetConstructedDataAssignedAccessRights"
}

func (m *BACnetConstructedDataAssignedAccessRights) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetConstructedDataAssignedAccessRights) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetConstructedDataAssignedAccessRights) GetLengthInBytes() uint16 {
...
func BACnetConstructedDataAssignedAccessRightsParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) (*BACnetConstructedDataAssignedAccessRights, error) {
	...
	assignedAccessRights := make([]*BACnetAssignedAccessRights, 0)
	{
		for !bool(IsBACnetConstructedDataClosingTag(readBuffer, false, tagNumber)) {
			...
			assignedAccessRights = append(assignedAccessRights, CastBACnetAssignedAccessRights(_item))
	...
	_child := &BACnetConstructedDataAssignedAccessRights{
...
func (m *BACnetConstructedDataAssignedAccessRights) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetConstructedDataAssignedAccessRights) String() string {
	if m == nil {
		return "<nil>"
	}
