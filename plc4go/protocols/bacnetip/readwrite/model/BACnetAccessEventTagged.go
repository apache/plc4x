...
func (m *_BACnetAccessEventTagged) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (_bACnetAccessEventTagged BACnetAccessEventTagged, err error) {
