...
func (m *_BACnetAccessEventTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *_BACnetAccessEventTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *_BACnetAccessEventTagged) GetLengthInBytes() uint16 {
