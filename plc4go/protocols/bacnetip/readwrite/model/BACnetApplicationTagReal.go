...
func (m *_BACnetApplicationTagReal) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetApplicationTagReal) GetLengthInBytes(ctx context.Context) uint64 {
