...
func (m *_BACnetApplicationTagReal) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetApplicationTag) (_bACnetApplicationTagReal BACnetApplicationTagReal, err error) {
