...
func NewBACnetConstructedDataAnalogOutputMaxPresValue(openingTag BACnetOpeningTag, peekedTagHeader BACnetTagHeader, closingTag BACnetClosingTag, maxPresValue BACnetApplicationTagReal) *_BACnetConstructedDataAnalogOutputMaxPresValue {
	if maxPresValue == nil {
...
func (b *_BACnetConstructedDataAnalogOutputMaxPresValueBuilder) setParent(contract BACnetConstructedDataContract) {
	...
	contract.(*_BACnetConstructedData)._SubType = b._BACnetConstructedDataAnalogOutputMaxPresValue
}
...
func (m *_BACnetConstructedDataAnalogOutputMaxPresValue) GetPlx4xTypeName() string {
	return "BACnetConstructedDataAnalogOutputMaxPresValue"
}

func (m *_BACnetConstructedDataAnalogOutputMaxPresValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataAnalogOutputMaxPresValue) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataAnalogOutputMaxPresValue) deepCopy() *_BACnetConstructedDataAnalogOutputMaxPresValue {
	...
	_BACnetConstructedDataAnalogOutputMaxPresValueCopy.BACnetConstructedDataContract.(*_BACnetConstructedData)._SubType = m
