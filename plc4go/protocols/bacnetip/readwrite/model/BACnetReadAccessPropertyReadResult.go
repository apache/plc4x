...
func (m *_BACnetReadAccessPropertyReadResult) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetReadAccessPropertyReadResult) GetLengthInBytes(ctx context.Context) uint64 {
