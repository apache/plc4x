...
func (m *_BACnetConstructedDataNotificationClass) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataNotificationClass) GetLengthInBytes(ctx context.Context) uint64 {
