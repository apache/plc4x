...
func BACnetFaultParameterNoneParse(theBytes []byte) (BACnetFaultParameterNone, error) {
	return BACnetFaultParameterNoneParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian))) // TODO: get endianness from mspec
}
