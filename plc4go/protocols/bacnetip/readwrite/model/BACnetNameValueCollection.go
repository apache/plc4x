...
func (m *_BACnetNameValueCollection) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetNameValueCollection) GetLengthInBytes(ctx context.Context) uint64 {
