...
func (m *BACnetConstructedDataIPv6AutoAddressingEnable) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag) {
...
func (m *BACnetConstructedDataIPv6AutoAddressingEnable) GetActualValue() *BACnetApplicationTagBoolean {
...
func (m *BACnetConstructedDataIPv6AutoAddressingEnable) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		_autoAddressingEnableErr := writeBuffer.WriteSerializable(m.AutoAddressingEnable)
