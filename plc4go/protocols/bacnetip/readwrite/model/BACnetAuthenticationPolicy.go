...
func (m *_BACnetAuthenticationPolicy) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_bACnetAuthenticationPolicy BACnetAuthenticationPolicy, err error) {
