...
func (m *_BACnetConstructedDataIPv6DHCPLeaseTimeBuilder) WithMandatoryFields(ipv6DhcpLeaseTime BACnetApplicationTagUnsignedInteger) BACnetConstructedDataIPv6DHCPLeaseTimeBuilder {
	return m.WithIpv6DhcpLeaseTime(ipv6DhcpLeaseTime)
}

func (m *_BACnetConstructedDataIPv6DHCPLeaseTimeBuilder) WithIpv6DhcpLeaseTime(ipv6DhcpLeaseTime BACnetApplicationTagUnsignedInteger) BACnetConstructedDataIPv6DHCPLeaseTimeBuilder {
	m.Ipv6DhcpLeaseTime = ipv6DhcpLeaseTime
	return m
}

func (m *_BACnetConstructedDataIPv6DHCPLeaseTimeBuilder) WithIpv6DhcpLeaseTimeBuilder(builderSupplier func(BACnetApplicationTagUnsignedIntegerBuilder) BACnetApplicationTagUnsignedIntegerBuilder) BACnetConstructedDataIPv6DHCPLeaseTimeBuilder {
	builder := builderSupplier(m.Ipv6DhcpLeaseTime.CreateBACnetApplicationTagUnsignedIntegerBuilder())
	var err error
	m.Ipv6DhcpLeaseTime, err = builder.Build()
	if err != nil {
		if m.err == nil {
...
func (m *_BACnetConstructedDataIPv6DHCPLeaseTimeBuilder) Build() (BACnetConstructedDataIPv6DHCPLeaseTime, error) {
	if m.Ipv6DhcpLeaseTime == nil {
		if m.err == nil {
			m.err = new(utils.MultiError)
		}
		m.err.Append(errors.New("mandatory field 'ipv6DhcpLeaseTime' not set"))
	}
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._BACnetConstructedDataIPv6DHCPLeaseTime.deepCopy(), nil
}

func (m *_BACnetConstructedDataIPv6DHCPLeaseTimeBuilder) MustBuild() BACnetConstructedDataIPv6DHCPLeaseTime {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetConstructedDataIPv6DHCPLeaseTimeBuilder) DeepCopy() any {
	return m.CreateBACnetConstructedDataIPv6DHCPLeaseTimeBuilder()
}

// CreateBACnetConstructedDataIPv6DHCPLeaseTimeBuilder creates a BACnetConstructedDataIPv6DHCPLeaseTimeBuilder
func (m *_BACnetConstructedDataIPv6DHCPLeaseTime) CreateBACnetConstructedDataIPv6DHCPLeaseTimeBuilder() BACnetConstructedDataIPv6DHCPLeaseTimeBuilder {
	if m == nil {
		return NewBACnetConstructedDataIPv6DHCPLeaseTimeBuilder()
	}
	return &_BACnetConstructedDataIPv6DHCPLeaseTimeBuilder{_BACnetConstructedDataIPv6DHCPLeaseTime: m.deepCopy()}
}
