...
func (m *_SecurityResponseCodeTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_SecurityResponseCodeTagged) GetLengthInBytes(ctx context.Context) uint64 {
