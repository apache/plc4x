...
func (m *_SecurityResponseCodeTaggedBuilder) WithMandatoryFields(header BACnetTagHeader, value SecurityResponseCode) SecurityResponseCodeTaggedBuilder {
	return m.WithHeader(header).WithValue(value)
}

func (m *_SecurityResponseCodeTaggedBuilder) WithHeader(header BACnetTagHeader) SecurityResponseCodeTaggedBuilder {
	m.Header = header
	return m
}

func (m *_SecurityResponseCodeTaggedBuilder) WithHeaderBuilder(builderSupplier func(BACnetTagHeaderBuilder) BACnetTagHeaderBuilder) SecurityResponseCodeTaggedBuilder {
...
func (m *_SecurityResponseCodeTaggedBuilder) WithValue(value SecurityResponseCode) SecurityResponseCodeTaggedBuilder {
	m.Value = value
	return m
}

func (m *_SecurityResponseCodeTaggedBuilder) Build() (SecurityResponseCodeTagged, error) {
	if m.Header == nil {
		if m.err == nil {
	...
	return m._SecurityResponseCodeTagged.deepCopy(), nil
}

func (m *_SecurityResponseCodeTaggedBuilder) MustBuild() SecurityResponseCodeTagged {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_SecurityResponseCodeTaggedBuilder) DeepCopy() any {
	return m.CreateSecurityResponseCodeTaggedBuilder()
}

// CreateSecurityResponseCodeTaggedBuilder creates a SecurityResponseCodeTaggedBuilder
func (m *_SecurityResponseCodeTagged) CreateSecurityResponseCodeTaggedBuilder() SecurityResponseCodeTaggedBuilder {
	if m == nil {
		return NewSecurityResponseCodeTaggedBuilder()
	}
	return &_SecurityResponseCodeTaggedBuilder{_SecurityResponseCodeTagged: m.deepCopy()}
}
