...
func BACnetLogRecordLogDatumLogStatusParseWithBufferProducer(tagNumber uint8) func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetLogRecordLogDatumLogStatus, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetLogRecordLogDatumLogStatus, error) {
		return BACnetLogRecordLogDatumLogStatusParseWithBuffer(ctx, readBuffer, tagNumber)
	}
}
