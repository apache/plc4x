...
func (m *_BACnetLogRecordLogDatumLogStatus) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetLogRecordLogDatumLogStatus) GetLengthInBytes(ctx context.Context) uint64 {
