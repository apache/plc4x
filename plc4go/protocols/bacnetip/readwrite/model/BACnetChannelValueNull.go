...
func BACnetChannelValueNullParseWithBufferProducer() func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetChannelValueNull, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetChannelValueNull, error) {
		return BACnetChannelValueNullParseWithBuffer(ctx, readBuffer)
	}
}
