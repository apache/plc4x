...
func (m *_BACnetConstructedDataMaintenanceRequired) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataMaintenanceRequired) GetLengthInBytes(ctx context.Context) uint64 {
