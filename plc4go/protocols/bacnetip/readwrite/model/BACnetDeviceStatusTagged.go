...
func (m *_BACnetDeviceStatusTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetDeviceStatusTagged) GetLengthInBytes(ctx context.Context) uint64 {
