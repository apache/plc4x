...
// BACnetDeviceStatusTagged is the data-structure of this message
type BACnetDeviceStatusTagged struct {
...
// IBACnetDeviceStatusTagged is the corresponding interface of BACnetDeviceStatusTagged
type IBACnetDeviceStatusTagged interface {
...
func (m *BACnetDeviceStatusTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetDeviceStatusTagged) GetValue() BACnetDeviceStatus {
	return m.Value
}

func (m *BACnetDeviceStatusTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetDeviceStatusTagged) GetIsProprietary() bool {
...
// NewBACnetDeviceStatusTagged factory function for BACnetDeviceStatusTagged
func NewBACnetDeviceStatusTagged(header *BACnetTagHeader, value BACnetDeviceStatus, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetDeviceStatusTagged {
	return &BACnetDeviceStatusTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetDeviceStatusTagged) GetTypeName() string {
	return "BACnetDeviceStatusTagged"
}

func (m *BACnetDeviceStatusTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetDeviceStatusTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetDeviceStatusTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetDeviceStatusTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetDeviceStatusTagged) String() string {
	if m == nil {
		return "<nil>"
	}
