...
func (m *_NLMInitializeRoutingTable) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_NLM, apduLength uint16) (_nLMInitializeRoutingTable NLMInitializeRoutingTable, err error) {
