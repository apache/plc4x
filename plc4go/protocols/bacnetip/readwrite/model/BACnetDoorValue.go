...
func (m BACnetDoorValue) GetLengthInBits(ctx context.Context) uint64 {
	return 8
}

func (m BACnetDoorValue) GetLengthInBytes(ctx context.Context) uint64 {
...
func BACnetDoorValueParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetDoorValue, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint8("BACnetDoorValue", 8)
	if err != nil {
...
func (e BACnetDoorValue) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint8("BACnetDoorValue", 8, uint8(uint8(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}

func (e BACnetDoorValue) GetValue() uint8 {
	return uint8(e)
}
