...
func (m *_NLMWhoIsRouterToNetwork) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_NLM, apduLength uint16) (_nLMWhoIsRouterToNetwork NLMWhoIsRouterToNetwork, err error) {
