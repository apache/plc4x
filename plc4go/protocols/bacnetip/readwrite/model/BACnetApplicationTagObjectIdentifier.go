...
func (m *_BACnetApplicationTagObjectIdentifierBuilder) WithMandatoryFields(payload BACnetTagPayloadObjectIdentifier) BACnetApplicationTagObjectIdentifierBuilder {
	return m.WithPayload(payload)
}

func (m *_BACnetApplicationTagObjectIdentifierBuilder) WithPayload(payload BACnetTagPayloadObjectIdentifier) BACnetApplicationTagObjectIdentifierBuilder {
	m.Payload = payload
	return m
}

func (m *_BACnetApplicationTagObjectIdentifierBuilder) WithPayloadBuilder(builderSupplier func(BACnetTagPayloadObjectIdentifierBuilder) BACnetTagPayloadObjectIdentifierBuilder) BACnetApplicationTagObjectIdentifierBuilder {
...
func (m *_BACnetApplicationTagObjectIdentifierBuilder) Build() (BACnetApplicationTagObjectIdentifier, error) {
	if m.Payload == nil {
		if m.err == nil {
	...
	return m._BACnetApplicationTagObjectIdentifier.deepCopy(), nil
}

func (m *_BACnetApplicationTagObjectIdentifierBuilder) MustBuild() BACnetApplicationTagObjectIdentifier {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetApplicationTagObjectIdentifierBuilder) DeepCopy() any {
	return m.CreateBACnetApplicationTagObjectIdentifierBuilder()
}

// CreateBACnetApplicationTagObjectIdentifierBuilder creates a BACnetApplicationTagObjectIdentifierBuilder
func (m *_BACnetApplicationTagObjectIdentifier) CreateBACnetApplicationTagObjectIdentifierBuilder() BACnetApplicationTagObjectIdentifierBuilder {
	if m == nil {
		return NewBACnetApplicationTagObjectIdentifierBuilder()
	}
	return &_BACnetApplicationTagObjectIdentifierBuilder{_BACnetApplicationTagObjectIdentifier: m.deepCopy()}
}
