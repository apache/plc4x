...
func (m *_BACnetApplicationTagObjectIdentifier) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetApplicationTag) (_bACnetApplicationTagObjectIdentifier BACnetApplicationTagObjectIdentifier, err error) {
