...
func (m *_BACnetApplicationTagObjectIdentifier) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetApplicationTagObjectIdentifier) GetLengthInBytes(ctx context.Context) uint64 {
