...
func (m *_BACnetConstructedDataScheduleDefault) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataScheduleDefault) GetLengthInBytes(ctx context.Context) uint64 {
