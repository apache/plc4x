...
func BACnetTagPayloadOctetStringParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, actualLength uint32) (BACnetTagPayloadOctetString, error) {
	v, err := (&_BACnetTagPayloadOctetString{}).parse(ctx, readBuffer, actualLength)
	if err != nil {
		return nil, err
	}
	return v, err
...
func (m *_BACnetTagPayloadOctetString) parse(ctx context.Context, readBuffer utils.ReadBuffer, actualLength uint32) (_bACnetTagPayloadOctetString BACnetTagPayloadOctetString, err error) {
