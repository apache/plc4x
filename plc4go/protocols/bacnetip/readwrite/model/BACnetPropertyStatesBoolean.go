...
func (m *_BACnetPropertyStatesBoolean) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesBoolean) GetLengthInBytes(ctx context.Context) uint64 {
