...
func (m *_BACnetPropertyStatesBoolean) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetPropertyStates, peekedTagNumber uint8) (_bACnetPropertyStatesBoolean BACnetPropertyStatesBoolean, err error) {
