...
func (m *_BACnetFaultParameterFaultExtendedParameters) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetFaultParameterFaultExtendedParameters) GetLengthInBytes(ctx context.Context) uint64 {
