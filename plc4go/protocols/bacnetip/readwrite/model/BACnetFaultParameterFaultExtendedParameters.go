...
func (m *_BACnetFaultParameterFaultExtendedParameters) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (_bACnetFaultParameterFaultExtendedParameters BACnetFaultParameterFaultExtendedParameters, err error) {
