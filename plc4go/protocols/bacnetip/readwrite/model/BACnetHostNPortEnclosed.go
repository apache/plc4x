...
func (m *_BACnetHostNPortEnclosed) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (_bACnetHostNPortEnclosed BACnetHostNPortEnclosed, err error) {
