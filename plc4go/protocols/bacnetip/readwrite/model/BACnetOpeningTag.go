...
func BACnetOpeningTagParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, tagNumberArgument uint8) (BACnetOpeningTag, error) {
	v, err := (&_BACnetOpeningTag{}).parse(ctx, readBuffer, tagNumberArgument)
	if err != nil {
		return nil, err
	}
	return v, err
...
func (m *_BACnetOpeningTag) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumberArgument uint8) (_bACnetOpeningTag BACnetOpeningTag, err error) {
