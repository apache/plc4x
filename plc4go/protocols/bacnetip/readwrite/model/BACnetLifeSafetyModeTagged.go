...
func (m *_BACnetLifeSafetyModeTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *_BACnetLifeSafetyModeTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *_BACnetLifeSafetyModeTagged) GetLengthInBytes() uint16 {
	return m.GetLengthInBits() / 8
}

func BACnetLifeSafetyModeTaggedParse(theBytes []byte, tagNumber uint8, tagClass TagClass) (BACnetLifeSafetyModeTagged, error) {
	return BACnetLifeSafetyModeTaggedParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian)), tagNumber, tagClass) // TODO: get endianness from mspec
}

func BACnetLifeSafetyModeTaggedParseWithBuffer(readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (BACnetLifeSafetyModeTagged, error) {
...
func (m *_BACnetLifeSafetyModeTagged) SerializeWithWriteBuffer(writeBuffer utils.WriteBuffer) error {
