...
// BACnetLifeSafetyModeTagged is the data-structure of this message
type BACnetLifeSafetyModeTagged struct {
...
// IBACnetLifeSafetyModeTagged is the corresponding interface of BACnetLifeSafetyModeTagged
type IBACnetLifeSafetyModeTagged interface {
...
func (m *BACnetLifeSafetyModeTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetLifeSafetyModeTagged) GetValue() BACnetLifeSafetyMode {
	return m.Value
}

func (m *BACnetLifeSafetyModeTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetLifeSafetyModeTagged) GetIsProprietary() bool {
...
// NewBACnetLifeSafetyModeTagged factory function for BACnetLifeSafetyModeTagged
func NewBACnetLifeSafetyModeTagged(header *BACnetTagHeader, value BACnetLifeSafetyMode, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetLifeSafetyModeTagged {
	return &BACnetLifeSafetyModeTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetLifeSafetyModeTagged) GetTypeName() string {
	return "BACnetLifeSafetyModeTagged"
}

func (m *BACnetLifeSafetyModeTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetLifeSafetyModeTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetLifeSafetyModeTagged) GetLengthInBytes() uint16 {
	return m.GetLengthInBits() / 8
}

func BACnetLifeSafetyModeTaggedParse(readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (*BACnetLifeSafetyModeTagged, error) {
...
func (m *BACnetLifeSafetyModeTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetLifeSafetyModeTagged) String() string {
	if m == nil {
		return "<nil>"
	}
