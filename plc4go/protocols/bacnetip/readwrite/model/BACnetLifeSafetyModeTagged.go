...
func (m *_BACnetLifeSafetyModeTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetLifeSafetyModeTagged) GetLengthInBytes(ctx context.Context) uint64 {
