...
func (m *_BACnetConstructedDataElevatorGroupAll) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.BACnetConstructedDataContract.(*_BACnetConstructedData).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_BACnetConstructedDataElevatorGroupAll) GetLengthInBytes(ctx context.Context) uint64 {
