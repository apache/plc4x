...
// BACnetEscalatorOperationDirectionTagged is the data-structure of this message
type BACnetEscalatorOperationDirectionTagged struct {
...
// IBACnetEscalatorOperationDirectionTagged is the corresponding interface of BACnetEscalatorOperationDirectionTagged
type IBACnetEscalatorOperationDirectionTagged interface {
...
func (m *BACnetEscalatorOperationDirectionTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetEscalatorOperationDirectionTagged) GetValue() BACnetEscalatorOperationDirection {
	return m.Value
}

func (m *BACnetEscalatorOperationDirectionTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetEscalatorOperationDirectionTagged) GetIsProprietary() bool {
...
// NewBACnetEscalatorOperationDirectionTagged factory function for BACnetEscalatorOperationDirectionTagged
func NewBACnetEscalatorOperationDirectionTagged(header *BACnetTagHeader, value BACnetEscalatorOperationDirection, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetEscalatorOperationDirectionTagged {
	return &BACnetEscalatorOperationDirectionTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetEscalatorOperationDirectionTagged) GetTypeName() string {
	return "BACnetEscalatorOperationDirectionTagged"
}

func (m *BACnetEscalatorOperationDirectionTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetEscalatorOperationDirectionTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetEscalatorOperationDirectionTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetEscalatorOperationDirectionTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetEscalatorOperationDirectionTagged) String() string {
	if m == nil {
		return "<nil>"
	}
