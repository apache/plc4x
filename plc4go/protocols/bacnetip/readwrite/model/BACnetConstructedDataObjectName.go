...
func (m *_BACnetConstructedDataObjectName) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataObjectName) GetLengthInBytes(ctx context.Context) uint64 {
