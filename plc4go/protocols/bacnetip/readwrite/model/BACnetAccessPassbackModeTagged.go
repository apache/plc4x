...
func (m *_BACnetAccessPassbackModeTagged) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (_bACnetAccessPassbackModeTagged BACnetAccessPassbackModeTagged, err error) {
