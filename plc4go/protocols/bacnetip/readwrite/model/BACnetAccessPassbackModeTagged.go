...
// BACnetAccessPassbackModeTagged is the data-structure of this message
type BACnetAccessPassbackModeTagged struct {
...
// IBACnetAccessPassbackModeTagged is the corresponding interface of BACnetAccessPassbackModeTagged
type IBACnetAccessPassbackModeTagged interface {
...
func (m *BACnetAccessPassbackModeTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetAccessPassbackModeTagged) GetValue() BACnetAccessPassbackMode {
	return m.Value
}
...
// NewBACnetAccessPassbackModeTagged factory function for BACnetAccessPassbackModeTagged
func NewBACnetAccessPassbackModeTagged(header *BACnetTagHeader, value BACnetAccessPassbackMode, tagNumber uint8, tagClass TagClass) *BACnetAccessPassbackModeTagged {
	return &BACnetAccessPassbackModeTagged{Header: header, Value: value, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetAccessPassbackModeTagged) GetTypeName() string {
	return "BACnetAccessPassbackModeTagged"
}

func (m *BACnetAccessPassbackModeTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetAccessPassbackModeTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetAccessPassbackModeTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetAccessPassbackModeTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetAccessPassbackModeTagged) String() string {
	if m == nil {
		return "<nil>"
	}
