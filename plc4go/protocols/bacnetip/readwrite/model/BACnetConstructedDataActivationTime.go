...
func NewBACnetConstructedDataActivationTime(openingTag BACnetOpeningTag, peekedTagHeader BACnetTagHeader, closingTag BACnetClosingTag, activationTime BACnetDateTime) *_BACnetConstructedDataActivationTime {
...
func (m *_BACnetConstructedDataActivationTime) GetPlx4xTypeName() string {
	return "BACnetConstructedDataActivationTime"
}

func (m *_BACnetConstructedDataActivationTime) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataActivationTime) GetLengthInBytes(ctx context.Context) uint64 {
