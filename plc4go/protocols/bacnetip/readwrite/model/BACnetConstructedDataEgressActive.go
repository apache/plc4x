...
func (m *_BACnetConstructedDataEgressActive) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataEgressActive) GetLengthInBytes(ctx context.Context) uint64 {
