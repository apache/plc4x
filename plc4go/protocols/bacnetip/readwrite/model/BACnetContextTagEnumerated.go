...
func (m *_BACnetContextTagEnumerated) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetContextTag, header BACnetTagHeader, tagNumberArgument uint8, dataType BACnetDataType) (_bACnetContextTagEnumerated BACnetContextTagEnumerated, err error) {
