...
func (m *_BACnetConstructedDataAccessEventTime) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataAccessEventTime) GetLengthInBytes(ctx context.Context) uint64 {
