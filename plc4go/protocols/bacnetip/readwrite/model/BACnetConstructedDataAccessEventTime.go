...
func (m *_BACnetConstructedDataAccessEventTimeBuilder) WithAccessEventTimeBuilder(builderSupplier func(BACnetTimeStampBuilder) BACnetTimeStampBuilder) BACnetConstructedDataAccessEventTimeBuilder {
	builder := builderSupplier(m.AccessEventTime.CreateBACnetTimeStampBuilder())
	var err error
