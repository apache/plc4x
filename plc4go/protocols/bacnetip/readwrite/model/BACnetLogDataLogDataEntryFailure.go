...
func (m *_BACnetLogDataLogDataEntryFailure) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetLogDataLogDataEntryFailure) GetLengthInBytes(ctx context.Context) uint64 {
