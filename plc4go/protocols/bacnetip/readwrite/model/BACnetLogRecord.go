...
func (m *_BACnetLogRecordBuilder) WithLogDatumBuilder(builderSupplier func(BACnetLogRecordLogDatumBuilder) BACnetLogRecordLogDatumBuilder) BACnetLogRecordBuilder {
	builder := builderSupplier(m.LogDatum.CreateBACnetLogRecordLogDatumBuilder())
	var err error
	...
	if err != nil {
		...
		m.err.Append(errors.Wrap(err, "BACnetLogRecordLogDatumBuilder failed"))
	}
	return m
}
