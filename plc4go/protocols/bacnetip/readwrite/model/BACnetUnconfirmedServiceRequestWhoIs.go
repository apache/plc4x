...
func (m *_BACnetUnconfirmedServiceRequestWhoIs) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetUnconfirmedServiceRequest, serviceRequestLength uint16) (_bACnetUnconfirmedServiceRequestWhoIs BACnetUnconfirmedServiceRequestWhoIs, err error) {
