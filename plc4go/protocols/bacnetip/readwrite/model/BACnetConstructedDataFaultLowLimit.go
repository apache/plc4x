...
func (m *_BACnetConstructedDataFaultLowLimit) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataFaultLowLimit) GetLengthInBytes(ctx context.Context) uint64 {
