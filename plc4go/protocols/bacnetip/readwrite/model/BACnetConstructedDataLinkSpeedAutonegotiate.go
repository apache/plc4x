...
func (m *_BACnetConstructedDataLinkSpeedAutonegotiateBuilder) WithMandatoryFields(linkSpeedAutonegotiate BACnetApplicationTagBoolean) BACnetConstructedDataLinkSpeedAutonegotiateBuilder {
	return m.WithLinkSpeedAutonegotiate(linkSpeedAutonegotiate)
}

func (m *_BACnetConstructedDataLinkSpeedAutonegotiateBuilder) WithLinkSpeedAutonegotiate(linkSpeedAutonegotiate BACnetApplicationTagBoolean) BACnetConstructedDataLinkSpeedAutonegotiateBuilder {
	m.LinkSpeedAutonegotiate = linkSpeedAutonegotiate
	return m
}

func (m *_BACnetConstructedDataLinkSpeedAutonegotiateBuilder) WithLinkSpeedAutonegotiateBuilder(builderSupplier func(BACnetApplicationTagBooleanBuilder) BACnetApplicationTagBooleanBuilder) BACnetConstructedDataLinkSpeedAutonegotiateBuilder {
	builder := builderSupplier(m.LinkSpeedAutonegotiate.CreateBACnetApplicationTagBooleanBuilder())
	var err error
	m.LinkSpeedAutonegotiate, err = builder.Build()
	if err != nil {
		if m.err == nil {
...
func (m *_BACnetConstructedDataLinkSpeedAutonegotiateBuilder) Build() (BACnetConstructedDataLinkSpeedAutonegotiate, error) {
	if m.LinkSpeedAutonegotiate == nil {
		if m.err == nil {
			m.err = new(utils.MultiError)
		}
		m.err.Append(errors.New("mandatory field 'linkSpeedAutonegotiate' not set"))
	}
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._BACnetConstructedDataLinkSpeedAutonegotiate.deepCopy(), nil
}

func (m *_BACnetConstructedDataLinkSpeedAutonegotiateBuilder) MustBuild() BACnetConstructedDataLinkSpeedAutonegotiate {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetConstructedDataLinkSpeedAutonegotiateBuilder) DeepCopy() any {
	return m.CreateBACnetConstructedDataLinkSpeedAutonegotiateBuilder()
}

// CreateBACnetConstructedDataLinkSpeedAutonegotiateBuilder creates a BACnetConstructedDataLinkSpeedAutonegotiateBuilder
func (m *_BACnetConstructedDataLinkSpeedAutonegotiate) CreateBACnetConstructedDataLinkSpeedAutonegotiateBuilder() BACnetConstructedDataLinkSpeedAutonegotiateBuilder {
	if m == nil {
		return NewBACnetConstructedDataLinkSpeedAutonegotiateBuilder()
	}
	return &_BACnetConstructedDataLinkSpeedAutonegotiateBuilder{_BACnetConstructedDataLinkSpeedAutonegotiate: m.deepCopy()}
}
