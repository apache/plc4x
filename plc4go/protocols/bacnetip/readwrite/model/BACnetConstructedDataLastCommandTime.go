...
func (m *_BACnetConstructedDataLastCommandTimeBuilder) WithLastCommandTimeBuilder(builderSupplier func(BACnetTimeStampBuilder) BACnetTimeStampBuilder) BACnetConstructedDataLastCommandTimeBuilder {
	builder := builderSupplier(m.LastCommandTime.CreateBACnetTimeStampBuilder())
	var err error
	m.LastCommandTime, err = builder.Build()
	if err != nil {
		if m.err == nil {
