...
func (m *_BACnetConstructedDataFloorText) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataFloorText) GetLengthInBytes(ctx context.Context) uint64 {
