...
func (m *_BACnetConstructedDataRecordCount) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataRecordCount) GetLengthInBytes(ctx context.Context) uint64 {
