...
func (m *_BACnetPropertyStatesAccessCredentialDisableReason) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetPropertyStates, peekedTagNumber uint8) (_bACnetPropertyStatesAccessCredentialDisableReason BACnetPropertyStatesAccessCredentialDisableReason, err error) {
