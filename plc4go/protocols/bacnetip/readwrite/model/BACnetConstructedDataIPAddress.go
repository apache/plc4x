...
func (m *_BACnetConstructedDataIPAddress) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataIPAddress) GetLengthInBytes(ctx context.Context) uint64 {
