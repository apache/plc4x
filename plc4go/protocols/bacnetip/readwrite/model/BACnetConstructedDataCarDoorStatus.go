...
func (m *BACnetConstructedDataCarDoorStatus) GetNumberOfDataElements() *BACnetApplicationTagUnsignedInteger {
...
func (m *BACnetConstructedDataCarDoorStatus) GetZero() uint64 {
...
func NewBACnetConstructedDataCarDoorStatus(numberOfDataElements *BACnetApplicationTagUnsignedInteger, carDoorStatus []*BACnetDoorStatusTagged, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag, tagNumber uint8, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) *BACnetConstructedDataCarDoorStatus {
