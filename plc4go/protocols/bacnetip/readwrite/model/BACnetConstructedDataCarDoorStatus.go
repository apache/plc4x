...
func (m *_BACnetConstructedDataCarDoorStatus) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataCarDoorStatus) GetLengthInBytes(ctx context.Context) uint64 {
