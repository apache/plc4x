...
func (m *_NLMInitializeRoutingTableAck) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_NLM, apduLength uint16) (_nLMInitializeRoutingTableAck NLMInitializeRoutingTableAck, err error) {
