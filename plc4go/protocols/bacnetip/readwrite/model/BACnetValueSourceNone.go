...
func (m *_BACnetValueSourceNone) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetValueSource) (_bACnetValueSourceNone BACnetValueSourceNone, err error) {
