...
func (m *_BACnetEscalatorModeTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetEscalatorModeTagged) GetLengthInBytes(ctx context.Context) uint64 {
