...
func (m *_BACnetEscalatorModeTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *_BACnetEscalatorModeTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *_BACnetEscalatorModeTagged) GetLengthInBytes() uint16 {
	return m.GetLengthInBits() / 8
}

func BACnetEscalatorModeTaggedParse(theBytes []byte, tagNumber uint8, tagClass TagClass) (BACnetEscalatorModeTagged, error) {
	return BACnetEscalatorModeTaggedParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian)), tagNumber, tagClass) // TODO: get endianness from mspec
}
