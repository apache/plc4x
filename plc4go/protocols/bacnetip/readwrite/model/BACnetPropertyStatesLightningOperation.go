...
func (m *_BACnetPropertyStatesLightningOperationBuilder) WithMandatoryFields(lightningOperation BACnetLightingOperationTagged) BACnetPropertyStatesLightningOperationBuilder {
	return m.WithLightningOperation(lightningOperation)
}

func (m *_BACnetPropertyStatesLightningOperationBuilder) WithLightningOperation(lightningOperation BACnetLightingOperationTagged) BACnetPropertyStatesLightningOperationBuilder {
	m.LightningOperation = lightningOperation
	return m
}

func (m *_BACnetPropertyStatesLightningOperationBuilder) WithLightningOperationBuilder(builderSupplier func(BACnetLightingOperationTaggedBuilder) BACnetLightingOperationTaggedBuilder) BACnetPropertyStatesLightningOperationBuilder {
...
func (m *_BACnetPropertyStatesLightningOperationBuilder) Build() (BACnetPropertyStatesLightningOperation, error) {
	...
	return m._BACnetPropertyStatesLightningOperation.deepCopy(), nil
}

func (m *_BACnetPropertyStatesLightningOperationBuilder) MustBuild() BACnetPropertyStatesLightningOperation {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetPropertyStatesLightningOperationBuilder) DeepCopy() any {
	return m.CreateBACnetPropertyStatesLightningOperationBuilder()
}

// CreateBACnetPropertyStatesLightningOperationBuilder creates a BACnetPropertyStatesLightningOperationBuilder
func (m *_BACnetPropertyStatesLightningOperation) CreateBACnetPropertyStatesLightningOperationBuilder() BACnetPropertyStatesLightningOperationBuilder {
	if m == nil {
		return NewBACnetPropertyStatesLightningOperationBuilder()
	}
	return &_BACnetPropertyStatesLightningOperationBuilder{_BACnetPropertyStatesLightningOperation: m.deepCopy()}
}
