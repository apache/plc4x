...
func (m *_BACnetLogDataLogData) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetLogData, tagNumber uint8) (_bACnetLogDataLogData BACnetLogDataLogData, err error) {
