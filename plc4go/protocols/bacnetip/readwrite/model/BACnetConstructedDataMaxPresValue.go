...
func (m *_BACnetConstructedDataMaxPresValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataMaxPresValue) GetLengthInBytes(ctx context.Context) uint64 {
