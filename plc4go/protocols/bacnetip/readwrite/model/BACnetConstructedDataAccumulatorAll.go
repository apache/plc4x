...
func (m *_BACnetConstructedDataAccumulatorAll) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.BACnetConstructedDataContract.(*_BACnetConstructedData).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_BACnetConstructedDataAccumulatorAll) GetLengthInBytes(ctx context.Context) uint64 {
