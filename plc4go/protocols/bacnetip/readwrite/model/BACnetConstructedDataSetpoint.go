...
func (m *_BACnetConstructedDataSetpoint) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataSetpoint) GetLengthInBytes(ctx context.Context) uint64 {
