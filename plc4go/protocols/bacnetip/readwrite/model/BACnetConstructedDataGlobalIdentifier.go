...
func (m *_BACnetConstructedDataGlobalIdentifier) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataGlobalIdentifier) GetLengthInBytes(ctx context.Context) uint64 {
