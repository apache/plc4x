...
func (m *_BACnetConstructedDataFileType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataFileType) GetLengthInBytes(ctx context.Context) uint64 {
