...
func (m *_BACnetCalendarEntryDateRange) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetCalendarEntry) (_bACnetCalendarEntryDateRange BACnetCalendarEntryDateRange, err error) {
