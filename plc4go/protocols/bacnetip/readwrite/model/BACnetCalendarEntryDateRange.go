...
func (m *_BACnetCalendarEntryDateRange) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetCalendarEntryDateRange) GetLengthInBytes(ctx context.Context) uint64 {
