...
func (m *_BACnetNetworkPortCommandTagged) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (_bACnetNetworkPortCommandTagged BACnetNetworkPortCommandTagged, err error) {
