...
// BACnetNetworkPortCommandTagged is the data-structure of this message
type BACnetNetworkPortCommandTagged struct {
...
// IBACnetNetworkPortCommandTagged is the corresponding interface of BACnetNetworkPortCommandTagged
type IBACnetNetworkPortCommandTagged interface {
...
func (m *BACnetNetworkPortCommandTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetNetworkPortCommandTagged) GetValue() BACnetNetworkPortCommand {
	return m.Value
}

func (m *BACnetNetworkPortCommandTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetNetworkPortCommandTagged) GetIsProprietary() bool {
...
// NewBACnetNetworkPortCommandTagged factory function for BACnetNetworkPortCommandTagged
func NewBACnetNetworkPortCommandTagged(header *BACnetTagHeader, value BACnetNetworkPortCommand, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetNetworkPortCommandTagged {
	return &BACnetNetworkPortCommandTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetNetworkPortCommandTagged) GetTypeName() string {
	return "BACnetNetworkPortCommandTagged"
}

func (m *BACnetNetworkPortCommandTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetNetworkPortCommandTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetNetworkPortCommandTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetNetworkPortCommandTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetNetworkPortCommandTagged) String() string {
	if m == nil {
		return "<nil>"
	}
