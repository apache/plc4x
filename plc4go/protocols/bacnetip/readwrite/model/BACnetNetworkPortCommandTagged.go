...
func (m *_BACnetNetworkPortCommandTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetNetworkPortCommandTagged) GetLengthInBytes(ctx context.Context) uint64 {
