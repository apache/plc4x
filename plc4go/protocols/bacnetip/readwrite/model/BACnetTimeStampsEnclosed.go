...
func BACnetTimeStampsEnclosedParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (BACnetTimeStampsEnclosed, error) {
	v, err := (&_BACnetTimeStampsEnclosed{}).parse(ctx, readBuffer, tagNumber)
	if err != nil {
		return nil, err
	}
	return v, err
...
func (m *_BACnetTimeStampsEnclosed) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (_bACnetTimeStampsEnclosed BACnetTimeStampsEnclosed, err error) {
