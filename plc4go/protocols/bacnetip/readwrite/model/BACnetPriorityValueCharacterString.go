...
func (m *_BACnetPriorityValueCharacterString) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPriorityValueCharacterString) GetLengthInBytes(ctx context.Context) uint64 {
