...
func (m *_BACnetConstructedDataInstanceOf) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataInstanceOf) GetLengthInBytes(ctx context.Context) uint64 {
