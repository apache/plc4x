...
func (m *_BACnetConstructedDataStateDescription) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataStateDescription) GetLengthInBytes(ctx context.Context) uint64 {
