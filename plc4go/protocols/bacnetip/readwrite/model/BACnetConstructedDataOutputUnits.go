...
func (m *_BACnetConstructedDataOutputUnits) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataOutputUnits) GetLengthInBytes(ctx context.Context) uint64 {
