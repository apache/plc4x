...
func (m *_BACnetConstructedDataStrikeCount) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataStrikeCount) GetLengthInBytes(ctx context.Context) uint64 {
