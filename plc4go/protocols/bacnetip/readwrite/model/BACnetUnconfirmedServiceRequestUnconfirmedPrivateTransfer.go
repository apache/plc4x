...
func BACnetUnconfirmedServiceRequestUnconfirmedPrivateTransferParse(theBytes []byte, serviceRequestLength uint16) (BACnetUnconfirmedServiceRequestUnconfirmedPrivateTransfer, error) {
	return BACnetUnconfirmedServiceRequestUnconfirmedPrivateTransferParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian)), serviceRequestLength) // TODO: get endianness from mspec
}
