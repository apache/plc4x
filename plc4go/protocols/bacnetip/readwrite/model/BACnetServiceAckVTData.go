...
func (m *_BACnetServiceAckVTData) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetServiceAck, serviceAckLength uint32) (_bACnetServiceAckVTData BACnetServiceAckVTData, err error) {
