...
func (m *_BACnetContextTagUnknown) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetContextTag, actualLength uint32, tagNumberArgument uint8, dataType BACnetDataType) (_bACnetContextTagUnknown BACnetContextTagUnknown, err error) {
