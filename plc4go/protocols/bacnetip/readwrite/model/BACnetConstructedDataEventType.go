...
func (m *_BACnetConstructedDataEventType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataEventType) GetLengthInBytes(ctx context.Context) uint64 {
