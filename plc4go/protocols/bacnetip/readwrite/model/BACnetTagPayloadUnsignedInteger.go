...
func (m *_BACnetTagPayloadUnsignedInteger) GetActualValue() uint64 {
	...
	valueUint64 := m.ValueUint64
	_ = valueUint64
	return uint64(utils.InlineIf(m.GetIsUint8(), func() interface{} {return uint64((*m.GetValueUint8()))}, func() interface{} {return uint64((utils.InlineIf(m.GetIsUint16(), func() interface{} {return uint64((*m.GetValueUint16()))}, func() interface{} {return uint64((utils.InlineIf(m.GetIsUint24(), func() interface{} {return uint64((*m.GetValueUint24()))}, func() interface{} {return uint64((utils.InlineIf(m.GetIsUint32(), func() interface{} {return uint64((*m.GetValueUint32()))}, func() interface{} {return uint64((utils.InlineIf(m.GetIsUint40(), func() interface{} {return uint64((*m.GetValueUint40()))}, func() interface{} {return uint64((utils.InlineIf(m.GetIsUint48(), func() interface{} {return uint64((*m.GetValueUint48()))}, func() interface{} {return uint64((utils.InlineIf(m.GetIsUint56(), func() interface{} {return uint64((*m.GetValueUint56()))}, func() interface{} {return uint64((*m.GetValueUint64()))}).(uint64)))}).(uint64)))}).(uint64)))}).(uint64)))}).(uint64)))}).(uint64)))}).(uint64))
}
