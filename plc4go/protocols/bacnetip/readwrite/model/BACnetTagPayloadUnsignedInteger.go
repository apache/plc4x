...
func (m *_BACnetTagPayloadUnsignedInteger) parse(ctx context.Context, readBuffer utils.ReadBuffer, actualLength uint32) (_bACnetTagPayloadUnsignedInteger BACnetTagPayloadUnsignedInteger, err error) {
