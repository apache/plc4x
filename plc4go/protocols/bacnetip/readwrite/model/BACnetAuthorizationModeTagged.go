...
// BACnetAuthorizationModeTagged is the data-structure of this message
type BACnetAuthorizationModeTagged struct {
...
// IBACnetAuthorizationModeTagged is the corresponding interface of BACnetAuthorizationModeTagged
type IBACnetAuthorizationModeTagged interface {
...
func (m *BACnetAuthorizationModeTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetAuthorizationModeTagged) GetValue() BACnetAuthorizationMode {
	return m.Value
}

func (m *BACnetAuthorizationModeTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetAuthorizationModeTagged) GetIsProprietary() bool {
...
// NewBACnetAuthorizationModeTagged factory function for BACnetAuthorizationModeTagged
func NewBACnetAuthorizationModeTagged(header *BACnetTagHeader, value BACnetAuthorizationMode, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetAuthorizationModeTagged {
	return &BACnetAuthorizationModeTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetAuthorizationModeTagged) GetTypeName() string {
	return "BACnetAuthorizationModeTagged"
}

func (m *BACnetAuthorizationModeTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetAuthorizationModeTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetAuthorizationModeTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetAuthorizationModeTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetAuthorizationModeTagged) String() string {
	if m == nil {
		return "<nil>"
	}
