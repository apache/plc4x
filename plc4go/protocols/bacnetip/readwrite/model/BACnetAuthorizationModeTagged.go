...
func (m *_BACnetAuthorizationModeTagged) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (_bACnetAuthorizationModeTagged BACnetAuthorizationModeTagged, err error) {
