...
func (m *_BACnetConstructedDataTimerRunning) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataTimerRunning) GetLengthInBytes(ctx context.Context) uint64 {
