...
func (m *BACnetConstructedDataExecutionDelay) GetNumberOfDataElements() *BACnetApplicationTagUnsignedInteger {
...
func (m *BACnetConstructedDataExecutionDelay) GetZero() uint64 {
...
func NewBACnetConstructedDataExecutionDelay(numberOfDataElements *BACnetApplicationTagUnsignedInteger, executionDelay []*BACnetApplicationTagUnsignedInteger, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag, tagNumber uint8, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) *BACnetConstructedDataExecutionDelay {
