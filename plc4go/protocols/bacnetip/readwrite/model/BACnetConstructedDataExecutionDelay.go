...
func (m *_BACnetConstructedDataExecutionDelay) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataExecutionDelay) GetLengthInBytes(ctx context.Context) uint64 {
