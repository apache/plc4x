...
func (m *_BACnetObjectTypesSupportedTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetObjectTypesSupportedTagged) GetLengthInBytes(ctx context.Context) uint64 {
