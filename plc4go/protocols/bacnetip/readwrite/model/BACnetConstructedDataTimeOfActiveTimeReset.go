...
func (m *BACnetConstructedDataTimeOfActiveTimeReset) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag) {
...
func NewBACnetConstructedDataTimeOfActiveTimeReset(timeOfActiveTimeReset *BACnetDateTime, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag, tagNumber uint8) *BACnetConstructedDataTimeOfActiveTimeReset {
