...
type IBACnetCalendarEntry interface {
...
type IBACnetCalendarEntryParent interface {
	SerializeParent(writeBuffer utils.WriteBuffer, child IBACnetCalendarEntry, serializeChildFunction func() error) error
	GetTypeName() string
}

type IBACnetCalendarEntryChild interface {
	Serialize(writeBuffer utils.WriteBuffer) error
...
func (m *BACnetCalendarEntry) GetPeekedTagHeader() *BACnetTagHeader {
...
func (m *BACnetCalendarEntry) GetPeekedTagNumber() uint8 {
...
func CastBACnetCalendarEntry(structType interface{}) *BACnetCalendarEntry {
	...
	if casted, ok := structType.(IBACnetCalendarEntryChild); ok {
		return casted.GetParent()
	}
	return nil
}

func (m *BACnetCalendarEntry) GetTypeName() string {
	return "BACnetCalendarEntry"
}

func (m *BACnetCalendarEntry) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetCalendarEntry) GetLengthInBitsConditional(lastItem bool) uint16 {
	return m.Child.GetLengthInBits()
}

func (m *BACnetCalendarEntry) GetParentLengthInBits() uint16 {
...
func (m *BACnetCalendarEntry) GetLengthInBytes() uint16 {
...
func BACnetCalendarEntryParse(readBuffer utils.ReadBuffer, tagNumber uint8) (*BACnetCalendarEntry, error) {
	...
	var _child BACnetCalendarEntryChild
...
func (m *BACnetCalendarEntry) Serialize(writeBuffer utils.WriteBuffer) error {
	return m.Child.Serialize(writeBuffer)
}

func (m *BACnetCalendarEntry) SerializeParent(writeBuffer utils.WriteBuffer, child IBACnetCalendarEntry, serializeChildFunction func() error) error {
...
func (m *BACnetCalendarEntry) String() string {
	if m == nil {
		return "<nil>"
	}
