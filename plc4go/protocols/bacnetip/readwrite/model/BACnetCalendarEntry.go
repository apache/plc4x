...
func (m *_BACnetCalendarEntry) GetPlx4xTypeName() string {
	return "BACnetCalendarEntry"
}

func (m *_BACnetCalendarEntry) getLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetCalendarEntry) GetLengthInBytes(ctx context.Context) uint64 {
...
func BACnetCalendarEntryParseWithBuffer[T BACnetCalendarEntry](ctx context.Context, readBuffer utils.ReadBuffer) (T, error) {
	v, err := (new(_BACnetCalendarEntry)).parse(ctx, readBuffer)
	if err != nil {
		var zero T
		return zero, err
	}
