...
func (m *_BACnetConstructedDataFullDutyBaseline) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataFullDutyBaseline) GetLengthInBytes(ctx context.Context) uint64 {
