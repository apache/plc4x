...
func (m *_BACnetConstructedDataRequestedShedLevel) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataRequestedShedLevel) GetLengthInBytes(ctx context.Context) uint64 {
