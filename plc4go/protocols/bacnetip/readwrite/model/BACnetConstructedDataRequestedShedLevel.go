...
func (m *_BACnetConstructedDataRequestedShedLevelBuilder) WithRequestedShedLevelBuilder(builderSupplier func(BACnetShedLevelBuilder) BACnetShedLevelBuilder) BACnetConstructedDataRequestedShedLevelBuilder {
	builder := builderSupplier(m.RequestedShedLevel.CreateBACnetShedLevelBuilder())
	var err error
	m.RequestedShedLevel, err = builder.Build()
	if err != nil {
		if m.err == nil {
