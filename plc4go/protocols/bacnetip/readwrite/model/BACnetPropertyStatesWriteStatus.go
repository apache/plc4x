...
func (m *_BACnetPropertyStatesWriteStatus) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesWriteStatus) GetLengthInBytes(ctx context.Context) uint64 {
