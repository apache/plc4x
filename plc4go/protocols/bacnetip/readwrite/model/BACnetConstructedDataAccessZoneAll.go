...
func (m *_BACnetConstructedDataAccessZoneAll) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.BACnetConstructedDataContract.(*_BACnetConstructedData).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_BACnetConstructedDataAccessZoneAll) GetLengthInBytes(ctx context.Context) uint64 {
