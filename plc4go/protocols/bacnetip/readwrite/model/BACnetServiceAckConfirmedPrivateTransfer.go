...
func (m *_BACnetServiceAckConfirmedPrivateTransferBuilder) WithMandatoryFields(vendorId BACnetVendorIdTagged, serviceNumber BACnetContextTagUnsignedInteger) BACnetServiceAckConfirmedPrivateTransferBuilder {
	return m.WithVendorId(vendorId).WithServiceNumber(serviceNumber)
}

func (m *_BACnetServiceAckConfirmedPrivateTransferBuilder) WithVendorId(vendorId BACnetVendorIdTagged) BACnetServiceAckConfirmedPrivateTransferBuilder {
	m.VendorId = vendorId
	return m
}

func (m *_BACnetServiceAckConfirmedPrivateTransferBuilder) WithVendorIdBuilder(builderSupplier func(BACnetVendorIdTaggedBuilder) BACnetVendorIdTaggedBuilder) BACnetServiceAckConfirmedPrivateTransferBuilder {
...
func (m *_BACnetServiceAckConfirmedPrivateTransferBuilder) WithServiceNumber(serviceNumber BACnetContextTagUnsignedInteger) BACnetServiceAckConfirmedPrivateTransferBuilder {
	m.ServiceNumber = serviceNumber
	return m
}

func (m *_BACnetServiceAckConfirmedPrivateTransferBuilder) WithServiceNumberBuilder(builderSupplier func(BACnetContextTagUnsignedIntegerBuilder) BACnetContextTagUnsignedIntegerBuilder) BACnetServiceAckConfirmedPrivateTransferBuilder {
...
func (m *_BACnetServiceAckConfirmedPrivateTransferBuilder) WithOptionalResultBlock(resultBlock BACnetConstructedData) BACnetServiceAckConfirmedPrivateTransferBuilder {
	m.ResultBlock = resultBlock
	return m
}

func (m *_BACnetServiceAckConfirmedPrivateTransferBuilder) WithOptionalResultBlockBuilder(builderSupplier func(BACnetConstructedDataBuilder) BACnetConstructedDataBuilder) BACnetServiceAckConfirmedPrivateTransferBuilder {
	builder := builderSupplier(m.ResultBlock.CreateBACnetConstructedDataBuilder())
	var err error
	m.ResultBlock, err = builder.Build()
	if err != nil {
		if m.err == nil {
			m.err = &utils.MultiError{MainError: errors.New("sub builder failed")}
		}
...
func (m *_BACnetServiceAckConfirmedPrivateTransferBuilder) Build() (BACnetServiceAckConfirmedPrivateTransfer, error) {
	if m.VendorId == nil {
		if m.err == nil {
	...
	return m._BACnetServiceAckConfirmedPrivateTransfer.deepCopy(), nil
}

func (m *_BACnetServiceAckConfirmedPrivateTransferBuilder) MustBuild() BACnetServiceAckConfirmedPrivateTransfer {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetServiceAckConfirmedPrivateTransferBuilder) DeepCopy() any {
	return m.CreateBACnetServiceAckConfirmedPrivateTransferBuilder()
}

// CreateBACnetServiceAckConfirmedPrivateTransferBuilder creates a BACnetServiceAckConfirmedPrivateTransferBuilder
func (m *_BACnetServiceAckConfirmedPrivateTransfer) CreateBACnetServiceAckConfirmedPrivateTransferBuilder() BACnetServiceAckConfirmedPrivateTransferBuilder {
	if m == nil {
		return NewBACnetServiceAckConfirmedPrivateTransferBuilder()
	}
	return &_BACnetServiceAckConfirmedPrivateTransferBuilder{_BACnetServiceAckConfirmedPrivateTransfer: m.deepCopy()}
}
