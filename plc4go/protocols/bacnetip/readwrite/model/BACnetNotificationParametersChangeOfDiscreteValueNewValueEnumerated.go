...
func (m *_BACnetNotificationParametersChangeOfDiscreteValueNewValueEnumerated) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetNotificationParametersChangeOfDiscreteValueNewValue, tagNumber uint8) (_bACnetNotificationParametersChangeOfDiscreteValueNewValueEnumerated BACnetNotificationParametersChangeOfDiscreteValueNewValueEnumerated, err error) {
