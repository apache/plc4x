...
func (m *_BACnetConstructedDataDescription) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataDescription) GetLengthInBytes(ctx context.Context) uint64 {
