...
func (m *_BACnetEventParameterChangeOfCharacterStringListOfAlarmValues) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (_bACnetEventParameterChangeOfCharacterStringListOfAlarmValues BACnetEventParameterChangeOfCharacterStringListOfAlarmValues, err error) {
