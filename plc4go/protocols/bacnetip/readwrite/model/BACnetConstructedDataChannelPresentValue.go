...
func (m *_BACnetConstructedDataChannelPresentValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataChannelPresentValue) GetLengthInBytes(ctx context.Context) uint64 {
