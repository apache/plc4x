...
func (m *_BACnetTimerStateChangeValueBoolean) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetTimerStateChangeValueBoolean) GetLengthInBytes(ctx context.Context) uint64 {
