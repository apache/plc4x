...
func BACnetTimerStateChangeValueBooleanParseWithBufferProducer(objectTypeArgument BACnetObjectType) func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetTimerStateChangeValueBoolean, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetTimerStateChangeValueBoolean, error) {
		return BACnetTimerStateChangeValueBooleanParseWithBuffer(ctx, readBuffer, objectTypeArgument)
	}
}
