...
func (m *_BACnetConstructedDataDerivativeConstant) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataDerivativeConstant) GetLengthInBytes(ctx context.Context) uint64 {
