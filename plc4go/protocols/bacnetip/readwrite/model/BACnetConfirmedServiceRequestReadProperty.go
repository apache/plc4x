...
func (m *_BACnetConfirmedServiceRequestReadProperty) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetConfirmedServiceRequest, serviceRequestLength uint32) (_bACnetConfirmedServiceRequestReadProperty BACnetConfirmedServiceRequestReadProperty, err error) {
