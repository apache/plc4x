...
func (m *_BACnetServiceAckCreateObject) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetServiceAckCreateObject) GetLengthInBytes(ctx context.Context) uint64 {
