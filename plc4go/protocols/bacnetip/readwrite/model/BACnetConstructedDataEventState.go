...
func (m *_BACnetConstructedDataEventState) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataEventState) GetLengthInBytes(ctx context.Context) uint64 {
