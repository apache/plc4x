...
func (m *_BVLCOriginalUnicastNPDU) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BVLC, bvlcPayloadLength uint16) (_bVLCOriginalUnicastNPDU BVLCOriginalUnicastNPDU, err error) {
