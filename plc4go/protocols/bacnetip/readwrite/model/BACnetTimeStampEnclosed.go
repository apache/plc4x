...
func (m *_BACnetTimeStampEnclosed) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (_bACnetTimeStampEnclosed BACnetTimeStampEnclosed, err error) {
