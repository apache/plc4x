...
// BACnetConstructedDataAnalogOutputRelinquishDefault is the data-structure of this message
type BACnetConstructedDataAnalogOutputRelinquishDefault struct {
...
type IBACnetConstructedDataAnalogOutputRelinquishDefault interface {
...
func (m *BACnetConstructedDataAnalogOutputRelinquishDefault) GetObjectTypeArgument() BACnetObjectType {
	return BACnetObjectType_ANALOG_OUTPUT
}

func (m *BACnetConstructedDataAnalogOutputRelinquishDefault) GetPropertyIdentifierArgument() BACnetPropertyIdentifier {
...
func (m *BACnetConstructedDataAnalogOutputRelinquishDefault) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag) {
	m.BACnetConstructedData.OpeningTag = openingTag
	m.BACnetConstructedData.PeekedTagHeader = peekedTagHeader
	m.BACnetConstructedData.ClosingTag = closingTag
}

func (m *BACnetConstructedDataAnalogOutputRelinquishDefault) GetParent() *BACnetConstructedData {
...
func (m *BACnetConstructedDataAnalogOutputRelinquishDefault) GetRelinquishDefault() *BACnetApplicationTagReal {
...
func (m *BACnetConstructedDataAnalogOutputRelinquishDefault) GetActualValue() *BACnetApplicationTagReal {
...
func CastBACnetConstructedDataAnalogOutputRelinquishDefault(structType interface{}) *BACnetConstructedDataAnalogOutputRelinquishDefault {
	...
	if casted, ok := structType.(BACnetConstructedData); ok {
		return CastBACnetConstructedDataAnalogOutputRelinquishDefault(casted.Child)
	}
	if casted, ok := structType.(*BACnetConstructedData); ok {
		return CastBACnetConstructedDataAnalogOutputRelinquishDefault(casted.Child)
	}
...
func (m *BACnetConstructedDataAnalogOutputRelinquishDefault) GetTypeName() string {
	return "BACnetConstructedDataAnalogOutputRelinquishDefault"
}

func (m *BACnetConstructedDataAnalogOutputRelinquishDefault) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetConstructedDataAnalogOutputRelinquishDefault) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetConstructedDataAnalogOutputRelinquishDefault) GetLengthInBytes() uint16 {
...
func BACnetConstructedDataAnalogOutputRelinquishDefaultParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) (*BACnetConstructedDataAnalogOutputRelinquishDefault, error) {
	...
	_child := &BACnetConstructedDataAnalogOutputRelinquishDefault{
...
func (m *BACnetConstructedDataAnalogOutputRelinquishDefault) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetConstructedDataAnalogOutputRelinquishDefault) String() string {
	if m == nil {
		return "<nil>"
	}
