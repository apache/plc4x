...
func BACnetApplicationTagBitStringParseWithBufferProducer(header BACnetTagHeader) func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetApplicationTagBitString, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetApplicationTagBitString, error) {
		return BACnetApplicationTagBitStringParseWithBuffer(ctx, readBuffer, header)
	}
}
