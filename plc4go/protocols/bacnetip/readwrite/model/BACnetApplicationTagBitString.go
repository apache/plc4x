...
func (m *_BACnetApplicationTagBitString) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetApplicationTag, header BACnetTagHeader) (_bACnetApplicationTagBitString BACnetApplicationTagBitString, err error) {
