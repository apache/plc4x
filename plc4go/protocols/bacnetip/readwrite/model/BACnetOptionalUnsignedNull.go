...
func (m *_BACnetOptionalUnsignedNull) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetOptionalUnsignedNull) GetLengthInBytes(ctx context.Context) uint64 {
