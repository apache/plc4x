...
func BACnetOptionalUnsignedNullParseWithBufferProducer() func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetOptionalUnsignedNull, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetOptionalUnsignedNull, error) {
		return BACnetOptionalUnsignedNullParseWithBuffer(ctx, readBuffer)
	}
}
