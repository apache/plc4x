...
// ErrorClassTagged is the data-structure of this message
type ErrorClassTagged struct {
...
// IErrorClassTagged is the corresponding interface of ErrorClassTagged
type IErrorClassTagged interface {
...
func (m *ErrorClassTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *ErrorClassTagged) GetValue() ErrorClass {
	return m.Value
}

func (m *ErrorClassTagged) GetProprietaryValue() uint32 {
...
func (m *ErrorClassTagged) GetIsProprietary() bool {
...
// NewErrorClassTagged factory function for ErrorClassTagged
func NewErrorClassTagged(header *BACnetTagHeader, value ErrorClass, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *ErrorClassTagged {
	return &ErrorClassTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *ErrorClassTagged) GetTypeName() string {
	return "ErrorClassTagged"
}

func (m *ErrorClassTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *ErrorClassTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *ErrorClassTagged) GetLengthInBytes() uint16 {
...
func ErrorClassTaggedParse(readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (*ErrorClassTagged, error) {
	...
	// Create the instance
	return NewErrorClassTagged(header, value, proprietaryValue, tagNumber, tagClass), nil
}

func (m *ErrorClassTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *ErrorClassTagged) String() string {
	if m == nil {
		return "<nil>"
	}
