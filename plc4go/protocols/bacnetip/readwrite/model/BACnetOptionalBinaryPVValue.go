...
func (m *_BACnetOptionalBinaryPVValueBuilder) WithMandatoryFields(binaryPv BACnetBinaryPVTagged) BACnetOptionalBinaryPVValueBuilder {
	return m.WithBinaryPv(binaryPv)
}

func (m *_BACnetOptionalBinaryPVValueBuilder) WithBinaryPv(binaryPv BACnetBinaryPVTagged) BACnetOptionalBinaryPVValueBuilder {
	m.BinaryPv = binaryPv
	return m
}

func (m *_BACnetOptionalBinaryPVValueBuilder) WithBinaryPvBuilder(builderSupplier func(BACnetBinaryPVTaggedBuilder) BACnetBinaryPVTaggedBuilder) BACnetOptionalBinaryPVValueBuilder {
...
func (m *_BACnetOptionalBinaryPVValueBuilder) Build() (BACnetOptionalBinaryPVValue, error) {
	if m.BinaryPv == nil {
		if m.err == nil {
	...
	return m._BACnetOptionalBinaryPVValue.deepCopy(), nil
}

func (m *_BACnetOptionalBinaryPVValueBuilder) MustBuild() BACnetOptionalBinaryPVValue {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetOptionalBinaryPVValueBuilder) DeepCopy() any {
	return m.CreateBACnetOptionalBinaryPVValueBuilder()
}

// CreateBACnetOptionalBinaryPVValueBuilder creates a BACnetOptionalBinaryPVValueBuilder
func (m *_BACnetOptionalBinaryPVValue) CreateBACnetOptionalBinaryPVValueBuilder() BACnetOptionalBinaryPVValueBuilder {
	if m == nil {
		return NewBACnetOptionalBinaryPVValueBuilder()
	}
	return &_BACnetOptionalBinaryPVValueBuilder{_BACnetOptionalBinaryPVValue: m.deepCopy()}
}
