...
func (m *_BACnetOptionalBinaryPVValue) GetPlx4xTypeName() string {
	return "BACnetOptionalBinaryPVValue"
}

func (m *_BACnetOptionalBinaryPVValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetOptionalBinaryPVValue) GetLengthInBytes(ctx context.Context) uint64 {
