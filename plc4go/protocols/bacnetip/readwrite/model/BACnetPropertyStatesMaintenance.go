...
func (m *_BACnetPropertyStatesMaintenance) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesMaintenance) GetLengthInBytes(ctx context.Context) uint64 {
