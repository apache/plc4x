...
func (m *_BACnetTimerStateChangeValueCharacterString) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetTimerStateChangeValue, objectTypeArgument BACnetObjectType) (_bACnetTimerStateChangeValueCharacterString BACnetTimerStateChangeValueCharacterString, err error) {
