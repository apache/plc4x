...
func (m *_BACnetTimerStateChangeValueCharacterString) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetTimerStateChangeValueCharacterString) GetLengthInBytes(ctx context.Context) uint64 {
