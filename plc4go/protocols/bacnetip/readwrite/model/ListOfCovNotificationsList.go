...
// ListOfCovNotificationsList is the data-structure of this message
type ListOfCovNotificationsList struct {
...
// IListOfCovNotificationsList is the corresponding interface of ListOfCovNotificationsList
type IListOfCovNotificationsList interface {
...
func (m *ListOfCovNotificationsList) GetOpeningTag() *BACnetOpeningTag {
	return m.OpeningTag
}

func (m *ListOfCovNotificationsList) GetSpecifications() []*ListOfCovNotifications {
	return m.Specifications
}

func (m *ListOfCovNotificationsList) GetClosingTag() *BACnetClosingTag {
	return m.ClosingTag
}
...
// NewListOfCovNotificationsList factory function for ListOfCovNotificationsList
func NewListOfCovNotificationsList(openingTag *BACnetOpeningTag, specifications []*ListOfCovNotifications, closingTag *BACnetClosingTag, tagNumber uint8) *ListOfCovNotificationsList {
	return &ListOfCovNotificationsList{OpeningTag: openingTag, Specifications: specifications, ClosingTag: closingTag, TagNumber: tagNumber}
}
...
func (m *ListOfCovNotificationsList) GetTypeName() string {
	return "ListOfCovNotificationsList"
}

func (m *ListOfCovNotificationsList) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *ListOfCovNotificationsList) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *ListOfCovNotificationsList) GetLengthInBytes() uint16 {
...
func ListOfCovNotificationsListParse(readBuffer utils.ReadBuffer, tagNumber uint8) (*ListOfCovNotificationsList, error) {
	...
	specifications := make([]*ListOfCovNotifications, 0)
	{
		for !bool(IsBACnetConstructedDataClosingTag(readBuffer, false, tagNumber)) {
			...
			specifications = append(specifications, CastListOfCovNotifications(_item))
...
func (m *ListOfCovNotificationsList) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *ListOfCovNotificationsList) String() string {
	if m == nil {
		return "<nil>"
	}
