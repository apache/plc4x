...
func (m *_BACnetCalendarEntryDate) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetCalendarEntry) (_bACnetCalendarEntryDate BACnetCalendarEntryDate, err error) {
