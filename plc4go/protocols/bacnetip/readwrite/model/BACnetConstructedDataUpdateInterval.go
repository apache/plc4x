...
func (m *_BACnetConstructedDataUpdateInterval) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataUpdateInterval) GetLengthInBytes(ctx context.Context) uint64 {
