...
func (m *_BACnetLiftGroupModeTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetLiftGroupModeTagged) GetLengthInBytes(ctx context.Context) uint64 {
