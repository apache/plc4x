...
// BACnetConstructedDataTrendLogMultipleAll is the data-structure of this message
type BACnetConstructedDataTrendLogMultipleAll struct {
...
type IBACnetConstructedDataTrendLogMultipleAll interface {
...
func (m *BACnetConstructedDataTrendLogMultipleAll) GetPropertyIdentifierArgument() BACnetPropertyIdentifier {
...
func (m *BACnetConstructedDataTrendLogMultipleAll) GetParent() *BACnetConstructedData {
...
func CastBACnetConstructedDataTrendLogMultipleAll(structType interface{}) *BACnetConstructedDataTrendLogMultipleAll {
	...
	if casted, ok := structType.(BACnetConstructedData); ok {
		return CastBACnetConstructedDataTrendLogMultipleAll(casted.Child)
	}
	if casted, ok := structType.(*BACnetConstructedData); ok {
		return CastBACnetConstructedDataTrendLogMultipleAll(casted.Child)
	}
...
func (m *BACnetConstructedDataTrendLogMultipleAll) GetTypeName() string {
	return "BACnetConstructedDataTrendLogMultipleAll"
}

func (m *BACnetConstructedDataTrendLogMultipleAll) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetConstructedDataTrendLogMultipleAll) GetLengthInBitsConditional(lastItem bool) uint16 {
	lengthInBits := uint16(m.GetParentLengthInBits())

	return lengthInBits
}

func (m *BACnetConstructedDataTrendLogMultipleAll) GetLengthInBytes() uint16 {
...
func BACnetConstructedDataTrendLogMultipleAllParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier) (*BACnetConstructedDataTrendLogMultipleAll, error) {
	...
	// Validation
	if !(bool((1) == (2))) {
		return nil, utils.ParseValidationError{"TODO: implement me BACnetConstructedData ...TREND_LOG_MULTIPLE..."}
	}
	...
	_child := &BACnetConstructedDataTrendLogMultipleAll{
...
func (m *BACnetConstructedDataTrendLogMultipleAll) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetConstructedDataTrendLogMultipleAll) String() string {
	if m == nil {
		return "<nil>"
	}
