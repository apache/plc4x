...
func (m *_BACnetPriorityValueInteger) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPriorityValueInteger) GetLengthInBytes(ctx context.Context) uint64 {
