...
func (m *_BACnetPropertyStatesShedState) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetPropertyStates, peekedTagNumber uint8) (_bACnetPropertyStatesShedState BACnetPropertyStatesShedState, err error) {
