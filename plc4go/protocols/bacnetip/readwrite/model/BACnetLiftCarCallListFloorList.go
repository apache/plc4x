...
func (m *_BACnetLiftCarCallListFloorList) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetLiftCarCallListFloorList) GetLengthInBytes(ctx context.Context) uint64 {
