...
func (m *_BACnetLiftCarCallListFloorList) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (_bACnetLiftCarCallListFloorList BACnetLiftCarCallListFloorList, err error) {
