...
func (m *_BACnetPropertyIdentifierTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyIdentifierTagged) GetLengthInBytes(ctx context.Context) uint64 {
