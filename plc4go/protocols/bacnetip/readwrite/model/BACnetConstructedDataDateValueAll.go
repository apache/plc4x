...
func NewBACnetConstructedDataDateValueAll(openingTag BACnetOpeningTag, peekedTagHeader BACnetTagHeader, closingTag BACnetClosingTag) *_BACnetConstructedDataDateValueAll {
...
func (m *_BACnetConstructedDataDateValueAll) GetPlx4xTypeName() string {
	return "BACnetConstructedDataDateValueAll"
}

func (m *_BACnetConstructedDataDateValueAll) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.BACnetConstructedDataContract.(*_BACnetConstructedData).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_BACnetConstructedDataDateValueAll) GetLengthInBytes(ctx context.Context) uint64 {
