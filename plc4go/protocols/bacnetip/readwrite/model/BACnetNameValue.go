...
func (m *_BACnetNameValueBuilder) WithOptionalValueBuilder(builderSupplier func(BACnetConstructedDataBuilder) BACnetConstructedDataBuilder) BACnetNameValueBuilder {
	builder := builderSupplier(m.Value.CreateBACnetConstructedDataBuilder())
	var err error
