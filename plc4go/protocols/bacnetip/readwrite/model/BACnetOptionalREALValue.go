...
func BACnetOptionalREALValueParse(ctx context.Context, theBytes []byte) (BACnetOptionalREALValue, error) {
	return BACnetOptionalREALValueParseWithBuffer(ctx, utils.NewReadBufferByteBased(theBytes))
}

func BACnetOptionalREALValueParseWithBufferProducer() func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetOptionalREALValue, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetOptionalREALValue, error) {
		return BACnetOptionalREALValueParseWithBuffer(ctx, readBuffer)
	}
}
...
func BACnetOptionalREALValueParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetOptionalREALValue, error) {
	...
	realValue, err := ReadSimpleField[BACnetApplicationTagReal](ctx, "realValue", ReadComplex[BACnetApplicationTagReal](BACnetApplicationTagParseWithBufferProducer(), readBuffer))
	if err != nil {
