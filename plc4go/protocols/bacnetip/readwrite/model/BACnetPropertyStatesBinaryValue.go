...
func (m *_BACnetPropertyStatesBinaryValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesBinaryValue) GetLengthInBytes(ctx context.Context) uint64 {
