...
func (m *_BACnetPropertyStatesBinaryValue) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetPropertyStates, peekedTagNumber uint8) (_bACnetPropertyStatesBinaryValue BACnetPropertyStatesBinaryValue, err error) {
