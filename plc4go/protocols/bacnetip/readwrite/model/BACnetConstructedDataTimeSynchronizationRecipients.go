...
func (m *_BACnetConstructedDataTimeSynchronizationRecipientsBuilder) WithMandatoryFields(timeSynchronizationRecipients []BACnetRecipient) BACnetConstructedDataTimeSynchronizationRecipientsBuilder {
	return m.WithTimeSynchronizationRecipients(timeSynchronizationRecipients...)
}

func (m *_BACnetConstructedDataTimeSynchronizationRecipientsBuilder) WithTimeSynchronizationRecipients(timeSynchronizationRecipients ...BACnetRecipient) BACnetConstructedDataTimeSynchronizationRecipientsBuilder {
	m.TimeSynchronizationRecipients = timeSynchronizationRecipients
	return m
}

func (m *_BACnetConstructedDataTimeSynchronizationRecipientsBuilder) Build() (BACnetConstructedDataTimeSynchronizationRecipients, error) {
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._BACnetConstructedDataTimeSynchronizationRecipients.deepCopy(), nil
}

func (m *_BACnetConstructedDataTimeSynchronizationRecipientsBuilder) MustBuild() BACnetConstructedDataTimeSynchronizationRecipients {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetConstructedDataTimeSynchronizationRecipientsBuilder) DeepCopy() any {
	return m.CreateBACnetConstructedDataTimeSynchronizationRecipientsBuilder()
}
...
func (m *_BACnetConstructedDataTimeSynchronizationRecipients) CreateBACnetConstructedDataTimeSynchronizationRecipientsBuilder() BACnetConstructedDataTimeSynchronizationRecipientsBuilder {
	if m == nil {
		return NewBACnetConstructedDataTimeSynchronizationRecipientsBuilder()
	}
	return &_BACnetConstructedDataTimeSynchronizationRecipientsBuilder{_BACnetConstructedDataTimeSynchronizationRecipients: m.deepCopy()}
}
