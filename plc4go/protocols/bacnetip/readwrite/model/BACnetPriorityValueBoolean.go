...
func (m *_BACnetPriorityValueBoolean) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetPriorityValue, objectTypeArgument BACnetObjectType) (_bACnetPriorityValueBoolean BACnetPriorityValueBoolean, err error) {
