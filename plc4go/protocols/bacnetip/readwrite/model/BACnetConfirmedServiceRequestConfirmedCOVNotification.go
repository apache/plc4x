...
// BACnetConfirmedServiceRequestConfirmedCOVNotification is the data-structure of this message
...
// IBACnetConfirmedServiceRequestConfirmedCOVNotification is the corresponding interface of BACnetConfirmedServiceRequestConfirmedCOVNotification
...
func (m *BACnetConfirmedServiceRequestConfirmedCOVNotification) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		_lifetimeInSecondsErr := writeBuffer.WriteSerializable(m.LifetimeInSeconds)
		...
		_listOfValuesErr := writeBuffer.WriteSerializable(m.ListOfValues)
