...
func (m *_BACnetConstructedDataTimeOfStrikeCountReset) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataTimeOfStrikeCountReset) GetLengthInBytes(ctx context.Context) uint64 {
