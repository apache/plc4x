...
func (m *_BACnetConstructedDataAnalogInputPresentValue) GetPlx4xTypeName() string {
	return "BACnetConstructedDataAnalogInputPresentValue"
}

func (m *_BACnetConstructedDataAnalogInputPresentValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataAnalogInputPresentValue) GetLengthInBytes(ctx context.Context) uint64 {
