...
func (m *_BACnetConfirmedServiceRequestAuthenticate) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetConfirmedServiceRequest, serviceRequestPayloadLength uint32, serviceRequestLength uint32) (_bACnetConfirmedServiceRequestAuthenticate BACnetConfirmedServiceRequestAuthenticate, err error) {
