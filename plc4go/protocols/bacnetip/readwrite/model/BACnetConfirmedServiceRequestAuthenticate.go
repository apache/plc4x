...
func (m *_BACnetConfirmedServiceRequestAuthenticate) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConfirmedServiceRequestAuthenticate) GetLengthInBytes(ctx context.Context) uint64 {
