...
func (m *_NLMIAmRouterToNetwork) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_NLM, apduLength uint16) (_nLMIAmRouterToNetwork NLMIAmRouterToNetwork, err error) {
