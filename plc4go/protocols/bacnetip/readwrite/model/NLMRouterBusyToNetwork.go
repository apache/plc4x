...
func (m *_NLMRouterBusyToNetwork) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_NLM, apduLength uint16) (_nLMRouterBusyToNetwork NLMRouterBusyToNetwork, err error) {
