...
func (m *BACnetConstructedDataAccessCredentialAl) GetObjectTypeArgument() BACnetObjectType {
...
func (m *BACnetConstructedDataAccessCredentialAl) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag) {
...
func NewBACnetConstructedDataAccessCredentialAl(openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag, tagNumber uint8, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) *BACnetConstructedDataAccessCredentialAl {
...
func BACnetConstructedDataAccessCredentialAlParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) (*BACnetConstructedDataAccessCredentialAl, error) {
	positionAware := readBuffer
	_ = positionAware
	if pullErr := readBuffer.PullContext("BACnetConstructedDataAccessCredentialAl"); pullErr != nil {
		return nil, errors.Wrap(pullErr, "Error pulling for BACnetConstructedDataAccessCredentialAl")
	}
	...
	if closeErr := readBuffer.CloseContext("BACnetConstructedDataAccessCredentialAl"); closeErr != nil {
		return nil, errors.Wrap(closeErr, "Error closing for BACnetConstructedDataAccessCredentialAl")
	}
...
func (m *BACnetConstructedDataAccessCredentialAl) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		if pushErr := writeBuffer.PushContext("BACnetConstructedDataAccessCredentialAl"); pushErr != nil {
			return errors.Wrap(pushErr, "Error pushing for BACnetConstructedDataAccessCredentialAl")
		}

		if popErr := writeBuffer.PopContext("BACnetConstructedDataAccessCredentialAl"); popErr != nil {
			return errors.Wrap(popErr, "Error popping for BACnetConstructedDataAccessCredentialAl")
		}
		return nil
	}
