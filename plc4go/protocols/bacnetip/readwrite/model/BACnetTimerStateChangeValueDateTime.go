...
// BACnetTimerStateChangeValueDateTime is the data-structure of this message
type BACnetTimerStateChangeValueDateTime struct {
...
// IBACnetTimerStateChangeValueDateTime is the corresponding interface of BACnetTimerStateChangeValueDateTime
type IBACnetTimerStateChangeValueDateTime interface {
...
func (m *BACnetTimerStateChangeValueDateTime) InitializeParent(parent *BACnetTimerStateChangeValue, peekedTagHeader *BACnetTagHeader) {
	m.BACnetTimerStateChangeValue.PeekedTagHeader = peekedTagHeader
}

func (m *BACnetTimerStateChangeValueDateTime) GetParent() *BACnetTimerStateChangeValue {
...
func (m *BACnetTimerStateChangeValueDateTime) GetDateTimeValue() *BACnetDateTimeEnclosed {
...
// NewBACnetTimerStateChangeValueDateTime factory function for BACnetTimerStateChangeValueDateTime
func NewBACnetTimerStateChangeValueDateTime(dateTimeValue *BACnetDateTimeEnclosed, peekedTagHeader *BACnetTagHeader, objectTypeArgument BACnetObjectType) *BACnetTimerStateChangeValueDateTime {
	_result := &BACnetTimerStateChangeValueDateTime{
...
func CastBACnetTimerStateChangeValueDateTime(structType interface{}) *BACnetTimerStateChangeValueDateTime {
	...
	if casted, ok := structType.(BACnetTimerStateChangeValue); ok {
		return CastBACnetTimerStateChangeValueDateTime(casted.Child)
	}
	if casted, ok := structType.(*BACnetTimerStateChangeValue); ok {
		return CastBACnetTimerStateChangeValueDateTime(casted.Child)
	}
...
func (m *BACnetTimerStateChangeValueDateTime) GetTypeName() string {
	return "BACnetTimerStateChangeValueDateTime"
}

func (m *BACnetTimerStateChangeValueDateTime) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetTimerStateChangeValueDateTime) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetTimerStateChangeValueDateTime) GetLengthInBytes() uint16 {
...
func BACnetTimerStateChangeValueDateTimeParse(readBuffer utils.ReadBuffer, objectTypeArgument BACnetObjectType) (*BACnetTimerStateChangeValueDateTime, error) {
	...
	_child := &BACnetTimerStateChangeValueDateTime{
...
func (m *BACnetTimerStateChangeValueDateTime) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetTimerStateChangeValueDateTime) String() string {
	if m == nil {
		return "<nil>"
	}
