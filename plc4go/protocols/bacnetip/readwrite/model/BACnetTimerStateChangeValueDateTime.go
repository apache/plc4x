...
func (m *_BACnetTimerStateChangeValueDateTime) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetTimerStateChangeValueDateTime) GetLengthInBytes(ctx context.Context) uint64 {
