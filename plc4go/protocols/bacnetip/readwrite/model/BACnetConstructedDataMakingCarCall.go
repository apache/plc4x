...
// BACnetConstructedDataMakingCarCall is the data-structure of this message
type BACnetConstructedDataMakingCarCall struct {
...
type IBACnetConstructedDataMakingCarCall interface {
...
func (m *BACnetConstructedDataMakingCarCall) GetObjectTypeArgument() BACnetObjectType {
	return 0
}

func (m *BACnetConstructedDataMakingCarCall) GetPropertyIdentifierArgument() BACnetPropertyIdentifier {
...
func (m *BACnetConstructedDataMakingCarCall) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag) {
	m.BACnetConstructedData.OpeningTag = openingTag
	m.BACnetConstructedData.PeekedTagHeader = peekedTagHeader
	m.BACnetConstructedData.ClosingTag = closingTag
}

func (m *BACnetConstructedDataMakingCarCall) GetParent() *BACnetConstructedData {
...
func (m *BACnetConstructedDataMakingCarCall) GetNumberOfDataElements() *BACnetApplicationTagUnsignedInteger {
	return m.NumberOfDataElements
}

func (m *BACnetConstructedDataMakingCarCall) GetMakingCarCall() []*BACnetApplicationTagUnsignedInteger {
...
func (m *BACnetConstructedDataMakingCarCall) GetZero() uint64 {
...
func NewBACnetConstructedDataMakingCarCall(numberOfDataElements *BACnetApplicationTagUnsignedInteger, makingCarCall []*BACnetApplicationTagUnsignedInteger, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag, tagNumber uint8, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) *BACnetConstructedDataMakingCarCall {
...
func CastBACnetConstructedDataMakingCarCall(structType interface{}) *BACnetConstructedDataMakingCarCall {
	...
	if casted, ok := structType.(BACnetConstructedData); ok {
		return CastBACnetConstructedDataMakingCarCall(casted.Child)
	}
	if casted, ok := structType.(*BACnetConstructedData); ok {
		return CastBACnetConstructedDataMakingCarCall(casted.Child)
	}
...
func (m *BACnetConstructedDataMakingCarCall) GetTypeName() string {
	return "BACnetConstructedDataMakingCarCall"
}

func (m *BACnetConstructedDataMakingCarCall) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetConstructedDataMakingCarCall) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetConstructedDataMakingCarCall) GetLengthInBytes() uint16 {
...
func BACnetConstructedDataMakingCarCallParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) (*BACnetConstructedDataMakingCarCall, error) {
	...
	// Terminated array
	makingCarCall := make([]*BACnetApplicationTagUnsignedInteger, 0)
	{
		for !bool(IsBACnetConstructedDataClosingTag(readBuffer, false, tagNumber)) {
			_item, _err := BACnetApplicationTagParse(readBuffer)
			if _err != nil {
				return nil, errors.Wrap(_err, "Error parsing 'makingCarCall' field")
			}
			makingCarCall = append(makingCarCall, CastBACnetApplicationTagUnsignedInteger(_item))
	...
	_child := &BACnetConstructedDataMakingCarCall{
...
func (m *BACnetConstructedDataMakingCarCall) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		if m.MakingCarCall != nil {
			...
			for _, _element := range m.MakingCarCall {
...
func (m *BACnetConstructedDataMakingCarCall) String() string {
	if m == nil {
		return "<nil>"
	}
