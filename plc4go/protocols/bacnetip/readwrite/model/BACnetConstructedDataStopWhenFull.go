...
func (m *_BACnetConstructedDataStopWhenFull) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataStopWhenFull) GetLengthInBytes(ctx context.Context) uint64 {
