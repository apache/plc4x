...
func (m *_BACnetEventParameterUnsignedOutOfRange) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetEventParameterUnsignedOutOfRange) GetLengthInBytes(ctx context.Context) uint64 {
