...
func (m *_BACnetEventParameterUnsignedOutOfRange) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetEventParameter) (_bACnetEventParameterUnsignedOutOfRange BACnetEventParameterUnsignedOutOfRange, err error) {
