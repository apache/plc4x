...
func NewBACnetConstructedDataDeadband(openingTag BACnetOpeningTag, peekedTagHeader BACnetTagHeader, closingTag BACnetClosingTag, deadband BACnetApplicationTagReal) *_BACnetConstructedDataDeadband {
	if deadband == nil {
...
func (m *_BACnetConstructedDataDeadband) GetPlx4xTypeName() string {
	return "BACnetConstructedDataDeadband"
}

func (m *_BACnetConstructedDataDeadband) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataDeadband) GetLengthInBytes(ctx context.Context) uint64 {
