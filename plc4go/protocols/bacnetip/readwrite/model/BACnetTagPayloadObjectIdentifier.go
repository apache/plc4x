...
if err := WriteManualField[uint16]( ctx, "proprietaryValue", func(ctx context.Context) error { return WriteProprietaryObjectType(ctx, writeBuffer, m.GetObjectType(), m.GetProprietaryValue()) }, writeBuffer); err != nil{
