...
func (m *_BACnetTagPayloadObjectIdentifier) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_bACnetTagPayloadObjectIdentifier BACnetTagPayloadObjectIdentifier, err error) {
