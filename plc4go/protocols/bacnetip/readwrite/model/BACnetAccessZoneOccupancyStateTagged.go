...
func (m *_BACnetAccessZoneOccupancyStateTagged) GetPlx4xTypeName() string {
	return "BACnetAccessZoneOccupancyStateTagged"
}

func (m *_BACnetAccessZoneOccupancyStateTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetAccessZoneOccupancyStateTagged) GetLengthInBytes(ctx context.Context) uint64 {
