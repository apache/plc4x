...
func (m *_BACnetAuthenticationPolicyList) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetAuthenticationPolicyList) GetLengthInBytes(ctx context.Context) uint64 {
