...
func (m *_BACnetConstructedDataCountBeforeChange) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataCountBeforeChange) GetLengthInBytes(ctx context.Context) uint64 {
