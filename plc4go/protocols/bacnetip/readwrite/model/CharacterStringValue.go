...
// CharacterStringValue is the corresponding interface of CharacterStringValue
type CharacterStringValue interface {
	fmt.Stringer
	utils.LengthAware
	utils.Serializable
	utils.Copyable
	...
	// IsCharacterStringValue is a marker method to prevent unintentional type checks (interfaces of same signature)
	IsCharacterStringValue()
	// CreateBuilder creates a CharacterStringValueBuilder
	CreateCharacterStringValueBuilder() CharacterStringValueBuilder
}

// _CharacterStringValue is the data-structure of this message
type _CharacterStringValue struct {
...
var _ CharacterStringValue = (*_CharacterStringValue)(nil)

// NewCharacterStringValue factory function for _CharacterStringValue
func NewCharacterStringValue(objectIdentifier ReadableProperty, objectName ReadableProperty, objectType ReadableProperty, description OptionalProperty, presentValue ReadableProperty, statusFlags ReadableProperty, eventState OptionalProperty, reliability OptionalProperty, outOfService OptionalProperty, priorityArray OptionalProperty, relinquishDefault OptionalProperty, timeDelay OptionalProperty, notificationClass OptionalProperty, alarmValues OptionalProperty, faultValues OptionalProperty, eventEnable OptionalProperty, ackedTransitions OptionalProperty, notifyType OptionalProperty, eventTimeStamps OptionalProperty, eventMessageTexts OptionalProperty, eventMessageTextsConfig OptionalProperty, eventDetectionEnable OptionalProperty, eventAlgorithmInhibitRef OptionalProperty, eventAlgorithmInhibit OptionalProperty, timeDelayNormal OptionalProperty, reliabilityEvaluationInhibit OptionalProperty, propertyList ReadableProperty, currentCommandPriority OptionalProperty, valueSource OptionalProperty, valueSourceArray OptionalProperty, lastCommandTime OptionalProperty, commandTimeArray OptionalProperty, tags OptionalProperty, profileLocation OptionalProperty, profileName OptionalProperty) *_CharacterStringValue {
	if objectIdentifier == nil {
		panic("objectIdentifier of type ReadableProperty for CharacterStringValue must not be nil")
	}
	if objectName == nil {
		panic("objectName of type ReadableProperty for CharacterStringValue must not be nil")
	}
	if objectType == nil {
		panic("objectType of type ReadableProperty for CharacterStringValue must not be nil")
	}
	if description == nil {
		panic("description of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if presentValue == nil {
		panic("presentValue of type ReadableProperty for CharacterStringValue must not be nil")
	}
	if statusFlags == nil {
		panic("statusFlags of type ReadableProperty for CharacterStringValue must not be nil")
	}
	if eventState == nil {
		panic("eventState of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if reliability == nil {
		panic("reliability of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if outOfService == nil {
		panic("outOfService of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if priorityArray == nil {
		panic("priorityArray of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if relinquishDefault == nil {
		panic("relinquishDefault of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if timeDelay == nil {
		panic("timeDelay of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if notificationClass == nil {
		panic("notificationClass of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if alarmValues == nil {
		panic("alarmValues of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if faultValues == nil {
		panic("faultValues of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if eventEnable == nil {
		panic("eventEnable of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if ackedTransitions == nil {
		panic("ackedTransitions of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if notifyType == nil {
		panic("notifyType of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if eventTimeStamps == nil {
		panic("eventTimeStamps of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if eventMessageTexts == nil {
		panic("eventMessageTexts of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if eventMessageTextsConfig == nil {
		panic("eventMessageTextsConfig of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if eventDetectionEnable == nil {
		panic("eventDetectionEnable of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if eventAlgorithmInhibitRef == nil {
		panic("eventAlgorithmInhibitRef of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if eventAlgorithmInhibit == nil {
		panic("eventAlgorithmInhibit of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if timeDelayNormal == nil {
		panic("timeDelayNormal of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if reliabilityEvaluationInhibit == nil {
		panic("reliabilityEvaluationInhibit of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if propertyList == nil {
		panic("propertyList of type ReadableProperty for CharacterStringValue must not be nil")
	}
	if currentCommandPriority == nil {
		panic("currentCommandPriority of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if valueSource == nil {
		panic("valueSource of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if valueSourceArray == nil {
		panic("valueSourceArray of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if lastCommandTime == nil {
		panic("lastCommandTime of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if commandTimeArray == nil {
		panic("commandTimeArray of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if tags == nil {
		panic("tags of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if profileLocation == nil {
		panic("profileLocation of type OptionalProperty for CharacterStringValue must not be nil")
	}
	if profileName == nil {
		panic("profileName of type OptionalProperty for CharacterStringValue must not be nil")
	}
	return &_CharacterStringValue{ObjectIdentifier: objectIdentifier, ObjectName: objectName, ObjectType: objectType, Description: description, PresentValue: presentValue, StatusFlags: statusFlags, EventState: eventState, Reliability: reliability, OutOfService: outOfService, PriorityArray: priorityArray, RelinquishDefault: relinquishDefault, TimeDelay: timeDelay, NotificationClass: notificationClass, AlarmValues: alarmValues, FaultValues: faultValues, EventEnable: eventEnable, AckedTransitions: ackedTransitions, NotifyType: notifyType, EventTimeStamps: eventTimeStamps, EventMessageTexts: eventMessageTexts, EventMessageTextsConfig: eventMessageTextsConfig, EventDetectionEnable: eventDetectionEnable, EventAlgorithmInhibitRef: eventAlgorithmInhibitRef, EventAlgorithmInhibit: eventAlgorithmInhibit, TimeDelayNormal: timeDelayNormal, ReliabilityEvaluationInhibit: reliabilityEvaluationInhibit, PropertyList: propertyList, CurrentCommandPriority: currentCommandPriority, ValueSource: valueSource, ValueSourceArray: valueSourceArray, LastCommandTime: lastCommandTime, CommandTimeArray: commandTimeArray, Tags: tags, ProfileLocation: profileLocation, ProfileName: profileName}
}
...
// CharacterStringValueBuilder is a builder for CharacterStringValue
type CharacterStringValueBuilder interface {
	utils.Copyable
	// WithMandatoryFields adds all mandatory fields (convenience for using multiple builder calls)
	WithMandatoryFields(objectIdentifier ReadableProperty, objectName ReadableProperty, objectType ReadableProperty, description OptionalProperty, presentValue ReadableProperty, statusFlags ReadableProperty, eventState OptionalProperty, reliability OptionalProperty, outOfService OptionalProperty, priorityArray OptionalProperty, relinquishDefault OptionalProperty, timeDelay OptionalProperty, notificationClass OptionalProperty, alarmValues OptionalProperty, faultValues OptionalProperty, eventEnable OptionalProperty, ackedTransitions OptionalProperty, notifyType OptionalProperty, eventTimeStamps OptionalProperty, eventMessageTexts OptionalProperty, eventMessageTextsConfig OptionalProperty, eventDetectionEnable OptionalProperty, eventAlgorithmInhibitRef OptionalProperty, eventAlgorithmInhibit OptionalProperty, timeDelayNormal OptionalProperty, reliabilityEvaluationInhibit OptionalProperty, propertyList ReadableProperty, currentCommandPriority OptionalProperty, valueSource OptionalProperty, valueSourceArray OptionalProperty, lastCommandTime OptionalProperty, commandTimeArray OptionalProperty, tags OptionalProperty, profileLocation OptionalProperty, profileName OptionalProperty) CharacterStringValueBuilder
	// WithObjectIdentifier adds ObjectIdentifier (property field)
	WithObjectIdentifier(ReadableProperty) CharacterStringValueBuilder
	// WithObjectIdentifierBuilder adds ObjectIdentifier (property field) which is build by the builder
	WithObjectIdentifierBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) CharacterStringValueBuilder
	// WithObjectName adds ObjectName (property field)
	WithObjectName(ReadableProperty) CharacterStringValueBuilder
	// WithObjectNameBuilder adds ObjectName (property field) which is build by the builder
	WithObjectNameBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) CharacterStringValueBuilder
	// WithObjectType adds ObjectType (property field)
	WithObjectType(ReadableProperty) CharacterStringValueBuilder
	// WithObjectTypeBuilder adds ObjectType (property field) which is build by the builder
	WithObjectTypeBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) CharacterStringValueBuilder
	// WithDescription adds Description (property field)
	WithDescription(OptionalProperty) CharacterStringValueBuilder
	// WithDescriptionBuilder adds Description (property field) which is build by the builder
	WithDescriptionBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithPresentValue adds PresentValue (property field)
	WithPresentValue(ReadableProperty) CharacterStringValueBuilder
	// WithPresentValueBuilder adds PresentValue (property field) which is build by the builder
	WithPresentValueBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) CharacterStringValueBuilder
	// WithStatusFlags adds StatusFlags (property field)
	WithStatusFlags(ReadableProperty) CharacterStringValueBuilder
	// WithStatusFlagsBuilder adds StatusFlags (property field) which is build by the builder
	WithStatusFlagsBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) CharacterStringValueBuilder
	// WithEventState adds EventState (property field)
	WithEventState(OptionalProperty) CharacterStringValueBuilder
	// WithEventStateBuilder adds EventState (property field) which is build by the builder
	WithEventStateBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithReliability adds Reliability (property field)
	WithReliability(OptionalProperty) CharacterStringValueBuilder
	// WithReliabilityBuilder adds Reliability (property field) which is build by the builder
	WithReliabilityBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithOutOfService adds OutOfService (property field)
	WithOutOfService(OptionalProperty) CharacterStringValueBuilder
	// WithOutOfServiceBuilder adds OutOfService (property field) which is build by the builder
	WithOutOfServiceBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithPriorityArray adds PriorityArray (property field)
	WithPriorityArray(OptionalProperty) CharacterStringValueBuilder
	// WithPriorityArrayBuilder adds PriorityArray (property field) which is build by the builder
	WithPriorityArrayBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithRelinquishDefault adds RelinquishDefault (property field)
	WithRelinquishDefault(OptionalProperty) CharacterStringValueBuilder
	// WithRelinquishDefaultBuilder adds RelinquishDefault (property field) which is build by the builder
	WithRelinquishDefaultBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithTimeDelay adds TimeDelay (property field)
	WithTimeDelay(OptionalProperty) CharacterStringValueBuilder
	// WithTimeDelayBuilder adds TimeDelay (property field) which is build by the builder
	WithTimeDelayBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithNotificationClass adds NotificationClass (property field)
	WithNotificationClass(OptionalProperty) CharacterStringValueBuilder
	// WithNotificationClassBuilder adds NotificationClass (property field) which is build by the builder
	WithNotificationClassBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithAlarmValues adds AlarmValues (property field)
	WithAlarmValues(OptionalProperty) CharacterStringValueBuilder
	// WithAlarmValuesBuilder adds AlarmValues (property field) which is build by the builder
	WithAlarmValuesBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithFaultValues adds FaultValues (property field)
	WithFaultValues(OptionalProperty) CharacterStringValueBuilder
	// WithFaultValuesBuilder adds FaultValues (property field) which is build by the builder
	WithFaultValuesBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithEventEnable adds EventEnable (property field)
	WithEventEnable(OptionalProperty) CharacterStringValueBuilder
	// WithEventEnableBuilder adds EventEnable (property field) which is build by the builder
	WithEventEnableBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithAckedTransitions adds AckedTransitions (property field)
	WithAckedTransitions(OptionalProperty) CharacterStringValueBuilder
	// WithAckedTransitionsBuilder adds AckedTransitions (property field) which is build by the builder
	WithAckedTransitionsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithNotifyType adds NotifyType (property field)
	WithNotifyType(OptionalProperty) CharacterStringValueBuilder
	// WithNotifyTypeBuilder adds NotifyType (property field) which is build by the builder
	WithNotifyTypeBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithEventTimeStamps adds EventTimeStamps (property field)
	WithEventTimeStamps(OptionalProperty) CharacterStringValueBuilder
	// WithEventTimeStampsBuilder adds EventTimeStamps (property field) which is build by the builder
	WithEventTimeStampsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithEventMessageTexts adds EventMessageTexts (property field)
	WithEventMessageTexts(OptionalProperty) CharacterStringValueBuilder
	// WithEventMessageTextsBuilder adds EventMessageTexts (property field) which is build by the builder
	WithEventMessageTextsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithEventMessageTextsConfig adds EventMessageTextsConfig (property field)
	WithEventMessageTextsConfig(OptionalProperty) CharacterStringValueBuilder
	// WithEventMessageTextsConfigBuilder adds EventMessageTextsConfig (property field) which is build by the builder
	WithEventMessageTextsConfigBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithEventDetectionEnable adds EventDetectionEnable (property field)
	WithEventDetectionEnable(OptionalProperty) CharacterStringValueBuilder
	// WithEventDetectionEnableBuilder adds EventDetectionEnable (property field) which is build by the builder
	WithEventDetectionEnableBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithEventAlgorithmInhibitRef adds EventAlgorithmInhibitRef (property field)
	WithEventAlgorithmInhibitRef(OptionalProperty) CharacterStringValueBuilder
	// WithEventAlgorithmInhibitRefBuilder adds EventAlgorithmInhibitRef (property field) which is build by the builder
	WithEventAlgorithmInhibitRefBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithEventAlgorithmInhibit adds EventAlgorithmInhibit (property field)
	WithEventAlgorithmInhibit(OptionalProperty) CharacterStringValueBuilder
	// WithEventAlgorithmInhibitBuilder adds EventAlgorithmInhibit (property field) which is build by the builder
	WithEventAlgorithmInhibitBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithTimeDelayNormal adds TimeDelayNormal (property field)
	WithTimeDelayNormal(OptionalProperty) CharacterStringValueBuilder
	// WithTimeDelayNormalBuilder adds TimeDelayNormal (property field) which is build by the builder
	WithTimeDelayNormalBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithReliabilityEvaluationInhibit adds ReliabilityEvaluationInhibit (property field)
	WithReliabilityEvaluationInhibit(OptionalProperty) CharacterStringValueBuilder
	// WithReliabilityEvaluationInhibitBuilder adds ReliabilityEvaluationInhibit (property field) which is build by the builder
	WithReliabilityEvaluationInhibitBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithPropertyList adds PropertyList (property field)
	WithPropertyList(ReadableProperty) CharacterStringValueBuilder
	// WithPropertyListBuilder adds PropertyList (property field) which is build by the builder
	WithPropertyListBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) CharacterStringValueBuilder
	// WithCurrentCommandPriority adds CurrentCommandPriority (property field)
	WithCurrentCommandPriority(OptionalProperty) CharacterStringValueBuilder
	// WithCurrentCommandPriorityBuilder adds CurrentCommandPriority (property field) which is build by the builder
	WithCurrentCommandPriorityBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithValueSource adds ValueSource (property field)
	WithValueSource(OptionalProperty) CharacterStringValueBuilder
	// WithValueSourceBuilder adds ValueSource (property field) which is build by the builder
	WithValueSourceBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithValueSourceArray adds ValueSourceArray (property field)
	WithValueSourceArray(OptionalProperty) CharacterStringValueBuilder
	// WithValueSourceArrayBuilder adds ValueSourceArray (property field) which is build by the builder
	WithValueSourceArrayBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithLastCommandTime adds LastCommandTime (property field)
	WithLastCommandTime(OptionalProperty) CharacterStringValueBuilder
	// WithLastCommandTimeBuilder adds LastCommandTime (property field) which is build by the builder
	WithLastCommandTimeBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithCommandTimeArray adds CommandTimeArray (property field)
	WithCommandTimeArray(OptionalProperty) CharacterStringValueBuilder
	// WithCommandTimeArrayBuilder adds CommandTimeArray (property field) which is build by the builder
	WithCommandTimeArrayBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithTags adds Tags (property field)
	WithTags(OptionalProperty) CharacterStringValueBuilder
	// WithTagsBuilder adds Tags (property field) which is build by the builder
	WithTagsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithProfileLocation adds ProfileLocation (property field)
	WithProfileLocation(OptionalProperty) CharacterStringValueBuilder
	// WithProfileLocationBuilder adds ProfileLocation (property field) which is build by the builder
	WithProfileLocationBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// WithProfileName adds ProfileName (property field)
	WithProfileName(OptionalProperty) CharacterStringValueBuilder
	// WithProfileNameBuilder adds ProfileName (property field) which is build by the builder
	WithProfileNameBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder
	// Build builds the CharacterStringValue or returns an error if something is wrong
	Build() (CharacterStringValue, error)
	// MustBuild does the same as Build but panics on error
	MustBuild() CharacterStringValue
}

// NewCharacterStringValueBuilder() creates a CharacterStringValueBuilder
func NewCharacterStringValueBuilder() CharacterStringValueBuilder {
	return &_CharacterStringValueBuilder{_CharacterStringValue: new(_CharacterStringValue)}
}

type _CharacterStringValueBuilder struct {
	*_CharacterStringValue

	err *utils.MultiError
}

var _ (CharacterStringValueBuilder) = (*_CharacterStringValueBuilder)(nil)

func (b *_CharacterStringValueBuilder) WithMandatoryFields(objectIdentifier ReadableProperty, objectName ReadableProperty, objectType ReadableProperty, description OptionalProperty, presentValue ReadableProperty, statusFlags ReadableProperty, eventState OptionalProperty, reliability OptionalProperty, outOfService OptionalProperty, priorityArray OptionalProperty, relinquishDefault OptionalProperty, timeDelay OptionalProperty, notificationClass OptionalProperty, alarmValues OptionalProperty, faultValues OptionalProperty, eventEnable OptionalProperty, ackedTransitions OptionalProperty, notifyType OptionalProperty, eventTimeStamps OptionalProperty, eventMessageTexts OptionalProperty, eventMessageTextsConfig OptionalProperty, eventDetectionEnable OptionalProperty, eventAlgorithmInhibitRef OptionalProperty, eventAlgorithmInhibit OptionalProperty, timeDelayNormal OptionalProperty, reliabilityEvaluationInhibit OptionalProperty, propertyList ReadableProperty, currentCommandPriority OptionalProperty, valueSource OptionalProperty, valueSourceArray OptionalProperty, lastCommandTime OptionalProperty, commandTimeArray OptionalProperty, tags OptionalProperty, profileLocation OptionalProperty, profileName OptionalProperty) CharacterStringValueBuilder {
	return b.WithObjectIdentifier(objectIdentifier).WithObjectName(objectName).WithObjectType(objectType).WithDescription(description).WithPresentValue(presentValue).WithStatusFlags(statusFlags).WithEventState(eventState).WithReliability(reliability).WithOutOfService(outOfService).WithPriorityArray(priorityArray).WithRelinquishDefault(relinquishDefault).WithTimeDelay(timeDelay).WithNotificationClass(notificationClass).WithAlarmValues(alarmValues).WithFaultValues(faultValues).WithEventEnable(eventEnable).WithAckedTransitions(ackedTransitions).WithNotifyType(notifyType).WithEventTimeStamps(eventTimeStamps).WithEventMessageTexts(eventMessageTexts).WithEventMessageTextsConfig(eventMessageTextsConfig).WithEventDetectionEnable(eventDetectionEnable).WithEventAlgorithmInhibitRef(eventAlgorithmInhibitRef).WithEventAlgorithmInhibit(eventAlgorithmInhibit).WithTimeDelayNormal(timeDelayNormal).WithReliabilityEvaluationInhibit(reliabilityEvaluationInhibit).WithPropertyList(propertyList).WithCurrentCommandPriority(currentCommandPriority).WithValueSource(valueSource).WithValueSourceArray(valueSourceArray).WithLastCommandTime(lastCommandTime).WithCommandTimeArray(commandTimeArray).WithTags(tags).WithProfileLocation(profileLocation).WithProfileName(profileName)
}

func (b *_CharacterStringValueBuilder) WithObjectIdentifier(objectIdentifier ReadableProperty) CharacterStringValueBuilder {
	b.ObjectIdentifier = objectIdentifier
	return b
}

func (b *_CharacterStringValueBuilder) WithObjectIdentifierBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithObjectName(objectName ReadableProperty) CharacterStringValueBuilder {
	b.ObjectName = objectName
	return b
}

func (b *_CharacterStringValueBuilder) WithObjectNameBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithObjectType(objectType ReadableProperty) CharacterStringValueBuilder {
	b.ObjectType = objectType
	return b
}

func (b *_CharacterStringValueBuilder) WithObjectTypeBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithDescription(description OptionalProperty) CharacterStringValueBuilder {
	b.Description = description
	return b
}

func (b *_CharacterStringValueBuilder) WithDescriptionBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithPresentValue(presentValue ReadableProperty) CharacterStringValueBuilder {
	b.PresentValue = presentValue
	return b
}

func (b *_CharacterStringValueBuilder) WithPresentValueBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithStatusFlags(statusFlags ReadableProperty) CharacterStringValueBuilder {
	b.StatusFlags = statusFlags
	return b
}

func (b *_CharacterStringValueBuilder) WithStatusFlagsBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithEventState(eventState OptionalProperty) CharacterStringValueBuilder {
	b.EventState = eventState
	return b
}

func (b *_CharacterStringValueBuilder) WithEventStateBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithReliability(reliability OptionalProperty) CharacterStringValueBuilder {
	b.Reliability = reliability
	return b
}

func (b *_CharacterStringValueBuilder) WithReliabilityBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithOutOfService(outOfService OptionalProperty) CharacterStringValueBuilder {
	b.OutOfService = outOfService
	return b
}

func (b *_CharacterStringValueBuilder) WithOutOfServiceBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithPriorityArray(priorityArray OptionalProperty) CharacterStringValueBuilder {
	b.PriorityArray = priorityArray
	return b
}

func (b *_CharacterStringValueBuilder) WithPriorityArrayBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithRelinquishDefault(relinquishDefault OptionalProperty) CharacterStringValueBuilder {
	b.RelinquishDefault = relinquishDefault
	return b
}

func (b *_CharacterStringValueBuilder) WithRelinquishDefaultBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithTimeDelay(timeDelay OptionalProperty) CharacterStringValueBuilder {
	b.TimeDelay = timeDelay
	return b
}

func (b *_CharacterStringValueBuilder) WithTimeDelayBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithNotificationClass(notificationClass OptionalProperty) CharacterStringValueBuilder {
	b.NotificationClass = notificationClass
	return b
}

func (b *_CharacterStringValueBuilder) WithNotificationClassBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithAlarmValues(alarmValues OptionalProperty) CharacterStringValueBuilder {
	b.AlarmValues = alarmValues
	return b
}

func (b *_CharacterStringValueBuilder) WithAlarmValuesBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithFaultValues(faultValues OptionalProperty) CharacterStringValueBuilder {
	b.FaultValues = faultValues
	return b
}

func (b *_CharacterStringValueBuilder) WithFaultValuesBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithEventEnable(eventEnable OptionalProperty) CharacterStringValueBuilder {
	b.EventEnable = eventEnable
	return b
}

func (b *_CharacterStringValueBuilder) WithEventEnableBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithAckedTransitions(ackedTransitions OptionalProperty) CharacterStringValueBuilder {
	b.AckedTransitions = ackedTransitions
	return b
}

func (b *_CharacterStringValueBuilder) WithAckedTransitionsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithNotifyType(notifyType OptionalProperty) CharacterStringValueBuilder {
	b.NotifyType = notifyType
	return b
}

func (b *_CharacterStringValueBuilder) WithNotifyTypeBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithEventTimeStamps(eventTimeStamps OptionalProperty) CharacterStringValueBuilder {
	b.EventTimeStamps = eventTimeStamps
	return b
}

func (b *_CharacterStringValueBuilder) WithEventTimeStampsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithEventMessageTexts(eventMessageTexts OptionalProperty) CharacterStringValueBuilder {
	b.EventMessageTexts = eventMessageTexts
	return b
}

func (b *_CharacterStringValueBuilder) WithEventMessageTextsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithEventMessageTextsConfig(eventMessageTextsConfig OptionalProperty) CharacterStringValueBuilder {
	b.EventMessageTextsConfig = eventMessageTextsConfig
	return b
}

func (b *_CharacterStringValueBuilder) WithEventMessageTextsConfigBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithEventDetectionEnable(eventDetectionEnable OptionalProperty) CharacterStringValueBuilder {
	b.EventDetectionEnable = eventDetectionEnable
	return b
}

func (b *_CharacterStringValueBuilder) WithEventDetectionEnableBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithEventAlgorithmInhibitRef(eventAlgorithmInhibitRef OptionalProperty) CharacterStringValueBuilder {
	b.EventAlgorithmInhibitRef = eventAlgorithmInhibitRef
	return b
}

func (b *_CharacterStringValueBuilder) WithEventAlgorithmInhibitRefBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithEventAlgorithmInhibit(eventAlgorithmInhibit OptionalProperty) CharacterStringValueBuilder {
	b.EventAlgorithmInhibit = eventAlgorithmInhibit
	return b
}

func (b *_CharacterStringValueBuilder) WithEventAlgorithmInhibitBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithTimeDelayNormal(timeDelayNormal OptionalProperty) CharacterStringValueBuilder {
	b.TimeDelayNormal = timeDelayNormal
	return b
}

func (b *_CharacterStringValueBuilder) WithTimeDelayNormalBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithReliabilityEvaluationInhibit(reliabilityEvaluationInhibit OptionalProperty) CharacterStringValueBuilder {
	b.ReliabilityEvaluationInhibit = reliabilityEvaluationInhibit
	return b
}

func (b *_CharacterStringValueBuilder) WithReliabilityEvaluationInhibitBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithPropertyList(propertyList ReadableProperty) CharacterStringValueBuilder {
	b.PropertyList = propertyList
	return b
}

func (b *_CharacterStringValueBuilder) WithPropertyListBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithCurrentCommandPriority(currentCommandPriority OptionalProperty) CharacterStringValueBuilder {
	b.CurrentCommandPriority = currentCommandPriority
	return b
}

func (b *_CharacterStringValueBuilder) WithCurrentCommandPriorityBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithValueSource(valueSource OptionalProperty) CharacterStringValueBuilder {
	b.ValueSource = valueSource
	return b
}

func (b *_CharacterStringValueBuilder) WithValueSourceBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithValueSourceArray(valueSourceArray OptionalProperty) CharacterStringValueBuilder {
	b.ValueSourceArray = valueSourceArray
	return b
}

func (b *_CharacterStringValueBuilder) WithValueSourceArrayBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithLastCommandTime(lastCommandTime OptionalProperty) CharacterStringValueBuilder {
	b.LastCommandTime = lastCommandTime
	return b
}

func (b *_CharacterStringValueBuilder) WithLastCommandTimeBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithCommandTimeArray(commandTimeArray OptionalProperty) CharacterStringValueBuilder {
	b.CommandTimeArray = commandTimeArray
	return b
}

func (b *_CharacterStringValueBuilder) WithCommandTimeArrayBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithTags(tags OptionalProperty) CharacterStringValueBuilder {
	b.Tags = tags
	return b
}

func (b *_CharacterStringValueBuilder) WithTagsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithProfileLocation(profileLocation OptionalProperty) CharacterStringValueBuilder {
	b.ProfileLocation = profileLocation
	return b
}

func (b *_CharacterStringValueBuilder) WithProfileLocationBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) WithProfileName(profileName OptionalProperty) CharacterStringValueBuilder {
	b.ProfileName = profileName
	return b
}

func (b *_CharacterStringValueBuilder) WithProfileNameBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) CharacterStringValueBuilder {
...
func (b *_CharacterStringValueBuilder) Build() (CharacterStringValue, error) {
	...
	return b._CharacterStringValue.deepCopy(), nil
}

func (b *_CharacterStringValueBuilder) MustBuild() CharacterStringValue {
	build, err := b.Build()
	if err != nil {
		panic(err)
	}
...
func (b *_CharacterStringValueBuilder) DeepCopy() any {
	_copy := b.CreateCharacterStringValueBuilder().(*_CharacterStringValueBuilder)
	if b.err != nil {
...
// CreateCharacterStringValueBuilder creates a CharacterStringValueBuilder
func (b *_CharacterStringValue) CreateCharacterStringValueBuilder() CharacterStringValueBuilder {
	if b == nil {
		return NewCharacterStringValueBuilder()
	}
	return &_CharacterStringValueBuilder{_CharacterStringValue: b.deepCopy()}
}
...
func (m *_CharacterStringValue) GetObjectIdentifier() ReadableProperty {
	return m.ObjectIdentifier
}

func (m *_CharacterStringValue) GetObjectName() ReadableProperty {
	return m.ObjectName
}

func (m *_CharacterStringValue) GetObjectType() ReadableProperty {
	return m.ObjectType
}

func (m *_CharacterStringValue) GetDescription() OptionalProperty {
	return m.Description
}

func (m *_CharacterStringValue) GetPresentValue() ReadableProperty {
	return m.PresentValue
}

func (m *_CharacterStringValue) GetStatusFlags() ReadableProperty {
	return m.StatusFlags
}

func (m *_CharacterStringValue) GetEventState() OptionalProperty {
	return m.EventState
}

func (m *_CharacterStringValue) GetReliability() OptionalProperty {
	return m.Reliability
}

func (m *_CharacterStringValue) GetOutOfService() OptionalProperty {
	return m.OutOfService
}

func (m *_CharacterStringValue) GetPriorityArray() OptionalProperty {
	return m.PriorityArray
}

func (m *_CharacterStringValue) GetRelinquishDefault() OptionalProperty {
	return m.RelinquishDefault
}

func (m *_CharacterStringValue) GetTimeDelay() OptionalProperty {
	return m.TimeDelay
}

func (m *_CharacterStringValue) GetNotificationClass() OptionalProperty {
	return m.NotificationClass
}

func (m *_CharacterStringValue) GetAlarmValues() OptionalProperty {
	return m.AlarmValues
}

func (m *_CharacterStringValue) GetFaultValues() OptionalProperty {
	return m.FaultValues
}

func (m *_CharacterStringValue) GetEventEnable() OptionalProperty {
	return m.EventEnable
}

func (m *_CharacterStringValue) GetAckedTransitions() OptionalProperty {
	return m.AckedTransitions
}

func (m *_CharacterStringValue) GetNotifyType() OptionalProperty {
	return m.NotifyType
}

func (m *_CharacterStringValue) GetEventTimeStamps() OptionalProperty {
	return m.EventTimeStamps
}

func (m *_CharacterStringValue) GetEventMessageTexts() OptionalProperty {
	return m.EventMessageTexts
}

func (m *_CharacterStringValue) GetEventMessageTextsConfig() OptionalProperty {
	return m.EventMessageTextsConfig
}

func (m *_CharacterStringValue) GetEventDetectionEnable() OptionalProperty {
	return m.EventDetectionEnable
}

func (m *_CharacterStringValue) GetEventAlgorithmInhibitRef() OptionalProperty {
	return m.EventAlgorithmInhibitRef
}

func (m *_CharacterStringValue) GetEventAlgorithmInhibit() OptionalProperty {
	return m.EventAlgorithmInhibit
}

func (m *_CharacterStringValue) GetTimeDelayNormal() OptionalProperty {
	return m.TimeDelayNormal
}

func (m *_CharacterStringValue) GetReliabilityEvaluationInhibit() OptionalProperty {
	return m.ReliabilityEvaluationInhibit
}

func (m *_CharacterStringValue) GetPropertyList() ReadableProperty {
	return m.PropertyList
}

func (m *_CharacterStringValue) GetCurrentCommandPriority() OptionalProperty {
	return m.CurrentCommandPriority
}

func (m *_CharacterStringValue) GetValueSource() OptionalProperty {
	return m.ValueSource
}

func (m *_CharacterStringValue) GetValueSourceArray() OptionalProperty {
	return m.ValueSourceArray
}

func (m *_CharacterStringValue) GetLastCommandTime() OptionalProperty {
	return m.LastCommandTime
}

func (m *_CharacterStringValue) GetCommandTimeArray() OptionalProperty {
	return m.CommandTimeArray
}

func (m *_CharacterStringValue) GetTags() OptionalProperty {
	return m.Tags
}

func (m *_CharacterStringValue) GetProfileLocation() OptionalProperty {
	return m.ProfileLocation
}

func (m *_CharacterStringValue) GetProfileName() OptionalProperty {
...
func CastCharacterStringValue(structType any) CharacterStringValue {
	if casted, ok := structType.(CharacterStringValue); ok {
		return casted
	}
	if casted, ok := structType.(*CharacterStringValue); ok {
		return *casted
...
func (m *_CharacterStringValue) GetTypeName() string {
	return "CharacterStringValue"
}

func (m *_CharacterStringValue) GetLengthInBits(ctx context.Context) uint16 {
...
func (m *_CharacterStringValue) GetLengthInBytes(ctx context.Context) uint16 {
	return m.GetLengthInBits(ctx) / 8
}

func CharacterStringValueParse(ctx context.Context, theBytes []byte) (CharacterStringValue, error) {
	return CharacterStringValueParseWithBuffer(ctx, utils.NewReadBufferByteBased(theBytes))
}

func CharacterStringValueParseWithBufferProducer() func(ctx context.Context, readBuffer utils.ReadBuffer) (CharacterStringValue, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (CharacterStringValue, error) {
		return CharacterStringValueParseWithBuffer(ctx, readBuffer)
	}
}

func CharacterStringValueParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (CharacterStringValue, error) {
	v, err := (&_CharacterStringValue{}).parse(ctx, readBuffer)
	if err != nil {
		return nil, err
	}
	return v, nil
...
func (m *_CharacterStringValue) parse(ctx context.Context, readBuffer utils.ReadBuffer) (__characterStringValue CharacterStringValue, err error) {
	...
	presentValue, err := ReadSimpleField[ReadableProperty](ctx, "presentValue", ReadComplex[ReadableProperty](ReadablePropertyParseWithBufferProducer((string)("CharacterString")), readBuffer))
	if err != nil {
	...
	relinquishDefault, err := ReadSimpleField[OptionalProperty](ctx, "relinquishDefault", ReadComplex[OptionalProperty](OptionalPropertyParseWithBufferProducer((string)("CharacterString")), readBuffer))
	if err != nil {
	...
	alarmValues, err := ReadSimpleField[OptionalProperty](ctx, "alarmValues", ReadComplex[OptionalProperty](OptionalPropertyParseWithBufferProducer((string)("BACnetARRAY[N] of BACnetOptionalCharacterString")), readBuffer))
	if err != nil {
		return nil, errors.Wrap(err, fmt.Sprintf("Error parsing 'alarmValues' field"))
	}
	m.AlarmValues = alarmValues

	faultValues, err := ReadSimpleField[OptionalProperty](ctx, "faultValues", ReadComplex[OptionalProperty](OptionalPropertyParseWithBufferProducer((string)("BACnetARRAY[N] of BACnetOptionalCharacterString")), readBuffer))
	if err != nil {
...
func (m *_CharacterStringValue) Serialize() ([]byte, error) {
...
func (m *_CharacterStringValue) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
...
func (m *_CharacterStringValue) IsCharacterStringValue() {}

func (m *_CharacterStringValue) DeepCopy() any {
	return m.deepCopy()
}

func (m *_CharacterStringValue) deepCopy() *_CharacterStringValue {
	if m == nil {
		return nil
	}
	_CharacterStringValueCopy := &_CharacterStringValue{
	...
	return _CharacterStringValueCopy
}

func (m *_CharacterStringValue) String() string {
	if m == nil {
		return "<nil>"
	}
