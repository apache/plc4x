...
type BACnetServiceAckAtomicReadFileStreamOrRecordParent interface {
	SerializeParent(writeBuffer utils.WriteBuffer, child BACnetServiceAckAtomicReadFileStreamOrRecord, serializeChildFunction func() error) error
	GetTypeName() string
}
...
func (m *_BACnetServiceAckAtomicReadFileStreamOrRecord) GetParentLengthInBits() uint16 {
...
func (m *_BACnetServiceAckAtomicReadFileStreamOrRecord) GetLengthInBytes() uint16 {
...
func BACnetServiceAckAtomicReadFileStreamOrRecordParse(theBytes []byte) (BACnetServiceAckAtomicReadFileStreamOrRecord, error) {
	return BACnetServiceAckAtomicReadFileStreamOrRecordParseWithBuffer(utils.NewReadBufferByteBased(theBytes))
}
