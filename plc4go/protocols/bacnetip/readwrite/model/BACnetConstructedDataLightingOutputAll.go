...
func (m *_BACnetConstructedDataLightingOutputAllBuilder) WithMandatoryFields() BACnetConstructedDataLightingOutputAllBuilder {
	return m
}

func (m *_BACnetConstructedDataLightingOutputAllBuilder) Build() (BACnetConstructedDataLightingOutputAll, error) {
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._BACnetConstructedDataLightingOutputAll.deepCopy(), nil
}

func (m *_BACnetConstructedDataLightingOutputAllBuilder) MustBuild() BACnetConstructedDataLightingOutputAll {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetConstructedDataLightingOutputAllBuilder) DeepCopy() any {
	return m.CreateBACnetConstructedDataLightingOutputAllBuilder()
}

// CreateBACnetConstructedDataLightingOutputAllBuilder creates a BACnetConstructedDataLightingOutputAllBuilder
func (m *_BACnetConstructedDataLightingOutputAll) CreateBACnetConstructedDataLightingOutputAllBuilder() BACnetConstructedDataLightingOutputAllBuilder {
	if m == nil {
		return NewBACnetConstructedDataLightingOutputAllBuilder()
	}
	return &_BACnetConstructedDataLightingOutputAllBuilder{_BACnetConstructedDataLightingOutputAll: m.deepCopy()}
}
