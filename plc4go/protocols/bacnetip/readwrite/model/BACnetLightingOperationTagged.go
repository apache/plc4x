...
// BACnetLightingOperationTagged is the data-structure of this message
type BACnetLightingOperationTagged struct {
...
// IBACnetLightingOperationTagged is the corresponding interface of BACnetLightingOperationTagged
type IBACnetLightingOperationTagged interface {
...
func (m *BACnetLightingOperationTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetLightingOperationTagged) GetValue() BACnetLightingOperation {
	return m.Value
}

func (m *BACnetLightingOperationTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetLightingOperationTagged) GetIsProprietary() bool {
...
// NewBACnetLightingOperationTagged factory function for BACnetLightingOperationTagged
func NewBACnetLightingOperationTagged(header *BACnetTagHeader, value BACnetLightingOperation, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetLightingOperationTagged {
	return &BACnetLightingOperationTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetLightingOperationTagged) GetTypeName() string {
	return "BACnetLightingOperationTagged"
}

func (m *BACnetLightingOperationTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetLightingOperationTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetLightingOperationTagged) GetLengthInBytes() uint16 {
...
func BACnetLightingOperationTaggedParse(readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (*BACnetLightingOperationTagged, error) {
	...
	// Create the instance
	return NewBACnetLightingOperationTagged(header, value, proprietaryValue, tagNumber, tagClass), nil
}

func (m *BACnetLightingOperationTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetLightingOperationTagged) String() string {
	if m == nil {
		return "<nil>"
	}
