...
func (m *_BACnetLightingOperationTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetLightingOperationTagged) GetLengthInBytes(ctx context.Context) uint64 {
