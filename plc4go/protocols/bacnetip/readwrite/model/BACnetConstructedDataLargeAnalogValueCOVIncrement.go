...
func (m *BACnetConstructedDataLargeAnalogValueCOVIncrement) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag) {
...
func NewBACnetConstructedDataLargeAnalogValueCOVIncrement(covIncrement *BACnetApplicationTagDouble, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag, tagNumber uint8) *BACnetConstructedDataLargeAnalogValueCOVIncrement {
