...
func (m *_BACnetConstructedDataPowerMode) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataPowerMode) GetLengthInBytes(ctx context.Context) uint64 {
