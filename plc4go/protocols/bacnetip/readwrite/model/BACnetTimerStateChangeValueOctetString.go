...
func (m *_BACnetTimerStateChangeValueOctetString) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetTimerStateChangeValue, objectTypeArgument BACnetObjectType) (_bACnetTimerStateChangeValueOctetString BACnetTimerStateChangeValueOctetString, err error) {
