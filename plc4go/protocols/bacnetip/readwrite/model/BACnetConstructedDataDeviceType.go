...
func (m *_BACnetConstructedDataDeviceTypeBuilder) WithMandatoryFields(deviceType BACnetApplicationTagCharacterString) BACnetConstructedDataDeviceTypeBuilder {
	return m.WithDeviceType(deviceType)
}

func (m *_BACnetConstructedDataDeviceTypeBuilder) WithDeviceType(deviceType BACnetApplicationTagCharacterString) BACnetConstructedDataDeviceTypeBuilder {
	m.DeviceType = deviceType
	return m
}

func (m *_BACnetConstructedDataDeviceTypeBuilder) WithDeviceTypeBuilder(builderSupplier func(BACnetApplicationTagCharacterStringBuilder) BACnetApplicationTagCharacterStringBuilder) BACnetConstructedDataDeviceTypeBuilder {
	builder := builderSupplier(m.DeviceType.CreateBACnetApplicationTagCharacterStringBuilder())
	var err error
	m.DeviceType, err = builder.Build()
	if err != nil {
		if m.err == nil {
...
func (m *_BACnetConstructedDataDeviceTypeBuilder) Build() (BACnetConstructedDataDeviceType, error) {
	if m.DeviceType == nil {
		if m.err == nil {
			m.err = new(utils.MultiError)
		}
		m.err.Append(errors.New("mandatory field 'deviceType' not set"))
	}
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._BACnetConstructedDataDeviceType.deepCopy(), nil
}

func (m *_BACnetConstructedDataDeviceTypeBuilder) MustBuild() BACnetConstructedDataDeviceType {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetConstructedDataDeviceTypeBuilder) DeepCopy() any {
	return m.CreateBACnetConstructedDataDeviceTypeBuilder()
}

// CreateBACnetConstructedDataDeviceTypeBuilder creates a BACnetConstructedDataDeviceTypeBuilder
func (m *_BACnetConstructedDataDeviceType) CreateBACnetConstructedDataDeviceTypeBuilder() BACnetConstructedDataDeviceTypeBuilder {
	if m == nil {
		return NewBACnetConstructedDataDeviceTypeBuilder()
	}
	return &_BACnetConstructedDataDeviceTypeBuilder{_BACnetConstructedDataDeviceType: m.deepCopy()}
}
