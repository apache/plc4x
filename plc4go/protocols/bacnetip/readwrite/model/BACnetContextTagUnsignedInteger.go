...
func BACnetContextTagUnsignedIntegerParseWithBufferProducer(header BACnetTagHeader, tagNumberArgument uint8, dataType BACnetDataType) func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetContextTagUnsignedInteger, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetContextTagUnsignedInteger, error) {
		return BACnetContextTagUnsignedIntegerParseWithBuffer(ctx, readBuffer, header, tagNumberArgument, dataType)
	}
}
