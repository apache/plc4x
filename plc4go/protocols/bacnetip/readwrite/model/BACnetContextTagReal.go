...
func (m *_BACnetContextTagReal) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetContextTag, tagNumberArgument uint8, dataType BACnetDataType) (_bACnetContextTagReal BACnetContextTagReal, err error) {
