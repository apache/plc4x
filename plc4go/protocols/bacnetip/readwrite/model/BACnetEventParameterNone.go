...
func (m *_BACnetEventParameterNone) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetEventParameterNone) GetLengthInBytes(ctx context.Context) uint64 {
