...
func (m *_BACnetConstructedDataAccessEvent) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataAccessEvent) GetLengthInBytes(ctx context.Context) uint64 {
