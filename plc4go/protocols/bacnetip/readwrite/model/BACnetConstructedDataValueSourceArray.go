...
func (m *_BACnetConstructedDataValueSourceArray) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataValueSourceArray) GetLengthInBytes(ctx context.Context) uint64 {
