...
func (m *BACnetConstructedDataValueSourceArray) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag) {
...
func (m *BACnetConstructedDataValueSourceArray) GetNumberOfDataElements() *BACnetApplicationTagUnsignedInteger {
...
func (m *BACnetConstructedDataValueSourceArray) GetZero() uint64 {
...
func NewBACnetConstructedDataValueSourceArray(numberOfDataElements *BACnetApplicationTagUnsignedInteger, vtClassesSupported []*BACnetValueSource, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag, tagNumber uint8, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) *BACnetConstructedDataValueSourceArray {
...
func BACnetConstructedDataValueSourceArrayParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) (*BACnetConstructedDataValueSourceArray, error) {
	...
	if !(bool(bool((arrayIndexArgument) != (nil))) || bool(bool((len(vtClassesSupported)) == (16)))) {
		return nil, utils.ParseValidationError{"vtClassesSupported should have exactly 16 values"}
	}
