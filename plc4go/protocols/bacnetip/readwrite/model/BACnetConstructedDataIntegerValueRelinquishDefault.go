...
func (m *_BACnetConstructedDataIntegerValueRelinquishDefault) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataIntegerValueRelinquishDefault) GetLengthInBytes(ctx context.Context) uint64 {
