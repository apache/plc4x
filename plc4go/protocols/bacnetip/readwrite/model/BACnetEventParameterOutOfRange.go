...
func (m *_BACnetEventParameterOutOfRange) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetEventParameter) (_bACnetEventParameterOutOfRange BACnetEventParameterOutOfRange, err error) {
