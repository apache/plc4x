...
// IBACnetActionTagged is the corresponding interface of BACnetActionTagged
type IBACnetActionTagged interface {
...
func (m *BACnetActionTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetActionTagged) GetValue() BACnetAction {
	return m.Value
}
...
func (m *BACnetActionTagged) GetTypeName() string {
	return "BACnetActionTagged"
}

func (m *BACnetActionTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetActionTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetActionTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetActionTagged) String() string {
	if m == nil {
		return "<nil>"
	}
