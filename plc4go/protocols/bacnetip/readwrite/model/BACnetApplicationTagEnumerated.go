...
func (m *_BACnetApplicationTagEnumerated) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetApplicationTagEnumerated) GetLengthInBytes(ctx context.Context) uint64 {
