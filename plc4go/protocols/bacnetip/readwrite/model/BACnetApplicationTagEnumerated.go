...
func (m *_BACnetApplicationTagEnumerated) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetApplicationTag, header BACnetTagHeader) (_bACnetApplicationTagEnumerated BACnetApplicationTagEnumerated, err error) {
