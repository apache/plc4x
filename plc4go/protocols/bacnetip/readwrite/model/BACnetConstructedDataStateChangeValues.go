...
func (m *BACnetConstructedDataStateChangeValues) GetNumberOfDataElements() *BACnetApplicationTagUnsignedInteger {
...
func (m *BACnetConstructedDataStateChangeValues) GetZero() uint64 {
...
func NewBACnetConstructedDataStateChangeValues(numberOfDataElements *BACnetApplicationTagUnsignedInteger, stateChangeValues []*BACnetTimerStateChangeValue, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag, tagNumber uint8, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) *BACnetConstructedDataStateChangeValues {
