...
func (m *_BACnetConstructedDataCredentialDataInputPresentValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataCredentialDataInputPresentValue) GetLengthInBytes(ctx context.Context) uint64 {
