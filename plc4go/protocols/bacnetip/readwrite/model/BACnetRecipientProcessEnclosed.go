...
func (m *_BACnetRecipientProcessEnclosed) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetRecipientProcessEnclosed) GetLengthInBytes(ctx context.Context) uint64 {
