...
func (m *_BACnetEventParameterSignedOutOfRange) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetEventParameter) (_bACnetEventParameterSignedOutOfRange BACnetEventParameterSignedOutOfRange, err error) {
