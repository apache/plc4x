...
func (m *_BACnetConstructedDataVendorName) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataVendorName) GetLengthInBytes(ctx context.Context) uint64 {
