...
func (m *_BACnetHostAddressEnclosed) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (_bACnetHostAddressEnclosed BACnetHostAddressEnclosed, err error) {
