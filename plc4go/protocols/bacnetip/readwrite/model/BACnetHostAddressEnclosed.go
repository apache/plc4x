...
func (m *_BACnetHostAddressEnclosed) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetHostAddressEnclosed) GetLengthInBytes(ctx context.Context) uint64 {
