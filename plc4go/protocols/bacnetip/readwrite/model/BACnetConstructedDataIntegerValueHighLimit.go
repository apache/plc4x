...
func (m *_BACnetConstructedDataIntegerValueHighLimitBuilder) WithMandatoryFields(highLimit BACnetApplicationTagSignedInteger) BACnetConstructedDataIntegerValueHighLimitBuilder {
	return m.WithHighLimit(highLimit)
}

func (m *_BACnetConstructedDataIntegerValueHighLimitBuilder) WithHighLimit(highLimit BACnetApplicationTagSignedInteger) BACnetConstructedDataIntegerValueHighLimitBuilder {
	m.HighLimit = highLimit
	return m
}

func (m *_BACnetConstructedDataIntegerValueHighLimitBuilder) WithHighLimitBuilder(builderSupplier func(BACnetApplicationTagSignedIntegerBuilder) BACnetApplicationTagSignedIntegerBuilder) BACnetConstructedDataIntegerValueHighLimitBuilder {
	builder := builderSupplier(m.HighLimit.CreateBACnetApplicationTagSignedIntegerBuilder())
	var err error
...
func (m *_BACnetConstructedDataIntegerValueHighLimitBuilder) Build() (BACnetConstructedDataIntegerValueHighLimit, error) {
	if m.HighLimit == nil {
		if m.err == nil {
	...
	return m._BACnetConstructedDataIntegerValueHighLimit.deepCopy(), nil
}

func (m *_BACnetConstructedDataIntegerValueHighLimitBuilder) MustBuild() BACnetConstructedDataIntegerValueHighLimit {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetConstructedDataIntegerValueHighLimitBuilder) DeepCopy() any {
	return m.CreateBACnetConstructedDataIntegerValueHighLimitBuilder()
}

// CreateBACnetConstructedDataIntegerValueHighLimitBuilder creates a BACnetConstructedDataIntegerValueHighLimitBuilder
func (m *_BACnetConstructedDataIntegerValueHighLimit) CreateBACnetConstructedDataIntegerValueHighLimitBuilder() BACnetConstructedDataIntegerValueHighLimitBuilder {
	if m == nil {
		return NewBACnetConstructedDataIntegerValueHighLimitBuilder()
	}
	return &_BACnetConstructedDataIntegerValueHighLimitBuilder{_BACnetConstructedDataIntegerValueHighLimit: m.deepCopy()}
}
...
func (m *_BACnetConstructedDataIntegerValueHighLimit) deepCopy() *_BACnetConstructedDataIntegerValueHighLimit {
	...
	_BACnetConstructedDataIntegerValueHighLimitCopy := &_BACnetConstructedDataIntegerValueHighLimit{
		...
		m.HighLimit.DeepCopy().(BACnetApplicationTagSignedInteger),
	}
