...
func (m *BACnetConstructedDataIPDHCPLeaseTime) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag) {
...
func (m *BACnetConstructedDataIPDHCPLeaseTime) GetActualValue() *BACnetApplicationTagUnsignedInteger {
...
func (m *BACnetConstructedDataIPDHCPLeaseTime) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		_ipDhcpLeaseTimeErr := writeBuffer.WriteSerializable(m.IpDhcpLeaseTime)
