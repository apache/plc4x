...
// BACnetConstructedDataIPDHCPLeaseTime is the data-structure of this message
type BACnetConstructedDataIPDHCPLeaseTime struct {
...
type IBACnetConstructedDataIPDHCPLeaseTime interface {
...
func (m *BACnetConstructedDataIPDHCPLeaseTime) GetObjectTypeArgument() BACnetObjectType {
	return 0
}

func (m *BACnetConstructedDataIPDHCPLeaseTime) GetPropertyIdentifierArgument() BACnetPropertyIdentifier {
...
func (m *BACnetConstructedDataIPDHCPLeaseTime) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag) {
	m.BACnetConstructedData.OpeningTag = openingTag
	m.BACnetConstructedData.ClosingTag = closingTag
}

func (m *BACnetConstructedDataIPDHCPLeaseTime) GetParent() *BACnetConstructedData {
...
func (m *BACnetConstructedDataIPDHCPLeaseTime) GetIpDhcpLeaseTime() *BACnetApplicationTagUnsignedInteger {
...
func NewBACnetConstructedDataIPDHCPLeaseTime(ipDhcpLeaseTime *BACnetApplicationTagUnsignedInteger, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag, tagNumber uint8) *BACnetConstructedDataIPDHCPLeaseTime {
...
func CastBACnetConstructedDataIPDHCPLeaseTime(structType interface{}) *BACnetConstructedDataIPDHCPLeaseTime {
	...
	if casted, ok := structType.(BACnetConstructedData); ok {
		return CastBACnetConstructedDataIPDHCPLeaseTime(casted.Child)
	}
	if casted, ok := structType.(*BACnetConstructedData); ok {
		return CastBACnetConstructedDataIPDHCPLeaseTime(casted.Child)
	}
...
func (m *BACnetConstructedDataIPDHCPLeaseTime) GetTypeName() string {
	return "BACnetConstructedDataIPDHCPLeaseTime"
}

func (m *BACnetConstructedDataIPDHCPLeaseTime) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetConstructedDataIPDHCPLeaseTime) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetConstructedDataIPDHCPLeaseTime) GetLengthInBytes() uint16 {
...
func BACnetConstructedDataIPDHCPLeaseTimeParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier) (*BACnetConstructedDataIPDHCPLeaseTime, error) {
	...
	if _ipDhcpLeaseTimeErr != nil {
		return nil, errors.Wrap(_ipDhcpLeaseTimeErr, "Error parsing 'ipDhcpLeaseTime' field")
	}
	ipDhcpLeaseTime := CastBACnetApplicationTagUnsignedInteger(_ipDhcpLeaseTime)
	...
	_child := &BACnetConstructedDataIPDHCPLeaseTime{
		IpDhcpLeaseTime:       CastBACnetApplicationTagUnsignedInteger(ipDhcpLeaseTime),
...
func (m *BACnetConstructedDataIPDHCPLeaseTime) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		_ipDhcpLeaseTimeErr := m.IpDhcpLeaseTime.Serialize(writeBuffer)
...
func (m *BACnetConstructedDataIPDHCPLeaseTime) String() string {
	if m == nil {
		return "<nil>"
	}
