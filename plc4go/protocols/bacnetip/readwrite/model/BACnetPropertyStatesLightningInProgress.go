...
func (m *_BACnetPropertyStatesLightningInProgress) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesLightningInProgress) GetLengthInBytes(ctx context.Context) uint64 {
