...
func NewBACnetConstructedDataAnalogValueFaultLowLimit(openingTag BACnetOpeningTag, peekedTagHeader BACnetTagHeader, closingTag BACnetClosingTag, faultLowLimit BACnetApplicationTagReal) *_BACnetConstructedDataAnalogValueFaultLowLimit {
...
func (m *_BACnetConstructedDataAnalogValueFaultLowLimit) GetPlx4xTypeName() string {
	return "BACnetConstructedDataAnalogValueFaultLowLimit"
}

func (m *_BACnetConstructedDataAnalogValueFaultLowLimit) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataAnalogValueFaultLowLimit) GetLengthInBytes(ctx context.Context) uint64 {
