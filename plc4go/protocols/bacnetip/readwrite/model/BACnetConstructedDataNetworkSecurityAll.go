...
func NewBACnetConstructedDataNetworkSecurityAll(openingTag BACnetOpeningTag, peekedTagHeader BACnetTagHeader, closingTag BACnetClosingTag) *_BACnetConstructedDataNetworkSecurityAll {
...
func (m *_BACnetConstructedDataNetworkSecurityAll) GetPlx4xTypeName() string {
	return "BACnetConstructedDataNetworkSecurityAll"
}

func (m *_BACnetConstructedDataNetworkSecurityAll) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.BACnetConstructedDataContract.(*_BACnetConstructedData).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_BACnetConstructedDataNetworkSecurityAll) GetLengthInBytes(ctx context.Context) uint64 {
