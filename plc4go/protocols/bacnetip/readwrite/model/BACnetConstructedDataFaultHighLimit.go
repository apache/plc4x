...
func (m *_BACnetConstructedDataFaultHighLimit) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *_BACnetConstructedDataFaultHighLimit) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *_BACnetConstructedDataFaultHighLimit) GetLengthInBytes() uint16 {
