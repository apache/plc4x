...
// BACnetLoggingTypeTagged is the data-structure of this message
type BACnetLoggingTypeTagged struct {
...
// IBACnetLoggingTypeTagged is the corresponding interface of BACnetLoggingTypeTagged
type IBACnetLoggingTypeTagged interface {
...
func (m *BACnetLoggingTypeTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetLoggingTypeTagged) GetValue() BACnetLoggingType {
	return m.Value
}

func (m *BACnetLoggingTypeTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetLoggingTypeTagged) GetIsProprietary() bool {
...
// NewBACnetLoggingTypeTagged factory function for BACnetLoggingTypeTagged
func NewBACnetLoggingTypeTagged(header *BACnetTagHeader, value BACnetLoggingType, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetLoggingTypeTagged {
	return &BACnetLoggingTypeTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetLoggingTypeTagged) GetTypeName() string {
	return "BACnetLoggingTypeTagged"
}

func (m *BACnetLoggingTypeTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetLoggingTypeTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetLoggingTypeTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetLoggingTypeTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetLoggingTypeTagged) String() string {
	if m == nil {
		return "<nil>"
	}
