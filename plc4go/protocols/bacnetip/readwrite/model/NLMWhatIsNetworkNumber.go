...
func (m *_NLMWhatIsNetworkNumberBuilder) WithMandatoryFields() NLMWhatIsNetworkNumberBuilder {
	return m
}

func (m *_NLMWhatIsNetworkNumberBuilder) Build() (NLMWhatIsNetworkNumber, error) {
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._NLMWhatIsNetworkNumber.deepCopy(), nil
}

func (m *_NLMWhatIsNetworkNumberBuilder) MustBuild() NLMWhatIsNetworkNumber {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_NLMWhatIsNetworkNumberBuilder) DeepCopy() any {
	return m.CreateNLMWhatIsNetworkNumberBuilder()
}

// CreateNLMWhatIsNetworkNumberBuilder creates a NLMWhatIsNetworkNumberBuilder
func (m *_NLMWhatIsNetworkNumber) CreateNLMWhatIsNetworkNumberBuilder() NLMWhatIsNetworkNumberBuilder {
	if m == nil {
		return NewNLMWhatIsNetworkNumberBuilder()
	}
	return &_NLMWhatIsNetworkNumberBuilder{_NLMWhatIsNetworkNumber: m.deepCopy()}
}
