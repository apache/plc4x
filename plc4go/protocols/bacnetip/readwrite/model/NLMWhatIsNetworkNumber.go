...
func (m *_NLMWhatIsNetworkNumber) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_NLM, apduLength uint16) (_nLMWhatIsNetworkNumber NLMWhatIsNetworkNumber, err error) {
