...
func (m *_BACnetApplicationTagUnsignedInteger) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetApplicationTag, header BACnetTagHeader) (_bACnetApplicationTagUnsignedInteger BACnetApplicationTagUnsignedInteger, err error) {
