...
func (m *_BACnetApplicationTagUnsignedInteger) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetApplicationTagUnsignedInteger) GetLengthInBytes(ctx context.Context) uint64 {
