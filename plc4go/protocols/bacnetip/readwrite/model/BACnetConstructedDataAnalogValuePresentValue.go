...
func (m *_BACnetConstructedDataAnalogValuePresentValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataAnalogValuePresentValue) GetLengthInBytes(ctx context.Context) uint64 {
