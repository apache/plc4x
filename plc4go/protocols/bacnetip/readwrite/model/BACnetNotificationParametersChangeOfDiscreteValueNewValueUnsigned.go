...
func (m *_BACnetNotificationParametersChangeOfDiscreteValueNewValueUnsigned) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetNotificationParametersChangeOfDiscreteValueNewValue, tagNumber uint8) (_bACnetNotificationParametersChangeOfDiscreteValueNewValueUnsigned BACnetNotificationParametersChangeOfDiscreteValueNewValueUnsigned, err error) {
