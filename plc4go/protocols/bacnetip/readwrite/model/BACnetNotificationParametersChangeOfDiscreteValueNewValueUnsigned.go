...
func BACnetNotificationParametersChangeOfDiscreteValueNewValueUnsignedParse(theBytes []byte, tagNumber uint8) (BACnetNotificationParametersChangeOfDiscreteValueNewValueUnsigned, error) {
	return BACnetNotificationParametersChangeOfDiscreteValueNewValueUnsignedParseWithBuffer(utils.NewReadBufferByteBased(theBytes), tagNumber)
}
...
func (m *_BACnetNotificationParametersChangeOfDiscreteValueNewValueUnsigned) SerializeWithWriteBuffer(writeBuffer utils.WriteBuffer) error {
