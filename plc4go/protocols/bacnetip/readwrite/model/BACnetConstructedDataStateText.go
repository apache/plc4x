...
func (m *_BACnetConstructedDataStateText) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataStateText) GetLengthInBytes(ctx context.Context) uint64 {
