...
func (m *_BACnetLifeSafetyOperationTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetLifeSafetyOperationTagged) GetLengthInBytes(ctx context.Context) uint64 {
