...
// BACnetLifeSafetyOperationTagged is the data-structure of this message
type BACnetLifeSafetyOperationTagged struct {
...
// IBACnetLifeSafetyOperationTagged is the corresponding interface of BACnetLifeSafetyOperationTagged
type IBACnetLifeSafetyOperationTagged interface {
...
func (m *BACnetLifeSafetyOperationTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetLifeSafetyOperationTagged) GetValue() BACnetLifeSafetyOperation {
	return m.Value
}

func (m *BACnetLifeSafetyOperationTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetLifeSafetyOperationTagged) GetIsProprietary() bool {
...
// NewBACnetLifeSafetyOperationTagged factory function for BACnetLifeSafetyOperationTagged
func NewBACnetLifeSafetyOperationTagged(header *BACnetTagHeader, value BACnetLifeSafetyOperation, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetLifeSafetyOperationTagged {
	return &BACnetLifeSafetyOperationTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetLifeSafetyOperationTagged) GetTypeName() string {
	return "BACnetLifeSafetyOperationTagged"
}

func (m *BACnetLifeSafetyOperationTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetLifeSafetyOperationTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetLifeSafetyOperationTagged) GetLengthInBytes() uint16 {
	return m.GetLengthInBits() / 8
}

func BACnetLifeSafetyOperationTaggedParse(readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (*BACnetLifeSafetyOperationTagged, error) {
	...
	// Create the instance
	return NewBACnetLifeSafetyOperationTagged(header, value, proprietaryValue, tagNumber, tagClass), nil
}

func (m *BACnetLifeSafetyOperationTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetLifeSafetyOperationTagged) String() string {
	if m == nil {
		return "<nil>"
	}
