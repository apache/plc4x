...
func NewBACnetConstructedDataSystemStatus(openingTag BACnetOpeningTag, peekedTagHeader BACnetTagHeader, closingTag BACnetClosingTag, systemStatus BACnetDeviceStatusTagged) *_BACnetConstructedDataSystemStatus {
	if systemStatus == nil {
...
func (m *_BACnetConstructedDataSystemStatus) GetPlx4xTypeName() string {
	return "BACnetConstructedDataSystemStatus"
}

func (m *_BACnetConstructedDataSystemStatus) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataSystemStatus) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataSystemStatus) deepCopy() *_BACnetConstructedDataSystemStatus {
	...
	_BACnetConstructedDataSystemStatusCopy.BACnetConstructedDataContract.(*_BACnetConstructedData)._SubType = m
