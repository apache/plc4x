...
func (m *_BACnetConstructedDataAPDUTimeout) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataAPDUTimeout) GetLengthInBytes(ctx context.Context) uint64 {
