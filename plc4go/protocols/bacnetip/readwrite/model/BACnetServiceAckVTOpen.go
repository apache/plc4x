...
func (m *_BACnetServiceAckVTOpen) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetServiceAck, serviceAckLength uint32) (_bACnetServiceAckVTOpen BACnetServiceAckVTOpen, err error) {
