...
func (m *_BACnetEventParameterUnsignedRange) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetEventParameterUnsignedRange) GetLengthInBytes(ctx context.Context) uint64 {
