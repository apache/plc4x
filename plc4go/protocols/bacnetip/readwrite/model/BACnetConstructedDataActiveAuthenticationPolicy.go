...
func (m *BACnetConstructedDataActiveAuthenticationPolicy) GetActualValue() *BACnetApplicationTagUnsignedInteger {
...
func (m *BACnetConstructedDataActiveAuthenticationPolicy) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		_activeAuthenticationPolicyErr := writeBuffer.WriteSerializable(m.ActiveAuthenticationPolicy)
