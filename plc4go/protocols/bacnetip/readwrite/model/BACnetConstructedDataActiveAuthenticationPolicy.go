...
func (m *BACnetConstructedDataActiveAuthenticationPolicy) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag) {
...
func NewBACnetConstructedDataActiveAuthenticationPolicy(activeAuthenticationPolicy *BACnetApplicationTagUnsignedInteger, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag, tagNumber uint8) *BACnetConstructedDataActiveAuthenticationPolicy {
