...
func (m *_BACnetFaultParameterFaultExtendedParametersEntryReference) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetFaultParameterFaultExtendedParametersEntry) (_bACnetFaultParameterFaultExtendedParametersEntryReference BACnetFaultParameterFaultExtendedParametersEntryReference, err error) {
