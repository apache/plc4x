...
func (m *_BACnetConstructedDataCarDoorZone) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataCarDoorZone) GetLengthInBytes(ctx context.Context) uint64 {
