...
func (m *_BACnetPropertyStatesLightningTransition) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesLightningTransition) GetLengthInBytes(ctx context.Context) uint64 {
