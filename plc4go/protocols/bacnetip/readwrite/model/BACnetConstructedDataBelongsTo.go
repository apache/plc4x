...
func (m *_BACnetConstructedDataBelongsTo) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataBelongsTo) GetLengthInBytes(ctx context.Context) uint64 {
