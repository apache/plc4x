...
func (m *_BACnetEventSummariesList) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetEventSummariesList) GetLengthInBytes(ctx context.Context) uint64 {
