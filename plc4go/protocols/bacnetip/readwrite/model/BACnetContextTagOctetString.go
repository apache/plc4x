...
func (m *_BACnetContextTagOctetString) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetContextTagOctetString) GetLengthInBytes(ctx context.Context) uint64 {
