...
func (m *_BACnetConstructedDataAuthorizationModeBuilder) WithMandatoryFields(authorizationMode BACnetAuthorizationModeTagged) BACnetConstructedDataAuthorizationModeBuilder {
	return m.WithAuthorizationMode(authorizationMode)
}

func (m *_BACnetConstructedDataAuthorizationModeBuilder) WithAuthorizationMode(authorizationMode BACnetAuthorizationModeTagged) BACnetConstructedDataAuthorizationModeBuilder {
	m.AuthorizationMode = authorizationMode
	return m
}

func (m *_BACnetConstructedDataAuthorizationModeBuilder) WithAuthorizationModeBuilder(builderSupplier func(BACnetAuthorizationModeTaggedBuilder) BACnetAuthorizationModeTaggedBuilder) BACnetConstructedDataAuthorizationModeBuilder {
	builder := builderSupplier(m.AuthorizationMode.CreateBACnetAuthorizationModeTaggedBuilder())
	var err error
	m.AuthorizationMode, err = builder.Build()
	if err != nil {
		if m.err == nil {
			m.err = &utils.MultiError{MainError: errors.New("sub builder failed")}
		}
		m.err.Append(errors.Wrap(err, "BACnetAuthorizationModeTaggedBuilder failed"))
	}
	return m
}

func (m *_BACnetConstructedDataAuthorizationModeBuilder) Build() (BACnetConstructedDataAuthorizationMode, error) {
	if m.AuthorizationMode == nil {
		if m.err == nil {
			m.err = new(utils.MultiError)
		}
		m.err.Append(errors.New("mandatory field 'authorizationMode' not set"))
	}
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._BACnetConstructedDataAuthorizationMode.deepCopy(), nil
}

func (m *_BACnetConstructedDataAuthorizationModeBuilder) MustBuild() BACnetConstructedDataAuthorizationMode {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetConstructedDataAuthorizationModeBuilder) DeepCopy() any {
	return m.CreateBACnetConstructedDataAuthorizationModeBuilder()
}

// CreateBACnetConstructedDataAuthorizationModeBuilder creates a BACnetConstructedDataAuthorizationModeBuilder
func (m *_BACnetConstructedDataAuthorizationMode) CreateBACnetConstructedDataAuthorizationModeBuilder() BACnetConstructedDataAuthorizationModeBuilder {
	if m == nil {
		return NewBACnetConstructedDataAuthorizationModeBuilder()
	}
	return &_BACnetConstructedDataAuthorizationModeBuilder{_BACnetConstructedDataAuthorizationMode: m.deepCopy()}
}
