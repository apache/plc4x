...
func (m *_BACnetFaultParameterFaultStateListOfFaultValues) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetFaultParameterFaultStateListOfFaultValues) GetLengthInBytes(ctx context.Context) uint64 {
