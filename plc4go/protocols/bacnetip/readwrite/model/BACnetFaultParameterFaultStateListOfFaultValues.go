...
func (m *_BACnetFaultParameterFaultStateListOfFaultValues) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (_bACnetFaultParameterFaultStateListOfFaultValues BACnetFaultParameterFaultStateListOfFaultValues, err error) {
