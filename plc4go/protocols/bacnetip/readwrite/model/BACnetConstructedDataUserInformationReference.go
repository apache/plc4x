...
func (m *_BACnetConstructedDataUserInformationReference) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataUserInformationReference) GetLengthInBytes(ctx context.Context) uint64 {
