...
func BACnetEventParameterDoubleOutOfRangeParse(theBytes []byte) (BACnetEventParameterDoubleOutOfRange, error) {
	return BACnetEventParameterDoubleOutOfRangeParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian))) // TODO: get endianness from mspec
}

func BACnetEventParameterDoubleOutOfRangeParseWithBuffer(readBuffer utils.ReadBuffer) (BACnetEventParameterDoubleOutOfRange, error) {
	...
	_openingTag, _openingTagErr := BACnetOpeningTagParseWithBuffer(readBuffer, uint8(uint8(14)))
	...
	_lowLimit, _lowLimitErr := BACnetContextTagParseWithBuffer(readBuffer, uint8(uint8(1)), BACnetDataType(BACnetDataType_DOUBLE))
	if _lowLimitErr != nil {
	...
	_highLimit, _highLimitErr := BACnetContextTagParseWithBuffer(readBuffer, uint8(uint8(2)), BACnetDataType(BACnetDataType_DOUBLE))
	...
	_deadband, _deadbandErr := BACnetContextTagParseWithBuffer(readBuffer, uint8(uint8(3)), BACnetDataType(BACnetDataType_DOUBLE))
	if _deadbandErr != nil {
	...
	_closingTag, _closingTagErr := BACnetClosingTagParseWithBuffer(readBuffer, uint8(uint8(14)))
...
func (m *_BACnetEventParameterDoubleOutOfRange) SerializeWithWriteBuffer(writeBuffer utils.WriteBuffer) error {
