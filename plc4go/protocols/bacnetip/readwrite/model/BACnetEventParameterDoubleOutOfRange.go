...
func (m *_BACnetEventParameterDoubleOutOfRange) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetEventParameter) (_bACnetEventParameterDoubleOutOfRange BACnetEventParameterDoubleOutOfRange, err error) {
