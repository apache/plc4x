...
func (m *_BACnetConstructedDataLogBuffer) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataLogBuffer) GetLengthInBytes(ctx context.Context) uint64 {
