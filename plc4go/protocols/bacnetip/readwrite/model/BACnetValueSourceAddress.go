...
func (m *_BACnetValueSourceAddress) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetValueSource) (_bACnetValueSourceAddress BACnetValueSourceAddress, err error) {
