...
func (m *_BACnetValueSourceAddress) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.BACnetValueSourceContract.(*_BACnetValueSource).getLengthInBits(ctx))
...
func (m *_BACnetValueSourceAddress) GetLengthInBytes(ctx context.Context) uint64 {
