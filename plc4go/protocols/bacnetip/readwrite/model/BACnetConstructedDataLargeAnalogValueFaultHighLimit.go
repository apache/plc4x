...
func (m *BACnetConstructedDataLargeAnalogValueFaultHighLimit) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag) {
...
func NewBACnetConstructedDataLargeAnalogValueFaultHighLimit(faultHighLimit *BACnetApplicationTagDouble, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag, tagNumber uint8) *BACnetConstructedDataLargeAnalogValueFaultHighLimit {
