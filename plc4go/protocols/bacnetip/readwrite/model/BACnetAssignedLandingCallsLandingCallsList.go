...
func BACnetAssignedLandingCallsLandingCallsListParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (BACnetAssignedLandingCallsLandingCallsList, error) {
	v, err := (&_BACnetAssignedLandingCallsLandingCallsList{}).parse(ctx, readBuffer, tagNumber)
	if err != nil {
		return nil, err
	}
	return v, err
...
func (m *_BACnetAssignedLandingCallsLandingCallsList) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (_bACnetAssignedLandingCallsLandingCallsList BACnetAssignedLandingCallsLandingCallsList, err error) {
