...
func (m *_SubscribeCOVPropertyMultipleErrorFirstFailedSubscription) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (_subscribeCOVPropertyMultipleErrorFirstFailedSubscription SubscribeCOVPropertyMultipleErrorFirstFailedSubscription, err error) {
