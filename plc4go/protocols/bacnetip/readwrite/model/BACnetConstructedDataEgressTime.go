...
func (m *_BACnetConstructedDataEgressTimeBuilder) WithMandatoryFields(egressTime BACnetApplicationTagUnsignedInteger) BACnetConstructedDataEgressTimeBuilder {
	return m.WithEgressTime(egressTime)
}

func (m *_BACnetConstructedDataEgressTimeBuilder) WithEgressTime(egressTime BACnetApplicationTagUnsignedInteger) BACnetConstructedDataEgressTimeBuilder {
	m.EgressTime = egressTime
	return m
}

func (m *_BACnetConstructedDataEgressTimeBuilder) WithEgressTimeBuilder(builderSupplier func(BACnetApplicationTagUnsignedIntegerBuilder) BACnetApplicationTagUnsignedIntegerBuilder) BACnetConstructedDataEgressTimeBuilder {
	builder := builderSupplier(m.EgressTime.CreateBACnetApplicationTagUnsignedIntegerBuilder())
	var err error
	m.EgressTime, err = builder.Build()
	if err != nil {
		if m.err == nil {
...
func (m *_BACnetConstructedDataEgressTimeBuilder) Build() (BACnetConstructedDataEgressTime, error) {
	if m.EgressTime == nil {
		if m.err == nil {
			m.err = new(utils.MultiError)
		}
		m.err.Append(errors.New("mandatory field 'egressTime' not set"))
	}
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._BACnetConstructedDataEgressTime.deepCopy(), nil
}

func (m *_BACnetConstructedDataEgressTimeBuilder) MustBuild() BACnetConstructedDataEgressTime {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetConstructedDataEgressTimeBuilder) DeepCopy() any {
	return m.CreateBACnetConstructedDataEgressTimeBuilder()
}

// CreateBACnetConstructedDataEgressTimeBuilder creates a BACnetConstructedDataEgressTimeBuilder
func (m *_BACnetConstructedDataEgressTime) CreateBACnetConstructedDataEgressTimeBuilder() BACnetConstructedDataEgressTimeBuilder {
	if m == nil {
		return NewBACnetConstructedDataEgressTimeBuilder()
	}
	return &_BACnetConstructedDataEgressTimeBuilder{_BACnetConstructedDataEgressTime: m.deepCopy()}
}
