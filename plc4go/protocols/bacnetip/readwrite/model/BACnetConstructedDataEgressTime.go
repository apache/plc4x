...
func (m *_BACnetConstructedDataEgressTime) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataEgressTime) GetLengthInBytes(ctx context.Context) uint64 {
