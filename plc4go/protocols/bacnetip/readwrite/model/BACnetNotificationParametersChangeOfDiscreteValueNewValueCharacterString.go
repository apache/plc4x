...
func (m *_BACnetNotificationParametersChangeOfDiscreteValueNewValueCharacterString) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetNotificationParametersChangeOfDiscreteValueNewValue, tagNumber uint8) (_bACnetNotificationParametersChangeOfDiscreteValueNewValueCharacterString BACnetNotificationParametersChangeOfDiscreteValueNewValueCharacterString, err error) {
