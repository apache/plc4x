...
func (m *_BACnetTimerStateChangeValueInteger) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetTimerStateChangeValueInteger) GetLengthInBytes(ctx context.Context) uint64 {
