...
// BACnetTimerStateChangeValueInteger is the data-structure of this message
type BACnetTimerStateChangeValueInteger struct {
...
// IBACnetTimerStateChangeValueInteger is the corresponding interface of BACnetTimerStateChangeValueInteger
type IBACnetTimerStateChangeValueInteger interface {
...
func (m *BACnetTimerStateChangeValueInteger) InitializeParent(parent *BACnetTimerStateChangeValue, peekedTagHeader *BACnetTagHeader) {
	m.BACnetTimerStateChangeValue.PeekedTagHeader = peekedTagHeader
}

func (m *BACnetTimerStateChangeValueInteger) GetParent() *BACnetTimerStateChangeValue {
...
func (m *BACnetTimerStateChangeValueInteger) GetIntegerValue() *BACnetApplicationTagSignedInteger {
...
// NewBACnetTimerStateChangeValueInteger factory function for BACnetTimerStateChangeValueInteger
func NewBACnetTimerStateChangeValueInteger(integerValue *BACnetApplicationTagSignedInteger, peekedTagHeader *BACnetTagHeader, objectTypeArgument BACnetObjectType) *BACnetTimerStateChangeValueInteger {
	_result := &BACnetTimerStateChangeValueInteger{
...
func CastBACnetTimerStateChangeValueInteger(structType interface{}) *BACnetTimerStateChangeValueInteger {
	...
	if casted, ok := structType.(BACnetTimerStateChangeValue); ok {
		return CastBACnetTimerStateChangeValueInteger(casted.Child)
	}
	if casted, ok := structType.(*BACnetTimerStateChangeValue); ok {
		return CastBACnetTimerStateChangeValueInteger(casted.Child)
	}
...
func (m *BACnetTimerStateChangeValueInteger) GetTypeName() string {
	return "BACnetTimerStateChangeValueInteger"
}

func (m *BACnetTimerStateChangeValueInteger) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetTimerStateChangeValueInteger) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetTimerStateChangeValueInteger) GetLengthInBytes() uint16 {
...
func BACnetTimerStateChangeValueIntegerParse(readBuffer utils.ReadBuffer, objectTypeArgument BACnetObjectType) (*BACnetTimerStateChangeValueInteger, error) {
	...
	_child := &BACnetTimerStateChangeValueInteger{
...
func (m *BACnetTimerStateChangeValueInteger) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetTimerStateChangeValueInteger) String() string {
	if m == nil {
		return "<nil>"
	}
