...
func (m *_BACnetReadAccessSpecification) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_bACnetReadAccessSpecification BACnetReadAccessSpecification, err error) {
