...
func (m *_BACnetReadAccessSpecification) GetPlx4xTypeName() string {
	return "BACnetReadAccessSpecification"
}

func (m *_BACnetReadAccessSpecification) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetReadAccessSpecification) GetLengthInBytes(ctx context.Context) uint64 {
...
func BACnetReadAccessSpecificationParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetReadAccessSpecification, error) {
	v, err := (new(_BACnetReadAccessSpecification)).parse(ctx, readBuffer)
	if err != nil {
		return nil, err
	}
	return v, nil
