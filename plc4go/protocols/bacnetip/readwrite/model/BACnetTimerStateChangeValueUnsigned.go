...
func (m *_BACnetTimerStateChangeValueUnsigned) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetTimerStateChangeValueUnsigned) GetLengthInBytes(ctx context.Context) uint64 {
