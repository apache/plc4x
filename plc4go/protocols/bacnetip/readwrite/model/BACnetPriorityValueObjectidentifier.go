...
func BACnetPriorityValueObjectidentifierParseWithBufferProducer(objectTypeArgument BACnetObjectType) func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetPriorityValueObjectidentifier, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetPriorityValueObjectidentifier, error) {
		return BACnetPriorityValueObjectidentifierParseWithBuffer(ctx, readBuffer, objectTypeArgument)
	}
}
