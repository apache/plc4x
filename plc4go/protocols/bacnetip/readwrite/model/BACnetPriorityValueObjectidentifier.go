...
func (m *_BACnetPriorityValueObjectidentifier) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPriorityValueObjectidentifier) GetLengthInBytes(ctx context.Context) uint64 {
