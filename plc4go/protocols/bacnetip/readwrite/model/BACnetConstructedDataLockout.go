...
func (m *_BACnetConstructedDataLockout) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataLockout) GetLengthInBytes(ctx context.Context) uint64 {
