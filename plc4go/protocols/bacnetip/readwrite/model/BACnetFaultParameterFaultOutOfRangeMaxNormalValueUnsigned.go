...
func (m *_BACnetFaultParameterFaultOutOfRangeMaxNormalValueUnsignedBuilder) WithMandatoryFields(unsignedValue BACnetApplicationTagUnsignedInteger) BACnetFaultParameterFaultOutOfRangeMaxNormalValueUnsignedBuilder {
	return m.WithUnsignedValue(unsignedValue)
}

func (m *_BACnetFaultParameterFaultOutOfRangeMaxNormalValueUnsignedBuilder) WithUnsignedValue(unsignedValue BACnetApplicationTagUnsignedInteger) BACnetFaultParameterFaultOutOfRangeMaxNormalValueUnsignedBuilder {
	m.UnsignedValue = unsignedValue
	return m
}

func (m *_BACnetFaultParameterFaultOutOfRangeMaxNormalValueUnsignedBuilder) WithUnsignedValueBuilder(builderSupplier func(BACnetApplicationTagUnsignedIntegerBuilder) BACnetApplicationTagUnsignedIntegerBuilder) BACnetFaultParameterFaultOutOfRangeMaxNormalValueUnsignedBuilder {
...
func (m *_BACnetFaultParameterFaultOutOfRangeMaxNormalValueUnsignedBuilder) Build() (BACnetFaultParameterFaultOutOfRangeMaxNormalValueUnsigned, error) {
	...
	return m._BACnetFaultParameterFaultOutOfRangeMaxNormalValueUnsigned.deepCopy(), nil
}

func (m *_BACnetFaultParameterFaultOutOfRangeMaxNormalValueUnsignedBuilder) MustBuild() BACnetFaultParameterFaultOutOfRangeMaxNormalValueUnsigned {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetFaultParameterFaultOutOfRangeMaxNormalValueUnsignedBuilder) DeepCopy() any {
	return m.CreateBACnetFaultParameterFaultOutOfRangeMaxNormalValueUnsignedBuilder()
}
...
func (m *_BACnetFaultParameterFaultOutOfRangeMaxNormalValueUnsigned) CreateBACnetFaultParameterFaultOutOfRangeMaxNormalValueUnsignedBuilder() BACnetFaultParameterFaultOutOfRangeMaxNormalValueUnsignedBuilder {
	if m == nil {
		return NewBACnetFaultParameterFaultOutOfRangeMaxNormalValueUnsignedBuilder()
	}
	return &_BACnetFaultParameterFaultOutOfRangeMaxNormalValueUnsignedBuilder{_BACnetFaultParameterFaultOutOfRangeMaxNormalValueUnsigned: m.deepCopy()}
}
