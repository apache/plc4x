...
// TrendLog is the corresponding interface of TrendLog
type TrendLog interface {
	fmt.Stringer
	utils.LengthAware
	utils.Serializable
	utils.Copyable
	...
	GetLogDeviceObjectProperty() OptionalProperty
	// GetLogInterval returns LogInterval (property field)
	GetLogInterval() OptionalProperty
	...
	// IsTrendLog is a marker method to prevent unintentional type checks (interfaces of same signature)
	IsTrendLog()
	// CreateBuilder creates a TrendLogBuilder
	CreateTrendLogBuilder() TrendLogBuilder
}

// _TrendLog is the data-structure of this message
type _TrendLog struct {
	...
	LogDeviceObjectProperty      OptionalProperty
	LogInterval                  OptionalProperty
...
var _ TrendLog = (*_TrendLog)(nil)

// NewTrendLog factory function for _TrendLog
func NewTrendLog(objectIdentifier ReadableProperty, objectName ReadableProperty, objectType ReadableProperty, description OptionalProperty, enable WritableProperty, startTime OptionalProperty, stopTime OptionalProperty, logDeviceObjectProperty OptionalProperty, logInterval OptionalProperty, cOVResubscriptionInterval OptionalProperty, clientCOVIncrement OptionalProperty, stopWhenFull ReadableProperty, bufferSize ReadableProperty, logBuffer ReadableProperty, recordCount WritableProperty, totalRecordCount ReadableProperty, loggingType ReadableProperty, alignIntervals OptionalProperty, intervalOffset OptionalProperty, trigger OptionalProperty, statusFlags ReadableProperty, reliability OptionalProperty, notificationThreshold OptionalProperty, recordsSinceNotification OptionalProperty, lastNotifyRecord OptionalProperty, eventState ReadableProperty, notificationClass OptionalProperty, eventEnable OptionalProperty, ackedTransitions OptionalProperty, notifyType OptionalProperty, eventTimeStamps OptionalProperty, eventMessageTexts OptionalProperty, eventMessageTextsConfig OptionalProperty, eventDetectionEnable OptionalProperty, eventAlgorithmInhibitRef OptionalProperty, eventAlgorithmInhibit OptionalProperty, reliabilityEvaluationInhibit OptionalProperty, propertyList ReadableProperty, tags OptionalProperty, profileLocation OptionalProperty, profileName OptionalProperty) *_TrendLog {
	if objectIdentifier == nil {
		panic("objectIdentifier of type ReadableProperty for TrendLog must not be nil")
	}
	if objectName == nil {
		panic("objectName of type ReadableProperty for TrendLog must not be nil")
	}
	if objectType == nil {
		panic("objectType of type ReadableProperty for TrendLog must not be nil")
	}
	if description == nil {
		panic("description of type OptionalProperty for TrendLog must not be nil")
	}
	if enable == nil {
		panic("enable of type WritableProperty for TrendLog must not be nil")
	}
	if startTime == nil {
		panic("startTime of type OptionalProperty for TrendLog must not be nil")
	}
	if stopTime == nil {
		panic("stopTime of type OptionalProperty for TrendLog must not be nil")
	}
	if logDeviceObjectProperty == nil {
		panic("logDeviceObjectProperty of type OptionalProperty for TrendLog must not be nil")
	}
	if logInterval == nil {
		panic("logInterval of type OptionalProperty for TrendLog must not be nil")
	}
	if cOVResubscriptionInterval == nil {
		panic("cOVResubscriptionInterval of type OptionalProperty for TrendLog must not be nil")
	}
	if clientCOVIncrement == nil {
		panic("clientCOVIncrement of type OptionalProperty for TrendLog must not be nil")
	}
	if stopWhenFull == nil {
		panic("stopWhenFull of type ReadableProperty for TrendLog must not be nil")
	}
	if bufferSize == nil {
		panic("bufferSize of type ReadableProperty for TrendLog must not be nil")
	}
	if logBuffer == nil {
		panic("logBuffer of type ReadableProperty for TrendLog must not be nil")
	}
	if recordCount == nil {
		panic("recordCount of type WritableProperty for TrendLog must not be nil")
	}
	if totalRecordCount == nil {
		panic("totalRecordCount of type ReadableProperty for TrendLog must not be nil")
	}
	if loggingType == nil {
		panic("loggingType of type ReadableProperty for TrendLog must not be nil")
	}
	if alignIntervals == nil {
		panic("alignIntervals of type OptionalProperty for TrendLog must not be nil")
	}
	if intervalOffset == nil {
		panic("intervalOffset of type OptionalProperty for TrendLog must not be nil")
	}
	if trigger == nil {
		panic("trigger of type OptionalProperty for TrendLog must not be nil")
	}
	if statusFlags == nil {
		panic("statusFlags of type ReadableProperty for TrendLog must not be nil")
	}
	if reliability == nil {
		panic("reliability of type OptionalProperty for TrendLog must not be nil")
	}
	if notificationThreshold == nil {
		panic("notificationThreshold of type OptionalProperty for TrendLog must not be nil")
	}
	if recordsSinceNotification == nil {
		panic("recordsSinceNotification of type OptionalProperty for TrendLog must not be nil")
	}
	if lastNotifyRecord == nil {
		panic("lastNotifyRecord of type OptionalProperty for TrendLog must not be nil")
	}
	if eventState == nil {
		panic("eventState of type ReadableProperty for TrendLog must not be nil")
	}
	if notificationClass == nil {
		panic("notificationClass of type OptionalProperty for TrendLog must not be nil")
	}
	if eventEnable == nil {
		panic("eventEnable of type OptionalProperty for TrendLog must not be nil")
	}
	if ackedTransitions == nil {
		panic("ackedTransitions of type OptionalProperty for TrendLog must not be nil")
	}
	if notifyType == nil {
		panic("notifyType of type OptionalProperty for TrendLog must not be nil")
	}
	if eventTimeStamps == nil {
		panic("eventTimeStamps of type OptionalProperty for TrendLog must not be nil")
	}
	if eventMessageTexts == nil {
		panic("eventMessageTexts of type OptionalProperty for TrendLog must not be nil")
	}
	if eventMessageTextsConfig == nil {
		panic("eventMessageTextsConfig of type OptionalProperty for TrendLog must not be nil")
	}
	if eventDetectionEnable == nil {
		panic("eventDetectionEnable of type OptionalProperty for TrendLog must not be nil")
	}
	if eventAlgorithmInhibitRef == nil {
		panic("eventAlgorithmInhibitRef of type OptionalProperty for TrendLog must not be nil")
	}
	if eventAlgorithmInhibit == nil {
		panic("eventAlgorithmInhibit of type OptionalProperty for TrendLog must not be nil")
	}
	if reliabilityEvaluationInhibit == nil {
		panic("reliabilityEvaluationInhibit of type OptionalProperty for TrendLog must not be nil")
	}
	if propertyList == nil {
		panic("propertyList of type ReadableProperty for TrendLog must not be nil")
	}
	if tags == nil {
		panic("tags of type OptionalProperty for TrendLog must not be nil")
	}
	if profileLocation == nil {
		panic("profileLocation of type OptionalProperty for TrendLog must not be nil")
	}
	if profileName == nil {
		panic("profileName of type OptionalProperty for TrendLog must not be nil")
	}
	return &_TrendLog{ObjectIdentifier: objectIdentifier, ObjectName: objectName, ObjectType: objectType, Description: description, Enable: enable, StartTime: startTime, StopTime: stopTime, LogDeviceObjectProperty: logDeviceObjectProperty, LogInterval: logInterval, COVResubscriptionInterval: cOVResubscriptionInterval, ClientCOVIncrement: clientCOVIncrement, StopWhenFull: stopWhenFull, BufferSize: bufferSize, LogBuffer: logBuffer, RecordCount: recordCount, TotalRecordCount: totalRecordCount, LoggingType: loggingType, AlignIntervals: alignIntervals, IntervalOffset: intervalOffset, Trigger: trigger, StatusFlags: statusFlags, Reliability: reliability, NotificationThreshold: notificationThreshold, RecordsSinceNotification: recordsSinceNotification, LastNotifyRecord: lastNotifyRecord, EventState: eventState, NotificationClass: notificationClass, EventEnable: eventEnable, AckedTransitions: ackedTransitions, NotifyType: notifyType, EventTimeStamps: eventTimeStamps, EventMessageTexts: eventMessageTexts, EventMessageTextsConfig: eventMessageTextsConfig, EventDetectionEnable: eventDetectionEnable, EventAlgorithmInhibitRef: eventAlgorithmInhibitRef, EventAlgorithmInhibit: eventAlgorithmInhibit, ReliabilityEvaluationInhibit: reliabilityEvaluationInhibit, PropertyList: propertyList, Tags: tags, ProfileLocation: profileLocation, ProfileName: profileName}
}
...
// TrendLogBuilder is a builder for TrendLog
type TrendLogBuilder interface {
	utils.Copyable
	// WithMandatoryFields adds all mandatory fields (convenience for using multiple builder calls)
	WithMandatoryFields(objectIdentifier ReadableProperty, objectName ReadableProperty, objectType ReadableProperty, description OptionalProperty, enable WritableProperty, startTime OptionalProperty, stopTime OptionalProperty, logDeviceObjectProperty OptionalProperty, logInterval OptionalProperty, cOVResubscriptionInterval OptionalProperty, clientCOVIncrement OptionalProperty, stopWhenFull ReadableProperty, bufferSize ReadableProperty, logBuffer ReadableProperty, recordCount WritableProperty, totalRecordCount ReadableProperty, loggingType ReadableProperty, alignIntervals OptionalProperty, intervalOffset OptionalProperty, trigger OptionalProperty, statusFlags ReadableProperty, reliability OptionalProperty, notificationThreshold OptionalProperty, recordsSinceNotification OptionalProperty, lastNotifyRecord OptionalProperty, eventState ReadableProperty, notificationClass OptionalProperty, eventEnable OptionalProperty, ackedTransitions OptionalProperty, notifyType OptionalProperty, eventTimeStamps OptionalProperty, eventMessageTexts OptionalProperty, eventMessageTextsConfig OptionalProperty, eventDetectionEnable OptionalProperty, eventAlgorithmInhibitRef OptionalProperty, eventAlgorithmInhibit OptionalProperty, reliabilityEvaluationInhibit OptionalProperty, propertyList ReadableProperty, tags OptionalProperty, profileLocation OptionalProperty, profileName OptionalProperty) TrendLogBuilder
	// WithObjectIdentifier adds ObjectIdentifier (property field)
	WithObjectIdentifier(ReadableProperty) TrendLogBuilder
	// WithObjectIdentifierBuilder adds ObjectIdentifier (property field) which is build by the builder
	WithObjectIdentifierBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) TrendLogBuilder
	...
	WithObjectNameBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) TrendLogBuilder
	...
	WithObjectTypeBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) TrendLogBuilder
	// WithDescription adds Description (property field)
	WithDescription(OptionalProperty) TrendLogBuilder
	// WithDescriptionBuilder adds Description (property field) which is build by the builder
	WithDescriptionBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder
	// WithEnable adds Enable (property field)
	WithEnable(WritableProperty) TrendLogBuilder
	// WithEnableBuilder adds Enable (property field) which is build by the builder
	WithEnableBuilder(func(WritablePropertyBuilder) WritablePropertyBuilder) TrendLogBuilder
	// WithStartTime adds StartTime (property field)
	WithStartTime(OptionalProperty) TrendLogBuilder
	// WithStartTimeBuilder adds StartTime (property field) which is build by the builder
	WithStartTimeBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder
	// WithStopTime adds StopTime (property field)
	WithStopTime(OptionalProperty) TrendLogBuilder
	// WithStopTimeBuilder adds StopTime (property field) which is build by the builder
	WithStopTimeBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder
	// WithLogDeviceObjectProperty adds LogDeviceObjectProperty (property field)
	WithLogDeviceObjectProperty(OptionalProperty) TrendLogBuilder
	// WithLogDeviceObjectPropertyBuilder adds LogDeviceObjectProperty (property field) which is build by the builder
	WithLogDeviceObjectPropertyBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder
	// WithLogInterval adds LogInterval (property field)
	WithLogInterval(OptionalProperty) TrendLogBuilder
	// WithLogIntervalBuilder adds LogInterval (property field) which is build by the builder
	WithLogIntervalBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder
	// WithCOVResubscriptionInterval adds COVResubscriptionInterval (property field)
	WithCOVResubscriptionInterval(OptionalProperty) TrendLogBuilder
	// WithCOVResubscriptionIntervalBuilder adds COVResubscriptionInterval (property field) which is build by the builder
	WithCOVResubscriptionIntervalBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder
	// WithClientCOVIncrement adds ClientCOVIncrement (property field)
	WithClientCOVIncrement(OptionalProperty) TrendLogBuilder
	// WithClientCOVIncrementBuilder adds ClientCOVIncrement (property field) which is build by the builder
	WithClientCOVIncrementBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder
	...
	WithStopWhenFullBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) TrendLogBuilder
	...
	WithBufferSizeBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) TrendLogBuilder
	...
	WithLogBufferBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) TrendLogBuilder
	// WithRecordCount adds RecordCount (property field)
	WithRecordCount(WritableProperty) TrendLogBuilder
	// WithRecordCountBuilder adds RecordCount (property field) which is build by the builder
	WithRecordCountBuilder(func(WritablePropertyBuilder) WritablePropertyBuilder) TrendLogBuilder
	...
	WithTotalRecordCountBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) TrendLogBuilder
	// WithLoggingType adds LoggingType (property field)
	WithLoggingType(ReadableProperty) TrendLogBuilder
	// WithLoggingTypeBuilder adds LoggingType (property field) which is build by the builder
	WithLoggingTypeBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) TrendLogBuilder
	// WithAlignIntervals adds AlignIntervals (property field)
	WithAlignIntervals(OptionalProperty) TrendLogBuilder
	// WithAlignIntervalsBuilder adds AlignIntervals (property field) which is build by the builder
	WithAlignIntervalsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder
	// WithIntervalOffset adds IntervalOffset (property field)
	WithIntervalOffset(OptionalProperty) TrendLogBuilder
	// WithIntervalOffsetBuilder adds IntervalOffset (property field) which is build by the builder
	WithIntervalOffsetBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder
	// WithTrigger adds Trigger (property field)
	WithTrigger(OptionalProperty) TrendLogBuilder
	// WithTriggerBuilder adds Trigger (property field) which is build by the builder
	WithTriggerBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder
	...
	WithStatusFlagsBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) TrendLogBuilder
	// WithReliability adds Reliability (property field)
	WithReliability(OptionalProperty) TrendLogBuilder
	// WithReliabilityBuilder adds Reliability (property field) which is build by the builder
	WithReliabilityBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder
	// WithNotificationThreshold adds NotificationThreshold (property field)
	WithNotificationThreshold(OptionalProperty) TrendLogBuilder
	// WithNotificationThresholdBuilder adds NotificationThreshold (property field) which is build by the builder
	WithNotificationThresholdBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder
	// WithRecordsSinceNotification adds RecordsSinceNotification (property field)
	WithRecordsSinceNotification(OptionalProperty) TrendLogBuilder
	// WithRecordsSinceNotificationBuilder adds RecordsSinceNotification (property field) which is build by the builder
	WithRecordsSinceNotificationBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder
	// WithLastNotifyRecord adds LastNotifyRecord (property field)
	WithLastNotifyRecord(OptionalProperty) TrendLogBuilder
	// WithLastNotifyRecordBuilder adds LastNotifyRecord (property field) which is build by the builder
	WithLastNotifyRecordBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder
...
func (b *_TrendLogBuilder) WithObjectName(objectName ReadableProperty) TrendLogBuilder {
	b.ObjectName = objectName
	return b
}

func (b *_TrendLogBuilder) WithObjectNameBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithObjectType(objectType ReadableProperty) TrendLogBuilder {
	b.ObjectType = objectType
	return b
}

func (b *_TrendLogBuilder) WithObjectTypeBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithDescription(description OptionalProperty) TrendLogBuilder {
	b.Description = description
	return b
}

func (b *_TrendLogBuilder) WithDescriptionBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithEnable(enable WritableProperty) TrendLogBuilder {
	b.Enable = enable
	return b
}

func (b *_TrendLogBuilder) WithEnableBuilder(builderSupplier func(WritablePropertyBuilder) WritablePropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithStartTime(startTime OptionalProperty) TrendLogBuilder {
	b.StartTime = startTime
	return b
}

func (b *_TrendLogBuilder) WithStartTimeBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithStopTime(stopTime OptionalProperty) TrendLogBuilder {
	b.StopTime = stopTime
	return b
}

func (b *_TrendLogBuilder) WithStopTimeBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithLogDeviceObjectProperty(logDeviceObjectProperty OptionalProperty) TrendLogBuilder {
	b.LogDeviceObjectProperty = logDeviceObjectProperty
	return b
}

func (b *_TrendLogBuilder) WithLogDeviceObjectPropertyBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
	builder := builderSupplier(b.LogDeviceObjectProperty.CreateOptionalPropertyBuilder())
	var err error
...
func (b *_TrendLogBuilder) WithLogInterval(logInterval OptionalProperty) TrendLogBuilder {
	b.LogInterval = logInterval
	return b
}

func (b *_TrendLogBuilder) WithLogIntervalBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
	builder := builderSupplier(b.LogInterval.CreateOptionalPropertyBuilder())
	var err error
...
func (b *_TrendLogBuilder) WithCOVResubscriptionInterval(cOVResubscriptionInterval OptionalProperty) TrendLogBuilder {
	b.COVResubscriptionInterval = cOVResubscriptionInterval
	return b
}

func (b *_TrendLogBuilder) WithCOVResubscriptionIntervalBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithClientCOVIncrement(clientCOVIncrement OptionalProperty) TrendLogBuilder {
	b.ClientCOVIncrement = clientCOVIncrement
	return b
}

func (b *_TrendLogBuilder) WithClientCOVIncrementBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithStopWhenFull(stopWhenFull ReadableProperty) TrendLogBuilder {
	b.StopWhenFull = stopWhenFull
	return b
}

func (b *_TrendLogBuilder) WithStopWhenFullBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithBufferSize(bufferSize ReadableProperty) TrendLogBuilder {
	b.BufferSize = bufferSize
	return b
}

func (b *_TrendLogBuilder) WithBufferSizeBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithLogBuffer(logBuffer ReadableProperty) TrendLogBuilder {
	b.LogBuffer = logBuffer
	return b
}

func (b *_TrendLogBuilder) WithLogBufferBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithRecordCount(recordCount WritableProperty) TrendLogBuilder {
	b.RecordCount = recordCount
	return b
}

func (b *_TrendLogBuilder) WithRecordCountBuilder(builderSupplier func(WritablePropertyBuilder) WritablePropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithTotalRecordCount(totalRecordCount ReadableProperty) TrendLogBuilder {
	b.TotalRecordCount = totalRecordCount
	return b
}

func (b *_TrendLogBuilder) WithTotalRecordCountBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithLoggingType(loggingType ReadableProperty) TrendLogBuilder {
	b.LoggingType = loggingType
	return b
}

func (b *_TrendLogBuilder) WithLoggingTypeBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithAlignIntervals(alignIntervals OptionalProperty) TrendLogBuilder {
	b.AlignIntervals = alignIntervals
	return b
}

func (b *_TrendLogBuilder) WithAlignIntervalsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithIntervalOffset(intervalOffset OptionalProperty) TrendLogBuilder {
	b.IntervalOffset = intervalOffset
	return b
}

func (b *_TrendLogBuilder) WithIntervalOffsetBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithTrigger(trigger OptionalProperty) TrendLogBuilder {
	b.Trigger = trigger
	return b
}

func (b *_TrendLogBuilder) WithTriggerBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithStatusFlags(statusFlags ReadableProperty) TrendLogBuilder {
	b.StatusFlags = statusFlags
	return b
}

func (b *_TrendLogBuilder) WithStatusFlagsBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithReliability(reliability OptionalProperty) TrendLogBuilder {
	b.Reliability = reliability
	return b
}

func (b *_TrendLogBuilder) WithReliabilityBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithNotificationThreshold(notificationThreshold OptionalProperty) TrendLogBuilder {
	b.NotificationThreshold = notificationThreshold
	return b
}

func (b *_TrendLogBuilder) WithNotificationThresholdBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithRecordsSinceNotification(recordsSinceNotification OptionalProperty) TrendLogBuilder {
	b.RecordsSinceNotification = recordsSinceNotification
	return b
}

func (b *_TrendLogBuilder) WithRecordsSinceNotificationBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithLastNotifyRecord(lastNotifyRecord OptionalProperty) TrendLogBuilder {
	b.LastNotifyRecord = lastNotifyRecord
	return b
}

func (b *_TrendLogBuilder) WithLastNotifyRecordBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithEventState(eventState ReadableProperty) TrendLogBuilder {
	b.EventState = eventState
	return b
}

func (b *_TrendLogBuilder) WithEventStateBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithNotificationClass(notificationClass OptionalProperty) TrendLogBuilder {
	b.NotificationClass = notificationClass
	return b
}

func (b *_TrendLogBuilder) WithNotificationClassBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithEventEnable(eventEnable OptionalProperty) TrendLogBuilder {
	b.EventEnable = eventEnable
	return b
}

func (b *_TrendLogBuilder) WithEventEnableBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithAckedTransitions(ackedTransitions OptionalProperty) TrendLogBuilder {
	b.AckedTransitions = ackedTransitions
	return b
}

func (b *_TrendLogBuilder) WithAckedTransitionsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithNotifyType(notifyType OptionalProperty) TrendLogBuilder {
	b.NotifyType = notifyType
	return b
}

func (b *_TrendLogBuilder) WithNotifyTypeBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithEventTimeStamps(eventTimeStamps OptionalProperty) TrendLogBuilder {
	b.EventTimeStamps = eventTimeStamps
	return b
}

func (b *_TrendLogBuilder) WithEventTimeStampsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithEventMessageTexts(eventMessageTexts OptionalProperty) TrendLogBuilder {
	b.EventMessageTexts = eventMessageTexts
	return b
}

func (b *_TrendLogBuilder) WithEventMessageTextsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithEventMessageTextsConfig(eventMessageTextsConfig OptionalProperty) TrendLogBuilder {
	b.EventMessageTextsConfig = eventMessageTextsConfig
	return b
}

func (b *_TrendLogBuilder) WithEventMessageTextsConfigBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithEventDetectionEnable(eventDetectionEnable OptionalProperty) TrendLogBuilder {
	b.EventDetectionEnable = eventDetectionEnable
	return b
}

func (b *_TrendLogBuilder) WithEventDetectionEnableBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithEventAlgorithmInhibitRef(eventAlgorithmInhibitRef OptionalProperty) TrendLogBuilder {
	b.EventAlgorithmInhibitRef = eventAlgorithmInhibitRef
	return b
}

func (b *_TrendLogBuilder) WithEventAlgorithmInhibitRefBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithEventAlgorithmInhibit(eventAlgorithmInhibit OptionalProperty) TrendLogBuilder {
	b.EventAlgorithmInhibit = eventAlgorithmInhibit
	return b
}

func (b *_TrendLogBuilder) WithEventAlgorithmInhibitBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithReliabilityEvaluationInhibit(reliabilityEvaluationInhibit OptionalProperty) TrendLogBuilder {
	b.ReliabilityEvaluationInhibit = reliabilityEvaluationInhibit
	return b
}

func (b *_TrendLogBuilder) WithReliabilityEvaluationInhibitBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithPropertyList(propertyList ReadableProperty) TrendLogBuilder {
	b.PropertyList = propertyList
	return b
}

func (b *_TrendLogBuilder) WithPropertyListBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithTags(tags OptionalProperty) TrendLogBuilder {
	b.Tags = tags
	return b
}

func (b *_TrendLogBuilder) WithTagsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithProfileLocation(profileLocation OptionalProperty) TrendLogBuilder {
	b.ProfileLocation = profileLocation
	return b
}

func (b *_TrendLogBuilder) WithProfileLocationBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) WithProfileName(profileName OptionalProperty) TrendLogBuilder {
	b.ProfileName = profileName
	return b
}

func (b *_TrendLogBuilder) WithProfileNameBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TrendLogBuilder {
...
func (b *_TrendLogBuilder) Build() (TrendLog, error) {
	...
	return b._TrendLog.deepCopy(), nil
}

func (b *_TrendLogBuilder) MustBuild() TrendLog {
	build, err := b.Build()
	if err != nil {
		panic(err)
	}
...
func (b *_TrendLogBuilder) DeepCopy() any {
	_copy := b.CreateTrendLogBuilder().(*_TrendLogBuilder)
	if b.err != nil {
...
// CreateTrendLogBuilder creates a TrendLogBuilder
func (b *_TrendLog) CreateTrendLogBuilder() TrendLogBuilder {
	if b == nil {
		return NewTrendLogBuilder()
	}
	return &_TrendLogBuilder{_TrendLog: b.deepCopy()}
}
...
func (m *_TrendLog) GetObjectIdentifier() ReadableProperty {
	return m.ObjectIdentifier
}

func (m *_TrendLog) GetObjectName() ReadableProperty {
	return m.ObjectName
}

func (m *_TrendLog) GetObjectType() ReadableProperty {
	return m.ObjectType
}

func (m *_TrendLog) GetDescription() OptionalProperty {
	return m.Description
}

func (m *_TrendLog) GetEnable() WritableProperty {
	return m.Enable
}

func (m *_TrendLog) GetStartTime() OptionalProperty {
	return m.StartTime
}

func (m *_TrendLog) GetStopTime() OptionalProperty {
	return m.StopTime
}

func (m *_TrendLog) GetLogDeviceObjectProperty() OptionalProperty {
	return m.LogDeviceObjectProperty
}

func (m *_TrendLog) GetLogInterval() OptionalProperty {
	return m.LogInterval
}

func (m *_TrendLog) GetCOVResubscriptionInterval() OptionalProperty {
	return m.COVResubscriptionInterval
}

func (m *_TrendLog) GetClientCOVIncrement() OptionalProperty {
	return m.ClientCOVIncrement
}

func (m *_TrendLog) GetStopWhenFull() ReadableProperty {
	return m.StopWhenFull
}

func (m *_TrendLog) GetBufferSize() ReadableProperty {
	return m.BufferSize
}

func (m *_TrendLog) GetLogBuffer() ReadableProperty {
	return m.LogBuffer
}

func (m *_TrendLog) GetRecordCount() WritableProperty {
	return m.RecordCount
}

func (m *_TrendLog) GetTotalRecordCount() ReadableProperty {
	return m.TotalRecordCount
}

func (m *_TrendLog) GetLoggingType() ReadableProperty {
	return m.LoggingType
}

func (m *_TrendLog) GetAlignIntervals() OptionalProperty {
	return m.AlignIntervals
}

func (m *_TrendLog) GetIntervalOffset() OptionalProperty {
	return m.IntervalOffset
}

func (m *_TrendLog) GetTrigger() OptionalProperty {
	return m.Trigger
}

func (m *_TrendLog) GetStatusFlags() ReadableProperty {
	return m.StatusFlags
}

func (m *_TrendLog) GetReliability() OptionalProperty {
	return m.Reliability
}

func (m *_TrendLog) GetNotificationThreshold() OptionalProperty {
	return m.NotificationThreshold
}

func (m *_TrendLog) GetRecordsSinceNotification() OptionalProperty {
	return m.RecordsSinceNotification
}

func (m *_TrendLog) GetLastNotifyRecord() OptionalProperty {
	return m.LastNotifyRecord
}

func (m *_TrendLog) GetEventState() ReadableProperty {
	return m.EventState
}

func (m *_TrendLog) GetNotificationClass() OptionalProperty {
	return m.NotificationClass
}

func (m *_TrendLog) GetEventEnable() OptionalProperty {
	return m.EventEnable
}

func (m *_TrendLog) GetAckedTransitions() OptionalProperty {
	return m.AckedTransitions
}

func (m *_TrendLog) GetNotifyType() OptionalProperty {
	return m.NotifyType
}

func (m *_TrendLog) GetEventTimeStamps() OptionalProperty {
	return m.EventTimeStamps
}

func (m *_TrendLog) GetEventMessageTexts() OptionalProperty {
	return m.EventMessageTexts
}

func (m *_TrendLog) GetEventMessageTextsConfig() OptionalProperty {
	return m.EventMessageTextsConfig
}

func (m *_TrendLog) GetEventDetectionEnable() OptionalProperty {
	return m.EventDetectionEnable
}

func (m *_TrendLog) GetEventAlgorithmInhibitRef() OptionalProperty {
	return m.EventAlgorithmInhibitRef
}

func (m *_TrendLog) GetEventAlgorithmInhibit() OptionalProperty {
	return m.EventAlgorithmInhibit
}

func (m *_TrendLog) GetReliabilityEvaluationInhibit() OptionalProperty {
	return m.ReliabilityEvaluationInhibit
}

func (m *_TrendLog) GetPropertyList() ReadableProperty {
	return m.PropertyList
}

func (m *_TrendLog) GetTags() OptionalProperty {
	return m.Tags
}

func (m *_TrendLog) GetProfileLocation() OptionalProperty {
	return m.ProfileLocation
}

func (m *_TrendLog) GetProfileName() OptionalProperty {
...
func CastTrendLog(structType any) TrendLog {
	if casted, ok := structType.(TrendLog); ok {
		return casted
	}
	if casted, ok := structType.(*TrendLog); ok {
		return *casted
...
func (m *_TrendLog) GetTypeName() string {
	return "TrendLog"
}

func (m *_TrendLog) GetLengthInBits(ctx context.Context) uint16 {
...
func (m *_TrendLog) GetLengthInBytes(ctx context.Context) uint16 {
	return m.GetLengthInBits(ctx) / 8
}

func TrendLogParse(ctx context.Context, theBytes []byte) (TrendLog, error) {
	return TrendLogParseWithBuffer(ctx, utils.NewReadBufferByteBased(theBytes))
}

func TrendLogParseWithBufferProducer() func(ctx context.Context, readBuffer utils.ReadBuffer) (TrendLog, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (TrendLog, error) {
		return TrendLogParseWithBuffer(ctx, readBuffer)
	}
}

func TrendLogParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (TrendLog, error) {
	v, err := (&_TrendLog{}).parse(ctx, readBuffer)
	if err != nil {
		return nil, err
	}
	return v, nil
...
func (m *_TrendLog) parse(ctx context.Context, readBuffer utils.ReadBuffer) (__trendLog TrendLog, err error) {
	positionAware := readBuffer
	_ = positionAware
	if pullErr := readBuffer.PullContext("TrendLog"); pullErr != nil {
		return nil, errors.Wrap(pullErr, "Error pulling for TrendLog")
	}
	...
	logDeviceObjectProperty, err := ReadSimpleField[OptionalProperty](ctx, "logDeviceObjectProperty", ReadComplex[OptionalProperty](OptionalPropertyParseWithBufferProducer((string)("BACnetDeviceObjectPropertyReference")), readBuffer))
	if err != nil {
	...
	logInterval, err := ReadSimpleField[OptionalProperty](ctx, "logInterval", ReadComplex[OptionalProperty](OptionalPropertyParseWithBufferProducer((string)("Unsigned")), readBuffer))
	if err != nil {
	...
	logBuffer, err := ReadSimpleField[ReadableProperty](ctx, "logBuffer", ReadComplex[ReadableProperty](ReadablePropertyParseWithBufferProducer((string)("BACnetLIST of BACnetLogRecord")), readBuffer))
	if err != nil {
	...
	if closeErr := readBuffer.CloseContext("TrendLog"); closeErr != nil {
		return nil, errors.Wrap(closeErr, "Error closing for TrendLog")
	}

	return m, nil
}

func (m *_TrendLog) Serialize() ([]byte, error) {
...
func (m *_TrendLog) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	positionAware := writeBuffer
	_ = positionAware
	log := zerolog.Ctx(ctx)
	_ = log
	if pushErr := writeBuffer.PushContext("TrendLog"); pushErr != nil {
		return errors.Wrap(pushErr, "Error pushing for TrendLog")
	}
	...
	if err := WriteSimpleField[OptionalProperty](ctx, "logDeviceObjectProperty", m.GetLogDeviceObjectProperty(), WriteComplex[OptionalProperty](writeBuffer)); err != nil {
		return errors.Wrap(err, "Error serializing 'logDeviceObjectProperty' field")
	}

	if err := WriteSimpleField[OptionalProperty](ctx, "logInterval", m.GetLogInterval(), WriteComplex[OptionalProperty](writeBuffer)); err != nil {
	...
	if popErr := writeBuffer.PopContext("TrendLog"); popErr != nil {
		return errors.Wrap(popErr, "Error popping for TrendLog")
	}
	return nil
}

func (m *_TrendLog) IsTrendLog() {}

func (m *_TrendLog) DeepCopy() any {
	return m.deepCopy()
}

func (m *_TrendLog) deepCopy() *_TrendLog {
	if m == nil {
		return nil
	}
	_TrendLogCopy := &_TrendLog{
		...
		m.LogDeviceObjectProperty.DeepCopy().(OptionalProperty),
		m.LogInterval.DeepCopy().(OptionalProperty),
	...
	return _TrendLogCopy
}

func (m *_TrendLog) String() string {
	if m == nil {
		return "<nil>"
	}
