...
func (m *_BACnetRecipientEnclosed) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (_bACnetRecipientEnclosed BACnetRecipientEnclosed, err error) {
