...
func (m *_BACnetPropertyStatesNetworkType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesNetworkType) GetLengthInBytes(ctx context.Context) uint64 {
