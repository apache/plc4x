...
func (m *_BACnetPropertyStatesBacnetIpMode) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesBacnetIpMode) GetLengthInBytes(ctx context.Context) uint64 {
