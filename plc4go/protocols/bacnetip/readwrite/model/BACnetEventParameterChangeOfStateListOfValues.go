...
func BACnetEventParameterChangeOfStateListOfValuesParse(theBytes []byte, tagNumber uint8) (BACnetEventParameterChangeOfStateListOfValues, error) {
	return BACnetEventParameterChangeOfStateListOfValuesParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian)), tagNumber) // TODO: get endianness from mspec
}

func BACnetEventParameterChangeOfStateListOfValuesParseWithBuffer(readBuffer utils.ReadBuffer, tagNumber uint8) (BACnetEventParameterChangeOfStateListOfValues, error) {
