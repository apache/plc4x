...
func (m *_BACnetEventParameterChangeOfStateListOfValues) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetEventParameterChangeOfStateListOfValues) GetLengthInBytes(ctx context.Context) uint64 {
