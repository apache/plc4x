...
func (m *_BACnetConstructedDataLastCredentialAdded) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataLastCredentialAdded) GetLengthInBytes(ctx context.Context) uint64 {
