...
// BVLCReadForeignDeviceTable is the data-structure of this message
type BVLCReadForeignDeviceTable struct {
	*BVLC
}

// IBVLCReadForeignDeviceTable is the corresponding interface of BVLCReadForeignDeviceTable
