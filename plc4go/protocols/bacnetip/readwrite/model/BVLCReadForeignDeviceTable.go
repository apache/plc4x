...
func (m *_BVLCReadForeignDeviceTable) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BVLC) (_bVLCReadForeignDeviceTable BVLCReadForeignDeviceTable, err error) {
