...
func (m BACnetAuthenticationStatus) GetLengthInBits(ctx context.Context) uint64 {
	return 8
}

func (m BACnetAuthenticationStatus) GetLengthInBytes(ctx context.Context) uint64 {
...
func BACnetAuthenticationStatusParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetAuthenticationStatus, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint8("BACnetAuthenticationStatus", 8)
	if err != nil {
...
func (e BACnetAuthenticationStatus) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint8("BACnetAuthenticationStatus", 8, uint8(uint8(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}

func (e BACnetAuthenticationStatus) GetValue() uint8 {
	return uint8(e)
}
