...
func (m *_BACnetTimerStateChangeValueObjectidentifier) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetTimerStateChangeValue, objectTypeArgument BACnetObjectType) (_bACnetTimerStateChangeValueObjectidentifier BACnetTimerStateChangeValueObjectidentifier, err error) {
