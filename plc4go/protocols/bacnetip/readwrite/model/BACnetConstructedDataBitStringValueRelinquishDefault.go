...
func (m *_BACnetConstructedDataBitStringValueRelinquishDefault) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataBitStringValueRelinquishDefault) GetLengthInBytes(ctx context.Context) uint64 {
