...
func (m *BACnetConstructedDataSecuredStatus) GetActualValue() *BACnetDoorSecuredStatusTagged {
...
func BACnetConstructedDataSecuredStatusParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) (*BACnetConstructedDataSecuredStatus, error) {
	...
	actualValue := CastBACnetDoorSecuredStatusTagged(_actualValue)
	_ = actualValue
...
func (m *BACnetConstructedDataSecuredStatus) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		_securedStatusErr := writeBuffer.WriteSerializable(m.SecuredStatus)
