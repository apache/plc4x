...
func (m *_BACnetConstructedDataSecuredStatus) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataSecuredStatus) GetLengthInBytes(ctx context.Context) uint64 {
