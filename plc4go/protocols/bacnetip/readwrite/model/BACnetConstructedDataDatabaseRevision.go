...
func (m *_BACnetConstructedDataDatabaseRevision) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataDatabaseRevision) GetLengthInBytes(ctx context.Context) uint64 {
