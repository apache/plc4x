...
func (m *_BACnetConstructedDataUpdateTime) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataUpdateTime) GetLengthInBytes(ctx context.Context) uint64 {
