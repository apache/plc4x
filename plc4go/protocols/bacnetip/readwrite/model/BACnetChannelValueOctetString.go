...
func (m *_BACnetChannelValueOctetString) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetChannelValueOctetString) GetLengthInBytes(ctx context.Context) uint64 {
