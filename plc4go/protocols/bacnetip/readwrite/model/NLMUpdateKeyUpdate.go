...
func (m *_NLMUpdateKeyUpdate) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_NLM, apduLength uint16) (_nLMUpdateKeyUpdate NLMUpdateKeyUpdate, err error) {
