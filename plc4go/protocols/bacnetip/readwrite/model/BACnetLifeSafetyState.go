...
func (m BACnetLifeSafetyState) GetLengthInBits(ctx context.Context) uint64 {
	return 16
}

func (m BACnetLifeSafetyState) GetLengthInBytes(ctx context.Context) uint64 {
...
func (e BACnetLifeSafetyState) GetValue() uint16 {
	return uint16(e)
}
