...
func (m *_BACnetLogRecordLogDatumEnumeratedValue) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetLogRecordLogDatum, tagNumber uint8) (_bACnetLogRecordLogDatumEnumeratedValue BACnetLogRecordLogDatumEnumeratedValue, err error) {
