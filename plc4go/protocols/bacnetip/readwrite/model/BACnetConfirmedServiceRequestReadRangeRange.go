...
func (m *_BACnetConfirmedServiceRequestReadRangeRange) getLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConfirmedServiceRequestReadRangeRange) GetLengthInBytes(ctx context.Context) uint64 {
