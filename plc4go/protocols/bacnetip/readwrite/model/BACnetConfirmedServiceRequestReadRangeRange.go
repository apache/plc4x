...
func (m *_BACnetConfirmedServiceRequestReadRangeRange) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_bACnetConfirmedServiceRequestReadRangeRange BACnetConfirmedServiceRequestReadRangeRange, err error) {
