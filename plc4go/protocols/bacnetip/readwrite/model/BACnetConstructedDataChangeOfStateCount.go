...
func (m *_BACnetConstructedDataChangeOfStateCount) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataChangeOfStateCount) GetLengthInBytes(ctx context.Context) uint64 {
