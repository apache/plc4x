...
func (m *_BACnetApplicationTagBoolean) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetApplicationTagBoolean) GetLengthInBytes(ctx context.Context) uint64 {
