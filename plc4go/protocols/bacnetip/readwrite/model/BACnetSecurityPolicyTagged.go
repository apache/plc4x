...
// BACnetSecurityPolicyTagged is the data-structure of this message
type BACnetSecurityPolicyTagged struct {
...
// IBACnetSecurityPolicyTagged is the corresponding interface of BACnetSecurityPolicyTagged
type IBACnetSecurityPolicyTagged interface {
...
func (m *BACnetSecurityPolicyTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetSecurityPolicyTagged) GetValue() BACnetSecurityPolicy {
	return m.Value
}
...
// NewBACnetSecurityPolicyTagged factory function for BACnetSecurityPolicyTagged
func NewBACnetSecurityPolicyTagged(header *BACnetTagHeader, value BACnetSecurityPolicy, tagNumber uint8, tagClass TagClass) *BACnetSecurityPolicyTagged {
	return &BACnetSecurityPolicyTagged{Header: header, Value: value, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetSecurityPolicyTagged) GetTypeName() string {
	return "BACnetSecurityPolicyTagged"
}

func (m *BACnetSecurityPolicyTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetSecurityPolicyTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetSecurityPolicyTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetSecurityPolicyTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetSecurityPolicyTagged) String() string {
	if m == nil {
		return "<nil>"
	}
