...
func (m *_BACnetConstructedDataCount) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataCount) GetLengthInBytes(ctx context.Context) uint64 {
