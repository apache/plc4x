...
const(
	...
	BACnetVendorId_PARAMETERLLC BACnetVendorId = 70
	...
	BACnetVendorId_ROSEMONT_ENGINEERING_INC BACnetVendorId = 1582
	BACnetVendorId_MINIVEIL_INDUSTRIES_LTD BACnetVendorId = 1583
	BACnetVendorId_PROFCONAB BACnetVendorId = 1584
	BACnetVendorId_KE_AUTOMASJONAS BACnetVendorId = 1585
	BACnetVendorId_NORDOMATIC_PROPERTY_TECHNOLOGIESAB BACnetVendorId = 1586
	...
	BACnetVendorId_<missing IDENTIFIER_LITERAL> BACnetVendorId = 1618
...
func init() {
	...
	BACnetVendorIdValues = []BACnetVendorId {
		...
		BACnetVendorId_<missing IDENTIFIER_LITERAL>,
...
func BACnetVendorIdByValue(value uint16) (enum BACnetVendorId, ok bool) {
	switch value {
		...
		case 1618:
			return BACnetVendorId_<missing IDENTIFIER_LITERAL>, true
		case 1619:
...
func BACnetVendorIdByName(value string) (enum BACnetVendorId, ok bool) {
	...
	case "GPS_AIR":
		return BACnetVendorId_GPS_AIR, true
	case "<missing IDENTIFIER_LITERAL>":
		return BACnetVendorId_<missing IDENTIFIER_LITERAL>, true
...
func (e BACnetVendorId) PLC4XEnumName() string {
	...
	case BACnetVendorId_GPS_AIR:
		return "GPS_AIR"
	case BACnetVendorId_<missing IDENTIFIER_LITERAL>:
		return "<missing IDENTIFIER_LITERAL>"
