...
func (m *_BACnetConstructedDataMemberOfBuilder) WithMandatoryFields(zones []BACnetDeviceObjectReference) BACnetConstructedDataMemberOfBuilder {
	return m.WithZones(zones...)
}

func (m *_BACnetConstructedDataMemberOfBuilder) WithZones(zones ...BACnetDeviceObjectReference) BACnetConstructedDataMemberOfBuilder {
	m.Zones = zones
	return m
}

func (m *_BACnetConstructedDataMemberOfBuilder) Build() (BACnetConstructedDataMemberOf, error) {
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._BACnetConstructedDataMemberOf.deepCopy(), nil
}

func (m *_BACnetConstructedDataMemberOfBuilder) MustBuild() BACnetConstructedDataMemberOf {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetConstructedDataMemberOfBuilder) DeepCopy() any {
	return m.CreateBACnetConstructedDataMemberOfBuilder()
}

// CreateBACnetConstructedDataMemberOfBuilder creates a BACnetConstructedDataMemberOfBuilder
func (m *_BACnetConstructedDataMemberOf) CreateBACnetConstructedDataMemberOfBuilder() BACnetConstructedDataMemberOfBuilder {
	if m == nil {
		return NewBACnetConstructedDataMemberOfBuilder()
	}
	return &_BACnetConstructedDataMemberOfBuilder{_BACnetConstructedDataMemberOf: m.deepCopy()}
}
