...
func (m *_BACnetUnconfirmedServiceRequestIHave) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetUnconfirmedServiceRequest, serviceRequestLength uint16) (_bACnetUnconfirmedServiceRequestIHave BACnetUnconfirmedServiceRequestIHave, err error) {
