...
func (m BACnetEscalatorFault) GetLengthInBits(ctx context.Context) uint64 {
	return 16
}

func (m BACnetEscalatorFault) GetLengthInBytes(ctx context.Context) uint64 {
...
func BACnetEscalatorFaultParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetEscalatorFault, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint16("BACnetEscalatorFault", 16)
	if err != nil {
...
func (e BACnetEscalatorFault) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint16("BACnetEscalatorFault", 16, uint16(uint16(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}

func (e BACnetEscalatorFault) GetValue() uint16 {
	return uint16(e)
}
