...
// BACnetAuthorizationExemptionTagged is the data-structure of this message
type BACnetAuthorizationExemptionTagged struct {
...
// IBACnetAuthorizationExemptionTagged is the corresponding interface of BACnetAuthorizationExemptionTagged
type IBACnetAuthorizationExemptionTagged interface {
...
func (m *BACnetAuthorizationExemptionTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetAuthorizationExemptionTagged) GetValue() BACnetAuthorizationExemption {
	return m.Value
}

func (m *BACnetAuthorizationExemptionTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetAuthorizationExemptionTagged) GetIsProprietary() bool {
...
// NewBACnetAuthorizationExemptionTagged factory function for BACnetAuthorizationExemptionTagged
func NewBACnetAuthorizationExemptionTagged(header *BACnetTagHeader, value BACnetAuthorizationExemption, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetAuthorizationExemptionTagged {
	return &BACnetAuthorizationExemptionTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetAuthorizationExemptionTagged) GetTypeName() string {
	return "BACnetAuthorizationExemptionTagged"
}

func (m *BACnetAuthorizationExemptionTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetAuthorizationExemptionTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetAuthorizationExemptionTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetAuthorizationExemptionTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetAuthorizationExemptionTagged) String() string {
	if m == nil {
		return "<nil>"
	}
