...
func (m *_BACnetAuthorizationExemptionTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetAuthorizationExemptionTagged) GetLengthInBytes(ctx context.Context) uint64 {
