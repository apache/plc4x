...
func (m *_BACnetPropertyStatesSecurityLevel) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetPropertyStates, peekedTagNumber uint8) (_bACnetPropertyStatesSecurityLevel BACnetPropertyStatesSecurityLevel, err error) {
