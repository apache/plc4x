...
func (m *_BACnetPropertyStatesSecurityLevel) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesSecurityLevel) GetLengthInBytes(ctx context.Context) uint64 {
