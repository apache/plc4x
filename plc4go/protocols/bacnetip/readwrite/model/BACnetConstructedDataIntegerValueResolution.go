...
func (m *_BACnetConstructedDataIntegerValueResolution) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataIntegerValueResolution) GetLengthInBytes(ctx context.Context) uint64 {
