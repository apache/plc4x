...
func (m *_BACnetConstructedDataFaultSignals) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataFaultSignals) GetLengthInBytes(ctx context.Context) uint64 {
