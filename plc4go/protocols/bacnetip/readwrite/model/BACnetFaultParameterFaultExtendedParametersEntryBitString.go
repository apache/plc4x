...
func BACnetFaultParameterFaultExtendedParametersEntryBitStringParse(theBytes []byte) (BACnetFaultParameterFaultExtendedParametersEntryBitString, error) {
	return BACnetFaultParameterFaultExtendedParametersEntryBitStringParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian))) // TODO: get endianness from mspec
}
