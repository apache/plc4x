...
func (m *_BACnetFaultParameterFaultExtendedParametersEntryBitString) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetFaultParameterFaultExtendedParametersEntry) (_bACnetFaultParameterFaultExtendedParametersEntryBitString BACnetFaultParameterFaultExtendedParametersEntryBitString, err error) {
