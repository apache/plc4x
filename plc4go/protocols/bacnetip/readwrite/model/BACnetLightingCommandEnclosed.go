...
func (m *_BACnetLightingCommandEnclosed) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetLightingCommandEnclosed) GetLengthInBytes(ctx context.Context) uint64 {
