...
func (m *_BACnetLightingCommandEnclosed) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (_bACnetLightingCommandEnclosed BACnetLightingCommandEnclosed, err error) {
