...
// BACnetConstructedDataAccumulatorHighLimit is the data-structure of this message
type BACnetConstructedDataAccumulatorHighLimit struct {
...
// IBACnetConstructedDataAccumulatorHighLimit is the corresponding interface of BACnetConstructedDataAccumulatorHighLimit
type IBACnetConstructedDataAccumulatorHighLimit interface {
...
func (m *BACnetConstructedDataAccumulatorHighLimit) GetObjectTypeArgument() BACnetObjectType {
	return BACnetObjectType_ACCUMULATOR
}

func (m *BACnetConstructedDataAccumulatorHighLimit) GetPropertyIdentifierArgument() BACnetPropertyIdentifier {
...
func (m *BACnetConstructedDataAccumulatorHighLimit) GetParent() *BACnetConstructedData {
...
func (m *BACnetConstructedDataAccumulatorHighLimit) GetHighLimit() *BACnetApplicationTagUnsignedInteger {
	return m.HighLimit
}
...
func (m *BACnetConstructedDataAccumulatorHighLimit) GetActualValue() *BACnetApplicationTagUnsignedInteger {
...
func NewBACnetConstructedDataAccumulatorHighLimit(highLimit *BACnetApplicationTagUnsignedInteger, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag, tagNumber uint8, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) *BACnetConstructedDataAccumulatorHighLimit {
...
func CastBACnetConstructedDataAccumulatorHighLimit(structType interface{}) *BACnetConstructedDataAccumulatorHighLimit {
	...
	if casted, ok := structType.(BACnetConstructedData); ok {
		return CastBACnetConstructedDataAccumulatorHighLimit(casted.Child)
	}
	if casted, ok := structType.(*BACnetConstructedData); ok {
		return CastBACnetConstructedDataAccumulatorHighLimit(casted.Child)
	}
...
func (m *BACnetConstructedDataAccumulatorHighLimit) GetTypeName() string {
	return "BACnetConstructedDataAccumulatorHighLimit"
}

func (m *BACnetConstructedDataAccumulatorHighLimit) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetConstructedDataAccumulatorHighLimit) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetConstructedDataAccumulatorHighLimit) GetLengthInBytes() uint16 {
...
func BACnetConstructedDataAccumulatorHighLimitParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) (*BACnetConstructedDataAccumulatorHighLimit, error) {
	...
	_child := &BACnetConstructedDataAccumulatorHighLimit{
...
func (m *BACnetConstructedDataAccumulatorHighLimit) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetConstructedDataAccumulatorHighLimit) String() string {
	if m == nil {
		return "<nil>"
	}
