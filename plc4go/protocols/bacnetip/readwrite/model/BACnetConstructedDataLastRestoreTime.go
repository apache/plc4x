...
func (m *_BACnetConstructedDataLastRestoreTimeBuilder) WithLastRestoreTimeBuilder(builderSupplier func(BACnetTimeStampBuilder) BACnetTimeStampBuilder) BACnetConstructedDataLastRestoreTimeBuilder {
	builder := builderSupplier(m.LastRestoreTime.CreateBACnetTimeStampBuilder())
	var err error
	m.LastRestoreTime, err = builder.Build()
	if err != nil {
		if m.err == nil {
