...
// TimePatternValue is the corresponding interface of TimePatternValue
type TimePatternValue interface {
	fmt.Stringer
	utils.LengthAware
	utils.Serializable
	utils.Copyable
	...
	// IsTimePatternValue is a marker method to prevent unintentional type checks (interfaces of same signature)
	IsTimePatternValue()
	// CreateBuilder creates a TimePatternValueBuilder
	CreateTimePatternValueBuilder() TimePatternValueBuilder
}

// _TimePatternValue is the data-structure of this message
type _TimePatternValue struct {
...
var _ TimePatternValue = (*_TimePatternValue)(nil)

// NewTimePatternValue factory function for _TimePatternValue
func NewTimePatternValue(objectIdentifier ReadableProperty, objectName ReadableProperty, objectType ReadableProperty, description OptionalProperty, presentValue ReadableProperty, statusFlags ReadableProperty, eventState OptionalProperty, reliability OptionalProperty, outOfService OptionalProperty, priorityArray OptionalProperty, relinquishDefault OptionalProperty, reliabilityEvaluationInhibit OptionalProperty, propertyList ReadableProperty, eventDetectionEnable OptionalProperty, notificationClass OptionalProperty, eventEnable OptionalProperty, ackedTransitions OptionalProperty, notifyType OptionalProperty, eventTimeStamps OptionalProperty, eventMessageTexts OptionalProperty, eventMessageTextsConfig OptionalProperty, currentCommandPriority OptionalProperty, valueSource OptionalProperty, valueSourceArray OptionalProperty, lastCommandTime OptionalProperty, commandTimeArray OptionalProperty, tags OptionalProperty, profileLocation OptionalProperty, profileName OptionalProperty) *_TimePatternValue {
	if objectIdentifier == nil {
		panic("objectIdentifier of type ReadableProperty for TimePatternValue must not be nil")
	}
	if objectName == nil {
		panic("objectName of type ReadableProperty for TimePatternValue must not be nil")
	}
	if objectType == nil {
		panic("objectType of type ReadableProperty for TimePatternValue must not be nil")
	}
	if description == nil {
		panic("description of type OptionalProperty for TimePatternValue must not be nil")
	}
	if presentValue == nil {
		panic("presentValue of type ReadableProperty for TimePatternValue must not be nil")
	}
	if statusFlags == nil {
		panic("statusFlags of type ReadableProperty for TimePatternValue must not be nil")
	}
	if eventState == nil {
		panic("eventState of type OptionalProperty for TimePatternValue must not be nil")
	}
	if reliability == nil {
		panic("reliability of type OptionalProperty for TimePatternValue must not be nil")
	}
	if outOfService == nil {
		panic("outOfService of type OptionalProperty for TimePatternValue must not be nil")
	}
	if priorityArray == nil {
		panic("priorityArray of type OptionalProperty for TimePatternValue must not be nil")
	}
	if relinquishDefault == nil {
		panic("relinquishDefault of type OptionalProperty for TimePatternValue must not be nil")
	}
	if reliabilityEvaluationInhibit == nil {
		panic("reliabilityEvaluationInhibit of type OptionalProperty for TimePatternValue must not be nil")
	}
	if propertyList == nil {
		panic("propertyList of type ReadableProperty for TimePatternValue must not be nil")
	}
	if eventDetectionEnable == nil {
		panic("eventDetectionEnable of type OptionalProperty for TimePatternValue must not be nil")
	}
	if notificationClass == nil {
		panic("notificationClass of type OptionalProperty for TimePatternValue must not be nil")
	}
	if eventEnable == nil {
		panic("eventEnable of type OptionalProperty for TimePatternValue must not be nil")
	}
	if ackedTransitions == nil {
		panic("ackedTransitions of type OptionalProperty for TimePatternValue must not be nil")
	}
	if notifyType == nil {
		panic("notifyType of type OptionalProperty for TimePatternValue must not be nil")
	}
	if eventTimeStamps == nil {
		panic("eventTimeStamps of type OptionalProperty for TimePatternValue must not be nil")
	}
	if eventMessageTexts == nil {
		panic("eventMessageTexts of type OptionalProperty for TimePatternValue must not be nil")
	}
	if eventMessageTextsConfig == nil {
		panic("eventMessageTextsConfig of type OptionalProperty for TimePatternValue must not be nil")
	}
	if currentCommandPriority == nil {
		panic("currentCommandPriority of type OptionalProperty for TimePatternValue must not be nil")
	}
	if valueSource == nil {
		panic("valueSource of type OptionalProperty for TimePatternValue must not be nil")
	}
	if valueSourceArray == nil {
		panic("valueSourceArray of type OptionalProperty for TimePatternValue must not be nil")
	}
	if lastCommandTime == nil {
		panic("lastCommandTime of type OptionalProperty for TimePatternValue must not be nil")
	}
	if commandTimeArray == nil {
		panic("commandTimeArray of type OptionalProperty for TimePatternValue must not be nil")
	}
	if tags == nil {
		panic("tags of type OptionalProperty for TimePatternValue must not be nil")
	}
	if profileLocation == nil {
		panic("profileLocation of type OptionalProperty for TimePatternValue must not be nil")
	}
	if profileName == nil {
		panic("profileName of type OptionalProperty for TimePatternValue must not be nil")
	}
	return &_TimePatternValue{ObjectIdentifier: objectIdentifier, ObjectName: objectName, ObjectType: objectType, Description: description, PresentValue: presentValue, StatusFlags: statusFlags, EventState: eventState, Reliability: reliability, OutOfService: outOfService, PriorityArray: priorityArray, RelinquishDefault: relinquishDefault, ReliabilityEvaluationInhibit: reliabilityEvaluationInhibit, PropertyList: propertyList, EventDetectionEnable: eventDetectionEnable, NotificationClass: notificationClass, EventEnable: eventEnable, AckedTransitions: ackedTransitions, NotifyType: notifyType, EventTimeStamps: eventTimeStamps, EventMessageTexts: eventMessageTexts, EventMessageTextsConfig: eventMessageTextsConfig, CurrentCommandPriority: currentCommandPriority, ValueSource: valueSource, ValueSourceArray: valueSourceArray, LastCommandTime: lastCommandTime, CommandTimeArray: commandTimeArray, Tags: tags, ProfileLocation: profileLocation, ProfileName: profileName}
}
...
// TimePatternValueBuilder is a builder for TimePatternValue
type TimePatternValueBuilder interface {
	utils.Copyable
	// WithMandatoryFields adds all mandatory fields (convenience for using multiple builder calls)
	WithMandatoryFields(objectIdentifier ReadableProperty, objectName ReadableProperty, objectType ReadableProperty, description OptionalProperty, presentValue ReadableProperty, statusFlags ReadableProperty, eventState OptionalProperty, reliability OptionalProperty, outOfService OptionalProperty, priorityArray OptionalProperty, relinquishDefault OptionalProperty, reliabilityEvaluationInhibit OptionalProperty, propertyList ReadableProperty, eventDetectionEnable OptionalProperty, notificationClass OptionalProperty, eventEnable OptionalProperty, ackedTransitions OptionalProperty, notifyType OptionalProperty, eventTimeStamps OptionalProperty, eventMessageTexts OptionalProperty, eventMessageTextsConfig OptionalProperty, currentCommandPriority OptionalProperty, valueSource OptionalProperty, valueSourceArray OptionalProperty, lastCommandTime OptionalProperty, commandTimeArray OptionalProperty, tags OptionalProperty, profileLocation OptionalProperty, profileName OptionalProperty) TimePatternValueBuilder
	// WithObjectIdentifier adds ObjectIdentifier (property field)
	WithObjectIdentifier(ReadableProperty) TimePatternValueBuilder
	// WithObjectIdentifierBuilder adds ObjectIdentifier (property field) which is build by the builder
	WithObjectIdentifierBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) TimePatternValueBuilder
	// WithObjectName adds ObjectName (property field)
	WithObjectName(ReadableProperty) TimePatternValueBuilder
	// WithObjectNameBuilder adds ObjectName (property field) which is build by the builder
	WithObjectNameBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) TimePatternValueBuilder
	// WithObjectType adds ObjectType (property field)
	WithObjectType(ReadableProperty) TimePatternValueBuilder
	// WithObjectTypeBuilder adds ObjectType (property field) which is build by the builder
	WithObjectTypeBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) TimePatternValueBuilder
	// WithDescription adds Description (property field)
	WithDescription(OptionalProperty) TimePatternValueBuilder
	// WithDescriptionBuilder adds Description (property field) which is build by the builder
	WithDescriptionBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder
	// WithPresentValue adds PresentValue (property field)
	WithPresentValue(ReadableProperty) TimePatternValueBuilder
	// WithPresentValueBuilder adds PresentValue (property field) which is build by the builder
	WithPresentValueBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) TimePatternValueBuilder
	// WithStatusFlags adds StatusFlags (property field)
	WithStatusFlags(ReadableProperty) TimePatternValueBuilder
	// WithStatusFlagsBuilder adds StatusFlags (property field) which is build by the builder
	WithStatusFlagsBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) TimePatternValueBuilder
	// WithEventState adds EventState (property field)
	WithEventState(OptionalProperty) TimePatternValueBuilder
	// WithEventStateBuilder adds EventState (property field) which is build by the builder
	WithEventStateBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder
	// WithReliability adds Reliability (property field)
	WithReliability(OptionalProperty) TimePatternValueBuilder
	// WithReliabilityBuilder adds Reliability (property field) which is build by the builder
	WithReliabilityBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder
	// WithOutOfService adds OutOfService (property field)
	WithOutOfService(OptionalProperty) TimePatternValueBuilder
	// WithOutOfServiceBuilder adds OutOfService (property field) which is build by the builder
	WithOutOfServiceBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder
	// WithPriorityArray adds PriorityArray (property field)
	WithPriorityArray(OptionalProperty) TimePatternValueBuilder
	// WithPriorityArrayBuilder adds PriorityArray (property field) which is build by the builder
	WithPriorityArrayBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder
	// WithRelinquishDefault adds RelinquishDefault (property field)
	WithRelinquishDefault(OptionalProperty) TimePatternValueBuilder
	// WithRelinquishDefaultBuilder adds RelinquishDefault (property field) which is build by the builder
	WithRelinquishDefaultBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder
	// WithReliabilityEvaluationInhibit adds ReliabilityEvaluationInhibit (property field)
	WithReliabilityEvaluationInhibit(OptionalProperty) TimePatternValueBuilder
	// WithReliabilityEvaluationInhibitBuilder adds ReliabilityEvaluationInhibit (property field) which is build by the builder
	WithReliabilityEvaluationInhibitBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder
	// WithPropertyList adds PropertyList (property field)
	WithPropertyList(ReadableProperty) TimePatternValueBuilder
	// WithPropertyListBuilder adds PropertyList (property field) which is build by the builder
	WithPropertyListBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) TimePatternValueBuilder
	// WithEventDetectionEnable adds EventDetectionEnable (property field)
	WithEventDetectionEnable(OptionalProperty) TimePatternValueBuilder
	// WithEventDetectionEnableBuilder adds EventDetectionEnable (property field) which is build by the builder
	WithEventDetectionEnableBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder
	// WithNotificationClass adds NotificationClass (property field)
	WithNotificationClass(OptionalProperty) TimePatternValueBuilder
	// WithNotificationClassBuilder adds NotificationClass (property field) which is build by the builder
	WithNotificationClassBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder
	// WithEventEnable adds EventEnable (property field)
	WithEventEnable(OptionalProperty) TimePatternValueBuilder
	// WithEventEnableBuilder adds EventEnable (property field) which is build by the builder
	WithEventEnableBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder
	// WithAckedTransitions adds AckedTransitions (property field)
	WithAckedTransitions(OptionalProperty) TimePatternValueBuilder
	// WithAckedTransitionsBuilder adds AckedTransitions (property field) which is build by the builder
	WithAckedTransitionsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder
	// WithNotifyType adds NotifyType (property field)
	WithNotifyType(OptionalProperty) TimePatternValueBuilder
	// WithNotifyTypeBuilder adds NotifyType (property field) which is build by the builder
	WithNotifyTypeBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder
	// WithEventTimeStamps adds EventTimeStamps (property field)
	WithEventTimeStamps(OptionalProperty) TimePatternValueBuilder
	// WithEventTimeStampsBuilder adds EventTimeStamps (property field) which is build by the builder
	WithEventTimeStampsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder
	// WithEventMessageTexts adds EventMessageTexts (property field)
	WithEventMessageTexts(OptionalProperty) TimePatternValueBuilder
	// WithEventMessageTextsBuilder adds EventMessageTexts (property field) which is build by the builder
	WithEventMessageTextsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder
	// WithEventMessageTextsConfig adds EventMessageTextsConfig (property field)
	WithEventMessageTextsConfig(OptionalProperty) TimePatternValueBuilder
	// WithEventMessageTextsConfigBuilder adds EventMessageTextsConfig (property field) which is build by the builder
	WithEventMessageTextsConfigBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder
	// WithCurrentCommandPriority adds CurrentCommandPriority (property field)
	WithCurrentCommandPriority(OptionalProperty) TimePatternValueBuilder
	// WithCurrentCommandPriorityBuilder adds CurrentCommandPriority (property field) which is build by the builder
	WithCurrentCommandPriorityBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder
	// WithValueSource adds ValueSource (property field)
	WithValueSource(OptionalProperty) TimePatternValueBuilder
	// WithValueSourceBuilder adds ValueSource (property field) which is build by the builder
	WithValueSourceBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder
	// WithValueSourceArray adds ValueSourceArray (property field)
	WithValueSourceArray(OptionalProperty) TimePatternValueBuilder
	// WithValueSourceArrayBuilder adds ValueSourceArray (property field) which is build by the builder
	WithValueSourceArrayBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder
	// WithLastCommandTime adds LastCommandTime (property field)
	WithLastCommandTime(OptionalProperty) TimePatternValueBuilder
	// WithLastCommandTimeBuilder adds LastCommandTime (property field) which is build by the builder
	WithLastCommandTimeBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder
	// WithCommandTimeArray adds CommandTimeArray (property field)
	WithCommandTimeArray(OptionalProperty) TimePatternValueBuilder
	// WithCommandTimeArrayBuilder adds CommandTimeArray (property field) which is build by the builder
	WithCommandTimeArrayBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder
	// WithTags adds Tags (property field)
	WithTags(OptionalProperty) TimePatternValueBuilder
	// WithTagsBuilder adds Tags (property field) which is build by the builder
	WithTagsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder
	// WithProfileLocation adds ProfileLocation (property field)
	WithProfileLocation(OptionalProperty) TimePatternValueBuilder
	// WithProfileLocationBuilder adds ProfileLocation (property field) which is build by the builder
	WithProfileLocationBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder
	// WithProfileName adds ProfileName (property field)
	WithProfileName(OptionalProperty) TimePatternValueBuilder
	// WithProfileNameBuilder adds ProfileName (property field) which is build by the builder
	WithProfileNameBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder
	// Build builds the TimePatternValue or returns an error if something is wrong
	Build() (TimePatternValue, error)
	// MustBuild does the same as Build but panics on error
	MustBuild() TimePatternValue
}

// NewTimePatternValueBuilder() creates a TimePatternValueBuilder
func NewTimePatternValueBuilder() TimePatternValueBuilder {
	return &_TimePatternValueBuilder{_TimePatternValue: new(_TimePatternValue)}
}

type _TimePatternValueBuilder struct {
	*_TimePatternValue

	err *utils.MultiError
}

var _ (TimePatternValueBuilder) = (*_TimePatternValueBuilder)(nil)

func (b *_TimePatternValueBuilder) WithMandatoryFields(objectIdentifier ReadableProperty, objectName ReadableProperty, objectType ReadableProperty, description OptionalProperty, presentValue ReadableProperty, statusFlags ReadableProperty, eventState OptionalProperty, reliability OptionalProperty, outOfService OptionalProperty, priorityArray OptionalProperty, relinquishDefault OptionalProperty, reliabilityEvaluationInhibit OptionalProperty, propertyList ReadableProperty, eventDetectionEnable OptionalProperty, notificationClass OptionalProperty, eventEnable OptionalProperty, ackedTransitions OptionalProperty, notifyType OptionalProperty, eventTimeStamps OptionalProperty, eventMessageTexts OptionalProperty, eventMessageTextsConfig OptionalProperty, currentCommandPriority OptionalProperty, valueSource OptionalProperty, valueSourceArray OptionalProperty, lastCommandTime OptionalProperty, commandTimeArray OptionalProperty, tags OptionalProperty, profileLocation OptionalProperty, profileName OptionalProperty) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithObjectIdentifier(objectIdentifier ReadableProperty) TimePatternValueBuilder {
	b.ObjectIdentifier = objectIdentifier
	return b
}

func (b *_TimePatternValueBuilder) WithObjectIdentifierBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithObjectName(objectName ReadableProperty) TimePatternValueBuilder {
	b.ObjectName = objectName
	return b
}

func (b *_TimePatternValueBuilder) WithObjectNameBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithObjectType(objectType ReadableProperty) TimePatternValueBuilder {
	b.ObjectType = objectType
	return b
}

func (b *_TimePatternValueBuilder) WithObjectTypeBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithDescription(description OptionalProperty) TimePatternValueBuilder {
	b.Description = description
	return b
}

func (b *_TimePatternValueBuilder) WithDescriptionBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithPresentValue(presentValue ReadableProperty) TimePatternValueBuilder {
	b.PresentValue = presentValue
	return b
}

func (b *_TimePatternValueBuilder) WithPresentValueBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithStatusFlags(statusFlags ReadableProperty) TimePatternValueBuilder {
	b.StatusFlags = statusFlags
	return b
}

func (b *_TimePatternValueBuilder) WithStatusFlagsBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithEventState(eventState OptionalProperty) TimePatternValueBuilder {
	b.EventState = eventState
	return b
}

func (b *_TimePatternValueBuilder) WithEventStateBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithReliability(reliability OptionalProperty) TimePatternValueBuilder {
	b.Reliability = reliability
	return b
}

func (b *_TimePatternValueBuilder) WithReliabilityBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithOutOfService(outOfService OptionalProperty) TimePatternValueBuilder {
	b.OutOfService = outOfService
	return b
}

func (b *_TimePatternValueBuilder) WithOutOfServiceBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithPriorityArray(priorityArray OptionalProperty) TimePatternValueBuilder {
	b.PriorityArray = priorityArray
	return b
}

func (b *_TimePatternValueBuilder) WithPriorityArrayBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithRelinquishDefault(relinquishDefault OptionalProperty) TimePatternValueBuilder {
	b.RelinquishDefault = relinquishDefault
	return b
}

func (b *_TimePatternValueBuilder) WithRelinquishDefaultBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithReliabilityEvaluationInhibit(reliabilityEvaluationInhibit OptionalProperty) TimePatternValueBuilder {
	b.ReliabilityEvaluationInhibit = reliabilityEvaluationInhibit
	return b
}

func (b *_TimePatternValueBuilder) WithReliabilityEvaluationInhibitBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithPropertyList(propertyList ReadableProperty) TimePatternValueBuilder {
	b.PropertyList = propertyList
	return b
}

func (b *_TimePatternValueBuilder) WithPropertyListBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithEventDetectionEnable(eventDetectionEnable OptionalProperty) TimePatternValueBuilder {
	b.EventDetectionEnable = eventDetectionEnable
	return b
}

func (b *_TimePatternValueBuilder) WithEventDetectionEnableBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithNotificationClass(notificationClass OptionalProperty) TimePatternValueBuilder {
	b.NotificationClass = notificationClass
	return b
}

func (b *_TimePatternValueBuilder) WithNotificationClassBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithEventEnable(eventEnable OptionalProperty) TimePatternValueBuilder {
	b.EventEnable = eventEnable
	return b
}

func (b *_TimePatternValueBuilder) WithEventEnableBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithAckedTransitions(ackedTransitions OptionalProperty) TimePatternValueBuilder {
	b.AckedTransitions = ackedTransitions
	return b
}

func (b *_TimePatternValueBuilder) WithAckedTransitionsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithNotifyType(notifyType OptionalProperty) TimePatternValueBuilder {
	b.NotifyType = notifyType
	return b
}

func (b *_TimePatternValueBuilder) WithNotifyTypeBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithEventTimeStamps(eventTimeStamps OptionalProperty) TimePatternValueBuilder {
	b.EventTimeStamps = eventTimeStamps
	return b
}

func (b *_TimePatternValueBuilder) WithEventTimeStampsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithEventMessageTexts(eventMessageTexts OptionalProperty) TimePatternValueBuilder {
	b.EventMessageTexts = eventMessageTexts
	return b
}

func (b *_TimePatternValueBuilder) WithEventMessageTextsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithEventMessageTextsConfig(eventMessageTextsConfig OptionalProperty) TimePatternValueBuilder {
	b.EventMessageTextsConfig = eventMessageTextsConfig
	return b
}

func (b *_TimePatternValueBuilder) WithEventMessageTextsConfigBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithCurrentCommandPriority(currentCommandPriority OptionalProperty) TimePatternValueBuilder {
	b.CurrentCommandPriority = currentCommandPriority
	return b
}

func (b *_TimePatternValueBuilder) WithCurrentCommandPriorityBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithValueSource(valueSource OptionalProperty) TimePatternValueBuilder {
	b.ValueSource = valueSource
	return b
}

func (b *_TimePatternValueBuilder) WithValueSourceBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithValueSourceArray(valueSourceArray OptionalProperty) TimePatternValueBuilder {
	b.ValueSourceArray = valueSourceArray
	return b
}

func (b *_TimePatternValueBuilder) WithValueSourceArrayBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithLastCommandTime(lastCommandTime OptionalProperty) TimePatternValueBuilder {
	b.LastCommandTime = lastCommandTime
	return b
}

func (b *_TimePatternValueBuilder) WithLastCommandTimeBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithCommandTimeArray(commandTimeArray OptionalProperty) TimePatternValueBuilder {
	b.CommandTimeArray = commandTimeArray
	return b
}

func (b *_TimePatternValueBuilder) WithCommandTimeArrayBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithTags(tags OptionalProperty) TimePatternValueBuilder {
	b.Tags = tags
	return b
}

func (b *_TimePatternValueBuilder) WithTagsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithProfileLocation(profileLocation OptionalProperty) TimePatternValueBuilder {
	b.ProfileLocation = profileLocation
	return b
}

func (b *_TimePatternValueBuilder) WithProfileLocationBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) WithProfileName(profileName OptionalProperty) TimePatternValueBuilder {
	b.ProfileName = profileName
	return b
}

func (b *_TimePatternValueBuilder) WithProfileNameBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) TimePatternValueBuilder {
...
func (b *_TimePatternValueBuilder) Build() (TimePatternValue, error) {
	...
	return b._TimePatternValue.deepCopy(), nil
}

func (b *_TimePatternValueBuilder) MustBuild() TimePatternValue {
	build, err := b.Build()
	if err != nil {
		panic(err)
	}
...
func (b *_TimePatternValueBuilder) DeepCopy() any {
	_copy := b.CreateTimePatternValueBuilder().(*_TimePatternValueBuilder)
	if b.err != nil {
...
// CreateTimePatternValueBuilder creates a TimePatternValueBuilder
func (b *_TimePatternValue) CreateTimePatternValueBuilder() TimePatternValueBuilder {
	if b == nil {
		return NewTimePatternValueBuilder()
	}
	return &_TimePatternValueBuilder{_TimePatternValue: b.deepCopy()}
}
...
func (m *_TimePatternValue) GetObjectIdentifier() ReadableProperty {
	return m.ObjectIdentifier
}

func (m *_TimePatternValue) GetObjectName() ReadableProperty {
	return m.ObjectName
}

func (m *_TimePatternValue) GetObjectType() ReadableProperty {
	return m.ObjectType
}

func (m *_TimePatternValue) GetDescription() OptionalProperty {
	return m.Description
}

func (m *_TimePatternValue) GetPresentValue() ReadableProperty {
	return m.PresentValue
}

func (m *_TimePatternValue) GetStatusFlags() ReadableProperty {
	return m.StatusFlags
}

func (m *_TimePatternValue) GetEventState() OptionalProperty {
	return m.EventState
}

func (m *_TimePatternValue) GetReliability() OptionalProperty {
	return m.Reliability
}

func (m *_TimePatternValue) GetOutOfService() OptionalProperty {
	return m.OutOfService
}

func (m *_TimePatternValue) GetPriorityArray() OptionalProperty {
	return m.PriorityArray
}

func (m *_TimePatternValue) GetRelinquishDefault() OptionalProperty {
	return m.RelinquishDefault
}

func (m *_TimePatternValue) GetReliabilityEvaluationInhibit() OptionalProperty {
	return m.ReliabilityEvaluationInhibit
}

func (m *_TimePatternValue) GetPropertyList() ReadableProperty {
	return m.PropertyList
}

func (m *_TimePatternValue) GetEventDetectionEnable() OptionalProperty {
	return m.EventDetectionEnable
}

func (m *_TimePatternValue) GetNotificationClass() OptionalProperty {
	return m.NotificationClass
}

func (m *_TimePatternValue) GetEventEnable() OptionalProperty {
	return m.EventEnable
}

func (m *_TimePatternValue) GetAckedTransitions() OptionalProperty {
	return m.AckedTransitions
}

func (m *_TimePatternValue) GetNotifyType() OptionalProperty {
	return m.NotifyType
}

func (m *_TimePatternValue) GetEventTimeStamps() OptionalProperty {
	return m.EventTimeStamps
}

func (m *_TimePatternValue) GetEventMessageTexts() OptionalProperty {
	return m.EventMessageTexts
}

func (m *_TimePatternValue) GetEventMessageTextsConfig() OptionalProperty {
	return m.EventMessageTextsConfig
}

func (m *_TimePatternValue) GetCurrentCommandPriority() OptionalProperty {
	return m.CurrentCommandPriority
}

func (m *_TimePatternValue) GetValueSource() OptionalProperty {
	return m.ValueSource
}

func (m *_TimePatternValue) GetValueSourceArray() OptionalProperty {
	return m.ValueSourceArray
}

func (m *_TimePatternValue) GetLastCommandTime() OptionalProperty {
	return m.LastCommandTime
}

func (m *_TimePatternValue) GetCommandTimeArray() OptionalProperty {
	return m.CommandTimeArray
}

func (m *_TimePatternValue) GetTags() OptionalProperty {
	return m.Tags
}

func (m *_TimePatternValue) GetProfileLocation() OptionalProperty {
	return m.ProfileLocation
}

func (m *_TimePatternValue) GetProfileName() OptionalProperty {
...
func CastTimePatternValue(structType any) TimePatternValue {
	if casted, ok := structType.(TimePatternValue); ok {
		return casted
	}
	if casted, ok := structType.(*TimePatternValue); ok {
		return *casted
...
func (m *_TimePatternValue) GetTypeName() string {
	return "TimePatternValue"
}

func (m *_TimePatternValue) GetLengthInBits(ctx context.Context) uint16 {
...
func (m *_TimePatternValue) GetLengthInBytes(ctx context.Context) uint16 {
	return m.GetLengthInBits(ctx) / 8
}

func TimePatternValueParse(ctx context.Context, theBytes []byte) (TimePatternValue, error) {
	return TimePatternValueParseWithBuffer(ctx, utils.NewReadBufferByteBased(theBytes))
}

func TimePatternValueParseWithBufferProducer() func(ctx context.Context, readBuffer utils.ReadBuffer) (TimePatternValue, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (TimePatternValue, error) {
		return TimePatternValueParseWithBuffer(ctx, readBuffer)
	}
}

func TimePatternValueParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (TimePatternValue, error) {
	v, err := (&_TimePatternValue{}).parse(ctx, readBuffer)
	if err != nil {
		return nil, err
	}
	return v, nil
...
func (m *_TimePatternValue) parse(ctx context.Context, readBuffer utils.ReadBuffer) (__timePatternValue TimePatternValue, err error) {
	positionAware := readBuffer
	_ = positionAware
	if pullErr := readBuffer.PullContext("TimePatternValue"); pullErr != nil {
		return nil, errors.Wrap(pullErr, "Error pulling for TimePatternValue")
	}
	...
	if closeErr := readBuffer.CloseContext("TimePatternValue"); closeErr != nil {
		return nil, errors.Wrap(closeErr, "Error closing for TimePatternValue")
	}

	return m, nil
}

func (m *_TimePatternValue) Serialize() ([]byte, error) {
...
func (m *_TimePatternValue) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	positionAware := writeBuffer
	_ = positionAware
	log := zerolog.Ctx(ctx)
	_ = log
	if pushErr := writeBuffer.PushContext("TimePatternValue"); pushErr != nil {
		return errors.Wrap(pushErr, "Error pushing for TimePatternValue")
	}
	...
	if popErr := writeBuffer.PopContext("TimePatternValue"); popErr != nil {
		return errors.Wrap(popErr, "Error popping for TimePatternValue")
	}
	return nil
}

func (m *_TimePatternValue) IsTimePatternValue() {}

func (m *_TimePatternValue) DeepCopy() any {
	return m.deepCopy()
}

func (m *_TimePatternValue) deepCopy() *_TimePatternValue {
	if m == nil {
		return nil
	}
	_TimePatternValueCopy := &_TimePatternValue{
	...
	return _TimePatternValueCopy
}

func (m *_TimePatternValue) String() string {
	if m == nil {
		return "<nil>"
	}
