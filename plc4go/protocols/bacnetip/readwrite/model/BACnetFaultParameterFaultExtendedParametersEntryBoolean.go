...
func (m *_BACnetFaultParameterFaultExtendedParametersEntryBoolean) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetFaultParameterFaultExtendedParametersEntry) (_bACnetFaultParameterFaultExtendedParametersEntryBoolean BACnetFaultParameterFaultExtendedParametersEntryBoolean, err error) {
