...
func BACnetHostAddressParse(theBytes []byte) (BACnetHostAddress, error) {
	return BACnetHostAddressParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian))) // TODO: get endianness from mspec
}
