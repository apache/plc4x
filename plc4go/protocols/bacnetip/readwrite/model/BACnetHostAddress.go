...
func (m *_BACnetHostAddress) GetPlx4xTypeName() string {
	return "BACnetHostAddress"
}

func (m *_BACnetHostAddress) getLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetHostAddress) GetLengthInBytes(ctx context.Context) uint64 {
...
func BACnetHostAddressParseWithBuffer[T BACnetHostAddress](ctx context.Context, readBuffer utils.ReadBuffer) (T, error) {
	v, err := (new(_BACnetHostAddress)).parse(ctx, readBuffer)
	if err != nil {
		var zero T
		return zero, err
	}
