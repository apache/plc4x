...
func (m *_BACnetAccessRuleLocationSpecifierTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *_BACnetAccessRuleLocationSpecifierTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *_BACnetAccessRuleLocationSpecifierTagged) GetLengthInBytes() uint16 {
