...
func (m *_BACnetAccessRuleLocationSpecifierTagged) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (_bACnetAccessRuleLocationSpecifierTagged BACnetAccessRuleLocationSpecifierTagged, err error) {
