...
// BACnetTagPayloadCharacterString is the data-structure of this message
...
// IBACnetTagPayloadCharacterString is the corresponding interface of BACnetTagPayloadCharacterString
...
func (m *BACnetTagPayloadCharacterString) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	_encodingErr := writeBuffer.WriteSerializable(m.Encoding)
