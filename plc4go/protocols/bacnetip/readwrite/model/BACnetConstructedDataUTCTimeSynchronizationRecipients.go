...
func (m *_BACnetConstructedDataUTCTimeSynchronizationRecipientsBuilder) WithMandatoryFields(utcTimeSynchronizationRecipients []BACnetRecipient) BACnetConstructedDataUTCTimeSynchronizationRecipientsBuilder {
	return m.WithUtcTimeSynchronizationRecipients(utcTimeSynchronizationRecipients...)
}

func (m *_BACnetConstructedDataUTCTimeSynchronizationRecipientsBuilder) WithUtcTimeSynchronizationRecipients(utcTimeSynchronizationRecipients ...BACnetRecipient) BACnetConstructedDataUTCTimeSynchronizationRecipientsBuilder {
	m.UtcTimeSynchronizationRecipients = utcTimeSynchronizationRecipients
	return m
}

func (m *_BACnetConstructedDataUTCTimeSynchronizationRecipientsBuilder) Build() (BACnetConstructedDataUTCTimeSynchronizationRecipients, error) {
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._BACnetConstructedDataUTCTimeSynchronizationRecipients.deepCopy(), nil
}

func (m *_BACnetConstructedDataUTCTimeSynchronizationRecipientsBuilder) MustBuild() BACnetConstructedDataUTCTimeSynchronizationRecipients {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetConstructedDataUTCTimeSynchronizationRecipientsBuilder) DeepCopy() any {
	return m.CreateBACnetConstructedDataUTCTimeSynchronizationRecipientsBuilder()
}
...
func (m *_BACnetConstructedDataUTCTimeSynchronizationRecipients) CreateBACnetConstructedDataUTCTimeSynchronizationRecipientsBuilder() BACnetConstructedDataUTCTimeSynchronizationRecipientsBuilder {
	if m == nil {
		return NewBACnetConstructedDataUTCTimeSynchronizationRecipientsBuilder()
	}
	return &_BACnetConstructedDataUTCTimeSynchronizationRecipientsBuilder{_BACnetConstructedDataUTCTimeSynchronizationRecipients: m.deepCopy()}
}
