...
func (m *BACnetConstructedDataLightingCommandDefaultPriority) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag) {
...
func NewBACnetConstructedDataLightingCommandDefaultPriority(lightingCommandDefaultPriority *BACnetApplicationTagUnsignedInteger, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag, tagNumber uint8) *BACnetConstructedDataLightingCommandDefaultPriority {
