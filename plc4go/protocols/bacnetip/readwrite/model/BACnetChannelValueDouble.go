...
func (m *_BACnetChannelValueDouble) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetChannelValueDouble) GetLengthInBytes(ctx context.Context) uint64 {
