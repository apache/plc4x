...
func BACnetChannelValueDoubleParseWithBufferProducer() func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetChannelValueDouble, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetChannelValueDouble, error) {
		return BACnetChannelValueDoubleParseWithBuffer(ctx, readBuffer)
	}
}
