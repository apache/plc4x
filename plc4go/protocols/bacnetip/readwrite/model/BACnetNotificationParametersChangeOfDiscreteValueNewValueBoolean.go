...
func (m *_BACnetNotificationParametersChangeOfDiscreteValueNewValueBoolean) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetNotificationParametersChangeOfDiscreteValueNewValue, tagNumber uint8) (_bACnetNotificationParametersChangeOfDiscreteValueNewValueBoolean BACnetNotificationParametersChangeOfDiscreteValueNewValueBoolean, err error) {
