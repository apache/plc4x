...
func (m *_BACnetFaultParameterFaultLifeSafety) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetFaultParameter) (_bACnetFaultParameterFaultLifeSafety BACnetFaultParameterFaultLifeSafety, err error) {
