...
func (m *_BACnetConstructedDataUTCOffset) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataUTCOffset) GetLengthInBytes(ctx context.Context) uint64 {
