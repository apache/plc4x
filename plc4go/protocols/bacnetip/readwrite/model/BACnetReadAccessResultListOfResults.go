...
func (m *_BACnetReadAccessResultListOfResults) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetReadAccessResultListOfResults) GetLengthInBytes(ctx context.Context) uint64 {
