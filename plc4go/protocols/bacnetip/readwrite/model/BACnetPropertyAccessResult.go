...
func (m *_BACnetPropertyAccessResult) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyAccessResult) GetLengthInBytes(ctx context.Context) uint64 {
