...
func (m *_BACnetConstructedDataNotificationThreshold) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataNotificationThreshold) GetLengthInBytes(ctx context.Context) uint64 {
