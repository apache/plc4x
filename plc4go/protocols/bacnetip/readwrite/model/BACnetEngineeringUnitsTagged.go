...
func (m *_BACnetEngineeringUnitsTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetEngineeringUnitsTagged) GetLengthInBytes(ctx context.Context) uint64 {
