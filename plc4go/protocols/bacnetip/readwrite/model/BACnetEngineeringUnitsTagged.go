...
func (m *_BACnetEngineeringUnitsTagged) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (_bACnetEngineeringUnitsTagged BACnetEngineeringUnitsTagged, err error) {
