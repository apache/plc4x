...
func (m *_BACnetEventParameterBufferReady) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetEventParameterBufferReady) GetLengthInBytes(ctx context.Context) uint64 {
