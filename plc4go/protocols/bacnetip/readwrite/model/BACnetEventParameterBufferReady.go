...
func (m *_BACnetEventParameterBufferReady) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetEventParameter) (_bACnetEventParameterBufferReady BACnetEventParameterBufferReady, err error) {
