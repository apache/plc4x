...
func (m *_BACnetConstructedDataMinimumValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataMinimumValue) GetLengthInBytes(ctx context.Context) uint64 {
