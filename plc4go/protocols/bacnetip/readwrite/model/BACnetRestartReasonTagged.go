...
func (m *_BACnetRestartReasonTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetRestartReasonTagged) GetLengthInBytes(ctx context.Context) uint64 {
