...
func (m *_BACnetRestartReasonTagged) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (_bACnetRestartReasonTagged BACnetRestartReasonTagged, err error) {
