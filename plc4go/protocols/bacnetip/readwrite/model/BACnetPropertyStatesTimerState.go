...
func (m *_BACnetPropertyStatesTimerState) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesTimerState) GetLengthInBytes(ctx context.Context) uint64 {
