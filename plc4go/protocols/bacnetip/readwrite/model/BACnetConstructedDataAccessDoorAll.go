...
func NewBACnetConstructedDataAccessDoorAll(openingTag BACnetOpeningTag, peekedTagHeader BACnetTagHeader, closingTag BACnetClosingTag) *_BACnetConstructedDataAccessDoorAll {
...
func (m *_BACnetConstructedDataAccessDoorAll) GetPlx4xTypeName() string {
	return "BACnetConstructedDataAccessDoorAll"
}

func (m *_BACnetConstructedDataAccessDoorAll) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.BACnetConstructedDataContract.(*_BACnetConstructedData).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_BACnetConstructedDataAccessDoorAll) GetLengthInBytes(ctx context.Context) uint64 {
