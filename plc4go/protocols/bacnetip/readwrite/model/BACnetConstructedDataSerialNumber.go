...
// BACnetConstructedDataSerialNumber is the data-structure of this message
type BACnetConstructedDataSerialNumber struct {
...
type IBACnetConstructedDataSerialNumber interface {
...
func (m *BACnetConstructedDataSerialNumber) GetObjectTypeArgument() BACnetObjectType {
	return 0
}
...
func (m *BACnetConstructedDataSerialNumber) GetParent() *BACnetConstructedData {
...
func (m *BACnetConstructedDataSerialNumber) GetSerialNumber() *BACnetApplicationTagCharacterString {
...
func (m *BACnetConstructedDataSerialNumber) GetActualValue() *BACnetApplicationTagCharacterString {
...
func CastBACnetConstructedDataSerialNumber(structType interface{}) *BACnetConstructedDataSerialNumber {
	...
	if casted, ok := structType.(BACnetConstructedData); ok {
		return CastBACnetConstructedDataSerialNumber(casted.Child)
	}
	if casted, ok := structType.(*BACnetConstructedData); ok {
		return CastBACnetConstructedDataSerialNumber(casted.Child)
	}
...
func (m *BACnetConstructedDataSerialNumber) GetTypeName() string {
	return "BACnetConstructedDataSerialNumber"
}

func (m *BACnetConstructedDataSerialNumber) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetConstructedDataSerialNumber) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetConstructedDataSerialNumber) GetLengthInBytes() uint16 {
...
func BACnetConstructedDataSerialNumberParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) (*BACnetConstructedDataSerialNumber, error) {
	...
	_child := &BACnetConstructedDataSerialNumber{
		SerialNumber:          CastBACnetApplicationTagCharacterString(serialNumber),
...
func (m *BACnetConstructedDataSerialNumber) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetConstructedDataSerialNumber) String() string {
	if m == nil {
		return "<nil>"
	}
