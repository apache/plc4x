...
func (m *_ChangeListRemoveError) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetError, errorChoice BACnetConfirmedServiceChoice) (_changeListRemoveError ChangeListRemoveError, err error) {
