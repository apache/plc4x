...
func (m *_BACnetConstructedDataActualShedLevel) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataActualShedLevel) GetLengthInBytes(ctx context.Context) uint64 {
