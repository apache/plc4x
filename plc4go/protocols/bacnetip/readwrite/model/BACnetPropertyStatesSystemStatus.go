...
func (m *_BACnetPropertyStatesSystemStatus) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesSystemStatus) GetLengthInBytes(ctx context.Context) uint64 {
