...
func (m *_BACnetConstructedDataProcessIdentifierFilterBuilder) WithProcessIdentifierFilterBuilder(builderSupplier func(BACnetProcessIdSelectionBuilder) BACnetProcessIdSelectionBuilder) BACnetConstructedDataProcessIdentifierFilterBuilder {
	builder := builderSupplier(m.ProcessIdentifierFilter.CreateBACnetProcessIdSelectionBuilder())
	var err error
	m.ProcessIdentifierFilter, err = builder.Build()
	if err != nil {
		if m.err == nil {
			m.err = &utils.MultiError{MainError: errors.New("sub builder failed")}
		}
		m.err.Append(errors.Wrap(err, "BACnetProcessIdSelectionBuilder failed"))
	}
	return m
}
