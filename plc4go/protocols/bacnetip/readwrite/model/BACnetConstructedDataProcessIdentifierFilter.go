...
func (m *BACnetConstructedDataProcessIdentifierFilter) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag) {
...
func (m *BACnetConstructedDataProcessIdentifierFilter) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		_processIdentifierFilterErr := writeBuffer.WriteSerializable(m.ProcessIdentifierFilter)
