...
// BACnetConstructedDataProcessIdentifierFilter is the data-structure of this message
type BACnetConstructedDataProcessIdentifierFilter struct {
...
type IBACnetConstructedDataProcessIdentifierFilter interface {
...
func (m *BACnetConstructedDataProcessIdentifierFilter) GetObjectTypeArgument() BACnetObjectType {
	return 0
}

func (m *BACnetConstructedDataProcessIdentifierFilter) GetPropertyIdentifierArgument() BACnetPropertyIdentifier {
...
func (m *BACnetConstructedDataProcessIdentifierFilter) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag) {
	m.BACnetConstructedData.OpeningTag = openingTag
	m.BACnetConstructedData.ClosingTag = closingTag
}

func (m *BACnetConstructedDataProcessIdentifierFilter) GetParent() *BACnetConstructedData {
...
func (m *BACnetConstructedDataProcessIdentifierFilter) GetProcessIdentifierFilter() *BACnetProcessIdSelection {
...
func NewBACnetConstructedDataProcessIdentifierFilter(processIdentifierFilter *BACnetProcessIdSelection, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag, tagNumber uint8) *BACnetConstructedDataProcessIdentifierFilter {
...
func CastBACnetConstructedDataProcessIdentifierFilter(structType interface{}) *BACnetConstructedDataProcessIdentifierFilter {
	...
	if casted, ok := structType.(BACnetConstructedData); ok {
		return CastBACnetConstructedDataProcessIdentifierFilter(casted.Child)
	}
	if casted, ok := structType.(*BACnetConstructedData); ok {
		return CastBACnetConstructedDataProcessIdentifierFilter(casted.Child)
	}
...
func (m *BACnetConstructedDataProcessIdentifierFilter) GetTypeName() string {
	return "BACnetConstructedDataProcessIdentifierFilter"
}

func (m *BACnetConstructedDataProcessIdentifierFilter) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetConstructedDataProcessIdentifierFilter) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetConstructedDataProcessIdentifierFilter) GetLengthInBytes() uint16 {
...
func BACnetConstructedDataProcessIdentifierFilterParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier) (*BACnetConstructedDataProcessIdentifierFilter, error) {
	...
	_child := &BACnetConstructedDataProcessIdentifierFilter{
		ProcessIdentifierFilter: CastBACnetProcessIdSelection(processIdentifierFilter),
...
func (m *BACnetConstructedDataProcessIdentifierFilter) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetConstructedDataProcessIdentifierFilter) String() string {
	if m == nil {
		return "<nil>"
	}
