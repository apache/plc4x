...
func (m *_BACnetPropertyStatesPolarity) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesPolarity) GetLengthInBytes(ctx context.Context) uint64 {
