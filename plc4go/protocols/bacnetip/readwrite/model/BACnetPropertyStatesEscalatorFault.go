...
func (m *_BACnetPropertyStatesEscalatorFault) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetPropertyStates, peekedTagNumber uint8) (_bACnetPropertyStatesEscalatorFault BACnetPropertyStatesEscalatorFault, err error) {
