...
func (m *_BACnetTimeStampDateTime) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetTimeStamp) (_bACnetTimeStampDateTime BACnetTimeStampDateTime, err error) {
