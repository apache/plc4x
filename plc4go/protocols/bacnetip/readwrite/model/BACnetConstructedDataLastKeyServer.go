...
func (m *_BACnetConstructedDataLastKeyServer) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataLastKeyServer) GetLengthInBytes(ctx context.Context) uint64 {
