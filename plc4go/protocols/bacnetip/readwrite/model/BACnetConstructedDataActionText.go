...
func (m *_BACnetConstructedDataActionText) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataActionText) GetLengthInBytes(ctx context.Context) uint64 {
