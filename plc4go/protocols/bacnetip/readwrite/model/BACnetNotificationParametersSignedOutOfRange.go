...
func (m *_BACnetNotificationParametersSignedOutOfRange) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetNotificationParameters, peekedTagNumber uint8, tagNumber uint8, objectTypeArgument BACnetObjectType) (_bACnetNotificationParametersSignedOutOfRange BACnetNotificationParametersSignedOutOfRange, err error) {
