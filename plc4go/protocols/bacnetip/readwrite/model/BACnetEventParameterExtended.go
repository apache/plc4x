...
func (m *_BACnetEventParameterExtended) GetPlx4xTypeName() string {
	return "BACnetEventParameterExtended"
}

func (m *_BACnetEventParameterExtended) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetEventParameterExtended) GetLengthInBytes(ctx context.Context) uint64 {
