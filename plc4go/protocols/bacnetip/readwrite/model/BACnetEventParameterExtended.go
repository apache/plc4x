...
func BACnetEventParameterExtendedParse(ctx context.Context, theBytes []byte) (BACnetEventParameterExtended, error) {
	return BACnetEventParameterExtendedParseWithBuffer(ctx, utils.NewReadBufferByteBased(theBytes))
}

func BACnetEventParameterExtendedParseWithBufferProducer() func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetEventParameterExtended, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetEventParameterExtended, error) {
		return BACnetEventParameterExtendedParseWithBuffer(ctx, readBuffer)
	}
}
