...
func (m *_NLMICouldBeRouterToNetworkBuilder) WithMandatoryFields(destinationNetworkAddress uint16, performanceIndex uint8) NLMICouldBeRouterToNetworkBuilder {
	return m.WithDestinationNetworkAddress(destinationNetworkAddress).WithPerformanceIndex(performanceIndex)
}

func (m *_NLMICouldBeRouterToNetworkBuilder) WithDestinationNetworkAddress(destinationNetworkAddress uint16) NLMICouldBeRouterToNetworkBuilder {
	m.DestinationNetworkAddress = destinationNetworkAddress
	return m
}

func (m *_NLMICouldBeRouterToNetworkBuilder) WithPerformanceIndex(performanceIndex uint8) NLMICouldBeRouterToNetworkBuilder {
	m.PerformanceIndex = performanceIndex
	return m
}

func (m *_NLMICouldBeRouterToNetworkBuilder) Build() (NLMICouldBeRouterToNetwork, error) {
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._NLMICouldBeRouterToNetwork.deepCopy(), nil
}

func (m *_NLMICouldBeRouterToNetworkBuilder) MustBuild() NLMICouldBeRouterToNetwork {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_NLMICouldBeRouterToNetworkBuilder) DeepCopy() any {
	return m.CreateNLMICouldBeRouterToNetworkBuilder()
}

// CreateNLMICouldBeRouterToNetworkBuilder creates a NLMICouldBeRouterToNetworkBuilder
func (m *_NLMICouldBeRouterToNetwork) CreateNLMICouldBeRouterToNetworkBuilder() NLMICouldBeRouterToNetworkBuilder {
	if m == nil {
		return NewNLMICouldBeRouterToNetworkBuilder()
	}
	return &_NLMICouldBeRouterToNetworkBuilder{_NLMICouldBeRouterToNetwork: m.deepCopy()}
}
