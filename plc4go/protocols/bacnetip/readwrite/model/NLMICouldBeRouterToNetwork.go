...
func (m *_NLMICouldBeRouterToNetwork) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_NLMICouldBeRouterToNetwork) GetLengthInBytes(ctx context.Context) uint64 {
