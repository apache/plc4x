...
func (m *_NLMICouldBeRouterToNetwork) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_NLM, apduLength uint16) (_nLMICouldBeRouterToNetwork NLMICouldBeRouterToNetwork, err error) {
