...
func (m *_BACnetConstructedDataPriority) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataPriority) GetLengthInBytes(ctx context.Context) uint64 {
