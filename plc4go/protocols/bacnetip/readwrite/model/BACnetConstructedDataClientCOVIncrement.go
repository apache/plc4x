...
func (m *_BACnetConstructedDataClientCOVIncrement) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataClientCOVIncrement) GetLengthInBytes(ctx context.Context) uint64 {
