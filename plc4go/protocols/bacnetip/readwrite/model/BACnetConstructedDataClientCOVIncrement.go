...
func (m *_BACnetConstructedDataClientCOVIncrementBuilder) WithCovIncrementBuilder(builderSupplier func(BACnetClientCOVBuilder) BACnetClientCOVBuilder) BACnetConstructedDataClientCOVIncrementBuilder {
	builder := builderSupplier(m.CovIncrement.CreateBACnetClientCOVBuilder())
	var err error
	...
	if err != nil {
		...
		m.err.Append(errors.Wrap(err, "BACnetClientCOVBuilder failed"))
	}
	return m
}
