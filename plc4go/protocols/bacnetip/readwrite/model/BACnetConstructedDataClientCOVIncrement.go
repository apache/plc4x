...
func (m *BACnetConstructedDataClientCOVIncrement) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag) {
...
func NewBACnetConstructedDataClientCOVIncrement(covIncrement *BACnetClientCOV, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag, tagNumber uint8) *BACnetConstructedDataClientCOVIncrement {
