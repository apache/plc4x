...
func (m *BACnetConstructedDataGroupMemberNames) GetNumberOfDataElements() *BACnetApplicationTagUnsignedInteger {
...
func (m *BACnetConstructedDataGroupMemberNames) GetZero() uint64 {
...
func NewBACnetConstructedDataGroupMemberNames(numberOfDataElements *BACnetApplicationTagUnsignedInteger, groupMemberNames []*BACnetApplicationTagCharacterString, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag, tagNumber uint8, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) *BACnetConstructedDataGroupMemberNames {
