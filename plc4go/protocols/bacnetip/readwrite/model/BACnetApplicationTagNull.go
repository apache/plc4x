...
func (m *_BACnetApplicationTagNull) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetApplicationTag) (_bACnetApplicationTagNull BACnetApplicationTagNull, err error) {
