...
func (m *_BACnetEventParameterChangeOfBitstring) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetEventParameter) (_bACnetEventParameterChangeOfBitstring BACnetEventParameterChangeOfBitstring, err error) {
