...
func (m *_BACnetOptionalUnsignedValue) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetOptionalUnsigned) (_bACnetOptionalUnsignedValue BACnetOptionalUnsignedValue, err error) {
