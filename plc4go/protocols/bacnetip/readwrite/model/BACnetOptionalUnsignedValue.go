...
func (m *_BACnetOptionalUnsignedValueBuilder) WithMandatoryFields(unsignedValue BACnetApplicationTagUnsignedInteger) BACnetOptionalUnsignedValueBuilder {
	return m.WithUnsignedValue(unsignedValue)
}

func (m *_BACnetOptionalUnsignedValueBuilder) WithUnsignedValue(unsignedValue BACnetApplicationTagUnsignedInteger) BACnetOptionalUnsignedValueBuilder {
	m.UnsignedValue = unsignedValue
	return m
}

func (m *_BACnetOptionalUnsignedValueBuilder) WithUnsignedValueBuilder(builderSupplier func(BACnetApplicationTagUnsignedIntegerBuilder) BACnetApplicationTagUnsignedIntegerBuilder) BACnetOptionalUnsignedValueBuilder {
...
func (m *_BACnetOptionalUnsignedValueBuilder) Build() (BACnetOptionalUnsignedValue, error) {
	...
	return m._BACnetOptionalUnsignedValue.deepCopy(), nil
}

func (m *_BACnetOptionalUnsignedValueBuilder) MustBuild() BACnetOptionalUnsignedValue {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetOptionalUnsignedValueBuilder) DeepCopy() any {
	return m.CreateBACnetOptionalUnsignedValueBuilder()
}

// CreateBACnetOptionalUnsignedValueBuilder creates a BACnetOptionalUnsignedValueBuilder
func (m *_BACnetOptionalUnsignedValue) CreateBACnetOptionalUnsignedValueBuilder() BACnetOptionalUnsignedValueBuilder {
	if m == nil {
		return NewBACnetOptionalUnsignedValueBuilder()
	}
	return &_BACnetOptionalUnsignedValueBuilder{_BACnetOptionalUnsignedValue: m.deepCopy()}
}
