...
func (m *_BACnetConstructedDataCarAssignedDirection) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataCarAssignedDirection) GetLengthInBytes(ctx context.Context) uint64 {
