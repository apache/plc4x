...
func (m *_BACnetLiftCarDoorCommandTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetLiftCarDoorCommandTagged) GetLengthInBytes(ctx context.Context) uint64 {
