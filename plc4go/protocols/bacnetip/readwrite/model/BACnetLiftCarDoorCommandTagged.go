...
// BACnetLiftCarDoorCommandTagged is the data-structure of this message
type BACnetLiftCarDoorCommandTagged struct {
...
// IBACnetLiftCarDoorCommandTagged is the corresponding interface of BACnetLiftCarDoorCommandTagged
type IBACnetLiftCarDoorCommandTagged interface {
...
func (m *BACnetLiftCarDoorCommandTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetLiftCarDoorCommandTagged) GetValue() BACnetLiftCarDoorCommand {
	return m.Value
}
...
// NewBACnetLiftCarDoorCommandTagged factory function for BACnetLiftCarDoorCommandTagged
func NewBACnetLiftCarDoorCommandTagged(header *BACnetTagHeader, value BACnetLiftCarDoorCommand, tagNumber uint8, tagClass TagClass) *BACnetLiftCarDoorCommandTagged {
	return &BACnetLiftCarDoorCommandTagged{Header: header, Value: value, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetLiftCarDoorCommandTagged) GetTypeName() string {
	return "BACnetLiftCarDoorCommandTagged"
}

func (m *BACnetLiftCarDoorCommandTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetLiftCarDoorCommandTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetLiftCarDoorCommandTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetLiftCarDoorCommandTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetLiftCarDoorCommandTagged) String() string {
	if m == nil {
		return "<nil>"
	}
