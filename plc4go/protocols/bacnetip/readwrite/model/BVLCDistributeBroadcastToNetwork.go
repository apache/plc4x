...
func (m *_BVLCDistributeBroadcastToNetwork) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BVLC, bvlcPayloadLength uint16) (_bVLCDistributeBroadcastToNetwork BVLCDistributeBroadcastToNetwork, err error) {
