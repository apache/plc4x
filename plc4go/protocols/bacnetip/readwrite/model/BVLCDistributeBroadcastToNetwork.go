...
func (m *_BVLCDistributeBroadcastToNetwork) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BVLCDistributeBroadcastToNetwork) GetLengthInBytes(ctx context.Context) uint64 {
