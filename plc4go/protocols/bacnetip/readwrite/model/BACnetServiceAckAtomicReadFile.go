...
func (m *_BACnetServiceAckAtomicReadFile) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetServiceAck, serviceAckLength uint32) (_bACnetServiceAckAtomicReadFile BACnetServiceAckAtomicReadFile, err error) {
