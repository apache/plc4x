...
func (m *_BACnetChannelValueTime) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetChannelValue) (_bACnetChannelValueTime BACnetChannelValueTime, err error) {
