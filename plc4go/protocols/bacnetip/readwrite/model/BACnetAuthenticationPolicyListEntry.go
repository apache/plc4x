...
func (m *_BACnetAuthenticationPolicyListEntry) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_bACnetAuthenticationPolicyListEntry BACnetAuthenticationPolicyListEntry, err error) {
