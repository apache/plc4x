...
func (m *_BACnetConstructedDataBACnetIPGlobalAddress) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataBACnetIPGlobalAddress) GetLengthInBytes(ctx context.Context) uint64 {
