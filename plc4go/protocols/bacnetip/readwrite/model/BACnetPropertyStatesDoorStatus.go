...
func (m *_BACnetPropertyStatesDoorStatus) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesDoorStatus) GetLengthInBytes(ctx context.Context) uint64 {
