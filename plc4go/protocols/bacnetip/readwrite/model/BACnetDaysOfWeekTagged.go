...
func (m *_BACnetDaysOfWeekTagged) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (_bACnetDaysOfWeekTagged BACnetDaysOfWeekTagged, err error) {
