...
func (m *_BVLCReadForeignDeviceTableAck) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BVLC, bvlcPayloadLength uint16) (_bVLCReadForeignDeviceTableAck BVLCReadForeignDeviceTableAck, err error) {
