...
func BACnetEscalatorOperationDirectionParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetEscalatorOperationDirection, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint16("BACnetEscalatorOperationDirection", 16)
	if err != nil {
...
func (e BACnetEscalatorOperationDirection) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint16("BACnetEscalatorOperationDirection", 16, uint16(uint16(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}

func (e BACnetEscalatorOperationDirection) GetValue() uint16 {
	return uint16(e)
}
