...
func (m *_BVLCReadBroadcastDistributionTableAck) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BVLC, bvlcPayloadLength uint16) (_bVLCReadBroadcastDistributionTableAck BVLCReadBroadcastDistributionTableAck, err error) {
