...
func (m *_BVLCReadBroadcastDistributionTableAck) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BVLCReadBroadcastDistributionTableAck) GetLengthInBytes(ctx context.Context) uint64 {
