...
func (m *_BACnetConstructedDataMinPresValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataMinPresValue) GetLengthInBytes(ctx context.Context) uint64 {
