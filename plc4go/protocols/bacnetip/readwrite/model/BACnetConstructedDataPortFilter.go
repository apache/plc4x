...
func (m *_BACnetConstructedDataPortFilter) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataPortFilter) GetLengthInBytes(ctx context.Context) uint64 {
