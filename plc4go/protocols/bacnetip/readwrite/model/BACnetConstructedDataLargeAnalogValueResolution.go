...
func (m *_BACnetConstructedDataLargeAnalogValueResolution) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataLargeAnalogValueResolution) GetLengthInBytes(ctx context.Context) uint64 {
