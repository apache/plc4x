...
func (m *BACnetConstructedDataFaultValues) GetNumberOfDataElements() *BACnetApplicationTagUnsignedInteger {
...
func (m *BACnetConstructedDataFaultValues) GetZero() uint64 {
...
func NewBACnetConstructedDataFaultValues(numberOfDataElements *BACnetApplicationTagUnsignedInteger, faultValues []*BACnetLifeSafetyStateTagged, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag, tagNumber uint8, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) *BACnetConstructedDataFaultValues {
