...
func (m *_BACnetConstructedDataFaultValues) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataFaultValues) GetLengthInBytes(ctx context.Context) uint64 {
