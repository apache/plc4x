...
func (m *_BACnetConstructedDataInstantaneousPower) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataInstantaneousPower) GetLengthInBytes(ctx context.Context) uint64 {
