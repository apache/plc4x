...
func (m *_BVLCDeleteForeignDeviceTableEntry) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BVLC) (_bVLCDeleteForeignDeviceTableEntry BVLCDeleteForeignDeviceTableEntry, err error) {
