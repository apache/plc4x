...
func (m *_BACnetOptionalCharacterString) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_bACnetOptionalCharacterString BACnetOptionalCharacterString, err error) {
