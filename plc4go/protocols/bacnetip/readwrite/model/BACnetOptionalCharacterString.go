...
func (m *_BACnetOptionalCharacterString) getLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetOptionalCharacterString) GetLengthInBytes(ctx context.Context) uint64 {
