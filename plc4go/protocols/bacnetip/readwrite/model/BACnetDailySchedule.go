...
func (m *_BACnetDailySchedule) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetDailySchedule) GetLengthInBytes(ctx context.Context) uint64 {
...
func BACnetDailyScheduleParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetDailySchedule, error) {
	v, err := (new(_BACnetDailySchedule)).parse(ctx, readBuffer)
	if err != nil {
		return nil, err
	}
	return v, nil
