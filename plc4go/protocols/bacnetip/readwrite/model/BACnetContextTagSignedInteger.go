...
func (m *_BACnetContextTagSignedInteger) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetContextTagSignedInteger) GetLengthInBytes(ctx context.Context) uint64 {
