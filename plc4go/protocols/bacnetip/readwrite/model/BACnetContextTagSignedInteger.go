...
func (m *_BACnetContextTagSignedInteger) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetContextTag, header BACnetTagHeader, tagNumberArgument uint8, dataType BACnetDataType) (_bACnetContextTagSignedInteger BACnetContextTagSignedInteger, err error) {
