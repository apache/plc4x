...
func (m *_BACnetConstructedDataLoggingRecord) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataLoggingRecord) GetLengthInBytes(ctx context.Context) uint64 {
