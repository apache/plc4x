...
func (m *_BACnetLogDataLogDataEntryAnyValueBuilder) WithOptionalAnyValueBuilder(builderSupplier func(BACnetConstructedDataBuilder) BACnetConstructedDataBuilder) BACnetLogDataLogDataEntryAnyValueBuilder {
	builder := builderSupplier(m.AnyValue.CreateBACnetConstructedDataBuilder())
	var err error
	m.AnyValue, err = builder.Build()
	if err != nil {
		if m.err == nil {
