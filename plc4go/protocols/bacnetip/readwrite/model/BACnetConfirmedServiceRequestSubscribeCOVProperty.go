...
func (m *_BACnetConfirmedServiceRequestSubscribeCOVProperty) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetConfirmedServiceRequest, serviceRequestLength uint32) (_bACnetConfirmedServiceRequestSubscribeCOVProperty BACnetConfirmedServiceRequestSubscribeCOVProperty, err error) {
