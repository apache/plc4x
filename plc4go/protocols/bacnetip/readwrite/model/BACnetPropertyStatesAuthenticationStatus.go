...
func (m *_BACnetPropertyStatesAuthenticationStatus) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetPropertyStates, peekedTagNumber uint8) (_bACnetPropertyStatesAuthenticationStatus BACnetPropertyStatesAuthenticationStatus, err error) {
