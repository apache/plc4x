...
func (m *_BACnetConstructedDataDefaultFadeTime) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataDefaultFadeTime) GetLengthInBytes(ctx context.Context) uint64 {
