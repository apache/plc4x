...
func (m *BACnetConstructedDataObjectPropertyReference) GetActualValue() *BACnetDeviceObjectPropertyReference {
...
func (m *BACnetConstructedDataObjectPropertyReference) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		_propertyReferenceErr := writeBuffer.WriteSerializable(m.PropertyReference)
