...
func (m *_BACnetPropertyStatesUnsignedValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesUnsignedValue) GetLengthInBytes(ctx context.Context) uint64 {
