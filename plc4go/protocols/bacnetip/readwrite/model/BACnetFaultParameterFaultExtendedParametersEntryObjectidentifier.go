...
func (m *_BACnetFaultParameterFaultExtendedParametersEntryObjectidentifier) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetFaultParameterFaultExtendedParametersEntry) (_bACnetFaultParameterFaultExtendedParametersEntryObjectidentifier BACnetFaultParameterFaultExtendedParametersEntryObjectidentifier, err error) {
