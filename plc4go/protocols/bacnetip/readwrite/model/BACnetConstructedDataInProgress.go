...
func (m *_BACnetConstructedDataInProgress) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataInProgress) GetLengthInBytes(ctx context.Context) uint64 {
