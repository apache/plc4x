...
func (m *_BACnetChannelValueUnsigned) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetChannelValueUnsigned) GetLengthInBytes(ctx context.Context) uint64 {
