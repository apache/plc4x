...
func (m *_BACnetChannelValueUnsigned) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetChannelValue) (_bACnetChannelValueUnsigned BACnetChannelValueUnsigned, err error) {
