...
// BACnetPropertyStatesProtocolLevel is the data-structure of this message
type BACnetPropertyStatesProtocolLevel struct {
	*BACnetPropertyStates
	ProtocolLevel *BACnetProtocolLevelTagged
}

// IBACnetPropertyStatesProtocolLevel is the corresponding interface of BACnetPropertyStatesProtocolLevel
type IBACnetPropertyStatesProtocolLevel interface {
...
func (m *BACnetPropertyStatesProtocolLevel) InitializeParent(parent *BACnetPropertyStates, peekedTagHeader *BACnetTagHeader) {
	m.BACnetPropertyStates.PeekedTagHeader = peekedTagHeader
}

func (m *BACnetPropertyStatesProtocolLevel) GetParent() *BACnetPropertyStates {
...
func (m *BACnetPropertyStatesProtocolLevel) GetProtocolLevel() *BACnetProtocolLevelTagged {
...
// NewBACnetPropertyStatesProtocolLevel factory function for BACnetPropertyStatesProtocolLevel
func NewBACnetPropertyStatesProtocolLevel(protocolLevel *BACnetProtocolLevelTagged, peekedTagHeader *BACnetTagHeader) *BACnetPropertyStatesProtocolLevel {
	_result := &BACnetPropertyStatesProtocolLevel{
...
func CastBACnetPropertyStatesProtocolLevel(structType interface{}) *BACnetPropertyStatesProtocolLevel {
	...
	if casted, ok := structType.(BACnetPropertyStates); ok {
		return CastBACnetPropertyStatesProtocolLevel(casted.Child)
	}
	if casted, ok := structType.(*BACnetPropertyStates); ok {
		return CastBACnetPropertyStatesProtocolLevel(casted.Child)
	}
...
func (m *BACnetPropertyStatesProtocolLevel) GetTypeName() string {
	return "BACnetPropertyStatesProtocolLevel"
}

func (m *BACnetPropertyStatesProtocolLevel) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetPropertyStatesProtocolLevel) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetPropertyStatesProtocolLevel) GetLengthInBytes() uint16 {
...
func BACnetPropertyStatesProtocolLevelParse(readBuffer utils.ReadBuffer, peekedTagNumber uint8) (*BACnetPropertyStatesProtocolLevel, error) {
	...
	_child := &BACnetPropertyStatesProtocolLevel{
...
func (m *BACnetPropertyStatesProtocolLevel) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetPropertyStatesProtocolLevel) String() string {
	if m == nil {
		return "<nil>"
	}
