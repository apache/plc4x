...
func (m *_BACnetPropertyStatesProtocolLevel) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetPropertyStates, peekedTagNumber uint8) (_bACnetPropertyStatesProtocolLevel BACnetPropertyStatesProtocolLevel, err error) {
