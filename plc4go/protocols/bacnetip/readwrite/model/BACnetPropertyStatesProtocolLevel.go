...
func (m *_BACnetPropertyStatesProtocolLevel) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesProtocolLevel) GetLengthInBytes(ctx context.Context) uint64 {
