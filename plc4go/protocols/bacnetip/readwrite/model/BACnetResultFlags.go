...
func (m BACnetResultFlags) GetLengthInBits(ctx context.Context) uint64 {
	return 8
}

func (m BACnetResultFlags) GetLengthInBytes(ctx context.Context) uint64 {
...
func BACnetResultFlagsParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetResultFlags, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint8("BACnetResultFlags", 8)
	if err != nil {
...
func (e BACnetResultFlags) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint8("BACnetResultFlags", 8, uint8(uint8(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}

func (e BACnetResultFlags) GetValue() uint8 {
	return uint8(e)
}
