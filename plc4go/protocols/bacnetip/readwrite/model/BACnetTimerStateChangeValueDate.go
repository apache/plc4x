...
func (m *_BACnetTimerStateChangeValueDate) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetTimerStateChangeValue, objectTypeArgument BACnetObjectType) (_bACnetTimerStateChangeValueDate BACnetTimerStateChangeValueDate, err error) {
