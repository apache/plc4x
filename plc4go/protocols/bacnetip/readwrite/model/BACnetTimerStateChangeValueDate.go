...
func (m *_BACnetTimerStateChangeValueDate) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetTimerStateChangeValueDate) GetLengthInBytes(ctx context.Context) uint64 {
