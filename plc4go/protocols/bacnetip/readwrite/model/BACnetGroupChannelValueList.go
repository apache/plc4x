...
func (m *_BACnetGroupChannelValueList) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (_bACnetGroupChannelValueList BACnetGroupChannelValueList, err error) {
