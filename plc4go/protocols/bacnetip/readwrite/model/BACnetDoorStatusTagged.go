...
func (m *_BACnetDoorStatusTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *_BACnetDoorStatusTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *_BACnetDoorStatusTagged) GetLengthInBytes() uint16 {
	return m.GetLengthInBits() / 8
}

func BACnetDoorStatusTaggedParse(theBytes []byte, tagNumber uint8, tagClass TagClass) (BACnetDoorStatusTagged, error) {
	return BACnetDoorStatusTaggedParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian)), tagNumber, tagClass) // TODO: get endianness from mspec
}
