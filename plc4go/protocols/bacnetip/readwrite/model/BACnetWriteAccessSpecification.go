...
func (m *_BACnetWriteAccessSpecification) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_bACnetWriteAccessSpecification BACnetWriteAccessSpecification, err error) {
