...
func (m *_BACnetWriteAccessSpecification) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetWriteAccessSpecification) GetLengthInBytes(ctx context.Context) uint64 {
