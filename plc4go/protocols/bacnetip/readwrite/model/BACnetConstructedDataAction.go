...
func (m *_BACnetConstructedDataAction) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataAction) GetLengthInBytes(ctx context.Context) uint64 {
