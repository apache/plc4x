...
func BACnetNotifyTypeParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetNotifyType, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint8("BACnetNotifyType", 8)
	if err != nil {
...
func (e BACnetNotifyType) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint8("BACnetNotifyType", 8, uint8(uint8(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}

func (e BACnetNotifyType) GetValue() uint8 {
	return uint8(e)
}
