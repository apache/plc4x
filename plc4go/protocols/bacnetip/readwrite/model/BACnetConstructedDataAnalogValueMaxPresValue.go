...
func (m *_BACnetConstructedDataAnalogValueMaxPresValueBuilder) WithMandatoryFields(maxPresValue BACnetApplicationTagReal) BACnetConstructedDataAnalogValueMaxPresValueBuilder {
	return m.WithMaxPresValue(maxPresValue)
}

func (m *_BACnetConstructedDataAnalogValueMaxPresValueBuilder) WithMaxPresValue(maxPresValue BACnetApplicationTagReal) BACnetConstructedDataAnalogValueMaxPresValueBuilder {
	m.MaxPresValue = maxPresValue
	return m
}

func (m *_BACnetConstructedDataAnalogValueMaxPresValueBuilder) WithMaxPresValueBuilder(builderSupplier func(BACnetApplicationTagRealBuilder) BACnetApplicationTagRealBuilder) BACnetConstructedDataAnalogValueMaxPresValueBuilder {
...
func (m *_BACnetConstructedDataAnalogValueMaxPresValueBuilder) Build() (BACnetConstructedDataAnalogValueMaxPresValue, error) {
	...
	return m._BACnetConstructedDataAnalogValueMaxPresValue.deepCopy(), nil
}

func (m *_BACnetConstructedDataAnalogValueMaxPresValueBuilder) MustBuild() BACnetConstructedDataAnalogValueMaxPresValue {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetConstructedDataAnalogValueMaxPresValueBuilder) DeepCopy() any {
	return m.CreateBACnetConstructedDataAnalogValueMaxPresValueBuilder()
}

// CreateBACnetConstructedDataAnalogValueMaxPresValueBuilder creates a BACnetConstructedDataAnalogValueMaxPresValueBuilder
func (m *_BACnetConstructedDataAnalogValueMaxPresValue) CreateBACnetConstructedDataAnalogValueMaxPresValueBuilder() BACnetConstructedDataAnalogValueMaxPresValueBuilder {
	if m == nil {
		return NewBACnetConstructedDataAnalogValueMaxPresValueBuilder()
	}
	return &_BACnetConstructedDataAnalogValueMaxPresValueBuilder{_BACnetConstructedDataAnalogValueMaxPresValue: m.deepCopy()}
}
