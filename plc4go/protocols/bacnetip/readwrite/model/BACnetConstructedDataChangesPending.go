...
func (m *_BACnetConstructedDataChangesPending) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataChangesPending) GetLengthInBytes(ctx context.Context) uint64 {
