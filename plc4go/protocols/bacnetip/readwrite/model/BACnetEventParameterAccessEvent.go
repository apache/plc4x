...
func (m *_BACnetEventParameterAccessEvent) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetEventParameter) (_bACnetEventParameterAccessEvent BACnetEventParameterAccessEvent, err error) {
