...
func (m *_BACnetPropertyStatesIntegerValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesIntegerValue) GetLengthInBytes(ctx context.Context) uint64 {
