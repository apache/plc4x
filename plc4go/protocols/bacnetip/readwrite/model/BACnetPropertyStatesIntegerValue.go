...
func (m *_BACnetPropertyStatesIntegerValue) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetPropertyStates, peekedTagNumber uint8) (_bACnetPropertyStatesIntegerValue BACnetPropertyStatesIntegerValue, err error) {
