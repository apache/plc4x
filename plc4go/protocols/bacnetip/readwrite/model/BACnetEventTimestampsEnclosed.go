...
func (m *_BACnetEventTimestampsEnclosed) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetEventTimestampsEnclosed) GetLengthInBytes(ctx context.Context) uint64 {
