...
func NewBACnetConstructedDataObjectList(openingTag BACnetOpeningTag, peekedTagHeader BACnetTagHeader, closingTag BACnetClosingTag, numberOfDataElements BACnetApplicationTagUnsignedInteger, objectList []BACnetApplicationTagObjectIdentifier) *_BACnetConstructedDataObjectList {
...
func (b *_BACnetConstructedDataObjectListBuilder) setParent(contract BACnetConstructedDataContract) {
	...
	contract.(*_BACnetConstructedData)._SubType = b._BACnetConstructedDataObjectList
}
...
func (m *_BACnetConstructedDataObjectList) GetPlx4xTypeName() string {
	return "BACnetConstructedDataObjectList"
}

func (m *_BACnetConstructedDataObjectList) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataObjectList) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataObjectList) deepCopy() *_BACnetConstructedDataObjectList {
	...
	_BACnetConstructedDataObjectListCopy.BACnetConstructedDataContract.(*_BACnetConstructedData)._SubType = m
