...
// BACnetAccessRuleTimeRangeSpecifierTagged is the data-structure of this message
type BACnetAccessRuleTimeRangeSpecifierTagged struct {
...
// IBACnetAccessRuleTimeRangeSpecifierTagged is the corresponding interface of BACnetAccessRuleTimeRangeSpecifierTagged
type IBACnetAccessRuleTimeRangeSpecifierTagged interface {
...
func (m *BACnetAccessRuleTimeRangeSpecifierTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetAccessRuleTimeRangeSpecifierTagged) GetValue() BACnetAccessRuleTimeRangeSpecifier {
	return m.Value
}
...
// NewBACnetAccessRuleTimeRangeSpecifierTagged factory function for BACnetAccessRuleTimeRangeSpecifierTagged
func NewBACnetAccessRuleTimeRangeSpecifierTagged(header *BACnetTagHeader, value BACnetAccessRuleTimeRangeSpecifier, tagNumber uint8, tagClass TagClass) *BACnetAccessRuleTimeRangeSpecifierTagged {
	return &BACnetAccessRuleTimeRangeSpecifierTagged{Header: header, Value: value, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetAccessRuleTimeRangeSpecifierTagged) GetTypeName() string {
	return "BACnetAccessRuleTimeRangeSpecifierTagged"
}

func (m *BACnetAccessRuleTimeRangeSpecifierTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetAccessRuleTimeRangeSpecifierTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetAccessRuleTimeRangeSpecifierTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetAccessRuleTimeRangeSpecifierTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetAccessRuleTimeRangeSpecifierTagged) String() string {
	if m == nil {
		return "<nil>"
	}
