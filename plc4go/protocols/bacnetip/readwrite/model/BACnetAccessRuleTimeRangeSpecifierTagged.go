...
func (m *_BACnetAccessRuleTimeRangeSpecifierTagged) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (_bACnetAccessRuleTimeRangeSpecifierTagged BACnetAccessRuleTimeRangeSpecifierTagged, err error) {
