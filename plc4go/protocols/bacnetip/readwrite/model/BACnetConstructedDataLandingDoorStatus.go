...
func (m *_BACnetConstructedDataLandingDoorStatus) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataLandingDoorStatus) GetLengthInBytes(ctx context.Context) uint64 {
