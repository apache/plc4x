...
func (m *_BACnetPropertyStatesLiftCarMode) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetPropertyStates, peekedTagNumber uint8) (_bACnetPropertyStatesLiftCarMode BACnetPropertyStatesLiftCarMode, err error) {
