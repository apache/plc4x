...
func (m *_BACnetPropertyStatesLiftCarMode) GetPlx4xTypeName() string {
	return "BACnetPropertyStatesLiftCarMode"
}

func (m *_BACnetPropertyStatesLiftCarMode) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesLiftCarMode) GetLengthInBytes(ctx context.Context) uint64 {
