...
func (m *_BACnetPriorityValueConstructedValueBuilder) WithConstructedValueBuilder(builderSupplier func(BACnetConstructedDataBuilder) BACnetConstructedDataBuilder) BACnetPriorityValueConstructedValueBuilder {
	builder := builderSupplier(m.ConstructedValue.CreateBACnetConstructedDataBuilder())
	var err error
	m.ConstructedValue, err = builder.Build()
	if err != nil {
		if m.err == nil {
