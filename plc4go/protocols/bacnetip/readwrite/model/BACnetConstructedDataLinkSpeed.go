...
func NewBACnetConstructedDataLinkSpeed(openingTag BACnetOpeningTag, peekedTagHeader BACnetTagHeader, closingTag BACnetClosingTag, linkSpeed BACnetApplicationTagReal) *_BACnetConstructedDataLinkSpeed {
	if linkSpeed == nil {
...
func (m *_BACnetConstructedDataLinkSpeed) GetPlx4xTypeName() string {
	return "BACnetConstructedDataLinkSpeed"
}

func (m *_BACnetConstructedDataLinkSpeed) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataLinkSpeed) GetLengthInBytes(ctx context.Context) uint64 {
