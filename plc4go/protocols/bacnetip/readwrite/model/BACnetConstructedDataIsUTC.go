...
func (m *_BACnetConstructedDataIsUTC) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataIsUTC) GetLengthInBytes(ctx context.Context) uint64 {
