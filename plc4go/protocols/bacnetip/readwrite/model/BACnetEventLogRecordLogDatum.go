...
func (m *_BACnetEventLogRecordLogDatum) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (_bACnetEventLogRecordLogDatum BACnetEventLogRecordLogDatum, err error) {
