...
func (m *_BACnetEventParameterChangeOfValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetEventParameterChangeOfValue) GetLengthInBytes(ctx context.Context) uint64 {
