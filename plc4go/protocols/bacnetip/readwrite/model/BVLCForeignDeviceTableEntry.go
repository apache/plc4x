...
func (m *_BVLCForeignDeviceTableEntry) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_bVLCForeignDeviceTableEntry BVLCForeignDeviceTableEntry, err error) {
