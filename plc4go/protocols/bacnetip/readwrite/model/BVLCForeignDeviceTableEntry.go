...
func (m *_BVLCForeignDeviceTableEntry) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BVLCForeignDeviceTableEntry) GetLengthInBytes(ctx context.Context) uint64 {
