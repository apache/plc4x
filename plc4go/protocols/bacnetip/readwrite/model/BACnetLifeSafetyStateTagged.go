...
func (m *_BACnetLifeSafetyStateTaggedBuilder) WithMandatoryFields(header BACnetTagHeader, value BACnetLifeSafetyState, proprietaryValue uint32) BACnetLifeSafetyStateTaggedBuilder {
	return m.WithHeader(header).WithValue(value).WithProprietaryValue(proprietaryValue)
}

func (m *_BACnetLifeSafetyStateTaggedBuilder) WithHeader(header BACnetTagHeader) BACnetLifeSafetyStateTaggedBuilder {
	m.Header = header
	return m
}

func (m *_BACnetLifeSafetyStateTaggedBuilder) WithHeaderBuilder(builderSupplier func(BACnetTagHeaderBuilder) BACnetTagHeaderBuilder) BACnetLifeSafetyStateTaggedBuilder {
...
func (m *_BACnetLifeSafetyStateTaggedBuilder) WithValue(value BACnetLifeSafetyState) BACnetLifeSafetyStateTaggedBuilder {
	m.Value = value
	return m
}

func (m *_BACnetLifeSafetyStateTaggedBuilder) WithProprietaryValue(proprietaryValue uint32) BACnetLifeSafetyStateTaggedBuilder {
	m.ProprietaryValue = proprietaryValue
	return m
}

func (m *_BACnetLifeSafetyStateTaggedBuilder) Build() (BACnetLifeSafetyStateTagged, error) {
	if m.Header == nil {
		if m.err == nil {
	...
	return m._BACnetLifeSafetyStateTagged.deepCopy(), nil
}

func (m *_BACnetLifeSafetyStateTaggedBuilder) MustBuild() BACnetLifeSafetyStateTagged {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetLifeSafetyStateTaggedBuilder) DeepCopy() any {
	return m.CreateBACnetLifeSafetyStateTaggedBuilder()
}

// CreateBACnetLifeSafetyStateTaggedBuilder creates a BACnetLifeSafetyStateTaggedBuilder
func (m *_BACnetLifeSafetyStateTagged) CreateBACnetLifeSafetyStateTaggedBuilder() BACnetLifeSafetyStateTaggedBuilder {
	if m == nil {
		return NewBACnetLifeSafetyStateTaggedBuilder()
	}
	return &_BACnetLifeSafetyStateTaggedBuilder{_BACnetLifeSafetyStateTagged: m.deepCopy()}
}
