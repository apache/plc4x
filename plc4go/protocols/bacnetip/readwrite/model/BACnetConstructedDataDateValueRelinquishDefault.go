...
func (m *_BACnetConstructedDataDateValueRelinquishDefault) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *_BACnetConstructedDataDateValueRelinquishDefault) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *_BACnetConstructedDataDateValueRelinquishDefault) GetLengthInBytes() uint16 {
...
func (m *_BACnetConstructedDataDateValueRelinquishDefault) SerializeWithWriteBuffer(writeBuffer utils.WriteBuffer) error {
