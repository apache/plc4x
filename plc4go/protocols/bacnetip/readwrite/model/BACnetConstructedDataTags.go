...
func (m *_BACnetConstructedDataTags) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataTags) GetLengthInBytes(ctx context.Context) uint64 {
