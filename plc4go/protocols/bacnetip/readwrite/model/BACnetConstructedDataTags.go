...
func (m *BACnetConstructedDataTags) GetNumberOfDataElements() *BACnetApplicationTagUnsignedInteger {
...
func (m *BACnetConstructedDataTags) GetZero() uint64 {
...
func NewBACnetConstructedDataTags(numberOfDataElements *BACnetApplicationTagUnsignedInteger, tags []*BACnetNameValue, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag, tagNumber uint8, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) *BACnetConstructedDataTags {
