...
func (m *_BACnetUnconfirmedServiceRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, serviceRequestLength uint16) (_bACnetUnconfirmedServiceRequest BACnetUnconfirmedServiceRequest, err error) {
