...
func (m *_BACnetEventLogRecordLogDatumNotification) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetEventLogRecordLogDatum, tagNumber uint8) (_bACnetEventLogRecordLogDatumNotification BACnetEventLogRecordLogDatumNotification, err error) {
