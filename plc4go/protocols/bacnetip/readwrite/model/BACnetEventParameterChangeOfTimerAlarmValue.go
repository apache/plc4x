...
// BACnetEventParameterChangeOfTimerAlarmValue is the data-structure of this message
type BACnetEventParameterChangeOfTimerAlarmValue struct {
...
// IBACnetEventParameterChangeOfTimerAlarmValue is the corresponding interface of BACnetEventParameterChangeOfTimerAlarmValue
type IBACnetEventParameterChangeOfTimerAlarmValue interface {
...
func (m *BACnetEventParameterChangeOfTimerAlarmValue) GetOpeningTag() *BACnetOpeningTag {
	return m.OpeningTag
}

func (m *BACnetEventParameterChangeOfTimerAlarmValue) GetAlarmValues() []*BACnetTimerStateTagged {
	return m.AlarmValues
}

func (m *BACnetEventParameterChangeOfTimerAlarmValue) GetClosingTag() *BACnetClosingTag {
	return m.ClosingTag
}
...
// NewBACnetEventParameterChangeOfTimerAlarmValue factory function for BACnetEventParameterChangeOfTimerAlarmValue
func NewBACnetEventParameterChangeOfTimerAlarmValue(openingTag *BACnetOpeningTag, alarmValues []*BACnetTimerStateTagged, closingTag *BACnetClosingTag, tagNumber uint8) *BACnetEventParameterChangeOfTimerAlarmValue {
	return &BACnetEventParameterChangeOfTimerAlarmValue{OpeningTag: openingTag, AlarmValues: alarmValues, ClosingTag: closingTag, TagNumber: tagNumber}
}
...
func (m *BACnetEventParameterChangeOfTimerAlarmValue) GetTypeName() string {
	return "BACnetEventParameterChangeOfTimerAlarmValue"
}

func (m *BACnetEventParameterChangeOfTimerAlarmValue) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetEventParameterChangeOfTimerAlarmValue) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetEventParameterChangeOfTimerAlarmValue) GetLengthInBytes() uint16 {
...
func (m *BACnetEventParameterChangeOfTimerAlarmValue) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetEventParameterChangeOfTimerAlarmValue) String() string {
	if m == nil {
		return "<nil>"
	}
