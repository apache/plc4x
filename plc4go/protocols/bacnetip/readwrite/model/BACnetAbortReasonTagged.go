...
func (m *_BACnetAbortReasonTagged) parse(ctx context.Context, readBuffer utils.ReadBuffer, actualLength uint32) (_bACnetAbortReasonTagged BACnetAbortReasonTagged, err error) {
