...
func (m BACnetLogStatus) GetLengthInBits(ctx context.Context) uint64 {
	return 8
}

func (m BACnetLogStatus) GetLengthInBytes(ctx context.Context) uint64 {
...
func BACnetLogStatusParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetLogStatus, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint8("BACnetLogStatus", 8)
	if err != nil {
...
func (e BACnetLogStatus) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint8("BACnetLogStatus", 8, uint8(uint8(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}

func (e BACnetLogStatus) GetValue() uint8 {
	return uint8(e)
}
