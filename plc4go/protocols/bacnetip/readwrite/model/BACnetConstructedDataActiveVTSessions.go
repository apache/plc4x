...
func (m *_BACnetConstructedDataActiveVTSessions) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataActiveVTSessions) GetLengthInBytes(ctx context.Context) uint64 {
