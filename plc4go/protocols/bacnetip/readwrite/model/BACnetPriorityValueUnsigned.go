...
func (m *_BACnetPriorityValueUnsigned) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPriorityValueUnsigned) GetLengthInBytes(ctx context.Context) uint64 {
