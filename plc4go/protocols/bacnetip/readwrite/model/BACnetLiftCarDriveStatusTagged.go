...
func (m *_BACnetLiftCarDriveStatusTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetLiftCarDriveStatusTagged) GetLengthInBytes(ctx context.Context) uint64 {
