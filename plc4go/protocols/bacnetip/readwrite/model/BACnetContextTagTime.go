...
func (m *_BACnetContextTagTime) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetContextTag, tagNumberArgument uint8, dataType BACnetDataType) (_bACnetContextTagTime BACnetContextTagTime, err error) {
