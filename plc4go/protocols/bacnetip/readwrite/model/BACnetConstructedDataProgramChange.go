...
func (m *_BACnetConstructedDataProgramChange) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataProgramChange) GetLengthInBytes(ctx context.Context) uint64 {
