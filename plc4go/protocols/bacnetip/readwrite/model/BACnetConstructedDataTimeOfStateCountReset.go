...
func (m *BACnetConstructedDataTimeOfStateCountReset) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag) {
...
func NewBACnetConstructedDataTimeOfStateCountReset(timeOfStateCountReset *BACnetDateTime, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag, tagNumber uint8) *BACnetConstructedDataTimeOfStateCountReset {
