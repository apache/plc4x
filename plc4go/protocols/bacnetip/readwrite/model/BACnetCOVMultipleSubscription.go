...
func (m *_BACnetCOVMultipleSubscription) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_bACnetCOVMultipleSubscription BACnetCOVMultipleSubscription, err error) {
