...
func (m *_BACnetPriorityValueDateBuilder) WithMandatoryFields(dateValue BACnetApplicationTagDate) BACnetPriorityValueDateBuilder {
	return m.WithDateValue(dateValue)
}

func (m *_BACnetPriorityValueDateBuilder) WithDateValue(dateValue BACnetApplicationTagDate) BACnetPriorityValueDateBuilder {
	m.DateValue = dateValue
	return m
}

func (m *_BACnetPriorityValueDateBuilder) WithDateValueBuilder(builderSupplier func(BACnetApplicationTagDateBuilder) BACnetApplicationTagDateBuilder) BACnetPriorityValueDateBuilder {
...
func (m *_BACnetPriorityValueDateBuilder) Build() (BACnetPriorityValueDate, error) {
	if m.DateValue == nil {
		if m.err == nil {
	...
	return m._BACnetPriorityValueDate.deepCopy(), nil
}

func (m *_BACnetPriorityValueDateBuilder) MustBuild() BACnetPriorityValueDate {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetPriorityValueDateBuilder) DeepCopy() any {
	return m.CreateBACnetPriorityValueDateBuilder()
}

// CreateBACnetPriorityValueDateBuilder creates a BACnetPriorityValueDateBuilder
func (m *_BACnetPriorityValueDate) CreateBACnetPriorityValueDateBuilder() BACnetPriorityValueDateBuilder {
	if m == nil {
		return NewBACnetPriorityValueDateBuilder()
	}
	return &_BACnetPriorityValueDateBuilder{_BACnetPriorityValueDate: m.deepCopy()}
}
