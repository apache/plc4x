...
func NewBACnetPriorityValueDate(dateValue *BACnetApplicationTagDate, peekedTagHeader *BACnetTagHeader, objectTypeArgument BACnetObjectType) *BACnetPriorityValueDate {
