...
func (m *_ErrorCodeTagged) GetPlx4xTypeName() string {
	return "ErrorCodeTagged"
}

func (m *_ErrorCodeTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ErrorCodeTagged) GetLengthInBytes(ctx context.Context) uint64 {
