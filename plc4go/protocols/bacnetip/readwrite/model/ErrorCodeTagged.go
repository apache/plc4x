...
func (m *_ErrorCodeTagged) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (_errorCodeTagged ErrorCodeTagged, err error) {
