...
// ErrorCodeTagged is the data-structure of this message
type ErrorCodeTagged struct {
...
// IErrorCodeTagged is the corresponding interface of ErrorCodeTagged
type IErrorCodeTagged interface {
...
func (m *ErrorCodeTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *ErrorCodeTagged) GetValue() ErrorCode {
	return m.Value
}

func (m *ErrorCodeTagged) GetProprietaryValue() uint32 {
...
func (m *ErrorCodeTagged) GetIsProprietary() bool {
...
// NewErrorCodeTagged factory function for ErrorCodeTagged
func NewErrorCodeTagged(header *BACnetTagHeader, value ErrorCode, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *ErrorCodeTagged {
	return &ErrorCodeTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}

func CastErrorCodeTagged(structType interface{}) *ErrorCodeTagged {
...
func (m *ErrorCodeTagged) GetTypeName() string {
	return "ErrorCodeTagged"
}

func (m *ErrorCodeTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *ErrorCodeTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *ErrorCodeTagged) GetLengthInBytes() uint16 {
...
func (m *ErrorCodeTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *ErrorCodeTagged) String() string {
	if m == nil {
		return "<nil>"
	}
