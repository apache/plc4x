...
func (m *_BACnetClientCOVObject) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetClientCOV) (_bACnetClientCOVObject BACnetClientCOVObject, err error) {
