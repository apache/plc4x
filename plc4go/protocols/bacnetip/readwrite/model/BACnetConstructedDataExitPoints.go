...
func (m *_BACnetConstructedDataExitPoints) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataExitPoints) GetLengthInBytes(ctx context.Context) uint64 {
