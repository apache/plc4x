...
func (m *_BACnetConstructedDataListOfGroupMembers) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataListOfGroupMembers) GetLengthInBytes(ctx context.Context) uint64 {
