...
func (m *BACnetConstructedDataListOfGroupMembers) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag) {
...
func NewBACnetConstructedDataListOfGroupMembers(listOfGroupMembers []*BACnetReadAccessSpecification, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag, tagNumber uint8) *BACnetConstructedDataListOfGroupMembers {
