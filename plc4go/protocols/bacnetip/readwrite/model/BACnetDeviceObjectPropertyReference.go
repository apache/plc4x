...
func (m *_BACnetDeviceObjectPropertyReference) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_bACnetDeviceObjectPropertyReference BACnetDeviceObjectPropertyReference, err error) {
