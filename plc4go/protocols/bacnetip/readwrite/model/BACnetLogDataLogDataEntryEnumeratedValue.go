...
func (m *_BACnetLogDataLogDataEntryEnumeratedValue) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetLogDataLogDataEntry) (_bACnetLogDataLogDataEntryEnumeratedValue BACnetLogDataLogDataEntryEnumeratedValue, err error) {
