...
func (m *_BACnetServicesSupportedTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetServicesSupportedTagged) GetLengthInBytes(ctx context.Context) uint64 {
