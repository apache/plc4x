...
func (m *_BACnetPropertyStatesAction) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesAction) GetLengthInBytes(ctx context.Context) uint64 {
