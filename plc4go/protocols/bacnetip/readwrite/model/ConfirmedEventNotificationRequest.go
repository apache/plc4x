...
func (m *_ConfirmedEventNotificationRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_confirmedEventNotificationRequest ConfirmedEventNotificationRequest, err error) {
