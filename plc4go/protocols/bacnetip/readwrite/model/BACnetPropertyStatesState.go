...
func (m *_BACnetPropertyStatesState) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetPropertyStates, peekedTagNumber uint8) (_bACnetPropertyStatesState BACnetPropertyStatesState, err error) {
