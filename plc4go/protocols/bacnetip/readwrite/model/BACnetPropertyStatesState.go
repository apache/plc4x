...
func (m *_BACnetPropertyStatesState) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesState) GetLengthInBytes(ctx context.Context) uint64 {
