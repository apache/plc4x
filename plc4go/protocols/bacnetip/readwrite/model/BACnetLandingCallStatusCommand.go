...
func (m *_BACnetLandingCallStatusCommand) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_bACnetLandingCallStatusCommand BACnetLandingCallStatusCommand, err error) {
