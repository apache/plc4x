...
func (m *BACnetConfirmedServiceRequestConfirmedEventNotification) GetEventType() *BACnetEventTypeTagged {
	return m.EventType
}
...
func (m *BACnetConfirmedServiceRequestConfirmedEventNotification) GetNotifyType() *BACnetNotifyTypeTagged {
	return m.NotifyType
}
...
func (m *BACnetConfirmedServiceRequestConfirmedEventNotification) GetFromState() *BACnetEventStateTagged {
	return m.FromState
}

func (m *BACnetConfirmedServiceRequestConfirmedEventNotification) GetToState() *BACnetEventStateTagged {
	return m.ToState
}
