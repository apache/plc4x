...
// BACnetEscalatorFaultTaggedExactly can be used when we want exactly this type and not a type which fulfills BACnetEscalatorFaultTagged.
// This is useful for switch cases.
type BACnetEscalatorFaultTaggedExactly interface {
	BACnetEscalatorFaultTagged
	isBACnetEscalatorFaultTagged() bool
}
...
func (m *_BACnetEscalatorFaultTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *_BACnetEscalatorFaultTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *_BACnetEscalatorFaultTagged) GetLengthInBytes() uint16 {
...
func BACnetEscalatorFaultTaggedParse(theBytes []byte, tagNumber uint8, tagClass TagClass) (BACnetEscalatorFaultTagged, error) {
	return BACnetEscalatorFaultTaggedParseWithBuffer(utils.NewReadBufferByteBased(theBytes), tagNumber, tagClass)
}
...
func (m *_BACnetEscalatorFaultTagged) SerializeWithWriteBuffer(writeBuffer utils.WriteBuffer) error {
