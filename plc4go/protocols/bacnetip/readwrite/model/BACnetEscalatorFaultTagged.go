...
func (m *_BACnetEscalatorFaultTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetEscalatorFaultTagged) GetLengthInBytes(ctx context.Context) uint64 {
