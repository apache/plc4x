...
// BACnetEscalatorFaultTagged is the data-structure of this message
type BACnetEscalatorFaultTagged struct {
...
// IBACnetEscalatorFaultTagged is the corresponding interface of BACnetEscalatorFaultTagged
type IBACnetEscalatorFaultTagged interface {
...
func (m *BACnetEscalatorFaultTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetEscalatorFaultTagged) GetValue() BACnetEscalatorFault {
	return m.Value
}

func (m *BACnetEscalatorFaultTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetEscalatorFaultTagged) GetIsProprietary() bool {
...
// NewBACnetEscalatorFaultTagged factory function for BACnetEscalatorFaultTagged
func NewBACnetEscalatorFaultTagged(header *BACnetTagHeader, value BACnetEscalatorFault, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetEscalatorFaultTagged {
	return &BACnetEscalatorFaultTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetEscalatorFaultTagged) GetTypeName() string {
	return "BACnetEscalatorFaultTagged"
}

func (m *BACnetEscalatorFaultTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetEscalatorFaultTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetEscalatorFaultTagged) GetLengthInBytes() uint16 {
...
func BACnetEscalatorFaultTaggedParse(readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (*BACnetEscalatorFaultTagged, error) {
	...
	// Virtual field
	_isProprietary := bool((value) == (BACnetEscalatorFault_VENDOR_PROPRIETARY_VALUE))
	...
	// Create the instance
	return NewBACnetEscalatorFaultTagged(header, value, proprietaryValue, tagNumber, tagClass), nil
}

func (m *BACnetEscalatorFaultTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetEscalatorFaultTagged) String() string {
	if m == nil {
		return "<nil>"
	}
