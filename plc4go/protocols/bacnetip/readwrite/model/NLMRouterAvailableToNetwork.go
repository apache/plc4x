...
func (m *_NLMRouterAvailableToNetwork) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_NLM, apduLength uint16) (_nLMRouterAvailableToNetwork NLMRouterAvailableToNetwork, err error) {
