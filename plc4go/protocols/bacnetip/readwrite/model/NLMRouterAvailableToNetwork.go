...
func (m *_NLMRouterAvailableToNetwork) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_NLMRouterAvailableToNetwork) GetLengthInBytes(ctx context.Context) uint64 {
