...
func (m *_BACnetReadAccessProperty) parse(ctx context.Context, readBuffer utils.ReadBuffer, objectTypeArgument BACnetObjectType) (_bACnetReadAccessProperty BACnetReadAccessProperty, err error) {
