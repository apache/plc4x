...
// BACnetAuthenticationFactor is the data-structure of this message
...
// IBACnetAuthenticationFactor is the corresponding interface of BACnetAuthenticationFactor
type IBACnetAuthenticationFactor interface {
...
func (m *BACnetAuthenticationFactor) GetFormatType() *BACnetAuthenticationFactorTypeTagged {
	return m.FormatType
}

func (m *BACnetAuthenticationFactor) GetFormatClass() *BACnetContextTagUnsignedInteger {
	return m.FormatClass
}

func (m *BACnetAuthenticationFactor) GetValue() *BACnetContextTagOctetString {
	return m.Value
}
...
// NewBACnetAuthenticationFactor factory function for BACnetAuthenticationFactor
func NewBACnetAuthenticationFactor(formatType *BACnetAuthenticationFactorTypeTagged, formatClass *BACnetContextTagUnsignedInteger, value *BACnetContextTagOctetString) *BACnetAuthenticationFactor {
	return &BACnetAuthenticationFactor{FormatType: formatType, FormatClass: formatClass, Value: value}
}
...
func (m *BACnetAuthenticationFactor) GetTypeName() string {
	return "BACnetAuthenticationFactor"
}

func (m *BACnetAuthenticationFactor) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetAuthenticationFactor) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetAuthenticationFactor) GetLengthInBytes() uint16 {
...
func BACnetAuthenticationFactorParse(readBuffer utils.ReadBuffer) (*BACnetAuthenticationFactor, error) {
	...
	formatClass := CastBACnetContextTagUnsignedInteger(_formatClass)
	...
	value := CastBACnetContextTagOctetString(_value)
...
func (m *BACnetAuthenticationFactor) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetAuthenticationFactor) String() string {
	if m == nil {
		return "<nil>"
	}
