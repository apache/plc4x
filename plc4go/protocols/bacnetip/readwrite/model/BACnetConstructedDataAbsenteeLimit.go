...
func (m *_BACnetConstructedDataAbsenteeLimit) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataAbsenteeLimit) GetLengthInBytes(ctx context.Context) uint64 {
