...
func (m *BACnetConstructedDataOccupancyCountEnable) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag) {
...
func (m *BACnetConstructedDataOccupancyCountEnable) GetActualValue() *BACnetApplicationTagBoolean {
...
func (m *BACnetConstructedDataOccupancyCountEnable) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		_occupancyCountEnableErr := writeBuffer.WriteSerializable(m.OccupancyCountEnable)
