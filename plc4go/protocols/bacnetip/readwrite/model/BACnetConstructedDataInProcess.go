...
func (m *_BACnetConstructedDataInProcess) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataInProcess) GetLengthInBytes(ctx context.Context) uint64 {
