...
func (m *_ConfirmedPrivateTransferError) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetError, errorChoice BACnetConfirmedServiceChoice) (_confirmedPrivateTransferError ConfirmedPrivateTransferError, err error) {
