...
func BACnetFaultParameterFaultOutOfRangeMinNormalValueDoubleParse(theBytes []byte, tagNumber uint8) (BACnetFaultParameterFaultOutOfRangeMinNormalValueDouble, error) {
	return BACnetFaultParameterFaultOutOfRangeMinNormalValueDoubleParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian)), tagNumber) // TODO: get endianness from mspec
}
