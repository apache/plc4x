...
func (m *_BACnetServiceAckRequestKey) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetServiceAck, serviceAckPayloadLength uint32, serviceAckLength uint32) (_bACnetServiceAckRequestKey BACnetServiceAckRequestKey, err error) {
