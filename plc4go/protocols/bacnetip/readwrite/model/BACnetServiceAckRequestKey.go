...
func (m *_BACnetServiceAckRequestKeyBuilder) WithMandatoryFields(bytesOfRemovedService []byte) BACnetServiceAckRequestKeyBuilder {
	return m.WithBytesOfRemovedService(bytesOfRemovedService...)
}

func (m *_BACnetServiceAckRequestKeyBuilder) WithBytesOfRemovedService(bytesOfRemovedService ...byte) BACnetServiceAckRequestKeyBuilder {
	m.BytesOfRemovedService = bytesOfRemovedService
	return m
}

func (m *_BACnetServiceAckRequestKeyBuilder) Build() (BACnetServiceAckRequestKey, error) {
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._BACnetServiceAckRequestKey.deepCopy(), nil
}

func (m *_BACnetServiceAckRequestKeyBuilder) MustBuild() BACnetServiceAckRequestKey {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetServiceAckRequestKeyBuilder) DeepCopy() any {
	return m.CreateBACnetServiceAckRequestKeyBuilder()
}

// CreateBACnetServiceAckRequestKeyBuilder creates a BACnetServiceAckRequestKeyBuilder
func (m *_BACnetServiceAckRequestKey) CreateBACnetServiceAckRequestKeyBuilder() BACnetServiceAckRequestKeyBuilder {
	if m == nil {
		return NewBACnetServiceAckRequestKeyBuilder()
	}
	return &_BACnetServiceAckRequestKeyBuilder{_BACnetServiceAckRequestKey: m.deepCopy()}
}
