...
func (m *_BACnetConstructedDataErrorLimit) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataErrorLimit) GetLengthInBytes(ctx context.Context) uint64 {
