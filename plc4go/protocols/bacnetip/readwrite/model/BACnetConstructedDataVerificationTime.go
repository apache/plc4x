...
func (m *_BACnetConstructedDataVerificationTime) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataVerificationTime) GetLengthInBytes(ctx context.Context) uint64 {
