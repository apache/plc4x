...
func (m *_BACnetConstructedDataLifeSafetyZoneFaultValues) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataLifeSafetyZoneFaultValues) GetLengthInBytes(ctx context.Context) uint64 {
