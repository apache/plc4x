...
// DateTimeValue is the corresponding interface of DateTimeValue
type DateTimeValue interface {
	...
	// IsDateTimeValue is a marker method to prevent unintentional type checks (interfaces of same signature)
	IsDateTimeValue()
	// CreateBuilder creates a DateTimeValueBuilder
	CreateDateTimeValueBuilder() DateTimeValueBuilder
}

// _DateTimeValue is the data-structure of this message
type _DateTimeValue struct {
...
var _ DateTimeValue = (*_DateTimeValue)(nil)

// NewDateTimeValue factory function for _DateTimeValue
func NewDateTimeValue(objectIdentifier ReadableProperty, objectName ReadableProperty, objectType ReadableProperty, description OptionalProperty, presentValue ReadableProperty, statusFlags ReadableProperty, eventState OptionalProperty, reliability OptionalProperty, outOfService OptionalProperty, priorityArray OptionalProperty, relinquishDefault OptionalProperty, isUTC OptionalProperty, reliabilityEvaluationInhibit OptionalProperty, propertyList ReadableProperty, eventDetectionEnable OptionalProperty, notificationClass OptionalProperty, eventEnable OptionalProperty, ackedTransitions OptionalProperty, notifyType OptionalProperty, eventTimeStamps OptionalProperty, eventMessageTexts OptionalProperty, eventMessageTextsConfig OptionalProperty, currentCommandPriority OptionalProperty, valueSource OptionalProperty, valueSourceArray OptionalProperty, lastCommandTime OptionalProperty, commandTimeArray OptionalProperty, tags OptionalProperty, profileLocation OptionalProperty, profileName OptionalProperty) *_DateTimeValue {
	if objectIdentifier == nil {
		panic("objectIdentifier of type ReadableProperty for DateTimeValue must not be nil")
	}
	if objectName == nil {
		panic("objectName of type ReadableProperty for DateTimeValue must not be nil")
	}
	if objectType == nil {
		panic("objectType of type ReadableProperty for DateTimeValue must not be nil")
	}
	if description == nil {
		panic("description of type OptionalProperty for DateTimeValue must not be nil")
	}
	if presentValue == nil {
		panic("presentValue of type ReadableProperty for DateTimeValue must not be nil")
	}
	if statusFlags == nil {
		panic("statusFlags of type ReadableProperty for DateTimeValue must not be nil")
	}
	if eventState == nil {
		panic("eventState of type OptionalProperty for DateTimeValue must not be nil")
	}
	if reliability == nil {
		panic("reliability of type OptionalProperty for DateTimeValue must not be nil")
	}
	if outOfService == nil {
		panic("outOfService of type OptionalProperty for DateTimeValue must not be nil")
	}
	if priorityArray == nil {
		panic("priorityArray of type OptionalProperty for DateTimeValue must not be nil")
	}
	if relinquishDefault == nil {
		panic("relinquishDefault of type OptionalProperty for DateTimeValue must not be nil")
	}
	if isUTC == nil {
		panic("isUTC of type OptionalProperty for DateTimeValue must not be nil")
	}
	if reliabilityEvaluationInhibit == nil {
		panic("reliabilityEvaluationInhibit of type OptionalProperty for DateTimeValue must not be nil")
	}
	if propertyList == nil {
		panic("propertyList of type ReadableProperty for DateTimeValue must not be nil")
	}
	if eventDetectionEnable == nil {
		panic("eventDetectionEnable of type OptionalProperty for DateTimeValue must not be nil")
	}
	if notificationClass == nil {
		panic("notificationClass of type OptionalProperty for DateTimeValue must not be nil")
	}
	if eventEnable == nil {
		panic("eventEnable of type OptionalProperty for DateTimeValue must not be nil")
	}
	if ackedTransitions == nil {
		panic("ackedTransitions of type OptionalProperty for DateTimeValue must not be nil")
	}
	if notifyType == nil {
		panic("notifyType of type OptionalProperty for DateTimeValue must not be nil")
	}
	if eventTimeStamps == nil {
		panic("eventTimeStamps of type OptionalProperty for DateTimeValue must not be nil")
	}
	if eventMessageTexts == nil {
		panic("eventMessageTexts of type OptionalProperty for DateTimeValue must not be nil")
	}
	if eventMessageTextsConfig == nil {
		panic("eventMessageTextsConfig of type OptionalProperty for DateTimeValue must not be nil")
	}
	if currentCommandPriority == nil {
		panic("currentCommandPriority of type OptionalProperty for DateTimeValue must not be nil")
	}
	if valueSource == nil {
		panic("valueSource of type OptionalProperty for DateTimeValue must not be nil")
	}
	if valueSourceArray == nil {
		panic("valueSourceArray of type OptionalProperty for DateTimeValue must not be nil")
	}
	if lastCommandTime == nil {
		panic("lastCommandTime of type OptionalProperty for DateTimeValue must not be nil")
	}
	if commandTimeArray == nil {
		panic("commandTimeArray of type OptionalProperty for DateTimeValue must not be nil")
	}
	if tags == nil {
		panic("tags of type OptionalProperty for DateTimeValue must not be nil")
	}
	if profileLocation == nil {
		panic("profileLocation of type OptionalProperty for DateTimeValue must not be nil")
	}
	if profileName == nil {
		panic("profileName of type OptionalProperty for DateTimeValue must not be nil")
	}
...
// DateTimeValueBuilder is a builder for DateTimeValue
type DateTimeValueBuilder interface {
	utils.Copyable
	// WithMandatoryFields adds all mandatory fields (convenience for using multiple builder calls)
	WithMandatoryFields(objectIdentifier ReadableProperty, objectName ReadableProperty, objectType ReadableProperty, description OptionalProperty, presentValue ReadableProperty, statusFlags ReadableProperty, eventState OptionalProperty, reliability OptionalProperty, outOfService OptionalProperty, priorityArray OptionalProperty, relinquishDefault OptionalProperty, isUTC OptionalProperty, reliabilityEvaluationInhibit OptionalProperty, propertyList ReadableProperty, eventDetectionEnable OptionalProperty, notificationClass OptionalProperty, eventEnable OptionalProperty, ackedTransitions OptionalProperty, notifyType OptionalProperty, eventTimeStamps OptionalProperty, eventMessageTexts OptionalProperty, eventMessageTextsConfig OptionalProperty, currentCommandPriority OptionalProperty, valueSource OptionalProperty, valueSourceArray OptionalProperty, lastCommandTime OptionalProperty, commandTimeArray OptionalProperty, tags OptionalProperty, profileLocation OptionalProperty, profileName OptionalProperty) DateTimeValueBuilder
	// WithObjectIdentifier adds ObjectIdentifier (property field)
	WithObjectIdentifier(ReadableProperty) DateTimeValueBuilder
	// WithObjectIdentifierBuilder adds ObjectIdentifier (property field) which is build by the builder
	WithObjectIdentifierBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) DateTimeValueBuilder
	// WithObjectName adds ObjectName (property field)
	WithObjectName(ReadableProperty) DateTimeValueBuilder
	// WithObjectNameBuilder adds ObjectName (property field) which is build by the builder
	WithObjectNameBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) DateTimeValueBuilder
	// WithObjectType adds ObjectType (property field)
	WithObjectType(ReadableProperty) DateTimeValueBuilder
	// WithObjectTypeBuilder adds ObjectType (property field) which is build by the builder
	WithObjectTypeBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) DateTimeValueBuilder
	// WithDescription adds Description (property field)
	WithDescription(OptionalProperty) DateTimeValueBuilder
	// WithDescriptionBuilder adds Description (property field) which is build by the builder
	WithDescriptionBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder
	// WithPresentValue adds PresentValue (property field)
	WithPresentValue(ReadableProperty) DateTimeValueBuilder
	// WithPresentValueBuilder adds PresentValue (property field) which is build by the builder
	WithPresentValueBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) DateTimeValueBuilder
	// WithStatusFlags adds StatusFlags (property field)
	WithStatusFlags(ReadableProperty) DateTimeValueBuilder
	// WithStatusFlagsBuilder adds StatusFlags (property field) which is build by the builder
	WithStatusFlagsBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) DateTimeValueBuilder
	// WithEventState adds EventState (property field)
	WithEventState(OptionalProperty) DateTimeValueBuilder
	// WithEventStateBuilder adds EventState (property field) which is build by the builder
	WithEventStateBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder
	// WithReliability adds Reliability (property field)
	WithReliability(OptionalProperty) DateTimeValueBuilder
	// WithReliabilityBuilder adds Reliability (property field) which is build by the builder
	WithReliabilityBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder
	// WithOutOfService adds OutOfService (property field)
	WithOutOfService(OptionalProperty) DateTimeValueBuilder
	// WithOutOfServiceBuilder adds OutOfService (property field) which is build by the builder
	WithOutOfServiceBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder
	// WithPriorityArray adds PriorityArray (property field)
	WithPriorityArray(OptionalProperty) DateTimeValueBuilder
	// WithPriorityArrayBuilder adds PriorityArray (property field) which is build by the builder
	WithPriorityArrayBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder
	// WithRelinquishDefault adds RelinquishDefault (property field)
	WithRelinquishDefault(OptionalProperty) DateTimeValueBuilder
	// WithRelinquishDefaultBuilder adds RelinquishDefault (property field) which is build by the builder
	WithRelinquishDefaultBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder
	// WithIsUTC adds IsUTC (property field)
	WithIsUTC(OptionalProperty) DateTimeValueBuilder
	// WithIsUTCBuilder adds IsUTC (property field) which is build by the builder
	WithIsUTCBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder
	// WithReliabilityEvaluationInhibit adds ReliabilityEvaluationInhibit (property field)
	WithReliabilityEvaluationInhibit(OptionalProperty) DateTimeValueBuilder
	// WithReliabilityEvaluationInhibitBuilder adds ReliabilityEvaluationInhibit (property field) which is build by the builder
	WithReliabilityEvaluationInhibitBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder
	// WithPropertyList adds PropertyList (property field)
	WithPropertyList(ReadableProperty) DateTimeValueBuilder
	// WithPropertyListBuilder adds PropertyList (property field) which is build by the builder
	WithPropertyListBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) DateTimeValueBuilder
	// WithEventDetectionEnable adds EventDetectionEnable (property field)
	WithEventDetectionEnable(OptionalProperty) DateTimeValueBuilder
	// WithEventDetectionEnableBuilder adds EventDetectionEnable (property field) which is build by the builder
	WithEventDetectionEnableBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder
	// WithNotificationClass adds NotificationClass (property field)
	WithNotificationClass(OptionalProperty) DateTimeValueBuilder
	// WithNotificationClassBuilder adds NotificationClass (property field) which is build by the builder
	WithNotificationClassBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder
	// WithEventEnable adds EventEnable (property field)
	WithEventEnable(OptionalProperty) DateTimeValueBuilder
	// WithEventEnableBuilder adds EventEnable (property field) which is build by the builder
	WithEventEnableBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder
	// WithAckedTransitions adds AckedTransitions (property field)
	WithAckedTransitions(OptionalProperty) DateTimeValueBuilder
	// WithAckedTransitionsBuilder adds AckedTransitions (property field) which is build by the builder
	WithAckedTransitionsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder
	// WithNotifyType adds NotifyType (property field)
	WithNotifyType(OptionalProperty) DateTimeValueBuilder
	// WithNotifyTypeBuilder adds NotifyType (property field) which is build by the builder
	WithNotifyTypeBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder
	// WithEventTimeStamps adds EventTimeStamps (property field)
	WithEventTimeStamps(OptionalProperty) DateTimeValueBuilder
	// WithEventTimeStampsBuilder adds EventTimeStamps (property field) which is build by the builder
	WithEventTimeStampsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder
	// WithEventMessageTexts adds EventMessageTexts (property field)
	WithEventMessageTexts(OptionalProperty) DateTimeValueBuilder
	// WithEventMessageTextsBuilder adds EventMessageTexts (property field) which is build by the builder
	WithEventMessageTextsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder
	// WithEventMessageTextsConfig adds EventMessageTextsConfig (property field)
	WithEventMessageTextsConfig(OptionalProperty) DateTimeValueBuilder
	// WithEventMessageTextsConfigBuilder adds EventMessageTextsConfig (property field) which is build by the builder
	WithEventMessageTextsConfigBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder
	// WithCurrentCommandPriority adds CurrentCommandPriority (property field)
	WithCurrentCommandPriority(OptionalProperty) DateTimeValueBuilder
	// WithCurrentCommandPriorityBuilder adds CurrentCommandPriority (property field) which is build by the builder
	WithCurrentCommandPriorityBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder
	// WithValueSource adds ValueSource (property field)
	WithValueSource(OptionalProperty) DateTimeValueBuilder
	// WithValueSourceBuilder adds ValueSource (property field) which is build by the builder
	WithValueSourceBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder
	// WithValueSourceArray adds ValueSourceArray (property field)
	WithValueSourceArray(OptionalProperty) DateTimeValueBuilder
	// WithValueSourceArrayBuilder adds ValueSourceArray (property field) which is build by the builder
	WithValueSourceArrayBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder
	// WithLastCommandTime adds LastCommandTime (property field)
	WithLastCommandTime(OptionalProperty) DateTimeValueBuilder
	// WithLastCommandTimeBuilder adds LastCommandTime (property field) which is build by the builder
	WithLastCommandTimeBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder
	// WithCommandTimeArray adds CommandTimeArray (property field)
	WithCommandTimeArray(OptionalProperty) DateTimeValueBuilder
	// WithCommandTimeArrayBuilder adds CommandTimeArray (property field) which is build by the builder
	WithCommandTimeArrayBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder
	// WithTags adds Tags (property field)
	WithTags(OptionalProperty) DateTimeValueBuilder
	// WithTagsBuilder adds Tags (property field) which is build by the builder
	WithTagsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder
	// WithProfileLocation adds ProfileLocation (property field)
	WithProfileLocation(OptionalProperty) DateTimeValueBuilder
	// WithProfileLocationBuilder adds ProfileLocation (property field) which is build by the builder
	WithProfileLocationBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder
	// WithProfileName adds ProfileName (property field)
	WithProfileName(OptionalProperty) DateTimeValueBuilder
	// WithProfileNameBuilder adds ProfileName (property field) which is build by the builder
	WithProfileNameBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder
	// Build builds the DateTimeValue or returns an error if something is wrong
	Build() (DateTimeValue, error)
	// MustBuild does the same as Build but panics on error
	MustBuild() DateTimeValue
}

// NewDateTimeValueBuilder() creates a DateTimeValueBuilder
func NewDateTimeValueBuilder() DateTimeValueBuilder {
	return &_DateTimeValueBuilder{_DateTimeValue: new(_DateTimeValue)}
}

type _DateTimeValueBuilder struct {
	*_DateTimeValue

	err *utils.MultiError
}

var _ (DateTimeValueBuilder) = (*_DateTimeValueBuilder)(nil)

func (b *_DateTimeValueBuilder) WithMandatoryFields(objectIdentifier ReadableProperty, objectName ReadableProperty, objectType ReadableProperty, description OptionalProperty, presentValue ReadableProperty, statusFlags ReadableProperty, eventState OptionalProperty, reliability OptionalProperty, outOfService OptionalProperty, priorityArray OptionalProperty, relinquishDefault OptionalProperty, isUTC OptionalProperty, reliabilityEvaluationInhibit OptionalProperty, propertyList ReadableProperty, eventDetectionEnable OptionalProperty, notificationClass OptionalProperty, eventEnable OptionalProperty, ackedTransitions OptionalProperty, notifyType OptionalProperty, eventTimeStamps OptionalProperty, eventMessageTexts OptionalProperty, eventMessageTextsConfig OptionalProperty, currentCommandPriority OptionalProperty, valueSource OptionalProperty, valueSourceArray OptionalProperty, lastCommandTime OptionalProperty, commandTimeArray OptionalProperty, tags OptionalProperty, profileLocation OptionalProperty, profileName OptionalProperty) DateTimeValueBuilder {
	return b.WithObjectIdentifier(objectIdentifier).WithObjectName(objectName).WithObjectType(objectType).WithDescription(description).WithPresentValue(presentValue).WithStatusFlags(statusFlags).WithEventState(eventState).WithReliability(reliability).WithOutOfService(outOfService).WithPriorityArray(priorityArray).WithRelinquishDefault(relinquishDefault).WithIsUTC(isUTC).WithReliabilityEvaluationInhibit(reliabilityEvaluationInhibit).WithPropertyList(propertyList).WithEventDetectionEnable(eventDetectionEnable).WithNotificationClass(notificationClass).WithEventEnable(eventEnable).WithAckedTransitions(ackedTransitions).WithNotifyType(notifyType).WithEventTimeStamps(eventTimeStamps).WithEventMessageTexts(eventMessageTexts).WithEventMessageTextsConfig(eventMessageTextsConfig).WithCurrentCommandPriority(currentCommandPriority).WithValueSource(valueSource).WithValueSourceArray(valueSourceArray).WithLastCommandTime(lastCommandTime).WithCommandTimeArray(commandTimeArray).WithTags(tags).WithProfileLocation(profileLocation).WithProfileName(profileName)
}

func (b *_DateTimeValueBuilder) WithObjectIdentifier(objectIdentifier ReadableProperty) DateTimeValueBuilder {
	b.ObjectIdentifier = objectIdentifier
	return b
}

func (b *_DateTimeValueBuilder) WithObjectIdentifierBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithObjectName(objectName ReadableProperty) DateTimeValueBuilder {
	b.ObjectName = objectName
	return b
}

func (b *_DateTimeValueBuilder) WithObjectNameBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithObjectType(objectType ReadableProperty) DateTimeValueBuilder {
	b.ObjectType = objectType
	return b
}

func (b *_DateTimeValueBuilder) WithObjectTypeBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithDescription(description OptionalProperty) DateTimeValueBuilder {
	b.Description = description
	return b
}

func (b *_DateTimeValueBuilder) WithDescriptionBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithPresentValue(presentValue ReadableProperty) DateTimeValueBuilder {
	b.PresentValue = presentValue
	return b
}

func (b *_DateTimeValueBuilder) WithPresentValueBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithStatusFlags(statusFlags ReadableProperty) DateTimeValueBuilder {
	b.StatusFlags = statusFlags
	return b
}

func (b *_DateTimeValueBuilder) WithStatusFlagsBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithEventState(eventState OptionalProperty) DateTimeValueBuilder {
	b.EventState = eventState
	return b
}

func (b *_DateTimeValueBuilder) WithEventStateBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithReliability(reliability OptionalProperty) DateTimeValueBuilder {
	b.Reliability = reliability
	return b
}

func (b *_DateTimeValueBuilder) WithReliabilityBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithOutOfService(outOfService OptionalProperty) DateTimeValueBuilder {
	b.OutOfService = outOfService
	return b
}

func (b *_DateTimeValueBuilder) WithOutOfServiceBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithPriorityArray(priorityArray OptionalProperty) DateTimeValueBuilder {
	b.PriorityArray = priorityArray
	return b
}

func (b *_DateTimeValueBuilder) WithPriorityArrayBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithRelinquishDefault(relinquishDefault OptionalProperty) DateTimeValueBuilder {
	b.RelinquishDefault = relinquishDefault
	return b
}

func (b *_DateTimeValueBuilder) WithRelinquishDefaultBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithIsUTC(isUTC OptionalProperty) DateTimeValueBuilder {
	b.IsUTC = isUTC
	return b
}

func (b *_DateTimeValueBuilder) WithIsUTCBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithReliabilityEvaluationInhibit(reliabilityEvaluationInhibit OptionalProperty) DateTimeValueBuilder {
	b.ReliabilityEvaluationInhibit = reliabilityEvaluationInhibit
	return b
}

func (b *_DateTimeValueBuilder) WithReliabilityEvaluationInhibitBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithPropertyList(propertyList ReadableProperty) DateTimeValueBuilder {
	b.PropertyList = propertyList
	return b
}

func (b *_DateTimeValueBuilder) WithPropertyListBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithEventDetectionEnable(eventDetectionEnable OptionalProperty) DateTimeValueBuilder {
	b.EventDetectionEnable = eventDetectionEnable
	return b
}

func (b *_DateTimeValueBuilder) WithEventDetectionEnableBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithNotificationClass(notificationClass OptionalProperty) DateTimeValueBuilder {
	b.NotificationClass = notificationClass
	return b
}

func (b *_DateTimeValueBuilder) WithNotificationClassBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithEventEnable(eventEnable OptionalProperty) DateTimeValueBuilder {
	b.EventEnable = eventEnable
	return b
}

func (b *_DateTimeValueBuilder) WithEventEnableBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithAckedTransitions(ackedTransitions OptionalProperty) DateTimeValueBuilder {
	b.AckedTransitions = ackedTransitions
	return b
}

func (b *_DateTimeValueBuilder) WithAckedTransitionsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithNotifyType(notifyType OptionalProperty) DateTimeValueBuilder {
	b.NotifyType = notifyType
	return b
}

func (b *_DateTimeValueBuilder) WithNotifyTypeBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithEventTimeStamps(eventTimeStamps OptionalProperty) DateTimeValueBuilder {
	b.EventTimeStamps = eventTimeStamps
	return b
}

func (b *_DateTimeValueBuilder) WithEventTimeStampsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithEventMessageTexts(eventMessageTexts OptionalProperty) DateTimeValueBuilder {
	b.EventMessageTexts = eventMessageTexts
	return b
}

func (b *_DateTimeValueBuilder) WithEventMessageTextsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithEventMessageTextsConfig(eventMessageTextsConfig OptionalProperty) DateTimeValueBuilder {
	b.EventMessageTextsConfig = eventMessageTextsConfig
	return b
}

func (b *_DateTimeValueBuilder) WithEventMessageTextsConfigBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithCurrentCommandPriority(currentCommandPriority OptionalProperty) DateTimeValueBuilder {
	b.CurrentCommandPriority = currentCommandPriority
	return b
}

func (b *_DateTimeValueBuilder) WithCurrentCommandPriorityBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithValueSource(valueSource OptionalProperty) DateTimeValueBuilder {
	b.ValueSource = valueSource
	return b
}

func (b *_DateTimeValueBuilder) WithValueSourceBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithValueSourceArray(valueSourceArray OptionalProperty) DateTimeValueBuilder {
	b.ValueSourceArray = valueSourceArray
	return b
}

func (b *_DateTimeValueBuilder) WithValueSourceArrayBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithLastCommandTime(lastCommandTime OptionalProperty) DateTimeValueBuilder {
	b.LastCommandTime = lastCommandTime
	return b
}

func (b *_DateTimeValueBuilder) WithLastCommandTimeBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithCommandTimeArray(commandTimeArray OptionalProperty) DateTimeValueBuilder {
	b.CommandTimeArray = commandTimeArray
	return b
}

func (b *_DateTimeValueBuilder) WithCommandTimeArrayBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithTags(tags OptionalProperty) DateTimeValueBuilder {
	b.Tags = tags
	return b
}

func (b *_DateTimeValueBuilder) WithTagsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithProfileLocation(profileLocation OptionalProperty) DateTimeValueBuilder {
	b.ProfileLocation = profileLocation
	return b
}

func (b *_DateTimeValueBuilder) WithProfileLocationBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) WithProfileName(profileName OptionalProperty) DateTimeValueBuilder {
	b.ProfileName = profileName
	return b
}

func (b *_DateTimeValueBuilder) WithProfileNameBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) DateTimeValueBuilder {
...
func (b *_DateTimeValueBuilder) Build() (DateTimeValue, error) {
	...
	return b._DateTimeValue.deepCopy(), nil
}

func (b *_DateTimeValueBuilder) MustBuild() DateTimeValue {
	build, err := b.Build()
	if err != nil {
		panic(err)
	}
...
func (b *_DateTimeValueBuilder) DeepCopy() any {
	_copy := b.CreateDateTimeValueBuilder().(*_DateTimeValueBuilder)
	if b.err != nil {
...
// CreateDateTimeValueBuilder creates a DateTimeValueBuilder
func (b *_DateTimeValue) CreateDateTimeValueBuilder() DateTimeValueBuilder {
	if b == nil {
		return NewDateTimeValueBuilder()
	}
	return &_DateTimeValueBuilder{_DateTimeValue: b.deepCopy()}
}
...
func (m *_DateTimeValue) GetObjectIdentifier() ReadableProperty {
	return m.ObjectIdentifier
}

func (m *_DateTimeValue) GetObjectName() ReadableProperty {
	return m.ObjectName
}

func (m *_DateTimeValue) GetObjectType() ReadableProperty {
	return m.ObjectType
}

func (m *_DateTimeValue) GetDescription() OptionalProperty {
	return m.Description
}

func (m *_DateTimeValue) GetPresentValue() ReadableProperty {
	return m.PresentValue
}

func (m *_DateTimeValue) GetStatusFlags() ReadableProperty {
	return m.StatusFlags
}

func (m *_DateTimeValue) GetEventState() OptionalProperty {
	return m.EventState
}

func (m *_DateTimeValue) GetReliability() OptionalProperty {
	return m.Reliability
}

func (m *_DateTimeValue) GetOutOfService() OptionalProperty {
	return m.OutOfService
}

func (m *_DateTimeValue) GetPriorityArray() OptionalProperty {
	return m.PriorityArray
}

func (m *_DateTimeValue) GetRelinquishDefault() OptionalProperty {
	return m.RelinquishDefault
}

func (m *_DateTimeValue) GetIsUTC() OptionalProperty {
	return m.IsUTC
}

func (m *_DateTimeValue) GetReliabilityEvaluationInhibit() OptionalProperty {
	return m.ReliabilityEvaluationInhibit
}

func (m *_DateTimeValue) GetPropertyList() ReadableProperty {
	return m.PropertyList
}

func (m *_DateTimeValue) GetEventDetectionEnable() OptionalProperty {
	return m.EventDetectionEnable
}

func (m *_DateTimeValue) GetNotificationClass() OptionalProperty {
	return m.NotificationClass
}

func (m *_DateTimeValue) GetEventEnable() OptionalProperty {
	return m.EventEnable
}

func (m *_DateTimeValue) GetAckedTransitions() OptionalProperty {
	return m.AckedTransitions
}

func (m *_DateTimeValue) GetNotifyType() OptionalProperty {
	return m.NotifyType
}

func (m *_DateTimeValue) GetEventTimeStamps() OptionalProperty {
	return m.EventTimeStamps
}

func (m *_DateTimeValue) GetEventMessageTexts() OptionalProperty {
	return m.EventMessageTexts
}

func (m *_DateTimeValue) GetEventMessageTextsConfig() OptionalProperty {
	return m.EventMessageTextsConfig
}

func (m *_DateTimeValue) GetCurrentCommandPriority() OptionalProperty {
	return m.CurrentCommandPriority
}

func (m *_DateTimeValue) GetValueSource() OptionalProperty {
	return m.ValueSource
}

func (m *_DateTimeValue) GetValueSourceArray() OptionalProperty {
	return m.ValueSourceArray
}

func (m *_DateTimeValue) GetLastCommandTime() OptionalProperty {
	return m.LastCommandTime
}

func (m *_DateTimeValue) GetCommandTimeArray() OptionalProperty {
	return m.CommandTimeArray
}

func (m *_DateTimeValue) GetTags() OptionalProperty {
	return m.Tags
}

func (m *_DateTimeValue) GetProfileLocation() OptionalProperty {
	return m.ProfileLocation
}

func (m *_DateTimeValue) GetProfileName() OptionalProperty {
...
func CastDateTimeValue(structType any) DateTimeValue {
	if casted, ok := structType.(DateTimeValue); ok {
		return casted
	}
	if casted, ok := structType.(*DateTimeValue); ok {
		return *casted
...
func (m *_DateTimeValue) GetTypeName() string {
	return "DateTimeValue"
}

func (m *_DateTimeValue) GetLengthInBits(ctx context.Context) uint16 {
...
func (m *_DateTimeValue) GetLengthInBytes(ctx context.Context) uint16 {
	return m.GetLengthInBits(ctx) / 8
}

func DateTimeValueParse(ctx context.Context, theBytes []byte) (DateTimeValue, error) {
	return DateTimeValueParseWithBuffer(ctx, utils.NewReadBufferByteBased(theBytes))
}

func DateTimeValueParseWithBufferProducer() func(ctx context.Context, readBuffer utils.ReadBuffer) (DateTimeValue, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (DateTimeValue, error) {
		return DateTimeValueParseWithBuffer(ctx, readBuffer)
	}
}

func DateTimeValueParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (DateTimeValue, error) {
	v, err := (&_DateTimeValue{}).parse(ctx, readBuffer)
	if err != nil {
		return nil, err
	}
	return v, nil
...
func (m *_DateTimeValue) parse(ctx context.Context, readBuffer utils.ReadBuffer) (__dateTimeValue DateTimeValue, err error) {
...
func (m *_DateTimeValue) Serialize() ([]byte, error) {
...
func (m *_DateTimeValue) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
...
func (m *_DateTimeValue) IsDateTimeValue() {}

func (m *_DateTimeValue) DeepCopy() any {
	return m.deepCopy()
}

func (m *_DateTimeValue) deepCopy() *_DateTimeValue {
	if m == nil {
		return nil
	}
	_DateTimeValueCopy := &_DateTimeValue{
	...
	return _DateTimeValueCopy
}

func (m *_DateTimeValue) String() string {
	if m == nil {
		return "<nil>"
	}
