...
func (m *_BACnetTagHeader) GetActualLength() uint32 {
	...
	extExtExtLength := m.GetExtExtExtLength()
	_ = extExtExtLength
	return uint32(utils.InlineIf(bool(bool((m.GetLengthValueType()) == ((5)))) && bool(bool(((*m.GetExtLength())) == ((255)))), func() any {return uint32((*m.GetExtExtExtLength()))}, func() any {return uint32((utils.InlineIf(bool(bool((m.GetLengthValueType()) == ((5)))) && bool(bool(((*m.GetExtLength())) == ((254)))), func() any {return uint32((*m.GetExtExtLength()))}, func() any {return uint32((utils.InlineIf(bool((m.GetLengthValueType()) == ((5))), func() any {return uint32((*m.GetExtLength()))}, func() any {return uint32(m.GetLengthValueType())}).(uint32)))}).(uint32)))}).(uint32))
}
...
lengthValueType,err := ReadSimpleField( ctx, "lengthValueType", ReadUnsignedByte(readBuffer, uint8(3)) )
	...
	actualLength,err := ReadVirtualField[uint32](ctx, "actualLength", (*uint32)(nil), utils.InlineIf(bool(bool((lengthValueType) == ((5)))) && bool(bool(((*extLength)) == ((255)))), func() any {return uint32((*extExtExtLength))}, func() any {return uint32((utils.InlineIf(bool(bool((lengthValueType) == ((5)))) && bool(bool(((*extLength)) == ((254)))), func() any {return uint32((*extExtLength))}, func() any {return uint32((utils.InlineIf(bool((lengthValueType) == ((5))), func() any {return uint32((*extLength))}, func() any {return uint32(lengthValueType)}).(uint32)))}).(uint32)))}).(uint32));
	if err != nil {
