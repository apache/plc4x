...
func (m *_BACnetConstructedDataModelName) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataModelName) GetLengthInBytes(ctx context.Context) uint64 {
