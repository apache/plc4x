...
func (m *_BACnetConstructedDataRepresents) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataRepresents) GetLengthInBytes(ctx context.Context) uint64 {
