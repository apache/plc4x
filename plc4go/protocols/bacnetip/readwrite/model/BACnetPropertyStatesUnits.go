...
func (m *_BACnetPropertyStatesUnits) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesUnits) GetLengthInBytes(ctx context.Context) uint64 {
