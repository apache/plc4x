...
func (m *_BACnetPriorityValueOctetString) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPriorityValueOctetString) GetLengthInBytes(ctx context.Context) uint64 {
