...
// MultistateInput is the corresponding interface of MultistateInput
type MultistateInput interface {
	fmt.Stringer
	utils.LengthAware
	utils.Serializable
	utils.Copyable
	...
	// IsMultistateInput is a marker method to prevent unintentional type checks (interfaces of same signature)
	IsMultistateInput()
	// CreateBuilder creates a MultistateInputBuilder
	CreateMultistateInputBuilder() MultistateInputBuilder
}

// _MultistateInput is the data-structure of this message
type _MultistateInput struct {
...
var _ MultistateInput = (*_MultistateInput)(nil)

// NewMultistateInput factory function for _MultistateInput
func NewMultistateInput(objectIdentifier ReadableProperty, objectName ReadableProperty, objectType ReadableProperty, presentValue ReadableProperty, description OptionalProperty, deviceType OptionalProperty, statusFlags ReadableProperty, eventState ReadableProperty, reliability OptionalProperty, outOfService ReadableProperty, numberOfStates ReadableProperty, stateText OptionalProperty, timeDelay OptionalProperty, notificationClass OptionalProperty, alarmValues OptionalProperty, faultValues OptionalProperty, eventEnable OptionalProperty, ackedTransitions OptionalProperty, notifyType OptionalProperty, eventTimeStamps OptionalProperty, eventMessageTexts OptionalProperty, eventMessageTextsConfig OptionalProperty, eventDetectionEnable OptionalProperty, eventAlgorithmInhibitRef OptionalProperty, eventAlgorithmInhibit OptionalProperty, timeDelayNormal OptionalProperty, reliabilityEvaluationInhibit OptionalProperty, propertyList ReadableProperty, interfaceValue OptionalProperty, tags OptionalProperty, profileLocation OptionalProperty, profileName OptionalProperty) *_MultistateInput {
	if objectIdentifier == nil {
		panic("objectIdentifier of type ReadableProperty for MultistateInput must not be nil")
	}
	if objectName == nil {
		panic("objectName of type ReadableProperty for MultistateInput must not be nil")
	}
	if objectType == nil {
		panic("objectType of type ReadableProperty for MultistateInput must not be nil")
	}
	if presentValue == nil {
		panic("presentValue of type ReadableProperty for MultistateInput must not be nil")
	}
	if description == nil {
		panic("description of type OptionalProperty for MultistateInput must not be nil")
	}
	if deviceType == nil {
		panic("deviceType of type OptionalProperty for MultistateInput must not be nil")
	}
	if statusFlags == nil {
		panic("statusFlags of type ReadableProperty for MultistateInput must not be nil")
	}
	if eventState == nil {
		panic("eventState of type ReadableProperty for MultistateInput must not be nil")
	}
	if reliability == nil {
		panic("reliability of type OptionalProperty for MultistateInput must not be nil")
	}
	if outOfService == nil {
		panic("outOfService of type ReadableProperty for MultistateInput must not be nil")
	}
	if numberOfStates == nil {
		panic("numberOfStates of type ReadableProperty for MultistateInput must not be nil")
	}
	if stateText == nil {
		panic("stateText of type OptionalProperty for MultistateInput must not be nil")
	}
	if timeDelay == nil {
		panic("timeDelay of type OptionalProperty for MultistateInput must not be nil")
	}
	if notificationClass == nil {
		panic("notificationClass of type OptionalProperty for MultistateInput must not be nil")
	}
	if alarmValues == nil {
		panic("alarmValues of type OptionalProperty for MultistateInput must not be nil")
	}
	if faultValues == nil {
		panic("faultValues of type OptionalProperty for MultistateInput must not be nil")
	}
	if eventEnable == nil {
		panic("eventEnable of type OptionalProperty for MultistateInput must not be nil")
	}
	if ackedTransitions == nil {
		panic("ackedTransitions of type OptionalProperty for MultistateInput must not be nil")
	}
	if notifyType == nil {
		panic("notifyType of type OptionalProperty for MultistateInput must not be nil")
	}
	if eventTimeStamps == nil {
		panic("eventTimeStamps of type OptionalProperty for MultistateInput must not be nil")
	}
	if eventMessageTexts == nil {
		panic("eventMessageTexts of type OptionalProperty for MultistateInput must not be nil")
	}
	if eventMessageTextsConfig == nil {
		panic("eventMessageTextsConfig of type OptionalProperty for MultistateInput must not be nil")
	}
	if eventDetectionEnable == nil {
		panic("eventDetectionEnable of type OptionalProperty for MultistateInput must not be nil")
	}
	if eventAlgorithmInhibitRef == nil {
		panic("eventAlgorithmInhibitRef of type OptionalProperty for MultistateInput must not be nil")
	}
	if eventAlgorithmInhibit == nil {
		panic("eventAlgorithmInhibit of type OptionalProperty for MultistateInput must not be nil")
	}
	if timeDelayNormal == nil {
		panic("timeDelayNormal of type OptionalProperty for MultistateInput must not be nil")
	}
	if reliabilityEvaluationInhibit == nil {
		panic("reliabilityEvaluationInhibit of type OptionalProperty for MultistateInput must not be nil")
	}
	if propertyList == nil {
		panic("propertyList of type ReadableProperty for MultistateInput must not be nil")
	}
	if interfaceValue == nil {
		panic("interfaceValue of type OptionalProperty for MultistateInput must not be nil")
	}
	if tags == nil {
		panic("tags of type OptionalProperty for MultistateInput must not be nil")
	}
	if profileLocation == nil {
		panic("profileLocation of type OptionalProperty for MultistateInput must not be nil")
	}
	if profileName == nil {
		panic("profileName of type OptionalProperty for MultistateInput must not be nil")
	}
	return &_MultistateInput{ObjectIdentifier: objectIdentifier, ObjectName: objectName, ObjectType: objectType, PresentValue: presentValue, Description: description, DeviceType: deviceType, StatusFlags: statusFlags, EventState: eventState, Reliability: reliability, OutOfService: outOfService, NumberOfStates: numberOfStates, StateText: stateText, TimeDelay: timeDelay, NotificationClass: notificationClass, AlarmValues: alarmValues, FaultValues: faultValues, EventEnable: eventEnable, AckedTransitions: ackedTransitions, NotifyType: notifyType, EventTimeStamps: eventTimeStamps, EventMessageTexts: eventMessageTexts, EventMessageTextsConfig: eventMessageTextsConfig, EventDetectionEnable: eventDetectionEnable, EventAlgorithmInhibitRef: eventAlgorithmInhibitRef, EventAlgorithmInhibit: eventAlgorithmInhibit, TimeDelayNormal: timeDelayNormal, ReliabilityEvaluationInhibit: reliabilityEvaluationInhibit, PropertyList: propertyList, InterfaceValue: interfaceValue, Tags: tags, ProfileLocation: profileLocation, ProfileName: profileName}
}
...
// MultistateInputBuilder is a builder for MultistateInput
type MultistateInputBuilder interface {
	utils.Copyable
	// WithMandatoryFields adds all mandatory fields (convenience for using multiple builder calls)
	WithMandatoryFields(objectIdentifier ReadableProperty, objectName ReadableProperty, objectType ReadableProperty, presentValue ReadableProperty, description OptionalProperty, deviceType OptionalProperty, statusFlags ReadableProperty, eventState ReadableProperty, reliability OptionalProperty, outOfService ReadableProperty, numberOfStates ReadableProperty, stateText OptionalProperty, timeDelay OptionalProperty, notificationClass OptionalProperty, alarmValues OptionalProperty, faultValues OptionalProperty, eventEnable OptionalProperty, ackedTransitions OptionalProperty, notifyType OptionalProperty, eventTimeStamps OptionalProperty, eventMessageTexts OptionalProperty, eventMessageTextsConfig OptionalProperty, eventDetectionEnable OptionalProperty, eventAlgorithmInhibitRef OptionalProperty, eventAlgorithmInhibit OptionalProperty, timeDelayNormal OptionalProperty, reliabilityEvaluationInhibit OptionalProperty, propertyList ReadableProperty, interfaceValue OptionalProperty, tags OptionalProperty, profileLocation OptionalProperty, profileName OptionalProperty) MultistateInputBuilder
	// WithObjectIdentifier adds ObjectIdentifier (property field)
	WithObjectIdentifier(ReadableProperty) MultistateInputBuilder
	// WithObjectIdentifierBuilder adds ObjectIdentifier (property field) which is build by the builder
	WithObjectIdentifierBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) MultistateInputBuilder
	...
	WithObjectNameBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) MultistateInputBuilder
	...
	WithObjectTypeBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) MultistateInputBuilder
	// WithPresentValue adds PresentValue (property field)
	WithPresentValue(ReadableProperty) MultistateInputBuilder
	// WithPresentValueBuilder adds PresentValue (property field) which is build by the builder
	WithPresentValueBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) MultistateInputBuilder
	// WithDescription adds Description (property field)
	WithDescription(OptionalProperty) MultistateInputBuilder
	// WithDescriptionBuilder adds Description (property field) which is build by the builder
	WithDescriptionBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder
	// WithDeviceType adds DeviceType (property field)
	WithDeviceType(OptionalProperty) MultistateInputBuilder
	// WithDeviceTypeBuilder adds DeviceType (property field) which is build by the builder
	WithDeviceTypeBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder
	...
	WithStatusFlagsBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) MultistateInputBuilder
	...
	WithEventStateBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) MultistateInputBuilder
	// WithReliability adds Reliability (property field)
	WithReliability(OptionalProperty) MultistateInputBuilder
	// WithReliabilityBuilder adds Reliability (property field) which is build by the builder
	WithReliabilityBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder
	...
	WithOutOfServiceBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) MultistateInputBuilder
	...
	WithNumberOfStatesBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) MultistateInputBuilder
	// WithStateText adds StateText (property field)
	WithStateText(OptionalProperty) MultistateInputBuilder
	// WithStateTextBuilder adds StateText (property field) which is build by the builder
	WithStateTextBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder
	// WithTimeDelay adds TimeDelay (property field)
	WithTimeDelay(OptionalProperty) MultistateInputBuilder
	// WithTimeDelayBuilder adds TimeDelay (property field) which is build by the builder
	WithTimeDelayBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder
	// WithNotificationClass adds NotificationClass (property field)
	WithNotificationClass(OptionalProperty) MultistateInputBuilder
	// WithNotificationClassBuilder adds NotificationClass (property field) which is build by the builder
	WithNotificationClassBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder
	// WithAlarmValues adds AlarmValues (property field)
	WithAlarmValues(OptionalProperty) MultistateInputBuilder
	// WithAlarmValuesBuilder adds AlarmValues (property field) which is build by the builder
	WithAlarmValuesBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder
	// WithFaultValues adds FaultValues (property field)
	WithFaultValues(OptionalProperty) MultistateInputBuilder
	// WithFaultValuesBuilder adds FaultValues (property field) which is build by the builder
	WithFaultValuesBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder
	// WithEventEnable adds EventEnable (property field)
	WithEventEnable(OptionalProperty) MultistateInputBuilder
	// WithEventEnableBuilder adds EventEnable (property field) which is build by the builder
	WithEventEnableBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder
	// WithAckedTransitions adds AckedTransitions (property field)
	WithAckedTransitions(OptionalProperty) MultistateInputBuilder
	// WithAckedTransitionsBuilder adds AckedTransitions (property field) which is build by the builder
	WithAckedTransitionsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder
	// WithNotifyType adds NotifyType (property field)
	WithNotifyType(OptionalProperty) MultistateInputBuilder
	// WithNotifyTypeBuilder adds NotifyType (property field) which is build by the builder
	WithNotifyTypeBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder
	// WithEventTimeStamps adds EventTimeStamps (property field)
	WithEventTimeStamps(OptionalProperty) MultistateInputBuilder
	// WithEventTimeStampsBuilder adds EventTimeStamps (property field) which is build by the builder
	WithEventTimeStampsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder
	// WithEventMessageTexts adds EventMessageTexts (property field)
	WithEventMessageTexts(OptionalProperty) MultistateInputBuilder
	// WithEventMessageTextsBuilder adds EventMessageTexts (property field) which is build by the builder
	WithEventMessageTextsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder
	// WithEventMessageTextsConfig adds EventMessageTextsConfig (property field)
	WithEventMessageTextsConfig(OptionalProperty) MultistateInputBuilder
	// WithEventMessageTextsConfigBuilder adds EventMessageTextsConfig (property field) which is build by the builder
	WithEventMessageTextsConfigBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder
	// WithEventDetectionEnable adds EventDetectionEnable (property field)
	WithEventDetectionEnable(OptionalProperty) MultistateInputBuilder
	// WithEventDetectionEnableBuilder adds EventDetectionEnable (property field) which is build by the builder
	WithEventDetectionEnableBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder
	// WithEventAlgorithmInhibitRef adds EventAlgorithmInhibitRef (property field)
	WithEventAlgorithmInhibitRef(OptionalProperty) MultistateInputBuilder
	// WithEventAlgorithmInhibitRefBuilder adds EventAlgorithmInhibitRef (property field) which is build by the builder
	WithEventAlgorithmInhibitRefBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder
	// WithEventAlgorithmInhibit adds EventAlgorithmInhibit (property field)
	WithEventAlgorithmInhibit(OptionalProperty) MultistateInputBuilder
	// WithEventAlgorithmInhibitBuilder adds EventAlgorithmInhibit (property field) which is build by the builder
	WithEventAlgorithmInhibitBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder
	// WithTimeDelayNormal adds TimeDelayNormal (property field)
	WithTimeDelayNormal(OptionalProperty) MultistateInputBuilder
	// WithTimeDelayNormalBuilder adds TimeDelayNormal (property field) which is build by the builder
	WithTimeDelayNormalBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder
	// WithReliabilityEvaluationInhibit adds ReliabilityEvaluationInhibit (property field)
	WithReliabilityEvaluationInhibit(OptionalProperty) MultistateInputBuilder
	// WithReliabilityEvaluationInhibitBuilder adds ReliabilityEvaluationInhibit (property field) which is build by the builder
	WithReliabilityEvaluationInhibitBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder
	// WithPropertyList adds PropertyList (property field)
	WithPropertyList(ReadableProperty) MultistateInputBuilder
	// WithPropertyListBuilder adds PropertyList (property field) which is build by the builder
	WithPropertyListBuilder(func(ReadablePropertyBuilder) ReadablePropertyBuilder) MultistateInputBuilder
	// WithInterfaceValue adds InterfaceValue (property field)
	WithInterfaceValue(OptionalProperty) MultistateInputBuilder
	// WithInterfaceValueBuilder adds InterfaceValue (property field) which is build by the builder
	WithInterfaceValueBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder
	// WithTags adds Tags (property field)
	WithTags(OptionalProperty) MultistateInputBuilder
	// WithTagsBuilder adds Tags (property field) which is build by the builder
	WithTagsBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder
	// WithProfileLocation adds ProfileLocation (property field)
	WithProfileLocation(OptionalProperty) MultistateInputBuilder
	// WithProfileLocationBuilder adds ProfileLocation (property field) which is build by the builder
	WithProfileLocationBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder
	// WithProfileName adds ProfileName (property field)
	WithProfileName(OptionalProperty) MultistateInputBuilder
	// WithProfileNameBuilder adds ProfileName (property field) which is build by the builder
	WithProfileNameBuilder(func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder
	// Build builds the MultistateInput or returns an error if something is wrong
	Build() (MultistateInput, error)
	// MustBuild does the same as Build but panics on error
	MustBuild() MultistateInput
}

// NewMultistateInputBuilder() creates a MultistateInputBuilder
func NewMultistateInputBuilder() MultistateInputBuilder {
	return &_MultistateInputBuilder{_MultistateInput: new(_MultistateInput)}
}

type _MultistateInputBuilder struct {
	*_MultistateInput

	err *utils.MultiError
}

var _ (MultistateInputBuilder) = (*_MultistateInputBuilder)(nil)

func (b *_MultistateInputBuilder) WithMandatoryFields(objectIdentifier ReadableProperty, objectName ReadableProperty, objectType ReadableProperty, presentValue ReadableProperty, description OptionalProperty, deviceType OptionalProperty, statusFlags ReadableProperty, eventState ReadableProperty, reliability OptionalProperty, outOfService ReadableProperty, numberOfStates ReadableProperty, stateText OptionalProperty, timeDelay OptionalProperty, notificationClass OptionalProperty, alarmValues OptionalProperty, faultValues OptionalProperty, eventEnable OptionalProperty, ackedTransitions OptionalProperty, notifyType OptionalProperty, eventTimeStamps OptionalProperty, eventMessageTexts OptionalProperty, eventMessageTextsConfig OptionalProperty, eventDetectionEnable OptionalProperty, eventAlgorithmInhibitRef OptionalProperty, eventAlgorithmInhibit OptionalProperty, timeDelayNormal OptionalProperty, reliabilityEvaluationInhibit OptionalProperty, propertyList ReadableProperty, interfaceValue OptionalProperty, tags OptionalProperty, profileLocation OptionalProperty, profileName OptionalProperty) MultistateInputBuilder {
	return b.WithObjectIdentifier(objectIdentifier).WithObjectName(objectName).WithObjectType(objectType).WithPresentValue(presentValue).WithDescription(description).WithDeviceType(deviceType).WithStatusFlags(statusFlags).WithEventState(eventState).WithReliability(reliability).WithOutOfService(outOfService).WithNumberOfStates(numberOfStates).WithStateText(stateText).WithTimeDelay(timeDelay).WithNotificationClass(notificationClass).WithAlarmValues(alarmValues).WithFaultValues(faultValues).WithEventEnable(eventEnable).WithAckedTransitions(ackedTransitions).WithNotifyType(notifyType).WithEventTimeStamps(eventTimeStamps).WithEventMessageTexts(eventMessageTexts).WithEventMessageTextsConfig(eventMessageTextsConfig).WithEventDetectionEnable(eventDetectionEnable).WithEventAlgorithmInhibitRef(eventAlgorithmInhibitRef).WithEventAlgorithmInhibit(eventAlgorithmInhibit).WithTimeDelayNormal(timeDelayNormal).WithReliabilityEvaluationInhibit(reliabilityEvaluationInhibit).WithPropertyList(propertyList).WithInterfaceValue(interfaceValue).WithTags(tags).WithProfileLocation(profileLocation).WithProfileName(profileName)
}

func (b *_MultistateInputBuilder) WithObjectIdentifier(objectIdentifier ReadableProperty) MultistateInputBuilder {
	b.ObjectIdentifier = objectIdentifier
	return b
}

func (b *_MultistateInputBuilder) WithObjectIdentifierBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithObjectName(objectName ReadableProperty) MultistateInputBuilder {
	b.ObjectName = objectName
	return b
}

func (b *_MultistateInputBuilder) WithObjectNameBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithObjectType(objectType ReadableProperty) MultistateInputBuilder {
	b.ObjectType = objectType
	return b
}

func (b *_MultistateInputBuilder) WithObjectTypeBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithPresentValue(presentValue ReadableProperty) MultistateInputBuilder {
	b.PresentValue = presentValue
	return b
}

func (b *_MultistateInputBuilder) WithPresentValueBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithDescription(description OptionalProperty) MultistateInputBuilder {
	b.Description = description
	return b
}

func (b *_MultistateInputBuilder) WithDescriptionBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithDeviceType(deviceType OptionalProperty) MultistateInputBuilder {
	b.DeviceType = deviceType
	return b
}

func (b *_MultistateInputBuilder) WithDeviceTypeBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithStatusFlags(statusFlags ReadableProperty) MultistateInputBuilder {
	b.StatusFlags = statusFlags
	return b
}

func (b *_MultistateInputBuilder) WithStatusFlagsBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithEventState(eventState ReadableProperty) MultistateInputBuilder {
	b.EventState = eventState
	return b
}

func (b *_MultistateInputBuilder) WithEventStateBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithReliability(reliability OptionalProperty) MultistateInputBuilder {
	b.Reliability = reliability
	return b
}

func (b *_MultistateInputBuilder) WithReliabilityBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithOutOfService(outOfService ReadableProperty) MultistateInputBuilder {
	b.OutOfService = outOfService
	return b
}

func (b *_MultistateInputBuilder) WithOutOfServiceBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithNumberOfStates(numberOfStates ReadableProperty) MultistateInputBuilder {
	b.NumberOfStates = numberOfStates
	return b
}

func (b *_MultistateInputBuilder) WithNumberOfStatesBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithStateText(stateText OptionalProperty) MultistateInputBuilder {
	b.StateText = stateText
	return b
}

func (b *_MultistateInputBuilder) WithStateTextBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithTimeDelay(timeDelay OptionalProperty) MultistateInputBuilder {
	b.TimeDelay = timeDelay
	return b
}

func (b *_MultistateInputBuilder) WithTimeDelayBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithNotificationClass(notificationClass OptionalProperty) MultistateInputBuilder {
	b.NotificationClass = notificationClass
	return b
}

func (b *_MultistateInputBuilder) WithNotificationClassBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithAlarmValues(alarmValues OptionalProperty) MultistateInputBuilder {
	b.AlarmValues = alarmValues
	return b
}

func (b *_MultistateInputBuilder) WithAlarmValuesBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithFaultValues(faultValues OptionalProperty) MultistateInputBuilder {
	b.FaultValues = faultValues
	return b
}

func (b *_MultistateInputBuilder) WithFaultValuesBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithEventEnable(eventEnable OptionalProperty) MultistateInputBuilder {
	b.EventEnable = eventEnable
	return b
}

func (b *_MultistateInputBuilder) WithEventEnableBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithAckedTransitions(ackedTransitions OptionalProperty) MultistateInputBuilder {
	b.AckedTransitions = ackedTransitions
	return b
}

func (b *_MultistateInputBuilder) WithAckedTransitionsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithNotifyType(notifyType OptionalProperty) MultistateInputBuilder {
	b.NotifyType = notifyType
	return b
}

func (b *_MultistateInputBuilder) WithNotifyTypeBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithEventTimeStamps(eventTimeStamps OptionalProperty) MultistateInputBuilder {
	b.EventTimeStamps = eventTimeStamps
	return b
}

func (b *_MultistateInputBuilder) WithEventTimeStampsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithEventMessageTexts(eventMessageTexts OptionalProperty) MultistateInputBuilder {
	b.EventMessageTexts = eventMessageTexts
	return b
}

func (b *_MultistateInputBuilder) WithEventMessageTextsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithEventMessageTextsConfig(eventMessageTextsConfig OptionalProperty) MultistateInputBuilder {
	b.EventMessageTextsConfig = eventMessageTextsConfig
	return b
}

func (b *_MultistateInputBuilder) WithEventMessageTextsConfigBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithEventDetectionEnable(eventDetectionEnable OptionalProperty) MultistateInputBuilder {
	b.EventDetectionEnable = eventDetectionEnable
	return b
}

func (b *_MultistateInputBuilder) WithEventDetectionEnableBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithEventAlgorithmInhibitRef(eventAlgorithmInhibitRef OptionalProperty) MultistateInputBuilder {
	b.EventAlgorithmInhibitRef = eventAlgorithmInhibitRef
	return b
}

func (b *_MultistateInputBuilder) WithEventAlgorithmInhibitRefBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithEventAlgorithmInhibit(eventAlgorithmInhibit OptionalProperty) MultistateInputBuilder {
	b.EventAlgorithmInhibit = eventAlgorithmInhibit
	return b
}

func (b *_MultistateInputBuilder) WithEventAlgorithmInhibitBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithTimeDelayNormal(timeDelayNormal OptionalProperty) MultistateInputBuilder {
	b.TimeDelayNormal = timeDelayNormal
	return b
}

func (b *_MultistateInputBuilder) WithTimeDelayNormalBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithReliabilityEvaluationInhibit(reliabilityEvaluationInhibit OptionalProperty) MultistateInputBuilder {
	b.ReliabilityEvaluationInhibit = reliabilityEvaluationInhibit
	return b
}

func (b *_MultistateInputBuilder) WithReliabilityEvaluationInhibitBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithPropertyList(propertyList ReadableProperty) MultistateInputBuilder {
	b.PropertyList = propertyList
	return b
}

func (b *_MultistateInputBuilder) WithPropertyListBuilder(builderSupplier func(ReadablePropertyBuilder) ReadablePropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithInterfaceValue(interfaceValue OptionalProperty) MultistateInputBuilder {
	b.InterfaceValue = interfaceValue
	return b
}

func (b *_MultistateInputBuilder) WithInterfaceValueBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithTags(tags OptionalProperty) MultistateInputBuilder {
	b.Tags = tags
	return b
}

func (b *_MultistateInputBuilder) WithTagsBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithProfileLocation(profileLocation OptionalProperty) MultistateInputBuilder {
	b.ProfileLocation = profileLocation
	return b
}

func (b *_MultistateInputBuilder) WithProfileLocationBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) WithProfileName(profileName OptionalProperty) MultistateInputBuilder {
	b.ProfileName = profileName
	return b
}

func (b *_MultistateInputBuilder) WithProfileNameBuilder(builderSupplier func(OptionalPropertyBuilder) OptionalPropertyBuilder) MultistateInputBuilder {
...
func (b *_MultistateInputBuilder) Build() (MultistateInput, error) {
	...
	return b._MultistateInput.deepCopy(), nil
}

func (b *_MultistateInputBuilder) MustBuild() MultistateInput {
	build, err := b.Build()
	if err != nil {
		panic(err)
	}
...
func (b *_MultistateInputBuilder) DeepCopy() any {
	_copy := b.CreateMultistateInputBuilder().(*_MultistateInputBuilder)
	if b.err != nil {
...
// CreateMultistateInputBuilder creates a MultistateInputBuilder
func (b *_MultistateInput) CreateMultistateInputBuilder() MultistateInputBuilder {
	if b == nil {
		return NewMultistateInputBuilder()
	}
	return &_MultistateInputBuilder{_MultistateInput: b.deepCopy()}
}
...
func (m *_MultistateInput) GetObjectIdentifier() ReadableProperty {
	return m.ObjectIdentifier
}

func (m *_MultistateInput) GetObjectName() ReadableProperty {
	return m.ObjectName
}

func (m *_MultistateInput) GetObjectType() ReadableProperty {
	return m.ObjectType
}

func (m *_MultistateInput) GetPresentValue() ReadableProperty {
	return m.PresentValue
}

func (m *_MultistateInput) GetDescription() OptionalProperty {
	return m.Description
}

func (m *_MultistateInput) GetDeviceType() OptionalProperty {
	return m.DeviceType
}

func (m *_MultistateInput) GetStatusFlags() ReadableProperty {
	return m.StatusFlags
}

func (m *_MultistateInput) GetEventState() ReadableProperty {
	return m.EventState
}

func (m *_MultistateInput) GetReliability() OptionalProperty {
	return m.Reliability
}

func (m *_MultistateInput) GetOutOfService() ReadableProperty {
	return m.OutOfService
}

func (m *_MultistateInput) GetNumberOfStates() ReadableProperty {
	return m.NumberOfStates
}

func (m *_MultistateInput) GetStateText() OptionalProperty {
	return m.StateText
}

func (m *_MultistateInput) GetTimeDelay() OptionalProperty {
	return m.TimeDelay
}

func (m *_MultistateInput) GetNotificationClass() OptionalProperty {
	return m.NotificationClass
}

func (m *_MultistateInput) GetAlarmValues() OptionalProperty {
	return m.AlarmValues
}

func (m *_MultistateInput) GetFaultValues() OptionalProperty {
	return m.FaultValues
}

func (m *_MultistateInput) GetEventEnable() OptionalProperty {
	return m.EventEnable
}

func (m *_MultistateInput) GetAckedTransitions() OptionalProperty {
	return m.AckedTransitions
}

func (m *_MultistateInput) GetNotifyType() OptionalProperty {
	return m.NotifyType
}

func (m *_MultistateInput) GetEventTimeStamps() OptionalProperty {
	return m.EventTimeStamps
}

func (m *_MultistateInput) GetEventMessageTexts() OptionalProperty {
	return m.EventMessageTexts
}

func (m *_MultistateInput) GetEventMessageTextsConfig() OptionalProperty {
	return m.EventMessageTextsConfig
}

func (m *_MultistateInput) GetEventDetectionEnable() OptionalProperty {
	return m.EventDetectionEnable
}

func (m *_MultistateInput) GetEventAlgorithmInhibitRef() OptionalProperty {
	return m.EventAlgorithmInhibitRef
}

func (m *_MultistateInput) GetEventAlgorithmInhibit() OptionalProperty {
	return m.EventAlgorithmInhibit
}

func (m *_MultistateInput) GetTimeDelayNormal() OptionalProperty {
	return m.TimeDelayNormal
}

func (m *_MultistateInput) GetReliabilityEvaluationInhibit() OptionalProperty {
	return m.ReliabilityEvaluationInhibit
}

func (m *_MultistateInput) GetPropertyList() ReadableProperty {
	return m.PropertyList
}

func (m *_MultistateInput) GetInterfaceValue() OptionalProperty {
	return m.InterfaceValue
}

func (m *_MultistateInput) GetTags() OptionalProperty {
	return m.Tags
}

func (m *_MultistateInput) GetProfileLocation() OptionalProperty {
	return m.ProfileLocation
}

func (m *_MultistateInput) GetProfileName() OptionalProperty {
...
func CastMultistateInput(structType any) MultistateInput {
	if casted, ok := structType.(MultistateInput); ok {
		return casted
	}
	if casted, ok := structType.(*MultistateInput); ok {
		return *casted
...
func (m *_MultistateInput) GetTypeName() string {
	return "MultistateInput"
}

func (m *_MultistateInput) GetLengthInBits(ctx context.Context) uint16 {
...
func (m *_MultistateInput) GetLengthInBytes(ctx context.Context) uint16 {
	return m.GetLengthInBits(ctx) / 8
}

func MultistateInputParse(ctx context.Context, theBytes []byte) (MultistateInput, error) {
	return MultistateInputParseWithBuffer(ctx, utils.NewReadBufferByteBased(theBytes))
}

func MultistateInputParseWithBufferProducer() func(ctx context.Context, readBuffer utils.ReadBuffer) (MultistateInput, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (MultistateInput, error) {
		return MultistateInputParseWithBuffer(ctx, readBuffer)
	}
}

func MultistateInputParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (MultistateInput, error) {
	v, err := (&_MultistateInput{}).parse(ctx, readBuffer)
	if err != nil {
		return nil, err
	}
	return v, nil
...
func (m *_MultistateInput) parse(ctx context.Context, readBuffer utils.ReadBuffer) (__multistateInput MultistateInput, err error) {
	positionAware := readBuffer
	_ = positionAware
	if pullErr := readBuffer.PullContext("MultistateInput"); pullErr != nil {
		return nil, errors.Wrap(pullErr, "Error pulling for MultistateInput")
	}
	...
	if closeErr := readBuffer.CloseContext("MultistateInput"); closeErr != nil {
		return nil, errors.Wrap(closeErr, "Error closing for MultistateInput")
	}

	return m, nil
}

func (m *_MultistateInput) Serialize() ([]byte, error) {
...
func (m *_MultistateInput) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	positionAware := writeBuffer
	_ = positionAware
	log := zerolog.Ctx(ctx)
	_ = log
	if pushErr := writeBuffer.PushContext("MultistateInput"); pushErr != nil {
		return errors.Wrap(pushErr, "Error pushing for MultistateInput")
	}
	...
	if popErr := writeBuffer.PopContext("MultistateInput"); popErr != nil {
		return errors.Wrap(popErr, "Error popping for MultistateInput")
	}
	return nil
}

func (m *_MultistateInput) IsMultistateInput() {}

func (m *_MultistateInput) DeepCopy() any {
	return m.deepCopy()
}

func (m *_MultistateInput) deepCopy() *_MultistateInput {
	if m == nil {
		return nil
	}
	_MultistateInputCopy := &_MultistateInput{
	...
	return _MultistateInputCopy
}

func (m *_MultistateInput) String() string {
	if m == nil {
		return "<nil>"
	}
