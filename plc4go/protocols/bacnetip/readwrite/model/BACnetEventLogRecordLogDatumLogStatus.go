...
func BACnetEventLogRecordLogDatumLogStatusParse(ctx context.Context, theBytes []byte, tagNumber uint8) (BACnetEventLogRecordLogDatumLogStatus, error) {
	return BACnetEventLogRecordLogDatumLogStatusParseWithBuffer(ctx, utils.NewReadBufferByteBased(theBytes), tagNumber)
}

func BACnetEventLogRecordLogDatumLogStatusParseWithBufferProducer(tagNumber uint8) func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetEventLogRecordLogDatumLogStatus, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetEventLogRecordLogDatumLogStatus, error) {
		return BACnetEventLogRecordLogDatumLogStatusParseWithBuffer(ctx, readBuffer, tagNumber)
	}
}
