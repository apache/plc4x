...
func (m *_BACnetDoorValueTagged) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (_bACnetDoorValueTagged BACnetDoorValueTagged, err error) {
