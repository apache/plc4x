...
func BACnetDoorValueTaggedParse(theBytes []byte, tagNumber uint8, tagClass TagClass) (BACnetDoorValueTagged, error) {
	return BACnetDoorValueTaggedParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian)), tagNumber, tagClass) // TODO: get endianness from mspec
}
