...
func (m *_BACnetConfirmedServiceRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, serviceRequestLength uint32) (_bACnetConfirmedServiceRequest BACnetConfirmedServiceRequest, err error) {
