...
func (m *_BACnetOptionalCharacterStringNull) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetOptionalCharacterStringNull) GetLengthInBytes(ctx context.Context) uint64 {
