...
func (m *_BACnetConstructedDataCOVUPeriodBuilder) WithMandatoryFields(covuPeriod BACnetApplicationTagUnsignedInteger) BACnetConstructedDataCOVUPeriodBuilder {
	return m.WithCovuPeriod(covuPeriod)
}

func (m *_BACnetConstructedDataCOVUPeriodBuilder) WithCovuPeriod(covuPeriod BACnetApplicationTagUnsignedInteger) BACnetConstructedDataCOVUPeriodBuilder {
	m.CovuPeriod = covuPeriod
	return m
}

func (m *_BACnetConstructedDataCOVUPeriodBuilder) WithCovuPeriodBuilder(builderSupplier func(BACnetApplicationTagUnsignedIntegerBuilder) BACnetApplicationTagUnsignedIntegerBuilder) BACnetConstructedDataCOVUPeriodBuilder {
	builder := builderSupplier(m.CovuPeriod.CreateBACnetApplicationTagUnsignedIntegerBuilder())
	var err error
	m.CovuPeriod, err = builder.Build()
	if err != nil {
		if m.err == nil {
...
func (m *_BACnetConstructedDataCOVUPeriodBuilder) Build() (BACnetConstructedDataCOVUPeriod, error) {
	if m.CovuPeriod == nil {
		if m.err == nil {
			m.err = new(utils.MultiError)
		}
		m.err.Append(errors.New("mandatory field 'covuPeriod' not set"))
	}
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._BACnetConstructedDataCOVUPeriod.deepCopy(), nil
}

func (m *_BACnetConstructedDataCOVUPeriodBuilder) MustBuild() BACnetConstructedDataCOVUPeriod {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetConstructedDataCOVUPeriodBuilder) DeepCopy() any {
	return m.CreateBACnetConstructedDataCOVUPeriodBuilder()
}

// CreateBACnetConstructedDataCOVUPeriodBuilder creates a BACnetConstructedDataCOVUPeriodBuilder
func (m *_BACnetConstructedDataCOVUPeriod) CreateBACnetConstructedDataCOVUPeriodBuilder() BACnetConstructedDataCOVUPeriodBuilder {
	if m == nil {
		return NewBACnetConstructedDataCOVUPeriodBuilder()
	}
	return &_BACnetConstructedDataCOVUPeriodBuilder{_BACnetConstructedDataCOVUPeriod: m.deepCopy()}
}
