...
func NewBACnetConstructedDataCOVUPeriod(openingTag BACnetOpeningTag, peekedTagHeader BACnetTagHeader, closingTag BACnetClosingTag, covuPeriod BACnetApplicationTagUnsignedInteger) *_BACnetConstructedDataCOVUPeriod {
	if covuPeriod == nil {
...
func (m *_BACnetConstructedDataCOVUPeriod) GetPlx4xTypeName() string {
	return "BACnetConstructedDataCOVUPeriod"
}

func (m *_BACnetConstructedDataCOVUPeriod) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataCOVUPeriod) GetLengthInBytes(ctx context.Context) uint64 {
