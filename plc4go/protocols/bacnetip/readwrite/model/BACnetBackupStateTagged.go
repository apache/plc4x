...
// BACnetBackupStateTagged is the data-structure of this message
type BACnetBackupStateTagged struct {
...
// IBACnetBackupStateTagged is the corresponding interface of BACnetBackupStateTagged
type IBACnetBackupStateTagged interface {
...
func (m *BACnetBackupStateTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetBackupStateTagged) GetValue() BACnetBackupState {
	return m.Value
}
...
// NewBACnetBackupStateTagged factory function for BACnetBackupStateTagged
func NewBACnetBackupStateTagged(header *BACnetTagHeader, value BACnetBackupState, tagNumber uint8, tagClass TagClass) *BACnetBackupStateTagged {
	return &BACnetBackupStateTagged{Header: header, Value: value, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetBackupStateTagged) GetTypeName() string {
	return "BACnetBackupStateTagged"
}

func (m *BACnetBackupStateTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetBackupStateTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetBackupStateTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetBackupStateTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetBackupStateTagged) String() string {
	if m == nil {
		return "<nil>"
	}
