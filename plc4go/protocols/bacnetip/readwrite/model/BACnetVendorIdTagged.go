...
if err := WriteManualField[uint32]( ctx, "unknownId", func(ctx context.Context) error { return WriteProprietaryEnumGeneric(ctx, writeBuffer, m.GetUnknownId(), m.GetIsUnknownId()) }, writeBuffer); err != nil{
