...
func (m *_BACnetScaleIntegerScale) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetScale) (_bACnetScaleIntegerScale BACnetScaleIntegerScale, err error) {
