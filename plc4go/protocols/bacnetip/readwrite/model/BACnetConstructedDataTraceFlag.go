...
func (m *_BACnetConstructedDataTraceFlag) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataTraceFlag) GetLengthInBytes(ctx context.Context) uint64 {
