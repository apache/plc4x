...
func (m *_BACnetConstructedDataAnalogInputInterfaceValueBuilder) WithInterfaceValueBuilder(builderSupplier func(BACnetOptionalREALBuilder) BACnetOptionalREALBuilder) BACnetConstructedDataAnalogInputInterfaceValueBuilder {
	builder := builderSupplier(m.InterfaceValue.CreateBACnetOptionalREALBuilder())
	var err error
