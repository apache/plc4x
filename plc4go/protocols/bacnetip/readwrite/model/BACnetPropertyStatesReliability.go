...
func (m *_BACnetPropertyStatesReliability) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesReliability) GetLengthInBytes(ctx context.Context) uint64 {
