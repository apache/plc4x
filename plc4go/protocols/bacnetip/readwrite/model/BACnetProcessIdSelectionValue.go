...
func (m *_BACnetProcessIdSelectionValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetProcessIdSelectionValue) GetLengthInBytes(ctx context.Context) uint64 {
