...
func (m *_BACnetDeviceObjectReference) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_bACnetDeviceObjectReference BACnetDeviceObjectReference, err error) {
