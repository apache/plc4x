...
func (m *_BACnetPropertyStatesLockStatus) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesLockStatus) GetLengthInBytes(ctx context.Context) uint64 {
