...
func (m *BACnetConstructedDataAlarmValues) GetNumberOfDataElements() *BACnetApplicationTagUnsignedInteger {
...
func (m *BACnetConstructedDataAlarmValues) GetZero() uint64 {
...
func NewBACnetConstructedDataAlarmValues(numberOfDataElements *BACnetApplicationTagUnsignedInteger, alarmValues []*BACnetLifeSafetyStateTagged, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag, tagNumber uint8, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) *BACnetConstructedDataAlarmValues {
