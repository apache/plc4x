...
func (m NLMRejectMessageToNetworkRejectReason) GetLengthInBits(ctx context.Context) uint64 {
	return 8
}

func (m NLMRejectMessageToNetworkRejectReason) GetLengthInBytes(ctx context.Context) uint64 {
...
func NLMRejectMessageToNetworkRejectReasonParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (NLMRejectMessageToNetworkRejectReason, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint8("NLMRejectMessageToNetworkRejectReason", 8)
	if err != nil {
...
func (e NLMRejectMessageToNetworkRejectReason) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint8("NLMRejectMessageToNetworkRejectReason", 8, uint8(uint8(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}

func (e NLMRejectMessageToNetworkRejectReason) GetValue() uint8 {
	return uint8(e)
}
