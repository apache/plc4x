...
func (m *_BACnetConstructedDataOccupancyState) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataOccupancyState) GetLengthInBytes(ctx context.Context) uint64 {
