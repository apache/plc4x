...
func (m *_BACnetConstructedDataAdjustValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataAdjustValue) GetLengthInBytes(ctx context.Context) uint64 {
