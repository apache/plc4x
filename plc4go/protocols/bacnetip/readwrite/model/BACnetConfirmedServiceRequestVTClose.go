...
func (m *_BACnetConfirmedServiceRequestVTClose) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetConfirmedServiceRequest, serviceRequestPayloadLength uint32, serviceRequestLength uint32) (_bACnetConfirmedServiceRequestVTClose BACnetConfirmedServiceRequestVTClose, err error) {
