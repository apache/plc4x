...
func (m *_BACnetRelationshipTagged) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (_bACnetRelationshipTagged BACnetRelationshipTagged, err error) {
