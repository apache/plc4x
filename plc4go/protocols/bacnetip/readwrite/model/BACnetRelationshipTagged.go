...
func (m *_BACnetRelationshipTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetRelationshipTagged) GetLengthInBytes(ctx context.Context) uint64 {
