...
func (m *_BACnetPropertyStatesExtendedValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesExtendedValue) GetLengthInBytes(ctx context.Context) uint64 {
