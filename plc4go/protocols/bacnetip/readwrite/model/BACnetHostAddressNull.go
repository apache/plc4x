...
func BACnetHostAddressNullParseWithBufferProducer() func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetHostAddressNull, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetHostAddressNull, error) {
		return BACnetHostAddressNullParseWithBuffer(ctx, readBuffer)
	}
}
