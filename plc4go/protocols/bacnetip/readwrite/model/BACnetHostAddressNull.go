...
func (m *_BACnetHostAddressNull) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetHostAddress) (_bACnetHostAddressNull BACnetHostAddressNull, err error) {
