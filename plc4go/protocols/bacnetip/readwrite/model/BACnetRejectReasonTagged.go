...
func (m *_BACnetRejectReasonTagged) parse(ctx context.Context, readBuffer utils.ReadBuffer, actualLength uint32) (_bACnetRejectReasonTagged BACnetRejectReasonTagged, err error) {
