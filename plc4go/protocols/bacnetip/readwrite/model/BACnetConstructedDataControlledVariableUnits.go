...
func (b *_BACnetConstructedDataControlledVariableUnitsBuilder) setParent(contract BACnetConstructedDataContract) {
	...
	contract.(*_BACnetConstructedData)._SubType = b._BACnetConstructedDataControlledVariableUnits
}
...
func (m *_BACnetConstructedDataControlledVariableUnits) GetPlx4xTypeName() string {
	return "BACnetConstructedDataControlledVariableUnits"
}

func (m *_BACnetConstructedDataControlledVariableUnits) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataControlledVariableUnits) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataControlledVariableUnits) deepCopy() *_BACnetConstructedDataControlledVariableUnits {
	...
	_BACnetConstructedDataControlledVariableUnitsCopy.BACnetConstructedDataContract.(*_BACnetConstructedData)._SubType = m
