...
func (m *_BACnetPropertyStatesLifeSafetyMode) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetPropertyStates, peekedTagNumber uint8) (_bACnetPropertyStatesLifeSafetyMode BACnetPropertyStatesLifeSafetyMode, err error) {
