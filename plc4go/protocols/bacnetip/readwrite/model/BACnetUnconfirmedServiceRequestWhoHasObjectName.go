...
func (m *_BACnetUnconfirmedServiceRequestWhoHasObjectName) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetUnconfirmedServiceRequestWhoHasObject) (_bACnetUnconfirmedServiceRequestWhoHasObjectName BACnetUnconfirmedServiceRequestWhoHasObjectName, err error) {
