...
func (m *_BACnetConstructedDataEntryPoints) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataEntryPoints) GetLengthInBytes(ctx context.Context) uint64 {
