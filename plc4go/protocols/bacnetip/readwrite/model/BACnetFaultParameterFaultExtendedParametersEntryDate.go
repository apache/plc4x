...
func BACnetFaultParameterFaultExtendedParametersEntryDateParseWithBufferProducer() func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetFaultParameterFaultExtendedParametersEntryDate, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (BACnetFaultParameterFaultExtendedParametersEntryDate, error) {
		return BACnetFaultParameterFaultExtendedParametersEntryDateParseWithBuffer(ctx, readBuffer)
	}
}
