...
func (m *_BACnetApplicationTagOctetString) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetApplicationTagOctetString) GetLengthInBytes(ctx context.Context) uint64 {
