...
func (m *_BACnetApplicationTagOctetString) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetApplicationTag, header BACnetTagHeader) (_bACnetApplicationTagOctetString BACnetApplicationTagOctetString, err error) {
