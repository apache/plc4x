...
func (m *_BACnetConstructedDataDoorMembers) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *_BACnetConstructedDataDoorMembers) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *_BACnetConstructedDataDoorMembers) GetLengthInBytes() uint16 {
...
func BACnetConstructedDataDoorMembersParse(theBytes []byte, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier, arrayIndexArgument BACnetTagPayloadUnsignedInteger) (BACnetConstructedDataDoorMembers, error) {
	return BACnetConstructedDataDoorMembersParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian)), tagNumber, objectTypeArgument, propertyIdentifierArgument, arrayIndexArgument) // TODO: get endianness from mspec
}

func BACnetConstructedDataDoorMembersParseWithBuffer(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier, arrayIndexArgument BACnetTagPayloadUnsignedInteger) (BACnetConstructedDataDoorMembers, error) {
...
func (m *_BACnetConstructedDataDoorMembers) SerializeWithWriteBuffer(writeBuffer utils.WriteBuffer) error {
