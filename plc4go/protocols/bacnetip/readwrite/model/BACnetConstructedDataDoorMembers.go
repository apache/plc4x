...
func (m *BACnetConstructedDataDoorMembers) GetNumberOfDataElements() *BACnetApplicationTagUnsignedInteger {
...
func (m *BACnetConstructedDataDoorMembers) GetZero() uint64 {
...
func NewBACnetConstructedDataDoorMembers(numberOfDataElements *BACnetApplicationTagUnsignedInteger, doorMembers []*BACnetDeviceObjectReference, openingTag *BACnetOpeningTag, peekedTagHeader *BACnetTagHeader, closingTag *BACnetClosingTag, tagNumber uint8, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) *BACnetConstructedDataDoorMembers {
...
func BACnetConstructedDataDoorMembersParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier, arrayIndexArgument *BACnetTagPayloadUnsignedInteger) (*BACnetConstructedDataDoorMembers, error) {
