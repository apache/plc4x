...
func (m *_BACnetFaultParameterFaultCharacterString) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetFaultParameter) (_bACnetFaultParameterFaultCharacterString BACnetFaultParameterFaultCharacterString, err error) {
