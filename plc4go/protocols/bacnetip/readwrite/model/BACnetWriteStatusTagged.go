...
func BACnetWriteStatusTaggedParse(theBytes []byte, tagNumber uint8, tagClass TagClass) (BACnetWriteStatusTagged, error) {
	return BACnetWriteStatusTaggedParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian)), tagNumber, tagClass) // TODO: get endianness from mspec
}

func BACnetWriteStatusTaggedParseWithBuffer(readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (BACnetWriteStatusTagged, error) {
...
func (m *_BACnetWriteStatusTagged) SerializeWithWriteBuffer(writeBuffer utils.WriteBuffer) error {
