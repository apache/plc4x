...
func (m *_BACnetConstructedDataLiftFaultSignals) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataLiftFaultSignals) GetLengthInBytes(ctx context.Context) uint64 {
