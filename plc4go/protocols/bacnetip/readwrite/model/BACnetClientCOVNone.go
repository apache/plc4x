...
func (m *_BACnetClientCOVNone) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetClientCOV) (_bACnetClientCOVNone BACnetClientCOVNone, err error) {
