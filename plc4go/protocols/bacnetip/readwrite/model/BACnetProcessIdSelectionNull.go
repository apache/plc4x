...
func BACnetProcessIdSelectionNullParse(theBytes []byte) (BACnetProcessIdSelectionNull, error) {
	return BACnetProcessIdSelectionNullParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian))) // TODO: get endianness from mspec
}

func BACnetProcessIdSelectionNullParseWithBuffer(readBuffer utils.ReadBuffer) (BACnetProcessIdSelectionNull, error) {
