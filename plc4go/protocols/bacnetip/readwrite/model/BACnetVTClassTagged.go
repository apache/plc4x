...
// BACnetVTClassTagged is the data-structure of this message
type BACnetVTClassTagged struct {
...
// IBACnetVTClassTagged is the corresponding interface of BACnetVTClassTagged
type IBACnetVTClassTagged interface {
...
func (m *BACnetVTClassTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetVTClassTagged) GetValue() BACnetVTClass {
	return m.Value
}

func (m *BACnetVTClassTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetVTClassTagged) GetIsProprietary() bool {
...
// NewBACnetVTClassTagged factory function for BACnetVTClassTagged
func NewBACnetVTClassTagged(header *BACnetTagHeader, value BACnetVTClass, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetVTClassTagged {
	return &BACnetVTClassTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetVTClassTagged) GetTypeName() string {
	return "BACnetVTClassTagged"
}

func (m *BACnetVTClassTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetVTClassTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetVTClassTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetVTClassTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetVTClassTagged) String() string {
	if m == nil {
		return "<nil>"
	}
