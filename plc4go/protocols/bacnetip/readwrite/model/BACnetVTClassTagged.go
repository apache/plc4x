...
func BACnetVTClassTaggedParse(theBytes []byte, tagNumber uint8, tagClass TagClass) (BACnetVTClassTagged, error) {
	return BACnetVTClassTaggedParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian)), tagNumber, tagClass) // TODO: get endianness from mspec
}
