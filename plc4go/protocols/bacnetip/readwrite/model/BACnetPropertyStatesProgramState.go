...
func (m *_BACnetPropertyStatesProgramState) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetPropertyStatesProgramState) GetLengthInBytes(ctx context.Context) uint64 {
