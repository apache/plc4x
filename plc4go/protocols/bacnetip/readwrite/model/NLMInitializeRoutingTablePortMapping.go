...
func (m *_NLMInitializeRoutingTablePortMapping) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_nLMInitializeRoutingTablePortMapping NLMInitializeRoutingTablePortMapping, err error) {
