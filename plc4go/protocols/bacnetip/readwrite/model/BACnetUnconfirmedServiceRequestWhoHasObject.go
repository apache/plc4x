...
func (m *_BACnetUnconfirmedServiceRequestWhoHasObject) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_bACnetUnconfirmedServiceRequestWhoHasObject BACnetUnconfirmedServiceRequestWhoHasObject, err error) {
