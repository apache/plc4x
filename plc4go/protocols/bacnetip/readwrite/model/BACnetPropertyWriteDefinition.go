...
func (m *_BACnetPropertyWriteDefinition) parse(ctx context.Context, readBuffer utils.ReadBuffer, objectTypeArgument BACnetObjectType) (_bACnetPropertyWriteDefinition BACnetPropertyWriteDefinition, err error) {
