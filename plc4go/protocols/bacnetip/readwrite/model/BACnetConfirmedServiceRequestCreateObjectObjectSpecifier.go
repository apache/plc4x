...
func (m *_BACnetConfirmedServiceRequestCreateObjectObjectSpecifier) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (_bACnetConfirmedServiceRequestCreateObjectObjectSpecifier BACnetConfirmedServiceRequestCreateObjectObjectSpecifier, err error) {
