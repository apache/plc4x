...
func (m *_BACnetConstructedDataUnspecifiedBuilder) WithMandatoryFields(data []BACnetConstructedDataElement) BACnetConstructedDataUnspecifiedBuilder {
	return m.WithData(data...)
}

func (m *_BACnetConstructedDataUnspecifiedBuilder) WithOptionalNumberOfDataElements(numberOfDataElements BACnetApplicationTagUnsignedInteger) BACnetConstructedDataUnspecifiedBuilder {
	m.NumberOfDataElements = numberOfDataElements
	return m
}

func (m *_BACnetConstructedDataUnspecifiedBuilder) WithOptionalNumberOfDataElementsBuilder(builderSupplier func(BACnetApplicationTagUnsignedIntegerBuilder) BACnetApplicationTagUnsignedIntegerBuilder) BACnetConstructedDataUnspecifiedBuilder {
...
func (m *_BACnetConstructedDataUnspecifiedBuilder) WithData(data ...BACnetConstructedDataElement) BACnetConstructedDataUnspecifiedBuilder {
	m.Data = data
	return m
}

func (m *_BACnetConstructedDataUnspecifiedBuilder) Build() (BACnetConstructedDataUnspecified, error) {
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._BACnetConstructedDataUnspecified.deepCopy(), nil
}

func (m *_BACnetConstructedDataUnspecifiedBuilder) MustBuild() BACnetConstructedDataUnspecified {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetConstructedDataUnspecifiedBuilder) DeepCopy() any {
	return m.CreateBACnetConstructedDataUnspecifiedBuilder()
}

// CreateBACnetConstructedDataUnspecifiedBuilder creates a BACnetConstructedDataUnspecifiedBuilder
func (m *_BACnetConstructedDataUnspecified) CreateBACnetConstructedDataUnspecifiedBuilder() BACnetConstructedDataUnspecifiedBuilder {
	if m == nil {
		return NewBACnetConstructedDataUnspecifiedBuilder()
	}
	return &_BACnetConstructedDataUnspecifiedBuilder{_BACnetConstructedDataUnspecified: m.deepCopy()}
}
