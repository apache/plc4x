...
func (m *_BACnetConstructedDataUnspecified) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataUnspecified) GetLengthInBytes(ctx context.Context) uint64 {
