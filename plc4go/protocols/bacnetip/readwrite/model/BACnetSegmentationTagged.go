...
func (m *_BACnetSegmentationTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetSegmentationTagged) GetLengthInBytes(ctx context.Context) uint64 {
