...
func (m *_BACnetGroupChannelValueBuilder) WithValueBuilder(builderSupplier func(BACnetChannelValueBuilder) BACnetChannelValueBuilder) BACnetGroupChannelValueBuilder {
	builder := builderSupplier(m.Value.CreateBACnetChannelValueBuilder())
	var err error
