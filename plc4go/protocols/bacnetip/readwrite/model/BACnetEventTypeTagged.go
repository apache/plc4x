...
func BACnetEventTypeTaggedParse(theBytes []byte, tagNumber uint8, tagClass TagClass) (BACnetEventTypeTagged, error) {
	return BACnetEventTypeTaggedParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian)), tagNumber, tagClass) // TODO: get endianness from mspec
}

func BACnetEventTypeTaggedParseWithBuffer(readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (BACnetEventTypeTagged, error) {
...
func (m *_BACnetEventTypeTagged) SerializeWithWriteBuffer(writeBuffer utils.WriteBuffer) error {
