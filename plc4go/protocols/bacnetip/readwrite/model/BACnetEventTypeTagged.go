...
// BACnetEventTypeTagged is the data-structure of this message
type BACnetEventTypeTagged struct {
...
// IBACnetEventTypeTagged is the corresponding interface of BACnetEventTypeTagged
type IBACnetEventTypeTagged interface {
...
func (m *BACnetEventTypeTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetEventTypeTagged) GetValue() BACnetEventType {
	return m.Value
}

func (m *BACnetEventTypeTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetEventTypeTagged) GetIsProprietary() bool {
...
// NewBACnetEventTypeTagged factory function for BACnetEventTypeTagged
func NewBACnetEventTypeTagged(header *BACnetTagHeader, value BACnetEventType, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetEventTypeTagged {
	return &BACnetEventTypeTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetEventTypeTagged) GetTypeName() string {
	return "BACnetEventTypeTagged"
}

func (m *BACnetEventTypeTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetEventTypeTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetEventTypeTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetEventTypeTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetEventTypeTagged) String() string {
	if m == nil {
		return "<nil>"
	}
