...
func (m *_BVLCWriteBroadcastDistributionTable) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BVLC, bvlcPayloadLength uint16) (_bVLCWriteBroadcastDistributionTable BVLCWriteBroadcastDistributionTable, err error) {
