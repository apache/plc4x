...
func (m *_BACnetEventParameterFloatingLimit) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetEventParameter) (_bACnetEventParameterFloatingLimit BACnetEventParameterFloatingLimit, err error) {
