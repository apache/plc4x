...
func (m *_BACnetConstructedDataSlaveAddressBinding) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataSlaveAddressBinding) GetLengthInBytes(ctx context.Context) uint64 {
