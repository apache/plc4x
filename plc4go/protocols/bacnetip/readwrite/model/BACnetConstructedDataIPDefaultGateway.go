...
func (m *BACnetConstructedDataIPDefaultGateway) GetActualValue() *BACnetApplicationTagOctetString {
...
func (m *BACnetConstructedDataIPDefaultGateway) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		_ipDefaultGatewayErr := writeBuffer.WriteSerializable(m.IpDefaultGateway)
