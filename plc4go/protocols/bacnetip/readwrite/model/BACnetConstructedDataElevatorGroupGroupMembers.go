...
func (m *_BACnetConstructedDataElevatorGroupGroupMembers) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataElevatorGroupGroupMembers) GetLengthInBytes(ctx context.Context) uint64 {
