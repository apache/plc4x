...
func (m *BACnetConstructedDataElevatorGroupGroupMembers) GetNumberOfDataElements() *BACnetApplicationTagUnsignedInteger {
...
func (m *BACnetConstructedDataElevatorGroupGroupMembers) GetZero() uint64 {
