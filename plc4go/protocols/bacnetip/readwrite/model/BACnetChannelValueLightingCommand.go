...
func (m *_BACnetChannelValueLightingCommand) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetChannelValueLightingCommand) GetLengthInBytes(ctx context.Context) uint64 {
