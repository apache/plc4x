...
func BACnetAccessCredentialDisableReasonTaggedParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (BACnetAccessCredentialDisableReasonTagged, error) {
	v, err := (&_BACnetAccessCredentialDisableReasonTagged{}).parse(ctx, readBuffer, tagNumber, tagClass)
	if err != nil {
		return nil, err
	}
	return v, err
...
func (m *_BACnetAccessCredentialDisableReasonTagged) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8, tagClass TagClass) (_bACnetAccessCredentialDisableReasonTagged BACnetAccessCredentialDisableReasonTagged, err error) {
