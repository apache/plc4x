...
// BACnetAccessCredentialDisableReasonTagged is the data-structure of this message
type BACnetAccessCredentialDisableReasonTagged struct {
...
// IBACnetAccessCredentialDisableReasonTagged is the corresponding interface of BACnetAccessCredentialDisableReasonTagged
type IBACnetAccessCredentialDisableReasonTagged interface {
...
func (m *BACnetAccessCredentialDisableReasonTagged) GetHeader() *BACnetTagHeader {
	return m.Header
}

func (m *BACnetAccessCredentialDisableReasonTagged) GetValue() BACnetAccessCredentialDisableReason {
	return m.Value
}

func (m *BACnetAccessCredentialDisableReasonTagged) GetProprietaryValue() uint32 {
...
func (m *BACnetAccessCredentialDisableReasonTagged) GetIsProprietary() bool {
...
// NewBACnetAccessCredentialDisableReasonTagged factory function for BACnetAccessCredentialDisableReasonTagged
func NewBACnetAccessCredentialDisableReasonTagged(header *BACnetTagHeader, value BACnetAccessCredentialDisableReason, proprietaryValue uint32, tagNumber uint8, tagClass TagClass) *BACnetAccessCredentialDisableReasonTagged {
	return &BACnetAccessCredentialDisableReasonTagged{Header: header, Value: value, ProprietaryValue: proprietaryValue, TagNumber: tagNumber, TagClass: tagClass}
}
...
func (m *BACnetAccessCredentialDisableReasonTagged) GetTypeName() string {
	return "BACnetAccessCredentialDisableReasonTagged"
}

func (m *BACnetAccessCredentialDisableReasonTagged) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetAccessCredentialDisableReasonTagged) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetAccessCredentialDisableReasonTagged) GetLengthInBytes() uint16 {
...
func (m *BACnetAccessCredentialDisableReasonTagged) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetAccessCredentialDisableReasonTagged) String() string {
	if m == nil {
		return "<nil>"
	}
