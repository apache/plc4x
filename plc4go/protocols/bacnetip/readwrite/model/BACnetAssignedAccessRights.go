...
func (m *_BACnetAssignedAccessRights) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_bACnetAssignedAccessRights BACnetAssignedAccessRights, err error) {
