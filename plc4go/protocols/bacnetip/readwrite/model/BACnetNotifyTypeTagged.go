...
func (m *_BACnetNotifyTypeTagged) GetPlx4xTypeName() string {
	return "BACnetNotifyTypeTagged"
}

func (m *_BACnetNotifyTypeTagged) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetNotifyTypeTagged) GetLengthInBytes(ctx context.Context) uint64 {
