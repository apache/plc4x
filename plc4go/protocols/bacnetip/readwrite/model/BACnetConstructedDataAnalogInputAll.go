...
func (m *BACnetConstructedDataAnalogInputAll) GetObjectType() BACnetObjectType {
...
func BACnetConstructedDataAnalogInputAllParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectType BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier) (*BACnetConstructedDataAnalogInputAll, error) {
	...
	// Validation
	if !(bool((1) == (2))) {
		return nil, utils.ParseValidationError{"TODO: implement me BACnetConstructedData ...ANALOG_INPUT..."}
	}
