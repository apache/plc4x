...
func (m *BACnetConstructedDataCarPosition) InitializeParent(parent *BACnetConstructedData, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag) {
...
func NewBACnetConstructedDataCarPosition(carPosition *BACnetApplicationTagUnsignedInteger, openingTag *BACnetOpeningTag, closingTag *BACnetClosingTag, tagNumber uint8) *BACnetConstructedDataCarPosition {
...
func BACnetConstructedDataCarPositionParse(readBuffer utils.ReadBuffer, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier) (*BACnetConstructedDataCarPosition, error) {
...
func (m *BACnetConstructedDataCarPosition) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		_carPositionErr := m.CarPosition.Serialize(writeBuffer)
