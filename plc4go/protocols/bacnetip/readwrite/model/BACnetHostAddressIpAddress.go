...
func (m *_BACnetHostAddressIpAddress) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetHostAddressIpAddress) GetLengthInBytes(ctx context.Context) uint64 {
