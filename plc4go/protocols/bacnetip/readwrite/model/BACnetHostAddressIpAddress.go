...
func (m *_BACnetHostAddressIpAddress) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetHostAddress) (_bACnetHostAddressIpAddress BACnetHostAddressIpAddress, err error) {
