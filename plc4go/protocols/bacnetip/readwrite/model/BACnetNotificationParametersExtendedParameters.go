...
func (m *_BACnetNotificationParametersExtendedParameters) parse(ctx context.Context, readBuffer utils.ReadBuffer, tagNumber uint8) (_bACnetNotificationParametersExtendedParameters BACnetNotificationParametersExtendedParameters, err error) {
