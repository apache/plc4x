...
// BACnetEventParameterChangeOfDiscreteValue is the data-structure of this message
type BACnetEventParameterChangeOfDiscreteValue struct {
...
// IBACnetEventParameterChangeOfDiscreteValue is the corresponding interface of BACnetEventParameterChangeOfDiscreteValue
type IBACnetEventParameterChangeOfDiscreteValue interface {
...
func (m *BACnetEventParameterChangeOfDiscreteValue) InitializeParent(parent *BACnetEventParameter, peekedTagHeader *BACnetTagHeader) {
	m.BACnetEventParameter.PeekedTagHeader = peekedTagHeader
}

func (m *BACnetEventParameterChangeOfDiscreteValue) GetParent() *BACnetEventParameter {
...
func (m *BACnetEventParameterChangeOfDiscreteValue) GetOpeningTag() *BACnetOpeningTag {
	return m.OpeningTag
}

func (m *BACnetEventParameterChangeOfDiscreteValue) GetTimeDelay() *BACnetContextTagUnsignedInteger {
	return m.TimeDelay
}

func (m *BACnetEventParameterChangeOfDiscreteValue) GetClosingTag() *BACnetClosingTag {
	return m.ClosingTag
}
...
// NewBACnetEventParameterChangeOfDiscreteValue factory function for BACnetEventParameterChangeOfDiscreteValue
func NewBACnetEventParameterChangeOfDiscreteValue(openingTag *BACnetOpeningTag, timeDelay *BACnetContextTagUnsignedInteger, closingTag *BACnetClosingTag, peekedTagHeader *BACnetTagHeader) *BACnetEventParameterChangeOfDiscreteValue {
	_result := &BACnetEventParameterChangeOfDiscreteValue{
...
func CastBACnetEventParameterChangeOfDiscreteValue(structType interface{}) *BACnetEventParameterChangeOfDiscreteValue {
	...
	if casted, ok := structType.(BACnetEventParameter); ok {
		return CastBACnetEventParameterChangeOfDiscreteValue(casted.Child)
	}
	if casted, ok := structType.(*BACnetEventParameter); ok {
		return CastBACnetEventParameterChangeOfDiscreteValue(casted.Child)
	}
...
func (m *BACnetEventParameterChangeOfDiscreteValue) GetTypeName() string {
	return "BACnetEventParameterChangeOfDiscreteValue"
}

func (m *BACnetEventParameterChangeOfDiscreteValue) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetEventParameterChangeOfDiscreteValue) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetEventParameterChangeOfDiscreteValue) GetLengthInBytes() uint16 {
...
func BACnetEventParameterChangeOfDiscreteValueParse(readBuffer utils.ReadBuffer) (*BACnetEventParameterChangeOfDiscreteValue, error) {
	...
	_child := &BACnetEventParameterChangeOfDiscreteValue{
...
func (m *BACnetEventParameterChangeOfDiscreteValue) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetEventParameterChangeOfDiscreteValue) String() string {
	if m == nil {
		return "<nil>"
	}
