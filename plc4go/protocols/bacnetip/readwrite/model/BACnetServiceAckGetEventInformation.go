...
func (m *_BACnetServiceAckGetEventInformation) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetServiceAck, serviceAckLength uint32) (_bACnetServiceAckGetEventInformation BACnetServiceAckGetEventInformation, err error) {
