...
func (m *_BACnetRecipient) getLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetRecipient) GetLengthInBytes(ctx context.Context) uint64 {
...
func BACnetRecipientParseWithBuffer[T BACnetRecipient](ctx context.Context, readBuffer utils.ReadBuffer) (T, error) {
	v, err := (new(_BACnetRecipient)).parse(ctx, readBuffer)
	if err != nil {
		var zero T
		return zero, err
	}
