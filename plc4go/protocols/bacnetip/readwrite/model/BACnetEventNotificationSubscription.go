...
func (m *_BACnetEventNotificationSubscription) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_bACnetEventNotificationSubscription BACnetEventNotificationSubscription, err error) {
