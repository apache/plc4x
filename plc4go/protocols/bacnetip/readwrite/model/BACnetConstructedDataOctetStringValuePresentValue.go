...
func NewBACnetConstructedDataOctetStringValuePresentValue(openingTag BACnetOpeningTag, peekedTagHeader BACnetTagHeader, closingTag BACnetClosingTag, presentValue BACnetApplicationTagOctetString) *_BACnetConstructedDataOctetStringValuePresentValue {
	if presentValue == nil {
...
func (m *_BACnetConstructedDataOctetStringValuePresentValue) GetPlx4xTypeName() string {
	return "BACnetConstructedDataOctetStringValuePresentValue"
}

func (m *_BACnetConstructedDataOctetStringValuePresentValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataOctetStringValuePresentValue) GetLengthInBytes(ctx context.Context) uint64 {
