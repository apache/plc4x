...
func (m *_BACnetConstructedDataThreatLevel) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataThreatLevel) GetLengthInBytes(ctx context.Context) uint64 {
