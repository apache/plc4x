...
func (m *_BACnetConstructedDataSupportedFormats) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetConstructedDataSupportedFormats) GetLengthInBytes(ctx context.Context) uint64 {
