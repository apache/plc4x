...
// BACnetLandingCallStatus is the data-structure of this message
type BACnetLandingCallStatus struct {
...
// IBACnetLandingCallStatus is the corresponding interface of BACnetLandingCallStatus
type IBACnetLandingCallStatus interface {
...
func (m *BACnetLandingCallStatus) GetFloorNumber() *BACnetContextTagUnsignedInteger {
	return m.FloorNumber
}

func (m *BACnetLandingCallStatus) GetCommand() *BACnetLandingCallStatusCommand {
	return m.Command
}

func (m *BACnetLandingCallStatus) GetFloorText() *BACnetContextTagCharacterString {
	return m.FloorText
}
...
// NewBACnetLandingCallStatus factory function for BACnetLandingCallStatus
func NewBACnetLandingCallStatus(floorNumber *BACnetContextTagUnsignedInteger, command *BACnetLandingCallStatusCommand, floorText *BACnetContextTagCharacterString) *BACnetLandingCallStatus {
	return &BACnetLandingCallStatus{FloorNumber: floorNumber, Command: command, FloorText: floorText}
}
...
func (m *BACnetLandingCallStatus) GetTypeName() string {
	return "BACnetLandingCallStatus"
}

func (m *BACnetLandingCallStatus) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetLandingCallStatus) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetLandingCallStatus) GetLengthInBytes() uint16 {
...
func BACnetLandingCallStatusParse(readBuffer utils.ReadBuffer) (*BACnetLandingCallStatus, error) {
	...
	command := CastBACnetLandingCallStatusCommand(_command)
	...
	var floorText *BACnetContextTagCharacterString = nil
	{
		...
		default:
			floorText = CastBACnetContextTagCharacterString(_val)
...
func (m *BACnetLandingCallStatus) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetLandingCallStatus) String() string {
	if m == nil {
		return "<nil>"
	}
