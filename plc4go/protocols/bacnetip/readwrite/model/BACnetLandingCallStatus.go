...
func (m *_BACnetLandingCallStatusBuilder) WithCommandBuilder(builderSupplier func(BACnetLandingCallStatusCommandBuilder) BACnetLandingCallStatusCommandBuilder) BACnetLandingCallStatusBuilder {
	builder := builderSupplier(m.Command.CreateBACnetLandingCallStatusCommandBuilder())
	var err error
	...
	if err != nil {
		...
		m.err.Append(errors.Wrap(err, "BACnetLandingCallStatusCommandBuilder failed"))
	}
	return m
}
