...
func (m *_BACnetLogDataLogDataEntryIntegerValue) GetPlx4xTypeName() string {
	return "BACnetLogDataLogDataEntryIntegerValue"
}

func (m *_BACnetLogDataLogDataEntryIntegerValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetLogDataLogDataEntryIntegerValue) GetLengthInBytes(ctx context.Context) uint64 {
