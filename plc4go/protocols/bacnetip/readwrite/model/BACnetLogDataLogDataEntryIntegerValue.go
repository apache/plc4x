...
// BACnetLogDataLogDataEntryIntegerValue is the data-structure of this message
type BACnetLogDataLogDataEntryIntegerValue struct {
	*BACnetLogDataLogDataEntry
	IntegerValue *BACnetContextTagSignedInteger
}

// IBACnetLogDataLogDataEntryIntegerValue is the corresponding interface of BACnetLogDataLogDataEntryIntegerValue
type IBACnetLogDataLogDataEntryIntegerValue interface {
...
func (m *BACnetLogDataLogDataEntryIntegerValue) InitializeParent(parent *BACnetLogDataLogDataEntry, peekedTagHeader *BACnetTagHeader) {
	m.BACnetLogDataLogDataEntry.PeekedTagHeader = peekedTagHeader
}

func (m *BACnetLogDataLogDataEntryIntegerValue) GetParent() *BACnetLogDataLogDataEntry {
...
func (m *BACnetLogDataLogDataEntryIntegerValue) GetIntegerValue() *BACnetContextTagSignedInteger {
...
// NewBACnetLogDataLogDataEntryIntegerValue factory function for BACnetLogDataLogDataEntryIntegerValue
func NewBACnetLogDataLogDataEntryIntegerValue(integerValue *BACnetContextTagSignedInteger, peekedTagHeader *BACnetTagHeader) *BACnetLogDataLogDataEntryIntegerValue {
	_result := &BACnetLogDataLogDataEntryIntegerValue{
...
func CastBACnetLogDataLogDataEntryIntegerValue(structType interface{}) *BACnetLogDataLogDataEntryIntegerValue {
	...
	if casted, ok := structType.(BACnetLogDataLogDataEntry); ok {
		return CastBACnetLogDataLogDataEntryIntegerValue(casted.Child)
	}
	if casted, ok := structType.(*BACnetLogDataLogDataEntry); ok {
		return CastBACnetLogDataLogDataEntryIntegerValue(casted.Child)
	}
...
func (m *BACnetLogDataLogDataEntryIntegerValue) GetTypeName() string {
	return "BACnetLogDataLogDataEntryIntegerValue"
}

func (m *BACnetLogDataLogDataEntryIntegerValue) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *BACnetLogDataLogDataEntryIntegerValue) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *BACnetLogDataLogDataEntryIntegerValue) GetLengthInBytes() uint16 {
...
func BACnetLogDataLogDataEntryIntegerValueParse(readBuffer utils.ReadBuffer) (*BACnetLogDataLogDataEntryIntegerValue, error) {
	...
	_child := &BACnetLogDataLogDataEntryIntegerValue{
...
func (m *BACnetLogDataLogDataEntryIntegerValue) Serialize(writeBuffer utils.WriteBuffer) error {
...
func (m *BACnetLogDataLogDataEntryIntegerValue) String() string {
	if m == nil {
		return "<nil>"
	}
