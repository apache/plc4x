...
func (m *_BACnetLogDataLogDataEntryIntegerValue) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_BACnetLogDataLogDataEntry) (_bACnetLogDataLogDataEntryIntegerValue BACnetLogDataLogDataEntryIntegerValue, err error) {
