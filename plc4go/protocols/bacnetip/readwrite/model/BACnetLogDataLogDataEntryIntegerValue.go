...
func (m *_BACnetLogDataLogDataEntryIntegerValueBuilder) WithMandatoryFields(integerValue BACnetContextTagSignedInteger) BACnetLogDataLogDataEntryIntegerValueBuilder {
	return m.WithIntegerValue(integerValue)
}

func (m *_BACnetLogDataLogDataEntryIntegerValueBuilder) WithIntegerValue(integerValue BACnetContextTagSignedInteger) BACnetLogDataLogDataEntryIntegerValueBuilder {
	m.IntegerValue = integerValue
	return m
}

func (m *_BACnetLogDataLogDataEntryIntegerValueBuilder) WithIntegerValueBuilder(builderSupplier func(BACnetContextTagSignedIntegerBuilder) BACnetContextTagSignedIntegerBuilder) BACnetLogDataLogDataEntryIntegerValueBuilder {
...
func (m *_BACnetLogDataLogDataEntryIntegerValueBuilder) Build() (BACnetLogDataLogDataEntryIntegerValue, error) {
	...
	return m._BACnetLogDataLogDataEntryIntegerValue.deepCopy(), nil
}

func (m *_BACnetLogDataLogDataEntryIntegerValueBuilder) MustBuild() BACnetLogDataLogDataEntryIntegerValue {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BACnetLogDataLogDataEntryIntegerValueBuilder) DeepCopy() any {
	return m.CreateBACnetLogDataLogDataEntryIntegerValueBuilder()
}

// CreateBACnetLogDataLogDataEntryIntegerValueBuilder creates a BACnetLogDataLogDataEntryIntegerValueBuilder
func (m *_BACnetLogDataLogDataEntryIntegerValue) CreateBACnetLogDataLogDataEntryIntegerValueBuilder() BACnetLogDataLogDataEntryIntegerValueBuilder {
	if m == nil {
		return NewBACnetLogDataLogDataEntryIntegerValueBuilder()
	}
	return &_BACnetLogDataLogDataEntryIntegerValueBuilder{_BACnetLogDataLogDataEntryIntegerValue: m.deepCopy()}
}
