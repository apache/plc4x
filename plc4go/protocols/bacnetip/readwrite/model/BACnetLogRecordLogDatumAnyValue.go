...
func (m *_BACnetLogRecordLogDatumAnyValue) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BACnetLogRecordLogDatumAnyValue) GetLengthInBytes(ctx context.Context) uint64 {
