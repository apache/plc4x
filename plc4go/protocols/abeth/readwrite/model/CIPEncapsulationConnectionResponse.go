...
func (m *_CIPEncapsulationConnectionResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_CIPEncapsulationPacket) (_cIPEncapsulationConnectionResponse CIPEncapsulationConnectionResponse, err error) {
