...
func DF1ResponseMessageParseWithBuffer[T DF1ResponseMessage](ctx context.Context, readBuffer utils.ReadBuffer, payloadLength uint16) (T, error) {
	v, err := (&_DF1ResponseMessage{}).parse(ctx, readBuffer, payloadLength)
	if err != nil {
		var zero T
		return zero, err
	}
...
func (m *_DF1ResponseMessage) parse(ctx context.Context, readBuffer utils.ReadBuffer, payloadLength uint16) (_dF1ResponseMessage DF1ResponseMessage, err error) {
