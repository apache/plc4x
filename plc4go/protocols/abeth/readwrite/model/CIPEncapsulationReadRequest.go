...
func (m *_CIPEncapsulationReadRequestBuilder) WithRequestBuilder(builderSupplier func(DF1RequestMessageBuilder) DF1RequestMessageBuilder) CIPEncapsulationReadRequestBuilder {
	builder := builderSupplier(m.Request.CreateDF1RequestMessageBuilder())
	var err error
	...
	if err != nil {
		...
		m.err.Append(errors.Wrap(err, "DF1RequestMessageBuilder failed"))
	}
	return m
}
