...
func (m *_CIPEncapsulationReadRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_CIPEncapsulationPacket) (_cIPEncapsulationReadRequest CIPEncapsulationReadRequest, err error) {
