...
func (m *_CIPEncapsulationReadRequest) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_CIPEncapsulationReadRequest) GetLengthInBytes(ctx context.Context) uint64 {
