...
func (m *_DF1CommandRequestMessageBuilder) WithCommandBuilder(builderSupplier func(DF1RequestCommandBuilder) DF1RequestCommandBuilder) DF1CommandRequestMessageBuilder {
	builder := builderSupplier(m.Command.CreateDF1RequestCommandBuilder())
	var err error
	...
	if err != nil {
		...
		m.err.Append(errors.Wrap(err, "DF1RequestCommandBuilder failed"))
	}
	return m
}
