...
func (m *_CIPEncapsulationReadResponseBuilder) WithResponseBuilder(builderSupplier func(DF1ResponseMessageBuilder) DF1ResponseMessageBuilder) CIPEncapsulationReadResponseBuilder {
	builder := builderSupplier(m.Response.CreateDF1ResponseMessageBuilder())
	var err error
	m.Response, err = builder.Build()
	if err != nil {
		if m.err == nil {
			m.err = &utils.MultiError{MainError: errors.New("sub builder failed")}
		}
		m.err.Append(errors.Wrap(err, "DF1ResponseMessageBuilder failed"))
	}
	return m
}
