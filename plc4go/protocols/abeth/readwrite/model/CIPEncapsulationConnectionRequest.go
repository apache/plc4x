...
func (m *_CIPEncapsulationConnectionRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_CIPEncapsulationPacket) (_cIPEncapsulationConnectionRequest CIPEncapsulationConnectionRequest, err error) {
