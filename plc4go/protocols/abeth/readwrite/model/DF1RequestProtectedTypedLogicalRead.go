...
func (m *_DF1RequestProtectedTypedLogicalRead) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_DF1RequestCommand) (_dF1RequestProtectedTypedLogicalRead DF1RequestProtectedTypedLogicalRead, err error) {
