...
func (m *_EipDisconnectRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_EipPacket, response bool) (_eipDisconnectRequest EipDisconnectRequest, err error) {
