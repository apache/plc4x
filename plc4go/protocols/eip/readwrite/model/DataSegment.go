...
func (m *_DataSegmentBuilder) WithSegmentTypeBuilder(builderSupplier func(DataSegmentTypeBuilder) DataSegmentTypeBuilder) DataSegmentBuilder {
	builder := builderSupplier(m.SegmentType.CreateDataSegmentTypeBuilder())
	var err error
	...
	if err != nil {
		...
		m.err.Append(errors.Wrap(err, "DataSegmentTypeBuilder failed"))
	}
	return m
}
