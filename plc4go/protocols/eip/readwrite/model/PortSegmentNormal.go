...
func (m *_PortSegmentNormal) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_PortSegmentType) (_portSegmentNormal PortSegmentNormal, err error) {
