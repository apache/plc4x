...
func ServicesParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, servicesLen uint16) (Services, error) {
	v, err := (&_Services{}).parse(ctx, readBuffer, servicesLen)
	if err != nil {
		return nil, err
	}
	return v, err
...
func (m *_Services) parse(ctx context.Context, readBuffer utils.ReadBuffer, servicesLen uint16) (_services Services, err error) {
