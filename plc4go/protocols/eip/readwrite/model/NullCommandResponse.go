...
func (m *_NullCommandResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_EipPacket, response bool) (_nullCommandResponse NullCommandResponse, err error) {
