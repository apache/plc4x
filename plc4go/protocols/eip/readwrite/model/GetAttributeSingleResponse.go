...
func (m *_GetAttributeSingleResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_CipService, connected bool, serviceLen uint16) (_getAttributeSingleResponse GetAttributeSingleResponse, err error) {
