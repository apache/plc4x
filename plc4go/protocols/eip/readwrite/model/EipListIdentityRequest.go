...
func (m *_EipListIdentityRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_EipPacket, response bool) (_eipListIdentityRequest EipListIdentityRequest, err error) {
