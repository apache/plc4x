...
func (m *_SetAttributeAllResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_CipService, connected bool, serviceLen uint16) (_setAttributeAllResponse SetAttributeAllResponse, err error) {
