...
func (m *_LogicalSegmentBuilder) WithSegmentTypeBuilder(builderSupplier func(LogicalSegmentTypeBuilder) LogicalSegmentTypeBuilder) LogicalSegmentBuilder {
	builder := builderSupplier(m.SegmentType.CreateLogicalSegmentTypeBuilder())
	var err error
	...
	if err != nil {
		...
		m.err.Append(errors.Wrap(err, "LogicalSegmentTypeBuilder failed"))
	}
	return m
}
