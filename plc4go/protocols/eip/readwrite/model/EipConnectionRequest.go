...
func (m *_EipConnectionRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_EipPacket, response bool) (_eipConnectionRequest EipConnectionRequest, err error) {
