...
func CipIdentityParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (CipIdentity, error) {
	...
	// Count array
	socketAddressAddress := make([]uint8, max(uint16(4), 0))
	...
	// Const Field (zeroes1)
	zeroes1, _zeroes1Err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint32("zeroes1", 32)
	if _zeroes1Err != nil {
	...
	// Const Field (zeroes2)
	zeroes2, _zeroes2Err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint32("zeroes2", 32)
	if _zeroes2Err != nil {
