...
func CipIdentityParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (CipIdentity, error) {
	...
	zeroes1, err := readConstField[uint32](ctx, "zeroes1", ReadUnsignedInt(readBuffer, 32), CipIdentity.ZEROES1)
	if err != nil {
		return nil, errors.Wrap(err, fmt.Sprintf("Error parsing 'zeroes1' field"))
	}
	_ = zeroes1

	zeroes2, err := readConstField[uint32](ctx, "zeroes2", ReadUnsignedInt(readBuffer, 32), CipIdentity.ZEROES2)
	if err != nil {
