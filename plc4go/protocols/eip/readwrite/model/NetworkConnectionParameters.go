...
func (m *_NetworkConnectionParameters) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_networkConnectionParameters NetworkConnectionParameters, err error) {
