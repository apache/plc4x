...
func NewNullCommandRequestBuilder() NullCommandRequestBuilder {
	return &_NullCommandRequestBuilder{_NullCommandRequest: new(_NullCommandRequest)}
}
...
func (m *_NullCommandRequest) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.EipPacketContract.(*_EipPacket).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_NullCommandRequest) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_NullCommandRequest) deepCopy() *_NullCommandRequest {
	...
	_NullCommandRequestCopy.EipPacketContract.(*_EipPacket)._SubType = m
