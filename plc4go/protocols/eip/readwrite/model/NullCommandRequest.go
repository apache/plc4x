...
func (m *_NullCommandRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_EipPacket, response bool) (_nullCommandRequest NullCommandRequest, err error) {
