...
func (m *_CipConnectionManagerCloseResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_CipService, connected bool, serviceLen uint16) (_cipConnectionManagerCloseResponse CipConnectionManagerCloseResponse, err error) {
