...
func (m *_CipConnectionManagerResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_CipService, connected bool, serviceLen uint16) (_cipConnectionManagerResponse CipConnectionManagerResponse, err error) {
