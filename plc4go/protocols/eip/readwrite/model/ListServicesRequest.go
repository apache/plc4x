...
func (m *_ListServicesRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_EipPacket, response bool) (_listServicesRequest ListServicesRequest, err error) {
