...
func (m *_AnsiExtendedSymbolSegment) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_DataSegmentType) (_ansiExtendedSymbolSegment AnsiExtendedSymbolSegment, err error) {
