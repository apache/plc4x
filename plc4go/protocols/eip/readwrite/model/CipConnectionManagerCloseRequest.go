...
func (m *_CipConnectionManagerCloseRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_CipService, connected bool, serviceLen uint16) (_cipConnectionManagerCloseRequest CipConnectionManagerCloseRequest, err error) {
