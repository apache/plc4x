...
func (m *_CIPAttributes) parse(ctx context.Context, readBuffer utils.ReadBuffer, packetLength uint16) (__cIPAttributes CIPAttributes, err error) {
	...
	data,err := readBuffer.ReadByteArray("data", int(utils.InlineIf((bool((packetLength) > (((((numberOfClasses) * ((2)))) + ((6)))))), func() any {return int32(int32(packetLength) - int32((int32((int32(numberOfClasses) * int32(int32(2)))) + int32(int32(6)))))}, func() any {return int32(int32(0))}).(int32)))
	if err != nil {
