...
func (m *_ConnectedAddressItem) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_TypeId) (_connectedAddressItem ConnectedAddressItem, err error) {
