...
func (m OpcuaNodeIdServicesVariableOption) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableOption) GetLengthInBytes(ctx context.Context) uint64 {
