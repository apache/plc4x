...
func (m *_CloseSecureChannelRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_closeSecureChannelRequest CloseSecureChannelRequest, err error) {
