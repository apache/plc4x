...
func (b *_HistoryUpdateDetailsBuilder) setParent(contract ExtensionObjectDefinitionContract) {
	...
	contract.(*_ExtensionObjectDefinition)._SubType = b._HistoryUpdateDetails
}
...
func (m *_HistoryUpdateDetails) GetPlx4xTypeName() string {
	return "HistoryUpdateDetails"
}

func (m *_HistoryUpdateDetails) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.ExtensionObjectDefinitionContract.(*_ExtensionObjectDefinition).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_HistoryUpdateDetails) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_HistoryUpdateDetails) deepCopy() *_HistoryUpdateDetails {
	...
	_HistoryUpdateDetailsCopy.ExtensionObjectDefinitionContract.(*_ExtensionObjectDefinition)._SubType = m
