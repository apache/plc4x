...
func (m *_OpcuaAPUBuilder) WithMessageBuilder(builderSupplier func(MessagePDUBuilder) MessagePDUBuilder) OpcuaAPUBuilder {
	builder := builderSupplier(m.Message.CreateMessagePDUBuilder())
	var err error
	...
	if err != nil {
		...
		m.err.Append(errors.Wrap(err, "MessagePDUBuilder failed"))
	}
	return m
}
