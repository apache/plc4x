...
func (m OpcuaNodeIdServicesVariableNegotiation) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableNegotiation) GetLengthInBytes(ctx context.Context) uint64 {
