...
func (m OpcuaNodeIdServicesVariableOutput) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableOutput) GetLengthInBytes(ctx context.Context) uint64 {
