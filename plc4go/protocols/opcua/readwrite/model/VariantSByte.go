...
func (m *_VariantSByte) GetPlx4xTypeName() string {
	return "VariantSByte"
}

func (m *_VariantSByte) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_VariantSByte) GetLengthInBytes(ctx context.Context) uint64 {
