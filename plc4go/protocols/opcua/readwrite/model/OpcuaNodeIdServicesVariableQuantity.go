...
func (m OpcuaNodeIdServicesVariableQuantity) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableQuantity) GetLengthInBytes(ctx context.Context) uint64 {
