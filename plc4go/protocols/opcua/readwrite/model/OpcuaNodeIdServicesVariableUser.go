...
func (m OpcuaNodeIdServicesVariableUser) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableUser) GetLengthInBytes(ctx context.Context) uint64 {
