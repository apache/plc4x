...
func (m OpcuaNodeIdServicesVariableSet) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableSet) GetLengthInBytes(ctx context.Context) uint64 {
