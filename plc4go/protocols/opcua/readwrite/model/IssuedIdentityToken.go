...
func (b *_IssuedIdentityTokenBuilder) Build() (IssuedIdentityToken, error) {
	...
	if b.TokenData == nil {
		b.collectedErr = append(b.collectedErr, errors.New("mandatory field 'tokenData' not set"))
	}
...
func (m *_IssuedIdentityToken) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_IssuedIdentityToken) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_IssuedIdentityToken) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, extensionId int32) (__issuedIdentityToken IssuedIdentityToken, err error) {
	...
	tokenData, err := ReadSimpleField[PascalByteString](ctx, "tokenData", ReadComplex[PascalByteString](PascalByteStringParseWithBuffer, readBuffer), codegen.WithEncoding("UTF8"))
	if err != nil {
...
func (m *_IssuedIdentityToken) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		if err := WriteSimpleField[PascalByteString](ctx, "tokenData", m.GetTokenData(), WriteComplex[PascalByteString](writeBuffer), codegen.WithEncoding("UTF8")); err != nil {
...
func (m *_IssuedIdentityToken) deepCopy() *_IssuedIdentityToken {
	...
	_IssuedIdentityTokenCopy.ExtensionObjectDefinitionContract.(*_ExtensionObjectDefinition)._SubType = m
