...
func (m OpcuaNodeIdServicesVariablePublished) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariablePublished) GetLengthInBytes(ctx context.Context) uint64 {
