...
func (m OpcuaNodeIdServicesVariableRemove) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableRemove) GetLengthInBytes(ctx context.Context) uint64 {
