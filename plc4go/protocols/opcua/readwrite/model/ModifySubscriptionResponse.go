...
func (m *_ModifySubscriptionResponse) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ModifySubscriptionResponse) GetLengthInBytes(ctx context.Context) uint64 {
