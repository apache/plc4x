...
func (m *_ModifySubscriptionResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_modifySubscriptionResponse ModifySubscriptionResponse, err error) {
