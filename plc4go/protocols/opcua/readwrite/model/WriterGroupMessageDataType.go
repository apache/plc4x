...
func (m *_WriterGroupMessageDataType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_writerGroupMessageDataType WriterGroupMessageDataType, err error) {
