...
func HistoryReadResponseParseWithBufferProducer(identifier string) func(ctx context.Context, readBuffer utils.ReadBuffer) (HistoryReadResponse, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (HistoryReadResponse, error) {
		return HistoryReadResponseParseWithBuffer(ctx, readBuffer, identifier)
	}
}
