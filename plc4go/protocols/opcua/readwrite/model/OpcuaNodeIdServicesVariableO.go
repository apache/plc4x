...
func (m OpcuaNodeIdServicesVariableO) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableO) GetLengthInBytes(ctx context.Context) uint64 {
