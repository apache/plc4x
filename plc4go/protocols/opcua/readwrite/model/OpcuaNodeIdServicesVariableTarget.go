...
func (m OpcuaNodeIdServicesVariableTarget) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableTarget) GetLengthInBytes(ctx context.Context) uint64 {
