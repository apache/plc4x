...
func (m *_DoubleComplexNumberType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_doubleComplexNumberType DoubleComplexNumberType, err error) {
