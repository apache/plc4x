...
func (m *_CloseSecureChannelResponse) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_CloseSecureChannelResponse) GetLengthInBytes(ctx context.Context) uint64 {
