...
func CloseSecureChannelResponseParseWithBufferProducer(identifier string) func(ctx context.Context, readBuffer utils.ReadBuffer) (CloseSecureChannelResponse, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (CloseSecureChannelResponse, error) {
		return CloseSecureChannelResponseParseWithBuffer(ctx, readBuffer, identifier)
	}
}
