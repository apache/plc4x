...
const (
	...
	OpcuaNodeIdServicesVariableGet_GetRecordsMethodType_InputArguments           OpcuaNodeIdServicesVariableGet = 19359
	OpcuaNodeIdServicesVariableGet_GetRecordsMethodType_OutputArguments          OpcuaNodeIdServicesVariableGet = 19360
...
func init() {
	...
	OpcuaNodeIdServicesVariableGetValues = []OpcuaNodeIdServicesVariableGet{
		...
		OpcuaNodeIdServicesVariableGet_GetRecordsMethodType_InputArguments,
		OpcuaNodeIdServicesVariableGet_GetRecordsMethodType_OutputArguments,
...
func OpcuaNodeIdServicesVariableGetByValue(value int32) (enum OpcuaNodeIdServicesVariableGet, ok bool) {
	...
	case 19359:
		return OpcuaNodeIdServicesVariableGet_GetRecordsMethodType_InputArguments, true
	case 19360:
		return OpcuaNodeIdServicesVariableGet_GetRecordsMethodType_OutputArguments, true
	case 23727:
...
func OpcuaNodeIdServicesVariableGetByName(value string) (enum OpcuaNodeIdServicesVariableGet, ok bool) {
	...
	case "GetEncryptingKeyMethodType_OutputArguments":
		return OpcuaNodeIdServicesVariableGet_GetEncryptingKeyMethodType_OutputArguments, true
	case "GetRecordsMethodType_InputArguments":
		return OpcuaNodeIdServicesVariableGet_GetRecordsMethodType_InputArguments, true
	case "GetRecordsMethodType_OutputArguments":
		return OpcuaNodeIdServicesVariableGet_GetRecordsMethodType_OutputArguments, true
...
func (m OpcuaNodeIdServicesVariableGet) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableGet) GetLengthInBytes(ctx context.Context) uint64 {
...
func OpcuaNodeIdServicesVariableGetParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (OpcuaNodeIdServicesVariableGet, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadInt32("OpcuaNodeIdServicesVariableGet", 32)
	if err != nil {
...
func (e OpcuaNodeIdServicesVariableGet) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteInt32("OpcuaNodeIdServicesVariableGet", 32, int32(int32(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}

func (e OpcuaNodeIdServicesVariableGet) GetValue() int32 {
	return int32(e)
}
...
func (e OpcuaNodeIdServicesVariableGet) PLC4XEnumName() string {
	...
	case OpcuaNodeIdServicesVariableGet_GetRecordsMethodType_InputArguments:
		return "GetRecordsMethodType_InputArguments"
	case OpcuaNodeIdServicesVariableGet_GetRecordsMethodType_OutputArguments:
		return "GetRecordsMethodType_OutputArguments"
