...
func (m *_SecuritySettingsDataType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_SecuritySettingsDataType) GetLengthInBytes(ctx context.Context) uint64 {
