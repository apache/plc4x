...
func (m *_TransferSubscriptionsRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_transferSubscriptionsRequest TransferSubscriptionsRequest, err error) {
