...
func (m *_EnumField) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_EnumField) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_EnumField) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, extensionId int32) (__enumField EnumField, err error) {
	...
	value, err := ReadSimpleField(ctx, "value", ReadSignedLong(readBuffer, uint8(64)), codegen.WithEncoding("UTF8"))
	if err != nil {
...
func (m *_EnumField) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		if err := WriteSimpleField[int64](ctx, "value", m.GetValue(), WriteSignedLong(writeBuffer, 64), codegen.WithEncoding("UTF8")); err != nil {
