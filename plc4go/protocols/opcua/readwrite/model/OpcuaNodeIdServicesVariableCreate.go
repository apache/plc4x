...
func (m OpcuaNodeIdServicesVariableCreate) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableCreate) GetLengthInBytes(ctx context.Context) uint64 {
