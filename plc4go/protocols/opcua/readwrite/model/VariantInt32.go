...
func NewVariantInt32(arrayLengthSpecified bool, arrayDimensionsSpecified bool, noOfArrayDimensions *int32, arrayDimensions []int32, arrayLength *int32, value []int32) *_VariantInt32 {
...
func (m *_VariantInt32) GetPlx4xTypeName() string {
	return "VariantInt32"
}

func (m *_VariantInt32) GetLengthInBits(ctx context.Context) uint64 {
	...
	// Array field
	if len(m.Value) > 0 {
		lengthInBits += 32 * uint64(len(m.Value))
	}

	return lengthInBits
}

func (m *_VariantInt32) GetLengthInBytes(ctx context.Context) uint64 {
