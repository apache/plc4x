...
func (m OpcuaNodeIdServicesVariableSubscribed) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableSubscribed) GetLengthInBytes(ctx context.Context) uint64 {
