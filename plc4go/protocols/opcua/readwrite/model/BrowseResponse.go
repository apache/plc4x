...
func (m *_BrowseResponseBuilder) WithMandatoryFields(responseHeader ExtensionObjectDefinition, noOfResults int32, results []ExtensionObjectDefinition, noOfDiagnosticInfos int32, diagnosticInfos []DiagnosticInfo) BrowseResponseBuilder {
...
func (m *_BrowseResponseBuilder) WithResponseHeader(responseHeader ExtensionObjectDefinition) BrowseResponseBuilder {
	m.ResponseHeader = responseHeader
	return m
}

func (m *_BrowseResponseBuilder) WithResponseHeaderBuilder(builderSupplier func(ExtensionObjectDefinitionBuilder) ExtensionObjectDefinitionBuilder) BrowseResponseBuilder {
...
func (m *_BrowseResponseBuilder) WithNoOfResults(noOfResults int32) BrowseResponseBuilder {
	m.NoOfResults = noOfResults
	return m
}

func (m *_BrowseResponseBuilder) WithResults(results ...ExtensionObjectDefinition) BrowseResponseBuilder {
	m.Results = results
	return m
}

func (m *_BrowseResponseBuilder) WithNoOfDiagnosticInfos(noOfDiagnosticInfos int32) BrowseResponseBuilder {
	m.NoOfDiagnosticInfos = noOfDiagnosticInfos
	return m
}

func (m *_BrowseResponseBuilder) WithDiagnosticInfos(diagnosticInfos ...DiagnosticInfo) BrowseResponseBuilder {
	m.DiagnosticInfos = diagnosticInfos
	return m
}

func (m *_BrowseResponseBuilder) Build() (BrowseResponse, error) {
	...
	return m._BrowseResponse.deepCopy(), nil
}

func (m *_BrowseResponseBuilder) MustBuild() BrowseResponse {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_BrowseResponseBuilder) DeepCopy() any {
	return m.CreateBrowseResponseBuilder()
}

// CreateBrowseResponseBuilder creates a BrowseResponseBuilder
func (m *_BrowseResponse) CreateBrowseResponseBuilder() BrowseResponseBuilder {
	if m == nil {
		return NewBrowseResponseBuilder()
	}
	return &_BrowseResponseBuilder{_BrowseResponse: m.deepCopy()}
}
