...
func (m *_BrowseResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_browseResponse BrowseResponse, err error) {
