...
func (m OpcuaNodeIdServicesVariableAction) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableAction) GetLengthInBytes(ctx context.Context) uint64 {
