...
const (
	...
	OpcuaNodeIdServicesVariableI_IIeeeTsnInterfaceConfigurationTalkerType_MacAddress      OpcuaNodeIdServicesVariableI = 24192
	OpcuaNodeIdServicesVariableI_IIeeeTsnInterfaceConfigurationTalkerType_InterfaceName   OpcuaNodeIdServicesVariableI = 24193
	OpcuaNodeIdServicesVariableI_IIeeeTsnInterfaceConfigurationTalkerType_TimeAwareOffset OpcuaNodeIdServicesVariableI = 24194
	OpcuaNodeIdServicesVariableI_IIeeeTsnInterfaceConfigurationListenerType_MacAddress    OpcuaNodeIdServicesVariableI = 24196
	OpcuaNodeIdServicesVariableI_IIeeeTsnInterfaceConfigurationListenerType_InterfaceName OpcuaNodeIdServicesVariableI = 24197
...
func init() {
	...
	OpcuaNodeIdServicesVariableIValues = []OpcuaNodeIdServicesVariableI{
		...
		OpcuaNodeIdServicesVariableI_IIeeeTsnInterfaceConfigurationTalkerType_MacAddress,
		OpcuaNodeIdServicesVariableI_IIeeeTsnInterfaceConfigurationTalkerType_InterfaceName,
		OpcuaNodeIdServicesVariableI_IIeeeTsnInterfaceConfigurationTalkerType_TimeAwareOffset,
		OpcuaNodeIdServicesVariableI_IIeeeTsnInterfaceConfigurationListenerType_MacAddress,
...
func OpcuaNodeIdServicesVariableIByValue(value int32) (enum OpcuaNodeIdServicesVariableI, ok bool) {
	...
	case 24192:
		return OpcuaNodeIdServicesVariableI_IIeeeTsnInterfaceConfigurationTalkerType_MacAddress, true
	case 24193:
		return OpcuaNodeIdServicesVariableI_IIeeeTsnInterfaceConfigurationTalkerType_InterfaceName, true
	case 24194:
		return OpcuaNodeIdServicesVariableI_IIeeeTsnInterfaceConfigurationTalkerType_TimeAwareOffset, true
	case 24196:
		return OpcuaNodeIdServicesVariableI_IIeeeTsnInterfaceConfigurationListenerType_MacAddress, true
	case 24197:
		return OpcuaNodeIdServicesVariableI_IIeeeTsnInterfaceConfigurationListenerType_InterfaceName, true
	case 24198:
...
func OpcuaNodeIdServicesVariableIByName(value string) (enum OpcuaNodeIdServicesVariableI, ok bool) {
	...
	case "IIeeeTsnInterfaceConfigurationType_InterfaceName":
		return OpcuaNodeIdServicesVariableI_IIeeeTsnInterfaceConfigurationType_InterfaceName, true
	case "IIeeeTsnInterfaceConfigurationTalkerType_MacAddress":
		return OpcuaNodeIdServicesVariableI_IIeeeTsnInterfaceConfigurationTalkerType_MacAddress, true
	case "IIeeeTsnInterfaceConfigurationTalkerType_InterfaceName":
		return OpcuaNodeIdServicesVariableI_IIeeeTsnInterfaceConfigurationTalkerType_InterfaceName, true
	case "IIeeeTsnInterfaceConfigurationTalkerType_TimeAwareOffset":
		return OpcuaNodeIdServicesVariableI_IIeeeTsnInterfaceConfigurationTalkerType_TimeAwareOffset, true
	case "IIeeeTsnInterfaceConfigurationListenerType_MacAddress":
		return OpcuaNodeIdServicesVariableI_IIeeeTsnInterfaceConfigurationListenerType_MacAddress, true
	case "IIeeeTsnInterfaceConfigurationListenerType_InterfaceName":
		return OpcuaNodeIdServicesVariableI_IIeeeTsnInterfaceConfigurationListenerType_InterfaceName, true
...
func (e OpcuaNodeIdServicesVariableI) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return writeBuffer.WriteInt32("OpcuaNodeIdServicesVariableI", 32, int32(e), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}
...
func (e OpcuaNodeIdServicesVariableI) PLC4XEnumName() string {
	...
	case OpcuaNodeIdServicesVariableI_IIeeeTsnInterfaceConfigurationTalkerType_MacAddress:
		return "IIeeeTsnInterfaceConfigurationTalkerType_MacAddress"
	case OpcuaNodeIdServicesVariableI_IIeeeTsnInterfaceConfigurationTalkerType_InterfaceName:
		return "IIeeeTsnInterfaceConfigurationTalkerType_InterfaceName"
	...
	case OpcuaNodeIdServicesVariableI_IIeeeTsnInterfaceConfigurationListenerType_MacAddress:
		return "IIeeeTsnInterfaceConfigurationListenerType_MacAddress"
	case OpcuaNodeIdServicesVariableI_IIeeeTsnInterfaceConfigurationListenerType_InterfaceName:
		return "IIeeeTsnInterfaceConfigurationListenerType_InterfaceName"
