...
func (m *_PubSubConfigurationDataType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_pubSubConfigurationDataType PubSubConfigurationDataType, err error) {
