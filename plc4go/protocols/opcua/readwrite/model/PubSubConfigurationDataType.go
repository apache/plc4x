...
func (m *_PubSubConfigurationDataType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_PubSubConfigurationDataType) GetLengthInBytes(ctx context.Context) uint64 {
