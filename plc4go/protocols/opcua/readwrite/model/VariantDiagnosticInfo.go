...
func (m *_VariantDiagnosticInfo) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_Variant, arrayLengthSpecified bool) (_variantDiagnosticInfo VariantDiagnosticInfo, err error) {
