...
func VariantDiagnosticInfoParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, arrayLengthSpecified bool) (VariantDiagnosticInfo, error) {
	...
	if arrayLengthSpecified {
		...
		if _err != nil {
			return nil, errors.Wrap(_err, "Error parsing 'arrayLength' field of VariantDiagnosticInfo")
		}
		arrayLength = &_val
	}
	...
	// Count array
	value := make([]DiagnosticInfo, utils.Max(utils.InlineIf(bool((arrayLength) == (nil)), func() any { return uint16(uint16(1)) }, func() any { return uint16((*arrayLength)) }).(uint16), 0))
	...
	}
	{
		...
		for _curItem := uint16(0); _curItem < _numItems; _curItem++ {
			...
			if _err != nil {
				return nil, errors.Wrap(_err, "Error parsing 'value' field of VariantDiagnosticInfo")
			}
			value[_curItem] = _item.(DiagnosticInfo)
		}
	}
