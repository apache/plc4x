...
func (m *_PubSubKeyPushTargetDataType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_PubSubKeyPushTargetDataType) GetLengthInBytes(ctx context.Context) uint64 {
