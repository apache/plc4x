...
func (m OpcuaNodeIdServicesVariableDeadband) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableDeadband) GetLengthInBytes(ctx context.Context) uint64 {
