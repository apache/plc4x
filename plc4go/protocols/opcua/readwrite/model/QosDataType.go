...
func (m *_QosDataType) GetPlx4xTypeName() string {
	return "QosDataType"
}

func (m *_QosDataType) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.ExtensionObjectDefinitionContract.(*_ExtensionObjectDefinition).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_QosDataType) GetLengthInBytes(ctx context.Context) uint64 {
