...
func (m *_OpcuaMessageError) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MessagePDU, response bool) (_opcuaMessageError OpcuaMessageError, err error) {
