...
func (m *_StandaloneSubscribedDataSetRefDataType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_StandaloneSubscribedDataSetRefDataType) GetLengthInBytes(ctx context.Context) uint64 {
