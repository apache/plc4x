...
func (m *_UserNameIdentityToken) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_UserIdentityTokenDefinition, identifier string) (_userNameIdentityToken UserNameIdentityToken, err error) {
