...
func (m OpcuaNodeIdServicesVariableBit) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableBit) GetLengthInBytes(ctx context.Context) uint64 {
