...
func (m *_FindServersOnNetworkResponse) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_FindServersOnNetworkResponse) GetLengthInBytes(ctx context.Context) uint64 {
