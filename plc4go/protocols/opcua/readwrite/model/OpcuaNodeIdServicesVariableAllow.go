...
func (m OpcuaNodeIdServicesVariableAllow) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableAllow) GetLengthInBytes(ctx context.Context) uint64 {
