...
func (m OpcuaNodeIdServicesVariableImage) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableImage) GetLengthInBytes(ctx context.Context) uint64 {
