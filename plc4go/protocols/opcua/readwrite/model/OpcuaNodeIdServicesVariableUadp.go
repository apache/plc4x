...
func (m OpcuaNodeIdServicesVariableUadp) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableUadp) GetLengthInBytes(ctx context.Context) uint64 {
