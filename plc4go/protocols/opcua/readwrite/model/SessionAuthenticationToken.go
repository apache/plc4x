...
func (m *_SessionAuthenticationToken) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_sessionAuthenticationToken SessionAuthenticationToken, err error) {
