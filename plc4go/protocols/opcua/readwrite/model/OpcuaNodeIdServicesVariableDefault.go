...
func (m OpcuaNodeIdServicesVariableDefault) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableDefault) GetLengthInBytes(ctx context.Context) uint64 {
