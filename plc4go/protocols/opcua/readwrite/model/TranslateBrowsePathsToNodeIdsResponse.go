...
func TranslateBrowsePathsToNodeIdsResponseParseWithBufferProducer(identifier string) func(ctx context.Context, readBuffer utils.ReadBuffer) (TranslateBrowsePathsToNodeIdsResponse, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (TranslateBrowsePathsToNodeIdsResponse, error) {
		return TranslateBrowsePathsToNodeIdsResponseParseWithBuffer(ctx, readBuffer, identifier)
	}
}
