...
func TranslateBrowsePathsToNodeIdsResponseParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, identifier string) (TranslateBrowsePathsToNodeIdsResponse, error) {
	...
	}
	{
		...
		for _curItem := uint16(0); _curItem < _numItems; _curItem++ {
			...
			_ = arrayCtx
			_ = _curItem
			_item, _err := ExtensionObjectDefinitionParseWithBuffer(arrayCtx, readBuffer, "551")
			if _err != nil {
				return nil, errors.Wrap(_err, "Error parsing 'results' field of TranslateBrowsePathsToNodeIdsResponse")
			}
	...
	}
	{
		...
		for _curItem := uint16(0); _curItem < _numItems; _curItem++ {
			...
			if _err != nil {
				return nil, errors.Wrap(_err, "Error parsing 'diagnosticInfos' field of TranslateBrowsePathsToNodeIdsResponse")
			}
