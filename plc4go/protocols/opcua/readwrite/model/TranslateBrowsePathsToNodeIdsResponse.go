...
func (b *_TranslateBrowsePathsToNodeIdsResponseBuilder) setParent(contract ExtensionObjectDefinitionContract) {
	...
	contract.(*_ExtensionObjectDefinition)._SubType = b._TranslateBrowsePathsToNodeIdsResponse
}
...
func (m *_TranslateBrowsePathsToNodeIdsResponse) GetPlx4xTypeName() string {
	return "TranslateBrowsePathsToNodeIdsResponse"
}

func (m *_TranslateBrowsePathsToNodeIdsResponse) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_TranslateBrowsePathsToNodeIdsResponse) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_TranslateBrowsePathsToNodeIdsResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, extensionId int32) (__translateBrowsePathsToNodeIdsResponse TranslateBrowsePathsToNodeIdsResponse, err error) {
	...
	results, err := ReadCountArrayField[BrowsePathResult](ctx, "results", ReadComplex[BrowsePathResult](ExtensionObjectDefinitionParseWithBufferProducer[BrowsePathResult]((int32)(int32(551))), readBuffer), uint64(noOfResults), codegen.WithEncoding("UTF8"))
	if err != nil {
