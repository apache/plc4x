...
func (m *_FindServersOnNetworkRequest) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_FindServersOnNetworkRequest) GetLengthInBytes(ctx context.Context) uint64 {
