...
func (m *_GenericAttributeValueBuilder) WithValueBuilder(builderSupplier func(VariantBuilder) VariantBuilder) GenericAttributeValueBuilder {
	builder := builderSupplier(m.Value.CreateVariantBuilder())
	var err error
