...
func (m *_PriorityMappingEntryType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_PriorityMappingEntryType) GetLengthInBytes(ctx context.Context) uint64 {
