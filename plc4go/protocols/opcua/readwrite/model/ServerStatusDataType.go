...
func (m *_ServerStatusDataTypeBuilder) WithBuildInfoBuilder(builderSupplier func(ExtensionObjectDefinitionBuilder) ExtensionObjectDefinitionBuilder) ServerStatusDataTypeBuilder {
	builder := builderSupplier(m.BuildInfo.CreateExtensionObjectDefinitionBuilder())
	var err error
	m.BuildInfo, err = builder.Build()
	if err != nil {
		if m.err == nil {
