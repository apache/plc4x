...
func (m OpcuaNodeIdServicesVariableTwo) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableTwo) GetLengthInBytes(ctx context.Context) uint64 {
