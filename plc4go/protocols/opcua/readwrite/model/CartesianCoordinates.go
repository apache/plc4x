...
// CartesianCoordinatesExactly can be used when we want exactly this type and not a type which fulfills CartesianCoordinates.
// This is useful for switch cases.
type CartesianCoordinatesExactly interface {
	CartesianCoordinates
	isCartesianCoordinates() bool
}
...
func (m *_CartesianCoordinates) InitializeParent(parent ExtensionObjectDefinition) {}

func (m *_CartesianCoordinates) GetParent() ExtensionObjectDefinition {
...
func CartesianCoordinatesParse(ctx context.Context, theBytes []byte, identifier string) (CartesianCoordinates, error) {
...
func (m *_CartesianCoordinates) isCartesianCoordinates() bool {
	return true
}
