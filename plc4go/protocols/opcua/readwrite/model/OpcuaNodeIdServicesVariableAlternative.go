...
func (m OpcuaNodeIdServicesVariableAlternative) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableAlternative) GetLengthInBytes(ctx context.Context) uint64 {
