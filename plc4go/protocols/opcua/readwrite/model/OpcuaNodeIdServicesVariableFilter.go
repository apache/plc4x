...
func (m OpcuaNodeIdServicesVariableFilter) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableFilter) GetLengthInBytes(ctx context.Context) uint64 {
