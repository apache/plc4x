...
func (m *_OpcuaAcknowledgeResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MessagePDU, response bool) (_opcuaAcknowledgeResponse OpcuaAcknowledgeResponse, err error) {
