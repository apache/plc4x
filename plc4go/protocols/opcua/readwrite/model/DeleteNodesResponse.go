...
// DeleteNodesResponseExactly can be used when we want exactly this type and not a type which fulfills DeleteNodesResponse.
// This is useful for switch cases.
type DeleteNodesResponseExactly interface {
	DeleteNodesResponse
	isDeleteNodesResponse() bool
}
...
func (m *_DeleteNodesResponse) InitializeParent(parent ExtensionObjectDefinition) {}

func (m *_DeleteNodesResponse) GetParent() ExtensionObjectDefinition {
...
func DeleteNodesResponseParse(ctx context.Context, theBytes []byte, identifier string) (DeleteNodesResponse, error) {
	return DeleteNodesResponseParseWithBuffer(ctx, utils.NewReadBufferByteBased(theBytes), identifier)
}

func DeleteNodesResponseParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, identifier string) (DeleteNodesResponse, error) {
	...
	if _responseHeaderErr != nil {
		return nil, errors.Wrap(_responseHeaderErr, "Error parsing 'responseHeader' field of DeleteNodesResponse")
	}
	...
	if _noOfResultsErr != nil {
		return nil, errors.Wrap(_noOfResultsErr, "Error parsing 'noOfResults' field of DeleteNodesResponse")
	}
	...
	}
	{
		...
		for _curItem := uint16(0); _curItem < _numItems; _curItem++ {
			...
			if _err != nil {
				return nil, errors.Wrap(_err, "Error parsing 'results' field of DeleteNodesResponse")
			}
	...
	if _noOfDiagnosticInfosErr != nil {
		return nil, errors.Wrap(_noOfDiagnosticInfosErr, "Error parsing 'noOfDiagnosticInfos' field of DeleteNodesResponse")
	}
	...
	}
	{
		...
		for _curItem := uint16(0); _curItem < _numItems; _curItem++ {
			...
			if _err != nil {
				return nil, errors.Wrap(_err, "Error parsing 'diagnosticInfos' field of DeleteNodesResponse")
			}
...
func (m *_DeleteNodesResponse) isDeleteNodesResponse() bool {
	return true
}
