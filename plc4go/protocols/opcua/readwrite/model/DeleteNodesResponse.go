...
func DeleteNodesResponseParseWithBufferProducer(identifier string) func(ctx context.Context, readBuffer utils.ReadBuffer) (DeleteNodesResponse, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (DeleteNodesResponse, error) {
		return DeleteNodesResponseParseWithBuffer(ctx, readBuffer, identifier)
	}
}
