...
func (m *_AliasNameDataType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_AliasNameDataType) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_AliasNameDataType) deepCopy() *_AliasNameDataType {
	...
	_AliasNameDataTypeCopy.ExtensionObjectDefinitionContract.(*_ExtensionObjectDefinition)._SubType = m
