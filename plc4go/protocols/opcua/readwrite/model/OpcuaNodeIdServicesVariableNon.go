...
func (m OpcuaNodeIdServicesVariableNon) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableNon) GetLengthInBytes(ctx context.Context) uint64 {
