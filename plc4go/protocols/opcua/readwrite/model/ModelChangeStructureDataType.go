...
func (m *_ModelChangeStructureDataType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_modelChangeStructureDataType ModelChangeStructureDataType, err error) {
