...
func (m OpcuaNodeIdServicesVariableAccess) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableAccess) GetLengthInBytes(ctx context.Context) uint64 {
