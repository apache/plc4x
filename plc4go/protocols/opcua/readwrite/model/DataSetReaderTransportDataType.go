...
func (m *_DataSetReaderTransportDataType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_dataSetReaderTransportDataType DataSetReaderTransportDataType, err error) {
