...
func (m *_OpcuaMessageRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MessagePDU, totalLength uint32, response bool) (_opcuaMessageRequest OpcuaMessageRequest, err error) {
