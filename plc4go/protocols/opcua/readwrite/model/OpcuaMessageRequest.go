...
func (m *_OpcuaMessageRequest) GetPlx4xTypeName() string {
	return "OpcuaMessageRequest"
}

func (m *_OpcuaMessageRequest) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_OpcuaMessageRequest) GetLengthInBytes(ctx context.Context) uint64 {
