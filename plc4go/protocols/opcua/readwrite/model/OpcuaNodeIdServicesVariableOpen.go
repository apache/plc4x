...
func (m OpcuaNodeIdServicesVariableOpen) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableOpen) GetLengthInBytes(ctx context.Context) uint64 {
