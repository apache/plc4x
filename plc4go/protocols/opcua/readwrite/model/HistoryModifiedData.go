...
func (m *_HistoryModifiedData) GetPlx4xTypeName() string {
	return "HistoryModifiedData"
}

func (m *_HistoryModifiedData) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_HistoryModifiedData) GetLengthInBytes(ctx context.Context) uint64 {
