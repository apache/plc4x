...
func (m OpcuaNodeIdServicesVariableMove) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableMove) GetLengthInBytes(ctx context.Context) uint64 {
