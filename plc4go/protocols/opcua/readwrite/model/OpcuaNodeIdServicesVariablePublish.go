...
func (m OpcuaNodeIdServicesVariablePublish) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariablePublish) GetLengthInBytes(ctx context.Context) uint64 {
