...
func (m OpcuaNodeIdServicesVariableFile) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableFile) GetLengthInBytes(ctx context.Context) uint64 {
