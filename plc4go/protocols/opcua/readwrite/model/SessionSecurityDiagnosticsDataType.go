...
func (m *_SessionSecurityDiagnosticsDataType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_sessionSecurityDiagnosticsDataType SessionSecurityDiagnosticsDataType, err error) {
