...
func (m *_ServerDiagnosticsSummaryDataType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_serverDiagnosticsSummaryDataType ServerDiagnosticsSummaryDataType, err error) {
