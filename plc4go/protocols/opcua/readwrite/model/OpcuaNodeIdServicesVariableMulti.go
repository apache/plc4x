...
func (m OpcuaNodeIdServicesVariableMulti) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableMulti) GetLengthInBytes(ctx context.Context) uint64 {
