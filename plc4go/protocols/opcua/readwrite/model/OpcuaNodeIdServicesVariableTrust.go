...
func (m OpcuaNodeIdServicesVariableTrust) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableTrust) GetLengthInBytes(ctx context.Context) uint64 {
