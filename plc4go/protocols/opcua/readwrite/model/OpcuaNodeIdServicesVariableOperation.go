...
func (m OpcuaNodeIdServicesVariableOperation) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableOperation) GetLengthInBytes(ctx context.Context) uint64 {
