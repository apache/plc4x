...
func (m OpcuaNodeIdServicesVariablePermission) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariablePermission) GetLengthInBytes(ctx context.Context) uint64 {
