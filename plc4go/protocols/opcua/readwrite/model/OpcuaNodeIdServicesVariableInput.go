...
func (m OpcuaNodeIdServicesVariableInput) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableInput) GetLengthInBytes(ctx context.Context) uint64 {
