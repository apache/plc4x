...
func (m OpcuaNodeIdServicesVariableRole) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableRole) GetLengthInBytes(ctx context.Context) uint64 {
