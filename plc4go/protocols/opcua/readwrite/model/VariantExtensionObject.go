...
func (m *_VariantExtensionObject) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_Variant, arrayLengthSpecified bool) (_variantExtensionObject VariantExtensionObject, err error) {
