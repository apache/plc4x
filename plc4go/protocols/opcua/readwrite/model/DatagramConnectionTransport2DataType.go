...
func (m *_DatagramConnectionTransport2DataType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_DatagramConnectionTransport2DataType) GetLengthInBytes(ctx context.Context) uint64 {
