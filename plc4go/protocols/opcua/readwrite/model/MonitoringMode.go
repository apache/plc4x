...
func (m MonitoringMode) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m MonitoringMode) GetLengthInBytes(ctx context.Context) uint64 {
...
func MonitoringModeParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (MonitoringMode, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint32("MonitoringMode", 32)
	if err != nil {
...
func (e MonitoringMode) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint32("MonitoringMode", 32, uint32(uint32(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}

func (e MonitoringMode) GetValue() uint32 {
	return uint32(e)
}
