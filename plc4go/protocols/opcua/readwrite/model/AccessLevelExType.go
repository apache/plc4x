...
func (m AccessLevelExType) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m AccessLevelExType) GetLengthInBytes(ctx context.Context) uint64 {
...
func AccessLevelExTypeParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (AccessLevelExType, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint32("AccessLevelExType", 32)
	if err != nil {
...
func (e AccessLevelExType) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint32("AccessLevelExType", 32, uint32(uint32(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}

func (e AccessLevelExType) GetValue() uint32 {
	return uint32(e)
}
