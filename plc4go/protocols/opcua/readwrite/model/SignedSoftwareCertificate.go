...
func (m *_SignedSoftwareCertificate) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_signedSoftwareCertificate SignedSoftwareCertificate, err error) {
