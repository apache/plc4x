...
func (m *_SignedSoftwareCertificate) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_SignedSoftwareCertificate) GetLengthInBytes(ctx context.Context) uint64 {
