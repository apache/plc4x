...
func (m OpcuaNodeIdServicesVariableAxis) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableAxis) GetLengthInBytes(ctx context.Context) uint64 {
