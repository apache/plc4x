...
func (m OpcuaNodeIdServicesVariableAnnotations) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableAnnotations) GetLengthInBytes(ctx context.Context) uint64 {
