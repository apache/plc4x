...
func (m OpcuaNodeIdServicesVariableAttribute) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableAttribute) GetLengthInBytes(ctx context.Context) uint64 {
