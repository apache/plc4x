...
func (m UadpDataSetMessageContentMask) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m UadpDataSetMessageContentMask) GetLengthInBytes(ctx context.Context) uint64 {
...
func UadpDataSetMessageContentMaskParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (UadpDataSetMessageContentMask, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint32("UadpDataSetMessageContentMask", 32)
	if err != nil {
...
func (e UadpDataSetMessageContentMask) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint32("UadpDataSetMessageContentMask", 32, uint32(uint32(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}

func (e UadpDataSetMessageContentMask) GetValue() uint32 {
	return uint32(e)
}
