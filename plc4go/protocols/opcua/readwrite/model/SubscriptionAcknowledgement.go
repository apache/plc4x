...
func (m *_SubscriptionAcknowledgement) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_subscriptionAcknowledgement SubscriptionAcknowledgement, err error) {
