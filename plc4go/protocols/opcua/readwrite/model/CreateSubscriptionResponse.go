...
func (m *_CreateSubscriptionResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_createSubscriptionResponse CreateSubscriptionResponse, err error) {
