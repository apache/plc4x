...
func (m OpcuaNodeIdServicesVariableModel) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableModel) GetLengthInBytes(ctx context.Context) uint64 {
