...
func (m OpcuaNodeIdServicesVariableMonitoring) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableMonitoring) GetLengthInBytes(ctx context.Context) uint64 {
