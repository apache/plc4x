...
func (m *_JsonActionRequestMessage) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_JsonActionRequestMessage) GetLengthInBytes(ctx context.Context) uint64 {
