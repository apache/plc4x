...
func (m OpcuaNodeIdServicesVariableSessions) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableSessions) GetLengthInBytes(ctx context.Context) uint64 {
