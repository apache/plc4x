...
func (m OpcuaNodeIdServicesVariableTimestamps) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableTimestamps) GetLengthInBytes(ctx context.Context) uint64 {
