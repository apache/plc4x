...
func (m OpcuaNodeIdServicesVariableAudit) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableAudit) GetLengthInBytes(ctx context.Context) uint64 {
