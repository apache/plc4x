...
func (m *_SamplingIntervalDiagnosticsDataType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_samplingIntervalDiagnosticsDataType SamplingIntervalDiagnosticsDataType, err error) {
