...
func VariantFloatParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, arrayLengthSpecified bool) (VariantFloat, error) {
	...
	// Count array
	value := make([]float32, max(utils.InlineIf(bool((arrayLength) == (nil)), func() any { return uint16(uint16(1)) }, func() any { return uint16((*arrayLength)) }).(uint16), 0))
	...
	}
	{
		...
		for _curItem := uint16(0); _curItem < _numItems; _curItem++ {
			...
			_ = arrayCtx
			_ = _curItem
			_item, _err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadFloat32("", 32)
			if _err != nil {
