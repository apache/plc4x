...
func ModifySubscriptionRequestParseWithBufferProducer(identifier string) func(ctx context.Context, readBuffer utils.ReadBuffer) (ModifySubscriptionRequest, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (ModifySubscriptionRequest, error) {
		return ModifySubscriptionRequestParseWithBuffer(ctx, readBuffer, identifier)
	}
}
