...
func (m *_ModifySubscriptionRequest) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ModifySubscriptionRequest) GetLengthInBytes(ctx context.Context) uint64 {
