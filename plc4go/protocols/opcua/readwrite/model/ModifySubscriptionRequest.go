...
func (m *_ModifySubscriptionRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_modifySubscriptionRequest ModifySubscriptionRequest, err error) {
