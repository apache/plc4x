...
func (m *_AxisInformationBuilder) WithEngineeringUnitsBuilder(builderSupplier func(ExtensionObjectDefinitionBuilder) ExtensionObjectDefinitionBuilder) AxisInformationBuilder {
	builder := builderSupplier(m.EngineeringUnits.CreateExtensionObjectDefinitionBuilder())
	var err error
	m.EngineeringUnits, err = builder.Build()
	if err != nil {
		if m.err == nil {
...
func (m *_AxisInformationBuilder) WithEURangeBuilder(builderSupplier func(ExtensionObjectDefinitionBuilder) ExtensionObjectDefinitionBuilder) AxisInformationBuilder {
	builder := builderSupplier(m.EURange.CreateExtensionObjectDefinitionBuilder())
	var err error
	m.EURange, err = builder.Build()
	if err != nil {
		if m.err == nil {
			m.err = &utils.MultiError{MainError: errors.New("sub builder failed")}
		}
