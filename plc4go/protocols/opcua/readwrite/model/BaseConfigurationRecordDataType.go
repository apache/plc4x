...
func (m *_BaseConfigurationRecordDataType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BaseConfigurationRecordDataType) GetLengthInBytes(ctx context.Context) uint64 {
