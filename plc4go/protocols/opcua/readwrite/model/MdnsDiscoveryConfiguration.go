...
func (m *_MdnsDiscoveryConfiguration) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_MdnsDiscoveryConfiguration) GetLengthInBytes(ctx context.Context) uint64 {
