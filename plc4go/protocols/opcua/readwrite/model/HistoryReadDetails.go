...
// HistoryReadDetailsExactly can be used when we want exactly this type and not a type which fulfills HistoryReadDetails.
// This is useful for switch cases.
type HistoryReadDetailsExactly interface {
	HistoryReadDetails
	isHistoryReadDetails() bool
}
...
func (m *_HistoryReadDetails) InitializeParent(parent ExtensionObjectDefinition) {}

func (m *_HistoryReadDetails) GetParent() ExtensionObjectDefinition {
...
func HistoryReadDetailsParse(ctx context.Context, theBytes []byte, identifier string) (HistoryReadDetails, error) {
	return HistoryReadDetailsParseWithBuffer(ctx, utils.NewReadBufferByteBased(theBytes), identifier)
}

func HistoryReadDetailsParseWithBufferProducer(identifier string) func(ctx context.Context, readBuffer utils.ReadBuffer) (HistoryReadDetails, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (HistoryReadDetails, error) {
		return HistoryReadDetailsParseWithBuffer(ctx, readBuffer, identifier)
	}
}
...
func (m *_HistoryReadDetails) isHistoryReadDetails() bool {
	return true
}
