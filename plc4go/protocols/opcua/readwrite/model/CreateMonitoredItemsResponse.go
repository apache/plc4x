...
func CreateMonitoredItemsResponseParseWithBufferProducer(identifier string) func(ctx context.Context, readBuffer utils.ReadBuffer) (CreateMonitoredItemsResponse, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (CreateMonitoredItemsResponse, error) {
		return CreateMonitoredItemsResponseParseWithBuffer(ctx, readBuffer, identifier)
	}
}
