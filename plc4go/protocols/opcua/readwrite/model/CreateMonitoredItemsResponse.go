...
func (m *_CreateMonitoredItemsResponse) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_CreateMonitoredItemsResponse) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_CreateMonitoredItemsResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, extensionId int32) (__createMonitoredItemsResponse CreateMonitoredItemsResponse, err error) {
	...
	results, err := ReadCountArrayField[MonitoredItemCreateResult](ctx, "results", ReadComplex[MonitoredItemCreateResult](ExtensionObjectDefinitionParseWithBufferProducer[MonitoredItemCreateResult]((int32)(int32(748))), readBuffer), uint64(noOfResults), codegen.WithEncoding("UTF8"))
	if err != nil {
