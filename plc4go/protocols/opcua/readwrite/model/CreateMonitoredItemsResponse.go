...
func (m *_CreateMonitoredItemsResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_createMonitoredItemsResponse CreateMonitoredItemsResponse, err error) {
