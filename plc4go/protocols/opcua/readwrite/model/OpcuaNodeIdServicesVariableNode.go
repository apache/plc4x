...
func (m OpcuaNodeIdServicesVariableNode) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableNode) GetLengthInBytes(ctx context.Context) uint64 {
