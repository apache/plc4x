...
func (m OpcuaNodeIdServicesVariableDelete) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableDelete) GetLengthInBytes(ctx context.Context) uint64 {
