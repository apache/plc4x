...
func (m OpcuaNodeIdServicesVariableFinite) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableFinite) GetLengthInBytes(ctx context.Context) uint64 {
