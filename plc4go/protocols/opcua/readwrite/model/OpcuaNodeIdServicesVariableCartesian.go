...
func (m OpcuaNodeIdServicesVariableCartesian) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableCartesian) GetLengthInBytes(ctx context.Context) uint64 {
