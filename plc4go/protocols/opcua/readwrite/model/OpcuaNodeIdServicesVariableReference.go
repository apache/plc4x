...
func (m OpcuaNodeIdServicesVariableReference) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableReference) GetLengthInBytes(ctx context.Context) uint64 {
