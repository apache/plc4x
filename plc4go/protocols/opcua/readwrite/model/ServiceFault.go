...
func ServiceFaultParseWithBufferProducer(identifier string) func(ctx context.Context, readBuffer utils.ReadBuffer) (ServiceFault, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (ServiceFault, error) {
		return ServiceFaultParseWithBuffer(ctx, readBuffer, identifier)
	}
}
