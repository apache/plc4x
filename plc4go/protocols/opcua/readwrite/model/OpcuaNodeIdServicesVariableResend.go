...
func (m OpcuaNodeIdServicesVariableResend) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableResend) GetLengthInBytes(ctx context.Context) uint64 {
