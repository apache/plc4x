...
func (m *_SubscriptionDiagnosticsDataType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_SubscriptionDiagnosticsDataType) GetLengthInBytes(ctx context.Context) uint64 {
