...
func (m OpcuaNodeIdServicesVariableThree) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableThree) GetLengthInBytes(ctx context.Context) uint64 {
