...
// DataTypeDefinitionExactly can be used when we want exactly this type and not a type which fulfills DataTypeDefinition.
// This is useful for switch cases.
type DataTypeDefinitionExactly interface {
	DataTypeDefinition
	isDataTypeDefinition() bool
}
...
func (m *_DataTypeDefinition) InitializeParent(parent ExtensionObjectDefinition) {}

func (m *_DataTypeDefinition) GetParent() ExtensionObjectDefinition {
...
func DataTypeDefinitionParse(ctx context.Context, theBytes []byte, identifier string) (DataTypeDefinition, error) {
...
func (m *_DataTypeDefinition) isDataTypeDefinition() bool {
	return true
}
