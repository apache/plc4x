...
func (m OpcuaNodeIdServicesVariableEngineering) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableEngineering) GetLengthInBytes(ctx context.Context) uint64 {
