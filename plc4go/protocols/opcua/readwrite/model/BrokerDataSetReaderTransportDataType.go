...
func (m *_BrokerDataSetReaderTransportDataType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BrokerDataSetReaderTransportDataType) GetLengthInBytes(ctx context.Context) uint64 {
