...
func (m OpcuaNodeIdServicesVariableLog) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableLog) GetLengthInBytes(ctx context.Context) uint64 {
