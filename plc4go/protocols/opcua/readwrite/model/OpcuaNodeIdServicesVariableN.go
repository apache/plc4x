...
func (m OpcuaNodeIdServicesVariableN) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableN) GetLengthInBytes(ctx context.Context) uint64 {
