...
func (m *_ModifyMonitoredItemsRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_modifyMonitoredItemsRequest ModifyMonitoredItemsRequest, err error) {
