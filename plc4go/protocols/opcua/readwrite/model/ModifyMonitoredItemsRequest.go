...
func (m *_ModifyMonitoredItemsRequest) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ModifyMonitoredItemsRequest) GetLengthInBytes(ctx context.Context) uint64 {
