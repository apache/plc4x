...
func (m *_BaseConfigurationDataType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_BaseConfigurationDataType) GetLengthInBytes(ctx context.Context) uint64 {
