...
func (m OpcuaNodeIdServicesVariableRequest) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableRequest) GetLengthInBytes(ctx context.Context) uint64 {
