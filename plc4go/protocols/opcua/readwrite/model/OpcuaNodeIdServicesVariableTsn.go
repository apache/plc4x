...
func (m OpcuaNodeIdServicesVariableTsn) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableTsn) GetLengthInBytes(ctx context.Context) uint64 {
