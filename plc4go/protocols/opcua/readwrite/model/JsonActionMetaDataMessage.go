...
func (m *_JsonActionMetaDataMessage) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_JsonActionMetaDataMessage) GetLengthInBytes(ctx context.Context) uint64 {
