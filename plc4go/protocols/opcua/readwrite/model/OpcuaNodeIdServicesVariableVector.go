...
func (m OpcuaNodeIdServicesVariableVector) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableVector) GetLengthInBytes(ctx context.Context) uint64 {
