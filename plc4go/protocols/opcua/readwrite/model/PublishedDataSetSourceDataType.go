...
func (m *_PublishedDataSetSourceDataType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_publishedDataSetSourceDataType PublishedDataSetSourceDataType, err error) {
