...
func (m *_AddReferencesResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_addReferencesResponse AddReferencesResponse, err error) {
