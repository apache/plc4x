...
func AddReferencesResponseParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, identifier string) (AddReferencesResponse, error) {
	...
	}
	{
		...
		for _curItem := uint16(0); _curItem < _numItems; _curItem++ {
			...
			if _err != nil {
				return nil, errors.Wrap(_err, "Error parsing 'results' field of AddReferencesResponse")
			}
	...
	}
	{
		...
		for _curItem := uint16(0); _curItem < _numItems; _curItem++ {
			...
			if _err != nil {
				return nil, errors.Wrap(_err, "Error parsing 'diagnosticInfos' field of AddReferencesResponse")
			}
