...
func (m *_ConnectionTransportDataType) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.ExtensionObjectDefinitionContract.(*_ExtensionObjectDefinition).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_ConnectionTransportDataType) GetLengthInBytes(ctx context.Context) uint64 {
