...
// ImageJPGExactly can be used when we want exactly this type and not a type which fulfills ImageJPG.
// This is useful for switch cases.
type ImageJPGExactly interface {
	ImageJPG
	isImageJPG() bool
}
...
func (m *_ImageJPG) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_imageJPG ImageJPG, err error) {
...
func (m *_ImageJPG) isImageJPG() bool {
	return true
}
