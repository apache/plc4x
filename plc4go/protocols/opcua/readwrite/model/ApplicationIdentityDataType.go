...
func (m *_ApplicationIdentityDataType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ApplicationIdentityDataType) GetLengthInBytes(ctx context.Context) uint64 {
