...
func (m OpcuaNodeIdServicesVariableIdentity) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableIdentity) GetLengthInBytes(ctx context.Context) uint64 {
