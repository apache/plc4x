...
func (b *_ProgramDiagnosticDataTypeBuilder) WithLastMethodReturnStatusBuilder(builderSupplier func(StatusResultBuilder) StatusResultBuilder) ProgramDiagnosticDataTypeBuilder {
	...
	if err != nil {
		b.collectedErr = append(b.collectedErr, errors.Wrap(err, "StatusResultBuilder failed"))
	}
	return b
}
...
func (m *_ProgramDiagnosticDataType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ProgramDiagnosticDataType) GetLengthInBytes(ctx context.Context) uint64 {
