...
func (m *_UserIdentityTokenDefinition) parse(ctx context.Context, readBuffer utils.ReadBuffer, identifier string) (_userIdentityTokenDefinition UserIdentityTokenDefinition, err error) {
