...
func (m OpcuaNodeIdServicesVariableId) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableId) GetLengthInBytes(ctx context.Context) uint64 {
