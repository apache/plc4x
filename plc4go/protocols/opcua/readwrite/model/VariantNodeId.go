...
func (m *_VariantNodeId) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_Variant, arrayLengthSpecified bool) (_variantNodeId VariantNodeId, err error) {
