...
func (m OpcuaNodeIdServicesVariableTransition) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableTransition) GetLengthInBytes(ctx context.Context) uint64 {
