...
func (m *_UpdateDataDetails) GetPlx4xTypeName() string {
	return "UpdateDataDetails"
}

func (m *_UpdateDataDetails) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_UpdateDataDetails) GetLengthInBytes(ctx context.Context) uint64 {
