...
func (m *_DeleteReferencesRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_deleteReferencesRequest DeleteReferencesRequest, err error) {
