...
func VariantByteParseWithBufferProducer(arrayLengthSpecified bool) func(ctx context.Context, readBuffer utils.ReadBuffer) (VariantByte, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (VariantByte, error) {
		return VariantByteParseWithBuffer(ctx, readBuffer, arrayLengthSpecified)
	}
}
