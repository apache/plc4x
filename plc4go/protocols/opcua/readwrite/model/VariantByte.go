...
func VariantByteParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, arrayLengthSpecified bool) (VariantByte, error) {
	...
	value, err := ReadCountArrayField[uint8](ctx, "value", ReadUnsignedByte(readBuffer, 8), uint64(utils.InlineIf(bool((arrayLength) == (nil)), func() any { return int32(int32(1)) }, func() any { return int32((*arrayLength)) }).(int32)))
	if err != nil {
