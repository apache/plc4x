...
func VariantUInt32ParseWithBufferProducer(arrayLengthSpecified bool) func(ctx context.Context, readBuffer utils.ReadBuffer) (VariantUInt32, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (VariantUInt32, error) {
		return VariantUInt32ParseWithBuffer(ctx, readBuffer, arrayLengthSpecified)
	}
}
