...
func (m OpcuaNodeIdServicesVariableNaming) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableNaming) GetLengthInBytes(ctx context.Context) uint64 {
