...
func (m *_SubscribedDataSetDataType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_subscribedDataSetDataType SubscribedDataSetDataType, err error) {
