...
func (m OpcuaNodeIdServicesVariableJson) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableJson) GetLengthInBytes(ctx context.Context) uint64 {
