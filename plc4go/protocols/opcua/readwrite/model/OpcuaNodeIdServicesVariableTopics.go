...
func (m OpcuaNodeIdServicesVariableTopics) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableTopics) GetLengthInBytes(ctx context.Context) uint64 {
