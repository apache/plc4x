...
func (m AccessLevelType) GetLengthInBits(ctx context.Context) uint64 {
	return 8
}

func (m AccessLevelType) GetLengthInBytes(ctx context.Context) uint64 {
...
func AccessLevelTypeParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (AccessLevelType, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint8("AccessLevelType", 8)
	if err != nil {
...
func (e AccessLevelType) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint8("AccessLevelType", 8, uint8(uint8(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}

func (e AccessLevelType) GetValue() uint8 {
	return uint8(e)
}
