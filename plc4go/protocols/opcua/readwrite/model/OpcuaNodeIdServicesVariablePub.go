...
func (m OpcuaNodeIdServicesVariablePub) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariablePub) GetLengthInBytes(ctx context.Context) uint64 {
