...
func (m OpcuaNodeIdServicesVariableProgram) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableProgram) GetLengthInBytes(ctx context.Context) uint64 {
