...
func (m OpcuaNodeIdServicesVariableMessage) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableMessage) GetLengthInBytes(ctx context.Context) uint64 {
