...
func (m OpcuaNodeIdServicesVariableLocal) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableLocal) GetLengthInBytes(ctx context.Context) uint64 {
