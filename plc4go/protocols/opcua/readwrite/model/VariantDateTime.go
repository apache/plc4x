...
func VariantDateTimeParseWithBufferProducer(arrayLengthSpecified bool) func(ctx context.Context, readBuffer utils.ReadBuffer) (VariantDateTime, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (VariantDateTime, error) {
		return VariantDateTimeParseWithBuffer(ctx, readBuffer, arrayLengthSpecified)
	}
}
