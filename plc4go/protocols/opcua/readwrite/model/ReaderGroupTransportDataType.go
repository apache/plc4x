...
func (m *_ReaderGroupTransportDataType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_readerGroupTransportDataType ReaderGroupTransportDataType, err error) {
