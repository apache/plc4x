...
func (m *_AnonymousIdentityToken) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_UserIdentityTokenDefinition, identifier string) (_anonymousIdentityToken AnonymousIdentityToken, err error) {
