...
func (m *_SetPublishingModeResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_setPublishingModeResponse SetPublishingModeResponse, err error) {
