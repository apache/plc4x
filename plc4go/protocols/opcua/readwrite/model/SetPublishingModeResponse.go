...
func SetPublishingModeResponseParseWithBufferProducer(identifier string) func(ctx context.Context, readBuffer utils.ReadBuffer) (SetPublishingModeResponse, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (SetPublishingModeResponse, error) {
		return SetPublishingModeResponseParseWithBuffer(ctx, readBuffer, identifier)
	}
}
