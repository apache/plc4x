...
func (m *_SessionlessInvokeResponseType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_sessionlessInvokeResponseType SessionlessInvokeResponseType, err error) {
