...
func (m OpcuaNodeIdServicesVariableType) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableType) GetLengthInBytes(ctx context.Context) uint64 {
