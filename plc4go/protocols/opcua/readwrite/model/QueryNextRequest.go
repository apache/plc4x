...
func (m *_QueryNextRequest) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_QueryNextRequest) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_QueryNextRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, extensionId int32) (__queryNextRequest QueryNextRequest, err error) {
	...
	releaseContinuationPoint, err := ReadSimpleField(ctx, "releaseContinuationPoint", ReadBoolean(readBuffer), codegen.WithEncoding("UTF8"))
	if err != nil {
...
func (m *_QueryNextRequest) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		if err := WriteSimpleField[bool](ctx, "releaseContinuationPoint", m.GetReleaseContinuationPoint(), WriteBoolean(writeBuffer), codegen.WithEncoding("UTF8")); err != nil {
