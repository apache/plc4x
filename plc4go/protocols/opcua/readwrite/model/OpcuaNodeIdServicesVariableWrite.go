...
func (m OpcuaNodeIdServicesVariableWrite) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableWrite) GetLengthInBytes(ctx context.Context) uint64 {
