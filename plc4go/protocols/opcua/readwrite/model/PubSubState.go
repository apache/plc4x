...
func (m PubSubState) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m PubSubState) GetLengthInBytes(ctx context.Context) uint64 {
...
func PubSubStateParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (PubSubState, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint32("PubSubState", 32)
	if err != nil {
...
func (e PubSubState) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint32("PubSubState", 32, uint32(uint32(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}

func (e PubSubState) GetValue() uint32 {
	return uint32(e)
}
