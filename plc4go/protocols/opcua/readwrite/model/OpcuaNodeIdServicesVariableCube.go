...
func (m OpcuaNodeIdServicesVariableCube) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableCube) GetLengthInBytes(ctx context.Context) uint64 {
