...
func (m OpcuaNodeIdServicesVariableExpression) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableExpression) GetLengthInBytes(ctx context.Context) uint64 {
