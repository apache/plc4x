...
func (m *_OpenSecureChannelRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_openSecureChannelRequest OpenSecureChannelRequest, err error) {
