...
func (m OpcuaNodeIdServicesVariableH) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableH) GetLengthInBytes(ctx context.Context) uint64 {
