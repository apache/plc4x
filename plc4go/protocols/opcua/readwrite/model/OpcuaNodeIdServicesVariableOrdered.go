...
func (m OpcuaNodeIdServicesVariableOrdered) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableOrdered) GetLengthInBytes(ctx context.Context) uint64 {
