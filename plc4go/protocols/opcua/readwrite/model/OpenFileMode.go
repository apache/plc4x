...
func OpenFileModeParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (OpenFileMode, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint32("OpenFileMode", 32)
	if err != nil {
...
func (e OpenFileMode) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint32("OpenFileMode", 32, uint32(uint32(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}

func (e OpenFileMode) GetValue() uint32 {
	return uint32(e)
}
