...
func (m OpcuaNodeIdServicesVariableView) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableView) GetLengthInBytes(ctx context.Context) uint64 {
