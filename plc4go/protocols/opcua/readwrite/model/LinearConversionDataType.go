...
func (m *_LinearConversionDataType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_LinearConversionDataType) GetLengthInBytes(ctx context.Context) uint64 {
