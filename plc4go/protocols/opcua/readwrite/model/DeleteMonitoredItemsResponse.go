...
func DeleteMonitoredItemsResponseParseWithBufferProducer(identifier string) func(ctx context.Context, readBuffer utils.ReadBuffer) (DeleteMonitoredItemsResponse, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (DeleteMonitoredItemsResponse, error) {
		return DeleteMonitoredItemsResponseParseWithBuffer(ctx, readBuffer, identifier)
	}
}
