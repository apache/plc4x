...
func (m *_UnsignedRationalNumber) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_unsignedRationalNumber UnsignedRationalNumber, err error) {
