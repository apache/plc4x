...
func (m *_SemanticChangeStructureDataType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_semanticChangeStructureDataType SemanticChangeStructureDataType, err error) {
