...
func (m *_ReadRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_readRequest ReadRequest, err error) {
