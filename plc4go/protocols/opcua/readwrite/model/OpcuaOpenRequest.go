...
func (m *_OpcuaOpenRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MessagePDU, totalLength uint32, response bool) (_opcuaOpenRequest OpcuaOpenRequest, err error) {
