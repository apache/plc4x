...
func (m *_OpcuaOpenRequestBuilder) WithOpenRequestBuilder(builderSupplier func(OpenChannelMessageBuilder) OpenChannelMessageBuilder) OpcuaOpenRequestBuilder {
	builder := builderSupplier(m.OpenRequest.CreateOpenChannelMessageBuilder())
	var err error
	m.OpenRequest, err = builder.Build()
	if err != nil {
		if m.err == nil {
...
func (m *_OpcuaOpenRequestBuilder) WithMessageBuilder(builderSupplier func(PayloadBuilder) PayloadBuilder) OpcuaOpenRequestBuilder {
