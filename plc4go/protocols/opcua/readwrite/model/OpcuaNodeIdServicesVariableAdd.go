...
func (m OpcuaNodeIdServicesVariableAdd) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableAdd) GetLengthInBytes(ctx context.Context) uint64 {
