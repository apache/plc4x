...
func (m OpcuaNodeIdServicesVariableHistory) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableHistory) GetLengthInBytes(ctx context.Context) uint64 {
