...
func (m OpcuaNodeIdServicesVariableAlias) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableAlias) GetLengthInBytes(ctx context.Context) uint64 {
