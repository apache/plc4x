...
func (m *_MonitoredItemCreateRequest) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_MonitoredItemCreateRequest) GetLengthInBytes(ctx context.Context) uint64 {
