...
func (m OpcuaNodeIdServicesVariableOverride) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableOverride) GetLengthInBytes(ctx context.Context) uint64 {
