...
func VariantDoubleParseWithBufferProducer(arrayLengthSpecified bool) func(ctx context.Context, readBuffer utils.ReadBuffer) (VariantDouble, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (VariantDouble, error) {
		return VariantDoubleParseWithBuffer(ctx, readBuffer, arrayLengthSpecified)
	}
}
