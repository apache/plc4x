...
func VariantDoubleParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, arrayLengthSpecified bool) (VariantDouble, error) {
	...
	value, err := ReadCountArrayField[float64](ctx, "value", ReadDouble(readBuffer, 64), uint64(utils.InlineIf(bool((arrayLength) == (nil)), func() any { return int32(int32(1)) }, func() any { return int32((*arrayLength)) }).(int32)))
	if err != nil {
