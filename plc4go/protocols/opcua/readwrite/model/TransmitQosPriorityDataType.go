...
func (m *_TransmitQosPriorityDataType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_TransmitQosPriorityDataType) GetLengthInBytes(ctx context.Context) uint64 {
