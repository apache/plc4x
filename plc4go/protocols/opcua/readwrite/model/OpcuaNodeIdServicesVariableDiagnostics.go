...
func (m OpcuaNodeIdServicesVariableDiagnostics) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableDiagnostics) GetLengthInBytes(ctx context.Context) uint64 {
