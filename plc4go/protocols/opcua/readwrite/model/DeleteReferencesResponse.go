...
func DeleteReferencesResponseParseWithBufferProducer(identifier string) func(ctx context.Context, readBuffer utils.ReadBuffer) (DeleteReferencesResponse, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (DeleteReferencesResponse, error) {
		return DeleteReferencesResponseParseWithBuffer(ctx, readBuffer, identifier)
	}
}
