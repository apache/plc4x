...
func (m *_DeleteReferencesResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_deleteReferencesResponse DeleteReferencesResponse, err error) {
