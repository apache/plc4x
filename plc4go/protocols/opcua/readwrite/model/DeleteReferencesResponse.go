...
func (m *_DeleteReferencesResponse) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_DeleteReferencesResponse) GetLengthInBytes(ctx context.Context) uint64 {
