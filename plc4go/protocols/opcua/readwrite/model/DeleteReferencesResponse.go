...
// DeleteReferencesResponseExactly can be used when we want exactly this type and not a type which fulfills DeleteReferencesResponse.
// This is useful for switch cases.
type DeleteReferencesResponseExactly interface {
	DeleteReferencesResponse
	isDeleteReferencesResponse() bool
}
...
func (m *_DeleteReferencesResponse) InitializeParent(parent ExtensionObjectDefinition) {}

func (m *_DeleteReferencesResponse) GetParent() ExtensionObjectDefinition {
...
func DeleteReferencesResponseParse(ctx context.Context, theBytes []byte, identifier string) (DeleteReferencesResponse, error) {
	return DeleteReferencesResponseParseWithBuffer(ctx, utils.NewReadBufferByteBased(theBytes), identifier)
}

func DeleteReferencesResponseParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, identifier string) (DeleteReferencesResponse, error) {
	...
	if _responseHeaderErr != nil {
		return nil, errors.Wrap(_responseHeaderErr, "Error parsing 'responseHeader' field of DeleteReferencesResponse")
	}
	...
	if _noOfResultsErr != nil {
		return nil, errors.Wrap(_noOfResultsErr, "Error parsing 'noOfResults' field of DeleteReferencesResponse")
	}
	...
	}
	{
		...
		for _curItem := uint16(0); _curItem < _numItems; _curItem++ {
			...
			if _err != nil {
				return nil, errors.Wrap(_err, "Error parsing 'results' field of DeleteReferencesResponse")
			}
	...
	if _noOfDiagnosticInfosErr != nil {
		return nil, errors.Wrap(_noOfDiagnosticInfosErr, "Error parsing 'noOfDiagnosticInfos' field of DeleteReferencesResponse")
	}
	...
	}
	{
		...
		for _curItem := uint16(0); _curItem < _numItems; _curItem++ {
			...
			if _err != nil {
				return nil, errors.Wrap(_err, "Error parsing 'diagnosticInfos' field of DeleteReferencesResponse")
			}
	...
	_child := &_DeleteReferencesResponse{
...
func (m *_DeleteReferencesResponse) isDeleteReferencesResponse() bool {
	return true
}
