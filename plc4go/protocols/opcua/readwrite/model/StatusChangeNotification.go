...
func (m *_StatusChangeNotification) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_StatusChangeNotification) GetLengthInBytes(ctx context.Context) uint64 {
