...
func (m *_OpcuaHelloRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MessagePDU, response bool) (_opcuaHelloRequest OpcuaHelloRequest, err error) {
