...
func (m *_JsonPubSubConnectionMessage) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_JsonPubSubConnectionMessage) GetLengthInBytes(ctx context.Context) uint64 {
