...
func (m OpcuaNodeIdServicesVariableRational) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableRational) GetLengthInBytes(ctx context.Context) uint64 {
