...
func (m *_MonitoredItemModifyRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_monitoredItemModifyRequest MonitoredItemModifyRequest, err error) {
