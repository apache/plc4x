...
func (m OpcuaNodeIdServicesVariableAliases) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableAliases) GetLengthInBytes(ctx context.Context) uint64 {
