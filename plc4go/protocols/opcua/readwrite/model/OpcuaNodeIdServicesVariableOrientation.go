...
func (m OpcuaNodeIdServicesVariableOrientation) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableOrientation) GetLengthInBytes(ctx context.Context) uint64 {
