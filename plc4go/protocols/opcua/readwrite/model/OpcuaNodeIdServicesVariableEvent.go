...
func (m OpcuaNodeIdServicesVariableEvent) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableEvent) GetLengthInBytes(ctx context.Context) uint64 {
