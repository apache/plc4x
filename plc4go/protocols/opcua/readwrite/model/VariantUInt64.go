...
func VariantUInt64ParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, arrayLengthSpecified bool) (VariantUInt64, error) {
	...
	value, err := ReadCountArrayField[uint64](ctx, "value", ReadUnsignedLong(readBuffer, 64), uint64(utils.InlineIf(bool((arrayLength) == (nil)), func() any { return int32(int32(1)) }, func() any { return int32((*arrayLength)) }).(int32)))
	if err != nil {
