...
func (m OpcuaNodeIdServicesVariableArray) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableArray) GetLengthInBytes(ctx context.Context) uint64 {
