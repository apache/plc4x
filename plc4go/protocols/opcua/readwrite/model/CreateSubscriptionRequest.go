...
func (m *_CreateSubscriptionRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_createSubscriptionRequest CreateSubscriptionRequest, err error) {
