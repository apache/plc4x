...
func (m OpcuaNodeIdServicesVariableDisconnect) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableDisconnect) GetLengthInBytes(ctx context.Context) uint64 {
