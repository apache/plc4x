...
func (m *_SetMonitoringModeResponse) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_SetMonitoringModeResponse) GetLengthInBytes(ctx context.Context) uint64 {
