...
func SetMonitoringModeResponseParseWithBufferProducer(identifier string) func(ctx context.Context, readBuffer utils.ReadBuffer) (SetMonitoringModeResponse, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (SetMonitoringModeResponse, error) {
		return SetMonitoringModeResponseParseWithBuffer(ctx, readBuffer, identifier)
	}
}
