...
func (m *_SetMonitoringModeResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_setMonitoringModeResponse SetMonitoringModeResponse, err error) {
