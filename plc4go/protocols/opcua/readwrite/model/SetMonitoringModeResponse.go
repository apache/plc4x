...
// SetMonitoringModeResponseExactly can be used when we want exactly this type and not a type which fulfills SetMonitoringModeResponse.
// This is useful for switch cases.
type SetMonitoringModeResponseExactly interface {
	SetMonitoringModeResponse
	isSetMonitoringModeResponse() bool
}
...
func (m *_SetMonitoringModeResponse) InitializeParent(parent ExtensionObjectDefinition) {}

func (m *_SetMonitoringModeResponse) GetParent() ExtensionObjectDefinition {
...
func SetMonitoringModeResponseParse(ctx context.Context, theBytes []byte, identifier string) (SetMonitoringModeResponse, error) {
	return SetMonitoringModeResponseParseWithBuffer(ctx, utils.NewReadBufferByteBased(theBytes), identifier)
}

func SetMonitoringModeResponseParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, identifier string) (SetMonitoringModeResponse, error) {
	...
	if _responseHeaderErr != nil {
		return nil, errors.Wrap(_responseHeaderErr, "Error parsing 'responseHeader' field of SetMonitoringModeResponse")
	}
	...
	if _noOfResultsErr != nil {
		return nil, errors.Wrap(_noOfResultsErr, "Error parsing 'noOfResults' field of SetMonitoringModeResponse")
	}
	...
	}
	{
		...
		for _curItem := uint16(0); _curItem < _numItems; _curItem++ {
			...
			if _err != nil {
				return nil, errors.Wrap(_err, "Error parsing 'results' field of SetMonitoringModeResponse")
			}
	...
	if _noOfDiagnosticInfosErr != nil {
		return nil, errors.Wrap(_noOfDiagnosticInfosErr, "Error parsing 'noOfDiagnosticInfos' field of SetMonitoringModeResponse")
	}
	...
	}
	{
		...
		for _curItem := uint16(0); _curItem < _numItems; _curItem++ {
			...
			if _err != nil {
				return nil, errors.Wrap(_err, "Error parsing 'diagnosticInfos' field of SetMonitoringModeResponse")
			}
	...
	_child := &_SetMonitoringModeResponse{
...
func (m *_SetMonitoringModeResponse) isSetMonitoringModeResponse() bool {
	return true
}
