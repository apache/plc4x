...
func (m *_EphemeralKeyType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_EphemeralKeyType) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_EphemeralKeyType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, extensionId int32) (__ephemeralKeyType EphemeralKeyType, err error) {
	...
	publicKey, err := ReadSimpleField[PascalByteString](ctx, "publicKey", ReadComplex[PascalByteString](PascalByteStringParseWithBuffer, readBuffer), codegen.WithEncoding("UTF8"))
	if err != nil {
...
func (m *_EphemeralKeyType) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		if err := WriteSimpleField[PascalByteString](ctx, "publicKey", m.GetPublicKey(), WriteComplex[PascalByteString](writeBuffer), codegen.WithEncoding("UTF8")); err != nil {
