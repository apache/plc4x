...
func (m OpcuaNodeIdServicesVariableIcon) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableIcon) GetLengthInBytes(ctx context.Context) uint64 {
