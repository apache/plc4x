...
func (b *_ViewDescriptionBuilder) Build() (ViewDescription, error) {
	if b.ViewId == nil {
		b.collectedErr = append(b.collectedErr, errors.New("mandatory field 'viewId' not set"))
	}
...
func (m *_ViewDescription) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ViewDescription) GetLengthInBytes(ctx context.Context) uint64 {
