...
func (m OpcuaNodeIdServicesVariableBrowse) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableBrowse) GetLengthInBytes(ctx context.Context) uint64 {
