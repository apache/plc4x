...
func (m *_ConfigurationVersionDataType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ConfigurationVersionDataType) GetLengthInBytes(ctx context.Context) uint64 {
