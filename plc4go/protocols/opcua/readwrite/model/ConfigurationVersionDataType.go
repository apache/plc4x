...
func (m *_ConfigurationVersionDataType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_configurationVersionDataType ConfigurationVersionDataType, err error) {
