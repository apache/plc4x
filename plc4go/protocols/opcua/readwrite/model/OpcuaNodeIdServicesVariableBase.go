...
func (m OpcuaNodeIdServicesVariableBase) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableBase) GetLengthInBytes(ctx context.Context) uint64 {
