...
func (m *_DatagramWriterGroupTransportDataType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_DatagramWriterGroupTransportDataType) GetLengthInBytes(ctx context.Context) uint64 {
