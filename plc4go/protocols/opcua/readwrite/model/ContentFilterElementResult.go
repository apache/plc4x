...
func (m *_ContentFilterElementResult) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ContentFilterElementResult) GetLengthInBytes(ctx context.Context) uint64 {
