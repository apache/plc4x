...
func (m *_EndpointUrlListDataType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_endpointUrlListDataType EndpointUrlListDataType, err error) {
