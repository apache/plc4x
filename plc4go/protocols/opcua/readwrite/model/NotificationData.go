...
// NotificationDataExactly can be used when we want exactly this type and not a type which fulfills NotificationData.
// This is useful for switch cases.
type NotificationDataExactly interface {
	NotificationData
	isNotificationData() bool
}
...
func (m *_NotificationData) InitializeParent(parent ExtensionObjectDefinition) {}

func (m *_NotificationData) GetParent() ExtensionObjectDefinition {
...
func NotificationDataParse(ctx context.Context, theBytes []byte, identifier string) (NotificationData, error) {
...
func (m *_NotificationData) isNotificationData() bool {
	return true
}
