...
func BrowseNextResponseParseWithBufferProducer(identifier string) func(ctx context.Context, readBuffer utils.ReadBuffer) (BrowseNextResponse, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (BrowseNextResponse, error) {
		return BrowseNextResponseParseWithBuffer(ctx, readBuffer, identifier)
	}
}
