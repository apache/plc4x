...
func (m *_PubSubConnectionDataType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_PubSubConnectionDataType) GetLengthInBytes(ctx context.Context) uint64 {
