...
func (m *_SessionlessInvokeRequestType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_sessionlessInvokeRequestType SessionlessInvokeRequestType, err error) {
