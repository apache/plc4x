...
func (m OpcuaNodeIdServicesVariableY) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableY) GetLengthInBytes(ctx context.Context) uint64 {
