...
func (m OpcuaNodeIdServicesVariableConnect) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableConnect) GetLengthInBytes(ctx context.Context) uint64 {
