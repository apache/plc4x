...
func (m *_PubSubConfigurationRefDataType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_PubSubConfigurationRefDataType) GetLengthInBytes(ctx context.Context) uint64 {
