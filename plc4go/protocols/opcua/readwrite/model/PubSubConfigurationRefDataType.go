...
func (m *_PubSubConfigurationRefDataType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_pubSubConfigurationRefDataType PubSubConfigurationRefDataType, err error) {
