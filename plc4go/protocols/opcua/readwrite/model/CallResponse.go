...
func CallResponseParseWithBufferProducer(identifier string) func(ctx context.Context, readBuffer utils.ReadBuffer) (CallResponse, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (CallResponse, error) {
		return CallResponseParseWithBuffer(ctx, readBuffer, identifier)
	}
}
