...
func (m OpcuaNodeIdServicesVariableWith) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableWith) GetLengthInBytes(ctx context.Context) uint64 {
