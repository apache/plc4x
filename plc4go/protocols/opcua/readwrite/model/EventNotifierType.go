...
func (m EventNotifierType) GetLengthInBits(ctx context.Context) uint64 {
	return 8
}

func (m EventNotifierType) GetLengthInBytes(ctx context.Context) uint64 {
...
func EventNotifierTypeParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (EventNotifierType, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint8("EventNotifierType", 8)
	if err != nil {
...
func (e EventNotifierType) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint8("EventNotifierType", 8, uint8(uint8(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}

func (e EventNotifierType) GetValue() uint8 {
	return uint8(e)
}
