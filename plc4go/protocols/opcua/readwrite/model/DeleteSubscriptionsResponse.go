...
func (m *_DeleteSubscriptionsResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_deleteSubscriptionsResponse DeleteSubscriptionsResponse, err error) {
