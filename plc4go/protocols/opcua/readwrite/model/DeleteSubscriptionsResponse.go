...
func DeleteSubscriptionsResponseParseWithBufferProducer(identifier string) func(ctx context.Context, readBuffer utils.ReadBuffer) (DeleteSubscriptionsResponse, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (DeleteSubscriptionsResponse, error) {
		return DeleteSubscriptionsResponseParseWithBuffer(ctx, readBuffer, identifier)
	}
}
