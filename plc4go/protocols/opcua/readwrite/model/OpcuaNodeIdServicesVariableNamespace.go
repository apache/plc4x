...
func (m OpcuaNodeIdServicesVariableNamespace) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableNamespace) GetLengthInBytes(ctx context.Context) uint64 {
