...
func (m OpcuaNodeIdServicesVariableTemporary) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableTemporary) GetLengthInBytes(ctx context.Context) uint64 {
