...
func (m OpcuaNodeIdServicesVariableSubscription) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableSubscription) GetLengthInBytes(ctx context.Context) uint64 {
