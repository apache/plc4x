...
func (m OpcuaNodeIdServicesVariableCondition) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableCondition) GetLengthInBytes(ctx context.Context) uint64 {
