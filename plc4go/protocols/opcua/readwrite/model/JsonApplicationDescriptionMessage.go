...
func (m *_JsonApplicationDescriptionMessage) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_JsonApplicationDescriptionMessage) GetLengthInBytes(ctx context.Context) uint64 {
