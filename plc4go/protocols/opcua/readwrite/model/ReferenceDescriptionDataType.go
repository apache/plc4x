...
func (m *_ReferenceDescriptionDataType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ReferenceDescriptionDataType) GetLengthInBytes(ctx context.Context) uint64 {
