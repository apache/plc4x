...
func (m *_ReferenceDescriptionDataType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_referenceDescriptionDataType ReferenceDescriptionDataType, err error) {
