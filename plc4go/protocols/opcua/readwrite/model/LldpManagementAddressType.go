...
func (m *_LldpManagementAddressType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_LldpManagementAddressType) GetLengthInBytes(ctx context.Context) uint64 {
