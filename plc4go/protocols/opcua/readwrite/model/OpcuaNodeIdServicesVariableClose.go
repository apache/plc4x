...
func (m OpcuaNodeIdServicesVariableClose) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableClose) GetLengthInBytes(ctx context.Context) uint64 {
