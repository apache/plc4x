...
func (m *_CreateMonitoredItemsRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_createMonitoredItemsRequest CreateMonitoredItemsRequest, err error) {
