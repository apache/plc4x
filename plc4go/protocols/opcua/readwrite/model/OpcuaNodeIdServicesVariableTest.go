...
func (m OpcuaNodeIdServicesVariableTest) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableTest) GetLengthInBytes(ctx context.Context) uint64 {
