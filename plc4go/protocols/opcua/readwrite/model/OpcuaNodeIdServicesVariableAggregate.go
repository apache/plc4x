...
func (m OpcuaNodeIdServicesVariableAggregate) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableAggregate) GetLengthInBytes(ctx context.Context) uint64 {
