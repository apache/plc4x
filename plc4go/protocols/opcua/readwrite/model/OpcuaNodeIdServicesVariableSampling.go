...
func (m OpcuaNodeIdServicesVariableSampling) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableSampling) GetLengthInBytes(ctx context.Context) uint64 {
