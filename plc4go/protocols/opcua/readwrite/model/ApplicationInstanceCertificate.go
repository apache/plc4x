...
func (m *_ApplicationInstanceCertificate) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_applicationInstanceCertificate ApplicationInstanceCertificate, err error) {
