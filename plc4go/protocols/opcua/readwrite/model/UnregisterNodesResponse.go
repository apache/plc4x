...
func UnregisterNodesResponseParseWithBufferProducer(identifier string) func(ctx context.Context, readBuffer utils.ReadBuffer) (UnregisterNodesResponse, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (UnregisterNodesResponse, error) {
		return UnregisterNodesResponseParseWithBuffer(ctx, readBuffer, identifier)
	}
}
