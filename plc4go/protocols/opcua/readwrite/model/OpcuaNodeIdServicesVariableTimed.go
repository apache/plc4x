...
func (m OpcuaNodeIdServicesVariableTimed) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableTimed) GetLengthInBytes(ctx context.Context) uint64 {
