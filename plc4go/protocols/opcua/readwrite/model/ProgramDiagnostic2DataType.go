...
func (m *_ProgramDiagnostic2DataType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_programDiagnostic2DataType ProgramDiagnostic2DataType, err error) {
