...
func (m *_ProgramDiagnostic2DataType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ProgramDiagnostic2DataType) GetLengthInBytes(ctx context.Context) uint64 {
