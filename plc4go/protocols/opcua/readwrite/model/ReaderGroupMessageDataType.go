...
func (m *_ReaderGroupMessageDataType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_readerGroupMessageDataType ReaderGroupMessageDataType, err error) {
