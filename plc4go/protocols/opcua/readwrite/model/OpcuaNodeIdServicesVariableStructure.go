...
func (m OpcuaNodeIdServicesVariableStructure) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableStructure) GetLengthInBytes(ctx context.Context) uint64 {
