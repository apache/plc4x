...
func (m OpcuaNodeIdServicesVariableReader) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableReader) GetLengthInBytes(ctx context.Context) uint64 {
