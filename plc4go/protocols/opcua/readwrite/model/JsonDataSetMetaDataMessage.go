...
func (m *_JsonDataSetMetaDataMessage) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_JsonDataSetMetaDataMessage) GetLengthInBytes(ctx context.Context) uint64 {
