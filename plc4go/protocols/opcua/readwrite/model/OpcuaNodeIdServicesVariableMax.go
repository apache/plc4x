...
func (m OpcuaNodeIdServicesVariableMax) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableMax) GetLengthInBytes(ctx context.Context) uint64 {
