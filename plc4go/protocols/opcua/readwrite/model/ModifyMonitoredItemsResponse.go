...
func ModifyMonitoredItemsResponseParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, identifier string) (ModifyMonitoredItemsResponse, error) {
	...
	if _responseHeaderErr != nil {
		return nil, errors.Wrap(_responseHeaderErr, "Error parsing 'responseHeader' field of ModifyMonitoredItemsResponse")
	}
	...
	if _noOfResultsErr != nil {
		return nil, errors.Wrap(_noOfResultsErr, "Error parsing 'noOfResults' field of ModifyMonitoredItemsResponse")
	}
	...
	// Count array
	results := make([]ExtensionObjectDefinition, max(noOfResults, 0))
	...
	}
	{
		...
		for _curItem := uint16(0); _curItem < _numItems; _curItem++ {
			...
			_ = arrayCtx
			_ = _curItem
			_item, _err := ExtensionObjectDefinitionParseWithBuffer(arrayCtx, readBuffer, "760")
			if _err != nil {
				return nil, errors.Wrap(_err, "Error parsing 'results' field of ModifyMonitoredItemsResponse")
			}
	...
	if _noOfDiagnosticInfosErr != nil {
		return nil, errors.Wrap(_noOfDiagnosticInfosErr, "Error parsing 'noOfDiagnosticInfos' field of ModifyMonitoredItemsResponse")
	}
	...
	}
	{
		...
		for _curItem := uint16(0); _curItem < _numItems; _curItem++ {
			...
			if _err != nil {
				return nil, errors.Wrap(_err, "Error parsing 'diagnosticInfos' field of ModifyMonitoredItemsResponse")
			}
