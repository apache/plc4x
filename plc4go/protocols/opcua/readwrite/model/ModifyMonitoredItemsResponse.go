...
func (b *_ModifyMonitoredItemsResponseBuilder) setParent(contract ExtensionObjectDefinitionContract) {
	...
	contract.(*_ExtensionObjectDefinition)._SubType = b._ModifyMonitoredItemsResponse
}
...
func (m *_ModifyMonitoredItemsResponse) GetPlx4xTypeName() string {
	return "ModifyMonitoredItemsResponse"
}

func (m *_ModifyMonitoredItemsResponse) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ModifyMonitoredItemsResponse) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_ModifyMonitoredItemsResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, extensionId int32) (__modifyMonitoredItemsResponse ModifyMonitoredItemsResponse, err error) {
	...
	results, err := ReadCountArrayField[MonitoredItemModifyResult](ctx, "results", ReadComplex[MonitoredItemModifyResult](ExtensionObjectDefinitionParseWithBufferProducer[MonitoredItemModifyResult]((int32)(int32(760))), readBuffer), uint64(noOfResults), codegen.WithEncoding("UTF8"))
	if err != nil {
...
func (m *_ModifyMonitoredItemsResponse) deepCopy() *_ModifyMonitoredItemsResponse {
	...
	_ModifyMonitoredItemsResponseCopy.ExtensionObjectDefinitionContract.(*_ExtensionObjectDefinition)._SubType = m
