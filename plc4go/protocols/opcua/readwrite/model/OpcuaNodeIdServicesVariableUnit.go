...
func (m OpcuaNodeIdServicesVariableUnit) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableUnit) GetLengthInBytes(ctx context.Context) uint64 {
