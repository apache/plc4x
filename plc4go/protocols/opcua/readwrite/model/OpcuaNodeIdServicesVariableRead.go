...
func (m OpcuaNodeIdServicesVariableRead) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableRead) GetLengthInBytes(ctx context.Context) uint64 {
