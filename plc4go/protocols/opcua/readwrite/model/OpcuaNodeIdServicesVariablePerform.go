...
func (m OpcuaNodeIdServicesVariablePerform) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariablePerform) GetLengthInBytes(ctx context.Context) uint64 {
