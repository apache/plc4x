...
func (m *_SetPublishingModeRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_setPublishingModeRequest SetPublishingModeRequest, err error) {
