...
func (m *_SetPublishingModeRequest) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_SetPublishingModeRequest) GetLengthInBytes(ctx context.Context) uint64 {
