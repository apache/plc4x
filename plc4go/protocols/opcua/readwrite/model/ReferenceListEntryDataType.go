...
func (m *_ReferenceListEntryDataType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_referenceListEntryDataType ReferenceListEntryDataType, err error) {
