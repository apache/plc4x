...
func (m *_ReferenceListEntryDataType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ReferenceListEntryDataType) GetLengthInBytes(ctx context.Context) uint64 {
