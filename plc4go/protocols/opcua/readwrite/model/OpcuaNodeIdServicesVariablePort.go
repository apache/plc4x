...
func (m OpcuaNodeIdServicesVariablePort) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariablePort) GetLengthInBytes(ctx context.Context) uint64 {
