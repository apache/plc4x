...
func (m *_DataSetWriterDataType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_dataSetWriterDataType DataSetWriterDataType, err error) {
