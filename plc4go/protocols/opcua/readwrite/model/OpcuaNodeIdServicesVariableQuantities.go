...
func (m OpcuaNodeIdServicesVariableQuantities) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableQuantities) GetLengthInBytes(ctx context.Context) uint64 {
