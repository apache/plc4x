...
// TransferSubscriptionsResponseExactly can be used when we want exactly this type and not a type which fulfills TransferSubscriptionsResponse.
// This is useful for switch cases.
type TransferSubscriptionsResponseExactly interface {
	TransferSubscriptionsResponse
	isTransferSubscriptionsResponse() bool
}
...
func (m *_TransferSubscriptionsResponse) InitializeParent(parent ExtensionObjectDefinition) {}

func (m *_TransferSubscriptionsResponse) GetParent() ExtensionObjectDefinition {
...
func TransferSubscriptionsResponseParse(ctx context.Context, theBytes []byte, identifier string) (TransferSubscriptionsResponse, error) {
	return TransferSubscriptionsResponseParseWithBuffer(ctx, utils.NewReadBufferByteBased(theBytes), identifier)
}

func TransferSubscriptionsResponseParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, identifier string) (TransferSubscriptionsResponse, error) {
	...
	if _responseHeaderErr != nil {
		return nil, errors.Wrap(_responseHeaderErr, "Error parsing 'responseHeader' field of TransferSubscriptionsResponse")
	}
	...
	if _noOfResultsErr != nil {
		return nil, errors.Wrap(_noOfResultsErr, "Error parsing 'noOfResults' field of TransferSubscriptionsResponse")
	}
	...
	}
	{
		...
		for _curItem := uint16(0); _curItem < _numItems; _curItem++ {
			...
			_ = arrayCtx
			_ = _curItem
			_item, _err := ExtensionObjectDefinitionParseWithBuffer(arrayCtx, readBuffer, "838")
			if _err != nil {
				return nil, errors.Wrap(_err, "Error parsing 'results' field of TransferSubscriptionsResponse")
			}
	...
	if _noOfDiagnosticInfosErr != nil {
		return nil, errors.Wrap(_noOfDiagnosticInfosErr, "Error parsing 'noOfDiagnosticInfos' field of TransferSubscriptionsResponse")
	}
	...
	}
	{
		...
		for _curItem := uint16(0); _curItem < _numItems; _curItem++ {
			...
			if _err != nil {
				return nil, errors.Wrap(_err, "Error parsing 'diagnosticInfos' field of TransferSubscriptionsResponse")
			}
	...
	_child := &_TransferSubscriptionsResponse{
...
func (m *_TransferSubscriptionsResponse) isTransferSubscriptionsResponse() bool {
	return true
}
