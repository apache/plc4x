...
func (m *_TransferSubscriptionsResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, identifier string) (_transferSubscriptionsResponse TransferSubscriptionsResponse, err error) {
