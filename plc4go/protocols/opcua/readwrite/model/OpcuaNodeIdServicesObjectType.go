...
func (m OpcuaNodeIdServicesObjectType) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesObjectType) GetLengthInBytes(ctx context.Context) uint64 {
