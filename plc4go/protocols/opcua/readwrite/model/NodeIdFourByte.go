...
func (b *_NodeIdFourByteBuilder) setParent(contract NodeIdTypeDefinitionContract) {
	...
	contract.(*_NodeIdTypeDefinition)._SubType = b._NodeIdFourByte
}
...
func (m *_NodeIdFourByte) GetPlx4xTypeName() string {
	return "NodeIdFourByte"
}

func (m *_NodeIdFourByte) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_NodeIdFourByte) GetLengthInBytes(ctx context.Context) uint64 {
