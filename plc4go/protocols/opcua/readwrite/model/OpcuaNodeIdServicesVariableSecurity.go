...
func (m OpcuaNodeIdServicesVariableSecurity) GetLengthInBits(ctx context.Context) uint64 {
	return 32
}

func (m OpcuaNodeIdServicesVariableSecurity) GetLengthInBytes(ctx context.Context) uint64 {
