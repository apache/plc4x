...
func (m *_ApduDataExtDomainAddressSelectiveRead) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtDomainAddressSelectiveRead ApduDataExtDomainAddressSelectiveRead, err error) {
