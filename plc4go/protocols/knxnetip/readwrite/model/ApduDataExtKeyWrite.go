...
func (m *_ApduDataExtKeyWrite) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtKeyWrite ApduDataExtKeyWrite, err error) {
