...
func (m *_TDataConnectedReq) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_CEMI, size uint16) (_tDataConnectedReq TDataConnectedReq, err error) {
