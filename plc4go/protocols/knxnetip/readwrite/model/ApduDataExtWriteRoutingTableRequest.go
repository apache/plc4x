...
func (m *_ApduDataExtWriteRoutingTableRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtWriteRoutingTableRequest ApduDataExtWriteRoutingTableRequest, err error) {
