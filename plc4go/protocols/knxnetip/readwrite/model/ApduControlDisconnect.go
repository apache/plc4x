...
func (m *_ApduControlDisconnect) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduControl) (_apduControlDisconnect ApduControlDisconnect, err error) {
