...
func (m *_ApduDataExtGroupPropertyValueWrite) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtGroupPropertyValueWrite ApduDataExtGroupPropertyValueWrite, err error) {
