...
func (m *_ApduDataExtLinkRead) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtLinkRead ApduDataExtLinkRead, err error) {
