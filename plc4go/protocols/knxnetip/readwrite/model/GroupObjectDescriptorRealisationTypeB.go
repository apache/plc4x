...
func (m *_GroupObjectDescriptorRealisationTypeB) GetPlx4xTypeName() string {
	return "GroupObjectDescriptorRealisationTypeB"
}

func (m *_GroupObjectDescriptorRealisationTypeB) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_GroupObjectDescriptorRealisationTypeB) GetLengthInBytes(ctx context.Context) uint64 {
...
func GroupObjectDescriptorRealisationTypeBParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (GroupObjectDescriptorRealisationTypeB, error) {
	v, err := (new(_GroupObjectDescriptorRealisationTypeB)).parse(ctx, readBuffer)
	if err != nil {
		return nil, err
	}
	return v, nil
