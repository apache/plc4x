...
func KnxDatapointParse(theBytes []byte, datapointType KnxDatapointType) (api.PlcValue, error) {
	return KnxDatapointParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian)), datapointType) // TODO: get endianness from mspec
}

func KnxDatapointParseWithBuffer(readBuffer utils.ReadBuffer, datapointType KnxDatapointType) (api.PlcValue, error) {
