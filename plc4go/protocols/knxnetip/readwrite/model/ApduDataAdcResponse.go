...
func (m *_ApduDataAdcResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduData, dataLength uint8) (_apduDataAdcResponse ApduDataAdcResponse, err error) {
