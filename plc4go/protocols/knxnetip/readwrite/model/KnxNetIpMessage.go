...
func KnxNetIpMessageParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (KnxNetIpMessage, error) {
	...
	protocolVersion, err := readConstField[uint8](ctx, "protocolVersion", ReadUnsignedByte(readBuffer, 8), KnxNetIpMessage.PROTOCOLVERSION, codegen.WithByteOrder(binary.BigEndian))
	if err != nil {
