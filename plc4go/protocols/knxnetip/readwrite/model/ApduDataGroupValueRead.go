...
func (m *_ApduDataGroupValueRead) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduData, dataLength uint8) (_apduDataGroupValueRead ApduDataGroupValueRead, err error) {
