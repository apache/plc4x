...
func (m *_CEMIAdditionalInformation) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_cEMIAdditionalInformation CEMIAdditionalInformation, err error) {
