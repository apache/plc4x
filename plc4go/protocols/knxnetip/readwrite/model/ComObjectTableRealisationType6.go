...
func (m *_ComObjectTableRealisationType6) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ComObjectTable, firmwareType FirmwareType) (_comObjectTableRealisationType6 ComObjectTableRealisationType6, err error) {
