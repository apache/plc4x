...
func (m *_ApduDataExtDomainAddressSerialNumberRead) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtDomainAddressSerialNumberRead ApduDataExtDomainAddressSerialNumberRead, err error) {
