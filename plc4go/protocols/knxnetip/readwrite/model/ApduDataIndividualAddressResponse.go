...
func (m *_ApduDataIndividualAddressResponse) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.ApduDataContract.(*_ApduData).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_ApduDataIndividualAddressResponse) GetLengthInBytes(ctx context.Context) uint64 {
