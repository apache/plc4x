...
func (m *_LRawConBuilder) WithMandatoryFields() LRawConBuilder {
	return m
}

func (m *_LRawConBuilder) Build() (LRawCon, error) {
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._LRawCon.deepCopy(), nil
}

func (m *_LRawConBuilder) MustBuild() LRawCon {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_LRawConBuilder) DeepCopy() any {
	return m.CreateLRawConBuilder()
}

// CreateLRawConBuilder creates a LRawConBuilder
func (m *_LRawCon) CreateLRawConBuilder() LRawConBuilder {
	if m == nil {
		return NewLRawConBuilder()
	}
	return &_LRawConBuilder{_LRawCon: m.deepCopy()}
}
