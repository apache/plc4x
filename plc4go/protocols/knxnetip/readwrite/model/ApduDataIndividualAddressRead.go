...
func (m *_ApduDataIndividualAddressRead) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduData, dataLength uint8) (_apduDataIndividualAddressRead ApduDataIndividualAddressRead, err error) {
