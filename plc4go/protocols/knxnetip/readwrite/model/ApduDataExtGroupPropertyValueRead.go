...
func NewApduDataExtGroupPropertyValueRead() *_ApduDataExtGroupPropertyValueRead {
...
func (m *_ApduDataExtGroupPropertyValueRead) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.ApduDataExtContract.(*_ApduDataExt).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_ApduDataExtGroupPropertyValueRead) GetLengthInBytes(ctx context.Context) uint64 {
