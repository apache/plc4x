...
func (m *_ApduDataExtGroupPropertyValueRead) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtGroupPropertyValueRead ApduDataExtGroupPropertyValueRead, err error) {
