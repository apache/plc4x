...
func (m DeviceDescriptor) GetLengthInBits(ctx context.Context) uint64 {
	return 16
}

func (m DeviceDescriptor) GetLengthInBytes(ctx context.Context) uint64 {
...
func DeviceDescriptorParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (DeviceDescriptor, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint16("DeviceDescriptor", 16)
	if err != nil {
