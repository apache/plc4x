...
func (m *_GroupObjectDescriptorRealisationType2) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_GroupObjectDescriptorRealisationType2) GetLengthInBytes(ctx context.Context) uint64 {
