...
func (m *_GroupObjectDescriptorRealisationType2) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_groupObjectDescriptorRealisationType2 GroupObjectDescriptorRealisationType2, err error) {
