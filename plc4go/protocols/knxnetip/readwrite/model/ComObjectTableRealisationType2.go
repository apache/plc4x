...
func (m *_ComObjectTableRealisationType2) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ComObjectTable, firmwareType FirmwareType) (_comObjectTableRealisationType2 ComObjectTableRealisationType2, err error) {
