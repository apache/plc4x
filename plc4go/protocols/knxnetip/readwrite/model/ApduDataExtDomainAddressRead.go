...
func (m *_ApduDataExtDomainAddressRead) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtDomainAddressRead ApduDataExtDomainAddressRead, err error) {
