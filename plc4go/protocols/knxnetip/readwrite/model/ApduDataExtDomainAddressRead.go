...
func (m *_ApduDataExtDomainAddressRead) GetPlx4xTypeName() string {
	return "ApduDataExtDomainAddressRead"
}

func (m *_ApduDataExtDomainAddressRead) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.ApduDataExtContract.(*_ApduDataExt).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_ApduDataExtDomainAddressRead) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_ApduDataExtDomainAddressRead) deepCopy() *_ApduDataExtDomainAddressRead {
	...
	_ApduDataExtDomainAddressReadCopy.ApduDataExtContract.(*_ApduDataExt)._SubType = m
