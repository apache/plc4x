...
func (m *_GroupObjectDescriptorRealisationType1) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_GroupObjectDescriptorRealisationType1) GetLengthInBytes(ctx context.Context) uint64 {
