...
func (m *_GroupObjectDescriptorRealisationType1) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_groupObjectDescriptorRealisationType1 GroupObjectDescriptorRealisationType1, err error) {
