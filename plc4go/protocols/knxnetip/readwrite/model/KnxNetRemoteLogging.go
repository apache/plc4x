...
func (m *_KnxNetRemoteLogging) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ServiceId) (_knxNetRemoteLogging KnxNetRemoteLogging, err error) {
