...
func (m *_ApduDataExtLinkResponseBuilder) WithMandatoryFields() ApduDataExtLinkResponseBuilder {
	return m
}

func (m *_ApduDataExtLinkResponseBuilder) Build() (ApduDataExtLinkResponse, error) {
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._ApduDataExtLinkResponse.deepCopy(), nil
}

func (m *_ApduDataExtLinkResponseBuilder) MustBuild() ApduDataExtLinkResponse {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_ApduDataExtLinkResponseBuilder) DeepCopy() any {
	return m.CreateApduDataExtLinkResponseBuilder()
}

// CreateApduDataExtLinkResponseBuilder creates a ApduDataExtLinkResponseBuilder
func (m *_ApduDataExtLinkResponse) CreateApduDataExtLinkResponseBuilder() ApduDataExtLinkResponseBuilder {
	if m == nil {
		return NewApduDataExtLinkResponseBuilder()
	}
	return &_ApduDataExtLinkResponseBuilder{_ApduDataExtLinkResponse: m.deepCopy()}
}
