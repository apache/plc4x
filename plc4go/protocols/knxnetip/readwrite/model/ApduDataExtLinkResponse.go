...
func (m *_ApduDataExtLinkResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtLinkResponse ApduDataExtLinkResponse, err error) {
