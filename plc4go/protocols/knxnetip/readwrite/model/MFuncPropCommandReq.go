...
func (m *_MFuncPropCommandReqBuilder) WithMandatoryFields() MFuncPropCommandReqBuilder {
	return m
}

func (m *_MFuncPropCommandReqBuilder) Build() (MFuncPropCommandReq, error) {
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._MFuncPropCommandReq.deepCopy(), nil
}

func (m *_MFuncPropCommandReqBuilder) MustBuild() MFuncPropCommandReq {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_MFuncPropCommandReqBuilder) DeepCopy() any {
	return m.CreateMFuncPropCommandReqBuilder()
}

// CreateMFuncPropCommandReqBuilder creates a MFuncPropCommandReqBuilder
func (m *_MFuncPropCommandReq) CreateMFuncPropCommandReqBuilder() MFuncPropCommandReqBuilder {
	if m == nil {
		return NewMFuncPropCommandReqBuilder()
	}
	return &_MFuncPropCommandReqBuilder{_MFuncPropCommandReq: m.deepCopy()}
}
