...
func MFuncPropCommandReqParse(theBytes []byte, size uint16) (MFuncPropCommandReq, error) {
	return MFuncPropCommandReqParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian)), size) // TODO: get endianness from mspec
}
