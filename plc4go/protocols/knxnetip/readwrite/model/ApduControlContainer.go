...
func (m *_ApduControlContainerBuilder) WithControlApduBuilder(builderSupplier func(ApduControlBuilder) ApduControlBuilder) ApduControlContainerBuilder {
	builder := builderSupplier(m.ControlApdu.CreateApduControlBuilder())
	var err error
	m.ControlApdu, err = builder.Build()
	if err != nil {
		if m.err == nil {
			m.err = &utils.MultiError{MainError: errors.New("sub builder failed")}
		}
		m.err.Append(errors.Wrap(err, "ApduControlBuilder failed"))
	}
	return m
}
