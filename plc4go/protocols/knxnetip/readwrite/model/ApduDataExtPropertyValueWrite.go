...
func (m *_ApduDataExtPropertyValueWrite) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ApduDataExtPropertyValueWrite) GetLengthInBytes(ctx context.Context) uint64 {
