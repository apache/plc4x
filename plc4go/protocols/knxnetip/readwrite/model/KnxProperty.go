...
func KnxPropertyParse(theBytes []byte, propertyType KnxPropertyDataType, dataLengthInBytes uint8) (api.PlcValue, error) {
	return KnxPropertyParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian)), propertyType, dataLengthInBytes) // TODO: get endianness from mspec
}

func KnxPropertyParseWithBuffer(readBuffer utils.ReadBuffer, propertyType KnxPropertyDataType, dataLengthInBytes uint8) (api.PlcValue, error) {
