...
func (m *_KnxNetRemoteConfigurationAndDiagnosis) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ServiceId) (_knxNetRemoteConfigurationAndDiagnosis KnxNetRemoteConfigurationAndDiagnosis, err error) {
