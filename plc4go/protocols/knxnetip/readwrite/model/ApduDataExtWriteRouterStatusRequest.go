...
func (m *_ApduDataExtWriteRouterStatusRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtWriteRouterStatusRequest ApduDataExtWriteRouterStatusRequest, err error) {
