...
type ApduDataExtWriteRouterStatusRequest interface {
	...
	CreateApduDataExtWriteRouterStatusRequestBuilder() ApduDataExtWriteRouterStatusRequestBuilder
}
...
type ApduDataExtWriteRouterStatusRequestBuilder interface {
	utils.Copyable
	// WithMandatoryFields adds all mandatory fields (convenience for using multiple builder calls)
	WithMandatoryFields() ApduDataExtWriteRouterStatusRequestBuilder
	// Done is used to finish work on this child and return (or create one if none) to the parent builder
	Done() ApduDataExtBuilder
	// Build builds the ApduDataExtWriteRouterStatusRequest or returns an error if something is wrong
	Build() (ApduDataExtWriteRouterStatusRequest, error)
	// MustBuild does the same as Build but panics on error
	MustBuild() ApduDataExtWriteRouterStatusRequest
}
...
func NewApduDataExtWriteRouterStatusRequestBuilder() ApduDataExtWriteRouterStatusRequestBuilder {
	return &_ApduDataExtWriteRouterStatusRequestBuilder{_ApduDataExtWriteRouterStatusRequest: new(_ApduDataExtWriteRouterStatusRequest)}
}
...
func (b *_ApduDataExtWriteRouterStatusRequestBuilder) setParent(contract ApduDataExtContract) {
	...
	contract.(*_ApduDataExt)._SubType = b._ApduDataExtWriteRouterStatusRequest
}
...
func (m *_ApduDataExtWriteRouterStatusRequest) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.ApduDataExtContract.(*_ApduDataExt).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_ApduDataExtWriteRouterStatusRequest) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_ApduDataExtWriteRouterStatusRequest) deepCopy() *_ApduDataExtWriteRouterStatusRequest {
	...
	_ApduDataExtWriteRouterStatusRequestCopy.ApduDataExtContract.(*_ApduDataExt)._SubType = m
