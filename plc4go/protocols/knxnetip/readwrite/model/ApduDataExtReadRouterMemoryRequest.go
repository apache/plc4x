...
func (m *_ApduDataExtReadRouterMemoryRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtReadRouterMemoryRequest ApduDataExtReadRouterMemoryRequest, err error) {
