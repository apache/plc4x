...
func ApduDataGroupValueWriteParseWithBufferProducer(dataLength uint8) func(ctx context.Context, readBuffer utils.ReadBuffer) (ApduDataGroupValueWrite, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (ApduDataGroupValueWrite, error) {
		return ApduDataGroupValueWriteParseWithBuffer(ctx, readBuffer, dataLength)
	}
}
