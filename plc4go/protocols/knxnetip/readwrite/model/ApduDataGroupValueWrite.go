...
func (m *_ApduDataGroupValueWrite) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduData, dataLength uint8) (_apduDataGroupValueWrite ApduDataGroupValueWrite, err error) {
