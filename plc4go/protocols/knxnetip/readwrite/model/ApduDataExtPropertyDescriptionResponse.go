...
func (m *_ApduDataExtPropertyDescriptionResponse) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ApduDataExtPropertyDescriptionResponse) GetLengthInBytes(ctx context.Context) uint64 {
