...
func (m *_ProjectInstallationIdentifier) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_projectInstallationIdentifier ProjectInstallationIdentifier, err error) {
