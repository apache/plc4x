...
func (m *_ApduDataMemoryResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduData, dataLength uint8) (_apduDataMemoryResponse ApduDataMemoryResponse, err error) {
