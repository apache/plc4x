...
func (m *_ApduDataExtReadRoutingTableResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtReadRoutingTableResponse ApduDataExtReadRoutingTableResponse, err error) {
