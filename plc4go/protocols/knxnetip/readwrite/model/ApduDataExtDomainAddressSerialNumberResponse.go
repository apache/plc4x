...
func (m *_ApduDataExtDomainAddressSerialNumberResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtDomainAddressSerialNumberResponse ApduDataExtDomainAddressSerialNumberResponse, err error) {
