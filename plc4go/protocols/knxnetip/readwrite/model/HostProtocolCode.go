...
func (m HostProtocolCode) GetLengthInBits(ctx context.Context) uint64 {
	return 8
}

func (m HostProtocolCode) GetLengthInBytes(ctx context.Context) uint64 {
...
func HostProtocolCodeParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (HostProtocolCode, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint8("HostProtocolCode", 8)
	if err != nil {
...
func (e HostProtocolCode) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint8("HostProtocolCode", 8, uint8(uint8(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}
