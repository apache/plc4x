...
func (m *_TDataIndividualInd) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_CEMI, size uint16) (_tDataIndividualInd TDataIndividualInd, err error) {
