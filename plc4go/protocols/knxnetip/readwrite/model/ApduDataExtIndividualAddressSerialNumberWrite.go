...
func NewApduDataExtIndividualAddressSerialNumberWrite() *_ApduDataExtIndividualAddressSerialNumberWrite {
...
func (m *_ApduDataExtIndividualAddressSerialNumberWrite) GetPlx4xTypeName() string {
