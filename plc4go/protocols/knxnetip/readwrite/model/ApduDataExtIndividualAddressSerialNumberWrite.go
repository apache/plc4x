...
func (m *_ApduDataExtIndividualAddressSerialNumberWrite) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtIndividualAddressSerialNumberWrite ApduDataExtIndividualAddressSerialNumberWrite, err error) {
