...
func (m *_ApduDataExtIndividualAddressSerialNumberWriteBuilder) WithMandatoryFields() ApduDataExtIndividualAddressSerialNumberWriteBuilder {
	return m
}

func (m *_ApduDataExtIndividualAddressSerialNumberWriteBuilder) Build() (ApduDataExtIndividualAddressSerialNumberWrite, error) {
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._ApduDataExtIndividualAddressSerialNumberWrite.deepCopy(), nil
}

func (m *_ApduDataExtIndividualAddressSerialNumberWriteBuilder) MustBuild() ApduDataExtIndividualAddressSerialNumberWrite {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_ApduDataExtIndividualAddressSerialNumberWriteBuilder) DeepCopy() any {
	return m.CreateApduDataExtIndividualAddressSerialNumberWriteBuilder()
}
...
func (m *_ApduDataExtIndividualAddressSerialNumberWrite) CreateApduDataExtIndividualAddressSerialNumberWriteBuilder() ApduDataExtIndividualAddressSerialNumberWriteBuilder {
	if m == nil {
		return NewApduDataExtIndividualAddressSerialNumberWriteBuilder()
	}
	return &_ApduDataExtIndividualAddressSerialNumberWriteBuilder{_ApduDataExtIndividualAddressSerialNumberWrite: m.deepCopy()}
}
