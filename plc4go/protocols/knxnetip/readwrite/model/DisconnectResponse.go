...
func (m *_DisconnectResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_KnxNetIpMessage) (_disconnectResponse DisconnectResponse, err error) {
