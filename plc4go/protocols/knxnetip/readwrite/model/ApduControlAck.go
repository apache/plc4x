...
// ApduControlAck is the data-structure of this message
type ApduControlAck struct {
	*ApduControl
}

// IApduControlAck is the corresponding interface of ApduControlAck
...
func (m *ApduControlAck) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *ApduControlAck) GetLengthInBitsConditional(lastItem bool) uint16 {
	lengthInBits := uint16(m.GetParentLengthInBits())

	return lengthInBits
}

func (m *ApduControlAck) GetLengthInBytes() uint16 {
