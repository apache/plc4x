...
func (m *_ComObjectTableRealisationType1) GetPlx4xTypeName() string {
	return "ComObjectTableRealisationType1"
}

func (m *_ComObjectTableRealisationType1) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ComObjectTableRealisationType1) GetLengthInBytes(ctx context.Context) uint64 {
