...
func ApduDataExtParseWithBuffer[T ApduDataExt](ctx context.Context, readBuffer utils.ReadBuffer, length uint8) (T, error) {
	v, err := (&_ApduDataExt{}).parse(ctx, readBuffer, length)
	if err != nil {
		var zero T
		return zero, err
	}
...
func (m *_ApduDataExt) parse(ctx context.Context, readBuffer utils.ReadBuffer, length uint8) (_apduDataExt ApduDataExt, err error) {
