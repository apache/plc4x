...
func (m *_MPropInfoIndBuilder) WithMandatoryFields() MPropInfoIndBuilder {
	return m
}

func (m *_MPropInfoIndBuilder) Build() (MPropInfoInd, error) {
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._MPropInfoInd.deepCopy(), nil
}

func (m *_MPropInfoIndBuilder) MustBuild() MPropInfoInd {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_MPropInfoIndBuilder) DeepCopy() any {
	return m.CreateMPropInfoIndBuilder()
}

// CreateMPropInfoIndBuilder creates a MPropInfoIndBuilder
func (m *_MPropInfoInd) CreateMPropInfoIndBuilder() MPropInfoIndBuilder {
	if m == nil {
		return NewMPropInfoIndBuilder()
	}
	return &_MPropInfoIndBuilder{_MPropInfoInd: m.deepCopy()}
}
