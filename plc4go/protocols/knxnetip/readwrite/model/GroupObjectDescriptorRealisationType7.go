...
func (m *_GroupObjectDescriptorRealisationType7) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_groupObjectDescriptorRealisationType7 GroupObjectDescriptorRealisationType7, err error) {
