...
func (m *_ApduDataExtAuthorizeRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtAuthorizeRequest ApduDataExtAuthorizeRequest, err error) {
