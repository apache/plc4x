...
func (m *_ConnectionRequestInformationDeviceManagement) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ConnectionRequestInformation) (_connectionRequestInformationDeviceManagement ConnectionRequestInformationDeviceManagement, err error) {
