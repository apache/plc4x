...
func (m *_ApduDataExtDomainAddressResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtDomainAddressResponse ApduDataExtDomainAddressResponse, err error) {
