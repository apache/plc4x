...
func (m *_ConnectionResponseDataBlockDeviceManagement) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ConnectionResponseDataBlock) (_connectionResponseDataBlockDeviceManagement ConnectionResponseDataBlockDeviceManagement, err error) {
