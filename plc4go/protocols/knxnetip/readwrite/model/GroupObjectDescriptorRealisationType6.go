...
func (m *_GroupObjectDescriptorRealisationType6) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_groupObjectDescriptorRealisationType6 GroupObjectDescriptorRealisationType6, err error) {
