...
func (m *_ApduDataExtReadRouterStatusResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtReadRouterStatusResponse ApduDataExtReadRouterStatusResponse, err error) {
