...
func NewApduDataExtReadRouterStatusResponse() *_ApduDataExtReadRouterStatusResponse {
...
func (m *_ApduDataExtReadRouterStatusResponse) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.ApduDataExtContract.(*_ApduDataExt).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_ApduDataExtReadRouterStatusResponse) GetLengthInBytes(ctx context.Context) uint64 {
