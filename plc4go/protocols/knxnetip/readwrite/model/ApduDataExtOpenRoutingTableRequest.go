...
func (m *_ApduDataExtOpenRoutingTableRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtOpenRoutingTableRequest ApduDataExtOpenRoutingTableRequest, err error) {
