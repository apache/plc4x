...
func (m *_ApduDataExtPropertyDescriptionRead) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtPropertyDescriptionRead ApduDataExtPropertyDescriptionRead, err error) {
