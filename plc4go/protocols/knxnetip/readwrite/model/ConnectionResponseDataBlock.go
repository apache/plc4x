...
func (m *_ConnectionResponseDataBlock) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_connectionResponseDataBlock ConnectionResponseDataBlock, err error) {
