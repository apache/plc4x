...
func (m *_ApduDataAdcRead) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduData, dataLength uint8) (_apduDataAdcRead ApduDataAdcRead, err error) {
