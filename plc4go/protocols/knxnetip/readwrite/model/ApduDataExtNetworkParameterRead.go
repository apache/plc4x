...
func (m *_ApduDataExtNetworkParameterRead) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtNetworkParameterRead ApduDataExtNetworkParameterRead, err error) {
