...
func NewApduDataExtNetworkParameterRead() *_ApduDataExtNetworkParameterRead {
...
func (m *_ApduDataExtNetworkParameterRead) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.ApduDataExtContract.(*_ApduDataExt).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_ApduDataExtNetworkParameterRead) GetLengthInBytes(ctx context.Context) uint64 {
