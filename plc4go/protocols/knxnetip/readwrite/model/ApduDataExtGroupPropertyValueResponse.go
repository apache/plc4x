...
func (m *_ApduDataExtGroupPropertyValueResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtGroupPropertyValueResponse ApduDataExtGroupPropertyValueResponse, err error) {
