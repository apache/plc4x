...
func (m *_ApduDataMemoryWrite) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduData, dataLength uint8) (_apduDataMemoryWrite ApduDataMemoryWrite, err error) {
