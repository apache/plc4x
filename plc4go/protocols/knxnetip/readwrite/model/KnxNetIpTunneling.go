...
func KnxNetIpTunnelingParseWithBufferProducer() func(ctx context.Context, readBuffer utils.ReadBuffer) (KnxNetIpTunneling, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (KnxNetIpTunneling, error) {
		return KnxNetIpTunnelingParseWithBuffer(ctx, readBuffer)
	}
}
