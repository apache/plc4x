...
func (m *_ApduDataExtPropertyValueRead) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtPropertyValueRead ApduDataExtPropertyValueRead, err error) {
