...
// LPollDataReq is the data-structure of this message
...
// ILPollDataReq is the corresponding interface of LPollDataReq
...
func NewLPollDataReq(size uint16) *LPollDataReq {
	_result := &LPollDataReq{
		CEMI: NewCEMI(size),
	}
