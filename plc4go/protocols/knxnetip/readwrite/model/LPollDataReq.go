...
func LPollDataReqParse(theBytes []byte, size uint16) (LPollDataReq, error) {
	return LPollDataReqParseWithBuffer(utils.NewReadBufferByteBased(theBytes), size)
}
...
func (m *_LPollDataReq) SerializeWithWriteBuffer(writeBuffer utils.WriteBuffer) error {
