...
// HPAIDiscoveryEndpoint is the data-structure of this message
...
// IHPAIDiscoveryEndpoint is the corresponding interface of HPAIDiscoveryEndpoint
...
func (m *HPAIDiscoveryEndpoint) Serialize(writeBuffer utils.WriteBuffer) error {
	...
	_hostProtocolCodeErr := writeBuffer.WriteSerializable(m.HostProtocolCode)
