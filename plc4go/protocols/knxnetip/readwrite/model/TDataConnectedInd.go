...
func (m *_TDataConnectedInd) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_CEMI, size uint16) (_tDataConnectedInd TDataConnectedInd, err error) {
