...
func (m *_ApduDataExtWriteRouterMemoryRequestBuilder) WithMandatoryFields() ApduDataExtWriteRouterMemoryRequestBuilder {
	return m
}

func (m *_ApduDataExtWriteRouterMemoryRequestBuilder) Build() (ApduDataExtWriteRouterMemoryRequest, error) {
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._ApduDataExtWriteRouterMemoryRequest.deepCopy(), nil
}

func (m *_ApduDataExtWriteRouterMemoryRequestBuilder) MustBuild() ApduDataExtWriteRouterMemoryRequest {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_ApduDataExtWriteRouterMemoryRequestBuilder) DeepCopy() any {
	return m.CreateApduDataExtWriteRouterMemoryRequestBuilder()
}

// CreateApduDataExtWriteRouterMemoryRequestBuilder creates a ApduDataExtWriteRouterMemoryRequestBuilder
func (m *_ApduDataExtWriteRouterMemoryRequest) CreateApduDataExtWriteRouterMemoryRequestBuilder() ApduDataExtWriteRouterMemoryRequestBuilder {
	if m == nil {
		return NewApduDataExtWriteRouterMemoryRequestBuilder()
	}
	return &_ApduDataExtWriteRouterMemoryRequestBuilder{_ApduDataExtWriteRouterMemoryRequest: m.deepCopy()}
}
