...
func (m *_ApduDataExtWriteRouterMemoryRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtWriteRouterMemoryRequest ApduDataExtWriteRouterMemoryRequest, err error) {
