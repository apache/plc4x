...
func (m *_ApduDataGroupValueResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduData, dataLength uint8) (_apduDataGroupValueResponse ApduDataGroupValueResponse, err error) {
