...
func (m *_ApduDataExtGroupPropertyValueInfoReport) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.ApduDataExtContract.(*_ApduDataExt).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_ApduDataExtGroupPropertyValueInfoReport) GetLengthInBytes(ctx context.Context) uint64 {
