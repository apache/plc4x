...
func (m *_ApduDataExtPropertyValueResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtPropertyValueResponse ApduDataExtPropertyValueResponse, err error) {
