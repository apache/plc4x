...
func (m *_ApduDataExtPropertyValueResponse) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ApduDataExtPropertyValueResponse) GetLengthInBytes(ctx context.Context) uint64 {
