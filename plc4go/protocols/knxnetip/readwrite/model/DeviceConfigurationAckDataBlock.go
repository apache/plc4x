...
func (m *_DeviceConfigurationAckDataBlock) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_deviceConfigurationAckDataBlock DeviceConfigurationAckDataBlock, err error) {
