...
func (m *_DeviceConfigurationAckDataBlock) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_DeviceConfigurationAckDataBlock) GetLengthInBytes(ctx context.Context) uint64 {
