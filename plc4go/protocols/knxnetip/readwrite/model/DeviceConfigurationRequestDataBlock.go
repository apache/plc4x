...
func (m *_DeviceConfigurationRequestDataBlock) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_deviceConfigurationRequestDataBlock DeviceConfigurationRequestDataBlock, err error) {
