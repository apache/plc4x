...
func NewApduDataExtReadRouterStatusRequest() *_ApduDataExtReadRouterStatusRequest {
...
func (m *_ApduDataExtReadRouterStatusRequest) GetPlx4xTypeName() string {
	return "ApduDataExtReadRouterStatusRequest"
}

func (m *_ApduDataExtReadRouterStatusRequest) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.ApduDataExtContract.(*_ApduDataExt).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_ApduDataExtReadRouterStatusRequest) GetLengthInBytes(ctx context.Context) uint64 {
