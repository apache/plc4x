...
func (m *_ApduDataExtReadRouterStatusRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtReadRouterStatusRequest ApduDataExtReadRouterStatusRequest, err error) {
