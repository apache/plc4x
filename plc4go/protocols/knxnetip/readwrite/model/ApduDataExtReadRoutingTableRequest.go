...
func (m *_ApduDataExtReadRoutingTableRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtReadRoutingTableRequest ApduDataExtReadRoutingTableRequest, err error) {
