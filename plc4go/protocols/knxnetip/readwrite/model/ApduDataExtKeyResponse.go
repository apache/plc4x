...
func (m *_ApduDataExtKeyResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtKeyResponse ApduDataExtKeyResponse, err error) {
