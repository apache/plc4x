...
func (m *_KnxGroupAddressFreeLevel) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_KnxGroupAddress, numLevels uint8) (_knxGroupAddressFreeLevel KnxGroupAddressFreeLevel, err error) {
