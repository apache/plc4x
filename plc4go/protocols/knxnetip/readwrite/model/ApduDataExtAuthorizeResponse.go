...
func (m *_ApduDataExtAuthorizeResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtAuthorizeResponse ApduDataExtAuthorizeResponse, err error) {
