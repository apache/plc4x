...
func (m *_ApduDataIndividualAddressWrite) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduData, dataLength uint8) (_apduDataIndividualAddressWrite ApduDataIndividualAddressWrite, err error) {
