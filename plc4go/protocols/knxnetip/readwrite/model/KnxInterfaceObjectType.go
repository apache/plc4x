...
func (m KnxInterfaceObjectType) GetLengthInBits(ctx context.Context) uint64 {
	return 16
}

func (m KnxInterfaceObjectType) GetLengthInBytes(ctx context.Context) uint64 {
...
func KnxInterfaceObjectTypeParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (KnxInterfaceObjectType, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint16("KnxInterfaceObjectType", 16)
	if err != nil {
