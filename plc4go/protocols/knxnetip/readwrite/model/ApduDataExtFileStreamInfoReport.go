...
func (m *_ApduDataExtFileStreamInfoReport) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtFileStreamInfoReport ApduDataExtFileStreamInfoReport, err error) {
