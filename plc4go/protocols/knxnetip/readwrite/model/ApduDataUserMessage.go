...
func (m *_ApduDataUserMessage) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduData, dataLength uint8) (_apduDataUserMessage ApduDataUserMessage, err error) {
