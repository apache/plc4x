...
func (m *_ApduDataExtNetworkParameterWrite) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtNetworkParameterWrite ApduDataExtNetworkParameterWrite, err error) {
