...
func (m *_KnxNetIpRouting) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_KnxNetIpRouting) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_KnxNetIpRouting) deepCopy() *_KnxNetIpRouting {
	...
	_KnxNetIpRoutingCopy.ServiceIdContract.(*_ServiceId)._SubType = m
