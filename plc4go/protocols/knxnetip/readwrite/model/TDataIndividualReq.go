...
func (m *_TDataIndividualReq) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_CEMI, size uint16) (_tDataIndividualReq TDataIndividualReq, err error) {
