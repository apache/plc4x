...
func (m *_ApduDataExtNetworkParameterResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ApduDataExt, length uint8) (_apduDataExtNetworkParameterResponse ApduDataExtNetworkParameterResponse, err error) {
