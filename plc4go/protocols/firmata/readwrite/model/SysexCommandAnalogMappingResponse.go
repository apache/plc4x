...
func (m *_SysexCommandAnalogMappingResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SysexCommand, response bool) (_sysexCommandAnalogMappingResponse SysexCommandAnalogMappingResponse, err error) {
