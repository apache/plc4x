...
func (m *_SysexCommandAnalogMappingResponse) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.SysexCommandContract.(*_SysexCommand).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_SysexCommandAnalogMappingResponse) GetLengthInBytes(ctx context.Context) uint64 {
