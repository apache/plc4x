...
func SysexCommandPinStateQueryParseWithBufferProducer(response bool) func(ctx context.Context, readBuffer utils.ReadBuffer) (SysexCommandPinStateQuery, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (SysexCommandPinStateQuery, error) {
		return SysexCommandPinStateQueryParseWithBuffer(ctx, readBuffer, response)
	}
}
