...
func (m *_SysexCommandAnalogMappingQueryResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SysexCommand, response bool) (_sysexCommandAnalogMappingQueryResponse SysexCommandAnalogMappingQueryResponse, err error) {
