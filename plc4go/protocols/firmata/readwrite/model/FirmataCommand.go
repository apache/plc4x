...
func FirmataCommandParseWithBuffer[T FirmataCommand](ctx context.Context, readBuffer utils.ReadBuffer, response bool) (T, error) {
	v, err := (&_FirmataCommand{}).parse(ctx, readBuffer, response)
	if err != nil {
		var zero T
		return zero, err
	}
...
func (m *_FirmataCommand) parse(ctx context.Context, readBuffer utils.ReadBuffer, response bool) (_firmataCommand FirmataCommand, err error) {
