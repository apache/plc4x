...
func (m *_SysexCommandStringData) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SysexCommand, response bool) (_sysexCommandStringData SysexCommandStringData, err error) {
