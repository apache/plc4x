...
func (m *_SysexCommandReportFirmwareRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SysexCommand, response bool) (_sysexCommandReportFirmwareRequest SysexCommandReportFirmwareRequest, err error) {
