...
func (m *_FirmataCommandSetDigitalPinValue) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_FirmataCommand, response bool) (_firmataCommandSetDigitalPinValue FirmataCommandSetDigitalPinValue, err error) {
