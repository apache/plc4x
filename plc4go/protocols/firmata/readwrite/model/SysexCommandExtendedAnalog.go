...
func (m *_SysexCommandExtendedAnalog) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SysexCommand, response bool) (_sysexCommandExtendedAnalog SysexCommandExtendedAnalog, err error) {
