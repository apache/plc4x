...
func (m *_FirmataCommandSetPinMode) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_FirmataCommand, response bool) (_firmataCommandSetPinMode FirmataCommandSetPinMode, err error) {
