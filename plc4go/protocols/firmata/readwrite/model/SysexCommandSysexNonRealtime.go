...
func (m *_SysexCommandSysexNonRealtime) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.SysexCommandContract.(*_SysexCommand).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_SysexCommandSysexNonRealtime) GetLengthInBytes(ctx context.Context) uint64 {
