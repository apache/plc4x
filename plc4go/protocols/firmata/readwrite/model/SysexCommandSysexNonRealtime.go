...
func (m *_SysexCommandSysexNonRealtime) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SysexCommand, response bool) (_sysexCommandSysexNonRealtime SysexCommandSysexNonRealtime, err error) {
