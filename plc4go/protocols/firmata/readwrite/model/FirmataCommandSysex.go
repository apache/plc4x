...
func (m *_FirmataCommandSysexBuilder) WithCommandBuilder(builderSupplier func(SysexCommandBuilder) SysexCommandBuilder) FirmataCommandSysexBuilder {
	builder := builderSupplier(m.Command.CreateSysexCommandBuilder())
	var err error
	...
	if err != nil {
		...
		m.err.Append(errors.Wrap(err, "SysexCommandBuilder failed"))
	}
	return m
}
