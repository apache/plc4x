...
func (m *_SysexCommandCapabilityQuery) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SysexCommand, response bool) (_sysexCommandCapabilityQuery SysexCommandCapabilityQuery, err error) {
