...
func (m *_FirmataMessageDigitalIO) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_FirmataMessage, response bool) (_firmataMessageDigitalIO FirmataMessageDigitalIO, err error) {
