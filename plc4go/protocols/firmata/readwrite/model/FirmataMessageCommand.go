...
func (m *_FirmataMessageCommand) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_FirmataMessage, response bool) (_firmataMessageCommand FirmataMessageCommand, err error) {
