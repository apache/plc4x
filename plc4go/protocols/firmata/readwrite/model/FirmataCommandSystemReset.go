...
func (m *_FirmataCommandSystemReset) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_FirmataCommand, response bool) (_firmataCommandSystemReset FirmataCommandSystemReset, err error) {
