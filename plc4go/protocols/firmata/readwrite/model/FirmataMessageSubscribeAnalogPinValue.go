...
func (m *_FirmataMessageSubscribeAnalogPinValue) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_FirmataMessage, response bool) (_firmataMessageSubscribeAnalogPinValue FirmataMessageSubscribeAnalogPinValue, err error) {
