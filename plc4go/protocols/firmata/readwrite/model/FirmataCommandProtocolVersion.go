...
func (m *_FirmataCommandProtocolVersionBuilder) WithMandatoryFields(majorVersion uint8, minorVersion uint8) FirmataCommandProtocolVersionBuilder {
	return m.WithMajorVersion(majorVersion).WithMinorVersion(minorVersion)
}

func (m *_FirmataCommandProtocolVersionBuilder) WithMajorVersion(majorVersion uint8) FirmataCommandProtocolVersionBuilder {
	m.MajorVersion = majorVersion
	return m
}

func (m *_FirmataCommandProtocolVersionBuilder) WithMinorVersion(minorVersion uint8) FirmataCommandProtocolVersionBuilder {
	m.MinorVersion = minorVersion
	return m
}

func (m *_FirmataCommandProtocolVersionBuilder) Build() (FirmataCommandProtocolVersion, error) {
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._FirmataCommandProtocolVersion.deepCopy(), nil
}

func (m *_FirmataCommandProtocolVersionBuilder) MustBuild() FirmataCommandProtocolVersion {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_FirmataCommandProtocolVersionBuilder) DeepCopy() any {
	return m.CreateFirmataCommandProtocolVersionBuilder()
}

// CreateFirmataCommandProtocolVersionBuilder creates a FirmataCommandProtocolVersionBuilder
func (m *_FirmataCommandProtocolVersion) CreateFirmataCommandProtocolVersionBuilder() FirmataCommandProtocolVersionBuilder {
	if m == nil {
		return NewFirmataCommandProtocolVersionBuilder()
	}
	return &_FirmataCommandProtocolVersionBuilder{_FirmataCommandProtocolVersion: m.deepCopy()}
}
