...
func (m *_FirmataCommandProtocolVersion) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_FirmataCommand, response bool) (_firmataCommandProtocolVersion FirmataCommandProtocolVersion, err error) {
