...
func (m *_FirmataMessageSubscribeDigitalPinValue) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_FirmataMessage, response bool) (_firmataMessageSubscribeDigitalPinValue FirmataMessageSubscribeDigitalPinValue, err error) {
