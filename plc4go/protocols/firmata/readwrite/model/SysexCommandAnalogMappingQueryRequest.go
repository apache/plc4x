...
func (m *_SysexCommandAnalogMappingQueryRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SysexCommand, response bool) (_sysexCommandAnalogMappingQueryRequest SysexCommandAnalogMappingQueryRequest, err error) {
