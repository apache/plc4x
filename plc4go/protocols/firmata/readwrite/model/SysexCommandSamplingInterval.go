...
func (m *_SysexCommandSamplingInterval) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SysexCommand, response bool) (_sysexCommandSamplingInterval SysexCommandSamplingInterval, err error) {
