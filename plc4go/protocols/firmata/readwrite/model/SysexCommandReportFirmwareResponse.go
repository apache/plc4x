...
func (m *_SysexCommandReportFirmwareResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SysexCommand, response bool) (_sysexCommandReportFirmwareResponse SysexCommandReportFirmwareResponse, err error) {
