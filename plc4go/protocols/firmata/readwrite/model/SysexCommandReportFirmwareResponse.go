...
if err := WriteManualArrayField[byte]( ctx, "fileName", m.GetFileName(), func(ctx context.Context, writeBuffer utils.WriteBuffer,m byte) error { return SerializeSysexString(ctx, writeBuffer, m) }, writeBuffer); err != nil{
