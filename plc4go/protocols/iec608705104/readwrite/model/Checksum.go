...
type ChecksumBuilder interface {
	...
	WithMandatoryFields() ChecksumBuilder
...
func (b *_ChecksumBuilder) WithMandatoryFields() ChecksumBuilder {
	return b
}
...
func ChecksumParse(ctx context.Context, theBytes []byte) (Checksum, error) {
	return ChecksumParseWithBuffer(ctx, utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.LittleEndian)))
}
