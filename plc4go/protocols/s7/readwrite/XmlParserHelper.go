...
func (m S7XmlParserHelper) Parse(typeName string, xmlString string, parserArguments ...string) (any, error) {
	...
	case "S7PayloadUserDataItem":
		...
		return model.S7PayloadUserDataItemParseWithBuffer(context.Background(), utils.NewXmlReadBuffer(strings.NewReader(xmlString)), cpuFunctionGroup, cpuFunctionType, cpuSubfunction)
	...
	case "CycServiceItemType":
		return model.CycServiceItemTypeParseWithBuffer(context.Background(), utils.NewXmlReadBuffer(strings.NewReader(xmlString)))
	...
	case "AssociatedQueryValueType":
		return model.AssociatedQueryValueTypeParseWithBuffer(context.Background(), utils.NewXmlReadBuffer(strings.NewReader(xmlString)))
	case "COTPPacket":
	...
	case "Alarm8MessageQueryType":
		return model.Alarm8MessageQueryTypeParseWithBuffer(context.Background(), utils.NewXmlReadBuffer(strings.NewReader(xmlString)))
