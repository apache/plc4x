...
func (m *_S7ParameterUserData) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_S7Parameter, messageType uint8) (_s7ParameterUserData S7ParameterUserData, err error) {
