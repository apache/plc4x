...
func (m *_S7PayloadUserDataItemCpuFunctionMsgSubscription) InitializeParent(parent S7PayloadUserDataItem , returnCode DataTransportErrorCode , transportSize DataTransportSize ) {	m.ReturnCode = returnCode
