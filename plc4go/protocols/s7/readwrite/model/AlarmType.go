...
func (m AlarmType) GetLengthInBits(ctx context.Context) uint64 {
	return 8
}

func (m AlarmType) GetLengthInBytes(ctx context.Context) uint64 {
...
func AlarmTypeParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (AlarmType, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint8("AlarmType", 8)
	if err != nil {
...
func (e AlarmType) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint8("AlarmType", 8, uint8(uint8(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}
