...
func (m *_COTPParameterTpduSize) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_COTPParameter, rest uint8) (_cOTPParameterTpduSize COTPParameterTpduSize, err error) {
