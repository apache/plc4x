...
func (m *_S7ParameterReadVarResponseBuilder) WithMandatoryFields(numItems uint8) S7ParameterReadVarResponseBuilder {
	return m.WithNumItems(numItems)
}

func (m *_S7ParameterReadVarResponseBuilder) WithNumItems(numItems uint8) S7ParameterReadVarResponseBuilder {
	m.NumItems = numItems
	return m
}

func (m *_S7ParameterReadVarResponseBuilder) Build() (S7ParameterReadVarResponse, error) {
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._S7ParameterReadVarResponse.deepCopy(), nil
}

func (m *_S7ParameterReadVarResponseBuilder) MustBuild() S7ParameterReadVarResponse {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_S7ParameterReadVarResponseBuilder) DeepCopy() any {
	return m.CreateS7ParameterReadVarResponseBuilder()
}

// CreateS7ParameterReadVarResponseBuilder creates a S7ParameterReadVarResponseBuilder
func (m *_S7ParameterReadVarResponse) CreateS7ParameterReadVarResponseBuilder() S7ParameterReadVarResponseBuilder {
	if m == nil {
		return NewS7ParameterReadVarResponseBuilder()
	}
	return &_S7ParameterReadVarResponseBuilder{_S7ParameterReadVarResponse: m.deepCopy()}
}
