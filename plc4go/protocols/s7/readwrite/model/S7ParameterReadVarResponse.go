...
// S7ParameterReadVarResponse is the data-structure of this message
type S7ParameterReadVarResponse struct {
	*S7Parameter
	NumItems uint8
}

// IS7ParameterReadVarResponse is the corresponding interface of S7ParameterReadVarResponse
