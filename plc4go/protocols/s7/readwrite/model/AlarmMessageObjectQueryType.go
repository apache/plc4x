...
func (m *_AlarmMessageObjectQueryType) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_alarmMessageObjectQueryType AlarmMessageObjectQueryType, err error) {
