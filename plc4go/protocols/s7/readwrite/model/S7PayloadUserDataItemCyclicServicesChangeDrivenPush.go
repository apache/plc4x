...
func (m *_S7PayloadUserDataItemCyclicServicesChangeDrivenPush) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_S7PayloadUserDataItemCyclicServicesChangeDrivenPush) GetLengthInBytes(ctx context.Context) uint64 {
