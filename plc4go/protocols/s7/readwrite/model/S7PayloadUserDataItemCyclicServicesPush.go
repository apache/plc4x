...
func (m *_S7PayloadUserDataItemCyclicServicesPush) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_S7PayloadUserDataItemCyclicServicesPush) GetLengthInBytes(ctx context.Context) uint64 {
