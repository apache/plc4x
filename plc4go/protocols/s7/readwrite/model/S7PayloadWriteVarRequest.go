...
func (m *_S7PayloadWriteVarRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_S7Payload, messageType uint8, parameter S7Parameter) (_s7PayloadWriteVarRequest S7PayloadWriteVarRequest, err error) {
