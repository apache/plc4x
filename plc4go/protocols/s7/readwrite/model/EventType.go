...
func EventTypeParse(ctx context.Context, theBytes []byte) (EventType, error) {
	return EventTypeParseWithBuffer(ctx, utils.NewReadBufferByteBased(theBytes))
}

func EventTypeParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (EventType, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint8("EventType", 8)
	if err != nil {
...
func (e EventType) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint8("EventType", 8, uint8(uint8(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}
