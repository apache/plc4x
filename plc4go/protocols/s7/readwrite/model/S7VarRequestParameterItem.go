...
func (m *_S7VarRequestParameterItem) getLengthInBits(ctx context.Context) uint64 {
...
func (m *_S7VarRequestParameterItem) GetLengthInBytes(ctx context.Context) uint64 {
