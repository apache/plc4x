...
func (m *_S7VarRequestParameterItem) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_s7VarRequestParameterItem S7VarRequestParameterItem, err error) {
