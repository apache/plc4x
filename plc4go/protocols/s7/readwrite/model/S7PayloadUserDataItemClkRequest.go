...
func (m *_S7PayloadUserDataItemClkRequest) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.S7PayloadUserDataItemContract.(*_S7PayloadUserDataItem).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_S7PayloadUserDataItemClkRequest) GetLengthInBytes(ctx context.Context) uint64 {
