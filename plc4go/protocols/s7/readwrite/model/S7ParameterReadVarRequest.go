...
func (m *_S7ParameterReadVarRequest) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_S7ParameterReadVarRequest) GetLengthInBytes(ctx context.Context) uint64 {
