...
func (m *_AlarmMessageObjectPushType) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_alarmMessageObjectPushType AlarmMessageObjectPushType, err error) {
