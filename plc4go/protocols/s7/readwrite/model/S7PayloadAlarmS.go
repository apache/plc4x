...
func S7PayloadAlarmSParseWithBufferProducer(cpuFunctionGroup uint8, cpuFunctionType uint8, cpuSubfunction uint8) func(ctx context.Context, readBuffer utils.ReadBuffer) (S7PayloadAlarmS, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (S7PayloadAlarmS, error) {
		return S7PayloadAlarmSParseWithBuffer(ctx, readBuffer, cpuFunctionGroup, cpuFunctionType, cpuSubfunction)
	}
}
