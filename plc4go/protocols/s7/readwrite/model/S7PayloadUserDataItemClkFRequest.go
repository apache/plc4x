...
func (m *_S7PayloadUserDataItemClkFRequest) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.S7PayloadUserDataItemContract.(*_S7PayloadUserDataItem).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_S7PayloadUserDataItemClkFRequest) GetLengthInBytes(ctx context.Context) uint64 {
