...
func (m *_S7ParameterWriteVarResponse) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_S7ParameterWriteVarResponse) GetLengthInBytes(ctx context.Context) uint64 {
