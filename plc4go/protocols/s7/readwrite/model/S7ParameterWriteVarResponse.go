...
// S7ParameterWriteVarResponse is the data-structure of this message
type S7ParameterWriteVarResponse struct {
	*S7Parameter
	NumItems uint8
}

// IS7ParameterWriteVarResponse is the corresponding interface of S7ParameterWriteVarResponse
