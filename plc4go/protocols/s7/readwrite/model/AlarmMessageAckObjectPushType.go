...
func (m *_AlarmMessageAckObjectPushType) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_alarmMessageAckObjectPushType AlarmMessageAckObjectPushType, err error) {
