...
func (m *_COTPPacketConnectionRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_COTPPacket, cotpLen uint16) (_cOTPPacketConnectionRequest COTPPacketConnectionRequest, err error) {
