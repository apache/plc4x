...
func (m *_TPKTPacketBuilder) WithPayloadBuilder(builderSupplier func(COTPPacketBuilder) COTPPacketBuilder) TPKTPacketBuilder {
	builder := builderSupplier(m.Payload.CreateCOTPPacketBuilder())
	var err error
	...
	if err != nil {
		...
		m.err.Append(errors.Wrap(err, "COTPPacketBuilder failed"))
	}
	return m
}
