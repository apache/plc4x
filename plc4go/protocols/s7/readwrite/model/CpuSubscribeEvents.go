...
func (m CpuSubscribeEvents) GetLengthInBits(ctx context.Context) uint64 {
	return 8
}

func (m CpuSubscribeEvents) GetLengthInBytes(ctx context.Context) uint64 {
...
func CpuSubscribeEventsParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (CpuSubscribeEvents, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint8("CpuSubscribeEvents", 8)
	if err != nil {
...
func (e CpuSubscribeEvents) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint8("CpuSubscribeEvents", 8, uint8(uint8(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}
