...
func (m *_S7VarRequestParameterItemAddress) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_S7VarRequestParameterItem) (_s7VarRequestParameterItemAddress S7VarRequestParameterItemAddress, err error) {
