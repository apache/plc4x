...
func (m *_S7VarRequestParameterItemAddressBuilder) WithAddressBuilder(builderSupplier func(S7AddressBuilder) S7AddressBuilder) S7VarRequestParameterItemAddressBuilder {
	builder := builderSupplier(m.Address.CreateS7AddressBuilder())
	var err error
	...
	if err != nil {
		...
		m.err.Append(errors.Wrap(err, "S7AddressBuilder failed"))
	}
	return m
}
