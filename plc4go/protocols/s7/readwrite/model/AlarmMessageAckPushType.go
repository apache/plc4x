...
func (m *_AlarmMessageAckPushType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_AlarmMessageAckPushType) GetLengthInBytes(ctx context.Context) uint64 {
...
func AlarmMessageAckPushTypeParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (AlarmMessageAckPushType, error) {
	v, err := (new(_AlarmMessageAckPushType)).parse(ctx, readBuffer)
	if err != nil {
		return nil, err
	}
	return v, nil
