...
func (m *_S7PayloadUserDataItemCpuFunctionAlarmAck) InitializeParent(parent S7PayloadUserDataItem , returnCode DataTransportErrorCode , transportSize DataTransportSize ) {	m.ReturnCode = returnCode
...
func (m *_S7PayloadUserDataItemCpuFunctionAlarmAck) GetLengthInBits(ctx context.Context) uint16 {
...
func (m *_S7PayloadUserDataItemCpuFunctionAlarmAck) GetLengthInBytes(ctx context.Context) uint16 {
...
func S7PayloadUserDataItemCpuFunctionAlarmAckParse(theBytes []byte, cpuFunctionType uint8, cpuSubfunction uint8) (S7PayloadUserDataItemCpuFunctionAlarmAck, error) {
	return S7PayloadUserDataItemCpuFunctionAlarmAckParseWithBuffer(context.Background(), utils.NewReadBufferByteBased(theBytes), cpuFunctionType, cpuSubfunction)
}

func S7PayloadUserDataItemCpuFunctionAlarmAckParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, cpuFunctionType uint8, cpuSubfunction uint8) (S7PayloadUserDataItemCpuFunctionAlarmAck, error) {
...
func (m *_S7PayloadUserDataItemCpuFunctionAlarmAck) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
