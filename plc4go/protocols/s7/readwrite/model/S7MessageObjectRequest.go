...
func (m *_S7MessageObjectRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_S7DataAlarmMessage, cpuFunctionType uint8) (_s7MessageObjectRequest S7MessageObjectRequest, err error) {
