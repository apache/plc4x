...
func (m *_Alarm8MessageQueryType) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_Alarm8MessageQueryType) GetLengthInBytes(ctx context.Context) uint64 {
...
func Alarm8MessageQueryTypeParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (Alarm8MessageQueryType, error) {
	v, err := (new(_Alarm8MessageQueryType)).parse(ctx, readBuffer)
	if err != nil {
		return nil, err
	}
	return v, nil
