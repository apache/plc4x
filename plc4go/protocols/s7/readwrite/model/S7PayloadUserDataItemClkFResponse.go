...
func (m *_S7PayloadUserDataItemClkFResponse) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_S7PayloadUserDataItemClkFResponse) GetLengthInBytes(ctx context.Context) uint64 {
