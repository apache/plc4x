...
func (m *_COTPPacketConnectionResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_COTPPacket, cotpLen uint16) (_cOTPPacketConnectionResponse COTPPacketConnectionResponse, err error) {
