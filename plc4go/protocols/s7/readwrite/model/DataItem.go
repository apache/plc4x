...
func DataItemParse(theBytes []byte, dataProtocolId string, stringLength int32) (api.PlcValue, error) {
	return DataItemParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian)), dataProtocolId, stringLength) // TODO: get endianness from mspec
}
