...
func (m *_S7PayloadUserDataItemCyclicServicesSubscribeRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_S7PayloadUserDataItem, cpuFunctionGroup uint8, cpuFunctionType uint8, cpuSubfunction uint8) (_s7PayloadUserDataItemCyclicServicesSubscribeRequest S7PayloadUserDataItemCyclicServicesSubscribeRequest, err error) {
