...
func (m *_S7ParameterWriteVarRequest) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_S7ParameterWriteVarRequest) GetLengthInBytes(ctx context.Context) uint64 {
