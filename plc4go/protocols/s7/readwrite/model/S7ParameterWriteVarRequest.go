...
func (m *_S7ParameterWriteVarRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_S7Parameter, messageType uint8) (_s7ParameterWriteVarRequest S7ParameterWriteVarRequest, err error) {
