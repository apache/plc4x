...
func (m *_S7ParameterUserDataItemCPUFunctions) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_S7ParameterUserDataItem) (_s7ParameterUserDataItemCPUFunctions S7ParameterUserDataItemCPUFunctions, err error) {
