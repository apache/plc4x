...
// S7PayloadNotify8 is the data-structure of this message
type S7PayloadNotify8 struct {
	*S7PayloadUserDataItem
	AlarmMessage *AlarmMessagePushType
}

// IS7PayloadNotify8 is the corresponding interface of S7PayloadNotify8
...
func NewS7PayloadNotify8(alarmMessage *AlarmMessagePushType, returnCode DataTransportErrorCode, transportSize DataTransportSize) *S7PayloadNotify8 {
	_result := &S7PayloadNotify8{
