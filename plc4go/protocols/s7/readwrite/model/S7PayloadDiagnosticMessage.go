...
func (m *_S7PayloadDiagnosticMessage) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_S7PayloadDiagnosticMessage) GetLengthInBytes(ctx context.Context) uint64 {
