...
func (m *_COTPParameterCalledTsap) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_COTPParameter, rest uint8) (_cOTPParameterCalledTsap COTPParameterCalledTsap, err error) {
