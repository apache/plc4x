...
func (m *_AlarmMessageAckResponseType) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_alarmMessageAckResponseType AlarmMessageAckResponseType, err error) {
