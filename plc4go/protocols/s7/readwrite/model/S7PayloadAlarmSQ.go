...
func S7PayloadAlarmSQParseWithBufferProducer(cpuFunctionGroup uint8, cpuFunctionType uint8, cpuSubfunction uint8) func(ctx context.Context, readBuffer utils.ReadBuffer) (S7PayloadAlarmSQ, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (S7PayloadAlarmSQ, error) {
		return S7PayloadAlarmSQParseWithBuffer(ctx, readBuffer, cpuFunctionGroup, cpuFunctionType, cpuSubfunction)
	}
}
