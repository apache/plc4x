...
func (m MemoryArea) GetLengthInBits(ctx context.Context) uint64 {
	return 8
}

func (m MemoryArea) GetLengthInBytes(ctx context.Context) uint64 {
...
func MemoryAreaParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (MemoryArea, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint8("MemoryArea", 8)
	if err != nil {
