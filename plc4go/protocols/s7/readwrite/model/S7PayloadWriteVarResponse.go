...
func (m *_S7PayloadWriteVarResponse) GetPlx4xTypeName() string {
	return "S7PayloadWriteVarResponse"
}

func (m *_S7PayloadWriteVarResponse) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_S7PayloadWriteVarResponse) GetLengthInBytes(ctx context.Context) uint64 {
