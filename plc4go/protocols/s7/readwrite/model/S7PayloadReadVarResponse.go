...
func (m *_S7PayloadReadVarResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_S7Payload, messageType uint8, parameter S7Parameter) (_s7PayloadReadVarResponse S7PayloadReadVarResponse, err error) {
