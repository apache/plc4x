...
func S7PayloadUserDataItemCpuFunctionAlarmQueryRequestParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, cpuFunctionGroup uint8, cpuFunctionType uint8, cpuSubfunction uint8) (S7PayloadUserDataItemCpuFunctionAlarmQueryRequest, error) {
	...
	functionId, err := readConstField[uint8](ctx, "functionId", ReadUnsignedByte(readBuffer, 8), S7PayloadUserDataItemCpuFunctionAlarmQueryRequest.FUNCTIONID)
	if err != nil {
		return nil, errors.Wrap(err, fmt.Sprintf("Error parsing 'functionId' field"))
	}
	_ = functionId

	numberMessageObj, err := readConstField[uint8](ctx, "numberMessageObj", ReadUnsignedByte(readBuffer, 8), S7PayloadUserDataItemCpuFunctionAlarmQueryRequest.NUMBERMESSAGEOBJ)
	if err != nil {
		return nil, errors.Wrap(err, fmt.Sprintf("Error parsing 'numberMessageObj' field"))
	}
	_ = numberMessageObj

	variableSpec, err := readConstField[uint8](ctx, "variableSpec", ReadUnsignedByte(readBuffer, 8), S7PayloadUserDataItemCpuFunctionAlarmQueryRequest.VARIABLESPEC)
	if err != nil {
		return nil, errors.Wrap(err, fmt.Sprintf("Error parsing 'variableSpec' field"))
	}
	_ = variableSpec

	length, err := readConstField[uint8](ctx, "length", ReadUnsignedByte(readBuffer, 8), S7PayloadUserDataItemCpuFunctionAlarmQueryRequest.LENGTH)
	if err != nil {
