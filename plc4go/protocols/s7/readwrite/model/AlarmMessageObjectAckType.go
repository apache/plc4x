...
func (m *_AlarmMessageObjectAckType) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_alarmMessageObjectAckType AlarmMessageObjectAckType, err error) {
