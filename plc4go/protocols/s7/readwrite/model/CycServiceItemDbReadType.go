...
func (m *_CycServiceItemDbReadType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_CycServiceItemType) (_cycServiceItemDbReadType CycServiceItemDbReadType, err error) {
