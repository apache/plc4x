...
func (m *_ModbusPDUReadWriteMultipleHoldingRegistersResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ModbusPDU, response bool) (_modbusPDUReadWriteMultipleHoldingRegistersResponse ModbusPDUReadWriteMultipleHoldingRegistersResponse, err error) {
