...
func (m *_ModbusPDUReadWriteMultipleHoldingRegistersResponse) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ModbusPDUReadWriteMultipleHoldingRegistersResponse) GetLengthInBytes(ctx context.Context) uint64 {
