...
func (m *_ModbusPDUReportServerIdRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ModbusPDU, response bool) (_modbusPDUReportServerIdRequest ModbusPDUReportServerIdRequest, err error) {
