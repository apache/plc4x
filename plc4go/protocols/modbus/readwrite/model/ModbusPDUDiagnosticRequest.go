...
func (m *_ModbusPDUDiagnosticRequest) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ModbusPDUDiagnosticRequest) GetLengthInBytes(ctx context.Context) uint64 {
