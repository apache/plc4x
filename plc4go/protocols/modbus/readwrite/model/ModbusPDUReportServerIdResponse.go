...
func (m *_ModbusPDUReportServerIdResponse) GetPlx4xTypeName() string {
	return "ModbusPDUReportServerIdResponse"
}

func (m *_ModbusPDUReportServerIdResponse) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ModbusPDUReportServerIdResponse) GetLengthInBytes(ctx context.Context) uint64 {
