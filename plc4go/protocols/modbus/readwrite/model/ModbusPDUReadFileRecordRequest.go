...
// ModbusPDUReadFileRecordRequest is the data-structure of this message
type ModbusPDUReadFileRecordRequest struct {
	*ModbusPDU
	Items []*ModbusPDUReadFileRecordRequestItem
}

// IModbusPDUReadFileRecordRequest is the corresponding interface of ModbusPDUReadFileRecordRequest
