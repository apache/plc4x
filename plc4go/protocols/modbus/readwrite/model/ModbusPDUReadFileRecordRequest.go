...
func ModbusPDUReadFileRecordRequestParse(ctx context.Context, theBytes []byte, response bool) (ModbusPDUReadFileRecordRequest, error) {
	return ModbusPDUReadFileRecordRequestParseWithBuffer(ctx, utils.NewReadBufferByteBased(theBytes), response)
}

func ModbusPDUReadFileRecordRequestParseWithBufferProducer(response bool) func(ctx context.Context, readBuffer utils.ReadBuffer) (ModbusPDUReadFileRecordRequest, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (ModbusPDUReadFileRecordRequest, error) {
		return ModbusPDUReadFileRecordRequestParseWithBuffer(ctx, readBuffer, response)
	}
}
