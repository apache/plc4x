...
func (m *_ModbusPDUReadFileRecordRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ModbusPDU, response bool) (_modbusPDUReadFileRecordRequest ModbusPDUReadFileRecordRequest, err error) {
