...
func (m *_ModbusPDUDiagnosticResponse) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ModbusPDUDiagnosticResponse) GetLengthInBytes(ctx context.Context) uint64 {
