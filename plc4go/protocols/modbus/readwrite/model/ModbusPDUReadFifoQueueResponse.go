...
func (m *_ModbusPDUReadFifoQueueResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ModbusPDU, response bool) (_modbusPDUReadFifoQueueResponse ModbusPDUReadFifoQueueResponse, err error) {
