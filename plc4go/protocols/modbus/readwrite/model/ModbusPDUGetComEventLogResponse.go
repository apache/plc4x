...
func (m *_ModbusPDUGetComEventLogResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ModbusPDU, response bool) (_modbusPDUGetComEventLogResponse ModbusPDUGetComEventLogResponse, err error) {
