...
func (m *_ModbusPDUWriteSingleRegisterResponseBuilder) WithMandatoryFields(address uint16, value uint16) ModbusPDUWriteSingleRegisterResponseBuilder {
	return m.WithAddress(address).WithValue(value)
}

func (m *_ModbusPDUWriteSingleRegisterResponseBuilder) WithAddress(address uint16) ModbusPDUWriteSingleRegisterResponseBuilder {
	m.Address = address
	return m
}

func (m *_ModbusPDUWriteSingleRegisterResponseBuilder) WithValue(value uint16) ModbusPDUWriteSingleRegisterResponseBuilder {
	m.Value = value
	return m
}

func (m *_ModbusPDUWriteSingleRegisterResponseBuilder) Build() (ModbusPDUWriteSingleRegisterResponse, error) {
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._ModbusPDUWriteSingleRegisterResponse.deepCopy(), nil
}

func (m *_ModbusPDUWriteSingleRegisterResponseBuilder) MustBuild() ModbusPDUWriteSingleRegisterResponse {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_ModbusPDUWriteSingleRegisterResponseBuilder) DeepCopy() any {
	return m.CreateModbusPDUWriteSingleRegisterResponseBuilder()
}

// CreateModbusPDUWriteSingleRegisterResponseBuilder creates a ModbusPDUWriteSingleRegisterResponseBuilder
func (m *_ModbusPDUWriteSingleRegisterResponse) CreateModbusPDUWriteSingleRegisterResponseBuilder() ModbusPDUWriteSingleRegisterResponseBuilder {
	if m == nil {
		return NewModbusPDUWriteSingleRegisterResponseBuilder()
	}
	return &_ModbusPDUWriteSingleRegisterResponseBuilder{_ModbusPDUWriteSingleRegisterResponse: m.deepCopy()}
}
