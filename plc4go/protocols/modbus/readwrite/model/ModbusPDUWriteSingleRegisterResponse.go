...
func (m *_ModbusPDUWriteSingleRegisterResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ModbusPDU, response bool) (_modbusPDUWriteSingleRegisterResponse ModbusPDUWriteSingleRegisterResponse, err error) {
