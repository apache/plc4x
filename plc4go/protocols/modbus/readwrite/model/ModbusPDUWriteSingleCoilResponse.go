...
func (m *_ModbusPDUWriteSingleCoilResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ModbusPDU, response bool) (_modbusPDUWriteSingleCoilResponse ModbusPDUWriteSingleCoilResponse, err error) {
