...
func (m *_ModbusPDUWriteSingleCoilRequest) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ModbusPDUWriteSingleCoilRequest) GetLengthInBytes(ctx context.Context) uint64 {
