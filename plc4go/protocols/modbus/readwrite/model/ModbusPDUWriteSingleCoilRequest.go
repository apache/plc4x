...
func ModbusPDUWriteSingleCoilRequestParseWithBufferProducer(response bool) func(ctx context.Context, readBuffer utils.ReadBuffer) (ModbusPDUWriteSingleCoilRequest, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (ModbusPDUWriteSingleCoilRequest, error) {
		return ModbusPDUWriteSingleCoilRequestParseWithBuffer(ctx, readBuffer, response)
	}
}
