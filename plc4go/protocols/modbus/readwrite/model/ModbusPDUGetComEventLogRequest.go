...
func (m *_ModbusPDUGetComEventLogRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ModbusPDU, response bool) (_modbusPDUGetComEventLogRequest ModbusPDUGetComEventLogRequest, err error) {
