...
// ModbusPDUReadExceptionStatusResponse is the data-structure of this message
type ModbusPDUReadExceptionStatusResponse struct {
	*ModbusPDU
	Value uint8
}

// IModbusPDUReadExceptionStatusResponse is the corresponding interface of ModbusPDUReadExceptionStatusResponse
