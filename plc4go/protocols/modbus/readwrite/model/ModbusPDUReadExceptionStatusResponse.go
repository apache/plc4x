...
func (m *_ModbusPDUReadExceptionStatusResponse) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ModbusPDUReadExceptionStatusResponse) GetLengthInBytes(ctx context.Context) uint64 {
