...
func (m *_ModbusPDUReadHoldingRegistersResponse) GetPlx4xTypeName() string {
	return "ModbusPDUReadHoldingRegistersResponse"
}

func (m *_ModbusPDUReadHoldingRegistersResponse) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ModbusPDUReadHoldingRegistersResponse) GetLengthInBytes(ctx context.Context) uint64 {
