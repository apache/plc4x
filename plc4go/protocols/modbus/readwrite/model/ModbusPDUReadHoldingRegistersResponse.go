...
func (m *_ModbusPDUReadHoldingRegistersResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ModbusPDU, response bool) (_modbusPDUReadHoldingRegistersResponse ModbusPDUReadHoldingRegistersResponse, err error) {
