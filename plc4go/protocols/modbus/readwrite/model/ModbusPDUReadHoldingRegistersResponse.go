...
func ModbusPDUReadHoldingRegistersResponseParseWithBufferProducer(response bool) func(ctx context.Context, readBuffer utils.ReadBuffer) (ModbusPDUReadHoldingRegistersResponse, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (ModbusPDUReadHoldingRegistersResponse, error) {
		return ModbusPDUReadHoldingRegistersResponseParseWithBuffer(ctx, readBuffer, response)
	}
}
