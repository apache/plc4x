...
func (b *_ModbusPDUReadCoilsResponseBuilder) setParent(contract ModbusPDUContract) {
	...
	contract.(*_ModbusPDU)._SubType = b._ModbusPDUReadCoilsResponse
}
...
func (m *_ModbusPDUReadCoilsResponse) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ModbusPDUReadCoilsResponse) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_ModbusPDUReadCoilsResponse) deepCopy() *_ModbusPDUReadCoilsResponse {
	...
	_ModbusPDUReadCoilsResponseCopy.ModbusPDUContract.(*_ModbusPDU)._SubType = m
