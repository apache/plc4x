...
func (m *_ModbusPDUGetComEventCounterResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ModbusPDU, response bool) (_modbusPDUGetComEventCounterResponse ModbusPDUGetComEventCounterResponse, err error) {
