...
func (m *_ModbusPDUReadFileRecordResponseItem) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_modbusPDUReadFileRecordResponseItem ModbusPDUReadFileRecordResponseItem, err error) {
