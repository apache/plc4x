...
func (m *_ModbusPDUReadExceptionStatusRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ModbusPDU, response bool) (_modbusPDUReadExceptionStatusRequest ModbusPDUReadExceptionStatusRequest, err error) {
