...
func (m *_ModbusPDUWriteSingleRegisterRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ModbusPDU, response bool) (_modbusPDUWriteSingleRegisterRequest ModbusPDUWriteSingleRegisterRequest, err error) {
