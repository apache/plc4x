...
func (m *_ModbusPDUReadFileRecordRequestItem) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_modbusPDUReadFileRecordRequestItem ModbusPDUReadFileRecordRequestItem, err error) {
