...
func (m *_ModbusPDUReadCoilsRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ModbusPDU, response bool) (_modbusPDUReadCoilsRequest ModbusPDUReadCoilsRequest, err error) {
