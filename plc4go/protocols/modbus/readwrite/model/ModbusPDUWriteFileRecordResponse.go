...
func (m *_ModbusPDUWriteFileRecordResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ModbusPDU, response bool) (_modbusPDUWriteFileRecordResponse ModbusPDUWriteFileRecordResponse, err error) {
