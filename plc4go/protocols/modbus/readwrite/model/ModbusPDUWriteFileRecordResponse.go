...
func (m *_ModbusPDUWriteFileRecordResponse) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ModbusPDUWriteFileRecordResponse) GetLengthInBytes(ctx context.Context) uint64 {
