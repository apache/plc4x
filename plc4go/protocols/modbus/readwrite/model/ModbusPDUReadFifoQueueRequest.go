...
func (m *_ModbusPDUReadFifoQueueRequest) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ModbusPDUReadFifoQueueRequest) GetLengthInBytes(ctx context.Context) uint64 {
