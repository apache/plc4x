...
func (m *_ModbusPDUReadInputRegistersRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ModbusPDU, response bool) (_modbusPDUReadInputRegistersRequest ModbusPDUReadInputRegistersRequest, err error) {
