...
func ModbusPDUReadInputRegistersRequestParse(theBytes []byte, response bool) (ModbusPDUReadInputRegistersRequest, error) {
	return ModbusPDUReadInputRegistersRequestParseWithBuffer(utils.NewReadBufferByteBased(theBytes), response)
}
...
func (m *_ModbusPDUReadInputRegistersRequest) SerializeWithWriteBuffer(writeBuffer utils.WriteBuffer) error {
