...
func (m *_ModbusPDUWriteMultipleHoldingRegistersResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ModbusPDU, response bool) (_modbusPDUWriteMultipleHoldingRegistersResponse ModbusPDUWriteMultipleHoldingRegistersResponse, err error) {
