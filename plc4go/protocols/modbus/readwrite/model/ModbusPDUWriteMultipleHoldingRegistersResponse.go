...
func ModbusPDUWriteMultipleHoldingRegistersResponseParse(ctx context.Context, theBytes []byte, response bool) (ModbusPDUWriteMultipleHoldingRegistersResponse, error) {
	return ModbusPDUWriteMultipleHoldingRegistersResponseParseWithBuffer(ctx, utils.NewReadBufferByteBased(theBytes), response)
}

func ModbusPDUWriteMultipleHoldingRegistersResponseParseWithBufferProducer(response bool) func(ctx context.Context, readBuffer utils.ReadBuffer) (ModbusPDUWriteMultipleHoldingRegistersResponse, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (ModbusPDUWriteMultipleHoldingRegistersResponse, error) {
		return ModbusPDUWriteMultipleHoldingRegistersResponseParseWithBuffer(ctx, readBuffer, response)
	}
}
