...
func DataItemParse(theBytes []byte, dataType ModbusDataType, numberOfValues uint16, offset uint16) (api.PlcValue, error) {
	return DataItemParseWithBuffer(utils.NewReadBufferByteBased(theBytes), dataType, numberOfValues, offset)
}

func DataItemParseWithBuffer(readBuffer utils.ReadBuffer, dataType ModbusDataType, numberOfValues uint16, offset uint16) (api.PlcValue, error) {
