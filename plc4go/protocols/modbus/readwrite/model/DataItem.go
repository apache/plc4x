...
func DataItemParse(ctx context.Context, theBytes []byte, dataType ModbusDataType, numberOfValues uint16, bigEndian bool, stringLength uint16) (api.PlcValue, error) {
	return DataItemParseWithBuffer(ctx, utils.NewReadBufferByteBased(theBytes), dataType, numberOfValues, bigEndian, stringLength)
}

func DataItemParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, dataType ModbusDataType, numberOfValues uint16, bigEndian bool, stringLength uint16) (api.PlcValue, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	...
	case dataType == ModbusDataType_CHAR: // List
		...
		var value []api.PlcValue
		for i := 0; i < int(numberOfValues); i++ {
			_item, _itemErr := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadString("value", uint32(8), utils.WithEncoding("UTF8"))
			if _itemErr != nil {
				return nil, errors.Wrap(_itemErr, "Error parsing 'value' field")
			}
	...
	case dataType == ModbusDataType_WCHAR: // List
		...
		var value []api.PlcValue
		for i := 0; i < int(numberOfValues); i++ {
			_item, _itemErr := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadString("value", uint32(16), utils.WithEncoding("UTF8"))
			if _itemErr != nil {
				return nil, errors.Wrap(_itemErr, "Error parsing 'value' field")
			}
			value = append(value, values.NewPlcSTRING(_item))
		...
		readBuffer.CloseContext("DataItem")
		return values.NewPlcList(value), nil
	case dataType == ModbusDataType_STRING && numberOfValues == uint16(1): // STRING
		// Simple Field (value)
	...
	case dataType == ModbusDataType_STRING: // List
		// Array Field (value)
		var value []api.PlcValue
		for i := 0; i < int(numberOfValues); i++ {
			_item, _itemErr := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadString("value", uint32((stringLength)*(8)), utils.WithEncoding("UTF8"))
			if _itemErr != nil {
				return nil, errors.Wrap(_itemErr, "Error parsing 'value' field")
			}
			value = append(value, values.NewPlcSTRING(_item))
		...
		readBuffer.CloseContext("DataItem")
		return values.NewPlcList(value), nil
	case dataType == ModbusDataType_WSTRING && numberOfValues == uint16(1): // WSTRING
		// Simple Field (value)
	...
	case dataType == ModbusDataType_WSTRING: // List
		// Array Field (value)
		var value []api.PlcValue
		for i := 0; i < int(numberOfValues); i++ {
			_item, _itemErr := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadString("value", uint32((stringLength)*(16)), utils.WithEncoding("UTF8"))
			if _itemErr != nil {
				return nil, errors.Wrap(_itemErr, "Error parsing 'value' field")
			}
			value = append(value, values.NewPlcSTRING(_item))
...
func DataItemSerialize(value api.PlcValue, dataType ModbusDataType, numberOfValues uint16, bigEndian bool, stringLength uint16) ([]byte, error) {
	wb := utils.NewWriteBufferByteBased()
	if err := DataItemSerializeWithWriteBuffer(context.Background(), wb, value, dataType, numberOfValues, bigEndian, stringLength); err != nil {
		return nil, err
	}
...
func (m _DataItem) GetBigEndian() bool {
	return m.BigEndian
}
...
func DataItemSerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer, value api.PlcValue, dataType ModbusDataType, numberOfValues uint16, bigEndian bool, stringLength uint16) error {
	log := zerolog.Ctx(ctx)
	_ = log
	m := _DataItem{
		DataType:       dataType,
	...
	case dataType == ModbusDataType_BYTE: // List
		// Array Field (value)
		for i := uint32(0); i < uint32((m.GetNumberOfValues())*(8)); i++ {
			_itemErr := /*TODO: migrate me*/ writeBuffer.WriteBit("", value.GetIndex(i).GetBool())
			if _itemErr != nil {
				return errors.Wrap(_itemErr, "Error serializing 'value' field")
			}
	...
	case dataType == ModbusDataType_WCHAR: // List
		// Array Field (value)
		for i := uint32(0); i < uint32(m.GetNumberOfValues()); i++ {
			_itemErr := /*TODO: migrate me*/ writeBuffer.WriteString("", uint32(16), value.GetIndex(i).GetString(), utils.WithEncoding("UTF8)"))
			if _itemErr != nil {
				return errors.Wrap(_itemErr, "Error serializing 'value' field")
			}
		}
	...
	case dataType == ModbusDataType_STRING: // List
		// Array Field (value)
		for i := uint32(0); i < uint32(m.GetNumberOfValues()); i++ {
			_itemErr := /*TODO: migrate me*/ writeBuffer.WriteString("", uint32((stringLength)*(8)), value.GetIndex(i).GetString(), utils.WithEncoding("UTF8)"))
			if _itemErr != nil {
				return errors.Wrap(_itemErr, "Error serializing 'value' field")
			}
		}
	...
	case dataType == ModbusDataType_WSTRING: // List
		// Array Field (value)
		for i := uint32(0); i < uint32(m.GetNumberOfValues()); i++ {
			_itemErr := /*TODO: migrate me*/ writeBuffer.WriteString("", uint32((stringLength)*(16)), value.GetIndex(i).GetString(), utils.WithEncoding("UTF8)"))
			if _itemErr != nil {
				return errors.Wrap(_itemErr, "Error serializing 'value' field")
			}
		}
