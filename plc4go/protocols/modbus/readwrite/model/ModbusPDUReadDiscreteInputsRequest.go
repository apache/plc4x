...
func ModbusPDUReadDiscreteInputsRequestParse(ctx context.Context, theBytes []byte, response bool) (ModbusPDUReadDiscreteInputsRequest, error) {
	return ModbusPDUReadDiscreteInputsRequestParseWithBuffer(ctx, utils.NewReadBufferByteBased(theBytes), response)
}

func ModbusPDUReadDiscreteInputsRequestParseWithBufferProducer(response bool) func(ctx context.Context, readBuffer utils.ReadBuffer) (ModbusPDUReadDiscreteInputsRequest, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (ModbusPDUReadDiscreteInputsRequest, error) {
		return ModbusPDUReadDiscreteInputsRequestParseWithBuffer(ctx, readBuffer, response)
	}
}
