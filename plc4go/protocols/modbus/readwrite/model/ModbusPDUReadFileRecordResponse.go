...
func (m *_ModbusPDUReadFileRecordResponse) GetPlx4xTypeName() string {
	return "ModbusPDUReadFileRecordResponse"
}

func (m *_ModbusPDUReadFileRecordResponse) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ModbusPDUReadFileRecordResponse) GetLengthInBytes(ctx context.Context) uint64 {
