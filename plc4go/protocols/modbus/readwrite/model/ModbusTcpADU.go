...
func ModbusTcpADUParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, driverType DriverType, response bool) (ModbusTcpADU, error) {
	...
	protocolIdentifier, err := readConstField[uint16](ctx, "protocolIdentifier", ReadUnsignedShort(readBuffer, 16), ModbusTcpADU.PROTOCOLIDENTIFIER, codegen.WithByteOrder(binary.BigEndian))
	if err != nil {
