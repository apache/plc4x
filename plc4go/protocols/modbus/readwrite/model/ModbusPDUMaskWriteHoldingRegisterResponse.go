...
func (m *_ModbusPDUMaskWriteHoldingRegisterResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ModbusPDU, response bool) (_modbusPDUMaskWriteHoldingRegisterResponse ModbusPDUMaskWriteHoldingRegisterResponse, err error) {
