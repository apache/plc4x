...
func ModbusPDUMaskWriteHoldingRegisterResponseParseWithBufferProducer(response bool) func(ctx context.Context, readBuffer utils.ReadBuffer) (ModbusPDUMaskWriteHoldingRegisterResponse, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (ModbusPDUMaskWriteHoldingRegisterResponse, error) {
		return ModbusPDUMaskWriteHoldingRegisterResponseParseWithBuffer(ctx, readBuffer, response)
	}
}
...
func (m *_ModbusPDUMaskWriteHoldingRegisterResponse) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		_referenceAddressErr := /*TODO: migrate me*/ writeBuffer.WriteUint16("referenceAddress", 16, uint16((referenceAddress)))
		...
		_andMaskErr := /*TODO: migrate me*/ writeBuffer.WriteUint16("andMask", 16, uint16((andMask)))
		if _andMaskErr != nil {
		...
		_orMaskErr := /*TODO: migrate me*/ writeBuffer.WriteUint16("orMask", 16, uint16((orMask)))
		if _orMaskErr != nil {
