...
func (m *_ModbusPDUReadWriteMultipleHoldingRegistersRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ModbusPDU, response bool) (_modbusPDUReadWriteMultipleHoldingRegistersRequest ModbusPDUReadWriteMultipleHoldingRegistersRequest, err error) {
