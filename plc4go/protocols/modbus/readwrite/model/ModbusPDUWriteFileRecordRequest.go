...
func (m *_ModbusPDUWriteFileRecordRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ModbusPDU, response bool) (_modbusPDUWriteFileRecordRequest ModbusPDUWriteFileRecordRequest, err error) {
