...
func (m *_SALDataClockAndTimekeeping) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SALData, applicationId ApplicationId) (_sALDataClockAndTimekeeping SALDataClockAndTimekeeping, err error) {
