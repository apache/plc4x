...
func (m *_SALDataClockAndTimekeepingBuilder) WithClockAndTimekeepingDataBuilder(builderSupplier func(ClockAndTimekeepingDataBuilder) ClockAndTimekeepingDataBuilder) SALDataClockAndTimekeepingBuilder {
	builder := builderSupplier(m.ClockAndTimekeepingData.CreateClockAndTimekeepingDataBuilder())
	var err error
	m.ClockAndTimekeepingData, err = builder.Build()
	if err != nil {
		if m.err == nil {
			m.err = &utils.MultiError{MainError: errors.New("sub builder failed")}
		}
		m.err.Append(errors.Wrap(err, "ClockAndTimekeepingDataBuilder failed"))
	}
	return m
}
