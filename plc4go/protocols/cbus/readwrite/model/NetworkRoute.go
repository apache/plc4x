...
func NewNetworkRoute(routeType RouteType, additionalBridgeAddresses []BridgeAddress) *_NetworkRoute {
	return &_NetworkRoute{RouteType: routeType, AdditionalBridgeAddresses: additionalBridgeAddresses}
}
