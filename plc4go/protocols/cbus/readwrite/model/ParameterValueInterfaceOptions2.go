...
func (m *_ParameterValueInterfaceOptions2) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ParameterValue, parameterType ParameterType, numBytes uint8) (_parameterValueInterfaceOptions2 ParameterValueInterfaceOptions2, err error) {
