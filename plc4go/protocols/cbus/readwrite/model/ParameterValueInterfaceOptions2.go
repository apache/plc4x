...
func (m *_ParameterValueInterfaceOptions2) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ParameterValueInterfaceOptions2) GetLengthInBytes(ctx context.Context) uint64 {
