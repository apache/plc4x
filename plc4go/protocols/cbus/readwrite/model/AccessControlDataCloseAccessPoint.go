...
func (b *_AccessControlDataCloseAccessPointBuilder) setParent(contract AccessControlDataContract) {
	...
	contract.(*_AccessControlData)._SubType = b._AccessControlDataCloseAccessPoint
}
...
func (m *_AccessControlDataCloseAccessPoint) GetPlx4xTypeName() string {
	return "AccessControlDataCloseAccessPoint"
}

func (m *_AccessControlDataCloseAccessPoint) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.AccessControlDataContract.(*_AccessControlData).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_AccessControlDataCloseAccessPoint) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_AccessControlDataCloseAccessPoint) deepCopy() *_AccessControlDataCloseAccessPoint {
	...
	_AccessControlDataCloseAccessPointCopy.AccessControlDataContract.(*_AccessControlData)._SubType = m
