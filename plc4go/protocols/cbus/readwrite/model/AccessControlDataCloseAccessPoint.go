...
func (m *_AccessControlDataCloseAccessPoint) InitializeParent(parent AccessControlData , commandTypeContainer AccessControlCommandTypeContainer , networkId byte , accessPointId byte ) {	m.CommandTypeContainer = commandTypeContainer
...
func AccessControlDataCloseAccessPointParse(theBytes []byte) (AccessControlDataCloseAccessPoint, error) {
	return AccessControlDataCloseAccessPointParseWithBuffer(context.Background(), utils.NewReadBufferByteBased(theBytes))
}
