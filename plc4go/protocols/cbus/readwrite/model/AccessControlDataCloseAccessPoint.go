...
func (m *_AccessControlDataCloseAccessPoint) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AccessControlData) (_accessControlDataCloseAccessPoint AccessControlDataCloseAccessPoint, err error) {
