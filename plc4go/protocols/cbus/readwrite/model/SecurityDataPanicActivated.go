...
func (m *_SecurityDataPanicActivated) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SecurityData) (_securityDataPanicActivated SecurityDataPanicActivated, err error) {
