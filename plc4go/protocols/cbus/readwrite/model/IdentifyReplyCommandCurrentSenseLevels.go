...
func (m *_IdentifyReplyCommandCurrentSenseLevelsBuilder) WithMandatoryFields(currentSenseLevels []byte) IdentifyReplyCommandCurrentSenseLevelsBuilder {
	return m.WithCurrentSenseLevels(currentSenseLevels...)
}

func (m *_IdentifyReplyCommandCurrentSenseLevelsBuilder) WithCurrentSenseLevels(currentSenseLevels ...byte) IdentifyReplyCommandCurrentSenseLevelsBuilder {
	m.CurrentSenseLevels = currentSenseLevels
	return m
}

func (m *_IdentifyReplyCommandCurrentSenseLevelsBuilder) Build() (IdentifyReplyCommandCurrentSenseLevels, error) {
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._IdentifyReplyCommandCurrentSenseLevels.deepCopy(), nil
}

func (m *_IdentifyReplyCommandCurrentSenseLevelsBuilder) MustBuild() IdentifyReplyCommandCurrentSenseLevels {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_IdentifyReplyCommandCurrentSenseLevelsBuilder) DeepCopy() any {
	return m.CreateIdentifyReplyCommandCurrentSenseLevelsBuilder()
}

// CreateIdentifyReplyCommandCurrentSenseLevelsBuilder creates a IdentifyReplyCommandCurrentSenseLevelsBuilder
func (m *_IdentifyReplyCommandCurrentSenseLevels) CreateIdentifyReplyCommandCurrentSenseLevelsBuilder() IdentifyReplyCommandCurrentSenseLevelsBuilder {
	if m == nil {
		return NewIdentifyReplyCommandCurrentSenseLevelsBuilder()
	}
	return &_IdentifyReplyCommandCurrentSenseLevelsBuilder{_IdentifyReplyCommandCurrentSenseLevels: m.deepCopy()}
}
