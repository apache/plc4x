...
func (m *_IdentifyReplyCommandCurrentSenseLevels) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_IdentifyReplyCommand, attribute Attribute, numBytes uint8) (_identifyReplyCommandCurrentSenseLevels IdentifyReplyCommandCurrentSenseLevels, err error) {
