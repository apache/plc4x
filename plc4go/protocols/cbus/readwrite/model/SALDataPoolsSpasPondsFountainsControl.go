...
func (m *_SALDataPoolsSpasPondsFountainsControlBuilder) WithPoolsSpaPondsFountainsDataBuilder(builderSupplier func(LightingDataBuilder) LightingDataBuilder) SALDataPoolsSpasPondsFountainsControlBuilder {
	builder := builderSupplier(m.PoolsSpaPondsFountainsData.CreateLightingDataBuilder())
	var err error
	m.PoolsSpaPondsFountainsData, err = builder.Build()
	if err != nil {
		if m.err == nil {
