...
func (m *_SecurityDataStatusReport2) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SecurityData) (_securityDataStatusReport2 SecurityDataStatusReport2, err error) {
