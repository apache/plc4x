...
func (m *_MediaTransportControlDataEnumerateCategoriesSelectionTracks) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MediaTransportControlData) (_mediaTransportControlDataEnumerateCategoriesSelectionTracks MediaTransportControlDataEnumerateCategoriesSelectionTracks, err error) {
