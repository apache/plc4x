...
func (m *_SecurityDataArmFailedCleared) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SecurityData) (_securityDataArmFailedCleared SecurityDataArmFailedCleared, err error) {
