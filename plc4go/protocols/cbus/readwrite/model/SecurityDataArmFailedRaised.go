...
func (m *_SecurityDataArmFailedRaised) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SecurityData) (_securityDataArmFailedRaised SecurityDataArmFailedRaised, err error) {
