...
func (m ErrorReportingCommandType) GetLengthInBits(ctx context.Context) uint64 {
	return 4
}

func (m ErrorReportingCommandType) GetLengthInBytes(ctx context.Context) uint64 {
...
func ErrorReportingCommandTypeParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (ErrorReportingCommandType, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint8("ErrorReportingCommandType", 4)
	if err != nil {
...
func (e ErrorReportingCommandType) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint8("ErrorReportingCommandType", 4, uint8(uint8(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}
