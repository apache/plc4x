...
func (m *_ErrorReportingSystemCategoryType) parse(ctx context.Context, readBuffer utils.ReadBuffer, errorReportingSystemCategoryClass ErrorReportingSystemCategoryClass) (_errorReportingSystemCategoryType ErrorReportingSystemCategoryType, err error) {
