...
func (m *_SecurityDataGasAlarmClearedBuilder) WithMandatoryFields() SecurityDataGasAlarmClearedBuilder {
	return m
}

func (m *_SecurityDataGasAlarmClearedBuilder) Build() (SecurityDataGasAlarmCleared, error) {
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._SecurityDataGasAlarmCleared.deepCopy(), nil
}

func (m *_SecurityDataGasAlarmClearedBuilder) MustBuild() SecurityDataGasAlarmCleared {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_SecurityDataGasAlarmClearedBuilder) DeepCopy() any {
	return m.CreateSecurityDataGasAlarmClearedBuilder()
}

// CreateSecurityDataGasAlarmClearedBuilder creates a SecurityDataGasAlarmClearedBuilder
func (m *_SecurityDataGasAlarmCleared) CreateSecurityDataGasAlarmClearedBuilder() SecurityDataGasAlarmClearedBuilder {
	if m == nil {
		return NewSecurityDataGasAlarmClearedBuilder()
	}
	return &_SecurityDataGasAlarmClearedBuilder{_SecurityDataGasAlarmCleared: m.deepCopy()}
}
