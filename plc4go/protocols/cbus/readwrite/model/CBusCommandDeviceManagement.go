...
func (m *_CBusCommandDeviceManagement) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_CBusCommand, cBusOptions CBusOptions) (_cBusCommandDeviceManagement CBusCommandDeviceManagement, err error) {
