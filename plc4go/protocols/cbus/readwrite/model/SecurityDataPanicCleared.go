...
func (b *_SecurityDataPanicClearedBuilder) Build() (SecurityDataPanicCleared, error) {
	if err := stdErrors.Join(b.collectedErr...); err != nil {
		return nil, errors.Wrap(err, "error occurred during build")
	}
	return b._SecurityDataPanicCleared.deepCopy(), nil
}

func (b *_SecurityDataPanicClearedBuilder) MustBuild() SecurityDataPanicCleared {
	build, err := b.Build()
	if err != nil {
		panic(err)
	}
...
func (b *_SecurityDataPanicClearedBuilder) buildForSecurityData() (SecurityData, error) {
	return b.Build()
}

func (b *_SecurityDataPanicClearedBuilder) DeepCopy() any {
	_copy := b.CreateSecurityDataPanicClearedBuilder().(*_SecurityDataPanicClearedBuilder)
...
func (b *_SecurityDataPanicCleared) CreateSecurityDataPanicClearedBuilder() SecurityDataPanicClearedBuilder {
	if b == nil {
		return NewSecurityDataPanicClearedBuilder()
	}
	return &_SecurityDataPanicClearedBuilder{_SecurityDataPanicCleared: b.deepCopy()}
}
...
func (m *_SecurityDataPanicCleared) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.SecurityDataContract.(*_SecurityData).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_SecurityDataPanicCleared) GetLengthInBytes(ctx context.Context) uint64 {
