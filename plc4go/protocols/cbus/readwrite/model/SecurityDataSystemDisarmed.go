...
func (m *_SecurityDataSystemDisarmed) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SecurityData) (_securityDataSystemDisarmed SecurityDataSystemDisarmed, err error) {
