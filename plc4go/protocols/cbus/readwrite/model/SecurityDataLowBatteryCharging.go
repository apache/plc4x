...
func (m *_SecurityDataLowBatteryCharging) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SecurityData) (_securityDataLowBatteryCharging SecurityDataLowBatteryCharging, err error) {
