...
func (m *_MeteringDataGasConsumption) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MeteringData) (_meteringDataGasConsumption MeteringDataGasConsumption, err error) {
