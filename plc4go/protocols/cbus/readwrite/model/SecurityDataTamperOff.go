...
func (m *_SecurityDataTamperOff) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SecurityData) (_securityDataTamperOff SecurityDataTamperOff, err error) {
