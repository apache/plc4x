...
func (m *_SecurityDataZoneIsolated) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *_SecurityDataZoneIsolated) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *_SecurityDataZoneIsolated) GetLengthInBytes() uint16 {
