...
func (m *_SecurityDataZoneIsolated) GetPlx4xTypeName() string {
	return "SecurityDataZoneIsolated"
}

func (m *_SecurityDataZoneIsolated) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_SecurityDataZoneIsolated) GetLengthInBytes(ctx context.Context) uint64 {
