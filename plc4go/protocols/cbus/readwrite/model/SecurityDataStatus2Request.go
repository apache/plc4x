...
func (m *_SecurityDataStatus2Request) InitializeParent(parent SecurityData , commandTypeContainer SecurityCommandTypeContainer , argument byte ) {	m.CommandTypeContainer = commandTypeContainer
	m.Argument = argument
}
...
func SecurityDataStatus2RequestParse(theBytes []byte) (SecurityDataStatus2Request, error) {
	return SecurityDataStatus2RequestParseWithBuffer(context.Background(), utils.NewReadBufferByteBased(theBytes))
}
