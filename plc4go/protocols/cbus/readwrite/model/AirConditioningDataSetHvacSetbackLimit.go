...
func (m *_AirConditioningDataSetHvacSetbackLimit) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AirConditioningData) (_airConditioningDataSetHvacSetbackLimit AirConditioningDataSetHvacSetbackLimit, err error) {
