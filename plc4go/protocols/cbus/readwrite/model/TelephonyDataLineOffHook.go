...
func (m *_TelephonyDataLineOffHook) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_TelephonyDataLineOffHook) GetLengthInBytes(ctx context.Context) uint64 {
