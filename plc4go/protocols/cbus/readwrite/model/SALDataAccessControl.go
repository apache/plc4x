...
func (m *_SALDataAccessControlBuilder) WithAccessControlDataBuilder(builderSupplier func(AccessControlDataBuilder) AccessControlDataBuilder) SALDataAccessControlBuilder {
	builder := builderSupplier(m.AccessControlData.CreateAccessControlDataBuilder())
	var err error
	m.AccessControlData, err = builder.Build()
	if err != nil {
		if m.err == nil {
			m.err = &utils.MultiError{MainError: errors.New("sub builder failed")}
		}
		m.err.Append(errors.Wrap(err, "AccessControlDataBuilder failed"))
	}
	return m
}
