...
func (m *_LevelInformationNormal) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_LevelInformation) (_levelInformationNormal LevelInformationNormal, err error) {
