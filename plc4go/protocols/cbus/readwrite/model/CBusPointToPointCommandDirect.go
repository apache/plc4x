...
func (m *_CBusPointToPointCommandDirect) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_CBusPointToPointCommand, cBusOptions CBusOptions) (_cBusPointToPointCommandDirect CBusPointToPointCommandDirect, err error) {
