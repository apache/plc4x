...
func (m *_NetworkProtocolControlInformation) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_networkProtocolControlInformation NetworkProtocolControlInformation, err error) {
