...
func (m *_SecurityDataRequestZoneName) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_SecurityDataRequestZoneName) GetLengthInBytes(ctx context.Context) uint64 {
