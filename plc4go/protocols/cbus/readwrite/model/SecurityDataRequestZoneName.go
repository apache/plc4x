...
func (m *_SecurityDataRequestZoneName) InitializeParent(parent SecurityData , commandTypeContainer SecurityCommandTypeContainer , argument byte ) {	m.CommandTypeContainer = commandTypeContainer
	m.Argument = argument
}
...
func SecurityDataRequestZoneNameParse(theBytes []byte) (SecurityDataRequestZoneName, error) {
	return SecurityDataRequestZoneNameParseWithBuffer(context.Background(), utils.NewReadBufferByteBased(theBytes))
}
