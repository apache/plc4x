...
func (m *_MeteringDataOilConsumption) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MeteringData) (_meteringDataOilConsumption MeteringDataOilConsumption, err error) {
