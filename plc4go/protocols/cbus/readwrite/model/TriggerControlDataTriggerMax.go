...
func (m *_TriggerControlDataTriggerMax) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *_TriggerControlDataTriggerMax) GetLengthInBitsConditional(lastItem bool) uint16 {
	lengthInBits := uint16(m.GetParentLengthInBits())

	return lengthInBits
}

func (m *_TriggerControlDataTriggerMax) GetLengthInBytes() uint16 {
