...
func (m *_TriggerControlDataTriggerMax) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_TriggerControlData) (_triggerControlDataTriggerMax TriggerControlDataTriggerMax, err error) {
