...
func (m *_CBusMessageToClientBuilder) WithReplyBuilder(builderSupplier func(ReplyOrConfirmationBuilder) ReplyOrConfirmationBuilder) CBusMessageToClientBuilder {
	builder := builderSupplier(m.Reply.CreateReplyOrConfirmationBuilder())
	var err error
