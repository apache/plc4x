...
func (m *_ReplyOrConfirmationConfirmation) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ReplyOrConfirmation, cBusOptions CBusOptions, requestContext RequestContext) (_replyOrConfirmationConfirmation ReplyOrConfirmationConfirmation, err error) {
