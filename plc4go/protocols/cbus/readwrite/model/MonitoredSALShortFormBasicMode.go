...
func (m *_MonitoredSALShortFormBasicMode) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MonitoredSAL, cBusOptions CBusOptions) (_monitoredSALShortFormBasicMode MonitoredSALShortFormBasicMode, err error) {
