...
func (m *_ParameterValueInterfaceOptions3) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ParameterValue, parameterType ParameterType, numBytes uint8) (_parameterValueInterfaceOptions3 ParameterValueInterfaceOptions3, err error) {
