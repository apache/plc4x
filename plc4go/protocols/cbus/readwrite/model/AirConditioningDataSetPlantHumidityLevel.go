...
func (m *_AirConditioningDataSetPlantHumidityLevel) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_AirConditioningDataSetPlantHumidityLevel) GetLengthInBytes(ctx context.Context) uint64 {
