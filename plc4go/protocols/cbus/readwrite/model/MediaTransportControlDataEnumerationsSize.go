...
func (m *_MediaTransportControlDataEnumerationsSize) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MediaTransportControlData) (_mediaTransportControlDataEnumerationsSize MediaTransportControlDataEnumerationsSize, err error) {
