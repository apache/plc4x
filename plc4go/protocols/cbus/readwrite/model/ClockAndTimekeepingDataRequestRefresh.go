...
func (m *_ClockAndTimekeepingDataRequestRefresh) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ClockAndTimekeepingData) (_clockAndTimekeepingDataRequestRefresh ClockAndTimekeepingDataRequestRefresh, err error) {
