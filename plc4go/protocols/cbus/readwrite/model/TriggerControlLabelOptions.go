...
func (m *_TriggerControlLabelOptions) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_triggerControlLabelOptions TriggerControlLabelOptions, err error) {
