...
func (m *_SecurityDataStatus1Request) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SecurityData) (_securityDataStatus1Request SecurityDataStatus1Request, err error) {
