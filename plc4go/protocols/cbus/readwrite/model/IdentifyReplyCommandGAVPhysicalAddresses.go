...
func (m *_IdentifyReplyCommandGAVPhysicalAddresses) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_IdentifyReplyCommand, attribute Attribute, numBytes uint8) (_identifyReplyCommandGAVPhysicalAddresses IdentifyReplyCommandGAVPhysicalAddresses, err error) {
