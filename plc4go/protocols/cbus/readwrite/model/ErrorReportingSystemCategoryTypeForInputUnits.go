...
func (m ErrorReportingSystemCategoryTypeForInputUnits) GetLengthInBits(ctx context.Context) uint64 {
	return 4
}

func (m ErrorReportingSystemCategoryTypeForInputUnits) GetLengthInBytes(ctx context.Context) uint64 {
...
func ErrorReportingSystemCategoryTypeForInputUnitsParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (ErrorReportingSystemCategoryTypeForInputUnits, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint8("ErrorReportingSystemCategoryTypeForInputUnits", 4)
	if err != nil {
...
func (e ErrorReportingSystemCategoryTypeForInputUnits) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint8("ErrorReportingSystemCategoryTypeForInputUnits", 4, uint8(uint8(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}
