...
func (m ChannelStatus) GetLengthInBits(ctx context.Context) uint64 {
	return 8
}

func (m ChannelStatus) GetLengthInBytes(ctx context.Context) uint64 {
...
func ChannelStatusParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (ChannelStatus, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint8("ChannelStatus", 8)
	if err != nil {
...
func (e ChannelStatus) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint8("ChannelStatus", 8, uint8(uint8(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}
