...
func NewCBusHeader(priorityClass PriorityClass, destinationAddressType DestinationAddressType) *_CBusHeader {
	return &_CBusHeader{PriorityClass: priorityClass, DestinationAddressType: destinationAddressType}
}
