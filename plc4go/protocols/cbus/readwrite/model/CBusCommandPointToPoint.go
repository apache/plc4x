...
func (m *_CBusCommandPointToPoint) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_CBusCommand, cBusOptions CBusOptions) (_cBusCommandPointToPoint CBusCommandPointToPoint, err error) {
