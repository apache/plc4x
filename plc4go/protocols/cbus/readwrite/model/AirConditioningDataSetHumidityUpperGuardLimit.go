...
func (b *_AirConditioningDataSetHumidityUpperGuardLimitBuilder) setParent(contract AirConditioningDataContract) {
	...
	contract.(*_AirConditioningData)._SubType = b._AirConditioningDataSetHumidityUpperGuardLimit
}
...
func (m *_AirConditioningDataSetHumidityUpperGuardLimit) GetPlx4xTypeName() string {
	return "AirConditioningDataSetHumidityUpperGuardLimit"
}

func (m *_AirConditioningDataSetHumidityUpperGuardLimit) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_AirConditioningDataSetHumidityUpperGuardLimit) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_AirConditioningDataSetHumidityUpperGuardLimit) deepCopy() *_AirConditioningDataSetHumidityUpperGuardLimit {
	...
	_AirConditioningDataSetHumidityUpperGuardLimitCopy.AirConditioningDataContract.(*_AirConditioningData)._SubType = m
