...
func AirConditioningDataSetHumidityUpperGuardLimitParseWithBufferProducer() func(ctx context.Context, readBuffer utils.ReadBuffer) (AirConditioningDataSetHumidityUpperGuardLimit, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (AirConditioningDataSetHumidityUpperGuardLimit, error) {
		return AirConditioningDataSetHumidityUpperGuardLimitParseWithBuffer(ctx, readBuffer)
	}
}
