...
func (m *_SALDataAudioAndVideoBuilder) WithAudioVideoDataBuilder(builderSupplier func(LightingDataBuilder) LightingDataBuilder) SALDataAudioAndVideoBuilder {
	builder := builderSupplier(m.AudioVideoData.CreateLightingDataBuilder())
	var err error
	m.AudioVideoData, err = builder.Build()
	if err != nil {
		if m.err == nil {
