...
func (m *_SALDataAudioAndVideo) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SALData, applicationId ApplicationId) (_sALDataAudioAndVideo SALDataAudioAndVideo, err error) {
