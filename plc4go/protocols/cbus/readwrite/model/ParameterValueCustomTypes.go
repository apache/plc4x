...
func (m *_ParameterValueCustomTypes) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ParameterValue, parameterType ParameterType, numBytes uint8) (_parameterValueCustomTypes ParameterValueCustomTypes, err error) {
