...
func (m *_MediaTransportControlDataPlay) InitializeParent(parent MediaTransportControlData , commandTypeContainer MediaTransportControlCommandTypeContainer , mediaLinkGroup byte ) {	m.CommandTypeContainer = commandTypeContainer
...
func MediaTransportControlDataPlayParse(theBytes []byte) (MediaTransportControlDataPlay, error) {
	return MediaTransportControlDataPlayParseWithBuffer(context.Background(), utils.NewReadBufferByteBased(theBytes))
}
