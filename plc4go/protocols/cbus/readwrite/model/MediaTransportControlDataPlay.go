...
func (m *_MediaTransportControlDataPlay) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MediaTransportControlData) (_mediaTransportControlDataPlay MediaTransportControlDataPlay, err error) {
