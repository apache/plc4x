...
func (m *_MediaTransportControlDataPlay) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.MediaTransportControlDataContract.(*_MediaTransportControlData).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_MediaTransportControlDataPlay) GetLengthInBytes(ctx context.Context) uint64 {
