...
func (m *_RequestCommandBuilder) WithCbusCommandBuilder(builderSupplier func(CBusCommandBuilder) CBusCommandBuilder) RequestCommandBuilder {
	builder := builderSupplier(m.CbusCommand.CreateCBusCommandBuilder())
	var err error
	m.CbusCommand, err = builder.Build()
	if err != nil {
		if m.err == nil {
			m.err = &utils.MultiError{MainError: errors.New("sub builder failed")}
		}
		m.err.Append(errors.Wrap(err, "CBusCommandBuilder failed"))
	}
	return m
}
