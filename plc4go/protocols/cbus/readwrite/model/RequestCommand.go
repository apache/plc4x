...
if err := WriteManualField[Checksum]( ctx, "chksum", func(ctx context.Context) error { return CalculateChecksum(ctx, writeBuffer, m.GetCbusCommand(), m.GetCBusOptions().GetSrchk()) }, writeBuffer); err != nil{
