...
func (m *_SecurityDataFireAlarmRaised) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.SecurityDataContract.(*_SecurityData).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_SecurityDataFireAlarmRaised) GetLengthInBytes(ctx context.Context) uint64 {
