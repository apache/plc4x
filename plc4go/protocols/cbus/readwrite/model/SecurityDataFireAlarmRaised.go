...
func (m *_SecurityDataFireAlarmRaised) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SecurityData) (_securityDataFireAlarmRaised SecurityDataFireAlarmRaised, err error) {
