...
func (b *_SALDataErrorReportingBuilder) WithErrorReportingDataBuilder(builderSupplier func(ErrorReportingDataBuilder) ErrorReportingDataBuilder) SALDataErrorReportingBuilder {
	...
	if err != nil {
		b.collectedErr = append(b.collectedErr, errors.Wrap(err, "ErrorReportingDataBuilder failed"))
	}
	return b
}
...
func (m *_SALDataErrorReporting) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_SALDataErrorReporting) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_SALDataErrorReporting) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SALData, applicationId ApplicationId) (__sALDataErrorReporting SALDataErrorReporting, err error) {
	...
	errorReportingData, err := ReadSimpleField[ErrorReportingData](ctx, "errorReportingData", ReadComplex[ErrorReportingData](ErrorReportingDataParseWithBuffer, readBuffer), codegen.WithEncoding("UTF8"), codegen.WithByteOrder(binary.BigEndian))
	if err != nil {
...
func (m *_SALDataErrorReporting) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		if err := WriteSimpleField[ErrorReportingData](ctx, "errorReportingData", m.GetErrorReportingData(), WriteComplex[ErrorReportingData](writeBuffer), codegen.WithEncoding("UTF8"), codegen.WithByteOrder(binary.BigEndian)); err != nil {
