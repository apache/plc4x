...
func (m *_CBusCommandPointToPointToMultiPoint) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_CBusCommand, cBusOptions CBusOptions) (_cBusCommandPointToPointToMultiPoint CBusCommandPointToPointToMultiPoint, err error) {
