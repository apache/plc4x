...
func (m *_CBusCommandPointToPointToMultiPointBuilder) WithCommandBuilder(builderSupplier func(CBusPointToPointToMultiPointCommandBuilder) CBusPointToPointToMultiPointCommandBuilder) CBusCommandPointToPointToMultiPointBuilder {
	builder := builderSupplier(m.Command.CreateCBusPointToPointToMultiPointCommandBuilder())
	var err error
	...
	if err != nil {
		...
		m.err.Append(errors.Wrap(err, "CBusPointToPointToMultiPointCommandBuilder failed"))
	}
	return m
}
