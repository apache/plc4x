...
func (m ErrorReportingSystemCategoryVariant) GetLengthInBits(ctx context.Context) uint64 {
	return 2
}

func (m ErrorReportingSystemCategoryVariant) GetLengthInBytes(ctx context.Context) uint64 {
