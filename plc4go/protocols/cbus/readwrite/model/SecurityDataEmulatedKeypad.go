...
func (m *_SecurityDataEmulatedKeypad) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SecurityData) (_securityDataEmulatedKeypad SecurityDataEmulatedKeypad, err error) {
