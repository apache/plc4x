...
func (m *_SALDataMeteringBuilder) WithMeteringDataBuilder(builderSupplier func(MeteringDataBuilder) MeteringDataBuilder) SALDataMeteringBuilder {
	builder := builderSupplier(m.MeteringData.CreateMeteringDataBuilder())
	var err error
	m.MeteringData, err = builder.Build()
	if err != nil {
		if m.err == nil {
			m.err = &utils.MultiError{MainError: errors.New("sub builder failed")}
		}
		m.err.Append(errors.Wrap(err, "MeteringDataBuilder failed"))
	}
	return m
}
