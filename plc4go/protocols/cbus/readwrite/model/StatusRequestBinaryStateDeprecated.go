...
func (m *_StatusRequestBinaryStateDeprecated) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_StatusRequest) (_statusRequestBinaryStateDeprecated StatusRequestBinaryStateDeprecated, err error) {
