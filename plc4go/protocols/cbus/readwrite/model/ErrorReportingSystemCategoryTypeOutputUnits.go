...
func ErrorReportingSystemCategoryTypeOutputUnitsParseWithBufferProducer(errorReportingSystemCategoryClass ErrorReportingSystemCategoryClass) func(ctx context.Context, readBuffer utils.ReadBuffer) (ErrorReportingSystemCategoryTypeOutputUnits, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (ErrorReportingSystemCategoryTypeOutputUnits, error) {
		return ErrorReportingSystemCategoryTypeOutputUnitsParseWithBuffer(ctx, readBuffer, errorReportingSystemCategoryClass)
	}
}
