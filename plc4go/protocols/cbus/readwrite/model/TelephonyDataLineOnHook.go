...
func (m *_TelephonyDataLineOnHook) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_TelephonyData) (_telephonyDataLineOnHook TelephonyDataLineOnHook, err error) {
