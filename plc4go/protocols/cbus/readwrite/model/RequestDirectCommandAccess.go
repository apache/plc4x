...
func (m *_RequestDirectCommandAccess) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_Request, cBusOptions CBusOptions) (_requestDirectCommandAccess RequestDirectCommandAccess, err error) {
