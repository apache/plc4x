...
func (m *_ErrorReportingDataGeneric) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ErrorReportingData) (_errorReportingDataGeneric ErrorReportingDataGeneric, err error) {
