...
func (m *_SecurityDataLowBatteryCorrected) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SecurityData) (_securityDataLowBatteryCorrected SecurityDataLowBatteryCorrected, err error) {
