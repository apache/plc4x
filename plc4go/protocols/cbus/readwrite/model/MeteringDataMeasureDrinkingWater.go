...
func (m *_MeteringDataMeasureDrinkingWater) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MeteringData) (_meteringDataMeasureDrinkingWater MeteringDataMeasureDrinkingWater, err error) {
