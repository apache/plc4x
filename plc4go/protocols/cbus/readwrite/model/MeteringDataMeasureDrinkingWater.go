...
func (m *_MeteringDataMeasureDrinkingWater) GetPlx4xTypeName() string {
	return "MeteringDataMeasureDrinkingWater"
}

func (m *_MeteringDataMeasureDrinkingWater) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.MeteringDataContract.(*_MeteringData).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_MeteringDataMeasureDrinkingWater) GetLengthInBytes(ctx context.Context) uint64 {
