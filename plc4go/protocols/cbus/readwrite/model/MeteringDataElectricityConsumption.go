...
func (m *_MeteringDataElectricityConsumption) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MeteringData) (_meteringDataElectricityConsumption MeteringDataElectricityConsumption, err error) {
