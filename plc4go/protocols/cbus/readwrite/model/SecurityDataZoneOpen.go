...
func (m *_SecurityDataZoneOpen) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SecurityData) (_securityDataZoneOpen SecurityDataZoneOpen, err error) {
