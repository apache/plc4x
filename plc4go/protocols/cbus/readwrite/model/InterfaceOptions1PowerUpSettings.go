...
func (m *_InterfaceOptions1PowerUpSettings) parse(ctx context.Context, readBuffer utils.ReadBuffer) (_interfaceOptions1PowerUpSettings InterfaceOptions1PowerUpSettings, err error) {
