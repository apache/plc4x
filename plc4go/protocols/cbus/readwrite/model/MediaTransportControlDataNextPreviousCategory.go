...
func (m *_MediaTransportControlDataNextPreviousCategory) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MediaTransportControlData) (_mediaTransportControlDataNextPreviousCategory MediaTransportControlDataNextPreviousCategory, err error) {
