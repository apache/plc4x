...
func (m *_SecurityDataLineCutAlarmCleared) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SecurityData) (_securityDataLineCutAlarmCleared SecurityDataLineCutAlarmCleared, err error) {
