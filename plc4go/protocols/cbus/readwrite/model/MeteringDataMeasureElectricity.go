...
func (m *_MeteringDataMeasureElectricity) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MeteringData) (_meteringDataMeasureElectricity MeteringDataMeasureElectricity, err error) {
