...
func (m *_IdentifyReplyCommandLogicalAssignment) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_IdentifyReplyCommand, attribute Attribute, numBytes uint8) (_identifyReplyCommandLogicalAssignment IdentifyReplyCommandLogicalAssignment, err error) {
