...
func (m *_SALDataSecurity) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SALData, applicationId ApplicationId) (_sALDataSecurity SALDataSecurity, err error) {
