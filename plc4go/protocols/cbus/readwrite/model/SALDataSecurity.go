...
func (m *_SALDataSecurityBuilder) WithSecurityDataBuilder(builderSupplier func(SecurityDataBuilder) SecurityDataBuilder) SALDataSecurityBuilder {
	builder := builderSupplier(m.SecurityData.CreateSecurityDataBuilder())
	var err error
	m.SecurityData, err = builder.Build()
	if err != nil {
		if m.err == nil {
			m.err = &utils.MultiError{MainError: errors.New("sub builder failed")}
		}
		m.err.Append(errors.Wrap(err, "SecurityDataBuilder failed"))
	}
	return m
}
