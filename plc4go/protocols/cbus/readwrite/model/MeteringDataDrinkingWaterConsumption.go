...
func (m *_MeteringDataDrinkingWaterConsumption) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_MeteringDataDrinkingWaterConsumption) GetLengthInBytes(ctx context.Context) uint64 {
