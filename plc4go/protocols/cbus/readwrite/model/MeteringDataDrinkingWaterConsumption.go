...
func (m *_MeteringDataDrinkingWaterConsumption) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MeteringData) (_meteringDataDrinkingWaterConsumption MeteringDataDrinkingWaterConsumption, err error) {
