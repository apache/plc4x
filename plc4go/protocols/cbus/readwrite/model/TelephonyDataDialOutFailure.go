...
func (m *_TelephonyDataDialOutFailure) InitializeParent(parent TelephonyData , commandTypeContainer TelephonyCommandTypeContainer , argument byte ) {	m.CommandTypeContainer = commandTypeContainer
	m.Argument = argument
}
...
func TelephonyDataDialOutFailureParse(theBytes []byte) (TelephonyDataDialOutFailure, error) {
	return TelephonyDataDialOutFailureParseWithBuffer(context.Background(), utils.NewReadBufferByteBased(theBytes))
}
