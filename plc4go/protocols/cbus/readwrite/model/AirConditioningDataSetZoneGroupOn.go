...
func (m *_AirConditioningDataSetZoneGroupOn) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AirConditioningData) (_airConditioningDataSetZoneGroupOn AirConditioningDataSetZoneGroupOn, err error) {
