...
func (m *_AirConditioningDataSetZoneGroupOn) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_AirConditioningDataSetZoneGroupOn) GetLengthInBytes(ctx context.Context) uint64 {
