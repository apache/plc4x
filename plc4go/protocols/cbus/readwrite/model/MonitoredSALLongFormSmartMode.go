...
func (m *_MonitoredSALLongFormSmartMode) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MonitoredSAL, cBusOptions CBusOptions) (_monitoredSALLongFormSmartMode MonitoredSALLongFormSmartMode, err error) {
