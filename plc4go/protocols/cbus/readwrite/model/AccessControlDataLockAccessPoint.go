...
func (m *_AccessControlDataLockAccessPoint) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AccessControlData) (_accessControlDataLockAccessPoint AccessControlDataLockAccessPoint, err error) {
