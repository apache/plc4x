...
func (m *_CBusPointToMultiPointCommand) parse(ctx context.Context, readBuffer utils.ReadBuffer, cBusOptions CBusOptions) (_cBusPointToMultiPointCommand CBusPointToMultiPointCommand, err error) {
