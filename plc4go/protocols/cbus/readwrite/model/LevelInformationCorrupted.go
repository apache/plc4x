...
func (m *_LevelInformationCorrupted) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_LevelInformation) (_levelInformationCorrupted LevelInformationCorrupted, err error) {
