...
func (m *_TelephonyDataRejectIncomingCall) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_TelephonyData) (_telephonyDataRejectIncomingCall TelephonyDataRejectIncomingCall, err error) {
