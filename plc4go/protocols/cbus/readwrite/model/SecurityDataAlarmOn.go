...
func (m *_SecurityDataAlarmOn) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SecurityData) (_securityDataAlarmOn SecurityDataAlarmOn, err error) {
