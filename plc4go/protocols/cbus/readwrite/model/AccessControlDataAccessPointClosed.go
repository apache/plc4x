...
func (m *_AccessControlDataAccessPointClosed) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AccessControlData) (_accessControlDataAccessPointClosed AccessControlDataAccessPointClosed, err error) {
