...
func (m *_MediaTransportControlDataSourcePowerControl) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MediaTransportControlData) (_mediaTransportControlDataSourcePowerControl MediaTransportControlDataSourcePowerControl, err error) {
