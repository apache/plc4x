...
func (m *_AirConditioningDataSetZoneHumidityMode) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AirConditioningData) (_airConditioningDataSetZoneHumidityMode AirConditioningDataSetZoneHumidityMode, err error) {
