...
func (m *_MediaTransportControlDataStatusRequest) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MediaTransportControlData) (_mediaTransportControlDataStatusRequest MediaTransportControlDataStatusRequest, err error) {
