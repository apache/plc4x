...
func (m *_SecurityDataOtherAlarmCleared) InitializeParent(parent SecurityData , commandTypeContainer SecurityCommandTypeContainer , argument byte ) {	m.CommandTypeContainer = commandTypeContainer
	m.Argument = argument
}
...
func SecurityDataOtherAlarmClearedParse(theBytes []byte) (SecurityDataOtherAlarmCleared, error) {
	return SecurityDataOtherAlarmClearedParseWithBuffer(context.Background(), utils.NewReadBufferByteBased(theBytes))
}
