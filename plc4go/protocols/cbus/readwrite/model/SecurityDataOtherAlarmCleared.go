...
func (m *_SecurityDataOtherAlarmCleared) GetPlx4xTypeName() string {
	return "SecurityDataOtherAlarmCleared"
}

func (m *_SecurityDataOtherAlarmCleared) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.SecurityDataContract.(*_SecurityData).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_SecurityDataOtherAlarmCleared) GetLengthInBytes(ctx context.Context) uint64 {
