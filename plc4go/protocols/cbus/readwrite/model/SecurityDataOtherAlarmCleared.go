...
func (m *_SecurityDataOtherAlarmCleared) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SecurityData) (_securityDataOtherAlarmCleared SecurityDataOtherAlarmCleared, err error) {
