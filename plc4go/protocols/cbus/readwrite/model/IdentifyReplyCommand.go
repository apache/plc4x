...
func (m *_IdentifyReplyCommand) parse(ctx context.Context, readBuffer utils.ReadBuffer, attribute Attribute, numBytes uint8) (_identifyReplyCommand IdentifyReplyCommand, err error) {
