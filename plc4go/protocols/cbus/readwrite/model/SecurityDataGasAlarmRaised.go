...
func (m *_SecurityDataGasAlarmRaised) InitializeParent(parent SecurityData , commandTypeContainer SecurityCommandTypeContainer , argument byte ) {	m.CommandTypeContainer = commandTypeContainer
	m.Argument = argument
}
...
func SecurityDataGasAlarmRaisedParse(theBytes []byte) (SecurityDataGasAlarmRaised, error) {
	return SecurityDataGasAlarmRaisedParseWithBuffer(context.Background(), utils.NewReadBufferByteBased(theBytes))
}
