...
func (m *_SecurityDataGasAlarmRaised) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SecurityData) (_securityDataGasAlarmRaised SecurityDataGasAlarmRaised, err error) {
