...
func (m *_MeasurementDataChannelMeasurementData) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MeasurementData) (_measurementDataChannelMeasurementData MeasurementDataChannelMeasurementData, err error) {
