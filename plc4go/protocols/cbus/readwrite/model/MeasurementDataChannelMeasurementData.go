...
func (m *_MeasurementDataChannelMeasurementData) InitializeParent(parent MeasurementData , commandTypeContainer MeasurementCommandTypeContainer ) {	m.CommandTypeContainer = commandTypeContainer
}
