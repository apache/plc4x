...
func (m *_MeteringDataMeasureOtherWater) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MeteringData) (_meteringDataMeasureOtherWater MeteringDataMeasureOtherWater, err error) {
