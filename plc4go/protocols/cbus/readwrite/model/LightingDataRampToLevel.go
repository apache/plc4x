...
func (m *_LightingDataRampToLevel) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_LightingData) (_lightingDataRampToLevel LightingDataRampToLevel, err error) {
