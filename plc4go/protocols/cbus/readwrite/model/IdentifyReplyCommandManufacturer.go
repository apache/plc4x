...
func (m *_IdentifyReplyCommandManufacturer) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_IdentifyReplyCommand, attribute Attribute, numBytes uint8) (_identifyReplyCommandManufacturer IdentifyReplyCommandManufacturer, err error) {
