...
func (m *_IdentifyReplyCommandManufacturerBuilder) WithMandatoryFields(manufacturerName string) IdentifyReplyCommandManufacturerBuilder {
	return m.WithManufacturerName(manufacturerName)
}

func (m *_IdentifyReplyCommandManufacturerBuilder) WithManufacturerName(manufacturerName string) IdentifyReplyCommandManufacturerBuilder {
	m.ManufacturerName = manufacturerName
	return m
}

func (m *_IdentifyReplyCommandManufacturerBuilder) Build() (IdentifyReplyCommandManufacturer, error) {
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._IdentifyReplyCommandManufacturer.deepCopy(), nil
}

func (m *_IdentifyReplyCommandManufacturerBuilder) MustBuild() IdentifyReplyCommandManufacturer {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_IdentifyReplyCommandManufacturerBuilder) DeepCopy() any {
	return m.CreateIdentifyReplyCommandManufacturerBuilder()
}

// CreateIdentifyReplyCommandManufacturerBuilder creates a IdentifyReplyCommandManufacturerBuilder
func (m *_IdentifyReplyCommandManufacturer) CreateIdentifyReplyCommandManufacturerBuilder() IdentifyReplyCommandManufacturerBuilder {
	if m == nil {
		return NewIdentifyReplyCommandManufacturerBuilder()
	}
	return &_IdentifyReplyCommandManufacturerBuilder{_IdentifyReplyCommandManufacturer: m.deepCopy()}
}
