...
func (m *_SALDataTelephonyStatusAndControl) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SALData, applicationId ApplicationId) (_sALDataTelephonyStatusAndControl SALDataTelephonyStatusAndControl, err error) {
