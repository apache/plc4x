...
func (m *_MediaTransportControlDataRewind) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MediaTransportControlData) (_mediaTransportControlDataRewind MediaTransportControlDataRewind, err error) {
