...
func (m *_StatusRequestBinaryState) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_StatusRequestBinaryState) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_StatusRequestBinaryState) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_StatusRequest) (__statusRequestBinaryState StatusRequestBinaryState, err error) {
	...
	reservedField0, err := ReadReservedField(ctx, "reserved", ReadByte(readBuffer, 8), byte(0x7A), codegen.WithEncoding("UTF8"), codegen.WithByteOrder(binary.BigEndian))
	if err != nil {
...
func (m *_StatusRequestBinaryState) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		if err := WriteReservedField[byte](ctx, "reserved", byte(0x7A), WriteByte(writeBuffer, 8), codegen.WithEncoding("UTF8"), codegen.WithByteOrder(binary.BigEndian)); err != nil {
