...
func (m *_TriggerControlDataTriggerEvent) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_TriggerControlData) (_triggerControlDataTriggerEvent TriggerControlDataTriggerEvent, err error) {
