...
func (m MediaTransportControlCommandType) GetLengthInBits(ctx context.Context) uint64 {
	return 4
}

func (m MediaTransportControlCommandType) GetLengthInBytes(ctx context.Context) uint64 {
...
func MediaTransportControlCommandTypeParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (MediaTransportControlCommandType, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint8("MediaTransportControlCommandType", 4)
	if err != nil {
