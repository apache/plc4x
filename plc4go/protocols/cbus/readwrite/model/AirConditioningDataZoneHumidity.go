...
func (m *_AirConditioningDataZoneHumidity) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_AirConditioningDataZoneHumidity) GetLengthInBytes(ctx context.Context) uint64 {
