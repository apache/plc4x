...
func (m *_AirConditioningDataZoneHumidity) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AirConditioningData) (_airConditioningDataZoneHumidity AirConditioningDataZoneHumidity, err error) {
