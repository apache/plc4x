...
func (m *_SALDataTemperatureBroadcast) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SALData, applicationId ApplicationId) (_sALDataTemperatureBroadcast SALDataTemperatureBroadcast, err error) {
