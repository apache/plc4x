...
func (m *_TelephonyDataInternetConnectionRequestMade) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_TelephonyData) (_telephonyDataInternetConnectionRequestMade TelephonyDataInternetConnectionRequestMade, err error) {
