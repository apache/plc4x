...
func ParameterChangeParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (ParameterChange, error) {
	...
	specialChar1, err := readConstField[byte](ctx, "specialChar1", ReadByte(readBuffer, 8), ParameterChange.SPECIALCHAR1)
	if err != nil {
		return nil, errors.Wrap(err, fmt.Sprintf("Error parsing 'specialChar1' field"))
	}
	_ = specialChar1

	specialChar2, err := readConstField[byte](ctx, "specialChar2", ReadByte(readBuffer, 8), ParameterChange.SPECIALCHAR2)
	if err != nil {
