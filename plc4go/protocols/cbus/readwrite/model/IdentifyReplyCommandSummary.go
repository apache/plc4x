...
func (m *_IdentifyReplyCommandSummary) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_IdentifyReplyCommand, attribute Attribute, numBytes uint8) (_identifyReplyCommandSummary IdentifyReplyCommandSummary, err error) {
