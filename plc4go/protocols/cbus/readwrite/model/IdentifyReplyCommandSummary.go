...
func (m *_IdentifyReplyCommandSummary) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_IdentifyReplyCommandSummary) GetLengthInBytes(ctx context.Context) uint64 {
