...
func (m *_SALDataMeasurement) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SALData, applicationId ApplicationId) (_sALDataMeasurement SALDataMeasurement, err error) {
