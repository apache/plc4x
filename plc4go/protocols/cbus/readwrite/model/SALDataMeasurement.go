...
func (m *_SALDataMeasurementBuilder) WithMeasurementDataBuilder(builderSupplier func(MeasurementDataBuilder) MeasurementDataBuilder) SALDataMeasurementBuilder {
	builder := builderSupplier(m.MeasurementData.CreateMeasurementDataBuilder())
	var err error
	m.MeasurementData, err = builder.Build()
	if err != nil {
		if m.err == nil {
			m.err = &utils.MultiError{MainError: errors.New("sub builder failed")}
		}
		m.err.Append(errors.Wrap(err, "MeasurementDataBuilder failed"))
	}
	return m
}
