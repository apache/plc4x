...
func (m *_AirConditioningDataZoneTemperature) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_AirConditioningDataZoneTemperature) GetLengthInBytes(ctx context.Context) uint64 {
