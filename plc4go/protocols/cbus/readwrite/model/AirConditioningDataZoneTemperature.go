...
func (m *_AirConditioningDataZoneTemperature) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AirConditioningData) (_airConditioningDataZoneTemperature AirConditioningDataZoneTemperature, err error) {
