...
func CustomManufacturerParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, numBytes uint8) (CustomManufacturer, error) {
	v, err := (&_CustomManufacturer{}).parse(ctx, readBuffer, numBytes)
	if err != nil {
		return nil, err
	}
	return v, err
...
func (m *_CustomManufacturer) parse(ctx context.Context, readBuffer utils.ReadBuffer, numBytes uint8) (_customManufacturer CustomManufacturer, err error) {
