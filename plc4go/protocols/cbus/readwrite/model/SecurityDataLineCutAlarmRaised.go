...
func (m *_SecurityDataLineCutAlarmRaised) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.SecurityDataContract.(*_SecurityData).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_SecurityDataLineCutAlarmRaised) GetLengthInBytes(ctx context.Context) uint64 {
