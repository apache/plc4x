...
func (m *_AirConditioningDataRefresh) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_AirConditioningDataRefresh) GetLengthInBytes(ctx context.Context) uint64 {
