...
func (m TriggerControlCommandTypeContainer) GetLengthInBits(ctx context.Context) uint64 {
	return 8
}

func (m TriggerControlCommandTypeContainer) GetLengthInBytes(ctx context.Context) uint64 {
...
func TriggerControlCommandTypeContainerParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (TriggerControlCommandTypeContainer, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint8("TriggerControlCommandTypeContainer", 8)
	if err != nil {
...
func (e TriggerControlCommandTypeContainer) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint8("TriggerControlCommandTypeContainer", 8, uint8(uint8(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}
