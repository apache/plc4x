...
func (m *_TriggerControlDataIndicatorKill) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_TriggerControlData) (_triggerControlDataIndicatorKill TriggerControlDataIndicatorKill, err error) {
