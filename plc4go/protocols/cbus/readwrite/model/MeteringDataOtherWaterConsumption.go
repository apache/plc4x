...
func (m *_MeteringDataOtherWaterConsumption) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MeteringData) (_meteringDataOtherWaterConsumption MeteringDataOtherWaterConsumption, err error) {
