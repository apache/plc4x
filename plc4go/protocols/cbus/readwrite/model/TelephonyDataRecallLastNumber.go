...
func (m *_TelephonyDataRecallLastNumber) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_TelephonyData, commandTypeContainer TelephonyCommandTypeContainer) (_telephonyDataRecallLastNumber TelephonyDataRecallLastNumber, err error) {
