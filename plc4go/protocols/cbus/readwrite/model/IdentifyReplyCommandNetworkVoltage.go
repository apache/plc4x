...
func IdentifyReplyCommandNetworkVoltageParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, attribute Attribute, numBytes uint8) (IdentifyReplyCommandNetworkVoltage, error) {
	...
	dot, err := readConstField[byte](ctx, "dot", ReadByte(readBuffer, 8), IdentifyReplyCommandNetworkVoltage.DOT)
	if err != nil {
	...
	v, err := readConstField[byte](ctx, "v", ReadByte(readBuffer, 8), IdentifyReplyCommandNetworkVoltage.V)
	if err != nil {
