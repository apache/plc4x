...
func (m *_MediaTransportControlDataFastForward) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MediaTransportControlData) (_mediaTransportControlDataFastForward MediaTransportControlDataFastForward, err error) {
