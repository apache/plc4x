...
func (m *_MonitoredSALReplyBuilder) WithMonitoredSALBuilder(builderSupplier func(MonitoredSALBuilder) MonitoredSALBuilder) MonitoredSALReplyBuilder {
	builder := builderSupplier(m.MonitoredSAL.CreateMonitoredSALBuilder())
	var err error
	m.MonitoredSAL, err = builder.Build()
	if err != nil {
		if m.err == nil {
			m.err = &utils.MultiError{MainError: errors.New("sub builder failed")}
		}
		m.err.Append(errors.Wrap(err, "MonitoredSALBuilder failed"))
	}
	return m
}
