...
func (m *_AirConditioningDataSetPlantHvacLevel) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AirConditioningData) (_airConditioningDataSetPlantHvacLevel AirConditioningDataSetPlantHvacLevel, err error) {
