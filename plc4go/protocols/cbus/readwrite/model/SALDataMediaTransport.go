...
func (m *_SALDataMediaTransport) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SALData, applicationId ApplicationId) (_sALDataMediaTransport SALDataMediaTransport, err error) {
