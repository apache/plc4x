...
func (m *_SecurityDataOtherAlarmRaised) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.SecurityDataContract.(*_SecurityData).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_SecurityDataOtherAlarmRaised) GetLengthInBytes(ctx context.Context) uint64 {
