...
func (m *_SecurityDataOtherAlarmRaised) InitializeParent(parent SecurityData , commandTypeContainer SecurityCommandTypeContainer , argument byte ) {	m.CommandTypeContainer = commandTypeContainer
	m.Argument = argument
}
...
func SecurityDataOtherAlarmRaisedParse(theBytes []byte) (SecurityDataOtherAlarmRaised, error) {
	return SecurityDataOtherAlarmRaisedParseWithBuffer(context.Background(), utils.NewReadBufferByteBased(theBytes))
}
