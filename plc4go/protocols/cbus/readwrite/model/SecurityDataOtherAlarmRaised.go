...
func (m *_SecurityDataOtherAlarmRaised) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SecurityData) (_securityDataOtherAlarmRaised SecurityDataOtherAlarmRaised, err error) {
