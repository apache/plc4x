...
func (m *_CALDataGetStatus) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_CALData, requestContext RequestContext) (_cALDataGetStatus CALDataGetStatus, err error) {
