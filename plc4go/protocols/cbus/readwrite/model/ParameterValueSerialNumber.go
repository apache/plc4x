...
func (m *_ParameterValueSerialNumber) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ParameterValue, parameterType ParameterType, numBytes uint8) (_parameterValueSerialNumber ParameterValueSerialNumber, err error) {
