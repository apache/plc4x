...
func (m *_SecurityDataRaiseAlarm) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SecurityData) (_securityDataRaiseAlarm SecurityDataRaiseAlarm, err error) {
