...
func (m *_SecurityDataRaiseAlarm) GetPlx4xTypeName() string {
	return "SecurityDataRaiseAlarm"
}

func (m *_SecurityDataRaiseAlarm) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.SecurityDataContract.(*_SecurityData).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_SecurityDataRaiseAlarm) GetLengthInBytes(ctx context.Context) uint64 {
