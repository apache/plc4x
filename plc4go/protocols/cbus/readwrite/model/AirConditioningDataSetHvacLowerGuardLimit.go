...
func (m *_AirConditioningDataSetHvacLowerGuardLimit) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AirConditioningData) (_airConditioningDataSetHvacLowerGuardLimit AirConditioningDataSetHvacLowerGuardLimit, err error) {
