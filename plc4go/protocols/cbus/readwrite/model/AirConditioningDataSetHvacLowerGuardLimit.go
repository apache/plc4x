...
func AirConditioningDataSetHvacLowerGuardLimitParse(theBytes []byte) (AirConditioningDataSetHvacLowerGuardLimit, error) {
	return AirConditioningDataSetHvacLowerGuardLimitParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian))) // TODO: get endianness from mspec
}
