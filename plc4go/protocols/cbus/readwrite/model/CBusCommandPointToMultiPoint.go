...
func (m *_CBusCommandPointToMultiPoint) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_CBusCommand, cBusOptions CBusOptions) (_cBusCommandPointToMultiPoint CBusCommandPointToMultiPoint, err error) {
