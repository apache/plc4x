...
func (m *_CBusCommandPointToMultiPointBuilder) WithCommandBuilder(builderSupplier func(CBusPointToMultiPointCommandBuilder) CBusPointToMultiPointCommandBuilder) CBusCommandPointToMultiPointBuilder {
	builder := builderSupplier(m.Command.CreateCBusPointToMultiPointCommandBuilder())
	var err error
	...
	if err != nil {
		...
		m.err.Append(errors.Wrap(err, "CBusPointToMultiPointCommandBuilder failed"))
	}
	return m
}
