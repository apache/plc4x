...
func (m *_SecurityDataOn) GetPlx4xTypeName() string {
	return "SecurityDataOn"
}

func (m *_SecurityDataOn) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_SecurityDataOn) GetLengthInBytes(ctx context.Context) uint64 {
