...
func (m *_MediaTransportControlDataNextPreviousTrack) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MediaTransportControlData) (_mediaTransportControlDataNextPreviousTrack MediaTransportControlDataNextPreviousTrack, err error) {
