...
func (m *_MediaTransportControlDataNextPreviousTrack) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_MediaTransportControlDataNextPreviousTrack) GetLengthInBytes(ctx context.Context) uint64 {
