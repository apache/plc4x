...
func (m *_LightingDataOn) InitializeParent(parent LightingData , commandTypeContainer LightingCommandTypeContainer ) {	m.CommandTypeContainer = commandTypeContainer
}
...
func LightingDataOnParse(theBytes []byte) (LightingDataOn, error) {
	return LightingDataOnParseWithBuffer(context.Background(), utils.NewReadBufferByteBased(theBytes))
}
