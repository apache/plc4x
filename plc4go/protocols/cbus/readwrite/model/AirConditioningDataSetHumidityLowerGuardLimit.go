...
func (m *_AirConditioningDataSetHumidityLowerGuardLimit) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AirConditioningData) (_airConditioningDataSetHumidityLowerGuardLimit AirConditioningDataSetHumidityLowerGuardLimit, err error) {
