...
func (m *_SALDataHvacActuatorBuilder) WithHvacActuatorDataBuilder(builderSupplier func(LightingDataBuilder) LightingDataBuilder) SALDataHvacActuatorBuilder {
	builder := builderSupplier(m.HvacActuatorData.CreateLightingDataBuilder())
	var err error
	m.HvacActuatorData, err = builder.Build()
	if err != nil {
		if m.err == nil {
