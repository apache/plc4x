...
func (m *_TelephonyDataIsolateSecondaryOutlet) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_TelephonyData) (_telephonyDataIsolateSecondaryOutlet TelephonyDataIsolateSecondaryOutlet, err error) {
