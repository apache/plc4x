...
func (m *_CBusPointToPointToMultiPointCommand) parse(ctx context.Context, readBuffer utils.ReadBuffer, cBusOptions CBusOptions) (_cBusPointToPointToMultiPointCommand CBusPointToPointToMultiPointCommand, err error) {
