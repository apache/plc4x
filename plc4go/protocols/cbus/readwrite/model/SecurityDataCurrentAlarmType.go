...
func (m *_SecurityDataCurrentAlarmType) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SecurityData) (_securityDataCurrentAlarmType SecurityDataCurrentAlarmType, err error) {
