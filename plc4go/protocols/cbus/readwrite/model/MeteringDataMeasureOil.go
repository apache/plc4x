...
func (m *_MeteringDataMeasureOil) GetPlx4xTypeName() string {
	return "MeteringDataMeasureOil"
}

func (m *_MeteringDataMeasureOil) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.MeteringDataContract.(*_MeteringData).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_MeteringDataMeasureOil) GetLengthInBytes(ctx context.Context) uint64 {
...
func (m *_MeteringDataMeasureOil) deepCopy() *_MeteringDataMeasureOil {
	...
	_MeteringDataMeasureOilCopy.MeteringDataContract.(*_MeteringData)._SubType = m
