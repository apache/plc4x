...
func (m *_RequestEmpty) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_Request, cBusOptions CBusOptions) (_requestEmpty RequestEmpty, err error) {
