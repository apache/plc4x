...
func (m *_MediaTransportControlDataNextPreviousSelection) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MediaTransportControlData) (_mediaTransportControlDataNextPreviousSelection MediaTransportControlDataNextPreviousSelection, err error) {
