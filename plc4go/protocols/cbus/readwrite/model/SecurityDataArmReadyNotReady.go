...
func (m *_SecurityDataArmReadyNotReady) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_SecurityDataArmReadyNotReady) GetLengthInBytes(ctx context.Context) uint64 {
