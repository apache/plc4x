...
func (m *_AirConditioningDataHumidityScheduleEntry) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AirConditioningData) (_airConditioningDataHumidityScheduleEntry AirConditioningDataHumidityScheduleEntry, err error) {
