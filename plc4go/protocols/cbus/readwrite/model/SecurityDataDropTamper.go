...
func (m *_SecurityDataDropTamper) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SecurityData) (_securityDataDropTamper SecurityDataDropTamper, err error) {
