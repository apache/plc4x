...
func (m *_CBusMessageToServer) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_CBusMessage, isResponse bool, requestContext RequestContext, cBusOptions CBusOptions) (_cBusMessageToServer CBusMessageToServer, err error) {
