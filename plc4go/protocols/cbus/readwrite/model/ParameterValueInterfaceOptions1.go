...
func (m *_ParameterValueInterfaceOptions1) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ParameterValue, parameterType ParameterType, numBytes uint8) (_parameterValueInterfaceOptions1 ParameterValueInterfaceOptions1, err error) {
