...
func (m *_ParameterValueInterfaceOptions1) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ParameterValueInterfaceOptions1) GetLengthInBytes(ctx context.Context) uint64 {
