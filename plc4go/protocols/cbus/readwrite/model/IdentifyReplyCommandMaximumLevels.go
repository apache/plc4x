...
func (m *_IdentifyReplyCommandMaximumLevels) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_IdentifyReplyCommand, attribute Attribute, numBytes uint8) (_identifyReplyCommandMaximumLevels IdentifyReplyCommandMaximumLevels, err error) {
