...
func (m *_IdentifyReplyCommandMaximumLevelsBuilder) WithMandatoryFields(maximumLevels []byte) IdentifyReplyCommandMaximumLevelsBuilder {
	return m.WithMaximumLevels(maximumLevels...)
}

func (m *_IdentifyReplyCommandMaximumLevelsBuilder) WithMaximumLevels(maximumLevels ...byte) IdentifyReplyCommandMaximumLevelsBuilder {
	m.MaximumLevels = maximumLevels
	return m
}

func (m *_IdentifyReplyCommandMaximumLevelsBuilder) Build() (IdentifyReplyCommandMaximumLevels, error) {
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._IdentifyReplyCommandMaximumLevels.deepCopy(), nil
}

func (m *_IdentifyReplyCommandMaximumLevelsBuilder) MustBuild() IdentifyReplyCommandMaximumLevels {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_IdentifyReplyCommandMaximumLevelsBuilder) DeepCopy() any {
	return m.CreateIdentifyReplyCommandMaximumLevelsBuilder()
}

// CreateIdentifyReplyCommandMaximumLevelsBuilder creates a IdentifyReplyCommandMaximumLevelsBuilder
func (m *_IdentifyReplyCommandMaximumLevels) CreateIdentifyReplyCommandMaximumLevelsBuilder() IdentifyReplyCommandMaximumLevelsBuilder {
	if m == nil {
		return NewIdentifyReplyCommandMaximumLevelsBuilder()
	}
	return &_IdentifyReplyCommandMaximumLevelsBuilder{_IdentifyReplyCommandMaximumLevels: m.deepCopy()}
}
