...
func (m *_ClockAndTimekeepingDataUpdateTime) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ClockAndTimekeepingData) (_clockAndTimekeepingDataUpdateTime ClockAndTimekeepingDataUpdateTime, err error) {
