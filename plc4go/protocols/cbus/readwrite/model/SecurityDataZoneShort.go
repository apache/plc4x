...
func (m *_SecurityDataZoneShort) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SecurityData) (_securityDataZoneShort SecurityDataZoneShort, err error) {
