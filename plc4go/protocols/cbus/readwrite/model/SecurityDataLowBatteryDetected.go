...
func (m *_SecurityDataLowBatteryDetected) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.SecurityDataContract.(*_SecurityData).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_SecurityDataLowBatteryDetected) GetLengthInBytes(ctx context.Context) uint64 {
