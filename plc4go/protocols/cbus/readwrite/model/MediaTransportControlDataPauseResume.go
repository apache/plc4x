...
func MediaTransportControlDataPauseResumeParseWithBufferProducer() func(ctx context.Context, readBuffer utils.ReadBuffer) (MediaTransportControlDataPauseResume, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (MediaTransportControlDataPauseResume, error) {
		return MediaTransportControlDataPauseResumeParseWithBuffer(ctx, readBuffer)
	}
}
