...
func (m *_IdentifyReplyCommandDelays) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_IdentifyReplyCommand, attribute Attribute, numBytes uint8) (_identifyReplyCommandDelays IdentifyReplyCommandDelays, err error) {
