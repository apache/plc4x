...
func (m *_CBusPointToMultiPointCommandNormal) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_CBusPointToMultiPointCommandNormal) GetLengthInBytes(ctx context.Context) uint64 {
