...
func (m *_ParameterValueApplicationAddress2) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_ParameterValueApplicationAddress2) GetLengthInBytes(ctx context.Context) uint64 {
