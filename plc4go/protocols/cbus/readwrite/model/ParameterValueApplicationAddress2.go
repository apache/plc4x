...
func (m *_ParameterValueApplicationAddress2Builder) WithMandatoryFields(value ApplicationAddress2, data []byte) ParameterValueApplicationAddress2Builder {
	return m.WithValue(value).WithData(data...)
}

func (m *_ParameterValueApplicationAddress2Builder) WithValue(value ApplicationAddress2) ParameterValueApplicationAddress2Builder {
	m.Value = value
	return m
}

func (m *_ParameterValueApplicationAddress2Builder) WithValueBuilder(builderSupplier func(ApplicationAddress2Builder) ApplicationAddress2Builder) ParameterValueApplicationAddress2Builder {
	builder := builderSupplier(m.Value.CreateApplicationAddress2Builder())
	var err error
	...
	if err != nil {
		...
		m.err.Append(errors.Wrap(err, "ApplicationAddress2Builder failed"))
	}
	return m
}

func (m *_ParameterValueApplicationAddress2Builder) WithData(data ...byte) ParameterValueApplicationAddress2Builder {
	m.Data = data
	return m
}

func (m *_ParameterValueApplicationAddress2Builder) Build() (ParameterValueApplicationAddress2, error) {
	if m.Value == nil {
		if m.err == nil {
	...
	return m._ParameterValueApplicationAddress2.deepCopy(), nil
}

func (m *_ParameterValueApplicationAddress2Builder) MustBuild() ParameterValueApplicationAddress2 {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_ParameterValueApplicationAddress2Builder) DeepCopy() any {
	return m.CreateParameterValueApplicationAddress2Builder()
}

// CreateParameterValueApplicationAddress2Builder creates a ParameterValueApplicationAddress2Builder
func (m *_ParameterValueApplicationAddress2) CreateParameterValueApplicationAddress2Builder() ParameterValueApplicationAddress2Builder {
	if m == nil {
		return NewParameterValueApplicationAddress2Builder()
	}
	return &_ParameterValueApplicationAddress2Builder{_ParameterValueApplicationAddress2: m.deepCopy()}
}
