...
func (m *_ParameterValueApplicationAddress2) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ParameterValue, parameterType ParameterType, numBytes uint8) (_parameterValueApplicationAddress2 ParameterValueApplicationAddress2, err error) {
