...
func (m *_ParameterValueBaudRateSelector) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ParameterValue, parameterType ParameterType, numBytes uint8) (_parameterValueBaudRateSelector ParameterValueBaudRateSelector, err error) {
