...
func (m LightingLabelType) GetLengthInBits(ctx context.Context) uint64 {
	return 2
}

func (m LightingLabelType) GetLengthInBytes(ctx context.Context) uint64 {
...
func LightingLabelTypeParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (LightingLabelType, error) {
	log := zerolog.Ctx(ctx)
	_ = log
	val, err := /*TODO: migrate me*/ /*TODO: migrate me*/ readBuffer.ReadUint8("LightingLabelType", 2)
	if err != nil {
...
func (e LightingLabelType) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	log := zerolog.Ctx(ctx)
	_ = log
	return /*TODO: migrate me*/ writeBuffer.WriteUint8("LightingLabelType", 2, uint8(uint8(e)), utils.WithAdditionalStringRepresentation(e.PLC4XEnumName()))
}
