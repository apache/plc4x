...
func (m *_MediaTransportControlDataTotalTracks) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_MediaTransportControlDataTotalTracks) GetLengthInBytes(ctx context.Context) uint64 {
