...
func PowerUpParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (PowerUp, error) {
	...
	powerUpIndicator1, err := readConstField[byte](ctx, "powerUpIndicator1", ReadByte(readBuffer, 8), PowerUp.POWERUPINDICATOR1)
	if err != nil {
		return nil, errors.Wrap(err, fmt.Sprintf("Error parsing 'powerUpIndicator1' field"))
	}
	_ = powerUpIndicator1

	powerUpIndicator2, err := readConstField[byte](ctx, "powerUpIndicator2", ReadByte(readBuffer, 8), PowerUp.POWERUPINDICATOR2)
	if err != nil {
