...
func (m *_MediaTransportControlDataSetCategory) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MediaTransportControlData) (_mediaTransportControlDataSetCategory MediaTransportControlDataSetCategory, err error) {
