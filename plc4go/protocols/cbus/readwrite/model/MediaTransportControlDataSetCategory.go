...
func (m *_MediaTransportControlDataSetCategory) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_MediaTransportControlDataSetCategory) GetLengthInBytes(ctx context.Context) uint64 {
