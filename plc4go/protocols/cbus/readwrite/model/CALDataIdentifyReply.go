...
func (m *_CALDataIdentifyReplyBuilder) WithIdentifyReplyCommandBuilder(builderSupplier func(IdentifyReplyCommandBuilder) IdentifyReplyCommandBuilder) CALDataIdentifyReplyBuilder {
	builder := builderSupplier(m.IdentifyReplyCommand.CreateIdentifyReplyCommandBuilder())
	var err error
	m.IdentifyReplyCommand, err = builder.Build()
	if err != nil {
		if m.err == nil {
			m.err = &utils.MultiError{MainError: errors.New("sub builder failed")}
		}
		m.err.Append(errors.Wrap(err, "IdentifyReplyCommandBuilder failed"))
	}
	return m
}
