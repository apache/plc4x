...
func (m *_MediaTransportControlDataTrackName) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MediaTransportControlData, commandTypeContainer MediaTransportControlCommandTypeContainer) (_mediaTransportControlDataTrackName MediaTransportControlDataTrackName, err error) {
