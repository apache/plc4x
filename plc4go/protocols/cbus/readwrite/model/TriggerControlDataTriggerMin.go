...
func (m *_TriggerControlDataTriggerMin) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_TriggerControlData) (_triggerControlDataTriggerMin TriggerControlDataTriggerMin, err error) {
