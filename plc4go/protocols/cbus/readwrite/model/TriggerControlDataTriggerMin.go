...
func TriggerControlDataTriggerMinParse(theBytes []byte) (TriggerControlDataTriggerMin, error) {
	return TriggerControlDataTriggerMinParseWithBuffer(utils.NewReadBufferByteBased(theBytes))
}
...
func (m *_TriggerControlDataTriggerMin) SerializeWithWriteBuffer(writeBuffer utils.WriteBuffer) error {
