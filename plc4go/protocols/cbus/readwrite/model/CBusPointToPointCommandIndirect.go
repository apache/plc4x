...
func (m *_CBusPointToPointCommandIndirect) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_CBusPointToPointCommandIndirect) GetLengthInBytes(ctx context.Context) uint64 {
