...
func (m *_HVACHumidityStatusFlags) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_HVACHumidityStatusFlags) GetLengthInBytes(ctx context.Context) uint64 {
...
func HVACHumidityStatusFlagsParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer) (HVACHumidityStatusFlags, error) {
	v, err := (new(_HVACHumidityStatusFlags)).parse(ctx, readBuffer)
	if err != nil {
		return nil, err
	}
	return v, nil
