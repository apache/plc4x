...
func (m *_SecurityDataFireAlarmClearedBuilder) WithMandatoryFields() SecurityDataFireAlarmClearedBuilder {
	return m
}

func (m *_SecurityDataFireAlarmClearedBuilder) Build() (SecurityDataFireAlarmCleared, error) {
	if m.err != nil {
		return nil, errors.Wrap(m.err, "error occurred during build")
	}
	return m._SecurityDataFireAlarmCleared.deepCopy(), nil
}

func (m *_SecurityDataFireAlarmClearedBuilder) MustBuild() SecurityDataFireAlarmCleared {
	build, err := m.Build()
	if err != nil {
		panic(err)
	}
...
func (m *_SecurityDataFireAlarmClearedBuilder) DeepCopy() any {
	return m.CreateSecurityDataFireAlarmClearedBuilder()
}

// CreateSecurityDataFireAlarmClearedBuilder creates a SecurityDataFireAlarmClearedBuilder
func (m *_SecurityDataFireAlarmCleared) CreateSecurityDataFireAlarmClearedBuilder() SecurityDataFireAlarmClearedBuilder {
	if m == nil {
		return NewSecurityDataFireAlarmClearedBuilder()
	}
	return &_SecurityDataFireAlarmClearedBuilder{_SecurityDataFireAlarmCleared: m.deepCopy()}
}
