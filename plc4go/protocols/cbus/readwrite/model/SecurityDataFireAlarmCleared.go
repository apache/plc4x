...
func (m *_SecurityDataFireAlarmCleared) GetLengthInBits(ctx context.Context) uint64 {
	lengthInBits := uint64(m.SecurityDataContract.(*_SecurityData).getLengthInBits(ctx))

	return lengthInBits
}

func (m *_SecurityDataFireAlarmCleared) GetLengthInBytes(ctx context.Context) uint64 {
