...
func (m *_SecurityDataFireAlarmCleared) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SecurityData) (_securityDataFireAlarmCleared SecurityDataFireAlarmCleared, err error) {
