...
func (m *_SecurityDataFireAlarmCleared) InitializeParent(parent SecurityData , commandTypeContainer SecurityCommandTypeContainer , argument byte ) {	m.CommandTypeContainer = commandTypeContainer
	m.Argument = argument
}
...
func SecurityDataFireAlarmClearedParse(theBytes []byte) (SecurityDataFireAlarmCleared, error) {
	return SecurityDataFireAlarmClearedParseWithBuffer(context.Background(), utils.NewReadBufferByteBased(theBytes))
}
