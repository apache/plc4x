...
func (m *_RequestSmartConnectShortcut) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_RequestSmartConnectShortcut) GetLengthInBytes(ctx context.Context) uint64 {
