...
func (m *_MeteringDataMeasureGas) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_MeteringData) (_meteringDataMeasureGas MeteringDataMeasureGas, err error) {
