...
func (m *_SALDataHeatingBuilder) WithHeatingDataBuilder(builderSupplier func(LightingDataBuilder) LightingDataBuilder) SALDataHeatingBuilder {
	builder := builderSupplier(m.HeatingData.CreateLightingDataBuilder())
	var err error
	m.HeatingData, err = builder.Build()
	if err != nil {
		if m.err == nil {
