...
func SecurityDataZoneUnsealedParseWithBufferProducer() func(ctx context.Context, readBuffer utils.ReadBuffer) (SecurityDataZoneUnsealed, error) {
	return func(ctx context.Context, readBuffer utils.ReadBuffer) (SecurityDataZoneUnsealed, error) {
		return SecurityDataZoneUnsealedParseWithBuffer(ctx, readBuffer)
	}
}
