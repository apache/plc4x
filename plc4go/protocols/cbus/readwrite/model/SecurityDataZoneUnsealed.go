...
func (m *_SecurityDataZoneUnsealed) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SecurityData) (_securityDataZoneUnsealed SecurityDataZoneUnsealed, err error) {
