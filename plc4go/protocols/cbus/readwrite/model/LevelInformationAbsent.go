...
func (m *_LevelInformationAbsent) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_LevelInformation) (_levelInformationAbsent LevelInformationAbsent, err error) {
