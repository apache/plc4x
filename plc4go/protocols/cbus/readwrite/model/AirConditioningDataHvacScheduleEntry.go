...
func (m *_AirConditioningDataHvacScheduleEntry) GetLengthInBits(ctx context.Context) uint64 {
...
func (m *_AirConditioningDataHvacScheduleEntry) GetLengthInBytes(ctx context.Context) uint64 {
