...
func (m *_AirConditioningDataHvacScheduleEntry) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_AirConditioningData) (_airConditioningDataHvacScheduleEntry AirConditioningDataHvacScheduleEntry, err error) {
