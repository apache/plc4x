...
func AirConditioningDataSetZoneHvacModeParse(theBytes []byte) (AirConditioningDataSetZoneHvacMode, error) {
	return AirConditioningDataSetZoneHvacModeParseWithBuffer(utils.NewReadBufferByteBased(theBytes, utils.WithByteOrderForReadBufferByteBased(binary.BigEndian))) // TODO: get endianness from mspec
}
