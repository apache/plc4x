...
func (m *_SALDataIrrigationControl) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_SALData, applicationId ApplicationId) (_sALDataIrrigationControl SALDataIrrigationControl, err error) {
