...
func (m *_ReplyOrConfirmationReplyBuilder) WithReplyBuilder(builderSupplier func(ReplyBuilder) ReplyBuilder) ReplyOrConfirmationReplyBuilder {
	builder := builderSupplier(m.Reply.CreateReplyBuilder())
	var err error
	m.Reply, err = builder.Build()
	if err != nil {
		if m.err == nil {
			m.err = &utils.MultiError{MainError: errors.New("sub builder failed")}
		}
		m.err.Append(errors.Wrap(err, "ReplyBuilder failed"))
	}
	return m
}
