...
type mockConstructorTestingTNewMockTransportAware interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockTransportAware(t mockConstructorTestingTNewMockTransportAware) *MockTransportAware {
