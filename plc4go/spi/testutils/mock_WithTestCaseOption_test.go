...
type mockConstructorTestingTNewMockWithTestCaseOption interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockWithTestCaseOption(t mockConstructorTestingTNewMockWithTestCaseOption) *MockWithTestCaseOption {
