...
type mockConstructorTestingTNewMockConnectionConnectAwaiter interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockConnectionConnectAwaiter(t mockConstructorTestingTNewMockConnectionConnectAwaiter) *MockConnectionConnectAwaiter {
