...
// NewMockTransportErrorHandlerSetter creates a new instance of MockTransportErrorHandlerSetter. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockTransportErrorHandlerSetter(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockTransportErrorHandlerSetter {
	mock := &MockTransportErrorHandlerSetter{}
	mock.Mock.Test(t)
...
// MockTransportErrorHandlerSetter is an autogenerated mock type for the TransportErrorHandlerSetter type
type MockTransportErrorHandlerSetter struct {
	mock.Mock
}

type MockTransportErrorHandlerSetter_Expecter struct {
	mock *mock.Mock
}

func (_m *MockTransportErrorHandlerSetter) EXPECT() *MockTransportErrorHandlerSetter_Expecter {
	return &MockTransportErrorHandlerSetter_Expecter{mock: &_m.Mock}
}

// SetTransportErrorHandler provides a mock function for the type MockTransportErrorHandlerSetter
func (_mock *MockTransportErrorHandlerSetter) SetTransportErrorHandler(handler transports.TransportErrorHandler) {
	_mock.Called(handler)
	return
}

// MockTransportErrorHandlerSetter_SetTransportErrorHandler_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetTransportErrorHandler'
type MockTransportErrorHandlerSetter_SetTransportErrorHandler_Call struct {
	*mock.Call
}
...
func (_c *MockTransportErrorHandlerSetter_SetTransportErrorHandler_Call) Run(run func(handler transports.TransportErrorHandler)) *MockTransportErrorHandlerSetter_SetTransportErrorHandler_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockTransportErrorHandlerSetter_SetTransportErrorHandler_Call) Return() *MockTransportErrorHandlerSetter_SetTransportErrorHandler_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockTransportErrorHandlerSetter_SetTransportErrorHandler_Call) RunAndReturn(run func(handler transports.TransportErrorHandler)) *MockTransportErrorHandlerSetter_SetTransportErrorHandler_Call {
	_c.Run(run)
	return _c
}
