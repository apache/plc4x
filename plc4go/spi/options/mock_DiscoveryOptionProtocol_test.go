...
type mockConstructorTestingTNewMockDiscoveryOptionProtocol interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockDiscoveryOptionProtocol(t mockConstructorTestingTNewMockDiscoveryOptionProtocol) *MockDiscoveryOptionProtocol {
