...
func (d *interceptedPlcReadRequestResult) Serialize() ([]byte, error) {
...
func (d *interceptedPlcReadRequestResult) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	if err := writeBuffer.PushContext("interceptedPlcReadRequestResult"); err != nil {
		return err
	}
	...
	if err := writeBuffer.PopContext("interceptedPlcReadRequestResult"); err != nil {
		return err
	}
	return nil
}

func (d *interceptedPlcReadRequestResult) String() string {
