...
type mockConstructorTestingTNewMockRequestInterceptor interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockRequestInterceptor(t mockConstructorTestingTNewMockRequestInterceptor) *MockRequestInterceptor {
