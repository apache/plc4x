...
type mockConstructorTestingTnewMockReadRequestFactory interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockReadRequestFactory(t mockConstructorTestingTnewMockReadRequestFactory) *mockReadRequestFactory {
