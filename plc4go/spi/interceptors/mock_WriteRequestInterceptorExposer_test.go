...
type mockConstructorTestingTNewMockWriteRequestInterceptorExposer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockWriteRequestInterceptorExposer(t mockConstructorTestingTNewMockWriteRequestInterceptorExposer) *MockWriteRequestInterceptorExposer {
