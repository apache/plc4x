...
func (d *interceptedPlcWriteRequestResult) Serialize() ([]byte, error) {
...
func (d *interceptedPlcWriteRequestResult) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	if err := writeBuffer.PushContext("interceptedPlcWriteRequestResult"); err != nil {
		return err
	}
	...
	if err := writeBuffer.PopContext("interceptedPlcWriteRequestResult"); err != nil {
		return err
	}
	return nil
}

func (d *interceptedPlcWriteRequestResult) String() string {
