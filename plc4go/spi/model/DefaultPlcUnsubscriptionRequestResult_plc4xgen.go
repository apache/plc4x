...
func (d *DefaultPlcUnsubscriptionRequestResult) SerializeWithWriteBuffer(writeBuffer utils.WriteBuffer) error {
	...
	if err := writeBuffer.PopContext("PlcUnsubscriptionRequestResult"); err != nil {
		return err
	}
	return nil
}
