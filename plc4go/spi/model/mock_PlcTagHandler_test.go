...
func (_m *MockPlcTagHandler) ParseQuery(query string) (apimodel.PlcQuery, error) {
	ret := _m.Called(query)

	var r0 apimodel.PlcQuery
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (apimodel.PlcQuery, error)); ok {
		return rf(query)
	}
	if rf, ok := ret.Get(0).(func(string) apimodel.PlcQuery); ok {
		r0 = rf(query)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(apimodel.PlcQuery)
		}
	}
...
func (_c *MockPlcTagHandler_ParseQuery_Call) Return(_a0 apimodel.PlcQuery, _a1 error) *MockPlcTagHandler_ParseQuery_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockPlcTagHandler_ParseQuery_Call) RunAndReturn(run func(string) (apimodel.PlcQuery, error)) *MockPlcTagHandler_ParseQuery_Call {
	_c.Call.Return(run)
	return _c
}

// ParseTag provides a mock function with given fields: tagAddress
func (_m *MockPlcTagHandler) ParseTag(tagAddress string) (apimodel.PlcTag, error) {
	ret := _m.Called(tagAddress)

	var r0 apimodel.PlcTag
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (apimodel.PlcTag, error)); ok {
		return rf(tagAddress)
	}
	if rf, ok := ret.Get(0).(func(string) apimodel.PlcTag); ok {
		r0 = rf(tagAddress)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockPlcTagHandler_ParseTag_Call) Return(_a0 apimodel.PlcTag, _a1 error) *MockPlcTagHandler_ParseTag_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockPlcTagHandler_ParseTag_Call) RunAndReturn(run func(string) (apimodel.PlcTag, error)) *MockPlcTagHandler_ParseTag_Call {
	_c.Call.Return(run)
	return _c
}
