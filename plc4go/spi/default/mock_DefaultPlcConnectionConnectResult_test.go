...
func (_m *MockDefaultPlcConnectionConnectResult) String() string {
	ret := _m.Called()
...
func (_c *MockDefaultPlcConnectionConnectResult_String_Call) Return(_a0 string) *MockDefaultPlcConnectionConnectResult_String_Call {
	_c.Call.Return(_a0)
	return _c
}
