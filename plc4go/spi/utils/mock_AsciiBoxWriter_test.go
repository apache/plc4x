...
type mockConstructorTestingTNewMockAsciiBoxWriter interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockAsciiBoxWriter(t mockConstructorTestingTNewMockAsciiBoxWriter) *MockAsciiBoxWriter {
