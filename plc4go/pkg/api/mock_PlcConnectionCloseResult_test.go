...
type mockConstructorTestingTNewMockPlcConnectionCloseResult interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockPlcConnectionCloseResult(t mockConstructorTestingTNewMockPlcConnectionCloseResult) *MockPlcConnectionCloseResult {
