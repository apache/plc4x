...
type mockConstructorTestingTNewMockPlcConnectionCacheCloseResult interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockPlcConnectionCacheCloseResult(t mockConstructorTestingTNewMockPlcConnectionCacheCloseResult) *MockPlcConnectionCacheCloseResult {
