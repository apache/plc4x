...
func (_m *MockPlcSubscriptionResponse) String() string {
	ret := _m.Called()
...
func (_c *MockPlcSubscriptionResponse_String_Call) Return(_a0 string) *MockPlcSubscriptionResponse_String_Call {
	_c.Call.Return(_a0)
	return _c
}
