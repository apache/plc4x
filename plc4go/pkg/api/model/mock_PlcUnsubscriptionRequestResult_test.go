...
func (_m *MockPlcUnsubscriptionRequestResult) String() string {
	ret := _m.Called()
...
func (_c *MockPlcUnsubscriptionRequestResult_String_Call) Return(_a0 string) *MockPlcUnsubscriptionRequestResult_String_Call {
	_c.Call.Return(_a0)
	return _c
}
