...
type mockConstructorTestingTNewMockPlcSubscriptionEvent interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockPlcSubscriptionEvent(t mockConstructorTestingTNewMockPlcSubscriptionEvent) *MockPlcSubscriptionEvent {
