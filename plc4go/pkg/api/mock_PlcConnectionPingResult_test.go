...
func (_m *MockPlcConnectionPingResult) String() string {
	ret := _m.Called()
...
func (_c *MockPlcConnectionPingResult_String_Call) Return(_a0 string) *MockPlcConnectionPingResult_String_Call {
	_c.Call.Return(_a0)
	return _c
}
