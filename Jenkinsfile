...
pipeline {
    ...
    stages {
        ...
        stage('Build') {
            ...
            steps {
                echo 'Building'
                sh 'mvn -P${JENKINS_PROFILE},development,with-boost,with-cpp,with-java,with-dotnet,with-python,with-proxies,with-sandbox,with-logstash ${MVN_TEST_FAIL_IGNORE} ${MVN_LOCAL_REPO_OPT} clean install'
            }
            post {
                always {
        ...
        stage('Build develop') {
            ...
            steps {
                ...
                sh 'mvn -U -P${JENKINS_PROFILE},development,with-boost,with-java,with-dotnet,with-cpp,with-python,with-proxies,with-sandbox,with-logstash ${MVN_TEST_FAIL_IGNORE} ${JQASSISTANT_NEO4J_VERSION} -DaltDeploymentRepository=snapshot-repo::default::file:./local-snapshots-dir clean deploy'
        ...
        stage('Build site') {
            ...
            steps {
                echo 'Building Site'
                sh 'mvn -P${JENKINS_PROFILE},with-java,with-proxies,with-logstash site'
            }
        }
        ...
        stage('Stage site') {
            ...
            steps {
                ...
                sh 'mvn -P${JENKINS_PROFILE},with-java,with-proxies,with-logstash site:stage'
