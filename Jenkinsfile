    ...
    stages {
        ...
        stage('Build develop') {
            ...
            steps {
                ...
                sh 'mvn -U -P${JENKINS_PROFILE},apache-release,development,with-boost,with-java,with-dotnet,with-cpp,with-python,with-proxies,with-sandbox ${MVN_TEST_FAIL_IGNORE} ${JQASSISTANT_NEO4J_VERSION} -DaltDeploymentRepository=snapshot-repo::default::file:./local-snapshots-dir clean deploy'
